...
public class GenForm extends FormBridge
{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		ims.framework.FormUiLogic m_ccDischargedForm = loader.loadComponent(102256, appForm, startControlID * 10 + 1000, anchoringHelper6.getSize(), instance1, startTabIndex.intValue() + 14, skipContextValidation);
		//ims.framework.Control m_ccDischargedControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1005), new Integer(576), new Integer(528), new Integer(272), new Integer(20), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, new Integer(startTabIndex.intValue() + 14), m_ccDischargedForm, instance1 } );
		ims.framework.Control m_ccDischargedControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1006),  new Integer(anchoringHelper6.getX()), new Integer(anchoringHelper6.getY()), new Integer(anchoringHelper6.getWidth()), new Integer(anchoringHelper6.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, new Integer(startTabIndex.intValue() + 14), m_ccDischargedForm, instance1, Boolean.TRUE } );
		...
		ims.framework.FormUiLogic m_ccConfirmedByForm = loader.loadComponent(102256, appForm, startControlID * 10 + 2000, anchoringHelper7.getSize(), instance2, startTabIndex.intValue() + 11, skipContextValidation);
		//ims.framework.Control m_ccConfirmedByControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1007), new Integer(152), new Integer(528), new Integer(264), new Integer(20), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, new Integer(startTabIndex.intValue() + 11), m_ccConfirmedByForm, instance2 } );
		ims.framework.Control m_ccConfirmedByControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1008),  new Integer(anchoringHelper7.getX()), new Integer(anchoringHelper7.getY()), new Integer(anchoringHelper7.getWidth()), new Integer(anchoringHelper7.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, new Integer(startTabIndex.intValue() + 11), m_ccConfirmedByForm, instance2, Boolean.TRUE } );
		...
		ims.framework.FormUiLogic m_ccAdmittingNurseForm = loader.loadComponent(102256, appForm, startControlID * 10 + 3000, anchoringHelper8.getSize(), instance3, startTabIndex.intValue() + 6, skipContextValidation);
		//ims.framework.Control m_ccAdmittingNurseControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1009), new Integer(568), new Integer(88), new Integer(264), new Integer(20), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT, new Integer(startTabIndex.intValue() + 6), m_ccAdmittingNurseForm, instance3 } );
		ims.framework.Control m_ccAdmittingNurseControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1010),  new Integer(anchoringHelper8.getX()), new Integer(anchoringHelper8.getY()), new Integer(anchoringHelper8.getWidth()), new Integer(anchoringHelper8.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT, new Integer(startTabIndex.intValue() + 6), m_ccAdmittingNurseForm, instance3, Boolean.FALSE } );
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1022), new Integer(anchoringHelper20.getX()), new Integer(anchoringHelper20.getY()), new Integer(anchoringHelper20.getWidth()), new Integer(anchoringHelper20.getHeight()), new Integer(startTabIndex.intValue() + 22), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Cancel Discharge", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1023), new Integer(anchoringHelper21.getX()), new Integer(anchoringHelper21.getY()), new Integer(anchoringHelper21.getWidth()), new Integer(anchoringHelper21.getHeight()), new Integer(startTabIndex.intValue() + 21), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Clinical Discharge", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1025), new Integer(anchoringHelper23.getX()), new Integer(anchoringHelper23.getY()), new Integer(anchoringHelper23.getWidth()), new Integer(anchoringHelper23.getHeight()), new Integer(startTabIndex.intValue() + 19), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Copy Last", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1026), new Integer(anchoringHelper24.getX()), new Integer(anchoringHelper24.getY()), new Integer(anchoringHelper24.getWidth()), new Integer(anchoringHelper24.getHeight()), new Integer(startTabIndex.intValue() + 18), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Edit", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1027), new Integer(anchoringHelper25.getX()), new Integer(anchoringHelper25.getY()), new Integer(anchoringHelper25.getWidth()), new Integer(anchoringHelper25.getHeight()), new Integer(startTabIndex.intValue() + 17), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "New", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1028), new Integer(anchoringHelper26.getX()), new Integer(anchoringHelper26.getY()), new Integer(anchoringHelper26.getWidth()), new Integer(anchoringHelper26.getHeight()), new Integer(startTabIndex.intValue() + 10), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPBOTTOMRIGHT,Boolean.TRUE, new Integer(1000), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
		...
		super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1029), new Integer(anchoringHelper27.getX()), new Integer(anchoringHelper27.getY()), new Integer(anchoringHelper27.getWidth()), new Integer(anchoringHelper27.getHeight()), new Integer(startTabIndex.intValue() + 9), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT,Boolean.TRUE, new Integer(1000), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
		...
		super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1030), new Integer(anchoringHelper28.getX()), new Integer(anchoringHelper28.getY()), new Integer(anchoringHelper28.getWidth()), new Integer(anchoringHelper28.getHeight()), new Integer(startTabIndex.intValue() + 5), ControlState.DISABLED, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT,Boolean.FALSE, new Integer(0), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
		...
		super.addControl(factory.getControl(DateTimeControl.class, new Object[] { control, new Integer(startControlID.intValue() + 1034), new Integer(anchoringHelper32.getX()), new Integer(anchoringHelper32.getY()), new Integer(anchoringHelper32.getWidth()), new Integer(anchoringHelper32.getHeight()), new Integer(startTabIndex.intValue() + 16), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT,Boolean.TRUE, null, Boolean.FALSE, null, Boolean.TRUE, null}));
		...
		super.addControl(factory.getControl(DateTimeControl.class, new Object[] { control, new Integer(startControlID.intValue() + 1035), new Integer(anchoringHelper33.getX()), new Integer(anchoringHelper33.getY()), new Integer(anchoringHelper33.getWidth()), new Integer(anchoringHelper33.getHeight()), new Integer(startTabIndex.intValue() + 13), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT,Boolean.TRUE, null, Boolean.FALSE, null, Boolean.TRUE, null}));
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.ClinicalAdmission.__internal_x_context__clinicalAdmission_" + componentIdentifier, "BO-1009100020-ID", "ID_ClinicalAdmission");
			fields[145] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.ClinicalAdmission.__internal_x_context__clinicalAdmission_" + componentIdentifier, "BO-1009100020-DISCHARGEDDATETIME", "DischargedDateTime");
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.ClinicalAdmission.__internal_x_context__clinicalAdmission_" + componentIdentifier, "BO-1009100020-CARECONTEXT", "CareContext");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.ClinicalAdmission.__internal_x_context__clinicalAdmission_" + componentIdentifier, "BO-1009100020-CLIENTUNDERSTANDING", "ClientUnderstanding");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.ClinicalAdmission.__internal_x_context__clinicalAdmission_" + componentIdentifier, "BO-1009100020-SOCIALCIRCUMSTANCE", "SocialCircumstance");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.ClinicalAdmission.__internal_x_context__clinicalAdmission_" + componentIdentifier, "BO-1009100020-CONFIRMEDDATETIME", "ConfirmedDateTime");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.ClinicalAdmission.__internal_x_context__previousClinicalAdmission_" + componentIdentifier, "BO-1009100020-ID", "ID_ClinicalAdmission");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.ClinicalAdmission.__internal_x_context__previousClinicalAdmission_" + componentIdentifier, "BO-1009100020-DISCHARGEDDATETIME", "DischargedDateTime");
			fields[152] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.ClinicalAdmission.__internal_x_context__previousClinicalAdmission_" + componentIdentifier, "BO-1009100020-CARECONTEXT", "CareContext");
			fields[153] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.ClinicalAdmission.__internal_x_context__previousClinicalAdmission_" + componentIdentifier, "BO-1009100020-CLIENTUNDERSTANDING", "ClientUnderstanding");
			fields[154] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.ClinicalAdmission.__internal_x_context__previousClinicalAdmission_" + componentIdentifier, "BO-1009100020-SOCIALCIRCUMSTANCE", "SocialCircumstance");
			fields[155] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.ClinicalAdmission.__internal_x_context__previousClinicalAdmission_" + componentIdentifier, "BO-1009100020-CONFIRMEDDATETIME", "ConfirmedDateTime");
			fields[156] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.ClinicalAdmission.__internal_x_context__admissionDetail_" + componentIdentifier, "BO-1014100008-ID", "ID_AdmissionDetail");
			fields[157] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.ClinicalAdmission.__internal_x_context__admissionDetail_" + componentIdentifier, "BO-1014100008-ADMISSIONDATETIME", "AdmissionDateTime");
			fields[158] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.ClinicalAdmission.__internal_x_context__admissionDetail_" + componentIdentifier, "BO-1014100008-BED", "Bed");
			fields[159] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.ClinicalAdmission.__internal_x_context__admissionDetail_" + componentIdentifier, "BO-1014100008-SPECIALTY", "Specialty");
			fields[160] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.ClinicalAdmission.__internal_x_context__admissionDetail_" + componentIdentifier, "BO-1014100008-WARDTYPE", "WardType");
			fields[161] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.ClinicalAdmission.__internal_x_context__admissionDetail_" + componentIdentifier, "BO-1014100008-METHODOFADMISSION", "MethodOfAdmission");
			fields[162] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.ClinicalAdmission.__internal_x_context__admissionDetail_" + componentIdentifier, "BO-1014100008-SOURCEOFADMISSION", "SourceOfAdmission");
			fields[163] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.ClinicalAdmission.__internal_x_context__admissionDetail_" + componentIdentifier, "BO-1014100008-REASONFORADMISSION", "ReasonForAdmission");
			fields[164] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.ClinicalAdmission.__internal_x_context__admissionDetail_" + componentIdentifier, "BO-1014100008-ESTDISCHARGEDATE", "EstDischargeDate");
			fields[165] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.ClinicalAdmission.__internal_x_context__admissionDetail_" + componentIdentifier, "BO-1014100008-ISCHAPLAINREQUIRED", "IsChaplainRequired");
			fields[166] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.ClinicalAdmission.__internal_x_context__admissionDetail_" + componentIdentifier, "BO-1014100008-PATIENTSTATUS", "PatientStatus");
			fields[167] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.ClinicalAdmission.__internal_x_context__admissionDetail_" + componentIdentifier, "BO-1014100008-UPDATECFL", "UpdateCFL");
			fields[168] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.ClinicalAdmission.__internal_x_context__admissionDetail_" + componentIdentifier, "BO-1014100008-ANTICIPATEDSTAY", "AnticipatedStay");
			fields[169] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.ClinicalAdmission.__internal_x_context__admissionDetail_" + componentIdentifier, "BO-1014100008-CASEFOLDERCOMMENTS", "CaseFolderComments");
			fields[170] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.ClinicalAdmission.__internal_x_context__admissionDetail_" + componentIdentifier, "BO-1014100008-EXTENDEDLENGTHOFSTAYREASON", "ExtendedLengthOfStayReason");
			fields[171] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.ClinicalAdmission.__internal_x_context__admissionDetail_" + componentIdentifier, "BO-1014100008-MEDICALLYFITFORDISCHARGE", "MedicallyFitForDischarge");
			fields[172] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.ClinicalAdmission.__internal_x_context__admissionDetail_" + componentIdentifier, "BO-1014100008-PATIENTREQUIRESTRANSPORT", "PatientRequiresTransport");
			fields[173] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.ClinicalAdmission.__internal_x_context__admissionDetail_" + componentIdentifier, "BO-1014100008-ABLETOGODISCHARGELOUNGE", "AbleToGoDischargeLounge");
			fields[174] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.ClinicalAdmission.__internal_x_context__admissionDetail_" + componentIdentifier, "BO-1014100008-REASONCANNOTGODISCHARGELOUNGE", "ReasonCannotGoDischargeLounge");
			fields[175] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.ClinicalAdmission.__internal_x_context__admissionDetail_" + componentIdentifier, "BO-1014100008-SELFADMITPATIENT", "SelfAdmitPatient");
			fields[176] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.ClinicalAdmission.__internal_x_context__admissionDetail_" + componentIdentifier, "BO-1014100008-SOURCEOFEMERGENCYREFERRAL", "SourceOfEmergencyReferral");
			fields[177] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.ClinicalAdmission.__internal_x_context__localContextForRie_" + componentIdentifier, "BO-1009100020-ID", "ID_ClinicalAdmission");
			fields[178] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.ClinicalAdmission.__internal_x_context__localContextForRie_" + componentIdentifier, "BO-1009100020-DISCHARGEDDATETIME", "DischargedDateTime");
			fields[179] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.ClinicalAdmission.__internal_x_context__localContextForRie_" + componentIdentifier, "BO-1009100020-CARECONTEXT", "CareContext");
			fields[180] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.ClinicalAdmission.__internal_x_context__localContextForRie_" + componentIdentifier, "BO-1009100020-CLIENTUNDERSTANDING", "ClientUnderstanding");
			fields[181] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.ClinicalAdmission.__internal_x_context__localContextForRie_" + componentIdentifier, "BO-1009100020-SOCIALCIRCUMSTANCE", "SocialCircumstance");
			fields[182] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.ClinicalAdmission.__internal_x_context__localContextForRie_" + componentIdentifier, "BO-1009100020-CONFIRMEDDATETIME", "ConfirmedDateTime");
			return fields;
		}
