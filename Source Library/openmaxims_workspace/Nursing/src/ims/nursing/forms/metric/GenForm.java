...
public class GenForm extends FormBridge
{
	...
	public static class GroupWRadioButton extends RadioButtonBridge
	{
		...
		protected void setContext(Integer startTabIndex, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize)
		{
			...
			control.addButton(0, anchoringHelper1.getX(), anchoringHelper1.getY(), anchoringHelper1.getWidth(), "Estimated", startTabIndex.intValue() + 14);
			...
			control.addButton(1, anchoringHelper2.getX(), anchoringHelper2.getY(), anchoringHelper2.getWidth(), "Measured", startTabIndex.intValue() + 13);
		}
	...
	public static class GroupHRadioButton extends RadioButtonBridge
	{
		...
		protected void setContext(Integer startTabIndex, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize)
		{
			...
			control.addButton(0, anchoringHelper3.getX(), anchoringHelper3.getY(), anchoringHelper3.getWidth(), "Estimated", startTabIndex.intValue() + 11);
			...
			control.addButton(1, anchoringHelper4.getX(), anchoringHelper4.getY(), anchoringHelper4.getWidth(), "Measured", startTabIndex.intValue() + 10);
		}
	...
	private void validateContext(ims.framework.Context context)
	{
		...
		if(!context.isValidContextType(ims.nursing.vo.MetricSearchCriteriaVo.class))
			throw new ims.framework.exceptions.CodingRuntimeException("The type 'ims.nursing.vo.MetricSearchCriteriaVo' of the global context variable 'Nursing.MetricSearchCriteria' is not supported.");
	}
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.Metric.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1022100011-ID", "ID_Metrics");
			fields[145] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.Metric.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1022100011-HEIGHTVALUE", "HeightValue");
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.Metric.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1022100011-HEIGHTESTIMATEDMEASURED", "HeightEstimatedMeasured");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.Metric.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1022100011-WEIGHTVALUE", "WeightValue");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.Metric.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1022100011-WEIGHTESTIMATEDMEASURED", "WeightEstimatedMeasured");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.Metric.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1022100011-BMI", "BMI");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.Metric.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1022100011-SURFACEAREA", "SurfaceArea");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.Metric.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1022100011-NECKSIZE", "NeckSize");
			fields[152] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.Metric.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1022100011-PATIENT", "Patient");
			return fields;
		}
