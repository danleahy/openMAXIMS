...
public class GenForm extends FormBridge
{
	...
	public static class ctnMustContainer extends ContainerBridge
	{
		...
		protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
		{
			...
			RuntimeAnchoring anchoringHelper5 = new RuntimeAnchoring(designSize, runtimeSize, 472, 108, 342, 56, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFTRIGHT);
			...
			// Label Controls
			RuntimeAnchoring anchoringHelper6 = new RuntimeAnchoring(designSize, runtimeSize, 430, 18, 40, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
			...
			RuntimeAnchoring anchoringHelper7 = new RuntimeAnchoring(designSize, runtimeSize, 480, 92, 123, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
			...
			RuntimeAnchoring anchoringHelper12 = new RuntimeAnchoring(designSize, runtimeSize, 90, 166, 636, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
			...
			RuntimeAnchoring anchoringHelper16 = new RuntimeAnchoring(designSize, runtimeSize, 8, 66, 156, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
			...
			RuntimeAnchoring anchoringHelper17 = new RuntimeAnchoring(designSize, runtimeSize, 8, 42, 129, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
			...
			// TextBox Controls
			RuntimeAnchoring anchoringHelper19 = new RuntimeAnchoring(designSize, runtimeSize, 613, 90, 186, 21, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFTRIGHT);
			...
			RuntimeAnchoring anchoringHelper20 = new RuntimeAnchoring(designSize, runtimeSize, 613, 40, 186, 46, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFTRIGHT);
			...
			// ComboBox Controls
			RuntimeAnchoring anchoringHelper21 = new RuntimeAnchoring(designSize, runtimeSize, 613, 16, 186, 21, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFTRIGHT);
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1033), new Integer(anchoringHelper35.getX()), new Integer(anchoringHelper35.getY()), new Integer(anchoringHelper35.getWidth()), new Integer(anchoringHelper35.getHeight()), new Integer(startTabIndex.intValue() + 16), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Edit", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		RuntimeAnchoring anchoringHelper36 = new RuntimeAnchoring(designSize, runtimeSize, 677, 592, 75, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT);
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1035), new Integer(anchoringHelper37.getX()), new Integer(anchoringHelper37.getY()), new Integer(anchoringHelper37.getWidth()), new Integer(anchoringHelper37.getHeight()), new Integer(startTabIndex.intValue() + 18), ControlState.HIDDEN, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Cancel", Boolean.FALSE, null, Boolean.FALSE, Boolean.FALSE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		grdDetails.addStringColumn("Step 3 (ADE)", 1, 1, 100, true, false, 0, 0, true, ims.framework.enumerations.CharacterCasing.NORMAL);
		grdDetails.addStringColumn("Total (ORM)", 1, 1, 80, true, false, 0, 0, true, ims.framework.enumerations.CharacterCasing.NORMAL);
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.MUST.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1016100016-ID", "ID_MUST");
			fields[145] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.MUST.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1016100016-CLINICALCONTACT", "ClinicalContact");
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.MUST.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1016100016-CARECONTEXT", "CareContext");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.MUST.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1016100016-PREVIOUSHEALTHYWEIGHT", "PreviousHealthyWeight");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.MUST.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1016100016-ACUTELYILL", "AcutelyIll");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.MUST.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1016100016-ACTIONTAKEN", "ActionTaken");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.MUST.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1016100016-WEIGHTLOSSREASON", "WeightLossReason");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.MUST.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1016100016-MANAGEMENT", "Management");
			fields[152] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.MUST.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1016100016-BMISCORE", "BMIScore");
			fields[153] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.MUST.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1016100016-UWLSCORE", "UWLScore");
			fields[154] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.MUST.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1016100016-ADESCORE", "ADEScore");
			fields[155] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.MUST.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1016100016-ORMSCORE", "ORMScore");
			return fields;
		}
