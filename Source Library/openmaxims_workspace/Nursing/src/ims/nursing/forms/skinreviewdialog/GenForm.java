...
public class GenForm extends FormBridge
{
	...
	public static class grpInfectionRadioButton extends RadioButtonBridge
	{
		...
		protected void setContext(Integer startTabIndex, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize)
		{
			...
			control.addButton(0, anchoringHelper3.getX(), anchoringHelper3.getY(), anchoringHelper3.getWidth(), "Yes", startTabIndex.intValue() + 13);
			...
			control.addButton(1, anchoringHelper4.getX(), anchoringHelper4.getY(), anchoringHelper4.getWidth(), "No", startTabIndex.intValue() + 14);
		}
	...
	public static class grpSwabRadioButton extends RadioButtonBridge
	{
		...
		protected void setContext(Integer startTabIndex, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize)
		{
			...
			control.addButton(0, anchoringHelper5.getX(), anchoringHelper5.getY(), anchoringHelper5.getWidth(), "Yes", startTabIndex.intValue() + 15);
			...
			control.addButton(1, anchoringHelper6.getX(), anchoringHelper6.getY(), anchoringHelper6.getWidth(), "No", startTabIndex.intValue() + 16);
		}
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		ComboBox m_cmbPainTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1039), new Integer(anchoringHelper46.getX()), new Integer(anchoringHelper46.getY()), new Integer(anchoringHelper46.getWidth()), new Integer(anchoringHelper46.getHeight()), new Integer(startTabIndex.intValue() + 12), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
		...
		ComboBox m_cmbWoundBedTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1040), new Integer(anchoringHelper47.getX()), new Integer(anchoringHelper47.getY()), new Integer(anchoringHelper47.getWidth()), new Integer(anchoringHelper47.getHeight()), new Integer(startTabIndex.intValue() + 7), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
		...
		ComboBox m_cmbSurroundingSkinTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1041), new Integer(anchoringHelper48.getX()), new Integer(anchoringHelper48.getY()), new Integer(anchoringHelper48.getWidth()), new Integer(anchoringHelper48.getHeight()), new Integer(startTabIndex.intValue() + 8), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
		...
		ComboBox m_cmbOdourTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1044), new Integer(anchoringHelper51.getX()), new Integer(anchoringHelper51.getY()), new Integer(anchoringHelper51.getWidth()), new Integer(anchoringHelper51.getHeight()), new Integer(startTabIndex.intValue() + 11), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
		...
		ComboBox m_cmbSecondaryTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1048), new Integer(anchoringHelper55.getX()), new Integer(anchoringHelper55.getY()), new Integer(anchoringHelper55.getWidth()), new Integer(anchoringHelper55.getHeight()), new Integer(startTabIndex.intValue() + 21), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
		...
		ComboBox m_cmbPrimaryTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1049), new Integer(anchoringHelper56.getX()), new Integer(anchoringHelper56.getY()), new Integer(anchoringHelper56.getWidth()), new Integer(anchoringHelper56.getHeight()), new Integer(startTabIndex.intValue() + 20), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
		...
		super.addControl(factory.getControl(CheckBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1050), new Integer(anchoringHelper57.getX()), new Integer(anchoringHelper57.getY()), new Integer(anchoringHelper57.getWidth()), new Integer(anchoringHelper57.getHeight()), new Integer(startTabIndex.intValue() + 24), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,"", Boolean.FALSE, null}));
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, "_cv_COE.SkinBodyChart.ReviewVO", "BO-1016100004-ID", "ID_SkinAssessmentReview");
			fields[145] = new ims.framework.ReportField(this.context, "_cv_COE.SkinBodyChart.ReviewVO", "BO-1016100004-DATETIMEREVIEW", "DateTimeReview");
			fields[146] = new ims.framework.ReportField(this.context, "_cv_COE.SkinBodyChart.ReviewVO", "BO-1016100004-SITEDETAILS", "SiteDetails");
			fields[147] = new ims.framework.ReportField(this.context, "_cv_COE.SkinBodyChart.ReviewVO", "BO-1016100004-HOWLONGISITPRESENT", "HowLongIsItPresent");
			fields[148] = new ims.framework.ReportField(this.context, "_cv_COE.SkinBodyChart.ReviewVO", "BO-1016100004-PRESSURESOREGRADE", "PressureSoreGrade");
			fields[149] = new ims.framework.ReportField(this.context, "_cv_COE.SkinBodyChart.ReviewVO", "BO-1016100004-LENGTH", "Length");
			fields[150] = new ims.framework.ReportField(this.context, "_cv_COE.SkinBodyChart.ReviewVO", "BO-1016100004-WIDTH", "Width");
			fields[151] = new ims.framework.ReportField(this.context, "_cv_COE.SkinBodyChart.ReviewVO", "BO-1016100004-DEPTH", "Depth");
			fields[152] = new ims.framework.ReportField(this.context, "_cv_COE.SkinBodyChart.ReviewVO", "BO-1016100004-WOUNDBED", "WoundBed");
			fields[153] = new ims.framework.ReportField(this.context, "_cv_COE.SkinBodyChart.ReviewVO", "BO-1016100004-SURROUNDINGSKIN", "SurroundingSkin");
			fields[154] = new ims.framework.ReportField(this.context, "_cv_COE.SkinBodyChart.ReviewVO", "BO-1016100004-EXUDATEAMOUNT", "ExudateAmount");
			fields[155] = new ims.framework.ReportField(this.context, "_cv_COE.SkinBodyChart.ReviewVO", "BO-1016100004-EXUDATETYPE", "ExudateType");
			fields[156] = new ims.framework.ReportField(this.context, "_cv_COE.SkinBodyChart.ReviewVO", "BO-1016100004-ODOUR", "Odour");
			fields[157] = new ims.framework.ReportField(this.context, "_cv_COE.SkinBodyChart.ReviewVO", "BO-1016100004-PAIN", "Pain");
			fields[158] = new ims.framework.ReportField(this.context, "_cv_COE.SkinBodyChart.ReviewVO", "BO-1016100004-INFECTIONSUSPECTED", "InfectionSuspected");
			fields[159] = new ims.framework.ReportField(this.context, "_cv_COE.SkinBodyChart.ReviewVO", "BO-1016100004-SWABTAKEN", "SwabTaken");
			fields[160] = new ims.framework.ReportField(this.context, "_cv_COE.SkinBodyChart.ReviewVO", "BO-1016100004-WOUNDTRACED", "WoundTraced");
			fields[161] = new ims.framework.ReportField(this.context, "_cv_COE.SkinBodyChart.ReviewVO", "BO-1016100004-CLEANSEDWITH", "CleansedWith");
			fields[162] = new ims.framework.ReportField(this.context, "_cv_COE.SkinBodyChart.ReviewVO", "BO-1016100004-PRIMARYDRESSING", "PrimaryDressing");
			fields[163] = new ims.framework.ReportField(this.context, "_cv_COE.SkinBodyChart.ReviewVO", "BO-1016100004-SECONDARYDRESSING", "SecondaryDressing");
			fields[164] = new ims.framework.ReportField(this.context, "_cv_COE.SkinBodyChart.ReviewVO", "BO-1016100004-FREQUENCYOFCHANGE", "FrequencyOfChange");
			fields[165] = new ims.framework.ReportField(this.context, "_cv_COE.SkinBodyChart.ReviewVO", "BO-1016100004-COMMENT", "Comment");
			fields[166] = new ims.framework.ReportField(this.context, "_cv_COE.SkinBodyChart.SelectedSkinAssessment", "BO-1003100002-ID", "ID_Assessment");
			fields[167] = new ims.framework.ReportField(this.context, "_cv_COE.SkinBodyChart.SelectedSkinAssessment", "BO-1003100002-DATETIMEINITIATED", "DateTimeInitiated");
			fields[168] = new ims.framework.ReportField(this.context, "_cv_COE.SkinBodyChart.SelectedSkinAssessment", "BO-1003100002-CLINICALCONTACT", "ClinicalContact");
			fields[169] = new ims.framework.ReportField(this.context, "_cv_COE.SkinBodyChart.SelectedSkinAssessment", "BO-1003100002-CARECONTEXT", "CareContext");
			fields[170] = new ims.framework.ReportField(this.context, "_cv_COE.SkinBodyChart.SelectedSkinAssessment", "BO-1016100003-ISSKININTACT", "IsSkinIntact");
			fields[171] = new ims.framework.ReportField(this.context, "_cv_COE.SkinBodyChart.FindingsVO", "BO-1016100005-ID", "ID_SkinAssessmentFindings");
			fields[172] = new ims.framework.ReportField(this.context, "_cv_COE.SkinBodyChart.FindingsVO", "BO-1016100005-WOUNDTYPE", "WoundType");
			fields[173] = new ims.framework.ReportField(this.context, "_cv_COE.SkinBodyChart.FindingsVO", "BO-1016100005-SITEIMAGE", "SiteImage");
			fields[174] = new ims.framework.ReportField(this.context, "_cv_COE.SkinBodyChart.FindingsVO", "BO-1016100005-SITENAME", "SiteName");
			fields[175] = new ims.framework.ReportField(this.context, "_cv_COE.SkinBodyChart.FindingsVO", "BO-1016100005-SITEDETAILS", "SiteDetails");
			fields[176] = new ims.framework.ReportField(this.context, "_cv_COE.SkinBodyChart.FindingsVO", "BO-1016100005-HOWLONGISITPRESENT", "HowLongIsItPresent");
			fields[177] = new ims.framework.ReportField(this.context, "_cv_COE.SkinBodyChart.FindingsVO", "BO-1016100005-PRESSURESOREGRADE", "PressureSoreGrade");
			fields[178] = new ims.framework.ReportField(this.context, "_cv_COE.SkinBodyChart.FindingsVO", "BO-1016100005-LENGTH", "Length");
			fields[179] = new ims.framework.ReportField(this.context, "_cv_COE.SkinBodyChart.FindingsVO", "BO-1016100005-WIDTH", "Width");
			fields[180] = new ims.framework.ReportField(this.context, "_cv_COE.SkinBodyChart.FindingsVO", "BO-1016100005-DEPTH", "Depth");
			fields[181] = new ims.framework.ReportField(this.context, "_cv_COE.SkinBodyChart.FindingsVO", "BO-1016100005-WOUNDBED", "WoundBed");
			fields[182] = new ims.framework.ReportField(this.context, "_cv_COE.SkinBodyChart.FindingsVO", "BO-1016100005-SURROUNDINGSKIN", "SurroundingSkin");
			fields[183] = new ims.framework.ReportField(this.context, "_cv_COE.SkinBodyChart.FindingsVO", "BO-1016100005-EXUDATEAMOUNT", "ExudateAmount");
			fields[184] = new ims.framework.ReportField(this.context, "_cv_COE.SkinBodyChart.FindingsVO", "BO-1016100005-EXUDATETYPE", "ExudateType");
			fields[185] = new ims.framework.ReportField(this.context, "_cv_COE.SkinBodyChart.FindingsVO", "BO-1016100005-ODOUR", "Odour");
			fields[186] = new ims.framework.ReportField(this.context, "_cv_COE.SkinBodyChart.FindingsVO", "BO-1016100005-PAIN", "Pain");
			fields[187] = new ims.framework.ReportField(this.context, "_cv_COE.SkinBodyChart.FindingsVO", "BO-1016100005-INFECTIONSUSPECTED", "InfectionSuspected");
			fields[188] = new ims.framework.ReportField(this.context, "_cv_COE.SkinBodyChart.FindingsVO", "BO-1016100005-SWABTAKEN", "SwabTaken");
			fields[189] = new ims.framework.ReportField(this.context, "_cv_COE.SkinBodyChart.FindingsVO", "BO-1016100005-WOUNDTRACED", "WoundTraced");
			fields[190] = new ims.framework.ReportField(this.context, "_cv_COE.SkinBodyChart.FindingsVO", "BO-1016100005-CLEANSEDWITH", "CleansedWith");
			fields[191] = new ims.framework.ReportField(this.context, "_cv_COE.SkinBodyChart.FindingsVO", "BO-1016100005-PRIMARYDRESSING", "PrimaryDressing");
			fields[192] = new ims.framework.ReportField(this.context, "_cv_COE.SkinBodyChart.FindingsVO", "BO-1016100005-SECONDARYDRESSING", "SecondaryDressing");
			fields[193] = new ims.framework.ReportField(this.context, "_cv_COE.SkinBodyChart.FindingsVO", "BO-1016100005-FREQUENCYOFCHANGE", "FrequencyOfChange");
			fields[194] = new ims.framework.ReportField(this.context, "_cv_COE.SkinBodyChart.FindingsVO", "BO-1016100005-COMMENT", "Comment");
			fields[195] = new ims.framework.ReportField(this.context, "_cv_COE.SkinBodyChart.FindingsVO", "BO-1016100005-ISDISCONTINUEDASSESS", "IsDiscontinuedAssess");
			fields[196] = new ims.framework.ReportField(this.context, "_cv_COE.SkinBodyChart.FindingsVO", "BO-1016100005-ISCONTINUEDASSESSMENT", "IsContinuedAssessment");
			return fields;
		}
