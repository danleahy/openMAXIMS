...
public class GenForm extends FormBridge
{
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[154] = new ims.framework.ReportField(this.context, "_cv_COE.CarePlanEvaluation", "BO-1010100004-ID", "ID_CarePlanEvaluationNote");
			fields[155] = new ims.framework.ReportField(this.context, "_cv_COE.CarePlanEvaluation", "BO-1010100004-RECORDEDDATETIME", "RecordedDateTime");
			fields[156] = new ims.framework.ReportField(this.context, "_cv_COE.CarePlanEvaluation", "BO-1010100004-NOTE", "Note");
			fields[157] = new ims.framework.ReportField(this.context, "_cv_COE.CarePlanEvaluation", "BO-1010100004-CORRECTIONDATETIME", "CorrectionDateTime");
			fields[158] = new ims.framework.ReportField(this.context, "_cv_COE.CarePlanEvaluation", "BO-1010100004-CORRECTIONREASON", "CorrectionReason");
			fields[159] = new ims.framework.ReportField(this.context, "_cv_COE.CarePlanEvaluation", "BO-1010100004-ACTIVE", "Active");
			fields[160] = new ims.framework.ReportField(this.context, "_cv_COE.CarePlanEvaluation", "BO-1010100004-CONFIRMEDBY", "ConfirmedBy");
			fields[161] = new ims.framework.ReportField(this.context, "_cv_COE.CarePlanEvaluation", "BO-1010100004-CONFIRMEDDATETIME", "ConfirmedDateTime");
			fields[162] = new ims.framework.ReportField(this.context, "_cv_COE.CarePlanEvaluation", "BO-1010100004-CAREPLAN", "CarePlan");
			fields[163] = new ims.framework.ReportField(this.context, "_cv_Core.Hospital", "BO-1007100007-ID", "ID_Location");
			fields[164] = new ims.framework.ReportField(this.context, "_cv_Core.Hospital", "BO-1007100007-NAME", "Name");
			fields[165] = new ims.framework.ReportField(this.context, "_cv_Core.Hospital", "BO-1007100007-ISACTIVE", "IsActive");
			fields[166] = new ims.framework.ReportField(this.context, "_cv_Core.Hospital", "BO-1007100007-ISVIRTUAL", "IsVirtual");
			fields[167] = new ims.framework.ReportField(this.context, "_cv_Core.Hospital", "BO-1007100007-TYPE", "Type");
			fields[168] = new ims.framework.ReportField(this.context, "_cv_Core.Hospital", "BO-1007100007-DISPLAYINEDTRACKING", "DisplayInEDTracking");
			fields[169] = new ims.framework.ReportField(this.context, "_cv_Core.Hospital", "BO-1007100007-CASENOTEFOLDERLOCATION", "CaseNoteFolderLocation");
			fields[170] = new ims.framework.ReportField(this.context, "_cv_Core.Hospital", "BO-1007100007-SECUREACCOMMODATION", "SecureAccommodation");
			fields[171] = new ims.framework.ReportField(this.context, "_cv_Core.Hospital", "BO-1007100007-TREATINGHOSP", "TreatingHosp");
			fields[172] = new ims.framework.ReportField(this.context, "_cv_Core.Hospital", "BO-1007100007-REFERRINGHOSPITAL", "ReferringHospital");
			fields[173] = new ims.framework.ReportField(this.context, "_cv_Core.Ward", "BO-1007100007-ID", "ID_Location");
			fields[174] = new ims.framework.ReportField(this.context, "_cv_Core.Ward", "BO-1007100007-NAME", "Name");
			fields[175] = new ims.framework.ReportField(this.context, "_cv_Core.Ward", "BO-1007100007-ISACTIVE", "IsActive");
			fields[176] = new ims.framework.ReportField(this.context, "_cv_Core.Ward", "BO-1007100007-ISVIRTUAL", "IsVirtual");
			fields[177] = new ims.framework.ReportField(this.context, "_cv_Core.Ward", "BO-1007100007-TYPE", "Type");
			fields[178] = new ims.framework.ReportField(this.context, "_cv_Core.Ward", "BO-1007100007-DISPLAYINEDTRACKING", "DisplayInEDTracking");
			fields[179] = new ims.framework.ReportField(this.context, "_cv_Core.Ward", "BO-1007100007-CASENOTEFOLDERLOCATION", "CaseNoteFolderLocation");
			fields[180] = new ims.framework.ReportField(this.context, "_cv_Core.Ward", "BO-1007100007-SECUREACCOMMODATION", "SecureAccommodation");
			fields[181] = new ims.framework.ReportField(this.context, "_cv_Core.Ward", "BO-1007100007-TREATINGHOSP", "TreatingHosp");
			fields[182] = new ims.framework.ReportField(this.context, "_cv_Core.Ward", "BO-1007100007-REFERRINGHOSPITAL", "ReferringHospital");
			fields[183] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.CarePlanDetails.__internal_x_context__CarePlan_" + componentIdentifier, "BO-1010100003-ID", "ID_CarePlan");
			fields[184] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.CarePlanDetails.__internal_x_context__CarePlan_" + componentIdentifier, "BO-1010100003-TITLE", "Title");
			fields[185] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.CarePlanDetails.__internal_x_context__CarePlan_" + componentIdentifier, "BO-1010100003-OBJECTIVE", "Objective");
			fields[186] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.CarePlanDetails.__internal_x_context__CarePlan_" + componentIdentifier, "BO-1010100003-NEXTEVALUATIONDATE", "NextEvaluationDate");
			fields[187] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.CarePlanDetails.__internal_x_context__CarePlan_" + componentIdentifier, "BO-1010100003-LASTREVIEWEDDATE", "LastReviewedDate");
			fields[188] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.CarePlanDetails.__internal_x_context__CarePlan_" + componentIdentifier, "BO-1010100003-LASTREVIEWEDBY", "LastReviewedBy");
			fields[189] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.CarePlanDetails.__internal_x_context__CarePlan_" + componentIdentifier, "BO-1010100003-CONFIRMEDBY", "ConfirmedBy");
			fields[190] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.CarePlanDetails.__internal_x_context__CarePlan_" + componentIdentifier, "BO-1010100003-CONFIRMEDDATETIME", "ConfirmedDateTime");
			fields[191] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.CarePlanDetails.__internal_x_context__CarePlan_" + componentIdentifier, "BO-1010100003-CLINICALCONTACT", "ClinicalContact");
			fields[192] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.CarePlanDetails.__internal_x_context__CarePlan_" + componentIdentifier, "BO-1010100003-CARECONTEXT", "CareContext");
			return fields;
		}
