...
public class GenForm extends FormBridge
{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		contextMenus.contextMenuAdmissionSummaryMenuVIEWDIAGNOSISItem = factory.createMenuItem(startControlID.intValue() + 12, "View Diagnosis", true, false, new Integer(102223), true, false);
		contextMenus.contextMenuAdmissionSummaryMenu.add(contextMenus.contextMenuAdmissionSummaryMenuVIEWDIAGNOSISItem);
		contextMenus.contextMenuAdmissionSummaryMenuVIEWPROCEDUREItem = factory.createMenuItem(startControlID.intValue() + 13, "View Procedure", true, false, new Integer(102223), true, false);
		contextMenus.contextMenuAdmissionSummaryMenu.add(contextMenus.contextMenuAdmissionSummaryMenuVIEWPROCEDUREItem);
		contextMenus.contextMenuAdmissionSummaryMenuNEWDIAGNOSISItem = factory.createMenuItem(startControlID.intValue() + 14, "New Diagnosis", true, false, new Integer(102149), true, false);
		contextMenus.contextMenuAdmissionSummaryMenu.add(contextMenus.contextMenuAdmissionSummaryMenuNEWDIAGNOSISItem);
		contextMenus.contextMenuAdmissionSummaryMenuNEWPROCEDUREItem = factory.createMenuItem(startControlID.intValue() + 15, "New Procedure", true, false, new Integer(102149), true, false);
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1013), new Integer(anchoringHelper13.getX()), new Integer(anchoringHelper13.getY()), new Integer(anchoringHelper13.getWidth()), new Integer(anchoringHelper13.getHeight()), new Integer(startTabIndex.intValue() + 14), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "New", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1014), new Integer(anchoringHelper14.getX()), new Integer(anchoringHelper14.getY()), new Integer(anchoringHelper14.getWidth()), new Integer(anchoringHelper14.getHeight()), new Integer(startTabIndex.intValue() + 15), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Edit", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
	...
	public final class ContextMenus implements java.io.Serializable
	{
		...
		{
			private static final long serialVersionUID = 1L;
			public static final int VIEWDIAGNOSIS = 12;
			public static final int VIEWPROCEDURE = 13;
			public static final int NEWDIAGNOSIS = 14;
			public static final int NEWPROCEDURE = 15;
		}
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedPatientProcedureFromNursingAdmission", "BO-1003100017-ID", "ID_PatientProcedure");
			fields[145] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedPatientDiagnosisFromNursingAdmission", "BO-1003100016-ID", "ID_PatientDiagnosis");
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.NursingAdmission.__internal_x_context__voAdmissionDetails_" + componentIdentifier, "BO-1009100010-ID", "ID_AdmissionDetails");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.NursingAdmission.__internal_x_context__voAdmissionDetails_" + componentIdentifier, "BO-1009100010-CARECONTEXT", "CareContext");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.NursingAdmission.__internal_x_context__voAdmissionDetails_" + componentIdentifier, "BO-1009100010-CLINICALCONTACT", "ClinicalContact");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.NursingAdmission.__internal_x_context__voAdmissionDetails_" + componentIdentifier, "BO-1009100010-PATIENTADMREASON", "PatientAdmReason");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.NursingAdmission.__internal_x_context__voAdmissionDetails_" + componentIdentifier, "BO-1009100010-NURSINGADMREASON", "NursingAdmReason");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.NursingAdmission.__internal_x_context__voAdmissionDetails_" + componentIdentifier, "BO-1009100010-RESUSSTATUS", "ResusStatus");
			fields[152] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.NursingAdmission.__internal_x_context__voAdmissionDetails_" + componentIdentifier, "BO-1009100010-ISDNRFORMCOMPLETED", "IsDnrFormCompleted");
			fields[153] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.NursingAdmission.__internal_x_context__voAdmissionDetails_" + componentIdentifier, "BO-1009100010-WASDIAGNOSISDISCUSSED", "WasDiagnosisDiscussed");
			fields[154] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.NursingAdmission.__internal_x_context__voAdmissionDetails_" + componentIdentifier, "BO-1009100010-COMMUNICATIONNEEDS", "CommunicationNeeds");
			fields[155] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.NursingAdmission.__internal_x_context__voAdmissionDetails_" + componentIdentifier, "BO-1009100010-PREFERREDLANG", "PreferredLang");
			fields[156] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.NursingAdmission.__internal_x_context__voFamilySupport_" + componentIdentifier, "BO-1003100005-ID", "ID_SupportNetworkFamily");
			fields[157] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.NursingAdmission.__internal_x_context__voFamilySupport_" + componentIdentifier, "BO-1003100005-CARERNAME", "CarerName");
			fields[158] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.NursingAdmission.__internal_x_context__voFamilySupport_" + componentIdentifier, "BO-1003100005-CARERRELATIONSHIP", "CarerRelationship");
			fields[159] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.NursingAdmission.__internal_x_context__voFamilySupport_" + componentIdentifier, "BO-1003100005-CARERADDRESS", "CarerAddress");
			fields[160] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.NursingAdmission.__internal_x_context__voFamilySupport_" + componentIdentifier, "BO-1003100005-CARERHOMEPHONE", "CarerHomePhone");
			fields[161] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.NursingAdmission.__internal_x_context__voFamilySupport_" + componentIdentifier, "BO-1003100005-CARERMOBILEPHONE", "CarerMobilePhone");
			fields[162] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.NursingAdmission.__internal_x_context__voFamilySupport_" + componentIdentifier, "BO-1003100005-CARERWORKPHONE", "CarerWorkPhone");
			fields[163] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.NursingAdmission.__internal_x_context__voFamilySupport_" + componentIdentifier, "BO-1003100005-CAREREMAIL", "CarerEmail");
			fields[164] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.NursingAdmission.__internal_x_context__voFamilySupport_" + componentIdentifier, "BO-1003100005-ISMAINCARER", "IsMainCarer");
			fields[165] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.NursingAdmission.__internal_x_context__voFamilySupport_" + componentIdentifier, "BO-1003100005-EMERGENCYCONTACTORDER", "EmergencyContactOrder");
			fields[166] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.NursingAdmission.__internal_x_context__voFamilySupport_" + componentIdentifier, "BO-1003100005-ISCURRENTLYACTIVEFAMILYSUPPORT", "IsCurrentlyActiveFamilySupport");
			fields[167] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.NursingAdmission.__internal_x_context__voFamilySupport_" + componentIdentifier, "BO-1003100005-DISCUSSPROGRESS", "DiscussProgress");
			fields[168] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.NursingAdmission.__internal_x_context__voFamilySupport_" + componentIdentifier, "BO-1003100005-PATIENT", "Patient");
			fields[169] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.NursingAdmission.__internal_x_context__voFamilySupport_" + componentIdentifier, "BO-1003100005-FITANDWELL", "FitAndWell");
			fields[170] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.NursingAdmission.__internal_x_context__voFamilySupport_" + componentIdentifier, "BO-1003100005-AWARECLIENTPOSITION", "AwareClientPosition");
			fields[171] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.NursingAdmission.__internal_x_context__voFamilySupport_" + componentIdentifier, "BO-1003100005-PERMISSIONTOCONTACT", "PermissionToContact");
			fields[172] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.NursingAdmission.__internal_x_context__voFamilySupport_" + componentIdentifier, "BO-1003100005-INACTIVATINGDATETIME", "InactivatingDateTime");
			return fields;
		}
