...
public class GenForm extends FormBridge
{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1019), new Integer(anchoringHelper19.getX()), new Integer(anchoringHelper19.getY()), new Integer(anchoringHelper19.getWidth()), new Integer(anchoringHelper19.getHeight()), new Integer(startTabIndex.intValue() + 12), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Edit", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.RepositioningPlan.__internal_x_context__RepositioningPlan_" + componentIdentifier, "BO-1009100006-ID", "ID_RepositioningPlan");
			fields[145] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.RepositioningPlan.__internal_x_context__RepositioningPlan_" + componentIdentifier, "BO-1009100006-CLINICALCONTACT", "ClinicalContact");
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.RepositioningPlan.__internal_x_context__RepositioningPlan_" + componentIdentifier, "BO-1009100006-CARECONTEXT", "CareContext");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.RepositioningPlan.__internal_x_context__RepositioningPlan_" + componentIdentifier, "BO-1009100006-POSITIONINGFREQ", "PositioningFreq");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.RepositioningPlan.__internal_x_context__RepositioningPlan_" + componentIdentifier, "BO-1009100006-SKINTOLERANCETEST", "SkinToleranceTest");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.RepositioningPlan.__internal_x_context__RepositioningPlan_" + componentIdentifier, "BO-1009100006-BLANCHING", "Blanching");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.RepositioningPlan.__internal_x_context__RepositioningPlan_" + componentIdentifier, "BO-1009100006-POSITIONINGSUITABLE", "PositioningSuitable");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.RepositioningPlan.__internal_x_context__RepositioningPlan_" + componentIdentifier, "BO-1009100006-COMMENT", "Comment");
			fields[152] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.RepositioningPlan.__internal_x_context__previousRepositioningPlan_" + componentIdentifier, "BO-1009100006-ID", "ID_RepositioningPlan");
			fields[153] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.RepositioningPlan.__internal_x_context__previousRepositioningPlan_" + componentIdentifier, "BO-1009100006-CLINICALCONTACT", "ClinicalContact");
			fields[154] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.RepositioningPlan.__internal_x_context__previousRepositioningPlan_" + componentIdentifier, "BO-1009100006-CARECONTEXT", "CareContext");
			fields[155] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.RepositioningPlan.__internal_x_context__previousRepositioningPlan_" + componentIdentifier, "BO-1009100006-POSITIONINGFREQ", "PositioningFreq");
			fields[156] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.RepositioningPlan.__internal_x_context__previousRepositioningPlan_" + componentIdentifier, "BO-1009100006-SKINTOLERANCETEST", "SkinToleranceTest");
			fields[157] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.RepositioningPlan.__internal_x_context__previousRepositioningPlan_" + componentIdentifier, "BO-1009100006-BLANCHING", "Blanching");
			fields[158] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.RepositioningPlan.__internal_x_context__previousRepositioningPlan_" + componentIdentifier, "BO-1009100006-POSITIONINGSUITABLE", "PositioningSuitable");
			fields[159] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.RepositioningPlan.__internal_x_context__previousRepositioningPlan_" + componentIdentifier, "BO-1009100006-COMMENT", "Comment");
			return fields;
		}
