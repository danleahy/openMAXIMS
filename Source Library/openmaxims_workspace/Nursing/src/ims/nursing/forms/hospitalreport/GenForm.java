...
public class GenForm extends FormBridge
{
	...
	private void validateContext(ims.framework.Context context)
	{
		if(context == null)
			return;
		if(!context.isValidContextType(ims.nursing.vo.HospitalReportSearchCriteriaVo.class))
			throw new ims.framework.exceptions.CodingRuntimeException("The type 'ims.nursing.vo.HospitalReportSearchCriteriaVo' of the global context variable 'Nursing.HospitalReportSearchCriteria' is not supported.");
	}
