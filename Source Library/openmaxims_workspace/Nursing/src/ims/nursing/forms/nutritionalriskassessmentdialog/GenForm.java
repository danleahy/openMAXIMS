...
public class GenForm extends FormBridge
{
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, "_cv_Nursing.NutritionalRiskRecord", "BO-1003100002-ID", "ID_Assessment");
			fields[145] = new ims.framework.ReportField(this.context, "_cv_Nursing.NutritionalRiskRecord", "BO-1003100002-DATETIMEINITIATED", "DateTimeInitiated");
			fields[146] = new ims.framework.ReportField(this.context, "_cv_Nursing.NutritionalRiskRecord", "BO-1003100002-CLINICALCONTACT", "ClinicalContact");
			fields[147] = new ims.framework.ReportField(this.context, "_cv_Nursing.NutritionalRiskRecord", "BO-1003100002-CARECONTEXT", "CareContext");
			...
			fields[159] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.NutritionalRiskAssessmentDialog.__internal_x_context__Hcp_" + componentIdentifier, "BO-1006100000-ID", "ID_Hcp");
			fields[160] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.NutritionalRiskAssessmentDialog.__internal_x_context__Hcp_" + componentIdentifier, "BO-1006100000-HCPTYPE", "HcpType");
			fields[161] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.NutritionalRiskAssessmentDialog.__internal_x_context__Hcp_" + componentIdentifier, "BO-1006100000-ISACTIVE", "IsActive");
			fields[162] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.NutritionalRiskAssessmentDialog.__internal_x_context__Hcp_" + componentIdentifier, "BO-1006100000-ISHCPARESPONSIBLEHCP", "IsHCPaResponsibleHCP");
			fields[163] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.NutritionalRiskAssessmentDialog.__internal_x_context__Hcp_" + componentIdentifier, "BO-1006100000-ISARESPONSIBLEEDCLINICIAN", "IsAResponsibleEDClinician");
			fields[164] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.NutritionalRiskAssessmentDialog.__internal_x_context__Hcp_" + componentIdentifier, "BO-1006100000-ISHCPAENDOSCOPIST", "IsHCPaEndoscopist");
			return fields;
		}
