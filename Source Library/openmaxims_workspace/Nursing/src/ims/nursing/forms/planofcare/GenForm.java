...
public class GenForm extends FormBridge
{
	...
	public static class lyrPOCLayer extends Layer
	{
		...
		public static class tabPocDetailsContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				ims.framework.FormUiLogic m_customConfirmingForm = loader.loadComponent(102228, appForm, startControlID * 10 + 1000, anchoringHelper4.getSize(), instance1, startTabIndex.intValue() + 14, skipContextValidation);
				//ims.framework.Control m_customConfirmingControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1003), new Integer(418), new Integer(136), new Integer(392), new Integer(64), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, new Integer(startTabIndex.intValue() + 14), m_customConfirmingForm, instance1 } );
				ims.framework.Control m_customConfirmingControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1004),  new Integer(anchoringHelper4.getX()), new Integer(anchoringHelper4.getY()), new Integer(anchoringHelper4.getWidth()), new Integer(anchoringHelper4.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, new Integer(startTabIndex.intValue() + 14), m_customConfirmingForm, instance1, Boolean.FALSE } );
				...
				ims.framework.FormUiLogic m_customResolvedForm = loader.loadComponent(102228, appForm, startControlID * 10 + 2000, anchoringHelper5.getSize(), instance2, startTabIndex.intValue() + 10, skipContextValidation);
				//ims.framework.Control m_customResolvedControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1005), new Integer(8), new Integer(136), new Integer(392), new Integer(64), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, new Integer(startTabIndex.intValue() + 10), m_customResolvedForm, instance2 } );
				ims.framework.Control m_customResolvedControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1006),  new Integer(anchoringHelper5.getX()), new Integer(anchoringHelper5.getY()), new Integer(anchoringHelper5.getWidth()), new Integer(anchoringHelper5.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, new Integer(startTabIndex.intValue() + 10), m_customResolvedForm, instance2, Boolean.FALSE } );
				...
				ims.framework.FormUiLogic m_customStartForm = loader.loadComponent(102228, appForm, startControlID * 10 + 3000, anchoringHelper6.getSize(), instance3, startTabIndex.intValue() + 3, skipContextValidation);
				//ims.framework.Control m_customStartControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1007), new Integer(8), new Integer(0), new Integer(392), new Integer(64), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, new Integer(startTabIndex.intValue() + 3), m_customStartForm, instance3 } );
				...
				ComboBox m_cmbGroupTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1017), new Integer(anchoringHelper15.getX()), new Integer(anchoringHelper15.getY()), new Integer(anchoringHelper15.getWidth()), new Integer(anchoringHelper15.getHeight()), new Integer(startTabIndex.intValue() + 7), ControlState.DISABLED, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
	...
	private void validateContext(ims.framework.Context context)
	{
		...
		if(!context.isValidContextType(ims.nursing.vo.PlanOfCareSearchCriteriaVo.class))
			throw new ims.framework.exceptions.CodingRuntimeException("The type 'ims.nursing.vo.PlanOfCareSearchCriteriaVo' of the global context variable 'Nursing.PlanOfCareSearchCriteria' is not supported.");
	}
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1027), new Integer(anchoringHelper25.getX()), new Integer(anchoringHelper25.getY()), new Integer(anchoringHelper25.getWidth()), new Integer(anchoringHelper25.getHeight()), new Integer(startTabIndex.intValue() + 19), ControlState.HIDDEN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Save", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.PlanOfCare.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1009100002-ID", "ID_PlanOfCare");
			fields[145] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.PlanOfCare.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1009100002-GROUP", "Group");
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.PlanOfCare.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1009100002-TITLE", "Title");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.PlanOfCare.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1009100002-STARTDATETIME", "StartDateTime");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.PlanOfCare.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1009100002-RESOLVEDDATETIME", "ResolvedDateTime");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.PlanOfCare.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1009100002-LEVELOFINTERVENTION", "LevelOfIntervention");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.PlanOfCare.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1009100002-CLINICALCONTACT", "ClinicalContact");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.PlanOfCare.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1009100002-CARECONTEXT", "CareContext");
			fields[152] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.PlanOfCare.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1009100002-STATUS", "Status");
			fields[153] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.PlanOfCare.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1009100002-CONFIRMINGDATETIME", "ConfirmingDateTime");
			return fields;
		}
