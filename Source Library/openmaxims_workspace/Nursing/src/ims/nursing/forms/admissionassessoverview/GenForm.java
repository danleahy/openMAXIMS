...
public class GenForm extends FormBridge
{
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[155] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.AdmissionAssessOverview.__internal_x_context__assmnt_" + componentIdentifier, "BO-1003100002-ID", "ID_Assessment");
			fields[156] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.AdmissionAssessOverview.__internal_x_context__assmnt_" + componentIdentifier, "BO-1003100002-DATETIMEINITIATED", "DateTimeInitiated");
			fields[157] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.AdmissionAssessOverview.__internal_x_context__assmnt_" + componentIdentifier, "BO-1003100002-CLINICALCONTACT", "ClinicalContact");
			fields[158] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.AdmissionAssessOverview.__internal_x_context__assmnt_" + componentIdentifier, "BO-1003100002-CARECONTEXT", "CareContext");
			fields[159] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.AdmissionAssessOverview.__internal_x_context__assmnt_" + componentIdentifier, "BO-1015100000-ASSESSMENTTYPE", "AssessmentType");
			fields[160] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.AdmissionAssessOverview.__internal_x_context__assmnt_" + componentIdentifier, "BO-1015100000-ASSESSMENTSTATUS", "AssessmentStatus");
			fields[161] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.AdmissionAssessOverview.__internal_x_context__assmnt_" + componentIdentifier, "BO-1015100000-DATETIMECOMPLETE", "DateTimeComplete");
			return fields;
		}
