...
public class GenForm extends FormBridge
{
	...
	private void validateContext(ims.framework.Context context)
	{
		...
		if(!context.isValidContextType(ims.nursing.vo.PainReviewSearchCriteriaVo.class))
			throw new ims.framework.exceptions.CodingRuntimeException("The type 'ims.nursing.vo.PainReviewSearchCriteriaVo' of the global context variable 'Nursing.PainReviewSearchCriteria' is not supported.");
	}
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[153] = new ims.framework.ReportField(this.context, "_cv_COE.PainBodyChart.ReadOnlyAssessment", "BO-1003100002-ID", "ID_Assessment");
			fields[154] = new ims.framework.ReportField(this.context, "_cv_COE.PainBodyChart.ReadOnlyAssessment", "BO-1003100002-DATETIMEINITIATED", "DateTimeInitiated");
			fields[155] = new ims.framework.ReportField(this.context, "_cv_COE.PainBodyChart.ReadOnlyAssessment", "BO-1003100002-CLINICALCONTACT", "ClinicalContact");
			fields[156] = new ims.framework.ReportField(this.context, "_cv_COE.PainBodyChart.ReadOnlyAssessment", "BO-1003100002-CARECONTEXT", "CareContext");
			fields[157] = new ims.framework.ReportField(this.context, "_cv_COE.PainBodyChart.ReadOnlyAssessment", "BO-1016100000-ASSESSMENTDATETIME", "AssessmentDateTime");
			fields[158] = new ims.framework.ReportField(this.context, "_cv_COE.PainBodyChart.AssessmentFinding", "BO-1016100002-ID", "ID_PainAssessmentFindings");
			fields[159] = new ims.framework.ReportField(this.context, "_cv_COE.PainBodyChart.AssessmentFinding", "BO-1016100002-SITEIMAGE", "SiteImage");
			fields[160] = new ims.framework.ReportField(this.context, "_cv_COE.PainBodyChart.AssessmentFinding", "BO-1016100002-SITENAME", "SiteName");
			fields[161] = new ims.framework.ReportField(this.context, "_cv_COE.PainBodyChart.AssessmentFinding", "BO-1016100002-PAINHYPERSENSITIVITY", "PainHypersensitivity");
			fields[162] = new ims.framework.ReportField(this.context, "_cv_COE.PainBodyChart.AssessmentFinding", "BO-1016100002-ISDISCONTINUEDASSESS", "IsDiscontinuedAssess");
			fields[163] = new ims.framework.ReportField(this.context, "_cv_COE.PainBodyChart.AssessmentFinding", "BO-1016100002-ISCONTINUEDASSESSMENT", "IsContinuedAssessment");
			fields[164] = new ims.framework.ReportField(this.context, "_cv_COE.PainBodyChart.AssessmentFinding", "BO-1016100002-SITEDETAILS", "SiteDetails");
			fields[165] = new ims.framework.ReportField(this.context, "_cv_COE.PainBodyChart.AssessmentFinding", "BO-1016100002-TYPE", "Type");
			fields[166] = new ims.framework.ReportField(this.context, "_cv_COE.PainBodyChart.AssessmentFinding", "BO-1016100002-SEVERITY", "Severity");
			fields[167] = new ims.framework.ReportField(this.context, "_cv_COE.PainBodyChart.AssessmentFinding", "BO-1016100002-ONSET", "Onset");
			fields[168] = new ims.framework.ReportField(this.context, "_cv_COE.PainBodyChart.AssessmentFinding", "BO-1016100002-PROGRESSION", "Progression");
			fields[169] = new ims.framework.ReportField(this.context, "_cv_COE.PainBodyChart.AssessmentFinding", "BO-1016100002-DEPTH", "Depth");
			fields[170] = new ims.framework.ReportField(this.context, "_cv_COE.PainBodyChart.PainAssessmentVO", "BO-1003100002-ID", "ID_Assessment");
			fields[171] = new ims.framework.ReportField(this.context, "_cv_COE.PainBodyChart.PainAssessmentVO", "BO-1003100002-DATETIMEINITIATED", "DateTimeInitiated");
			fields[172] = new ims.framework.ReportField(this.context, "_cv_COE.PainBodyChart.PainAssessmentVO", "BO-1003100002-CLINICALCONTACT", "ClinicalContact");
			fields[173] = new ims.framework.ReportField(this.context, "_cv_COE.PainBodyChart.PainAssessmentVO", "BO-1003100002-CARECONTEXT", "CareContext");
			fields[174] = new ims.framework.ReportField(this.context, "_cv_COE.PainBodyChart.PainAssessmentVO", "BO-1016100000-ASSESSMENTDATETIME", "AssessmentDateTime");
			fields[175] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.PainReview.__internal_x_context__PainAssessment_" + componentIdentifier, "BO-1003100002-ID", "ID_Assessment");
			fields[176] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.PainReview.__internal_x_context__PainAssessment_" + componentIdentifier, "BO-1003100002-DATETIMEINITIATED", "DateTimeInitiated");
			fields[177] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.PainReview.__internal_x_context__PainAssessment_" + componentIdentifier, "BO-1003100002-CLINICALCONTACT", "ClinicalContact");
			fields[178] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.PainReview.__internal_x_context__PainAssessment_" + componentIdentifier, "BO-1003100002-CARECONTEXT", "CareContext");
			fields[179] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.PainReview.__internal_x_context__PainAssessment_" + componentIdentifier, "BO-1016100000-ASSESSMENTDATETIME", "AssessmentDateTime");
			return fields;
		}
