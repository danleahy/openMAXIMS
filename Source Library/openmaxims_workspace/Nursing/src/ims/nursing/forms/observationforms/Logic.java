...
import ims.nursing.forms.observationforms.GenForm.groupFilterEnumeration;
...
public class Logic extends BaseLogic
{
	...
	protected void onFormOpen() throws FormOpenException
	{
		...
		//WDEV-19389 
		if (!(form.getGlobalContext().Core.getCurrentCareContextIsNotNull() && form.getGlobalContext().Nursing.getObservationFormsSearchCriteriaIsNotNull() && form.getGlobalContext().Core.getCurrentCareContext().equals(form.getGlobalContext().Nursing.getObservationFormsSearchCriteria().getCareContext())))
		{
			form.getGlobalContext().Nursing.setObservationFormsSearchCriteria(null);
		}
		
		if(form.getGlobalContext().Nursing.getObservationFormsSearchCriteriaIsNotNull())
		{
			setSearchCriteria(form.getGlobalContext().Nursing.getObservationFormsSearchCriteria());
			try
			{
