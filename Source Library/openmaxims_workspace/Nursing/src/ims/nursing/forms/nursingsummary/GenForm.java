...
public class GenForm extends FormBridge
{
	...
	private void validateContext(ims.framework.Context context)
	{
		...
		if(!context.isValidContextType(ims.nursing.vo.NursingSummarySearchCriteriaVo.class))
			throw new ims.framework.exceptions.CodingRuntimeException("The type 'ims.nursing.vo.NursingSummarySearchCriteriaVo' of the global context variable 'Nursing.NursingSummarySearchCriteria' is not supported.");
	}
