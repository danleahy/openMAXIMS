...
public class GenForm extends FormBridge
{
		...
		public static class lyrDetailsLayer extends Layer
		{
			...
			public static class tabDetailsContainer extends LayerBridge
			{
				...
				protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
				{
					...
					super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1008), new Integer(anchoringHelper8.getX()), new Integer(anchoringHelper8.getY()), new Integer(anchoringHelper8.getWidth()), new Integer(anchoringHelper8.getHeight()), new Integer(startTabIndex.intValue() + 14), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Clear", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1020), new Integer(anchoringHelper20.getX()), new Integer(anchoringHelper20.getY()), new Integer(anchoringHelper20.getWidth()), new Integer(anchoringHelper20.getHeight()), new Integer(startTabIndex.intValue() + 11), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Edit", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1021), new Integer(anchoringHelper21.getX()), new Integer(anchoringHelper21.getY()), new Integer(anchoringHelper21.getWidth()), new Integer(anchoringHelper21.getHeight()), new Integer(startTabIndex.intValue() + 10), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "New", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.HandlingMovement.__internal_x_context__SelectedParentInstance_" + componentIdentifier, "BO-1009100016-ID", "ID_PatientHandlingMovement");
			fields[145] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.HandlingMovement.__internal_x_context__SelectedParentInstance_" + componentIdentifier, "BO-1009100016-CARECONTEXT", "CareContext");
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.HandlingMovement.__internal_x_context__SelectedParentInstance_" + componentIdentifier, "BO-1009100016-CLINICALCONTACT", "ClinicalContact");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.HandlingMovement.__internal_x_context__SelectedChildInstance_" + componentIdentifier, "BO-1009100017-ID", "ID_HandlingMovementDetail");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.HandlingMovement.__internal_x_context__SelectedChildInstance_" + componentIdentifier, "BO-1009100017-MOVEMENT", "Movement");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.HandlingMovement.__internal_x_context__SelectedChildInstance_" + componentIdentifier, "BO-1009100017-OTHEREQUIPMENT", "OtherEquipment");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.HandlingMovement.__internal_x_context__SelectedChildInstance_" + componentIdentifier, "BO-1009100017-NOOFSTAFF", "NoOfStaff");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.HandlingMovement.__internal_x_context__SelectedChildInstance_" + componentIdentifier, "BO-1009100017-DETAILS", "Details");
			fields[152] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.HandlingMovement.__internal_x_context__UpdatedChild_" + componentIdentifier, "BO-1009100017-ID", "ID_HandlingMovementDetail");
			fields[153] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.HandlingMovement.__internal_x_context__UpdatedChild_" + componentIdentifier, "BO-1009100017-MOVEMENT", "Movement");
			fields[154] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.HandlingMovement.__internal_x_context__UpdatedChild_" + componentIdentifier, "BO-1009100017-OTHEREQUIPMENT", "OtherEquipment");
			fields[155] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.HandlingMovement.__internal_x_context__UpdatedChild_" + componentIdentifier, "BO-1009100017-NOOFSTAFF", "NoOfStaff");
			fields[156] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.HandlingMovement.__internal_x_context__UpdatedChild_" + componentIdentifier, "BO-1009100017-DETAILS", "Details");
			return fields;
		}
