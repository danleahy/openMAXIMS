...
public class GenForm extends FormBridge
{
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.CopyCarePlans.__internal_x_context__selectedRow_" + componentIdentifier, "BO-1010100003-ID", "ID_CarePlan");
			fields[145] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.CopyCarePlans.__internal_x_context__selectedRow_" + componentIdentifier, "BO-1010100003-TITLE", "Title");
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.CopyCarePlans.__internal_x_context__selectedRow_" + componentIdentifier, "BO-1010100003-NEXTEVALUATIONDATE", "NextEvaluationDate");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.CopyCarePlans.__internal_x_context__selectedRow_" + componentIdentifier, "BO-1010100003-LASTREVIEWEDDATE", "LastReviewedDate");
			return fields;
		}
