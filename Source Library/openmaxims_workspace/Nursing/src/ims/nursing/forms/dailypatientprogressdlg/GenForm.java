...
public class GenForm extends FormBridge
{
	...
	public static class lyrTabsLayer extends Layer
	{
		...
		public static class tabCurrentContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1009), new Integer(anchoringHelper9.getX()), new Integer(anchoringHelper9.getY()), new Integer(anchoringHelper9.getWidth()), new Integer(anchoringHelper9.getHeight()), new Integer(startTabIndex.intValue() + 8), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.FALSE, new Integer(255), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
				...
				ComboBox m_cmbStatusTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1011), new Integer(anchoringHelper11.getX()), new Integer(anchoringHelper11.getY()), new Integer(anchoringHelper11.getWidth()), new Integer(anchoringHelper11.getHeight()), new Integer(startTabIndex.intValue() + 6), ControlState.DISABLED, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,Boolean.TRUE, Boolean.TRUE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
				...
				ComboBox m_cmbStatusReasonTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1012), new Integer(anchoringHelper12.getX()), new Integer(anchoringHelper12.getY()), new Integer(anchoringHelper12.getWidth()), new Integer(anchoringHelper12.getHeight()), new Integer(startTabIndex.intValue() + 7), ControlState.DISABLED, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
				...
				super.addControl(factory.getControl(DynamicGrid.class, new Object[] { control, new Integer(startControlID.intValue() + 1014), new Integer(anchoringHelper14.getX()), new Integer(anchoringHelper14.getY()), new Integer(anchoringHelper14.getWidth()), new Integer(anchoringHelper14.getHeight()), new Integer(startTabIndex.intValue() + 9), ControlState.READONLY, ControlState.EDITABLE, ims.framework.enumerations.ControlAnchoring.ALL, contextMenus.contextMenuDPPQuestions, Boolean.FALSE, Boolean.FALSE, Boolean.TRUE}));
			}
		...
		public static class tabNonApplicableContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1015), new Integer(anchoringHelper15.getX()), new Integer(anchoringHelper15.getY()), new Integer(anchoringHelper15.getWidth()), new Integer(anchoringHelper15.getHeight()), new Integer(startTabIndex.intValue() + 13), ControlState.HIDDEN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Select Questions", Boolean.TRUE, null, Boolean.FALSE, Boolean.FALSE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		public static class tabStandardQuestionContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1018), new Integer(anchoringHelper18.getX()), new Integer(anchoringHelper18.getY()), new Integer(anchoringHelper18.getWidth()), new Integer(anchoringHelper18.getHeight()), new Integer(startTabIndex.intValue() + 16), ControlState.HIDDEN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Select Questions", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
				...
				super.addControl(factory.getControl(DynamicGrid.class, new Object[] { control, new Integer(startControlID.intValue() + 1020), new Integer(anchoringHelper20.getX()), new Integer(anchoringHelper20.getY()), new Integer(anchoringHelper20.getWidth()), new Integer(anchoringHelper20.getHeight()), new Integer(startTabIndex.intValue() + 15), ControlState.READONLY, ControlState.EDITABLE, ims.framework.enumerations.ControlAnchoring.ALL, null, Boolean.FALSE, Boolean.FALSE, Boolean.TRUE}));
			}
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, "_cv_Nursing.UserAssessmentDPP", "BO-1003100043-ID", "ID_UserAssessment");
			fields[145] = new ims.framework.ReportField(this.context, "_cv_Nursing.UserAssessmentDPP", "BO-1003100043-NAME", "Name");
			fields[146] = new ims.framework.ReportField(this.context, "_cv_Nursing.UserAssessmentDPP", "BO-1003100043-DESCRIPTION", "Description");
			fields[147] = new ims.framework.ReportField(this.context, "_cv_Nursing.UserAssessmentDPP", "BO-1003100043-ASSESSMENTTYPE", "AssessmentType");
			fields[148] = new ims.framework.ReportField(this.context, "_cv_Nursing.UserAssessmentDPP", "BO-1003100043-ACTIVESTATUS", "ActiveStatus");
			fields[149] = new ims.framework.ReportField(this.context, "_cv_Nursing.UserAssessmentDPP", "BO-1003100043-HELPURL", "HelpURL");
			fields[150] = new ims.framework.ReportField(this.context, "_cv_Nursing.UserAssessmentDPP", "BO-1003100043-SCORINGMETHOD", "ScoringMethod");
			fields[151] = new ims.framework.ReportField(this.context, "_cv_Nursing.UserAssessmentDPP", "BO-1003100043-ISFLATVIEW", "IsFlatView");
			fields[152] = new ims.framework.ReportField(this.context, "_cv_Nursing.UserAssessmentDPP", "BO-1003100043-CATEGORY", "Category");
			fields[153] = new ims.framework.ReportField(this.context, "_cv_Nursing.UserAssessmentDPP", "BO-1003100043-ISMULTIPLEGROUP", "IsMultipleGroup");
			fields[154] = new ims.framework.ReportField(this.context, "_cv_Nursing.UserAssessmentDPP", "BO-1003100043-GROUPQUESTIONWIDTH", "GroupQuestionWidth");
			fields[155] = new ims.framework.ReportField(this.context, "_cv_Nursing.UserAssessmentDPP", "BO-1003100043-STOREPRINTEDASSESSMENT", "StorePrintedAssessment");
			fields[156] = new ims.framework.ReportField(this.context, "_cv_Nursing.UserAssessmentDPP", "BO-1003100043-ISMULTIROLE", "IsMultiRole");
			fields[157] = new ims.framework.ReportField(this.context, "_cv_Nursing.UserAssessmentDPP", "BO-1003100043-HEADERTEXT", "HeaderText");
			fields[158] = new ims.framework.ReportField(this.context, "_cv_Nursing.UserAssessmentDPP", "BO-1003100043-FOOTERTEXT", "FooterText");
			fields[159] = new ims.framework.ReportField(this.context, "_cv_Nursing.UserAssessmentDPP", "BO-1003100043-MAXHEADERHEIGHT", "MaxHeaderHeight");
			fields[160] = new ims.framework.ReportField(this.context, "_cv_Nursing.UserAssessmentDPP", "BO-1003100043-MAXFOOTERHEIGHT", "MaxFooterHeight");
			fields[161] = new ims.framework.ReportField(this.context, "_cv_Nursing.UserAssessmentDPP", "BO-1003100043-ASSOCIATEDREPORT", "AssociatedReport");
			fields[162] = new ims.framework.ReportField(this.context, "_cv_Nursing.UserAssessmentDPP", "BO-1003100043-CANCOPYLAST", "CanCopyLast");
			fields[163] = new ims.framework.ReportField(this.context, "_cv_Nursing.UserAssessmentDPP", "BO-1003100043-COPYLASTFROMCONTEXT", "CopyLastFromContext");
			fields[164] = new ims.framework.ReportField(this.context, "_cv_Nursing.PatientAssessmentVo", "BO-1003100048-ID", "ID_PatientAssessment");
			fields[165] = new ims.framework.ReportField(this.context, "_cv_Nursing.PatientAssessmentVo", "BO-1003100048-STATUS", "Status");
			fields[166] = new ims.framework.ReportField(this.context, "_cv_Nursing.PatientAssessmentVo", "BO-1003100048-COMPLETEDDATETIME", "CompletedDateTime");
			fields[167] = new ims.framework.ReportField(this.context, "_cv_Nursing.PatientAssessmentVo", "BO-1003100048-STATUSREASON", "StatusReason");
			fields[168] = new ims.framework.ReportField(this.context, "_cv_Nursing.PatientAssessmentVo", "BO-1003100048-STATUSREASONTEXT", "StatusReasonText");
			fields[169] = new ims.framework.ReportField(this.context, "_cv_Nursing.PatientAssessmentVo", "BO-1003100048-DPPTYPE", "DPPType");
			fields[170] = new ims.framework.ReportField(this.context, "_cv_Nursing.PatientAssessmentVo", "BO-1003100048-DPPTYPETEXT", "DPPTypeText");
			fields[171] = new ims.framework.ReportField(this.context, "_cv_Nursing.PatientAssessmentVo", "BO-1003100048-ISCURRENTFORTYPE", "IsCurrentForType");
			fields[172] = new ims.framework.ReportField(this.context, "_cv_Nursing.PatientAssessmentVo", "BO-1003100048-CLINICALCONTACT", "ClinicalContact");
			fields[173] = new ims.framework.ReportField(this.context, "_cv_Nursing.PatientAssessmentVo", "BO-1003100048-CARECONTEXT", "CareContext");
			fields[174] = new ims.framework.ReportField(this.context, "_cv_Nursing.PatientAssessmentVo", "BO-1003100048-EPISODEOFCARE", "EpisodeOfCare");
			fields[175] = new ims.framework.ReportField(this.context, "_cv_Nursing.PatientAssessmentVo", "BO-1003100048-PATIENT", "Patient");
			fields[176] = new ims.framework.ReportField(this.context, "_cv_Nursing.PatientAssessmentVo", "BO-1003100048-SCORE", "Score");
			fields[177] = new ims.framework.ReportField(this.context, "_cv_Nursing.PatientAssessmentVo", "BO-1003100048-ISASSESSMENTDOCUMENTSAVED", "IsAssessmentDocumentSaved");
			fields[178] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.DailyPatientProgressDlg.__internal_x_context__PatientAssessmentVo_" + componentIdentifier, "BO-1003100048-ID", "ID_PatientAssessment");
			fields[179] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.DailyPatientProgressDlg.__internal_x_context__PatientAssessmentVo_" + componentIdentifier, "BO-1003100048-STATUS", "Status");
			fields[180] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.DailyPatientProgressDlg.__internal_x_context__PatientAssessmentVo_" + componentIdentifier, "BO-1003100048-COMPLETEDDATETIME", "CompletedDateTime");
			fields[181] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.DailyPatientProgressDlg.__internal_x_context__PatientAssessmentVo_" + componentIdentifier, "BO-1003100048-STATUSREASON", "StatusReason");
			fields[182] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.DailyPatientProgressDlg.__internal_x_context__PatientAssessmentVo_" + componentIdentifier, "BO-1003100048-STATUSREASONTEXT", "StatusReasonText");
			fields[183] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.DailyPatientProgressDlg.__internal_x_context__PatientAssessmentVo_" + componentIdentifier, "BO-1003100048-DPPTYPE", "DPPType");
			fields[184] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.DailyPatientProgressDlg.__internal_x_context__PatientAssessmentVo_" + componentIdentifier, "BO-1003100048-DPPTYPETEXT", "DPPTypeText");
			fields[185] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.DailyPatientProgressDlg.__internal_x_context__PatientAssessmentVo_" + componentIdentifier, "BO-1003100048-ISCURRENTFORTYPE", "IsCurrentForType");
			fields[186] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.DailyPatientProgressDlg.__internal_x_context__PatientAssessmentVo_" + componentIdentifier, "BO-1003100048-CLINICALCONTACT", "ClinicalContact");
			fields[187] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.DailyPatientProgressDlg.__internal_x_context__PatientAssessmentVo_" + componentIdentifier, "BO-1003100048-CARECONTEXT", "CareContext");
			fields[188] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.DailyPatientProgressDlg.__internal_x_context__PatientAssessmentVo_" + componentIdentifier, "BO-1003100048-EPISODEOFCARE", "EpisodeOfCare");
			fields[189] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.DailyPatientProgressDlg.__internal_x_context__PatientAssessmentVo_" + componentIdentifier, "BO-1003100048-PATIENT", "Patient");
			fields[190] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.DailyPatientProgressDlg.__internal_x_context__PatientAssessmentVo_" + componentIdentifier, "BO-1003100048-SCORE", "Score");
			fields[191] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.DailyPatientProgressDlg.__internal_x_context__PatientAssessmentVo_" + componentIdentifier, "BO-1003100048-ISASSESSMENTDOCUMENTSAVED", "IsAssessmentDocumentSaved");
			return fields;
		}
