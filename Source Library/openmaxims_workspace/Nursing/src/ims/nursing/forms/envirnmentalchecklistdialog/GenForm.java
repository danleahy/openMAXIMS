...
public class GenForm extends FormBridge
{
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, "_cv_COE.EnvironmentalChecklist", "BO-1009100018-ID", "ID_EnvironmentalChecklist");
			fields[145] = new ims.framework.ReportField(this.context, "_cv_COE.EnvironmentalChecklist", "BO-1009100018-CARECONTEXT", "CareContext");
			fields[146] = new ims.framework.ReportField(this.context, "_cv_COE.EnvironmentalChecklist", "BO-1009100018-CLINICALCONTACT", "ClinicalContact");
			fields[147] = new ims.framework.ReportField(this.context, "_cv_COE.AssessmentMobility", "BO-1015100001-ID", "ID_AssessmentComponent");
			fields[148] = new ims.framework.ReportField(this.context, "_cv_COE.AssessmentMobility", "BO-1015100001-ISCOMPLETE", "IsComplete");
			fields[149] = new ims.framework.ReportField(this.context, "_cv_COE.AssessmentMobility", "BO-1015100001-COPY", "Copy");
			fields[150] = new ims.framework.ReportField(this.context, "_cv_COE.AssessmentMobility", "BO-1015100001-COMPONENTTYPE", "ComponentType");
			fields[151] = new ims.framework.ReportField(this.context, "_cv_COE.AssessmentMobility", "BO-1012100030-ASSISTANCEWITHMOBILITY", "AssistanceWithMobility");
			fields[152] = new ims.framework.ReportField(this.context, "_cv_COE.AssessmentMobility", "BO-1012100030-NOTES", "Notes");
			fields[153] = new ims.framework.ReportField(this.context, "_cv_COE.AssessmentMobility", "BO-1012100030-BEDTYPE", "BedType");
			fields[154] = new ims.framework.ReportField(this.context, "_cv_COE.AssessmentMobility", "BO-1012100030-CHAIRTYPE", "ChairType");
			fields[155] = new ims.framework.ReportField(this.context, "_cv_COE.AssessmentMobility", "BO-1012100030-FALLASSESSMENTSCORE", "FallAssessmentScore");
			fields[156] = new ims.framework.ReportField(this.context, "_cv_Nursing.AssessmentComponent", "BO-1015100001-ID", "ID_AssessmentComponent");
			fields[157] = new ims.framework.ReportField(this.context, "_cv_Nursing.AssessmentComponent", "BO-1015100001-ISCOMPLETE", "IsComplete");
			fields[158] = new ims.framework.ReportField(this.context, "_cv_Nursing.AssessmentComponent", "BO-1015100001-COPY", "Copy");
			fields[159] = new ims.framework.ReportField(this.context, "_cv_Nursing.AssessmentComponent", "BO-1015100001-COMPONENTTYPE", "ComponentType");
			return fields;
		}
