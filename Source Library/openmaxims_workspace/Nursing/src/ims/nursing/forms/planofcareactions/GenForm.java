...
public class GenForm extends FormBridge
{
	...
	public static class lyr1Layer extends Layer
	{
		...
		public static class tabChronologicalContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				Grid m_grdChronologicalTemp = (Grid)factory.getControl(Grid.class, new Object[] { control, new Integer(startControlID.intValue() + 1007), new Integer(anchoringHelper8.getX()), new Integer(anchoringHelper8.getY()), new Integer(anchoringHelper8.getWidth()), new Integer(anchoringHelper8.getHeight()), new Integer(startTabIndex.intValue() + 6), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL,Boolean.TRUE, Boolean.FALSE, new Integer(24), Boolean.TRUE, contextMenus.contextMenuGenericGrid, Boolean.FALSE, Boolean.FALSE, new Integer(0), null, Boolean.FALSE, Boolean.TRUE});
		...
		public static class tabNewActionsContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				ims.framework.FormUiLogic m_customAuthoringForm = loader.loadComponent(102228, appForm, startControlID * 10 + 1000, anchoringHelper11.getSize(), instance1, startTabIndex.intValue() + 8, skipContextValidation);
				//ims.framework.Control m_customAuthoringControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1010), new Integer(0), new Integer(8), new Integer(300), new Integer(56), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, new Integer(startTabIndex.intValue() + 8), m_customAuthoringForm, instance1 } );
				ims.framework.Control m_customAuthoringControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1011),  new Integer(anchoringHelper11.getX()), new Integer(anchoringHelper11.getY()), new Integer(anchoringHelper11.getWidth()), new Integer(anchoringHelper11.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, new Integer(startTabIndex.intValue() + 8), m_customAuthoringForm, instance1, Boolean.FALSE } );
	...
	private void validateContext(ims.framework.Context context)
	{
		...
		if(!context.isValidContextType(ims.nursing.vo.PlanOfCareActionsSearchCriteriaVo.class))
			throw new ims.framework.exceptions.CodingRuntimeException("The type 'ims.nursing.vo.PlanOfCareActionsSearchCriteriaVo' of the global context variable 'Nursing.PlanOfCareActionsSearchCriteria' is not supported.");
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, "_cv_PlanOfCareActionsReview", "BO-1009100014-ID", "ID_PlanOfCareNoting");
			fields[145] = new ims.framework.ReportField(this.context, "_cv_PlanOfCareActionsReview", "BO-1009100014-CARECONTEXT", "CareContext");
			fields[146] = new ims.framework.ReportField(this.context, "_cv_PlanOfCareActionsReview", "BO-1009100014-REVIEWINGDATETIME", "ReviewingDateTime");
			fields[147] = new ims.framework.ReportField(this.context, "_cv_PlanOfCareActionsReview", "BO-1009100014-ACTIONSTATUS", "ActionStatus");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.PlanOfCareActions.__internal_x_context__EditedNewActionRecord_" + componentIdentifier, "BO-1009100002-ID", "ID_PlanOfCare");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.PlanOfCareActions.__internal_x_context__EditedNewActionRecord_" + componentIdentifier, "BO-1009100002-GROUP", "Group");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.PlanOfCareActions.__internal_x_context__EditedNewActionRecord_" + componentIdentifier, "BO-1009100002-TITLE", "Title");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.PlanOfCareActions.__internal_x_context__EditedNewActionRecord_" + componentIdentifier, "BO-1009100002-STARTDATETIME", "StartDateTime");
			fields[152] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.PlanOfCareActions.__internal_x_context__EditedNewActionRecord_" + componentIdentifier, "BO-1009100002-RESOLVEDDATETIME", "ResolvedDateTime");
			fields[153] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.PlanOfCareActions.__internal_x_context__EditedNewActionRecord_" + componentIdentifier, "BO-1009100002-LEVELOFINTERVENTION", "LevelOfIntervention");
			fields[154] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.PlanOfCareActions.__internal_x_context__Context1_" + componentIdentifier, "BO-1009100014-ID", "ID_PlanOfCareNoting");
			return fields;
		}
