...
public class GenForm extends FormBridge
{
		...
		public static class lyrDetailsLayer extends Layer
		{
			...
			public static class tabDeviceContainer extends LayerBridge
			{
				...
				protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
				{
					...
					ims.framework.FormUiLogic m_customInsertedHCPForm = loader.loadComponent(102228, appForm, startControlID * 10 + 1000, anchoringHelper1.getSize(), instance1, startTabIndex.intValue() + 8, skipContextValidation);
					//ims.framework.Control m_customInsertedHCPControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1000), new Integer(208), new Integer(7), new Integer(296), new Integer(56), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT, new Integer(startTabIndex.intValue() + 8), m_customInsertedHCPForm, instance1 } );
					ims.framework.Control m_customInsertedHCPControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1001),  new Integer(anchoringHelper1.getX()), new Integer(anchoringHelper1.getY()), new Integer(anchoringHelper1.getWidth()), new Integer(anchoringHelper1.getHeight()), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT, new Integer(startTabIndex.intValue() + 8), m_customInsertedHCPForm, instance1, Boolean.FALSE } );
					...
					RuntimeAnchoring anchoringHelper2 = new RuntimeAnchoring(designSize, runtimeSize, 499, 56, 309, 56, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
					ims.framework.FormUiLogic m_customAuthoringHCPForm = loader.loadComponent(102228, appForm, startControlID * 10 + 2000, anchoringHelper2.getSize(), instance2, startTabIndex.intValue() + 17, skipContextValidation);
					//ims.framework.Control m_customAuthoringHCPControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1002), new Integer(499), new Integer(56), new Integer(309), new Integer(56), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.TOPRIGHT, new Integer(startTabIndex.intValue() + 17), m_customAuthoringHCPForm, instance2 } );
					...
					// TextBox Controls
					RuntimeAnchoring anchoringHelper14 = new RuntimeAnchoring(designSize, runtimeSize, 640, 39, 153, 21, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
					...
					// Date Time Controls
					RuntimeAnchoring anchoringHelper17 = new RuntimeAnchoring(designSize, runtimeSize, 349, 63, 140, 20, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
					...
					RuntimeAnchoring anchoringHelper18 = new RuntimeAnchoring(designSize, runtimeSize, 349, 87, 140, 20, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
					...
					RuntimeAnchoring anchoringHelper21 = new RuntimeAnchoring(designSize, runtimeSize, 349, 135, 140, 21, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
					ComboBox m_cmbRemovalReasonTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1022), new Integer(anchoringHelper21.getX()), new Integer(anchoringHelper21.getY()), new Integer(anchoringHelper21.getWidth()), new Integer(anchoringHelper21.getHeight()), new Integer(startTabIndex.intValue() + 14), ControlState.DISABLED, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPRIGHT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
					...
					RuntimeAnchoring anchoringHelper23 = new RuntimeAnchoring(designSize, runtimeSize, 349, 112, 140, 21, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
					ComboBox m_qmbRemovalByTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1024), new Integer(anchoringHelper23.getX()), new Integer(anchoringHelper23.getY()), new Integer(anchoringHelper23.getWidth()), new Integer(anchoringHelper23.getHeight()), new Integer(startTabIndex.intValue() + 13), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.TRUE, new Integer(1), null, Boolean.FALSE, new Integer(-1), Boolean.FALSE});
					...
					// AnswerBox Controls
					RuntimeAnchoring anchoringHelper24 = new RuntimeAnchoring(designSize, runtimeSize, 640, 15, 16, 16, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
					AnswerBox tmpansCulture = (AnswerBox)factory.getControl(AnswerBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1025), new Integer(anchoringHelper24.getX()), new Integer(anchoringHelper24.getY()), new Integer(anchoringHelper24.getWidth()), new Integer(anchoringHelper24.getHeight()), new Integer(startTabIndex.intValue() + 15), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT, "", Boolean.FALSE, Boolean.TRUE, new Integer(10), Boolean.FALSE});
			...
			public static class tabVIPContainer extends LayerBridge
			{
				...
				protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
				{
					...
					ims.framework.FormUiLogic m_customVipAuthoringHCPForm = loader.loadComponent(102228, appForm, startControlID * 10 + 3000, anchoringHelper25.getSize(), instance1, startTabIndex.intValue() + 22, skipContextValidation);
					//ims.framework.Control m_customVipAuthoringHCPControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1026), new Integer(416), new Integer(40), new Integer(300), new Integer(64), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFT, new Integer(startTabIndex.intValue() + 22), m_customVipAuthoringHCPForm, instance1 } );
					...
					// Label Controls
					RuntimeAnchoring anchoringHelper26 = new RuntimeAnchoring(designSize, runtimeSize, 128, 83, 44, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
					super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1028), new Integer(anchoringHelper26.getX()), new Integer(anchoringHelper26.getY()), new Integer(anchoringHelper26.getWidth()), new Integer(anchoringHelper26.getHeight()), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Action:", new Integer(1), null, new Integer(0)}));
					RuntimeAnchoring anchoringHelper27 = new RuntimeAnchoring(designSize, runtimeSize, 128, 49, 64, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
					super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1029), new Integer(anchoringHelper27.getX()), new Integer(anchoringHelper27.getY()), new Integer(anchoringHelper27.getWidth()), new Integer(anchoringHelper27.getHeight()), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "VIP Score:", new Integer(1), null, new Integer(0)}));
			
					// ComboBox Controls
					RuntimeAnchoring anchoringHelper28 = new RuntimeAnchoring(designSize, runtimeSize, 216, 47, 136, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
					...
					RuntimeAnchoring anchoringHelper29 = new RuntimeAnchoring(designSize, runtimeSize, 216, 81, 136, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
	...
	private void validateContext(ims.framework.Context context)
	{
		...
		if(!context.isValidContextType(ims.nursing.vo.InvasiveDeviceSearchCriteriaVo.class))
			throw new ims.framework.exceptions.CodingRuntimeException("The type 'ims.nursing.vo.InvasiveDeviceSearchCriteriaVo' of the global context variable 'Nursing.InvasiveDeviceSearchCriteria' is not supported.");
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1036), new Integer(anchoringHelper34.getX()), new Integer(anchoringHelper34.getY()), new Integer(anchoringHelper34.getWidth()), new Integer(anchoringHelper34.getHeight()), new Integer(startTabIndex.intValue() + 25), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "New", Boolean.TRUE, null, Boolean.TRUE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1037), new Integer(anchoringHelper35.getX()), new Integer(anchoringHelper35.getY()), new Integer(anchoringHelper35.getWidth()), new Integer(anchoringHelper35.getHeight()), new Integer(startTabIndex.intValue() + 26), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Edit", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		RuntimeAnchoring anchoringHelper36 = new RuntimeAnchoring(designSize, runtimeSize, 686, 600, 75, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT);
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.InvasiveDevice.__internal_x_context__EditedDeviceRecord_" + componentIdentifier, "BO-1072100043-ID", "ID_PatientInvasiveDevice");
			fields[145] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.InvasiveDevice.__internal_x_context__EditedDeviceRecord_" + componentIdentifier, "BO-1072100043-INSERTEDDATETIME", "InsertedDateTime");
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.InvasiveDevice.__internal_x_context__EditedDeviceRecord_" + componentIdentifier, "BO-1072100043-REMOVALDATETIME", "RemovalDateTime");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.InvasiveDevice.__internal_x_context__EditedDeviceRecord_" + componentIdentifier, "BO-1072100043-TARGETREMOVALDATETIME", "TargetRemovalDateTime");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.InvasiveDevice.__internal_x_context__EditedDeviceRecord_" + componentIdentifier, "BO-1072100043-SITE", "Site");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.InvasiveDevice.__internal_x_context__EditedDeviceRecord_" + componentIdentifier, "BO-1072100043-CLINICALCONTACT", "ClinicalContact");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.InvasiveDevice.__internal_x_context__EditedDeviceRecord_" + componentIdentifier, "BO-1072100043-CARECONTEXT", "CareContext");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.InvasiveDevice.__internal_x_context__EditedDeviceRecord_" + componentIdentifier, "BO-1072100043-TYPE", "Type");
			fields[152] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.InvasiveDevice.__internal_x_context__EditedDeviceRecord_" + componentIdentifier, "BO-1072100043-SIZE", "Size");
			fields[153] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.InvasiveDevice.__internal_x_context__EditedDeviceRecord_" + componentIdentifier, "BO-1072100043-COMMENT", "Comment");
			fields[154] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.InvasiveDevice.__internal_x_context__EditedDeviceRecord_" + componentIdentifier, "BO-1072100043-REMOVALREASON", "RemovalReason");
			fields[155] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.InvasiveDevice.__internal_x_context__EditedDeviceRecord_" + componentIdentifier, "BO-1072100043-SENTFORCULTURE", "SentForCulture");
			fields[156] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.InvasiveDevice.__internal_x_context__EditedDeviceRecord_" + componentIdentifier, "BO-1072100043-RESULT", "Result");
			fields[157] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.InvasiveDevice.__internal_x_context__EditedVipRecord_" + componentIdentifier, "BO-1072100056-ID", "ID_VIPScore");
			fields[158] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.InvasiveDevice.__internal_x_context__EditedVipRecord_" + componentIdentifier, "BO-1072100056-CLINICALCONTACT", "ClinicalContact");
			fields[159] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.InvasiveDevice.__internal_x_context__EditedVipRecord_" + componentIdentifier, "BO-1072100056-CARECONTEXT", "CareContext");
			fields[160] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.InvasiveDevice.__internal_x_context__EditedVipRecord_" + componentIdentifier, "BO-1072100056-VIPSCALE", "VIPScale");
			fields[161] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.InvasiveDevice.__internal_x_context__EditedVipRecord_" + componentIdentifier, "BO-1072100056-ACTION", "Action");
			return fields;
		}
