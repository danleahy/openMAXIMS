...
public class GenForm extends FormBridge
{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		contextMenus.contextMenuProcedureADDItem = factory.createMenuItem(startControlID.intValue() + 12, "New Procedure", true, false, new Integer(102179), true, false);
		...
		contextMenus.contextMenuProcedureUPDATEItem = factory.createMenuItem(startControlID.intValue() + 13, "Edit Procedure", true, false, new Integer(102150), true, false);
		...
		contextMenus.contextMenuProcedurePERFORMEDItem = factory.createMenuItem(startControlID.intValue() + 14, "Mark Procedure as Performed", true, false, new Integer(102209), true, false);
		...
		contextMenus.contextMenuProcedureVIEWASSOCIATIONSItem = factory.createMenuItem(startControlID.intValue() + 15, "View Associations", true, false, new Integer(102266), true, false);
		...
		contextMenus.contextMenuProcedureNEWINTRAOPERATIVEDETAILSItem = factory.createMenuItem(startControlID.intValue() + 16, "New Intra Operative Details", true, false, new Integer(102149), true, false);
		...
		contextMenus.contextMenuProcedureEDITINTRAOPERATIVEDETAILSItem = factory.createMenuItem(startControlID.intValue() + 17, "View\\Edit Intra Operative Details", true, false, new Integer(102150), true, false);
		...
		contextMenus.contextMenuProcedureNEWCATARACTINTRAOPERATIVEDETAILSItem = factory.createMenuItem(startControlID.intValue() + 18, "New Cataract Intra Operative Details", true, false, new Integer(102149), true, false);
		...
		contextMenus.contextMenuProcedureEDITCATARACTINTRAOPERATIVEDETAILSItem = factory.createMenuItem(startControlID.intValue() + 19, "View\\Edit Cataract Intra Operative Details", true, false, new Integer(102150), true, false);
		...
		contextMenus.contextMenuProcedureRIEItem = factory.createMenuItem(startControlID.intValue() + 20, "RIE", true, false, new Integer(102142), true, false);
		...
		contextMenus.contextMenuProcedureCANCELItem = factory.createMenuItem(startControlID.intValue() + 21, "Mark Procedure as Cancelled", true, false, new Integer(102148), true, false);
		...
		contextMenus.Clinical.contextMenuEDischargeDiagnosisEtcDiagnosisMenuNEW_DIAGNOSISItem = factory.createMenuItem(startControlID.intValue() + 22, "New Diagnosis", true, false, new Integer(102149), true, false);
		...
		contextMenus.Clinical.contextMenuEDischargeDiagnosisEtcDiagnosisMenuEDIT_DIAGNOSISItem = factory.createMenuItem(startControlID.intValue() + 23, "Edit Diagnosis", true, false, new Integer(102150), true, false);
		...
		contextMenus.Clinical.contextMenuEDischargeDiagnosisEtcDiagnosisMenuVIEW_DIAGNOSISItem = factory.createMenuItem(startControlID.intValue() + 24, "View Diagnosis", true, false, new Integer(102223), true, false);
		...
		contextMenus.Clinical.contextMenuEDischargeDiagnosisEtcDiagnosisMenuRIEItem = factory.createMenuItem(startControlID.intValue() + 25, "RIE", true, false, new Integer(102142), true, false);
		...
		ims.framework.FormUiLogic m_ccConsultantAnaesthetistForm = loader.loadComponent(102256, appForm, startControlID * 10 + 1000, anchoringHelper4.getSize(), instance1, startTabIndex.intValue() + 8, skipContextValidation);
		//ims.framework.Control m_ccConsultantAnaesthetistControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1001), new Integer(584), new Integer(70), new Integer(208), new Integer(20), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT, new Integer(startTabIndex.intValue() + 8), m_ccConsultantAnaesthetistForm, instance1 } );
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1016), new Integer(anchoringHelper17.getX()), new Integer(anchoringHelper17.getY()), new Integer(anchoringHelper17.getWidth()), new Integer(anchoringHelper17.getHeight()), new Integer(startTabIndex.intValue() + 13), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Edit", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));

		// Date Controls
		RuntimeAnchoring anchoringHelper18 = new RuntimeAnchoring(designSize, runtimeSize, 584, 21, 184, 20, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		Grid m_grdAssistantsTemp = (Grid)factory.getControl(Grid.class, new Object[] { control, new Integer(startControlID.intValue() + 1022), new Integer(anchoringHelper23.getX()), new Integer(anchoringHelper23.getY()), new Integer(anchoringHelper23.getWidth()), new Integer(anchoringHelper23.getHeight()), new Integer(startTabIndex.intValue() + 11), ControlState.DISABLED, ControlState.EDITABLE, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT,Boolean.TRUE, Boolean.FALSE, new Integer(24), Boolean.TRUE, contextMenus.contextMenuGenericGrid, Boolean.FALSE, Boolean.TRUE, new Integer(0), null, Boolean.FALSE, Boolean.TRUE});
	...
	public final class ContextMenus implements java.io.Serializable
	{
		...
		public final class Procedure implements java.io.Serializable
		{
			...
			public static final int PERFORMED = 14;
			public static final int VIEWASSOCIATIONS = 15;
			public static final int NEWINTRAOPERATIVEDETAILS = 16;
			public static final int EDITINTRAOPERATIVEDETAILS = 17;
			public static final int NEWCATARACTINTRAOPERATIVEDETAILS = 18;
			public static final int EDITCATARACTINTRAOPERATIVEDETAILS = 19;
			public static final int RIE = 20;
		...
		public final class ClinicalNamespace implements java.io.Serializable
		{
			...
			{
				private static final long serialVersionUID = 1L;
				public static final int NEW_DIAGNOSIS = 22;
				public static final int EDIT_DIAGNOSIS = 23;
				public static final int VIEW_DIAGNOSIS = 24;
				public static final int RIE = 25;
			}
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedProcedure", "BO-1003100019-ID", "ID_Procedure");
			fields[145] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedProcedure", "BO-1003100019-PROCEDURENAME", "ProcedureName");
			fields[146] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedProcedure", "BO-1003100019-ISACTIVE", "IsActive");
			fields[147] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedProcedure", "BO-1003100019-PROCEDURESTATUS", "ProcedureStatus");
			fields[148] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedProcedure", "BO-1003100019-DURATIONINMINS", "DurationInMins");
			fields[149] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedProcedure", "BO-1003100019-TCILAGTIME", "TCILagTime");
			fields[150] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedProcedure", "BO-1003100019-LOS", "LOS");
			fields[151] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedProcedure", "BO-1003100019-ISLATERALITYAPPLICABLE", "IsLateralityApplicable");
			fields[152] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedProcedure", "BO-1003100019-ISBILATERALLISTINGAPPLICABLE", "IsBilateralListingApplicable");
			fields[153] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedProcedure", "BO-1003100019-DEFAULTANAESTHETICTYPE", "DefaultAnaestheticType");
			fields[154] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedProcedure", "BO-1003100019-GENDERSPECIFIC", "GenderSpecific");
			fields[155] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedProcedure", "BO-1003100019-ISENDOSCOPY", "IsEndoscopy");
			fields[156] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedProcedure", "BO-1003100019-ENDOSCOPYTYPE", "EndoscopyType");
			fields[157] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedProcedure", "BO-1003100019-MEDICALWL", "MedicalWL");
			fields[158] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedPatientDiagnosisOPNotes", "BO-1003100016-ID", "ID_PatientDiagnosis");
			fields[159] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedPatientDiagnosisOPNotes", "BO-1003100016-DIAGNOSISDESCRIPTION", "DiagnosisDescription");
			fields[160] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedPatientDiagnosisOPNotes", "BO-1003100016-DIAGNOSEDDATE", "DiagnosedDate");
			fields[161] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedPatientDiagnosisOPNotes", "BO-1003100016-SOURCEOFINFORMATION", "SourceofInformation");
			fields[162] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedPatientDiagnosisOPNotes", "BO-1003100016-ISCOMORBIDITY", "IsComorbidity");
			fields[163] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedPatientDiagnosisOPNotes", "BO-1003100016-EPISODEOFCARE", "EpisodeOfCare");
			fields[164] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedPatientDiagnosisOPNotes", "BO-1003100016-DIAGNOSEDONADMISSION", "DiagnosedOnAdmission");
			fields[165] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalOPNotesGeneralDetailsCC.__internal_x_context__CurrentOPNote_" + componentIdentifier, "BO-1003100106-ID", "ID_SurgicalOperationNotes");
			fields[166] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalOPNotesGeneralDetailsCC.__internal_x_context__CurrentOPNote_" + componentIdentifier, "BO-1003100106-CARECONTEXT", "CareContext");
			fields[167] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalOPNotesGeneralDetailsCC.__internal_x_context__CurrentOPNote_" + componentIdentifier, "BO-1003100106-ANAESTHETICGIVEN", "AnaestheticGiven");
			fields[168] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalOPNotesGeneralDetailsCC.__internal_x_context__CurrentOPNote_" + componentIdentifier, "BO-1003100106-ESTIMATEDDATEOFDISCHARGE", "EstimatedDateOfDischarge");
			fields[169] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalOPNotesGeneralDetailsCC.__internal_x_context__SelectedProcedure_" + componentIdentifier, "BO-1003100017-ID", "ID_PatientProcedure");
			fields[170] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalOPNotesGeneralDetailsCC.__internal_x_context__SelectedProcedure_" + componentIdentifier, "BO-1003100017-PROCEDURESTATUS", "ProcedureStatus");
			fields[171] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalOPNotesGeneralDetailsCC.__internal_x_context__SelectedProcedure_" + componentIdentifier, "BO-1003100017-PROCDATE", "ProcDate");
			fields[172] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalOPNotesGeneralDetailsCC.__internal_x_context__SelectedProcedure_" + componentIdentifier, "BO-1003100017-INFOSOURCE", "InfoSource");
			fields[173] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalOPNotesGeneralDetailsCC.__internal_x_context__SelectedProcedure_" + componentIdentifier, "BO-1003100017-CARECONTEXT", "CareContext");
			fields[174] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalOPNotesGeneralDetailsCC.__internal_x_context__SelectedProcedure_" + componentIdentifier, "BO-1003100017-INCLUDEINDISCHARGELETTER", "IncludeInDischargeLetter");
			fields[175] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalOPNotesGeneralDetailsCC.__internal_x_context__SelectedProcedure_" + componentIdentifier, "BO-1003100017-PROCEDUREDESCRIPTION", "ProcedureDescription");
			fields[176] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalOPNotesGeneralDetailsCC.__internal_x_context__SelectedProcedure_" + componentIdentifier, "BO-1003100017-PROCEDUREURGENCY", "ProcedureUrgency");
			fields[177] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalOPNotesGeneralDetailsCC.__internal_x_context__SelectedProcedure_" + componentIdentifier, "BO-1003100017-EPISODEOFCARE", "EpisodeOfCare");
			fields[178] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalOPNotesGeneralDetailsCC.__internal_x_context__ProcedureToBeRIE_" + componentIdentifier, "BO-1003100017-ID", "ID_PatientProcedure");
			fields[179] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalOPNotesGeneralDetailsCC.__internal_x_context__ProcedureToBeRIE_" + componentIdentifier, "BO-1003100017-PROCEDURESTATUS", "ProcedureStatus");
			fields[180] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalOPNotesGeneralDetailsCC.__internal_x_context__ProcedureToBeRIE_" + componentIdentifier, "BO-1003100017-PROCDATE", "ProcDate");
			fields[181] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalOPNotesGeneralDetailsCC.__internal_x_context__ProcedureToBeRIE_" + componentIdentifier, "BO-1003100017-INFOSOURCE", "InfoSource");
			fields[182] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalOPNotesGeneralDetailsCC.__internal_x_context__ProcedureToBeRIE_" + componentIdentifier, "BO-1003100017-CARECONTEXT", "CareContext");
			fields[183] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalOPNotesGeneralDetailsCC.__internal_x_context__ProcedureToBeRIE_" + componentIdentifier, "BO-1003100017-INCLUDEINDISCHARGELETTER", "IncludeInDischargeLetter");
			fields[184] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalOPNotesGeneralDetailsCC.__internal_x_context__ProcedureToBeRIE_" + componentIdentifier, "BO-1003100017-PROCEDUREDESCRIPTION", "ProcedureDescription");
			fields[185] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalOPNotesGeneralDetailsCC.__internal_x_context__ProcedureToBeRIE_" + componentIdentifier, "BO-1003100017-PROCEDUREURGENCY", "ProcedureUrgency");
			fields[186] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalOPNotesGeneralDetailsCC.__internal_x_context__ProcedureToBeRIE_" + componentIdentifier, "BO-1003100017-EPISODEOFCARE", "EpisodeOfCare");
			return fields;
		}
