...
public class GenForm extends FormBridge
{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1010), new Integer(anchoringHelper10.getX()), new Integer(anchoringHelper10.getY()), new Integer(anchoringHelper10.getWidth()), new Integer(anchoringHelper10.getHeight()), new Integer(startTabIndex.intValue() + 11), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "New", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1011), new Integer(anchoringHelper11.getX()), new Integer(anchoringHelper11.getY()), new Integer(anchoringHelper11.getWidth()), new Integer(anchoringHelper11.getHeight()), new Integer(startTabIndex.intValue() + 12), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Edit", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(RichTextControl.class, new Object[] { control, new Integer(startControlID.intValue() + 1020), new Integer(anchoringHelper20.getX()), new Integer(anchoringHelper20.getY()), new Integer(anchoringHelper20.getWidth()), new Integer(anchoringHelper20.getHeight()), new Integer(startTabIndex.intValue() + 9), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, Boolean.FALSE, Boolean.FALSE, new Integer(10000)} ));
	}
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedFitForSurgeryComment", "BO-1096100042-ID", "ID_FitForSurgeryComment");
			fields[145] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedFitForSurgeryComment", "BO-1096100042-COMMENT", "Comment");
			fields[146] = new ims.framework.ReportField(this.context, "_cv_Clinical.AppointmentForFitForSurgery", "BO-1055100007-ID", "ID_Booking_Appointment");
			fields[147] = new ims.framework.ReportField(this.context, "_cv_Clinical.AppointmentForFitForSurgery", "BO-1055100007-APPOINTMENTDATE", "AppointmentDate");
			fields[148] = new ims.framework.ReportField(this.context, "_cv_Clinical.AppointmentForFitForSurgery", "BO-1055100007-APPTSTARTTIME", "ApptStartTime");
			fields[149] = new ims.framework.ReportField(this.context, "_cv_Clinical.AppointmentForFitForSurgery", "BO-1055100007-APPTSTATUS", "ApptStatus");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.FitForSurgeryAssessment.__internal_x_context__CurrentRecord_" + componentIdentifier, "BO-1096100024-ID", "ID_FitForSurgeryAssesment");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.FitForSurgeryAssessment.__internal_x_context__CurrentRecord_" + componentIdentifier, "BO-1096100024-CARECONTEXT", "CareContext");
			fields[152] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.FitForSurgeryAssessment.__internal_x_context__CurrentRecord_" + componentIdentifier, "BO-1096100024-ANAESTHETICTYPE", "AnaestheticType");
			fields[153] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.FitForSurgeryAssessment.__internal_x_context__CurrentRecord_" + componentIdentifier, "BO-1096100024-ASASCORE", "ASAScore");
			fields[154] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.FitForSurgeryAssessment.__internal_x_context__CurrentRecord_" + componentIdentifier, "BO-1096100024-COMMENTS", "Comments");
			fields[155] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.FitForSurgeryAssessment.__internal_x_context__CurrentRecord_" + componentIdentifier, "BO-1096100024-FITFORSURGERY", "FitForSurgery");
			fields[156] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.FitForSurgeryAssessment.__internal_x_context__CurrentRecord_" + componentIdentifier, "BO-1096100024-NOTFITREASON", "NotFitReason");
			fields[157] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.FitForSurgeryAssessment.__internal_x_context__LoggedInHcp_" + componentIdentifier, "BO-1006100000-ID", "ID_Hcp");
			return fields;
		}
