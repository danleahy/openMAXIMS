...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "CodedDiagnosisForAttendanceDialog";
	}
	public int getWidth()
	{
		return 712;
	...
	{
		return new String[] { "_cv_Core.CodedDiagnosisForAttendanceList", "_cv_Core.CodedDiagnosesForAttendance", "_cv_Clinical.DisableMainCheckbox", "_cv_Core.TaxonomyMap" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Clinical.CodedDiagnosisForAttendanceDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
