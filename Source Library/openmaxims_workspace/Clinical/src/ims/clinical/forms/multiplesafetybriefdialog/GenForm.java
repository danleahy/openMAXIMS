...
public class GenForm extends FormBridge
{
	...
	public static class grdAppointmentsRow extends GridRowBridge
	{
		...
		public ims.scheduling.vo.Booking_AppointmentRefVo getValue()
		{
			return (ims.scheduling.vo.Booking_AppointmentRefVo)super.row.getValue();
		}
		public void setValue(ims.scheduling.vo.Booking_AppointmentRefVo value)
		{
	...
	public static class grdAppointmentsGrid extends GridBridge
	{
		...
		public ims.scheduling.vo.Booking_AppointmentRefVo[] getValues()
		{
			ims.scheduling.vo.Booking_AppointmentRefVo[] listOfValues = new ims.scheduling.vo.Booking_AppointmentRefVo[this.getRows().size()];
		...
		public ims.scheduling.vo.Booking_AppointmentRefVo getValue()
		{
			return (ims.scheduling.vo.Booking_AppointmentRefVo)super.grid.getValue();
		}
		public void setValue(ims.scheduling.vo.Booking_AppointmentRefVo value)
		{
		...
		public grdAppointmentsRow getRowByValue(ims.scheduling.vo.Booking_AppointmentRefVo value)
		{
	...
	{
		if(new ims.framework.ContextVariable("Clinical.TheatreSessionStartDateTime", "_cv_Clinical.TheatreSessionStartDateTime").getValueIsNull(context))
			throw new ims.framework.exceptions.FormMandatoryContextMissingException("The required context data 'Clinical.TheatreSessionStartDateTime' is not available.");
	}
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		ims.framework.utils.SizeInfo designSize = new ims.framework.utils.SizeInfo(480, 304);
		if(runtimeSize == null)
		...
		// Label Controls
		RuntimeAnchoring anchoringHelper1 = new RuntimeAnchoring(designSize, runtimeSize, 215, 231, 91, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1000), new Integer(anchoringHelper1.getX()), new Integer(anchoringHelper1.getY()), new Integer(anchoringHelper1.getWidth()), new Integer(anchoringHelper1.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Date and Time:", new Integer(1), null, new Integer(0)}));

		// Button Controls
		RuntimeAnchoring anchoringHelper2 = new RuntimeAnchoring(designSize, runtimeSize, 309, 267, 75, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT);
		...
		RuntimeAnchoring anchoringHelper3 = new RuntimeAnchoring(designSize, runtimeSize, 389, 267, 75, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT);
		...
		// Date Time Controls
		RuntimeAnchoring anchoringHelper4 = new RuntimeAnchoring(designSize, runtimeSize, 312, 229, 152, 20, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		// Grid Controls
		RuntimeAnchoring anchoringHelper5 = new RuntimeAnchoring(designSize, runtimeSize, 16, 16, 448, 200, ims.framework.enumerations.ControlAnchoring.ALL);
		Grid m_grdAppointmentsTemp = (Grid)factory.getControl(Grid.class, new Object[] { control, new Integer(startControlID.intValue() + 1004), new Integer(anchoringHelper5.getX()), new Integer(anchoringHelper5.getY()), new Integer(anchoringHelper5.getWidth()), new Integer(anchoringHelper5.getHeight()), new Integer(startTabIndex.intValue() + 1), ControlState.READONLY, ControlState.EDITABLE, ims.framework.enumerations.ControlAnchoring.ALL,Boolean.FALSE, Boolean.FALSE, new Integer(52), Boolean.TRUE, null, Boolean.FALSE, Boolean.FALSE, new Integer(0), null, Boolean.TRUE, Boolean.TRUE});
		...
		grdAppointments.addStringColumn("Hospital No.", 0, 0, 100, true, false, 1, 0, true, ims.framework.enumerations.CharacterCasing.NORMAL);
		grdAppointments.addStringColumn("Surname", 0, 0, 110, true, false, 1, 0, true, ims.framework.enumerations.CharacterCasing.NORMAL);
		grdAppointments.addStringColumn("Forename", 0, 0, 110, true, false, 1, 0, true, ims.framework.enumerations.CharacterCasing.NORMAL);
		grdAppointments.addBoolColumn("Select", 1, 1, -1, false, false, 0, true);
	...
	public class LocalContext extends ContextBridge
	{
		...
		public LocalContext(Context context, ims.framework.FormInfo formInfo, String componentIdentifier)
		{
			...
			cxl_CaseTimeVo = new ims.framework.ContextVariable("CaseTimeVo", prefix + "_lv_Clinical.MultipleSafetyBriefDialog.__internal_x_context__CaseTimeVo_" + componentIdentifier + "");
			cxl_BookingState = new ims.framework.ContextVariable("BookingState", prefix + "_lv_Clinical.MultipleSafetyBriefDialog.__internal_x_context__BookingState_" + componentIdentifier + "");
		}
		
		public boolean getCaseTimeVoIsNotNull()
		{
			return !cxl_CaseTimeVo.getValueIsNull(context);
		}
		public ims.vo.ValueObject getCaseTimeVo()
		{
			return (ims.vo.ValueObject)cxl_CaseTimeVo.getValue(context);
		}
		public void setCaseTimeVo(ims.vo.ValueObject value)
		{
			cxl_CaseTimeVo.setValue(context, value);
		}
		private ims.framework.ContextVariable cxl_CaseTimeVo = null;
		public boolean getBookingStateIsNotNull()
		{
			return !cxl_BookingState.getValueIsNull(context);
		}
		public ims.scheduling.vo.lookups.AcuteTheateListBookingState getBookingState()
		{
			return (ims.scheduling.vo.lookups.AcuteTheateListBookingState)cxl_BookingState.getValue(context);
		}
		public void setBookingState(ims.scheduling.vo.lookups.AcuteTheateListBookingState value)
		{
			cxl_BookingState.setValue(context, value);
		}
		private ims.framework.ContextVariable cxl_BookingState = null;
	}
