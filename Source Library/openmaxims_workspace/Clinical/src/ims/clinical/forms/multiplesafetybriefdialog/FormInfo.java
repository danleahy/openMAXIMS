...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "MultipleSafetyBriefDialog";
	}
	public int getWidth()
	{
		return 480;
	...
	{
		return new String[] { "_cv_Clinical.TheatreSessionStartDateTime", "_cv_Clinical.AvailableSafetyBriefAppointments", "_cv_Scheduling.TheatreSession" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Clinical.MultipleSafetyBriefDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
