...
public class GenForm extends FormBridge
{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		ims.framework.FormUiLogic m_ccOrderingClinForm = loader.loadComponent(102256, appForm, startControlID * 10 + 2000, anchoringHelper2.getSize(), instance2, startTabIndex.intValue() + 7, skipContextValidation);
		//ims.framework.Control m_ccOrderingClinControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1002), new Integer(560), new Integer(8), new Integer(296), new Integer(20), ControlState.DISABLED, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.TOPRIGHT, new Integer(startTabIndex.intValue() + 7), m_ccOrderingClinForm, instance2 } );
		ims.framework.Control m_ccOrderingClinControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1003),  new Integer(anchoringHelper2.getX()), new Integer(anchoringHelper2.getY()), new Integer(anchoringHelper2.getWidth()), new Integer(anchoringHelper2.getHeight()), ControlState.DISABLED, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.TOPRIGHT, new Integer(startTabIndex.intValue() + 7), m_ccOrderingClinForm, instance2, Boolean.TRUE } );
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1017), new Integer(anchoringHelper16.getX()), new Integer(anchoringHelper16.getY()), new Integer(anchoringHelper16.getWidth()), new Integer(anchoringHelper16.getHeight()), new Integer(startTabIndex.intValue() + 18), ControlState.UNKNOWN, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "TTA Dispensed", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1018), new Integer(anchoringHelper17.getX()), new Integer(anchoringHelper17.getY()), new Integer(anchoringHelper17.getWidth()), new Integer(anchoringHelper17.getHeight()), new Integer(startTabIndex.intValue() + 17), ControlState.UNKNOWN, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Enter Pharmacy", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1021), new Integer(anchoringHelper20.getX()), new Integer(anchoringHelper20.getY()), new Integer(anchoringHelper20.getWidth()), new Integer(anchoringHelper20.getHeight()), new Integer(startTabIndex.intValue() + 21), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Edit", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1022), new Integer(anchoringHelper21.getX()), new Integer(anchoringHelper21.getY()), new Integer(anchoringHelper21.getWidth()), new Integer(anchoringHelper21.getHeight()), new Integer(startTabIndex.intValue() + 13), ControlState.UNKNOWN, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Approve", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1025), new Integer(anchoringHelper24.getX()), new Integer(anchoringHelper24.getY()), new Integer(anchoringHelper24.getWidth()), new Integer(anchoringHelper24.getHeight()), new Integer(startTabIndex.intValue() + 19), ControlState.UNKNOWN, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Final Checks", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1026), new Integer(anchoringHelper25.getX()), new Integer(anchoringHelper25.getY()), new Integer(anchoringHelper25.getWidth()), new Integer(anchoringHelper25.getHeight()), new Integer(startTabIndex.intValue() + 14), ControlState.UNKNOWN, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Suspended", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1028), new Integer(anchoringHelper27.getX()), new Integer(anchoringHelper27.getY()), new Integer(anchoringHelper27.getWidth()), new Integer(anchoringHelper27.getHeight()), new Integer(startTabIndex.intValue() + 11), ControlState.DISABLED, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.TOPRIGHT,Boolean.FALSE, new Integer(0), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
		...
		super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1029), new Integer(anchoringHelper28.getX()), new Integer(anchoringHelper28.getY()), new Integer(anchoringHelper28.getWidth()), new Integer(anchoringHelper28.getHeight()), new Integer(startTabIndex.intValue() + 10), ControlState.DISABLED, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.TOPRIGHT,Boolean.FALSE, new Integer(25), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.TRUE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
		...
		super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1030), new Integer(anchoringHelper29.getX()), new Integer(anchoringHelper29.getY()), new Integer(anchoringHelper29.getWidth()), new Integer(anchoringHelper29.getHeight()), new Integer(startTabIndex.intValue() + 5), ControlState.DISABLED, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT,Boolean.TRUE, new Integer(1500), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
		...
		super.addControl(factory.getControl(DateTimeControl.class, new Object[] { control, new Integer(startControlID.intValue() + 1032), new Integer(anchoringHelper31.getX()), new Integer(anchoringHelper31.getY()), new Integer(anchoringHelper31.getWidth()), new Integer(anchoringHelper31.getHeight()), new Integer(startTabIndex.intValue() + 9), ControlState.DISABLED, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.TOPRIGHT,Boolean.TRUE, null, Boolean.FALSE, null, Boolean.TRUE, null}));
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, "_cv_Clinical.EDischargeMeds", "BO-1099100016-ID", "ID_TTAMedicationDetail");
			fields[145] = new ims.framework.ReportField(this.context, "_cv_Clinical.EDischargeMeds", "BO-1099100016-OTHERMEDICATIONTEXT", "OtherMedicationText");
			fields[146] = new ims.framework.ReportField(this.context, "_cv_Clinical.EDischargeMeds", "BO-1099100016-DOSEVALUE", "DoseValue");
			fields[147] = new ims.framework.ReportField(this.context, "_cv_Clinical.EDischargeMeds", "BO-1099100016-DOSEUNIT", "DoseUnit");
			fields[148] = new ims.framework.ReportField(this.context, "_cv_Clinical.EDischargeMeds", "BO-1099100016-FORM", "Form");
			fields[149] = new ims.framework.ReportField(this.context, "_cv_Clinical.EDischargeMeds", "BO-1099100016-ROUTE", "Route");
			fields[150] = new ims.framework.ReportField(this.context, "_cv_Clinical.EDischargeMeds", "BO-1099100016-FREQUENCYVALUE", "FrequencyValue");
			fields[151] = new ims.framework.ReportField(this.context, "_cv_Clinical.EDischargeMeds", "BO-1099100016-FREQUENCYUNIT", "FrequencyUnit");
			fields[152] = new ims.framework.ReportField(this.context, "_cv_Clinical.EDischargeMeds", "BO-1099100016-COMMENCEDDATE", "CommencedDate");
			fields[153] = new ims.framework.ReportField(this.context, "_cv_Clinical.EDischargeMeds", "BO-1099100016-DURATIONVALUE", "DurationValue");
			fields[154] = new ims.framework.ReportField(this.context, "_cv_Clinical.EDischargeMeds", "BO-1099100016-DURATIONUNIT", "DurationUnit");
			fields[155] = new ims.framework.ReportField(this.context, "_cv_Clinical.EDischargeMeds", "BO-1099100016-CLINICALCOMMENTSFORPHARMACY", "ClinicalCommentsForPharmacy");
			fields[156] = new ims.framework.ReportField(this.context, "_cv_Clinical.EDischargeMeds", "BO-1099100016-MEDICATIONINSTRUCTIONSFORPATIENT", "MedicationInstructionsForPatient");
			fields[157] = new ims.framework.ReportField(this.context, "_cv_Clinical.EDischargeMeds", "BO-1099100016-PRESCRIBERCONTACTED", "PrescriberContacted");
			fields[158] = new ims.framework.ReportField(this.context, "_cv_Clinical.EDischargeMeds", "BO-1099100016-UNITTEXT", "UnitText");
			fields[159] = new ims.framework.ReportField(this.context, "_cv_Clinical.eDischargePharmacyApprovalTTADockedPrinted", "BO-1099100017-ID", "ID_TTAStatus");
			fields[160] = new ims.framework.ReportField(this.context, "_cv_Clinical.eDischargePharmacyApprovalTTADockedPrinted", "BO-1099100017-STATUS", "Status");
			fields[161] = new ims.framework.ReportField(this.context, "_cv_Clinical.eDischargePharmacyApprovalTTADockedPrinted", "BO-1099100017-STATUSDATETIME", "StatusDateTime");
			fields[162] = new ims.framework.ReportField(this.context, "_cv_Clinical.eDischargePharmacyApprovalTTADockedPrinted", "BO-1099100017-REASONFORREJECTION", "ReasonForRejection");
			fields[163] = new ims.framework.ReportField(this.context, "_cv_Clinical.eDischargePharmacyApprovalTTADockedPrinted", "BO-1099100017-REASONFORSUSPENSION", "ReasonForSuspension");
			fields[164] = new ims.framework.ReportField(this.context, "_cv_Clinical.eDischargePharmacyApprovalTTADispense", "BO-1099100017-ID", "ID_TTAStatus");
			fields[165] = new ims.framework.ReportField(this.context, "_cv_Clinical.eDischargePharmacyApprovalTTADispense", "BO-1099100017-STATUS", "Status");
			fields[166] = new ims.framework.ReportField(this.context, "_cv_Clinical.eDischargePharmacyApprovalTTADispense", "BO-1099100017-STATUSDATETIME", "StatusDateTime");
			fields[167] = new ims.framework.ReportField(this.context, "_cv_Clinical.eDischargePharmacyApprovalTTADispense", "BO-1099100017-REASONFORREJECTION", "ReasonForRejection");
			fields[168] = new ims.framework.ReportField(this.context, "_cv_Clinical.eDischargePharmacyApprovalTTADispense", "BO-1099100017-REASONFORSUSPENSION", "ReasonForSuspension");
			fields[169] = new ims.framework.ReportField(this.context, "_cv_Clinical.eDischargePharmacyApprovalTTAPharmacySystemDetails", "BO-1099100017-ID", "ID_TTAStatus");
			fields[170] = new ims.framework.ReportField(this.context, "_cv_Clinical.eDischargePharmacyApprovalTTAPharmacySystemDetails", "BO-1099100017-STATUS", "Status");
			fields[171] = new ims.framework.ReportField(this.context, "_cv_Clinical.eDischargePharmacyApprovalTTAPharmacySystemDetails", "BO-1099100017-STATUSDATETIME", "StatusDateTime");
			fields[172] = new ims.framework.ReportField(this.context, "_cv_Clinical.eDischargePharmacyApprovalTTAPharmacySystemDetails", "BO-1099100017-REASONFORREJECTION", "ReasonForRejection");
			fields[173] = new ims.framework.ReportField(this.context, "_cv_Clinical.eDischargePharmacyApprovalTTAPharmacySystemDetails", "BO-1099100017-REASONFORSUSPENSION", "ReasonForSuspension");
			fields[174] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargePharmacyApprovalComponent.__internal_x_context__EditedRecord_" + componentIdentifier, "BO-1099100015-ID", "ID_TTAMedicationAndPharmacy");
			fields[175] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargePharmacyApprovalComponent.__internal_x_context__EditedRecord_" + componentIdentifier, "BO-1099100015-BODYWEIGHTKG", "BodyWeightKg");
			fields[176] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargePharmacyApprovalComponent.__internal_x_context__EditedRecord_" + componentIdentifier, "BO-1099100015-CLINICALCOMMENTSTOPHARMACY", "ClinicalCommentsToPharmacy");
			fields[177] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargePharmacyApprovalComponent.__internal_x_context__EditedRecord_" + componentIdentifier, "BO-1099100015-ORDERINGDATETIME", "OrderingDateTime");
			fields[178] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargePharmacyApprovalComponent.__internal_x_context__EditedRecord_" + componentIdentifier, "BO-1099100015-CLINICIANBLEEPNO", "ClinicianBleepNo");
			fields[179] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargePharmacyApprovalComponent.__internal_x_context__EditedRecord_" + componentIdentifier, "BO-1099100015-DATESUBMITTEDTOPHARMACY", "DateSubmittedToPharmacy");
			fields[180] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargePharmacyApprovalComponent.__internal_x_context__EditedMedicalRecord_" + componentIdentifier, "BO-1099100016-ID", "ID_TTAMedicationDetail");
			fields[181] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargePharmacyApprovalComponent.__internal_x_context__EditedMedicalRecord_" + componentIdentifier, "BO-1099100016-OTHERMEDICATIONTEXT", "OtherMedicationText");
			fields[182] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargePharmacyApprovalComponent.__internal_x_context__EditedMedicalRecord_" + componentIdentifier, "BO-1099100016-DOSEVALUE", "DoseValue");
			fields[183] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargePharmacyApprovalComponent.__internal_x_context__EditedMedicalRecord_" + componentIdentifier, "BO-1099100016-DOSEUNIT", "DoseUnit");
			fields[184] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargePharmacyApprovalComponent.__internal_x_context__EditedMedicalRecord_" + componentIdentifier, "BO-1099100016-FORM", "Form");
			fields[185] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargePharmacyApprovalComponent.__internal_x_context__EditedMedicalRecord_" + componentIdentifier, "BO-1099100016-ROUTE", "Route");
			fields[186] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargePharmacyApprovalComponent.__internal_x_context__EditedMedicalRecord_" + componentIdentifier, "BO-1099100016-FREQUENCYVALUE", "FrequencyValue");
			fields[187] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargePharmacyApprovalComponent.__internal_x_context__EditedMedicalRecord_" + componentIdentifier, "BO-1099100016-FREQUENCYUNIT", "FrequencyUnit");
			fields[188] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargePharmacyApprovalComponent.__internal_x_context__EditedMedicalRecord_" + componentIdentifier, "BO-1099100016-COMMENCEDDATE", "CommencedDate");
			fields[189] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargePharmacyApprovalComponent.__internal_x_context__EditedMedicalRecord_" + componentIdentifier, "BO-1099100016-DURATIONVALUE", "DurationValue");
			fields[190] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargePharmacyApprovalComponent.__internal_x_context__EditedMedicalRecord_" + componentIdentifier, "BO-1099100016-DURATIONUNIT", "DurationUnit");
			fields[191] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargePharmacyApprovalComponent.__internal_x_context__EditedMedicalRecord_" + componentIdentifier, "BO-1099100016-CLINICALCOMMENTSFORPHARMACY", "ClinicalCommentsForPharmacy");
			fields[192] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargePharmacyApprovalComponent.__internal_x_context__EditedMedicalRecord_" + componentIdentifier, "BO-1099100016-MEDICATIONINSTRUCTIONSFORPATIENT", "MedicationInstructionsForPatient");
			fields[193] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargePharmacyApprovalComponent.__internal_x_context__EditedMedicalRecord_" + componentIdentifier, "BO-1099100016-PRESCRIBERCONTACTED", "PrescriberContacted");
			fields[194] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargePharmacyApprovalComponent.__internal_x_context__EditedMedicalRecord_" + componentIdentifier, "BO-1099100016-UNITTEXT", "UnitText");
			fields[195] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargePharmacyApprovalComponent.__internal_x_context__CurrentStatus_" + componentIdentifier, "BO-1099100017-ID", "ID_TTAStatus");
			fields[196] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargePharmacyApprovalComponent.__internal_x_context__CurrentStatus_" + componentIdentifier, "BO-1099100017-STATUS", "Status");
			fields[197] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargePharmacyApprovalComponent.__internal_x_context__CurrentStatus_" + componentIdentifier, "BO-1099100017-STATUSDATETIME", "StatusDateTime");
			fields[198] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargePharmacyApprovalComponent.__internal_x_context__CurrentStatus_" + componentIdentifier, "BO-1099100017-REASONFORREJECTION", "ReasonForRejection");
			fields[199] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargePharmacyApprovalComponent.__internal_x_context__CurrentStatus_" + componentIdentifier, "BO-1099100017-REASONFORSUSPENSION", "ReasonForSuspension");
			fields[200] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargePharmacyApprovalComponent.__internal_x_context__Summary_" + componentIdentifier, "BO-1099100018-ID", "ID_Summary");
			fields[201] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargePharmacyApprovalComponent.__internal_x_context__Summary_" + componentIdentifier, "BO-1099100018-CARECONTEXT", "CareContext");
			fields[202] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargePharmacyApprovalComponent.__internal_x_context__Summary_" + componentIdentifier, "BO-1099100018-ADMISSIONDATETIME", "AdmissionDateTime");
			fields[203] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargePharmacyApprovalComponent.__internal_x_context__Summary_" + componentIdentifier, "BO-1099100018-TTASTATUS", "TTAStatus");
			fields[204] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargePharmacyApprovalComponent.__internal_x_context__Summary_" + componentIdentifier, "BO-1099100018-HASHADANYPROCEDURESPERFORMED", "HasHadAnyProceduresPerformed");
			fields[205] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargePharmacyApprovalComponent.__internal_x_context__Summary_" + componentIdentifier, "BO-1099100018-ADDITONALCLINICALINFO", "AdditonalClinicalInfo");
			fields[206] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargePharmacyApprovalComponent.__internal_x_context__Summary_" + componentIdentifier, "BO-1099100018-DISCHARGELETTERSTATUS", "DischargeLetterStatus");
			fields[207] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargePharmacyApprovalComponent.__internal_x_context__Summary_" + componentIdentifier, "BO-1099100018-DISCHARGESUPPLEMENTARYLETTERSTATUS", "DischargeSupplementaryLetterStatus");
			fields[208] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargePharmacyApprovalComponent.__internal_x_context__Summary_" + componentIdentifier, "BO-1099100018-DISCHARGEDETAILS", "DischargeDetails");
			return fields;
		}
