...
public class GenForm extends FormBridge
{
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, "_cv_Clinical.HospitalAtNightPatientDetails", "BO-1072100096-ID", "ID_HospitalAtNightPatientDetail");
			fields[145] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.HospitalAtNightWorklist.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1072100096-ID", "ID_HospitalAtNightPatientDetail");
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.HospitalAtNightWorklist.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1072100096-MEWS", "MEWS");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.HospitalAtNightWorklist.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1072100096-TYPEOFREQUEST", "TypeOfRequest");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.HospitalAtNightWorklist.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1072100096-REQUESTINGDATETIME", "RequestingDateTime");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.HospitalAtNightWorklist.__internal_x_context__LoggedHCP_" + componentIdentifier, "BO-1006100000-ID", "ID_Hcp");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.HospitalAtNightWorklist.__internal_x_context__LoggedHCP_" + componentIdentifier, "BO-1006100000-HCPTYPE", "HcpType");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.HospitalAtNightWorklist.__internal_x_context__LoggedHCP_" + componentIdentifier, "BO-1006100000-ISACTIVE", "IsActive");
			fields[152] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.HospitalAtNightWorklist.__internal_x_context__LoggedHCP_" + componentIdentifier, "BO-1006100000-ISHCPARESPONSIBLEHCP", "IsHCPaResponsibleHCP");
			fields[153] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.HospitalAtNightWorklist.__internal_x_context__LoggedHCP_" + componentIdentifier, "BO-1006100000-ISARESPONSIBLEEDCLINICIAN", "IsAResponsibleEDClinician");
			fields[154] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.HospitalAtNightWorklist.__internal_x_context__LoggedHCP_" + componentIdentifier, "BO-1006100000-ISHCPAENDOSCOPIST", "IsHCPaEndoscopist");
			return fields;
		}
