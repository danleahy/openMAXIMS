...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "InternalReferralsListGridComponent";
	}
	public int getWidth()
	{
		return 768;
	...
	{
		return new String[] { "_cv_Clinical.ClinicalReferralRef", "_cv_Clinical.LinkedPatientDocument", "_cv_Core.RieMessage", "_cv_Core.PatientDocumentsCollectionForClinicalReferral" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Clinical.InternalReferralsListGridComponent.__internal_x_context__" + String.valueOf(getFormId());
	}
