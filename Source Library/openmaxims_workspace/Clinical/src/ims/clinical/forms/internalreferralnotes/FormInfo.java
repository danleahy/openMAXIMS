...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Clinical.ClinicalReferraNotes" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Clinical.InternalReferralNotes.__internal_x_context__" + String.valueOf(getFormId());
	}
