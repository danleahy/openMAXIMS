...
public class GenForm extends FormBridge
{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		// Panel Controls
		RuntimeAnchoring anchoringHelper1 = new RuntimeAnchoring(designSize, runtimeSize, 8, 352, 836, 184, ims.framework.enumerations.ControlAnchoring.ALL);
		...
		RuntimeAnchoring anchoringHelper2 = new RuntimeAnchoring(designSize, runtimeSize, 8, 8, 836, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT);
		...
		RuntimeAnchoring anchoringHelper3 = new RuntimeAnchoring(designSize, runtimeSize, 168, 454, 256, 20, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		ims.framework.FormUiLogic m_ccHCPForm = loader.loadComponent(102256, appForm, startControlID * 10 + 1000, anchoringHelper3.getSize(), instance1, startTabIndex.intValue() + 3, skipContextValidation);
		//ims.framework.Control m_ccHCPControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1002), new Integer(168), new Integer(454), new Integer(256), new Integer(20), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, new Integer(startTabIndex.intValue() + 3), m_ccHCPForm, instance1 } );
		ims.framework.Control m_ccHCPControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1003),  new Integer(anchoringHelper3.getX()), new Integer(anchoringHelper3.getY()), new Integer(anchoringHelper3.getWidth()), new Integer(anchoringHelper3.getHeight()), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, new Integer(startTabIndex.intValue() + 3), m_ccHCPForm, instance1, Boolean.FALSE } );
		...
		// Label Controls
		RuntimeAnchoring anchoringHelper4 = new RuntimeAnchoring(designSize, runtimeSize, 312, 392, 80, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1004), new Integer(anchoringHelper4.getX()), new Integer(anchoringHelper4.getY()), new Integer(anchoringHelper4.getWidth()), new Integer(anchoringHelper4.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Not Specified", new Integer(1), null, new Integer(0)}));
		RuntimeAnchoring anchoringHelper5 = new RuntimeAnchoring(designSize, runtimeSize, 216, 392, 67, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1005), new Integer(anchoringHelper5.getX()), new Integer(anchoringHelper5.getY()), new Integer(anchoringHelper5.getWidth()), new Integer(anchoringHelper5.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Diagnoses:", new Integer(1), null, new Integer(0)}));
		RuntimeAnchoring anchoringHelper6 = new RuntimeAnchoring(designSize, runtimeSize, 168, 433, 103, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1006), new Integer(anchoringHelper6.getX()), new Integer(anchoringHelper6.getY()), new Integer(anchoringHelper6.getWidth()), new Integer(anchoringHelper6.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "<<VTE Status>>", new Integer(1), null, new Integer(0)}));
		RuntimeAnchoring anchoringHelper7 = new RuntimeAnchoring(designSize, runtimeSize, 21, 433, 140, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1007), new Integer(anchoringHelper7.getX()), new Integer(anchoringHelper7.getY()), new Integer(anchoringHelper7.getWidth()), new Integer(anchoringHelper7.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "VTE Assessment Status:", new Integer(1), null, new Integer(0)}));
		RuntimeAnchoring anchoringHelper8 = new RuntimeAnchoring(designSize, runtimeSize, 168, 411, 186, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1008), new Integer(anchoringHelper8.getX()), new Integer(anchoringHelper8.getY()), new Integer(anchoringHelper8.getWidth()), new Integer(anchoringHelper8.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "<<Dementia Worklist status>>", new Integer(1), null, new Integer(0)}));
		RuntimeAnchoring anchoringHelper9 = new RuntimeAnchoring(designSize, runtimeSize, 21, 411, 123, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1009), new Integer(anchoringHelper9.getX()), new Integer(anchoringHelper9.getY()), new Integer(anchoringHelper9.getWidth()), new Integer(anchoringHelper9.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Dementia Screening:", new Integer(1), null, new Integer(0)}));
		RuntimeAnchoring anchoringHelper10 = new RuntimeAnchoring(designSize, runtimeSize, 312, 375, 102, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1010), new Integer(anchoringHelper10.getX()), new Integer(anchoringHelper10.getY()), new Integer(anchoringHelper10.getWidth()), new Integer(anchoringHelper10.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "NOT COMPLETED", new Integer(1), null, new Integer(0)}));
		RuntimeAnchoring anchoringHelper11 = new RuntimeAnchoring(designSize, runtimeSize, 216, 375, 85, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1011), new Integer(anchoringHelper11.getX()), new Integer(anchoringHelper11.getY()), new Integer(anchoringHelper11.getWidth()), new Integer(anchoringHelper11.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "TTA Required:", new Integer(1), null, new Integer(0)}));
		RuntimeAnchoring anchoringHelper12 = new RuntimeAnchoring(designSize, runtimeSize, 21, 390, 66, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1012), new Integer(anchoringHelper12.getX()), new Integer(anchoringHelper12.getY()), new Integer(anchoringHelper12.getWidth()), new Integer(anchoringHelper12.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Complete :", new Integer(1), null, new Integer(0)}));
		RuntimeAnchoring anchoringHelper13 = new RuntimeAnchoring(designSize, runtimeSize, 448, 451, 100, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1013), new Integer(anchoringHelper13.getX()), new Integer(anchoringHelper13.getY()), new Integer(anchoringHelper13.getWidth()), new Integer(anchoringHelper13.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Distribution List:", new Integer(1), null, new Integer(0)}));
		RuntimeAnchoring anchoringHelper14 = new RuntimeAnchoring(designSize, runtimeSize, 232, 479, 87, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1014), new Integer(anchoringHelper14.getX()), new Integer(anchoringHelper14.getY()), new Integer(anchoringHelper14.getWidth()), new Integer(anchoringHelper14.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "<< specialty >>", new Integer(0), null, new Integer(0)}));
		RuntimeAnchoring anchoringHelper15 = new RuntimeAnchoring(designSize, runtimeSize, 21, 503, 118, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1015), new Integer(anchoringHelper15.getX()), new Integer(anchoringHelper15.getY()), new Integer(anchoringHelper15.getWidth()), new Integer(anchoringHelper15.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Date of Completion:", new Integer(1), null, new Integer(0)}));
		RuntimeAnchoring anchoringHelper16 = new RuntimeAnchoring(designSize, runtimeSize, 61, 479, 73, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1016), new Integer(anchoringHelper16.getX()), new Integer(anchoringHelper16.getY()), new Integer(anchoringHelper16.getWidth()), new Integer(anchoringHelper16.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "<< grade >>", new Integer(0), null, new Integer(0)}));
		RuntimeAnchoring anchoringHelper17 = new RuntimeAnchoring(designSize, runtimeSize, 21, 479, 42, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1017), new Integer(anchoringHelper17.getX()), new Integer(anchoringHelper17.getY()), new Integer(anchoringHelper17.getWidth()), new Integer(anchoringHelper17.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Grade:", new Integer(1), null, new Integer(0)}));
		RuntimeAnchoring anchoringHelper18 = new RuntimeAnchoring(designSize, runtimeSize, 21, 456, 32, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1018), new Integer(anchoringHelper18.getX()), new Integer(anchoringHelper18.getY()), new Integer(anchoringHelper18.getWidth()), new Integer(anchoringHelper18.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "HCP:", new Integer(1), null, new Integer(0)}));
		RuntimeAnchoring anchoringHelper19 = new RuntimeAnchoring(designSize, runtimeSize, 169, 479, 60, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1019), new Integer(anchoringHelper19.getX()), new Integer(anchoringHelper19.getY()), new Integer(anchoringHelper19.getWidth()), new Integer(anchoringHelper19.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Specialty:", new Integer(1), null, new Integer(0)}));
		RuntimeAnchoring anchoringHelper20 = new RuntimeAnchoring(designSize, runtimeSize, 21, 375, 88, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1020), new Integer(anchoringHelper20.getX()), new Integer(anchoringHelper20.getY()), new Integer(anchoringHelper20.getWidth()), new Integer(anchoringHelper20.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Clinical Details", new Integer(1), null, new Integer(0)}));

		// Button Controls
		RuntimeAnchoring anchoringHelper21 = new RuntimeAnchoring(designSize, runtimeSize, 8, 544, 75, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT);
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1021), new Integer(anchoringHelper21.getX()), new Integer(anchoringHelper21.getY()), new Integer(anchoringHelper21.getWidth()), new Integer(anchoringHelper21.getHeight()), new Integer(startTabIndex.intValue() + 9), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Edit", Boolean.TRUE, null, Boolean.FALSE, Boolean.FALSE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		RuntimeAnchoring anchoringHelper23 = new RuntimeAnchoring(designSize, runtimeSize, 770, 544, 75, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT);
		...
		RuntimeAnchoring anchoringHelper24 = new RuntimeAnchoring(designSize, runtimeSize, 448, 504, 75, 23, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		// Date Time Controls
		RuntimeAnchoring anchoringHelper25 = new RuntimeAnchoring(designSize, runtimeSize, 168, 501, 240, 20, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		// CheckBox Controls
		RuntimeAnchoring anchoringHelper26 = new RuntimeAnchoring(designSize, runtimeSize, 168, 384, 16, 16, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		// Grid Controls
		RuntimeAnchoring anchoringHelper27 = new RuntimeAnchoring(designSize, runtimeSize, 576, 451, 256, 61, ims.framework.enumerations.ControlAnchoring.ALL);
		...
		RuntimeAnchoring anchoringHelper28 = new RuntimeAnchoring(designSize, runtimeSize, 448, 374, 364, 72, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		RuntimeAnchoring anchoringHelper29 = new RuntimeAnchoring(designSize, runtimeSize, 411, 422, 24, 24, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(ImageButton.class, new Object[] { control, new Integer(startControlID.intValue() + 1029), new Integer(anchoringHelper29.getX()), new Integer(anchoringHelper29.getY()), new Integer(anchoringHelper29.getWidth()), new Integer(anchoringHelper29.getHeight()), new Integer(-1), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, this.getImages().OCRR.UpdatedResult, this.getImages().OCRR.UpdatedResult, null, Boolean.FALSE, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null}));

		// HTML Viewer Controls
		RuntimeAnchoring anchoringHelper30 = new RuntimeAnchoring(designSize, runtimeSize, 8, 36, 836, 312, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT);
	...
	public Label lblDiagnosisRequired()
	{
	...
	public DynamicGrid dyngrdSummary()
	{
		return (DynamicGrid)super.getControl(27);
	}
	public ImageButton imbDementia()
	{
	...
	public class LocalContext extends ContextBridge
	{
		...
		public LocalContext(Context context, ims.framework.FormInfo formInfo, String componentIdentifier)
		{
			...
			cxl_TTAMedicationDetails = new ims.framework.ContextVariable("TTAMedicationDetails", prefix + "_lv_Clinical.EDischargePreViewComponent.__internal_x_context__TTAMedicationDetails_" + componentIdentifier + "");
		}
		...
		public boolean getTTAMedicationDetailsIsNotNull()
		{
			return !cxl_TTAMedicationDetails.getValueIsNull(context);
		}
		public ims.clinical.vo.DischargeMedicationDetailsLiteVo getTTAMedicationDetails()
		{
			return (ims.clinical.vo.DischargeMedicationDetailsLiteVo)cxl_TTAMedicationDetails.getValue(context);
		}
		public void setTTAMedicationDetails(ims.clinical.vo.DischargeMedicationDetailsLiteVo value)
		{
			cxl_TTAMedicationDetails.setValue(context, value);
		}
		private ims.framework.ContextVariable cxl_TTAMedicationDetails = null;
	}
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargePreViewComponent.__internal_x_context__EditedRecord_" + componentIdentifier, "BO-1099100004-ID", "ID_DischargeReportDetail");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargePreViewComponent.__internal_x_context__EditedRecord_" + componentIdentifier, "BO-1099100004-CARECONTEXT", "CareContext");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargePreViewComponent.__internal_x_context__EditedRecord_" + componentIdentifier, "BO-1099100004-DATEOFCOMPLETION", "DateOfCompletion");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargePreViewComponent.__internal_x_context__EditedRecord_" + componentIdentifier, "BO-1099100004-COPYLETTERTOPATIENT", "CopyLetterToPatient");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargePreViewComponent.__internal_x_context__EditedRecord_" + componentIdentifier, "BO-1099100004-ISCLINICALDETAILSCOMPLETE", "IsClinicalDetailsComplete");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargePreViewComponent.__internal_x_context__DischargeDocument_" + componentIdentifier, "BO-1068100001-ID", "ID_PatientDocument");
			fields[152] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargePreViewComponent.__internal_x_context__DischargeDocument_" + componentIdentifier, "BO-1068100001-PATIENT", "Patient");
			fields[153] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargePreViewComponent.__internal_x_context__DischargeDocument_" + componentIdentifier, "BO-1068100001-EPISODEOFCARE", "EpisodeofCare");
			fields[154] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargePreViewComponent.__internal_x_context__DischargeDocument_" + componentIdentifier, "BO-1068100001-CARECONTEXT", "CareContext");
			fields[155] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargePreViewComponent.__internal_x_context__DischargeDocument_" + componentIdentifier, "BO-1068100001-CLINICALCONTACT", "ClinicalContact");
			fields[156] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargePreViewComponent.__internal_x_context__DischargeDocument_" + componentIdentifier, "BO-1068100001-REFERRAL", "Referral");
			fields[157] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargePreViewComponent.__internal_x_context__DischargeDocument_" + componentIdentifier, "BO-1068100001-NAME", "Name");
			fields[158] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargePreViewComponent.__internal_x_context__DischargeDocument_" + componentIdentifier, "BO-1068100001-CREATIONTYPE", "CreationType");
			fields[159] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargePreViewComponent.__internal_x_context__DischargeDocument_" + componentIdentifier, "BO-1068100001-CATEGORY", "Category");
			fields[160] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargePreViewComponent.__internal_x_context__DischargeDocument_" + componentIdentifier, "BO-1068100001-STATUS", "Status");
			fields[161] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargePreViewComponent.__internal_x_context__DischargeDocument_" + componentIdentifier, "BO-1068100001-RECORDINGUSER", "RecordingUser");
			fields[162] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargePreViewComponent.__internal_x_context__DischargeDocument_" + componentIdentifier, "BO-1068100001-RECORDINGDATETIME", "RecordingDateTime");
			fields[163] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargePreViewComponent.__internal_x_context__DischargeDocument_" + componentIdentifier, "BO-1068100001-AUTHORINGHCP", "AuthoringHCP");
			fields[164] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargePreViewComponent.__internal_x_context__DischargeDocument_" + componentIdentifier, "BO-1068100001-AUTHORINGDATETIME", "AuthoringDateTime");
			fields[165] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargePreViewComponent.__internal_x_context__DischargeDocument_" + componentIdentifier, "BO-1068100001-SPECIALTY", "Specialty");
			fields[166] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargePreViewComponent.__internal_x_context__DischargeDocument_" + componentIdentifier, "BO-1068100001-CORRESPONDENCESTATUS", "CorrespondenceStatus");
			fields[167] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargePreViewComponent.__internal_x_context__DischargeDocument_" + componentIdentifier, "BO-1068100001-DOCUMENTDATE", "DocumentDate");
			fields[168] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargePreViewComponent.__internal_x_context__DischargeDocument_" + componentIdentifier, "BO-1068100001-CLINIC", "Clinic");
			fields[169] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargePreViewComponent.__internal_x_context__DischargeDocument_" + componentIdentifier, "BO-1068100001-ISLOCKEDFOREDITING", "IsLockedForEditing");
			fields[170] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargePreViewComponent.__internal_x_context__DischargeDocument_" + componentIdentifier, "BO-1068100001-LOCKEDBYUSER", "LockedByUser");
			fields[171] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargePreViewComponent.__internal_x_context__DischargeDocument_" + componentIdentifier, "BO-1068100001-LOCKEDONDATETIME", "LockedOnDateTime");
			fields[172] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargePreViewComponent.__internal_x_context__DischargeDocument_" + componentIdentifier, "BO-1068100001-RESPONSIBLEHCP", "ResponsibleHCP");
			fields[173] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargePreViewComponent.__internal_x_context__DischargeDocument_" + componentIdentifier, "BO-1068100001-NOOFCOPIES", "NoOfCopies");
			fields[174] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargePreViewComponent.__internal_x_context__DischargeDocument_" + componentIdentifier, "BO-1068100001-HISTORICALFILENAME", "HistoricalFileName");
			fields[175] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargePreViewComponent.__internal_x_context__DischargeDocument_" + componentIdentifier, "BO-1068100001-HISTORICDOCID", "HistoricDocId");
			fields[176] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargePreViewComponent.__internal_x_context__DischargeDocument_" + componentIdentifier, "BO-1068100001-WASPRINTED", "WasPrinted");
			fields[177] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargePreViewComponent.__internal_x_context__DischargeDocument_" + componentIdentifier, "BO-1068100001-EMAILSTATUS", "EmailStatus");
			fields[178] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargePreViewComponent.__internal_x_context__DischargeDocument_" + componentIdentifier, "BO-1068100001-COPYPATIENTONCORRESPONDENCE", "CopyPatientOnCorrespondence");
			fields[179] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargePreViewComponent.__internal_x_context__DischargeDocument_" + componentIdentifier, "BO-1068100001-HASENCLOSURE", "HasEnclosure");
			fields[180] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargePreViewComponent.__internal_x_context__DementiaStatus_" + componentIdentifier, "BO-1003100117-ID", "ID_Dementia");
			fields[181] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargePreViewComponent.__internal_x_context__DementiaStatus_" + componentIdentifier, "BO-1003100117-DISCHARGEDATETIME", "DischargeDateTime");
			fields[182] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargePreViewComponent.__internal_x_context__TTAMedicationDetails_" + componentIdentifier, "BO-1099100002-ID", "ID_MedicationDetails");
			fields[183] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargePreViewComponent.__internal_x_context__TTAMedicationDetails_" + componentIdentifier, "BO-1099100002-CARECONTEXT", "CareContext");
			fields[184] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargePreViewComponent.__internal_x_context__TTAMedicationDetails_" + componentIdentifier, "BO-1099100002-TTAREQUIRED", "TTARequired");
			return fields;
		}
