...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "TheatreSafeyBriefDelayDialog";
	}
	public int getWidth()
	{
		return 520;
	...
	{
		return new String[] { "_cv_Scheduling.TheatreSession" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Clinical.TheatreSafeyBriefDelayDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
