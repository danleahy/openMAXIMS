...
public class GenForm extends FormBridge
{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1012), new Integer(anchoringHelper14.getX()), new Integer(anchoringHelper14.getY()), new Integer(anchoringHelper14.getWidth()), new Integer(anchoringHelper14.getHeight()), new Integer(startTabIndex.intValue() + 18), ControlState.UNKNOWN, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Status History", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1017), new Integer(anchoringHelper19.getX()), new Integer(anchoringHelper19.getY()), new Integer(anchoringHelper19.getWidth()), new Integer(anchoringHelper19.getHeight()), new Integer(startTabIndex.intValue() + 17), ControlState.UNKNOWN, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Submit TTA", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1018), new Integer(anchoringHelper20.getX()), new Integer(anchoringHelper20.getY()), new Integer(anchoringHelper20.getWidth()), new Integer(anchoringHelper20.getHeight()), new Integer(startTabIndex.intValue() + 13), ControlState.DISABLED, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.TOPRIGHT,Boolean.TRUE, new Integer(0), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
		...
		super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1020), new Integer(anchoringHelper22.getX()), new Integer(anchoringHelper22.getY()), new Integer(anchoringHelper22.getWidth()), new Integer(anchoringHelper22.getHeight()), new Integer(startTabIndex.intValue() + 12), ControlState.DISABLED, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.TOPRIGHT,Boolean.FALSE, new Integer(0), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
		...
		super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1021), new Integer(anchoringHelper23.getX()), new Integer(anchoringHelper23.getY()), new Integer(anchoringHelper23.getWidth()), new Integer(anchoringHelper23.getHeight()), new Integer(startTabIndex.intValue() + 11), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT,Boolean.FALSE, new Integer(25), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.TRUE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
		...
		super.addControl(factory.getControl(DateTimeControl.class, new Object[] { control, new Integer(startControlID.intValue() + 1023), new Integer(anchoringHelper25.getX()), new Integer(anchoringHelper25.getY()), new Integer(anchoringHelper25.getWidth()), new Integer(anchoringHelper25.getHeight()), new Integer(startTabIndex.intValue() + 10), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT,Boolean.TRUE, null, Boolean.FALSE, null, Boolean.TRUE, null}));
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[159] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeMedsSthkComponent.__internal_x_context__EditedMedicalRecord_" + componentIdentifier, "BO-1099100016-ID", "ID_TTAMedicationDetail");
			fields[160] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeMedsSthkComponent.__internal_x_context__EditedMedicalRecord_" + componentIdentifier, "BO-1099100016-OTHERMEDICATIONTEXT", "OtherMedicationText");
			fields[161] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeMedsSthkComponent.__internal_x_context__EditedMedicalRecord_" + componentIdentifier, "BO-1099100016-DOSEVALUE", "DoseValue");
			fields[162] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeMedsSthkComponent.__internal_x_context__EditedMedicalRecord_" + componentIdentifier, "BO-1099100016-DOSEUNIT", "DoseUnit");
			fields[163] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeMedsSthkComponent.__internal_x_context__EditedMedicalRecord_" + componentIdentifier, "BO-1099100016-FORM", "Form");
			fields[164] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeMedsSthkComponent.__internal_x_context__EditedMedicalRecord_" + componentIdentifier, "BO-1099100016-ROUTE", "Route");
			fields[165] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeMedsSthkComponent.__internal_x_context__EditedMedicalRecord_" + componentIdentifier, "BO-1099100016-FREQUENCYVALUE", "FrequencyValue");
			fields[166] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeMedsSthkComponent.__internal_x_context__EditedMedicalRecord_" + componentIdentifier, "BO-1099100016-FREQUENCYUNIT", "FrequencyUnit");
			fields[167] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeMedsSthkComponent.__internal_x_context__EditedMedicalRecord_" + componentIdentifier, "BO-1099100016-COMMENCEDDATE", "CommencedDate");
			fields[168] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeMedsSthkComponent.__internal_x_context__EditedMedicalRecord_" + componentIdentifier, "BO-1099100016-DURATIONVALUE", "DurationValue");
			fields[169] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeMedsSthkComponent.__internal_x_context__EditedMedicalRecord_" + componentIdentifier, "BO-1099100016-DURATIONUNIT", "DurationUnit");
			fields[170] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeMedsSthkComponent.__internal_x_context__EditedMedicalRecord_" + componentIdentifier, "BO-1099100016-CLINICALCOMMENTSFORPHARMACY", "ClinicalCommentsForPharmacy");
			fields[171] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeMedsSthkComponent.__internal_x_context__EditedMedicalRecord_" + componentIdentifier, "BO-1099100016-MEDICATIONINSTRUCTIONSFORPATIENT", "MedicationInstructionsForPatient");
			fields[172] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeMedsSthkComponent.__internal_x_context__EditedMedicalRecord_" + componentIdentifier, "BO-1099100016-PRESCRIBERCONTACTED", "PrescriberContacted");
			fields[173] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeMedsSthkComponent.__internal_x_context__EditedMedicalRecord_" + componentIdentifier, "BO-1099100016-UNITTEXT", "UnitText");
			fields[174] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeMedsSthkComponent.__internal_x_context__EditedRecord_" + componentIdentifier, "BO-1099100015-ID", "ID_TTAMedicationAndPharmacy");
			fields[175] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeMedsSthkComponent.__internal_x_context__EditedRecord_" + componentIdentifier, "BO-1099100015-BODYWEIGHTKG", "BodyWeightKg");
			fields[176] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeMedsSthkComponent.__internal_x_context__EditedRecord_" + componentIdentifier, "BO-1099100015-CLINICALCOMMENTSTOPHARMACY", "ClinicalCommentsToPharmacy");
			fields[177] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeMedsSthkComponent.__internal_x_context__EditedRecord_" + componentIdentifier, "BO-1099100015-ORDERINGDATETIME", "OrderingDateTime");
			fields[178] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeMedsSthkComponent.__internal_x_context__EditedRecord_" + componentIdentifier, "BO-1099100015-CLINICIANBLEEPNO", "ClinicianBleepNo");
			fields[179] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeMedsSthkComponent.__internal_x_context__EditedRecord_" + componentIdentifier, "BO-1099100015-DATESUBMITTEDTOPHARMACY", "DateSubmittedToPharmacy");
			fields[180] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeMedsSthkComponent.__internal_x_context__CurrentStatus_" + componentIdentifier, "BO-1099100017-ID", "ID_TTAStatus");
			fields[181] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeMedsSthkComponent.__internal_x_context__CurrentStatus_" + componentIdentifier, "BO-1099100017-STATUS", "Status");
			fields[182] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeMedsSthkComponent.__internal_x_context__CurrentStatus_" + componentIdentifier, "BO-1099100017-STATUSDATETIME", "StatusDateTime");
			fields[183] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeMedsSthkComponent.__internal_x_context__CurrentStatus_" + componentIdentifier, "BO-1099100017-REASONFORREJECTION", "ReasonForRejection");
			fields[184] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeMedsSthkComponent.__internal_x_context__CurrentStatus_" + componentIdentifier, "BO-1099100017-REASONFORSUSPENSION", "ReasonForSuspension");
			fields[185] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeMedsSthkComponent.__internal_x_context__Summary_" + componentIdentifier, "BO-1099100018-ID", "ID_Summary");
			fields[186] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeMedsSthkComponent.__internal_x_context__Summary_" + componentIdentifier, "BO-1099100018-CARECONTEXT", "CareContext");
			fields[187] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeMedsSthkComponent.__internal_x_context__Summary_" + componentIdentifier, "BO-1099100018-ADMISSIONDATETIME", "AdmissionDateTime");
			fields[188] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeMedsSthkComponent.__internal_x_context__Summary_" + componentIdentifier, "BO-1099100018-TTASTATUS", "TTAStatus");
			fields[189] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeMedsSthkComponent.__internal_x_context__Summary_" + componentIdentifier, "BO-1099100018-HASHADANYPROCEDURESPERFORMED", "HasHadAnyProceduresPerformed");
			fields[190] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeMedsSthkComponent.__internal_x_context__Summary_" + componentIdentifier, "BO-1099100018-ADDITONALCLINICALINFO", "AdditonalClinicalInfo");
			fields[191] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeMedsSthkComponent.__internal_x_context__Summary_" + componentIdentifier, "BO-1099100018-DISCHARGELETTERSTATUS", "DischargeLetterStatus");
			fields[192] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeMedsSthkComponent.__internal_x_context__Summary_" + componentIdentifier, "BO-1099100018-DISCHARGESUPPLEMENTARYLETTERSTATUS", "DischargeSupplementaryLetterStatus");
			fields[193] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeMedsSthkComponent.__internal_x_context__Summary_" + componentIdentifier, "BO-1099100018-DISCHARGEDETAILS", "DischargeDetails");
			return fields;
		}
