...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "RemoveIntraOpCaseTimesDialog";
	}
	public int getWidth()
	{
		return 440;
	...
	{
		return new String[] { "_cv_Clinical.TheatreAppointmentRef" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Clinical.RemoveIntraOpCaseTimesDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
