...
public class GenForm extends FormBridge
{
	...
	public static class ctnDetailsContainer extends ContainerBridge
	{
		...
		protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
		{
			...
			// Button Controls
			RuntimeAnchoring anchoringHelper5 = new RuntimeAnchoring(designSize, runtimeSize, 744, 168, 75, 23, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
			super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1004), new Integer(anchoringHelper5.getX()), new Integer(anchoringHelper5.getY()), new Integer(anchoringHelper5.getWidth()), new Integer(anchoringHelper5.getHeight()), new Integer(startTabIndex.intValue() + 14), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT, "OK", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
			RuntimeAnchoring anchoringHelper6 = new RuntimeAnchoring(designSize, runtimeSize, 744, 192, 75, 23, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
			super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1005), new Integer(anchoringHelper6.getX()), new Integer(anchoringHelper6.getY()), new Integer(anchoringHelper6.getWidth()), new Integer(anchoringHelper6.getHeight()), new Integer(startTabIndex.intValue() + 15), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT, "Cancel", Boolean.FALSE, null, Boolean.FALSE, Boolean.FALSE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
			...
			ComboBox m_cmbAreaTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1007), new Integer(anchoringHelper8.getX()), new Integer(anchoringHelper8.getY()), new Integer(anchoringHelper8.getWidth()), new Integer(anchoringHelper8.getHeight()), new Integer(startTabIndex.intValue() + 11), ControlState.DISABLED, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.TRUE, new Integer(-1)});
			...
			ComboBox m_qmbRecHCPTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1008), new Integer(anchoringHelper9.getX()), new Integer(anchoringHelper9.getY()), new Integer(anchoringHelper9.getWidth()), new Integer(anchoringHelper9.getHeight()), new Integer(startTabIndex.intValue() + 9), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.TRUE, new Integer(1), null, Boolean.TRUE, new Integer(-1), Boolean.FALSE});
			...
			super.addControl(factory.getControl(ImageButton.class, new Object[] { control, new Integer(startControlID.intValue() + 1009), new Integer(anchoringHelper10.getX()), new Integer(anchoringHelper10.getY()), new Integer(anchoringHelper10.getWidth()), new Integer(anchoringHelper10.getHeight()), new Integer(startTabIndex.intValue() + 13), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT, form_images_local.Admin.Task, form_images_local.Admin.Task_Disabled, null, Boolean.FALSE, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null}));
	
			// Rich Text Controls
			RuntimeAnchoring anchoringHelper11 = new RuntimeAnchoring(designSize, runtimeSize, 112, 56, 624, 160, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT);
			super.addControl(factory.getControl(RichTextControl.class, new Object[] { control, new Integer(startControlID.intValue() + 1010), new Integer(anchoringHelper11.getX()), new Integer(anchoringHelper11.getY()), new Integer(anchoringHelper11.getWidth()), new Integer(anchoringHelper11.getHeight()), new Integer(startTabIndex.intValue() + 12), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT, Boolean.FALSE, Boolean.FALSE, new Integer(0)} ));
		}
	...
	private void validateContext(ims.framework.Context context)
	{
		if(context == null)
			return;
		if(!context.isValidContextType(ims.clinical.vo.lookups.MDTListAorB.class))
			throw new ims.framework.exceptions.CodingRuntimeException("The type 'ims.clinical.vo.lookups.MDTListAorB' of the global context variable 'Core.CurrentMDTListShown' is not supported.");
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1030), new Integer(anchoringHelper31.getX()), new Integer(anchoringHelper31.getY()), new Integer(anchoringHelper31.getWidth()), new Integer(anchoringHelper31.getHeight()), new Integer(startTabIndex.intValue() + 16), ControlState.HIDDEN, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Save", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, "_cv_Clinical.CurrentMDTListAndDates", "BO-1072100028-ID", "ID_MDTListandDates");
			fields[145] = new ims.framework.ReportField(this.context, "_cv_Clinical.CurrentMDTListAndDates", "BO-1072100028-LISTPATIENTISON", "ListPatientisOn");
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.MDTNotes.__internal_x_context__MDTListAndDates_" + componentIdentifier, "BO-1072100028-ID", "ID_MDTListandDates");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.MDTNotes.__internal_x_context__MDTListAndDates_" + componentIdentifier, "BO-1072100028-LISTPATIENTISON", "ListPatientisOn");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.MDTNotes.__internal_x_context__CurrentMDTMeeting_" + componentIdentifier, "BO-1072100024-ID", "ID_MDTMeeting");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.MDTNotes.__internal_x_context__CurrentMDTMeeting_" + componentIdentifier, "BO-1072100024-MDTMEETINGDATE", "MDTMeetingDate");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.MDTNotes.__internal_x_context__CurrentMDTMeeting_" + componentIdentifier, "BO-1072100024-LISTPATIENTISON", "ListPatientisOn");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.MDTNotes.__internal_x_context__CurrentMDTNote_" + componentIdentifier, "BO-1072100023-ID", "ID_MDTNotes");
			fields[152] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.MDTNotes.__internal_x_context__CurrentMDTNote_" + componentIdentifier, "BO-1072100023-AUTHORINGDATETIME", "AuthoringDateTime");
			fields[153] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.MDTNotes.__internal_x_context__CurrentMDTNote_" + componentIdentifier, "BO-1072100023-AREA", "Area");
			fields[154] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.MDTNotes.__internal_x_context__CurrentMDTNote_" + componentIdentifier, "BO-1072100023-NOTES", "Notes");
			fields[155] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.MDTNotes.__internal_x_context__LatestMDTMeeting_" + componentIdentifier, "BO-1072100024-ID", "ID_MDTMeeting");
			fields[156] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.MDTNotes.__internal_x_context__LatestMDTMeeting_" + componentIdentifier, "BO-1072100024-MDTMEETINGDATE", "MDTMeetingDate");
			return fields;
		}
