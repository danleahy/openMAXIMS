...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "FinalAndIncorrectCountIntraOpDialog";
	}
	public int getWidth()
	{
		return 864;
	...
	{
		return new String[] { "_cv_Clinical.TheatreAppointmentRef", "_cv_Clinical.IntraOpCaseStaffDetailRefVo", "_cv_Clinical.FinalCountsIntraOpVo" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Clinical.FinalAndIncorrectCountIntraOpDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
