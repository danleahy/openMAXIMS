...
public class GenForm extends FormBridge
{
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PMHCheckList.__internal_x_context__voPatientPMHChecklist_" + componentIdentifier, "BO-1072100015-ID", "ID_PatientPMHChecklist");
			fields[145] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PMHCheckList.__internal_x_context__voPatientPMHChecklist_" + componentIdentifier, "BO-1072100015-PMHINFOTEXT", "PMHInfoText");
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PMHCheckList.__internal_x_context__voPatientPMHChecklist_" + componentIdentifier, "BO-1072100015-PRESCOMPLAINT", "PresComplaint");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PMHCheckList.__internal_x_context__voPatientPMHChecklist_" + componentIdentifier, "BO-1072100015-CARECONTEXT", "CareContext");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PMHCheckList.__internal_x_context__voPatientPMHChecklistDiagnosis_" + componentIdentifier, "BO-1072100016-ID", "ID_PatientPMHChecklistDiagnosis");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PMHCheckList.__internal_x_context__voPatientPMHChecklistDiagnosis_" + componentIdentifier, "BO-1072100016-SELECTED", "Selected");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PMHCheckList.__internal_x_context__voPatientPMHChecklistDiagnosis_" + componentIdentifier, "BO-1072100016-NOTES", "Notes");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PMHCheckList.__internal_x_context__voPatientPMHChecklistDiagnosis_" + componentIdentifier, "BO-1072100016-SOURCEOFINFORMATION", "SourceofInformation");
			fields[152] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PMHCheckList.__internal_x_context__voPatientPMHChecklistProcedure_" + componentIdentifier, "BO-1072100017-ID", "ID_PatientPMHChecklistProcedure");
			fields[153] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PMHCheckList.__internal_x_context__voPatientPMHChecklistProcedure_" + componentIdentifier, "BO-1072100017-SELECTED", "Selected");
			fields[154] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PMHCheckList.__internal_x_context__voPatientPMHChecklistProcedure_" + componentIdentifier, "BO-1072100017-NOTES", "Notes");
			fields[155] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PMHCheckList.__internal_x_context__voPatientPMHChecklistProcedure_" + componentIdentifier, "BO-1072100017-SOURCEOFINFORMATION", "SourceofInformation");
			fields[156] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PMHCheckList.__internal_x_context__PastMedicalHistory_" + componentIdentifier, "BO-1003100009-ID", "ID_PastMedicalHistory");
			fields[157] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PMHCheckList.__internal_x_context__PastMedicalHistory_" + componentIdentifier, "BO-1003100009-PATIENT", "Patient");
			return fields;
		}
