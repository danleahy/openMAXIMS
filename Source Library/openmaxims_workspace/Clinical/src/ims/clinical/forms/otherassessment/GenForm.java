...
public class GenForm extends FormBridge
{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1011), new Integer(anchoringHelper11.getX()), new Integer(anchoringHelper11.getY()), new Integer(anchoringHelper11.getWidth()), new Integer(anchoringHelper11.getHeight()), new Integer(startTabIndex.intValue() + 7), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "New", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.OtherAssessment.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1003100109-ID", "ID_OtherAssessmentSummary");
			fields[145] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.OtherAssessment.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1003100109-CARECONTEXT", "CareContext");
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.OtherAssessment.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1003100109-ASSESSMENTDATE", "AssessmentDate");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.OtherAssessment.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1003100109-ASSESSMENTNAME", "AssessmentName");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.OtherAssessment.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1003100109-SCORE", "Score");
			return fields;
		}
