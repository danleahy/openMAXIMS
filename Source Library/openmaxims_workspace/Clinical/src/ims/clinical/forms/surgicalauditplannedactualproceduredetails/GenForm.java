...
public class GenForm extends FormBridge
{
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, "_cv_Clinical.CurrentSurgicalAuditProcedureDetail", "BO-1072100103-ID", "ID_SurgicalAuditProcedureDetails");
			fields[145] = new ims.framework.ReportField(this.context, "_cv_Clinical.CurrentSurgicalAuditProcedureDetail", "BO-1072100103-PATIENT", "Patient");
			fields[146] = new ims.framework.ReportField(this.context, "_cv_Clinical.CurrentSurgicalAuditProcedureDetail", "BO-1072100103-CARECONTEXT", "CareContext");
			fields[147] = new ims.framework.ReportField(this.context, "_cv_Clinical.CurrentSurgicalAuditProcedureDetail", "BO-1072100103-ANAESTHETISTNOTREQUIRED", "AnaesthetistNotRequired");
			fields[148] = new ims.framework.ReportField(this.context, "_cv_Clinical.CurrentSurgicalAuditProcedureDetail", "BO-1072100103-ANAESTHETISTASSISTNOTREQUIRED", "AnaesthetistAssistNotRequired");
			fields[149] = new ims.framework.ReportField(this.context, "_cv_Clinical.CurrentSurgicalAuditProcedureDetail", "BO-1072100103-OTHER", "Other");
			fields[150] = new ims.framework.ReportField(this.context, "_cv_Clinical.CurrentSurgicalAuditProcedureDetail", "BO-1072100103-SURGICALCHECKLISTPERFORMED", "SurgicalCheckListPerformed");
			fields[151] = new ims.framework.ReportField(this.context, "_cv_Clinical.CurrentSurgicalAuditProcedureDetail", "BO-1072100103-CHECKLISTNOTPERFORMEDREASON", "CheckListNotPerformedReason");
			fields[152] = new ims.framework.ReportField(this.context, "_cv_Clinical.CurrentSurgicalAuditProcedureDetail", "BO-1072100103-LOCUMANAESTNURSE", "LocumAnaestNurse");
			fields[153] = new ims.framework.ReportField(this.context, "_cv_Clinical.CurrentSurgicalAuditProcedureDetail", "BO-1072100103-LOCUMSCRUBNURSE", "LocumScrubNurse");
			fields[154] = new ims.framework.ReportField(this.context, "_cv_Clinical.CurrentSurgicalAuditProcedureDetail", "BO-1072100103-LOCUMCIRCULATINGNURSE", "LocumCirculatingNurse");
			fields[155] = new ims.framework.ReportField(this.context, "_cv_Clinical.CurrentSurgicalAuditProcedureDetail", "BO-1072100103-ANAESTHETICUSED", "AnaestheticUsed");
			fields[156] = new ims.framework.ReportField(this.context, "_cv_Clinical.CurrentSurgicalAuditProcedureDetail", "BO-1072100103-ANAESTHETICUSEDCOMMENT", "AnaestheticUsedComment");
			fields[157] = new ims.framework.ReportField(this.context, "_cv_Clinical.CurrentSurgicalAuditProcedureDetail", "BO-1072100103-ENTEROPTHEATRETIME", "EnterOpTheatreTime");
			fields[158] = new ims.framework.ReportField(this.context, "_cv_Clinical.SurgicalAuditSurgicalPack", "BO-1072100105-ID", "ID_SurgicalAuditSurgicalPack");
			fields[159] = new ims.framework.ReportField(this.context, "_cv_Clinical.SurgicalAuditSurgicalPack", "BO-1072100105-SURGICALPACK", "SurgicalPack");
			fields[160] = new ims.framework.ReportField(this.context, "_cv_Clinical.SurgicalAuditSurgicalPack", "BO-1072100105-BARCODENUMBER", "BarcodeNumber");
			fields[161] = new ims.framework.ReportField(this.context, "_cv_Clinical.SurgicalAuditSurgicalPack", "BO-1072100105-COMMENT", "Comment");
			fields[162] = new ims.framework.ReportField(this.context, "_cv_Clinical.SurgicalAuditActualPlannedProcedure", "BO-1003100017-ID", "ID_PatientProcedure");
			fields[163] = new ims.framework.ReportField(this.context, "_cv_Clinical.SurgicalAuditActualPlannedProcedure", "BO-1003100017-PROCEDUREDESCRIPTION", "ProcedureDescription");
			fields[164] = new ims.framework.ReportField(this.context, "_cv_Clinical.SurgicalAuditActualPlannedProcedure", "BO-1003100017-INFOSOURCE", "InfoSource");
			fields[165] = new ims.framework.ReportField(this.context, "_cv_Clinical.SurgicalAuditActualPlannedProcedure", "BO-1003100017-CARECONTEXT", "CareContext");
			fields[166] = new ims.framework.ReportField(this.context, "_cv_Clinical.SurgicalAuditActualPlannedProcedure", "BO-1003100017-EPISODEOFCARE", "EpisodeOfCare");
			fields[167] = new ims.framework.ReportField(this.context, "_cv_Clinical.SurgicalAuditActualPlannedProcedure", "BO-1003100017-ISPRIMARY", "IsPrimary");
			fields[168] = new ims.framework.ReportField(this.context, "_cv_Clinical.SurgicalAuditActualPlannedProcedure", "BO-1003100017-PROCEDURESTATUS", "ProcedureStatus");
			fields[169] = new ims.framework.ReportField(this.context, "_cv_Clinical.SurgicalAuditActualPlannedProcedure", "BO-1003100017-PROCEDUREOUTCOME", "ProcedureOutcome");
			fields[170] = new ims.framework.ReportField(this.context, "_cv_Clinical.SurgicalAuditActualPlannedProcedure", "BO-1003100017-CANCELLEDDATE", "CancelledDate");
			fields[171] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalAuditPlannedActualProcedureDetails.__internal_x_context__CareContextRef_" + componentIdentifier, "BO-1004100019-ID", "ID_CareContext");
			fields[172] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalAuditPlannedActualProcedureDetails.__internal_x_context__PatientRef_" + componentIdentifier, "BO-1001100000-ID", "ID_Patient");
			fields[173] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalAuditPlannedActualProcedureDetails.__internal_x_context__SurgicalAuditOperationDetailsRef_" + componentIdentifier, "BO-1072100108-ID", "ID_SurgicalAuditOperationDetail");
			fields[174] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalAuditPlannedActualProcedureDetails.__internal_x_context__CurrentSurgicalAuditOperationDetails_" + componentIdentifier, "BO-1072100108-ID", "ID_SurgicalAuditOperationDetail");
			fields[175] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalAuditPlannedActualProcedureDetails.__internal_x_context__CurrentSurgicalAuditOperationDetails_" + componentIdentifier, "BO-1072100108-PATIENT", "Patient");
			fields[176] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalAuditPlannedActualProcedureDetails.__internal_x_context__CurrentSurgicalAuditOperationDetails_" + componentIdentifier, "BO-1072100108-CARECONTEXT", "CareContext");
			fields[177] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalAuditPlannedActualProcedureDetails.__internal_x_context__CurrentSurgicalAuditOperationDetails_" + componentIdentifier, "BO-1072100108-OPERATIONCANCELLED", "OperationCancelled");
			fields[178] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalAuditPlannedActualProcedureDetails.__internal_x_context__CurrentSurgicalAuditOperationDetails_" + componentIdentifier, "BO-1072100108-REASONFORCANCELLATION", "ReasonForCancellation");
			fields[179] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalAuditPlannedActualProcedureDetails.__internal_x_context__CurrentSurgicalAuditOperationDetails_" + componentIdentifier, "BO-1072100108-REASONFORCANCELLATIONCOMMENT", "ReasonForCancellationComment");
			return fields;
		}
