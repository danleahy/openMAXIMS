...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "InternalReferralStatusHistory";
	}
	public int getWidth()
	{
		return 672;
	...
	{
		return new String[] { "_cv_Clinical.ClinicalReferralStatusHistory" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Clinical.InternalReferralStatusHistory.__internal_x_context__" + String.valueOf(getFormId());
	}
