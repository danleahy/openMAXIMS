...
public class GenForm extends FormBridge
{
	...
	public static class lyrLayer extends Layer
	{
		...
		public static class tabReferralDetailsContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1019), new Integer(anchoringHelper20.getX()), new Integer(anchoringHelper20.getY()), new Integer(anchoringHelper20.getWidth()), new Integer(anchoringHelper20.getHeight()), new Integer(startTabIndex.intValue() + 11), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.FALSE, new Integer(30), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
				...
				super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1023), new Integer(anchoringHelper24.getX()), new Integer(anchoringHelper24.getY()), new Integer(anchoringHelper24.getWidth()), new Integer(anchoringHelper24.getHeight()), new Integer(startTabIndex.intValue() + 9), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.TRUE, new Integer(120), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
				...
				super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1025), new Integer(anchoringHelper26.getX()), new Integer(anchoringHelper26.getY()), new Integer(anchoringHelper26.getWidth()), new Integer(anchoringHelper26.getHeight()), new Integer(startTabIndex.intValue() + 22), ControlState.DISABLED, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT,Boolean.FALSE, new Integer(0), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
				...
				super.addControl(factory.getControl(DateTimeControl.class, new Object[] { control, new Integer(startControlID.intValue() + 1029), new Integer(anchoringHelper30.getX()), new Integer(anchoringHelper30.getY()), new Integer(anchoringHelper30.getWidth()), new Integer(anchoringHelper30.getHeight()), new Integer(startTabIndex.intValue() + 23), ControlState.DISABLED, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT,Boolean.TRUE, null, Boolean.FALSE, null, Boolean.FALSE, null}));
				...
				ComboBox m_cmbPriorityTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1036), new Integer(anchoringHelper37.getX()), new Integer(anchoringHelper37.getY()), new Integer(anchoringHelper37.getWidth()), new Integer(anchoringHelper37.getHeight()), new Integer(startTabIndex.intValue() + 13), ControlState.DISABLED, ControlState.ENABLED,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1046), new Integer(anchoringHelper46.getX()), new Integer(anchoringHelper46.getY()), new Integer(anchoringHelper46.getWidth()), new Integer(anchoringHelper46.getHeight()), new Integer(startTabIndex.intValue() + 26), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Close", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1050), new Integer(anchoringHelper50.getX()), new Integer(anchoringHelper50.getY()), new Integer(anchoringHelper50.getWidth()), new Integer(anchoringHelper50.getHeight()), new Integer(startTabIndex.intValue() + 25), ControlState.HIDDEN, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Cancel", Boolean.FALSE, null, Boolean.FALSE, Boolean.FALSE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
	}
	...
	private class ReportFields
	{
		...
		{
			String prefix = formInfo.getLocalVariablesPrefix();
			IReportField[] fields = new IReportField[270];
			...
			fields[144] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedGraphicAssessmentVo", "BO-1028100006-ID", "ID_GraphicAssessment");
			fields[145] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedGraphicAssessmentVo", "BO-1028100006-NAME", "Name");
			fields[146] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedGraphicAssessmentVo", "BO-1028100006-ASSESSMENTTYPE", "AssessmentType");
			fields[147] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedGraphicAssessmentVo", "BO-1028100006-ACTIVESTATUS", "ActiveStatus");
			fields[148] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedGraphicAssessmentVo", "BO-1028100006-HELPURL", "HelpUrl");
			fields[149] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedGraphicAssessmentVo", "BO-1028100006-STOREPRINTEDREPORT", "StorePrintedReport");
			fields[150] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedGraphicAssessmentVo", "BO-1028100006-ASSOCIATEDREPORTFORPRINTING", "AssociatedReportForPrinting");
			fields[151] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedPreceedingReferralVo", "BO-1072100062-ID", "ID_ReferralsRecording");
			fields[152] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedPreceedingReferralVo", "BO-1072100062-REFERRALTYPE", "ReferralType");
			fields[153] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedPreceedingReferralVo", "BO-1072100062-REFERRALSOURCE", "ReferralSource");
			fields[154] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedPreceedingReferralVo", "BO-1072100062-DATESENT", "DateSent");
			fields[155] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedPreceedingReferralVo", "BO-1072100062-DETAILS", "Details");
			fields[156] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedPreceedingReferralVo", "BO-1072100062-DATEFIRSTSEEN", "DateFirstSeen");
			fields[157] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedPreceedingReferralVo", "BO-1072100062-DATERECEIVED", "DateReceived");
			fields[158] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedPreceedingReferralVo", "BO-1072100062-REFERRALPRIORITY", "ReferralPriority");
			fields[159] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedPreceedingReferralVo", "BO-1072100062-REASONFORREFERRAL", "ReasonForReferral");
			fields[160] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedPreceedingReferralVo", "BO-1072100062-SPECIALTYFUNCTIONCODE", "SpecialtyFunctionCode");
			fields[161] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedPreceedingReferralVo", "BO-1072100062-REFERRALCATEGORY", "ReferralCategory");
			fields[162] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedPreceedingReferralVo", "BO-1072100062-PRIMARYPRECEEDING", "PrimaryPreceeding");
			fields[163] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedPreceedingReferralVo", "BO-1072100062-CARESPELL", "CareSpell");
			fields[164] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedPreceedingReferralVo", "BO-1072100062-CARECONTEXT", "CareContext");
			fields[165] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedPreceedingReferralVo", "BO-1072100062-CLINICALCONTACT", "ClinicalContact");
			fields[166] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedPreceedingReferralVo", "BO-1072100062-REFERRALSTATUS", "ReferralStatus");
			fields[167] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedPreceedingReferralVo", "BO-1072100062-URGENTCANCERREFERRALTYPE", "UrgentCancerReferralType");
			fields[168] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedPreceedingReferralVo", "BO-1072100062-CANCERSTATUS", "CancerStatus");
			fields[169] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedPreceedingReferralVo", "BO-1072100062-DELAYREASONGPURGENTREFERRAL", "DelayReasonGPUrgentReferral");
			fields[170] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedPreceedingReferralVo", "BO-1072100062-DELAYREASONTEXT", "DelayReasonText");
			fields[171] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedPreceedingReferralVo", "BO-1072100062-DISCIPLINE", "Discipline");
			fields[172] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedPreceedingReferralVo", "BO-1072100062-REASONFORREFERRALTEXT", "ReasonForReferralText");
			fields[173] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedReferralRecordingVo", "BO-1072100062-ID", "ID_ReferralsRecording");
			fields[174] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedReferralRecordingVo", "BO-1072100062-REFERRALTYPE", "ReferralType");
			fields[175] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedReferralRecordingVo", "BO-1072100062-REFERRALSOURCE", "ReferralSource");
			fields[176] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedReferralRecordingVo", "BO-1072100062-DATESENT", "DateSent");
			fields[177] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedReferralRecordingVo", "BO-1072100062-DETAILS", "Details");
			fields[178] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedReferralRecordingVo", "BO-1072100062-DATEFIRSTSEEN", "DateFirstSeen");
			fields[179] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedReferralRecordingVo", "BO-1072100062-DATERECEIVED", "DateReceived");
			fields[180] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedReferralRecordingVo", "BO-1072100062-REFERRALPRIORITY", "ReferralPriority");
			fields[181] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedReferralRecordingVo", "BO-1072100062-REASONFORREFERRAL", "ReasonForReferral");
			fields[182] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedReferralRecordingVo", "BO-1072100062-SPECIALTYFUNCTIONCODE", "SpecialtyFunctionCode");
			fields[183] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedReferralRecordingVo", "BO-1072100062-REFERRALCATEGORY", "ReferralCategory");
			fields[184] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedReferralRecordingVo", "BO-1072100062-PRIMARYPRECEEDING", "PrimaryPreceeding");
			fields[185] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedReferralRecordingVo", "BO-1072100062-CARESPELL", "CareSpell");
			fields[186] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedReferralRecordingVo", "BO-1072100062-CARECONTEXT", "CareContext");
			fields[187] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedReferralRecordingVo", "BO-1072100062-CLINICALCONTACT", "ClinicalContact");
			fields[188] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedReferralRecordingVo", "BO-1072100062-REFERRALSTATUS", "ReferralStatus");
			fields[189] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedReferralRecordingVo", "BO-1072100062-URGENTCANCERREFERRALTYPE", "UrgentCancerReferralType");
			fields[190] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedReferralRecordingVo", "BO-1072100062-CANCERSTATUS", "CancerStatus");
			fields[191] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedReferralRecordingVo", "BO-1072100062-DELAYREASONGPURGENTREFERRAL", "DelayReasonGPUrgentReferral");
			fields[192] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedReferralRecordingVo", "BO-1072100062-DELAYREASONTEXT", "DelayReasonText");
			fields[193] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedReferralRecordingVo", "BO-1072100062-DISCIPLINE", "Discipline");
			fields[194] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedUserAssessmentVo", "BO-1003100043-ID", "ID_UserAssessment");
			fields[195] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedUserAssessmentVo", "BO-1003100043-NAME", "Name");
			fields[196] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedUserAssessmentVo", "BO-1003100043-DESCRIPTION", "Description");
			fields[197] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedUserAssessmentVo", "BO-1003100043-ASSESSMENTTYPE", "AssessmentType");
			fields[198] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedUserAssessmentVo", "BO-1003100043-ACTIVESTATUS", "ActiveStatus");
			fields[199] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedUserAssessmentVo", "BO-1003100043-HELPURL", "HelpURL");
			fields[200] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedUserAssessmentVo", "BO-1003100043-SCORINGMETHOD", "ScoringMethod");
			fields[201] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedUserAssessmentVo", "BO-1003100043-ISFLATVIEW", "IsFlatView");
			fields[202] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedUserAssessmentVo", "BO-1003100043-CATEGORY", "Category");
			fields[203] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedUserAssessmentVo", "BO-1003100043-ISMULTIPLEGROUP", "IsMultipleGroup");
			fields[204] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedUserAssessmentVo", "BO-1003100043-GROUPQUESTIONWIDTH", "GroupQuestionWidth");
			fields[205] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedUserAssessmentVo", "BO-1003100043-STOREPRINTEDASSESSMENT", "StorePrintedAssessment");
			fields[206] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedUserAssessmentVo", "BO-1003100043-ISMULTIROLE", "IsMultiRole");
			fields[207] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedUserAssessmentVo", "BO-1003100043-HEADERTEXT", "HeaderText");
			fields[208] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedUserAssessmentVo", "BO-1003100043-FOOTERTEXT", "FooterText");
			fields[209] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedUserAssessmentVo", "BO-1003100043-MAXHEADERHEIGHT", "MaxHeaderHeight");
			fields[210] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedUserAssessmentVo", "BO-1003100043-MAXFOOTERHEIGHT", "MaxFooterHeight");
			fields[211] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedUserAssessmentVo", "BO-1003100043-ASSOCIATEDREPORT", "AssociatedReport");
			fields[212] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedUserAssessmentVo", "BO-1003100043-CANCOPYLAST", "CanCopyLast");
			fields[213] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedUserAssessmentVo", "BO-1003100043-COPYLASTFROMCONTEXT", "CopyLastFromContext");
			fields[214] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.DemoreferralDetails.__internal_x_context__SelectedReferral_" + componentIdentifier, "BO-1072100062-ID", "ID_ReferralsRecording");
			fields[215] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.DemoreferralDetails.__internal_x_context__SelectedReferral_" + componentIdentifier, "BO-1072100062-REFERRALTYPE", "ReferralType");
			fields[216] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.DemoreferralDetails.__internal_x_context__SelectedReferral_" + componentIdentifier, "BO-1072100062-REFERRALSOURCE", "ReferralSource");
			fields[217] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.DemoreferralDetails.__internal_x_context__SelectedReferral_" + componentIdentifier, "BO-1072100062-DATESENT", "DateSent");
			fields[218] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.DemoreferralDetails.__internal_x_context__SelectedReferral_" + componentIdentifier, "BO-1072100062-DETAILS", "Details");
			fields[219] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.DemoreferralDetails.__internal_x_context__SelectedReferral_" + componentIdentifier, "BO-1072100062-DATEFIRSTSEEN", "DateFirstSeen");
			fields[220] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.DemoreferralDetails.__internal_x_context__SelectedReferral_" + componentIdentifier, "BO-1072100062-DATERECEIVED", "DateReceived");
			fields[221] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.DemoreferralDetails.__internal_x_context__SelectedReferral_" + componentIdentifier, "BO-1072100062-REFERRALPRIORITY", "ReferralPriority");
			fields[222] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.DemoreferralDetails.__internal_x_context__SelectedReferral_" + componentIdentifier, "BO-1072100062-REASONFORREFERRAL", "ReasonForReferral");
			fields[223] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.DemoreferralDetails.__internal_x_context__SelectedReferral_" + componentIdentifier, "BO-1072100062-SPECIALTYFUNCTIONCODE", "SpecialtyFunctionCode");
			fields[224] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.DemoreferralDetails.__internal_x_context__SelectedReferral_" + componentIdentifier, "BO-1072100062-REFERRALCATEGORY", "ReferralCategory");
			fields[225] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.DemoreferralDetails.__internal_x_context__SelectedReferral_" + componentIdentifier, "BO-1072100062-PRIMARYPRECEEDING", "PrimaryPreceeding");
			fields[226] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.DemoreferralDetails.__internal_x_context__SelectedReferral_" + componentIdentifier, "BO-1072100062-CARESPELL", "CareSpell");
			fields[227] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.DemoreferralDetails.__internal_x_context__SelectedReferral_" + componentIdentifier, "BO-1072100062-CARECONTEXT", "CareContext");
			fields[228] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.DemoreferralDetails.__internal_x_context__SelectedReferral_" + componentIdentifier, "BO-1072100062-CLINICALCONTACT", "ClinicalContact");
			fields[229] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.DemoreferralDetails.__internal_x_context__SelectedReferral_" + componentIdentifier, "BO-1072100062-REFERRALSTATUS", "ReferralStatus");
			fields[230] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.DemoreferralDetails.__internal_x_context__SelectedReferral_" + componentIdentifier, "BO-1072100062-URGENTCANCERREFERRALTYPE", "UrgentCancerReferralType");
			fields[231] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.DemoreferralDetails.__internal_x_context__SelectedReferral_" + componentIdentifier, "BO-1072100062-CANCERSTATUS", "CancerStatus");
			fields[232] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.DemoreferralDetails.__internal_x_context__SelectedReferral_" + componentIdentifier, "BO-1072100062-DELAYREASONGPURGENTREFERRAL", "DelayReasonGPUrgentReferral");
			fields[233] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.DemoreferralDetails.__internal_x_context__SelectedReferral_" + componentIdentifier, "BO-1072100062-DELAYREASONTEXT", "DelayReasonText");
			fields[234] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.DemoreferralDetails.__internal_x_context__SelectedReferral_" + componentIdentifier, "BO-1072100062-DISCIPLINE", "Discipline");
			fields[235] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.DemoreferralDetails.__internal_x_context__SelectedReferral_" + componentIdentifier, "BO-1072100062-REASONFORREFERRALTEXT", "ReasonForReferralText");
			fields[236] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.DemoreferralDetails.__internal_x_context__LoggedInMOS_" + componentIdentifier, "BO-1006100006-ID", "ID_MemberOfStaff");
			fields[237] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.DemoreferralDetails.__internal_x_context__LoggedInMOS_" + componentIdentifier, "BO-1006100006-INITIALS", "Initials");
			fields[238] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.DemoreferralDetails.__internal_x_context__LoggedInMOS_" + componentIdentifier, "BO-1006100006-SIGNATUREBLOCK", "SignatureBlock");
			fields[239] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.DemoreferralDetails.__internal_x_context__LoggedInMOS_" + componentIdentifier, "BO-1006100006-STAFFTYPE", "StaffType");
			fields[240] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.DemoreferralDetails.__internal_x_context__LoggedInMOS_" + componentIdentifier, "BO-1006100006-ISACTIVE", "IsActive");
			fields[241] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.DemoreferralDetails.__internal_x_context__LoggedInMOS_" + componentIdentifier, "BO-1006100006-SDSROLEID", "SdsRoleId");
			fields[242] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.DemoreferralDetails.__internal_x_context__LoggedInMOS_" + componentIdentifier, "BO-1006100006-CANREFERPATIENT", "CanReferPatient");
			fields[243] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.DemoreferralDetails.__internal_x_context__UserAssessmentVo_" + componentIdentifier, "BO-1003100043-ID", "ID_UserAssessment");
			fields[244] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.DemoreferralDetails.__internal_x_context__UserAssessmentVo_" + componentIdentifier, "BO-1003100043-NAME", "Name");
			fields[245] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.DemoreferralDetails.__internal_x_context__UserAssessmentVo_" + componentIdentifier, "BO-1003100043-DESCRIPTION", "Description");
			fields[246] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.DemoreferralDetails.__internal_x_context__UserAssessmentVo_" + componentIdentifier, "BO-1003100043-ASSESSMENTTYPE", "AssessmentType");
			fields[247] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.DemoreferralDetails.__internal_x_context__UserAssessmentVo_" + componentIdentifier, "BO-1003100043-ACTIVESTATUS", "ActiveStatus");
			fields[248] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.DemoreferralDetails.__internal_x_context__UserAssessmentVo_" + componentIdentifier, "BO-1003100043-HELPURL", "HelpURL");
			fields[249] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.DemoreferralDetails.__internal_x_context__UserAssessmentVo_" + componentIdentifier, "BO-1003100043-SCORINGMETHOD", "ScoringMethod");
			fields[250] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.DemoreferralDetails.__internal_x_context__UserAssessmentVo_" + componentIdentifier, "BO-1003100043-ISFLATVIEW", "IsFlatView");
			fields[251] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.DemoreferralDetails.__internal_x_context__UserAssessmentVo_" + componentIdentifier, "BO-1003100043-CATEGORY", "Category");
			fields[252] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.DemoreferralDetails.__internal_x_context__UserAssessmentVo_" + componentIdentifier, "BO-1003100043-ISMULTIPLEGROUP", "IsMultipleGroup");
			fields[253] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.DemoreferralDetails.__internal_x_context__UserAssessmentVo_" + componentIdentifier, "BO-1003100043-GROUPQUESTIONWIDTH", "GroupQuestionWidth");
			fields[254] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.DemoreferralDetails.__internal_x_context__UserAssessmentVo_" + componentIdentifier, "BO-1003100043-STOREPRINTEDASSESSMENT", "StorePrintedAssessment");
			fields[255] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.DemoreferralDetails.__internal_x_context__UserAssessmentVo_" + componentIdentifier, "BO-1003100043-ISMULTIROLE", "IsMultiRole");
			fields[256] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.DemoreferralDetails.__internal_x_context__UserAssessmentVo_" + componentIdentifier, "BO-1003100043-HEADERTEXT", "HeaderText");
			fields[257] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.DemoreferralDetails.__internal_x_context__UserAssessmentVo_" + componentIdentifier, "BO-1003100043-FOOTERTEXT", "FooterText");
			fields[258] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.DemoreferralDetails.__internal_x_context__UserAssessmentVo_" + componentIdentifier, "BO-1003100043-MAXHEADERHEIGHT", "MaxHeaderHeight");
			fields[259] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.DemoreferralDetails.__internal_x_context__UserAssessmentVo_" + componentIdentifier, "BO-1003100043-MAXFOOTERHEIGHT", "MaxFooterHeight");
			fields[260] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.DemoreferralDetails.__internal_x_context__UserAssessmentVo_" + componentIdentifier, "BO-1003100043-ASSOCIATEDREPORT", "AssociatedReport");
			fields[261] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.DemoreferralDetails.__internal_x_context__UserAssessmentVo_" + componentIdentifier, "BO-1003100043-CANCOPYLAST", "CanCopyLast");
			fields[262] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.DemoreferralDetails.__internal_x_context__UserAssessmentVo_" + componentIdentifier, "BO-1003100043-COPYLASTFROMCONTEXT", "CopyLastFromContext");
			fields[263] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.DemoreferralDetails.__internal_x_context__GraphicalUserAssessment_" + componentIdentifier, "BO-1028100006-ID", "ID_GraphicAssessment");
			fields[264] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.DemoreferralDetails.__internal_x_context__GraphicalUserAssessment_" + componentIdentifier, "BO-1028100006-NAME", "Name");
			fields[265] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.DemoreferralDetails.__internal_x_context__GraphicalUserAssessment_" + componentIdentifier, "BO-1028100006-ASSESSMENTTYPE", "AssessmentType");
			fields[266] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.DemoreferralDetails.__internal_x_context__GraphicalUserAssessment_" + componentIdentifier, "BO-1028100006-ACTIVESTATUS", "ActiveStatus");
			fields[267] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.DemoreferralDetails.__internal_x_context__GraphicalUserAssessment_" + componentIdentifier, "BO-1028100006-HELPURL", "HelpUrl");
			fields[268] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.DemoreferralDetails.__internal_x_context__GraphicalUserAssessment_" + componentIdentifier, "BO-1028100006-STOREPRINTEDREPORT", "StorePrintedReport");
			fields[269] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.DemoreferralDetails.__internal_x_context__GraphicalUserAssessment_" + componentIdentifier, "BO-1028100006-ASSOCIATEDREPORTFORPRINTING", "AssociatedReportForPrinting");
			return fields;
		}
