...
public class GenForm extends FormBridge
{
	...
	public static class lyrDetailsLayer extends Layer
	{
		...
		public static class tabRecipentsContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				super.addControl(factory.getControl(DateTimeControl.class, new Object[] { control, new Integer(startControlID.intValue() + 1011), new Integer(anchoringHelper11.getX()), new Integer(anchoringHelper11.getY()), new Integer(anchoringHelper11.getWidth()), new Integer(anchoringHelper11.getHeight()), new Integer(startTabIndex.intValue() + 4), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT,Boolean.TRUE, null, Boolean.FALSE, null, Boolean.FALSE, null}));
		...
		public static class tabCommentsOPDContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				Grid m_grdClinicalNotesTemp = (Grid)factory.getControl(Grid.class, new Object[] { control, new Integer(startControlID.intValue() + 1022), new Integer(anchoringHelper22.getX()), new Integer(anchoringHelper22.getY()), new Integer(anchoringHelper22.getWidth()), new Integer(anchoringHelper22.getHeight()), new Integer(startTabIndex.intValue() + 8), ControlState.EDITABLE, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL,Boolean.FALSE, Boolean.FALSE, new Integer(24), Boolean.TRUE, null, Boolean.FALSE, Boolean.FALSE, new Integer(0), null, Boolean.FALSE, Boolean.TRUE});
				...
				super.addControl(factory.getControl(IntBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1023), new Integer(anchoringHelper23.getX()), new Integer(anchoringHelper23.getY()), new Integer(anchoringHelper23.getWidth()), new Integer(anchoringHelper23.getHeight()), new Integer(startTabIndex.intValue() + 13), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT,Boolean.TRUE, Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, new Integer(9)}));
			}
		...
		public static class tabSummaryIPContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				super.addControl(factory.getControl(IntBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1029), new Integer(anchoringHelper29.getX()), new Integer(anchoringHelper29.getY()), new Integer(anchoringHelper29.getWidth()), new Integer(anchoringHelper29.getHeight()), new Integer(startTabIndex.intValue() + 16), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT,Boolean.TRUE, Boolean.TRUE, Boolean.TRUE, null, null, Boolean.FALSE, new Integer(9)}));
				...
				super.addControl(factory.getControl(RichTextControl.class, new Object[] { control, new Integer(startControlID.intValue() + 1030), new Integer(anchoringHelper30.getX()), new Integer(anchoringHelper30.getY()), new Integer(anchoringHelper30.getWidth()), new Integer(anchoringHelper30.getHeight()), new Integer(startTabIndex.intValue() + 12), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, Boolean.FALSE, Boolean.FALSE, new Integer(0)} ));
			}
	...
	private void validateContext(ims.framework.Context context)
	{
		if(context == null)
			return;
		if(!context.isValidContextType(ims.core.vo.CorrespondenceSearchCriteriaVo.class))
			throw new ims.framework.exceptions.CodingRuntimeException("The type 'ims.core.vo.CorrespondenceSearchCriteriaVo' of the global context variable 'Clinical.CurrentCorrespondanceSearchCriteria' is not supported.");
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1041), new Integer(anchoringHelper41.getX()), new Integer(anchoringHelper41.getY()), new Integer(anchoringHelper41.getWidth()), new Integer(anchoringHelper41.getHeight()), new Integer(startTabIndex.intValue() + 11), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Close", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1042), new Integer(anchoringHelper42.getX()), new Integer(anchoringHelper42.getY()), new Integer(anchoringHelper42.getWidth()), new Integer(anchoringHelper42.getHeight()), new Integer(startTabIndex.intValue() + 10), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Edit", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1043), new Integer(anchoringHelper43.getX()), new Integer(anchoringHelper43.getY()), new Integer(anchoringHelper43.getWidth()), new Integer(anchoringHelper43.getHeight()), new Integer(startTabIndex.intValue() + 9), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "New", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[146] = new ims.framework.ReportField(this.context, "_cv_Clinical.CurrentClinicalCorrespondanceLiteVo", "BO-1072100040-ID", "ID_ClinicalCorrespondence");
			fields[147] = new ims.framework.ReportField(this.context, "_cv_Clinical.CurrentClinicalCorrespondanceLiteVo", "BO-1072100040-VERIFYINGDATETIME", "VerifyingDateTime");
			fields[148] = new ims.framework.ReportField(this.context, "_cv_Clinical.CurrentClinicalCorrespondanceLiteVo", "BO-1072100040-HASOBJECTIVENOTE", "HasObjectiveNote");
			fields[149] = new ims.framework.ReportField(this.context, "_cv_Clinical.CurrentClinicalCorrespondanceLiteVo", "BO-1072100040-HASPLANNOTE", "HasPlanNote");
			fields[150] = new ims.framework.ReportField(this.context, "_cv_Clinical.CurrentClinicalCorrespondanceLiteVo", "BO-1072100040-HASINSTRUCTIONSNOTE", "HasInstructionsNote");
			fields[151] = new ims.framework.ReportField(this.context, "_cv_Clinical.CurrentClinicalCorrespondanceLiteVo", "BO-1072100040-TYPE", "Type");
			fields[152] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.DocumentGeneration.__internal_x_context__SelectedItem_" + componentIdentifier, "BO-1072100040-ID", "ID_ClinicalCorrespondence");
			fields[153] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.DocumentGeneration.__internal_x_context__SelectedItem_" + componentIdentifier, "BO-1072100040-VERIFYINGDATETIME", "VerifyingDateTime");
			fields[154] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.DocumentGeneration.__internal_x_context__SelectedItem_" + componentIdentifier, "BO-1072100040-HASOBJECTIVENOTE", "HasObjectiveNote");
			fields[155] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.DocumentGeneration.__internal_x_context__SelectedItem_" + componentIdentifier, "BO-1072100040-HASPLANNOTE", "HasPlanNote");
			fields[156] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.DocumentGeneration.__internal_x_context__SelectedItem_" + componentIdentifier, "BO-1072100040-HASINSTRUCTIONSNOTE", "HasInstructionsNote");
			fields[157] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.DocumentGeneration.__internal_x_context__SelectedItem_" + componentIdentifier, "BO-1072100040-TYPE", "Type");
			fields[158] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.DocumentGeneration.__internal_x_context__SelectedItem_" + componentIdentifier, "BO-1072100040-MEDICATION", "Medication");
			fields[159] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.DocumentGeneration.__internal_x_context__SelectedItem_" + componentIdentifier, "BO-1072100040-RUSERVERIFYINGDATETIME", "RUserVerifyingDateTime");
			fields[160] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.DocumentGeneration.__internal_x_context__Inpatient_" + componentIdentifier, "BO-1072100050-ID", "ID_InpatientDischargeNoteFollowup");
			fields[161] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.DocumentGeneration.__internal_x_context__Inpatient_" + componentIdentifier, "BO-1072100050-OUTCOME", "Outcome");
			fields[162] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.DocumentGeneration.__internal_x_context__Inpatient_" + componentIdentifier, "BO-1072100050-REVIEWIN", "ReviewIn");
			fields[163] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.DocumentGeneration.__internal_x_context__Inpatient_" + componentIdentifier, "BO-1072100050-REVIEWINUNITS", "ReviewinUnits");
			fields[164] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.DocumentGeneration.__internal_x_context__Inpatient_" + componentIdentifier, "BO-1072100050-CARECONTEXT", "CareContext");
			fields[165] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.DocumentGeneration.__internal_x_context__Outpatient_" + componentIdentifier, "BO-1072100046-ID", "ID_OutpatientNotesOutcome");
			fields[166] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.DocumentGeneration.__internal_x_context__Outpatient_" + componentIdentifier, "BO-1072100046-INSTRUCTIONNEXTCLINIC", "InstructionNextClinic");
			fields[167] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.DocumentGeneration.__internal_x_context__Outpatient_" + componentIdentifier, "BO-1072100046-OUTCOME", "Outcome");
			fields[168] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.DocumentGeneration.__internal_x_context__Outpatient_" + componentIdentifier, "BO-1072100046-REVIEWIN", "ReviewIn");
			fields[169] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.DocumentGeneration.__internal_x_context__Outpatient_" + componentIdentifier, "BO-1072100046-REVIEWINUNITS", "ReviewinUnits");
			fields[170] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.DocumentGeneration.__internal_x_context__Outpatient_" + componentIdentifier, "BO-1072100046-CARECONTEXT", "CareContext");
			fields[171] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.DocumentGeneration.__internal_x_context__Outpatient_" + componentIdentifier, "BO-1072100046-CLINICALCONTACT", "ClinicalContact");
			return fields;
		}
