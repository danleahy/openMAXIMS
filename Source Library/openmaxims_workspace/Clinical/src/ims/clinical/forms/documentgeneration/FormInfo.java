...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Core.GPDetails", "_cv_Core.ClinicalNotingMode", "_cv_Admin.MemberOfStaffShortVoCollection", "_cv_Clinical.CurrentClinicalCorrespondanceLiteVo" };
	}
