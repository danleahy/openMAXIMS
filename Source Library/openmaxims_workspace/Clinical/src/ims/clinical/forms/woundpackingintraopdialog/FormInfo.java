...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "WoundPackingIntraOpDialog";
	}
	public int getWidth()
	{
		return 576;
	...
	{
		return new String[] { "_cv_Clinical.TheatreAppointmentRef", "_cv_Clinical.WoundPackingIntraOpVo" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Clinical.WoundPackingIntraOpDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
