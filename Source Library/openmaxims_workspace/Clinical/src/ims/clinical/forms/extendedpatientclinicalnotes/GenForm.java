...
public class GenForm extends FormBridge
{
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[158] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ExtendedPatientClinicalNotes.__internal_x_context__ClinicalNoteVoForContext_" + componentIdentifier, "BO-1011100000-ID", "ID_ClinicalNotes");
			fields[159] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ExtendedPatientClinicalNotes.__internal_x_context__ClinicalNoteVoForContext_" + componentIdentifier, "BO-1011100000-CLINICALNOTE", "ClinicalNote");
			fields[160] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ExtendedPatientClinicalNotes.__internal_x_context__ClinicalNoteVoForContext_" + componentIdentifier, "BO-1011100000-NOTETYPE", "NoteType");
			fields[161] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ExtendedPatientClinicalNotes.__internal_x_context__ClinicalNoteVoForContext_" + componentIdentifier, "BO-1011100000-DISCIPLINE", "Discipline");
			fields[162] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ExtendedPatientClinicalNotes.__internal_x_context__ClinicalNoteVoForContext_" + componentIdentifier, "BO-1011100000-CLINICALCONTACT", "ClinicalContact");
			fields[163] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ExtendedPatientClinicalNotes.__internal_x_context__ClinicalNoteVoForContext_" + componentIdentifier, "BO-1011100000-ISDERIVEDNOTE", "IsDerivedNote");
			fields[164] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ExtendedPatientClinicalNotes.__internal_x_context__ClinicalNoteVoForContext_" + componentIdentifier, "BO-1011100000-FORREVIEW", "ForReview");
			fields[165] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ExtendedPatientClinicalNotes.__internal_x_context__ClinicalNoteVoForContext_" + componentIdentifier, "BO-1011100000-FORREVIEWDISCIPLINE", "ForReviewDiscipline");
			fields[166] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ExtendedPatientClinicalNotes.__internal_x_context__ClinicalNoteVoForContext_" + componentIdentifier, "BO-1011100000-REVIEWINGDATETIME", "ReviewingDateTime");
			fields[167] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ExtendedPatientClinicalNotes.__internal_x_context__ClinicalNoteVoForContext_" + componentIdentifier, "BO-1011100000-ISCORRECTED", "IsCorrected");
			fields[168] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ExtendedPatientClinicalNotes.__internal_x_context__ClinicalNoteVoForContext_" + componentIdentifier, "BO-1011100000-ISTRANSCRIBED", "IsTranscribed");
			fields[169] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ExtendedPatientClinicalNotes.__internal_x_context__ClinicalNoteVoForContext_" + componentIdentifier, "BO-1011100000-SOURCEOFNOTE", "SourceOfNote");
			fields[170] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ExtendedPatientClinicalNotes.__internal_x_context__ClinicalNoteVoForContext_" + componentIdentifier, "BO-1011100000-RECORDINGDATETIME", "RecordingDateTime");
			fields[171] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ExtendedPatientClinicalNotes.__internal_x_context__ClinicalNoteVoForContext_" + componentIdentifier, "BO-1011100000-INHOSPITALREPORT", "InHospitalReport");
			fields[172] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ExtendedPatientClinicalNotes.__internal_x_context__ClinicalNoteVoForContext_" + componentIdentifier, "BO-1011100000-CARECONTEXT", "CareContext");
			fields[173] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ExtendedPatientClinicalNotes.__internal_x_context__ClinicalNoteVoForContext_" + componentIdentifier, "BO-1011100000-NOTECLASSIFICATION", "NoteClassification");
			return fields;
		}
