...
public class GenForm extends FormBridge
{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		ims.framework.FormUiLogic m_ccHandOverFromRecoveryNurseForm = loader.loadComponent(102256, appForm, startControlID * 10 + 1000, anchoringHelper3.getSize(), instance1, startTabIndex.intValue() + 13, skipContextValidation);
		//ims.framework.Control m_ccHandOverFromRecoveryNurseControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1000), new Integer(447), new Integer(384), new Integer(380), new Integer(20), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT, new Integer(startTabIndex.intValue() + 13), m_ccHandOverFromRecoveryNurseForm, instance1 } );
		ims.framework.Control m_ccHandOverFromRecoveryNurseControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1001),  new Integer(anchoringHelper3.getX()), new Integer(anchoringHelper3.getY()), new Integer(anchoringHelper3.getWidth()), new Integer(anchoringHelper3.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT, new Integer(startTabIndex.intValue() + 13), m_ccHandOverFromRecoveryNurseForm, instance1, Boolean.FALSE } );
		...
		ims.framework.FormUiLogic m_ccWardUnitNurseForm = loader.loadComponent(102256, appForm, startControlID * 10 + 2000, anchoringHelper4.getSize(), instance2, startTabIndex.intValue() + 17, skipContextValidation);
		//ims.framework.Control m_ccWardUnitNurseControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1002), new Integer(447), new Integer(464), new Integer(380), new Integer(20), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT, new Integer(startTabIndex.intValue() + 17), m_ccWardUnitNurseForm, instance2 } );
		ims.framework.Control m_ccWardUnitNurseControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1003),  new Integer(anchoringHelper4.getX()), new Integer(anchoringHelper4.getY()), new Integer(anchoringHelper4.getWidth()), new Integer(anchoringHelper4.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT, new Integer(startTabIndex.intValue() + 17), m_ccWardUnitNurseForm, instance2, Boolean.FALSE } );
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1018), new Integer(anchoringHelper18.getX()), new Integer(anchoringHelper18.getY()), new Integer(anchoringHelper18.getWidth()), new Integer(anchoringHelper18.getHeight()), new Integer(startTabIndex.intValue() + 19), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Edit", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalAuditRecoveryCC.__internal_x_context__currentSurgicalAuditOpDetail_" + componentIdentifier, "BO-1072100108-ID", "ID_SurgicalAuditOperationDetail");
			fields[145] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalAuditRecoveryCC.__internal_x_context__currentSurgicalAuditOpDetail_" + componentIdentifier, "BO-1072100108-PATIENT", "Patient");
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalAuditRecoveryCC.__internal_x_context__currentSurgicalAuditOpDetail_" + componentIdentifier, "BO-1072100108-CARECONTEXT", "CareContext");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalAuditRecoveryCC.__internal_x_context__currentSurgicalAuditOpDetail_" + componentIdentifier, "BO-1072100108-OPERATIONCANCELLED", "OperationCancelled");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalAuditRecoveryCC.__internal_x_context__currentSurgicalAuditOpDetail_" + componentIdentifier, "BO-1072100108-REASONFORCANCELLATION", "ReasonForCancellation");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalAuditRecoveryCC.__internal_x_context__currentSurgicalAuditOpDetail_" + componentIdentifier, "BO-1072100108-REASONFORCANCELLATIONCOMMENT", "ReasonForCancellationComment");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalAuditRecoveryCC.__internal_x_context__currentSurgicalAuditRecovery_" + componentIdentifier, "BO-1072100106-ID", "ID_SurgicalAuditRecovery");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalAuditRecoveryCC.__internal_x_context__currentSurgicalAuditRecovery_" + componentIdentifier, "BO-1072100106-PATIENT", "Patient");
			fields[152] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalAuditRecoveryCC.__internal_x_context__currentSurgicalAuditRecovery_" + componentIdentifier, "BO-1072100106-CARECONTEXT", "CareContext");
			fields[153] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalAuditRecoveryCC.__internal_x_context__currentSurgicalAuditRecovery_" + componentIdentifier, "BO-1072100106-CONFIRMPATIENTARRIVAL", "ConfirmPatientArrival");
			fields[154] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalAuditRecoveryCC.__internal_x_context__currentSurgicalAuditRecovery_" + componentIdentifier, "BO-1072100106-TIMEARRIVESINRECOVERY", "TimeArrivesInRecovery");
			fields[155] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalAuditRecoveryCC.__internal_x_context__currentSurgicalAuditRecovery_" + componentIdentifier, "BO-1072100106-TIMEWARDNOTIFIED", "TimeWardNotified");
			fields[156] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalAuditRecoveryCC.__internal_x_context__currentSurgicalAuditRecovery_" + componentIdentifier, "BO-1072100106-TIMELEAVESRECOVERY", "TimeLeavesRecovery");
			fields[157] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalAuditRecoveryCC.__internal_x_context__currentSurgicalAuditRecovery_" + componentIdentifier, "BO-1072100106-RECOVERYLOCUMBOOL", "RecoveryLocumBool");
			fields[158] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalAuditRecoveryCC.__internal_x_context__currentSurgicalAuditRecovery_" + componentIdentifier, "BO-1072100106-RECOVERYLOCUMNURSE", "RecoveryLocumNurse");
			fields[159] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalAuditRecoveryCC.__internal_x_context__currentSurgicalAuditRecovery_" + componentIdentifier, "BO-1072100106-RECOVERYHANDOVERLOCUMBOOL", "RecoveryHandoverLocumBool");
			fields[160] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalAuditRecoveryCC.__internal_x_context__currentSurgicalAuditRecovery_" + componentIdentifier, "BO-1072100106-RECOVERYHANDOVERLOCUMNURSE", "RecoveryHandoverLocumNurse");
			fields[161] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalAuditRecoveryCC.__internal_x_context__currentSurgicalAuditRecovery_" + componentIdentifier, "BO-1072100106-WARDLOCUMBOOL", "WardLocumBool");
			fields[162] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalAuditRecoveryCC.__internal_x_context__currentSurgicalAuditRecovery_" + componentIdentifier, "BO-1072100106-WARDLOCUMNURSE", "WardLocumNurse");
			return fields;
		}
