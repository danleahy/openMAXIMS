...
public class GenForm extends FormBridge
{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1012), new Integer(anchoringHelper12.getX()), new Integer(anchoringHelper12.getY()), new Integer(anchoringHelper12.getWidth()), new Integer(anchoringHelper12.getHeight()), new Integer(startTabIndex.intValue() + 10), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Edit", Boolean.TRUE, null, Boolean.FALSE, Boolean.FALSE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientMeetings.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1072100058-ID", "ID_PatientMeeting");
			fields[145] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientMeetings.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1072100058-CARECONTEXT", "CareContext");
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientMeetings.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1072100058-CLINICALCONTACT", "ClinicalContact");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientMeetings.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1072100058-MEETINGDATETIME", "MeetingDateTime");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientMeetings.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1072100058-NEXTMEETINGDATE", "NextMeetingDate");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientMeetings.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1072100058-STATUS", "Status");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientMeetings.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1072100058-MEETINGNOTES", "MeetingNotes");
			return fields;
		}
