...
public class GenForm extends FormBridge
{
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeAllergiesEtcComponent.__internal_x_context__VoAllergy_" + componentIdentifier, "BO-1003100008-ID", "ID_PatientAllergy");
			fields[145] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeAllergiesEtcComponent.__internal_x_context__VoAllergy_" + componentIdentifier, "BO-1003100008-ALLERGENDESCRIPTION", "AllergenDescription");
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeAllergiesEtcComponent.__internal_x_context__VoAllergy_" + componentIdentifier, "BO-1003100008-ALLERGENTYPE", "AllergenType");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeAllergiesEtcComponent.__internal_x_context__VoAllergy_" + componentIdentifier, "BO-1003100008-WHENIDENTIFIED", "WhenIdentified");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeAllergiesEtcComponent.__internal_x_context__VoAllergy_" + componentIdentifier, "BO-1003100008-SOURCEOFINFORMATION", "SourceofInformation");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeAllergiesEtcComponent.__internal_x_context__VoAllergy_" + componentIdentifier, "BO-1003100008-COMMENTS", "Comments");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeAllergiesEtcComponent.__internal_x_context__VoAllergy_" + componentIdentifier, "BO-1003100008-ISCURRENTLYACTIVEALLERGY", "IsCurrentlyActiveAllergy");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeAllergiesEtcComponent.__internal_x_context__VoAllergy_" + componentIdentifier, "BO-1003100008-PATIENT", "Patient");
			fields[152] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeAllergiesEtcComponent.__internal_x_context__VoAllergy_" + componentIdentifier, "BO-1003100008-INACTIVATIONCOMMENTS", "InactivationComments");
			fields[153] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeAllergiesEtcComponent.__internal_x_context__PatientNoAllergyInfo_" + componentIdentifier, "BO-1003100085-ID", "ID_PatientNoAllergyInfo");
			fields[154] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeAllergiesEtcComponent.__internal_x_context__PatientNoAllergyInfo_" + componentIdentifier, "BO-1003100085-PATIENT", "Patient");
			fields[155] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeAllergiesEtcComponent.__internal_x_context__PatientNoAllergyInfo_" + componentIdentifier, "BO-1003100085-ALLERGYSTATUS", "AllergyStatus");
			fields[156] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeAllergiesEtcComponent.__internal_x_context__PatientNoAllergyInfo_" + componentIdentifier, "BO-1003100085-WHENIDENTIFIED", "WhenIdentified");
			fields[157] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeAllergiesEtcComponent.__internal_x_context__PatientNoAllergyInfo_" + componentIdentifier, "BO-1003100085-SOURCEOFINFORMATION", "SourceofInformation");
			fields[158] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeAllergiesEtcComponent.__internal_x_context__AlertRecord_" + componentIdentifier, "BO-1003100012-ID", "ID_PatientAlert");
			fields[159] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeAllergiesEtcComponent.__internal_x_context__AlertRecord_" + componentIdentifier, "BO-1003100012-ALERTTYPE", "AlertType");
			fields[160] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeAllergiesEtcComponent.__internal_x_context__AlertRecord_" + componentIdentifier, "BO-1003100012-ISCURRENTLYACTIVEALERT", "IsCurrentlyActiveAlert");
			fields[161] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeAllergiesEtcComponent.__internal_x_context__AlertRecord_" + componentIdentifier, "BO-1003100012-COMMENTS", "Comments");
			fields[162] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeAllergiesEtcComponent.__internal_x_context__AlertRecord_" + componentIdentifier, "BO-1003100012-SOURCEOFINFORMATION", "SourceofInformation");
			fields[163] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeAllergiesEtcComponent.__internal_x_context__AlertRecord_" + componentIdentifier, "BO-1003100012-DATEIDENTIFIED", "DateIdentified");
			fields[164] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeAllergiesEtcComponent.__internal_x_context__AlertRecord_" + componentIdentifier, "BO-1003100012-PATIENT", "Patient");
			fields[165] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeAllergiesEtcComponent.__internal_x_context__AlertRecord_" + componentIdentifier, "BO-1003100012-INACTIVATIONCOMMENTS", "InactivationComments");
			return fields;
		}
