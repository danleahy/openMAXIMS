...
public class GenForm extends FormBridge
{
	...
	public static class ctnDetailsContainer extends ContainerBridge
	{
		...
		protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
		{
			...
			ims.framework.FormUiLogic m_customControlAuthoringInfoForm = loader.loadComponent(102228, appForm, startControlID * 10 + 1000, anchoringHelper1.getSize(), instance1, startTabIndex.intValue() + 16, skipContextValidation);
			//ims.framework.Control m_customControlAuthoringInfoControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1000), new Integer(434), new Integer(128), new Integer(382), new Integer(56), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT, new Integer(startTabIndex.intValue() + 16), m_customControlAuthoringInfoForm, instance1 } );
			ims.framework.Control m_customControlAuthoringInfoControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1001),  new Integer(anchoringHelper1.getX()), new Integer(anchoringHelper1.getY()), new Integer(anchoringHelper1.getWidth()), new Integer(anchoringHelper1.getHeight()), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT, new Integer(startTabIndex.intValue() + 16), m_customControlAuthoringInfoForm, instance1, Boolean.FALSE } );
			...
			ims.framework.FormUiLogic m_customControlCodingItemForm = loader.loadComponent(123133, appForm, startControlID * 10 + 2000, anchoringHelper2.getSize(), instance2, startTabIndex.intValue() + 7, skipContextValidation);
			//ims.framework.Control m_customControlCodingItemControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1002), new Integer(8), new Integer(24), new Integer(808), new Integer(64), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT, new Integer(startTabIndex.intValue() + 7), m_customControlCodingItemForm, instance2 } );
			ims.framework.Control m_customControlCodingItemControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1003),  new Integer(anchoringHelper2.getX()), new Integer(anchoringHelper2.getY()), new Integer(anchoringHelper2.getWidth()), new Integer(anchoringHelper2.getHeight()), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT, new Integer(startTabIndex.intValue() + 7), m_customControlCodingItemForm, instance2, Boolean.FALSE } );
			...
			RuntimeAnchoring anchoringHelper4 = new RuntimeAnchoring(designSize, runtimeSize, 442, 191, 95, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
			...
			super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1012), new Integer(anchoringHelper11.getX()), new Integer(anchoringHelper11.getY()), new Integer(anchoringHelper11.getWidth()), new Integer(anchoringHelper11.getHeight()), new Integer(startTabIndex.intValue() + 13), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.TRUE, new Integer(250), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
			...
			super.addControl(factory.getControl(PartialDateBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1014), new Integer(anchoringHelper13.getX()), new Integer(anchoringHelper13.getY()), new Integer(anchoringHelper13.getWidth()), new Integer(anchoringHelper13.getHeight()), new Integer(startTabIndex.intValue() + 15), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT, "Invalid date entered", Boolean.FALSE, Boolean.FALSE}));
			...
			ComboBox m_cmbTypeTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1015), new Integer(anchoringHelper14.getX()), new Integer(anchoringHelper14.getY()), new Integer(anchoringHelper14.getWidth()), new Integer(anchoringHelper14.getHeight()), new Integer(startTabIndex.intValue() + 11), ControlState.DISABLED, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,Boolean.TRUE, Boolean.TRUE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
			...
			ComboBox m_cmbSourceTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1017), new Integer(anchoringHelper16.getX()), new Integer(anchoringHelper16.getY()), new Integer(anchoringHelper16.getWidth()), new Integer(anchoringHelper16.getHeight()), new Integer(startTabIndex.intValue() + 14), ControlState.DISABLED, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.TRUE, new Integer(-1)});
	...
	public static class groupFilterRadioButton extends RadioButtonBridge
	{
		...
		protected void setContext(Integer startTabIndex, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize)
		{
			...
			control.addButton(0, anchoringHelper18.getX(), anchoringHelper18.getY(), anchoringHelper18.getWidth(), "View All", startTabIndex.intValue() + 3);
	...
	private void validateContext(ims.framework.Context context)
	{
		...
		if(!context.isValidContextType(ims.core.vo.AllergiesResultsSearchCriteriaVo.class))
			throw new ims.framework.exceptions.CodingRuntimeException("The type 'ims.core.vo.AllergiesResultsSearchCriteriaVo' of the global context variable 'Core.AllergiesResultsSearchCriteria' is not supported.");
	}
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.Allergies.__internal_x_context__VoAllergy_" + componentIdentifier, "BO-1003100008-ID", "ID_PatientAllergy");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.Allergies.__internal_x_context__VoAllergy_" + componentIdentifier, "BO-1003100008-SOURCEOFINFORMATION", "SourceofInformation");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.Allergies.__internal_x_context__VoAllergy_" + componentIdentifier, "BO-1003100008-WHENIDENTIFIED", "WhenIdentified");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.Allergies.__internal_x_context__VoAllergy_" + componentIdentifier, "BO-1003100008-COMMENTS", "Comments");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.Allergies.__internal_x_context__VoAllergy_" + componentIdentifier, "BO-1003100008-ISCURRENTLYACTIVEALLERGY", "IsCurrentlyActiveAllergy");
			fields[152] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.Allergies.__internal_x_context__VoAllergy_" + componentIdentifier, "BO-1003100008-ALLERGENDESCRIPTION", "AllergenDescription");
			fields[153] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.Allergies.__internal_x_context__VoAllergy_" + componentIdentifier, "BO-1003100008-ALLERGENTYPE", "AllergenType");
			fields[154] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.Allergies.__internal_x_context__VoAllergy_" + componentIdentifier, "BO-1003100008-PATIENT", "Patient");
			fields[155] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.Allergies.__internal_x_context__PatientNoAllergyInfo_" + componentIdentifier, "BO-1003100085-ID", "ID_PatientNoAllergyInfo");
			fields[156] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.Allergies.__internal_x_context__PatientNoAllergyInfo_" + componentIdentifier, "BO-1003100085-PATIENT", "Patient");
			fields[157] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.Allergies.__internal_x_context__PatientNoAllergyInfo_" + componentIdentifier, "BO-1003100085-ALLERGYSTATUS", "AllergyStatus");
			fields[158] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.Allergies.__internal_x_context__PatientNoAllergyInfo_" + componentIdentifier, "BO-1003100085-WHENIDENTIFIED", "WhenIdentified");
			fields[159] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.Allergies.__internal_x_context__PatientNoAllergyInfo_" + componentIdentifier, "BO-1003100085-SOURCEOFINFORMATION", "SourceofInformation");
			return fields;
		}
