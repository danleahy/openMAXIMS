...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "OtherEquipmentIntraOpDialog";
	}
	public int getWidth()
	{
		return 576;
	...
	{
		return new String[] { "_cv_Clinical.TheatreAppointmentRef", "_cv_Clinical.OtherEquipmentIntraOpVo", "_cv_Clinical.IntraOpCaseStaffDetailRefVo" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Clinical.OtherEquipmentIntraOpDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
