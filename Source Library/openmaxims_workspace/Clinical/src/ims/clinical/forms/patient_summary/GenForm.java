...
public class GenForm extends FormBridge
{
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, "_cv_Clinical.CareContextWithHistory", "BO-1004100019-ID", "ID_CareContext");
			fields[145] = new ims.framework.ReportField(this.context, "_cv_Clinical.CareContextWithHistory", "BO-1004100019-CONTEXT", "Context");
			fields[146] = new ims.framework.ReportField(this.context, "_cv_Clinical.CareContextWithHistory", "BO-1004100019-STARTDATETIME", "StartDateTime");
			fields[147] = new ims.framework.ReportField(this.context, "_cv_Clinical.CareContextWithHistory", "BO-1004100019-ENDDATETIME", "EndDateTime");
			fields[148] = new ims.framework.ReportField(this.context, "_cv_Clinical.PatientSummary.CareSpell", "BO-1004100017-ID", "ID_CareSpell");
			fields[149] = new ims.framework.ReportField(this.context, "_cv_Clinical.PatientSummary.CareSpell", "BO-1004100017-STARTDATE", "StartDate");
			fields[150] = new ims.framework.ReportField(this.context, "_cv_Clinical.PatientSummary.CareSpell", "BO-1004100017-ENDDATE", "EndDate");
			fields[151] = new ims.framework.ReportField(this.context, "_cv_Clinical.PatientSummary.CareSpell", "BO-1004100017-PATIENT", "Patient");
			fields[152] = new ims.framework.ReportField(this.context, "_cv_Clinical.EpisodeOfCareWithHistory", "BO-1004100018-ID", "ID_EpisodeOfCare");
			fields[153] = new ims.framework.ReportField(this.context, "_cv_Clinical.EpisodeOfCareWithHistory", "BO-1004100018-SPECIALTY", "Specialty");
			fields[154] = new ims.framework.ReportField(this.context, "_cv_Clinical.EpisodeOfCareWithHistory", "BO-1004100018-STARTDATE", "StartDate");
			fields[155] = new ims.framework.ReportField(this.context, "_cv_Clinical.EpisodeOfCareWithHistory", "BO-1004100018-ENDDATE", "EndDate");
			fields[156] = new ims.framework.ReportField(this.context, "_cv_Clinical.UnsavedSOAPINformation", "BO-1072100036-ID", "ID_SoapNote");
			fields[157] = new ims.framework.ReportField(this.context, "_cv_Clinical.UnsavedSOAPINformation", "BO-1072100036-SUBJECTIVENOTE", "SubjectiveNote");
			fields[158] = new ims.framework.ReportField(this.context, "_cv_Clinical.UnsavedSOAPINformation", "BO-1072100036-OBJECTIVENOTE", "ObjectiveNote");
			fields[159] = new ims.framework.ReportField(this.context, "_cv_Clinical.UnsavedSOAPINformation", "BO-1072100036-ANALYSISNOTE", "AnalysisNote");
			fields[160] = new ims.framework.ReportField(this.context, "_cv_Clinical.UnsavedSOAPINformation", "BO-1072100036-PLANNOTE", "PlanNote");
			fields[161] = new ims.framework.ReportField(this.context, "_cv_Clinical.UnsavedSOAPINformation", "BO-1072100036-CLINICALNOTE", "ClinicalNote");
			fields[162] = new ims.framework.ReportField(this.context, "_cv_Clinical.UnsavedSOAPINformation", "BO-1072100036-CARECONTEXT", "CareContext");
			fields[163] = new ims.framework.ReportField(this.context, "_cv_Core.ParentClinContact", "BO-1004100003-ID", "ID_ClinicalContact");
			fields[164] = new ims.framework.ReportField(this.context, "_cv_Core.ParentClinContact", "BO-1004100003-SPECIALTY", "Specialty");
			fields[165] = new ims.framework.ReportField(this.context, "_cv_Core.ParentClinContact", "BO-1004100003-CONTACTTYPE", "ContactType");
			fields[166] = new ims.framework.ReportField(this.context, "_cv_Core.ParentClinContact", "BO-1004100003-STARTDATETIME", "StartDateTime");
			fields[167] = new ims.framework.ReportField(this.context, "_cv_Core.ParentClinContact", "BO-1004100003-ENDDATETIME", "EndDateTime");
			fields[168] = new ims.framework.ReportField(this.context, "_cv_Core.ParentClinContact", "BO-1004100003-CARECONTEXT", "CareContext");
			fields[169] = new ims.framework.ReportField(this.context, "_cv_Core.ParentClinContact", "BO-1004100003-ISCLINICALNOTECREATED", "IsClinicalNoteCreated");
			fields[170] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalContact", "BO-1004100003-ID", "ID_ClinicalContact");
			fields[171] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalContact", "BO-1004100003-SPECIALTY", "Specialty");
			fields[172] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalContact", "BO-1004100003-SEENBY", "SeenBy");
			fields[173] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalContact", "BO-1004100003-CONTACTTYPE", "ContactType");
			fields[174] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalContact", "BO-1004100003-STARTDATETIME", "StartDateTime");
			fields[175] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalContact", "BO-1004100003-ENDDATETIME", "EndDateTime");
			fields[176] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalContact", "BO-1004100003-CARECONTEXT", "CareContext");
			fields[177] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalContact", "BO-1004100003-ISCLINICALNOTECREATED", "IsClinicalNoteCreated");
			fields[178] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalNotesShort", "BO-1011100000-ID", "ID_ClinicalNotes");
			fields[179] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalNotesShort", "BO-1011100000-CLINICALNOTE", "ClinicalNote");
			fields[180] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalNotesShort", "BO-1011100000-NOTETYPE", "NoteType");
			fields[181] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalNotesShort", "BO-1011100000-DISCIPLINE", "Discipline");
			fields[182] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalNotesShort", "BO-1011100000-CLINICALCONTACT", "ClinicalContact");
			fields[183] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalNotesShort", "BO-1011100000-ISDERIVEDNOTE", "IsDerivedNote");
			fields[184] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalNotesShort", "BO-1011100000-FORREVIEW", "ForReview");
			fields[185] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalNotesShort", "BO-1011100000-FORREVIEWDISCIPLINE", "ForReviewDiscipline");
			fields[186] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalNotesShort", "BO-1011100000-REVIEWINGDATETIME", "ReviewingDateTime");
			fields[187] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalNotesShort", "BO-1011100000-ISCORRECTED", "IsCorrected");
			fields[188] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalNotesShort", "BO-1011100000-ISTRANSCRIBED", "IsTranscribed");
			fields[189] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalNotesShort", "BO-1011100000-SOURCEOFNOTE", "SourceOfNote");
			fields[190] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalNotesShort", "BO-1011100000-RECORDINGDATETIME", "RecordingDateTime");
			fields[191] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalNotesShort", "BO-1011100000-NOTECLASSIFICATION", "NoteClassification");
			fields[192] = new ims.framework.ReportField(this.context, "_cv_Clinical.PatientSummary.ClinicalContact", "BO-1004100003-ID", "ID_ClinicalContact");
			fields[193] = new ims.framework.ReportField(this.context, "_cv_Clinical.PatientSummary.EpisodeOfCare", "BO-1004100018-ID", "ID_EpisodeOfCare");
			fields[194] = new ims.framework.ReportField(this.context, "_cv_ICP.Service", "BO-1003100032-ID", "ID_Service");
			fields[195] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedPatientProcedureFromPatientSummary", "BO-1003100017-ID", "ID_PatientProcedure");
			fields[196] = new ims.framework.ReportField(this.context, "_cv_Clinical.PatientSummary.CareContext", "BO-1004100019-ID", "ID_CareContext");
			fields[197] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedPatientDiagnosisFromPatientSummary", "BO-1003100016-ID", "ID_PatientDiagnosis");
			fields[198] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedPatientProblemFromPatientSummary", "BO-1023100001-ID", "ID_PatientProblem");
			fields[199] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.Patient_Summary.__internal_x_context__PreviousDiagnosisEpisodeOfCare_" + componentIdentifier, "BO-1004100018-ID", "ID_EpisodeOfCare");
			fields[200] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.Patient_Summary.__internal_x_context__PreviousProcedureEpisodeOfCare_" + componentIdentifier, "BO-1004100018-ID", "ID_EpisodeOfCare");
			return fields;
		}
