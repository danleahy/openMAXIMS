...
public class GenForm extends FormBridge
{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		// Button Controls
		RuntimeAnchoring anchoringHelper1 = new RuntimeAnchoring(designSize, runtimeSize, 200, 248, 75, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT);
		...
		// Grid Controls
		RuntimeAnchoring anchoringHelper2 = new RuntimeAnchoring(designSize, runtimeSize, 8, 16, 464, 224, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT);
		...
		grdCommChannels.addComboBoxColumn("Contact Type", 0, 0, 150, true, true, false, false, true, -1);
		grdCommChannels.addStringColumn("Contact Value", 0, 0, -1, true, false, 0, 50, true, ims.framework.enumerations.CharacterCasing.NORMAL);
