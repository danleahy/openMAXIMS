...
public class GenForm extends FormBridge
{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1012), new Integer(anchoringHelper12.getX()), new Integer(anchoringHelper12.getY()), new Integer(anchoringHelper12.getWidth()), new Integer(anchoringHelper12.getHeight()), new Integer(startTabIndex.intValue() + 14), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Edit", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1013), new Integer(anchoringHelper13.getX()), new Integer(anchoringHelper13.getY()), new Integer(anchoringHelper13.getWidth()), new Integer(anchoringHelper13.getHeight()), new Integer(startTabIndex.intValue() + 12), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Active", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1014), new Integer(anchoringHelper14.getX()), new Integer(anchoringHelper14.getY()), new Integer(anchoringHelper14.getWidth()), new Integer(anchoringHelper14.getHeight()), new Integer(startTabIndex.intValue() + 13), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Remove From List", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(DateTimeControl.class, new Object[] { control, new Integer(startControlID.intValue() + 1021), new Integer(anchoringHelper21.getX()), new Integer(anchoringHelper21.getY()), new Integer(anchoringHelper21.getWidth()), new Integer(anchoringHelper21.getHeight()), new Integer(startTabIndex.intValue() + 10), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.TRUE, null, Boolean.FALSE, null, Boolean.TRUE, null}));
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, "_cv_Clinical.HospitalAtNightNotes", "BO-1072100097-ID", "ID_HospitalAtNightNotes");
			fields[145] = new ims.framework.ReportField(this.context, "_cv_Clinical.HospitalAtNightNotes", "BO-1072100097-NOTE", "Note");
			fields[146] = new ims.framework.ReportField(this.context, "_cv_Clinical.HospitalAtNightPatientDetails", "BO-1072100096-ID", "ID_HospitalAtNightPatientDetail");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.HospitalAtNightPatientDetail.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1072100096-ID", "ID_HospitalAtNightPatientDetail");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.HospitalAtNightPatientDetail.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1072100096-CARECONTEXT", "CareContext");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.HospitalAtNightPatientDetail.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1072100096-PATIENT", "Patient");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.HospitalAtNightPatientDetail.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1072100096-SITUATION", "Situation");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.HospitalAtNightPatientDetail.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1072100096-BACKGROUND", "Background");
			fields[152] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.HospitalAtNightPatientDetail.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1072100096-ASSESSMENT", "Assessment");
			fields[153] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.HospitalAtNightPatientDetail.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1072100096-RECOMMENDATION", "Recommendation");
			fields[154] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.HospitalAtNightPatientDetail.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1072100096-MEWS", "MEWS");
			fields[155] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.HospitalAtNightPatientDetail.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1072100096-TYPEOFREQUEST", "TypeOfRequest");
			fields[156] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.HospitalAtNightPatientDetail.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1072100096-REQUESTINGDATETIME", "RequestingDateTime");
			fields[157] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.HospitalAtNightPatientDetail.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1072100096-WARDWHENPLACEDONLIST", "WardWhenPlacedOnList");
			fields[158] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.HospitalAtNightPatientDetail.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1072100096-HOSPITALATNIGHTLISTANDDATES", "HospitalAtNightListAndDates");
			fields[159] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.HospitalAtNightPatientDetail.__internal_x_context__HospitalAtNightConfig_" + componentIdentifier, "BO-1073100034-ID", "ID_HospitalAtNightCutOverPointsConfig");
			fields[160] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.HospitalAtNightPatientDetail.__internal_x_context__HospitalAtNightConfig_" + componentIdentifier, "BO-1073100034-STARTTIME", "StartTime");
			fields[161] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.HospitalAtNightPatientDetail.__internal_x_context__HospitalAtNightConfig_" + componentIdentifier, "BO-1073100034-ENDTIME", "EndTime");
			fields[162] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.HospitalAtNightPatientDetail.__internal_x_context__HospitalAtNightConfig_" + componentIdentifier, "BO-1073100034-HOSPITAL", "Hospital");
			fields[163] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.HospitalAtNightPatientDetail.__internal_x_context__LoggedHCP_" + componentIdentifier, "BO-1006100000-ID", "ID_Hcp");
			fields[164] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.HospitalAtNightPatientDetail.__internal_x_context__LoggedHCP_" + componentIdentifier, "BO-1006100000-HCPTYPE", "HcpType");
			fields[165] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.HospitalAtNightPatientDetail.__internal_x_context__LoggedHCP_" + componentIdentifier, "BO-1006100000-ISACTIVE", "IsActive");
			fields[166] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.HospitalAtNightPatientDetail.__internal_x_context__LoggedHCP_" + componentIdentifier, "BO-1006100000-ISHCPARESPONSIBLEHCP", "IsHCPaResponsibleHCP");
			fields[167] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.HospitalAtNightPatientDetail.__internal_x_context__LoggedHCP_" + componentIdentifier, "BO-1006100000-ISARESPONSIBLEEDCLINICIAN", "IsAResponsibleEDClinician");
			fields[168] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.HospitalAtNightPatientDetail.__internal_x_context__LoggedHCP_" + componentIdentifier, "BO-1006100000-ISHCPAENDOSCOPIST", "IsHCPaEndoscopist");
			return fields;
		}
