...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "AnaestheticSignInDialog";
	}
	public int getWidth()
	{
		return 896;
	...
	{
		return new String[] { "_cv_Scheduling.TheatreSession", "_cv_Clinical.TheatreBookingRef", "_cv_Clinical.TheatreAppointmentRef", "_cv_Clinical.AcuteTheatreCaseTimes.PersistAnaestheticTime", "_cv_Clinical.AcuteTheatreCaseTimes.SignIn" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Clinical.AnaestheticSignInDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
