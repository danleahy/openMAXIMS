...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "InternalReferralsBookedListComponent";
	}
	public int getWidth()
	{
		return 848;
	...
	{
		return new String[] { "_cv_Clinical.ClinicalReferralRef" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Clinical.InternalReferralsBookedListComponent.__internal_x_context__" + String.valueOf(getFormId());
	}
