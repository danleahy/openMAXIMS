...
public class GenForm extends FormBridge
{
	...
	public static class ctnDetailsContainer extends ContainerBridge
	{
		...
		protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
		{
			...
			super.addControl(factory.getControl(DateTimeControl.class, new Object[] { control, new Integer(startControlID.intValue() + 1016), new Integer(anchoringHelper15.getX()), new Integer(anchoringHelper15.getY()), new Integer(anchoringHelper15.getWidth()), new Integer(anchoringHelper15.getHeight()), new Integer(startTabIndex.intValue() + 25), ControlState.DISABLED, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFTRIGHT,Boolean.TRUE, null, Boolean.FALSE, null, Boolean.FALSE, null}));
			...
			ComboBox m_cmbRecordingHCPTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1017), new Integer(anchoringHelper16.getX()), new Integer(anchoringHelper16.getY()), new Integer(anchoringHelper16.getWidth()), new Integer(anchoringHelper16.getHeight()), new Integer(startTabIndex.intValue() + 26), ControlState.DISABLED, ControlState.DISABLED,ims.framework.enumerations.ControlAnchoring.BOTTOMLEFTRIGHT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
	...
	private void validateContext(ims.framework.Context context)
	{
		...
		if(!context.isValidContextType(ims.clinical.vo.MedicationOnAdmissionSearchCriteriaVo.class))
			throw new ims.framework.exceptions.CodingRuntimeException("The type 'ims.clinical.vo.MedicationOnAdmissionSearchCriteriaVo' of the global context variable 'Clinical.MedicationOnAdmissionSearchCriteria' is not supported.");
		if(!context.isValidContextType(ims.clinical.vo.MedicationOnAdmissionSearchCriteriaVo.class))
			throw new ims.framework.exceptions.CodingRuntimeException("The type 'ims.clinical.vo.MedicationOnAdmissionSearchCriteriaVo' of the global context variable 'Clinical.MedicationSearchCriteria' is not supported.");
		if(!context.isValidContextType(ims.clinical.vo.MedicationOnAdmissionSearchCriteriaVo.class))
			throw new ims.framework.exceptions.CodingRuntimeException("The type 'ims.clinical.vo.MedicationOnAdmissionSearchCriteriaVo' of the global context variable 'Clinical.MedicationOnDischargeSearchCriteria' is not supported.");
	}
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1022), new Integer(anchoringHelper24.getX()), new Integer(anchoringHelper24.getY()), new Integer(anchoringHelper24.getWidth()), new Integer(anchoringHelper24.getHeight()), new Integer(startTabIndex.intValue() + 21), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Close", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1023), new Integer(anchoringHelper25.getX()), new Integer(anchoringHelper25.getY()), new Integer(anchoringHelper25.getWidth()), new Integer(anchoringHelper25.getHeight()), new Integer(startTabIndex.intValue() + 20), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Inactivate", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1024), new Integer(anchoringHelper26.getX()), new Integer(anchoringHelper26.getY()), new Integer(anchoringHelper26.getWidth()), new Integer(anchoringHelper26.getHeight()), new Integer(startTabIndex.intValue() + 19), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Edit", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1025), new Integer(anchoringHelper27.getX()), new Integer(anchoringHelper27.getY()), new Integer(anchoringHelper27.getWidth()), new Integer(anchoringHelper27.getHeight()), new Integer(startTabIndex.intValue() + 24), ControlState.HIDDEN, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Cancel", Boolean.FALSE, null, Boolean.FALSE, Boolean.FALSE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.MedicationOnAdmission.__internal_x_context__Record_" + componentIdentifier, "BO-1003100014-ID", "ID_PatientMedication");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.MedicationOnAdmission.__internal_x_context__Record_" + componentIdentifier, "BO-1003100014-OTHERMEDICATIONTEXT", "OtherMedicationText");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.MedicationOnAdmission.__internal_x_context__Record_" + componentIdentifier, "BO-1003100014-PATIENT", "Patient");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.MedicationOnAdmission.__internal_x_context__Record_" + componentIdentifier, "BO-1003100014-FREQUENCY", "Frequency");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.MedicationOnAdmission.__internal_x_context__Record_" + componentIdentifier, "BO-1003100014-SOURCEOFINFORMATION", "SourceofInformation");
			fields[152] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.MedicationOnAdmission.__internal_x_context__Record_" + componentIdentifier, "BO-1003100014-COMMENCEDDATE", "CommencedDate");
			fields[153] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.MedicationOnAdmission.__internal_x_context__Record_" + componentIdentifier, "BO-1003100014-NODAYSSUPPLY", "NoDaysSupply");
			fields[154] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.MedicationOnAdmission.__internal_x_context__Record_" + componentIdentifier, "BO-1003100014-BATCHNO", "BatchNo");
			fields[155] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.MedicationOnAdmission.__internal_x_context__Record_" + componentIdentifier, "BO-1003100014-EXPIRYDATE", "ExpiryDate");
			fields[156] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.MedicationOnAdmission.__internal_x_context__Record_" + componentIdentifier, "BO-1003100014-ISDISCONTINUED", "IsDiscontinued");
			fields[157] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.MedicationOnAdmission.__internal_x_context__Record_" + componentIdentifier, "BO-1003100014-DIFFICULTIESWITHMED", "DifficultiesWithMed");
			fields[158] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.MedicationOnAdmission.__internal_x_context__Record_" + componentIdentifier, "BO-1003100014-SUPPLIED", "Supplied");
			fields[159] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.MedicationOnAdmission.__internal_x_context__Record_" + componentIdentifier, "BO-1003100014-INPOSSESSION", "InPossession");
			fields[160] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.MedicationOnAdmission.__internal_x_context__Record_" + componentIdentifier, "BO-1003100014-ISMEDICATIONONADMISSION", "IsMedicationonAdmission");
			fields[161] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.MedicationOnAdmission.__internal_x_context__Record_" + componentIdentifier, "BO-1003100014-ISDISCHARGEMEDICATION", "IsDischargeMedication");
			fields[162] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.MedicationOnAdmission.__internal_x_context__Record_" + componentIdentifier, "BO-1003100014-CARECONTEXT", "CareContext");
			fields[163] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.MedicationOnAdmission.__internal_x_context__Record_" + componentIdentifier, "BO-1003100014-ISINTTO", "IsInTTO");
			fields[164] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.MedicationOnAdmission.__internal_x_context__Record_" + componentIdentifier, "BO-1003100014-ISDISCONTINUEDDATE", "IsDiscontinuedDate");
			fields[165] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.MedicationOnAdmission.__internal_x_context__Record_" + componentIdentifier, "BO-1003100014-ISDISCONTINUEDREASON", "IsDiscontinuedReason");
			fields[166] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.MedicationOnAdmission.__internal_x_context__Record_" + componentIdentifier, "BO-1003100014-ISDISCONTINUEDREASONTEXT", "IsDiscontinuedReasonText");
			fields[167] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.MedicationOnAdmission.__internal_x_context__Record_" + componentIdentifier, "BO-1003100014-ISCOPIED", "IsCopied");
			fields[168] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.MedicationOnAdmission.__internal_x_context__Record_" + componentIdentifier, "BO-1003100014-COMMENCEDBYTYPE", "CommencedByType");
			fields[169] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.MedicationOnAdmission.__internal_x_context__Record_" + componentIdentifier, "BO-1003100014-DISCONTINUEDBYTYPE", "DiscontinuedByType");
			fields[170] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.MedicationOnAdmission.__internal_x_context__Record_" + componentIdentifier, "BO-1003100014-SELFMEDICATING", "SelfMedicating");
			fields[171] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.MedicationOnAdmission.__internal_x_context__Record_" + componentIdentifier, "BO-1003100014-COMMENT", "Comment");
			return fields;
		}
