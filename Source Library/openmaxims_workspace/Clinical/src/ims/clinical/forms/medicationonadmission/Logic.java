...
import ims.clinical.forms.medicationonadmission.GenForm.Group1Enumeration;
import ims.clinical.vo.MedicationOnAdmissionSearchCriteriaVo;
...
public class Logic extends BaseLogic
{
	...
	private static final int LIST_INACTIVE		= 3;
	...
	protected void onFormOpen() throws ims.framework.exceptions.FormOpenException
	{
		...
		//WDEV-19389 
		if (engine.getFormName().equals(form.getForms().Clinical.MedicationOnAdmission))
		{
			if (!(form.getGlobalContext().Core.getCurrentCareContextIsNotNull() && form.getGlobalContext().Clinical.getMedicationOnAdmissionSearchCriteriaIsNotNull() && form.getGlobalContext().Core.getCurrentCareContext().equals(form.getGlobalContext().Clinical.getMedicationOnAdmissionSearchCriteria().getCareContext())))
				form.getGlobalContext().Clinical.setMedicationOnAdmissionSearchCriteria(null);
			setGlobalContext(form.getGlobalContext().Clinical.getMedicationOnAdmissionSearchCriteria());
		}
		else if (engine.getFormName().equals(form.getForms().Clinical.MedicationOnDischarge))
		{
			if (!(form.getGlobalContext().Core.getCurrentCareContextIsNotNull() && form.getGlobalContext().Clinical.getMedicationOnDischargeSearchCriteriaIsNotNull() && form.getGlobalContext().Core.getCurrentCareContext().equals(form.getGlobalContext().Clinical.getMedicationOnDischargeSearchCriteria().getCareContext())))
				form.getGlobalContext().Clinical.setMedicationOnDischargeSearchCriteria(null);
			setGlobalContext(form.getGlobalContext().Clinical.getMedicationOnDischargeSearchCriteria());
		}
		else if (engine.getFormName().equals(form.getForms().Clinical.Medication))
		{
			if (!(form.getGlobalContext().Core.getCurrentCareContextIsNotNull() && form.getGlobalContext().Clinical.getMedicationSearchCriteriaIsNotNull() && form.getGlobalContext().Core.getCurrentCareContext().equals(form.getGlobalContext().Clinical.getMedicationSearchCriteria().getCareContext())))
				form.getGlobalContext().Clinical.setMedicationSearchCriteria(null);
			setGlobalContext(form.getGlobalContext().Clinical.getMedicationSearchCriteria());
		}
		//WDEV-19389 - end
	...
	private void setGlobalContext(MedicationOnAdmissionSearchCriteriaVo medicationOnAdmissionSearchCriteria)
	{
		if(medicationOnAdmissionSearchCriteria != null)
		{
			setSearchCriteria(medicationOnAdmissionSearchCriteria);
			try
			{
	...
	private MedicationOnAdmissionSearchCriteriaVo getSearchCriteria()
	{
		MedicationOnAdmissionSearchCriteriaVo searchCriteria = new MedicationOnAdmissionSearchCriteriaVo();
	...
	private void setSearchCriteria(MedicationOnAdmissionSearchCriteriaVo medicationOnAdmissionSearchCriteriaVo)
	{
		setViewType(medicationOnAdmissionSearchCriteriaVo.getViewType());		
	}
	...
	private void setViewType(Integer searchType)
	{
		...
		case LIST_ACTIVE:
			...
			break;
		case LIST_INACTIVE:
			form.Group1().setValue(Group1Enumeration.rdoDiscontinued);
			break;
		}				
	}
	...
	private Integer getViewType()
	{
		...
		if (Group1Enumeration.rdoDiscontinued.equals(searchType))
		{
	...
	protected void onRadioButtonGroup1ValueChanged() throws PresentationLogicException 
	{
		...
		//WDEV-19389 - start
		if (engine.getFormName().equals(form.getForms().Clinical.MedicationOnAdmission))
			form.getGlobalContext().Clinical.setMedicationOnAdmissionSearchCriteria(getSearchCriteria());
		else if (engine.getFormName().equals(form.getForms().Clinical.MedicationOnDischarge))
			form.getGlobalContext().Clinical.setMedicationOnDischargeSearchCriteria(getSearchCriteria());
		else if (engine.getFormName().equals(form.getForms().Clinical.Medication))
			form.getGlobalContext().Clinical.setMedicationSearchCriteria(getSearchCriteria());
		//WDEV-19389 - end
	}
