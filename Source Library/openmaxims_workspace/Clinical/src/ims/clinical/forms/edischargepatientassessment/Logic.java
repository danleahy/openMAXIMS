...
public class Logic extends BaseLogic
{
	...
	protected String[] validateUIRules(String[] existingErrors)
	{
		...
		if (form.customControlCompleted().getValue() != null && form.customControlAuthoring().getValue() != null && form.customControlCompleted().getValue().getAuthoringDateTime().isLessThan(form.customControlAuthoring().getValue().getAuthoringDateTime()))
		{
			listOfErrors.add("'Completed Date/Time' cannot be earlier than 'Authoring Date/Time'");
		}
		if(listOfErrors.size() == 0)
		{			
			return null;
		}
		String[] result = listOfErrors.toArray(new String[listOfErrors.size()]);
