...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Clinical.TheatreAppointmentRef", "_cv_Clinical.IntraOpSpecimenVo" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Clinical.SpecimenIntraOpDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
