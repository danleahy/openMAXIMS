...
public class GenForm extends FormBridge
{
	...
	public static class lyrSuitableLayer extends Layer
	{
		...
		public static class tabPageDetailsContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				super.addControl(factory.getControl(RichTextControl.class, new Object[] { control, new Integer(startControlID.intValue() + 1002), new Integer(anchoringHelper3.getX()), new Integer(anchoringHelper3.getY()), new Integer(anchoringHelper3.getWidth()), new Integer(anchoringHelper3.getHeight()), new Integer(startTabIndex.intValue() + 16), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, Boolean.FALSE, Boolean.TRUE, new Integer(10000)} ));
				...
				super.addControl(factory.getControl(RichTextControl.class, new Object[] { control, new Integer(startControlID.intValue() + 1003), new Integer(anchoringHelper4.getX()), new Integer(anchoringHelper4.getY()), new Integer(anchoringHelper4.getWidth()), new Integer(anchoringHelper4.getHeight()), new Integer(startTabIndex.intValue() + 15), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPBOTTOMLEFT, Boolean.FALSE, Boolean.TRUE, new Integer(10000)} ));
			}
		...
		public static class tabPageCommentsContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				super.addControl(factory.getControl(DynamicGrid.class, new Object[] { control, new Integer(startControlID.intValue() + 1004), new Integer(anchoringHelper5.getX()), new Integer(anchoringHelper5.getY()), new Integer(anchoringHelper5.getWidth()), new Integer(anchoringHelper5.getHeight()), new Integer(startTabIndex.intValue() + 17), ControlState.DISABLED, ControlState.READONLY, ims.framework.enumerations.ControlAnchoring.ALL, contextMenus.Clinical.contextMenuSuitableForSurgeryComments, Boolean.TRUE, Boolean.FALSE, Boolean.TRUE}));
			}
	...
	public static class ctnConclusionsContainer extends ContainerBridge
	{
		...
		protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
		{
			...
			super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1019), new Integer(anchoringHelper20.getX()), new Integer(anchoringHelper20.getY()), new Integer(anchoringHelper20.getWidth()), new Integer(anchoringHelper20.getHeight()), new Integer(startTabIndex.intValue() + 27), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPBOTTOMRIGHT,Boolean.TRUE, new Integer(10000), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
			...
			super.addControl(factory.getControl(DateControl.class, new Object[] { control, new Integer(startControlID.intValue() + 1020), new Integer(anchoringHelper21.getX()), new Integer(anchoringHelper21.getY()), new Integer(anchoringHelper21.getWidth()), new Integer(anchoringHelper21.getHeight()), new Integer(startTabIndex.intValue() + 25), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT,Boolean.TRUE, null, Boolean.FALSE, null, Boolean.TRUE, null}));
			...
			ComboBox m_cmbReasonNotSuitableTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1021), new Integer(anchoringHelper22.getX()), new Integer(anchoringHelper22.getY()), new Integer(anchoringHelper22.getWidth()), new Integer(anchoringHelper22.getHeight()), new Integer(startTabIndex.intValue() + 26), ControlState.DISABLED, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPRIGHT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
			...
			super.addControl(factory.getControl(CheckBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1023), new Integer(anchoringHelper24.getX()), new Integer(anchoringHelper24.getY()), new Integer(anchoringHelper24.getWidth()), new Integer(anchoringHelper24.getHeight()), new Integer(startTabIndex.intValue() + 23), ControlState.DISABLED, ControlState.ENABLED,ims.framework.enumerations.ControlAnchoring.TOPRIGHT ," ", Boolean.TRUE, null}));
			...
			super.addControl(factory.getControl(CheckBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1024), new Integer(anchoringHelper25.getX()), new Integer(anchoringHelper25.getY()), new Integer(anchoringHelper25.getWidth()), new Integer(anchoringHelper25.getHeight()), new Integer(startTabIndex.intValue() + 21), ControlState.DISABLED, ControlState.ENABLED,ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT ,"", Boolean.TRUE, null}));
			...
			super.addControl(factory.getControl(RichTextControl.class, new Object[] { control, new Integer(startControlID.intValue() + 1026), new Integer(anchoringHelper27.getX()), new Integer(anchoringHelper27.getY()), new Integer(anchoringHelper27.getWidth()), new Integer(anchoringHelper27.getHeight()), new Integer(startTabIndex.intValue() + 20), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, Boolean.FALSE, Boolean.TRUE, new Integer(10000)} ));
		}
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		ims.framework.FormUiLogic m_ccClinicalProcedureForm = loader.loadComponent(123133, appForm, startControlID * 10 + 1000, anchoringHelper30.getSize(), instance1, startTabIndex.intValue() + 7, skipContextValidation);
		//ims.framework.Control m_ccClinicalProcedureControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1029), new Integer(440), new Integer(56), new Integer(400), new Integer(64), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT, new Integer(startTabIndex.intValue() + 7), m_ccClinicalProcedureForm, instance1 } );
		...
		ims.framework.FormUiLogic m_ccAuthoringForm = loader.loadComponent(102228, appForm, startControlID * 10 + 3000, anchoringHelper32.getSize(), instance3, startTabIndex.intValue() + 2, skipContextValidation);
		//ims.framework.Control m_ccAuthoringControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1033), new Integer(16), new Integer(56), new Integer(400), new Integer(58), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFT, new Integer(startTabIndex.intValue() + 2), m_ccAuthoringForm, instance3 } );
		ims.framework.Control m_ccAuthoringControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1034),  new Integer(anchoringHelper32.getX()), new Integer(anchoringHelper32.getY()), new Integer(anchoringHelper32.getWidth()), new Integer(anchoringHelper32.getHeight()), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFT, new Integer(startTabIndex.intValue() + 2), m_ccAuthoringForm, instance3, Boolean.FALSE } );
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1042), new Integer(anchoringHelper40.getX()), new Integer(anchoringHelper40.getY()), new Integer(anchoringHelper40.getWidth()), new Integer(anchoringHelper40.getHeight()), new Integer(startTabIndex.intValue() + 29), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Edit", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1043), new Integer(anchoringHelper41.getX()), new Integer(anchoringHelper41.getY()), new Integer(anchoringHelper41.getWidth()), new Integer(anchoringHelper41.getHeight()), new Integer(startTabIndex.intValue() + 32), ControlState.HIDDEN, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Cancel", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1044), new Integer(anchoringHelper42.getX()), new Integer(anchoringHelper42.getY()), new Integer(anchoringHelper42.getWidth()), new Integer(anchoringHelper42.getHeight()), new Integer(startTabIndex.intValue() + 31), ControlState.HIDDEN, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Save", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		ComboBox m_cmbLateralityTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1048), new Integer(anchoringHelper46.getX()), new Integer(anchoringHelper46.getY()), new Integer(anchoringHelper46.getWidth()), new Integer(anchoringHelper46.getHeight()), new Integer(startTabIndex.intValue() + 13), ControlState.DISABLED, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
		...
		super.addControl(factory.getControl(IntBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1050), new Integer(anchoringHelper48.getX()), new Integer(anchoringHelper48.getY()), new Integer(anchoringHelper48.getWidth()), new Integer(anchoringHelper48.getHeight()), new Integer(startTabIndex.intValue() + 14), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT,Boolean.TRUE, Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, new Integer(4)}));
	}
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedSuitableforSurgeryComment", "BO-1096100041-ID", "ID_SuitableForSurgeryComment");
			fields[145] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedSuitableforSurgeryComment", "BO-1096100041-COMMENT", "Comment");
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SuitableforSurgeryAssessment.__internal_x_context__Assessment_" + componentIdentifier, "BO-1096100015-ID", "ID_SuitableForSurgeryAssessment");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SuitableforSurgeryAssessment.__internal_x_context__Assessment_" + componentIdentifier, "BO-1096100015-CARECONTEXT", "CareContext");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SuitableforSurgeryAssessment.__internal_x_context__Assessment_" + componentIdentifier, "BO-1096100015-THEATRETYPE", "TheatreType");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SuitableforSurgeryAssessment.__internal_x_context__Assessment_" + componentIdentifier, "BO-1096100015-HISTORYPRESCOMPLAINT", "HistoryPresComplaint");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SuitableforSurgeryAssessment.__internal_x_context__Assessment_" + componentIdentifier, "BO-1096100015-EXAMINATION", "Examination");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SuitableforSurgeryAssessment.__internal_x_context__Assessment_" + componentIdentifier, "BO-1096100015-CONCLUSIONS", "Conclusions");
			fields[152] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SuitableforSurgeryAssessment.__internal_x_context__Assessment_" + componentIdentifier, "BO-1096100015-NOTSUITABLEFORSURGEYCOMMENTS", "NotSuitableForSurgeyComments");
			fields[153] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SuitableforSurgeryAssessment.__internal_x_context__Assessment_" + componentIdentifier, "BO-1096100015-SUITABLEFORSURGERY", "SuitableForSurgery");
			fields[154] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SuitableforSurgeryAssessment.__internal_x_context__Assessment_" + componentIdentifier, "BO-1096100015-REASONNOTSUITABLE", "ReasonNotSuitable");
			fields[155] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SuitableforSurgeryAssessment.__internal_x_context__Assessment_" + componentIdentifier, "BO-1096100015-PROCEDUREPERFORMED", "ProcedurePerformed");
			fields[156] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SuitableforSurgeryAssessment.__internal_x_context__Assessment_" + componentIdentifier, "BO-1096100015-SUITABLEFORSURGERYDATE", "SuitableForSurgeryDate");
			fields[157] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SuitableforSurgeryAssessment.__internal_x_context__Assessment_" + componentIdentifier, "BO-1096100015-REQUIREDDURATIONINMINS", "RequiredDurationInMins");
			fields[158] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SuitableforSurgeryAssessment.__internal_x_context__Assessment_" + componentIdentifier, "BO-1096100015-ANAESTHETICTYPE", "AnaestheticType");
			fields[159] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SuitableforSurgeryAssessment.__internal_x_context__Assessment_" + componentIdentifier, "BO-1096100015-SPECIALEQUIPMENTREQUIRED", "SpecialEquipmentRequired");
			fields[160] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SuitableforSurgeryAssessment.__internal_x_context__Assessment_" + componentIdentifier, "BO-1096100015-SPECIALEQUIPMENTCOMMENTS", "SpecialEquipmentComments");
			fields[161] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SuitableforSurgeryAssessment.__internal_x_context__Assessment_" + componentIdentifier, "BO-1096100015-SPECIALINSTRUCTIONSREQUIRED", "SpecialInstructionsRequired");
			fields[162] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SuitableforSurgeryAssessment.__internal_x_context__Assessment_" + componentIdentifier, "BO-1096100015-SPECIALINSTRUCTIONSCOMMENTS", "SpecialInstructionsComments");
			fields[163] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SuitableforSurgeryAssessment.__internal_x_context__LoggedInHcp_" + componentIdentifier, "BO-1006100000-ID", "ID_Hcp");
			return fields;
		}
