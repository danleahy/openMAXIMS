...
//	private static final String CHECK_BOX_TEXT_ON_FALSE = "Suitable for surgery (checking it will erase not suitable for surgery comments)";
	...
	{
		if (Boolean.FALSE.equals(form.ctnConclusions().chkSpecialEquipment().getValue())) //WDEV-18760
		{	
	...
	{
		if (Boolean.FALSE.equals(form.ctnConclusions().chkSpecialInstructions().getValue())) //WDEV-18760
		{	
