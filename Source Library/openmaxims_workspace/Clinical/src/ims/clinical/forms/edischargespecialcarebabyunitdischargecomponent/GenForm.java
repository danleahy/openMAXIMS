...
public class GenForm extends FormBridge
{
	...
	public static class GroupMidwifeRadioButton extends RadioButtonBridge
	{
		...
		protected void setContext(Integer startTabIndex, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize)
		{
			...
			control.addButton(0, anchoringHelper3.getX(), anchoringHelper3.getY(), anchoringHelper3.getWidth(), "No", startTabIndex.intValue() + 7);
			...
			control.addButton(1, anchoringHelper4.getX(), anchoringHelper4.getY(), anchoringHelper4.getWidth(), "Yes", startTabIndex.intValue() + 6);
		}
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		ims.framework.FormUiLogic m_ccDischargingNurseForm = loader.loadComponent(102256, appForm, startControlID * 10 + 1000, anchoringHelper9.getSize(), instance1, startTabIndex.intValue() + 3, skipContextValidation);
		//ims.framework.Control m_ccDischargingNurseControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1002), new Integer(200), new Integer(16), new Integer(312), new Integer(20), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT, new Integer(startTabIndex.intValue() + 3), m_ccDischargingNurseForm, instance1 } );
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1028), new Integer(anchoringHelper34.getX()), new Integer(anchoringHelper34.getY()), new Integer(anchoringHelper34.getWidth()), new Integer(anchoringHelper34.getHeight()), new Integer(startTabIndex.intValue() + 1), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "New", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		ComboBox m_cmbHowAdministeredTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1031), new Integer(anchoringHelper37.getX()), new Integer(anchoringHelper37.getY()), new Integer(anchoringHelper37.getWidth()), new Integer(anchoringHelper37.getHeight()), new Integer(startTabIndex.intValue() + 13), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPRIGHT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.TRUE, new Integer(-1)});
		...
		super.addControl(factory.getControl(IntBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1035), new Integer(anchoringHelper41.getX()), new Integer(anchoringHelper41.getY()), new Integer(anchoringHelper41.getWidth()), new Integer(anchoringHelper41.getHeight()), new Integer(startTabIndex.intValue() + 16), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.TRUE, Boolean.TRUE, Boolean.FALSE, null, null, Boolean.TRUE, new Integer(9)}));
		...
		super.addControl(factory.getControl(IntBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1036), new Integer(anchoringHelper42.getX()), new Integer(anchoringHelper42.getY()), new Integer(anchoringHelper42.getWidth()), new Integer(anchoringHelper42.getHeight()), new Integer(startTabIndex.intValue() + 17), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.TRUE, Boolean.TRUE, Boolean.FALSE, null, null, Boolean.TRUE, new Integer(9)}));
		...
		super.addControl(factory.getControl(IntBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1037), new Integer(anchoringHelper43.getX()), new Integer(anchoringHelper43.getY()), new Integer(anchoringHelper43.getWidth()), new Integer(anchoringHelper43.getHeight()), new Integer(startTabIndex.intValue() + 5), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.TOPRIGHT,Boolean.TRUE, Boolean.TRUE, Boolean.FALSE, null, null, Boolean.TRUE, new Integer(9)}));
		...
		super.addControl(factory.getControl(DecimalBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1039), new Integer(anchoringHelper45.getX()), new Integer(anchoringHelper45.getY()), new Integer(anchoringHelper45.getWidth()), new Integer(anchoringHelper45.getHeight()), new Integer(startTabIndex.intValue() + 18), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.TOPRIGHT,Boolean.TRUE, Boolean.TRUE, Boolean.TRUE, new Integer(5), new Integer(2), "The decimal value is invalid. A valid value can have up to 3 digits and up to 2 decimals.", null, Boolean.TRUE}));
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeSpecialCareBabyUnitDischargeComponent.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1099100013-ID", "ID_NeoNatal");
			fields[145] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeSpecialCareBabyUnitDischargeComponent.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1099100013-CARECONTEXT", "CareContext");
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeSpecialCareBabyUnitDischargeComponent.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1099100013-DISCHARGINGNURSE", "DischargingNurse");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeSpecialCareBabyUnitDischargeComponent.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1099100013-GESTATIONWEEKS", "GestationWeeks");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeSpecialCareBabyUnitDischargeComponent.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1099100013-ISMIDWIFE", "IsMidwife");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeSpecialCareBabyUnitDischargeComponent.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1099100013-ISHEALTHVISITOR", "IsHealthVisitor");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeSpecialCareBabyUnitDischargeComponent.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1099100013-FEEDING", "Feeding");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeSpecialCareBabyUnitDischargeComponent.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1099100013-ISVITAMINKGIVEN", "IsVitaminKGiven");
			fields[152] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeSpecialCareBabyUnitDischargeComponent.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1099100013-ROUTE", "Route");
			fields[153] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeSpecialCareBabyUnitDischargeComponent.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1099100013-_1STPKUTESTDATE", "FirstPKUTestDate");
			fields[154] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeSpecialCareBabyUnitDischargeComponent.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1099100013-_2NDPKUTESTDATE", "SecondPKUTestDate");
			fields[155] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeSpecialCareBabyUnitDischargeComponent.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1099100013-APGAR1MINUTE", "Apgar1Minute");
			fields[156] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeSpecialCareBabyUnitDischargeComponent.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1099100013-APGAR5MINUTE", "Apgar5Minute");
			fields[157] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeSpecialCareBabyUnitDischargeComponent.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1099100013-BIRTHWEIGHT", "BirthWeight");
			fields[158] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeSpecialCareBabyUnitDischargeComponent.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1099100013-LENGTH", "Length");
			fields[159] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeSpecialCareBabyUnitDischargeComponent.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1099100013-DISCHARGEWEIGHT", "DischargeWeight");
			fields[160] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeSpecialCareBabyUnitDischargeComponent.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1099100013-ISCOMPLETE", "IsComplete");
			fields[161] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeSpecialCareBabyUnitDischargeComponent.__internal_x_context__STHKSummary_" + componentIdentifier, "BO-1099100018-ID", "ID_Summary");
			return fields;
		}
