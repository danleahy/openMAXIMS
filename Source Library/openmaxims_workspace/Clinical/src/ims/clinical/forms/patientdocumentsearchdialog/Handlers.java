...
abstract public class Handlers implements ims.framework.UILogic, IFormUILogicCode
{
	...
	abstract protected void onGrdDocumentsGridButtonClicked(int column, GenForm.grdDocumentsRow row) throws ims.framework.exceptions.PresentationLogicException;
	...
	public final void setContext(ims.framework.UIEngine engine, GenForm form)
	{
		...
		this.form.grdDocuments().setGridButtonClickedEvent(new GridButtonClicked()
		{
			private static final long serialVersionUID = 1L;
			...
			{
				onGrdDocumentsGridButtonClicked(column, new GenForm.grdDocumentsRow(row));
			}
		});
