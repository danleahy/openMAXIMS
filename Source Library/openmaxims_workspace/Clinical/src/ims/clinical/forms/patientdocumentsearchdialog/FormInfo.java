...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "PatientDocumentSearchDialog";
	}
	public int getWidth()
	{
		return 704;
	...
	{
		return new String[] { "_cv_Clinical.LinkedPatientDocument" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Clinical.PatientDocumentSearchDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
