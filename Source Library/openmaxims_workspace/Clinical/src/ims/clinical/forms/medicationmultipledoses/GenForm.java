...
public class GenForm extends FormBridge
{
	...
	public static class ctnDetailsContainer extends ContainerBridge
	{
		...
		protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
		{
			...
			ims.framework.FormUiLogic m_customControlCodingItemForm = loader.loadComponent(123133, appForm, startControlID * 10 + 1000, anchoringHelper1.getSize(), instance1, startTabIndex.intValue() + 8, skipContextValidation);
			//ims.framework.Control m_customControlCodingItemControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1000), new Integer(8), new Integer(16), new Integer(816), new Integer(64), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT, new Integer(startTabIndex.intValue() + 8), m_customControlCodingItemForm, instance1 } );
			ims.framework.Control m_customControlCodingItemControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1001),  new Integer(anchoringHelper1.getX()), new Integer(anchoringHelper1.getY()), new Integer(anchoringHelper1.getWidth()), new Integer(anchoringHelper1.getHeight()), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT, new Integer(startTabIndex.intValue() + 8), m_customControlCodingItemForm, instance1, Boolean.FALSE } );
			...
			RuntimeAnchoring anchoringHelper7 = new RuntimeAnchoring(designSize, runtimeSize, 192, 288, 129, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
			super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1007), new Integer(anchoringHelper7.getX()), new Integer(anchoringHelper7.getY()), new Integer(anchoringHelper7.getWidth()), new Integer(anchoringHelper7.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "No. of days to Supply:", new Integer(1), null, new Integer(0)}));
			RuntimeAnchoring anchoringHelper8 = new RuntimeAnchoring(designSize, runtimeSize, 16, 288, 132, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
			...
			super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1011), new Integer(anchoringHelper11.getX()), new Integer(anchoringHelper11.getY()), new Integer(anchoringHelper11.getWidth()), new Integer(anchoringHelper11.getHeight()), new Integer(-1), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT,Boolean.FALSE, new Integer(255), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
			...
			super.addControl(factory.getControl(DateControl.class, new Object[] { control, new Integer(startControlID.intValue() + 1012), new Integer(anchoringHelper12.getX()), new Integer(anchoringHelper12.getY()), new Integer(anchoringHelper12.getWidth()), new Integer(anchoringHelper12.getHeight()), new Integer(startTabIndex.intValue() + 16), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT,Boolean.TRUE, null, Boolean.FALSE, null, Boolean.FALSE, null}));
			...
			ComboBox m_cmbCommencedByTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1013), new Integer(anchoringHelper13.getX()), new Integer(anchoringHelper13.getY()), new Integer(anchoringHelper13.getWidth()), new Integer(anchoringHelper13.getHeight()), new Integer(startTabIndex.intValue() + 12), ControlState.DISABLED, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,Boolean.TRUE, Boolean.TRUE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
			...
			ComboBox m_cmbFrequencyTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1014), new Integer(anchoringHelper14.getX()), new Integer(anchoringHelper14.getY()), new Integer(anchoringHelper14.getWidth()), new Integer(anchoringHelper14.getHeight()), new Integer(startTabIndex.intValue() + 13), ControlState.DISABLED, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
			...
			ComboBox m_qmbCommencedByTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1016), new Integer(anchoringHelper16.getX()), new Integer(anchoringHelper16.getY()), new Integer(anchoringHelper16.getWidth()), new Integer(anchoringHelper16.getHeight()), new Integer(startTabIndex.intValue() + 14), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.TRUE, new Integer(1), null, Boolean.FALSE, new Integer(-1), Boolean.FALSE});
			...
			// CheckBox Controls
			RuntimeAnchoring anchoringHelper17 = new RuntimeAnchoring(designSize, runtimeSize, 152, 288, 16, 16, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT);
			super.addControl(factory.getControl(CheckBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1017), new Integer(anchoringHelper17.getX()), new Integer(anchoringHelper17.getY()), new Integer(anchoringHelper17.getWidth()), new Integer(anchoringHelper17.getHeight()), new Integer(startTabIndex.intValue() + 18), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT ,"", Boolean.FALSE, null}));
			...
			// IntBox Controls
			RuntimeAnchoring anchoringHelper19 = new RuntimeAnchoring(designSize, runtimeSize, 320, 288, 40, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
			super.addControl(factory.getControl(IntBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1019), new Integer(anchoringHelper19.getX()), new Integer(anchoringHelper19.getY()), new Integer(anchoringHelper19.getWidth()), new Integer(anchoringHelper19.getHeight()), new Integer(startTabIndex.intValue() + 19), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.TRUE, Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, new Integer(9)}));
		}
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		ims.framework.FormUiLogic m_customControlAuthoringInfoForm = loader.loadComponent(102228, appForm, startControlID * 10 + 2000, anchoringHelper20.getSize(), instance1, startTabIndex.intValue() + 3, skipContextValidation);
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1023), new Integer(anchoringHelper22.getX()), new Integer(anchoringHelper22.getY()), new Integer(anchoringHelper22.getWidth()), new Integer(anchoringHelper22.getHeight()), new Integer(startTabIndex.intValue() + 20), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Close", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(CheckBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1027), new Integer(anchoringHelper26.getX()), new Integer(anchoringHelper26.getY()), new Integer(anchoringHelper26.getWidth()), new Integer(anchoringHelper26.getHeight()), new Integer(startTabIndex.intValue() + 6), ControlState.UNKNOWN, ControlState.HIDDEN,ims.framework.enumerations.ControlAnchoring.TOPRIGHT ,"Hide Discontinued Medications/Doses", Boolean.TRUE, null}));
		...
		super.addControl(factory.getControl(Link.class, new Object[] { control, new Integer(startControlID.intValue() + 1029), new Integer(anchoringHelper28.getX()), new Integer(anchoringHelper28.getY()), new Integer(anchoringHelper28.getWidth()), new Integer(anchoringHelper28.getHeight()), new Integer(startTabIndex.intValue() + 1), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT,"Return", Boolean.FALSE, null}));
	}
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[147] = new ims.framework.ReportField(this.context, "_cv_Clinical.CurrentMedicationOverView", "BO-1072100034-ID", "ID_MedicationOverview");
			fields[148] = new ims.framework.ReportField(this.context, "_cv_Clinical.CurrentMedicationOverView", "BO-1072100034-TYPE", "Type");
			fields[149] = new ims.framework.ReportField(this.context, "_cv_Clinical.CurrentMedicationOverView", "BO-1072100034-CARECONTEXT", "CareContext");
			fields[150] = new ims.framework.ReportField(this.context, "_cv_Clinical.CurrentMedicationOverView", "BO-1072100034-CORRECTNESS", "Correctness");
			fields[151] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalContact", "BO-1004100003-ID", "ID_ClinicalContact");
			fields[152] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalContact", "BO-1004100003-SPECIALTY", "Specialty");
			fields[153] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalContact", "BO-1004100003-SEENBY", "SeenBy");
			fields[154] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalContact", "BO-1004100003-CONTACTTYPE", "ContactType");
			fields[155] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalContact", "BO-1004100003-STARTDATETIME", "StartDateTime");
			fields[156] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalContact", "BO-1004100003-ENDDATETIME", "EndDateTime");
			fields[157] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalContact", "BO-1004100003-CARECONTEXT", "CareContext");
			fields[158] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalContact", "BO-1004100003-ISCLINICALNOTECREATED", "IsClinicalNoteCreated");
			fields[159] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.MedicationMultipleDoses.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1003100014-ID", "ID_PatientMedication");
			fields[160] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.MedicationMultipleDoses.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1003100014-OTHERMEDICATIONTEXT", "OtherMedicationText");
			fields[161] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.MedicationMultipleDoses.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1003100014-PATIENT", "Patient");
			fields[162] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.MedicationMultipleDoses.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1003100014-FREQUENCY", "Frequency");
			fields[163] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.MedicationMultipleDoses.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1003100014-SOURCEOFINFORMATION", "SourceofInformation");
			fields[164] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.MedicationMultipleDoses.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1003100014-COMMENCEDDATE", "CommencedDate");
			fields[165] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.MedicationMultipleDoses.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1003100014-NODAYSSUPPLY", "NoDaysSupply");
			fields[166] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.MedicationMultipleDoses.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1003100014-BATCHNO", "BatchNo");
			fields[167] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.MedicationMultipleDoses.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1003100014-EXPIRYDATE", "ExpiryDate");
			fields[168] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.MedicationMultipleDoses.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1003100014-ISDISCONTINUED", "IsDiscontinued");
			fields[169] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.MedicationMultipleDoses.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1003100014-DIFFICULTIESWITHMED", "DifficultiesWithMed");
			fields[170] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.MedicationMultipleDoses.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1003100014-SUPPLIED", "Supplied");
			fields[171] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.MedicationMultipleDoses.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1003100014-INPOSSESSION", "InPossession");
			fields[172] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.MedicationMultipleDoses.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1003100014-ISMEDICATIONONADMISSION", "IsMedicationonAdmission");
			fields[173] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.MedicationMultipleDoses.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1003100014-ISDISCHARGEMEDICATION", "IsDischargeMedication");
			fields[174] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.MedicationMultipleDoses.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1003100014-CARECONTEXT", "CareContext");
			fields[175] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.MedicationMultipleDoses.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1003100014-ISINTTO", "IsInTTO");
			fields[176] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.MedicationMultipleDoses.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1003100014-ISDISCONTINUEDDATE", "IsDiscontinuedDate");
			fields[177] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.MedicationMultipleDoses.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1003100014-ISDISCONTINUEDREASON", "IsDiscontinuedReason");
			fields[178] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.MedicationMultipleDoses.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1003100014-ISDISCONTINUEDREASONTEXT", "IsDiscontinuedReasonText");
			fields[179] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.MedicationMultipleDoses.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1003100014-ISCOPIED", "IsCopied");
			fields[180] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.MedicationMultipleDoses.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1003100014-COMMENCEDBYTYPE", "CommencedByType");
			fields[181] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.MedicationMultipleDoses.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1003100014-DISCONTINUEDBYTYPE", "DiscontinuedByType");
			fields[182] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.MedicationMultipleDoses.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1003100014-SELFMEDICATING", "SelfMedicating");
			fields[183] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.MedicationMultipleDoses.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1003100014-COMMENT", "Comment");
			fields[184] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.MedicationMultipleDoses.__internal_x_context__CurrentOverView_" + componentIdentifier, "BO-1072100034-ID", "ID_MedicationOverview");
			fields[185] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.MedicationMultipleDoses.__internal_x_context__CurrentOverView_" + componentIdentifier, "BO-1072100034-TYPE", "Type");
			fields[186] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.MedicationMultipleDoses.__internal_x_context__CurrentOverView_" + componentIdentifier, "BO-1072100034-CARECONTEXT", "CareContext");
			fields[187] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.MedicationMultipleDoses.__internal_x_context__CurrentOverView_" + componentIdentifier, "BO-1072100034-CORRECTNESS", "Correctness");
			return fields;
		}
