...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "VTERemoveDeclineReasonDialog";
	}
	public int getWidth()
	{
		return 432;
	...
	{
		return new String[] { "_cv_Clinical.VTERemoveDeclineReason" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Clinical.VTERemoveDeclineReasonDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
