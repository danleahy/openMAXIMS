...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "WardSelectionForVteConfig";
	}
	public int getWidth()
	{
		return 400;
	...
	{
		return new String[] { "_cv_Core.SelectedWardsForVTEConfig" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Clinical.WardSelectionForVteConfig.__internal_x_context__" + String.valueOf(getFormId());
	}
