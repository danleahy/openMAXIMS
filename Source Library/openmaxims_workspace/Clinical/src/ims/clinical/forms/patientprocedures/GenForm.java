...
public class GenForm extends FormBridge
{
	...
	public static class grdProcedureRow extends GridRowBridge
	{
		...
		{
			return (ims.framework.utils.PartialDate)super.row.get(0);
		}
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		//ims.framework.Control m_customControlAuthoringInfoControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1001), new Integer(8), new Integer(520), new Integer(312), new Integer(64), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, new Integer(startTabIndex.intValue() + 2), m_customControlAuthoringInfoForm, instance1 } );
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1011), new Integer(anchoringHelper11.getX()), new Integer(anchoringHelper11.getY()), new Integer(anchoringHelper11.getWidth()), new Integer(anchoringHelper11.getHeight()), new Integer(startTabIndex.intValue() + 17), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Edit", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		grdProcedure.addPartialDateColumn("Date", 0, 0, 80, true, true, null, false, 2, true);
		...
		RuntimeAnchoring anchoringHelper22 = new RuntimeAnchoring(designSize, runtimeSize, 328, 232, 240, 187, ims.framework.enumerations.ControlAnchoring.TOPBOTTOMLEFT);
		Grid m_grdImpDevInsTemp = (Grid)factory.getControl(Grid.class, new Object[] { control, new Integer(startControlID.intValue() + 1022), new Integer(anchoringHelper22.getX()), new Integer(anchoringHelper22.getY()), new Integer(anchoringHelper22.getWidth()), new Integer(anchoringHelper22.getHeight()), new Integer(startTabIndex.intValue() + 13), ControlState.DISABLED, ControlState.EDITABLE, ims.framework.enumerations.ControlAnchoring.TOPBOTTOMLEFT,Boolean.TRUE, Boolean.FALSE, new Integer(24), Boolean.TRUE, contextMenus.contextMenuImplantDevicesAddGrid, Boolean.FALSE, Boolean.FALSE, new Integer(0), null, Boolean.FALSE, Boolean.TRUE});
		...
		RuntimeAnchoring anchoringHelper23 = new RuntimeAnchoring(designSize, runtimeSize, 584, 232, 240, 187, ims.framework.enumerations.ControlAnchoring.ALL);
		Grid m_grdImpDevRemTemp = (Grid)factory.getControl(Grid.class, new Object[] { control, new Integer(startControlID.intValue() + 1023), new Integer(anchoringHelper23.getX()), new Integer(anchoringHelper23.getY()), new Integer(anchoringHelper23.getWidth()), new Integer(anchoringHelper23.getHeight()), new Integer(startTabIndex.intValue() + 14), ControlState.DISABLED, ControlState.EDITABLE, ims.framework.enumerations.ControlAnchoring.ALL,Boolean.TRUE, Boolean.FALSE, new Integer(24), Boolean.TRUE, contextMenus.contextMenuImplantDevicesRemoveGrid, Boolean.FALSE, Boolean.FALSE, new Integer(0), null, Boolean.FALSE, Boolean.TRUE});
		...
		grdOtherHcp.addMutableComboBoxColumn("Other HCPs Present", 0, 0, -1, false, true, true, false, true, true, -1);
	...
	public class LocalContext extends ContextBridge
	{
		...
		public LocalContext(Context context, ims.framework.FormInfo formInfo, String componentIdentifier)
		{
			...
			cxl_DateSortOrder = new ims.framework.ContextVariable("DateSortOrder", prefix + "_lv_Clinical.PatientProcedures.__internal_x_context__DateSortOrder_" + componentIdentifier + "");
		}
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientProcedures.__internal_x_context__patientProcedure_" + componentIdentifier, "BO-1003100017-ID", "ID_PatientProcedure");
			fields[145] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientProcedures.__internal_x_context__patientProcedure_" + componentIdentifier, "BO-1003100017-PROCEDUREDESCRIPTION", "ProcedureDescription");
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientProcedures.__internal_x_context__patientProcedure_" + componentIdentifier, "BO-1003100017-INFOSOURCE", "InfoSource");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientProcedures.__internal_x_context__patientProcedure_" + componentIdentifier, "BO-1003100017-PROCDATE", "ProcDate");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientProcedures.__internal_x_context__patientProcedure_" + componentIdentifier, "BO-1003100017-INCLUDEINDISCHARGELETTER", "IncludeInDischargeLetter");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientProcedures.__internal_x_context__patientProcedure_" + componentIdentifier, "BO-1003100017-SITETEXT", "SiteText");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientProcedures.__internal_x_context__patientProcedure_" + componentIdentifier, "BO-1003100017-PROCLATERALITY", "ProcLaterality");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientProcedures.__internal_x_context__patientProcedure_" + componentIdentifier, "BO-1003100017-PROCEDURESTATUS", "ProcedureStatus");
			fields[152] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientProcedures.__internal_x_context__patientProcedure_" + componentIdentifier, "BO-1003100017-PROCTIME", "ProcTime");
			fields[153] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientProcedures.__internal_x_context__patientProcedure_" + componentIdentifier, "BO-1003100017-EPISODEOFCARE", "EpisodeOfCare");
			fields[154] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientProcedures.__internal_x_context__patientProcedure_" + componentIdentifier, "BO-1003100017-ISPRIMARY", "IsPrimary");
			fields[155] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientProcedures.__internal_x_context__patientProcedure_" + componentIdentifier, "BO-1003100017-NOTES", "Notes");
			fields[156] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientProcedures.__internal_x_context__patientProcedure_" + componentIdentifier, "BO-1003100017-PROCEDUREURGENCY", "ProcedureUrgency");
			fields[157] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientProcedures.__internal_x_context__patientProcedure_" + componentIdentifier, "BO-1003100017-PROCEDUREOUTCOME", "ProcedureOutcome");
			fields[158] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientProcedures.__internal_x_context__patientProcedure_" + componentIdentifier, "BO-1003100017-DATEPLANNED", "DatePlanned");
			fields[159] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientProcedures.__internal_x_context__patientProcedure_" + componentIdentifier, "BO-1003100017-PLANNEDPROC", "PlannedProc");
			fields[160] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientProcedures.__internal_x_context__patientProcedure_" + componentIdentifier, "BO-1003100017-PROCSITE", "ProcSite");
			fields[161] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientProcedures.__internal_x_context__patientProcedure_" + componentIdentifier, "BO-1003100017-PEFORMEDBY", "PeformedBy");
			fields[162] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientProcedures.__internal_x_context__patientProcedure_" + componentIdentifier, "BO-1003100017-PROCEDUREINTENT", "ProcedureIntent");
			fields[163] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientProcedures.__internal_x_context__patientProcedure_" + componentIdentifier, "BO-1003100017-LOCATION", "Location");
			fields[164] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientProcedures.__internal_x_context__patientProcedure_" + componentIdentifier, "BO-1003100017-SPECIALTY", "Specialty");
			fields[165] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientProcedures.__internal_x_context__patientProcedure_" + componentIdentifier, "BO-1003100017-CONFIRMEDSTATUS", "ConfirmedStatus");
			fields[166] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientProcedures.__internal_x_context__patientProcedure_" + componentIdentifier, "BO-1003100017-CONFIRMEDDATETIME", "ConfirmedDateTime");
			fields[167] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientProcedures.__internal_x_context__patientProcedure_" + componentIdentifier, "BO-1003100017-EXCLUDEFROMOTHERS", "ExcludeFromOthers");
			fields[168] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientProcedures.__internal_x_context__patientProcedure_" + componentIdentifier, "BO-1003100017-PROCLOCATION", "ProcLocation");
			fields[169] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientProcedures.__internal_x_context__patientProcedure_" + componentIdentifier, "BO-1003100017-CANCELLEDDATE", "CancelledDate");
			fields[170] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientProcedures.__internal_x_context__patientProcedure_" + componentIdentifier, "BO-1003100017-CANCELLEDREASON", "CancelledReason");
			fields[171] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientProcedures.__internal_x_context__patientProcedure_" + componentIdentifier, "BO-1003100017-SURGEONSGRADE", "SurgeonsGrade");
			fields[172] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientProcedures.__internal_x_context__patientProcedure_" + componentIdentifier, "BO-1003100017-PROCENDDATE", "ProcEndDate");
			fields[173] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientProcedures.__internal_x_context__patientProcedure_" + componentIdentifier, "BO-1003100017-PROCENDTIME", "ProcEndTime");
			fields[174] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientProcedures.__internal_x_context__patientProcedure_" + componentIdentifier, "BO-1003100017-SIGNIFPROC", "SignifProc");
			return fields;
		}
