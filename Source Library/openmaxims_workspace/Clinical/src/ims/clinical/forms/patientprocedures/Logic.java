...
public class Logic extends BaseLogic
{
	...
	protected void onBtnSaveClick() throws ims.framework.exceptions.PresentationLogicException
	{
		...
		String[] arrErrors = voProcedure.validate(validateUIRules());
		if( arrErrors != null)
		{
	...
	private String[] validateUIRules() //WDEV-15298 - separate method for UI
	{
		...
		{			
			...
			if (form.grdOtherHcp().getRows().get(i).getColHcp().getValue() != null)
			{
				...
				if(form.qmbPerfBy().getValue().getIMosHcpId() != null)
				{
					...
					{
						uIErrors.add("You cannot enter your Performing HCP in the 'Other HCPs Present' grid. Please update your entry and save again.");
					}					
				}
			}
		}	
		PartialDate procDate = form.pdtProcedure().getValue();
		Time procTime = form.tmeProcedure().getValue();
		if (procDate != null)
		{	
			if (procDate.isGreaterThan(new Date()))
			{	
				uIErrors.add("Date cannot be in the future.");
			}	
			if (procDate.isGreaterOrEqualThan(new PartialDate(new Date())) && procTime != null && procTime.isGreaterThan(new Time()))
			{
				uIErrors.add("Time cannot be in the future.");
			}	
		}	
	...
	//WDEV-15298 - faulty Date Display & Sort
	@Override
	...
	public class PDateComparator implements Comparator<Object>
	{
		private int direction = 1;

		public PDateComparator()
		{
			this(SortOrder.ASCENDING);
		}

		public PDateComparator(SortOrder order)
		{
