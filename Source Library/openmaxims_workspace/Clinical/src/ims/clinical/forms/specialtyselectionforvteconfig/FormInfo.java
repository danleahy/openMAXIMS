...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "SpecialtySelectionForVteConfig";
	}
	public int getWidth()
	{
		return 400;
	...
	{
		return new String[] { "_cv_Clinical.SelectedSpecialtiesForVteConfig" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Clinical.SpecialtySelectionForVteConfig.__internal_x_context__" + String.valueOf(getFormId());
	}
