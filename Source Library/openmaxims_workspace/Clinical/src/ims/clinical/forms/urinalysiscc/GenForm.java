...
public class GenForm extends FormBridge
{
	...
	public static class grpAscorbicRadioButton extends RadioButtonBridge
	{
		...
		protected void setContext(Integer startTabIndex, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize)
		{
			...
			control.addButton(0, anchoringHelper3.getX(), anchoringHelper3.getY(), anchoringHelper3.getWidth(), "", startTabIndex.intValue() + 46);
			...
			control.addButton(1, anchoringHelper4.getX(), anchoringHelper4.getY(), anchoringHelper4.getWidth(), "", startTabIndex.intValue() + 45);
			...
			control.addButton(2, anchoringHelper5.getX(), anchoringHelper5.getY(), anchoringHelper5.getWidth(), "", startTabIndex.intValue() + 44);
			...
			control.addButton(3, anchoringHelper6.getX(), anchoringHelper6.getY(), anchoringHelper6.getWidth(), "", startTabIndex.intValue() + 43);
			...
			control.addButton(4, anchoringHelper7.getX(), anchoringHelper7.getY(), anchoringHelper7.getWidth(), "", startTabIndex.intValue() + 42);
			...
			control.addButton(5, anchoringHelper8.getX(), anchoringHelper8.getY(), anchoringHelper8.getWidth(), "", startTabIndex.intValue() + 41);
		}
	...
	public static class grpNitrateRadioButton extends RadioButtonBridge
	{
		...
		protected void setContext(Integer startTabIndex, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize)
		{
			...
			control.addButton(0, anchoringHelper9.getX(), anchoringHelper9.getY(), anchoringHelper9.getWidth(), "", startTabIndex.intValue() + 60);
			...
			control.addButton(1, anchoringHelper10.getX(), anchoringHelper10.getY(), anchoringHelper10.getWidth(), "", startTabIndex.intValue() + 59);
		}
	...
	public static class grpUbgRadioButton extends RadioButtonBridge
	{
		...
		protected void setContext(Integer startTabIndex, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize)
		{
			...
			control.addButton(0, anchoringHelper11.getX(), anchoringHelper11.getY(), anchoringHelper11.getWidth(), "", startTabIndex.intValue() + 58);
			...
			control.addButton(1, anchoringHelper12.getX(), anchoringHelper12.getY(), anchoringHelper12.getWidth(), "", startTabIndex.intValue() + 57);
			...
			control.addButton(2, anchoringHelper13.getX(), anchoringHelper13.getY(), anchoringHelper13.getWidth(), "", startTabIndex.intValue() + 56);
			...
			control.addButton(3, anchoringHelper14.getX(), anchoringHelper14.getY(), anchoringHelper14.getWidth(), "", startTabIndex.intValue() + 55);
			...
			control.addButton(4, anchoringHelper15.getX(), anchoringHelper15.getY(), anchoringHelper15.getWidth(), "", startTabIndex.intValue() + 54);
			...
			control.addButton(5, anchoringHelper16.getX(), anchoringHelper16.getY(), anchoringHelper16.getWidth(), "", startTabIndex.intValue() + 53);
		}
	...
	public static class grpBilRadioButton extends RadioButtonBridge
	{
		...
		protected void setContext(Integer startTabIndex, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize)
		{
			...
			control.addButton(0, anchoringHelper17.getX(), anchoringHelper17.getY(), anchoringHelper17.getWidth(), "", startTabIndex.intValue() + 52);
			...
			control.addButton(1, anchoringHelper18.getX(), anchoringHelper18.getY(), anchoringHelper18.getWidth(), "", startTabIndex.intValue() + 51);
			...
			control.addButton(2, anchoringHelper19.getX(), anchoringHelper19.getY(), anchoringHelper19.getWidth(), "", startTabIndex.intValue() + 50);
			...
			control.addButton(3, anchoringHelper20.getX(), anchoringHelper20.getY(), anchoringHelper20.getWidth(), "", startTabIndex.intValue() + 49);
			...
			control.addButton(4, anchoringHelper21.getX(), anchoringHelper21.getY(), anchoringHelper21.getWidth(), "", startTabIndex.intValue() + 48);
			...
			control.addButton(5, anchoringHelper22.getX(), anchoringHelper22.getY(), anchoringHelper22.getWidth(), "", startTabIndex.intValue() + 47);
		}
	...
	public static class grpGluRadioButton extends RadioButtonBridge
	{
		...
		protected void setContext(Integer startTabIndex, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize)
		{
			...
			control.addButton(0, anchoringHelper23.getX(), anchoringHelper23.getY(), anchoringHelper23.getWidth(), "", startTabIndex.intValue() + 40);
			...
			control.addButton(1, anchoringHelper24.getX(), anchoringHelper24.getY(), anchoringHelper24.getWidth(), "", startTabIndex.intValue() + 39);
			...
			control.addButton(2, anchoringHelper25.getX(), anchoringHelper25.getY(), anchoringHelper25.getWidth(), "", startTabIndex.intValue() + 38);
			...
			control.addButton(3, anchoringHelper26.getX(), anchoringHelper26.getY(), anchoringHelper26.getWidth(), "", startTabIndex.intValue() + 37);
			...
			control.addButton(4, anchoringHelper27.getX(), anchoringHelper27.getY(), anchoringHelper27.getWidth(), "", startTabIndex.intValue() + 36);
			...
			control.addButton(5, anchoringHelper28.getX(), anchoringHelper28.getY(), anchoringHelper28.getWidth(), "", startTabIndex.intValue() + 35);
		}
	...
	public static class grpKetonesRadioButton extends RadioButtonBridge
	{
		...
		protected void setContext(Integer startTabIndex, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize)
		{
			...
			control.addButton(0, anchoringHelper29.getX(), anchoringHelper29.getY(), anchoringHelper29.getWidth(), "", startTabIndex.intValue() + 34);
			...
			control.addButton(1, anchoringHelper30.getX(), anchoringHelper30.getY(), anchoringHelper30.getWidth(), "", startTabIndex.intValue() + 33);
			...
			control.addButton(2, anchoringHelper31.getX(), anchoringHelper31.getY(), anchoringHelper31.getWidth(), "", startTabIndex.intValue() + 32);
			...
			control.addButton(3, anchoringHelper32.getX(), anchoringHelper32.getY(), anchoringHelper32.getWidth(), "", startTabIndex.intValue() + 31);
			...
			control.addButton(4, anchoringHelper33.getX(), anchoringHelper33.getY(), anchoringHelper33.getWidth(), "", startTabIndex.intValue() + 30);
			...
			control.addButton(5, anchoringHelper34.getX(), anchoringHelper34.getY(), anchoringHelper34.getWidth(), "", startTabIndex.intValue() + 29);
		}
	...
	public static class grpBloodRadioButton extends RadioButtonBridge
	{
		...
		protected void setContext(Integer startTabIndex, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize)
		{
			...
			control.addButton(0, anchoringHelper35.getX(), anchoringHelper35.getY(), anchoringHelper35.getWidth(), "", startTabIndex.intValue() + 28);
			...
			control.addButton(1, anchoringHelper36.getX(), anchoringHelper36.getY(), anchoringHelper36.getWidth(), "", startTabIndex.intValue() + 27);
			...
			control.addButton(2, anchoringHelper37.getX(), anchoringHelper37.getY(), anchoringHelper37.getWidth(), "", startTabIndex.intValue() + 26);
			...
			control.addButton(3, anchoringHelper38.getX(), anchoringHelper38.getY(), anchoringHelper38.getWidth(), "", startTabIndex.intValue() + 25);
			...
			control.addButton(4, anchoringHelper39.getX(), anchoringHelper39.getY(), anchoringHelper39.getWidth(), "", startTabIndex.intValue() + 24);
			...
			control.addButton(5, anchoringHelper40.getX(), anchoringHelper40.getY(), anchoringHelper40.getWidth(), "", startTabIndex.intValue() + 23);
		}
	...
	public static class grpProteinRadioButton extends RadioButtonBridge
	{
		...
		protected void setContext(Integer startTabIndex, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize)
		{
			...
			control.addButton(0, anchoringHelper41.getX(), anchoringHelper41.getY(), anchoringHelper41.getWidth(), "", startTabIndex.intValue() + 22);
			...
			control.addButton(1, anchoringHelper42.getX(), anchoringHelper42.getY(), anchoringHelper42.getWidth(), "", startTabIndex.intValue() + 21);
			...
			control.addButton(2, anchoringHelper43.getX(), anchoringHelper43.getY(), anchoringHelper43.getWidth(), "", startTabIndex.intValue() + 20);
			...
			control.addButton(3, anchoringHelper44.getX(), anchoringHelper44.getY(), anchoringHelper44.getWidth(), "", startTabIndex.intValue() + 19);
			...
			control.addButton(4, anchoringHelper45.getX(), anchoringHelper45.getY(), anchoringHelper45.getWidth(), "", startTabIndex.intValue() + 18);
			...
			control.addButton(5, anchoringHelper46.getX(), anchoringHelper46.getY(), anchoringHelper46.getWidth(), "", startTabIndex.intValue() + 17);
		}
	...
	public static class grpLeucocytesRadioButton extends RadioButtonBridge
	{
		...
		protected void setContext(Integer startTabIndex, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize)
		{
			...
			control.addButton(0, anchoringHelper47.getX(), anchoringHelper47.getY(), anchoringHelper47.getWidth(), "", startTabIndex.intValue() + 16);
			...
			control.addButton(1, anchoringHelper48.getX(), anchoringHelper48.getY(), anchoringHelper48.getWidth(), "", startTabIndex.intValue() + 15);
			...
			control.addButton(2, anchoringHelper49.getX(), anchoringHelper49.getY(), anchoringHelper49.getWidth(), "", startTabIndex.intValue() + 14);
			...
			control.addButton(3, anchoringHelper50.getX(), anchoringHelper50.getY(), anchoringHelper50.getWidth(), "", startTabIndex.intValue() + 13);
			...
			control.addButton(4, anchoringHelper51.getX(), anchoringHelper51.getY(), anchoringHelper51.getWidth(), "", startTabIndex.intValue() + 12);
			...
			control.addButton(5, anchoringHelper52.getX(), anchoringHelper52.getY(), anchoringHelper52.getWidth(), "", startTabIndex.intValue() + 11);
		}
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		ims.framework.FormUiLogic m_customControlAuthoringInfoForm = loader.loadComponent(102228, appForm, startControlID * 10 + 1000, anchoringHelper54.getSize(), instance1, startTabIndex.intValue() + 4, skipContextValidation);
		//ims.framework.Control m_customControlAuthoringInfoControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1001), new Integer(0), new Integer(45), new Integer(540), new Integer(56), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT, new Integer(startTabIndex.intValue() + 4), m_customControlAuthoringInfoForm, instance1 } );
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1031), new Integer(anchoringHelper83.getX()), new Integer(anchoringHelper83.getY()), new Integer(anchoringHelper83.getWidth()), new Integer(anchoringHelper83.getHeight()), new Integer(startTabIndex.intValue() + 66), ControlState.HIDDEN, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Save", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1032), new Integer(anchoringHelper84.getX()), new Integer(anchoringHelper84.getY()), new Integer(anchoringHelper84.getWidth()), new Integer(anchoringHelper84.getHeight()), new Integer(startTabIndex.intValue() + 67), ControlState.HIDDEN, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Cancel", Boolean.FALSE, null, Boolean.FALSE, Boolean.FALSE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1033), new Integer(anchoringHelper85.getX()), new Integer(anchoringHelper85.getY()), new Integer(anchoringHelper85.getWidth()), new Integer(anchoringHelper85.getHeight()), new Integer(startTabIndex.intValue() + 65), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Edit", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1034), new Integer(anchoringHelper86.getX()), new Integer(anchoringHelper86.getY()), new Integer(anchoringHelper86.getWidth()), new Integer(anchoringHelper86.getHeight()), new Integer(startTabIndex.intValue() + 64), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "New", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(DateTimeControl.class, new Object[] { control, new Integer(startControlID.intValue() + 1035), new Integer(anchoringHelper87.getX()), new Integer(anchoringHelper87.getY()), new Integer(anchoringHelper87.getWidth()), new Integer(anchoringHelper87.getHeight()), new Integer(startTabIndex.intValue() + 8), ControlState.DISABLED, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT,Boolean.TRUE, null, Boolean.FALSE, null, Boolean.FALSE, null}));
		...
		ComboBox m_cmbRecordingHCPTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1036), new Integer(anchoringHelper88.getX()), new Integer(anchoringHelper88.getY()), new Integer(anchoringHelper88.getWidth()), new Integer(anchoringHelper88.getHeight()), new Integer(startTabIndex.intValue() + 7), ControlState.DISABLED, ControlState.DISABLED,ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
		...
		ComboBox m_cmbPHTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1037), new Integer(anchoringHelper89.getX()), new Integer(anchoringHelper89.getY()), new Integer(anchoringHelper89.getWidth()), new Integer(anchoringHelper89.getHeight()), new Integer(startTabIndex.intValue() + 61), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
		...
		super.addControl(factory.getControl(CheckBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1039), new Integer(anchoringHelper91.getX()), new Integer(anchoringHelper91.getY()), new Integer(anchoringHelper91.getWidth()), new Integer(anchoringHelper91.getHeight()), new Integer(startTabIndex.intValue() + 62), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,"", Boolean.FALSE, null}));
		...
		super.addControl(factory.getControl(CheckBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1040), new Integer(anchoringHelper92.getX()), new Integer(anchoringHelper92.getY()), new Integer(anchoringHelper92.getWidth()), new Integer(anchoringHelper92.getHeight()), new Integer(startTabIndex.intValue() + 10), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,"", Boolean.TRUE, null}));
		...
		super.addControl(factory.getControl(CheckBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1041), new Integer(anchoringHelper93.getX()), new Integer(anchoringHelper93.getY()), new Integer(anchoringHelper93.getWidth()), new Integer(anchoringHelper93.getHeight()), new Integer(startTabIndex.intValue() + 9), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,"", Boolean.TRUE, null}));
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.UrinalysisCc.__internal_x_context__SelectedUrinalysis_" + componentIdentifier, "BO-1022100012-ID", "ID_Urinalysis");
			fields[145] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.UrinalysisCc.__internal_x_context__SelectedUrinalysis_" + componentIdentifier, "BO-1022100012-NOABNORMALITYDETECTED", "NoAbnormalityDetected");
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.UrinalysisCc.__internal_x_context__SelectedUrinalysis_" + componentIdentifier, "BO-1022100012-LEUCOCYTES", "Leucocytes");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.UrinalysisCc.__internal_x_context__SelectedUrinalysis_" + componentIdentifier, "BO-1022100012-PROTEIN", "Protein");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.UrinalysisCc.__internal_x_context__SelectedUrinalysis_" + componentIdentifier, "BO-1022100012-BLOOD", "Blood");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.UrinalysisCc.__internal_x_context__SelectedUrinalysis_" + componentIdentifier, "BO-1022100012-KETONES", "Ketones");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.UrinalysisCc.__internal_x_context__SelectedUrinalysis_" + componentIdentifier, "BO-1022100012-ASCORBICACID", "AscorbicAcid");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.UrinalysisCc.__internal_x_context__SelectedUrinalysis_" + componentIdentifier, "BO-1022100012-GLUCOSE", "Glucose");
			fields[152] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.UrinalysisCc.__internal_x_context__SelectedUrinalysis_" + componentIdentifier, "BO-1022100012-BILIRUBIN", "Bilirubin");
			fields[153] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.UrinalysisCc.__internal_x_context__SelectedUrinalysis_" + componentIdentifier, "BO-1022100012-UROBILINOGEN", "Urobilinogen");
			fields[154] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.UrinalysisCc.__internal_x_context__SelectedUrinalysis_" + componentIdentifier, "BO-1022100012-NITRATE", "Nitrate");
			fields[155] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.UrinalysisCc.__internal_x_context__SelectedUrinalysis_" + componentIdentifier, "BO-1022100012-PH", "PH");
			fields[156] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.UrinalysisCc.__internal_x_context__SelectedUrinalysis_" + componentIdentifier, "BO-1022100012-SPECIFICGRAVITY", "SpecificGravity");
			fields[157] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.UrinalysisCc.__internal_x_context__SelectedUrinalysis_" + componentIdentifier, "BO-1022100012-NOSAMPLE", "NoSample");
			fields[158] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.UrinalysisCc.__internal_x_context__SelectedUrinalysis_" + componentIdentifier, "BO-1022100012-ISACTIVE", "IsActive");
			fields[159] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.UrinalysisCc.__internal_x_context__SelectedUrinalysis_" + componentIdentifier, "BO-1022100012-CARECONTEXT", "CareContext");
			return fields;
		}
