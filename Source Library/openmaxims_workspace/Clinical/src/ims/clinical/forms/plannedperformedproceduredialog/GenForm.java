...
public class GenForm extends FormBridge
{
	...
	public static class GroupStausRadioButton extends RadioButtonBridge
	{
		...
		protected void setContext(Integer startTabIndex, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize)
		{
			...
			control.addButton(0, anchoringHelper3.getX(), anchoringHelper3.getY(), anchoringHelper3.getWidth(), "Cancelled", startTabIndex.intValue() + 8);
			...
			control.addButton(1, anchoringHelper4.getX(), anchoringHelper4.getY(), anchoringHelper4.getWidth(), "Performed", startTabIndex.intValue() + 7);
		}
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		ims.framework.FormUiLogic m_ccConsultantNameForm = loader.loadComponent(102256, appForm, startControlID * 10 + 2000, anchoringHelper6.getSize(), instance2, startTabIndex.intValue() + 9, skipContextValidation);
		//ims.framework.Control m_ccConsultantNameControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1002), new Integer(136), new Integer(120), new Integer(392), new Integer(20), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, new Integer(startTabIndex.intValue() + 9), m_ccConsultantNameForm, instance2 } );
		ims.framework.Control m_ccConsultantNameControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1003),  new Integer(anchoringHelper6.getX()), new Integer(anchoringHelper6.getY()), new Integer(anchoringHelper6.getWidth()), new Integer(anchoringHelper6.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, new Integer(startTabIndex.intValue() + 9), m_ccConsultantNameForm, instance2, Boolean.TRUE } );
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[158] = new ims.framework.ReportField(this.context, "_cv_Clinical.SurgicalAuditActualPlannedProcedure", "BO-1003100017-ID", "ID_PatientProcedure");
			fields[159] = new ims.framework.ReportField(this.context, "_cv_Clinical.SurgicalAuditActualPlannedProcedure", "BO-1003100017-PROCEDUREDESCRIPTION", "ProcedureDescription");
			fields[160] = new ims.framework.ReportField(this.context, "_cv_Clinical.SurgicalAuditActualPlannedProcedure", "BO-1003100017-INFOSOURCE", "InfoSource");
			fields[161] = new ims.framework.ReportField(this.context, "_cv_Clinical.SurgicalAuditActualPlannedProcedure", "BO-1003100017-CARECONTEXT", "CareContext");
			fields[162] = new ims.framework.ReportField(this.context, "_cv_Clinical.SurgicalAuditActualPlannedProcedure", "BO-1003100017-EPISODEOFCARE", "EpisodeOfCare");
			fields[163] = new ims.framework.ReportField(this.context, "_cv_Clinical.SurgicalAuditActualPlannedProcedure", "BO-1003100017-ISPRIMARY", "IsPrimary");
			fields[164] = new ims.framework.ReportField(this.context, "_cv_Clinical.SurgicalAuditActualPlannedProcedure", "BO-1003100017-PROCEDURESTATUS", "ProcedureStatus");
			fields[165] = new ims.framework.ReportField(this.context, "_cv_Clinical.SurgicalAuditActualPlannedProcedure", "BO-1003100017-PROCEDUREOUTCOME", "ProcedureOutcome");
			fields[166] = new ims.framework.ReportField(this.context, "_cv_Clinical.SurgicalAuditActualPlannedProcedure", "BO-1003100017-CANCELLEDDATE", "CancelledDate");
			return fields;
		}
