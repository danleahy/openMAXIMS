...
public class GenForm extends FormBridge
{
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedDrugToxicologyItem", "BO-1086100029-ID", "ID_DrugToxicologyItem");
			fields[145] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedDrugToxicologyItem", "BO-1086100029-TOXICOLOGYTYPE", "ToxicologyType");
			fields[146] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedDrugToxicologyItem", "BO-1086100029-TOXICOLOGYRESULT", "ToxicologyResult");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.UrineToxCc.__internal_x_context__currentDrugToxicology_" + componentIdentifier, "BO-1086100028-ID", "ID_DrugToxicology");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.UrineToxCc.__internal_x_context__currentDrugToxicology_" + componentIdentifier, "BO-1086100028-CARECONTEXT", "CareContext");
			return fields;
		}
