...
public class GenForm extends FormBridge
{
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ProceduresDialog.__internal_x_context__voContact_" + componentIdentifier, "BO-1004100003-ID", "ID_ClinicalContact");
			fields[145] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ProceduresDialog.__internal_x_context__voContact_" + componentIdentifier, "BO-1004100003-SPECIALTY", "Specialty");
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ProceduresDialog.__internal_x_context__voContact_" + componentIdentifier, "BO-1004100003-SEENBY", "SeenBy");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ProceduresDialog.__internal_x_context__voContact_" + componentIdentifier, "BO-1004100003-CONTACTTYPE", "ContactType");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ProceduresDialog.__internal_x_context__voContact_" + componentIdentifier, "BO-1004100003-STARTDATETIME", "StartDateTime");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ProceduresDialog.__internal_x_context__voContact_" + componentIdentifier, "BO-1004100003-ENDDATETIME", "EndDateTime");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ProceduresDialog.__internal_x_context__voContact_" + componentIdentifier, "BO-1004100003-CARECONTEXT", "CareContext");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ProceduresDialog.__internal_x_context__voContact_" + componentIdentifier, "BO-1004100003-ISCLINICALNOTECREATED", "IsClinicalNoteCreated");
			fields[152] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ProceduresDialog.__internal_x_context__voTaxonomyMap_" + componentIdentifier, "BO-1003100010-ID", "ID_TaxonomyMap");
			fields[153] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ProceduresDialog.__internal_x_context__voTaxonomyMap_" + componentIdentifier, "BO-1003100010-TAXONOMYNAME", "TaxonomyName");
			fields[154] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ProceduresDialog.__internal_x_context__voTaxonomyMap_" + componentIdentifier, "BO-1003100010-TAXONOMYCODE", "TaxonomyCode");
			fields[155] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ProceduresDialog.__internal_x_context__voDiagnosis_" + componentIdentifier, "BO-1003100025-ID", "ID_Diagnosis");
			fields[156] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ProceduresDialog.__internal_x_context__voDiagnosis_" + componentIdentifier, "BO-1003100025-DIAGNOSISNAME", "DiagnosisName");
			fields[157] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ProceduresDialog.__internal_x_context__voDiagnosis_" + componentIdentifier, "BO-1003100025-ISACTIVE", "IsActive");
			return fields;
		}
