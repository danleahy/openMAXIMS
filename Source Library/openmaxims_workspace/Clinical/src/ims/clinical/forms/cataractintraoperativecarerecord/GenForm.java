...
public class GenForm extends FormBridge
{
		...
		public static class tabCareRecordContainer extends LayerBridge
		{
			...
			public static class PlannedUnplannedRadioButton extends RadioButtonBridge
			{
				...
				protected void setContext(Integer startTabIndex, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize)
				{
					...
					control.addButton(0, anchoringHelper1.getX(), anchoringHelper1.getY(), anchoringHelper1.getWidth(), "Unplanned", startTabIndex.intValue() + 33);
					...
					control.addButton(1, anchoringHelper2.getX(), anchoringHelper2.getY(), anchoringHelper2.getWidth(), "Planned", startTabIndex.intValue() + 32);
				}
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				ims.framework.FormUiLogic m_ccCirculatingNurseForm = loader.loadComponent(102256, appForm, startControlID * 10 + 1000, anchoringHelper5.getSize(), instance1, startTabIndex.intValue() + 25, skipContextValidation);
				//ims.framework.Control m_ccCirculatingNurseControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1002), new Integer(560), new Integer(368), new Integer(264), new Integer(20), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFT, new Integer(startTabIndex.intValue() + 25), m_ccCirculatingNurseForm, instance1 } );
				ims.framework.Control m_ccCirculatingNurseControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1003),  new Integer(anchoringHelper5.getX()), new Integer(anchoringHelper5.getY()), new Integer(anchoringHelper5.getWidth()), new Integer(anchoringHelper5.getHeight()), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFT, new Integer(startTabIndex.intValue() + 25), m_ccCirculatingNurseForm, instance1, Boolean.FALSE } );
				...
				ims.framework.FormUiLogic m_ccScrubNurseForm = loader.loadComponent(102256, appForm, startControlID * 10 + 2000, anchoringHelper6.getSize(), instance2, startTabIndex.intValue() + 23, skipContextValidation);
				//ims.framework.Control m_ccScrubNurseControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1004), new Integer(128), new Integer(368), new Integer(280), new Integer(20), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFT, new Integer(startTabIndex.intValue() + 23), m_ccScrubNurseForm, instance2 } );
				ims.framework.Control m_ccScrubNurseControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1005),  new Integer(anchoringHelper6.getX()), new Integer(anchoringHelper6.getY()), new Integer(anchoringHelper6.getWidth()), new Integer(anchoringHelper6.getHeight()), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFT, new Integer(startTabIndex.intValue() + 23), m_ccScrubNurseForm, instance2, Boolean.FALSE } );
				...
				ims.framework.FormUiLogic m_ccODAODPForm = loader.loadComponent(102256, appForm, startControlID * 10 + 3000, anchoringHelper7.getSize(), instance3, startTabIndex.intValue() + 21, skipContextValidation);
				//ims.framework.Control m_ccODAODPControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1006), new Integer(560), new Integer(344), new Integer(264), new Integer(20), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFT, new Integer(startTabIndex.intValue() + 21), m_ccODAODPForm, instance3 } );
				ims.framework.Control m_ccODAODPControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1007),  new Integer(anchoringHelper7.getX()), new Integer(anchoringHelper7.getY()), new Integer(anchoringHelper7.getWidth()), new Integer(anchoringHelper7.getHeight()), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFT, new Integer(startTabIndex.intValue() + 21), m_ccODAODPForm, instance3, Boolean.FALSE } );
				...
				ims.framework.FormUiLogic m_ccAnaesthetistForm = loader.loadComponent(102256, appForm, startControlID * 10 + 4000, anchoringHelper8.getSize(), instance4, startTabIndex.intValue() + 19, skipContextValidation);
				//ims.framework.Control m_ccAnaesthetistControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1008), new Integer(128), new Integer(344), new Integer(280), new Integer(20), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFT, new Integer(startTabIndex.intValue() + 19), m_ccAnaesthetistForm, instance4 } );
				ims.framework.Control m_ccAnaesthetistControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1009),  new Integer(anchoringHelper8.getX()), new Integer(anchoringHelper8.getY()), new Integer(anchoringHelper8.getWidth()), new Integer(anchoringHelper8.getHeight()), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFT, new Integer(startTabIndex.intValue() + 19), m_ccAnaesthetistForm, instance4, Boolean.FALSE } );
				...
				ims.framework.FormUiLogic m_ccSurgeonAssistantForm = loader.loadComponent(102256, appForm, startControlID * 10 + 5000, anchoringHelper9.getSize(), instance5, startTabIndex.intValue() + 17, skipContextValidation);
				//ims.framework.Control m_ccSurgeonAssistantControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1010), new Integer(560), new Integer(320), new Integer(264), new Integer(20), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFT, new Integer(startTabIndex.intValue() + 17), m_ccSurgeonAssistantForm, instance5 } );
				ims.framework.Control m_ccSurgeonAssistantControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1011),  new Integer(anchoringHelper9.getX()), new Integer(anchoringHelper9.getY()), new Integer(anchoringHelper9.getWidth()), new Integer(anchoringHelper9.getHeight()), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFT, new Integer(startTabIndex.intValue() + 17), m_ccSurgeonAssistantForm, instance5, Boolean.FALSE } );
				...
				ims.framework.FormUiLogic m_ccSurgeonForm = loader.loadComponent(102256, appForm, startControlID * 10 + 6000, anchoringHelper10.getSize(), instance6, startTabIndex.intValue() + 15, skipContextValidation);
				//ims.framework.Control m_ccSurgeonControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1012), new Integer(128), new Integer(320), new Integer(280), new Integer(20), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFT, new Integer(startTabIndex.intValue() + 15), m_ccSurgeonForm, instance6 } );
				ims.framework.Control m_ccSurgeonControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1013),  new Integer(anchoringHelper10.getX()), new Integer(anchoringHelper10.getY()), new Integer(anchoringHelper10.getWidth()), new Integer(anchoringHelper10.getHeight()), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFT, new Integer(startTabIndex.intValue() + 15), m_ccSurgeonForm, instance6, Boolean.FALSE } );
				...
				ims.framework.FormUiLogic m_ccPlannedProcedureForm = loader.loadComponent(123133, appForm, startControlID * 10 + 8000, anchoringHelper12.getSize(), instance8, startTabIndex.intValue() + 4, skipContextValidation);
				//ims.framework.Control m_ccPlannedProcedureControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1016), new Integer(16), new Integer(112), new Integer(808), new Integer(64), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT, new Integer(startTabIndex.intValue() + 4), m_ccPlannedProcedureForm, instance8 } );
				ims.framework.Control m_ccPlannedProcedureControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1017),  new Integer(anchoringHelper12.getX()), new Integer(anchoringHelper12.getY()), new Integer(anchoringHelper12.getWidth()), new Integer(anchoringHelper12.getHeight()), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT, new Integer(startTabIndex.intValue() + 4), m_ccPlannedProcedureForm, instance8, Boolean.FALSE } );
				...
				ims.framework.FormUiLogic m_ccActualProcedurePerformedForm = loader.loadComponent(123133, appForm, startControlID * 10 + 9000, anchoringHelper13.getSize(), instance9, startTabIndex.intValue() + 28, skipContextValidation);
				//ims.framework.Control m_ccActualProcedurePerformedControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1018), new Integer(16), new Integer(448), new Integer(808), new Integer(64), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT, new Integer(startTabIndex.intValue() + 28), m_ccActualProcedurePerformedForm, instance9 } );
				...
				super.addControl(factory.getControl(DateControl.class, new Object[] { control, new Integer(startControlID.intValue() + 1037), new Integer(anchoringHelper31.getX()), new Integer(anchoringHelper31.getY()), new Integer(anchoringHelper31.getWidth()), new Integer(anchoringHelper31.getHeight()), new Integer(startTabIndex.intValue() + 8), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.TRUE, null, Boolean.FALSE, null, Boolean.TRUE, null}));
				...
				super.addControl(factory.getControl(DateTimeControl.class, new Object[] { control, new Integer(startControlID.intValue() + 1040), new Integer(anchoringHelper34.getX()), new Integer(anchoringHelper34.getY()), new Integer(anchoringHelper34.getWidth()), new Integer(anchoringHelper34.getHeight()), new Integer(startTabIndex.intValue() + 10), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.TRUE, null, Boolean.FALSE, null, Boolean.FALSE, null}));
				...
				super.addControl(factory.getControl(DateTimeControl.class, new Object[] { control, new Integer(startControlID.intValue() + 1041), new Integer(anchoringHelper35.getX()), new Integer(anchoringHelper35.getY()), new Integer(anchoringHelper35.getWidth()), new Integer(anchoringHelper35.getHeight()), new Integer(startTabIndex.intValue() + 13), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT,Boolean.TRUE, null, Boolean.FALSE, null, Boolean.FALSE, null}));
		...
		public static class tabDetailsContainer extends LayerBridge
		{
			...
			public static class grpYesNoRadioButton extends RadioButtonBridge
			{
				...
				protected void setContext(Integer startTabIndex, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize)
				{
					...
					control.addButton(0, anchoringHelper38.getX(), anchoringHelper38.getY(), anchoringHelper38.getWidth(), "Yes", startTabIndex.intValue() + 39);
					...
					control.addButton(1, anchoringHelper39.getX(), anchoringHelper39.getY(), anchoringHelper39.getWidth(), "No", startTabIndex.intValue() + 40);
				}
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				Grid m_grdDressingsTemp = (Grid)factory.getControl(Grid.class, new Object[] { control, new Integer(startControlID.intValue() + 1051), new Integer(anchoringHelper46.getX()), new Integer(anchoringHelper46.getY()), new Integer(anchoringHelper46.getWidth()), new Integer(anchoringHelper46.getHeight()), new Integer(startTabIndex.intValue() + 37), ControlState.DISABLED, ControlState.EDITABLE, ims.framework.enumerations.ControlAnchoring.ALL,Boolean.FALSE, Boolean.TRUE, new Integer(24), Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, new Integer(0), null, Boolean.FALSE, Boolean.TRUE});
				...
				super.addControl(factory.getControl(DynamicGrid.class, new Object[] { control, new Integer(startControlID.intValue() + 1053), new Integer(anchoringHelper48.getX()), new Integer(anchoringHelper48.getY()), new Integer(anchoringHelper48.getWidth()), new Integer(anchoringHelper48.getHeight()), new Integer(startTabIndex.intValue() + 35), ControlState.DISABLED, ControlState.EDITABLE, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT, contextMenus.Clinical.contextMenuAddRemoveItems2, Boolean.TRUE, Boolean.FALSE, Boolean.TRUE}));
				...
				super.addControl(factory.getControl(DynamicGrid.class, new Object[] { control, new Integer(startControlID.intValue() + 1054), new Integer(anchoringHelper49.getX()), new Integer(anchoringHelper49.getY()), new Integer(anchoringHelper49.getWidth()), new Integer(anchoringHelper49.getHeight()), new Integer(startTabIndex.intValue() + 34), ControlState.DISABLED, ControlState.EDITABLE, ims.framework.enumerations.ControlAnchoring.TOPLEFT, contextMenus.Clinical.contextMenuAddRemoveItems1, Boolean.TRUE, Boolean.FALSE, Boolean.TRUE}));
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1059), new Integer(anchoringHelper53.getX()), new Integer(anchoringHelper53.getY()), new Integer(anchoringHelper53.getWidth()), new Integer(anchoringHelper53.getHeight()), new Integer(startTabIndex.intValue() + 42), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Edit", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1060), new Integer(anchoringHelper54.getX()), new Integer(anchoringHelper54.getY()), new Integer(anchoringHelper54.getWidth()), new Integer(anchoringHelper54.getHeight()), new Integer(startTabIndex.intValue() + 41), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "New", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1061), new Integer(anchoringHelper55.getX()), new Integer(anchoringHelper55.getY()), new Integer(anchoringHelper55.getWidth()), new Integer(anchoringHelper55.getHeight()), new Integer(startTabIndex.intValue() + 44), ControlState.UNKNOWN, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Cancel", Boolean.FALSE, null, Boolean.FALSE, Boolean.FALSE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1062), new Integer(anchoringHelper56.getX()), new Integer(anchoringHelper56.getY()), new Integer(anchoringHelper56.getWidth()), new Integer(anchoringHelper56.getHeight()), new Integer(startTabIndex.intValue() + 43), ControlState.HIDDEN, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Save", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
	}
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[175] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.CataractIntraOperativeCareRecord.__internal_x_context__CurrentRecord_" + componentIdentifier, "BO-1072100081-ID", "ID_IntraOperativeCareRecord");
			fields[176] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.CataractIntraOperativeCareRecord.__internal_x_context__CurrentRecord_" + componentIdentifier, "BO-1072100081-CARECONTEXT", "CareContext");
			fields[177] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.CataractIntraOperativeCareRecord.__internal_x_context__CurrentRecord_" + componentIdentifier, "BO-1072100081-PROCEDUREDATE", "ProcedureDate");
			fields[178] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.CataractIntraOperativeCareRecord.__internal_x_context__CurrentRecord_" + componentIdentifier, "BO-1072100081-INTHEATRETIME", "InTheatreTime");
			fields[179] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.CataractIntraOperativeCareRecord.__internal_x_context__CurrentRecord_" + componentIdentifier, "BO-1072100081-SURGERYSTARTTIME", "SurgeryStartTime");
			fields[180] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.CataractIntraOperativeCareRecord.__internal_x_context__CurrentRecord_" + componentIdentifier, "BO-1072100081-SURGERYENDTIME", "SurgeryEndTime");
			fields[181] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.CataractIntraOperativeCareRecord.__internal_x_context__CurrentRecord_" + componentIdentifier, "BO-1072100081-ANAESTHETISTSTARTTIME", "AnaesthetistStartTime");
			fields[182] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.CataractIntraOperativeCareRecord.__internal_x_context__CurrentRecord_" + componentIdentifier, "BO-1072100081-OTHER", "Other");
			fields[183] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.CataractIntraOperativeCareRecord.__internal_x_context__CurrentRecord_" + componentIdentifier, "BO-1072100081-WASPLANNEDPROCEDURE", "WasPlannedProcedure");
			fields[184] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.CataractIntraOperativeCareRecord.__internal_x_context__CurrentRecord_" + componentIdentifier, "BO-1072100081-WASUNPLANNEDPROCEDURE", "WasUnplannedProcedure");
			fields[185] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.CataractIntraOperativeCareRecord.__internal_x_context__CurrentRecord_" + componentIdentifier, "BO-1072100081-ADMISSIONTYPE", "AdmissionType");
			fields[186] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.CataractIntraOperativeCareRecord.__internal_x_context__CurrentRecord_" + componentIdentifier, "BO-1072100081-READMISSIONTYPE", "ReadmissionType");
			fields[187] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.CataractIntraOperativeCareRecord.__internal_x_context__CurrentRecord_" + componentIdentifier, "BO-1072100081-PASEVENT", "PasEvent");
			fields[188] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.CataractIntraOperativeCareRecord.__internal_x_context__CurrentRecord_" + componentIdentifier, "BO-1072100081-INTOPACUTIME", "IntoPacuTime");
			fields[189] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.CataractIntraOperativeCareRecord.__internal_x_context__CurrentRecord_" + componentIdentifier, "BO-1072100081-TIMEINTORECOVERY", "TimeIntoRecovery");
			fields[190] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.CataractIntraOperativeCareRecord.__internal_x_context__CurrentRecord_" + componentIdentifier, "BO-1072100081-TIMEOUTOFRECOVERY", "TimeOutOfRecovery");
			fields[191] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.CataractIntraOperativeCareRecord.__internal_x_context__CurrentRecord_" + componentIdentifier, "BO-1072100081-ANAESTHETICUSED", "AnaestheticUsed");
			fields[192] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.CataractIntraOperativeCareRecord.__internal_x_context__PlannedPatientProcedure_" + componentIdentifier, "BO-1003100017-ID", "ID_PatientProcedure");
			fields[193] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.CataractIntraOperativeCareRecord.__internal_x_context__PlannedPatientProcedure_" + componentIdentifier, "BO-1003100017-PROCEDUREDESCRIPTION", "ProcedureDescription");
			fields[194] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.CataractIntraOperativeCareRecord.__internal_x_context__PlannedPatientProcedure_" + componentIdentifier, "BO-1003100017-INFOSOURCE", "InfoSource");
			fields[195] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.CataractIntraOperativeCareRecord.__internal_x_context__PlannedPatientProcedure_" + componentIdentifier, "BO-1003100017-PROCDATE", "ProcDate");
			fields[196] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.CataractIntraOperativeCareRecord.__internal_x_context__PlannedPatientProcedure_" + componentIdentifier, "BO-1003100017-INCLUDEINDISCHARGELETTER", "IncludeInDischargeLetter");
			fields[197] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.CataractIntraOperativeCareRecord.__internal_x_context__PlannedPatientProcedure_" + componentIdentifier, "BO-1003100017-SITETEXT", "SiteText");
			fields[198] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.CataractIntraOperativeCareRecord.__internal_x_context__PlannedPatientProcedure_" + componentIdentifier, "BO-1003100017-PROCLATERALITY", "ProcLaterality");
			fields[199] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.CataractIntraOperativeCareRecord.__internal_x_context__PlannedPatientProcedure_" + componentIdentifier, "BO-1003100017-PROCEDURESTATUS", "ProcedureStatus");
			fields[200] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.CataractIntraOperativeCareRecord.__internal_x_context__PlannedPatientProcedure_" + componentIdentifier, "BO-1003100017-PROCTIME", "ProcTime");
			fields[201] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.CataractIntraOperativeCareRecord.__internal_x_context__PlannedPatientProcedure_" + componentIdentifier, "BO-1003100017-EPISODEOFCARE", "EpisodeOfCare");
			fields[202] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.CataractIntraOperativeCareRecord.__internal_x_context__PlannedPatientProcedure_" + componentIdentifier, "BO-1003100017-ISPRIMARY", "IsPrimary");
			return fields;
		}
