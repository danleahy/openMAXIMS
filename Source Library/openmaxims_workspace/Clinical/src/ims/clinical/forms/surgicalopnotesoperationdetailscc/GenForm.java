...
public class GenForm extends FormBridge
{
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalOPNotesOperationDetailsCC.__internal_x_context__CurrentRecord_" + componentIdentifier, "BO-1072100085-ID", "ID_SurgicalOperationDetails");
			fields[145] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalOPNotesOperationDetailsCC.__internal_x_context__CurrentRecord_" + componentIdentifier, "BO-1072100085-CARECONTEXT", "CareContext");
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalOPNotesOperationDetailsCC.__internal_x_context__CurrentRecord_" + componentIdentifier, "BO-1072100085-INCISION", "Incision");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalOPNotesOperationDetailsCC.__internal_x_context__CurrentRecord_" + componentIdentifier, "BO-1072100085-FINDINGS", "Findings");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalOPNotesOperationDetailsCC.__internal_x_context__CurrentRecord_" + componentIdentifier, "BO-1072100085-PROCEDURE", "Procedure");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalOPNotesOperationDetailsCC.__internal_x_context__CurrentRecord_" + componentIdentifier, "BO-1072100085-CLOSURE", "Closure");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalOPNotesOperationDetailsCC.__internal_x_context__CurrentRecord_" + componentIdentifier, "BO-1072100085-PROSTHESIS", "Prosthesis");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalOPNotesOperationDetailsCC.__internal_x_context__CurrentRecord_" + componentIdentifier, "BO-1072100085-DRAIN", "Drain");
			return fields;
		}
