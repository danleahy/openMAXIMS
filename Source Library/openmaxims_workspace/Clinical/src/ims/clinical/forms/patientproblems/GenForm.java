...
public class GenForm extends FormBridge
{
	...
	public static class ctnDetailsContainer extends ContainerBridge
	{
		...
		protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
		{
			...
			ims.framework.FormUiLogic m_customControlAuthoringForm = loader.loadComponent(102228, appForm, startControlID * 10 + 1000, anchoringHelper3.getSize(), instance1, startTabIndex.intValue() + 17, skipContextValidation);
			//ims.framework.Control m_customControlAuthoringControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1000), new Integer(456), new Integer(184), new Integer(351), new Integer(56), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, new Integer(startTabIndex.intValue() + 17), m_customControlAuthoringForm, instance1 } );
			ims.framework.Control m_customControlAuthoringControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1001),  new Integer(anchoringHelper3.getX()), new Integer(anchoringHelper3.getY()), new Integer(anchoringHelper3.getWidth()), new Integer(anchoringHelper3.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, new Integer(startTabIndex.intValue() + 17), m_customControlAuthoringForm, instance1, Boolean.FALSE } );
			...
			super.addControl(factory.getControl(DateControl.class, new Object[] { control, new Integer(startControlID.intValue() + 1016), new Integer(anchoringHelper17.getX()), new Integer(anchoringHelper17.getY()), new Integer(anchoringHelper17.getWidth()), new Integer(anchoringHelper17.getHeight()), new Integer(startTabIndex.intValue() + 15), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.TRUE, null, Boolean.FALSE, null, Boolean.TRUE, null}));
			...
			ComboBox m_qmbResolvedByTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1020), new Integer(anchoringHelper21.getX()), new Integer(anchoringHelper21.getY()), new Integer(anchoringHelper21.getWidth()), new Integer(anchoringHelper21.getHeight()), new Integer(startTabIndex.intValue() + 14), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.TRUE, new Integer(1), null, Boolean.TRUE, new Integer(-1), Boolean.FALSE});
	...
	private void validateContext(ims.framework.Context context)
	{
		...
		if(!context.isValidContextType(ims.clinical.vo.PatientProblemsSearchCriteriaVo.class))
			throw new ims.framework.exceptions.CodingRuntimeException("The type 'ims.clinical.vo.PatientProblemsSearchCriteriaVo' of the global context variable 'Clinical.PatientProblemsSearchCriteria' is not supported.");
	}
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1025), new Integer(anchoringHelper25.getX()), new Integer(anchoringHelper25.getY()), new Integer(anchoringHelper25.getWidth()), new Integer(anchoringHelper25.getHeight()), new Integer(startTabIndex.intValue() + 21), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Close", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[168] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedPatientProblemFromPatientSummary", "BO-1023100001-ID", "ID_PatientProblem");
			fields[169] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientProblems.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1023100001-ID", "ID_PatientProblem");
			fields[170] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientProblems.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1023100001-PATIENTPROBLEM", "PatientProblem");
			fields[171] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientProblems.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1023100001-STATUS", "Status");
			fields[172] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientProblems.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1023100001-ISPRESENTINGPROBLEM", "IsPresentingProblem");
			fields[173] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientProblems.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1023100001-CLINICALCONTACT", "ClinicalContact");
			fields[174] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientProblems.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1023100001-PROBLEMCONTEXT", "ProblemContext");
			fields[175] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientProblems.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1023100001-ISACTIVE", "IsActive");
			fields[176] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientProblems.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1023100001-ISRESOLVED", "IsResolved");
			fields[177] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientProblems.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1023100001-DATERESOLVED", "DateResolved");
			fields[178] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientProblems.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1023100001-ONSET", "Onset");
			fields[179] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientProblems.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1023100001-SOURCE", "Source");
			fields[180] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientProblems.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1023100001-PROBLEMNOTE", "ProblemNote");
			fields[181] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientProblems.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1023100001-SPECIALTY", "Specialty");
			return fields;
		}
