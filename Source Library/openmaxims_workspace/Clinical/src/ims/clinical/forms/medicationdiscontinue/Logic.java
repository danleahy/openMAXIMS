...
public class Logic extends BaseLogic
{
	...
	protected void onFormOpen() throws ims.framework.exceptions.PresentationLogicException
	{
		...
		form.cmbDiscontinuedByType().setValue(MedicationCommencedDiscontinuedType.MOS);
		defaultHCP();
	...
	protected void onCmbDiscontinuedByTypeValueChanged() throws PresentationLogicException 
	{
		if ( (form.cmbDiscontinuedByType().getValue() != null)
			&& (form.cmbDiscontinuedByType().getValue().equals(MedicationCommencedDiscontinuedType.MOS)) )
		{
			form.qmbHCP().setEnabled(true);
			defaultHCP();
		}
