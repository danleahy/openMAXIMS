...
public abstract class BaseLogic extends Handlers
{
	...
	protected final void oncmbDeathNotificationStatusValueSet(Object value)
	{
		java.util.ArrayList listOfValues = this.form.cmbDeathNotificationStatus().getValues();
		...
		if(value == null)
		{
			if(listOfValues != null && listOfValues.size() > 0)
			{
				...
				{
					ims.admin.vo.lookups.PDSDeathNotificationStatus existingInstance = (ims.admin.vo.lookups.PDSDeathNotificationStatus)listOfValues.get(x);
		...
		else if(value instanceof ims.admin.vo.lookups.PDSDeathNotificationStatus)
		{
			ims.admin.vo.lookups.PDSDeathNotificationStatus instance = (ims.admin.vo.lookups.PDSDeathNotificationStatus)value;
			...
			this.form.cmbDeathNotificationStatus().newRow(instance, instance.getText(), instance.getImage(), instance.getTextColor());
		}
	}
	protected final void bindcmbDeathNotificationStatusLookup()
	{
		this.form.cmbDeathNotificationStatus().clear();
		ims.admin.vo.lookups.PDSDeathNotificationStatusCollection lookupCollection = ims.admin.vo.lookups.LookupHelper.getPDSDeathNotificationStatus(this.domain.getLookupService());
		for(int x = 0; x < lookupCollection.size(); x++)
		{
			this.form.cmbDeathNotificationStatus().newRow(lookupCollection.get(x), lookupCollection.get(x).getText(), lookupCollection.get(x).getImage(), lookupCollection.get(x).getTextColor());
		}
	}
	protected final void setcmbDeathNotificationStatusLookupValue(int id)
	{
		ims.admin.vo.lookups.PDSDeathNotificationStatus instance = ims.admin.vo.lookups.LookupHelper.getPDSDeathNotificationStatusInstance(this.domain.getLookupService(), id);
		if(instance != null)
			this.form.cmbDeathNotificationStatus().setValue(instance);
	}
	protected final void defaultcmbDeathNotificationStatusLookupValue()
	{
		this.form.cmbDeathNotificationStatus().setValue((ims.admin.vo.lookups.PDSDeathNotificationStatus)domain.getLookupService().getDefaultInstance(ims.admin.vo.lookups.PDSDeathNotificationStatus.class, engine.getFormName().getID(), ims.admin.vo.lookups.PDSDeathNotificationStatus.TYPE_ID));
	}
