...
public class GenForm extends FormBridge
{
	...
	public static class lyr1Layer extends Layer
	{
		...
		public static class tabOperationDetailsContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				ims.framework.FormUiLogic m_ccOperationDetailForm = loader.loadComponent(123174, appForm, startControlID * 10 + 2000, anchoringHelper2.getSize(), instance1, startTabIndex.intValue() + 18, skipContextValidation);
				//ims.framework.Control m_ccOperationDetailControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1002), new Integer(0), new Integer(8), new Integer(824), new Integer(560), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 18), m_ccOperationDetailForm, instance1 } );
				ims.framework.Control m_ccOperationDetailControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1003),  new Integer(anchoringHelper2.getX()), new Integer(anchoringHelper2.getY()), new Integer(anchoringHelper2.getWidth()), new Integer(anchoringHelper2.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 18), m_ccOperationDetailForm, instance1, Boolean.FALSE } );
		...
		public static class tabDiagramContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				ims.framework.FormUiLogic m_ccDiagramForm = loader.loadComponent(123173, appForm, startControlID * 10 + 3000, anchoringHelper3.getSize(), instance1, startTabIndex.intValue() + 28, skipContextValidation);
				//ims.framework.Control m_ccDiagramControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1004), new Integer(0), new Integer(0), new Integer(824), new Integer(568), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 28), m_ccDiagramForm, instance1 } );
				ims.framework.Control m_ccDiagramControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1005),  new Integer(anchoringHelper3.getX()), new Integer(anchoringHelper3.getY()), new Integer(anchoringHelper3.getWidth()), new Integer(anchoringHelper3.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 28), m_ccDiagramForm, instance1, Boolean.FALSE } );
		...
		public static class tabPostOpContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				ims.framework.FormUiLogic m_ccPostOpInstructionForm = loader.loadComponent(123172, appForm, startControlID * 10 + 4000, anchoringHelper4.getSize(), instance1, startTabIndex.intValue() + 47, skipContextValidation);
				//ims.framework.Control m_ccPostOpInstructionControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1006), new Integer(0), new Integer(8), new Integer(816), new Integer(560), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 47), m_ccPostOpInstructionForm, instance1 } );
				ims.framework.Control m_ccPostOpInstructionControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1007),  new Integer(anchoringHelper4.getX()), new Integer(anchoringHelper4.getY()), new Integer(anchoringHelper4.getWidth()), new Integer(anchoringHelper4.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 47), m_ccPostOpInstructionForm, instance1, Boolean.FALSE } );
		...
		public static class tabPreviewContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				ims.framework.FormUiLogic m_ccPreviewForm = loader.loadComponent(123175, appForm, startControlID * 10 + 5000, anchoringHelper5.getSize(), instance1, startTabIndex.intValue() + 59, skipContextValidation);
				//ims.framework.Control m_ccPreviewControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1008), new Integer(8), new Integer(0), new Integer(816), new Integer(568), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 59), m_ccPreviewForm, instance1 } );
				ims.framework.Control m_ccPreviewControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1009),  new Integer(anchoringHelper5.getX()), new Integer(anchoringHelper5.getY()), new Integer(anchoringHelper5.getWidth()), new Integer(anchoringHelper5.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 59), m_ccPreviewForm, instance1, Boolean.FALSE } );
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalOperationNotes.__internal_x_context__SurgicalOperationSummary_" + componentIdentifier, "BO-1072100111-ID", "ID_SurgicalOperationSummary");
			fields[145] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalOperationNotes.__internal_x_context__SurgicalOperationSummary_" + componentIdentifier, "BO-1072100111-CARECONTEXT", "CareContext");
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalOperationNotes.__internal_x_context__SurgicalOperationSummary_" + componentIdentifier, "BO-1072100111-OPERATIONDETAILSCOMPLETED", "OperationDetailsCompleted");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalOperationNotes.__internal_x_context__SurgicalOperationSummary_" + componentIdentifier, "BO-1072100111-SUMMARYDOCUMENTGENERATED", "SummaryDocumentGenerated");
			return fields;
		}
