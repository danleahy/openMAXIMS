...
public class GenForm extends FormBridge
{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		ComboBox m_qmbNurseTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1020), new Integer(anchoringHelper20.getX()), new Integer(anchoringHelper20.getY()), new Integer(anchoringHelper20.getWidth()), new Integer(anchoringHelper20.getHeight()), new Integer(startTabIndex.intValue() + 15), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFTRIGHT,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.TRUE, new Integer(1), null, Boolean.FALSE, new Integer(-1), Boolean.FALSE});
		...
		super.addControl(factory.getControl(CheckBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1021), new Integer(anchoringHelper21.getX()), new Integer(anchoringHelper21.getY()), new Integer(anchoringHelper21.getWidth()), new Integer(anchoringHelper21.getHeight()), new Integer(startTabIndex.intValue() + 9), ControlState.DISABLED, ControlState.ENABLED,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,"Significant Procedure", Boolean.FALSE, null}));
		...
		Grid m_grdAssistantsTemp = (Grid)factory.getControl(Grid.class, new Object[] { control, new Integer(startControlID.intValue() + 1022), new Integer(anchoringHelper22.getX()), new Integer(anchoringHelper22.getY()), new Integer(anchoringHelper22.getWidth()), new Integer(anchoringHelper22.getHeight()), new Integer(startTabIndex.intValue() + 13), ControlState.DISABLED, ControlState.EDITABLE, ims.framework.enumerations.ControlAnchoring.ALL,Boolean.TRUE, Boolean.FALSE, new Integer(24), Boolean.TRUE, contextMenus.contextMenuHcpGrid, Boolean.FALSE, Boolean.FALSE, new Integer(0), null, Boolean.FALSE, Boolean.TRUE});
		...
		Grid m_grdImpDevInsTemp = (Grid)factory.getControl(Grid.class, new Object[] { control, new Integer(startControlID.intValue() + 1024), new Integer(anchoringHelper24.getX()), new Integer(anchoringHelper24.getY()), new Integer(anchoringHelper24.getWidth()), new Integer(anchoringHelper24.getHeight()), new Integer(startTabIndex.intValue() + 16), ControlState.DISABLED, ControlState.EDITABLE, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT,Boolean.TRUE, Boolean.FALSE, new Integer(24), Boolean.TRUE, contextMenus.contextMenuImplantDevicesAddGrid, Boolean.FALSE, Boolean.FALSE, new Integer(0), null, Boolean.FALSE, Boolean.TRUE});
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalOperations.__internal_x_context__SurgicalOperation_" + componentIdentifier, "BO-1003100017-ID", "ID_PatientProcedure");
			fields[145] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalOperations.__internal_x_context__SurgicalOperation_" + componentIdentifier, "BO-1003100017-PROCEDUREDESCRIPTION", "ProcedureDescription");
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalOperations.__internal_x_context__SurgicalOperation_" + componentIdentifier, "BO-1003100017-INFOSOURCE", "InfoSource");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalOperations.__internal_x_context__SurgicalOperation_" + componentIdentifier, "BO-1003100017-PROCDATE", "ProcDate");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalOperations.__internal_x_context__SurgicalOperation_" + componentIdentifier, "BO-1003100017-INCLUDEINDISCHARGELETTER", "IncludeInDischargeLetter");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalOperations.__internal_x_context__SurgicalOperation_" + componentIdentifier, "BO-1003100017-SITETEXT", "SiteText");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalOperations.__internal_x_context__SurgicalOperation_" + componentIdentifier, "BO-1003100017-PROCLATERALITY", "ProcLaterality");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalOperations.__internal_x_context__SurgicalOperation_" + componentIdentifier, "BO-1003100017-PROCEDURESTATUS", "ProcedureStatus");
			fields[152] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalOperations.__internal_x_context__SurgicalOperation_" + componentIdentifier, "BO-1003100017-PROCTIME", "ProcTime");
			fields[153] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalOperations.__internal_x_context__SurgicalOperation_" + componentIdentifier, "BO-1003100017-EPISODEOFCARE", "EpisodeOfCare");
			fields[154] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalOperations.__internal_x_context__SurgicalOperation_" + componentIdentifier, "BO-1003100017-ISPRIMARY", "IsPrimary");
			fields[155] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalOperations.__internal_x_context__SurgicalOperation_" + componentIdentifier, "BO-1003100017-NOTES", "Notes");
			fields[156] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalOperations.__internal_x_context__SurgicalOperation_" + componentIdentifier, "BO-1003100017-PROCEDUREURGENCY", "ProcedureUrgency");
			fields[157] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalOperations.__internal_x_context__SurgicalOperation_" + componentIdentifier, "BO-1003100017-PROCEDUREOUTCOME", "ProcedureOutcome");
			fields[158] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalOperations.__internal_x_context__SurgicalOperation_" + componentIdentifier, "BO-1003100017-DATEPLANNED", "DatePlanned");
			fields[159] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalOperations.__internal_x_context__SurgicalOperation_" + componentIdentifier, "BO-1003100017-PLANNEDPROC", "PlannedProc");
			fields[160] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalOperations.__internal_x_context__SurgicalOperation_" + componentIdentifier, "BO-1003100017-PROCSITE", "ProcSite");
			fields[161] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalOperations.__internal_x_context__SurgicalOperation_" + componentIdentifier, "BO-1003100017-PEFORMEDBY", "PeformedBy");
			fields[162] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalOperations.__internal_x_context__SurgicalOperation_" + componentIdentifier, "BO-1003100017-PROCEDUREINTENT", "ProcedureIntent");
			fields[163] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalOperations.__internal_x_context__SurgicalOperation_" + componentIdentifier, "BO-1003100017-LOCATION", "Location");
			fields[164] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalOperations.__internal_x_context__SurgicalOperation_" + componentIdentifier, "BO-1003100017-SPECIALTY", "Specialty");
			fields[165] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalOperations.__internal_x_context__SurgicalOperation_" + componentIdentifier, "BO-1003100017-CONFIRMEDSTATUS", "ConfirmedStatus");
			fields[166] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalOperations.__internal_x_context__SurgicalOperation_" + componentIdentifier, "BO-1003100017-CONFIRMEDDATETIME", "ConfirmedDateTime");
			fields[167] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalOperations.__internal_x_context__SurgicalOperation_" + componentIdentifier, "BO-1003100017-EXCLUDEFROMOTHERS", "ExcludeFromOthers");
			fields[168] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalOperations.__internal_x_context__SurgicalOperation_" + componentIdentifier, "BO-1003100017-PROCLOCATION", "ProcLocation");
			fields[169] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalOperations.__internal_x_context__SurgicalOperation_" + componentIdentifier, "BO-1003100017-CANCELLEDDATE", "CancelledDate");
			fields[170] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalOperations.__internal_x_context__SurgicalOperation_" + componentIdentifier, "BO-1003100017-CANCELLEDREASON", "CancelledReason");
			fields[171] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalOperations.__internal_x_context__SurgicalOperation_" + componentIdentifier, "BO-1003100017-SURGEONSGRADE", "SurgeonsGrade");
			fields[172] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalOperations.__internal_x_context__SurgicalOperation_" + componentIdentifier, "BO-1003100017-PROCENDDATE", "ProcEndDate");
			fields[173] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalOperations.__internal_x_context__SurgicalOperation_" + componentIdentifier, "BO-1003100017-PROCENDTIME", "ProcEndTime");
			fields[174] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalOperations.__internal_x_context__SurgicalOperation_" + componentIdentifier, "BO-1003100017-SIGNIFPROC", "SignifProc");
			return fields;
		}
