...
public class GenForm extends FormBridge
{
	...
	public static class lyrDetailsLayer extends Layer
	{
		...
		public static class tabPageDiagnosisContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				ims.framework.FormUiLogic m_ccDiagnosisForm = loader.loadComponent(123156, appForm, startControlID * 10 + 2000, anchoringHelper2.getSize(), instance1, startTabIndex.intValue() + 10, skipContextValidation);
				//ims.framework.Control m_ccDiagnosisControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1002), new Integer(0), new Integer(0), new Integer(824), new Integer(564), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 10), m_ccDiagnosisForm, instance1 } );
				ims.framework.Control m_ccDiagnosisControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1003),  new Integer(anchoringHelper2.getX()), new Integer(anchoringHelper2.getY()), new Integer(anchoringHelper2.getWidth()), new Integer(anchoringHelper2.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 10), m_ccDiagnosisForm, instance1, Boolean.FALSE } );
		...
		public static class tabPageOpsProcsContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				ims.framework.FormUiLogic m_ccOpsProcsForm = loader.loadComponent(102301, appForm, startControlID * 10 + 4000, anchoringHelper4.getSize(), instance1, startTabIndex.intValue() + 53, skipContextValidation);
				//ims.framework.Control m_ccOpsProcsControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1006), new Integer(0), new Integer(0), new Integer(824), new Integer(566), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 53), m_ccOpsProcsForm, instance1 } );
				ims.framework.Control m_ccOpsProcsControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1007),  new Integer(anchoringHelper4.getX()), new Integer(anchoringHelper4.getY()), new Integer(anchoringHelper4.getWidth()), new Integer(anchoringHelper4.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 53), m_ccOpsProcsForm, instance1, Boolean.FALSE } );
		...
		public static class tabPageSupplementaryContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1025), new Integer(anchoringHelper14.getX()), new Integer(anchoringHelper14.getY()), new Integer(anchoringHelper14.getWidth()), new Integer(anchoringHelper14.getHeight()), new Integer(startTabIndex.intValue() + 7), ControlState.HIDDEN, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Save", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
				...
				super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1026), new Integer(anchoringHelper15.getX()), new Integer(anchoringHelper15.getY()), new Integer(anchoringHelper15.getWidth()), new Integer(anchoringHelper15.getHeight()), new Integer(startTabIndex.intValue() + 9), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Edit", Boolean.TRUE, null, Boolean.FALSE, Boolean.FALSE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeSTHK.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1099100009-ID", "ID_DischargeSupplementaryNotes");
			fields[145] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeSTHK.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1099100009-CARECONTEXT", "CareContext");
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeSTHK.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1099100009-SUPPLEMENTARYNOTE", "SupplementaryNote");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeSTHK.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1099100009-COMPLETEDBY", "CompletedBy");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeSTHK.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1099100009-COMPLETEDON", "CompletedOn");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeSTHK.__internal_x_context__DischargeDetailsRecord_" + componentIdentifier, "BO-1099100001-ID", "ID_DischargeDetails");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeSTHK.__internal_x_context__DischargeDetailsRecord_" + componentIdentifier, "BO-1099100001-CARECONTEXT", "CareContext");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeSTHK.__internal_x_context__DischargeDetailsRecord_" + componentIdentifier, "BO-1099100001-DATEOFDISCHARGE", "DateOfDischarge");
			fields[152] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeSTHK.__internal_x_context__DischargeDetailsRecord_" + componentIdentifier, "BO-1099100001-DISCHARGEMETHOD", "DischargeMethod");
			fields[153] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeSTHK.__internal_x_context__DischargeDetailsRecord_" + componentIdentifier, "BO-1099100001-DISCHARGEDESTINATION", "DischargeDestination");
			fields[154] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeSTHK.__internal_x_context__DischargeDetailsRecord_" + componentIdentifier, "BO-1099100001-DISCHARGELETTERSTATUS", "DischargeLetterStatus");
			fields[155] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeSTHK.__internal_x_context__DischargeDetailsRecord_" + componentIdentifier, "BO-1099100001-HASNOCOMPLICATIONS", "HasNoComplications");
			fields[156] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeSTHK.__internal_x_context__DischargeDetailsRecord_" + componentIdentifier, "BO-1099100001-HASNOCOMORBIDITIES", "HasNoComorbidities");
			fields[157] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeSTHK.__internal_x_context__DischargeDetailsRecord_" + componentIdentifier, "BO-1099100001-DISCHARGINGSPECIALTY", "DischargingSpecialty");
			fields[158] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeSTHK.__internal_x_context__DischargeDetailsRecord_" + componentIdentifier, "BO-1099100001-DISCHARGESUPPLEMENTARYLETTERSTATUS", "DischargeSupplementaryLetterStatus");
			fields[159] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeSTHK.__internal_x_context__DischargeDetailsRecord_" + componentIdentifier, "BO-1099100001-HASNODIAGNOSIS", "HasNoDiagnosis");
			fields[160] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeSTHK.__internal_x_context__DischargeDetailsRecord_" + componentIdentifier, "BO-1099100001-METHODOFDISCHARGE", "MethodOfDischarge");
			fields[161] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeSTHK.__internal_x_context__DischargeDetailsRecord_" + componentIdentifier, "BO-1099100001-ISDIAGNOSISCOMPLETE", "IsDiagnosisComplete");
			fields[162] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeSTHK.__internal_x_context__SelectedSummaryInstance_" + componentIdentifier, "BO-1099100018-ID", "ID_Summary");
			fields[163] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeSTHK.__internal_x_context__SelectedSummaryInstance_" + componentIdentifier, "BO-1099100018-CARECONTEXT", "CareContext");
			fields[164] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeSTHK.__internal_x_context__SelectedSummaryInstance_" + componentIdentifier, "BO-1099100018-ADMISSIONDATETIME", "AdmissionDateTime");
			fields[165] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeSTHK.__internal_x_context__SelectedSummaryInstance_" + componentIdentifier, "BO-1099100018-TTASTATUS", "TTAStatus");
			fields[166] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeSTHK.__internal_x_context__SelectedSummaryInstance_" + componentIdentifier, "BO-1099100018-HASHADANYPROCEDURESPERFORMED", "HasHadAnyProceduresPerformed");
			fields[167] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeSTHK.__internal_x_context__SelectedSummaryInstance_" + componentIdentifier, "BO-1099100018-ADDITONALCLINICALINFO", "AdditonalClinicalInfo");
			fields[168] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeSTHK.__internal_x_context__SelectedSummaryInstance_" + componentIdentifier, "BO-1099100018-DISCHARGELETTERSTATUS", "DischargeLetterStatus");
			fields[169] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeSTHK.__internal_x_context__SelectedSummaryInstance_" + componentIdentifier, "BO-1099100018-DISCHARGESUPPLEMENTARYLETTERSTATUS", "DischargeSupplementaryLetterStatus");
			fields[170] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeSTHK.__internal_x_context__SelectedSummaryInstance_" + componentIdentifier, "BO-1099100018-DISCHARGEDETAILS", "DischargeDetails");
			return fields;
		}
