...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "InternalReferralsServicesSearch";
	}
	public int getWidth()
	{
		return 544;
	...
	{
		return new String[] { "_cv_Clinical.ServiceSearchList", "_cv_Clinical.ServiceConfigSearchList" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Clinical.InternalReferralsServicesSearch.__internal_x_context__" + String.valueOf(getFormId());
	}
