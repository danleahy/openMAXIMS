...
public class GenForm extends FormBridge
{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		ims.framework.FormUiLogic m_ccTheatreNurseForm = loader.loadComponent(102256, appForm, startControlID * 10 + 1000, anchoringHelper1.getSize(), instance1, startTabIndex.intValue() + 6, skipContextValidation);
		//ims.framework.Control m_ccTheatreNurseControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1000), new Integer(192), new Integer(442), new Integer(384), new Integer(20), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, new Integer(startTabIndex.intValue() + 6), m_ccTheatreNurseForm, instance1 } );
		ims.framework.Control m_ccTheatreNurseControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1001),  new Integer(anchoringHelper1.getX()), new Integer(anchoringHelper1.getY()), new Integer(anchoringHelper1.getWidth()), new Integer(anchoringHelper1.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, new Integer(startTabIndex.intValue() + 6), m_ccTheatreNurseForm, instance1, Boolean.FALSE } );
		...
		super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1013), new Integer(anchoringHelper13.getX()), new Integer(anchoringHelper13.getY()), new Integer(anchoringHelper13.getWidth()), new Integer(anchoringHelper13.getHeight()), new Integer(startTabIndex.intValue() + 8), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT,Boolean.FALSE, new Integer(100), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, "_cv_Clinical.PatientProcedureMarkedAsPrimary", "BO-1003100017-ID", "ID_PatientProcedure");
			fields[145] = new ims.framework.ReportField(this.context, "_cv_Clinical.PatientProcedureMarkedAsPrimary", "BO-1003100017-PROCEDUREDESCRIPTION", "ProcedureDescription");
			fields[146] = new ims.framework.ReportField(this.context, "_cv_Clinical.PatientProcedureMarkedAsPrimary", "BO-1003100017-INFOSOURCE", "InfoSource");
			fields[147] = new ims.framework.ReportField(this.context, "_cv_Clinical.PatientProcedureMarkedAsPrimary", "BO-1003100017-CARECONTEXT", "CareContext");
			fields[148] = new ims.framework.ReportField(this.context, "_cv_Clinical.PatientProcedureMarkedAsPrimary", "BO-1003100017-EPISODEOFCARE", "EpisodeOfCare");
			fields[149] = new ims.framework.ReportField(this.context, "_cv_Clinical.PatientProcedureMarkedAsPrimary", "BO-1003100017-ISPRIMARY", "IsPrimary");
			fields[150] = new ims.framework.ReportField(this.context, "_cv_Clinical.PatientProcedureMarkedAsPrimary", "BO-1003100017-PROCEDURESTATUS", "ProcedureStatus");
			fields[151] = new ims.framework.ReportField(this.context, "_cv_Clinical.PatientProcedureMarkedAsPrimary", "BO-1003100017-PROCEDUREOUTCOME", "ProcedureOutcome");
			fields[152] = new ims.framework.ReportField(this.context, "_cv_Clinical.PatientProcedureMarkedAsPrimary", "BO-1003100017-CANCELLEDDATE", "CancelledDate");
			fields[153] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedPatientProcedureFromSurgicalAudit", "BO-1003100017-ID", "ID_PatientProcedure");
			fields[154] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedPatientProcedureFromSurgicalAudit", "BO-1003100017-PROCEDUREDESCRIPTION", "ProcedureDescription");
			fields[155] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedPatientProcedureFromSurgicalAudit", "BO-1003100017-INFOSOURCE", "InfoSource");
			fields[156] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedPatientProcedureFromSurgicalAudit", "BO-1003100017-CARECONTEXT", "CareContext");
			fields[157] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedPatientProcedureFromSurgicalAudit", "BO-1003100017-EPISODEOFCARE", "EpisodeOfCare");
			fields[158] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedPatientProcedureFromSurgicalAudit", "BO-1003100017-ISPRIMARY", "IsPrimary");
			fields[159] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedPatientProcedureFromSurgicalAudit", "BO-1003100017-PROCEDURESTATUS", "ProcedureStatus");
			fields[160] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedPatientProcedureFromSurgicalAudit", "BO-1003100017-PROCEDUREOUTCOME", "ProcedureOutcome");
			fields[161] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedPatientProcedureFromSurgicalAudit", "BO-1003100017-CANCELLEDDATE", "CancelledDate");
			fields[162] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalAuditPreOperationChecksTheatreNurse.__internal_x_context__OperationDetail_" + componentIdentifier, "BO-1072100108-ID", "ID_SurgicalAuditOperationDetail");
			fields[163] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalAuditPreOperationChecksTheatreNurse.__internal_x_context__OperationDetail_" + componentIdentifier, "BO-1072100108-PATIENT", "Patient");
			fields[164] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalAuditPreOperationChecksTheatreNurse.__internal_x_context__OperationDetail_" + componentIdentifier, "BO-1072100108-CARECONTEXT", "CareContext");
			fields[165] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalAuditPreOperationChecksTheatreNurse.__internal_x_context__OperationDetail_" + componentIdentifier, "BO-1072100108-OPERATIONCANCELLED", "OperationCancelled");
			fields[166] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalAuditPreOperationChecksTheatreNurse.__internal_x_context__OperationDetail_" + componentIdentifier, "BO-1072100108-REASONFORCANCELLATION", "ReasonForCancellation");
			fields[167] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalAuditPreOperationChecksTheatreNurse.__internal_x_context__OperationDetail_" + componentIdentifier, "BO-1072100108-REASONFORCANCELLATIONCOMMENT", "ReasonForCancellationComment");
			fields[168] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalAuditPreOperationChecksTheatreNurse.__internal_x_context__CareContext_" + componentIdentifier, "BO-1004100019-ID", "ID_CareContext");
			fields[169] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalAuditPreOperationChecksTheatreNurse.__internal_x_context__PatientRef_" + componentIdentifier, "BO-1001100000-ID", "ID_Patient");
			fields[170] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalAuditPreOperationChecksTheatreNurse.__internal_x_context__CurrentLocationRef_" + componentIdentifier, "BO-1007100007-ID", "ID_Location");
			fields[171] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.SurgicalAuditPreOperationChecksTheatreNurse.__internal_x_context__SurgicalAuditOperationDetails_" + componentIdentifier, "BO-1072100108-ID", "ID_SurgicalAuditOperationDetail");
			return fields;
		}
