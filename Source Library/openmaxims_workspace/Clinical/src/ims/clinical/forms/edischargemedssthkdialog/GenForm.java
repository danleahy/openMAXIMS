...
public class GenForm extends FormBridge
{
	...
	public static class GroupSelectionRadioButton extends RadioButtonBridge
	{
		...
		protected void setContext(Integer startTabIndex, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize)
		{
			...
			control.addButton(0, anchoringHelper1.getX(), anchoringHelper1.getY(), anchoringHelper1.getWidth(), "My Hotlist", startTabIndex.intValue() + 20);
			...
			control.addButton(1, anchoringHelper2.getX(), anchoringHelper2.getY(), anchoringHelper2.getWidth(), "Specialty Hotlist", startTabIndex.intValue() + 21);
			...
			control.addButton(2, anchoringHelper3.getX(), anchoringHelper3.getY(), anchoringHelper3.getWidth(), "All Medication", startTabIndex.intValue() + 22);
		}
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1021), new Integer(anchoringHelper24.getX()), new Integer(anchoringHelper24.getY()), new Integer(anchoringHelper24.getWidth()), new Integer(anchoringHelper24.getHeight()), new Integer(startTabIndex.intValue() + 9), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT,Boolean.FALSE, new Integer(40), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
		...
		super.addControl(factory.getControl(DateControl.class, new Object[] { control, new Integer(startControlID.intValue() + 1024), new Integer(anchoringHelper27.getX()), new Integer(anchoringHelper27.getY()), new Integer(anchoringHelper27.getWidth()), new Integer(anchoringHelper27.getHeight()), new Integer(startTabIndex.intValue() + 13), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.TRUE, null, Boolean.FALSE, null, Boolean.FALSE, null}));
		...
		ComboBox m_cmbFormTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1026), new Integer(anchoringHelper29.getX()), new Integer(anchoringHelper29.getY()), new Integer(anchoringHelper29.getWidth()), new Integer(anchoringHelper29.getHeight()), new Integer(startTabIndex.intValue() + 5), ControlState.DISABLED, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT ,Boolean.TRUE, Boolean.TRUE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
		...
		ComboBox m_cmbRouteTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1027), new Integer(anchoringHelper30.getX()), new Integer(anchoringHelper30.getY()), new Integer(anchoringHelper30.getWidth()), new Integer(anchoringHelper30.getHeight()), new Integer(startTabIndex.intValue() + 6), ControlState.DISABLED, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPRIGHT ,Boolean.TRUE, Boolean.TRUE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
		...
		ComboBox m_cmbDoseUnitTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1028), new Integer(anchoringHelper31.getX()), new Integer(anchoringHelper31.getY()), new Integer(anchoringHelper31.getWidth()), new Integer(anchoringHelper31.getHeight()), new Integer(startTabIndex.intValue() + 8), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPRIGHT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
		...
		super.addControl(factory.getControl(DecimalBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1032), new Integer(anchoringHelper35.getX()), new Integer(anchoringHelper35.getY()), new Integer(anchoringHelper35.getWidth()), new Integer(anchoringHelper35.getHeight()), new Integer(startTabIndex.intValue() + 7), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT,Boolean.TRUE, Boolean.TRUE, Boolean.FALSE, new Integer(6), new Integer(2), "The decimal value is invalid. A valid value can have up to 4 digits and up to 2 decimals.", null, Boolean.FALSE}));
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[159] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeMedsSthkDialog.__internal_x_context__EditedRecord_" + componentIdentifier, "BO-1099100016-ID", "ID_TTAMedicationDetail");
			fields[160] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeMedsSthkDialog.__internal_x_context__EditedRecord_" + componentIdentifier, "BO-1099100016-OTHERMEDICATIONTEXT", "OtherMedicationText");
			fields[161] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeMedsSthkDialog.__internal_x_context__EditedRecord_" + componentIdentifier, "BO-1099100016-DOSEVALUE", "DoseValue");
			fields[162] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeMedsSthkDialog.__internal_x_context__EditedRecord_" + componentIdentifier, "BO-1099100016-DOSEUNIT", "DoseUnit");
			fields[163] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeMedsSthkDialog.__internal_x_context__EditedRecord_" + componentIdentifier, "BO-1099100016-FORM", "Form");
			fields[164] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeMedsSthkDialog.__internal_x_context__EditedRecord_" + componentIdentifier, "BO-1099100016-ROUTE", "Route");
			fields[165] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeMedsSthkDialog.__internal_x_context__EditedRecord_" + componentIdentifier, "BO-1099100016-FREQUENCYVALUE", "FrequencyValue");
			fields[166] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeMedsSthkDialog.__internal_x_context__EditedRecord_" + componentIdentifier, "BO-1099100016-FREQUENCYUNIT", "FrequencyUnit");
			fields[167] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeMedsSthkDialog.__internal_x_context__EditedRecord_" + componentIdentifier, "BO-1099100016-COMMENCEDDATE", "CommencedDate");
			fields[168] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeMedsSthkDialog.__internal_x_context__EditedRecord_" + componentIdentifier, "BO-1099100016-DURATIONVALUE", "DurationValue");
			fields[169] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeMedsSthkDialog.__internal_x_context__EditedRecord_" + componentIdentifier, "BO-1099100016-DURATIONUNIT", "DurationUnit");
			fields[170] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeMedsSthkDialog.__internal_x_context__EditedRecord_" + componentIdentifier, "BO-1099100016-CLINICALCOMMENTSFORPHARMACY", "ClinicalCommentsForPharmacy");
			fields[171] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeMedsSthkDialog.__internal_x_context__EditedRecord_" + componentIdentifier, "BO-1099100016-MEDICATIONINSTRUCTIONSFORPATIENT", "MedicationInstructionsForPatient");
			fields[172] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeMedsSthkDialog.__internal_x_context__EditedRecord_" + componentIdentifier, "BO-1099100016-PRESCRIBERCONTACTED", "PrescriberContacted");
			fields[173] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeMedsSthkDialog.__internal_x_context__EditedRecord_" + componentIdentifier, "BO-1099100016-UNITTEXT", "UnitText");
			return fields;
		}
