...
import ims.clinical.vo.AuthoringClinicalNotesSearchCriteriaVo;
import ims.clinical.vo.UserClinicalNotesSearchCriteriaVo;
...
public class Logic extends BaseLogic
{
	...
	private void open()
	{
		...
		//WDEV-19389 
		if (form.getGlobalContext().Clinical.getAuthoringClinicalNotesSearchCriteriaIsNotNull())
		{
	...
	private AuthoringClinicalNotesSearchCriteriaVo getAuthoringSearchCriteria()
	{
		AuthoringClinicalNotesSearchCriteriaVo searchCriteria = new AuthoringClinicalNotesSearchCriteriaVo();
		
		searchCriteria.setHCP(form.lyrSearcFilter().tabRecordingHcp().qmbHcpRec().getValue());
		searchCriteria.setStatus(form.lyrSearcFilter().tabRecordingHcp().cmbHcpStatus().getValue());
		searchCriteria.setRequiringValidation(form.lyrSearcFilter().tabRecordingHcp().chkAuthValidation().getValue());
		searchCriteria.setFromDate(form.lyrSearcFilter().tabRecordingHcp().dteHcpFrom().getValue());
		searchCriteria.setTodate(form.lyrSearcFilter().tabRecordingHcp().dteHcpTo().getValue());
		
		return searchCriteria;
	}
	
	private void setAuthoringSearchCriteria(AuthoringClinicalNotesSearchCriteriaVo authoringClinicalNotesSearchCriteriaVo) 
	{
		if (authoringClinicalNotesSearchCriteriaVo.getHCPIsNotNull())
		{
			form.lyrSearcFilter().tabRecordingHcp().qmbHcpRec().newRow(authoringClinicalNotesSearchCriteriaVo.getHCP(), authoringClinicalNotesSearchCriteriaVo.getHCP().toString());
			form.lyrSearcFilter().tabRecordingHcp().qmbHcpRec().setValue(authoringClinicalNotesSearchCriteriaVo.getHCP());
		}
		form.lyrSearcFilter().tabRecordingHcp().cmbHcpStatus().setValue(authoringClinicalNotesSearchCriteriaVo.getStatus());
		form.lyrSearcFilter().tabRecordingHcp().dteHcpFrom().setValue(authoringClinicalNotesSearchCriteriaVo.getFromDate());
		form.lyrSearcFilter().tabRecordingHcp().dteHcpTo().setValue(authoringClinicalNotesSearchCriteriaVo.getTodate());
		form.lyrSearcFilter().tabRecordingHcp().chkAuthValidation().setValue(Boolean.TRUE.equals(authoringClinicalNotesSearchCriteriaVo.getRequiringValidation()) ? true : false);		
	}
	
	private UserClinicalNotesSearchCriteriaVo getUserSearchCriteria()
	{
		UserClinicalNotesSearchCriteriaVo searchCriteria = new UserClinicalNotesSearchCriteriaVo();
		
		searchCriteria.setUser(form.lyrSearcFilter().tabRecordingUser().qmbUserRec().getValue());
		searchCriteria.setRequiringValidation(Boolean.TRUE.equals(form.lyrSearcFilter().tabRecordingUser().chkRecValidation().getValue()) ? true : false);
		searchCriteria.setFromDate(form.lyrSearcFilter().tabRecordingUser().dteUserFrom().getValue());
		searchCriteria.setTodate(form.lyrSearcFilter().tabRecordingUser().dteUserTo().getValue());
		
		return searchCriteria;
	}

	private void setUseSearchCriteria(UserClinicalNotesSearchCriteriaVo userClinicalNotesSearchCriteria)
	{
		if (userClinicalNotesSearchCriteria.getUserIsNotNull())
		{
			form.lyrSearcFilter().tabRecordingUser().qmbUserRec().newRow(userClinicalNotesSearchCriteria.getUser(), userClinicalNotesSearchCriteria.getUser().toString());
			form.lyrSearcFilter().tabRecordingUser().qmbUserRec().setValue(userClinicalNotesSearchCriteria.getUser());
		}
		form.lyrSearcFilter().tabRecordingUser().chkRecValidation().setValue(userClinicalNotesSearchCriteria.getRequiringValidation());
		form.lyrSearcFilter().tabRecordingUser().dteUserFrom().setValue(userClinicalNotesSearchCriteria.getFromDate());
		form.lyrSearcFilter().tabRecordingUser().dteUserTo().setValue(userClinicalNotesSearchCriteria.getTodate());
	}
	...
	{
		clearTabsControls();
		form.getGlobalContext().Clinical.setAuthoringClinicalNotesSearchCriteria(null); //WDEV-19389 
	}

	protected void onImbClearUserClick() throws PresentationLogicException
	{
		clearTabsControls();
		form.getGlobalContext().Clinical.setUserClinicalNotesSearchCriteria(null); //WDEV-19389 
	}
	...
	protected void onImbSearchHcpClick() throws PresentationLogicException
	{
		...
		{
			search(TABHCP);
			form.getGlobalContext().Clinical.setAuthoringClinicalNotesSearchCriteria(getAuthoringSearchCriteria());//WDEV-19389 
		}
	}
	...
	protected void onImbSearchUserClick() throws PresentationLogicException
	{
		...
		{
			search(TABUSER);
			form.getGlobalContext().Clinical.setUserClinicalNotesSearchCriteria(getUserSearchCriteria());//WDEV-19389 
		}
	}
