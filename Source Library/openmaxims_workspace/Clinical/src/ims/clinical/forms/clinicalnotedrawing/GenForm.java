...
public class GenForm extends FormBridge
{
	...
	public static class lyrTabsLayer extends Layer
	{
		...
		public static class tabClinicalNotesContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				ims.framework.FormUiLogic m_customControlClinicalNotesAuthoiringForm = loader.loadComponent(102228, appForm, startControlID * 10 + 2000, anchoringHelper8.getSize(), instance2, startTabIndex.intValue() + 9, skipContextValidation);
				//ims.framework.Control m_customControlClinicalNotesAuthoiringControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1008), new Integer(8), new Integer(8), new Integer(368), new Integer(64), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFT, new Integer(startTabIndex.intValue() + 9), m_customControlClinicalNotesAuthoiringForm, instance2 } );
				...
				super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1018), new Integer(anchoringHelper17.getX()), new Integer(anchoringHelper17.getY()), new Integer(anchoringHelper17.getWidth()), new Integer(anchoringHelper17.getHeight()), new Integer(startTabIndex.intValue() + 31), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Close", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
				...
				super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1020), new Integer(anchoringHelper19.getX()), new Integer(anchoringHelper19.getY()), new Integer(anchoringHelper19.getWidth()), new Integer(anchoringHelper19.getHeight()), new Integer(startTabIndex.intValue() + 7), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "New", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
				...
				super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1023), new Integer(anchoringHelper22.getX()), new Integer(anchoringHelper22.getY()), new Integer(anchoringHelper22.getWidth()), new Integer(anchoringHelper22.getHeight()), new Integer(startTabIndex.intValue() + 19), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPBOTTOMRIGHT,Boolean.TRUE, new Integer(4000), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
				...
				super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1024), new Integer(anchoringHelper23.getX()), new Integer(anchoringHelper23.getY()), new Integer(anchoringHelper23.getWidth()), new Integer(anchoringHelper23.getHeight()), new Integer(startTabIndex.intValue() + 21), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT,Boolean.TRUE, new Integer(4000), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
				...
				super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1026), new Integer(anchoringHelper25.getX()), new Integer(anchoringHelper25.getY()), new Integer(anchoringHelper25.getWidth()), new Integer(anchoringHelper25.getHeight()), new Integer(startTabIndex.intValue() + 15), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL,Boolean.TRUE, new Integer(4000), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
				...
				super.addControl(factory.getControl(DateTimeControl.class, new Object[] { control, new Integer(startControlID.intValue() + 1027), new Integer(anchoringHelper26.getX()), new Integer(anchoringHelper26.getY()), new Integer(anchoringHelper26.getWidth()), new Integer(anchoringHelper26.getHeight()), new Integer(startTabIndex.intValue() + 13), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT,Boolean.TRUE, null, Boolean.FALSE, null, Boolean.FALSE, null}));
				...
				ComboBox m_cmbStatusIPTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1029), new Integer(anchoringHelper28.getX()), new Integer(anchoringHelper28.getY()), new Integer(anchoringHelper28.getWidth()), new Integer(anchoringHelper28.getHeight()), new Integer(startTabIndex.intValue() + 22), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.TRUE, new Integer(-1)});
				...
				ComboBox m_qmbTransIPTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1030), new Integer(anchoringHelper29.getX()), new Integer(anchoringHelper29.getY()), new Integer(anchoringHelper29.getWidth()), new Integer(anchoringHelper29.getHeight()), new Integer(startTabIndex.intValue() + 12), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT,Boolean.TRUE, Boolean.TRUE, SortOrder.NONE, Boolean.TRUE, new Integer(1), null, Boolean.FALSE, new Integer(-1), Boolean.FALSE});
				...
				super.addControl(factory.getControl(Link.class, new Object[] { control, new Integer(startControlID.intValue() + 1035), new Integer(anchoringHelper34.getX()), new Integer(anchoringHelper34.getY()), new Integer(anchoringHelper34.getWidth()), new Integer(anchoringHelper34.getHeight()), new Integer(startTabIndex.intValue() + 18), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT,"Diagnosis / Complications", Boolean.FALSE, null}));
				...
				super.addControl(factory.getControl(Link.class, new Object[] { control, new Integer(startControlID.intValue() + 1036), new Integer(anchoringHelper35.getX()), new Integer(anchoringHelper35.getY()), new Integer(anchoringHelper35.getWidth()), new Integer(anchoringHelper35.getHeight()), new Integer(startTabIndex.intValue() + 20), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT,"Procedures", Boolean.FALSE, null}));
			}
		...
		public static class tabOPDNoteContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				ims.framework.FormUiLogic m_customControlOPAuthoringForm = loader.loadComponent(102228, appForm, startControlID * 10 + 4000, anchoringHelper37.getSize(), instance2, startTabIndex.intValue() + 27, skipContextValidation);
				//ims.framework.Control m_customControlOPAuthoringControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1039), new Integer(0), new Integer(8), new Integer(424), new Integer(56), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFT, new Integer(startTabIndex.intValue() + 27), m_customControlOPAuthoringForm, instance2 } );
				...
				super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1051), new Integer(anchoringHelper48.getX()), new Integer(anchoringHelper48.getY()), new Integer(anchoringHelper48.getWidth()), new Integer(anchoringHelper48.getHeight()), new Integer(startTabIndex.intValue() + 45), ControlState.HIDDEN, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Save", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
				...
				super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1053), new Integer(anchoringHelper50.getX()), new Integer(anchoringHelper50.getY()), new Integer(anchoringHelper50.getWidth()), new Integer(anchoringHelper50.getHeight()), new Integer(startTabIndex.intValue() + 26), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Edit", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
				...
				super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1054), new Integer(anchoringHelper51.getX()), new Integer(anchoringHelper51.getY()), new Integer(anchoringHelper51.getWidth()), new Integer(anchoringHelper51.getHeight()), new Integer(startTabIndex.intValue() + 25), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "New", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
				...
				super.addControl(factory.getControl(DateTimeControl.class, new Object[] { control, new Integer(startControlID.intValue() + 1055), new Integer(anchoringHelper52.getX()), new Integer(anchoringHelper52.getY()), new Integer(anchoringHelper52.getWidth()), new Integer(anchoringHelper52.getHeight()), new Integer(startTabIndex.intValue() + 32), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT,Boolean.TRUE, null, Boolean.FALSE, null, Boolean.FALSE, null}));
				...
				ComboBox m_cmbStatusOPTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1057), new Integer(anchoringHelper54.getX()), new Integer(anchoringHelper54.getY()), new Integer(anchoringHelper54.getWidth()), new Integer(anchoringHelper54.getHeight()), new Integer(startTabIndex.intValue() + 43), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.TRUE, new Integer(-1)});
				...
				ComboBox m_cmbFollowUpTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1058), new Integer(anchoringHelper55.getX()), new Integer(anchoringHelper55.getY()), new Integer(anchoringHelper55.getWidth()), new Integer(anchoringHelper55.getHeight()), new Integer(startTabIndex.intValue() + 39), ControlState.DISABLED, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,Boolean.TRUE, Boolean.TRUE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
				...
				ComboBox m_cmbReviewTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1059), new Integer(anchoringHelper56.getX()), new Integer(anchoringHelper56.getY()), new Integer(anchoringHelper56.getWidth()), new Integer(anchoringHelper56.getHeight()), new Integer(startTabIndex.intValue() + 41), ControlState.DISABLED, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
				...
				ComboBox m_qmbTransByOPTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1060), new Integer(anchoringHelper57.getX()), new Integer(anchoringHelper57.getY()), new Integer(anchoringHelper57.getWidth()), new Integer(anchoringHelper57.getHeight()), new Integer(startTabIndex.intValue() + 30), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT,Boolean.TRUE, Boolean.TRUE, SortOrder.NONE, Boolean.TRUE, new Integer(1), null, Boolean.FALSE, new Integer(-1), Boolean.FALSE});
				...
				super.addControl(factory.getControl(IntBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1063), new Integer(anchoringHelper60.getX()), new Integer(anchoringHelper60.getY()), new Integer(anchoringHelper60.getWidth()), new Integer(anchoringHelper60.getHeight()), new Integer(startTabIndex.intValue() + 40), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.TRUE, Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, new Integer(9)}));
				...
				super.addControl(factory.getControl(Link.class, new Object[] { control, new Integer(startControlID.intValue() + 1064), new Integer(anchoringHelper61.getX()), new Integer(anchoringHelper61.getY()), new Integer(anchoringHelper61.getWidth()), new Integer(anchoringHelper61.getHeight()), new Integer(startTabIndex.intValue() + 37), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT,"Medication", Boolean.FALSE, null}));
				...
				super.addControl(factory.getControl(Link.class, new Object[] { control, new Integer(startControlID.intValue() + 1066), new Integer(anchoringHelper63.getX()), new Integer(anchoringHelper63.getY()), new Integer(anchoringHelper63.getWidth()), new Integer(anchoringHelper63.getHeight()), new Integer(startTabIndex.intValue() + 34), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT,"Diagnosis / Complications", Boolean.FALSE, null}));
				...
				super.addControl(factory.getControl(Link.class, new Object[] { control, new Integer(startControlID.intValue() + 1067), new Integer(anchoringHelper64.getX()), new Integer(anchoringHelper64.getY()), new Integer(anchoringHelper64.getWidth()), new Integer(anchoringHelper64.getHeight()), new Integer(startTabIndex.intValue() + 36), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT,"Procedures", Boolean.FALSE, null}));
				...
				super.addControl(factory.getControl(RichTextControl.class, new Object[] { control, new Integer(startControlID.intValue() + 1068), new Integer(anchoringHelper65.getX()), new Integer(anchoringHelper65.getY()), new Integer(anchoringHelper65.getWidth()), new Integer(anchoringHelper65.getHeight()), new Integer(startTabIndex.intValue() + 42), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, Boolean.FALSE, Boolean.FALSE, new Integer(4000)} ));
				...
				super.addControl(factory.getControl(RichTextControl.class, new Object[] { control, new Integer(startControlID.intValue() + 1069), new Integer(anchoringHelper66.getX()), new Integer(anchoringHelper66.getY()), new Integer(anchoringHelper66.getWidth()), new Integer(anchoringHelper66.getHeight()), new Integer(startTabIndex.intValue() + 38), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT, Boolean.FALSE, Boolean.FALSE, new Integer(4000)} ));
				...
				super.addControl(factory.getControl(RichTextControl.class, new Object[] { control, new Integer(startControlID.intValue() + 1070), new Integer(anchoringHelper67.getX()), new Integer(anchoringHelper67.getY()), new Integer(anchoringHelper67.getWidth()), new Integer(anchoringHelper67.getHeight()), new Integer(startTabIndex.intValue() + 35), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT, Boolean.FALSE, Boolean.FALSE, new Integer(4000)} ));
			}
		...
		public static class tabDrawingContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1077), new Integer(anchoringHelper72.getX()), new Integer(anchoringHelper72.getY()), new Integer(anchoringHelper72.getWidth()), new Integer(anchoringHelper72.getHeight()), new Integer(startTabIndex.intValue() + 47), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Edit", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
				...
				super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1078), new Integer(anchoringHelper73.getX()), new Integer(anchoringHelper73.getY()), new Integer(anchoringHelper73.getWidth()), new Integer(anchoringHelper73.getHeight()), new Integer(startTabIndex.intValue() + 46), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "New", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
				...
				super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1079), new Integer(anchoringHelper74.getX()), new Integer(anchoringHelper74.getY()), new Integer(anchoringHelper74.getWidth()), new Integer(anchoringHelper74.getHeight()), new Integer(startTabIndex.intValue() + 55), ControlState.HIDDEN, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Cancel", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
				...
				ComboBox m_cmbGraphicAdnotationImageTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1081), new Integer(anchoringHelper76.getX()), new Integer(anchoringHelper76.getY()), new Integer(anchoringHelper76.getWidth()), new Integer(anchoringHelper76.getHeight()), new Integer(startTabIndex.intValue() + 51), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT ,Boolean.TRUE, Boolean.TRUE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.TRUE, new Integer(-1)});
		...
		public static class tabAssessmentContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				super.addControl(factory.getControl(DynamicGrid.class, new Object[] { control, new Integer(startControlID.intValue() + 1083), new Integer(anchoringHelper78.getX()), new Integer(anchoringHelper78.getY()), new Integer(anchoringHelper78.getWidth()), new Integer(anchoringHelper78.getHeight()), new Integer(startTabIndex.intValue() + 57), ControlState.EDITABLE, ControlState.EDITABLE, ims.framework.enumerations.ControlAnchoring.ALL, contextMenus.contextMenuPatientAssessment, Boolean.FALSE, Boolean.FALSE, Boolean.TRUE}));
			}
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, "_cv_COE.SkinBodyChart.SelectedSkinAssessment", "BO-1003100002-ID", "ID_Assessment");
			fields[145] = new ims.framework.ReportField(this.context, "_cv_COE.SkinBodyChart.SelectedSkinAssessment", "BO-1003100002-DATETIMEINITIATED", "DateTimeInitiated");
			fields[146] = new ims.framework.ReportField(this.context, "_cv_COE.SkinBodyChart.SelectedSkinAssessment", "BO-1003100002-CLINICALCONTACT", "ClinicalContact");
			fields[147] = new ims.framework.ReportField(this.context, "_cv_COE.SkinBodyChart.SelectedSkinAssessment", "BO-1003100002-CARECONTEXT", "CareContext");
			fields[148] = new ims.framework.ReportField(this.context, "_cv_COE.SkinBodyChart.SelectedSkinAssessment", "BO-1016100003-ISSKININTACT", "IsSkinIntact");
			fields[149] = new ims.framework.ReportField(this.context, "_cv_COE.SkinBodyChart.SkinAssessmentVO", "BO-1003100002-ID", "ID_Assessment");
			fields[150] = new ims.framework.ReportField(this.context, "_cv_COE.SkinBodyChart.SkinAssessmentVO", "BO-1003100002-DATETIMEINITIATED", "DateTimeInitiated");
			fields[151] = new ims.framework.ReportField(this.context, "_cv_COE.SkinBodyChart.SkinAssessmentVO", "BO-1003100002-CLINICALCONTACT", "ClinicalContact");
			fields[152] = new ims.framework.ReportField(this.context, "_cv_COE.SkinBodyChart.SkinAssessmentVO", "BO-1003100002-CARECONTEXT", "CareContext");
			fields[153] = new ims.framework.ReportField(this.context, "_cv_COE.SkinBodyChart.SkinAssessmentVO", "BO-1016100003-ISSKININTACT", "IsSkinIntact");
			fields[154] = new ims.framework.ReportField(this.context, "_cv_COE.SkinBodyChart.FindingsVO", "BO-1016100005-ID", "ID_SkinAssessmentFindings");
			fields[155] = new ims.framework.ReportField(this.context, "_cv_COE.SkinBodyChart.FindingsVO", "BO-1016100005-WOUNDTYPE", "WoundType");
			fields[156] = new ims.framework.ReportField(this.context, "_cv_COE.SkinBodyChart.FindingsVO", "BO-1016100005-SITEIMAGE", "SiteImage");
			fields[157] = new ims.framework.ReportField(this.context, "_cv_COE.SkinBodyChart.FindingsVO", "BO-1016100005-SITENAME", "SiteName");
			fields[158] = new ims.framework.ReportField(this.context, "_cv_COE.SkinBodyChart.FindingsVO", "BO-1016100005-SITEDETAILS", "SiteDetails");
			fields[159] = new ims.framework.ReportField(this.context, "_cv_COE.SkinBodyChart.FindingsVO", "BO-1016100005-HOWLONGISITPRESENT", "HowLongIsItPresent");
			fields[160] = new ims.framework.ReportField(this.context, "_cv_COE.SkinBodyChart.FindingsVO", "BO-1016100005-PRESSURESOREGRADE", "PressureSoreGrade");
			fields[161] = new ims.framework.ReportField(this.context, "_cv_COE.SkinBodyChart.FindingsVO", "BO-1016100005-LENGTH", "Length");
			fields[162] = new ims.framework.ReportField(this.context, "_cv_COE.SkinBodyChart.FindingsVO", "BO-1016100005-WIDTH", "Width");
			fields[163] = new ims.framework.ReportField(this.context, "_cv_COE.SkinBodyChart.FindingsVO", "BO-1016100005-DEPTH", "Depth");
			fields[164] = new ims.framework.ReportField(this.context, "_cv_COE.SkinBodyChart.FindingsVO", "BO-1016100005-WOUNDBED", "WoundBed");
			fields[165] = new ims.framework.ReportField(this.context, "_cv_COE.SkinBodyChart.FindingsVO", "BO-1016100005-SURROUNDINGSKIN", "SurroundingSkin");
			fields[166] = new ims.framework.ReportField(this.context, "_cv_COE.SkinBodyChart.FindingsVO", "BO-1016100005-EXUDATEAMOUNT", "ExudateAmount");
			fields[167] = new ims.framework.ReportField(this.context, "_cv_COE.SkinBodyChart.FindingsVO", "BO-1016100005-EXUDATETYPE", "ExudateType");
			fields[168] = new ims.framework.ReportField(this.context, "_cv_COE.SkinBodyChart.FindingsVO", "BO-1016100005-ODOUR", "Odour");
			fields[169] = new ims.framework.ReportField(this.context, "_cv_COE.SkinBodyChart.FindingsVO", "BO-1016100005-PAIN", "Pain");
			fields[170] = new ims.framework.ReportField(this.context, "_cv_COE.SkinBodyChart.FindingsVO", "BO-1016100005-INFECTIONSUSPECTED", "InfectionSuspected");
			fields[171] = new ims.framework.ReportField(this.context, "_cv_COE.SkinBodyChart.FindingsVO", "BO-1016100005-SWABTAKEN", "SwabTaken");
			fields[172] = new ims.framework.ReportField(this.context, "_cv_COE.SkinBodyChart.FindingsVO", "BO-1016100005-WOUNDTRACED", "WoundTraced");
			fields[173] = new ims.framework.ReportField(this.context, "_cv_COE.SkinBodyChart.FindingsVO", "BO-1016100005-CLEANSEDWITH", "CleansedWith");
			fields[174] = new ims.framework.ReportField(this.context, "_cv_COE.SkinBodyChart.FindingsVO", "BO-1016100005-PRIMARYDRESSING", "PrimaryDressing");
			fields[175] = new ims.framework.ReportField(this.context, "_cv_COE.SkinBodyChart.FindingsVO", "BO-1016100005-SECONDARYDRESSING", "SecondaryDressing");
			fields[176] = new ims.framework.ReportField(this.context, "_cv_COE.SkinBodyChart.FindingsVO", "BO-1016100005-FREQUENCYOFCHANGE", "FrequencyOfChange");
			fields[177] = new ims.framework.ReportField(this.context, "_cv_COE.SkinBodyChart.FindingsVO", "BO-1016100005-COMMENT", "Comment");
			fields[178] = new ims.framework.ReportField(this.context, "_cv_COE.SkinBodyChart.FindingsVO", "BO-1016100005-ISDISCONTINUEDASSESS", "IsDiscontinuedAssess");
			fields[179] = new ims.framework.ReportField(this.context, "_cv_COE.SkinBodyChart.FindingsVO", "BO-1016100005-ISCONTINUEDASSESSMENT", "IsContinuedAssessment");
			fields[180] = new ims.framework.ReportField(this.context, "_cv_COE.SkinBodyChart.ReadOnlyAssessment", "BO-1003100002-ID", "ID_Assessment");
			fields[181] = new ims.framework.ReportField(this.context, "_cv_COE.SkinBodyChart.ReadOnlyAssessment", "BO-1003100002-DATETIMEINITIATED", "DateTimeInitiated");
			fields[182] = new ims.framework.ReportField(this.context, "_cv_COE.SkinBodyChart.ReadOnlyAssessment", "BO-1003100002-CLINICALCONTACT", "ClinicalContact");
			fields[183] = new ims.framework.ReportField(this.context, "_cv_COE.SkinBodyChart.ReadOnlyAssessment", "BO-1003100002-CARECONTEXT", "CareContext");
			fields[184] = new ims.framework.ReportField(this.context, "_cv_COE.SkinBodyChart.ReadOnlyAssessment", "BO-1016100003-ISSKININTACT", "IsSkinIntact");
			fields[185] = new ims.framework.ReportField(this.context, "_cv_Nursing.AssessmentComponent", "BO-1015100001-ID", "ID_AssessmentComponent");
			fields[186] = new ims.framework.ReportField(this.context, "_cv_Nursing.AssessmentComponent", "BO-1015100001-ISCOMPLETE", "IsComplete");
			fields[187] = new ims.framework.ReportField(this.context, "_cv_Nursing.AssessmentComponent", "BO-1015100001-COPY", "Copy");
			fields[188] = new ims.framework.ReportField(this.context, "_cv_Nursing.AssessmentComponent", "BO-1015100001-COMPONENTTYPE", "ComponentType");
			fields[189] = new ims.framework.ReportField(this.context, "_cv_Nursing.AssessmentHeaderInfo", "BO-1003100002-ID", "ID_Assessment");
			fields[190] = new ims.framework.ReportField(this.context, "_cv_Nursing.AssessmentHeaderInfo", "BO-1003100002-DATETIMEINITIATED", "DateTimeInitiated");
			fields[191] = new ims.framework.ReportField(this.context, "_cv_Nursing.AssessmentHeaderInfo", "BO-1003100002-CLINICALCONTACT", "ClinicalContact");
			fields[192] = new ims.framework.ReportField(this.context, "_cv_Nursing.AssessmentHeaderInfo", "BO-1003100002-CARECONTEXT", "CareContext");
			fields[193] = new ims.framework.ReportField(this.context, "_cv_Nursing.AssessmentHeaderInfo", "BO-1015100000-ASSESSMENTTYPE", "AssessmentType");
			fields[194] = new ims.framework.ReportField(this.context, "_cv_Nursing.AssessmentHeaderInfo", "BO-1015100000-ASSESSMENTSTATUS", "AssessmentStatus");
			fields[195] = new ims.framework.ReportField(this.context, "_cv_Nursing.AssessmentHeaderInfo", "BO-1015100000-DATETIMECOMPLETE", "DateTimeComplete");
			fields[196] = new ims.framework.ReportField(this.context, "_cv_Clinical.UnsavedSOAPINformation", "BO-1072100036-ID", "ID_SoapNote");
			fields[197] = new ims.framework.ReportField(this.context, "_cv_Clinical.UnsavedSOAPINformation", "BO-1072100036-SUBJECTIVENOTE", "SubjectiveNote");
			fields[198] = new ims.framework.ReportField(this.context, "_cv_Clinical.UnsavedSOAPINformation", "BO-1072100036-OBJECTIVENOTE", "ObjectiveNote");
			fields[199] = new ims.framework.ReportField(this.context, "_cv_Clinical.UnsavedSOAPINformation", "BO-1072100036-ANALYSISNOTE", "AnalysisNote");
			fields[200] = new ims.framework.ReportField(this.context, "_cv_Clinical.UnsavedSOAPINformation", "BO-1072100036-PLANNOTE", "PlanNote");
			fields[201] = new ims.framework.ReportField(this.context, "_cv_Clinical.UnsavedSOAPINformation", "BO-1072100036-CLINICALNOTE", "ClinicalNote");
			fields[202] = new ims.framework.ReportField(this.context, "_cv_Clinical.UnsavedSOAPINformation", "BO-1072100036-CARECONTEXT", "CareContext");
			fields[203] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalNotesShort", "BO-1011100000-ID", "ID_ClinicalNotes");
			fields[204] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalNotesShort", "BO-1011100000-CLINICALNOTE", "ClinicalNote");
			fields[205] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalNotesShort", "BO-1011100000-NOTETYPE", "NoteType");
			fields[206] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalNotesShort", "BO-1011100000-DISCIPLINE", "Discipline");
			fields[207] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalNotesShort", "BO-1011100000-CLINICALCONTACT", "ClinicalContact");
			fields[208] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalNotesShort", "BO-1011100000-ISDERIVEDNOTE", "IsDerivedNote");
			fields[209] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalNotesShort", "BO-1011100000-FORREVIEW", "ForReview");
			fields[210] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalNotesShort", "BO-1011100000-FORREVIEWDISCIPLINE", "ForReviewDiscipline");
			fields[211] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalNotesShort", "BO-1011100000-REVIEWINGDATETIME", "ReviewingDateTime");
			fields[212] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalNotesShort", "BO-1011100000-ISCORRECTED", "IsCorrected");
			fields[213] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalNotesShort", "BO-1011100000-ISTRANSCRIBED", "IsTranscribed");
			fields[214] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalNotesShort", "BO-1011100000-SOURCEOFNOTE", "SourceOfNote");
			fields[215] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalNotesShort", "BO-1011100000-RECORDINGDATETIME", "RecordingDateTime");
			fields[216] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalNotesShort", "BO-1011100000-NOTECLASSIFICATION", "NoteClassification");
			fields[217] = new ims.framework.ReportField(this.context, "_cv_Core.UserDefinedObjectSelected", "BO-1028100004-ID", "ID_UserDefinedObject");
			fields[218] = new ims.framework.ReportField(this.context, "_cv_Core.UserDefinedObjectSelected", "BO-1028100004-NAME", "Name");
			fields[219] = new ims.framework.ReportField(this.context, "_cv_Core.UserDefinedObjectSelected", "BO-1028100004-OBJECTTYPE", "ObjectType");
			fields[220] = new ims.framework.ReportField(this.context, "_cv_Core.UserDefinedObjectSelected", "BO-1028100004-ACTIVESTATUS", "ActiveStatus");
			fields[221] = new ims.framework.ReportField(this.context, "_cv_Assessment.PatientUserDefinedObject", "BO-1085100000-ID", "ID_PatientUserDefinedObject");
			fields[222] = new ims.framework.ReportField(this.context, "_cv_Clinical.PatientAssessment.EditedComponent", "BO-1028100005-ID", "ID_UserDefinedObjectComponent");
			fields[223] = new ims.framework.ReportField(this.context, "_cv_Clinical.PatientAssessment.SelectedAssessment", "BO-1003100048-ID", "ID_PatientAssessment");
			fields[224] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ClinicalNoteDrawing.__internal_x_context__ClinicalNotes_" + componentIdentifier, "BO-1011100000-ID", "ID_ClinicalNotes");
			fields[225] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ClinicalNoteDrawing.__internal_x_context__ClinicalNotes_" + componentIdentifier, "BO-1011100000-CLINICALNOTE", "ClinicalNote");
			fields[226] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ClinicalNoteDrawing.__internal_x_context__ClinicalNotes_" + componentIdentifier, "BO-1011100000-NOTETYPE", "NoteType");
			fields[227] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ClinicalNoteDrawing.__internal_x_context__ClinicalNotes_" + componentIdentifier, "BO-1011100000-DISCIPLINE", "Discipline");
			fields[228] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ClinicalNoteDrawing.__internal_x_context__ClinicalNotes_" + componentIdentifier, "BO-1011100000-CLINICALCONTACT", "ClinicalContact");
			fields[229] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ClinicalNoteDrawing.__internal_x_context__ClinicalNotes_" + componentIdentifier, "BO-1011100000-ISDERIVEDNOTE", "IsDerivedNote");
			fields[230] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ClinicalNoteDrawing.__internal_x_context__ClinicalNotes_" + componentIdentifier, "BO-1011100000-FORREVIEW", "ForReview");
			fields[231] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ClinicalNoteDrawing.__internal_x_context__ClinicalNotes_" + componentIdentifier, "BO-1011100000-FORREVIEWDISCIPLINE", "ForReviewDiscipline");
			fields[232] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ClinicalNoteDrawing.__internal_x_context__ClinicalNotes_" + componentIdentifier, "BO-1011100000-REVIEWINGDATETIME", "ReviewingDateTime");
			fields[233] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ClinicalNoteDrawing.__internal_x_context__ClinicalNotes_" + componentIdentifier, "BO-1011100000-ISCORRECTED", "IsCorrected");
			fields[234] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ClinicalNoteDrawing.__internal_x_context__ClinicalNotes_" + componentIdentifier, "BO-1011100000-ISTRANSCRIBED", "IsTranscribed");
			fields[235] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ClinicalNoteDrawing.__internal_x_context__ClinicalNotes_" + componentIdentifier, "BO-1011100000-SOURCEOFNOTE", "SourceOfNote");
			fields[236] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ClinicalNoteDrawing.__internal_x_context__ClinicalNotes_" + componentIdentifier, "BO-1011100000-RECORDINGDATETIME", "RecordingDateTime");
			fields[237] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ClinicalNoteDrawing.__internal_x_context__ClinicalNotes_" + componentIdentifier, "BO-1011100000-INHOSPITALREPORT", "InHospitalReport");
			fields[238] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ClinicalNoteDrawing.__internal_x_context__ClinicalNotes_" + componentIdentifier, "BO-1011100000-CARECONTEXT", "CareContext");
			fields[239] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ClinicalNoteDrawing.__internal_x_context__ClinicalNotes_" + componentIdentifier, "BO-1011100000-NOTECLASSIFICATION", "NoteClassification");
			fields[240] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ClinicalNoteDrawing.__internal_x_context__PreviousSkinAssessment_" + componentIdentifier, "BO-1003100002-ID", "ID_Assessment");
			fields[241] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ClinicalNoteDrawing.__internal_x_context__PreviousSkinAssessment_" + componentIdentifier, "BO-1003100002-DATETIMEINITIATED", "DateTimeInitiated");
			fields[242] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ClinicalNoteDrawing.__internal_x_context__PreviousSkinAssessment_" + componentIdentifier, "BO-1003100002-CLINICALCONTACT", "ClinicalContact");
			fields[243] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ClinicalNoteDrawing.__internal_x_context__PreviousSkinAssessment_" + componentIdentifier, "BO-1003100002-CARECONTEXT", "CareContext");
			fields[244] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ClinicalNoteDrawing.__internal_x_context__PreviousSkinAssessment_" + componentIdentifier, "BO-1016100003-ISSKININTACT", "IsSkinIntact");
			fields[245] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ClinicalNoteDrawing.__internal_x_context__SOAPVo_" + componentIdentifier, "BO-1072100036-ID", "ID_SoapNote");
			fields[246] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ClinicalNoteDrawing.__internal_x_context__SOAPVo_" + componentIdentifier, "BO-1072100036-SUBJECTIVENOTE", "SubjectiveNote");
			fields[247] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ClinicalNoteDrawing.__internal_x_context__SOAPVo_" + componentIdentifier, "BO-1072100036-OBJECTIVENOTE", "ObjectiveNote");
			fields[248] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ClinicalNoteDrawing.__internal_x_context__SOAPVo_" + componentIdentifier, "BO-1072100036-ANALYSISNOTE", "AnalysisNote");
			fields[249] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ClinicalNoteDrawing.__internal_x_context__SOAPVo_" + componentIdentifier, "BO-1072100036-PLANNOTE", "PlanNote");
			fields[250] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ClinicalNoteDrawing.__internal_x_context__SOAPVo_" + componentIdentifier, "BO-1072100036-CLINICALNOTE", "ClinicalNote");
			fields[251] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ClinicalNoteDrawing.__internal_x_context__SOAPVo_" + componentIdentifier, "BO-1072100036-CARECONTEXT", "CareContext");
			fields[252] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ClinicalNoteDrawing.__internal_x_context__SelectedNotingDetailsVo_" + componentIdentifier, "BO-1072100021-ID", "ID_NotingDetails");
			fields[253] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ClinicalNoteDrawing.__internal_x_context__SelectedNotingDetailsVo_" + componentIdentifier, "BO-1072100021-CLINICALCONTACT", "ClinicalContact");
			fields[254] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ClinicalNoteDrawing.__internal_x_context__SelectedNotingDetailsVo_" + componentIdentifier, "BO-1072100021-CARECONTEXT", "CareContext");
			fields[255] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ClinicalNoteDrawing.__internal_x_context__SelectedNotingDetailsVo_" + componentIdentifier, "BO-1072100021-CLINICALNOTE", "ClinicalNote");
			fields[256] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ClinicalNoteDrawing.__internal_x_context__SelectedNotingDetailsVo_" + componentIdentifier, "BO-1072100021-ISWRITTEN", "IsWritten");
			fields[257] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ClinicalNoteDrawing.__internal_x_context__SelectedNotingDetailsVo_" + componentIdentifier, "BO-1072100021-ISDICTATED", "IsDictated");
			fields[258] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ClinicalNoteDrawing.__internal_x_context__SelectedNotingDetailsVo_" + componentIdentifier, "BO-1072100021-ISTYPED", "IsTyped");
			fields[259] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ClinicalNoteDrawing.__internal_x_context__PatientAssessment_" + componentIdentifier, "BO-1003100048-ID", "ID_PatientAssessment");
			fields[260] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ClinicalNoteDrawing.__internal_x_context__PatientAssessment_" + componentIdentifier, "BO-1003100048-STATUS", "Status");
			fields[261] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ClinicalNoteDrawing.__internal_x_context__PatientAssessment_" + componentIdentifier, "BO-1003100048-COMPLETEDDATETIME", "CompletedDateTime");
			fields[262] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ClinicalNoteDrawing.__internal_x_context__PatientAssessment_" + componentIdentifier, "BO-1003100048-STATUSREASON", "StatusReason");
			fields[263] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ClinicalNoteDrawing.__internal_x_context__PatientAssessment_" + componentIdentifier, "BO-1003100048-STATUSREASONTEXT", "StatusReasonText");
			fields[264] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ClinicalNoteDrawing.__internal_x_context__PatientAssessment_" + componentIdentifier, "BO-1003100048-DPPTYPE", "DPPType");
			fields[265] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ClinicalNoteDrawing.__internal_x_context__PatientAssessment_" + componentIdentifier, "BO-1003100048-DPPTYPETEXT", "DPPTypeText");
			fields[266] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ClinicalNoteDrawing.__internal_x_context__PatientAssessment_" + componentIdentifier, "BO-1003100048-ISCURRENTFORTYPE", "IsCurrentForType");
			fields[267] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ClinicalNoteDrawing.__internal_x_context__PatientAssessment_" + componentIdentifier, "BO-1003100048-CLINICALCONTACT", "ClinicalContact");
			fields[268] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ClinicalNoteDrawing.__internal_x_context__PatientAssessment_" + componentIdentifier, "BO-1003100048-CARECONTEXT", "CareContext");
			fields[269] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ClinicalNoteDrawing.__internal_x_context__PatientAssessment_" + componentIdentifier, "BO-1003100048-EPISODEOFCARE", "EpisodeOfCare");
			fields[270] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ClinicalNoteDrawing.__internal_x_context__PatientAssessment_" + componentIdentifier, "BO-1003100048-PATIENT", "Patient");
			fields[271] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ClinicalNoteDrawing.__internal_x_context__PatientAssessment_" + componentIdentifier, "BO-1003100048-SCORE", "Score");
			fields[272] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ClinicalNoteDrawing.__internal_x_context__PatientAssessment_" + componentIdentifier, "BO-1003100048-ISASSESSMENTDOCUMENTSAVED", "IsAssessmentDocumentSaved");
			fields[273] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ClinicalNoteDrawing.__internal_x_context__CurrentAssessment_" + componentIdentifier, "BO-1003100048-ID", "ID_PatientAssessment");
			fields[274] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ClinicalNoteDrawing.__internal_x_context__CurrentAssessment_" + componentIdentifier, "BO-1003100048-STATUS", "Status");
			fields[275] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ClinicalNoteDrawing.__internal_x_context__CurrentAssessment_" + componentIdentifier, "BO-1003100048-COMPLETEDDATETIME", "CompletedDateTime");
			fields[276] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ClinicalNoteDrawing.__internal_x_context__CurrentAssessment_" + componentIdentifier, "BO-1003100048-STATUSREASON", "StatusReason");
			fields[277] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ClinicalNoteDrawing.__internal_x_context__CurrentAssessment_" + componentIdentifier, "BO-1003100048-STATUSREASONTEXT", "StatusReasonText");
			fields[278] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ClinicalNoteDrawing.__internal_x_context__CurrentAssessment_" + componentIdentifier, "BO-1003100048-DPPTYPE", "DPPType");
			fields[279] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ClinicalNoteDrawing.__internal_x_context__CurrentAssessment_" + componentIdentifier, "BO-1003100048-DPPTYPETEXT", "DPPTypeText");
			fields[280] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ClinicalNoteDrawing.__internal_x_context__CurrentAssessment_" + componentIdentifier, "BO-1003100048-ISCURRENTFORTYPE", "IsCurrentForType");
			fields[281] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ClinicalNoteDrawing.__internal_x_context__CurrentAssessment_" + componentIdentifier, "BO-1003100048-CLINICALCONTACT", "ClinicalContact");
			fields[282] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ClinicalNoteDrawing.__internal_x_context__CurrentAssessment_" + componentIdentifier, "BO-1003100048-CARECONTEXT", "CareContext");
			fields[283] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ClinicalNoteDrawing.__internal_x_context__CurrentAssessment_" + componentIdentifier, "BO-1003100048-EPISODEOFCARE", "EpisodeOfCare");
			fields[284] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ClinicalNoteDrawing.__internal_x_context__CurrentAssessment_" + componentIdentifier, "BO-1003100048-PATIENT", "Patient");
			fields[285] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ClinicalNoteDrawing.__internal_x_context__CurrentAssessment_" + componentIdentifier, "BO-1003100048-SCORE", "Score");
			fields[286] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ClinicalNoteDrawing.__internal_x_context__CurrentAssessment_" + componentIdentifier, "BO-1003100048-ISASSESSMENTDOCUMENTSAVED", "IsAssessmentDocumentSaved");
			fields[287] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ClinicalNoteDrawing.__internal_x_context__VoPatientAssessment_" + componentIdentifier, "BO-1003100048-ID", "ID_PatientAssessment");
			fields[288] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ClinicalNoteDrawing.__internal_x_context__VoPatientAssessment_" + componentIdentifier, "BO-1003100048-CLINICALCONTACT", "ClinicalContact");
			fields[289] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ClinicalNoteDrawing.__internal_x_context__VoPatientAssessment_" + componentIdentifier, "BO-1003100048-CARECONTEXT", "CareContext");
			fields[290] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ClinicalNoteDrawing.__internal_x_context__VoPatientAssessment_" + componentIdentifier, "BO-1003100048-STATUS", "Status");
			fields[291] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ClinicalNoteDrawing.__internal_x_context__VoPatientAssessment_" + componentIdentifier, "BO-1003100048-STATUSREASON", "StatusReason");
			fields[292] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ClinicalNoteDrawing.__internal_x_context__VoPatientAssessment_" + componentIdentifier, "BO-1003100048-ISCURRENTFORTYPE", "IsCurrentForType");
			fields[293] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ClinicalNoteDrawing.__internal_x_context__VoPatientAssessment_" + componentIdentifier, "BO-1003100048-DPPTYPE", "DPPType");
			fields[294] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ClinicalNoteDrawing.__internal_x_context__VoPatientAssessment_" + componentIdentifier, "BO-1003100048-COMPLETEDDATETIME", "CompletedDateTime");
			fields[295] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ClinicalNoteDrawing.__internal_x_context__VoPatientAssessment_" + componentIdentifier, "BO-1003100048-EPISODEOFCARE", "EpisodeOfCare");
			fields[296] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ClinicalNoteDrawing.__internal_x_context__VoPatientAssessment_" + componentIdentifier, "BO-1003100048-PATIENT", "Patient");
			fields[297] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ClinicalNoteDrawing.__internal_x_context__CurrentOPNote_" + componentIdentifier, "BO-1072100046-ID", "ID_OutpatientNotesOutcome");
			fields[298] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ClinicalNoteDrawing.__internal_x_context__CurrentOPNote_" + componentIdentifier, "BO-1072100046-INSTRUCTIONNEXTCLINIC", "InstructionNextClinic");
			fields[299] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ClinicalNoteDrawing.__internal_x_context__CurrentOPNote_" + componentIdentifier, "BO-1072100046-OUTCOME", "Outcome");
			fields[300] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ClinicalNoteDrawing.__internal_x_context__CurrentOPNote_" + componentIdentifier, "BO-1072100046-REVIEWIN", "ReviewIn");
			fields[301] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ClinicalNoteDrawing.__internal_x_context__CurrentOPNote_" + componentIdentifier, "BO-1072100046-REVIEWINUNITS", "ReviewinUnits");
			fields[302] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ClinicalNoteDrawing.__internal_x_context__CurrentOPNote_" + componentIdentifier, "BO-1072100046-CARECONTEXT", "CareContext");
			fields[303] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ClinicalNoteDrawing.__internal_x_context__CurrentOPNote_" + componentIdentifier, "BO-1072100046-CLINICALCONTACT", "ClinicalContact");
			return fields;
		}
