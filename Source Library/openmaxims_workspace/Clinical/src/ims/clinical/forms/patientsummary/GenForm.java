...
public class GenForm extends FormBridge
{
	...
	public static class ctnSummaryContainer extends ContainerBridge
	{
		...
		public static class GroupProcedureRadioButton extends RadioButtonBridge
		{
			...
			protected void setContext(Integer startTabIndex, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize)
			{
				...
				control.addButton(0, anchoringHelper1.getX(), anchoringHelper1.getY(), anchoringHelper1.getWidth(), "Performed Procedures", startTabIndex.intValue() + 18);
				...
				control.addButton(1, anchoringHelper2.getX(), anchoringHelper2.getY(), anchoringHelper2.getWidth(), "All", startTabIndex.intValue() + 19);
				...
				control.addButton(2, anchoringHelper3.getX(), anchoringHelper3.getY(), anchoringHelper3.getWidth(), "Planned Procedures", startTabIndex.intValue() + 16);
			}
		...
		public static class GroupDiagnosisRadioButton extends RadioButtonBridge
		{
			...
			protected void setContext(Integer startTabIndex, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize)
			{
				...
				control.addButton(0, anchoringHelper4.getX(), anchoringHelper4.getY(), anchoringHelper4.getWidth(), "All", startTabIndex.intValue() + 14);
				...
				control.addButton(1, anchoringHelper5.getX(), anchoringHelper5.getY(), anchoringHelper5.getWidth(), "Diagnosis", startTabIndex.intValue() + 9);
				...
				control.addButton(2, anchoringHelper6.getX(), anchoringHelper6.getY(), anchoringHelper6.getWidth(), "Problems", startTabIndex.intValue() + 13);
				...
				control.addButton(3, anchoringHelper7.getX(), anchoringHelper7.getY(), anchoringHelper7.getWidth(), "Complications", startTabIndex.intValue() + 11);
			}
		...
		protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
		{
			...
			Grid m_grdDiagnosisTemp = (Grid)factory.getControl(Grid.class, new Object[] { control, new Integer(startControlID.intValue() + 1000), new Integer(anchoringHelper8.getX()), new Integer(anchoringHelper8.getY()), new Integer(anchoringHelper8.getWidth()), new Integer(anchoringHelper8.getHeight()), new Integer(startTabIndex.intValue() + 20), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL,Boolean.TRUE, Boolean.FALSE, new Integer(24), Boolean.TRUE, contextMenus.contextMenuPatSummaryDiagComp, Boolean.FALSE, Boolean.FALSE, new Integer(0), null, Boolean.FALSE, Boolean.TRUE});
			...
			Grid m_grdProcedureTemp = (Grid)factory.getControl(Grid.class, new Object[] { control, new Integer(startControlID.intValue() + 1001), new Integer(anchoringHelper9.getX()), new Integer(anchoringHelper9.getY()), new Integer(anchoringHelper9.getWidth()), new Integer(anchoringHelper9.getHeight()), new Integer(startTabIndex.intValue() + 21), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPBOTTOMRIGHT,Boolean.TRUE, Boolean.FALSE, new Integer(24), Boolean.TRUE, contextMenus.contextMenuPatSummaryProc, Boolean.FALSE, Boolean.FALSE, new Integer(0), null, Boolean.FALSE, Boolean.TRUE});
			...
			super.addControl(factory.getControl(ImageButton.class, new Object[] { control, new Integer(startControlID.intValue() + 1002), new Integer(anchoringHelper10.getX()), new Integer(anchoringHelper10.getY()), new Integer(anchoringHelper10.getWidth()), new Integer(anchoringHelper10.getHeight()), new Integer(startTabIndex.intValue() + 17), ControlState.DISABLED, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.TOPRIGHT, form_images_local.COE.Orange, form_images_local.COE.Orange, null, Boolean.FALSE, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null}));
			...
			super.addControl(factory.getControl(ImageButton.class, new Object[] { control, new Integer(startControlID.intValue() + 1003), new Integer(anchoringHelper11.getX()), new Integer(anchoringHelper11.getY()), new Integer(anchoringHelper11.getWidth()), new Integer(anchoringHelper11.getHeight()), new Integer(startTabIndex.intValue() + 15), ControlState.DISABLED, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.TOPRIGHT, form_images_local.COE.DarkCyan, form_images_local.COE.DarkCyan, null, Boolean.FALSE, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null}));
			...
			super.addControl(factory.getControl(ImageButton.class, new Object[] { control, new Integer(startControlID.intValue() + 1004), new Integer(anchoringHelper12.getX()), new Integer(anchoringHelper12.getY()), new Integer(anchoringHelper12.getWidth()), new Integer(anchoringHelper12.getHeight()), new Integer(startTabIndex.intValue() + 12), ControlState.DISABLED, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFT, form_images_local.COE.BlueViolet, form_images_local.COE.BlueViolet, null, Boolean.FALSE, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null}));
			...
			super.addControl(factory.getControl(ImageButton.class, new Object[] { control, new Integer(startControlID.intValue() + 1005), new Integer(anchoringHelper13.getX()), new Integer(anchoringHelper13.getY()), new Integer(anchoringHelper13.getWidth()), new Integer(anchoringHelper13.getHeight()), new Integer(startTabIndex.intValue() + 10), ControlState.DISABLED, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFT, form_images_local.COE.LightSkyBlue, form_images_local.COE.LightSkyBlue, null, Boolean.FALSE, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null}));
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1013), new Integer(anchoringHelper19.getX()), new Integer(anchoringHelper19.getY()), new Integer(anchoringHelper19.getWidth()), new Integer(anchoringHelper19.getHeight()), new Integer(startTabIndex.intValue() + 24), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "New ICP", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1014), new Integer(anchoringHelper20.getX()), new Integer(anchoringHelper20.getY()), new Integer(anchoringHelper20.getWidth()), new Integer(anchoringHelper20.getHeight()), new Integer(startTabIndex.intValue() + 23), ControlState.HIDDEN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Search Workflow ID", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1015), new Integer(anchoringHelper21.getX()), new Integer(anchoringHelper21.getY()), new Integer(anchoringHelper21.getWidth()), new Integer(anchoringHelper21.getHeight()), new Integer(startTabIndex.intValue() + 22), ControlState.HIDDEN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT,Boolean.FALSE, new Integer(0), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
		...
		Grid m_grdListTemp = (Grid)factory.getControl(Grid.class, new Object[] { control, new Integer(startControlID.intValue() + 1020), new Integer(anchoringHelper26.getX()), new Integer(anchoringHelper26.getY()), new Integer(anchoringHelper26.getWidth()), new Integer(anchoringHelper26.getHeight()), new Integer(startTabIndex.intValue() + 7), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL,Boolean.TRUE, Boolean.TRUE, new Integer(24), Boolean.FALSE, contextMenus.contextMenuClinicalContactsList, Boolean.FALSE, Boolean.FALSE, new Integer(0), null, Boolean.TRUE, Boolean.TRUE});
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, "_cv_Clinical.PatientSummary.CareSpell", "BO-1004100017-ID", "ID_CareSpell");
			fields[145] = new ims.framework.ReportField(this.context, "_cv_Clinical.PatientSummary.CareSpell", "BO-1004100017-STARTDATE", "StartDate");
			fields[146] = new ims.framework.ReportField(this.context, "_cv_Clinical.PatientSummary.CareSpell", "BO-1004100017-ENDDATE", "EndDate");
			fields[147] = new ims.framework.ReportField(this.context, "_cv_Clinical.PatientSummary.CareSpell", "BO-1004100017-PATIENT", "Patient");
			fields[148] = new ims.framework.ReportField(this.context, "_cv_Clinical.UnsavedSOAPINformation", "BO-1072100036-ID", "ID_SoapNote");
			fields[149] = new ims.framework.ReportField(this.context, "_cv_Clinical.UnsavedSOAPINformation", "BO-1072100036-SUBJECTIVENOTE", "SubjectiveNote");
			fields[150] = new ims.framework.ReportField(this.context, "_cv_Clinical.UnsavedSOAPINformation", "BO-1072100036-OBJECTIVENOTE", "ObjectiveNote");
			fields[151] = new ims.framework.ReportField(this.context, "_cv_Clinical.UnsavedSOAPINformation", "BO-1072100036-ANALYSISNOTE", "AnalysisNote");
			fields[152] = new ims.framework.ReportField(this.context, "_cv_Clinical.UnsavedSOAPINformation", "BO-1072100036-PLANNOTE", "PlanNote");
			fields[153] = new ims.framework.ReportField(this.context, "_cv_Clinical.UnsavedSOAPINformation", "BO-1072100036-CLINICALNOTE", "ClinicalNote");
			fields[154] = new ims.framework.ReportField(this.context, "_cv_Clinical.UnsavedSOAPINformation", "BO-1072100036-CARECONTEXT", "CareContext");
			fields[155] = new ims.framework.ReportField(this.context, "_cv_Core.ParentClinContact", "BO-1004100003-ID", "ID_ClinicalContact");
			fields[156] = new ims.framework.ReportField(this.context, "_cv_Core.ParentClinContact", "BO-1004100003-SPECIALTY", "Specialty");
			fields[157] = new ims.framework.ReportField(this.context, "_cv_Core.ParentClinContact", "BO-1004100003-CONTACTTYPE", "ContactType");
			fields[158] = new ims.framework.ReportField(this.context, "_cv_Core.ParentClinContact", "BO-1004100003-STARTDATETIME", "StartDateTime");
			fields[159] = new ims.framework.ReportField(this.context, "_cv_Core.ParentClinContact", "BO-1004100003-ENDDATETIME", "EndDateTime");
			fields[160] = new ims.framework.ReportField(this.context, "_cv_Core.ParentClinContact", "BO-1004100003-CARECONTEXT", "CareContext");
			fields[161] = new ims.framework.ReportField(this.context, "_cv_Core.ParentClinContact", "BO-1004100003-ISCLINICALNOTECREATED", "IsClinicalNoteCreated");
			fields[162] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalContact", "BO-1004100003-ID", "ID_ClinicalContact");
			fields[163] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalContact", "BO-1004100003-SPECIALTY", "Specialty");
			fields[164] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalContact", "BO-1004100003-SEENBY", "SeenBy");
			fields[165] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalContact", "BO-1004100003-CONTACTTYPE", "ContactType");
			fields[166] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalContact", "BO-1004100003-STARTDATETIME", "StartDateTime");
			fields[167] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalContact", "BO-1004100003-ENDDATETIME", "EndDateTime");
			fields[168] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalContact", "BO-1004100003-CARECONTEXT", "CareContext");
			fields[169] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalContact", "BO-1004100003-ISCLINICALNOTECREATED", "IsClinicalNoteCreated");
			fields[170] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalNotesShort", "BO-1011100000-ID", "ID_ClinicalNotes");
			fields[171] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalNotesShort", "BO-1011100000-CLINICALNOTE", "ClinicalNote");
			fields[172] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalNotesShort", "BO-1011100000-NOTETYPE", "NoteType");
			fields[173] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalNotesShort", "BO-1011100000-DISCIPLINE", "Discipline");
			fields[174] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalNotesShort", "BO-1011100000-CLINICALCONTACT", "ClinicalContact");
			fields[175] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalNotesShort", "BO-1011100000-ISDERIVEDNOTE", "IsDerivedNote");
			fields[176] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalNotesShort", "BO-1011100000-FORREVIEW", "ForReview");
			fields[177] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalNotesShort", "BO-1011100000-FORREVIEWDISCIPLINE", "ForReviewDiscipline");
			fields[178] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalNotesShort", "BO-1011100000-REVIEWINGDATETIME", "ReviewingDateTime");
			fields[179] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalNotesShort", "BO-1011100000-ISCORRECTED", "IsCorrected");
			fields[180] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalNotesShort", "BO-1011100000-ISTRANSCRIBED", "IsTranscribed");
			fields[181] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalNotesShort", "BO-1011100000-SOURCEOFNOTE", "SourceOfNote");
			fields[182] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalNotesShort", "BO-1011100000-RECORDINGDATETIME", "RecordingDateTime");
			fields[183] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalNotesShort", "BO-1011100000-NOTECLASSIFICATION", "NoteClassification");
			fields[184] = new ims.framework.ReportField(this.context, "_cv_Clinical.CareContextWithHistory", "BO-1004100019-ID", "ID_CareContext");
			fields[185] = new ims.framework.ReportField(this.context, "_cv_Clinical.CareContextWithHistory", "BO-1004100019-CONTEXT", "Context");
			fields[186] = new ims.framework.ReportField(this.context, "_cv_Clinical.CareContextWithHistory", "BO-1004100019-STARTDATETIME", "StartDateTime");
			fields[187] = new ims.framework.ReportField(this.context, "_cv_Clinical.CareContextWithHistory", "BO-1004100019-ENDDATETIME", "EndDateTime");
			fields[188] = new ims.framework.ReportField(this.context, "_cv_Clinical.EpisodeOfCareWithHistory", "BO-1004100018-ID", "ID_EpisodeOfCare");
			fields[189] = new ims.framework.ReportField(this.context, "_cv_Clinical.EpisodeOfCareWithHistory", "BO-1004100018-SPECIALTY", "Specialty");
			fields[190] = new ims.framework.ReportField(this.context, "_cv_Clinical.EpisodeOfCareWithHistory", "BO-1004100018-STARTDATE", "StartDate");
			fields[191] = new ims.framework.ReportField(this.context, "_cv_Clinical.EpisodeOfCareWithHistory", "BO-1004100018-ENDDATE", "EndDate");
			fields[192] = new ims.framework.ReportField(this.context, "_cv_Clinical.PatientSummary.EpisodeOfCare", "BO-1004100018-ID", "ID_EpisodeOfCare");
			fields[193] = new ims.framework.ReportField(this.context, "_cv_Clinical.PatientSummary.ClinicalContact", "BO-1004100003-ID", "ID_ClinicalContact");
			fields[194] = new ims.framework.ReportField(this.context, "_cv_Clinical.PatientSummary.CareContext", "BO-1004100019-ID", "ID_CareContext");
			fields[195] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedPatientProblemFromPatientSummary", "BO-1023100001-ID", "ID_PatientProblem");
			fields[196] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedPatientDiagnosisFromPatientSummary", "BO-1003100016-ID", "ID_PatientDiagnosis");
			fields[197] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedPatientProcedureFromPatientSummary", "BO-1003100017-ID", "ID_PatientProcedure");
			fields[198] = new ims.framework.ReportField(this.context, "_cv_ICP.Service", "BO-1003100032-ID", "ID_Service");
			fields[199] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientSummary.__internal_x_context__PreviousDiagnosisEpisodeOfCare_" + componentIdentifier, "BO-1004100018-ID", "ID_EpisodeOfCare");
			fields[200] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientSummary.__internal_x_context__PreviousProcedureEpisodeOfCare_" + componentIdentifier, "BO-1004100018-ID", "ID_EpisodeOfCare");
			return fields;
		}
