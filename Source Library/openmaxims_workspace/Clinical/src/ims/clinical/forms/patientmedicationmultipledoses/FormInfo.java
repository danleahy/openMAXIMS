...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "PatientMedicationMultipleDoses";
	}
	public int getWidth()
	{
		return 848;
	...
	{
		return new String[] { "_cv_Clinical.CurrentMedicationOverView", "_cv_Clinical.DialogFormName", "_cv_Clinical.DiscontinueMedicationReasonValues", "_cv_Clinical.ReturnToFormCDIDescription", "_cv_Clinical.ReturnToFormMode", "_cv_Clinical.ReturnToFormName", "_cv_Core.ClinicalContact", "_cv_Core.TaxonomyMap" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Clinical.PatientMedicationMultipleDoses.__internal_x_context__" + String.valueOf(getFormId());
	}
