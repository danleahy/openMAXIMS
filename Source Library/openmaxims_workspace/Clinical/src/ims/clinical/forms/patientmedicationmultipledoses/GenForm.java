...
public class GenForm extends FormBridge
{
	...
	public static class ctnDetailsContainer extends ContainerBridge
	{
		...
		public static class cmbCommencedByComboBox extends ComboBoxBridge
		{
			...
			public void newRow(ims.core.vo.lookups.MedicationCommencedDiscontinuedType value, String text)
			{
				super.control.newRow(value, text);
			}
			public void newRow(ims.core.vo.lookups.MedicationCommencedDiscontinuedType value, String text, ims.framework.utils.Image image)
			{
				super.control.newRow(value, text, image);
			}
			public void newRow(ims.core.vo.lookups.MedicationCommencedDiscontinuedType value, String text, ims.framework.utils.Color textColor)
			{
				super.control.newRow(value, text, textColor);
			}
			public void newRow(ims.core.vo.lookups.MedicationCommencedDiscontinuedType value, String text, ims.framework.utils.Image image, ims.framework.utils.Color textColor)
			{
				super.control.newRow(value, text, image, textColor);
			}
			public boolean removeRow(ims.core.vo.lookups.MedicationCommencedDiscontinuedType value)
			{
				return super.control.removeRow(value);
			}
			public ims.core.vo.lookups.MedicationCommencedDiscontinuedType getValue()
			{
				return (ims.core.vo.lookups.MedicationCommencedDiscontinuedType)super.control.getValue();
			}
			public void setValue(ims.core.vo.lookups.MedicationCommencedDiscontinuedType value)
			{
		...
		protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
		{
			...
			RuntimeAnchoring anchoringHelper1 = new RuntimeAnchoring(designSize, runtimeSize, 8, 16, 800, 64, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT);
			ims.framework.FormUiLogic m_customControlCodingItemForm = loader.loadComponent(123133, appForm, startControlID * 10 + 1000, anchoringHelper1.getSize(), instance1, startTabIndex.intValue() + 5, skipContextValidation);
			//ims.framework.Control m_customControlCodingItemControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1000), new Integer(8), new Integer(16), new Integer(800), new Integer(64), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT, new Integer(startTabIndex.intValue() + 5), m_customControlCodingItemForm, instance1 } );
			ims.framework.Control m_customControlCodingItemControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1001),  new Integer(anchoringHelper1.getX()), new Integer(anchoringHelper1.getY()), new Integer(anchoringHelper1.getWidth()), new Integer(anchoringHelper1.getHeight()), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT, new Integer(startTabIndex.intValue() + 5), m_customControlCodingItemForm, instance1, Boolean.FALSE } );
			...
			// Label Controls
			RuntimeAnchoring anchoringHelper2 = new RuntimeAnchoring(designSize, runtimeSize, 16, 136, 63, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
			super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1002), new Integer(anchoringHelper2.getX()), new Integer(anchoringHelper2.getY()), new Integer(anchoringHelper2.getWidth()), new Integer(anchoringHelper2.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Comment:", new Integer(1), null, new Integer(0)}));
			RuntimeAnchoring anchoringHelper3 = new RuntimeAnchoring(designSize, runtimeSize, 408, 80, 0, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
			super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1003), new Integer(anchoringHelper3.getX()), new Integer(anchoringHelper3.getY()), new Integer(anchoringHelper3.getWidth()), new Integer(anchoringHelper3.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "", new Integer(1), null, new Integer(0)}));
			RuntimeAnchoring anchoringHelper4 = new RuntimeAnchoring(designSize, runtimeSize, 16, 82, 104, 16, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
			super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1004), new Integer(anchoringHelper4.getX()), new Integer(anchoringHelper4.getY()), new Integer(anchoringHelper4.getWidth()), new Integer(anchoringHelper4.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Commenced By:", new Integer(1), null, new Integer(0)}));
			RuntimeAnchoring anchoringHelper5 = new RuntimeAnchoring(designSize, runtimeSize, 584, 82, 108, 17, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
			...
			RuntimeAnchoring anchoringHelper6 = new RuntimeAnchoring(designSize, runtimeSize, 280, 82, 128, 16, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
			super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1006), new Integer(anchoringHelper6.getX()), new Integer(anchoringHelper6.getY()), new Integer(anchoringHelper6.getWidth()), new Integer(anchoringHelper6.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Commenced By (HCP):", new Integer(1), null, new Integer(0)}));
			RuntimeAnchoring anchoringHelper7 = new RuntimeAnchoring(designSize, runtimeSize, 576, 272, 129, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
			super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1007), new Integer(anchoringHelper7.getX()), new Integer(anchoringHelper7.getY()), new Integer(anchoringHelper7.getWidth()), new Integer(anchoringHelper7.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "No. of days to Supply:", new Integer(1), null, new Integer(0)}));
			RuntimeAnchoring anchoringHelper8 = new RuntimeAnchoring(designSize, runtimeSize, 400, 272, 132, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
			super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1008), new Integer(anchoringHelper8.getX()), new Integer(anchoringHelper8.getY()), new Integer(anchoringHelper8.getWidth()), new Integer(anchoringHelper8.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Include in Drug Order:", new Integer(1), null, new Integer(0)}));
			RuntimeAnchoring anchoringHelper9 = new RuntimeAnchoring(designSize, runtimeSize, 16, 111, 67, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
			super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1009), new Integer(anchoringHelper9.getX()), new Integer(anchoringHelper9.getY()), new Integer(anchoringHelper9.getWidth()), new Integer(anchoringHelper9.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Frequency:", new Integer(1), null, new Integer(0)}));
			RuntimeAnchoring anchoringHelper10 = new RuntimeAnchoring(designSize, runtimeSize, 280, 111, 47, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
			super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1010), new Integer(anchoringHelper10.getX()), new Integer(anchoringHelper10.getY()), new Integer(anchoringHelper10.getWidth()), new Integer(anchoringHelper10.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Source:", new Integer(1), null, new Integer(0)}));
	
			// TextBox Controls
			RuntimeAnchoring anchoringHelper11 = new RuntimeAnchoring(designSize, runtimeSize, 120, 136, 688, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT);
			super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1011), new Integer(anchoringHelper11.getX()), new Integer(anchoringHelper11.getY()), new Integer(anchoringHelper11.getWidth()), new Integer(anchoringHelper11.getHeight()), new Integer(startTabIndex.intValue() + 14), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT,Boolean.FALSE, new Integer(255), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
	
			// Date Controls
			RuntimeAnchoring anchoringHelper12 = new RuntimeAnchoring(designSize, runtimeSize, 696, 80, 112, 20, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
			super.addControl(factory.getControl(DateControl.class, new Object[] { control, new Integer(startControlID.intValue() + 1012), new Integer(anchoringHelper12.getX()), new Integer(anchoringHelper12.getY()), new Integer(anchoringHelper12.getWidth()), new Integer(anchoringHelper12.getHeight()), new Integer(startTabIndex.intValue() + 13), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT,Boolean.TRUE, null, Boolean.FALSE, null, Boolean.FALSE, null}));
	
			// ComboBox Controls
			RuntimeAnchoring anchoringHelper13 = new RuntimeAnchoring(designSize, runtimeSize, 120, 80, 152, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
			ComboBox m_cmbCommencedByTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1013), new Integer(anchoringHelper13.getX()), new Integer(anchoringHelper13.getY()), new Integer(anchoringHelper13.getWidth()), new Integer(anchoringHelper13.getHeight()), new Integer(startTabIndex.intValue() + 9), ControlState.DISABLED, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,Boolean.TRUE, Boolean.TRUE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
			...
			RuntimeAnchoring anchoringHelper14 = new RuntimeAnchoring(designSize, runtimeSize, 120, 109, 152, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
			ComboBox m_cmbFrequencyTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1014), new Integer(anchoringHelper14.getX()), new Integer(anchoringHelper14.getY()), new Integer(anchoringHelper14.getWidth()), new Integer(anchoringHelper14.getHeight()), new Integer(startTabIndex.intValue() + 10), ControlState.DISABLED, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
			...
			RuntimeAnchoring anchoringHelper15 = new RuntimeAnchoring(designSize, runtimeSize, 408, 109, 168, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT);
			...
			RuntimeAnchoring anchoringHelper16 = new RuntimeAnchoring(designSize, runtimeSize, 408, 80, 168, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT);
			ComboBox m_qmbCommencedByTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1016), new Integer(anchoringHelper16.getX()), new Integer(anchoringHelper16.getY()), new Integer(anchoringHelper16.getWidth()), new Integer(anchoringHelper16.getHeight()), new Integer(startTabIndex.intValue() + 11), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.TRUE, new Integer(1), null, Boolean.FALSE, new Integer(-1), Boolean.FALSE});
			...
			// CheckBox Controls
			RuntimeAnchoring anchoringHelper17 = new RuntimeAnchoring(designSize, runtimeSize, 536, 272, 16, 16, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT);
			super.addControl(factory.getControl(CheckBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1017), new Integer(anchoringHelper17.getX()), new Integer(anchoringHelper17.getY()), new Integer(anchoringHelper17.getWidth()), new Integer(anchoringHelper17.getHeight()), new Integer(-1), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT ,"", Boolean.FALSE, null}));
	
			// Dynamic Grid Controls
			RuntimeAnchoring anchoringHelper18 = new RuntimeAnchoring(designSize, runtimeSize, 16, 168, 792, 114, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT);
			...
			// IntBox Controls
			RuntimeAnchoring anchoringHelper19 = new RuntimeAnchoring(designSize, runtimeSize, 704, 272, 40, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
	...
	private void validateContext(ims.framework.Context context)
	{
		...
		if(!context.isValidContextType(ims.clinical.vo.MedicationOverViewFilterVo.class))
			throw new ims.framework.exceptions.CodingRuntimeException("The type 'ims.clinical.vo.MedicationOverViewFilterVo' of the global context variable 'Clinical.MedMultipleDosesAdmSearchCriteia' is not supported.");
		if(!context.isValidContextType(ims.clinical.vo.MedicationOverViewFilterVo.class))
			throw new ims.framework.exceptions.CodingRuntimeException("The type 'ims.clinical.vo.MedicationOverViewFilterVo' of the global context variable 'Clinical.MedMultipleDosesDisSearchCriteria' is not supported.");
		if(!context.isValidContextType(ims.clinical.vo.MedicationOverViewFilterVo.class))
			throw new ims.framework.exceptions.CodingRuntimeException("The type 'ims.clinical.vo.MedicationOverViewFilterVo' of the global context variable 'Clinical.MedMultipleDosesOPDSearchCriteria' is not supported.");
		if(!context.isValidContextType(ims.clinical.vo.MedicationOverViewFilterVo.class))
			throw new ims.framework.exceptions.CodingRuntimeException("The type 'ims.clinical.vo.MedicationOverViewFilterVo' of the global context variable 'Clinical.MedMultipleDosesPatSearchCriteria' is not supported.");
	}
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		if(factory.getUIEngine().getLoggedInRole().hasMenuActionRight(appForm, new ims.framework.MenuAction(1140001)))
		...
		if(factory.getUIEngine().getLoggedInRole().hasMenuActionRight(appForm, new ims.framework.MenuAction(1140002)))
		...
		if(factory.getUIEngine().getLoggedInRole().hasMenuActionRight(appForm, new ims.framework.MenuAction(1140003)))
		...
		if(factory.getUIEngine().getLoggedInRole().hasMenuActionRight(appForm, new ims.framework.MenuAction(1150001)))
		...
		if(factory.getUIEngine().getLoggedInRole().hasMenuActionRight(appForm, new ims.framework.MenuAction(1150002)))
		...
		if(factory.getUIEngine().getLoggedInRole().hasMenuActionRight(appForm, new ims.framework.MenuAction(1150003)))
		...
		// Custom Controls
		ims.framework.CustomComponent instance1 = factory.getEmptyCustomComponent();
		RuntimeAnchoring anchoringHelper20 = new RuntimeAnchoring(designSize, runtimeSize, 0, 48, 392, 56, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		ims.framework.FormUiLogic m_customControlAuthoringInfoForm = loader.loadComponent(102228, appForm, startControlID * 10 + 2000, anchoringHelper20.getSize(), instance1, startTabIndex.intValue() + 1, skipContextValidation);
		//ims.framework.Control m_customControlAuthoringInfoControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1020), new Integer(0), new Integer(48), new Integer(392), new Integer(56), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, new Integer(startTabIndex.intValue() + 1), m_customControlAuthoringInfoForm, instance1 } );
		...
		// Container Clasess
		RuntimeAnchoring anchoringHelper21 = new RuntimeAnchoring(designSize, runtimeSize, 8, 280, 832, 312, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFTRIGHT);
		...
		RuntimeAnchoring anchoringHelper23 = new RuntimeAnchoring(designSize, runtimeSize, 768, 600, 75, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT);
		...
		RuntimeAnchoring anchoringHelper25 = new RuntimeAnchoring(designSize, runtimeSize, 8, 24, 832, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT);
		RecordBrowser m_recbrOverviewsTemp = (RecordBrowser)factory.getControl(RecordBrowser.class, new Object[] { control, new Integer(startControlID.intValue() + 1026), new Integer(anchoringHelper25.getX()), new Integer(anchoringHelper25.getY()), new Integer(anchoringHelper25.getWidth()), new Integer(anchoringHelper25.getHeight()), new Integer(-1), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT, null});
		...
		// CheckBox Controls
		RuntimeAnchoring anchoringHelper26 = new RuntimeAnchoring(designSize, runtimeSize, 606, 88, 200, 16, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
		super.addControl(factory.getControl(CheckBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1027), new Integer(anchoringHelper26.getX()), new Integer(anchoringHelper26.getY()), new Integer(anchoringHelper26.getWidth()), new Integer(anchoringHelper26.getHeight()), new Integer(startTabIndex.intValue() + 4), ControlState.UNKNOWN, ControlState.HIDDEN,ims.framework.enumerations.ControlAnchoring.TOPRIGHT ,"Hide Discontinued Medications/Doses", Boolean.TRUE, null}));

		// Dynamic Grid Controls
		RuntimeAnchoring anchoringHelper27 = new RuntimeAnchoring(designSize, runtimeSize, 8, 112, 832, 160, ims.framework.enumerations.ControlAnchoring.ALL);
		...
		// Link Controls
		RuntimeAnchoring anchoringHelper28 = new RuntimeAnchoring(designSize, runtimeSize, 776, 0, 38, 17, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
		super.addControl(factory.getControl(Link.class, new Object[] { control, new Integer(startControlID.intValue() + 1029), new Integer(anchoringHelper28.getX()), new Integer(anchoringHelper28.getY()), new Integer(anchoringHelper28.getWidth()), new Integer(anchoringHelper28.getHeight()), new Integer(-1), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT,"Return", Boolean.FALSE, null}));
	}
	...
	public class LocalContext extends ContextBridge
	{
		...
		public LocalContext(Context context, ims.framework.FormInfo formInfo, String componentIdentifier)
		{
			...
			cxl_CodingItemTextSubmitted = new ims.framework.ContextVariable("CodingItemTextSubmitted", prefix + "_lv_Clinical.PatientMedicationMultipleDoses.__internal_x_context__CodingItemTextSubmitted_" + componentIdentifier + "");
			cxl_SelectedInstance = new ims.framework.ContextVariable("SelectedInstance", prefix + "_lv_Clinical.PatientMedicationMultipleDoses.__internal_x_context__SelectedInstance_" + componentIdentifier + "");
			cxl_CurrentOverView = new ims.framework.ContextVariable("CurrentOverView", prefix + "_lv_Clinical.PatientMedicationMultipleDoses.__internal_x_context__CurrentOverView_" + componentIdentifier + "");
			cxl_ScreenType = new ims.framework.ContextVariable("ScreenType", prefix + "_lv_Clinical.PatientMedicationMultipleDoses.__internal_x_context__ScreenType_" + componentIdentifier + "");
			cxl_bDiscontinueDose = new ims.framework.ContextVariable("bDiscontinueDose", prefix + "_lv_Clinical.PatientMedicationMultipleDoses.__internal_x_context__bDiscontinueDose_" + componentIdentifier + "");
			cxl_bDiscontinueMed = new ims.framework.ContextVariable("bDiscontinueMed", prefix + "_lv_Clinical.PatientMedicationMultipleDoses.__internal_x_context__bDiscontinueMed_" + componentIdentifier + "");
		}
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, "_cv_Clinical.CurrentMedicationOverView", "BO-1072100034-ID", "ID_MedicationOverview");
			fields[145] = new ims.framework.ReportField(this.context, "_cv_Clinical.CurrentMedicationOverView", "BO-1072100034-TYPE", "Type");
			fields[146] = new ims.framework.ReportField(this.context, "_cv_Clinical.CurrentMedicationOverView", "BO-1072100034-CARECONTEXT", "CareContext");
			fields[147] = new ims.framework.ReportField(this.context, "_cv_Clinical.CurrentMedicationOverView", "BO-1072100034-CORRECTNESS", "Correctness");
			fields[148] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalContact", "BO-1004100003-ID", "ID_ClinicalContact");
			fields[149] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalContact", "BO-1004100003-SPECIALTY", "Specialty");
			fields[150] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalContact", "BO-1004100003-SEENBY", "SeenBy");
			fields[151] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalContact", "BO-1004100003-CONTACTTYPE", "ContactType");
			fields[152] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalContact", "BO-1004100003-STARTDATETIME", "StartDateTime");
			fields[153] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalContact", "BO-1004100003-ENDDATETIME", "EndDateTime");
			fields[154] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalContact", "BO-1004100003-CARECONTEXT", "CareContext");
			fields[155] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalContact", "BO-1004100003-ISCLINICALNOTECREATED", "IsClinicalNoteCreated");
			fields[156] = new ims.framework.ReportField(this.context, "_cv_Core.TaxonomyMap", "BO-1003100010-ID", "ID_TaxonomyMap");
			fields[157] = new ims.framework.ReportField(this.context, "_cv_Core.TaxonomyMap", "BO-1003100010-TAXONOMYNAME", "TaxonomyName");
			fields[158] = new ims.framework.ReportField(this.context, "_cv_Core.TaxonomyMap", "BO-1003100010-TAXONOMYCODE", "TaxonomyCode");
			fields[159] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientMedicationMultipleDoses.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1003100014-ID", "ID_PatientMedication");
			fields[160] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientMedicationMultipleDoses.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1003100014-OTHERMEDICATIONTEXT", "OtherMedicationText");
			fields[161] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientMedicationMultipleDoses.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1003100014-PATIENT", "Patient");
			fields[162] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientMedicationMultipleDoses.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1003100014-FREQUENCY", "Frequency");
			fields[163] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientMedicationMultipleDoses.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1003100014-SOURCEOFINFORMATION", "SourceofInformation");
			fields[164] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientMedicationMultipleDoses.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1003100014-COMMENCEDDATE", "CommencedDate");
			fields[165] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientMedicationMultipleDoses.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1003100014-NODAYSSUPPLY", "NoDaysSupply");
			fields[166] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientMedicationMultipleDoses.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1003100014-BATCHNO", "BatchNo");
			fields[167] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientMedicationMultipleDoses.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1003100014-EXPIRYDATE", "ExpiryDate");
			fields[168] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientMedicationMultipleDoses.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1003100014-ISDISCONTINUED", "IsDiscontinued");
			fields[169] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientMedicationMultipleDoses.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1003100014-DIFFICULTIESWITHMED", "DifficultiesWithMed");
			fields[170] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientMedicationMultipleDoses.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1003100014-SUPPLIED", "Supplied");
			fields[171] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientMedicationMultipleDoses.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1003100014-INPOSSESSION", "InPossession");
			fields[172] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientMedicationMultipleDoses.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1003100014-ISMEDICATIONONADMISSION", "IsMedicationonAdmission");
			fields[173] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientMedicationMultipleDoses.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1003100014-ISDISCHARGEMEDICATION", "IsDischargeMedication");
			fields[174] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientMedicationMultipleDoses.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1003100014-CARECONTEXT", "CareContext");
			fields[175] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientMedicationMultipleDoses.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1003100014-ISINTTO", "IsInTTO");
			fields[176] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientMedicationMultipleDoses.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1003100014-ISDISCONTINUEDDATE", "IsDiscontinuedDate");
			fields[177] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientMedicationMultipleDoses.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1003100014-ISDISCONTINUEDREASON", "IsDiscontinuedReason");
			fields[178] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientMedicationMultipleDoses.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1003100014-ISDISCONTINUEDREASONTEXT", "IsDiscontinuedReasonText");
			fields[179] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientMedicationMultipleDoses.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1003100014-ISCOPIED", "IsCopied");
			fields[180] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientMedicationMultipleDoses.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1003100014-COMMENCEDBYTYPE", "CommencedByType");
			fields[181] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientMedicationMultipleDoses.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1003100014-DISCONTINUEDBYTYPE", "DiscontinuedByType");
			fields[182] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientMedicationMultipleDoses.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1003100014-SELFMEDICATING", "SelfMedicating");
			fields[183] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientMedicationMultipleDoses.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1003100014-COMMENT", "Comment");
			fields[184] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientMedicationMultipleDoses.__internal_x_context__CurrentOverView_" + componentIdentifier, "BO-1072100034-ID", "ID_MedicationOverview");
			fields[185] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientMedicationMultipleDoses.__internal_x_context__CurrentOverView_" + componentIdentifier, "BO-1072100034-TYPE", "Type");
			fields[186] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientMedicationMultipleDoses.__internal_x_context__CurrentOverView_" + componentIdentifier, "BO-1072100034-CARECONTEXT", "CareContext");
			fields[187] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientMedicationMultipleDoses.__internal_x_context__CurrentOverView_" + componentIdentifier, "BO-1072100034-CORRECTNESS", "Correctness");
			return fields;
		}
