...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "SkinClosureIntraOpDialog";
	}
	public int getWidth()
	{
		return 584;
	...
	{
		return new String[] { "_cv_Clinical.TheatreAppointmentRef", "_cv_Clinical.SkinClosureIntraOpVo" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Clinical.SkinClosureIntraOpDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
