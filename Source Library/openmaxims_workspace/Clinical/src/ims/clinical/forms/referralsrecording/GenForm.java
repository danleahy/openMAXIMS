...
public class GenForm extends FormBridge
{
	...
	public static class ctnDetailsContainer extends ContainerBridge
	{
		...
		protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
		{
			...
			super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1014), new Integer(anchoringHelper14.getX()), new Integer(anchoringHelper14.getY()), new Integer(anchoringHelper14.getWidth()), new Integer(anchoringHelper14.getHeight()), new Integer(startTabIndex.intValue() + 10), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT,Boolean.FALSE, new Integer(100), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.TRUE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
			...
			super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1015), new Integer(anchoringHelper15.getX()), new Integer(anchoringHelper15.getY()), new Integer(anchoringHelper15.getWidth()), new Integer(anchoringHelper15.getHeight()), new Integer(startTabIndex.intValue() + 19), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT,Boolean.FALSE, new Integer(30), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
			...
			super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1016), new Integer(anchoringHelper16.getX()), new Integer(anchoringHelper16.getY()), new Integer(anchoringHelper16.getWidth()), new Integer(anchoringHelper16.getHeight()), new Integer(startTabIndex.intValue() + 14), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT,Boolean.FALSE, new Integer(30), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
			...
			super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1017), new Integer(anchoringHelper17.getX()), new Integer(anchoringHelper17.getY()), new Integer(anchoringHelper17.getWidth()), new Integer(anchoringHelper17.getHeight()), new Integer(startTabIndex.intValue() + 20), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT,Boolean.FALSE, new Integer(30), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
			...
			super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1019), new Integer(anchoringHelper19.getX()), new Integer(anchoringHelper19.getY()), new Integer(anchoringHelper19.getWidth()), new Integer(anchoringHelper19.getHeight()), new Integer(startTabIndex.intValue() + 13), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT,Boolean.FALSE, new Integer(50), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
			...
			ComboBox m_cmbLocationTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1024), new Integer(anchoringHelper24.getX()), new Integer(anchoringHelper24.getY()), new Integer(anchoringHelper24.getWidth()), new Integer(anchoringHelper24.getHeight()), new Integer(startTabIndex.intValue() + 12), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT ,Boolean.TRUE, Boolean.TRUE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
			...
			ComboBox m_qmbRefferalToTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1027), new Integer(anchoringHelper27.getX()), new Integer(anchoringHelper27.getY()), new Integer(anchoringHelper27.getWidth()), new Integer(anchoringHelper27.getHeight()), new Integer(startTabIndex.intValue() + 11), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT,Boolean.TRUE, Boolean.TRUE, SortOrder.NONE, Boolean.TRUE, new Integer(1), null, Boolean.TRUE, new Integer(-1), Boolean.FALSE});
			...
			super.addControl(factory.getControl(CheckBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1028), new Integer(anchoringHelper28.getX()), new Integer(anchoringHelper28.getY()), new Integer(anchoringHelper28.getWidth()), new Integer(anchoringHelper28.getHeight()), new Integer(startTabIndex.intValue() + 9), ControlState.DISABLED, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT ,"Supply 'Referral to' Details", Boolean.TRUE, null}));
		}
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ReferralsRecording.__internal_x_context__EditedRecord_" + componentIdentifier, "BO-1072100062-ID", "ID_ReferralsRecording");
			fields[145] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ReferralsRecording.__internal_x_context__EditedRecord_" + componentIdentifier, "BO-1072100062-REFERRALTYPE", "ReferralType");
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ReferralsRecording.__internal_x_context__EditedRecord_" + componentIdentifier, "BO-1072100062-REFERRALSOURCE", "ReferralSource");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ReferralsRecording.__internal_x_context__EditedRecord_" + componentIdentifier, "BO-1072100062-DATESENT", "DateSent");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ReferralsRecording.__internal_x_context__EditedRecord_" + componentIdentifier, "BO-1072100062-DETAILS", "Details");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ReferralsRecording.__internal_x_context__EditedRecord_" + componentIdentifier, "BO-1072100062-DATEFIRSTSEEN", "DateFirstSeen");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ReferralsRecording.__internal_x_context__EditedRecord_" + componentIdentifier, "BO-1072100062-DATERECEIVED", "DateReceived");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ReferralsRecording.__internal_x_context__EditedRecord_" + componentIdentifier, "BO-1072100062-REFERRALPRIORITY", "ReferralPriority");
			fields[152] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ReferralsRecording.__internal_x_context__EditedRecord_" + componentIdentifier, "BO-1072100062-REASONFORREFERRAL", "ReasonForReferral");
			fields[153] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ReferralsRecording.__internal_x_context__EditedRecord_" + componentIdentifier, "BO-1072100062-SPECIALTYFUNCTIONCODE", "SpecialtyFunctionCode");
			fields[154] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ReferralsRecording.__internal_x_context__EditedRecord_" + componentIdentifier, "BO-1072100062-REFERRALCATEGORY", "ReferralCategory");
			fields[155] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ReferralsRecording.__internal_x_context__EditedRecord_" + componentIdentifier, "BO-1072100062-PRIMARYPRECEEDING", "PrimaryPreceeding");
			fields[156] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ReferralsRecording.__internal_x_context__EditedRecord_" + componentIdentifier, "BO-1072100062-CARESPELL", "CareSpell");
			fields[157] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ReferralsRecording.__internal_x_context__EditedRecord_" + componentIdentifier, "BO-1072100062-CARECONTEXT", "CareContext");
			fields[158] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ReferralsRecording.__internal_x_context__EditedRecord_" + componentIdentifier, "BO-1072100062-CLINICALCONTACT", "ClinicalContact");
			fields[159] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ReferralsRecording.__internal_x_context__EditedRecord_" + componentIdentifier, "BO-1072100062-REFERRALSTATUS", "ReferralStatus");
			fields[160] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ReferralsRecording.__internal_x_context__EditedRecord_" + componentIdentifier, "BO-1072100062-URGENTCANCERREFERRALTYPE", "UrgentCancerReferralType");
			fields[161] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ReferralsRecording.__internal_x_context__EditedRecord_" + componentIdentifier, "BO-1072100062-CANCERSTATUS", "CancerStatus");
			fields[162] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ReferralsRecording.__internal_x_context__EditedRecord_" + componentIdentifier, "BO-1072100062-DELAYREASONGPURGENTREFERRAL", "DelayReasonGPUrgentReferral");
			fields[163] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ReferralsRecording.__internal_x_context__EditedRecord_" + componentIdentifier, "BO-1072100062-DELAYREASONTEXT", "DelayReasonText");
			fields[164] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ReferralsRecording.__internal_x_context__EditedRecord_" + componentIdentifier, "BO-1072100062-DISCIPLINE", "Discipline");
			fields[165] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ReferralsRecording.__internal_x_context__EditedRecord_" + componentIdentifier, "BO-1072100062-REASONFORREFERRALTEXT", "ReasonForReferralText");
			return fields;
		}
