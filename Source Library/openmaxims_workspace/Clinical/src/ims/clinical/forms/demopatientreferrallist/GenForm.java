...
public class GenForm extends FormBridge
{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		super.addControl(factory.getControl(ImageButton.class, new Object[] { control, new Integer(startControlID.intValue() + 1017), new Integer(anchoringHelper17.getX()), new Integer(anchoringHelper17.getY()), new Integer(anchoringHelper17.getWidth()), new Integer(anchoringHelper17.getHeight()), new Integer(startTabIndex.intValue() + 1), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT, this.getImages().Core.FindEnabled24, this.getImages().Core.FindDisabled24, "Search for results matching 'Search Criteria'", Boolean.FALSE, Boolean.TRUE, Boolean.TRUE, Boolean.FALSE, null}));
	}
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedReferralRecordingVo", "BO-1072100062-ID", "ID_ReferralsRecording");
			fields[145] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedReferralRecordingVo", "BO-1072100062-REFERRALTYPE", "ReferralType");
			fields[146] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedReferralRecordingVo", "BO-1072100062-REFERRALSOURCE", "ReferralSource");
			fields[147] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedReferralRecordingVo", "BO-1072100062-DATESENT", "DateSent");
			fields[148] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedReferralRecordingVo", "BO-1072100062-DETAILS", "Details");
			fields[149] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedReferralRecordingVo", "BO-1072100062-DATEFIRSTSEEN", "DateFirstSeen");
			fields[150] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedReferralRecordingVo", "BO-1072100062-DATERECEIVED", "DateReceived");
			fields[151] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedReferralRecordingVo", "BO-1072100062-REFERRALPRIORITY", "ReferralPriority");
			fields[152] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedReferralRecordingVo", "BO-1072100062-REASONFORREFERRAL", "ReasonForReferral");
			fields[153] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedReferralRecordingVo", "BO-1072100062-SPECIALTYFUNCTIONCODE", "SpecialtyFunctionCode");
			fields[154] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedReferralRecordingVo", "BO-1072100062-REFERRALCATEGORY", "ReferralCategory");
			fields[155] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedReferralRecordingVo", "BO-1072100062-PRIMARYPRECEEDING", "PrimaryPreceeding");
			fields[156] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedReferralRecordingVo", "BO-1072100062-CARESPELL", "CareSpell");
			fields[157] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedReferralRecordingVo", "BO-1072100062-CARECONTEXT", "CareContext");
			fields[158] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedReferralRecordingVo", "BO-1072100062-CLINICALCONTACT", "ClinicalContact");
			fields[159] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedReferralRecordingVo", "BO-1072100062-REFERRALSTATUS", "ReferralStatus");
			fields[160] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedReferralRecordingVo", "BO-1072100062-URGENTCANCERREFERRALTYPE", "UrgentCancerReferralType");
			fields[161] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedReferralRecordingVo", "BO-1072100062-CANCERSTATUS", "CancerStatus");
			fields[162] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedReferralRecordingVo", "BO-1072100062-DELAYREASONGPURGENTREFERRAL", "DelayReasonGPUrgentReferral");
			fields[163] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedReferralRecordingVo", "BO-1072100062-DELAYREASONTEXT", "DelayReasonText");
			fields[164] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedReferralRecordingVo", "BO-1072100062-DISCIPLINE", "Discipline");
			return fields;
		}
