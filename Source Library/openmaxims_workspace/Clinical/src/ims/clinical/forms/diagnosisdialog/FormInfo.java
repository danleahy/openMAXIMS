...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Core.PatientDiagnosisAtConsultationList", "_cv_Core.PatientDiagnosisAtConsultation", "_cv_Clinical.DisableMainCheckbox", "_cv_Core.TaxonomyMap" };
	}
