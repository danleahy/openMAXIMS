...
public class GenForm extends FormBridge
{
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PresentingProblems.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1072100044-ID", "ID_PresentAbsentHistoryProblems");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PresentingProblems.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1072100044-HISTORYPRESENTINGPROBLEM", "HistoryPresentingProblem");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PresentingProblems.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1072100044-CLINICALCONTACT", "ClinicalContact");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PresentingProblems.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1072100044-CARECONTEXT", "CareContext");
			return fields;
		}
