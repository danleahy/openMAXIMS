...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "HandoverCountsIntraOpDialog";
	}
	public int getWidth()
	{
		return 704;
	...
	{
		return new String[] { "_cv_Clinical.IntraOpCaseStaffDetailRefVo", "_cv_Clinical.TheatreAppointmentRef", "_cv_Clinical.HandoverCountsIntraOpVo" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Clinical.HandoverCountsIntraOpDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
