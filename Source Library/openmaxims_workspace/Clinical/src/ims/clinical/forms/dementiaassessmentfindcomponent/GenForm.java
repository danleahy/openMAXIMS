...
public class GenForm extends FormBridge
{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1014), new Integer(anchoringHelper29.getX()), new Integer(anchoringHelper29.getY()), new Integer(anchoringHelper29.getWidth()), new Integer(anchoringHelper29.getHeight()), new Integer(startTabIndex.intValue() + 19), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Close", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1015), new Integer(anchoringHelper30.getX()), new Integer(anchoringHelper30.getY()), new Integer(anchoringHelper30.getWidth()), new Integer(anchoringHelper30.getHeight()), new Integer(startTabIndex.intValue() + 16), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "RIE", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1016), new Integer(anchoringHelper31.getX()), new Integer(anchoringHelper31.getY()), new Integer(anchoringHelper31.getWidth()), new Integer(anchoringHelper31.getHeight()), new Integer(startTabIndex.intValue() + 15), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Edit", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1018), new Integer(anchoringHelper33.getX()), new Integer(anchoringHelper33.getY()), new Integer(anchoringHelper33.getWidth()), new Integer(anchoringHelper33.getHeight()), new Integer(startTabIndex.intValue() + 17), ControlState.HIDDEN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Save", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.DementiaAssessmentFINDComponent.__internal_x_context__selectedDementia_" + componentIdentifier, "BO-1003100117-ID", "ID_Dementia");
			fields[152] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.DementiaAssessmentFINDComponent.__internal_x_context__selectedDementia_" + componentIdentifier, "BO-1003100117-ADMISSIONDATETIME", "AdmissionDateTime");
			fields[153] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.DementiaAssessmentFINDComponent.__internal_x_context__selectedDementia_" + componentIdentifier, "BO-1003100117-BREACHDATETIME", "BreachDateTime");
			fields[154] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.DementiaAssessmentFINDComponent.__internal_x_context__selectedDementia_" + componentIdentifier, "BO-1003100117-AGEONADMISSION", "AgeOnAdmission");
			fields[155] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.DementiaAssessmentFINDComponent.__internal_x_context__selectedDementia_" + componentIdentifier, "BO-1003100117-DISCHARGEDATETIME", "DischargeDateTime");
			fields[156] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.DementiaAssessmentFINDComponent.__internal_x_context__selectedDementia_" + componentIdentifier, "BO-1003100117-DEMENTIACONFIRMED", "DementiaConfirmed");
			fields[157] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.DementiaAssessmentFINDComponent.__internal_x_context__selectedDementia_" + componentIdentifier, "BO-1003100117-DELIRIUMCONFIRMED", "DeliriumConfirmed");
			fields[158] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.DementiaAssessmentFINDComponent.__internal_x_context__selectedDementia_" + componentIdentifier, "BO-1003100117-AMTSSCORE", "AMTSScore");
			fields[159] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.DementiaAssessmentFINDComponent.__internal_x_context__selectedDementia_" + componentIdentifier, "BO-1003100117-CONFIRMEDPATIENTPUTONDEMENTIAPATHWAY", "ConfirmedPatientPutOnDementiaPathway");
			fields[160] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.DementiaAssessmentFINDComponent.__internal_x_context__selectedDementia_" + componentIdentifier, "BO-1003100117-ADMISSIONDETAIL", "AdmissionDetail");
			fields[161] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.DementiaAssessmentFINDComponent.__internal_x_context__selectedDementia_" + componentIdentifier, "BO-1003100117-ISEXCLUDEDFROMWORKLIST", "IsExcludedFromWorklist");
			fields[162] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.DementiaAssessmentFINDComponent.__internal_x_context__AuthoringInfo_" + componentIdentifier, "BO-1003100069-ID", "ID_AuthoringInformation");
			fields[163] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.DementiaAssessmentFINDComponent.__internal_x_context__AuthoringInfo_" + componentIdentifier, "BO-1003100069-AUTHORINGDATETIME", "AuthoringDateTime");
			return fields;
		}
