...
public class GenForm extends FormBridge
{
	...
	public static class ctnDetailsContainer extends ContainerBridge
	{
		...
		public static class grpProcedureTypeRadioButton extends RadioButtonBridge
		{
			...
			protected void setContext(Integer startTabIndex, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize)
			{
				...
				control.addButton(0, anchoringHelper1.getX(), anchoringHelper1.getY(), anchoringHelper1.getWidth(), "All Operations", startTabIndex.intValue() + 3);
		...
		protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
		{
			...
			ims.framework.FormUiLogic m_ccPerformedByForm = loader.loadComponent(102256, appForm, startControlID * 10 + 1000, anchoringHelper3.getSize(), instance1, startTabIndex.intValue() + 8, skipContextValidation);
			//ims.framework.Control m_ccPerformedByControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1000), new Integer(120), new Integer(93), new Integer(368), new Integer(20), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, new Integer(startTabIndex.intValue() + 8), m_ccPerformedByForm, instance1 } );
			ims.framework.Control m_ccPerformedByControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1001),  new Integer(anchoringHelper3.getX()), new Integer(anchoringHelper3.getY()), new Integer(anchoringHelper3.getWidth()), new Integer(anchoringHelper3.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, new Integer(startTabIndex.intValue() + 8), m_ccPerformedByForm, instance1, Boolean.FALSE } );
			...
			RuntimeAnchoring anchoringHelper4 = new RuntimeAnchoring(designSize, runtimeSize, 488, 124, 352, 56, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT);
			ims.framework.FormUiLogic m_ccAuthorForm = loader.loadComponent(102228, appForm, startControlID * 10 + 2000, anchoringHelper4.getSize(), instance2, startTabIndex.intValue() + 14, skipContextValidation);
			//ims.framework.Control m_ccAuthorControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1002), new Integer(488), new Integer(124), new Integer(352), new Integer(56), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT, new Integer(startTabIndex.intValue() + 14), m_ccAuthorForm, instance2 } );
			ims.framework.Control m_ccAuthorControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1003),  new Integer(anchoringHelper4.getX()), new Integer(anchoringHelper4.getY()), new Integer(anchoringHelper4.getWidth()), new Integer(anchoringHelper4.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT, new Integer(startTabIndex.intValue() + 14), m_ccAuthorForm, instance2, Boolean.FALSE } );
			...
			RuntimeAnchoring anchoringHelper5 = new RuntimeAnchoring(designSize, runtimeSize, 8, 24, 830, 64, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT);
			...
			//ims.framework.Control m_ccProcedureControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1004), new Integer(8), new Integer(24), new Integer(830), new Integer(64), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT, new Integer(startTabIndex.intValue() + 4), m_ccProcedureForm, instance3 } );
			...
			RuntimeAnchoring anchoringHelper8 = new RuntimeAnchoring(designSize, runtimeSize, 120, 192, 248, 17, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT);
			...
			super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1013), new Integer(anchoringHelper13.getX()), new Integer(anchoringHelper13.getY()), new Integer(anchoringHelper13.getWidth()), new Integer(anchoringHelper13.getHeight()), new Integer(startTabIndex.intValue() + 11), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.FALSE, new Integer(255), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
			...
			super.addControl(factory.getControl(PartialDateBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1014), new Integer(anchoringHelper14.getX()), new Integer(anchoringHelper14.getY()), new Integer(anchoringHelper14.getWidth()), new Integer(anchoringHelper14.getHeight()), new Integer(startTabIndex.intValue() + 12), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, null, Boolean.FALSE, Boolean.FALSE}));
			...
			ComboBox m_cmbLateralityTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1015), new Integer(anchoringHelper15.getX()), new Integer(anchoringHelper15.getY()), new Integer(anchoringHelper15.getWidth()), new Integer(anchoringHelper15.getHeight()), new Integer(startTabIndex.intValue() + 10), ControlState.DISABLED, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
			...
			super.addControl(factory.getControl(TimeControl.class, new Object[] { control, new Integer(startControlID.intValue() + 1016), new Integer(anchoringHelper16.getX()), new Integer(anchoringHelper16.getY()), new Integer(anchoringHelper16.getWidth()), new Integer(anchoringHelper16.getHeight()), new Integer(startTabIndex.intValue() + 13), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.TRUE, Boolean.FALSE, null, Boolean.FALSE, ""}));
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		// Panel Controls
		RuntimeAnchoring anchoringHelper17 = new RuntimeAnchoring(designSize, runtimeSize, 5, 253, 842, 21, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFTRIGHT);
		...
		// Container Clasess
		RuntimeAnchoring anchoringHelper18 = new RuntimeAnchoring(designSize, runtimeSize, 2, 284, 844, 224, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFTRIGHT);
		...
		ims.framework.utils.SizeInfo m_ctnDetailsDesignSize = new ims.framework.utils.SizeInfo(844, 224);
		...
		// Button Controls
		RuntimeAnchoring anchoringHelper19 = new RuntimeAnchoring(designSize, runtimeSize, 85, 544, 75, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT);
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1020), new Integer(anchoringHelper19.getX()), new Integer(anchoringHelper19.getY()), new Integer(anchoringHelper19.getWidth()), new Integer(anchoringHelper19.getHeight()), new Integer(startTabIndex.intValue() + 21), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Edit", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		RuntimeAnchoring anchoringHelper20 = new RuntimeAnchoring(designSize, runtimeSize, 8, 544, 75, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT);
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1021), new Integer(anchoringHelper20.getX()), new Integer(anchoringHelper20.getY()), new Integer(anchoringHelper20.getWidth()), new Integer(anchoringHelper20.getHeight()), new Integer(startTabIndex.intValue() + 20), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "New", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		RuntimeAnchoring anchoringHelper21 = new RuntimeAnchoring(designSize, runtimeSize, 770, 544, 75, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT);
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1022), new Integer(anchoringHelper21.getX()), new Integer(anchoringHelper21.getY()), new Integer(anchoringHelper21.getWidth()), new Integer(anchoringHelper21.getHeight()), new Integer(startTabIndex.intValue() + 19), ControlState.HIDDEN, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Cancel", Boolean.FALSE, null, Boolean.FALSE, Boolean.FALSE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		RuntimeAnchoring anchoringHelper22 = new RuntimeAnchoring(designSize, runtimeSize, 692, 544, 75, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT);
		...
		// CheckBox Controls
		RuntimeAnchoring anchoringHelper23 = new RuntimeAnchoring(designSize, runtimeSize, 772, 520, 72, 16, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT);
		super.addControl(factory.getControl(CheckBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1024), new Integer(anchoringHelper23.getX()), new Integer(anchoringHelper23.getY()), new Integer(anchoringHelper23.getWidth()), new Integer(anchoringHelper23.getHeight()), new Integer(startTabIndex.intValue() + 17), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT ,"Complete", Boolean.TRUE, null}));

		// Grid Controls
		RuntimeAnchoring anchoringHelper24 = new RuntimeAnchoring(designSize, runtimeSize, 16, 32, 820, 216, ims.framework.enumerations.ControlAnchoring.ALL);
		...
		grdProcs.addStringColumn("Operation Description", 0, 0, 400, true, false, 0, 0, true, ims.framework.enumerations.CharacterCasing.NORMAL);
	...
	private class ReportFields
	{
		...
		{
			String prefix = formInfo.getLocalVariablesPrefix();
			IReportField[] fields = new IReportField[234];
			...
			fields[144] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalNotesShort", "BO-1011100000-ID", "ID_ClinicalNotes");
			fields[145] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalNotesShort", "BO-1011100000-CLINICALNOTE", "ClinicalNote");
			fields[146] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalNotesShort", "BO-1011100000-NOTETYPE", "NoteType");
			fields[147] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalNotesShort", "BO-1011100000-DISCIPLINE", "Discipline");
			fields[148] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalNotesShort", "BO-1011100000-CLINICALCONTACT", "ClinicalContact");
			fields[149] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalNotesShort", "BO-1011100000-ISDERIVEDNOTE", "IsDerivedNote");
			fields[150] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalNotesShort", "BO-1011100000-FORREVIEW", "ForReview");
			fields[151] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalNotesShort", "BO-1011100000-FORREVIEWDISCIPLINE", "ForReviewDiscipline");
			fields[152] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalNotesShort", "BO-1011100000-REVIEWINGDATETIME", "ReviewingDateTime");
			fields[153] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalNotesShort", "BO-1011100000-ISCORRECTED", "IsCorrected");
			fields[154] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalNotesShort", "BO-1011100000-ISTRANSCRIBED", "IsTranscribed");
			fields[155] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalNotesShort", "BO-1011100000-SOURCEOFNOTE", "SourceOfNote");
			fields[156] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalNotesShort", "BO-1011100000-RECORDINGDATETIME", "RecordingDateTime");
			fields[157] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalNotesShort", "BO-1011100000-NOTECLASSIFICATION", "NoteClassification");
			fields[158] = new ims.framework.ReportField(this.context, "_cv_Clinical.UnsavedSOAPINformation", "BO-1072100036-ID", "ID_SoapNote");
			fields[159] = new ims.framework.ReportField(this.context, "_cv_Clinical.UnsavedSOAPINformation", "BO-1072100036-SUBJECTIVENOTE", "SubjectiveNote");
			fields[160] = new ims.framework.ReportField(this.context, "_cv_Clinical.UnsavedSOAPINformation", "BO-1072100036-OBJECTIVENOTE", "ObjectiveNote");
			fields[161] = new ims.framework.ReportField(this.context, "_cv_Clinical.UnsavedSOAPINformation", "BO-1072100036-ANALYSISNOTE", "AnalysisNote");
			fields[162] = new ims.framework.ReportField(this.context, "_cv_Clinical.UnsavedSOAPINformation", "BO-1072100036-PLANNOTE", "PlanNote");
			fields[163] = new ims.framework.ReportField(this.context, "_cv_Clinical.UnsavedSOAPINformation", "BO-1072100036-CLINICALNOTE", "ClinicalNote");
			fields[164] = new ims.framework.ReportField(this.context, "_cv_Clinical.UnsavedSOAPINformation", "BO-1072100036-CARECONTEXT", "CareContext");
			fields[165] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedPatientProcedure", "BO-1003100017-ID", "ID_PatientProcedure");
			fields[166] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedPatientProcedure", "BO-1003100017-PROCEDUREDESCRIPTION", "ProcedureDescription");
			fields[167] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedPatientProcedure", "BO-1003100017-INFOSOURCE", "InfoSource");
			fields[168] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedPatientProcedure", "BO-1003100017-PROCDATE", "ProcDate");
			fields[169] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedPatientProcedure", "BO-1003100017-INCLUDEINDISCHARGELETTER", "IncludeInDischargeLetter");
			fields[170] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedPatientProcedure", "BO-1003100017-SITETEXT", "SiteText");
			fields[171] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedPatientProcedure", "BO-1003100017-PROCLATERALITY", "ProcLaterality");
			fields[172] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedPatientProcedure", "BO-1003100017-PROCEDURESTATUS", "ProcedureStatus");
			fields[173] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedPatientProcedure", "BO-1003100017-PROCTIME", "ProcTime");
			fields[174] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedPatientProcedure", "BO-1003100017-EPISODEOFCARE", "EpisodeOfCare");
			fields[175] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedPatientProcedure", "BO-1003100017-ISPRIMARY", "IsPrimary");
			fields[176] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedPatientProcedure", "BO-1003100017-NOTES", "Notes");
			fields[177] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedPatientProcedure", "BO-1003100017-PROCEDUREURGENCY", "ProcedureUrgency");
			fields[178] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedPatientProcedure", "BO-1003100017-PROCEDUREOUTCOME", "ProcedureOutcome");
			fields[179] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedPatientProcedure", "BO-1003100017-DATEPLANNED", "DatePlanned");
			fields[180] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedPatientProcedure", "BO-1003100017-PLANNEDPROC", "PlannedProc");
			fields[181] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedPatientProcedure", "BO-1003100017-PROCSITE", "ProcSite");
			fields[182] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedPatientProcedure", "BO-1003100017-PEFORMEDBY", "PeformedBy");
			fields[183] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedPatientProcedure", "BO-1003100017-PROCEDUREINTENT", "ProcedureIntent");
			fields[184] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedPatientProcedure", "BO-1003100017-LOCATION", "Location");
			fields[185] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedPatientProcedure", "BO-1003100017-SPECIALTY", "Specialty");
			fields[186] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedPatientProcedure", "BO-1003100017-CONFIRMEDSTATUS", "ConfirmedStatus");
			fields[187] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedPatientProcedure", "BO-1003100017-CONFIRMEDDATETIME", "ConfirmedDateTime");
			fields[188] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedPatientProcedure", "BO-1003100017-EXCLUDEFROMOTHERS", "ExcludeFromOthers");
			fields[189] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedPatientProcedure", "BO-1003100017-PROCLOCATION", "ProcLocation");
			fields[190] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedPatientProcedure", "BO-1003100017-CANCELLEDDATE", "CancelledDate");
			fields[191] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedPatientProcedure", "BO-1003100017-CANCELLEDREASON", "CancelledReason");
			fields[192] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedPatientProcedure", "BO-1003100017-SURGEONSGRADE", "SurgeonsGrade");
			fields[193] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedPatientProcedure", "BO-1003100017-PROCENDDATE", "ProcEndDate");
			fields[194] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedPatientProcedure", "BO-1003100017-PROCENDTIME", "ProcEndTime");
			fields[195] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedPatientProcedure", "BO-1003100017-SIGNIFPROC", "SignifProc");
			fields[196] = new ims.framework.ReportField(this.context, "_cv_Core.TaxonomyMap", "BO-1003100010-ID", "ID_TaxonomyMap");
			fields[197] = new ims.framework.ReportField(this.context, "_cv_Core.TaxonomyMap", "BO-1003100010-TAXONOMYNAME", "TaxonomyName");
			fields[198] = new ims.framework.ReportField(this.context, "_cv_Core.TaxonomyMap", "BO-1003100010-TAXONOMYCODE", "TaxonomyCode");
			fields[199] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedPatientProcedureFromNursingAdmission", "BO-1003100017-ID", "ID_PatientProcedure");
			fields[200] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedPatientProcedureFromPatientSummary", "BO-1003100017-ID", "ID_PatientProcedure");
			fields[201] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeOpsProcsComponent.__internal_x_context__PatientProcedureVo_" + componentIdentifier, "BO-1003100017-ID", "ID_PatientProcedure");
			fields[202] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeOpsProcsComponent.__internal_x_context__PatientProcedureVo_" + componentIdentifier, "BO-1003100017-PROCEDUREDESCRIPTION", "ProcedureDescription");
			fields[203] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeOpsProcsComponent.__internal_x_context__PatientProcedureVo_" + componentIdentifier, "BO-1003100017-INFOSOURCE", "InfoSource");
			fields[204] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeOpsProcsComponent.__internal_x_context__PatientProcedureVo_" + componentIdentifier, "BO-1003100017-PROCDATE", "ProcDate");
			fields[205] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeOpsProcsComponent.__internal_x_context__PatientProcedureVo_" + componentIdentifier, "BO-1003100017-INCLUDEINDISCHARGELETTER", "IncludeInDischargeLetter");
			fields[206] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeOpsProcsComponent.__internal_x_context__PatientProcedureVo_" + componentIdentifier, "BO-1003100017-SITETEXT", "SiteText");
			fields[207] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeOpsProcsComponent.__internal_x_context__PatientProcedureVo_" + componentIdentifier, "BO-1003100017-PROCLATERALITY", "ProcLaterality");
			fields[208] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeOpsProcsComponent.__internal_x_context__PatientProcedureVo_" + componentIdentifier, "BO-1003100017-PROCEDURESTATUS", "ProcedureStatus");
			fields[209] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeOpsProcsComponent.__internal_x_context__PatientProcedureVo_" + componentIdentifier, "BO-1003100017-PROCTIME", "ProcTime");
			fields[210] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeOpsProcsComponent.__internal_x_context__PatientProcedureVo_" + componentIdentifier, "BO-1003100017-EPISODEOFCARE", "EpisodeOfCare");
			fields[211] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeOpsProcsComponent.__internal_x_context__PatientProcedureVo_" + componentIdentifier, "BO-1003100017-ISPRIMARY", "IsPrimary");
			fields[212] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeOpsProcsComponent.__internal_x_context__PatientProcedureVo_" + componentIdentifier, "BO-1003100017-NOTES", "Notes");
			fields[213] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeOpsProcsComponent.__internal_x_context__PatientProcedureVo_" + componentIdentifier, "BO-1003100017-PROCEDUREURGENCY", "ProcedureUrgency");
			fields[214] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeOpsProcsComponent.__internal_x_context__PatientProcedureVo_" + componentIdentifier, "BO-1003100017-PROCEDUREOUTCOME", "ProcedureOutcome");
			fields[215] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeOpsProcsComponent.__internal_x_context__PatientProcedureVo_" + componentIdentifier, "BO-1003100017-DATEPLANNED", "DatePlanned");
			fields[216] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeOpsProcsComponent.__internal_x_context__PatientProcedureVo_" + componentIdentifier, "BO-1003100017-PLANNEDPROC", "PlannedProc");
			fields[217] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeOpsProcsComponent.__internal_x_context__PatientProcedureVo_" + componentIdentifier, "BO-1003100017-PROCSITE", "ProcSite");
			fields[218] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeOpsProcsComponent.__internal_x_context__PatientProcedureVo_" + componentIdentifier, "BO-1003100017-PEFORMEDBY", "PeformedBy");
			fields[219] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeOpsProcsComponent.__internal_x_context__PatientProcedureVo_" + componentIdentifier, "BO-1003100017-PROCEDUREINTENT", "ProcedureIntent");
			fields[220] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeOpsProcsComponent.__internal_x_context__PatientProcedureVo_" + componentIdentifier, "BO-1003100017-PROCENDDATE", "ProcEndDate");
			fields[221] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeOpsProcsComponent.__internal_x_context__PatientProcedureVo_" + componentIdentifier, "BO-1003100017-SIGNIFPROC", "SignifProc");
			fields[222] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeOpsProcsComponent.__internal_x_context__Hcp_" + componentIdentifier, "BO-1006100000-ID", "ID_Hcp");
			fields[223] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeOpsProcsComponent.__internal_x_context__Hcp_" + componentIdentifier, "BO-1006100000-HCPTYPE", "HcpType");
			fields[224] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeOpsProcsComponent.__internal_x_context__Hcp_" + componentIdentifier, "BO-1006100000-ISACTIVE", "IsActive");
			fields[225] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeOpsProcsComponent.__internal_x_context__Hcp_" + componentIdentifier, "BO-1006100000-ISHCPARESPONSIBLEHCP", "IsHCPaResponsibleHCP");
			fields[226] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeOpsProcsComponent.__internal_x_context__Hcp_" + componentIdentifier, "BO-1006100000-ISARESPONSIBLEEDCLINICIAN", "IsAResponsibleEDClinician");
			fields[227] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeOpsProcsComponent.__internal_x_context__Hcp_" + componentIdentifier, "BO-1006100000-ISHCPAENDOSCOPIST", "IsHCPaEndoscopist");
			fields[228] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeOpsProcsComponent.__internal_x_context__STHKSummary_" + componentIdentifier, "BO-1099100018-ID", "ID_Summary");
			fields[229] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeOpsProcsComponent.__internal_x_context__ProcedureToBeRIE_" + componentIdentifier, "BO-1003100017-ID", "ID_PatientProcedure");
			fields[230] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeOpsProcsComponent.__internal_x_context__ProcedureToBeRIE_" + componentIdentifier, "BO-1003100017-PROCEDUREDESCRIPTION", "ProcedureDescription");
			fields[231] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeOpsProcsComponent.__internal_x_context__ProcedureToBeRIE_" + componentIdentifier, "BO-1003100017-INCLUDEINDISCHARGELETTER", "IncludeInDischargeLetter");
			fields[232] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeOpsProcsComponent.__internal_x_context__ProcedureToBeRIE_" + componentIdentifier, "BO-1003100017-PROCDATE", "ProcDate");
			fields[233] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.EDischargeOpsProcsComponent.__internal_x_context__STHKSummaryVo_" + componentIdentifier, "BO-1099100018-ID", "ID_Summary");
			return fields;
		}
