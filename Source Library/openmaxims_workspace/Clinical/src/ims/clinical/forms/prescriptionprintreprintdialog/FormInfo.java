...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "PrescriptionPrintReprintDialog";
	}
	public int getWidth()
	{
		return 552;
	...
	{
		return new String[] { "_cv_Emergency.EDPrescriptionRef", "_cv_Core.ImsReportId" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Clinical.PrescriptionPrintReprintDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
