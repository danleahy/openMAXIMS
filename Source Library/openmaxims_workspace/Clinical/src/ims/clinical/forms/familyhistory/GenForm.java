...
public class GenForm extends FormBridge
{
	...
	public static class ctnFamilyHistoryContainer extends ContainerBridge
	{
		...
		protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
		{
			...
			ComboBox m_cbRelationshipTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1014), new Integer(anchoringHelper13.getX()), new Integer(anchoringHelper13.getY()), new Integer(anchoringHelper13.getWidth()), new Integer(anchoringHelper13.getHeight()), new Integer(startTabIndex.intValue() + 6), ControlState.DISABLED, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.TRUE, new Integer(-1)});
			...
			super.addControl(factory.getControl(IntBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1016), new Integer(anchoringHelper15.getX()), new Integer(anchoringHelper15.getY()), new Integer(anchoringHelper15.getWidth()), new Integer(anchoringHelper15.getHeight()), new Integer(startTabIndex.intValue() + 12), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT,Boolean.TRUE, Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, new Integer(3)}));
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		grdList.addIntColumn("Age Onset", 0, 0, 80, true, true, null, false, 0, true, 0);
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.FamilyHistory.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1003100056-ID", "ID_PatientFamilyHistory");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.FamilyHistory.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1003100056-RELATIONSHIP", "Relationship");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.FamilyHistory.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1003100056-RELATIVENAME", "RelativeName");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.FamilyHistory.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1003100056-RELATIVEDOB", "RelativeDOB");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.FamilyHistory.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1003100056-AGEATONSET", "AgeAtOnset");
			fields[152] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.FamilyHistory.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1003100056-RELATIVELIVING", "RelativeLiving");
			fields[153] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.FamilyHistory.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1003100056-AGEATDEATH", "AgeAtDeath");
			fields[154] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.FamilyHistory.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1003100056-NOTES", "Notes");
			fields[155] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.FamilyHistory.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1003100056-DIAGNOSISDESCRIPTION", "DiagnosisDescription");
			fields[156] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.FamilyHistory.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1003100056-PATIENT", "Patient");
			fields[157] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.FamilyHistory.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1003100056-CARECONTEXT", "CareContext");
			return fields;
		}
