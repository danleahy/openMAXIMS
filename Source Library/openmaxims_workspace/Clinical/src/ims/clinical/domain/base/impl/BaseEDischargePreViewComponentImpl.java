...
public abstract class BaseEDischargePreViewComponentImpl extends DomainImpl implements ims.clinical.domain.EDischargePreViewComponent, ims.domain.impl.Transactional
{
	...
	@SuppressWarnings("unused")
	public void validatesaveDischargeReportDetail(ims.clinical.vo.DischargeReportDetailVo record, ims.clinical.vo.DischargeReadyToLeaveVo voReady, ims.clinical.vo.RTLSummaryVo rTLSummaryVo, ims.core.vo.PatientNoDiagInfoForCCVo patientNoDiagInfo)
	{
		if(record == null)
	...
	@SuppressWarnings("unused")
	public void validatelistComorbidity(ims.core.admin.vo.EpisodeOfCareRefVo episodeofCareRefVo, ims.core.admin.vo.CareContextRefVo careContextRefVo)
	{
	}
	...
	@SuppressWarnings("unused")
	public void validategetRTLSummaryForCareContext(ims.core.admin.vo.CareContextRefVo careContextRef)
	{
	}
	...
	@SuppressWarnings("unused")
	public void validatelistDiagnoses(ims.core.admin.vo.EpisodeOfCareRefVo episodeofCareRefVo)
	{
	}

	@SuppressWarnings("unused")
	public void validategetDementia(ims.core.patient.vo.PatientRefVo patRef)
	{
	}

	@SuppressWarnings("unused")
	public void validatelistRelevComorbidity(ims.core.admin.vo.EpisodeOfCareRefVo episodeOfCareRefVo, ims.core.admin.vo.CareContextRefVo careContextRefVo)
	{
	}
}
