...
public abstract class BaseEDischargePatientReadyToLeaveComponentImpl extends DomainImpl implements ims.clinical.domain.EDischargePatientReadyToLeaveComponent, ims.domain.impl.Transactional
{
	...
	@SuppressWarnings("unused")
	public void validatesaveReadyToLeave(ims.clinical.vo.DischargeReadyToLeaveVo voReady, ims.clinical.vo.RTLSummaryVo rTLSummaryVo)
	{
	}
	...
	@SuppressWarnings("unused")
	public void validategetNurseEnabledDischargeInstructionFromFuturePlan(ims.core.admin.vo.CareContextRefVo careContextRef)
	{
	}
}
