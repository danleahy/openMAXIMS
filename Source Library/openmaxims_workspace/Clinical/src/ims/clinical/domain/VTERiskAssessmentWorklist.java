...
public interface VTERiskAssessmentWorklist extends ims.domain.DomainInterface
{
	...
	// Generated from form domain interface definition
	public ims.vo.interfaces.IVTERiskAssessment saveEpisode(ims.vo.interfaces.IVTERiskAssessment vteRiskAssessment, ims.clinical.vo.VTERemoveDeclineReasonVo removedReason) throws ims.domain.exceptions.StaleObjectException;

	// Generated from form domain interface definition
	public ims.clinical.vo.VTERiskAssessmentTCIVoCollection listFromTCI(ims.clinical.vo.VTERiskAssessmentWorklistCriteriaVo criteria);

	// Generated from form domain interface definition
	public ims.core.vo.VTEAssessmentConfigVo getVteConfig();
}
