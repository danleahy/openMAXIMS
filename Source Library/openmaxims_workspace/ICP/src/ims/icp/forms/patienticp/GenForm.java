...
public class GenForm extends FormBridge
{
	...
	public static class lyrMainLayer extends Layer
	{
		...
		public static class tabPageActionsContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				// Button Controls
				RuntimeAnchoring anchoringHelper2 = new RuntimeAnchoring(designSize, runtimeSize, 728, 7, 90, 23, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
				...
				RuntimeAnchoring anchoringHelper3 = new RuntimeAnchoring(designSize, runtimeSize, 632, 7, 90, 23, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
				...
				// CheckBox Controls
				RuntimeAnchoring anchoringHelper5 = new RuntimeAnchoring(designSize, runtimeSize, 432, 10, 88, 16, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
				...
				RuntimeAnchoring anchoringHelper6 = new RuntimeAnchoring(designSize, runtimeSize, 528, 10, 72, 16, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
				super.addControl(factory.getControl(CheckBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1005), new Integer(anchoringHelper6.getX()), new Integer(anchoringHelper6.getY()), new Integer(anchoringHelper6.getWidth()), new Integer(anchoringHelper6.getHeight()), new Integer(startTabIndex.intValue() + 4), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,"Completed", Boolean.TRUE, null}));
		
				// Dynamic Grid Controls
				RuntimeAnchoring anchoringHelper7 = new RuntimeAnchoring(designSize, runtimeSize, 8, 40, 810, 536, ims.framework.enumerations.ControlAnchoring.ALL);
				super.addControl(factory.getControl(DynamicGrid.class, new Object[] { control, new Integer(startControlID.intValue() + 1006), new Integer(anchoringHelper7.getX()), new Integer(anchoringHelper7.getY()), new Integer(anchoringHelper7.getWidth()), new Integer(anchoringHelper7.getHeight()), new Integer(-1), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, contextMenus.ICP.contextMenuActionMenu, Boolean.FALSE, Boolean.FALSE, Boolean.TRUE}));
			}
			...
			public CheckBox chkOutstandingAct()
			{
				return (CheckBox)super.getControl(4);
			}
			public CheckBox chkCompletedAct()
			{
		...
		public static class tabPageDetailsContainer extends LayerBridge
		{
			...
			public static class lyrICPLayer extends Layer
			{
				...
				public static class tabAssessmentContainer extends LayerBridge
				{
					...
					protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
					{
						...
						RuntimeAnchoring anchoringHelper8 = new RuntimeAnchoring(designSize, runtimeSize, 336, 440, 304, 64, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT);
						ims.framework.FormUiLogic m_authStructuredAssessmentCompletedForm = loader.loadComponent(102228, appForm, startControlID * 10 + 1000, anchoringHelper8.getSize(), instance1, -1, skipContextValidation);
						//ims.framework.Control m_authStructuredAssessmentCompletedControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1007), new Integer(336), new Integer(440), new Integer(304), new Integer(64), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, new Integer(-1), m_authStructuredAssessmentCompletedForm, instance1 } );
						...
						RuntimeAnchoring anchoringHelper9 = new RuntimeAnchoring(designSize, runtimeSize, 8, 440, 304, 64, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT);
						ims.framework.FormUiLogic m_authStructuredAssessmentForm = loader.loadComponent(102228, appForm, startControlID * 10 + 2000, anchoringHelper9.getSize(), instance2, -1, skipContextValidation);
						//ims.framework.Control m_authStructuredAssessmentControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1009), new Integer(8), new Integer(440), new Integer(304), new Integer(64), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, new Integer(-1), m_authStructuredAssessmentForm, instance2 } );
						...
						RuntimeAnchoring anchoringHelper10 = new RuntimeAnchoring(designSize, runtimeSize, 8, 40, 784, 392, ims.framework.enumerations.ControlAnchoring.ALL);
						ims.framework.FormUiLogic m_customStructuredAssessmentForm = loader.loadComponent(127109, appForm, startControlID * 10 + 3000, anchoringHelper10.getSize(), instance3, -1, skipContextValidation);
						//ims.framework.Control m_customStructuredAssessmentControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1011), new Integer(8), new Integer(40), new Integer(784), new Integer(392), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(-1), m_customStructuredAssessmentForm, instance3 } );
						...
						RuntimeAnchoring anchoringHelper11 = new RuntimeAnchoring(designSize, runtimeSize, 40, 8, 720, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT);
						...
						RuntimeAnchoring anchoringHelper12 = new RuntimeAnchoring(designSize, runtimeSize, 768, 8, 24, 23, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
						super.addControl(factory.getControl(ImageButton.class, new Object[] { control, new Integer(startControlID.intValue() + 1014), new Integer(anchoringHelper12.getX()), new Integer(anchoringHelper12.getY()), new Integer(anchoringHelper12.getWidth()), new Integer(anchoringHelper12.getHeight()), new Integer(startTabIndex.intValue() + 10), ControlState.DISABLED, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.TOPRIGHT, form_images_local.Core.HelpEnabled16, form_images_local.Core.HelpEnabled16, null, Boolean.FALSE, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null}));
						RuntimeAnchoring anchoringHelper13 = new RuntimeAnchoring(designSize, runtimeSize, 8, 8, 24, 23, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
				...
				public static class tabReportContainer extends LayerBridge
				{
					...
					protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
					{
						...
						// Custom Controls
						ims.framework.CustomComponent instance1 = factory.getEmptyCustomComponent();
						RuntimeAnchoring anchoringHelper14 = new RuntimeAnchoring(designSize, runtimeSize, 5, 5, 789, 495, ims.framework.enumerations.ControlAnchoring.ALL);
						ims.framework.FormUiLogic m_ccReportBuilderForm = loader.loadComponent(102275, appForm, startControlID * 10 + 4000, anchoringHelper14.getSize(), instance1, -1, skipContextValidation);
						//ims.framework.Control m_ccReportBuilderControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1016), new Integer(5), new Integer(5), new Integer(789), new Integer(495), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(-1), m_ccReportBuilderForm, instance1 } );
				...
				public static class tabGraphicAssessmentContainer extends LayerBridge
				{
					...
					protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
					{
						...
						ims.framework.CustomComponent instance2 = factory.getEmptyCustomComponent();
						RuntimeAnchoring anchoringHelper16 = new RuntimeAnchoring(designSize, runtimeSize, 8, 440, 304, 64, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT);
						ims.framework.FormUiLogic m_authGraphicalAssessmentForm = loader.loadComponent(102228, appForm, startControlID * 10 + 6000, anchoringHelper16.getSize(), instance2, -1, skipContextValidation);
						//ims.framework.Control m_authGraphicalAssessmentControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1020), new Integer(8), new Integer(440), new Integer(304), new Integer(64), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, new Integer(-1), m_authGraphicalAssessmentForm, instance2 } );
						...
						ims.framework.CustomComponent instance3 = factory.getEmptyCustomComponent();
						RuntimeAnchoring anchoringHelper17 = new RuntimeAnchoring(designSize, runtimeSize, 8, 40, 784, 392, ims.framework.enumerations.ControlAnchoring.ALL);
						ims.framework.FormUiLogic m_customGraphicalAssessmentForm = loader.loadComponent(127114, appForm, startControlID * 10 + 7000, anchoringHelper17.getSize(), instance3, -1, skipContextValidation);
						//ims.framework.Control m_customGraphicalAssessmentControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1022), new Integer(8), new Integer(40), new Integer(784), new Integer(392), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(-1), m_customGraphicalAssessmentForm, instance3 } );
						...
						// RecordBrowser Controls
						RuntimeAnchoring anchoringHelper18 = new RuntimeAnchoring(designSize, runtimeSize, 40, 8, 720, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT);
						...
						// Image Buttons Controls
						RuntimeAnchoring anchoringHelper19 = new RuntimeAnchoring(designSize, runtimeSize, 769, 8, 24, 23, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
						super.addControl(factory.getControl(ImageButton.class, new Object[] { control, new Integer(startControlID.intValue() + 1025), new Integer(anchoringHelper19.getX()), new Integer(anchoringHelper19.getY()), new Integer(anchoringHelper19.getWidth()), new Integer(anchoringHelper19.getHeight()), new Integer(startTabIndex.intValue() + 12), ControlState.DISABLED, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.TOPRIGHT, form_images_local.Core.HelpEnabled16, form_images_local.Core.HelpDisabled16, null, Boolean.FALSE, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null}));
						RuntimeAnchoring anchoringHelper20 = new RuntimeAnchoring(designSize, runtimeSize, 8, 8, 24, 23, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
				...
				public static class tabFormContainer extends LayerBridge
				{
					...
					protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
					{
						...
						RuntimeAnchoring anchoringHelper21 = new RuntimeAnchoring(designSize, runtimeSize, 6, 6, 790, 501, ims.framework.enumerations.ControlAnchoring.ALL);
						super.addControl(factory.getControl(DynamicForm.class, form, new Object[] { control, new Integer(startControlID.intValue() + 1027), new Integer(anchoringHelper21.getX()), new Integer(anchoringHelper21.getY()), new Integer(anchoringHelper21.getWidth()), new Integer(anchoringHelper21.getHeight()), new Integer(-1), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL}));
					}
				...
				public static class tabPageNoDetailsContainer extends LayerBridge
				{
					...
					protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
					{
						...
						// Label Controls
						RuntimeAnchoring anchoringHelper22 = new RuntimeAnchoring(designSize, runtimeSize, 24, 24, 216, 22, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
				...
				protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
				{
					...
					ims.framework.utils.SizeInfo m_tabAssessmentRuntimeSize = new ims.framework.utils.SizeInfo(anchoringHelper23.getWidth(), anchoringHelper23.getHeight());
					...
					ims.framework.utils.SizeInfo m_tabReportRuntimeSize = new ims.framework.utils.SizeInfo(anchoringHelper24.getWidth(), anchoringHelper24.getHeight());
					...
					ims.framework.utils.SizeInfo m_tabGraphicAssessmentRuntimeSize = new ims.framework.utils.SizeInfo(anchoringHelper25.getWidth(), anchoringHelper25.getHeight());
					...
					RuntimeAnchoring anchoringHelper26 = new RuntimeAnchoring(designSize, runtimeSize, 8, 8, 808, 536, ims.framework.enumerations.ControlAnchoring.ALL);
					...
					ims.framework.utils.SizeInfo m_tabFormRuntimeSize = new ims.framework.utils.SizeInfo(anchoringHelper26.getWidth(), anchoringHelper26.getHeight());
					...
					RuntimeAnchoring anchoringHelper27 = new RuntimeAnchoring(designSize, runtimeSize, 8, 8, 808, 536, ims.framework.enumerations.ControlAnchoring.ALL);
					...
					ims.framework.utils.SizeInfo m_tabPageNoDetailsRuntimeSize = new ims.framework.utils.SizeInfo(anchoringHelper27.getWidth(), anchoringHelper27.getHeight());
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				// Button Controls
				RuntimeAnchoring anchoringHelper28 = new RuntimeAnchoring(designSize, runtimeSize, 8, 552, 75, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT);
				super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1034), new Integer(anchoringHelper28.getX()), new Integer(anchoringHelper28.getY()), new Integer(anchoringHelper28.getWidth()), new Integer(anchoringHelper28.getHeight()), new Integer(startTabIndex.intValue() + 16), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "New", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
				RuntimeAnchoring anchoringHelper29 = new RuntimeAnchoring(designSize, runtimeSize, 88, 552, 75, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT);
				super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1035), new Integer(anchoringHelper29.getX()), new Integer(anchoringHelper29.getY()), new Integer(anchoringHelper29.getWidth()), new Integer(anchoringHelper29.getHeight()), new Integer(startTabIndex.intValue() + 13), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Edit", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
				RuntimeAnchoring anchoringHelper30 = new RuntimeAnchoring(designSize, runtimeSize, 272, 552, 75, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT);
				super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1036), new Integer(anchoringHelper30.getX()), new Integer(anchoringHelper30.getY()), new Integer(anchoringHelper30.getWidth()), new Integer(anchoringHelper30.getHeight()), new Integer(startTabIndex.intValue() + 15), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Close", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
				RuntimeAnchoring anchoringHelper31 = new RuntimeAnchoring(designSize, runtimeSize, 661, 552, 75, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT);
				super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1037), new Integer(anchoringHelper31.getX()), new Integer(anchoringHelper31.getY()), new Integer(anchoringHelper31.getWidth()), new Integer(anchoringHelper31.getHeight()), new Integer(startTabIndex.intValue() + 17), ControlState.HIDDEN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Save", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
				RuntimeAnchoring anchoringHelper32 = new RuntimeAnchoring(designSize, runtimeSize, 741, 552, 75, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT);
				super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1038), new Integer(anchoringHelper32.getX()), new Integer(anchoringHelper32.getY()), new Integer(anchoringHelper32.getWidth()), new Integer(anchoringHelper32.getHeight()), new Integer(startTabIndex.intValue() + 18), ControlState.HIDDEN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Cancel", Boolean.FALSE, null, Boolean.FALSE, Boolean.FALSE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		
				// CheckBox Controls
				RuntimeAnchoring anchoringHelper33 = new RuntimeAnchoring(designSize, runtimeSize, 576, 555, 72, 16, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT);
				super.addControl(factory.getControl(CheckBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1039), new Integer(anchoringHelper33.getX()), new Integer(anchoringHelper33.getY()), new Integer(anchoringHelper33.getWidth()), new Integer(anchoringHelper33.getHeight()), new Integer(startTabIndex.intValue() + 14), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT ,"Complete", Boolean.TRUE, null}));
			}
		...
		public static class tabPageClinicDetailsContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				// Custom Controls
				ims.framework.CustomComponent instance1 = factory.getEmptyCustomComponent();
				RuntimeAnchoring anchoringHelper34 = new RuntimeAnchoring(designSize, runtimeSize, 8, 32, 808, 544, ims.framework.enumerations.ControlAnchoring.ALL);
				ims.framework.FormUiLogic m_ccLinkedActionDetailsForm = loader.loadComponent(118121, appForm, startControlID * 10 + 8000, anchoringHelper34.getSize(), instance1, -1, skipContextValidation);
				//ims.framework.Control m_ccLinkedActionDetailsControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1040), new Integer(8), new Integer(32), new Integer(808), new Integer(544), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(-1), m_ccLinkedActionDetailsForm, instance1 } );
				...
				// RecordBrowser Controls
				RuntimeAnchoring anchoringHelper35 = new RuntimeAnchoring(designSize, runtimeSize, 8, 8, 808, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT);
				RecordBrowser m_recbrLinkedActionsTemp = (RecordBrowser)factory.getControl(RecordBrowser.class, new Object[] { control, new Integer(startControlID.intValue() + 1042), new Integer(anchoringHelper35.getX()), new Integer(anchoringHelper35.getY()), new Integer(anchoringHelper35.getWidth()), new Integer(anchoringHelper35.getHeight()), new Integer(-1), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT, null});
		...
		protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
		{
			...
			ims.framework.utils.SizeInfo m_tabPageActionsRuntimeSize = new ims.framework.utils.SizeInfo(anchoringHelper36.getWidth(), anchoringHelper36.getHeight());
			...
			ims.framework.utils.SizeInfo m_tabPageDetailsRuntimeSize = new ims.framework.utils.SizeInfo(anchoringHelper37.getWidth(), anchoringHelper37.getHeight());
			...
			ims.framework.utils.SizeInfo m_tabPageClinicDetailsRuntimeSize = new ims.framework.utils.SizeInfo(anchoringHelper38.getWidth(), anchoringHelper38.getHeight());
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		// Link Controls
		RuntimeAnchoring anchoringHelper39 = new RuntimeAnchoring(designSize, runtimeSize, 696, 0, 112, 17, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
		super.addControl(factory.getControl(Link.class, new Object[] { control, new Integer(startControlID.intValue() + 1046), new Integer(anchoringHelper39.getX()), new Integer(anchoringHelper39.getY()), new Integer(anchoringHelper39.getWidth()), new Integer(anchoringHelper39.getHeight()), new Integer(startTabIndex.intValue() + 1), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT,"<< Return to List", Boolean.FALSE, null}));
	}
	...
	public static class Images implements java.io.Serializable
	{
		...
		public final class ICPImages implements java.io.Serializable
		{
			...
			private ICPImages()
			{
				...
				NoAssociation_16 = new ImageHelper(118135, "Images/ICP/NoAssociation.png", new Integer(16), new Integer(16));
				DisciplineNoAction_16 = new ImageHelper(118132, "Images/ICP/DisciplineNoAction.gif", new Integer(16), new Integer(16));
			...
			public final ims.framework.utils.Image NoAssociation_16;
			public final ims.framework.utils.Image DisciplineNoAction_16;
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, "_cv_ICP.ActionStatus", "BO-1100100006-ID", "ID_PatientICPActionStatus");
			fields[145] = new ims.framework.ReportField(this.context, "_cv_ICP.ActionStatus", "BO-1100100006-STATUSDATE", "StatusDate");
			fields[146] = new ims.framework.ReportField(this.context, "_cv_ICP.ActionStatus", "BO-1100100006-STATUS", "Status");
			fields[147] = new ims.framework.ReportField(this.context, "_cv_ICP.ActionStatus", "BO-1100100006-VARIANCECATEGORY", "VarianceCategory");
			fields[148] = new ims.framework.ReportField(this.context, "_cv_ICP.ActionStatus", "BO-1100100006-VARIANCETYPE", "VarianceType");
			fields[149] = new ims.framework.ReportField(this.context, "_cv_ICP.ActionStatus", "BO-1100100006-VARIANCECOMMENT", "VarianceComment");
			fields[150] = new ims.framework.ReportField(this.context, "_cv_ICP.EvaluationNote", "BO-1100100008-ID", "ID_PatientICPEvaluationNote");
			fields[151] = new ims.framework.ReportField(this.context, "_cv_ICP.PatientICPRecord", "BO-1100100000-ID", "ID_PatientICP");
			fields[152] = new ims.framework.ReportField(this.context, "_cv_ICP.PatientCriticalEvent", "BO-1100100007-ID", "ID_PatientCriticalEvents");
			fields[153] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICP.__internal_x_context__CurrentPatientAssessment_" + componentIdentifier, "BO-1003100048-ID", "ID_PatientAssessment");
			fields[154] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICP.__internal_x_context__CurrentPatientAssessment_" + componentIdentifier, "BO-1003100048-STATUS", "Status");
			fields[155] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICP.__internal_x_context__CurrentPatientAssessment_" + componentIdentifier, "BO-1003100048-COMPLETEDDATETIME", "CompletedDateTime");
			fields[156] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICP.__internal_x_context__CurrentPatientAssessment_" + componentIdentifier, "BO-1003100048-STATUSREASON", "StatusReason");
			fields[157] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICP.__internal_x_context__CurrentPatientAssessment_" + componentIdentifier, "BO-1003100048-STATUSREASONTEXT", "StatusReasonText");
			fields[158] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICP.__internal_x_context__CurrentPatientAssessment_" + componentIdentifier, "BO-1003100048-DPPTYPE", "DPPType");
			fields[159] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICP.__internal_x_context__CurrentPatientAssessment_" + componentIdentifier, "BO-1003100048-DPPTYPETEXT", "DPPTypeText");
			fields[160] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICP.__internal_x_context__CurrentPatientAssessment_" + componentIdentifier, "BO-1003100048-ISCURRENTFORTYPE", "IsCurrentForType");
			fields[161] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICP.__internal_x_context__CurrentPatientAssessment_" + componentIdentifier, "BO-1003100048-CLINICALCONTACT", "ClinicalContact");
			fields[162] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICP.__internal_x_context__CurrentPatientAssessment_" + componentIdentifier, "BO-1003100048-CARECONTEXT", "CareContext");
			fields[163] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICP.__internal_x_context__CurrentPatientAssessment_" + componentIdentifier, "BO-1003100048-EPISODEOFCARE", "EpisodeOfCare");
			fields[164] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICP.__internal_x_context__CurrentPatientAssessment_" + componentIdentifier, "BO-1003100048-PATIENT", "Patient");
			fields[165] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICP.__internal_x_context__CurrentPatientAssessment_" + componentIdentifier, "BO-1003100048-SCORE", "Score");
			fields[166] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICP.__internal_x_context__CurrentPatientAssessment_" + componentIdentifier, "BO-1003100048-ISASSESSMENTDOCUMENTSAVED", "IsAssessmentDocumentSaved");
			fields[167] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICP.__internal_x_context__StructuralAssessment_" + componentIdentifier, "BO-1003100043-ID", "ID_UserAssessment");
			fields[168] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICP.__internal_x_context__StructuralAssessment_" + componentIdentifier, "BO-1003100043-NAME", "Name");
			fields[169] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICP.__internal_x_context__StructuralAssessment_" + componentIdentifier, "BO-1003100043-DESCRIPTION", "Description");
			fields[170] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICP.__internal_x_context__StructuralAssessment_" + componentIdentifier, "BO-1003100043-ASSESSMENTTYPE", "AssessmentType");
			fields[171] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICP.__internal_x_context__StructuralAssessment_" + componentIdentifier, "BO-1003100043-ACTIVESTATUS", "ActiveStatus");
			fields[172] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICP.__internal_x_context__StructuralAssessment_" + componentIdentifier, "BO-1003100043-HELPURL", "HelpURL");
			fields[173] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICP.__internal_x_context__StructuralAssessment_" + componentIdentifier, "BO-1003100043-SCORINGMETHOD", "ScoringMethod");
			fields[174] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICP.__internal_x_context__StructuralAssessment_" + componentIdentifier, "BO-1003100043-ISFLATVIEW", "IsFlatView");
			fields[175] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICP.__internal_x_context__StructuralAssessment_" + componentIdentifier, "BO-1003100043-CATEGORY", "Category");
			fields[176] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICP.__internal_x_context__StructuralAssessment_" + componentIdentifier, "BO-1003100043-ISMULTIPLEGROUP", "IsMultipleGroup");
			fields[177] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICP.__internal_x_context__StructuralAssessment_" + componentIdentifier, "BO-1003100043-GROUPQUESTIONWIDTH", "GroupQuestionWidth");
			fields[178] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICP.__internal_x_context__StructuralAssessment_" + componentIdentifier, "BO-1003100043-STOREPRINTEDASSESSMENT", "StorePrintedAssessment");
			fields[179] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICP.__internal_x_context__StructuralAssessment_" + componentIdentifier, "BO-1003100043-ISMULTIROLE", "IsMultiRole");
			fields[180] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICP.__internal_x_context__StructuralAssessment_" + componentIdentifier, "BO-1003100043-HEADERTEXT", "HeaderText");
			fields[181] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICP.__internal_x_context__StructuralAssessment_" + componentIdentifier, "BO-1003100043-FOOTERTEXT", "FooterText");
			fields[182] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICP.__internal_x_context__StructuralAssessment_" + componentIdentifier, "BO-1003100043-MAXHEADERHEIGHT", "MaxHeaderHeight");
			fields[183] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICP.__internal_x_context__StructuralAssessment_" + componentIdentifier, "BO-1003100043-MAXFOOTERHEIGHT", "MaxFooterHeight");
			fields[184] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICP.__internal_x_context__StructuralAssessment_" + componentIdentifier, "BO-1003100043-ASSOCIATEDREPORT", "AssociatedReport");
			fields[185] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICP.__internal_x_context__StructuralAssessment_" + componentIdentifier, "BO-1003100043-CANCOPYLAST", "CanCopyLast");
			fields[186] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICP.__internal_x_context__StructuralAssessment_" + componentIdentifier, "BO-1003100043-COPYLASTFROMCONTEXT", "CopyLastFromContext");
			fields[187] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICP.__internal_x_context__SelectedAction_" + componentIdentifier, "BO-1100100004-ID", "ID_PatientICPAction");
			fields[188] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICP.__internal_x_context__SelectedAction_" + componentIdentifier, "BO-1100100004-REQUIRESCOUNTERSIGNING", "RequiresCounterSigning");
			fields[189] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICP.__internal_x_context__GraphicalAssessment_" + componentIdentifier, "BO-1028100006-ID", "ID_GraphicAssessment");
			fields[190] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICP.__internal_x_context__GraphicalAssessment_" + componentIdentifier, "BO-1028100006-NAME", "Name");
			fields[191] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICP.__internal_x_context__GraphicalAssessment_" + componentIdentifier, "BO-1028100006-ASSESSMENTTYPE", "AssessmentType");
			fields[192] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICP.__internal_x_context__GraphicalAssessment_" + componentIdentifier, "BO-1028100006-ACTIVESTATUS", "ActiveStatus");
			fields[193] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICP.__internal_x_context__GraphicalAssessment_" + componentIdentifier, "BO-1028100006-HELPURL", "HelpUrl");
			fields[194] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICP.__internal_x_context__GraphicalAssessment_" + componentIdentifier, "BO-1028100006-STOREPRINTEDREPORT", "StorePrintedReport");
			fields[195] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICP.__internal_x_context__GraphicalAssessment_" + componentIdentifier, "BO-1028100006-ASSOCIATEDREPORTFORPRINTING", "AssociatedReportForPrinting");
			fields[196] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICP.__internal_x_context__CurrentPatientICP_" + componentIdentifier, "BO-1100100000-ID", "ID_PatientICP");
			fields[197] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICP.__internal_x_context__CurrentPatientICP_" + componentIdentifier, "BO-1100100000-HASOUTSTANDINGADMINACTIONS", "HasOutstandingAdminActions");
			fields[198] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICP.__internal_x_context__CurrentPatientICP_" + componentIdentifier, "BO-1100100000-HASOUTSTANDINGNURSINGACTIONS", "HasOutstandingNursingActions");
			fields[199] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICP.__internal_x_context__CurrentPatientICP_" + componentIdentifier, "BO-1100100000-HASOUTSTANDINGPHYSIOACTIONS", "HasOutstandingPhysioActions");
			fields[200] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICP.__internal_x_context__CurrentPatientICP_" + componentIdentifier, "BO-1100100000-HASOUTSTANDINGCLINICALACTIONS", "HasOutstandingClinicalActions");
			fields[201] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICP.__internal_x_context__CurrentPatientICP_" + componentIdentifier, "BO-1100100000-COMPLETEDDATETIME", "CompletedDateTime");
			fields[202] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICP.__internal_x_context__CurrentPatientICP_" + componentIdentifier, "BO-1100100000-ICP", "ICP");
			fields[203] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICP.__internal_x_context__ConfigurationICP_" + componentIdentifier, "BO-1060100000-ID", "ID_ICP");
			fields[204] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICP.__internal_x_context__ConfigurationICP_" + componentIdentifier, "BO-1060100000-NAME", "Name");
			fields[205] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICP.__internal_x_context__ConfigurationICP_" + componentIdentifier, "BO-1060100000-DESCRIPTION", "Description");
			fields[206] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICP.__internal_x_context__ConfigurationICP_" + componentIdentifier, "BO-1060100000-STATUS", "Status");
			fields[207] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICP.__internal_x_context__LoggedInHcp_" + componentIdentifier, "BO-1006100000-ID", "ID_Hcp");
			return fields;
		}
