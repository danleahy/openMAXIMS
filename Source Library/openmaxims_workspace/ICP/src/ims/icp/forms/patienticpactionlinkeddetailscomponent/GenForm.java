...
public class GenForm extends FormBridge
{
	...
	public static class lyrMainLayer extends Layer
	{
		...
		public static class tabPageAssessmentContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				ims.framework.FormUiLogic m_authStructuredAssessmentCompletedForm = loader.loadComponent(102228, appForm, startControlID * 10 + 2000, anchoringHelper3.getSize(), instance2, startTabIndex.intValue() + 10, skipContextValidation);
				//ims.framework.Control m_authStructuredAssessmentCompletedControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1003), new Integer(312), new Integer(440), new Integer(300), new Integer(56), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, new Integer(startTabIndex.intValue() + 10), m_authStructuredAssessmentCompletedForm, instance2 } );
				ims.framework.Control m_authStructuredAssessmentCompletedControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1004),  new Integer(anchoringHelper3.getX()), new Integer(anchoringHelper3.getY()), new Integer(anchoringHelper3.getWidth()), new Integer(anchoringHelper3.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, new Integer(startTabIndex.intValue() + 10), m_authStructuredAssessmentCompletedForm, instance2, Boolean.TRUE } );
				...
				ims.framework.FormUiLogic m_authStructuredAssessmentForm = loader.loadComponent(102228, appForm, startControlID * 10 + 3000, anchoringHelper4.getSize(), instance3, startTabIndex.intValue() + 7, skipContextValidation);
				//ims.framework.Control m_authStructuredAssessmentControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1005), new Integer(8), new Integer(440), new Integer(300), new Integer(56), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, new Integer(startTabIndex.intValue() + 7), m_authStructuredAssessmentForm, instance3 } );
				ims.framework.Control m_authStructuredAssessmentControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1006),  new Integer(anchoringHelper4.getX()), new Integer(anchoringHelper4.getY()), new Integer(anchoringHelper4.getWidth()), new Integer(anchoringHelper4.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, new Integer(startTabIndex.intValue() + 7), m_authStructuredAssessmentForm, instance3, Boolean.TRUE } );
		...
		public static class tabPageGraphicalAssessmentContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				ims.framework.FormUiLogic m_authGraphicalAssessmentCompletedForm = loader.loadComponent(102228, appForm, startControlID * 10 + 4000, anchoringHelper8.getSize(), instance1, startTabIndex.intValue() + 30, skipContextValidation);
				//ims.framework.Control m_authGraphicalAssessmentCompletedControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1010), new Integer(312), new Integer(440), new Integer(300), new Integer(56), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, new Integer(startTabIndex.intValue() + 30), m_authGraphicalAssessmentCompletedForm, instance1 } );
				ims.framework.Control m_authGraphicalAssessmentCompletedControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1011),  new Integer(anchoringHelper8.getX()), new Integer(anchoringHelper8.getY()), new Integer(anchoringHelper8.getWidth()), new Integer(anchoringHelper8.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, new Integer(startTabIndex.intValue() + 30), m_authGraphicalAssessmentCompletedForm, instance1, Boolean.FALSE } );
				...
				ims.framework.FormUiLogic m_authGraphicalAssessmentForm = loader.loadComponent(102228, appForm, startControlID * 10 + 5000, anchoringHelper9.getSize(), instance2, startTabIndex.intValue() + 27, skipContextValidation);
				//ims.framework.Control m_authGraphicalAssessmentControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1012), new Integer(8), new Integer(440), new Integer(300), new Integer(56), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, new Integer(startTabIndex.intValue() + 27), m_authGraphicalAssessmentForm, instance2 } );
				ims.framework.Control m_authGraphicalAssessmentControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1013),  new Integer(anchoringHelper9.getX()), new Integer(anchoringHelper9.getY()), new Integer(anchoringHelper9.getWidth()), new Integer(anchoringHelper9.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, new Integer(startTabIndex.intValue() + 27), m_authGraphicalAssessmentForm, instance2, Boolean.FALSE } );
				...
				ims.framework.FormUiLogic m_ccGraphicalAssessmentForm = loader.loadComponent(127114, appForm, startControlID * 10 + 6000, anchoringHelper10.getSize(), instance3, startTabIndex.intValue() + 16, skipContextValidation);
				//ims.framework.Control m_ccGraphicalAssessmentControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1014), new Integer(0), new Integer(32), new Integer(774), new Integer(408), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 16), m_ccGraphicalAssessmentForm, instance3 } );
				ims.framework.Control m_ccGraphicalAssessmentControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1015),  new Integer(anchoringHelper10.getX()), new Integer(anchoringHelper10.getY()), new Integer(anchoringHelper10.getWidth()), new Integer(anchoringHelper10.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 16), m_ccGraphicalAssessmentForm, instance3, Boolean.FALSE } );
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1027), new Integer(anchoringHelper21.getX()), new Integer(anchoringHelper21.getY()), new Integer(anchoringHelper21.getWidth()), new Integer(anchoringHelper21.getHeight()), new Integer(startTabIndex.intValue() + 37), ControlState.HIDDEN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Cancel", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1028), new Integer(anchoringHelper22.getX()), new Integer(anchoringHelper22.getY()), new Integer(anchoringHelper22.getWidth()), new Integer(anchoringHelper22.getHeight()), new Integer(startTabIndex.intValue() + 36), ControlState.HIDDEN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Save", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1029), new Integer(anchoringHelper23.getX()), new Integer(anchoringHelper23.getY()), new Integer(anchoringHelper23.getWidth()), new Integer(anchoringHelper23.getHeight()), new Integer(startTabIndex.intValue() + 34), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Edit", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1030), new Integer(anchoringHelper24.getX()), new Integer(anchoringHelper24.getY()), new Integer(anchoringHelper24.getWidth()), new Integer(anchoringHelper24.getHeight()), new Integer(startTabIndex.intValue() + 33), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "New", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(CheckBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1031), new Integer(anchoringHelper25.getX()), new Integer(anchoringHelper25.getY()), new Integer(anchoringHelper25.getWidth()), new Integer(anchoringHelper25.getHeight()), new Integer(startTabIndex.intValue() + 35), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT ,"Complete", Boolean.TRUE, null}));
	}
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICPActionLinkedDetailsComponent.__internal_x_context__PatientICPAction_" + componentIdentifier, "BO-1100100004-ID", "ID_PatientICPAction");
			fields[145] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICPActionLinkedDetailsComponent.__internal_x_context__PatientICPAction_" + componentIdentifier, "BO-1100100004-PATIENT", "Patient");
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICPActionLinkedDetailsComponent.__internal_x_context__PatientICPAction_" + componentIdentifier, "BO-1100100004-CARECONTEXT", "CareContext");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICPActionLinkedDetailsComponent.__internal_x_context__PatientICPAction_" + componentIdentifier, "BO-1100100004-ICP", "ICP");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICPActionLinkedDetailsComponent.__internal_x_context__PatientICPAction_" + componentIdentifier, "BO-1100100004-COMPLETEDONDATE", "CompletedOnDate");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICPActionLinkedDetailsComponent.__internal_x_context__PatientICPAction_" + componentIdentifier, "BO-1100100004-PARENTPHASE", "ParentPhase");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICPActionLinkedDetailsComponent.__internal_x_context__PatientICPAction_" + componentIdentifier, "BO-1100100004-REQUIRESCOUNTERSIGNING", "RequiresCounterSigning");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICPActionLinkedDetailsComponent.__internal_x_context__SelectedPatientAssessment_" + componentIdentifier, "BO-1003100048-ID", "ID_PatientAssessment");
			fields[152] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICPActionLinkedDetailsComponent.__internal_x_context__SelectedPatientAssessment_" + componentIdentifier, "BO-1003100048-STATUS", "Status");
			fields[153] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICPActionLinkedDetailsComponent.__internal_x_context__SelectedPatientAssessment_" + componentIdentifier, "BO-1003100048-COMPLETEDDATETIME", "CompletedDateTime");
			fields[154] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICPActionLinkedDetailsComponent.__internal_x_context__SelectedPatientAssessment_" + componentIdentifier, "BO-1003100048-STATUSREASON", "StatusReason");
			fields[155] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICPActionLinkedDetailsComponent.__internal_x_context__SelectedPatientAssessment_" + componentIdentifier, "BO-1003100048-STATUSREASONTEXT", "StatusReasonText");
			fields[156] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICPActionLinkedDetailsComponent.__internal_x_context__SelectedPatientAssessment_" + componentIdentifier, "BO-1003100048-DPPTYPE", "DPPType");
			fields[157] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICPActionLinkedDetailsComponent.__internal_x_context__SelectedPatientAssessment_" + componentIdentifier, "BO-1003100048-DPPTYPETEXT", "DPPTypeText");
			fields[158] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICPActionLinkedDetailsComponent.__internal_x_context__SelectedPatientAssessment_" + componentIdentifier, "BO-1003100048-ISCURRENTFORTYPE", "IsCurrentForType");
			fields[159] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICPActionLinkedDetailsComponent.__internal_x_context__SelectedPatientAssessment_" + componentIdentifier, "BO-1003100048-CLINICALCONTACT", "ClinicalContact");
			fields[160] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICPActionLinkedDetailsComponent.__internal_x_context__SelectedPatientAssessment_" + componentIdentifier, "BO-1003100048-CARECONTEXT", "CareContext");
			fields[161] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICPActionLinkedDetailsComponent.__internal_x_context__SelectedPatientAssessment_" + componentIdentifier, "BO-1003100048-EPISODEOFCARE", "EpisodeOfCare");
			fields[162] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICPActionLinkedDetailsComponent.__internal_x_context__SelectedPatientAssessment_" + componentIdentifier, "BO-1003100048-PATIENT", "Patient");
			fields[163] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICPActionLinkedDetailsComponent.__internal_x_context__SelectedPatientAssessment_" + componentIdentifier, "BO-1003100048-SCORE", "Score");
			fields[164] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICPActionLinkedDetailsComponent.__internal_x_context__SelectedPatientAssessment_" + componentIdentifier, "BO-1003100048-ISASSESSMENTDOCUMENTSAVED", "IsAssessmentDocumentSaved");
			fields[165] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICPActionLinkedDetailsComponent.__internal_x_context__SelectedPatientGraphicalAssessment_" + componentIdentifier, "BO-1003100048-ID", "ID_PatientAssessment");
			fields[166] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICPActionLinkedDetailsComponent.__internal_x_context__SelectedPatientGraphicalAssessment_" + componentIdentifier, "BO-1003100048-STATUS", "Status");
			fields[167] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICPActionLinkedDetailsComponent.__internal_x_context__SelectedPatientGraphicalAssessment_" + componentIdentifier, "BO-1003100048-COMPLETEDDATETIME", "CompletedDateTime");
			fields[168] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICPActionLinkedDetailsComponent.__internal_x_context__SelectedPatientGraphicalAssessment_" + componentIdentifier, "BO-1003100048-STATUSREASON", "StatusReason");
			fields[169] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICPActionLinkedDetailsComponent.__internal_x_context__SelectedPatientGraphicalAssessment_" + componentIdentifier, "BO-1003100048-STATUSREASONTEXT", "StatusReasonText");
			fields[170] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICPActionLinkedDetailsComponent.__internal_x_context__SelectedPatientGraphicalAssessment_" + componentIdentifier, "BO-1003100048-DPPTYPE", "DPPType");
			fields[171] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICPActionLinkedDetailsComponent.__internal_x_context__SelectedPatientGraphicalAssessment_" + componentIdentifier, "BO-1003100048-DPPTYPETEXT", "DPPTypeText");
			fields[172] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICPActionLinkedDetailsComponent.__internal_x_context__SelectedPatientGraphicalAssessment_" + componentIdentifier, "BO-1003100048-ISCURRENTFORTYPE", "IsCurrentForType");
			fields[173] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICPActionLinkedDetailsComponent.__internal_x_context__SelectedPatientGraphicalAssessment_" + componentIdentifier, "BO-1003100048-CLINICALCONTACT", "ClinicalContact");
			fields[174] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICPActionLinkedDetailsComponent.__internal_x_context__SelectedPatientGraphicalAssessment_" + componentIdentifier, "BO-1003100048-CARECONTEXT", "CareContext");
			fields[175] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICPActionLinkedDetailsComponent.__internal_x_context__SelectedPatientGraphicalAssessment_" + componentIdentifier, "BO-1003100048-EPISODEOFCARE", "EpisodeOfCare");
			fields[176] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICPActionLinkedDetailsComponent.__internal_x_context__SelectedPatientGraphicalAssessment_" + componentIdentifier, "BO-1003100048-PATIENT", "Patient");
			fields[177] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICPActionLinkedDetailsComponent.__internal_x_context__SelectedPatientGraphicalAssessment_" + componentIdentifier, "BO-1003100048-SCORE", "Score");
			fields[178] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICPActionLinkedDetailsComponent.__internal_x_context__SelectedPatientGraphicalAssessment_" + componentIdentifier, "BO-1003100048-ISASSESSMENTDOCUMENTSAVED", "IsAssessmentDocumentSaved");
			fields[179] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICPActionLinkedDetailsComponent.__internal_x_context__CareContext_" + componentIdentifier, "BO-1004100019-ID", "ID_CareContext");
			fields[180] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICPActionLinkedDetailsComponent.__internal_x_context__CareContext_" + componentIdentifier, "BO-1004100019-CONTEXT", "Context");
			fields[181] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICPActionLinkedDetailsComponent.__internal_x_context__CareContext_" + componentIdentifier, "BO-1004100019-ORDERINGHOSPITAL", "OrderingHospital");
			fields[182] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICPActionLinkedDetailsComponent.__internal_x_context__CareContext_" + componentIdentifier, "BO-1004100019-ESTIMATEDDISCHARGEDATE", "EstimatedDischargeDate");
			fields[183] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICPActionLinkedDetailsComponent.__internal_x_context__CareContext_" + componentIdentifier, "BO-1004100019-STARTDATETIME", "StartDateTime");
			fields[184] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICPActionLinkedDetailsComponent.__internal_x_context__CareContext_" + componentIdentifier, "BO-1004100019-ENDDATETIME", "EndDateTime");
			fields[185] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICPActionLinkedDetailsComponent.__internal_x_context__CareContext_" + componentIdentifier, "BO-1004100019-LOCATIONTYPE", "LocationType");
			fields[186] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICPActionLinkedDetailsComponent.__internal_x_context__CareContext_" + componentIdentifier, "BO-1004100019-RESPONSIBLEHCP", "ResponsibleHCP");
			fields[187] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICPActionLinkedDetailsComponent.__internal_x_context__ClinicalContact_" + componentIdentifier, "BO-1004100003-ID", "ID_ClinicalContact");
			fields[188] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICPActionLinkedDetailsComponent.__internal_x_context__ClinicalContact_" + componentIdentifier, "BO-1004100003-SPECIALTY", "Specialty");
			fields[189] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICPActionLinkedDetailsComponent.__internal_x_context__ClinicalContact_" + componentIdentifier, "BO-1004100003-CONTACTTYPE", "ContactType");
			fields[190] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICPActionLinkedDetailsComponent.__internal_x_context__ClinicalContact_" + componentIdentifier, "BO-1004100003-STARTDATETIME", "StartDateTime");
			fields[191] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICPActionLinkedDetailsComponent.__internal_x_context__ClinicalContact_" + componentIdentifier, "BO-1004100003-ENDDATETIME", "EndDateTime");
			fields[192] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICPActionLinkedDetailsComponent.__internal_x_context__ClinicalContact_" + componentIdentifier, "BO-1004100003-CARECONTEXT", "CareContext");
			fields[193] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICPActionLinkedDetailsComponent.__internal_x_context__ClinicalContact_" + componentIdentifier, "BO-1004100003-ISCLINICALNOTECREATED", "IsClinicalNoteCreated");
			return fields;
		}
