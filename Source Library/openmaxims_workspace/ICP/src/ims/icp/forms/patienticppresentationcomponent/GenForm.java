...
public class GenForm extends FormBridge
{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		super.addControl(factory.getControl(ImageButton.class, new Object[] { control, new Integer(startControlID.intValue() + 1007), new Integer(anchoringHelper8.getX()), new Integer(anchoringHelper8.getY()), new Integer(anchoringHelper8.getWidth()), new Integer(anchoringHelper8.getHeight()), new Integer(startTabIndex.intValue() + 15), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, this.getImages().Core.Minus, this.getImages().Core.MinusDisabled, "Remove Stage From Scope", Boolean.TRUE, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null}));
		...
		super.addControl(factory.getControl(ImageButton.class, new Object[] { control, new Integer(startControlID.intValue() + 1008), new Integer(anchoringHelper9.getX()), new Integer(anchoringHelper9.getY()), new Integer(anchoringHelper9.getWidth()), new Integer(anchoringHelper9.getHeight()), new Integer(startTabIndex.intValue() + 16), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, this.getImages().Core.Plus, this.getImages().Core.PlusDisabled, "Bring Phase Into Scope", Boolean.TRUE, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null}));
		...
		super.addControl(factory.getControl(ImageButton.class, new Object[] { control, new Integer(startControlID.intValue() + 1009), new Integer(anchoringHelper10.getX()), new Integer(anchoringHelper10.getY()), new Integer(anchoringHelper10.getWidth()), new Integer(anchoringHelper10.getHeight()), new Integer(startTabIndex.intValue() + 17), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, this.getImages().Core.Minus, this.getImages().Core.MinusDisabled, "Remove Phase From Scope", Boolean.TRUE, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null}));
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[150] = new ims.framework.ReportField(this.context, "_cv_ICP.PatientCriticalEvent", "BO-1100100007-ID", "ID_PatientCriticalEvents");
			fields[151] = new ims.framework.ReportField(this.context, "_cv_ICP.EvaluationNote", "BO-1100100008-ID", "ID_PatientICPEvaluationNote");
			fields[152] = new ims.framework.ReportField(this.context, "_cv_ICP.PatientICPRecord", "BO-1100100000-ID", "ID_PatientICP");
			fields[153] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICPPresentationComponent.__internal_x_context__ICP_" + componentIdentifier, "BO-1100100000-ID", "ID_PatientICP");
			fields[154] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICPPresentationComponent.__internal_x_context__ICP_" + componentIdentifier, "BO-1100100000-STARTEDDATETIME", "StartedDateTime");
			fields[155] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICPPresentationComponent.__internal_x_context__ICP_" + componentIdentifier, "BO-1100100000-COMPLETEDDATETIME", "CompletedDateTime");
			fields[156] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICPPresentationComponent.__internal_x_context__ICP_" + componentIdentifier, "BO-1100100000-HASOUTSTANDINGCLINICALACTIONS", "HasOutstandingClinicalActions");
			fields[157] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICPPresentationComponent.__internal_x_context__ICP_" + componentIdentifier, "BO-1100100000-HASOUTSTANDINGNURSINGACTIONS", "HasOutstandingNursingActions");
			fields[158] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICPPresentationComponent.__internal_x_context__ICP_" + componentIdentifier, "BO-1100100000-HASOUTSTANDINGPHYSIOACTIONS", "HasOutstandingPhysioActions");
			fields[159] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICPPresentationComponent.__internal_x_context__ICP_" + componentIdentifier, "BO-1100100000-HASOUTSTANDINGADMINACTIONS", "HasOutstandingAdminActions");
			fields[160] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICPPresentationComponent.__internal_x_context__LoggedInUser_" + componentIdentifier, "BO-1006100000-ID", "ID_Hcp");
			fields[161] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICPPresentationComponent.__internal_x_context__LoggedInUser_" + componentIdentifier, "BO-1006100000-HCPTYPE", "HcpType");
			fields[162] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICPPresentationComponent.__internal_x_context__LoggedInUser_" + componentIdentifier, "BO-1006100000-ISACTIVE", "IsActive");
			fields[163] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICPPresentationComponent.__internal_x_context__LoggedInUser_" + componentIdentifier, "BO-1006100000-ISHCPARESPONSIBLEHCP", "IsHCPaResponsibleHCP");
			fields[164] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICPPresentationComponent.__internal_x_context__LoggedInUser_" + componentIdentifier, "BO-1006100000-ISARESPONSIBLEEDCLINICIAN", "IsAResponsibleEDClinician");
			fields[165] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICPPresentationComponent.__internal_x_context__LoggedInUser_" + componentIdentifier, "BO-1006100000-ISHCPAENDOSCOPIST", "IsHCPaEndoscopist");
			fields[166] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICPPresentationComponent.__internal_x_context__Action_" + componentIdentifier, "BO-1100100004-ID", "ID_PatientICPAction");
			fields[167] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICPPresentationComponent.__internal_x_context__Action_" + componentIdentifier, "BO-1100100004-ICP", "ICP");
			fields[168] = new ims.framework.ReportField(this.context, prefix + "_lv_ICP.PatientICPPresentationComponent.__internal_x_context__Action_" + componentIdentifier, "BO-1100100004-REQUIRESCOUNTERSIGNING", "RequiresCounterSigning");
			return fields;
		}
