...
public interface HL7PathwayIf extends ims.domain.DomainInterface
{
	...
	*/
	...
	// Generated from form domain interface definition
	public ims.pathways.vo.PatientEventVo instantiatePatientEvent(ims.pathways.vo.PatientEventVo patientEvent, String eventTargetPASMappingValue) throws ims.domain.exceptions.DomainInterfaceException, ims.domain.exceptions.StaleObjectException;

	// Generated from form domain interface definition
	/**
	* This method will take the target out of scope
	*/
	public void takeTargetOutOfScopeWithoutEvent(ims.pathways.configuration.vo.TargetRefVo target, ims.pathways.vo.PatientPathwayJourneyRefVo journey) throws ims.domain.exceptions.DomainInterfaceException, ims.domain.exceptions.StaleObjectException;

	// Generated from form domain interface definition
	public ims.pathways.vo.PatientEventVo instantiatePatientEvent(ims.pathways.vo.PatientEventVo patientEvent, String eventTargetPASMappingValue, Boolean rTTClockImpact) throws ims.domain.exceptions.DomainInterfaceException, ims.domain.exceptions.StaleObjectException;

	// Generated from form domain interface definition
	/**
	* Method to update Patient Journey information when Referral Received DAte is modified
	*/
	public void updateJourneyFromReferralDateChange(ims.pathways.vo.PatientPathwayJourneyRefVo journey, ims.framework.utils.Date originalReferralReceivedDate, ims.framework.utils.Date newReferralReceivedDate) throws ims.domain.exceptions.StaleObjectException;

	// Generated from form domain interface definition
	/**
	* Used from PatientJourney form to load bring a target into scope without instantiating a PatientEvent
	*/
	public Boolean bringTargetIntoScopeWithoutEvent(ims.pathways.configuration.vo.TargetRefVo target, ims.pathways.vo.PatientPathwayJourneyRefVo journey, ims.framework.utils.Date eventDateTime) throws ims.domain.exceptions.DomainInterfaceException, ims.domain.exceptions.StaleObjectException;

	// Generated from form domain interface definition
	/**
	* Used from PatientJourney form to load bring a target into scope without instantiating a PatientEvent
	*/
	public Boolean bringTargetIntoScopeWithoutEvent(ims.pathways.domain.objects.PatientPathwayJourney journey, ims.pathways.configuration.domain.objects.PathwayTarget pathwayTarget, ims.pathways.configuration.domain.objects.Target target, ims.framework.utils.DateTime eventDateTime, Integer targetPeriod) throws ims.domain.exceptions.DomainInterfaceException, ims.domain.exceptions.StaleObjectException;

	// Generated from form domain interface definition
	public void takeTargetOutOfScopeWithoutEvent(ims.pathways.vo.PatientJourneyTargetRefVo target, ims.pathways.vo.PatientPathwayJourneyRefVo journey) throws ims.domain.exceptions.DomainInterfaceException, ims.domain.exceptions.StaleObjectException;

	// Generated from form domain interface definition
	/**
	* Pass CatsReferral to the method if available
	*/
	public ims.pathways.vo.PatientEventVo instantiatePatientEvent(ims.pathways.vo.PatientEventVo patientEvent, ims.RefMan.vo.CatsReferralRefVo catsReferral) throws ims.domain.exceptions.DomainInterfaceException, ims.domain.exceptions.StaleObjectException;
}
