...
abstract public class Handlers implements ims.framework.UILogic, IFormUILogicCode
{
	...
	abstract protected void onChkIncludeValueChanged() throws ims.framework.exceptions.PresentationLogicException;
	...
	public final void setContext(ims.framework.UIEngine engine, GenForm form)
	{
		...
		this.form.chkInclude().setValueChangedEvent(new ValueChanged()
		{
			private static final long serialVersionUID = 1L;
			public void handle() throws ims.framework.exceptions.PresentationLogicException
			{
				onChkIncludeValueChanged();
			}
		});
		...
		this.form.getContextMenus().Pathways.getPathwaysAwaitingValidationVIEWItem().setClickEvent(new ims.framework.delegates.MenuItemClick()
		{
			private static final long serialVersionUID = 1L;
			public void handle(ims.framework.Control sender) throws ims.framework.exceptions.PresentationLogicException
			{
				onContextMenuItemClick(GenForm.ContextMenus.PathwaysNamespace.PathwaysAwaitingValidation.VIEW, sender);
			}
		});
		this.form.getContextMenus().Pathways.getPathwaysAwaitingValidationVALIDATION_COMPLETEItem().setClickEvent(new ims.framework.delegates.MenuItemClick()
		{
			private static final long serialVersionUID = 1L;
			public void handle(ims.framework.Control sender) throws ims.framework.exceptions.PresentationLogicException
			{
				onContextMenuItemClick(GenForm.ContextMenus.PathwaysNamespace.PathwaysAwaitingValidation.VALIDATION_COMPLETE, sender);
			}
		});
		this.form.getContextMenus().Pathways.getPathwaysAwaitingValidationVIEWREFERRALDETAILSItem().setClickEvent(new ims.framework.delegates.MenuItemClick()
		{
			private static final long serialVersionUID = 1L;
			public void handle(ims.framework.Control sender) throws ims.framework.exceptions.PresentationLogicException
			{
				onContextMenuItemClick(GenForm.ContextMenus.PathwaysNamespace.PathwaysAwaitingValidation.VIEWREFERRALDETAILS, sender);
			}
		});
	}
