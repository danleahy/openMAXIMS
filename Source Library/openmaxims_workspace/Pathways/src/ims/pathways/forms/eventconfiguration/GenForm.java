...
public class GenForm extends FormBridge
{
	...
	public static class lyrTargetsLayer extends Layer
	{
		...
		public static class tabEventTargetsContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				super.addControl(factory.getControl(DynamicGrid.class, new Object[] { control, new Integer(startControlID.intValue() + 1002), new Integer(anchoringHelper3.getX()), new Integer(anchoringHelper3.getY()), new Integer(anchoringHelper3.getWidth()), new Integer(anchoringHelper3.getHeight()), new Integer(startTabIndex.intValue() + 19), ControlState.READONLY, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, contextMenus.Pathways.contextMenuEventTargetManagement, Boolean.TRUE, Boolean.FALSE, Boolean.TRUE}));
			}
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		RuntimeAnchoring anchoringHelper9 = new RuntimeAnchoring(designSize, runtimeSize, 464, 32, 376, 112, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT);
		ims.framework.FormUiLogic m_customControlMappingsForm = loader.loadComponent(104124, appForm, startControlID * 10 + 1000, anchoringHelper9.getSize(), instance1, startTabIndex.intValue() + 13, skipContextValidation);
		//ims.framework.Control m_customControlMappingsControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1008), new Integer(464), new Integer(32), new Integer(376), new Integer(112), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT, new Integer(startTabIndex.intValue() + 13), m_customControlMappingsForm, instance1 } );
		...
		RuntimeAnchoring anchoringHelper15 = new RuntimeAnchoring(designSize, runtimeSize, 464, 154, 109, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1015), new Integer(anchoringHelper15.getX()), new Integer(anchoringHelper15.getY()), new Integer(anchoringHelper15.getWidth()), new Integer(anchoringHelper15.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Cancellation Type:", new Integer(1), null, new Integer(0)}));
		RuntimeAnchoring anchoringHelper16 = new RuntimeAnchoring(designSize, runtimeSize, 464, 178, 124, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1016), new Integer(anchoringHelper16.getX()), new Integer(anchoringHelper16.getY()), new Integer(anchoringHelper16.getWidth()), new Integer(anchoringHelper16.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Cancellation Reason:", new Integer(1), null, new Integer(0)}));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1020), new Integer(anchoringHelper20.getX()), new Integer(anchoringHelper20.getY()), new Integer(anchoringHelper20.getWidth()), new Integer(anchoringHelper20.getHeight()), new Integer(startTabIndex.intValue() + 22), ControlState.HIDDEN, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Cancel", Boolean.FALSE, null, Boolean.FALSE, Boolean.FALSE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));

		// TextBox Controls
		RuntimeAnchoring anchoringHelper21 = new RuntimeAnchoring(designSize, runtimeSize, 104, 40, 344, 40, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		RuntimeAnchoring anchoringHelper22 = new RuntimeAnchoring(designSize, runtimeSize, 104, 16, 344, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		// ComboBox Controls
		RuntimeAnchoring anchoringHelper23 = new RuntimeAnchoring(designSize, runtimeSize, 104, 136, 344, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		RuntimeAnchoring anchoringHelper24 = new RuntimeAnchoring(designSize, runtimeSize, 104, 112, 344, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		RuntimeAnchoring anchoringHelper25 = new RuntimeAnchoring(designSize, runtimeSize, 592, 152, 240, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT);
		ComboBox m_cmbTypeTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1025), new Integer(anchoringHelper25.getX()), new Integer(anchoringHelper25.getY()), new Integer(anchoringHelper25.getWidth()), new Integer(anchoringHelper25.getHeight()), new Integer(startTabIndex.intValue() + 15), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT ,Boolean.TRUE, Boolean.TRUE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.TRUE, new Integer(-1)});
		...
		RuntimeAnchoring anchoringHelper26 = new RuntimeAnchoring(designSize, runtimeSize, 592, 176, 240, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT);
		ComboBox m_cmbReasonTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1026), new Integer(anchoringHelper26.getX()), new Integer(anchoringHelper26.getY()), new Integer(anchoringHelper26.getWidth()), new Integer(anchoringHelper26.getHeight()), new Integer(startTabIndex.intValue() + 16), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT ,Boolean.TRUE, Boolean.TRUE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.TRUE, new Integer(-1)});
		...
		RuntimeAnchoring anchoringHelper27 = new RuntimeAnchoring(designSize, runtimeSize, 104, 88, 344, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		// CheckBox Controls
		RuntimeAnchoring anchoringHelper28 = new RuntimeAnchoring(designSize, runtimeSize, 16, 192, 184, 16, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		RuntimeAnchoring anchoringHelper29 = new RuntimeAnchoring(designSize, runtimeSize, 360, 168, 104, 16, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		RuntimeAnchoring anchoringHelper30 = new RuntimeAnchoring(designSize, runtimeSize, 264, 168, 104, 16, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		RuntimeAnchoring anchoringHelper31 = new RuntimeAnchoring(designSize, runtimeSize, 168, 168, 104, 16, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		RuntimeAnchoring anchoringHelper32 = new RuntimeAnchoring(designSize, runtimeSize, 16, 168, 184, 16, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		// Link Controls
		RuntimeAnchoring anchoringHelper33 = new RuntimeAnchoring(designSize, runtimeSize, 656, 16, 160, 17, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
	...
	public Label lblCancellationType()
	{
		return (Label)super.getControl(10);
	}
	public Label lblCancellationReason()
	{
	...
	{
		return (cmbReasonComboBox)super.getComboBox(3);
	}
	public qmbImageComboBox qmbImage()
	{
		return (qmbImageComboBox)super.getComboBox(4);
	}
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, "_cv_Pathway.SelectedEventLiteVo", "BO-1089100000-ID", "ID_Event");
			fields[145] = new ims.framework.ReportField(this.context, "_cv_Pathway.SelectedEventLiteVo", "BO-1089100000-NAME", "Name");
			fields[146] = new ims.framework.ReportField(this.context, "_cv_Pathway.SelectedEventLiteVo", "BO-1089100000-DESCRIPTION", "Description");
			fields[147] = new ims.framework.ReportField(this.context, "_cv_Pathway.SelectedEventLiteVo", "BO-1089100000-STATUS", "Status");
			fields[148] = new ims.framework.ReportField(this.context, "_cv_Pathway.SelectedEventLiteVo", "BO-1089100000-PATIENTDIARYIMPACT", "PatientDiaryImpact");
			fields[149] = new ims.framework.ReportField(this.context, "_cv_Pathway.SelectedEventLiteVo", "BO-1089100000-EVENTTYPE", "EventType");
			fields[150] = new ims.framework.ReportField(this.context, "_cv_Pathway.SelectedEventLiteVo", "BO-1089100000-STARTSCLOCK", "StartsClock");
			fields[151] = new ims.framework.ReportField(this.context, "_cv_Pathway.SelectedEventLiteVo", "BO-1089100000-STOPSCLOCK", "StopsClock");
			fields[152] = new ims.framework.ReportField(this.context, "_cv_Pathway.SelectedEventLiteVo", "BO-1089100000-ENDSPATHWAY", "EndsPathway");
			fields[153] = new ims.framework.ReportField(this.context, "_cv_Pathway.SelectedEventLiteVo", "BO-1089100000-ISMANUALSCHEDULEDEVENT", "IsManualScheduledEvent");
			fields[154] = new ims.framework.ReportField(this.context, "_cv_Pathway.SelectedEventLiteVo", "BO-1089100000-CANCELLATIONTYPE", "CancellationType");
			fields[155] = new ims.framework.ReportField(this.context, "_cv_Pathway.SelectedEventLiteVo", "BO-1089100000-CANCELLATIONREASON", "CancellationReason");
			fields[156] = new ims.framework.ReportField(this.context, "_cv_Pathways.EventSearchAndSelectFilter", "BO-1089100000-ID", "ID_Event");
			fields[157] = new ims.framework.ReportField(this.context, "_cv_Pathways.EventSearchAndSelectFilter", "BO-1089100000-NAME", "Name");
			fields[158] = new ims.framework.ReportField(this.context, "_cv_Pathways.EventSearchAndSelectFilter", "BO-1089100000-DESCRIPTION", "Description");
			fields[159] = new ims.framework.ReportField(this.context, "_cv_Pathways.EventSearchAndSelectFilter", "BO-1089100000-STATUS", "Status");
			fields[160] = new ims.framework.ReportField(this.context, "_cv_Pathways.EventSearchAndSelectFilter", "BO-1089100000-PATIENTDIARYIMPACT", "PatientDiaryImpact");
			fields[161] = new ims.framework.ReportField(this.context, "_cv_Pathways.EventSearchAndSelectFilter", "BO-1089100000-EVENTTYPE", "EventType");
			fields[162] = new ims.framework.ReportField(this.context, "_cv_Pathways.EventSearchAndSelectFilter", "BO-1089100000-STARTSCLOCK", "StartsClock");
			fields[163] = new ims.framework.ReportField(this.context, "_cv_Pathways.EventSearchAndSelectFilter", "BO-1089100000-STOPSCLOCK", "StopsClock");
			fields[164] = new ims.framework.ReportField(this.context, "_cv_Pathways.EventSearchAndSelectFilter", "BO-1089100000-ENDSPATHWAY", "EndsPathway");
			fields[165] = new ims.framework.ReportField(this.context, "_cv_Pathways.EventSearchAndSelectFilter", "BO-1089100000-ISMANUALSCHEDULEDEVENT", "IsManualScheduledEvent");
			fields[166] = new ims.framework.ReportField(this.context, "_cv_Pathways.EventSearchAndSelectFilter", "BO-1089100000-CANCELLATIONTYPE", "CancellationType");
			fields[167] = new ims.framework.ReportField(this.context, "_cv_Pathways.EventSearchAndSelectFilter", "BO-1089100000-CANCELLATIONREASON", "CancellationReason");
			fields[168] = new ims.framework.ReportField(this.context, prefix + "_lv_Pathways.EventConfiguration.__internal_x_context__EditedRecord_" + componentIdentifier, "BO-1089100000-ID", "ID_Event");
			fields[169] = new ims.framework.ReportField(this.context, prefix + "_lv_Pathways.EventConfiguration.__internal_x_context__EditedRecord_" + componentIdentifier, "BO-1089100000-NAME", "Name");
			fields[170] = new ims.framework.ReportField(this.context, prefix + "_lv_Pathways.EventConfiguration.__internal_x_context__EditedRecord_" + componentIdentifier, "BO-1089100000-DESCRIPTION", "Description");
			fields[171] = new ims.framework.ReportField(this.context, prefix + "_lv_Pathways.EventConfiguration.__internal_x_context__EditedRecord_" + componentIdentifier, "BO-1089100000-STATUS", "Status");
			fields[172] = new ims.framework.ReportField(this.context, prefix + "_lv_Pathways.EventConfiguration.__internal_x_context__EditedRecord_" + componentIdentifier, "BO-1089100000-PATIENTDIARYIMPACT", "PatientDiaryImpact");
			fields[173] = new ims.framework.ReportField(this.context, prefix + "_lv_Pathways.EventConfiguration.__internal_x_context__EditedRecord_" + componentIdentifier, "BO-1089100000-EVENTTYPE", "EventType");
			fields[174] = new ims.framework.ReportField(this.context, prefix + "_lv_Pathways.EventConfiguration.__internal_x_context__EditedRecord_" + componentIdentifier, "BO-1089100000-STARTSCLOCK", "StartsClock");
			fields[175] = new ims.framework.ReportField(this.context, prefix + "_lv_Pathways.EventConfiguration.__internal_x_context__EditedRecord_" + componentIdentifier, "BO-1089100000-STOPSCLOCK", "StopsClock");
			fields[176] = new ims.framework.ReportField(this.context, prefix + "_lv_Pathways.EventConfiguration.__internal_x_context__EditedRecord_" + componentIdentifier, "BO-1089100000-ENDSPATHWAY", "EndsPathway");
			fields[177] = new ims.framework.ReportField(this.context, prefix + "_lv_Pathways.EventConfiguration.__internal_x_context__EditedRecord_" + componentIdentifier, "BO-1089100000-ISMANUALSCHEDULEDEVENT", "IsManualScheduledEvent");
			fields[178] = new ims.framework.ReportField(this.context, prefix + "_lv_Pathways.EventConfiguration.__internal_x_context__EditedRecord_" + componentIdentifier, "BO-1089100000-CANCELLATIONTYPE", "CancellationType");
			fields[179] = new ims.framework.ReportField(this.context, prefix + "_lv_Pathways.EventConfiguration.__internal_x_context__EditedRecord_" + componentIdentifier, "BO-1089100000-CANCELLATIONREASON", "CancellationReason");
			fields[180] = new ims.framework.ReportField(this.context, prefix + "_lv_Pathways.EventConfiguration.__internal_x_context__EventTargetEditedRecord_" + componentIdentifier, "BO-1089100006-ID", "ID_EventTarget");
			fields[181] = new ims.framework.ReportField(this.context, prefix + "_lv_Pathways.EventConfiguration.__internal_x_context__EventTargetEditedRecord_" + componentIdentifier, "BO-1089100006-EVENT", "Event");
			fields[182] = new ims.framework.ReportField(this.context, prefix + "_lv_Pathways.EventConfiguration.__internal_x_context__EventTargetEditedRecord_" + componentIdentifier, "BO-1089100006-STATUS", "Status");
			fields[183] = new ims.framework.ReportField(this.context, prefix + "_lv_Pathways.EventConfiguration.__internal_x_context__EventTargetEditedRecord_" + componentIdentifier, "BO-1089100006-SETJOURNEYTARGETSTATUSTO", "SetJourneyTargetStatusTo");
			fields[184] = new ims.framework.ReportField(this.context, prefix + "_lv_Pathways.EventConfiguration.__internal_x_context__EventTargetEditedRecord_" + componentIdentifier, "BO-1089100006-SETTOINSCOPE", "SetToInScope");
			return fields;
		}
