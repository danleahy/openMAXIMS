...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Core.RieMessage", "_cv_Pathways.SelectedPatientPathwayJourney", "_cv_Pathway.SelectedBreachReason", "_cv_Pathways.BreachReasonCorrectionData" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Pathways.BreachReasonListDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
