...
public class GenForm extends FormBridge
{
	...
	public static class ctnDetailsContainer extends ContainerBridge
	{
		...
		protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
		{
			...
			ims.framework.FormUiLogic m_customControlMappingsForm = loader.loadComponent(104124, appForm, startControlID * 10 + 1000, anchoringHelper1.getSize(), instance1, startTabIndex.intValue() + 16, skipContextValidation);
			//ims.framework.Control m_customControlMappingsControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1000), new Integer(472), new Integer(0), new Integer(352), new Integer(168), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.TOPBOTTOMRIGHT, new Integer(startTabIndex.intValue() + 16), m_customControlMappingsForm, instance1 } );
			ims.framework.Control m_customControlMappingsControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1001),  new Integer(anchoringHelper1.getX()), new Integer(anchoringHelper1.getY()), new Integer(anchoringHelper1.getWidth()), new Integer(anchoringHelper1.getHeight()), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.TOPBOTTOMRIGHT, new Integer(startTabIndex.intValue() + 16), m_customControlMappingsForm, instance1, Boolean.FALSE } );
			...
			super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1007), new Integer(anchoringHelper7.getX()), new Integer(anchoringHelper7.getY()), new Integer(anchoringHelper7.getWidth()), new Integer(anchoringHelper7.getHeight()), new Integer(startTabIndex.intValue() + 11), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT,Boolean.FALSE, new Integer(255), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.TRUE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, prefix + "_lv_Pathways.TargetConfiguration.__internal_x_context__EditedRecord_" + componentIdentifier, "BO-1089100001-ID", "ID_Target");
			fields[145] = new ims.framework.ReportField(this.context, prefix + "_lv_Pathways.TargetConfiguration.__internal_x_context__EditedRecord_" + componentIdentifier, "BO-1089100001-NAME", "Name");
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_Pathways.TargetConfiguration.__internal_x_context__EditedRecord_" + componentIdentifier, "BO-1089100001-DESCRIPTION", "Description");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_Pathways.TargetConfiguration.__internal_x_context__EditedRecord_" + componentIdentifier, "BO-1089100001-EVENTLINKTYPE", "EventLinkType");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_Pathways.TargetConfiguration.__internal_x_context__EditedRecord_" + componentIdentifier, "BO-1089100001-STATUS", "Status");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_Pathways.TargetConfiguration.__internal_x_context__EditedRecord_" + componentIdentifier, "BO-1089100001-TARGETDATECALCULATION", "TargetDateCalculation");
			return fields;
		}
