...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "PathwayNoteCorrectionDialog";
	}
	public int getWidth()
	{
		return 792;
	...
	{
		return new String[] { "_cv_Pathways.PatientJourneySelectedComment" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Pathways.PathwayNoteCorrectionDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
