...
public class Logic extends BaseLogic
{
	...
	private void newInstance()
	{
		...
		if (ConfigFlag.DOM.RTT_STANDARD_PATHWAY.getValue())
		{
			form.cmbJourneyCountType().setValue(JourneyCountType.DAYS);
			form.intNumWeeks().setValue(127);
		}
		//WDEV-17706
		else
	...
	private void updateControlState()
	{
		...
		//WDEV-20014
		boolean showJourneyCount = !ConfigFlag.DOM.RTT_STANDARD_PATHWAY.getValue();
		
		form.lblJourneyCountType().setVisible(showJourneyCount);
		form.cmbJourneyCountType().setVisible(showJourneyCount);
		form.cmbJourneyCountType().setEnabled(showJourneyCount && form.getMode().equals(FormMode.EDIT));
		
		form.lblReferralToTreatmentIn().setVisible(showJourneyCount);
		form.intNumWeeks().setVisible(showJourneyCount);
		form.intNumWeeks().setEnabled(showJourneyCount && form.getMode().equals(FormMode.EDIT));
		form.lblJourneyCount().setVisible(showJourneyCount);
	...
	//WDEV-19600 -- tool tip style change
	private void updateJourneyLabels() 
	{
		...
		String textLabel = value.getText(); 
		String txtWeekNoHeaderTooltip = null;
						
		if (textLabel != null)
		{
			form.lblJourneyCount().setValue(textLabel);			
			txtWeekNoHeaderTooltip = textLabel.endsWith("s") ? textLabel.substring(0, textLabel.length() - 1) : textLabel;
			form.ctnTargets().grdTargets().setColWeekNoCaption(txtWeekNoHeaderTooltip + " No.");			
		}		
	}
