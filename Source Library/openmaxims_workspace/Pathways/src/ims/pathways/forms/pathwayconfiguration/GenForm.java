...
public class GenForm extends FormBridge
{
	...
	public static class ctnTargetsContainer extends ContainerBridge
	{
		...
		public static class grdTargetsGrid extends GridBridge
		{
			...
			public void setColWarningCaption(String value)
			{
		...
		protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
		{
			...
			Grid m_grdTargetsTemp = (Grid)factory.getControl(Grid.class, new Object[] { control, new Integer(startControlID.intValue() + 1001), new Integer(anchoringHelper2.getX()), new Integer(anchoringHelper2.getY()), new Integer(anchoringHelper2.getWidth()), new Integer(anchoringHelper2.getHeight()), new Integer(startTabIndex.intValue() + 14), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL,Boolean.TRUE, Boolean.FALSE, new Integer(24), Boolean.TRUE, contextMenus.Pathways.contextMenuPathwayTargets, Boolean.FALSE, Boolean.FALSE, new Integer(0), null, Boolean.TRUE, Boolean.TRUE});
			...
			grdTargets.addIntColumn("Week No.", 0, 0, 70, false, true, null, false, 1, true, 0);
			...
			grdTargets.addIntColumn("Warning", 0, 0, 75, false, true, null, false, 0, true, 0);
			grdTargets.setColWarningHeaderTooltip("Indicates this target as a warning within X weeks/days of the target date");
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		ims.framework.FormUiLogic m_customControlMappingsForm = loader.loadComponent(104124, appForm, startControlID * 10 + 2000, anchoringHelper5.getSize(), instance2, startTabIndex.intValue() + 11, skipContextValidation);
		//ims.framework.Control m_customControlMappingsControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1005), new Integer(448), new Integer(48), new Integer(384), new Integer(224), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT, new Integer(startTabIndex.intValue() + 11), m_customControlMappingsForm, instance2 } );
		ims.framework.Control m_customControlMappingsControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1006),  new Integer(anchoringHelper5.getX()), new Integer(anchoringHelper5.getY()), new Integer(anchoringHelper5.getWidth()), new Integer(anchoringHelper5.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT, new Integer(startTabIndex.intValue() + 11), m_customControlMappingsForm, instance2, Boolean.FALSE } );
		...
		RuntimeAnchoring anchoringHelper8 = new RuntimeAnchoring(designSize, runtimeSize, 312, 222, 40, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1009), new Integer(anchoringHelper8.getX()), new Integer(anchoringHelper8.getY()), new Integer(anchoringHelper8.getWidth()), new Integer(anchoringHelper8.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "weeks", new Integer(1), null, new Integer(0)}));
		RuntimeAnchoring anchoringHelper9 = new RuntimeAnchoring(designSize, runtimeSize, 104, 222, 146, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		RuntimeAnchoring anchoringHelper17 = new RuntimeAnchoring(designSize, runtimeSize, 684, 592, 75, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT);
		...
		ComboBox m_cmbJourneyCountTypeTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1022), new Integer(anchoringHelper21.getX()), new Integer(anchoringHelper21.getY()), new Integer(anchoringHelper21.getWidth()), new Integer(anchoringHelper21.getHeight()), new Integer(startTabIndex.intValue() + 17), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT ,Boolean.FALSE, Boolean.TRUE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.TRUE, new Integer(-1)});
		...
		// IntBox Controls
		RuntimeAnchoring anchoringHelper26 = new RuntimeAnchoring(designSize, runtimeSize, 256, 220, 40, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
	...
	public Label lblJourneyCountType()
	{
	...
	public Label lblReferralToTreatmentIn()
	{
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, "_cv_Pathways.SelectedTarget", "BO-1089100001-ID", "ID_Target");
			fields[145] = new ims.framework.ReportField(this.context, "_cv_Pathways.SelectedTarget", "BO-1089100001-NAME", "Name");
			fields[146] = new ims.framework.ReportField(this.context, "_cv_Pathways.SelectedTarget", "BO-1089100001-DESCRIPTION", "Description");
			fields[147] = new ims.framework.ReportField(this.context, "_cv_Pathways.SelectedTarget", "BO-1089100001-STATUS", "Status");
			fields[148] = new ims.framework.ReportField(this.context, "_cv_Pathways.SelectedTarget", "BO-1089100001-EVENTLINKTYPE", "EventLinkType");
			fields[149] = new ims.framework.ReportField(this.context, "_cv_Pathways.SelectedTarget", "BO-1089100001-TARGETDATECALCULATION", "TargetDateCalculation");
			fields[150] = new ims.framework.ReportField(this.context, "_cv_Pathways.PathwayToCopy", "BO-1089100002-ID", "ID_Pathway");
			fields[151] = new ims.framework.ReportField(this.context, "_cv_Pathways.SelectedPathway", "BO-1089100002-ID", "ID_Pathway");
			fields[152] = new ims.framework.ReportField(this.context, prefix + "_lv_Pathways.PathwayConfiguration.__internal_x_context__SelectedPathway_" + componentIdentifier, "BO-1089100002-ID", "ID_Pathway");
			fields[153] = new ims.framework.ReportField(this.context, prefix + "_lv_Pathways.PathwayConfiguration.__internal_x_context__SelectedPathway_" + componentIdentifier, "BO-1089100002-NAME", "Name");
			fields[154] = new ims.framework.ReportField(this.context, prefix + "_lv_Pathways.PathwayConfiguration.__internal_x_context__SelectedPathway_" + componentIdentifier, "BO-1089100002-DESCRIPTION", "Description");
			fields[155] = new ims.framework.ReportField(this.context, prefix + "_lv_Pathways.PathwayConfiguration.__internal_x_context__SelectedPathway_" + componentIdentifier, "BO-1089100002-STATUS", "Status");
			fields[156] = new ims.framework.ReportField(this.context, prefix + "_lv_Pathways.PathwayConfiguration.__internal_x_context__SelectedPathway_" + componentIdentifier, "BO-1089100002-SPECIALTY", "Specialty");
			fields[157] = new ims.framework.ReportField(this.context, prefix + "_lv_Pathways.PathwayConfiguration.__internal_x_context__SelectedPathway_" + componentIdentifier, "BO-1089100002-NUMWEEKSDAYS", "NumWeeks");
			fields[158] = new ims.framework.ReportField(this.context, prefix + "_lv_Pathways.PathwayConfiguration.__internal_x_context__SelectedPathway_" + componentIdentifier, "BO-1089100002-JOURNEYCOUNTTYPE", "JourneyCountType");
			fields[159] = new ims.framework.ReportField(this.context, prefix + "_lv_Pathways.PathwayConfiguration.__internal_x_context__SelectedPathway_" + componentIdentifier, "BO-1089100002-ISDEFAULT", "IsDefault");
			fields[160] = new ims.framework.ReportField(this.context, prefix + "_lv_Pathways.PathwayConfiguration.__internal_x_context__SelectedPathway_" + componentIdentifier, "BO-1089100002-ISNON18WEEK", "IsNon18Week");
			fields[161] = new ims.framework.ReportField(this.context, prefix + "_lv_Pathways.PathwayConfiguration.__internal_x_context__SelectedPathway_" + componentIdentifier, "BO-1089100002-CONSULTANT", "Consultant");
			return fields;
		}
