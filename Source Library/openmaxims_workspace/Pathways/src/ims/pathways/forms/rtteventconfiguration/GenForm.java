...
public class GenForm extends FormBridge
{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1016), new Integer(anchoringHelper17.getX()), new Integer(anchoringHelper17.getY()), new Integer(anchoringHelper17.getWidth()), new Integer(anchoringHelper17.getHeight()), new Integer(startTabIndex.intValue() + 15), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Edit", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, prefix + "_lv_Pathways.RTTEventConfiguration.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1089100007-ID", "ID_RTTEvent");
			fields[145] = new ims.framework.ReportField(this.context, prefix + "_lv_Pathways.RTTEventConfiguration.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1089100007-NAME", "Name");
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_Pathways.RTTEventConfiguration.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1089100007-PASCODE", "PASCode");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_Pathways.RTTEventConfiguration.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1089100007-NATIONALCODE", "NationalCode");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_Pathways.RTTEventConfiguration.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1089100007-SEQUENCE", "Sequence");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_Pathways.RTTEventConfiguration.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1089100007-ACTION", "Action");
			return fields;
		}
