...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "PatientPathwayValidationCompleteDialog";
	}
	public int getWidth()
	{
		return 544;
	...
	{
		return new String[] { "_cv_Pathways.PatientPathwaysAwaitingValidationWorklistVo" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Pathways.PatientPathwayValidationCompleteDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
