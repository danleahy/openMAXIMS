...
public class S15VoMapper extends VoMapper
{
//	private static final Logger	LOG	= Logger.getLogger(S15VoMapper.class);
...
//	public Message processEvent(Message msg, ProviderSystemVo providerSystem) throws HL7Exception
	...
	public Message populateMessage(IHL7OutboundMessageHandler event)  throws Exception
	{
		...
		if(s12Vomapper==null)
		{
			throw new HL7Exception("S15 mapper requires S12 mapper. S12 mapper not found in list of registered mappers.");			
		}
		SIU_S12 s15=(SIU_S12)s12Vomapper.populateMessage(event);
		populateMSH( event.getProviderSystem(),  s15.getMSH(),Long.toString( new java.util.Date().getTime()),"SIU","S15");
		return s15;
	}
}
