...
public class GenForm extends FormBridge
{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1023), new Integer(anchoringHelper24.getX()), new Integer(anchoringHelper24.getY()), new Integer(anchoringHelper24.getWidth()), new Integer(anchoringHelper24.getHeight()), new Integer(startTabIndex.intValue() + 18), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "New", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedPreceedingReferralVo", "BO-1072100062-ID", "ID_ReferralsRecording");
			fields[145] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedPreceedingReferralVo", "BO-1072100062-REFERRALTYPE", "ReferralType");
			fields[146] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedPreceedingReferralVo", "BO-1072100062-REFERRALSOURCE", "ReferralSource");
			fields[147] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedPreceedingReferralVo", "BO-1072100062-DATESENT", "DateSent");
			fields[148] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedPreceedingReferralVo", "BO-1072100062-DETAILS", "Details");
			fields[149] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedPreceedingReferralVo", "BO-1072100062-DATEFIRSTSEEN", "DateFirstSeen");
			fields[150] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedPreceedingReferralVo", "BO-1072100062-DATERECEIVED", "DateReceived");
			fields[151] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedPreceedingReferralVo", "BO-1072100062-REFERRALPRIORITY", "ReferralPriority");
			fields[152] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedPreceedingReferralVo", "BO-1072100062-REASONFORREFERRAL", "ReasonForReferral");
			fields[153] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedPreceedingReferralVo", "BO-1072100062-SPECIALTYFUNCTIONCODE", "SpecialtyFunctionCode");
			fields[154] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedPreceedingReferralVo", "BO-1072100062-REFERRALCATEGORY", "ReferralCategory");
			fields[155] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedPreceedingReferralVo", "BO-1072100062-PRIMARYPRECEEDING", "PrimaryPreceeding");
			fields[156] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedPreceedingReferralVo", "BO-1072100062-CARESPELL", "CareSpell");
			fields[157] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedPreceedingReferralVo", "BO-1072100062-CARECONTEXT", "CareContext");
			fields[158] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedPreceedingReferralVo", "BO-1072100062-CLINICALCONTACT", "ClinicalContact");
			fields[159] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedPreceedingReferralVo", "BO-1072100062-REFERRALSTATUS", "ReferralStatus");
			fields[160] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedPreceedingReferralVo", "BO-1072100062-URGENTCANCERREFERRALTYPE", "UrgentCancerReferralType");
			fields[161] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedPreceedingReferralVo", "BO-1072100062-CANCERSTATUS", "CancerStatus");
			fields[162] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedPreceedingReferralVo", "BO-1072100062-DELAYREASONGPURGENTREFERRAL", "DelayReasonGPUrgentReferral");
			fields[163] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedPreceedingReferralVo", "BO-1072100062-DELAYREASONTEXT", "DelayReasonText");
			fields[164] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedPreceedingReferralVo", "BO-1072100062-DISCIPLINE", "Discipline");
			fields[165] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedPreceedingReferralVo", "BO-1072100062-REASONFORREFERRALTEXT", "ReasonForReferralText");
			fields[166] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.CancerreferralDetails.__internal_x_context__SelectedReferral_" + componentIdentifier, "BO-1072100062-ID", "ID_ReferralsRecording");
			fields[167] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.CancerreferralDetails.__internal_x_context__SelectedReferral_" + componentIdentifier, "BO-1072100062-REFERRALTYPE", "ReferralType");
			fields[168] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.CancerreferralDetails.__internal_x_context__SelectedReferral_" + componentIdentifier, "BO-1072100062-REFERRALSOURCE", "ReferralSource");
			fields[169] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.CancerreferralDetails.__internal_x_context__SelectedReferral_" + componentIdentifier, "BO-1072100062-DATESENT", "DateSent");
			fields[170] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.CancerreferralDetails.__internal_x_context__SelectedReferral_" + componentIdentifier, "BO-1072100062-DETAILS", "Details");
			fields[171] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.CancerreferralDetails.__internal_x_context__SelectedReferral_" + componentIdentifier, "BO-1072100062-DATEFIRSTSEEN", "DateFirstSeen");
			fields[172] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.CancerreferralDetails.__internal_x_context__SelectedReferral_" + componentIdentifier, "BO-1072100062-DATERECEIVED", "DateReceived");
			fields[173] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.CancerreferralDetails.__internal_x_context__SelectedReferral_" + componentIdentifier, "BO-1072100062-REFERRALPRIORITY", "ReferralPriority");
			fields[174] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.CancerreferralDetails.__internal_x_context__SelectedReferral_" + componentIdentifier, "BO-1072100062-REASONFORREFERRAL", "ReasonForReferral");
			fields[175] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.CancerreferralDetails.__internal_x_context__SelectedReferral_" + componentIdentifier, "BO-1072100062-SPECIALTYFUNCTIONCODE", "SpecialtyFunctionCode");
			fields[176] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.CancerreferralDetails.__internal_x_context__SelectedReferral_" + componentIdentifier, "BO-1072100062-REFERRALCATEGORY", "ReferralCategory");
			fields[177] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.CancerreferralDetails.__internal_x_context__SelectedReferral_" + componentIdentifier, "BO-1072100062-PRIMARYPRECEEDING", "PrimaryPreceeding");
			fields[178] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.CancerreferralDetails.__internal_x_context__SelectedReferral_" + componentIdentifier, "BO-1072100062-CARESPELL", "CareSpell");
			fields[179] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.CancerreferralDetails.__internal_x_context__SelectedReferral_" + componentIdentifier, "BO-1072100062-CARECONTEXT", "CareContext");
			fields[180] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.CancerreferralDetails.__internal_x_context__SelectedReferral_" + componentIdentifier, "BO-1072100062-CLINICALCONTACT", "ClinicalContact");
			fields[181] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.CancerreferralDetails.__internal_x_context__SelectedReferral_" + componentIdentifier, "BO-1072100062-REFERRALSTATUS", "ReferralStatus");
			fields[182] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.CancerreferralDetails.__internal_x_context__SelectedReferral_" + componentIdentifier, "BO-1072100062-URGENTCANCERREFERRALTYPE", "UrgentCancerReferralType");
			fields[183] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.CancerreferralDetails.__internal_x_context__SelectedReferral_" + componentIdentifier, "BO-1072100062-CANCERSTATUS", "CancerStatus");
			fields[184] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.CancerreferralDetails.__internal_x_context__SelectedReferral_" + componentIdentifier, "BO-1072100062-DELAYREASONGPURGENTREFERRAL", "DelayReasonGPUrgentReferral");
			fields[185] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.CancerreferralDetails.__internal_x_context__SelectedReferral_" + componentIdentifier, "BO-1072100062-DELAYREASONTEXT", "DelayReasonText");
			fields[186] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.CancerreferralDetails.__internal_x_context__SelectedReferral_" + componentIdentifier, "BO-1072100062-DISCIPLINE", "Discipline");
			fields[187] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.CancerreferralDetails.__internal_x_context__SelectedReferral_" + componentIdentifier, "BO-1072100062-REASONFORREFERRALTEXT", "ReasonForReferralText");
			fields[188] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.CancerreferralDetails.__internal_x_context__LoggedInMOS_" + componentIdentifier, "BO-1006100006-ID", "ID_MemberOfStaff");
			fields[189] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.CancerreferralDetails.__internal_x_context__LoggedInMOS_" + componentIdentifier, "BO-1006100006-INITIALS", "Initials");
			fields[190] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.CancerreferralDetails.__internal_x_context__LoggedInMOS_" + componentIdentifier, "BO-1006100006-SIGNATUREBLOCK", "SignatureBlock");
			fields[191] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.CancerreferralDetails.__internal_x_context__LoggedInMOS_" + componentIdentifier, "BO-1006100006-STAFFTYPE", "StaffType");
			fields[192] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.CancerreferralDetails.__internal_x_context__LoggedInMOS_" + componentIdentifier, "BO-1006100006-ISACTIVE", "IsActive");
			fields[193] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.CancerreferralDetails.__internal_x_context__LoggedInMOS_" + componentIdentifier, "BO-1006100006-SDSROLEID", "SdsRoleId");
			fields[194] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.CancerreferralDetails.__internal_x_context__LoggedInMOS_" + componentIdentifier, "BO-1006100006-CANREFERPATIENT", "CanReferPatient");
			return fields;
		}
