...
public class GenForm extends FormBridge
{
	...
	public static class lyrDetailsLayer extends Layer
	{
		...
		public static class tabDetailsContainer extends LayerBridge
		{
			...
			public static class ConcurrentChemotherapyRadioButton extends RadioButtonBridge
			{
				...
				protected void setContext(Integer startTabIndex, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize)
				{
					...
					control.addButton(0, anchoringHelper1.getX(), anchoringHelper1.getY(), anchoringHelper1.getWidth(), "No", startTabIndex.intValue() + 14);
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				ims.framework.FormUiLogic m_ccPrescribingHCPForm = loader.loadComponent(102256, appForm, startControlID * 10 + 1000, anchoringHelper3.getSize(), instance1, startTabIndex.intValue() + 15, skipContextValidation);
				//ims.framework.Control m_ccPrescribingHCPControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1000), new Integer(592), new Integer(8), new Integer(232), new Integer(20), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, new Integer(startTabIndex.intValue() + 15), m_ccPrescribingHCPForm, instance1 } );
				...
				ims.framework.FormUiLogic m_customConsultantForm = loader.loadComponent(102256, appForm, startControlID * 10 + 2000, anchoringHelper4.getSize(), instance2, startTabIndex.intValue() + 4, skipContextValidation);
				//ims.framework.Control m_customConsultantControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1002), new Integer(192), new Integer(56), new Integer(240), new Integer(20), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFTRIGHT, new Integer(startTabIndex.intValue() + 4), m_customConsultantForm, instance2 } );
				...
				ComboBox m_cmbDiseaseTreatmentTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1033), new Integer(anchoringHelper34.getX()), new Integer(anchoringHelper34.getY()), new Integer(anchoringHelper34.getWidth()), new Integer(anchoringHelper34.getHeight()), new Integer(startTabIndex.intValue() + 23), ControlState.DISABLED, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
				...
				ComboBox m_cmbTreatIntentTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1037), new Integer(anchoringHelper38.getX()), new Integer(anchoringHelper38.getY()), new Integer(anchoringHelper38.getWidth()), new Integer(anchoringHelper38.getHeight()), new Integer(startTabIndex.intValue() + 9), ControlState.DISABLED, ControlState.ENABLED,ims.framework.enumerations.ControlAnchoring.BOTTOMLEFTRIGHT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
				...
				ComboBox m_cmbAnatomicalSiteTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1039), new Integer(anchoringHelper40.getX()), new Integer(anchoringHelper40.getY()), new Integer(anchoringHelper40.getWidth()), new Integer(anchoringHelper40.getHeight()), new Integer(startTabIndex.intValue() + 8), ControlState.DISABLED, ControlState.ENABLED,ims.framework.enumerations.ControlAnchoring.BOTTOMLEFTRIGHT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
				...
				super.addControl(factory.getControl(IntBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1041), new Integer(anchoringHelper42.getX()), new Integer(anchoringHelper42.getY()), new Integer(anchoringHelper42.getWidth()), new Integer(anchoringHelper42.getHeight()), new Integer(startTabIndex.intValue() + 20), ControlState.DISABLED, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT,Boolean.TRUE, Boolean.FALSE, Boolean.FALSE, null, null, Boolean.FALSE, new Integer(3)}));
				...
				super.addControl(factory.getControl(IntBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1042), new Integer(anchoringHelper43.getX()), new Integer(anchoringHelper43.getY()), new Integer(anchoringHelper43.getWidth()), new Integer(anchoringHelper43.getHeight()), new Integer(startTabIndex.intValue() + 12), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT,Boolean.TRUE, Boolean.FALSE, Boolean.FALSE, null, null, Boolean.FALSE, new Integer(9)}));
		...
		public static class tabTeletherapyContainer extends LayerBridge
		{
			...
			public static class MultiplePlanningRadioButton extends RadioButtonBridge
			{
				...
				protected void setContext(Integer startTabIndex, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize)
				{
					...
					control.addButton(0, anchoringHelper46.getX(), anchoringHelper46.getY(), anchoringHelper46.getWidth(), "No", startTabIndex.intValue() + 53);
					...
					control.addButton(1, anchoringHelper47.getX(), anchoringHelper47.getY(), anchoringHelper47.getWidth(), "Yes", startTabIndex.intValue() + 52);
				}
			...
			public static class GeneralAnaestheticRadioButton extends RadioButtonBridge
			{
				...
				protected void setContext(Integer startTabIndex, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize)
				{
					...
					control.addButton(0, anchoringHelper48.getX(), anchoringHelper48.getY(), anchoringHelper48.getWidth(), "No", startTabIndex.intValue() + 47);
					...
					control.addButton(1, anchoringHelper49.getX(), anchoringHelper49.getY(), anchoringHelper49.getWidth(), "Yes", startTabIndex.intValue() + 46);
				}
			...
			public static class PreOperativeRadioButton extends RadioButtonBridge
			{
				...
				protected void setContext(Integer startTabIndex, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize)
				{
					...
					control.addButton(0, anchoringHelper50.getX(), anchoringHelper50.getY(), anchoringHelper50.getWidth(), "No", startTabIndex.intValue() + 45);
					...
					control.addButton(1, anchoringHelper51.getX(), anchoringHelper51.getY(), anchoringHelper51.getWidth(), "Yes", startTabIndex.intValue() + 44);
				}
			...
			public static class HyperfractionationRadioButton extends RadioButtonBridge
			{
				...
				protected void setContext(Integer startTabIndex, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize)
				{
					...
					control.addButton(0, anchoringHelper52.getX(), anchoringHelper52.getY(), anchoringHelper52.getWidth(), "No", startTabIndex.intValue() + 42);
					...
					control.addButton(1, anchoringHelper53.getX(), anchoringHelper53.getY(), anchoringHelper53.getWidth(), "Yes", startTabIndex.intValue() + 41);
				}
			...
			public static class RetreatmentRadioButton extends RadioButtonBridge
			{
				...
				protected void setContext(Integer startTabIndex, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize)
				{
					...
					control.addButton(0, anchoringHelper54.getX(), anchoringHelper54.getY(), anchoringHelper54.getWidth(), "No", startTabIndex.intValue() + 40);
					...
					control.addButton(1, anchoringHelper55.getX(), anchoringHelper55.getY(), anchoringHelper55.getWidth(), "Yes", startTabIndex.intValue() + 39);
				}
			...
			public static class AdjacentFieldsRadioButton extends RadioButtonBridge
			{
				...
				protected void setContext(Integer startTabIndex, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize)
				{
					if(startTabIndex == null)
						throw new RuntimeException("Invalid startTabIndex ");
					RuntimeAnchoring anchoringHelper56 = new RuntimeAnchoring(designSize, runtimeSize, 348, 275, 40, 16, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
					control.addButton(0, anchoringHelper56.getX(), anchoringHelper56.getY(), anchoringHelper56.getWidth(), "No", startTabIndex.intValue() + 37);
					RuntimeAnchoring anchoringHelper57 = new RuntimeAnchoring(designSize, runtimeSize, 292, 275, 40, 16, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
					control.addButton(1, anchoringHelper57.getX(), anchoringHelper57.getY(), anchoringHelper57.getWidth(), "Yes", startTabIndex.intValue() + 36);
				}
			...
			public static class SupraclavicularDetailsRadioButton extends RadioButtonBridge
			{
				...
				protected void setContext(Integer startTabIndex, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize)
				{
					...
					control.addButton(0, anchoringHelper58.getX(), anchoringHelper58.getY(), anchoringHelper58.getWidth(), "No", startTabIndex.intValue() + 33);
					...
					control.addButton(1, anchoringHelper59.getX(), anchoringHelper59.getY(), anchoringHelper59.getWidth(), "Yes", startTabIndex.intValue() + 32);
				}
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				RuntimeAnchoring anchoringHelper66 = new RuntimeAnchoring(designSize, runtimeSize, 8, 275, 95, 17, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT);
				...
				ComboBox m_cmbNoFieldsTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1067), new Integer(anchoringHelper81.getX()), new Integer(anchoringHelper81.getY()), new Integer(anchoringHelper81.getWidth()), new Integer(anchoringHelper81.getHeight()), new Integer(startTabIndex.intValue() + 50), ControlState.DISABLED, ControlState.ENABLED,ims.framework.enumerations.ControlAnchoring.TOPRIGHT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
				...
				ComboBox m_cmbBeamEnergyTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1068), new Integer(anchoringHelper82.getX()), new Integer(anchoringHelper82.getY()), new Integer(anchoringHelper82.getWidth()), new Integer(anchoringHelper82.getHeight()), new Integer(startTabIndex.intValue() + 49), ControlState.DISABLED, ControlState.ENABLED,ims.framework.enumerations.ControlAnchoring.TOPRIGHT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
				...
				ComboBox m_cmbRadiationTypeTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1069), new Integer(anchoringHelper83.getX()), new Integer(anchoringHelper83.getY()), new Integer(anchoringHelper83.getWidth()), new Integer(anchoringHelper83.getHeight()), new Integer(startTabIndex.intValue() + 48), ControlState.DISABLED, ControlState.ENABLED,ims.framework.enumerations.ControlAnchoring.TOPRIGHT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
				...
				grdPhaseDetails.addIntColumn("Phase", 0, 0, 100, false, true, null, false, 0, true, 0);
				...
				grdPhaseDetails.addIntColumn("Fractions", 0, 0, -1, false, true, null, false, 0, true, 0);
				...
				grdAdjacentFields.addIntColumn("Phase", 0, 0, 60, false, true, null, false, 0, true, 0);
				...
				grdAdjacentFields.addIntColumn("No. of Txt 1", 0, 0, 80, false, true, null, false, 0, true, 0);
				...
				grdAdjacentFields.addIntColumn("No. of Txt 2", 0, 0, -1, false, true, null, false, 0, true, 0);
				...
				super.addControl(factory.getControl(IntBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1072), new Integer(anchoringHelper86.getX()), new Integer(anchoringHelper86.getY()), new Integer(anchoringHelper86.getWidth()), new Integer(anchoringHelper86.getHeight()), new Integer(startTabIndex.intValue() + 35), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT,Boolean.TRUE, Boolean.FALSE, Boolean.FALSE, null, null, Boolean.FALSE, new Integer(9)}));
				...
				super.addControl(factory.getControl(IntBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1073), new Integer(anchoringHelper87.getX()), new Integer(anchoringHelper87.getY()), new Integer(anchoringHelper87.getWidth()), new Integer(anchoringHelper87.getHeight()), new Integer(startTabIndex.intValue() + 28), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT,Boolean.TRUE, Boolean.FALSE, Boolean.FALSE, null, null, Boolean.FALSE, new Integer(9)}));
				...
				super.addControl(factory.getControl(IntBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1074), new Integer(anchoringHelper88.getX()), new Integer(anchoringHelper88.getY()), new Integer(anchoringHelper88.getWidth()), new Integer(anchoringHelper88.getHeight()), new Integer(startTabIndex.intValue() + 30), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT,Boolean.TRUE, Boolean.FALSE, Boolean.FALSE, null, null, Boolean.FALSE, new Integer(9)}));
				...
				super.addControl(factory.getControl(IntBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1075), new Integer(anchoringHelper89.getX()), new Integer(anchoringHelper89.getY()), new Integer(anchoringHelper89.getWidth()), new Integer(anchoringHelper89.getHeight()), new Integer(startTabIndex.intValue() + 31), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT,Boolean.TRUE, Boolean.FALSE, Boolean.FALSE, null, null, Boolean.FALSE, new Integer(9)}));
				...
				super.addControl(factory.getControl(DecimalBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1076), new Integer(anchoringHelper90.getX()), new Integer(anchoringHelper90.getY()), new Integer(anchoringHelper90.getWidth()), new Integer(anchoringHelper90.getHeight()), new Integer(startTabIndex.intValue() + 34), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT,Boolean.TRUE, Boolean.FALSE, Boolean.FALSE, new Integer(5), new Integer(2), "The decimal value is invalid. A valid value can have up to 3 digits and up to 2 decimals.", null, Boolean.FALSE}));
				...
				super.addControl(factory.getControl(DecimalBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1077), new Integer(anchoringHelper91.getX()), new Integer(anchoringHelper91.getY()), new Integer(anchoringHelper91.getWidth()), new Integer(anchoringHelper91.getHeight()), new Integer(startTabIndex.intValue() + 29), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT,Boolean.TRUE, Boolean.FALSE, Boolean.FALSE, new Integer(5), new Integer(2), "The decimal value is invalid. A valid value can have up to 3 digits and up to 2 decimals.", null, Boolean.FALSE}));
		...
		public static class tabBrachytherapyContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				// Label Controls
				RuntimeAnchoring anchoringHelper93 = new RuntimeAnchoring(designSize, runtimeSize, 16, 100, 32, 17, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT);
				...
				RuntimeAnchoring anchoringHelper97 = new RuntimeAnchoring(designSize, runtimeSize, 440, 154, 80, 17, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT);
				...
				RuntimeAnchoring anchoringHelper101 = new RuntimeAnchoring(designSize, runtimeSize, 440, 106, 52, 17, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT);
				super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1094), new Integer(anchoringHelper101.getX()), new Integer(anchoringHelper101.getY()), new Integer(anchoringHelper101.getWidth()), new Integer(anchoringHelper101.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Isotope:", new Integer(1), null, new Integer(0)}));
				RuntimeAnchoring anchoringHelper102 = new RuntimeAnchoring(designSize, runtimeSize, 440, 58, 147, 17, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT);
				...
				// ComboBox Controls
				RuntimeAnchoring anchoringHelper104 = new RuntimeAnchoring(designSize, runtimeSize, 176, 98, 232, 20, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFTRIGHT);
				ComboBox m_cmbUnitTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1097), new Integer(anchoringHelper104.getX()), new Integer(anchoringHelper104.getY()), new Integer(anchoringHelper104.getWidth()), new Integer(anchoringHelper104.getHeight()), new Integer(startTabIndex.intValue() + 56), ControlState.DISABLED, ControlState.ENABLED,ims.framework.enumerations.ControlAnchoring.BOTTOMLEFTRIGHT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
				...
				ComboBox m_cmbPrescriptionPointTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1098), new Integer(anchoringHelper105.getX()), new Integer(anchoringHelper105.getY()), new Integer(anchoringHelper105.getWidth()), new Integer(anchoringHelper105.getHeight()), new Integer(startTabIndex.intValue() + 55), ControlState.DISABLED, ControlState.ENABLED,ims.framework.enumerations.ControlAnchoring.BOTTOMLEFTRIGHT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
				...
				ComboBox m_cmbBrachytherapyTypeTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1099), new Integer(anchoringHelper106.getX()), new Integer(anchoringHelper106.getY()), new Integer(anchoringHelper106.getWidth()), new Integer(anchoringHelper106.getHeight()), new Integer(startTabIndex.intValue() + 54), ControlState.DISABLED, ControlState.ENABLED,ims.framework.enumerations.ControlAnchoring.BOTTOMLEFTRIGHT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.TRUE, new Integer(-1)});
				...
				ComboBox m_cmbPatientTypeTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1100), new Integer(anchoringHelper107.getX()), new Integer(anchoringHelper107.getY()), new Integer(anchoringHelper107.getWidth()), new Integer(anchoringHelper107.getHeight()), new Integer(startTabIndex.intValue() + 65), ControlState.DISABLED, ControlState.ENABLED,ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
				...
				ComboBox m_cmbDeliveryTypeTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1101), new Integer(anchoringHelper108.getX()), new Integer(anchoringHelper108.getY()), new Integer(anchoringHelper108.getWidth()), new Integer(anchoringHelper108.getHeight()), new Integer(startTabIndex.intValue() + 62), ControlState.DISABLED, ControlState.ENABLED,ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
				...
				ComboBox m_cmbUnsealedSourceTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1102), new Integer(anchoringHelper109.getX()), new Integer(anchoringHelper109.getY()), new Integer(anchoringHelper109.getWidth()), new Integer(anchoringHelper109.getHeight()), new Integer(startTabIndex.intValue() + 64), ControlState.DISABLED, ControlState.ENABLED,ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
				...
				ComboBox m_cmbActualDoseRateTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1104), new Integer(anchoringHelper111.getX()), new Integer(anchoringHelper111.getY()), new Integer(anchoringHelper111.getWidth()), new Integer(anchoringHelper111.getHeight()), new Integer(startTabIndex.intValue() + 60), ControlState.DISABLED, ControlState.ENABLED,ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
				...
				super.addControl(factory.getControl(IntBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1106), new Integer(anchoringHelper113.getX()), new Integer(anchoringHelper113.getY()), new Integer(anchoringHelper113.getWidth()), new Integer(anchoringHelper113.getHeight()), new Integer(startTabIndex.intValue() + 59), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT,Boolean.TRUE, Boolean.FALSE, Boolean.FALSE, null, null, Boolean.FALSE, new Integer(5)}));
				...
				super.addControl(factory.getControl(IntBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1107), new Integer(anchoringHelper114.getX()), new Integer(anchoringHelper114.getY()), new Integer(anchoringHelper114.getWidth()), new Integer(anchoringHelper114.getHeight()), new Integer(startTabIndex.intValue() + 61), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT,Boolean.TRUE, Boolean.FALSE, Boolean.FALSE, null, null, Boolean.FALSE, new Integer(3)}));
		
				// DecimalBox Controls
				RuntimeAnchoring anchoringHelper115 = new RuntimeAnchoring(designSize, runtimeSize, 176, 339, 100, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
				super.addControl(factory.getControl(DecimalBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1108), new Integer(anchoringHelper115.getX()), new Integer(anchoringHelper115.getY()), new Integer(anchoringHelper115.getWidth()), new Integer(anchoringHelper115.getHeight()), new Integer(startTabIndex.intValue() + 58), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.TRUE, Boolean.FALSE, Boolean.FALSE, new Integer(5), new Integer(2), "The decimal value is invalid. A valid value can have up to 3 digits and up to 2 decimals.", null, Boolean.FALSE}));
			}
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1112), new Integer(anchoringHelper119.getX()), new Integer(anchoringHelper119.getY()), new Integer(anchoringHelper119.getWidth()), new Integer(anchoringHelper119.getHeight()), new Integer(startTabIndex.intValue() + 69), ControlState.HIDDEN, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Cancel", Boolean.FALSE, null, Boolean.FALSE, Boolean.FALSE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1114), new Integer(anchoringHelper121.getX()), new Integer(anchoringHelper121.getY()), new Integer(anchoringHelper121.getWidth()), new Integer(anchoringHelper121.getHeight()), new Integer(startTabIndex.intValue() + 67), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Edit", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, "_cv_Oncology.RadiotherapyPatTreatmentPlanAction", "BO-1105100038-ID", "ID_PatAction");
			fields[145] = new ims.framework.ReportField(this.context, "_cv_Oncology.RadiotherapyPatTreatmentPlanAction", "BO-1105100038-TREATINGCONSULTANT", "TreatingConsultant");
			fields[146] = new ims.framework.ReportField(this.context, "_cv_Oncology.RadiotherapyPatTreatmentPlanAction", "BO-1105100038-ACTIVITYGROUP", "ActivityGroup");
			fields[147] = new ims.framework.ReportField(this.context, "_cv_Oncology.RadiotherapyPatTreatmentPlanAction", "BO-1105100038-PLANNEDREGIME", "PlannedRegime");
			fields[148] = new ims.framework.ReportField(this.context, "_cv_Oncology.RadiotherapyPatTreatmentPlanAction", "BO-1105100038-ACTIVE", "Active");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.RadioTherapyDetails.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1074100003-ID", "ID_RadiotherapyDetails");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.RadioTherapyDetails.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1074100003-RADIOTHERAPYTYPE", "RadiotherapyType");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.RadioTherapyDetails.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1074100003-TREATINGCONSULTANT", "TreatingConsultant");
			fields[152] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.RadioTherapyDetails.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1074100003-TREATEMENTINTENT", "TreatementIntent");
			fields[153] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.RadioTherapyDetails.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1074100003-ANATOMICALTREATMENTSITE", "AnatomicalTreatmentSite");
			fields[154] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.RadioTherapyDetails.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1074100003-DATEDECISIONTOTREAT", "DateDecisionToTreat");
			fields[155] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.RadioTherapyDetails.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1074100003-STARTDATE", "StartDate");
			fields[156] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.RadioTherapyDetails.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1074100003-EPISODEOFCARE", "EpisodeOfCare");
			fields[157] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.RadioTherapyDetails.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1074100003-ENDDATE", "EndDate");
			fields[158] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.RadioTherapyDetails.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1074100003-PRESCRIBEDDOSE", "PrescribedDose");
			fields[159] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.RadioTherapyDetails.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1074100003-PRESCRIBEDFRACTIONS", "PrescribedFractions");
			fields[160] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.RadioTherapyDetails.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1074100003-PRESCRIBEDDURATION", "PrescribedDuration");
			fields[161] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.RadioTherapyDetails.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1074100003-TREATMENTCOURSESTATUS", "TreatmentCourseStatus");
			fields[162] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.RadioTherapyDetails.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1074100003-TREATINGHOSPITAL", "TreatingHospital");
			fields[163] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.RadioTherapyDetails.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1074100003-PERFORMANCESTATUSATDDT", "PerformanceStatusAtDDT");
			fields[164] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.RadioTherapyDetails.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1074100003-CONCURRENTCHEMOTHERAPY", "ConcurrentChemotherapy");
			fields[165] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.RadioTherapyDetails.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1074100003-TREATMENTCATEGORY", "TreatmentCategory");
			fields[166] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.RadioTherapyDetails.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1074100003-DISEASESTATUS", "DiseaseStatus");
			fields[167] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.RadioTherapyDetails.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1074100003-DISEASETREATMENT", "DiseaseTreatment");
			fields[168] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.RadioTherapyDetails.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1074100003-REASONDELAY1", "ReasonDelay1");
			fields[169] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.RadioTherapyDetails.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1074100003-REASONDELAY2", "ReasonDelay2");
			fields[170] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.RadioTherapyDetails.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1074100003-PRESCRIBEDDATE", "PrescribedDate");
			fields[171] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.RadioTherapyDetails.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1074100003-ASSOCIATEDTREATMENTPLANACTION", "AssociatedTreatmentPlanAction");
			return fields;
		}
