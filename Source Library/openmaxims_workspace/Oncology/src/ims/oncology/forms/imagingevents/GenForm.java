...
public class GenForm extends FormBridge
{
	...
	public static class ctn1Container extends ContainerBridge
	{
		...
		protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
		{
			...
			ims.framework.FormUiLogic m_customControlAuthoringInfoForm = loader.loadComponent(102228, appForm, startControlID * 10 + 2000, anchoringHelper4.getSize(), instance2, startTabIndex.intValue() + 15, skipContextValidation);
			//ims.framework.Control m_customControlAuthoringInfoControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1002), new Integer(416), new Integer(128), new Integer(336), new Integer(64), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFT, new Integer(startTabIndex.intValue() + 15), m_customControlAuthoringInfoForm, instance2 } );
			ims.framework.Control m_customControlAuthoringInfoControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1003),  new Integer(anchoringHelper4.getX()), new Integer(anchoringHelper4.getY()), new Integer(anchoringHelper4.getWidth()), new Integer(anchoringHelper4.getHeight()), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFT, new Integer(startTabIndex.intValue() + 15), m_customControlAuthoringInfoForm, instance2, Boolean.FALSE } );
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.ImagingEvents.__internal_x_context__CurrentRecord_" + componentIdentifier, "BO-1074100001-ID", "ID_Imagingevents");
			fields[145] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.ImagingEvents.__internal_x_context__CurrentRecord_" + componentIdentifier, "BO-1074100001-IMAGEDATE", "ImageDate");
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.ImagingEvents.__internal_x_context__CurrentRecord_" + componentIdentifier, "BO-1074100001-ANATOMICALSITE", "AnatomicalSite");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.ImagingEvents.__internal_x_context__CurrentRecord_" + componentIdentifier, "BO-1074100001-REPORTDATE", "ReportDate");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.ImagingEvents.__internal_x_context__CurrentRecord_" + componentIdentifier, "BO-1074100001-LESIONSIZE", "LesionSize");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.ImagingEvents.__internal_x_context__CurrentRecord_" + componentIdentifier, "BO-1074100001-IMAGINGEVENTDESCRIPTION", "ImagingEventDescription");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.ImagingEvents.__internal_x_context__CurrentRecord_" + componentIdentifier, "BO-1074100001-REQUESTEDDATE", "RequestedDate");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.ImagingEvents.__internal_x_context__CurrentRecord_" + componentIdentifier, "BO-1074100001-INVESTIGATIONRESULT", "InvestigationResult");
			fields[152] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.ImagingEvents.__internal_x_context__CurrentRecord_" + componentIdentifier, "BO-1074100001-EPISODEOFCARE", "EpisodeOfCare");
			return fields;
		}
