...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Oncology.RadioToxicityDetailsRef", "_cv_Oncology.ChemoToxicityDetailsRef" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Oncology.ToxicityComponent.__internal_x_context__" + String.valueOf(getFormId());
	}
