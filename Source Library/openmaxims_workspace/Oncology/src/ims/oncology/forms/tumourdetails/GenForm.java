...
public class GenForm extends FormBridge
{
	...
	public static class lyrMainLayer extends Layer
	{
		...
		public static class tabTumourDetailsContainer extends LayerBridge
		{
			...
			public static class lyrPrognosticTNMLayer extends Layer
			{
				...
				public static class tabTNMContainer extends LayerBridge
				{
					...
					protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
					{
						...
						super.addControl(factory.getControl(DynamicGrid.class, new Object[] { control, new Integer(startControlID.intValue() + 1001), new Integer(anchoringHelper2.getX()), new Integer(anchoringHelper2.getY()), new Integer(anchoringHelper2.getWidth()), new Integer(anchoringHelper2.getHeight()), new Integer(startTabIndex.intValue() + 18), ControlState.READONLY, ControlState.EDITABLE, ims.framework.enumerations.ControlAnchoring.ALL, null, Boolean.FALSE, Boolean.FALSE, Boolean.TRUE}));
					}
				...
				public static class tabPrognosticTabContainer extends LayerBridge
				{
					...
					protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
					{
						...
						super.addControl(factory.getControl(DynamicGrid.class, new Object[] { control, new Integer(startControlID.intValue() + 1003), new Integer(anchoringHelper4.getX()), new Integer(anchoringHelper4.getY()), new Integer(anchoringHelper4.getWidth()), new Integer(anchoringHelper4.getHeight()), new Integer(startTabIndex.intValue() + 19), ControlState.READONLY, ControlState.EDITABLE, ims.framework.enumerations.ControlAnchoring.ALL, null, Boolean.FALSE, Boolean.FALSE, Boolean.TRUE}));
					}
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				ims.framework.FormUiLogic m_ccAuthoringForm = loader.loadComponent(102228, appForm, startControlID * 10 + 1000, anchoringHelper8.getSize(), instance1, startTabIndex.intValue() + 15, skipContextValidation);
				//ims.framework.Control m_ccAuthoringControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1007), new Integer(408), new Integer(216), new Integer(408), new Integer(56), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT, new Integer(startTabIndex.intValue() + 15), m_ccAuthoringForm, instance1 } );
				ims.framework.Control m_ccAuthoringControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1008),  new Integer(anchoringHelper8.getX()), new Integer(anchoringHelper8.getY()), new Integer(anchoringHelper8.getWidth()), new Integer(anchoringHelper8.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT, new Integer(startTabIndex.intValue() + 15), m_ccAuthoringForm, instance1, Boolean.FALSE } );
				...
				ComboBox m_cmbPTValueTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1048), new Integer(anchoringHelper48.getX()), new Integer(anchoringHelper48.getY()), new Integer(anchoringHelper48.getWidth()), new Integer(anchoringHelper48.getHeight()), new Integer(startTabIndex.intValue() + 20), ControlState.DISABLED, ControlState.ENABLED,ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(7)});
				...
				ComboBox m_cmbTumourSiteTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1052), new Integer(anchoringHelper52.getX()), new Integer(anchoringHelper52.getY()), new Integer(anchoringHelper52.getWidth()), new Integer(anchoringHelper52.getHeight()), new Integer(startTabIndex.intValue() + 4), ControlState.DISABLED, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,Boolean.TRUE, Boolean.TRUE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
				...
				ComboBox m_cmbBenignTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1053), new Integer(anchoringHelper53.getX()), new Integer(anchoringHelper53.getY()), new Integer(anchoringHelper53.getWidth()), new Integer(anchoringHelper53.getHeight()), new Integer(startTabIndex.intValue() + 6), ControlState.DISABLED, ControlState.ENABLED,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
				...
				ComboBox m_cmbLateralityTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1054), new Integer(anchoringHelper54.getX()), new Integer(anchoringHelper54.getY()), new Integer(anchoringHelper54.getWidth()), new Integer(anchoringHelper54.getHeight()), new Integer(startTabIndex.intValue() + 5), ControlState.DISABLED, ControlState.ENABLED,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
				...
				ComboBox m_cmbSerumMarkerTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1056), new Integer(anchoringHelper56.getX()), new Integer(anchoringHelper56.getY()), new Integer(anchoringHelper56.getWidth()), new Integer(anchoringHelper56.getHeight()), new Integer(startTabIndex.intValue() + 13), ControlState.DISABLED, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT ,Boolean.TRUE, Boolean.TRUE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
				...
				ComboBox m_cmbTumourHistologyGradeTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1058), new Integer(anchoringHelper58.getX()), new Integer(anchoringHelper58.getY()), new Integer(anchoringHelper58.getWidth()), new Integer(anchoringHelper58.getHeight()), new Integer(startTabIndex.intValue() + 11), ControlState.DISABLED, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT ,Boolean.TRUE, Boolean.TRUE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(10)});
				...
				ComboBox m_cmbTumourHistologyTypeTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1059), new Integer(anchoringHelper59.getX()), new Integer(anchoringHelper59.getY()), new Integer(anchoringHelper59.getWidth()), new Integer(anchoringHelper59.getHeight()), new Integer(startTabIndex.intValue() + 10), ControlState.DISABLED, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT ,Boolean.TRUE, Boolean.TRUE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(10)});
		...
		public static class tabAssessmentContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				ims.framework.FormUiLogic m_ccTumourGroupAssessmentForm = loader.loadComponent(127109, appForm, startControlID * 10 + 2000, anchoringHelper60.getSize(), instance1, startTabIndex.intValue() + 28, skipContextValidation);
				//ims.framework.Control m_ccTumourGroupAssessmentControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1060), new Integer(8), new Integer(8), new Integer(808), new Integer(504), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 28), m_ccTumourGroupAssessmentForm, instance1 } );
				ims.framework.Control m_ccTumourGroupAssessmentControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1061),  new Integer(anchoringHelper60.getX()), new Integer(anchoringHelper60.getY()), new Integer(anchoringHelper60.getWidth()), new Integer(anchoringHelper60.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 28), m_ccTumourGroupAssessmentForm, instance1, Boolean.FALSE } );
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1064), new Integer(anchoringHelper63.getX()), new Integer(anchoringHelper63.getY()), new Integer(anchoringHelper63.getWidth()), new Integer(anchoringHelper63.getHeight()), new Integer(startTabIndex.intValue() + 31), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Edit", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1065), new Integer(anchoringHelper64.getX()), new Integer(anchoringHelper64.getY()), new Integer(anchoringHelper64.getWidth()), new Integer(anchoringHelper64.getHeight()), new Integer(startTabIndex.intValue() + 30), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "New", Boolean.TRUE, null, Boolean.TRUE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[166] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.TumourDetails.__internal_x_context__SelectedDiagnosisForPrimaryTumourDetails_" + componentIdentifier, "BO-1003100016-ID", "ID_PatientDiagnosis");
			fields[167] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.TumourDetails.__internal_x_context__SelectedDiagnosisForPrimaryTumourDetails_" + componentIdentifier, "BO-1003100016-DIAGNOSISDESCRIPTION", "DiagnosisDescription");
			fields[168] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.TumourDetails.__internal_x_context__SelectedDiagnosisForPrimaryTumourDetails_" + componentIdentifier, "BO-1003100016-DIAGNOSEDDATE", "DiagnosedDate");
			fields[169] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.TumourDetails.__internal_x_context__SelectedDiagnosisForPrimaryTumourDetails_" + componentIdentifier, "BO-1003100016-DIAGLATERALITY", "DiagLaterality");
			fields[170] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.TumourDetails.__internal_x_context__SelectedGroup_" + componentIdentifier, "BO-1074100009-ID", "ID_TumourGroup");
			fields[171] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.TumourDetails.__internal_x_context__SelectedGroup_" + componentIdentifier, "BO-1074100009-GROUPNAME", "GroupName");
			fields[172] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.TumourDetails.__internal_x_context__SelectedGroup_" + componentIdentifier, "BO-1074100009-TNMREQUIRESOVER45", "TnmRequiresOver45");
			fields[173] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.TumourDetails.__internal_x_context__SelectedGroup_" + componentIdentifier, "BO-1074100009-ISACTIVE", "IsActive");
			fields[174] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.TumourDetails.__internal_x_context__SelectedGroup_" + componentIdentifier, "BO-1074100009-HASTNM", "HasTNM");
			fields[175] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.TumourDetails.__internal_x_context__SelectedGroup_" + componentIdentifier, "BO-1074100009-ASSESSMENT", "Assessment");
			fields[176] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.TumourDetails.__internal_x_context__SelectedGroup_" + componentIdentifier, "BO-1074100009-ISPROGNOSTICGROUPINGRELEVANT", "IsPrognosticGroupingRelevant");
			fields[177] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.TumourDetails.__internal_x_context__SelectedGroup_" + componentIdentifier, "BO-1074100009-TNMREQUIRESDIFF", "TnmRequiresDiff");
			fields[178] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.TumourDetails.__internal_x_context__SelectedGroup_" + componentIdentifier, "BO-1074100009-TNMREQUIRESHISTO", "TnmRequiresHisto");
			fields[179] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.TumourDetails.__internal_x_context__SelectedGroup_" + componentIdentifier, "BO-1074100009-TNMREQUIRESSMARKERS", "TnmRequiresSMarkers");
			fields[180] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.TumourDetails.__internal_x_context__SelectedSite_" + componentIdentifier, "BO-1074100010-ID", "ID_TumourSite");
			fields[181] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.TumourDetails.__internal_x_context__SelectedSite_" + componentIdentifier, "BO-1074100010-NAME", "Name");
			fields[182] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.TumourDetails.__internal_x_context__SelectedSite_" + componentIdentifier, "BO-1074100010-ISACTIVE", "IsActive");
			fields[183] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.TumourDetails.__internal_x_context__SelectedSite_" + componentIdentifier, "BO-1074100010-HASSITESPECIFICTNM", "HasSiteSpecificTNM");
			fields[184] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.TumourDetails.__internal_x_context__SelectedSite_" + componentIdentifier, "BO-1074100010-HASSITESPECIFICHISTOLOGY", "HasSiteSpecificHistology");
			fields[185] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.TumourDetails.__internal_x_context__SelectedSite_" + componentIdentifier, "BO-1074100010-DESCRIPTION", "Description");
			fields[186] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.TumourDetails.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1074100007-ID", "ID_PrimaryTumourDetails");
			fields[187] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.TumourDetails.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1074100007-TUMOURLATERALITY", "TumourLaterality");
			fields[188] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.TumourDetails.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1074100007-ISCURRENT", "IsCurrent");
			fields[189] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.TumourDetails.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1074100007-ENDDATE", "EndDate");
			fields[190] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.TumourDetails.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1074100007-EPISODEOFCARE", "EpisodeOfCare");
			fields[191] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.TumourDetails.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1074100007-BENIGN", "Benign");
			fields[192] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.TumourDetails.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1074100007-TUMOURSTATUS", "TumourStatus");
			fields[193] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.TumourDetails.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1074100007-HISTOLOGYSOURCE", "HistologySource");
			fields[194] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.TumourDetails.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1074100007-DIFFERENTATATIONSOURCE", "DifferentatationSource");
			fields[195] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.TumourDetails.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1074100007-PRETREATMENTTCERT", "PreTreatmentTCert");
			fields[196] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.TumourDetails.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1074100007-PRETREATMENTNCERT", "PreTreatmentNCert");
			fields[197] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.TumourDetails.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1074100007-PRETREATMENTMCERT", "PreTreatmentMCert");
			fields[198] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.TumourDetails.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1074100007-PRETREATMENTOVERALLCERT", "PreTreatmentOverAllCert");
			fields[199] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.TumourDetails.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1074100007-BASISOFDIAGNOSIS", "BasisofDiagnosis");
			fields[200] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.TumourDetails.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1074100007-OVER45STATUS", "Over45Status");
			fields[201] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.TumourDetails.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1074100007-MOVEDTOPROGNOSTIC", "MovedToPrognostic");
			fields[202] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.TumourDetails.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1074100007-PROGNOSTICGROUPINGCERT", "PrognosticGroupingCert");
			fields[203] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.TumourDetails.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1074100007-PROGNOSTICTCERT", "PrognosticTCert");
			fields[204] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.TumourDetails.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1074100007-PROGNOSTICNCERT", "PrognosticNCert");
			fields[205] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.TumourDetails.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1074100007-PROGNOSTICMCERT", "PrognosticMCert");
			fields[206] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.TumourDetails.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1074100007-PATHOLOGICALDATE", "PathologicalDate");
			fields[207] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.TumourDetails.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1074100007-INTEGRATEDDATE", "IntegratedDate");
			fields[208] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.TumourDetails.__internal_x_context__CurrentEditableRecord_" + componentIdentifier, "BO-1074100007-ID", "ID_PrimaryTumourDetails");
			return fields;
		}
