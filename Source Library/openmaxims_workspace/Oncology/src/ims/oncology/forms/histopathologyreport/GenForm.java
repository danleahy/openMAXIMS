...
public class GenForm extends FormBridge
{
	...
	public static class lyrDetailsLayer extends Layer
	{
		...
		public static class tabGenDetailsContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				ims.framework.FormUiLogic m_customControlMosRequesterForm = loader.loadComponent(102256, appForm, startControlID * 10 + 1000, anchoringHelper1.getSize(), instance1, startTabIndex.intValue() + 15, skipContextValidation);
				//ims.framework.Control m_customControlMosRequesterControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1000), new Integer(560), new Integer(182), new Integer(248), new Integer(20), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT, new Integer(startTabIndex.intValue() + 15), m_customControlMosRequesterForm, instance1 } );
				ims.framework.Control m_customControlMosRequesterControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1001),  new Integer(anchoringHelper1.getX()), new Integer(anchoringHelper1.getY()), new Integer(anchoringHelper1.getWidth()), new Integer(anchoringHelper1.getHeight()), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT, new Integer(startTabIndex.intValue() + 15), m_customControlMosRequesterForm, instance1, Boolean.FALSE } );
				...
				ims.framework.FormUiLogic m_customControlAuthoringForm = loader.loadComponent(102228, appForm, startControlID * 10 + 3000, anchoringHelper3.getSize(), instance3, startTabIndex.intValue() + 17, skipContextValidation);
				//ims.framework.Control m_customControlAuthoringControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1004), new Integer(400), new Integer(224), new Integer(408), new Integer(56), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT, new Integer(startTabIndex.intValue() + 17), m_customControlAuthoringForm, instance3 } );
				ims.framework.Control m_customControlAuthoringControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1005),  new Integer(anchoringHelper3.getX()), new Integer(anchoringHelper3.getY()), new Integer(anchoringHelper3.getWidth()), new Integer(anchoringHelper3.getHeight()), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT, new Integer(startTabIndex.intValue() + 17), m_customControlAuthoringForm, instance3, Boolean.FALSE } );
		...
		public static class tabTumDetailsContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				ComboBox m_cmbExcisionMargTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1037), new Integer(anchoringHelper35.getX()), new Integer(anchoringHelper35.getY()), new Integer(anchoringHelper35.getWidth()), new Integer(anchoringHelper35.getHeight()), new Integer(startTabIndex.intValue() + 25), ControlState.DISABLED, ControlState.ENABLED,ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
				...
				ComboBox m_cmbGradeDifferentationTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1039), new Integer(anchoringHelper37.getX()), new Integer(anchoringHelper37.getY()), new Integer(anchoringHelper37.getWidth()), new Integer(anchoringHelper37.getHeight()), new Integer(startTabIndex.intValue() + 23), ControlState.DISABLED, ControlState.ENABLED,ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
				...
				ComboBox m_cmbSynchronousTumourTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1040), new Integer(anchoringHelper38.getX()), new Integer(anchoringHelper38.getY()), new Integer(anchoringHelper38.getWidth()), new Integer(anchoringHelper38.getHeight()), new Integer(startTabIndex.intValue() + 21), ControlState.DISABLED, ControlState.ENABLED,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
				...
				super.addControl(factory.getControl(IntBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1044), new Integer(anchoringHelper42.getX()), new Integer(anchoringHelper42.getY()), new Integer(anchoringHelper42.getWidth()), new Integer(anchoringHelper42.getHeight()), new Integer(startTabIndex.intValue() + 20), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.TRUE, Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, new Integer(9)}));
		...
		public static class tabTNMContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				ComboBox m_cmbPathologicalTNMTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1052), new Integer(anchoringHelper50.getX()), new Integer(anchoringHelper50.getY()), new Integer(anchoringHelper50.getWidth()), new Integer(anchoringHelper50.getHeight()), new Integer(startTabIndex.intValue() + 31), ControlState.DISABLED, ControlState.DISABLED,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
				...
				ComboBox m_cmbPathologicalMTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1053), new Integer(anchoringHelper51.getX()), new Integer(anchoringHelper51.getY()), new Integer(anchoringHelper51.getWidth()), new Integer(anchoringHelper51.getHeight()), new Integer(startTabIndex.intValue() + 30), ControlState.DISABLED, ControlState.ENABLED,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,Boolean.TRUE, Boolean.TRUE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
				...
				ComboBox m_cmbPathologicalNTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1054), new Integer(anchoringHelper52.getX()), new Integer(anchoringHelper52.getY()), new Integer(anchoringHelper52.getWidth()), new Integer(anchoringHelper52.getHeight()), new Integer(startTabIndex.intValue() + 29), ControlState.DISABLED, ControlState.ENABLED,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,Boolean.TRUE, Boolean.TRUE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
				...
				ComboBox m_cmbPathologicalTTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1055), new Integer(anchoringHelper53.getX()), new Integer(anchoringHelper53.getY()), new Integer(anchoringHelper53.getWidth()), new Integer(anchoringHelper53.getHeight()), new Integer(startTabIndex.intValue() + 28), ControlState.DISABLED, ControlState.ENABLED,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,Boolean.TRUE, Boolean.TRUE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(10)});
				...
				super.addControl(factory.getControl(DynamicGrid.class, new Object[] { control, new Integer(startControlID.intValue() + 1056), new Integer(anchoringHelper54.getX()), new Integer(anchoringHelper54.getY()), new Integer(anchoringHelper54.getWidth()), new Integer(anchoringHelper54.getHeight()), new Integer(startTabIndex.intValue() + 33), ControlState.READONLY, ControlState.EDITABLE, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT, null, Boolean.FALSE, Boolean.FALSE, Boolean.TRUE}));
				...
				super.addControl(factory.getControl(DynamicGrid.class, new Object[] { control, new Integer(startControlID.intValue() + 1057), new Integer(anchoringHelper55.getX()), new Integer(anchoringHelper55.getY()), new Integer(anchoringHelper55.getWidth()), new Integer(anchoringHelper55.getHeight()), new Integer(startTabIndex.intValue() + 32), ControlState.READONLY, ControlState.EDITABLE, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT, null, Boolean.FALSE, Boolean.FALSE, Boolean.TRUE}));
			}
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1068), new Integer(anchoringHelper65.getX()), new Integer(anchoringHelper65.getY()), new Integer(anchoringHelper65.getWidth()), new Integer(anchoringHelper65.getHeight()), new Integer(startTabIndex.intValue() + 34), ControlState.HIDDEN, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Save", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedUserAssessmentVo", "BO-1003100043-ID", "ID_UserAssessment");
			fields[145] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedUserAssessmentVo", "BO-1003100043-NAME", "Name");
			fields[146] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedUserAssessmentVo", "BO-1003100043-DESCRIPTION", "Description");
			fields[147] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedUserAssessmentVo", "BO-1003100043-ASSESSMENTTYPE", "AssessmentType");
			fields[148] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedUserAssessmentVo", "BO-1003100043-ACTIVESTATUS", "ActiveStatus");
			fields[149] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedUserAssessmentVo", "BO-1003100043-HELPURL", "HelpURL");
			fields[150] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedUserAssessmentVo", "BO-1003100043-SCORINGMETHOD", "ScoringMethod");
			fields[151] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedUserAssessmentVo", "BO-1003100043-ISFLATVIEW", "IsFlatView");
			fields[152] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedUserAssessmentVo", "BO-1003100043-CATEGORY", "Category");
			fields[153] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedUserAssessmentVo", "BO-1003100043-ISMULTIPLEGROUP", "IsMultipleGroup");
			fields[154] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedUserAssessmentVo", "BO-1003100043-GROUPQUESTIONWIDTH", "GroupQuestionWidth");
			fields[155] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedUserAssessmentVo", "BO-1003100043-STOREPRINTEDASSESSMENT", "StorePrintedAssessment");
			fields[156] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedUserAssessmentVo", "BO-1003100043-ISMULTIROLE", "IsMultiRole");
			fields[157] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedUserAssessmentVo", "BO-1003100043-HEADERTEXT", "HeaderText");
			fields[158] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedUserAssessmentVo", "BO-1003100043-FOOTERTEXT", "FooterText");
			fields[159] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedUserAssessmentVo", "BO-1003100043-MAXHEADERHEIGHT", "MaxHeaderHeight");
			fields[160] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedUserAssessmentVo", "BO-1003100043-MAXFOOTERHEIGHT", "MaxFooterHeight");
			fields[161] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedUserAssessmentVo", "BO-1003100043-ASSOCIATEDREPORT", "AssociatedReport");
			fields[162] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedUserAssessmentVo", "BO-1003100043-CANCOPYLAST", "CanCopyLast");
			fields[163] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedUserAssessmentVo", "BO-1003100043-COPYLASTFROMCONTEXT", "CopyLastFromContext");
			fields[164] = new ims.framework.ReportField(this.context, "_cv_Oncology.SelectedPrimaryTumourDetail", "BO-1074100007-ID", "ID_PrimaryTumourDetails");
			fields[165] = new ims.framework.ReportField(this.context, "_cv_Oncology.SelectedPrimaryTumourDetail", "BO-1074100007-TUMOURLATERALITY", "TumourLaterality");
			fields[166] = new ims.framework.ReportField(this.context, "_cv_Oncology.SelectedPrimaryTumourDetail", "BO-1074100007-ISCURRENT", "IsCurrent");
			fields[167] = new ims.framework.ReportField(this.context, "_cv_Oncology.SelectedPrimaryTumourDetail", "BO-1074100007-ENDDATE", "EndDate");
			fields[168] = new ims.framework.ReportField(this.context, "_cv_Oncology.SelectedPrimaryTumourDetail", "BO-1074100007-EPISODEOFCARE", "EpisodeOfCare");
			fields[169] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.HistoPathologyReport.__internal_x_context__SelectedPathologyDetailsVo_" + componentIdentifier, "BO-1074100015-ID", "ID_PathologyDetails");
			fields[170] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.HistoPathologyReport.__internal_x_context__SelectedPathologyDetailsVo_" + componentIdentifier, "BO-1074100015-INVESTIGATIONTYPE", "InvestigationType");
			fields[171] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.HistoPathologyReport.__internal_x_context__SelectedPathologyDetailsVo_" + componentIdentifier, "BO-1074100015-SAMPLERECEIPTDATE", "SampleReceiptDate");
			fields[172] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.HistoPathologyReport.__internal_x_context__SelectedPathologyDetailsVo_" + componentIdentifier, "BO-1074100015-INVESTIGATIONRESULTDATE", "InvestigationResultDate");
			fields[173] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.HistoPathologyReport.__internal_x_context__SelectedPathologyDetailsVo_" + componentIdentifier, "BO-1074100015-REPORTINGCONSULTANTCODE", "ReportingConsultantCode");
			fields[174] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.HistoPathologyReport.__internal_x_context__SelectedPathologyDetailsVo_" + componentIdentifier, "BO-1074100015-CARECONTEXT", "CareContext");
			fields[175] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.HistoPathologyReport.__internal_x_context__SelectedPathologyDetailsVo_" + componentIdentifier, "BO-1074100015-PREVIOUSVERSION", "PreviousVersion");
			fields[176] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.HistoPathologyReport.__internal_x_context__SelectedPathologyDetailsVo_" + componentIdentifier, "BO-1074100015-INVASIVELESIONSIZE", "InvasiveLesionSize");
			fields[177] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.HistoPathologyReport.__internal_x_context__SelectedPathologyDetailsVo_" + componentIdentifier, "BO-1074100015-SYNCHRONOUSTUMOURINDICATOR", "SynchronousTumourIndicator");
			fields[178] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.HistoPathologyReport.__internal_x_context__SelectedPathologyDetailsVo_" + componentIdentifier, "BO-1074100015-VASCULARLYMPHINVASION", "VascularLymphInvasion");
			fields[179] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.HistoPathologyReport.__internal_x_context__SelectedPathologyDetailsVo_" + componentIdentifier, "BO-1074100015-EXCISIONMARGIN", "ExcisionMargin");
			fields[180] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.HistoPathologyReport.__internal_x_context__SelectedPathologyDetailsVo_" + componentIdentifier, "BO-1074100015-NUMBERNODESEXAMINED", "NumberNodesExamined");
			fields[181] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.HistoPathologyReport.__internal_x_context__SelectedPathologyDetailsVo_" + componentIdentifier, "BO-1074100015-NODESPOSITIVENUMBER", "NodesPositiveNumber");
			fields[182] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.HistoPathologyReport.__internal_x_context__SelectedPathologyDetailsVo_" + componentIdentifier, "BO-1074100015-SERVICEREPORTID", "ServiceReportId");
			fields[183] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.HistoPathologyReport.__internal_x_context__SelectedPathologyDetailsVo_" + componentIdentifier, "BO-1074100015-SERVICEREPORTSTATUS", "ServiceReportStatus");
			fields[184] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.HistoPathologyReport.__internal_x_context__SelectedPathologyDetailsVo_" + componentIdentifier, "BO-1074100015-SPECIMENNATURE", "SpecimenNature");
			fields[185] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.HistoPathologyReport.__internal_x_context__SelectedPathologyDetailsVo_" + componentIdentifier, "BO-1074100015-CAREPROFCODEREQUESTER", "CareProfCodeRequester");
			fields[186] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.HistoPathologyReport.__internal_x_context__SelectedPathologyDetailsVo_" + componentIdentifier, "BO-1074100015-STATUS", "Status");
			fields[187] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.HistoPathologyReport.__internal_x_context__SpecimenQuestionsAssessment_" + componentIdentifier, "BO-1003100043-ID", "ID_UserAssessment");
			fields[188] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.HistoPathologyReport.__internal_x_context__SpecimenQuestionsAssessment_" + componentIdentifier, "BO-1003100043-NAME", "Name");
			fields[189] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.HistoPathologyReport.__internal_x_context__SpecimenQuestionsAssessment_" + componentIdentifier, "BO-1003100043-DESCRIPTION", "Description");
			fields[190] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.HistoPathologyReport.__internal_x_context__SpecimenQuestionsAssessment_" + componentIdentifier, "BO-1003100043-ASSESSMENTTYPE", "AssessmentType");
			fields[191] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.HistoPathologyReport.__internal_x_context__SpecimenQuestionsAssessment_" + componentIdentifier, "BO-1003100043-ACTIVESTATUS", "ActiveStatus");
			fields[192] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.HistoPathologyReport.__internal_x_context__SpecimenQuestionsAssessment_" + componentIdentifier, "BO-1003100043-HELPURL", "HelpURL");
			fields[193] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.HistoPathologyReport.__internal_x_context__SpecimenQuestionsAssessment_" + componentIdentifier, "BO-1003100043-SCORINGMETHOD", "ScoringMethod");
			fields[194] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.HistoPathologyReport.__internal_x_context__SpecimenQuestionsAssessment_" + componentIdentifier, "BO-1003100043-ISFLATVIEW", "IsFlatView");
			fields[195] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.HistoPathologyReport.__internal_x_context__SpecimenQuestionsAssessment_" + componentIdentifier, "BO-1003100043-CATEGORY", "Category");
			fields[196] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.HistoPathologyReport.__internal_x_context__SpecimenQuestionsAssessment_" + componentIdentifier, "BO-1003100043-ISMULTIPLEGROUP", "IsMultipleGroup");
			fields[197] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.HistoPathologyReport.__internal_x_context__SpecimenQuestionsAssessment_" + componentIdentifier, "BO-1003100043-GROUPQUESTIONWIDTH", "GroupQuestionWidth");
			fields[198] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.HistoPathologyReport.__internal_x_context__SpecimenQuestionsAssessment_" + componentIdentifier, "BO-1003100043-STOREPRINTEDASSESSMENT", "StorePrintedAssessment");
			fields[199] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.HistoPathologyReport.__internal_x_context__SpecimenQuestionsAssessment_" + componentIdentifier, "BO-1003100043-ISMULTIROLE", "IsMultiRole");
			fields[200] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.HistoPathologyReport.__internal_x_context__SpecimenQuestionsAssessment_" + componentIdentifier, "BO-1003100043-HEADERTEXT", "HeaderText");
			fields[201] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.HistoPathologyReport.__internal_x_context__SpecimenQuestionsAssessment_" + componentIdentifier, "BO-1003100043-FOOTERTEXT", "FooterText");
			fields[202] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.HistoPathologyReport.__internal_x_context__SpecimenQuestionsAssessment_" + componentIdentifier, "BO-1003100043-MAXHEADERHEIGHT", "MaxHeaderHeight");
			fields[203] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.HistoPathologyReport.__internal_x_context__SpecimenQuestionsAssessment_" + componentIdentifier, "BO-1003100043-MAXFOOTERHEIGHT", "MaxFooterHeight");
			fields[204] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.HistoPathologyReport.__internal_x_context__SpecimenQuestionsAssessment_" + componentIdentifier, "BO-1003100043-ASSOCIATEDREPORT", "AssociatedReport");
			fields[205] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.HistoPathologyReport.__internal_x_context__SpecimenQuestionsAssessment_" + componentIdentifier, "BO-1003100043-CANCOPYLAST", "CanCopyLast");
			fields[206] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.HistoPathologyReport.__internal_x_context__SpecimenQuestionsAssessment_" + componentIdentifier, "BO-1003100043-COPYLASTFROMCONTEXT", "CopyLastFromContext");
			fields[207] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.HistoPathologyReport.__internal_x_context__SelectedPrimaryTumour_" + componentIdentifier, "BO-1074100007-ID", "ID_PrimaryTumourDetails");
			fields[208] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.HistoPathologyReport.__internal_x_context__SelectedPrimaryTumour_" + componentIdentifier, "BO-1074100007-TUMOURLATERALITY", "TumourLaterality");
			fields[209] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.HistoPathologyReport.__internal_x_context__SelectedPrimaryTumour_" + componentIdentifier, "BO-1074100007-ISCURRENT", "IsCurrent");
			fields[210] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.HistoPathologyReport.__internal_x_context__SelectedPrimaryTumour_" + componentIdentifier, "BO-1074100007-ENDDATE", "EndDate");
			fields[211] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.HistoPathologyReport.__internal_x_context__SelectedPrimaryTumour_" + componentIdentifier, "BO-1074100007-EPISODEOFCARE", "EpisodeOfCare");
			fields[212] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.HistoPathologyReport.__internal_x_context__LoadedTumourGroup_" + componentIdentifier, "BO-1074100009-ID", "ID_TumourGroup");
			fields[213] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.HistoPathologyReport.__internal_x_context__LoadedTumourGroup_" + componentIdentifier, "BO-1074100009-GROUPNAME", "GroupName");
			fields[214] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.HistoPathologyReport.__internal_x_context__LoadedTumourGroup_" + componentIdentifier, "BO-1074100009-ISACTIVE", "IsActive");
			fields[215] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.HistoPathologyReport.__internal_x_context__LoadedTumourGroup_" + componentIdentifier, "BO-1074100009-HASTNM", "HasTNM");
			fields[216] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.HistoPathologyReport.__internal_x_context__LoadedTumourGroup_" + componentIdentifier, "BO-1074100009-ISPROGNOSTICGROUPINGRELEVANT", "IsPrognosticGroupingRelevant");
			fields[217] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.HistoPathologyReport.__internal_x_context__LoadedTumourGroup_" + componentIdentifier, "BO-1074100009-GROUPDESCRIPTION", "GroupDescription");
			fields[218] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.HistoPathologyReport.__internal_x_context__LoadedTumourGroup_" + componentIdentifier, "BO-1074100009-HASOTHERCLASSIFICATIONS", "HasOtherClassifications");
			fields[219] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.HistoPathologyReport.__internal_x_context__LoadedTumourGroup_" + componentIdentifier, "BO-1074100009-TNMREQUIRESDIFF", "TnmRequiresDiff");
			fields[220] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.HistoPathologyReport.__internal_x_context__LoadedTumourGroup_" + componentIdentifier, "BO-1074100009-TNMREQUIRESOVER45", "TnmRequiresOver45");
			fields[221] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.HistoPathologyReport.__internal_x_context__LoadedTumourGroup_" + componentIdentifier, "BO-1074100009-TNMREQUIRESHISTO", "TnmRequiresHisto");
			fields[222] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.HistoPathologyReport.__internal_x_context__LoadedTumourGroup_" + componentIdentifier, "BO-1074100009-TNMREQUIRESSMARKERS", "TnmRequiresSMarkers");
			fields[223] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.HistoPathologyReport.__internal_x_context__LoadedTumourGroup_" + componentIdentifier, "BO-1074100009-TNMVERSION", "TNMVersion");
			fields[224] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.HistoPathologyReport.__internal_x_context__LoadedTumourSite_" + componentIdentifier, "BO-1074100010-ID", "ID_TumourSite");
			fields[225] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.HistoPathologyReport.__internal_x_context__LoadedTumourSite_" + componentIdentifier, "BO-1074100010-NAME", "Name");
			fields[226] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.HistoPathologyReport.__internal_x_context__LoadedTumourSite_" + componentIdentifier, "BO-1074100010-ISACTIVE", "IsActive");
			fields[227] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.HistoPathologyReport.__internal_x_context__LoadedTumourSite_" + componentIdentifier, "BO-1074100010-HASSITESPECIFICTNM", "HasSiteSpecificTNM");
			fields[228] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.HistoPathologyReport.__internal_x_context__LoadedTumourSite_" + componentIdentifier, "BO-1074100010-HASSITESPECIFICHISTOLOGY", "HasSiteSpecificHistology");
			fields[229] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.HistoPathologyReport.__internal_x_context__LoadedTumourSite_" + componentIdentifier, "BO-1074100010-DESCRIPTION", "Description");
			fields[230] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.HistoPathologyReport.__internal_x_context__LoadedTumourSite_" + componentIdentifier, "BO-1074100010-TNMVERSION", "TNMVersion");
			return fields;
		}
