...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "PatientsOutpatientAppointments";
	}
	public int getWidth()
	{
		return 960;
	...
	{
		return new String[] { "_cv_Oncology.ChosenOPAppointment", "_cv_Oncology.ChosenCCOOPAppointment" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Oncology.PatientsOutpatientAppointments.__internal_x_context__" + String.valueOf(getFormId());
	}
