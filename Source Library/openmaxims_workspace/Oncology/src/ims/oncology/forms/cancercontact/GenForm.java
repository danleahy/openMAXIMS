...
public class GenForm extends FormBridge
{
	...
	public static class lyr1Layer extends Layer
	{
		...
		public static class tabPageDetailsContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1024), new Integer(anchoringHelper23.getX()), new Integer(anchoringHelper23.getY()), new Integer(anchoringHelper23.getWidth()), new Integer(anchoringHelper23.getHeight()), new Integer(startTabIndex.intValue() + 22), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Edit", Boolean.TRUE, null, Boolean.FALSE, Boolean.FALSE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.CancerContact.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1074100038-ID", "ID_CancerContacts");
			fields[145] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.CancerContact.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1074100038-CARECONTEXT", "CareContext");
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.CancerContact.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1074100038-HCPDISCIPLINE", "HCPDiscipline");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.CancerContact.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1074100038-CONTACTDATETIME", "ContactDateTime");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.CancerContact.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1074100038-UNITSREQUIRED", "UnitsRequired");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.CancerContact.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1074100038-UNITSGIVEN", "UnitsGiven");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.CancerContact.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1074100038-COMMENT", "Comment");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.CancerContact.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1074100038-EPISODEOFCARE", "EpisodeOfCare");
			return fields;
		}
