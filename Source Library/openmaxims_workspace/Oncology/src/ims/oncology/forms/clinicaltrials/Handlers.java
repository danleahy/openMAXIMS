...
{
	abstract protected void bindcmbEnteredLookup();
	abstract protected void defaultcmbEnteredLookupValue();
	abstract protected void bindcmbOferredLookup();
	abstract protected void defaultcmbOferredLookupValue();
	abstract protected void bindcmbTrialNameLookup();
	abstract protected void defaultcmbTrialNameLookupValue();
	abstract protected void onFormOpen(Object[] args) throws ims.framework.exceptions.PresentationLogicException;
	abstract protected void oncmbEnteredValueSet(Object value);
	abstract protected void oncmbOferredValueSet(Object value);
	abstract protected void oncmbTrialNameValueSet(Object value);
	abstract protected void onGrdClinicalTrialsSelectionChanged() throws ims.framework.exceptions.PresentationLogicException;
	...
	public final void setContext(ims.framework.UIEngine engine, GenForm form)
	{
		...
		this.form.ctnDetails().cmbEntered().setValueSetEvent(new ComboBoxValueSet()
		{
			private static final long serialVersionUID = 1L;
			public void handle(Object value)
			{
				oncmbEnteredValueSet(value);
			}
		});
		this.form.ctnDetails().cmbOferred().setValueSetEvent(new ComboBoxValueSet()
		{
			private static final long serialVersionUID = 1L;
			public void handle(Object value)
			{
				oncmbOferredValueSet(value);
			}
		});
		this.form.ctnDetails().cmbTrialName().setValueSetEvent(new ComboBoxValueSet()
		{
			private static final long serialVersionUID = 1L;
			public void handle(Object value)
			{
				oncmbTrialNameValueSet(value);
			}
		});
		this.form.grdClinicalTrials().setSelectionChangedEvent(new GridSelectionChanged()
		{
			private static final long serialVersionUID = 1L;
			public void handle(ims.framework.enumerations.MouseButton mouseButton) throws ims.framework.exceptions.PresentationLogicException
			{
				onGrdClinicalTrialsSelectionChanged();
			}
		});
	...
	{
		defaultcmbEnteredLookupValue();
		defaultcmbOferredLookupValue();
		defaultcmbTrialNameLookupValue();
	}
