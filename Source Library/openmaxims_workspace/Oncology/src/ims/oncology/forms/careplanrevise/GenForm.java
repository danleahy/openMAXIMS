...
public class GenForm extends FormBridge
{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1016), new Integer(anchoringHelper17.getX()), new Integer(anchoringHelper17.getY()), new Integer(anchoringHelper17.getWidth()), new Integer(anchoringHelper17.getHeight()), new Integer(startTabIndex.intValue() + 12), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT, ">>", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1018), new Integer(anchoringHelper19.getX()), new Integer(anchoringHelper19.getY()), new Integer(anchoringHelper19.getWidth()), new Integer(anchoringHelper19.getHeight()), new Integer(startTabIndex.intValue() + 17), ControlState.ENABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Cancel", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1019), new Integer(anchoringHelper20.getX()), new Integer(anchoringHelper20.getY()), new Integer(anchoringHelper20.getWidth()), new Integer(anchoringHelper20.getHeight()), new Integer(startTabIndex.intValue() + 10), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT,Boolean.TRUE, new Integer(1000), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
		...
		super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1020), new Integer(anchoringHelper21.getX()), new Integer(anchoringHelper21.getY()), new Integer(anchoringHelper21.getWidth()), new Integer(anchoringHelper21.getHeight()), new Integer(startTabIndex.intValue() + 1), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT,Boolean.TRUE, new Integer(255), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
		...
		ComboBox m_cmbAssociatedMDTTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1024), new Integer(anchoringHelper25.getX()), new Integer(anchoringHelper25.getY()), new Integer(anchoringHelper25.getWidth()), new Integer(anchoringHelper25.getHeight()), new Integer(startTabIndex.intValue() + 15), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.BOTTOMLEFTRIGHT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
		...
		ComboBox m_cmbRecurrenceTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1027), new Integer(anchoringHelper28.getX()), new Integer(anchoringHelper28.getY()), new Integer(anchoringHelper28.getWidth()), new Integer(anchoringHelper28.getHeight()), new Integer(startTabIndex.intValue() + 7), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
		...
		gridPlannedMod.addIntColumn("Seq.", 0, 0, -1, false, true, null, false, 0, true, 0);
		...
		Grid m_gridActualModalityTemp = (Grid)factory.getControl(Grid.class, new Object[] { control, new Integer(startControlID.intValue() + 1032), new Integer(anchoringHelper33.getX()), new Integer(anchoringHelper33.getY()), new Integer(anchoringHelper33.getWidth()), new Integer(anchoringHelper33.getHeight()), new Integer(startTabIndex.intValue() + 14), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT,Boolean.TRUE, Boolean.FALSE, new Integer(24), Boolean.TRUE, null, Boolean.FALSE, Boolean.FALSE, new Integer(0), null, Boolean.FALSE, Boolean.TRUE});
		...
		gridActualModality.addIntColumn("Seq.", 0, 0, -1, false, true, null, false, 0, true, 0);
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, "_cv_Oncology.voCancerCarePlan", "BO-1074100016-ID", "ID_CancerCarePlan");
			fields[145] = new ims.framework.ReportField(this.context, "_cv_Oncology.voCancerCarePlan", "BO-1074100016-CAREPLANDATE", "CarePlanDate");
			fields[146] = new ims.framework.ReportField(this.context, "_cv_Oncology.voCancerCarePlan", "BO-1074100016-CAREPLANINTENT", "CarePlanIntent");
			fields[147] = new ims.framework.ReportField(this.context, "_cv_Oncology.voCancerCarePlan", "BO-1074100016-RECURRENCEINDICATOR", "RecurrenceIndicator");
			fields[148] = new ims.framework.ReportField(this.context, "_cv_Oncology.voCancerCarePlan", "BO-1074100016-ISCURRENT", "IsCurrent");
			fields[149] = new ims.framework.ReportField(this.context, "_cv_Oncology.voCancerCarePlan", "BO-1074100016-EPISODEOFCARE", "EpisodeOfCare");
			fields[150] = new ims.framework.ReportField(this.context, "_cv_Oncology.voCancerCarePlan", "BO-1074100016-CAREPLANNOTES", "CarePlanNotes");
			fields[151] = new ims.framework.ReportField(this.context, "_cv_Oncology.voCancerCarePlan", "BO-1074100016-CURRENTSTATUS", "CurrentStatus");
			fields[152] = new ims.framework.ReportField(this.context, "_cv_Oncology.voCancerCarePlan", "BO-1074100016-AGREEDDATE", "AgreedDate");
			fields[153] = new ims.framework.ReportField(this.context, "_cv_Oncology.voCancerCarePlan", "BO-1074100016-REASONPATIENTPLANDIFFMDT", "ReasonPatientPlanDiffMDT");
			fields[154] = new ims.framework.ReportField(this.context, "_cv_Oncology.voCancerCarePlan", "BO-1074100016-HASASSOCIATEDMDTMEETING", "HasAssociatedMDTMeeting");
			fields[155] = new ims.framework.ReportField(this.context, "_cv_Oncology.voCancerCarePlan", "BO-1074100016-REASONFORREVISION", "ReasonForRevision");
			fields[156] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.CarePlanRevise.__internal_x_context__voCancerCarePlan_" + componentIdentifier, "BO-1074100016-ID", "ID_CancerCarePlan");
			fields[157] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.CarePlanRevise.__internal_x_context__voCancerCarePlan_" + componentIdentifier, "BO-1074100016-CAREPLANDATE", "CarePlanDate");
			fields[158] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.CarePlanRevise.__internal_x_context__voCancerCarePlan_" + componentIdentifier, "BO-1074100016-CAREPLANINTENT", "CarePlanIntent");
			fields[159] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.CarePlanRevise.__internal_x_context__voCancerCarePlan_" + componentIdentifier, "BO-1074100016-RECURRENCEINDICATOR", "RecurrenceIndicator");
			fields[160] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.CarePlanRevise.__internal_x_context__voCancerCarePlan_" + componentIdentifier, "BO-1074100016-ISCURRENT", "IsCurrent");
			fields[161] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.CarePlanRevise.__internal_x_context__voCancerCarePlan_" + componentIdentifier, "BO-1074100016-EPISODEOFCARE", "EpisodeOfCare");
			fields[162] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.CarePlanRevise.__internal_x_context__voCancerCarePlan_" + componentIdentifier, "BO-1074100016-CAREPLANNOTES", "CarePlanNotes");
			fields[163] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.CarePlanRevise.__internal_x_context__voCancerCarePlan_" + componentIdentifier, "BO-1074100016-CURRENTSTATUS", "CurrentStatus");
			fields[164] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.CarePlanRevise.__internal_x_context__voCancerCarePlan_" + componentIdentifier, "BO-1074100016-AGREEDDATE", "AgreedDate");
			fields[165] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.CarePlanRevise.__internal_x_context__voCancerCarePlan_" + componentIdentifier, "BO-1074100016-REASONPATIENTPLANDIFFMDT", "ReasonPatientPlanDiffMDT");
			fields[166] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.CarePlanRevise.__internal_x_context__voCancerCarePlan_" + componentIdentifier, "BO-1074100016-HASASSOCIATEDMDTMEETING", "HasAssociatedMDTMeeting");
			fields[167] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.CarePlanRevise.__internal_x_context__voCancerCarePlan_" + componentIdentifier, "BO-1074100016-REASONFORREVISION", "ReasonForRevision");
			return fields;
		}
