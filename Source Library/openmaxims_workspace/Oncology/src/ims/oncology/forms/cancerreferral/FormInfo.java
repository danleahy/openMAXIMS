...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Clinical.ReturnToFormMode", "_cv_Oncology.SelectedDiagnosisForPrimaryTumourDetails", "_cv_Clinical.DialogFormName" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Oncology.CancerReferral.__internal_x_context__" + String.valueOf(getFormId());
	}
