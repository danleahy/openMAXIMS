...
public class GenForm extends FormBridge
{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1004), new Integer(anchoringHelper8.getX()), new Integer(anchoringHelper8.getY()), new Integer(anchoringHelper8.getWidth()), new Integer(anchoringHelper8.getHeight()), new Integer(startTabIndex.intValue() + 14), ControlState.HIDDEN, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Cancel", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1006), new Integer(anchoringHelper10.getX()), new Integer(anchoringHelper10.getY()), new Integer(anchoringHelper10.getWidth()), new Integer(anchoringHelper10.getHeight()), new Integer(startTabIndex.intValue() + 12), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Edit", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, "_cv_Oncology.SelectedMedication", "BO-1003100024-ID", "ID_Medication");
			fields[145] = new ims.framework.ReportField(this.context, "_cv_Oncology.SelectedMedication", "BO-1003100024-MEDICATIONNAME", "MedicationName");
			fields[146] = new ims.framework.ReportField(this.context, "_cv_Oncology.SelectedMedication", "BO-1003100024-ISACTIVE", "IsActive");
			fields[147] = new ims.framework.ReportField(this.context, "_cv_Oncology.SelectedMedication", "BO-1003100024-ISCONTROLLEDDRUG", "IsControlledDrug");
			fields[148] = new ims.framework.ReportField(this.context, "_cv_Oncology.SelectedMedication", "BO-1003100024-FREQUENCYDEFAULT", "FrequencyDefault");
			fields[149] = new ims.framework.ReportField(this.context, "_cv_Oncology.SelectedMedication", "BO-1003100024-NOOFDAYSSUPPLYDEFAULT", "NoOfDaysSupplyDefault");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.ChemotherapyRegimensConfig.__internal_x_context__CurrentSelectedRecord_" + componentIdentifier, "BO-1075100021-ID", "ID_ChemoRegimensDrugConfig");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.ChemotherapyRegimensConfig.__internal_x_context__CurrentSelectedRecord_" + componentIdentifier, "BO-1075100021-REGIMEN", "Regimen");
			return fields;
		}
