...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "TreatmentGrouptoTreatmentTechniquesConfig";
	}
	public int getWidth()
	{
		return 848;
	...
	{
		return "_lv_Oncology.TreatmentGrouptoTreatmentTechniquesConfig.__internal_x_context__" + String.valueOf(getFormId());
	}
