...
public class GenForm extends FormBridge
{
		...
		public static class tabDetailsContainer extends LayerBridge
		{
			...
			public static class GroupStoppedEarlyRadioButton extends RadioButtonBridge
			{
				...
				protected void setContext(Integer startTabIndex, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize)
				{
					...
					control.addButton(0, anchoringHelper1.getX(), anchoringHelper1.getY(), anchoringHelper1.getWidth(), "Yes", startTabIndex.intValue() + 36);
					...
					control.addButton(1, anchoringHelper2.getX(), anchoringHelper2.getY(), anchoringHelper2.getWidth(), "No", startTabIndex.intValue() + 37);
				}
			...
			public static class GroupClinicalTrialRadioButton extends RadioButtonBridge
			{
				...
				protected void setContext(Integer startTabIndex, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize)
				{
					...
					control.addButton(0, anchoringHelper3.getX(), anchoringHelper3.getY(), anchoringHelper3.getWidth(), "No", startTabIndex.intValue() + 28);
					...
					control.addButton(1, anchoringHelper4.getX(), anchoringHelper4.getY(), anchoringHelper4.getWidth(), "Yes", startTabIndex.intValue() + 27);
				}
			...
			public static class GroupTimeDelayRadioButton extends RadioButtonBridge
			{
				...
				protected void setContext(Integer startTabIndex, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize)
				{
					...
					control.addButton(0, anchoringHelper5.getX(), anchoringHelper5.getY(), anchoringHelper5.getWidth(), "No", startTabIndex.intValue() + 35);
					...
					control.addButton(1, anchoringHelper6.getX(), anchoringHelper6.getY(), anchoringHelper6.getWidth(), "Yes", startTabIndex.intValue() + 34);
				}
			...
			public static class GroupDoseReductionRadioButton extends RadioButtonBridge
			{
				...
				protected void setContext(Integer startTabIndex, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize)
				{
					...
					control.addButton(0, anchoringHelper7.getX(), anchoringHelper7.getY(), anchoringHelper7.getWidth(), "No", startTabIndex.intValue() + 33);
					...
					control.addButton(1, anchoringHelper8.getX(), anchoringHelper8.getY(), anchoringHelper8.getWidth(), "Yes", startTabIndex.intValue() + 32);
				}
			...
			public static class GroupChemoradiationRadioButton extends RadioButtonBridge
			{
				...
				protected void setContext(Integer startTabIndex, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize)
				{
					...
					control.addButton(0, anchoringHelper9.getX(), anchoringHelper9.getY(), anchoringHelper9.getWidth(), "No", startTabIndex.intValue() + 17);
					...
					control.addButton(1, anchoringHelper10.getX(), anchoringHelper10.getY(), anchoringHelper10.getWidth(), "Yes", startTabIndex.intValue() + 16);
				}
			...
			public static class GroupCoMorbidityRadioButton extends RadioButtonBridge
			{
				...
				protected void setContext(Integer startTabIndex, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize)
				{
					...
					control.addButton(0, anchoringHelper11.getX(), anchoringHelper11.getY(), anchoringHelper11.getWidth(), "No", startTabIndex.intValue() + 26);
					...
					control.addButton(1, anchoringHelper12.getX(), anchoringHelper12.getY(), anchoringHelper12.getWidth(), "Yes", startTabIndex.intValue() + 25);
				}
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				super.addControl(factory.getControl(DateControl.class, new Object[] { control, new Integer(startControlID.intValue() + 1040), new Integer(anchoringHelper51.getX()), new Integer(anchoringHelper51.getY()), new Integer(anchoringHelper51.getWidth()), new Integer(anchoringHelper51.getHeight()), new Integer(startTabIndex.intValue() + 9), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.TRUE, null, Boolean.FALSE, null, Boolean.FALSE, null}));
				...
				super.addControl(factory.getControl(DateControl.class, new Object[] { control, new Integer(startControlID.intValue() + 1041), new Integer(anchoringHelper52.getX()), new Integer(anchoringHelper52.getY()), new Integer(anchoringHelper52.getWidth()), new Integer(anchoringHelper52.getHeight()), new Integer(startTabIndex.intValue() + 22), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT,Boolean.TRUE, null, Boolean.FALSE, null, Boolean.FALSE, null}));
				...
				super.addControl(factory.getControl(DateControl.class, new Object[] { control, new Integer(startControlID.intValue() + 1042), new Integer(anchoringHelper53.getX()), new Integer(anchoringHelper53.getY()), new Integer(anchoringHelper53.getWidth()), new Integer(anchoringHelper53.getHeight()), new Integer(startTabIndex.intValue() + 21), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT,Boolean.TRUE, null, Boolean.FALSE, null, Boolean.FALSE, null}));
				...
				super.addControl(factory.getControl(DateControl.class, new Object[] { control, new Integer(startControlID.intValue() + 1043), new Integer(anchoringHelper54.getX()), new Integer(anchoringHelper54.getY()), new Integer(anchoringHelper54.getWidth()), new Integer(anchoringHelper54.getHeight()), new Integer(startTabIndex.intValue() + 15), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.TRUE, null, Boolean.FALSE, null, Boolean.FALSE, null}));
				...
				ComboBox m_cmbHospitalTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1044), new Integer(anchoringHelper55.getX()), new Integer(anchoringHelper55.getY()), new Integer(anchoringHelper55.getWidth()), new Integer(anchoringHelper55.getHeight()), new Integer(startTabIndex.intValue() + 4), ControlState.DISABLED, ControlState.ENABLED,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.TRUE, new Integer(-1)});
				...
				ComboBox m_cmbDelay2Temp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1046), new Integer(anchoringHelper57.getX()), new Integer(anchoringHelper57.getY()), new Integer(anchoringHelper57.getWidth()), new Integer(anchoringHelper57.getHeight()), new Integer(startTabIndex.intValue() + 31), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
				...
				ComboBox m_cmbDelay1Temp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1047), new Integer(anchoringHelper58.getX()), new Integer(anchoringHelper58.getY()), new Integer(anchoringHelper58.getWidth()), new Integer(anchoringHelper58.getHeight()), new Integer(startTabIndex.intValue() + 30), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
				...
				ComboBox m_cmbPrefornmanceStatTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1048), new Integer(anchoringHelper59.getX()), new Integer(anchoringHelper59.getY()), new Integer(anchoringHelper59.getWidth()), new Integer(anchoringHelper59.getHeight()), new Integer(startTabIndex.intValue() + 14), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
				...
				ComboBox m_cmbTreatmentIntentTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1049), new Integer(anchoringHelper60.getX()), new Integer(anchoringHelper60.getY()), new Integer(anchoringHelper60.getWidth()), new Integer(anchoringHelper60.getHeight()), new Integer(startTabIndex.intValue() + 18), ControlState.DISABLED, ControlState.ENABLED,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
				...
				ComboBox m_cmbDrugTherapyTypeTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1053), new Integer(anchoringHelper64.getX()), new Integer(anchoringHelper64.getY()), new Integer(anchoringHelper64.getWidth()), new Integer(anchoringHelper64.getHeight()), new Integer(startTabIndex.intValue() + 19), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.TRUE, new Integer(-1)});
				...
				super.addControl(factory.getControl(IntBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1054), new Integer(anchoringHelper65.getX()), new Integer(anchoringHelper65.getY()), new Integer(anchoringHelper65.getWidth()), new Integer(anchoringHelper65.getHeight()), new Integer(startTabIndex.intValue() + 23), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.TRUE, Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, new Integer(9)}));
				...
				super.addControl(factory.getControl(IntBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1055), new Integer(anchoringHelper66.getX()), new Integer(anchoringHelper66.getY()), new Integer(anchoringHelper66.getWidth()), new Integer(anchoringHelper66.getHeight()), new Integer(startTabIndex.intValue() + 3), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.TRUE, Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, new Integer(9)}));
				...
				super.addControl(factory.getControl(IntBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1056), new Integer(anchoringHelper67.getX()), new Integer(anchoringHelper67.getY()), new Integer(anchoringHelper67.getWidth()), new Integer(anchoringHelper67.getHeight()), new Integer(startTabIndex.intValue() + 2), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.TRUE, Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, new Integer(9)}));
				...
				super.addControl(factory.getControl(DecimalBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1059), new Integer(anchoringHelper70.getX()), new Integer(anchoringHelper70.getY()), new Integer(anchoringHelper70.getWidth()), new Integer(anchoringHelper70.getHeight()), new Integer(startTabIndex.intValue() + 11), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.TRUE, Boolean.TRUE, Boolean.FALSE, new Integer(6), new Integer(2), "The decimal value is invalid. A valid value can have up to 4 digits and up to 2 decimals.", null, Boolean.FALSE}));
		...
		public static class tabCycleAndDrugCCOContainer extends LayerBridge
		{
			...
			public static class GroupStatusRadioButton extends RadioButtonBridge
			{
				...
				protected void setContext(Integer startTabIndex, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize)
				{
					...
					control.addButton(0, anchoringHelper73.getX(), anchoringHelper73.getY(), anchoringHelper73.getWidth(), "Active", startTabIndex.intValue() + 43);
					...
					control.addButton(1, anchoringHelper74.getX(), anchoringHelper74.getY(), anchoringHelper74.getWidth(), "All", startTabIndex.intValue() + 42);
				}
			...
			public static class Group1RadioButton extends RadioButtonBridge
			{
				...
				protected void setContext(Integer startTabIndex, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize)
				{
					...
					control.addButton(0, anchoringHelper75.getX(), anchoringHelper75.getY(), anchoringHelper75.getWidth(), "Inactive", startTabIndex.intValue() + 50);
					...
					control.addButton(1, anchoringHelper76.getX(), anchoringHelper76.getY(), anchoringHelper76.getWidth(), "Active", startTabIndex.intValue() + 49);
				}
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1078), new Integer(anchoringHelper87.getX()), new Integer(anchoringHelper87.getY()), new Integer(anchoringHelper87.getWidth()), new Integer(anchoringHelper87.getHeight()), new Integer(startTabIndex.intValue() + 55), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "OK", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
				...
				super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1079), new Integer(anchoringHelper88.getX()), new Integer(anchoringHelper88.getY()), new Integer(anchoringHelper88.getWidth()), new Integer(anchoringHelper88.getHeight()), new Integer(startTabIndex.intValue() + 56), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Cancel", Boolean.FALSE, null, Boolean.FALSE, Boolean.FALSE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
				...
				super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1080), new Integer(anchoringHelper89.getX()), new Integer(anchoringHelper89.getY()), new Integer(anchoringHelper89.getWidth()), new Integer(anchoringHelper89.getHeight()), new Integer(startTabIndex.intValue() + 51), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.FALSE, new Integer(0), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.TRUE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
				...
				super.addControl(factory.getControl(DateControl.class, new Object[] { control, new Integer(startControlID.intValue() + 1081), new Integer(anchoringHelper90.getX()), new Integer(anchoringHelper90.getY()), new Integer(anchoringHelper90.getWidth()), new Integer(anchoringHelper90.getHeight()), new Integer(startTabIndex.intValue() + 46), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.TRUE, null, Boolean.FALSE, null, Boolean.TRUE, null}));
				...
				ComboBox m_cmbTreatmentTypeTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1083), new Integer(anchoringHelper92.getX()), new Integer(anchoringHelper92.getY()), new Integer(anchoringHelper92.getWidth()), new Integer(anchoringHelper92.getHeight()), new Integer(startTabIndex.intValue() + 45), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,Boolean.TRUE, Boolean.TRUE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.TRUE, new Integer(-1)});
				...
				super.addControl(factory.getControl(DynamicGrid.class, new Object[] { control, new Integer(startControlID.intValue() + 1084), new Integer(anchoringHelper93.getX()), new Integer(anchoringHelper93.getY()), new Integer(anchoringHelper93.getWidth()), new Integer(anchoringHelper93.getHeight()), new Integer(startTabIndex.intValue() + 44), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, contextMenus.Oncology.contextMenuCCOChemoCycleMenu, Boolean.FALSE, Boolean.FALSE, Boolean.TRUE}));
				...
				super.addControl(factory.getControl(IntBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1085), new Integer(anchoringHelper94.getX()), new Integer(anchoringHelper94.getY()), new Integer(anchoringHelper94.getWidth()), new Integer(anchoringHelper94.getHeight()), new Integer(startTabIndex.intValue() + 47), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.TRUE, Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, new Integer(9)}));
				...
				super.addControl(factory.getControl(IntBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1086), new Integer(anchoringHelper95.getX()), new Integer(anchoringHelper95.getY()), new Integer(anchoringHelper95.getWidth()), new Integer(anchoringHelper95.getHeight()), new Integer(startTabIndex.intValue() + 54), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.TRUE, Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, new Integer(9)}));
				...
				super.addControl(factory.getControl(IntBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1087), new Integer(anchoringHelper96.getX()), new Integer(anchoringHelper96.getY()), new Integer(anchoringHelper96.getWidth()), new Integer(anchoringHelper96.getHeight()), new Integer(startTabIndex.intValue() + 53), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.TRUE, Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, new Integer(9)}));
				...
				super.addControl(factory.getControl(IntBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1088), new Integer(anchoringHelper97.getX()), new Integer(anchoringHelper97.getY()), new Integer(anchoringHelper97.getWidth()), new Integer(anchoringHelper97.getHeight()), new Integer(startTabIndex.intValue() + 52), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.TRUE, Boolean.TRUE, Boolean.FALSE, null, null, Boolean.TRUE, new Integer(9)}));
		...
		public static class tabCycleAndDrugContainer extends LayerBridge
		{
			...
			public static class GroupFilterStatusRadioButton extends RadioButtonBridge
			{
				...
				protected void setContext(Integer startTabIndex, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize)
				{
					...
					control.addButton(0, anchoringHelper98.getX(), anchoringHelper98.getY(), anchoringHelper98.getWidth(), "Active", startTabIndex.intValue() + 40);
					...
					control.addButton(1, anchoringHelper99.getX(), anchoringHelper99.getY(), anchoringHelper99.getWidth(), "All", startTabIndex.intValue() + 39);
				}
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				super.addControl(factory.getControl(DynamicGrid.class, new Object[] { control, new Integer(startControlID.intValue() + 1091), new Integer(anchoringHelper100.getX()), new Integer(anchoringHelper100.getY()), new Integer(anchoringHelper100.getWidth()), new Integer(anchoringHelper100.getHeight()), new Integer(startTabIndex.intValue() + 41), ControlState.READONLY, ControlState.READONLY, ims.framework.enumerations.ControlAnchoring.ALL, contextMenus.contextMenuChemotherapyCycle, Boolean.FALSE, Boolean.FALSE, Boolean.TRUE}));
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		contextMenus.contextMenuGenericGridCOPYItem = factory.createMenuItem(startControlID.intValue() + 15, "Copy", true, false, new Integer(102222), true, false);
		...
		contextMenus.contextMenuGenericGridREMOVE_UNVERIFIED_NHS_NUMBERItem = factory.createMenuItem(startControlID.intValue() + 16, "Remove Unverified NHS Number", true, false, new Integer(102300), true, false);
		...
		contextMenus.Oncology.contextMenuCCOChemoCycleMenuCCO_ADD_CYCLEItem = factory.createMenuItem(startControlID.intValue() + 17, "Add Cycle", true, false, new Integer(102179), true, false);
		...
		contextMenus.Oncology.contextMenuCCOChemoCycleMenuCCO_EDIT_CYCLEItem = factory.createMenuItem(startControlID.intValue() + 18, "Edit Cycle", true, false, new Integer(102150), true, false);
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1096), new Integer(anchoringHelper104.getX()), new Integer(anchoringHelper104.getY()), new Integer(anchoringHelper104.getWidth()), new Integer(anchoringHelper104.getHeight()), new Integer(startTabIndex.intValue() + 60), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Cancel", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1097), new Integer(anchoringHelper105.getX()), new Integer(anchoringHelper105.getY()), new Integer(anchoringHelper105.getWidth()), new Integer(anchoringHelper105.getHeight()), new Integer(startTabIndex.intValue() + 59), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Save", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1098), new Integer(anchoringHelper106.getX()), new Integer(anchoringHelper106.getY()), new Integer(anchoringHelper106.getWidth()), new Integer(anchoringHelper106.getHeight()), new Integer(startTabIndex.intValue() + 58), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Edit", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
	...
	public final class ContextMenus implements java.io.Serializable
	{
		...
		public final class GenericGrid implements java.io.Serializable
		{
			...
			public static final int REMOVE_UNVERIFIED_NHS_NUMBER = 16;
		}
		...
		public final class OncologyNamespace implements java.io.Serializable
		{
			...
			{
				private static final long serialVersionUID = 1L;
				public static final int CCO_ADD_CYCLE = 17;
				public static final int CCO_EDIT_CYCLE = 18;
			}
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, "_cv_Oncology.ChemotherapyCycleDetailsVo", "BO-1074100005-ID", "ID_ChemotherapyCycleDetails");
			fields[145] = new ims.framework.ReportField(this.context, "_cv_Oncology.ChemotherapyCycleDetailsVo", "BO-1074100005-CYCLENUMBER", "CycleNumber");
			fields[146] = new ims.framework.ReportField(this.context, "_cv_Oncology.ChemotherapyCycleDetailsVo", "BO-1074100005-CYCLESTARTDATE", "CycleStartDate");
			fields[147] = new ims.framework.ReportField(this.context, "_cv_Oncology.ChemotherapyCycleDetailsVo", "BO-1074100005-CYCLEDURATION", "CycleDuration");
			fields[148] = new ims.framework.ReportField(this.context, "_cv_Oncology.ChemotherapyCycleDetailsVo", "BO-1074100005-ISACTIVE", "IsActive");
			fields[149] = new ims.framework.ReportField(this.context, "_cv_Oncology.ChemoTherapyDayDetailsVo", "BO-1074100033-ID", "ID_ChemoTherapyDayDetails");
			fields[150] = new ims.framework.ReportField(this.context, "_cv_Oncology.ChemoTherapyDayDetailsVo", "BO-1074100033-DAYNUMBER", "DayNumber");
			fields[151] = new ims.framework.ReportField(this.context, "_cv_Oncology.ChemoTherapyDayDetailsVo", "BO-1074100033-DAYDATE", "DayDate");
			fields[152] = new ims.framework.ReportField(this.context, "_cv_Oncology.RadiotherapyPatTreatmentPlanAction", "BO-1105100038-ID", "ID_PatAction");
			fields[153] = new ims.framework.ReportField(this.context, "_cv_Oncology.RadiotherapyPatTreatmentPlanAction", "BO-1105100038-TREATINGCONSULTANT", "TreatingConsultant");
			fields[154] = new ims.framework.ReportField(this.context, "_cv_Oncology.RadiotherapyPatTreatmentPlanAction", "BO-1105100038-ACTIVITYGROUP", "ActivityGroup");
			fields[155] = new ims.framework.ReportField(this.context, "_cv_Oncology.RadiotherapyPatTreatmentPlanAction", "BO-1105100038-PLANNEDREGIME", "PlannedRegime");
			fields[156] = new ims.framework.ReportField(this.context, "_cv_Oncology.RadiotherapyPatTreatmentPlanAction", "BO-1105100038-ACTIVE", "Active");
			fields[157] = new ims.framework.ReportField(this.context, "_cv_Oncology.ChosenOPAppointment", "BO-1014100001-ID", "ID_OutpatientAttendance");
			fields[158] = new ims.framework.ReportField(this.context, "_cv_Oncology.ChosenOPAppointment", "BO-1014100001-APPOINTMENTDATETIME", "AppointmentDateTime");
			fields[159] = new ims.framework.ReportField(this.context, "_cv_Oncology.ChosenOPAppointment", "BO-1014100001-APPOINTMENTSTATUS", "AppointmentStatus");
			fields[160] = new ims.framework.ReportField(this.context, "_cv_Oncology.ChosenOPAppointment", "BO-1014100001-CANCELLATIONREASON", "CancellationReason");
			fields[161] = new ims.framework.ReportField(this.context, "_cv_Oncology.ChosenOPAppointment", "BO-1014100001-ISACTIVE", "IsActive");
			fields[162] = new ims.framework.ReportField(this.context, "_cv_Oncology.ChosenCCOOPAppointment", "BO-1055100003-ID", "ID_PatientApptDiary");
			fields[163] = new ims.framework.ReportField(this.context, "_cv_Oncology.ChosenCCOOPAppointment", "BO-1055100003-APPOINTMENTID", "AppointmentId");
			fields[164] = new ims.framework.ReportField(this.context, "_cv_Oncology.ChosenCCOOPAppointment", "BO-1055100003-APPTDATE", "ApptDate");
			fields[165] = new ims.framework.ReportField(this.context, "_cv_Oncology.ChosenCCOOPAppointment", "BO-1055100003-STARTTIME", "StartTime");
			fields[166] = new ims.framework.ReportField(this.context, "_cv_Oncology.ChosenCCOOPAppointment", "BO-1055100003-ENDTIME", "EndTime");
			fields[167] = new ims.framework.ReportField(this.context, "_cv_Oncology.ChosenCCOOPAppointment", "BO-1055100003-CLINICNAME", "ClinicName");
			fields[168] = new ims.framework.ReportField(this.context, "_cv_Oncology.ChosenCCOOPAppointment", "BO-1055100003-CLINIC", "Clinic");
			fields[169] = new ims.framework.ReportField(this.context, "_cv_Oncology.ChosenCCOOPAppointment", "BO-1055100003-SOURCE", "Source");
			fields[170] = new ims.framework.ReportField(this.context, "_cv_Oncology.ChosenCCOOPAppointment", "BO-1055100003-APPTTYPE", "ApptType");
			fields[171] = new ims.framework.ReportField(this.context, "_cv_Oncology.ChosenCCOOPAppointment", "BO-1055100003-PATIENT", "Patient");
			fields[172] = new ims.framework.ReportField(this.context, "_cv_Oncology.ChosenCCOOPAppointment", "BO-1055100003-STATUS", "Status");
			fields[173] = new ims.framework.ReportField(this.context, "_cv_Oncology.ChosenCCOOPAppointment", "BO-1055100003-STATUSDATE", "StatusDate");
			fields[174] = new ims.framework.ReportField(this.context, "_cv_Oncology.ChosenCCOOPAppointment", "BO-1055100003-BOOKEDBY", "BookedBy");
			fields[175] = new ims.framework.ReportField(this.context, "_cv_Oncology.ChosenCCOOPAppointment", "BO-1055100003-BOOKEDDATE", "BookedDate");
			fields[176] = new ims.framework.ReportField(this.context, "_cv_Oncology.ChosenCCOOPAppointment", "BO-1055100003-PKEY", "Pkey");
			fields[177] = new ims.framework.ReportField(this.context, "_cv_Oncology.ChosenCCOOPAppointment", "BO-1055100003-APPOINTHEADERID", "AppointHeaderId");
			fields[178] = new ims.framework.ReportField(this.context, "_cv_Oncology.ChosenCCOOPAppointment", "BO-1055100003-ACTIVE", "Active");
			fields[179] = new ims.framework.ReportField(this.context, "_cv_Oncology.ChemoTherapyDetailRecord", "BO-1074100004-ID", "ID_ChemotherapyDetails");
			fields[180] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.ChemotherapyDetails.__internal_x_context__ChemotherapyDetailsVo_" + componentIdentifier, "BO-1074100004-ID", "ID_ChemotherapyDetails");
			fields[181] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.ChemotherapyDetails.__internal_x_context__ChemotherapyDetailsVo_" + componentIdentifier, "BO-1074100004-EPISODEOFCARE", "EpisodeOfCare");
			fields[182] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.ChemotherapyDetails.__internal_x_context__ChemotherapyDetailsVo_" + componentIdentifier, "BO-1074100004-CARECONTEXT", "CareContext");
			fields[183] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.ChemotherapyDetails.__internal_x_context__ChemotherapyDetailsVo_" + componentIdentifier, "BO-1074100004-STARTDATE", "StartDate");
			fields[184] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.ChemotherapyDetails.__internal_x_context__ChemotherapyDetailsVo_" + componentIdentifier, "BO-1074100004-DATEDECISIONTOTREAT", "DateDecisionToTreat");
			fields[185] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.ChemotherapyDetails.__internal_x_context__ChemotherapyDetailsVo_" + componentIdentifier, "BO-1074100004-DRUGTHERAPYTYPE", "DrugTherapyType");
			fields[186] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.ChemotherapyDetails.__internal_x_context__ChemotherapyDetailsVo_" + componentIdentifier, "BO-1074100004-REGIMENACRONYM", "RegimenAcronym");
			fields[187] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.ChemotherapyDetails.__internal_x_context__ChemotherapyDetailsVo_" + componentIdentifier, "BO-1074100004-CANCERTREATEMENTINTENT", "CancerTreatementIntent");
			fields[188] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.ChemotherapyDetails.__internal_x_context__ChemotherapyDetailsVo_" + componentIdentifier, "BO-1074100004-TREATMENTRESPONSE", "TreatmentResponse");
			fields[189] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.ChemotherapyDetails.__internal_x_context__ChemotherapyDetailsVo_" + componentIdentifier, "BO-1074100004-TXCHANGEREASON", "TxChangeReason");
			fields[190] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.ChemotherapyDetails.__internal_x_context__ChemotherapyDetailsVo_" + componentIdentifier, "BO-1074100004-PRETREATSURFACEAREA", "PreTreatSurfaceArea");
			fields[191] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.ChemotherapyDetails.__internal_x_context__ChemotherapyDetailsVo_" + componentIdentifier, "BO-1074100004-CREATININECLEARANCE", "CreatinineClearance");
			fields[192] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.ChemotherapyDetails.__internal_x_context__ChemotherapyDetailsVo_" + componentIdentifier, "BO-1074100004-HEIGHTVALUECM", "HeightValueCM");
			fields[193] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.ChemotherapyDetails.__internal_x_context__ChemotherapyDetailsVo_" + componentIdentifier, "BO-1074100004-WEIGHTVALUEKG", "WeightValueKG");
			fields[194] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.ChemotherapyDetails.__internal_x_context__ChemotherapyDetailsVo_" + componentIdentifier, "BO-1074100004-STATUS", "Status");
			fields[195] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.ChemotherapyDetails.__internal_x_context__ChemotherapyDetailsVo_" + componentIdentifier, "BO-1074100004-PERFORMANCESTATUS", "PerformanceStatus");
			fields[196] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.ChemotherapyDetails.__internal_x_context__ChemotherapyDetailsVo_" + componentIdentifier, "BO-1074100004-DELAYREASON1", "DelayReason1");
			fields[197] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.ChemotherapyDetails.__internal_x_context__ChemotherapyDetailsVo_" + componentIdentifier, "BO-1074100004-DELAYREASON2", "DelayReason2");
			fields[198] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.ChemotherapyDetails.__internal_x_context__ChemotherapyDetailsVo_" + componentIdentifier, "BO-1074100004-TREATMENTSITE", "TreatmentSite");
			fields[199] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.ChemotherapyDetails.__internal_x_context__ChemotherapyDetailsVo_" + componentIdentifier, "BO-1074100004-ENDDATE", "EndDate");
			fields[200] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.ChemotherapyDetails.__internal_x_context__ChemotherapyDetailsVo_" + componentIdentifier, "BO-1074100004-PROGRAMMENR", "ProgrammeNr");
			fields[201] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.ChemotherapyDetails.__internal_x_context__ChemotherapyDetailsVo_" + componentIdentifier, "BO-1074100004-REGIMENNR", "RegimenNr");
			fields[202] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.ChemotherapyDetails.__internal_x_context__ChemotherapyDetailsVo_" + componentIdentifier, "BO-1074100004-COMORBIDITYADJUSTMENT", "ComorbidityAdjustment");
			fields[203] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.ChemotherapyDetails.__internal_x_context__ChemotherapyDetailsVo_" + componentIdentifier, "BO-1074100004-CHEMORADIATION", "ChemoRadiation");
			fields[204] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.ChemotherapyDetails.__internal_x_context__ChemotherapyDetailsVo_" + componentIdentifier, "BO-1074100004-CLINICALTRIAL", "ClinicalTrial");
			fields[205] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.ChemotherapyDetails.__internal_x_context__ChemotherapyDetailsVo_" + componentIdentifier, "BO-1074100004-PLANNEDCYCLES", "PlannedCycles");
			fields[206] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.ChemotherapyDetails.__internal_x_context__ChemotherapyDetailsVo_" + componentIdentifier, "BO-1074100004-OUTCOMEDOSEREDUCTION", "OutcomeDoseReduction");
			fields[207] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.ChemotherapyDetails.__internal_x_context__ChemotherapyDetailsVo_" + componentIdentifier, "BO-1074100004-OUTCOMETIMEDELAY", "OutcomeTimeDelay");
			fields[208] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.ChemotherapyDetails.__internal_x_context__ChemotherapyDetailsVo_" + componentIdentifier, "BO-1074100004-OUTCOMESTOPPEDEARLY", "OutcomeStoppedEarly");
			fields[209] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.ChemotherapyDetails.__internal_x_context__ChemotherapyDetailsVo_" + componentIdentifier, "BO-1074100004-OUTCOMESUMMARY", "OutcomeSummary");
			fields[210] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.ChemotherapyDetails.__internal_x_context__ChemotherapyDetailsVo_" + componentIdentifier, "BO-1074100004-PRESCRIBEDDATE", "PrescribedDate");
			fields[211] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.ChemotherapyDetails.__internal_x_context__ChemotherapyDetailsVo_" + componentIdentifier, "BO-1074100004-ASSOCIATEDTREATMENTPLANACTION", "AssociatedTreatmentPlanAction");
			fields[212] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.ChemotherapyDetails.__internal_x_context__SelectedCCOChemoCycleDetails_" + componentIdentifier, "BO-1074100047-ID", "ID_ChemoCycleDetailsCCO");
			fields[213] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.ChemotherapyDetails.__internal_x_context__SelectedCCOChemoCycleDetails_" + componentIdentifier, "BO-1074100047-CYCLENUMBER", "CycleNumber");
			fields[214] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.ChemotherapyDetails.__internal_x_context__SelectedCCOChemoCycleDetails_" + componentIdentifier, "BO-1074100047-CYCLESTARTDATE", "CycleStartDate");
			fields[215] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.ChemotherapyDetails.__internal_x_context__SelectedCCOChemoCycleDetails_" + componentIdentifier, "BO-1074100047-CYCLEDURATION", "CycleDuration");
			fields[216] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.ChemotherapyDetails.__internal_x_context__SelectedCCOChemoCycleDetails_" + componentIdentifier, "BO-1074100047-TREATMENTTYPE", "TreatmentType");
			fields[217] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.ChemotherapyDetails.__internal_x_context__SelectedCCOChemoCycleDetails_" + componentIdentifier, "BO-1074100047-REGIMEN", "Regimen");
			fields[218] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.ChemotherapyDetails.__internal_x_context__SelectedCCOChemoCycleDetails_" + componentIdentifier, "BO-1074100047-PROCUREMENTCODE", "ProcurementCode");
			fields[219] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.ChemotherapyDetails.__internal_x_context__SelectedCCOChemoCycleDetails_" + componentIdentifier, "BO-1074100047-DAYONEDELIVERYCODE", "DayOneDeliveryCode");
			fields[220] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.ChemotherapyDetails.__internal_x_context__SelectedCCOChemoCycleDetails_" + componentIdentifier, "BO-1074100047-DELIVERYCODEALLOTHERDAYS", "DeliveryCodeAllOtherDays");
			fields[221] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.ChemotherapyDetails.__internal_x_context__SelectedCCOChemoCycleDetails_" + componentIdentifier, "BO-1074100047-DAYNUMBER", "DayNumber");
			fields[222] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.ChemotherapyDetails.__internal_x_context__SelectedCCOChemoCycleDetails_" + componentIdentifier, "BO-1074100047-ISACTIVE", "IsActive");
			fields[223] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.ChemotherapyDetails.__internal_x_context__SelectedCCOChemoCycleDetails_" + componentIdentifier, "BO-1074100047-WEIGHT", "Weight");
			fields[224] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.ChemotherapyDetails.__internal_x_context__SelectedCCOChemoCycleDetails_" + componentIdentifier, "BO-1074100047-PERFORMANCESTATUS", "PerformanceStatus");
			return fields;
		}
