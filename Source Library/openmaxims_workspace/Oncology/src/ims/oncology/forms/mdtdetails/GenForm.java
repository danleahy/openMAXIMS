...
public class GenForm extends FormBridge
{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		contextMenus.Oncology.contextMenuMDTDetailsNEWItem = factory.createMenuItem(startControlID.intValue() + 14, "New", true, false, new Integer(102179), true, false);
		contextMenus.Oncology.contextMenuMDTDetails.add(contextMenus.Oncology.contextMenuMDTDetailsNEWItem);
		contextMenus.Oncology.contextMenuMDTDetailsEditItem = factory.createMenuItem(startControlID.intValue() + 15, "Edit", true, false, new Integer(102150), true, false);
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1016), new Integer(anchoringHelper17.getX()), new Integer(anchoringHelper17.getY()), new Integer(anchoringHelper17.getWidth()), new Integer(anchoringHelper17.getHeight()), new Integer(startTabIndex.intValue() + 14), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Close", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.MDTDetails.__internal_x_context__voCancerMDTMeeting_" + componentIdentifier, "BO-1074100017-ID", "ID_CancerMDTMeeting");
			fields[145] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.MDTDetails.__internal_x_context__voCancerMDTMeeting_" + componentIdentifier, "BO-1074100017-CARECONTEXT", "CareContext");
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.MDTDetails.__internal_x_context__voCancerMDTMeeting_" + componentIdentifier, "BO-1074100017-CLINICALCONTACT", "ClinicalContact");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.MDTDetails.__internal_x_context__voCancerMDTMeeting_" + componentIdentifier, "BO-1074100017-DATE", "Date");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.MDTDetails.__internal_x_context__voCancerMDTMeeting_" + componentIdentifier, "BO-1074100017-COMORBIDITYASSESSMENT", "CoMorbidityAssessment");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.MDTDetails.__internal_x_context__voCancerMDTMeeting_" + componentIdentifier, "BO-1074100017-NOTES", "Notes");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.MDTDetails.__internal_x_context__voCancerMDTMeeting_" + componentIdentifier, "BO-1074100017-PATIENTPERFORMANCESTATUS", "PatientPerformanceStatus");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.MDTDetails.__internal_x_context__voCancerMDTMeeting_" + componentIdentifier, "BO-1074100017-EPISODEOFCARE", "EpisodeOfCare");
			return fields;
		}
