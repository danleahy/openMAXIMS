...
public class GenForm extends FormBridge
{
	...
	public static class lyrSurgeryDetailsLayer extends Layer
	{
		...
		public static class tabGenDetContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				ims.framework.FormUiLogic m_customControlMosConsultantForm = loader.loadComponent(102256, appForm, startControlID * 10 + 1000, anchoringHelper3.getSize(), instance1, startTabIndex.intValue() + 9, skipContextValidation);
				//ims.framework.Control m_customControlMosConsultantControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1000), new Integer(152), new Integer(182), new Integer(216), new Integer(20), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFT, new Integer(startTabIndex.intValue() + 9), m_customControlMosConsultantForm, instance1 } );
				ims.framework.Control m_customControlMosConsultantControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1001),  new Integer(anchoringHelper3.getX()), new Integer(anchoringHelper3.getY()), new Integer(anchoringHelper3.getWidth()), new Integer(anchoringHelper3.getHeight()), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFT, new Integer(startTabIndex.intValue() + 9), m_customControlMosConsultantForm, instance1, Boolean.FALSE } );
				...
				ims.framework.FormUiLogic m_customControlAuthoringInfoForm = loader.loadComponent(102228, appForm, startControlID * 10 + 2000, anchoringHelper4.getSize(), instance2, startTabIndex.intValue() + 20, skipContextValidation);
				//ims.framework.Control m_customControlAuthoringInfoControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1002), new Integer(400), new Integer(392), new Integer(384), new Integer(64), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFT, new Integer(startTabIndex.intValue() + 20), m_customControlAuthoringInfoForm, instance2 } );
				ims.framework.Control m_customControlAuthoringInfoControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1003),  new Integer(anchoringHelper4.getX()), new Integer(anchoringHelper4.getY()), new Integer(anchoringHelper4.getWidth()), new Integer(anchoringHelper4.getHeight()), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFT, new Integer(startTabIndex.intValue() + 20), m_customControlAuthoringInfoForm, instance2, Boolean.FALSE } );
				...
				ComboBox m_qmbHospitalTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1024), new Integer(anchoringHelper24.getX()), new Integer(anchoringHelper24.getY()), new Integer(anchoringHelper24.getWidth()), new Integer(anchoringHelper24.getHeight()), new Integer(startTabIndex.intValue() + 8), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.TRUE, new Integer(1), null, Boolean.FALSE, new Integer(-1), Boolean.FALSE});
		...
		public static class tabProcContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				ims.framework.FormUiLogic m_customControlMosAnaesthetistForm = loader.loadComponent(102256, appForm, startControlID * 10 + 4000, anchoringHelper26.getSize(), instance1, startTabIndex.intValue() + 26, skipContextValidation);
				//ims.framework.Control m_customControlMosAnaesthetistControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1027), new Integer(152), new Integer(102), new Integer(248), new Integer(20), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFT, new Integer(startTabIndex.intValue() + 26), m_customControlMosAnaesthetistForm, instance1 } );
				ims.framework.Control m_customControlMosAnaesthetistControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1028),  new Integer(anchoringHelper26.getX()), new Integer(anchoringHelper26.getY()), new Integer(anchoringHelper26.getWidth()), new Integer(anchoringHelper26.getHeight()), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFT, new Integer(startTabIndex.intValue() + 26), m_customControlMosAnaesthetistForm, instance1, Boolean.FALSE } );
				...
				ims.framework.FormUiLogic m_customControlMosSurgeonForm = loader.loadComponent(102256, appForm, startControlID * 10 + 5000, anchoringHelper27.getSize(), instance2, startTabIndex.intValue() + 23, skipContextValidation);
				//ims.framework.Control m_customControlMosSurgeonControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1029), new Integer(152), new Integer(24), new Integer(248), new Integer(20), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFT, new Integer(startTabIndex.intValue() + 23), m_customControlMosSurgeonForm, instance2 } );
				ims.framework.Control m_customControlMosSurgeonControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1030),  new Integer(anchoringHelper27.getX()), new Integer(anchoringHelper27.getY()), new Integer(anchoringHelper27.getWidth()), new Integer(anchoringHelper27.getHeight()), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFT, new Integer(startTabIndex.intValue() + 23), m_customControlMosSurgeonForm, instance2, Boolean.FALSE } );
				...
				ComboBox m_cmbSurgeonGradeTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1041), new Integer(anchoringHelper38.getX()), new Integer(anchoringHelper38.getY()), new Integer(anchoringHelper38.getWidth()), new Integer(anchoringHelper38.getHeight()), new Integer(startTabIndex.intValue() + 25), ControlState.DISABLED, ControlState.ENABLED,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
				...
				Grid m_grdAssistantTemp = (Grid)factory.getControl(Grid.class, new Object[] { control, new Integer(startControlID.intValue() + 1043), new Integer(anchoringHelper40.getX()), new Integer(anchoringHelper40.getY()), new Integer(anchoringHelper40.getWidth()), new Integer(anchoringHelper40.getHeight()), new Integer(startTabIndex.intValue() + 34), ControlState.READONLY, ControlState.EDITABLE, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT,Boolean.TRUE, Boolean.FALSE, new Integer(24), Boolean.TRUE, contextMenus.contextMenuGenericGrid, Boolean.FALSE, Boolean.FALSE, new Integer(0), null, Boolean.FALSE, Boolean.TRUE});
				...
				super.addControl(factory.getControl(TimeControl.class, new Object[] { control, new Integer(startControlID.intValue() + 1044), new Integer(anchoringHelper41.getX()), new Integer(anchoringHelper41.getY()), new Integer(anchoringHelper41.getWidth()), new Integer(anchoringHelper41.getHeight()), new Integer(startTabIndex.intValue() + 32), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.TRUE, Boolean.FALSE, null, Boolean.FALSE, ""}));
				...
				super.addControl(factory.getControl(TimeControl.class, new Object[] { control, new Integer(startControlID.intValue() + 1045), new Integer(anchoringHelper42.getX()), new Integer(anchoringHelper42.getY()), new Integer(anchoringHelper42.getWidth()), new Integer(anchoringHelper42.getHeight()), new Integer(startTabIndex.intValue() + 30), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.TRUE, Boolean.FALSE, null, Boolean.FALSE, ""}));
			}
		...
		public static class tabPreOpPossumContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				ims.framework.FormUiLogic m_customControlPreOpPForm = loader.loadComponent(127109, appForm, startControlID * 10 + 6000, anchoringHelper43.getSize(), instance1, startTabIndex.intValue() + 39, skipContextValidation);
				//ims.framework.Control m_customControlPreOpPControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1046), new Integer(8), new Integer(8), new Integer(792), new Integer(520), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 39), m_customControlPreOpPForm, instance1 } );
				ims.framework.Control m_customControlPreOpPControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1047),  new Integer(anchoringHelper43.getX()), new Integer(anchoringHelper43.getY()), new Integer(anchoringHelper43.getWidth()), new Integer(anchoringHelper43.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 39), m_customControlPreOpPForm, instance1, Boolean.FALSE } );
		...
		public static class tabStructFindContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				ims.framework.FormUiLogic m_customControlProcedureFindingForm = loader.loadComponent(127114, appForm, startControlID * 10 + 7000, anchoringHelper44.getSize(), instance1, startTabIndex.intValue() + 41, skipContextValidation);
				//ims.framework.Control m_customControlProcedureFindingControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1048), new Integer(8), new Integer(32), new Integer(792), new Integer(496), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 41), m_customControlProcedureFindingForm, instance1 } );
				ims.framework.Control m_customControlProcedureFindingControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1049),  new Integer(anchoringHelper44.getX()), new Integer(anchoringHelper44.getY()), new Integer(anchoringHelper44.getWidth()), new Integer(anchoringHelper44.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 41), m_customControlProcedureFindingForm, instance1, Boolean.FALSE } );
		...
		public static class tabProcDetContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				ims.framework.FormUiLogic m_customControlProcedureDetailsForm = loader.loadComponent(127109, appForm, startControlID * 10 + 8000, anchoringHelper46.getSize(), instance1, startTabIndex.intValue() + 52, skipContextValidation);
				//ims.framework.Control m_customControlProcedureDetailsControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1051), new Integer(8), new Integer(32), new Integer(792), new Integer(496), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 52), m_customControlProcedureDetailsForm, instance1 } );
				ims.framework.Control m_customControlProcedureDetailsControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1052),  new Integer(anchoringHelper46.getX()), new Integer(anchoringHelper46.getY()), new Integer(anchoringHelper46.getWidth()), new Integer(anchoringHelper46.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 52), m_customControlProcedureDetailsForm, instance1, Boolean.FALSE } );
		...
		public static class tabOperativePossumContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				ims.framework.FormUiLogic m_customControlOperativePossumForm = loader.loadComponent(127109, appForm, startControlID * 10 + 9000, anchoringHelper48.getSize(), instance1, startTabIndex.intValue() + 55, skipContextValidation);
				//ims.framework.Control m_customControlOperativePossumControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1054), new Integer(8), new Integer(8), new Integer(792), new Integer(520), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 55), m_customControlOperativePossumForm, instance1 } );
				ims.framework.Control m_customControlOperativePossumControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1055),  new Integer(anchoringHelper48.getX()), new Integer(anchoringHelper48.getY()), new Integer(anchoringHelper48.getWidth()), new Integer(anchoringHelper48.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 55), m_customControlOperativePossumForm, instance1, Boolean.FALSE } );
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1065), new Integer(anchoringHelper58.getX()), new Integer(anchoringHelper58.getY()), new Integer(anchoringHelper58.getWidth()), new Integer(anchoringHelper58.getHeight()), new Integer(startTabIndex.intValue() + 36), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Edit", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
	...
	private class ReportFields
	{
		...
		{
			String prefix = formInfo.getLocalVariablesPrefix();
			IReportField[] fields = new IReportField[260];
			...
			fields[144] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedSubProcedure", "BO-1003100007-ID", "ID_SubProcedures");
			fields[145] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedSubProcedure", "BO-1003100007-SUBPROCEDUREDESCRIPTION", "SubProcedureDescription");
			fields[146] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedGraphicAssessmentVo", "BO-1028100006-ID", "ID_GraphicAssessment");
			fields[147] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedGraphicAssessmentVo", "BO-1028100006-NAME", "Name");
			fields[148] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedGraphicAssessmentVo", "BO-1028100006-ASSESSMENTTYPE", "AssessmentType");
			fields[149] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedGraphicAssessmentVo", "BO-1028100006-ACTIVESTATUS", "ActiveStatus");
			fields[150] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedGraphicAssessmentVo", "BO-1028100006-HELPURL", "HelpUrl");
			fields[151] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedGraphicAssessmentVo", "BO-1028100006-STOREPRINTEDREPORT", "StorePrintedReport");
			fields[152] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedGraphicAssessmentVo", "BO-1028100006-ASSOCIATEDREPORTFORPRINTING", "AssociatedReportForPrinting");
			fields[153] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedUserAssessmentVo", "BO-1003100043-ID", "ID_UserAssessment");
			fields[154] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedUserAssessmentVo", "BO-1003100043-NAME", "Name");
			fields[155] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedUserAssessmentVo", "BO-1003100043-DESCRIPTION", "Description");
			fields[156] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedUserAssessmentVo", "BO-1003100043-ASSESSMENTTYPE", "AssessmentType");
			fields[157] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedUserAssessmentVo", "BO-1003100043-ACTIVESTATUS", "ActiveStatus");
			fields[158] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedUserAssessmentVo", "BO-1003100043-HELPURL", "HelpURL");
			fields[159] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedUserAssessmentVo", "BO-1003100043-SCORINGMETHOD", "ScoringMethod");
			fields[160] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedUserAssessmentVo", "BO-1003100043-ISFLATVIEW", "IsFlatView");
			fields[161] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedUserAssessmentVo", "BO-1003100043-CATEGORY", "Category");
			fields[162] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedUserAssessmentVo", "BO-1003100043-ISMULTIPLEGROUP", "IsMultipleGroup");
			fields[163] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedUserAssessmentVo", "BO-1003100043-GROUPQUESTIONWIDTH", "GroupQuestionWidth");
			fields[164] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedUserAssessmentVo", "BO-1003100043-STOREPRINTEDASSESSMENT", "StorePrintedAssessment");
			fields[165] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedUserAssessmentVo", "BO-1003100043-ISMULTIROLE", "IsMultiRole");
			fields[166] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedUserAssessmentVo", "BO-1003100043-HEADERTEXT", "HeaderText");
			fields[167] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedUserAssessmentVo", "BO-1003100043-FOOTERTEXT", "FooterText");
			fields[168] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedUserAssessmentVo", "BO-1003100043-MAXHEADERHEIGHT", "MaxHeaderHeight");
			fields[169] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedUserAssessmentVo", "BO-1003100043-MAXFOOTERHEIGHT", "MaxFooterHeight");
			fields[170] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedUserAssessmentVo", "BO-1003100043-ASSOCIATEDREPORT", "AssociatedReport");
			fields[171] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedUserAssessmentVo", "BO-1003100043-CANCOPYLAST", "CanCopyLast");
			fields[172] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedUserAssessmentVo", "BO-1003100043-COPYLASTFROMCONTEXT", "CopyLastFromContext");
			fields[173] = new ims.framework.ReportField(this.context, "_cv_Core.GraphicAssessmentShortVo", "BO-1028100006-ID", "ID_GraphicAssessment");
			fields[174] = new ims.framework.ReportField(this.context, "_cv_Core.GraphicAssessmentShortVo", "BO-1028100006-NAME", "Name");
			fields[175] = new ims.framework.ReportField(this.context, "_cv_Core.GraphicAssessmentShortVo", "BO-1028100006-ASSESSMENTTYPE", "AssessmentType");
			fields[176] = new ims.framework.ReportField(this.context, "_cv_Core.GraphicAssessmentShortVo", "BO-1028100006-ACTIVESTATUS", "ActiveStatus");
			fields[177] = new ims.framework.ReportField(this.context, "_cv_Core.GraphicAssessmentShortVo", "BO-1028100006-HELPURL", "HelpUrl");
			fields[178] = new ims.framework.ReportField(this.context, "_cv_Core.GraphicAssessmentShortVo", "BO-1028100006-STOREPRINTEDREPORT", "StorePrintedReport");
			fields[179] = new ims.framework.ReportField(this.context, "_cv_Core.GraphicAssessmentShortVo", "BO-1028100006-ASSOCIATEDREPORTFORPRINTING", "AssociatedReportForPrinting");
			fields[180] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.SurgeryDetails.__internal_x_context__SelectedSurgeryDetails_" + componentIdentifier, "BO-1003100080-ID", "ID_SurgeryDetails");
			fields[181] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.SurgeryDetails.__internal_x_context__SelectedSurgeryDetails_" + componentIdentifier, "BO-1003100080-CARECONTEXT", "CareContext");
			fields[182] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.SurgeryDetails.__internal_x_context__SelectedSurgeryDetails_" + componentIdentifier, "BO-1003100080-RESPONSIBLECONSULTANT", "ResponsibleConsultant");
			fields[183] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.SurgeryDetails.__internal_x_context__SelectedSurgeryDetails_" + componentIdentifier, "BO-1003100080-SPECIALTYFUNCTIONCODE", "SpecialtyFunctionCode");
			fields[184] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.SurgeryDetails.__internal_x_context__SelectedSurgeryDetails_" + componentIdentifier, "BO-1003100080-ADMISSIONDATE", "AdmissionDate");
			fields[185] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.SurgeryDetails.__internal_x_context__SelectedSurgeryDetails_" + componentIdentifier, "BO-1003100080-DISCHARGEDATE", "DischargeDate");
			fields[186] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.SurgeryDetails.__internal_x_context__SelectedSurgeryDetails_" + componentIdentifier, "BO-1003100080-DISCHARGEDESTINATION", "DischargeDestination");
			fields[187] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.SurgeryDetails.__internal_x_context__SelectedSurgeryDetails_" + componentIdentifier, "BO-1003100080-ASAGRADE", "ASAGrade");
			fields[188] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.SurgeryDetails.__internal_x_context__SelectedSurgeryDetails_" + componentIdentifier, "BO-1003100080-CONSULTANTPRESENCE", "ConsultantPresence");
			fields[189] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.SurgeryDetails.__internal_x_context__SelectedSurgeryDetails_" + componentIdentifier, "BO-1003100080-ANAESTHETIST", "Anaesthetist");
			fields[190] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.SurgeryDetails.__internal_x_context__SelectedSurgeryDetails_" + componentIdentifier, "BO-1003100080-ANAESTHETISTGRADE", "AnaesthetistGrade");
			fields[191] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.SurgeryDetails.__internal_x_context__SelectedSurgeryDetails_" + componentIdentifier, "BO-1003100080-PROCEDURETYPE", "ProcedureType");
			fields[192] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.SurgeryDetails.__internal_x_context__SelectedSurgeryDetails_" + componentIdentifier, "BO-1003100080-EPISODEOFCARE", "EpisodeOfCare");
			fields[193] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.SurgeryDetails.__internal_x_context__PreOpPossumUserAssessment_" + componentIdentifier, "BO-1003100043-ID", "ID_UserAssessment");
			fields[194] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.SurgeryDetails.__internal_x_context__PreOpPossumUserAssessment_" + componentIdentifier, "BO-1003100043-NAME", "Name");
			fields[195] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.SurgeryDetails.__internal_x_context__PreOpPossumUserAssessment_" + componentIdentifier, "BO-1003100043-DESCRIPTION", "Description");
			fields[196] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.SurgeryDetails.__internal_x_context__PreOpPossumUserAssessment_" + componentIdentifier, "BO-1003100043-ASSESSMENTTYPE", "AssessmentType");
			fields[197] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.SurgeryDetails.__internal_x_context__PreOpPossumUserAssessment_" + componentIdentifier, "BO-1003100043-ACTIVESTATUS", "ActiveStatus");
			fields[198] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.SurgeryDetails.__internal_x_context__PreOpPossumUserAssessment_" + componentIdentifier, "BO-1003100043-HELPURL", "HelpURL");
			fields[199] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.SurgeryDetails.__internal_x_context__PreOpPossumUserAssessment_" + componentIdentifier, "BO-1003100043-SCORINGMETHOD", "ScoringMethod");
			fields[200] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.SurgeryDetails.__internal_x_context__PreOpPossumUserAssessment_" + componentIdentifier, "BO-1003100043-ISFLATVIEW", "IsFlatView");
			fields[201] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.SurgeryDetails.__internal_x_context__PreOpPossumUserAssessment_" + componentIdentifier, "BO-1003100043-CATEGORY", "Category");
			fields[202] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.SurgeryDetails.__internal_x_context__PreOpPossumUserAssessment_" + componentIdentifier, "BO-1003100043-ISMULTIPLEGROUP", "IsMultipleGroup");
			fields[203] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.SurgeryDetails.__internal_x_context__PreOpPossumUserAssessment_" + componentIdentifier, "BO-1003100043-GROUPQUESTIONWIDTH", "GroupQuestionWidth");
			fields[204] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.SurgeryDetails.__internal_x_context__PreOpPossumUserAssessment_" + componentIdentifier, "BO-1003100043-STOREPRINTEDASSESSMENT", "StorePrintedAssessment");
			fields[205] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.SurgeryDetails.__internal_x_context__PreOpPossumUserAssessment_" + componentIdentifier, "BO-1003100043-ISMULTIROLE", "IsMultiRole");
			fields[206] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.SurgeryDetails.__internal_x_context__PreOpPossumUserAssessment_" + componentIdentifier, "BO-1003100043-HEADERTEXT", "HeaderText");
			fields[207] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.SurgeryDetails.__internal_x_context__PreOpPossumUserAssessment_" + componentIdentifier, "BO-1003100043-FOOTERTEXT", "FooterText");
			fields[208] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.SurgeryDetails.__internal_x_context__PreOpPossumUserAssessment_" + componentIdentifier, "BO-1003100043-MAXHEADERHEIGHT", "MaxHeaderHeight");
			fields[209] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.SurgeryDetails.__internal_x_context__PreOpPossumUserAssessment_" + componentIdentifier, "BO-1003100043-MAXFOOTERHEIGHT", "MaxFooterHeight");
			fields[210] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.SurgeryDetails.__internal_x_context__PreOpPossumUserAssessment_" + componentIdentifier, "BO-1003100043-ASSOCIATEDREPORT", "AssociatedReport");
			fields[211] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.SurgeryDetails.__internal_x_context__PreOpPossumUserAssessment_" + componentIdentifier, "BO-1003100043-CANCOPYLAST", "CanCopyLast");
			fields[212] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.SurgeryDetails.__internal_x_context__PreOpPossumUserAssessment_" + componentIdentifier, "BO-1003100043-COPYLASTFROMCONTEXT", "CopyLastFromContext");
			fields[213] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.SurgeryDetails.__internal_x_context__OperativePossumUserAssessment_" + componentIdentifier, "BO-1003100043-ID", "ID_UserAssessment");
			fields[214] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.SurgeryDetails.__internal_x_context__OperativePossumUserAssessment_" + componentIdentifier, "BO-1003100043-NAME", "Name");
			fields[215] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.SurgeryDetails.__internal_x_context__OperativePossumUserAssessment_" + componentIdentifier, "BO-1003100043-DESCRIPTION", "Description");
			fields[216] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.SurgeryDetails.__internal_x_context__OperativePossumUserAssessment_" + componentIdentifier, "BO-1003100043-ASSESSMENTTYPE", "AssessmentType");
			fields[217] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.SurgeryDetails.__internal_x_context__OperativePossumUserAssessment_" + componentIdentifier, "BO-1003100043-ACTIVESTATUS", "ActiveStatus");
			fields[218] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.SurgeryDetails.__internal_x_context__OperativePossumUserAssessment_" + componentIdentifier, "BO-1003100043-HELPURL", "HelpURL");
			fields[219] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.SurgeryDetails.__internal_x_context__OperativePossumUserAssessment_" + componentIdentifier, "BO-1003100043-SCORINGMETHOD", "ScoringMethod");
			fields[220] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.SurgeryDetails.__internal_x_context__OperativePossumUserAssessment_" + componentIdentifier, "BO-1003100043-ISFLATVIEW", "IsFlatView");
			fields[221] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.SurgeryDetails.__internal_x_context__OperativePossumUserAssessment_" + componentIdentifier, "BO-1003100043-CATEGORY", "Category");
			fields[222] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.SurgeryDetails.__internal_x_context__OperativePossumUserAssessment_" + componentIdentifier, "BO-1003100043-ISMULTIPLEGROUP", "IsMultipleGroup");
			fields[223] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.SurgeryDetails.__internal_x_context__OperativePossumUserAssessment_" + componentIdentifier, "BO-1003100043-GROUPQUESTIONWIDTH", "GroupQuestionWidth");
			fields[224] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.SurgeryDetails.__internal_x_context__OperativePossumUserAssessment_" + componentIdentifier, "BO-1003100043-STOREPRINTEDASSESSMENT", "StorePrintedAssessment");
			fields[225] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.SurgeryDetails.__internal_x_context__OperativePossumUserAssessment_" + componentIdentifier, "BO-1003100043-ISMULTIROLE", "IsMultiRole");
			fields[226] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.SurgeryDetails.__internal_x_context__OperativePossumUserAssessment_" + componentIdentifier, "BO-1003100043-HEADERTEXT", "HeaderText");
			fields[227] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.SurgeryDetails.__internal_x_context__OperativePossumUserAssessment_" + componentIdentifier, "BO-1003100043-FOOTERTEXT", "FooterText");
			fields[228] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.SurgeryDetails.__internal_x_context__OperativePossumUserAssessment_" + componentIdentifier, "BO-1003100043-MAXHEADERHEIGHT", "MaxHeaderHeight");
			fields[229] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.SurgeryDetails.__internal_x_context__OperativePossumUserAssessment_" + componentIdentifier, "BO-1003100043-MAXFOOTERHEIGHT", "MaxFooterHeight");
			fields[230] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.SurgeryDetails.__internal_x_context__OperativePossumUserAssessment_" + componentIdentifier, "BO-1003100043-ASSOCIATEDREPORT", "AssociatedReport");
			fields[231] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.SurgeryDetails.__internal_x_context__OperativePossumUserAssessment_" + componentIdentifier, "BO-1003100043-CANCOPYLAST", "CanCopyLast");
			fields[232] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.SurgeryDetails.__internal_x_context__OperativePossumUserAssessment_" + componentIdentifier, "BO-1003100043-COPYLASTFROMCONTEXT", "CopyLastFromContext");
			fields[233] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.SurgeryDetails.__internal_x_context__ProcedureDetailsUserAssessment_" + componentIdentifier, "BO-1003100043-ID", "ID_UserAssessment");
			fields[234] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.SurgeryDetails.__internal_x_context__ProcedureDetailsUserAssessment_" + componentIdentifier, "BO-1003100043-NAME", "Name");
			fields[235] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.SurgeryDetails.__internal_x_context__ProcedureDetailsUserAssessment_" + componentIdentifier, "BO-1003100043-DESCRIPTION", "Description");
			fields[236] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.SurgeryDetails.__internal_x_context__ProcedureDetailsUserAssessment_" + componentIdentifier, "BO-1003100043-ASSESSMENTTYPE", "AssessmentType");
			fields[237] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.SurgeryDetails.__internal_x_context__ProcedureDetailsUserAssessment_" + componentIdentifier, "BO-1003100043-ACTIVESTATUS", "ActiveStatus");
			fields[238] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.SurgeryDetails.__internal_x_context__ProcedureDetailsUserAssessment_" + componentIdentifier, "BO-1003100043-HELPURL", "HelpURL");
			fields[239] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.SurgeryDetails.__internal_x_context__ProcedureDetailsUserAssessment_" + componentIdentifier, "BO-1003100043-SCORINGMETHOD", "ScoringMethod");
			fields[240] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.SurgeryDetails.__internal_x_context__ProcedureDetailsUserAssessment_" + componentIdentifier, "BO-1003100043-ISFLATVIEW", "IsFlatView");
			fields[241] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.SurgeryDetails.__internal_x_context__ProcedureDetailsUserAssessment_" + componentIdentifier, "BO-1003100043-CATEGORY", "Category");
			fields[242] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.SurgeryDetails.__internal_x_context__ProcedureDetailsUserAssessment_" + componentIdentifier, "BO-1003100043-ISMULTIPLEGROUP", "IsMultipleGroup");
			fields[243] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.SurgeryDetails.__internal_x_context__ProcedureDetailsUserAssessment_" + componentIdentifier, "BO-1003100043-GROUPQUESTIONWIDTH", "GroupQuestionWidth");
			fields[244] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.SurgeryDetails.__internal_x_context__ProcedureDetailsUserAssessment_" + componentIdentifier, "BO-1003100043-STOREPRINTEDASSESSMENT", "StorePrintedAssessment");
			fields[245] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.SurgeryDetails.__internal_x_context__ProcedureDetailsUserAssessment_" + componentIdentifier, "BO-1003100043-ISMULTIROLE", "IsMultiRole");
			fields[246] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.SurgeryDetails.__internal_x_context__ProcedureDetailsUserAssessment_" + componentIdentifier, "BO-1003100043-HEADERTEXT", "HeaderText");
			fields[247] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.SurgeryDetails.__internal_x_context__ProcedureDetailsUserAssessment_" + componentIdentifier, "BO-1003100043-FOOTERTEXT", "FooterText");
			fields[248] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.SurgeryDetails.__internal_x_context__ProcedureDetailsUserAssessment_" + componentIdentifier, "BO-1003100043-MAXHEADERHEIGHT", "MaxHeaderHeight");
			fields[249] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.SurgeryDetails.__internal_x_context__ProcedureDetailsUserAssessment_" + componentIdentifier, "BO-1003100043-MAXFOOTERHEIGHT", "MaxFooterHeight");
			fields[250] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.SurgeryDetails.__internal_x_context__ProcedureDetailsUserAssessment_" + componentIdentifier, "BO-1003100043-ASSOCIATEDREPORT", "AssociatedReport");
			fields[251] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.SurgeryDetails.__internal_x_context__ProcedureDetailsUserAssessment_" + componentIdentifier, "BO-1003100043-CANCOPYLAST", "CanCopyLast");
			fields[252] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.SurgeryDetails.__internal_x_context__ProcedureDetailsUserAssessment_" + componentIdentifier, "BO-1003100043-COPYLASTFROMCONTEXT", "CopyLastFromContext");
			fields[253] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.SurgeryDetails.__internal_x_context__ProcedureDetailsGraphicalUserAssessment_" + componentIdentifier, "BO-1028100006-ID", "ID_GraphicAssessment");
			fields[254] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.SurgeryDetails.__internal_x_context__ProcedureDetailsGraphicalUserAssessment_" + componentIdentifier, "BO-1028100006-NAME", "Name");
			fields[255] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.SurgeryDetails.__internal_x_context__ProcedureDetailsGraphicalUserAssessment_" + componentIdentifier, "BO-1028100006-ASSESSMENTTYPE", "AssessmentType");
			fields[256] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.SurgeryDetails.__internal_x_context__ProcedureDetailsGraphicalUserAssessment_" + componentIdentifier, "BO-1028100006-ACTIVESTATUS", "ActiveStatus");
			fields[257] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.SurgeryDetails.__internal_x_context__ProcedureDetailsGraphicalUserAssessment_" + componentIdentifier, "BO-1028100006-HELPURL", "HelpUrl");
			fields[258] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.SurgeryDetails.__internal_x_context__ProcedureDetailsGraphicalUserAssessment_" + componentIdentifier, "BO-1028100006-STOREPRINTEDREPORT", "StorePrintedReport");
			fields[259] = new ims.framework.ReportField(this.context, prefix + "_lv_Oncology.SurgeryDetails.__internal_x_context__ProcedureDetailsGraphicalUserAssessment_" + componentIdentifier, "BO-1028100006-ASSOCIATEDREPORTFORPRINTING", "AssociatedReportForPrinting");
			return fields;
		}
