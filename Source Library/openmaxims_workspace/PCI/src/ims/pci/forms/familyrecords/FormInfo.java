...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_PCI.Client", "_cv_PCI.ClientAddresses", "_cv_PCI.ClientParent", "_cv_Core.PatientToBeDisplayed" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_PCI.FamilyRecords.__internal_x_context__" + String.valueOf(getFormId());
	}
