...
public abstract class BaseLogic extends Handlers implements IComponent
{
	...
	{
		return ims.pci.domain.ClientAddress.class;
	}
	public final void setContext(ims.framework.UIComponentEngine engine, GenForm form, ims.pci.domain.ClientAddress domain)
	{
	...
	protected ims.pci.domain.ClientAddress domain;
}
