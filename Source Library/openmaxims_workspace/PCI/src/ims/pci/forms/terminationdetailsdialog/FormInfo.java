...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "TerminationDetailsDialog";
	}
	public int getWidth()
	{
		return 392;
	...
	{
		return new String[] { "_cv_PCI.TerminationDetails" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_PCI.TerminationDetailsDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
	...
	{
		return "Images/Core/termination_details_48.png";
	}
}
