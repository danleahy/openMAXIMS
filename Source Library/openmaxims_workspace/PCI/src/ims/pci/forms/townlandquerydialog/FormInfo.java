...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_PCI.County", "_cv_PCI.DED" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_PCI.TownlandQueryDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
	...
	{
		return "Images/PCI/route_map_search_48.png";
	}
}
