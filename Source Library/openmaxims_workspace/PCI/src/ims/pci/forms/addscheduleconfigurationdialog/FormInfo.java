...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "AddScheduleConfigurationDialog";
	}
	public int getWidth()
	{
		return 696;
	...
	{
		return new String[] { "_cv_PCI.ClientAddSchedule", "_cv_PCI.ClientSchedules", "_cv_PCI.ClientImmunisationSchedule" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_PCI.AddScheduleConfigurationDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
	...
	{
		return "Images/Core/schedule_add_48.png";
	}
}
