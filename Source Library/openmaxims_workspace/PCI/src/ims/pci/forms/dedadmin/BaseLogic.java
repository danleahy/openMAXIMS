...
public abstract class BaseLogic extends Handlers
{
	...
	{
		return ims.pci.domain.DEDAdmin.class;
	}
	public final void setContext(ims.framework.UIEngine engine, GenForm form, ims.pci.domain.DEDAdmin domain)
	{
	...
	protected final void oncmbSearchCountyValueSet(Object value)
	{
		java.util.ArrayList listOfValues = this.form.cmbSearchCounty().getValues();
		...
		else if(value instanceof ims.ntpf.vo.lookups.County)
		{
			...
			this.form.cmbSearchCounty().newRow(instance, instance.getText(), instance.getImage(), instance.getTextColor());
		}
	}
	protected final void bindcmbSearchCountyLookup()
	{
		this.form.cmbSearchCounty().clear();
		ims.ntpf.vo.lookups.CountyCollection lookupCollection = ims.ntpf.vo.lookups.LookupHelper.getCounty(this.domain.getLookupService());
		for(int x = 0; x < lookupCollection.size(); x++)
		{
			this.form.cmbSearchCounty().newRow(lookupCollection.get(x), lookupCollection.get(x).getText(), lookupCollection.get(x).getImage(), lookupCollection.get(x).getTextColor());
		}
	}
	protected final void setcmbSearchCountyLookupValue(int id)
	{
		ims.ntpf.vo.lookups.County instance = ims.ntpf.vo.lookups.LookupHelper.getCountyInstance(this.domain.getLookupService(), id);
		if(instance != null)
			this.form.cmbSearchCounty().setValue(instance);
	}
	protected final void defaultcmbSearchCountyLookupValue()
	{
		this.form.cmbSearchCounty().setValue((ims.ntpf.vo.lookups.County)domain.getLookupService().getDefaultInstance(ims.ntpf.vo.lookups.County.class, engine.getFormName().getID(), ims.ntpf.vo.lookups.County.TYPE_ID));
	}
	...
	protected ims.pci.domain.DEDAdmin domain;
}
