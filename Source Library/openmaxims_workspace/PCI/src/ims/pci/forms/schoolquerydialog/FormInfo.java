...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_PCI.CurrentSector", "_cv_PCI.School" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_PCI.SchoolQueryDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
