...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Clinical.PMHConfigSearchType", "_cv_Clinical.CCISearch.SelectedVaccines" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_PCI.ScheduleConfiguration.__internal_x_context__" + String.valueOf(getFormId());
	}
	...
	{
		return "Images/Core/Schedule_config_48.png";
	}
}
