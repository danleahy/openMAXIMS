...
public abstract class BaseLogic extends Handlers
{
	...
	{
		return ims.pci.domain.ClientSearch.class;
	}
	public final void setContext(ims.framework.UIEngine engine, GenForm form, ims.pci.domain.ClientSearch domain)
	{
	...
	protected final void oncmbPatientIDValueSet(Object value)
	{
		java.util.ArrayList listOfValues = this.form.cmbPatientID().getValues();
		...
		else if(value instanceof ims.core.vo.lookups.PatIdType)
		{
			...
			this.form.cmbPatientID().newRow(instance, instance.getText(), instance.getImage(), instance.getTextColor());
		}
	}
	protected final void bindcmbPatientIDLookup()
	{
		this.form.cmbPatientID().clear();
		...
		for(int x = 0; x < lookupCollection.size(); x++)
		{
			this.form.cmbPatientID().newRow(lookupCollection.get(x), lookupCollection.get(x).getText(), lookupCollection.get(x).getImage(), lookupCollection.get(x).getTextColor());
		}
	}
	protected final void setcmbPatientIDLookupValue(int id)
	{
		...
		if(instance != null)
			this.form.cmbPatientID().setValue(instance);
	}
	protected final void defaultcmbPatientIDLookupValue()
	{
		this.form.cmbPatientID().setValue((ims.core.vo.lookups.PatIdType)domain.getLookupService().getDefaultInstance(ims.core.vo.lookups.PatIdType.class, engine.getFormName().getID(), ims.core.vo.lookups.PatIdType.TYPE_ID));
	}
	...
	protected ims.pci.domain.ClientSearch domain;
}
