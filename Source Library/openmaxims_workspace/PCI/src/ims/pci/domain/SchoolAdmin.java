...
public interface SchoolAdmin extends ims.domain.DomainInterface
{
	...
	// Generated from form domain interface definition
	public ims.core.vo.LocationLiteVoCollection listSectors(String text, Boolean listInactive);
}
