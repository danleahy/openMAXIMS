...
public abstract class BaseWebServicesIntegrationImpl extends DomainImpl implements ims.admin.domain.WebServicesIntegration, ims.domain.impl.Transactional
{
	...
	@SuppressWarnings("unused")
	public void validatesetAppointmentConsultantCode(String sessionToken, String code)
	{
		if(sessionToken == null)
			throw new ims.domain.exceptions.DomainRuntimeException("The parameter 'sessionToken' of type 'String' cannot be null.");
		if(code == null)
	...
	@SuppressWarnings("unused")
	public void validatesetAppointmentLocationCode(String sessionToken, String code)
	{
		if(sessionToken == null)
			throw new ims.domain.exceptions.DomainRuntimeException("The parameter 'sessionToken' of type 'String' cannot be null.");
		if(code == null)
	...
	@SuppressWarnings("unused")
	public void validatesetAppointmentStartDateTime(String sessionToken, String startDate)
	{
		if(sessionToken == null)
			throw new ims.domain.exceptions.DomainRuntimeException("The parameter 'sessionToken' of type 'String' cannot be null.");
		if(startDate == null)
			throw new ims.domain.exceptions.DomainRuntimeException("The parameter 'startDate' of type 'String' cannot be null.");
	}

	@SuppressWarnings("unused")
	public void validatesetAppointmentEndDateTime(String sessionToken, String endDate)
	{
		if(sessionToken == null)
			throw new ims.domain.exceptions.DomainRuntimeException("The parameter 'sessionToken' of type 'String' cannot be null.");
		if(endDate == null)
			throw new ims.domain.exceptions.DomainRuntimeException("The parameter 'endDate' of type 'String' cannot be null.");
	}
	...
	@SuppressWarnings("unused")
	public void validateconvertOfficeDocument(String patientDocumentID, String format)
	{
		if(patientDocumentID == null)
			throw new ims.domain.exceptions.DomainRuntimeException("The parameter 'patientDocumentID' of type 'String' cannot be null.");
		if(format == null)
			throw new ims.domain.exceptions.DomainRuntimeException("The parameter 'format' of type 'String' cannot be null.");
	}

	@SuppressWarnings("unused")
	public void validatedeleteTempFile(String url)
	{
		if(url == null)
			throw new ims.domain.exceptions.DomainRuntimeException("The parameter 'url' of type 'String' cannot be null.");
	}
}
