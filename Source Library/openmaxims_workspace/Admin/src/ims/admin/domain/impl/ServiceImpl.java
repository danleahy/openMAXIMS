	...
	public ims.core.vo.ServiceVo saveService(ims.core.vo.ServiceVo voService) throws ims.domain.exceptions.StaleObjectException, ims.domain.exceptions.UniqueKeyViolationException
	{
		...
		if (Boolean.FALSE.equals(voService.getIsActive()))
		{
			...
			if (voService.getID_Service() != null)
			{
    			...
    			String query = "SELECT intRef FROM ServiceConfigIntReferral AS intRef LEFT JOIN intRef.service AS srv WHERE srv.id = :SRV_ID AND intRef.active = 1 and (intRef.isRIE = 0 OR intRef.isRIE is null)";
