...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Admin.SelectedRoleRigths", "_cv_Admin.SelectedPdsRoleRights" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Admin.AssignRightsDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
