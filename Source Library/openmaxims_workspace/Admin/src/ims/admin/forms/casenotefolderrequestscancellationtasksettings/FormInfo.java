...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "CaseNoteFolderRequestsCancellationTaskSettings";
	}
	public int getWidth()
	{
		return 576;
	...
	{
		return "_lv_Admin.CaseNoteFolderRequestsCancellationTaskSettings.__internal_x_context__" + String.valueOf(getFormId());
	}
