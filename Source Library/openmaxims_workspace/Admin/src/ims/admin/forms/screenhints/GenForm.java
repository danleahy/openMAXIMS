...
public class GenForm extends FormBridge
{
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.ScreenHints.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1002100008-ID", "ID_ScreenHint");
			fields[145] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.ScreenHints.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1002100008-IMSID", "ImsId");
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.ScreenHints.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1002100008-FORMID", "FormId");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.ScreenHints.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1002100008-USAGEDESCRIPTION", "UsageDescription");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.ScreenHints.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1002100008-USERHINTTEXT", "UserHintText");
			return fields;
		}
