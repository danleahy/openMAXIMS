...
public class GenForm extends FormBridge
{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1012), new Integer(anchoringHelper12.getX()), new Integer(anchoringHelper12.getY()), new Integer(anchoringHelper12.getWidth()), new Integer(anchoringHelper12.getHeight()), new Integer(startTabIndex.intValue() + 7), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Edit", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.AppointmentTrakingStatusColorConfig.__internal_x_context__CurrentRecord_" + componentIdentifier, "BO-1004100048-ID", "ID_AppointmentTrackingstatusColourConfig");
			fields[145] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.AppointmentTrakingStatusColorConfig.__internal_x_context__CurrentRecord_" + componentIdentifier, "BO-1004100048-TRACKINGSTATUS", "TrackingStatus");
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.AppointmentTrakingStatusColorConfig.__internal_x_context__CurrentRecord_" + componentIdentifier, "BO-1004100048-COLOUR", "Colour");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.AppointmentTrakingStatusColorConfig.__internal_x_context__CurrentRecord_" + componentIdentifier, "BO-1004100048-IDLETIMEINMINS", "IdleTimeInMins");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.AppointmentTrakingStatusColorConfig.__internal_x_context__CurrentRecord_" + componentIdentifier, "BO-1004100048-IDLECOLOUR", "IdleColour");
			return fields;
		}
