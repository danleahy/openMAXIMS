...
public class GenForm extends FormBridge
{
	...
	public static class ctnDetailsContainer extends ContainerBridge
	{
		...
		protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
		{
			...
			super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1010), new Integer(anchoringHelper11.getX()), new Integer(anchoringHelper11.getY()), new Integer(anchoringHelper11.getWidth()), new Integer(anchoringHelper11.getHeight()), new Integer(startTabIndex.intValue() + 22), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFTRIGHT,Boolean.FALSE, new Integer(25), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
			...
			super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1013), new Integer(anchoringHelper14.getX()), new Integer(anchoringHelper14.getY()), new Integer(anchoringHelper14.getWidth()), new Integer(anchoringHelper14.getHeight()), new Integer(startTabIndex.intValue() + 14), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT,Boolean.FALSE, new Integer(40), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
			...
			super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1015), new Integer(anchoringHelper16.getX()), new Integer(anchoringHelper16.getY()), new Integer(anchoringHelper16.getWidth()), new Integer(anchoringHelper16.getHeight()), new Integer(startTabIndex.intValue() + 17), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT,Boolean.FALSE, new Integer(40), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
			...
			super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1016), new Integer(anchoringHelper17.getX()), new Integer(anchoringHelper17.getY()), new Integer(anchoringHelper17.getWidth()), new Integer(anchoringHelper17.getHeight()), new Integer(startTabIndex.intValue() + 19), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT,Boolean.FALSE, new Integer(10), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
			...
			ComboBox m_cmbCountyTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1019), new Integer(anchoringHelper20.getX()), new Integer(anchoringHelper20.getY()), new Integer(anchoringHelper20.getWidth()), new Integer(anchoringHelper20.getHeight()), new Integer(startTabIndex.intValue() + 18), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		contextMenus.Admin.contextMenuPracticeCommChannelsADDItem = factory.createMenuItem(startControlID.intValue() + 12, "Add", true, false, new Integer(102179), true, false);
		contextMenus.Admin.contextMenuPracticeCommChannels.add(contextMenus.Admin.contextMenuPracticeCommChannelsADDItem);
		contextMenus.Admin.contextMenuPracticeCommChannelsREMOVEItem = factory.createMenuItem(startControlID.intValue() + 13, "Remove", true, false, new Integer(102300), true, false);
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1026), new Integer(anchoringHelper26.getX()), new Integer(anchoringHelper26.getY()), new Integer(anchoringHelper26.getWidth()), new Integer(anchoringHelper26.getHeight()), new Integer(startTabIndex.intValue() + 25), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Close", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1027), new Integer(anchoringHelper27.getX()), new Integer(anchoringHelper27.getY()), new Integer(anchoringHelper27.getWidth()), new Integer(anchoringHelper27.getHeight()), new Integer(startTabIndex.intValue() + 11), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Edit", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.PracticeAdmin.__internal_x_context__Practice_" + componentIdentifier, "BO-1007100003-ID", "ID_Organisation");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.PracticeAdmin.__internal_x_context__Practice_" + componentIdentifier, "BO-1007100003-NAME", "Name");
			fields[152] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.PracticeAdmin.__internal_x_context__Practice_" + componentIdentifier, "BO-1007100003-TYPE", "Type");
			fields[153] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.PracticeAdmin.__internal_x_context__Practice_" + componentIdentifier, "BO-1007100003-ISACTIVE", "IsActive");
			fields[154] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.PracticeAdmin.__internal_x_context__Practice_" + componentIdentifier, "BO-1007100003-COMMENT", "Comment");
			fields[155] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.PracticeAdmin.__internal_x_context__Practice_" + componentIdentifier, "BO-1007100003-PCTCODE", "PctCode");
			fields[156] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.PracticeAdmin.__internal_x_context__Surgery_" + componentIdentifier, "BO-1007100007-ID", "ID_Location");
			fields[157] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.PracticeAdmin.__internal_x_context__Surgery_" + componentIdentifier, "BO-1007100007-NAME", "Name");
			fields[158] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.PracticeAdmin.__internal_x_context__Surgery_" + componentIdentifier, "BO-1007100007-ISACTIVE", "IsActive");
			fields[159] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.PracticeAdmin.__internal_x_context__Surgery_" + componentIdentifier, "BO-1007100007-ISVIRTUAL", "IsVirtual");
			fields[160] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.PracticeAdmin.__internal_x_context__Surgery_" + componentIdentifier, "BO-1007100007-TYPE", "Type");
			fields[161] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.PracticeAdmin.__internal_x_context__Surgery_" + componentIdentifier, "BO-1007100007-DISPLAYINEDTRACKING", "DisplayInEDTracking");
			fields[162] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.PracticeAdmin.__internal_x_context__Surgery_" + componentIdentifier, "BO-1007100007-CASENOTEFOLDERLOCATION", "CaseNoteFolderLocation");
			fields[163] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.PracticeAdmin.__internal_x_context__Surgery_" + componentIdentifier, "BO-1007100007-SECUREACCOMMODATION", "SecureAccommodation");
			fields[164] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.PracticeAdmin.__internal_x_context__Surgery_" + componentIdentifier, "BO-1007100007-TREATINGHOSP", "TreatingHosp");
			fields[165] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.PracticeAdmin.__internal_x_context__Surgery_" + componentIdentifier, "BO-1007100007-REFERRINGHOSPITAL", "ReferringHospital");
			fields[166] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.PracticeAdmin.__internal_x_context__Surgery_" + componentIdentifier, "BO-1007100002-ALLSECUREACCOMMODATION", "AllSecureAccommodation");
			return fields;
		}
