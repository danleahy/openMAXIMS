...
public class GenForm extends FormBridge
{
	...
	public static class lyrAddsLayer extends Layer
	{
		...
		public static class tabFormsContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				// Button Controls
				RuntimeAnchoring anchoringHelper1 = new RuntimeAnchoring(designSize, runtimeSize, 245, 8, 75, 23, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
				super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1000), new Integer(anchoringHelper1.getX()), new Integer(anchoringHelper1.getY()), new Integer(anchoringHelper1.getWidth()), new Integer(anchoringHelper1.getHeight()), new Integer(startTabIndex.intValue() + 13), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT, "Search", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		
				// TextBox Controls
				RuntimeAnchoring anchoringHelper2 = new RuntimeAnchoring(designSize, runtimeSize, 16, 8, 216, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT);
				super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1001), new Integer(anchoringHelper2.getX()), new Integer(anchoringHelper2.getY()), new Integer(anchoringHelper2.getWidth()), new Integer(anchoringHelper2.getHeight()), new Integer(startTabIndex.intValue() + 12), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT,Boolean.FALSE, new Integer(30), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
		
				// Grid Controls
				RuntimeAnchoring anchoringHelper3 = new RuntimeAnchoring(designSize, runtimeSize, 16, 40, 304, 504, ims.framework.enumerations.ControlAnchoring.ALL);
				Grid m_grdNavFormsTemp = (Grid)factory.getControl(Grid.class, new Object[] { control, new Integer(startControlID.intValue() + 1002), new Integer(anchoringHelper3.getX()), new Integer(anchoringHelper3.getY()), new Integer(anchoringHelper3.getWidth()), new Integer(anchoringHelper3.getHeight()), new Integer(startTabIndex.intValue() + 14), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL,Boolean.FALSE, Boolean.TRUE, new Integer(24), Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, new Integer(0), null, Boolean.FALSE, Boolean.TRUE});
		...
		public static class tabAssesmentsContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				// Button Controls
				RuntimeAnchoring anchoringHelper4 = new RuntimeAnchoring(designSize, runtimeSize, 245, 7, 75, 23, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
				super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1003), new Integer(anchoringHelper4.getX()), new Integer(anchoringHelper4.getY()), new Integer(anchoringHelper4.getWidth()), new Integer(anchoringHelper4.getHeight()), new Integer(startTabIndex.intValue() + 16), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT, "Search", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		
				// TextBox Controls
				RuntimeAnchoring anchoringHelper5 = new RuntimeAnchoring(designSize, runtimeSize, 16, 7, 216, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT);
				super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1004), new Integer(anchoringHelper5.getX()), new Integer(anchoringHelper5.getY()), new Integer(anchoringHelper5.getWidth()), new Integer(anchoringHelper5.getHeight()), new Integer(startTabIndex.intValue() + 15), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT,Boolean.FALSE, new Integer(30), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
		
				// Grid Controls
				RuntimeAnchoring anchoringHelper6 = new RuntimeAnchoring(designSize, runtimeSize, 16, 40, 304, 496, ims.framework.enumerations.ControlAnchoring.ALL);
				Grid m_grdNavAssesmentsTemp = (Grid)factory.getControl(Grid.class, new Object[] { control, new Integer(startControlID.intValue() + 1005), new Integer(anchoringHelper6.getX()), new Integer(anchoringHelper6.getY()), new Integer(anchoringHelper6.getWidth()), new Integer(anchoringHelper6.getHeight()), new Integer(startTabIndex.intValue() + 17), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL,Boolean.FALSE, Boolean.TRUE, new Integer(24), Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, new Integer(0), null, Boolean.FALSE, Boolean.TRUE});
		...
		public static class tabReportsContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				// Button Controls
				RuntimeAnchoring anchoringHelper7 = new RuntimeAnchoring(designSize, runtimeSize, 245, 7, 75, 23, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
				super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1006), new Integer(anchoringHelper7.getX()), new Integer(anchoringHelper7.getY()), new Integer(anchoringHelper7.getWidth()), new Integer(anchoringHelper7.getHeight()), new Integer(startTabIndex.intValue() + 19), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT, "Search", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		
				// TextBox Controls
				RuntimeAnchoring anchoringHelper8 = new RuntimeAnchoring(designSize, runtimeSize, 16, 7, 216, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT);
				super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1007), new Integer(anchoringHelper8.getX()), new Integer(anchoringHelper8.getY()), new Integer(anchoringHelper8.getWidth()), new Integer(anchoringHelper8.getHeight()), new Integer(startTabIndex.intValue() + 18), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT,Boolean.FALSE, new Integer(30), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
		
				// Grid Controls
				RuntimeAnchoring anchoringHelper9 = new RuntimeAnchoring(designSize, runtimeSize, 16, 40, 304, 496, ims.framework.enumerations.ControlAnchoring.ALL);
				Grid m_grdNavReportsTemp = (Grid)factory.getControl(Grid.class, new Object[] { control, new Integer(startControlID.intValue() + 1008), new Integer(anchoringHelper9.getX()), new Integer(anchoringHelper9.getY()), new Integer(anchoringHelper9.getWidth()), new Integer(anchoringHelper9.getHeight()), new Integer(startTabIndex.intValue() + 20), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL,Boolean.FALSE, Boolean.TRUE, new Integer(24), Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, new Integer(0), null, Boolean.FALSE, Boolean.TRUE});
		...
		protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
		{
			...
			if(startTabIndex == null)
				throw new RuntimeException("Invalid startTabIndex");
			RuntimeAnchoring anchoringHelper10 = new RuntimeAnchoring(designSize, runtimeSize, 504, 8, 336, 576, ims.framework.enumerations.ControlAnchoring.TOPBOTTOMRIGHT);
			...
			ims.framework.utils.SizeInfo m_tabFormsRuntimeSize = new ims.framework.utils.SizeInfo(anchoringHelper10.getWidth(), anchoringHelper10.getHeight());
			...
			RuntimeAnchoring anchoringHelper11 = new RuntimeAnchoring(designSize, runtimeSize, 504, 8, 336, 576, ims.framework.enumerations.ControlAnchoring.TOPBOTTOMRIGHT);
			...
			ims.framework.utils.SizeInfo m_tabAssesmentsRuntimeSize = new ims.framework.utils.SizeInfo(anchoringHelper11.getWidth(), anchoringHelper11.getHeight());
			...
			RuntimeAnchoring anchoringHelper12 = new RuntimeAnchoring(designSize, runtimeSize, 504, 8, 336, 576, ims.framework.enumerations.ControlAnchoring.TOPBOTTOMRIGHT);
			...
			ims.framework.utils.SizeInfo m_tabReportsRuntimeSize = new ims.framework.utils.SizeInfo(anchoringHelper12.getWidth(), anchoringHelper12.getHeight());
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		contextMenus.contextMenuNavAdminAddRootGroupItem = factory.createMenuItem(startControlID.intValue() + 12, "Add Top Level Group", true, false, new Integer(102252), true, false);
		contextMenus.contextMenuNavAdmin.add(contextMenus.contextMenuNavAdminAddRootGroupItem);
		contextMenus.contextMenuNavAdminAddSecGroupItem = factory.createMenuItem(startControlID.intValue() + 13, "Add Second Level Group", true, false, new Integer(102253), true, false);
		contextMenus.contextMenuNavAdmin.add(contextMenus.contextMenuNavAdminAddSecGroupItem);
		contextMenus.contextMenuNavAdminAddAssessmentItem = factory.createMenuItem(startControlID.intValue() + 14, "Add Assessment", true, false, new Integer(102182), true, false);
		contextMenus.contextMenuNavAdmin.add(contextMenus.contextMenuNavAdminAddAssessmentItem);
		contextMenus.contextMenuNavAdminAddReportItem = factory.createMenuItem(startControlID.intValue() + 15, "Add Report", true, false, new Integer(102292), true, false);
		contextMenus.contextMenuNavAdmin.add(contextMenus.contextMenuNavAdminAddReportItem);
		contextMenus.contextMenuNavAdminEditTextItem = factory.createMenuItem(startControlID.intValue() + 16, "Edit Node Text", true, false, new Integer(103102), true, false);
		contextMenus.contextMenuNavAdmin.add(contextMenus.contextMenuNavAdminEditTextItem);
		contextMenus.contextMenuNavAdminChangePictureItem = factory.createMenuItem(startControlID.intValue() + 17, "Colapse All", true, false, new Integer(102208), true, false);
		contextMenus.contextMenuNavAdmin.add(contextMenus.contextMenuNavAdminChangePictureItem);
		contextMenus.contextMenuNavAdminRemoveItem = factory.createMenuItem(startControlID.intValue() + 18, "Remove this ", true, false, new Integer(102148), true, false);
		contextMenus.contextMenuNavAdmin.add(contextMenus.contextMenuNavAdminRemoveItem);
		contextMenus.contextMenuNavAdminSetStartFormItem = factory.createMenuItem(startControlID.intValue() + 19, "Set as Start Form", true, false, new Integer(102220), true, true);
		contextMenus.contextMenuNavAdmin.add(contextMenus.contextMenuNavAdminSetStartFormItem);
		contextMenus.contextMenuNavAdminSetSearchFormItem = factory.createMenuItem(startControlID.intValue() + 20, "Set as Patient Search Form", true, false, new Integer(102164), true, false);
		contextMenus.contextMenuNavAdmin.add(contextMenus.contextMenuNavAdminSetSearchFormItem);
		contextMenus.contextMenuNavAdminSetReadOnlyItem = factory.createMenuItem(startControlID.intValue() + 21, "Set as Read Only", true, false, new Integer(102223), true, true);
		contextMenus.contextMenuNavAdmin.add(contextMenus.contextMenuNavAdminSetReadOnlyItem);
		contextMenus.contextMenuNavAdminSetReadWriteItem = factory.createMenuItem(startControlID.intValue() + 22, "Set as Read/Write", true, false, new Integer(102223), true, false);
		contextMenus.contextMenuNavAdmin.add(contextMenus.contextMenuNavAdminSetReadWriteItem);
		contextMenus.contextMenuNavAdminReadOnlyForRipItem = factory.createMenuItem(startControlID.intValue() + 23, "Set Read Only for Patient RIP", true, false, new Integer(102145), true, false);
		contextMenus.contextMenuNavAdmin.add(contextMenus.contextMenuNavAdminReadOnlyForRipItem);
		contextMenus.contextMenuNavAdminReadWriteForRipItem = factory.createMenuItem(startControlID.intValue() + 24, "Set Read Write for Patient RIP", true, false, new Integer(102150), true, false);
		contextMenus.contextMenuNavAdmin.add(contextMenus.contextMenuNavAdminReadWriteForRipItem);
		contextMenus.contextMenuNavAdminInaccessibleForRipItem = factory.createMenuItem(startControlID.intValue() + 25, "Set Inaccessible for Patient RIP", true, false, new Integer(102141), true, false);
		contextMenus.contextMenuNavAdmin.add(contextMenus.contextMenuNavAdminInaccessibleForRipItem);
		contextMenus.contextMenuNavAdminReadOnlyForEpisEndItem = factory.createMenuItem(startControlID.intValue() + 26, "Set Read Only for Episode Ended", true, false, new Integer(102146), true, false);
		contextMenus.contextMenuNavAdmin.add(contextMenus.contextMenuNavAdminReadOnlyForEpisEndItem);
		contextMenus.contextMenuNavAdminReadWriteforEpisEndItem = factory.createMenuItem(startControlID.intValue() + 27, "Set Read Write for Episode Ended", true, false, new Integer(102150), true, false);
		contextMenus.contextMenuNavAdmin.add(contextMenus.contextMenuNavAdminReadWriteforEpisEndItem);
		contextMenus.contextMenuNavAdminInaccessibleForEpisEndItem = factory.createMenuItem(startControlID.intValue() + 28, "Set Inaccessible for Episode Ended", true, false, new Integer(102142), true, false);
		...
		// Label Controls
		RuntimeAnchoring anchoringHelper13 = new RuntimeAnchoring(designSize, runtimeSize, 240, 8, 189, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1012), new Integer(anchoringHelper13.getX()), new Integer(anchoringHelper13.getY()), new Integer(anchoringHelper13.getWidth()), new Integer(anchoringHelper13.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Show Image Style In Navigation", new Integer(1), null, new Integer(0)}));
		RuntimeAnchoring anchoringHelper14 = new RuntimeAnchoring(designSize, runtimeSize, 8, 448, 37, 17, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT);
		...
		RuntimeAnchoring anchoringHelper15 = new RuntimeAnchoring(designSize, runtimeSize, 8, 528, 124, 17, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT);
		...
		RuntimeAnchoring anchoringHelper16 = new RuntimeAnchoring(designSize, runtimeSize, 8, 488, 69, 17, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT);
		...
		RuntimeAnchoring anchoringHelper17 = new RuntimeAnchoring(designSize, runtimeSize, 8, 567, 43, 17, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT);
		...
		RuntimeAnchoring anchoringHelper18 = new RuntimeAnchoring(designSize, runtimeSize, 8, 408, 41, 17, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT);
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1019), new Integer(anchoringHelper20.getX()), new Integer(anchoringHelper20.getY()), new Integer(anchoringHelper20.getWidth()), new Integer(anchoringHelper20.getHeight()), new Integer(startTabIndex.intValue() + 21), ControlState.HIDDEN, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Save", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		RuntimeAnchoring anchoringHelper21 = new RuntimeAnchoring(designSize, runtimeSize, 96, 600, 75, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT);
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1020), new Integer(anchoringHelper21.getX()), new Integer(anchoringHelper21.getY()), new Integer(anchoringHelper21.getWidth()), new Integer(anchoringHelper21.getHeight()), new Integer(startTabIndex.intValue() + 10), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Edit", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		// TextBox Controls
		RuntimeAnchoring anchoringHelper23 = new RuntimeAnchoring(designSize, runtimeSize, 8, 424, 200, 21, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT);
		...
		// ComboBox Controls
		RuntimeAnchoring anchoringHelper24 = new RuntimeAnchoring(designSize, runtimeSize, 8, 464, 200, 21, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT);
		...
		RuntimeAnchoring anchoringHelper25 = new RuntimeAnchoring(designSize, runtimeSize, 8, 544, 200, 21, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT);
		...
		RuntimeAnchoring anchoringHelper26 = new RuntimeAnchoring(designSize, runtimeSize, 8, 504, 200, 21, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT);
		...
		// CheckBox Controls
		RuntimeAnchoring anchoringHelper27 = new RuntimeAnchoring(designSize, runtimeSize, 224, 8, 16, 16, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		RuntimeAnchoring anchoringHelper28 = new RuntimeAnchoring(designSize, runtimeSize, 56, 567, 16, 16, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT);
		super.addControl(factory.getControl(CheckBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1027), new Integer(anchoringHelper28.getX()), new Integer(anchoringHelper28.getY()), new Integer(anchoringHelper28.getWidth()), new Integer(anchoringHelper28.getHeight()), new Integer(startTabIndex.intValue() + 8), ControlState.DISABLED, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT ,"", Boolean.FALSE, null}));
		RuntimeAnchoring anchoringHelper29 = new RuntimeAnchoring(designSize, runtimeSize, 8, 8, 80, 16, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(CheckBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1028), new Integer(anchoringHelper29.getX()), new Integer(anchoringHelper29.getY()), new Integer(anchoringHelper29.getWidth()), new Integer(anchoringHelper29.getHeight()), new Integer(startTabIndex.intValue() + 1), ControlState.ENABLED, ControlState.DISABLED,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,"Active Only", Boolean.TRUE, null}));

		// Grid Controls
		RuntimeAnchoring anchoringHelper30 = new RuntimeAnchoring(designSize, runtimeSize, 8, 32, 208, 368, ims.framework.enumerations.ControlAnchoring.TOPBOTTOMLEFT);
		...
		// Tree Controls
		RuntimeAnchoring anchoringHelper31 = new RuntimeAnchoring(designSize, runtimeSize, 224, 32, 272, 552, ims.framework.enumerations.ControlAnchoring.ALL);
		super.addControl(factory.getControl(TreeView.class, new Object[] { control, new Integer(startControlID.intValue() + 1030), new Integer(anchoringHelper31.getX()), new Integer(anchoringHelper31.getY()), new Integer(anchoringHelper31.getWidth()), new Integer(anchoringHelper31.getHeight()), new Integer(startTabIndex.intValue() + 11), ControlState.ENABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.ALL,Boolean.TRUE, Boolean.FALSE, Boolean.FALSE, contextMenus.contextMenuNavAdmin, Boolean.TRUE, Boolean.TRUE, Boolean.TRUE, Boolean.FALSE, Boolean.TRUE}));
	}
	...
	public class LocalContext extends ContextBridge
	{
		...
		public LocalContext(Context context, ims.framework.FormInfo formInfo, String componentIdentifier)
		{
			...
			cxl_NavigationHasAssociatedRole = new ims.framework.ContextVariable("NavigationHasAssociatedRole", prefix + "_lv_Admin.NavigationAdminProt.__internal_x_context__NavigationHasAssociatedRole_" + componentIdentifier + "");
			cxl_IsReplicatedNavigation = new ims.framework.ContextVariable("IsReplicatedNavigation", prefix + "_lv_Admin.NavigationAdminProt.__internal_x_context__IsReplicatedNavigation_" + componentIdentifier + "");
		}
		...
		public boolean getNavigationHasAssociatedRoleIsNotNull()
		{
			return !cxl_NavigationHasAssociatedRole.getValueIsNull(context);
		}
		public Boolean getNavigationHasAssociatedRole()
		{
			return (Boolean)cxl_NavigationHasAssociatedRole.getValue(context);
		}
		public void setNavigationHasAssociatedRole(Boolean value)
		{
			cxl_NavigationHasAssociatedRole.setValue(context, value);
		}
		private ims.framework.ContextVariable cxl_NavigationHasAssociatedRole = null;
		public boolean getIsReplicatedNavigationIsNotNull()
		{
			return !cxl_IsReplicatedNavigation.getValueIsNull(context);
		}
		public Boolean getIsReplicatedNavigation()
		{
			return (Boolean)cxl_IsReplicatedNavigation.getValue(context);
		}
		public void setIsReplicatedNavigation(Boolean value)
		{
			cxl_IsReplicatedNavigation.setValue(context, value);
		}
		private ims.framework.ContextVariable cxl_IsReplicatedNavigation = null;
	}
	...
	public final class ContextMenus implements java.io.Serializable
	{
		...
		{
			private static final long serialVersionUID = 1L;
			public static final int AddRootGroup = 12;
			public static final int AddSecGroup = 13;
			public static final int AddAssessment = 14;
			public static final int AddReport = 15;
			public static final int EditText = 16;
			public static final int ChangePicture = 17;
			public static final int Remove = 18;
			public static final int SetStartForm = 19;
			public static final int SetSearchForm = 20;
			public static final int SetReadOnly = 21;
			public static final int SetReadWrite = 22;
			public static final int ReadOnlyForRip = 23;
			public static final int ReadWriteForRip = 24;
			public static final int InaccessibleForRip = 25;
			public static final int ReadOnlyForEpisEnd = 26;
			public static final int ReadWriteforEpisEnd = 27;
			public static final int InaccessibleForEpisEnd = 28;
		}
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.NavigationAdminProt.__internal_x_context__SelectedNav_" + componentIdentifier, "BO-1028100027-ID", "ID_AppNavigation");
			fields[145] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.NavigationAdminProt.__internal_x_context__SelectedNav_" + componentIdentifier, "BO-1028100027-NAVIGATIONNAME", "NavigationName");
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.NavigationAdminProt.__internal_x_context__SelectedNav_" + componentIdentifier, "BO-1028100027-ISACTIVE", "IsActive");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.NavigationAdminProt.__internal_x_context__SelectedNav_" + componentIdentifier, "BO-1028100027-COMMENT", "Comment");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.NavigationAdminProt.__internal_x_context__SelectedNav_" + componentIdentifier, "BO-1028100027-STYLE", "Style");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.NavigationAdminProt.__internal_x_context__AssessmentForm_" + componentIdentifier, "BO-1021100001-ID", "ID_AppForm");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.NavigationAdminProt.__internal_x_context__AssessmentForm_" + componentIdentifier, "BO-1021100001-NAME", "Name");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.NavigationAdminProt.__internal_x_context__AssessmentForm_" + componentIdentifier, "BO-1021100001-ALIASNAME", "AliasName");
			fields[152] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.NavigationAdminProt.__internal_x_context__AssessmentForm_" + componentIdentifier, "BO-1021100001-CAPTION", "Caption");
			fields[153] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.NavigationAdminProt.__internal_x_context__AssessmentForm_" + componentIdentifier, "BO-1021100001-ISDIALOG", "IsDialog");
			fields[154] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.NavigationAdminProt.__internal_x_context__AssessmentForm_" + componentIdentifier, "BO-1021100001-ISALIAS", "IsAlias");
			fields[155] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.NavigationAdminProt.__internal_x_context__AssessmentForm_" + componentIdentifier, "BO-1021100001-ISCOMPONENT", "IsComponent");
			fields[156] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.NavigationAdminProt.__internal_x_context__AssessmentForm_" + componentIdentifier, "BO-1021100001-DESCRIPTION", "Description");
			fields[157] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.NavigationAdminProt.__internal_x_context__AssessmentForm_" + componentIdentifier, "BO-1021100001-CANBEINNAVIGATION", "CanBeInNavigation");
			fields[158] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.NavigationAdminProt.__internal_x_context__AssessmentForm_" + componentIdentifier, "BO-1021100001-CANBEINTOPBUTTONS", "CanBeInTopButtons");
			fields[159] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.NavigationAdminProt.__internal_x_context__AssessmentForm_" + componentIdentifier, "BO-1021100001-LOGICCLASS", "LogicClass");
			fields[160] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.NavigationAdminProt.__internal_x_context__AssessmentForm_" + componentIdentifier, "BO-1021100001-ACCESSCLASS", "AccessClass");
			fields[161] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.NavigationAdminProt.__internal_x_context__AssessmentForm_" + componentIdentifier, "BO-1021100001-DOMAINCLASS", "DomainImpl");
			fields[162] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.NavigationAdminProt.__internal_x_context__AssessmentForm_" + componentIdentifier, "BO-1021100001-HELPLINK", "HelpLink");
			fields[163] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.NavigationAdminProt.__internal_x_context__AssessmentForm_" + componentIdentifier, "BO-1021100001-RIEBOCLASSNAME", "RieBoClassName");
			fields[164] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.NavigationAdminProt.__internal_x_context__AssessmentForm_" + componentIdentifier, "BO-1021100001-ISSYSTEM", "IsSystem");
			fields[165] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.NavigationAdminProt.__internal_x_context__AssessmentForm_" + componentIdentifier, "BO-1021100001-INFORMATIONBARVISIBLE", "InformationBarVisible");
			fields[166] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.NavigationAdminProt.__internal_x_context__ReportViewerForm_" + componentIdentifier, "BO-1021100001-ID", "ID_AppForm");
			fields[167] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.NavigationAdminProt.__internal_x_context__ReportViewerForm_" + componentIdentifier, "BO-1021100001-NAME", "Name");
			fields[168] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.NavigationAdminProt.__internal_x_context__ReportViewerForm_" + componentIdentifier, "BO-1021100001-ALIASNAME", "AliasName");
			fields[169] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.NavigationAdminProt.__internal_x_context__ReportViewerForm_" + componentIdentifier, "BO-1021100001-CAPTION", "Caption");
			fields[170] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.NavigationAdminProt.__internal_x_context__ReportViewerForm_" + componentIdentifier, "BO-1021100001-ISDIALOG", "IsDialog");
			fields[171] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.NavigationAdminProt.__internal_x_context__ReportViewerForm_" + componentIdentifier, "BO-1021100001-ISALIAS", "IsAlias");
			fields[172] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.NavigationAdminProt.__internal_x_context__ReportViewerForm_" + componentIdentifier, "BO-1021100001-ISCOMPONENT", "IsComponent");
			fields[173] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.NavigationAdminProt.__internal_x_context__ReportViewerForm_" + componentIdentifier, "BO-1021100001-DESCRIPTION", "Description");
			fields[174] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.NavigationAdminProt.__internal_x_context__ReportViewerForm_" + componentIdentifier, "BO-1021100001-CANBEINNAVIGATION", "CanBeInNavigation");
			fields[175] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.NavigationAdminProt.__internal_x_context__ReportViewerForm_" + componentIdentifier, "BO-1021100001-CANBEINTOPBUTTONS", "CanBeInTopButtons");
			fields[176] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.NavigationAdminProt.__internal_x_context__ReportViewerForm_" + componentIdentifier, "BO-1021100001-LOGICCLASS", "LogicClass");
			fields[177] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.NavigationAdminProt.__internal_x_context__ReportViewerForm_" + componentIdentifier, "BO-1021100001-ACCESSCLASS", "AccessClass");
			fields[178] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.NavigationAdminProt.__internal_x_context__ReportViewerForm_" + componentIdentifier, "BO-1021100001-DOMAINCLASS", "DomainImpl");
			fields[179] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.NavigationAdminProt.__internal_x_context__ReportViewerForm_" + componentIdentifier, "BO-1021100001-HELPLINK", "HelpLink");
			fields[180] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.NavigationAdminProt.__internal_x_context__ReportViewerForm_" + componentIdentifier, "BO-1021100001-RIEBOCLASSNAME", "RieBoClassName");
			fields[181] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.NavigationAdminProt.__internal_x_context__ReportViewerForm_" + componentIdentifier, "BO-1021100001-ISSYSTEM", "IsSystem");
			fields[182] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.NavigationAdminProt.__internal_x_context__ReportViewerForm_" + componentIdentifier, "BO-1021100001-INFORMATIONBARVISIBLE", "InformationBarVisible");
			return fields;
		}
