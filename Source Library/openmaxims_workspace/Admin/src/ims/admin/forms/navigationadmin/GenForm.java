...
public class GenForm extends FormBridge
{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		contextMenus.contextMenuGenericGridCOPYItem = factory.createMenuItem(startControlID.intValue() + 27, "Copy", true, false, new Integer(102222), true, false);
		...
		contextMenus.contextMenuGenericGridREMOVE_UNVERIFIED_NHS_NUMBERItem = factory.createMenuItem(startControlID.intValue() + 28, "Remove Unverified NHS Number", true, false, new Integer(102300), true, false);
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1008), new Integer(anchoringHelper9.getX()), new Integer(anchoringHelper9.getY()), new Integer(anchoringHelper9.getWidth()), new Integer(anchoringHelper9.getHeight()), new Integer(startTabIndex.intValue() + 4), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Edit", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1009), new Integer(anchoringHelper10.getX()), new Integer(anchoringHelper10.getY()), new Integer(anchoringHelper10.getWidth()), new Integer(anchoringHelper10.getHeight()), new Integer(startTabIndex.intValue() + 1), ControlState.HIDDEN, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Save", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
	...
	public final class ContextMenus implements java.io.Serializable
	{
		...
		public final class GenericGrid implements java.io.Serializable
		{
			...
			public static final int REMOVE_UNVERIFIED_NHS_NUMBER = 28;
		}
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, "_cv_Core.ReportTemplateRef", "BO-1004100008-ID", "ID_TemplateBo");
			fields[145] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.NavigationAdmin.__internal_x_context__SelectedNav_" + componentIdentifier, "BO-1028100027-ID", "ID_AppNavigation");
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.NavigationAdmin.__internal_x_context__SelectedNav_" + componentIdentifier, "BO-1028100027-NAVIGATIONNAME", "NavigationName");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.NavigationAdmin.__internal_x_context__SelectedNav_" + componentIdentifier, "BO-1028100027-ISACTIVE", "IsActive");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.NavigationAdmin.__internal_x_context__SelectedNav_" + componentIdentifier, "BO-1028100027-COMMENT", "Comment");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.NavigationAdmin.__internal_x_context__SelectedNav_" + componentIdentifier, "BO-1028100027-STYLE", "Style");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.NavigationAdmin.__internal_x_context__AssessmentForm_" + componentIdentifier, "BO-1021100001-ID", "ID_AppForm");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.NavigationAdmin.__internal_x_context__AssessmentForm_" + componentIdentifier, "BO-1021100001-NAME", "Name");
			fields[152] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.NavigationAdmin.__internal_x_context__AssessmentForm_" + componentIdentifier, "BO-1021100001-ALIASNAME", "AliasName");
			fields[153] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.NavigationAdmin.__internal_x_context__AssessmentForm_" + componentIdentifier, "BO-1021100001-CAPTION", "Caption");
			fields[154] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.NavigationAdmin.__internal_x_context__AssessmentForm_" + componentIdentifier, "BO-1021100001-ISDIALOG", "IsDialog");
			fields[155] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.NavigationAdmin.__internal_x_context__AssessmentForm_" + componentIdentifier, "BO-1021100001-ISALIAS", "IsAlias");
			fields[156] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.NavigationAdmin.__internal_x_context__AssessmentForm_" + componentIdentifier, "BO-1021100001-ISCOMPONENT", "IsComponent");
			fields[157] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.NavigationAdmin.__internal_x_context__AssessmentForm_" + componentIdentifier, "BO-1021100001-DESCRIPTION", "Description");
			fields[158] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.NavigationAdmin.__internal_x_context__AssessmentForm_" + componentIdentifier, "BO-1021100001-CANBEINNAVIGATION", "CanBeInNavigation");
			fields[159] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.NavigationAdmin.__internal_x_context__AssessmentForm_" + componentIdentifier, "BO-1021100001-CANBEINTOPBUTTONS", "CanBeInTopButtons");
			fields[160] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.NavigationAdmin.__internal_x_context__AssessmentForm_" + componentIdentifier, "BO-1021100001-LOGICCLASS", "LogicClass");
			fields[161] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.NavigationAdmin.__internal_x_context__AssessmentForm_" + componentIdentifier, "BO-1021100001-ACCESSCLASS", "AccessClass");
			fields[162] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.NavigationAdmin.__internal_x_context__AssessmentForm_" + componentIdentifier, "BO-1021100001-DOMAINCLASS", "DomainImpl");
			fields[163] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.NavigationAdmin.__internal_x_context__AssessmentForm_" + componentIdentifier, "BO-1021100001-HELPLINK", "HelpLink");
			fields[164] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.NavigationAdmin.__internal_x_context__AssessmentForm_" + componentIdentifier, "BO-1021100001-RIEBOCLASSNAME", "RieBoClassName");
			fields[165] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.NavigationAdmin.__internal_x_context__AssessmentForm_" + componentIdentifier, "BO-1021100001-ISSYSTEM", "IsSystem");
			fields[166] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.NavigationAdmin.__internal_x_context__AssessmentForm_" + componentIdentifier, "BO-1021100001-INFORMATIONBARVISIBLE", "InformationBarVisible");
			return fields;
		}
