...
public class GenForm extends FormBridge
{
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, "_cv_Admin.SystemJobNotification", "BO-1028100064-ID", "ID_ConfiguredJobNotification");
			fields[145] = new ims.framework.ReportField(this.context, "_cv_Admin.SystemJobNotification", "BO-1028100064-PRIORITY", "Priority");
			fields[146] = new ims.framework.ReportField(this.context, "_cv_Admin.SystemJobNotification", "BO-1028100064-USERMESSAGE", "UserMessage");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.SystemJobNotificationDialog.__internal_x_context__EditedRecord_" + componentIdentifier, "BO-1028100064-ID", "ID_ConfiguredJobNotification");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.SystemJobNotificationDialog.__internal_x_context__EditedRecord_" + componentIdentifier, "BO-1028100064-PRIORITY", "Priority");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.SystemJobNotificationDialog.__internal_x_context__EditedRecord_" + componentIdentifier, "BO-1028100064-USERMESSAGE", "UserMessage");
			return fields;
		}
