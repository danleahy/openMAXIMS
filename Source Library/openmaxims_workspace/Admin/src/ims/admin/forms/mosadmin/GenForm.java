...
public class GenForm extends FormBridge
{
	...
	public static class lyrLHSLayer extends Layer
	{
		...
		public static class tabOrganisationContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				super.addControl(factory.getControl(TreeView.class, new Object[] { control, new Integer(startControlID.intValue() + 1003), new Integer(anchoringHelper3.getX()), new Integer(anchoringHelper3.getY()), new Integer(anchoringHelper3.getWidth()), new Integer(anchoringHelper3.getHeight()), new Integer(startTabIndex.intValue() + 11), ControlState.ENABLED, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.ALL,Boolean.TRUE, Boolean.FALSE, Boolean.FALSE, contextMenus.contextMenuMosOrganisation, Boolean.FALSE, Boolean.FALSE, Boolean.FALSE, Boolean.FALSE, Boolean.FALSE}));
			}
	...
	public static class GroupTreeFilterRadioButton extends RadioButtonBridge
	{
		...
		protected void setContext(Integer startTabIndex, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize)
		{
			...
			control.addButton(0, anchoringHelper6.getX(), anchoringHelper6.getY(), anchoringHelper6.getWidth(), "View by Organisation/Location", startTabIndex.intValue() + 12);
			...
			control.addButton(1, anchoringHelper7.getX(), anchoringHelper7.getY(), anchoringHelper7.getWidth(), "View by Member Of Staff", startTabIndex.intValue() + 13);
		}
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		contextMenus.contextMenuGenericGridCOPYItem = factory.createMenuItem(startControlID.intValue() + 12, "Copy", true, false, new Integer(102222), true, false);
		...
		contextMenus.contextMenuGenericGridREMOVE_UNVERIFIED_NHS_NUMBERItem = factory.createMenuItem(startControlID.intValue() + 13, "Remove Unverified NHS Number", true, false, new Integer(102300), true, false);
		...
		contextMenus.contextMenuMosOrganisationADDItem = factory.createMenuItem(startControlID.intValue() + 14, "Add", true, false, new Integer(103128), true, false);
		contextMenus.contextMenuMosOrganisation.add(contextMenus.contextMenuMosOrganisationADDItem);
		contextMenus.contextMenuMosOrganisationEDITItem = factory.createMenuItem(startControlID.intValue() + 15, "Edit", true, false, new Integer(103128), true, false);
		contextMenus.contextMenuMosOrganisation.add(contextMenus.contextMenuMosOrganisationEDITItem);
		contextMenus.contextMenuMosOrganisationDEACTIVATEItem = factory.createMenuItem(startControlID.intValue() + 16, "Deactivate Member of Staff", true, false, new Integer(103130), true, true);
		contextMenus.contextMenuMosOrganisation.add(contextMenus.contextMenuMosOrganisationDEACTIVATEItem);
		contextMenus.contextMenuMosOrganisationSETORGANISATIONSItem = factory.createMenuItem(startControlID.intValue() + 17, "Set Locations", true, false, new Integer(103104), true, true);
		contextMenus.contextMenuMosOrganisation.add(contextMenus.contextMenuMosOrganisationSETORGANISATIONSItem);
		contextMenus.contextMenuMosOrganisationSERVICES_AND_TREATMENT_FUNCTIONSItem = factory.createMenuItem(startControlID.intValue() + 18, "Services and Treatment Functions", true, false, null, true, false);
		if(factory.getUIEngine().getLoggedInRole().hasMenuActionRight(appForm, new ims.framework.MenuAction(290001)))
			contextMenus.contextMenuMosOrganisation.add(contextMenus.contextMenuMosOrganisationSERVICES_AND_TREATMENT_FUNCTIONSItem);
		...
		// Label Controls
		RuntimeAnchoring anchoringHelper9 = new RuntimeAnchoring(designSize, runtimeSize, 424, 276, 70, 17, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
		...
		RuntimeAnchoring anchoringHelper10 = new RuntimeAnchoring(designSize, runtimeSize, 424, 228, 98, 17, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
		...
		RuntimeAnchoring anchoringHelper12 = new RuntimeAnchoring(designSize, runtimeSize, 424, 204, 49, 17, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
		...
		RuntimeAnchoring anchoringHelper13 = new RuntimeAnchoring(designSize, runtimeSize, 424, 252, 77, 17, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
		...
		RuntimeAnchoring anchoringHelper14 = new RuntimeAnchoring(designSize, runtimeSize, 432, 388, 58, 17, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
		...
		RuntimeAnchoring anchoringHelper15 = new RuntimeAnchoring(designSize, runtimeSize, 424, 300, 95, 17, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
		...
		RuntimeAnchoring anchoringHelper16 = new RuntimeAnchoring(designSize, runtimeSize, 424, 108, 33, 17, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
		...
		RuntimeAnchoring anchoringHelper17 = new RuntimeAnchoring(designSize, runtimeSize, 424, 156, 83, 17, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
		...
		RuntimeAnchoring anchoringHelper18 = new RuntimeAnchoring(designSize, runtimeSize, 424, 180, 59, 17, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
		...
		RuntimeAnchoring anchoringHelper19 = new RuntimeAnchoring(designSize, runtimeSize, 424, 132, 70, 17, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
		...
		RuntimeAnchoring anchoringHelper20 = new RuntimeAnchoring(designSize, runtimeSize, 424, 60, 36, 17, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
		...
		RuntimeAnchoring anchoringHelper21 = new RuntimeAnchoring(designSize, runtimeSize, 424, 84, 90, 17, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
		...
		// TextBox Controls
		RuntimeAnchoring anchoringHelper24 = new RuntimeAnchoring(designSize, runtimeSize, 528, 274, 288, 21, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
		super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1022), new Integer(anchoringHelper24.getX()), new Integer(anchoringHelper24.getY()), new Integer(anchoringHelper24.getWidth()), new Integer(anchoringHelper24.getHeight()), new Integer(startTabIndex.intValue() + 24), ControlState.DISABLED, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.TOPRIGHT,Boolean.FALSE, new Integer(0), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
		RuntimeAnchoring anchoringHelper25 = new RuntimeAnchoring(designSize, runtimeSize, 528, 226, 288, 21, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
		...
		RuntimeAnchoring anchoringHelper26 = new RuntimeAnchoring(designSize, runtimeSize, 528, 202, 288, 21, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
		...
		RuntimeAnchoring anchoringHelper27 = new RuntimeAnchoring(designSize, runtimeSize, 528, 250, 288, 21, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
		super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1025), new Integer(anchoringHelper27.getX()), new Integer(anchoringHelper27.getY()), new Integer(anchoringHelper27.getWidth()), new Integer(anchoringHelper27.getHeight()), new Integer(startTabIndex.intValue() + 23), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.TOPRIGHT,Boolean.FALSE, new Integer(50), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
		RuntimeAnchoring anchoringHelper28 = new RuntimeAnchoring(designSize, runtimeSize, 528, 154, 288, 21, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
		...
		RuntimeAnchoring anchoringHelper29 = new RuntimeAnchoring(designSize, runtimeSize, 528, 178, 288, 21, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
		...
		RuntimeAnchoring anchoringHelper30 = new RuntimeAnchoring(designSize, runtimeSize, 528, 130, 288, 21, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
		...
		// ComboBox Controls
		RuntimeAnchoring anchoringHelper31 = new RuntimeAnchoring(designSize, runtimeSize, 528, 58, 288, 21, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
		ComboBox m_cmbTypeTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1029), new Integer(anchoringHelper31.getX()), new Integer(anchoringHelper31.getY()), new Integer(anchoringHelper31.getWidth()), new Integer(anchoringHelper31.getHeight()), new Integer(startTabIndex.intValue() + 14), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPRIGHT ,Boolean.TRUE, Boolean.TRUE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
		...
		RuntimeAnchoring anchoringHelper32 = new RuntimeAnchoring(designSize, runtimeSize, 528, 106, 288, 21, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
		...
		RuntimeAnchoring anchoringHelper33 = new RuntimeAnchoring(designSize, runtimeSize, 528, 82, 248, 21, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
		ComboBox m_cmbHcpDiciplineDetailsTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1031), new Integer(anchoringHelper33.getX()), new Integer(anchoringHelper33.getY()), new Integer(anchoringHelper33.getWidth()), new Integer(anchoringHelper33.getHeight()), new Integer(startTabIndex.intValue() + 15), ControlState.DISABLED, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPRIGHT ,Boolean.TRUE, Boolean.TRUE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.TRUE, new Integer(-1)});
		...
		// Grid Controls
		RuntimeAnchoring anchoringHelper34 = new RuntimeAnchoring(designSize, runtimeSize, 528, 388, 288, 60, ims.framework.enumerations.ControlAnchoring.TOPBOTTOMRIGHT);
		...
		RuntimeAnchoring anchoringHelper35 = new RuntimeAnchoring(designSize, runtimeSize, 528, 300, 288, 80, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
		Grid m_grdMappingsTemp = (Grid)factory.getControl(Grid.class, new Object[] { control, new Integer(startControlID.intValue() + 1033), new Integer(anchoringHelper35.getX()), new Integer(anchoringHelper35.getY()), new Integer(anchoringHelper35.getWidth()), new Integer(anchoringHelper35.getHeight()), new Integer(startTabIndex.intValue() + 25), ControlState.READONLY, ControlState.EDITABLE, ims.framework.enumerations.ControlAnchoring.TOPRIGHT,Boolean.TRUE, Boolean.FALSE, new Integer(24), Boolean.FALSE, contextMenus.contextMenuGenericGrid, Boolean.FALSE, Boolean.FALSE, new Integer(0), null, Boolean.FALSE, Boolean.TRUE});
		...
		RuntimeAnchoring anchoringHelper37 = new RuntimeAnchoring(designSize, runtimeSize, 792, 82, 24, 23, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
		super.addControl(factory.getControl(ImageButton.class, new Object[] { control, new Integer(startControlID.intValue() + 1035), new Integer(anchoringHelper37.getX()), new Integer(anchoringHelper37.getY()), new Integer(anchoringHelper37.getWidth()), new Integer(anchoringHelper37.getHeight()), new Integer(startTabIndex.intValue() + 16), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT, this.getImages().Admin.StaffBlack, this.getImages().Admin.StaffBlack, "HCP Details", Boolean.FALSE, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null}));
	...
	public static class Forms implements java.io.Serializable
	{
		...
		public final class AdminForms implements java.io.Serializable
		{
			...
			private AdminForms()
			{
				...
				HcpServiceFunctionDialog = new LocalFormName(103265);
			}
			...
			public final FormName HcpServiceFunctionDialog;
		}
	...
	public class LocalContext extends ContextBridge
	{
		...
		public LocalContext(Context context, ims.framework.FormInfo formInfo, String componentIdentifier)
		{
			...
			cxl_Hcp = new ims.framework.ContextVariable("Hcp", prefix + "_lv_Admin.MosAdmin.__internal_x_context__Hcp_" + componentIdentifier + "");
		}
	...
	public final class ContextMenus implements java.io.Serializable
	{
		...
		public final class GenericGrid implements java.io.Serializable
		{
			...
			public static final int REMOVE_UNVERIFIED_NHS_NUMBER = 13;
		}
		...
		public final class MosOrganisation implements java.io.Serializable
		{
			...
			public static final int SETORGANISATIONS = 17;
			public static final int SERVICES_AND_TREATMENT_FUNCTIONS = 18;
		}
		public void disableAllMosOrganisationMenuItems()
		{
			...
			this.contextMenuMosOrganisationSERVICES_AND_TREATMENT_FUNCTIONSItem.setEnabled(false);
		}
		public void hideAllMosOrganisationMenuItems()
		{
			...
			this.contextMenuMosOrganisationSERVICES_AND_TREATMENT_FUNCTIONSItem.setVisible(false);
		}
		...
		public ReadOnlyMenuItem getMosOrganisationSERVICES_AND_TREATMENT_FUNCTIONSItem()
		{
			return this.contextMenuMosOrganisationSERVICES_AND_TREATMENT_FUNCTIONSItem;
		}
		private MenuItem contextMenuMosOrganisationSERVICES_AND_TREATMENT_FUNCTIONSItem;
	}
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, "_cv_Admin.SelectedMos", "BO-1006100006-ID", "ID_MemberOfStaff");
			fields[145] = new ims.framework.ReportField(this.context, "_cv_Admin.SelectedMos", "BO-1006100006-INITIALS", "Initials");
			fields[146] = new ims.framework.ReportField(this.context, "_cv_Admin.SelectedMos", "BO-1006100006-SIGNATUREBLOCK", "SignatureBlock");
			fields[147] = new ims.framework.ReportField(this.context, "_cv_Admin.SelectedMos", "BO-1006100006-STAFFTYPE", "StaffType");
			fields[148] = new ims.framework.ReportField(this.context, "_cv_Admin.SelectedMos", "BO-1006100006-ISACTIVE", "IsActive");
			fields[149] = new ims.framework.ReportField(this.context, "_cv_Admin.SelectedMos", "BO-1006100006-SDSROLEID", "SdsRoleId");
			fields[150] = new ims.framework.ReportField(this.context, "_cv_Admin.SelectedMos", "BO-1006100006-CANREFERPATIENT", "CanReferPatient");
			fields[151] = new ims.framework.ReportField(this.context, "_cv_Admin.NursingHcp", "BO-1006100000-ID", "ID_Hcp");
			fields[152] = new ims.framework.ReportField(this.context, "_cv_Admin.NursingHcp", "BO-1006100000-HCPTYPE", "HcpType");
			fields[153] = new ims.framework.ReportField(this.context, "_cv_Admin.NursingHcp", "BO-1006100000-ISACTIVE", "IsActive");
			fields[154] = new ims.framework.ReportField(this.context, "_cv_Admin.NursingHcp", "BO-1006100000-ISHCPARESPONSIBLEHCP", "IsHCPaResponsibleHCP");
			fields[155] = new ims.framework.ReportField(this.context, "_cv_Admin.NursingHcp", "BO-1006100000-ISALOCALCONSULTANT", "IsALocalConsultant");
			fields[156] = new ims.framework.ReportField(this.context, "_cv_Admin.NursingHcp", "BO-1006100000-ISARESPONSIBLEEDCLINICIAN", "IsAResponsibleEDClinician");
			fields[157] = new ims.framework.ReportField(this.context, "_cv_Admin.NursingHcp", "BO-1006100000-ISHCPAENDOSCOPIST", "IsHCPaEndoscopist");
			fields[158] = new ims.framework.ReportField(this.context, "_cv_Admin.NursingHcp", "BO-1006100007-NURSETYPE", "NurseType");
			fields[159] = new ims.framework.ReportField(this.context, "_cv_Admin.NursingHcp", "BO-1006100007-SPECIALTY", "Specialty");
			fields[160] = new ims.framework.ReportField(this.context, "_cv_Admin.MedicHcp", "BO-1006100000-ID", "ID_Hcp");
			fields[161] = new ims.framework.ReportField(this.context, "_cv_Admin.MedicHcp", "BO-1006100000-HCPTYPE", "HcpType");
			fields[162] = new ims.framework.ReportField(this.context, "_cv_Admin.MedicHcp", "BO-1006100000-ISACTIVE", "IsActive");
			fields[163] = new ims.framework.ReportField(this.context, "_cv_Admin.MedicHcp", "BO-1006100000-ISHCPARESPONSIBLEHCP", "IsHCPaResponsibleHCP");
			fields[164] = new ims.framework.ReportField(this.context, "_cv_Admin.MedicHcp", "BO-1006100000-ISALOCALCONSULTANT", "IsALocalConsultant");
			fields[165] = new ims.framework.ReportField(this.context, "_cv_Admin.MedicHcp", "BO-1006100000-ISARESPONSIBLEEDCLINICIAN", "IsAResponsibleEDClinician");
			fields[166] = new ims.framework.ReportField(this.context, "_cv_Admin.MedicHcp", "BO-1006100000-ISHCPAENDOSCOPIST", "IsHCPaEndoscopist");
			fields[167] = new ims.framework.ReportField(this.context, "_cv_Admin.MedicHcp", "BO-1006100004-MEDICTYPE", "MedicType");
			fields[168] = new ims.framework.ReportField(this.context, "_cv_Admin.MedicHcp", "BO-1006100004-GRADE", "Grade");
			fields[169] = new ims.framework.ReportField(this.context, "_cv_Admin.MedicHcp", "BO-1006100004-SPECIALTY", "Specialty");
			fields[170] = new ims.framework.ReportField(this.context, "_cv_Admin.MedicHcp", "BO-1006100004-SECONDSPECIALTY", "SecondSpecialty");
			fields[171] = new ims.framework.ReportField(this.context, "_cv_Admin.MedicHcp", "BO-1006100004-THIRDSPECIALTY", "ThirdSpecialty");
			fields[172] = new ims.framework.ReportField(this.context, "_cv_Admin.MedicHcp", "BO-1006100004-INPATIENTHANDLING", "InpatientHandling");
			fields[173] = new ims.framework.ReportField(this.context, "_cv_Admin.TherapistHcp", "BO-1006100000-ID", "ID_Hcp");
			fields[174] = new ims.framework.ReportField(this.context, "_cv_Admin.TherapistHcp", "BO-1006100000-HCPTYPE", "HcpType");
			fields[175] = new ims.framework.ReportField(this.context, "_cv_Admin.TherapistHcp", "BO-1006100000-ISACTIVE", "IsActive");
			fields[176] = new ims.framework.ReportField(this.context, "_cv_Admin.TherapistHcp", "BO-1006100000-ISHCPARESPONSIBLEHCP", "IsHCPaResponsibleHCP");
			fields[177] = new ims.framework.ReportField(this.context, "_cv_Admin.TherapistHcp", "BO-1006100000-ISALOCALCONSULTANT", "IsALocalConsultant");
			fields[178] = new ims.framework.ReportField(this.context, "_cv_Admin.TherapistHcp", "BO-1006100000-ISARESPONSIBLEEDCLINICIAN", "IsAResponsibleEDClinician");
			fields[179] = new ims.framework.ReportField(this.context, "_cv_Admin.TherapistHcp", "BO-1006100000-ISHCPAENDOSCOPIST", "IsHCPaEndoscopist");
			fields[180] = new ims.framework.ReportField(this.context, "_cv_Admin.TherapistHcp", "BO-1006100005-THERAPISTTYPE", "TherapistType");
			fields[181] = new ims.framework.ReportField(this.context, "_cv_Admin.TherapistHcp", "BO-1006100005-SPECIALTY", "Specialty");
			fields[182] = new ims.framework.ReportField(this.context, "_cv_Hcp", "BO-1006100000-ID", "ID_Hcp");
			fields[183] = new ims.framework.ReportField(this.context, "_cv_Hcp", "BO-1006100000-HCPTYPE", "HcpType");
			fields[184] = new ims.framework.ReportField(this.context, "_cv_Hcp", "BO-1006100000-ISACTIVE", "IsActive");
			fields[185] = new ims.framework.ReportField(this.context, "_cv_Hcp", "BO-1006100000-ISHCPARESPONSIBLEHCP", "IsHCPaResponsibleHCP");
			fields[186] = new ims.framework.ReportField(this.context, "_cv_Hcp", "BO-1006100000-ISALOCALCONSULTANT", "IsALocalConsultant");
			fields[187] = new ims.framework.ReportField(this.context, "_cv_Hcp", "BO-1006100000-ISARESPONSIBLEEDCLINICIAN", "IsAResponsibleEDClinician");
			fields[188] = new ims.framework.ReportField(this.context, "_cv_Hcp", "BO-1006100000-ISHCPAENDOSCOPIST", "IsHCPaEndoscopist");
			fields[189] = new ims.framework.ReportField(this.context, "_cv_MosFullName", "BO-1002100001-ID", "ID_PersonName");
			fields[190] = new ims.framework.ReportField(this.context, "_cv_MosFullName", "BO-1002100001-NAMETYPE", "NameType");
			fields[191] = new ims.framework.ReportField(this.context, "_cv_MosFullName", "BO-1002100001-SURNAME", "Surname");
			fields[192] = new ims.framework.ReportField(this.context, "_cv_MosFullName", "BO-1002100001-FORENAME", "Forename");
			fields[193] = new ims.framework.ReportField(this.context, "_cv_MosFullName", "BO-1002100001-MIDDLENAME", "MiddleName");
			fields[194] = new ims.framework.ReportField(this.context, "_cv_MosFullName", "BO-1002100001-TITLE", "Title");
			fields[195] = new ims.framework.ReportField(this.context, "_cv_MosFullName", "BO-1002100001-UPPERSURNAME", "UpperSurname");
			fields[196] = new ims.framework.ReportField(this.context, "_cv_MosFullName", "BO-1002100001-UPPERFORENAME", "UpperForename");
			fields[197] = new ims.framework.ReportField(this.context, "_cv_MosFullName", "BO-1002100001-NAMESUFFIX", "Namesuffix");
			fields[198] = new ims.framework.ReportField(this.context, "_cv_MosFullName", "BO-1002100001-OBJECTIDENTIFIER", "Objectidentifier");
			fields[199] = new ims.framework.ReportField(this.context, "_cv_MosFullName", "BO-1002100001-BEFFDATE", "Beffdate");
			fields[200] = new ims.framework.ReportField(this.context, "_cv_MosFullName", "BO-1002100001-BEFFDATECNF", "Beffdatecnf");
			fields[201] = new ims.framework.ReportField(this.context, "_cv_MosFullName", "BO-1002100001-BETDATE", "Betdate");
			fields[202] = new ims.framework.ReportField(this.context, "_cv_MosFullName", "BO-1002100001-BETDATECNF", "Betdatecnf");
			fields[203] = new ims.framework.ReportField(this.context, "_cv_MosFullName", "BO-1002100001-PDSUPDATEMODE", "PdsUpdateMode");
			fields[204] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.MosAdmin.__internal_x_context__Hcp_" + componentIdentifier, "BO-1006100000-ID", "ID_Hcp");
			fields[205] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.MosAdmin.__internal_x_context__Hcp_" + componentIdentifier, "BO-1006100000-HCPTYPE", "HcpType");
			fields[206] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.MosAdmin.__internal_x_context__Hcp_" + componentIdentifier, "BO-1006100000-ISACTIVE", "IsActive");
			fields[207] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.MosAdmin.__internal_x_context__Hcp_" + componentIdentifier, "BO-1006100000-ISHCPARESPONSIBLEHCP", "IsHCPaResponsibleHCP");
			fields[208] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.MosAdmin.__internal_x_context__Hcp_" + componentIdentifier, "BO-1006100000-ISALOCALCONSULTANT", "IsALocalConsultant");
			fields[209] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.MosAdmin.__internal_x_context__Hcp_" + componentIdentifier, "BO-1006100000-ISARESPONSIBLEEDCLINICIAN", "IsAResponsibleEDClinician");
			fields[210] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.MosAdmin.__internal_x_context__Hcp_" + componentIdentifier, "BO-1006100000-ISHCPAENDOSCOPIST", "IsHCPaEndoscopist");
			return fields;
		}
