...
public class Logic extends BaseLogic
{
	...
	public static final Integer Update_PDS_Patient_Using_BookingAppointment_IMSID = new Integer(16);	//wdev-20542
	public static final Integer Update_PDS_Patient_Using_TCI_IMSID = new Integer(17);					//wdev-20542
	...
	{	
		switch (menuItemID)
		{
			case GenForm.ContextMenus.AdminNamespace.SystemJob.New:
				...
				//wdev-20542
				if( form.getGlobalContext().Admin.getSystemJob().getImsId().equals(Update_PDS_Patient_Using_BookingAppointment_IMSID) || form.getGlobalContext().Admin.getSystemJob().getImsId().equals(Update_PDS_Patient_Using_TCI_IMSID))
				{
					try
					{
						SamlParser tempHelper = new SamlParser();
						
						tempHelper = tempHelper.loadFileContent(engine.getSAMLXmlContent());
						String valForField = tempHelper.getValueForField(tempHelper.NHSJOBROLECODE);
						
						String rolecode = null;
						if( engine.getLoggedInRole() != null )
							rolecode = domain.getRoleCodeFromAppRoleSpineRbac(engine.getLoggedInRole().getId());
						
						if( valForField != null && rolecode != null && rolecode.equals(valForField))
						{
							//TO DO STEP 4 
						...
						{
							engine.showMessage("Current MAXIMS login does not correspond to the Smart Card, please login again.");
						}
