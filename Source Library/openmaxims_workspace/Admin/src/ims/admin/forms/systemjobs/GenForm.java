...
public class GenForm extends FormBridge
{
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[163] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.SystemJobs.__internal_x_context__SelectedConfiguredJob_" + componentIdentifier, "BO-1028100057-ID", "ID_ConfiguredJob");
			fields[164] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.SystemJobs.__internal_x_context__SelectedConfiguredJob_" + componentIdentifier, "BO-1028100057-STARTDATETIME", "StartDateTime");
			fields[165] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.SystemJobs.__internal_x_context__SelectedConfiguredJob_" + componentIdentifier, "BO-1028100057-ENDDATETIME", "EndDateTime");
			fields[166] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.SystemJobs.__internal_x_context__SelectedConfiguredJob_" + componentIdentifier, "BO-1028100057-ISCRONTRIGGER", "IsCronTrigger");
			fields[167] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.SystemJobs.__internal_x_context__SelectedConfiguredJob_" + componentIdentifier, "BO-1028100057-CRONEXPRESSION", "CronExpression");
			fields[168] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.SystemJobs.__internal_x_context__SelectedConfiguredJob_" + componentIdentifier, "BO-1028100057-LASTRUN", "LastRun");
			fields[169] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.SystemJobs.__internal_x_context__SelectedConfiguredJob_" + componentIdentifier, "BO-1028100057-NEXTRUN", "NextRun");
			fields[170] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.SystemJobs.__internal_x_context__SelectedConfiguredJob_" + componentIdentifier, "BO-1028100057-CRONEXPRESSIONDISPLAY", "CronExpressionDisplay");
			fields[171] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.SystemJobs.__internal_x_context__SelectedConfiguredJob_" + componentIdentifier, "BO-1028100057-ISACTIVE", "IsActive");
			fields[172] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.SystemJobs.__internal_x_context__SelectedConfiguredJob_" + componentIdentifier, "BO-1028100057-DESCRIPTION", "Description");
			fields[173] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.SystemJobs.__internal_x_context__SelectedConfiguredJob_" + componentIdentifier, "BO-1028100057-FREQUENCY", "Frequency");
			fields[174] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.SystemJobs.__internal_x_context__SelectedConfiguredJob_" + componentIdentifier, "BO-1028100057-NAME", "Name");
			fields[175] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.SystemJobs.__internal_x_context__SelectedSystemJob_" + componentIdentifier, "BO-1028100056-ID", "ID_SystemJob");
			fields[176] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.SystemJobs.__internal_x_context__SelectedSystemJob_" + componentIdentifier, "BO-1028100056-NAME", "Name");
			fields[177] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.SystemJobs.__internal_x_context__SelectedSystemJob_" + componentIdentifier, "BO-1028100056-DESCRIPTION", "Description");
			fields[178] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.SystemJobs.__internal_x_context__SelectedSystemJob_" + componentIdentifier, "BO-1028100056-IMPLNAME", "ImplName");
			fields[179] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.SystemJobs.__internal_x_context__SelectedSystemJob_" + componentIdentifier, "BO-1028100056-ISACTIVE", "IsActive");
			fields[180] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.SystemJobs.__internal_x_context__SelectedSystemJob_" + componentIdentifier, "BO-1028100056-IMSID", "ImsId");
			fields[181] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.SystemJobs.__internal_x_context__SelectedSystemJob_" + componentIdentifier, "BO-1028100056-CONFIGFORMID", "ConfigFormId");
			return fields;
		}
