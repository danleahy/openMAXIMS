...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "DemographicsComunicationChannelsConfigDialog";
	}
	public int getWidth()
	{
		return 480;
	...
	{
		return new String[] { "_cv_Core.DemographicControlsConfigVo" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Admin.DemographicsComunicationChannelsConfigDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
