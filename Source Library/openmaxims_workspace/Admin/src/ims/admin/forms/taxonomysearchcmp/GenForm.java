...
public class GenForm extends FormBridge
{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1002), new Integer(anchoringHelper3.getX()), new Integer(anchoringHelper3.getY()), new Integer(anchoringHelper3.getWidth()), new Integer(anchoringHelper3.getHeight()), new Integer(startTabIndex.intValue() + 3), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT, "Search", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.TaxonomySearchCmp.__internal_x_context__value_" + componentIdentifier, "BO-1003100010-ID", "ID_TaxonomyMap");
			fields[145] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.TaxonomySearchCmp.__internal_x_context__value_" + componentIdentifier, "BO-1003100010-TAXONOMYNAME", "TaxonomyName");
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.TaxonomySearchCmp.__internal_x_context__value_" + componentIdentifier, "BO-1003100010-TAXONOMYCODE", "TaxonomyCode");
			return fields;
		}
