...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "_lv_Admin.ServiceConfiguration.__internal_x_context__" + String.valueOf(getFormId());
	}
	public ims.framework.FormInfo[] getComponentsFormInfo()
	{
		...
		componentsInfo[2] = new ims.admin.forms.hcpservicefunctioncomponent.FormInfo(103264);
