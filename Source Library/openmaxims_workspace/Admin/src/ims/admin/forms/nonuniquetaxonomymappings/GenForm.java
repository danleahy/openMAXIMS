...
public class GenForm extends FormBridge
{
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.NonUniqueTaxonomyMappings.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1003100071-ID", "ID_NonUniqueTaxonomyMap");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.NonUniqueTaxonomyMappings.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1003100071-TAXONOMYNAME", "TaxonomyName");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.NonUniqueTaxonomyMappings.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1003100071-TAXONOMYCODE", "TaxonomyCode");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.NonUniqueTaxonomyMappings.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1003100071-EFFECTIVEFROM", "EffectiveFrom");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.NonUniqueTaxonomyMappings.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1003100071-EFFECTIVETO", "EffectiveTo");
			return fields;
		}
