...
public class GenForm extends FormBridge
{
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.ProviderSystemAdmin.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1061100004-ID", "ID_ProviderSystem");
			fields[145] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.ProviderSystemAdmin.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1061100004-SYSTEMNAME", "SystemName");
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.ProviderSystemAdmin.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1061100004-DESCRIPTION", "Description");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.ProviderSystemAdmin.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1061100004-IPADDRESS", "IPAddress");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.ProviderSystemAdmin.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1061100004-IPPORT", "IPPort");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.ProviderSystemAdmin.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1061100004-HL7APPLICATION", "Hl7Application");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.ProviderSystemAdmin.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1061100004-CODESYSTEM", "CodeSystem");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.ProviderSystemAdmin.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1061100004-IDTYPECOMPONENT", "IdtypeComponent");
			fields[152] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.ProviderSystemAdmin.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1061100004-PRIMARYPATIENTID", "PrimaryPatientId");
			fields[153] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.ProviderSystemAdmin.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1061100004-CATEGORY", "Category");
			fields[154] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.ProviderSystemAdmin.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1061100004-SENDREFERRALLETTER", "SendReferralLetter");
			fields[155] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.ProviderSystemAdmin.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1061100004-SENDQUESTIONNAIRE", "SendQuestionnaire");
			return fields;
		}
