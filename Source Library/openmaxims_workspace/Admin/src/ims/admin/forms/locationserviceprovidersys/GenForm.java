...
public class GenForm extends FormBridge
{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1018), new Integer(anchoringHelper19.getX()), new Integer(anchoringHelper19.getY()), new Integer(anchoringHelper19.getWidth()), new Integer(anchoringHelper19.getHeight()), new Integer(startTabIndex.intValue() + 10), ControlState.HIDDEN, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT,Boolean.FALSE, new Integer(0), Boolean.TRUE, Boolean.FALSE, null, "Please enter the Provider System Name", Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
		...
		super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1019), new Integer(anchoringHelper20.getX()), new Integer(anchoringHelper20.getY()), new Integer(anchoringHelper20.getWidth()), new Integer(anchoringHelper20.getHeight()), new Integer(startTabIndex.intValue() + 3), ControlState.HIDDEN, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT,Boolean.TRUE, new Integer(500), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
		...
		ComboBox m_cmbIdTypeTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1022), new Integer(anchoringHelper23.getX()), new Integer(anchoringHelper23.getY()), new Integer(anchoringHelper23.getWidth()), new Integer(anchoringHelper23.getHeight()), new Integer(startTabIndex.intValue() + 7), ControlState.HIDDEN, ControlState.DISABLED,ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
		...
		ComboBox m_cmbIdCompTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1023), new Integer(anchoringHelper24.getX()), new Integer(anchoringHelper24.getY()), new Integer(anchoringHelper24.getWidth()), new Integer(anchoringHelper24.getHeight()), new Integer(startTabIndex.intValue() + 6), ControlState.HIDDEN, ControlState.DISABLED,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), "Defines which component (4 or 5) of CX in PID.3 is used for Id type code", Boolean.FALSE, new Integer(-1)});
		...
		ComboBox m_cmbCodeTypeTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1024), new Integer(anchoringHelper25.getX()), new Integer(anchoringHelper25.getY()), new Integer(anchoringHelper25.getWidth()), new Integer(anchoringHelper25.getHeight()), new Integer(startTabIndex.intValue() + 5), ControlState.HIDDEN, ControlState.DISABLED,ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.TRUE, new Integer(-1)});
		...
		super.addControl(factory.getControl(IntBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1027), new Integer(anchoringHelper28.getX()), new Integer(anchoringHelper28.getY()), new Integer(anchoringHelper28.getWidth()), new Integer(anchoringHelper28.getHeight()), new Integer(startTabIndex.intValue() + 4), ControlState.HIDDEN, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.FALSE, Boolean.FALSE, Boolean.FALSE, null, null, Boolean.TRUE, new Integer(9)}));
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, "_cv_OCRR.ProviderSystem", "BO-1061100004-ID", "ID_ProviderSystem");
			fields[145] = new ims.framework.ReportField(this.context, "_cv_OCRR.ProviderSystem", "BO-1061100004-SYSTEMNAME", "SystemName");
			fields[146] = new ims.framework.ReportField(this.context, "_cv_OCRR.ProviderSystem", "BO-1061100004-DESCRIPTION", "Description");
			fields[147] = new ims.framework.ReportField(this.context, "_cv_OCRR.ProviderSystem", "BO-1061100004-IPADDRESS", "IPAddress");
			fields[148] = new ims.framework.ReportField(this.context, "_cv_OCRR.ProviderSystem", "BO-1061100004-IPPORT", "IPPort");
			fields[149] = new ims.framework.ReportField(this.context, "_cv_OCRR.ProviderSystem", "BO-1061100004-HL7APPLICATION", "Hl7Application");
			fields[150] = new ims.framework.ReportField(this.context, "_cv_OCRR.ProviderSystem", "BO-1061100004-CODESYSTEM", "CodeSystem");
			fields[151] = new ims.framework.ReportField(this.context, "_cv_OCRR.ProviderSystem", "BO-1061100004-IDTYPECOMPONENT", "IdtypeComponent");
			fields[152] = new ims.framework.ReportField(this.context, "_cv_OCRR.ProviderSystem", "BO-1061100004-PRIMARYPATIENTID", "PrimaryPatientId");
			fields[153] = new ims.framework.ReportField(this.context, "_cv_OCRR.ProviderSystem", "BO-1061100004-CATEGORY", "Category");
			fields[154] = new ims.framework.ReportField(this.context, "_cv_OCRR.ProviderSystem", "BO-1061100004-SENDREFERRALLETTER", "SendReferralLetter");
			fields[155] = new ims.framework.ReportField(this.context, "_cv_OCRR.ProviderSystem", "BO-1061100004-SENDQUESTIONNAIRE", "SendQuestionnaire");
			fields[156] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.LocationServiceProviderSys.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1061100013-ID", "ID_LocSvcProviderSys");
			fields[157] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.LocationServiceProviderSys.__internal_x_context__SelectedRecordProviderSystem_" + componentIdentifier, "BO-1061100004-ID", "ID_ProviderSystem");
			fields[158] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.LocationServiceProviderSys.__internal_x_context__SelectedRecordProviderSystem_" + componentIdentifier, "BO-1061100004-SYSTEMNAME", "SystemName");
			fields[159] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.LocationServiceProviderSys.__internal_x_context__SelectedRecordProviderSystem_" + componentIdentifier, "BO-1061100004-DESCRIPTION", "Description");
			fields[160] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.LocationServiceProviderSys.__internal_x_context__SelectedRecordProviderSystem_" + componentIdentifier, "BO-1061100004-IPADDRESS", "IPAddress");
			fields[161] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.LocationServiceProviderSys.__internal_x_context__SelectedRecordProviderSystem_" + componentIdentifier, "BO-1061100004-IPPORT", "IPPort");
			fields[162] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.LocationServiceProviderSys.__internal_x_context__SelectedRecordProviderSystem_" + componentIdentifier, "BO-1061100004-HL7APPLICATION", "Hl7Application");
			fields[163] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.LocationServiceProviderSys.__internal_x_context__SelectedRecordProviderSystem_" + componentIdentifier, "BO-1061100004-CODESYSTEM", "CodeSystem");
			fields[164] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.LocationServiceProviderSys.__internal_x_context__SelectedRecordProviderSystem_" + componentIdentifier, "BO-1061100004-IDTYPECOMPONENT", "IdtypeComponent");
			fields[165] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.LocationServiceProviderSys.__internal_x_context__SelectedRecordProviderSystem_" + componentIdentifier, "BO-1061100004-PRIMARYPATIENTID", "PrimaryPatientId");
			fields[166] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.LocationServiceProviderSys.__internal_x_context__SelectedRecordProviderSystem_" + componentIdentifier, "BO-1061100004-CATEGORY", "Category");
			fields[167] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.LocationServiceProviderSys.__internal_x_context__SelectedRecordProviderSystem_" + componentIdentifier, "BO-1061100004-SENDREFERRALLETTER", "SendReferralLetter");
			fields[168] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.LocationServiceProviderSys.__internal_x_context__SelectedRecordProviderSystem_" + componentIdentifier, "BO-1061100004-SENDQUESTIONNAIRE", "SendQuestionnaire");
			return fields;
		}
