...
public class GenForm extends FormBridge
{
	...
	public static class lyr1Layer extends Layer
	{
		...
		public static class tabOrgContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1008), new Integer(anchoringHelper9.getX()), new Integer(anchoringHelper9.getY()), new Integer(anchoringHelper9.getWidth()), new Integer(anchoringHelper9.getHeight()), new Integer(startTabIndex.intValue() + 15), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.FALSE, new Integer(30), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
				...
				super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1015), new Integer(anchoringHelper16.getX()), new Integer(anchoringHelper16.getY()), new Integer(anchoringHelper16.getWidth()), new Integer(anchoringHelper16.getHeight()), new Integer(startTabIndex.intValue() + 14), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.FALSE, new Integer(30), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
				...
				super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1016), new Integer(anchoringHelper17.getX()), new Integer(anchoringHelper17.getY()), new Integer(anchoringHelper17.getWidth()), new Integer(anchoringHelper17.getHeight()), new Integer(startTabIndex.intValue() + 17), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.TRUE, new Integer(255), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		contextMenus.contextMenuSupplierTreeMenuADDSUPPLIERItem = factory.createMenuItem(startControlID.intValue() + 12, "Add", true, false, new Integer(102149), true, false);
		contextMenus.contextMenuSupplierTreeMenu.add(contextMenus.contextMenuSupplierTreeMenuADDSUPPLIERItem);
		contextMenus.contextMenuSupplierTreeMenuEDITSUPPLIERItem = factory.createMenuItem(startControlID.intValue() + 13, "Edit", true, false, new Integer(102150), true, false);
		contextMenus.contextMenuSupplierTreeMenu.add(contextMenus.contextMenuSupplierTreeMenuEDITSUPPLIERItem);
		contextMenus.contextMenuSupplierTreeMenuREMOVESUPPLIERItem = factory.createMenuItem(startControlID.intValue() + 14, "Remove", true, false, new Integer(102180), true, false);
		contextMenus.contextMenuSupplierTreeMenu.add(contextMenus.contextMenuSupplierTreeMenuREMOVESUPPLIERItem);
		contextMenus.contextMenuSupplierTreeMenuRESTORESUPPLIERItem = factory.createMenuItem(startControlID.intValue() + 15, "Restore", true, false, new Integer(103155), true, false);
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1023), new Integer(anchoringHelper24.getX()), new Integer(anchoringHelper24.getY()), new Integer(anchoringHelper24.getWidth()), new Integer(anchoringHelper24.getHeight()), new Integer(startTabIndex.intValue() + 18), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Save", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1024), new Integer(anchoringHelper25.getX()), new Integer(anchoringHelper25.getY()), new Integer(anchoringHelper25.getWidth()), new Integer(anchoringHelper25.getHeight()), new Integer(startTabIndex.intValue() + 19), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Cancel", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(TreeView.class, new Object[] { control, new Integer(startControlID.intValue() + 1027), new Integer(anchoringHelper28.getX()), new Integer(anchoringHelper28.getY()), new Integer(anchoringHelper28.getWidth()), new Integer(anchoringHelper28.getHeight()), new Integer(startTabIndex.intValue() + 5), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL,Boolean.TRUE, Boolean.FALSE, Boolean.FALSE, contextMenus.contextMenuSupplierTreeMenu, Boolean.FALSE, Boolean.FALSE, Boolean.FALSE, Boolean.FALSE, Boolean.TRUE}));
	}
	...
	public final class ContextMenus implements java.io.Serializable
	{
		...
		{
			private static final long serialVersionUID = 1L;
			public static final int ADDSUPPLIER = 12;
			public static final int EDITSUPPLIER = 13;
			public static final int REMOVESUPPLIER = 14;
			public static final int RESTORESUPPLIER = 15;
		}
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, "_cv_Admin.OrganisationVo", "BO-1007100003-ID", "ID_Organisation");
			fields[145] = new ims.framework.ReportField(this.context, "_cv_Admin.OrganisationVo", "BO-1007100003-NAME", "Name");
			fields[146] = new ims.framework.ReportField(this.context, "_cv_Admin.OrganisationVo", "BO-1007100003-TYPE", "Type");
			fields[147] = new ims.framework.ReportField(this.context, "_cv_Admin.OrganisationVo", "BO-1007100003-ISACTIVE", "IsActive");
			fields[148] = new ims.framework.ReportField(this.context, "_cv_Admin.OrganisationVo", "BO-1007100003-COMMENT", "Comment");
			fields[149] = new ims.framework.ReportField(this.context, "_cv_Admin.OrganisationVo", "BO-1007100003-PCTCODE", "PctCode");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.Supplier.__internal_x_context__Supplier_" + componentIdentifier, "BO-1007100003-ID", "ID_Organisation");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.Supplier.__internal_x_context__Supplier_" + componentIdentifier, "BO-1007100003-NAME", "Name");
			fields[152] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.Supplier.__internal_x_context__Supplier_" + componentIdentifier, "BO-1007100003-TYPE", "Type");
			fields[153] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.Supplier.__internal_x_context__Supplier_" + componentIdentifier, "BO-1007100003-ISACTIVE", "IsActive");
			fields[154] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.Supplier.__internal_x_context__Supplier_" + componentIdentifier, "BO-1007100003-COMMENT", "Comment");
			return fields;
		}
