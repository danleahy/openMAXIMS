...
public class GenForm extends FormBridge
{
			...
			public static class lyrLocationDetailLayer extends Layer
			{
				...
				public static class tabPageFunctionContainer extends LayerBridge
				{
					...
					protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
					{
						...
						Grid m_grdServiceFunctionTemp = (Grid)factory.getControl(Grid.class, new Object[] { control, new Integer(startControlID.intValue() + 1014), new Integer(anchoringHelper15.getX()), new Integer(anchoringHelper15.getY()), new Integer(anchoringHelper15.getWidth()), new Integer(anchoringHelper15.getHeight()), new Integer(startTabIndex.intValue() + 11), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL,Boolean.TRUE, Boolean.FALSE, new Integer(24), Boolean.TRUE, null, Boolean.FALSE, Boolean.FALSE, new Integer(0), null, Boolean.FALSE, Boolean.TRUE});
						...
						grdServiceFunction.addIntColumn("servicefunctionId", 0, 0, 0, true, true, null, false, 0, true, 0);
				...
				public static class tabPageActivityContainer extends LayerBridge
				{
					...
					protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
					{
						...
						Grid m_grdActivityTemp = (Grid)factory.getControl(Grid.class, new Object[] { control, new Integer(startControlID.intValue() + 1015), new Integer(anchoringHelper16.getX()), new Integer(anchoringHelper16.getY()), new Integer(anchoringHelper16.getWidth()), new Integer(anchoringHelper16.getHeight()), new Integer(startTabIndex.intValue() + 13), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL,Boolean.TRUE, Boolean.FALSE, new Integer(24), Boolean.TRUE, null, Boolean.FALSE, Boolean.FALSE, new Integer(0), null, Boolean.FALSE, Boolean.TRUE});
						...
						grdActivity.addIntColumn("serviceActivityId", 0, 0, 0, true, true, null, false, 0, true, 0);
				...
				public static class tabPagePricingContainer extends LayerBridge
				{
					...
					protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
					{
						...
						super.addControl(factory.getControl(CheckBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1016), new Integer(anchoringHelper17.getX()), new Integer(anchoringHelper17.getY()), new Integer(anchoringHelper17.getWidth()), new Integer(anchoringHelper17.getHeight()), new Integer(startTabIndex.intValue() + 14), ControlState.HIDDEN, ControlState.ENABLED,ims.framework.enumerations.ControlAnchoring.TOPRIGHT ,"Active Pricing Contexts only", Boolean.TRUE, null}));
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1033), new Integer(anchoringHelper34.getX()), new Integer(anchoringHelper34.getY()), new Integer(anchoringHelper34.getWidth()), new Integer(anchoringHelper34.getHeight()), new Integer(startTabIndex.intValue() + 17), ControlState.HIDDEN, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Cancel", Boolean.FALSE, null, Boolean.FALSE, Boolean.FALSE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, "_cv_Admin.SelectedLocShortVo", "BO-1007100007-ID", "ID_Location");
			fields[145] = new ims.framework.ReportField(this.context, "_cv_Admin.SelectedLocShortVo", "BO-1007100007-NAME", "Name");
			fields[146] = new ims.framework.ReportField(this.context, "_cv_Admin.SelectedLocShortVo", "BO-1007100007-ISACTIVE", "IsActive");
			fields[147] = new ims.framework.ReportField(this.context, "_cv_Admin.SelectedLocShortVo", "BO-1007100007-ISVIRTUAL", "IsVirtual");
			fields[148] = new ims.framework.ReportField(this.context, "_cv_Admin.SelectedLocShortVo", "BO-1007100007-TYPE", "Type");
			fields[149] = new ims.framework.ReportField(this.context, "_cv_Admin.SelectedLocShortVo", "BO-1007100007-DISPLAYINEDTRACKING", "DisplayInEDTracking");
			fields[150] = new ims.framework.ReportField(this.context, "_cv_Admin.SelectedLocShortVo", "BO-1007100007-CASENOTEFOLDERLOCATION", "CaseNoteFolderLocation");
			fields[151] = new ims.framework.ReportField(this.context, "_cv_Admin.SelectedLocShortVo", "BO-1007100007-SECUREACCOMMODATION", "SecureAccommodation");
			fields[152] = new ims.framework.ReportField(this.context, "_cv_Admin.SelectedLocShortVo", "BO-1007100007-TREATINGHOSP", "TreatingHosp");
			fields[153] = new ims.framework.ReportField(this.context, "_cv_Admin.SelectedLocShortVo", "BO-1007100007-REFERRINGHOSPITAL", "ReferringHospital");
			fields[154] = new ims.framework.ReportField(this.context, "_cv_Admin.ActivityContextPricingDetail", "BO-1007100004-ID", "ID_ActivityContextPricingDetails");
			fields[155] = new ims.framework.ReportField(this.context, "_cv_Admin.ActivityContextPricingDetail", "BO-1007100004-CONTEXT", "Context");
			fields[156] = new ims.framework.ReportField(this.context, "_cv_Admin.ActivityContextPricingDetail", "BO-1007100004-PRICE", "Price");
			fields[157] = new ims.framework.ReportField(this.context, "_cv_Admin.ActivityContextPricingDetail", "BO-1007100004-CURRENCY", "Currency");
			fields[158] = new ims.framework.ReportField(this.context, "_cv_Admin.ActivityContextPricingDetail", "BO-1007100004-NORMLENGTHSTAY", "NormLengthStay");
			fields[159] = new ims.framework.ReportField(this.context, "_cv_Admin.ActivityContextPricingDetail", "BO-1007100004-EFFECTIVEFROM", "EffectiveFrom");
			fields[160] = new ims.framework.ReportField(this.context, "_cv_Admin.ActivityContextPricingDetail", "BO-1007100004-EFFECTIVETO", "EffectiveTo");
			fields[161] = new ims.framework.ReportField(this.context, "_cv_Admin.ActivityContextPricingDetail", "BO-1007100004-ISACTIVE", "IsActive");
			fields[162] = new ims.framework.ReportField(this.context, "_cv_Admin.ActivityContextPricingDetail", "BO-1007100004-PRICECATEGORY", "PriceCategory");
			fields[163] = new ims.framework.ReportField(this.context, "_cv_Admin.ActivityContextPricingDetail", "BO-1007100004-ISPREACTIVE", "IsPreActive");
			fields[164] = new ims.framework.ReportField(this.context, "_cv_Admin.ActivityContextPricingDetail", "BO-1007100004-EFFECTIVETOSET", "EffectiveToSet");
			fields[165] = new ims.framework.ReportField(this.context, "_cv_Admin.ActivityContextPricingDetail", "BO-1007100004-EFFECTIVEFROMSET", "EffectiveFromSet");
			fields[166] = new ims.framework.ReportField(this.context, "_cv_Admin.ActivityContextPricingDetail", "BO-1007100004-ACTIVEPRICING", "ActivePricing");
			fields[167] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.LocationService.__internal_x_context__SelectedRecordOrganisation_" + componentIdentifier, "BO-1007100003-ID", "ID_Organisation");
			fields[168] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.LocationService.__internal_x_context__SelectedRecordOrganisation_" + componentIdentifier, "BO-1007100003-NAME", "Name");
			fields[169] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.LocationService.__internal_x_context__SelectedRecordOrganisation_" + componentIdentifier, "BO-1007100003-TYPE", "Type");
			fields[170] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.LocationService.__internal_x_context__SelectedRecordOrganisation_" + componentIdentifier, "BO-1007100003-ISACTIVE", "IsActive");
			fields[171] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.LocationService.__internal_x_context__SelectedRecordOrganisation_" + componentIdentifier, "BO-1007100003-COMMENT", "Comment");
			fields[172] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.LocationService.__internal_x_context__SelectedRecordOrganisation_" + componentIdentifier, "BO-1007100003-PCTCODE", "PctCode");
			fields[173] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.LocationService.__internal_x_context__SelectedRecordLocation_" + componentIdentifier, "BO-1007100007-ID", "ID_Location");
			fields[174] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.LocationService.__internal_x_context__SelectedRecordLocation_" + componentIdentifier, "BO-1007100007-NAME", "Name");
			fields[175] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.LocationService.__internal_x_context__SelectedRecordLocation_" + componentIdentifier, "BO-1007100007-ISACTIVE", "IsActive");
			fields[176] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.LocationService.__internal_x_context__SelectedRecordLocation_" + componentIdentifier, "BO-1007100007-ISVIRTUAL", "IsVirtual");
			fields[177] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.LocationService.__internal_x_context__SelectedRecordLocation_" + componentIdentifier, "BO-1007100007-TYPE", "Type");
			fields[178] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.LocationService.__internal_x_context__SelectedRecordLocation_" + componentIdentifier, "BO-1007100007-DISPLAYINEDTRACKING", "DisplayInEDTracking");
			fields[179] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.LocationService.__internal_x_context__SelectedRecordLocation_" + componentIdentifier, "BO-1007100007-CASENOTEFOLDERLOCATION", "CaseNoteFolderLocation");
			fields[180] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.LocationService.__internal_x_context__SelectedRecordLocation_" + componentIdentifier, "BO-1007100007-SECUREACCOMMODATION", "SecureAccommodation");
			fields[181] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.LocationService.__internal_x_context__SelectedRecordLocation_" + componentIdentifier, "BO-1007100007-TREATINGHOSP", "TreatingHosp");
			fields[182] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.LocationService.__internal_x_context__SelectedRecordLocation_" + componentIdentifier, "BO-1007100007-REFERRINGHOSPITAL", "ReferringHospital");
			fields[183] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.LocationService.__internal_x_context__SelectedRecordLocationService_" + componentIdentifier, "BO-1007100000-ID", "ID_LocationService");
			fields[184] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.LocationService.__internal_x_context__SelectedRecordLocationService_" + componentIdentifier, "BO-1007100000-ISACTIVE", "IsActive");
			fields[185] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.LocationService.__internal_x_context__SelectedRecordLocationService_" + componentIdentifier, "BO-1007100000-EFFECTIVETO", "EffectiveTo");
			fields[186] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.LocationService.__internal_x_context__SelectedRecordLocationService_" + componentIdentifier, "BO-1007100000-DEFAULTPRINTER", "DefaultPrinter");
			fields[187] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.LocationService.__internal_x_context__SelectedRecordLocSerFunc_" + componentIdentifier, "BO-1007100006-ID", "ID_LocationServiceFunction");
			fields[188] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.LocationService.__internal_x_context__SelectedRecordLocSerFunc_" + componentIdentifier, "BO-1007100006-ISACTIVE", "IsActive");
			fields[189] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.LocationService.__internal_x_context__SelectedRecordLocSerAct_" + componentIdentifier, "BO-1007100001-ID", "ID_LocationServiceActivity");
			fields[190] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.LocationService.__internal_x_context__SelectedRecordLocSerAct_" + componentIdentifier, "BO-1007100001-ISACTIVE", "IsActive");
			fields[191] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.LocationService.__internal_x_context__SelectedLocationServiceActivity_" + componentIdentifier, "BO-1007100001-ID", "ID_LocationServiceActivity");
			fields[192] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.LocationService.__internal_x_context__SelectedLocationServiceActivity_" + componentIdentifier, "BO-1007100001-ISACTIVE", "IsActive");
			return fields;
		}
