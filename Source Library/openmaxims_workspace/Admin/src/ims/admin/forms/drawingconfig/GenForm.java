...
public class GenForm extends FormBridge
{
	...
	public static class lyrDrawingLayer extends Layer
	{
		...
		public static class tabImageSearchContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				super.addControl(factory.getControl(ImageButton.class, new Object[] { control, new Integer(startControlID.intValue() + 1003), new Integer(anchoringHelper7.getX()), new Integer(anchoringHelper7.getY()), new Integer(anchoringHelper7.getWidth()), new Integer(anchoringHelper7.getHeight()), new Integer(startTabIndex.intValue() + 7), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT, form_images_local.Core.ClearEnabled24, form_images_local.Core.ClearDisabled24, "Reset search criteria and results", Boolean.FALSE, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null}));
				...
				super.addControl(factory.getControl(ImageButton.class, new Object[] { control, new Integer(startControlID.intValue() + 1004), new Integer(anchoringHelper8.getX()), new Integer(anchoringHelper8.getY()), new Integer(anchoringHelper8.getWidth()), new Integer(anchoringHelper8.getHeight()), new Integer(startTabIndex.intValue() + 6), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT, form_images_local.Core.FindEnabled24, form_images_local.Core.FindDisabled24, "Search for Drawing Configurations matching 'Search Criteria'", Boolean.FALSE, Boolean.TRUE, Boolean.TRUE, Boolean.FALSE, null}));
		...
		public static class tabImageSelectContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1012), new Integer(anchoringHelper15.getX()), new Integer(anchoringHelper15.getY()), new Integer(anchoringHelper15.getWidth()), new Integer(anchoringHelper15.getHeight()), new Integer(startTabIndex.intValue() + 11), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT,Boolean.TRUE, new Integer(255), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
				...
				super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1013), new Integer(anchoringHelper16.getX()), new Integer(anchoringHelper16.getY()), new Integer(anchoringHelper16.getWidth()), new Integer(anchoringHelper16.getHeight()), new Integer(startTabIndex.intValue() + 10), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT,Boolean.FALSE, new Integer(70), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.TRUE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
				...
				super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1014), new Integer(anchoringHelper17.getX()), new Integer(anchoringHelper17.getY()), new Integer(anchoringHelper17.getWidth()), new Integer(anchoringHelper17.getHeight()), new Integer(startTabIndex.intValue() + 14), ControlState.DISABLED, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.TOPRIGHT,Boolean.FALSE, new Integer(0), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
				...
				ComboBox m_cmbImageStatusTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1015), new Integer(anchoringHelper18.getX()), new Integer(anchoringHelper18.getY()), new Integer(anchoringHelper18.getWidth()), new Integer(anchoringHelper18.getHeight()), new Integer(startTabIndex.intValue() + 13), ControlState.DISABLED, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPRIGHT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.TRUE, new Integer(-1)});
				...
				super.addControl(factory.getControl(IntBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1016), new Integer(anchoringHelper19.getX()), new Integer(anchoringHelper19.getY()), new Integer(anchoringHelper19.getWidth()), new Integer(anchoringHelper19.getHeight()), new Integer(startTabIndex.intValue() + 12), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT,Boolean.TRUE, Boolean.TRUE, Boolean.FALSE, null, null, Boolean.TRUE, new Integer(9)}));
				...
				super.addControl(factory.getControl(ImageButton.class, new Object[] { control, new Integer(startControlID.intValue() + 1017), new Integer(anchoringHelper20.getX()), new Integer(anchoringHelper20.getY()), new Integer(anchoringHelper20.getWidth()), new Integer(anchoringHelper20.getHeight()), new Integer(startTabIndex.intValue() + 15), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT, form_images_local.Admin.ImageEnabled24, form_images_local.Admin.ImageDisabled24, "Select Image", Boolean.FALSE, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null}));
		...
		public static class tabRegionConfigContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				super.addControl(factory.getControl(DrawingControlConfigurator.class, new Object[] { control, new Integer(startControlID.intValue() + 1019), new Integer(anchoringHelper22.getX()), new Integer(anchoringHelper22.getY()), new Integer(anchoringHelper22.getWidth()), new Integer(anchoringHelper22.getHeight()), new Integer(startTabIndex.intValue() + 16), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL}));
			}
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1023), new Integer(anchoringHelper26.getX()), new Integer(anchoringHelper26.getY()), new Integer(anchoringHelper26.getWidth()), new Integer(anchoringHelper26.getHeight()), new Integer(startTabIndex.intValue() + 19), ControlState.HIDDEN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Select", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1024), new Integer(anchoringHelper27.getX()), new Integer(anchoringHelper27.getY()), new Integer(anchoringHelper27.getWidth()), new Integer(anchoringHelper27.getHeight()), new Integer(startTabIndex.intValue() + 17), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Edit", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1025), new Integer(anchoringHelper28.getX()), new Integer(anchoringHelper28.getY()), new Integer(anchoringHelper28.getWidth()), new Integer(anchoringHelper28.getHeight()), new Integer(startTabIndex.intValue() + 20), ControlState.HIDDEN, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Cancel", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1026), new Integer(anchoringHelper29.getX()), new Integer(anchoringHelper29.getY()), new Integer(anchoringHelper29.getWidth()), new Integer(anchoringHelper29.getHeight()), new Integer(startTabIndex.intValue() + 18), ControlState.HIDDEN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Save", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, "_cv_Admin.DrawingGraphicImageShortVo", "BO-1028100007-ID", "ID_DrawingGraphicImage");
			fields[145] = new ims.framework.ReportField(this.context, "_cv_Admin.DrawingGraphicImageShortVo", "BO-1028100007-IMAGENAME", "ImageName");
			fields[146] = new ims.framework.ReportField(this.context, "_cv_Admin.DrawingGraphicImageShortVo", "BO-1028100007-IMAGEDESCRIPTION", "ImageDescription");
			fields[147] = new ims.framework.ReportField(this.context, "_cv_Admin.DrawingGraphicImageShortVo", "BO-1028100007-VERSIONNUMBER", "VersionNumber");
			fields[148] = new ims.framework.ReportField(this.context, "_cv_Admin.DrawingGraphicImageShortVo", "BO-1028100007-IMAGESTATUS", "ImageStatus");
			fields[149] = new ims.framework.ReportField(this.context, "_cv_Admin.SelectedImage", "BO-1021100003-ID", "ID_AppImage");
			fields[150] = new ims.framework.ReportField(this.context, "_cv_Admin.SelectedImage", "BO-1021100003-IMAGEPATH", "ImagePath");
			fields[151] = new ims.framework.ReportField(this.context, "_cv_Admin.SelectedImage", "BO-1021100003-ISSYSTEM", "IsSystem");
			fields[152] = new ims.framework.ReportField(this.context, "_cv_Admin.SelectedImage", "BO-1021100003-NAMESPACE", "NameSpace");
			fields[153] = new ims.framework.ReportField(this.context, "_cv_Admin.SelectedImage", "BO-1021100003-ISACTIVE", "IsActive");
			fields[154] = new ims.framework.ReportField(this.context, "_cv_Admin.SelectedImage", "BO-1021100003-WIDTH", "Width");
			fields[155] = new ims.framework.ReportField(this.context, "_cv_Admin.SelectedImage", "BO-1021100003-HEIGHT", "Height");
			fields[156] = new ims.framework.ReportField(this.context, "_cv_Admin.DrawingImageVo", "BO-1021100008-ID", "ID_DrawingImage");
			fields[157] = new ims.framework.ReportField(this.context, "_cv_Admin.DrawingImageVo", "BO-1021100008-CATEGORY", "Category");
			fields[158] = new ims.framework.ReportField(this.context, "_cv_Admin.DrawingImageVo", "BO-1021100008-TYPE", "Type");
			fields[159] = new ims.framework.ReportField(this.context, "_cv_Admin.DrawingImageVo", "BO-1021100008-IMAGENAME", "ImageName");
			fields[160] = new ims.framework.ReportField(this.context, "_cv_Admin.DrawingImageVo", "BO-1021100008-VERSIONNUMBER", "VersionNumber");
			fields[161] = new ims.framework.ReportField(this.context, "_cv_Admin.DrawingImageVo", "BO-1021100008-IMAGESTATUS", "ImageStatus");
			fields[162] = new ims.framework.ReportField(this.context, "_cv_Core.DrawingGraphicImageVo", "BO-1028100007-ID", "ID_DrawingGraphicImage");
			fields[163] = new ims.framework.ReportField(this.context, "_cv_Core.DrawingGraphicImageVo", "BO-1028100007-IMAGENAME", "ImageName");
			fields[164] = new ims.framework.ReportField(this.context, "_cv_Core.DrawingGraphicImageVo", "BO-1028100007-IMAGEDESCRIPTION", "ImageDescription");
			fields[165] = new ims.framework.ReportField(this.context, "_cv_Core.DrawingGraphicImageVo", "BO-1028100007-VERSIONNUMBER", "VersionNumber");
			fields[166] = new ims.framework.ReportField(this.context, "_cv_Core.DrawingGraphicImageVo", "BO-1028100007-IMAGESTATUS", "ImageStatus");
			fields[167] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.DrawingConfig.__internal_x_context__ImageRecord_" + componentIdentifier, "BO-1028100007-ID", "ID_DrawingGraphicImage");
			fields[168] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.DrawingConfig.__internal_x_context__ImageRecord_" + componentIdentifier, "BO-1028100007-IMAGENAME", "ImageName");
			fields[169] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.DrawingConfig.__internal_x_context__ImageRecord_" + componentIdentifier, "BO-1028100007-IMAGEDESCRIPTION", "ImageDescription");
			fields[170] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.DrawingConfig.__internal_x_context__ImageRecord_" + componentIdentifier, "BO-1028100007-VERSIONNUMBER", "VersionNumber");
			fields[171] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.DrawingConfig.__internal_x_context__ImageRecord_" + componentIdentifier, "BO-1028100007-IMAGESTATUS", "ImageStatus");
			return fields;
		}
