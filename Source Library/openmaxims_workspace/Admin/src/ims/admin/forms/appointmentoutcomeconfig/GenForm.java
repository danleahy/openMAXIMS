...
public class GenForm extends FormBridge
{
	...
	public static class ctnDetailsContainer extends ContainerBridge
	{
		...
		protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
		{
			...
			// Label Controls
			RuntimeAnchoring anchoringHelper1 = new RuntimeAnchoring(designSize, runtimeSize, 616, 64, 46, 17, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT);
			super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1000), new Integer(anchoringHelper1.getX()), new Integer(anchoringHelper1.getY()), new Integer(anchoringHelper1.getWidth()), new Integer(anchoringHelper1.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Actions", new Integer(1), null, new Integer(0)}));
			RuntimeAnchoring anchoringHelper2 = new RuntimeAnchoring(designSize, runtimeSize, 16, 16, 153, 17, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT);
			super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1001), new Integer(anchoringHelper2.getX()), new Integer(anchoringHelper2.getY()), new Integer(anchoringHelper2.getWidth()), new Integer(anchoringHelper2.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Outcome Only Applies for:", new Integer(1), null, new Integer(0)}));
	
			// CheckBox Controls
			RuntimeAnchoring anchoringHelper3 = new RuntimeAnchoring(designSize, runtimeSize, 616, 203, 176, 16, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT);
			super.addControl(factory.getControl(CheckBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1002), new Integer(anchoringHelper3.getX()), new Integer(anchoringHelper3.getY()), new Integer(anchoringHelper3.getWidth()), new Integer(anchoringHelper3.getHeight()), new Integer(startTabIndex.intValue() + 17), ControlState.DISABLED, ControlState.ENABLED,ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT ,"Transfer of Care", Boolean.FALSE, null}));
			RuntimeAnchoring anchoringHelper4 = new RuntimeAnchoring(designSize, runtimeSize, 616, 155, 200, 16, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT);
			super.addControl(factory.getControl(CheckBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1003), new Integer(anchoringHelper4.getX()), new Integer(anchoringHelper4.getY()), new Integer(anchoringHelper4.getWidth()), new Integer(anchoringHelper4.getHeight()), new Integer(startTabIndex.intValue() + 15), ControlState.DISABLED, ControlState.ENABLED,ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT ,"Inter Provider Transfer", Boolean.FALSE, null}));
			RuntimeAnchoring anchoringHelper5 = new RuntimeAnchoring(designSize, runtimeSize, 616, 179, 176, 16, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT);
			super.addControl(factory.getControl(CheckBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1004), new Integer(anchoringHelper5.getX()), new Integer(anchoringHelper5.getY()), new Integer(anchoringHelper5.getWidth()), new Integer(anchoringHelper5.getHeight()), new Integer(startTabIndex.intValue() + 16), ControlState.DISABLED, ControlState.ENABLED,ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT ,"Request for Service", Boolean.FALSE, null}));
			RuntimeAnchoring anchoringHelper6 = new RuntimeAnchoring(designSize, runtimeSize, 616, 131, 176, 16, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT);
			...
			RuntimeAnchoring anchoringHelper7 = new RuntimeAnchoring(designSize, runtimeSize, 616, 107, 176, 16, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT);
			...
			RuntimeAnchoring anchoringHelper8 = new RuntimeAnchoring(designSize, runtimeSize, 616, 83, 176, 16, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT);
			super.addControl(factory.getControl(CheckBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1007), new Integer(anchoringHelper8.getX()), new Integer(anchoringHelper8.getY()), new Integer(anchoringHelper8.getWidth()), new Integer(anchoringHelper8.getHeight()), new Integer(startTabIndex.intValue() + 12), ControlState.DISABLED, ControlState.ENABLED,ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT ,"Can Add to Waiting List", Boolean.FALSE, null}));
			RuntimeAnchoring anchoringHelper9 = new RuntimeAnchoring(designSize, runtimeSize, 616, 40, 184, 16, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT);
			...
			RuntimeAnchoring anchoringHelper10 = new RuntimeAnchoring(designSize, runtimeSize, 176, 16, 44, 16, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT);
			super.addControl(factory.getControl(CheckBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1009), new Integer(anchoringHelper10.getX()), new Integer(anchoringHelper10.getY()), new Integer(anchoringHelper10.getWidth()), new Integer(anchoringHelper10.getHeight()), new Integer(startTabIndex.intValue() + 7), ControlState.DISABLED, ControlState.ENABLED,ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT ,"Seen", Boolean.FALSE, null}));
			RuntimeAnchoring anchoringHelper11 = new RuntimeAnchoring(designSize, runtimeSize, 312, 16, 88, 16, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT);
			super.addControl(factory.getControl(CheckBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1010), new Integer(anchoringHelper11.getX()), new Integer(anchoringHelper11.getY()), new Integer(anchoringHelper11.getWidth()), new Integer(anchoringHelper11.getHeight()), new Integer(startTabIndex.intValue() + 9), ControlState.DISABLED, ControlState.ENABLED,ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT ,"DNA Appts.", Boolean.FALSE, null}));
			RuntimeAnchoring anchoringHelper12 = new RuntimeAnchoring(designSize, runtimeSize, 232, 16, 65, 16, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT);
			super.addControl(factory.getControl(CheckBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1011), new Integer(anchoringHelper12.getX()), new Integer(anchoringHelper12.getY()), new Integer(anchoringHelper12.getWidth()), new Integer(anchoringHelper12.getHeight()), new Integer(startTabIndex.intValue() + 8), ControlState.DISABLED, ControlState.ENABLED,ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT ,"Not Seen ", Boolean.FALSE, null}));
	
			// Grid Controls
			RuntimeAnchoring anchoringHelper13 = new RuntimeAnchoring(designSize, runtimeSize, 16, 40, 576, 180, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFTRIGHT);
			Grid m_grdAppointmentOutcomeReasonsTemp = (Grid)factory.getControl(Grid.class, new Object[] { control, new Integer(startControlID.intValue() + 1012), new Integer(anchoringHelper13.getX()), new Integer(anchoringHelper13.getY()), new Integer(anchoringHelper13.getWidth()), new Integer(anchoringHelper13.getHeight()), new Integer(startTabIndex.intValue() + 10), ControlState.READONLY, ControlState.EDITABLE, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFTRIGHT,Boolean.TRUE, Boolean.FALSE, new Integer(24), Boolean.TRUE, null, Boolean.FALSE, Boolean.FALSE, new Integer(0), null, Boolean.FALSE, Boolean.TRUE});
			...
			grdAppointmentOutcomeReasons.addStringColumn("Appointment Outcome Reason", 0, 0, 520, false, false, 0, 0, true, ims.framework.enumerations.CharacterCasing.NORMAL);
			...
			RuntimeAnchoring anchoringHelper14 = new RuntimeAnchoring(designSize, runtimeSize, 0, 8, 472, 8, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		public CheckBox chkTransferOfCare()
		{
		...
		public CheckBox chkAddRequestForService()
		{
		...
		public CheckBox chkDNA()
		{
			return (CheckBox)super.getControl(10);
		}
		public CheckBox chkNotSeen()
		{
	...
	public static class grdAppOutcomeConfigRow extends GridRowBridge
	{
		...
		public boolean getColRequest()
		{
			return ((Boolean)super.row.get(8)).booleanValue();
		}
		public void setColRequest(boolean value)
		{
		...
		public void setColTransferCareReadOnly(boolean value)
		{
			super.row.setReadOnly(9, value);
		}
		public boolean isColTransferCareReadOnly()
		{
			return super.row.isReadOnly(9);
		}
		public void showColTransferCareOpened()
		{
			super.row.showOpened(9);
		}
		public void setTooltipForColTransferCare(String value)
		{
			super.row.setTooltip(9, value);
		}
		public boolean getColTransferCare()
		{
			return ((Boolean)super.row.get(9)).booleanValue();
		}
		public void setColTransferCare(boolean value)
		{
			super.row.set(9, new Boolean(value));
		}
		public void setCellColTransferCareTooltip(String value)
		{
			super.row.setTooltip(9, value);
		}
	...
	public static class grdAppOutcomeConfigGrid extends GridBridge
	{
		...
		public void setColTransferCareHeaderTooltip(String value)
		{
			super.grid.setColumnHeaderTooltip(9, value);
		}
		public String getColTransferCareHeaderTooltip()
		{
	...
	public static class GroupFilterRadioButton extends RadioButtonBridge
	{
		...
		protected void setContext(Integer startTabIndex, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize)
		{
			if(startTabIndex == null)
				throw new RuntimeException("Invalid startTabIndex ");
			RuntimeAnchoring anchoringHelper15 = new RuntimeAnchoring(designSize, runtimeSize, 96, 8, 104, 16, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
			control.addButton(0, anchoringHelper15.getX(), anchoringHelper15.getY(), anchoringHelper15.getWidth(), "All", startTabIndex.intValue() + 2);
			RuntimeAnchoring anchoringHelper16 = new RuntimeAnchoring(designSize, runtimeSize, 8, 8, 104, 16, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
			control.addButton(1, anchoringHelper16.getX(), anchoringHelper16.getY(), anchoringHelper16.getWidth(), "Active", startTabIndex.intValue() + 1);
		}
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		// Container Clasess
		RuntimeAnchoring anchoringHelper17 = new RuntimeAnchoring(designSize, runtimeSize, 8, 344, 832, 248, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFTRIGHT);
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1015), new Integer(anchoringHelper18.getX()), new Integer(anchoringHelper18.getY()), new Integer(anchoringHelper18.getWidth()), new Integer(anchoringHelper18.getHeight()), new Integer(startTabIndex.intValue() + 18), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Edit", Boolean.TRUE, null, Boolean.FALSE, Boolean.FALSE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		RuntimeAnchoring anchoringHelper19 = new RuntimeAnchoring(designSize, runtimeSize, 686, 600, 75, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT);
		...
		// CheckBox Controls
		RuntimeAnchoring anchoringHelper21 = new RuntimeAnchoring(designSize, runtimeSize, 536, 8, 144, 16, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(CheckBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1018), new Integer(anchoringHelper21.getX()), new Integer(anchoringHelper21.getY()), new Integer(anchoringHelper21.getWidth()), new Integer(anchoringHelper21.getHeight()), new Integer(startTabIndex.intValue() + 5), ControlState.ENABLED, ControlState.DISABLED,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,"Outcome for DNA Appts.", Boolean.TRUE, null}));
		RuntimeAnchoring anchoringHelper22 = new RuntimeAnchoring(designSize, runtimeSize, 344, 8, 168, 16, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(CheckBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1019), new Integer(anchoringHelper22.getX()), new Integer(anchoringHelper22.getY()), new Integer(anchoringHelper22.getWidth()), new Integer(anchoringHelper22.getHeight()), new Integer(startTabIndex.intValue() + 4), ControlState.ENABLED, ControlState.DISABLED,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,"Outcome for Not Seen Appts.", Boolean.TRUE, null}));
		RuntimeAnchoring anchoringHelper23 = new RuntimeAnchoring(designSize, runtimeSize, 176, 8, 144, 16, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(CheckBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1020), new Integer(anchoringHelper23.getX()), new Integer(anchoringHelper23.getY()), new Integer(anchoringHelper23.getWidth()), new Integer(anchoringHelper23.getHeight()), new Integer(startTabIndex.intValue() + 3), ControlState.ENABLED, ControlState.DISABLED,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,"Outcome for Seen Appts.", Boolean.TRUE, null}));

		// Grid Controls
		RuntimeAnchoring anchoringHelper24 = new RuntimeAnchoring(designSize, runtimeSize, 8, 32, 832, 304, ims.framework.enumerations.ControlAnchoring.ALL);
		Grid m_grdAppOutcomeConfigTemp = (Grid)factory.getControl(Grid.class, new Object[] { control, new Integer(startControlID.intValue() + 1021), new Integer(anchoringHelper24.getX()), new Integer(anchoringHelper24.getY()), new Integer(anchoringHelper24.getWidth()), new Integer(anchoringHelper24.getHeight()), new Integer(startTabIndex.intValue() + 6), ControlState.READONLY, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.ALL,Boolean.TRUE, Boolean.FALSE, new Integer(24), Boolean.TRUE, null, Boolean.FALSE, Boolean.FALSE, new Integer(0), null, Boolean.FALSE, Boolean.TRUE});
		...
		grdAppOutcomeConfig.addWrapTextColumn("Appt. Status", 0, 0, 110, true, false, 0, true);
		grdAppOutcomeConfig.addStringColumn("Appointment Outcome", 0, 0, 140, true, false, 0, 0, true, ims.framework.enumerations.CharacterCasing.NORMAL);
		grdAppOutcomeConfig.addStringColumn("Appointment Outcome Reason", 0, 0, 190, true, false, 0, 0, true, ims.framework.enumerations.CharacterCasing.NORMAL);
		grdAppOutcomeConfig.addBoolColumn("First", 1, 1, 40, true, false, 0, true);
		grdAppOutcomeConfig.addBoolColumn("Waiting", 1, 1, 55, true, false, 0, true);
		grdAppOutcomeConfig.addBoolColumn("Planned", 1, 1, 55, true, false, 0, true);
		grdAppOutcomeConfig.addBoolColumn("Appt.", 1, 1, 40, true, false, 0, true);
		grdAppOutcomeConfig.addBoolColumn("Transfer", 1, 1, 60, true, false, 0, true);
		grdAppOutcomeConfig.addBoolColumn("Request", 1, 1, 55, true, false, 0, true);
		grdAppOutcomeConfig.addBoolColumn("Transfer Care", 1, 1, -1, true, false, 0, true);
		super.addGrid(grdAppOutcomeConfig);

		// RadioButton Controls
		RadioButton tmpGroupFilter = (RadioButton)factory.getControl(RadioButton.class, new Object[] { control, new Integer(startControlID.intValue() + 1022), new Integer(0), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.TRUE});
	...
	public CheckBox chkDNASearch()
	{
		return (CheckBox)super.getControl(4);
	}
	public CheckBox chkNotSeenSearch()
	{
		return (CheckBox)super.getControl(5);
	}
	public CheckBox chkSeenSearch()
	{
		return (CheckBox)super.getControl(6);
	}
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.AppointmentOutcomeConfig.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1004100065-ID", "ID_AppointmentOutcomeConfig");
			fields[145] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.AppointmentOutcomeConfig.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1004100065-SHOWFIRSTDEFINITIVETREATMENT", "ShowFirstDefinitiveTreatment");
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.AppointmentOutcomeConfig.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1004100065-CANADDTOWAITINGLIST", "CanAddtoWaitingList");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.AppointmentOutcomeConfig.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1004100065-CANADDTOPLANNEDLIST", "CanAddtoPlannedList");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.AppointmentOutcomeConfig.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1004100065-CANMAKEAPPOINTMENT", "CanMakeAppointment");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.AppointmentOutcomeConfig.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1004100065-CANTRANSFER", "CanTransfer");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.AppointmentOutcomeConfig.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1004100065-APPOINTMENTOUTCOME", "AppointmentOutcome");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.AppointmentOutcomeConfig.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1004100065-USEDFORSEEN", "UsedForSeen");
			fields[152] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.AppointmentOutcomeConfig.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1004100065-USEDFORNOTSEEN", "UsedForNotSeen");
			fields[153] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.AppointmentOutcomeConfig.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1004100065-USEDFORDNA", "UsedForDNA");
			fields[154] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.AppointmentOutcomeConfig.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1004100065-CANADDREQUESTFORSERVICE", "CanAddRequestForService");
			fields[155] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.AppointmentOutcomeConfig.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1004100065-CANTRANSFEROFCARE", "CanTransferOfCare");
			return fields;
		}
