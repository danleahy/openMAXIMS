...
public class GenForm extends FormBridge
{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1014), new Integer(anchoringHelper17.getX()), new Integer(anchoringHelper17.getY()), new Integer(anchoringHelper17.getWidth()), new Integer(anchoringHelper17.getHeight()), new Integer(startTabIndex.intValue() + 22), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Select", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1018), new Integer(anchoringHelper21.getX()), new Integer(anchoringHelper21.getY()), new Integer(anchoringHelper21.getWidth()), new Integer(anchoringHelper21.getHeight()), new Integer(startTabIndex.intValue() + 25), ControlState.HIDDEN, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Cancel", Boolean.FALSE, null, Boolean.FALSE, Boolean.FALSE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[156] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.ProviderSystem.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1061100004-ID", "ID_ProviderSystem");
			fields[157] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.ProviderSystem.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1061100004-SYSTEMNAME", "SystemName");
			fields[158] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.ProviderSystem.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1061100004-DESCRIPTION", "Description");
			fields[159] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.ProviderSystem.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1061100004-IPADDRESS", "IPAddress");
			fields[160] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.ProviderSystem.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1061100004-IPPORT", "IPPort");
			fields[161] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.ProviderSystem.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1061100004-HL7APPLICATION", "Hl7Application");
			fields[162] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.ProviderSystem.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1061100004-CODESYSTEM", "CodeSystem");
			fields[163] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.ProviderSystem.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1061100004-IDTYPECOMPONENT", "IdtypeComponent");
			fields[164] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.ProviderSystem.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1061100004-PRIMARYPATIENTID", "PrimaryPatientId");
			fields[165] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.ProviderSystem.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1061100004-CATEGORY", "Category");
			fields[166] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.ProviderSystem.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1061100004-SENDREFERRALLETTER", "SendReferralLetter");
			fields[167] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.ProviderSystem.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1061100004-SENDQUESTIONNAIRE", "SendQuestionnaire");
			return fields;
		}
