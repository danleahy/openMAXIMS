...
public class GenForm extends FormBridge
{
	...
	public static class lyrHL7Layer extends Layer
	{
		...
		public static class tabInterfacesContainer extends LayerBridge
		{
			...
			public static class grpInterfaceRadioButton extends RadioButtonBridge
			{
				...
				protected void setContext(Integer startTabIndex, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize)
				{
					...
					control.addButton(0, anchoringHelper1.getX(), anchoringHelper1.getY(), anchoringHelper1.getWidth(), "Outbound", startTabIndex.intValue() + 2);
					...
					control.addButton(1, anchoringHelper2.getX(), anchoringHelper2.getY(), anchoringHelper2.getWidth(), "Inbound", startTabIndex.intValue() + 1);
				}
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				Grid m_grdStatsTemp = (Grid)factory.getControl(Grid.class, new Object[] { control, new Integer(startControlID.intValue() + 1010), new Integer(anchoringHelper13.getX()), new Integer(anchoringHelper13.getY()), new Integer(anchoringHelper13.getWidth()), new Integer(anchoringHelper13.getHeight()), new Integer(startTabIndex.intValue() + 7), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL,Boolean.TRUE, Boolean.FALSE, new Integer(24), Boolean.TRUE, contextMenus.contextMenuHl7AdminStatsMenu, Boolean.FALSE, Boolean.FALSE, new Integer(0), null, Boolean.FALSE, Boolean.TRUE});
				...
				grdStats.addIntColumn("Total", 1, 1, 70, false, true, null, false, 0, false, 0);
				grdStats.addIntColumn("Successful", 1, 1, 70, false, true, null, false, 0, false, 0);
				grdStats.addIntColumn("Failed", 1, 1, 70, false, true, null, false, 0, false, 0);
		...
		public static class tabQueryContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				super.addControl(factory.getControl(DateControl.class, new Object[] { control, new Integer(startControlID.intValue() + 1019), new Integer(anchoringHelper21.getX()), new Integer(anchoringHelper21.getY()), new Integer(anchoringHelper21.getWidth()), new Integer(anchoringHelper21.getHeight()), new Integer(startTabIndex.intValue() + 10), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.TRUE, null, Boolean.TRUE, null, Boolean.FALSE, null}));
				...
				Grid m_grdMsgsTemp = (Grid)factory.getControl(Grid.class, new Object[] { control, new Integer(startControlID.intValue() + 1022), new Integer(anchoringHelper24.getX()), new Integer(anchoringHelper24.getY()), new Integer(anchoringHelper24.getWidth()), new Integer(anchoringHelper24.getHeight()), new Integer(startTabIndex.intValue() + 16), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL,Boolean.TRUE, Boolean.FALSE, new Integer(24), Boolean.TRUE, contextMenus.contextMenuHl7AdminQryMenu, Boolean.FALSE, Boolean.FALSE, new Integer(0), null, Boolean.FALSE, Boolean.TRUE});
				...
				super.addControl(factory.getControl(ImageButton.class, new Object[] { control, new Integer(startControlID.intValue() + 1025), new Integer(anchoringHelper27.getX()), new Integer(anchoringHelper27.getY()), new Integer(anchoringHelper27.getWidth()), new Integer(anchoringHelper27.getHeight()), new Integer(startTabIndex.intValue() + 15), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT, form_images_local.Core.ClearEnabled24, form_images_local.Core.ClearDisabled24, "Reset search criteria and results", Boolean.FALSE, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null}));
				...
				super.addControl(factory.getControl(ImageButton.class, new Object[] { control, new Integer(startControlID.intValue() + 1026), new Integer(anchoringHelper28.getX()), new Integer(anchoringHelper28.getY()), new Integer(anchoringHelper28.getWidth()), new Integer(anchoringHelper28.getHeight()), new Integer(startTabIndex.intValue() + 14), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT, form_images_local.Core.FindEnabled24, form_images_local.Core.FindDisabled24, "Search for messages matching 'Search Criteria'", Boolean.FALSE, Boolean.TRUE, Boolean.TRUE, Boolean.FALSE, null}));
		...
		public static class tabDemographicFeedContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1038), new Integer(anchoringHelper40.getX()), new Integer(anchoringHelper40.getY()), new Integer(anchoringHelper40.getWidth()), new Integer(anchoringHelper40.getHeight()), new Integer(startTabIndex.intValue() + 25), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFTRIGHT,Boolean.TRUE, new Integer(0), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
				...
				super.addControl(factory.getControl(DateTimeControl.class, new Object[] { control, new Integer(startControlID.intValue() + 1040), new Integer(anchoringHelper42.getX()), new Integer(anchoringHelper42.getY()), new Integer(anchoringHelper42.getWidth()), new Integer(anchoringHelper42.getHeight()), new Integer(startTabIndex.intValue() + 18), ControlState.ENABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.TRUE, null, Boolean.FALSE, null, Boolean.FALSE, null}));
				...
				super.addControl(factory.getControl(DateTimeControl.class, new Object[] { control, new Integer(startControlID.intValue() + 1041), new Integer(anchoringHelper43.getX()), new Integer(anchoringHelper43.getY()), new Integer(anchoringHelper43.getWidth()), new Integer(anchoringHelper43.getHeight()), new Integer(startTabIndex.intValue() + 17), ControlState.ENABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.TRUE, null, Boolean.FALSE, null, Boolean.FALSE, null}));
				...
				ComboBox m_cmbPatIdTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1042), new Integer(anchoringHelper44.getX()), new Integer(anchoringHelper44.getY()), new Integer(anchoringHelper44.getWidth()), new Integer(anchoringHelper44.getHeight()), new Integer(startTabIndex.intValue() + 19), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,Boolean.TRUE, Boolean.TRUE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
		...
		public static class tabOutboundControlContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1046), new Integer(anchoringHelper48.getX()), new Integer(anchoringHelper48.getY()), new Integer(anchoringHelper48.getWidth()), new Integer(anchoringHelper48.getHeight()), new Integer(startTabIndex.intValue() + 31), ControlState.HIDDEN, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Cancel", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
				...
				super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1048), new Integer(anchoringHelper50.getX()), new Integer(anchoringHelper50.getY()), new Integer(anchoringHelper50.getWidth()), new Integer(anchoringHelper50.getHeight()), new Integer(startTabIndex.intValue() + 29), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Edit", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
				...
				Grid m_grdSelectQueueTypeTemp = (Grid)factory.getControl(Grid.class, new Object[] { control, new Integer(startControlID.intValue() + 1049), new Integer(anchoringHelper51.getX()), new Integer(anchoringHelper51.getY()), new Integer(anchoringHelper51.getWidth()), new Integer(anchoringHelper51.getHeight()), new Integer(startTabIndex.intValue() + 28), ControlState.DISABLED, ControlState.EDITABLE, ims.framework.enumerations.ControlAnchoring.ALL,Boolean.FALSE, Boolean.FALSE, new Integer(24), Boolean.TRUE, null, Boolean.FALSE, Boolean.FALSE, new Integer(0), null, Boolean.TRUE, Boolean.TRUE});
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.Hl7Admin.__internal_x_context__PatId_" + componentIdentifier, "BO-1001100004-ID", "ID_PatientId");
			fields[145] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.Hl7Admin.__internal_x_context__PatId_" + componentIdentifier, "BO-1001100004-TYPE", "Type");
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.Hl7Admin.__internal_x_context__PatId_" + componentIdentifier, "BO-1001100004-VALUE", "IdValue");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.Hl7Admin.__internal_x_context__PatId_" + componentIdentifier, "BO-1001100004-VERIFIED", "Verified");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.Hl7Admin.__internal_x_context__PatId_" + componentIdentifier, "BO-1001100004-MERGED", "Merged");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.Hl7Admin.__internal_x_context__PatId_" + componentIdentifier, "BO-1001100004-DUPLICATENHSNUM", "DuplicateNHSNum");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.Hl7Admin.__internal_x_context__PatId_" + componentIdentifier, "BO-1001100004-BEFFDATE", "Beffdate");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.Hl7Admin.__internal_x_context__PatId_" + componentIdentifier, "BO-1001100004-BEFFDATECNF", "Beffdatecnf");
			fields[152] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.Hl7Admin.__internal_x_context__PatId_" + componentIdentifier, "BO-1001100004-BETDATE", "Betdate");
			fields[153] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.Hl7Admin.__internal_x_context__PatId_" + componentIdentifier, "BO-1001100004-BETDATECNF", "Betdatecnf");
			fields[154] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.Hl7Admin.__internal_x_context__selectedOutBoundMessage_" + componentIdentifier, "BO-1103100000-ID", "ID_DemographicsMessageQueue");
			fields[155] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.Hl7Admin.__internal_x_context__selectedOutBoundMessage_" + componentIdentifier, "BO-1103100000-WASPROCESSED", "WasProcessed");
			fields[156] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.Hl7Admin.__internal_x_context__selectedOutBoundMessage_" + componentIdentifier, "BO-1103100000-WASDISCARDED", "WasDiscarded");
			fields[157] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.Hl7Admin.__internal_x_context__selectedOutBoundMessage_" + componentIdentifier, "BO-1103100000-MSGTEXT", "MsgText");
			fields[158] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.Hl7Admin.__internal_x_context__selectedOutBoundMessage_" + componentIdentifier, "BO-1103100000-ACKTEXT", "AckText");
			fields[159] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.Hl7Admin.__internal_x_context__selectedOutBoundMessage_" + componentIdentifier, "BO-1103100000-FAILUREMSG", "FailureMsg");
			fields[160] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.Hl7Admin.__internal_x_context__selectedOutBoundMessage_" + componentIdentifier, "BO-1103100000-MESSAGESTATUS", "MessageStatus");
			fields[161] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.Hl7Admin.__internal_x_context__selectedOutBoundMessage_" + componentIdentifier, "BO-1103100000-MSGTYPE", "MsgType");
			fields[162] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.Hl7Admin.__internal_x_context__selectedOutBoundMessage_" + componentIdentifier, "BO-1103100000-QUEUETYPE", "QueueType");
			fields[163] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.Hl7Admin.__internal_x_context__selectedOutBoundMessage_" + componentIdentifier, "BO-1103100000-PRIORPATIENT", "PriorPatient");
			return fields;
		}
