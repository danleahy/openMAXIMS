...
public abstract class BaseOcsIfInboundImpl extends DomainImpl implements ims.ocs_if.domain.OcsIfInbound, ims.domain.impl.Transactional
{
	...
	@SuppressWarnings("unused")
	public void validategetAnalyte(String extCode, String extTxt, ims.ocs_if.vo.IfProviderInvSearchVo providerInvSearch, ims.ocrr.vo.lookups.ResultUnitOfMeasure unitOfMeasure, Boolean doAnalyteCheck)
	{
	}
