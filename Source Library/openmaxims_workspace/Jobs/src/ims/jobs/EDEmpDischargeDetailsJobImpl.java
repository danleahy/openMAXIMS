...
public final class EDEmpDischargeDetailsJobImpl extends ims.scheduler.SchedulerJob
{
	private static final int 	TIMEOUT = 1000 * 60 * 15;
	private static final int 	MAX_BUFFER_LIMIT_NO_WARNING = 1024*1024;
	private static final String EMAIL_SUBJECT = "  Patient Data - ED Discharge Summary - ";
	...
	public SchedulerJobExecutionSummary doExecute() throws JobExecutionException
	{
		...
		TrackingJobVoCollection dischargedTrackings = getDischargedTrackingsRequiringLetter();
	...
	private TrackingJobVo populateAndSaveTracking(TrackingJobVo tracking) throws StaleObjectException 
	{
		...
		tracking.getAttendance().setDischargeLetterStatus(DischargeLetterStatus.GENERATED);//WDEV-19441
	...
	private TrackingJobVoCollection getDischargedTrackingsRequiringLetter() 
	{
		DomainFactoryBridge factory = getDomainFactory();
		
		String query = "select tr from Tracking as tr left join tr.dischargeLetterStatus as trStatus left join tr.attendance as att where tr.isDischarged = true and trStatus.id = :DischargeLetterStatus and att.isDischargeLetterRequired = true";
