...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_CcoSched.TransportUpdate.IsNew" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_CcoSched.TransportDetails.__internal_x_context__" + String.valueOf(getFormId());
	}
	...
	{
		return "Images/Core/ambulance_info_48.png";
	}
}
