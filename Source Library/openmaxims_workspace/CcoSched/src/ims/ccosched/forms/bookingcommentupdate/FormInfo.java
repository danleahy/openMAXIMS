...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_CcoSched.ClinicView.BookingComment" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_CcoSched.BookingCommentUpdate.__internal_x_context__" + String.valueOf(getFormId());
	}
	...
	{
		return "Images/Core/appointment_comment_48.png";
	}
}
