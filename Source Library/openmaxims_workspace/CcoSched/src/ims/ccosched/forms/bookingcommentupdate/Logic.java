...
//#############################################################################
//#EOH
// This code was generated by Vasile Purdila using IMS Development Environment (version 1.18 build 40610.1130)
...
public class Logic extends BaseLogicDTO
{
	...
	{
		if(form.getGlobalContext().CcoSched.ClinicView.getBookingComment() != null)
	...
	{
		form.getGlobalContext().CcoSched.ClinicView.setBookingComment(form.Comment().getValue());
