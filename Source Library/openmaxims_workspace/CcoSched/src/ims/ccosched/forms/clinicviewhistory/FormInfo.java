...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_CcoSched.ClinicView.ActionId", "_cv_CcoSched.ClinicView.ApptHead_id", "_cv_CcoSched.ClinicView.ApptId" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_CcoSched.ClinicViewHistory.__internal_x_context__" + String.valueOf(getFormId());
	}
