...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_CcoSched.Reschedule.SelectedAppointments" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_CcoSched.AppointmentsCancel.__internal_x_context__" + String.valueOf(getFormId());
	}
