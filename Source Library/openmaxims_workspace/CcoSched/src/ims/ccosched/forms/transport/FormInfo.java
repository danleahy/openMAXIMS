...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_CcoSched.PatientSearch.Alive", "_cv_CcoSched.Transport.Category", "_cv_CcoSched.Transport.HCP", "_cv_CcoSched.Trasport.AppointmentHeaderID" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_CcoSched.Transport.__internal_x_context__" + String.valueOf(getFormId());
	}
