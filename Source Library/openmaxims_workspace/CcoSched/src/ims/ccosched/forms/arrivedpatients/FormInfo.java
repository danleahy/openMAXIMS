...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_CcoSched.ClinicView.ClinicName", "_cv_CcoSched.ClinicView.Date" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_CcoSched.ArrivedPatients.__internal_x_context__" + String.valueOf(getFormId());
	}
