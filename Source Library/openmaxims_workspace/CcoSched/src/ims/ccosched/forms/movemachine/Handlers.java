...
abstract public class Handlers implements ims.framework.UILogic, IFormUILogicCode
{
	...
	abstract protected void onMachineValueChanged() throws ims.framework.exceptions.PresentationLogicException;
	abstract protected void onPatternClick() throws ims.framework.exceptions.PresentationLogicException;
	abstract protected void onDefaultGridGridCheckBoxClicked(int column, GenForm.DefaultGridRow row, boolean isChecked) throws ims.framework.exceptions.PresentationLogicException;
	...
	public final void setContext(ims.framework.UIEngine engine, GenForm form)
	{
		...
		this.form.Machine().setValueChangedEvent(new ValueChanged()
		{
			private static final long serialVersionUID = 1L;
			public void handle() throws ims.framework.exceptions.PresentationLogicException
			{
				onMachineValueChanged();
			}
		});
		...
		this.form.DefaultGrid().setGridCheckBoxClickedEvent(new GridCheckBoxClicked()
		{
			...
			{
				onDefaultGridGridCheckBoxClicked(column, new GenForm.DefaultGridRow(row), isChecked);
			}
		});
