...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_CcoSched.Trasport.AppointmentHeaderID", "_cv_CcoSched.TransportDetailsTitle" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_CcoSched.TransportUpdateDetails.__internal_x_context__" + String.valueOf(getFormId());
	}
