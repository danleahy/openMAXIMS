...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "ChangeAppointmentsTimes";
	}
	public int getWidth()
	{
		return 640;
	...
	{
		return new String[] { "_cv_CcoSched.PatientAppointments.Children", "_cv_CcoSched.PatientAppointments.Parent" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_CcoSched.ChangeAppointmentsTimes.__internal_x_context__" + String.valueOf(getFormId());
	}
