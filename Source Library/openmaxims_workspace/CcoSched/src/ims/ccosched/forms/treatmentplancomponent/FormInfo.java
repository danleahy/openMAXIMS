...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_CcoSched.TreatmentPlan.TreatmentPlanDetails", "_cv_CcoSched.ActionUpdate.TreatmentPlanActions", "_cv_CcoSched.TreatmentPlan.Anaesthetic", "_cv_CcoSched.TreatmentPlan.Technique", "_cv_PatTreatmentPlan" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_CcoSched.TreatmentPlanComponent.__internal_x_context__" + String.valueOf(getFormId());
	}
