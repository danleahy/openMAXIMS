...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_CcoSched.Booking.CalendarSelectedDates", "_cv_CcoSched.Booking.SelectedActions", "_cv_CcoSched.TreatmentPlan.FurtherAppointment" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_CcoSched.BookingAction.__internal_x_context__" + String.valueOf(getFormId());
	}
