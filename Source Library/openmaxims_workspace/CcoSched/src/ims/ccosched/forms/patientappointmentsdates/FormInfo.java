...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "PatientAppointmentsDates";
	}
	public int getWidth()
	{
		return 496;
	...
	{
		return new String[] { "_cv_Core.Template", "_cv_CcoSched.PatientAppointments.ApptEndDate", "_cv_CcoSched.PatientAppointments.ApptStartDate" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_CcoSched.PatientAppointmentsDates.__internal_x_context__" + String.valueOf(getFormId());
	}
	...
	{
		return "Images/Core/appointment_clock_48.png";
	}
}
