...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_CcoSched.RelaitedAppointments.RelaitedAppointments" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_CcoSched.RelaitedAppointments.__internal_x_context__" + String.valueOf(getFormId());
	}
	...
	{
		return "Images/CcoSched/relaited_appointment_48.png";
	}
}
