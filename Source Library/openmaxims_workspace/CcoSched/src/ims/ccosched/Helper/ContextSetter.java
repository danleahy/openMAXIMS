...
public class ContextSetter extends DTODomainImplementation implements IContextSetter
{
	...
	{
		ContextReader.setLoggedInUSer(new Integer(getSession().getUser().getUserId()).toString(),ctx);
	}
