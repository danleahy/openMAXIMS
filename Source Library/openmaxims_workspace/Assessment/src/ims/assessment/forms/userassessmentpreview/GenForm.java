...
public class GenForm extends FormBridge
{
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[156] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.UserAssessmentPreview.__internal_x_context__UserAssessmentVo_" + componentIdentifier, "BO-1003100043-ID", "ID_UserAssessment");
			fields[157] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.UserAssessmentPreview.__internal_x_context__UserAssessmentVo_" + componentIdentifier, "BO-1003100043-NAME", "Name");
			fields[158] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.UserAssessmentPreview.__internal_x_context__UserAssessmentVo_" + componentIdentifier, "BO-1003100043-DESCRIPTION", "Description");
			fields[159] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.UserAssessmentPreview.__internal_x_context__UserAssessmentVo_" + componentIdentifier, "BO-1003100043-ASSESSMENTTYPE", "AssessmentType");
			fields[160] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.UserAssessmentPreview.__internal_x_context__UserAssessmentVo_" + componentIdentifier, "BO-1003100043-ACTIVESTATUS", "ActiveStatus");
			fields[161] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.UserAssessmentPreview.__internal_x_context__UserAssessmentVo_" + componentIdentifier, "BO-1003100043-HELPURL", "HelpURL");
			fields[162] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.UserAssessmentPreview.__internal_x_context__UserAssessmentVo_" + componentIdentifier, "BO-1003100043-SCORINGMETHOD", "ScoringMethod");
			fields[163] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.UserAssessmentPreview.__internal_x_context__UserAssessmentVo_" + componentIdentifier, "BO-1003100043-ISFLATVIEW", "IsFlatView");
			fields[164] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.UserAssessmentPreview.__internal_x_context__UserAssessmentVo_" + componentIdentifier, "BO-1003100043-CATEGORY", "Category");
			fields[165] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.UserAssessmentPreview.__internal_x_context__UserAssessmentVo_" + componentIdentifier, "BO-1003100043-ISMULTIPLEGROUP", "IsMultipleGroup");
			fields[166] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.UserAssessmentPreview.__internal_x_context__UserAssessmentVo_" + componentIdentifier, "BO-1003100043-GROUPQUESTIONWIDTH", "GroupQuestionWidth");
			fields[167] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.UserAssessmentPreview.__internal_x_context__UserAssessmentVo_" + componentIdentifier, "BO-1003100043-STOREPRINTEDASSESSMENT", "StorePrintedAssessment");
			fields[168] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.UserAssessmentPreview.__internal_x_context__UserAssessmentVo_" + componentIdentifier, "BO-1003100043-ISMULTIROLE", "IsMultiRole");
			fields[169] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.UserAssessmentPreview.__internal_x_context__UserAssessmentVo_" + componentIdentifier, "BO-1003100043-HEADERTEXT", "HeaderText");
			fields[170] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.UserAssessmentPreview.__internal_x_context__UserAssessmentVo_" + componentIdentifier, "BO-1003100043-FOOTERTEXT", "FooterText");
			fields[171] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.UserAssessmentPreview.__internal_x_context__UserAssessmentVo_" + componentIdentifier, "BO-1003100043-MAXHEADERHEIGHT", "MaxHeaderHeight");
			fields[172] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.UserAssessmentPreview.__internal_x_context__UserAssessmentVo_" + componentIdentifier, "BO-1003100043-MAXFOOTERHEIGHT", "MaxFooterHeight");
			fields[173] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.UserAssessmentPreview.__internal_x_context__UserAssessmentVo_" + componentIdentifier, "BO-1003100043-ASSOCIATEDREPORT", "AssociatedReport");
			fields[174] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.UserAssessmentPreview.__internal_x_context__UserAssessmentVo_" + componentIdentifier, "BO-1003100043-CANCOPYLAST", "CanCopyLast");
			fields[175] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.UserAssessmentPreview.__internal_x_context__UserAssessmentVo_" + componentIdentifier, "BO-1003100043-COPYLASTFROMCONTEXT", "CopyLastFromContext");
			return fields;
		}
