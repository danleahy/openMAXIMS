...
public class GenForm extends FormBridge
{
	...
	public static class lyrAssessmentsLayer extends Layer
	{
		...
		public static class tabStructuralAssessmentContainer extends LayerBridge
		{
			...
			public static class lyrDualViewLayer extends Layer
			{
				...
				public static class tabPageReportContainer extends LayerBridge
				{
					...
					protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
					{
						...
						ims.framework.FormUiLogic m_ccReportBuilderForm = loader.loadComponent(102275, appForm, startControlID * 10 + 1000, anchoringHelper1.getSize(), instance1, startTabIndex.intValue() + 9, skipContextValidation);
						//ims.framework.Control m_ccReportBuilderControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1000), new Integer(0), new Integer(0), new Integer(808), new Integer(405), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 9), m_ccReportBuilderForm, instance1 } );
						ims.framework.Control m_ccReportBuilderControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1001),  new Integer(anchoringHelper1.getX()), new Integer(anchoringHelper1.getY()), new Integer(anchoringHelper1.getWidth()), new Integer(anchoringHelper1.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 9), m_ccReportBuilderForm, instance1, Boolean.FALSE } );
				...
				public static class tabPageAssessmentContainer extends LayerBridge
				{
					...
					protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
					{
						...
						ims.framework.FormUiLogic m_customStructuredAssessmentForm = loader.loadComponent(127109, appForm, startControlID * 10 + 2000, anchoringHelper2.getSize(), instance1, startTabIndex.intValue() + 10, skipContextValidation);
						//ims.framework.Control m_customStructuredAssessmentControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1002), new Integer(3), new Integer(2), new Integer(800), new Integer(400), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 10), m_customStructuredAssessmentForm, instance1 } );
						ims.framework.Control m_customStructuredAssessmentControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1003),  new Integer(anchoringHelper2.getX()), new Integer(anchoringHelper2.getY()), new Integer(anchoringHelper2.getWidth()), new Integer(anchoringHelper2.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 10), m_customStructuredAssessmentForm, instance1, Boolean.FALSE } );
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				// Custom Controls
				ims.framework.CustomComponent instance1 = factory.getEmptyCustomComponent();
				RuntimeAnchoring anchoringHelper5 = new RuntimeAnchoring(designSize, runtimeSize, 416, 472, 400, 56, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFTRIGHT);
				ims.framework.FormUiLogic m_authStructuredAssessmentCompletedForm = loader.loadComponent(102228, appForm, startControlID * 10 + 3000, anchoringHelper5.getSize(), instance1, startTabIndex.intValue() + 15, skipContextValidation);
				//ims.framework.Control m_authStructuredAssessmentCompletedControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1006), new Integer(416), new Integer(472), new Integer(400), new Integer(56), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFTRIGHT, new Integer(startTabIndex.intValue() + 15), m_authStructuredAssessmentCompletedForm, instance1 } );
				ims.framework.Control m_authStructuredAssessmentCompletedControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1007),  new Integer(anchoringHelper5.getX()), new Integer(anchoringHelper5.getY()), new Integer(anchoringHelper5.getWidth()), new Integer(anchoringHelper5.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFTRIGHT, new Integer(startTabIndex.intValue() + 15), m_authStructuredAssessmentCompletedForm, instance1, Boolean.FALSE } );
				...
				RuntimeAnchoring anchoringHelper6 = new RuntimeAnchoring(designSize, runtimeSize, 8, 472, 400, 56, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT);
				ims.framework.FormUiLogic m_authStructuredAssessmentForm = loader.loadComponent(102228, appForm, startControlID * 10 + 4000, anchoringHelper6.getSize(), instance2, startTabIndex.intValue() + 12, skipContextValidation);
				//ims.framework.Control m_authStructuredAssessmentControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1008), new Integer(8), new Integer(472), new Integer(400), new Integer(56), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, new Integer(startTabIndex.intValue() + 12), m_authStructuredAssessmentForm, instance2 } );
				ims.framework.Control m_authStructuredAssessmentControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1009),  new Integer(anchoringHelper6.getX()), new Integer(anchoringHelper6.getY()), new Integer(anchoringHelper6.getWidth()), new Integer(anchoringHelper6.getHeight()), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, new Integer(startTabIndex.intValue() + 12), m_authStructuredAssessmentForm, instance2, Boolean.FALSE } );
				...
				super.addControl(factory.getControl(ImageButton.class, new Object[] { control, new Integer(startControlID.intValue() + 1016), new Integer(anchoringHelper13.getX()), new Integer(anchoringHelper13.getY()), new Integer(anchoringHelper13.getWidth()), new Integer(anchoringHelper13.getHeight()), new Integer(startTabIndex.intValue() + 7), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT, form_images_local.Core.FindEnabled16, form_images_local.Core.FindDisabled16, "Search Patient Assessments", Boolean.FALSE, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null}));
				...
				super.addControl(factory.getControl(ImageButton.class, new Object[] { control, new Integer(startControlID.intValue() + 1017), new Integer(anchoringHelper14.getX()), new Integer(anchoringHelper14.getY()), new Integer(anchoringHelper14.getWidth()), new Integer(anchoringHelper14.getHeight()), new Integer(startTabIndex.intValue() + 4), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT, form_images_local.Core.QuestionSmall, form_images_local.Core.QuestionSmall, null, Boolean.FALSE, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null}));
		...
		public static class tabGraphicalAssessmentContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				// Custom Controls
				ims.framework.CustomComponent instance1 = factory.getEmptyCustomComponent();
				RuntimeAnchoring anchoringHelper16 = new RuntimeAnchoring(designSize, runtimeSize, 416, 472, 400, 56, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFTRIGHT);
				ims.framework.FormUiLogic m_authGraphicalAssessmentCompletedForm = loader.loadComponent(102228, appForm, startControlID * 10 + 5000, anchoringHelper16.getSize(), instance1, startTabIndex.intValue() + 38, skipContextValidation);
				//ims.framework.Control m_authGraphicalAssessmentCompletedControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1019), new Integer(416), new Integer(472), new Integer(400), new Integer(56), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFTRIGHT, new Integer(startTabIndex.intValue() + 38), m_authGraphicalAssessmentCompletedForm, instance1 } );
				ims.framework.Control m_authGraphicalAssessmentCompletedControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1020),  new Integer(anchoringHelper16.getX()), new Integer(anchoringHelper16.getY()), new Integer(anchoringHelper16.getWidth()), new Integer(anchoringHelper16.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFTRIGHT, new Integer(startTabIndex.intValue() + 38), m_authGraphicalAssessmentCompletedForm, instance1, Boolean.FALSE } );
				...
				ims.framework.FormUiLogic m_customGraphicalAssessmentForm = loader.loadComponent(127114, appForm, startControlID * 10 + 6000, anchoringHelper17.getSize(), instance2, startTabIndex.intValue() + 24, skipContextValidation);
				//ims.framework.Control m_customGraphicalAssessmentControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1021), new Integer(8), new Integer(40), new Integer(808), new Integer(424), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 24), m_customGraphicalAssessmentForm, instance2 } );
				ims.framework.Control m_customGraphicalAssessmentControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1022),  new Integer(anchoringHelper17.getX()), new Integer(anchoringHelper17.getY()), new Integer(anchoringHelper17.getWidth()), new Integer(anchoringHelper17.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 24), m_customGraphicalAssessmentForm, instance2, Boolean.FALSE } );
				...
				RuntimeAnchoring anchoringHelper18 = new RuntimeAnchoring(designSize, runtimeSize, 8, 472, 400, 56, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT);
				ims.framework.FormUiLogic m_authGraphicalAssessmentForm = loader.loadComponent(102228, appForm, startControlID * 10 + 7000, anchoringHelper18.getSize(), instance3, startTabIndex.intValue() + 35, skipContextValidation);
				//ims.framework.Control m_authGraphicalAssessmentControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1023), new Integer(8), new Integer(472), new Integer(400), new Integer(56), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, new Integer(startTabIndex.intValue() + 35), m_authGraphicalAssessmentForm, instance3 } );
				ims.framework.Control m_authGraphicalAssessmentControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1024),  new Integer(anchoringHelper18.getX()), new Integer(anchoringHelper18.getY()), new Integer(anchoringHelper18.getWidth()), new Integer(anchoringHelper18.getHeight()), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, new Integer(startTabIndex.intValue() + 35), m_authGraphicalAssessmentForm, instance3, Boolean.FALSE } );
				...
				super.addControl(factory.getControl(DateControl.class, new Object[] { control, new Integer(startControlID.intValue() + 1027), new Integer(anchoringHelper21.getX()), new Integer(anchoringHelper21.getY()), new Integer(anchoringHelper21.getWidth()), new Integer(anchoringHelper21.getHeight()), new Integer(startTabIndex.intValue() + 21), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT,Boolean.TRUE, null, Boolean.FALSE, null, Boolean.FALSE, null}));
				...
				super.addControl(factory.getControl(DateControl.class, new Object[] { control, new Integer(startControlID.intValue() + 1028), new Integer(anchoringHelper22.getX()), new Integer(anchoringHelper22.getY()), new Integer(anchoringHelper22.getWidth()), new Integer(anchoringHelper22.getHeight()), new Integer(startTabIndex.intValue() + 22), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT,Boolean.TRUE, null, Boolean.FALSE, null, Boolean.FALSE, null}));
				...
				super.addControl(factory.getControl(ImageButton.class, new Object[] { control, new Integer(startControlID.intValue() + 1030), new Integer(anchoringHelper24.getX()), new Integer(anchoringHelper24.getY()), new Integer(anchoringHelper24.getWidth()), new Integer(anchoringHelper24.getHeight()), new Integer(startTabIndex.intValue() + 23), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT, form_images_local.Core.FindEnabled16, form_images_local.Core.FindDisabled16, "Search Patient Assessments", Boolean.FALSE, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null}));
				...
				super.addControl(factory.getControl(ImageButton.class, new Object[] { control, new Integer(startControlID.intValue() + 1031), new Integer(anchoringHelper25.getX()), new Integer(anchoringHelper25.getY()), new Integer(anchoringHelper25.getWidth()), new Integer(anchoringHelper25.getHeight()), new Integer(startTabIndex.intValue() + 20), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT, form_images_local.Core.QuestionSmall, form_images_local.Core.QuestionSmall, null, Boolean.FALSE, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null}));
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		// Label Controls
		RuntimeAnchoring anchoringHelper29 = new RuntimeAnchoring(designSize, runtimeSize, 163, 576, 0, 17, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT);
		super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1035), new Integer(anchoringHelper29.getX()), new Integer(anchoringHelper29.getY()), new Integer(anchoringHelper29.getWidth()), new Integer(anchoringHelper29.getHeight()), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "", new Integer(1), null, new Integer(0)}));

		// Button Controls
		RuntimeAnchoring anchoringHelper30 = new RuntimeAnchoring(designSize, runtimeSize, 616, 600, 144, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT);
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1036), new Integer(anchoringHelper30.getX()), new Integer(anchoringHelper30.getY()), new Integer(anchoringHelper30.getWidth()), new Integer(anchoringHelper30.getHeight()), new Integer(startTabIndex.intValue() + 46), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, " Save As PDF", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		RuntimeAnchoring anchoringHelper31 = new RuntimeAnchoring(designSize, runtimeSize, 163, 600, 240, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT);
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1037), new Integer(anchoringHelper31.getX()), new Integer(anchoringHelper31.getY()), new Integer(anchoringHelper31.getWidth()), new Integer(anchoringHelper31.getHeight()), new Integer(startTabIndex.intValue() + 44), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Copy Answers from Previous Assessment", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		RuntimeAnchoring anchoringHelper32 = new RuntimeAnchoring(designSize, runtimeSize, 406, 600, 176, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT);
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1038), new Integer(anchoringHelper32.getX()), new Integer(anchoringHelper32.getY()), new Integer(anchoringHelper32.getWidth()), new Integer(anchoringHelper32.getHeight()), new Integer(startTabIndex.intValue() + 45), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Undo Assessment Completion", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		RuntimeAnchoring anchoringHelper33 = new RuntimeAnchoring(designSize, runtimeSize, 85, 600, 75, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT);
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1039), new Integer(anchoringHelper33.getX()), new Integer(anchoringHelper33.getY()), new Integer(anchoringHelper33.getWidth()), new Integer(anchoringHelper33.getHeight()), new Integer(startTabIndex.intValue() + 43), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Edit", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		RuntimeAnchoring anchoringHelper34 = new RuntimeAnchoring(designSize, runtimeSize, 7, 600, 75, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT);
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1040), new Integer(anchoringHelper34.getX()), new Integer(anchoringHelper34.getY()), new Integer(anchoringHelper34.getWidth()), new Integer(anchoringHelper34.getHeight()), new Integer(startTabIndex.intValue() + 42), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "New", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		RuntimeAnchoring anchoringHelper35 = new RuntimeAnchoring(designSize, runtimeSize, 685, 600, 75, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT);
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1041), new Integer(anchoringHelper35.getX()), new Integer(anchoringHelper35.getY()), new Integer(anchoringHelper35.getWidth()), new Integer(anchoringHelper35.getHeight()), new Integer(startTabIndex.intValue() + 48), ControlState.HIDDEN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Save", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		RuntimeAnchoring anchoringHelper36 = new RuntimeAnchoring(designSize, runtimeSize, 766, 600, 75, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT);
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1042), new Integer(anchoringHelper36.getX()), new Integer(anchoringHelper36.getY()), new Integer(anchoringHelper36.getWidth()), new Integer(anchoringHelper36.getHeight()), new Integer(startTabIndex.intValue() + 49), ControlState.HIDDEN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Cancel", Boolean.FALSE, null, Boolean.FALSE, Boolean.FALSE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		RuntimeAnchoring anchoringHelper37 = new RuntimeAnchoring(designSize, runtimeSize, 766, 600, 75, 23, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1043), new Integer(anchoringHelper37.getX()), new Integer(anchoringHelper37.getY()), new Integer(anchoringHelper37.getWidth()), new Integer(anchoringHelper37.getHeight()), new Integer(startTabIndex.intValue() + 50), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Close", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		RuntimeAnchoring anchoringHelper38 = new RuntimeAnchoring(designSize, runtimeSize, 685, 600, 75, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT);
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1044), new Integer(anchoringHelper38.getX()), new Integer(anchoringHelper38.getY()), new Integer(anchoringHelper38.getWidth()), new Integer(anchoringHelper38.getHeight()), new Integer(startTabIndex.intValue() + 47), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Print", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));

		// CheckBox Controls
		RuntimeAnchoring anchoringHelper39 = new RuntimeAnchoring(designSize, runtimeSize, 7, 576, 72, 16, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT);
		super.addControl(factory.getControl(CheckBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1045), new Integer(anchoringHelper39.getX()), new Integer(anchoringHelper39.getY()), new Integer(anchoringHelper39.getWidth()), new Integer(anchoringHelper39.getHeight()), new Integer(startTabIndex.intValue() + 41), ControlState.DISABLED, ControlState.ENABLED,ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT ,"Complete", Boolean.TRUE, null}));

		// Link Controls
		RuntimeAnchoring anchoringHelper40 = new RuntimeAnchoring(designSize, runtimeSize, 720, 9, 92, 17, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
		super.addControl(factory.getControl(Link.class, new Object[] { control, new Integer(startControlID.intValue() + 1046), new Integer(anchoringHelper40.getX()), new Integer(anchoringHelper40.getY()), new Integer(anchoringHelper40.getWidth()), new Integer(anchoringHelper40.getHeight()), new Integer(startTabIndex.intValue() + 1), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT,"Return to List", Boolean.FALSE, null}));
	}
	...
	public Label lblCopyLastStatus()
	{
	...
	public static class Images implements java.io.Serializable
	{
		...
		public final class CoreImages implements java.io.Serializable
		{
			...
			private CoreImages()
			{
				...
				PDFIconDisabled = new ImageHelper(102295, "Images/Core/pdf_disabled.gif", new Integer(16), new Integer(16));
			}
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[155] = new ims.framework.ReportField(this.context, "_cv_Assessment.PatientAssessment", "BO-1003100048-ID", "ID_PatientAssessment");
			fields[156] = new ims.framework.ReportField(this.context, "_cv_Clinical.PatientAssessment.SelectedAssessment", "BO-1003100048-ID", "ID_PatientAssessment");
			fields[157] = new ims.framework.ReportField(this.context, "_cv_EAS.EasPatientAssessment", "BO-1003100048-ID", "ID_PatientAssessment");
			fields[158] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.DynamicAssessments.__internal_x_context__StructuralAssessment_" + componentIdentifier, "BO-1003100043-ID", "ID_UserAssessment");
			fields[159] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.DynamicAssessments.__internal_x_context__StructuralAssessment_" + componentIdentifier, "BO-1003100043-NAME", "Name");
			fields[160] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.DynamicAssessments.__internal_x_context__StructuralAssessment_" + componentIdentifier, "BO-1003100043-DESCRIPTION", "Description");
			fields[161] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.DynamicAssessments.__internal_x_context__StructuralAssessment_" + componentIdentifier, "BO-1003100043-GROUPQUESTIONWIDTH", "GroupQuestionWidth");
			fields[162] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.DynamicAssessments.__internal_x_context__StructuralAssessment_" + componentIdentifier, "BO-1003100043-HELPURL", "HelpURL");
			fields[163] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.DynamicAssessments.__internal_x_context__StructuralAssessment_" + componentIdentifier, "BO-1003100043-ISFLATVIEW", "IsFlatView");
			fields[164] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.DynamicAssessments.__internal_x_context__StructuralAssessment_" + componentIdentifier, "BO-1003100043-ISMULTIPLEGROUP", "IsMultipleGroup");
			fields[165] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.DynamicAssessments.__internal_x_context__StructuralAssessment_" + componentIdentifier, "BO-1003100043-HEADERTEXT", "HeaderText");
			fields[166] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.DynamicAssessments.__internal_x_context__StructuralAssessment_" + componentIdentifier, "BO-1003100043-FOOTERTEXT", "FooterText");
			fields[167] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.DynamicAssessments.__internal_x_context__StructuralAssessment_" + componentIdentifier, "BO-1003100043-MAXHEADERHEIGHT", "MaxHeaderHeight");
			fields[168] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.DynamicAssessments.__internal_x_context__StructuralAssessment_" + componentIdentifier, "BO-1003100043-MAXFOOTERHEIGHT", "MaxFooterHeight");
			fields[169] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.DynamicAssessments.__internal_x_context__StructuralAssessment_" + componentIdentifier, "BO-1003100043-ASSESSMENTTYPE", "AssessmentType");
			fields[170] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.DynamicAssessments.__internal_x_context__StructuralAssessment_" + componentIdentifier, "BO-1003100043-SCORINGMETHOD", "ScoringMethod");
			fields[171] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.DynamicAssessments.__internal_x_context__StructuralAssessment_" + componentIdentifier, "BO-1003100043-ASSOCIATEDREPORT", "AssociatedReport");
			fields[172] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.DynamicAssessments.__internal_x_context__StructuralAssessment_" + componentIdentifier, "BO-1003100043-STOREPRINTEDASSESSMENT", "StorePrintedAssessment");
			fields[173] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.DynamicAssessments.__internal_x_context__StructuralAssessment_" + componentIdentifier, "BO-1003100043-CANCOPYLAST", "CanCopyLast");
			fields[174] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.DynamicAssessments.__internal_x_context__StructuralAssessment_" + componentIdentifier, "BO-1003100043-COPYLASTFROMCONTEXT", "CopyLastFromContext");
			fields[175] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.DynamicAssessments.__internal_x_context__StructuralAssessment_" + componentIdentifier, "BO-1003100043-CATEGORY", "Category");
			fields[176] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.DynamicAssessments.__internal_x_context__StructuralAssessment_" + componentIdentifier, "BO-1003100043-ACTIVESTATUS", "ActiveStatus");
			fields[177] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.DynamicAssessments.__internal_x_context__StructuralAssessmentRef_" + componentIdentifier, "BO-1003100043-ID", "ID_UserAssessment");
			fields[178] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.DynamicAssessments.__internal_x_context__GraphicalAssessment_" + componentIdentifier, "BO-1028100006-ID", "ID_GraphicAssessment");
			fields[179] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.DynamicAssessments.__internal_x_context__GraphicalAssessment_" + componentIdentifier, "BO-1028100006-NAME", "Name");
			fields[180] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.DynamicAssessments.__internal_x_context__GraphicalAssessment_" + componentIdentifier, "BO-1028100006-ASSESSMENTTYPE", "AssessmentType");
			fields[181] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.DynamicAssessments.__internal_x_context__GraphicalAssessment_" + componentIdentifier, "BO-1028100006-ACTIVESTATUS", "ActiveStatus");
			fields[182] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.DynamicAssessments.__internal_x_context__GraphicalAssessment_" + componentIdentifier, "BO-1028100006-HELPURL", "HelpUrl");
			fields[183] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.DynamicAssessments.__internal_x_context__GraphicalAssessment_" + componentIdentifier, "BO-1028100006-STOREPRINTEDREPORT", "StorePrintedReport");
			fields[184] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.DynamicAssessments.__internal_x_context__GraphicalAssessment_" + componentIdentifier, "BO-1028100006-ASSOCIATEDREPORTFORPRINTING", "AssociatedReportForPrinting");
			fields[185] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.DynamicAssessments.__internal_x_context__GraphicalAssessmentRef_" + componentIdentifier, "BO-1028100006-ID", "ID_GraphicAssessment");
			fields[186] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.DynamicAssessments.__internal_x_context__RIE_" + componentIdentifier, "BO-1003100048-ID", "ID_PatientAssessment");
			fields[187] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.DynamicAssessments.__internal_x_context__RIE_" + componentIdentifier, "BO-1003100048-STATUS", "Status");
			fields[188] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.DynamicAssessments.__internal_x_context__RIE_" + componentIdentifier, "BO-1003100048-COMPLETEDDATETIME", "CompletedDateTime");
			fields[189] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.DynamicAssessments.__internal_x_context__RIE_" + componentIdentifier, "BO-1003100048-PATIENT", "Patient");
			fields[190] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.DynamicAssessments.__internal_x_context__RIE_" + componentIdentifier, "BO-1003100048-CLINICALCONTACT", "ClinicalContact");
			fields[191] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.DynamicAssessments.__internal_x_context__RIE_" + componentIdentifier, "BO-1003100048-CARECONTEXT", "CareContext");
			fields[192] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.DynamicAssessments.__internal_x_context__RIE_" + componentIdentifier, "BO-1003100048-EPISODEOFCARE", "EpisodeOfCare");
			fields[193] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.DynamicAssessments.__internal_x_context__RIE_" + componentIdentifier, "BO-1003100048-SCORE", "Score");
			fields[194] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.DynamicAssessments.__internal_x_context__RIE_" + componentIdentifier, "BO-1003100048-ISASSESSMENTDOCUMENTSAVED", "IsAssessmentDocumentSaved");
			fields[195] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.DynamicAssessments.__internal_x_context__RIE_" + componentIdentifier, "BO-1003100048-ASSOCIATEDDOCUMENT", "AssociatedDocument");
			fields[196] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.DynamicAssessments.__internal_x_context__RIE_" + componentIdentifier, "BO-1003100048-STATUSREASON", "StatusReason");
			fields[197] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.DynamicAssessments.__internal_x_context__CurrentPatientAssessment_" + componentIdentifier, "BO-1003100048-ID", "ID_PatientAssessment");
			fields[198] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.DynamicAssessments.__internal_x_context__CurrentPatientAssessment_" + componentIdentifier, "BO-1003100048-STATUS", "Status");
			fields[199] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.DynamicAssessments.__internal_x_context__CurrentPatientAssessment_" + componentIdentifier, "BO-1003100048-COMPLETEDDATETIME", "CompletedDateTime");
			fields[200] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.DynamicAssessments.__internal_x_context__CurrentPatientAssessment_" + componentIdentifier, "BO-1003100048-PATIENT", "Patient");
			fields[201] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.DynamicAssessments.__internal_x_context__CurrentPatientAssessment_" + componentIdentifier, "BO-1003100048-CLINICALCONTACT", "ClinicalContact");
			fields[202] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.DynamicAssessments.__internal_x_context__CurrentPatientAssessment_" + componentIdentifier, "BO-1003100048-CARECONTEXT", "CareContext");
			fields[203] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.DynamicAssessments.__internal_x_context__CurrentPatientAssessment_" + componentIdentifier, "BO-1003100048-EPISODEOFCARE", "EpisodeOfCare");
			fields[204] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.DynamicAssessments.__internal_x_context__CurrentPatientAssessment_" + componentIdentifier, "BO-1003100048-SCORE", "Score");
			fields[205] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.DynamicAssessments.__internal_x_context__CurrentPatientAssessment_" + componentIdentifier, "BO-1003100048-ISASSESSMENTDOCUMENTSAVED", "IsAssessmentDocumentSaved");
			fields[206] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.DynamicAssessments.__internal_x_context__CurrentPatientAssessment_" + componentIdentifier, "BO-1003100048-ASSOCIATEDDOCUMENT", "AssociatedDocument");
			fields[207] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.DynamicAssessments.__internal_x_context__CurrentPatientAssessment_" + componentIdentifier, "BO-1003100048-STATUSREASON", "StatusReason");
			fields[208] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.DynamicAssessments.__internal_x_context__CopyAnswersFromPreviousAssessment_" + componentIdentifier, "BO-1003100048-ID", "ID_PatientAssessment");
			return fields;
		}
