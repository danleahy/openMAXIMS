...
public class GenForm extends FormBridge
{
	...
	public static class lyrDetailsLayer extends Layer
	{
		...
		public static class tabImagesContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				super.addControl(factory.getControl(DrawingControl.class, new Object[] { control, new Integer(startControlID.intValue() + 1001), new Integer(anchoringHelper2.getX()), new Integer(anchoringHelper2.getY()), new Integer(anchoringHelper2.getWidth()), new Integer(anchoringHelper2.getHeight()), new Integer(startTabIndex.intValue() + 11), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Boolean(true)}));
			}
		...
		public static class tabFindingsContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				super.addControl(factory.getControl(DynamicGrid.class, new Object[] { control, new Integer(startControlID.intValue() + 1004), new Integer(anchoringHelper5.getX()), new Integer(anchoringHelper5.getY()), new Integer(anchoringHelper5.getWidth()), new Integer(anchoringHelper5.getHeight()), new Integer(startTabIndex.intValue() + 13), ControlState.READONLY, ControlState.EDITABLE, ims.framework.enumerations.ControlAnchoring.TOPBOTTOMLEFT, contextMenus.contextMenuFindingMenu, Boolean.FALSE, Boolean.FALSE, Boolean.TRUE}));
			}
		...
		public static class tabStagesContainer extends LayerBridge
		{
			...
			public static class ctnStageDetailsContainer extends ContainerBridge
			{
				...
				protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
				{
					...
					super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1007), new Integer(anchoringHelper8.getX()), new Integer(anchoringHelper8.getY()), new Integer(anchoringHelper8.getWidth()), new Integer(anchoringHelper8.getHeight()), new Integer(startTabIndex.intValue() + 20), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Cancel", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
					...
					super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1008), new Integer(anchoringHelper9.getX()), new Integer(anchoringHelper9.getY()), new Integer(anchoringHelper9.getWidth()), new Integer(anchoringHelper9.getHeight()), new Integer(startTabIndex.intValue() + 19), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Add", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
					...
					ComboBox m_cmbStageTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1010), new Integer(anchoringHelper11.getX()), new Integer(anchoringHelper11.getY()), new Integer(anchoringHelper11.getWidth()), new Integer(anchoringHelper11.getHeight()), new Integer(startTabIndex.intValue() + 18), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.BOTTOMLEFTRIGHT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
					...
					super.addControl(factory.getControl(CheckBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1011), new Integer(anchoringHelper12.getX()), new Integer(anchoringHelper12.getY()), new Integer(anchoringHelper12.getWidth()), new Integer(anchoringHelper12.getHeight()), new Integer(startTabIndex.intValue() + 17), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT ,"Annotated", Boolean.TRUE, null}));
				}
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				Grid m_grdStagesTemp = (Grid)factory.getControl(Grid.class, new Object[] { control, new Integer(startControlID.intValue() + 1013), new Integer(anchoringHelper14.getX()), new Integer(anchoringHelper14.getY()), new Integer(anchoringHelper14.getWidth()), new Integer(anchoringHelper14.getHeight()), new Integer(startTabIndex.intValue() + 15), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL,Boolean.TRUE, Boolean.FALSE, new Integer(24), Boolean.TRUE, contextMenus.contextMenuStages, Boolean.FALSE, Boolean.FALSE, new Integer(0), null, Boolean.FALSE, Boolean.TRUE});
		...
		public static class tabFindingsWithStagesContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				super.addControl(factory.getControl(DynamicGrid.class, new Object[] { control, new Integer(startControlID.intValue() + 1015), new Integer(anchoringHelper16.getX()), new Integer(anchoringHelper16.getY()), new Integer(anchoringHelper16.getWidth()), new Integer(anchoringHelper16.getHeight()), new Integer(startTabIndex.intValue() + 21), ControlState.READONLY, ControlState.EDITABLE, ims.framework.enumerations.ControlAnchoring.TOPBOTTOMLEFT, contextMenus.contextMenuFindingWithStagesMenu, Boolean.FALSE, Boolean.FALSE, Boolean.TRUE}));
			}
		...
		public static class tabSpecialtiesContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				Grid m_grdSpecialitiesTemp = (Grid)factory.getControl(Grid.class, new Object[] { control, new Integer(startControlID.intValue() + 1016), new Integer(anchoringHelper17.getX()), new Integer(anchoringHelper17.getY()), new Integer(anchoringHelper17.getWidth()), new Integer(anchoringHelper17.getHeight()), new Integer(startTabIndex.intValue() + 23), ControlState.DISABLED, ControlState.READONLY, ims.framework.enumerations.ControlAnchoring.ALL,Boolean.TRUE, Boolean.FALSE, new Integer(24), Boolean.TRUE, contextMenus.contextMenuLIP, Boolean.FALSE, Boolean.TRUE, new Integer(0), null, Boolean.FALSE, Boolean.TRUE});
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		contextMenus.contextMenuUserAssessmentsADDItem = factory.createMenuItem(startControlID.intValue() + 12, "Add Scoring Assessment", true, false, new Integer(102179), true, false);
		contextMenus.contextMenuUserAssessments.add(contextMenus.contextMenuUserAssessmentsADDItem);
		contextMenus.contextMenuUserAssessmentsDPPItem = factory.createMenuItem(startControlID.intValue() + 13, "Add Daily Patient Progress", true, false, new Integer(102179), true, false);
		contextMenus.contextMenuUserAssessments.add(contextMenus.contextMenuUserAssessmentsDPPItem);
		contextMenus.contextMenuUserAssessmentsFALLRISKItem = factory.createMenuItem(startControlID.intValue() + 14, "Add Patient Falls Risk Assessment", true, false, new Integer(102179), true, false);
		contextMenus.contextMenuUserAssessments.add(contextMenus.contextMenuUserAssessmentsFALLRISKItem);
		contextMenus.contextMenuUserAssessmentsADLItem = factory.createMenuItem(startControlID.intValue() + 15, "Add Activities of Daily Living ", true, false, new Integer(102179), true, false);
		contextMenus.contextMenuUserAssessments.add(contextMenus.contextMenuUserAssessmentsADLItem);
		contextMenus.contextMenuUserAssessmentsSKINItem = factory.createMenuItem(startControlID.intValue() + 16, "Add Skin Management", true, false, new Integer(102179), true, false);
		contextMenus.contextMenuUserAssessments.add(contextMenus.contextMenuUserAssessmentsSKINItem);
		contextMenus.contextMenuUserAssessmentsBLADItem = factory.createMenuItem(startControlID.intValue() + 17, "Add Bladder Management", true, false, new Integer(102179), true, false);
		contextMenus.contextMenuUserAssessments.add(contextMenus.contextMenuUserAssessmentsBLADItem);
		contextMenus.contextMenuUserAssessmentsBWELItem = factory.createMenuItem(startControlID.intValue() + 18, "Add Bowel Management", true, false, new Integer(102179), true, false);
		contextMenus.contextMenuUserAssessments.add(contextMenus.contextMenuUserAssessmentsBWELItem);
		contextMenus.contextMenuUserAssessmentsMOBItem = factory.createMenuItem(startControlID.intValue() + 19, "Add Mobility", true, false, new Integer(102179), true, false);
		contextMenus.contextMenuUserAssessments.add(contextMenus.contextMenuUserAssessmentsMOBItem);
		contextMenus.contextMenuUserAssessmentsWCItem = factory.createMenuItem(startControlID.intValue() + 20, "Add Wheelchair and Equipment", true, false, new Integer(102179), true, false);
		contextMenus.contextMenuUserAssessments.add(contextMenus.contextMenuUserAssessmentsWCItem);
		contextMenus.contextMenuUserAssessmentsCOMItem = factory.createMenuItem(startControlID.intValue() + 21, "Add Community Preparation", true, false, new Integer(102179), true, false);
		contextMenus.contextMenuUserAssessments.add(contextMenus.contextMenuUserAssessmentsCOMItem);
		contextMenus.contextMenuUserAssessmentsDISItem = factory.createMenuItem(startControlID.intValue() + 22, "Add Discharge Coordination", true, false, new Integer(102179), true, false);
		contextMenus.contextMenuUserAssessments.add(contextMenus.contextMenuUserAssessmentsDISItem);
		contextMenus.contextMenuUserAssessmentsPSYItem = factory.createMenuItem(startControlID.intValue() + 23, "Add Psychological Issues", true, false, new Integer(102179), true, false);
		contextMenus.contextMenuUserAssessments.add(contextMenus.contextMenuUserAssessmentsPSYItem);
		contextMenus.contextMenuUserAssessmentsNURSEDISCHARGECHKLSTItem = factory.createMenuItem(startControlID.intValue() + 24, "Add Nursing Discharge Checklist", true, false, new Integer(102179), true, false);
		contextMenus.contextMenuUserAssessments.add(contextMenus.contextMenuUserAssessmentsNURSEDISCHARGECHKLSTItem);
		contextMenus.contextMenuUserAssessmentsPREOPPOSSUMItem = factory.createMenuItem(startControlID.intValue() + 25, "Add Preopossum", true, false, new Integer(102179), true, false);
		contextMenus.contextMenuUserAssessments.add(contextMenus.contextMenuUserAssessmentsPREOPPOSSUMItem);
		contextMenus.contextMenuUserAssessmentsOPERATIVEDETAILSPOSSUMItem = factory.createMenuItem(startControlID.intValue() + 26, "Add Operative Details Possum", true, false, new Integer(102179), true, false);
		contextMenus.contextMenuUserAssessments.add(contextMenus.contextMenuUserAssessmentsOPERATIVEDETAILSPOSSUMItem);
		contextMenus.contextMenuUserAssessmentsNEW_NON_SCORINGItem = factory.createMenuItem(startControlID.intValue() + 27, "Add Non Scoring Assessment", true, false, new Integer(102179), true, true);
		contextMenus.contextMenuUserAssessments.add(contextMenus.contextMenuUserAssessmentsNEW_NON_SCORINGItem);
		contextMenus.contextMenuUserAssessmentsDISCHARGECHECKLISTItem = factory.createMenuItem(startControlID.intValue() + 28, "Add Discharge Checklist", true, false, new Integer(102179), true, false);
		contextMenus.contextMenuUserAssessments.add(contextMenus.contextMenuUserAssessmentsDISCHARGECHECKLISTItem);
		contextMenus.contextMenuUserAssessmentsNURSING_DISCHARGEItem = factory.createMenuItem(startControlID.intValue() + 29, "Add Nursing Discharge", true, false, new Integer(102179), true, false);
		contextMenus.contextMenuUserAssessments.add(contextMenus.contextMenuUserAssessmentsNURSING_DISCHARGEItem);
		contextMenus.contextMenuUserAssessmentsNURSING_DISCHARGE_PLANNINGItem = factory.createMenuItem(startControlID.intValue() + 30, "Add Nursing Discharge Planning", true, false, new Integer(102179), true, false);
		contextMenus.contextMenuUserAssessments.add(contextMenus.contextMenuUserAssessmentsNURSING_DISCHARGE_PLANNINGItem);
		contextMenus.contextMenuUserAssessmentsADD_NEW_BASED_ON_PREVIOUSItem = factory.createMenuItem(startControlID.intValue() + 31, "Add Assessment based on ", true, false, new Integer(102222), true, true);
		contextMenus.contextMenuUserAssessments.add(contextMenus.contextMenuUserAssessmentsADD_NEW_BASED_ON_PREVIOUSItem);
		contextMenus.contextMenuUserAssessmentsMANCHESTERTRIAGEItem = factory.createMenuItem(startControlID.intValue() + 32, "Add Manchester Triage Protocol", true, false, new Integer(102179), true, false);
		contextMenus.contextMenuUserAssessments.add(contextMenus.contextMenuUserAssessmentsMANCHESTERTRIAGEItem);
		contextMenus.contextMenuUserAssessmentsEDITItem = factory.createMenuItem(startControlID.intValue() + 33, "Edit", true, false, new Integer(102150), true, false);
		contextMenus.contextMenuUserAssessments.add(contextMenus.contextMenuUserAssessmentsEDITItem);
		contextMenus.contextMenuUserAssessmentsVIEWItem = factory.createMenuItem(startControlID.intValue() + 34, "View", true, false, new Integer(102223), false, true);
		contextMenus.contextMenuUserAssessments.add(contextMenus.contextMenuUserAssessmentsVIEWItem);
		contextMenus.contextMenuUserAssessmentsPREVIEWItem = factory.createMenuItem(startControlID.intValue() + 35, "Preview", true, false, new Integer(102221), false, true);
		contextMenus.contextMenuUserAssessments.add(contextMenus.contextMenuUserAssessmentsPREVIEWItem);
		contextMenus.contextMenuUserAssessmentsMOVE_UPItem = factory.createMenuItem(startControlID.intValue() + 36, "Move Up", true, false, new Integer(102197), true, false);
		contextMenus.contextMenuUserAssessments.add(contextMenus.contextMenuUserAssessmentsMOVE_UPItem);
		contextMenus.contextMenuUserAssessmentsMOVE_DOWNItem = factory.createMenuItem(startControlID.intValue() + 37, "Move Down", true, false, new Integer(102198), true, false);
		contextMenus.contextMenuUserAssessments.add(contextMenus.contextMenuUserAssessmentsMOVE_DOWNItem);
		contextMenus.contextMenuUserAssessmentsINTRODUCTORY_PHONE_CALLItem = factory.createMenuItem(startControlID.intValue() + 38, "Add Introductory Phone Call", true, false, new Integer(102179), true, true);
		...
		contextMenus.contextMenuFindingMenuAddItem = factory.createMenuItem(startControlID.intValue() + 39, "Add Finding", true, false, new Integer(102179), true, false);
		contextMenus.contextMenuFindingMenu.add(contextMenus.contextMenuFindingMenuAddItem);
		contextMenus.contextMenuFindingMenuEditItem = factory.createMenuItem(startControlID.intValue() + 40, "Edit Finding", true, false, new Integer(102150), true, false);
		contextMenus.contextMenuFindingMenu.add(contextMenus.contextMenuFindingMenuEditItem);
		contextMenus.contextMenuFindingMenuRemoveItem = factory.createMenuItem(startControlID.intValue() + 41, "Remove Finding", true, false, new Integer(102148), true, false);
		contextMenus.contextMenuFindingMenu.add(contextMenus.contextMenuFindingMenuRemoveItem);
		contextMenus.contextMenuFindingMenuCloneItem = factory.createMenuItem(startControlID.intValue() + 42, "Clone", true, false, new Integer(102222), true, true);
		...
		contextMenus.contextMenuQuestionsAddItem = factory.createMenuItem(startControlID.intValue() + 43, "Add Question", true, false, new Integer(102215), true, false);
		contextMenus.contextMenuQuestions.add(contextMenus.contextMenuQuestionsAddItem);
		contextMenus.contextMenuQuestionsEditItem = factory.createMenuItem(startControlID.intValue() + 44, "Edit Question", true, false, new Integer(102216), true, false);
		contextMenus.contextMenuQuestions.add(contextMenus.contextMenuQuestionsEditItem);
		contextMenus.contextMenuQuestionsRemoveItem = factory.createMenuItem(startControlID.intValue() + 45, "Remove Question", true, false, new Integer(102148), true, false);
		contextMenus.contextMenuQuestions.add(contextMenus.contextMenuQuestionsRemoveItem);
		contextMenus.contextMenuQuestionsMoveUpItem = factory.createMenuItem(startControlID.intValue() + 46, "Move Up", true, false, new Integer(103116), true, false);
		contextMenus.contextMenuQuestions.add(contextMenus.contextMenuQuestionsMoveUpItem);
		contextMenus.contextMenuQuestionsMoveDownItem = factory.createMenuItem(startControlID.intValue() + 47, "Move Down", true, false, new Integer(103117), true, false);
		...
		contextMenus.contextMenuStagesADD_STAGEItem = factory.createMenuItem(startControlID.intValue() + 48, "Add Stage", true, false, new Integer(102179), true, false);
		contextMenus.contextMenuStages.add(contextMenus.contextMenuStagesADD_STAGEItem);
		contextMenus.contextMenuStagesEDIT_STAGEItem = factory.createMenuItem(startControlID.intValue() + 49, "Edit Stage", true, false, new Integer(102150), true, false);
		contextMenus.contextMenuStages.add(contextMenus.contextMenuStagesEDIT_STAGEItem);
		contextMenus.contextMenuStagesREMOVE_STAGEItem = factory.createMenuItem(startControlID.intValue() + 50, "Remove Stage", true, false, new Integer(102148), true, true);
		...
		contextMenus.contextMenuFindingWithStagesMenuADDItem = factory.createMenuItem(startControlID.intValue() + 51, "Add Finding", true, false, new Integer(102179), true, false);
		contextMenus.contextMenuFindingWithStagesMenu.add(contextMenus.contextMenuFindingWithStagesMenuADDItem);
		contextMenus.contextMenuFindingWithStagesMenuREMOVEItem = factory.createMenuItem(startControlID.intValue() + 52, "Remove Finding", true, false, new Integer(102148), true, false);
		contextMenus.contextMenuFindingWithStagesMenu.add(contextMenus.contextMenuFindingWithStagesMenuREMOVEItem);
		contextMenus.contextMenuFindingWithStagesMenuCOPYItem = factory.createMenuItem(startControlID.intValue() + 53, "Copy Questions", true, false, new Integer(102222), true, true);
		contextMenus.contextMenuFindingWithStagesMenu.add(contextMenus.contextMenuFindingWithStagesMenuCOPYItem);
		contextMenus.contextMenuFindingWithStagesMenuPASTEItem = factory.createMenuItem(startControlID.intValue() + 54, "Paste Questions", true, false, new Integer(102182), true, false);
		...
		contextMenus.contextMenuLIPNewItem = factory.createMenuItem(startControlID.intValue() + 55, "New", true, false, new Integer(102179), true, false);
		contextMenus.contextMenuLIP.add(contextMenus.contextMenuLIPNewItem);
		contextMenus.contextMenuLIPUpdateItem = factory.createMenuItem(startControlID.intValue() + 56, "Edit", true, false, new Integer(102150), true, false);
	...
	public final class ContextMenus implements java.io.Serializable
	{
		...
		public final class UserAssessments implements java.io.Serializable
		{
			...
			public static final int FALLRISK = 14;
			public static final int ADL = 15;
			public static final int SKIN = 16;
			public static final int BLAD = 17;
			public static final int BWEL = 18;
			public static final int MOB = 19;
			public static final int WC = 20;
			public static final int COM = 21;
			public static final int DIS = 22;
			public static final int PSY = 23;
			public static final int NURSEDISCHARGECHKLST = 24;
			public static final int PREOPPOSSUM = 25;
			public static final int OPERATIVEDETAILSPOSSUM = 26;
			public static final int NEW_NON_SCORING = 27;
			public static final int DISCHARGECHECKLIST = 28;
			public static final int NURSING_DISCHARGE = 29;
			public static final int NURSING_DISCHARGE_PLANNING = 30;
			public static final int ADD_NEW_BASED_ON_PREVIOUS = 31;
			public static final int MANCHESTERTRIAGE = 32;
			public static final int EDIT = 33;
			public static final int VIEW = 34;
			public static final int PREVIEW = 35;
			public static final int MOVE_UP = 36;
			public static final int MOVE_DOWN = 37;
			public static final int INTRODUCTORY_PHONE_CALL = 38;
		}
		...
		public final class FindingMenu implements java.io.Serializable
		{
			...
			public static final int Clone = 42;
		}
		...
		public final class Questions implements java.io.Serializable
		{
			...
			public static final int Edit = 44;
			public static final int Remove = 45;
			public static final int MoveUp = 46;
			public static final int MoveDown = 47;
		}
		...
		{
			private static final long serialVersionUID = 1L;
			public static final int ADD_STAGE = 48;
			public static final int EDIT_STAGE = 49;
			public static final int REMOVE_STAGE = 50;
		}
		...
		public final class FindingWithStagesMenu implements java.io.Serializable
		{
			...
			public static final int REMOVE = 52;
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, "_cv_Core.GraphicAssessmentShortVo", "BO-1028100006-ID", "ID_GraphicAssessment");
			fields[145] = new ims.framework.ReportField(this.context, "_cv_Core.GraphicAssessmentShortVo", "BO-1028100006-NAME", "Name");
			fields[146] = new ims.framework.ReportField(this.context, "_cv_Core.GraphicAssessmentShortVo", "BO-1028100006-ASSESSMENTTYPE", "AssessmentType");
			fields[147] = new ims.framework.ReportField(this.context, "_cv_Core.GraphicAssessmentShortVo", "BO-1028100006-ACTIVESTATUS", "ActiveStatus");
			fields[148] = new ims.framework.ReportField(this.context, "_cv_Core.GraphicAssessmentShortVo", "BO-1028100006-HELPURL", "HelpUrl");
			fields[149] = new ims.framework.ReportField(this.context, "_cv_Core.GraphicAssessmentShortVo", "BO-1028100006-STOREPRINTEDREPORT", "StorePrintedReport");
			fields[150] = new ims.framework.ReportField(this.context, "_cv_Core.GraphicAssessmentShortVo", "BO-1028100006-ASSOCIATEDREPORTFORPRINTING", "AssociatedReportForPrinting");
			fields[151] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedDrawingGraphicFindingVo", "BO-1028100011-ID", "ID_DrawingGraphicFinding");
			fields[152] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedDrawingGraphicFindingVo", "BO-1028100011-DESCRIPTION", "Description");
			fields[153] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedDrawingGraphicFindingVo", "BO-1028100011-DISPLAYTEXT", "DisplayText");
			fields[154] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedDrawingGraphicFindingVo", "BO-1028100011-COLOUR", "Colour");
			fields[155] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedDrawingGraphicFindingVo", "BO-1028100011-ISSINGLEMARK", "IsSingleMark");
			fields[156] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedDrawingGraphicFindingVo", "BO-1028100011-ACTIVESTATUS", "ActiveStatus");
			fields[157] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedQuestion", "BO-1058100000-ID", "ID_QuestionInformation");
			fields[158] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedQuestion", "BO-1058100000-TEXT", "Text");
			fields[159] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedQuestion", "BO-1058100000-SHORTTEXT", "ShortText");
			fields[160] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedQuestion", "BO-1058100000-ISQUESTION", "IsQuestion");
			fields[161] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedQuestion", "BO-1058100000-GENDERSPECIFIC", "GenderSpecific");
			fields[162] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedQuestion", "BO-1058100000-AGERANGEMIN", "AgeRangeMin");
			fields[163] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedQuestion", "BO-1058100000-AGERANGEMAX", "AgeRangeMax");
			fields[164] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedQuestion", "BO-1058100000-STATUS", "Status");
			fields[165] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedQuestion", "BO-1058100000-LEGENDTEXT", "LegendText");
			fields[166] = new ims.framework.ReportField(this.context, "_cv_Core.DrawingGraphicImageVo", "BO-1028100007-ID", "ID_DrawingGraphicImage");
			fields[167] = new ims.framework.ReportField(this.context, "_cv_Core.DrawingGraphicImageVo", "BO-1028100007-IMAGENAME", "ImageName");
			fields[168] = new ims.framework.ReportField(this.context, "_cv_Core.DrawingGraphicImageVo", "BO-1028100007-IMAGEDESCRIPTION", "ImageDescription");
			fields[169] = new ims.framework.ReportField(this.context, "_cv_Core.DrawingGraphicImageVo", "BO-1028100007-VERSIONNUMBER", "VersionNumber");
			fields[170] = new ims.framework.ReportField(this.context, "_cv_Core.DrawingGraphicImageVo", "BO-1028100007-IMAGESTATUS", "ImageStatus");
			fields[171] = new ims.framework.ReportField(this.context, "_cv_Core.ReportTemplateRef", "BO-1004100008-ID", "ID_TemplateBo");
			fields[172] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.GraphicAssessmentNew.__internal_x_context__GraphicAssessmentVo_" + componentIdentifier, "BO-1028100006-ID", "ID_GraphicAssessment");
			fields[173] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.GraphicAssessmentNew.__internal_x_context__GraphicAssessmentVo_" + componentIdentifier, "BO-1028100006-NAME", "Name");
			fields[174] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.GraphicAssessmentNew.__internal_x_context__GraphicAssessmentVo_" + componentIdentifier, "BO-1028100006-ASSESSMENTTYPE", "AssessmentType");
			fields[175] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.GraphicAssessmentNew.__internal_x_context__GraphicAssessmentVo_" + componentIdentifier, "BO-1028100006-ACTIVESTATUS", "ActiveStatus");
			fields[176] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.GraphicAssessmentNew.__internal_x_context__GraphicAssessmentVo_" + componentIdentifier, "BO-1028100006-HELPURL", "HelpUrl");
			fields[177] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.GraphicAssessmentNew.__internal_x_context__GraphicAssessmentVo_" + componentIdentifier, "BO-1028100006-STOREPRINTEDREPORT", "StorePrintedReport");
			fields[178] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.GraphicAssessmentNew.__internal_x_context__GraphicAssessmentVo_" + componentIdentifier, "BO-1028100006-ASSOCIATEDREPORTFORPRINTING", "AssociatedReportForPrinting");
			fields[179] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.GraphicAssessmentNew.__internal_x_context__CurrentStage_" + componentIdentifier, "BO-1083100003-ID", "ID_GraphicAssessmentStage");
			fields[180] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.GraphicAssessmentNew.__internal_x_context__CurrentStage_" + componentIdentifier, "BO-1083100003-ISANNOTATED", "IsAnnotated");
			fields[181] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.GraphicAssessmentNew.__internal_x_context__CurrentStage_" + componentIdentifier, "BO-1083100003-STAGENAME", "StageName");
			fields[182] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.GraphicAssessmentNew.__internal_x_context__CurrentStage_" + componentIdentifier, "BO-1083100003-ISACTIVE", "IsActive");
			fields[183] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.GraphicAssessmentNew.__internal_x_context__LinkedReport_" + componentIdentifier, "BO-1004100008-ID", "ID_TemplateBo");
			return fields;
		}
