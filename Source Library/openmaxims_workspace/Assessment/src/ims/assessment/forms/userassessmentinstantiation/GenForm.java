...
public class GenForm extends FormBridge
{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1006), new Integer(anchoringHelper6.getX()), new Integer(anchoringHelper6.getY()), new Integer(anchoringHelper6.getWidth()), new Integer(anchoringHelper6.getHeight()), new Integer(startTabIndex.intValue() + 6), ControlState.HIDDEN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Save", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		ComboBox m_cmbStatusTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1009), new Integer(anchoringHelper9.getX()), new Integer(anchoringHelper9.getY()), new Integer(anchoringHelper9.getWidth()), new Integer(anchoringHelper9.getHeight()), new Integer(startTabIndex.intValue() + 4), ControlState.DISABLED, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.BOTTOMLEFTRIGHT ,Boolean.TRUE, Boolean.TRUE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.TRUE, new Integer(-1)});
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, "_cv_Assessment.PatientUserDefinedObject", "BO-1085100000-ID", "ID_PatientUserDefinedObject");
			fields[145] = new ims.framework.ReportField(this.context, "_cv_Clinical.PatientAssessment.EditedComponent", "BO-1028100005-ID", "ID_UserDefinedObjectComponent");
			fields[146] = new ims.framework.ReportField(this.context, "_cv_Clinical.PatientAssessment.SelectedAssessment", "BO-1003100048-ID", "ID_PatientAssessment");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.UserAssessmentInstantiation.__internal_x_context__CurrentAssessment_" + componentIdentifier, "BO-1003100048-ID", "ID_PatientAssessment");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.UserAssessmentInstantiation.__internal_x_context__CurrentAssessment_" + componentIdentifier, "BO-1003100048-STATUS", "Status");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.UserAssessmentInstantiation.__internal_x_context__CurrentAssessment_" + componentIdentifier, "BO-1003100048-COMPLETEDDATETIME", "CompletedDateTime");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.UserAssessmentInstantiation.__internal_x_context__CurrentAssessment_" + componentIdentifier, "BO-1003100048-STATUSREASON", "StatusReason");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.UserAssessmentInstantiation.__internal_x_context__CurrentAssessment_" + componentIdentifier, "BO-1003100048-STATUSREASONTEXT", "StatusReasonText");
			fields[152] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.UserAssessmentInstantiation.__internal_x_context__CurrentAssessment_" + componentIdentifier, "BO-1003100048-DPPTYPE", "DPPType");
			fields[153] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.UserAssessmentInstantiation.__internal_x_context__CurrentAssessment_" + componentIdentifier, "BO-1003100048-DPPTYPETEXT", "DPPTypeText");
			fields[154] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.UserAssessmentInstantiation.__internal_x_context__CurrentAssessment_" + componentIdentifier, "BO-1003100048-ISCURRENTFORTYPE", "IsCurrentForType");
			fields[155] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.UserAssessmentInstantiation.__internal_x_context__CurrentAssessment_" + componentIdentifier, "BO-1003100048-CLINICALCONTACT", "ClinicalContact");
			fields[156] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.UserAssessmentInstantiation.__internal_x_context__CurrentAssessment_" + componentIdentifier, "BO-1003100048-CARECONTEXT", "CareContext");
			fields[157] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.UserAssessmentInstantiation.__internal_x_context__CurrentAssessment_" + componentIdentifier, "BO-1003100048-EPISODEOFCARE", "EpisodeOfCare");
			fields[158] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.UserAssessmentInstantiation.__internal_x_context__CurrentAssessment_" + componentIdentifier, "BO-1003100048-PATIENT", "Patient");
			fields[159] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.UserAssessmentInstantiation.__internal_x_context__CurrentAssessment_" + componentIdentifier, "BO-1003100048-SCORE", "Score");
			fields[160] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.UserAssessmentInstantiation.__internal_x_context__CurrentAssessment_" + componentIdentifier, "BO-1003100048-ISASSESSMENTDOCUMENTSAVED", "IsAssessmentDocumentSaved");
			return fields;
		}
