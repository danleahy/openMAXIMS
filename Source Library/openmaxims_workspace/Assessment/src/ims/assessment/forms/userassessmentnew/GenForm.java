...
public class GenForm extends FormBridge
{
	...
	public static class lyrTabsLayer extends Layer
	{
		...
		public static class tabAssessmentsContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				super.addControl(factory.getControl(DynamicGrid.class, new Object[] { control, new Integer(startControlID.intValue() + 1000), new Integer(anchoringHelper1.getX()), new Integer(anchoringHelper1.getY()), new Integer(anchoringHelper1.getWidth()), new Integer(anchoringHelper1.getHeight()), new Integer(startTabIndex.intValue() + 21), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, contextMenus.contextMenuUserAssessmentNew, Boolean.FALSE, Boolean.FALSE, Boolean.TRUE}));
			}
		...
		public static class tabRolesContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				super.addControl(factory.getControl(DynamicGrid.class, new Object[] { control, new Integer(startControlID.intValue() + 1005), new Integer(anchoringHelper6.getX()), new Integer(anchoringHelper6.getY()), new Integer(anchoringHelper6.getWidth()), new Integer(anchoringHelper6.getHeight()), new Integer(startTabIndex.intValue() + 24), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, null, Boolean.FALSE, Boolean.FALSE, Boolean.TRUE}));
			}
		...
		public static class tabTaxonomyContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				ims.framework.FormUiLogic m_ccTaxonomyForm = loader.loadComponent(104124, appForm, startControlID * 10 + 1000, anchoringHelper8.getSize(), instance1, startTabIndex.intValue() + 26, skipContextValidation);
				//ims.framework.Control m_ccTaxonomyControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1007), new Integer(192), new Integer(0), new Integer(432), new Integer(360), ControlState.ENABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 26), m_ccTaxonomyForm, instance1 } );
				ims.framework.Control m_ccTaxonomyControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1008),  new Integer(anchoringHelper8.getX()), new Integer(anchoringHelper8.getY()), new Integer(anchoringHelper8.getWidth()), new Integer(anchoringHelper8.getHeight()), ControlState.ENABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 26), m_ccTaxonomyForm, instance1, Boolean.FALSE } );
		...
		public static class tabFooterTextContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				super.addControl(factory.getControl(IntBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1013), new Integer(anchoringHelper13.getX()), new Integer(anchoringHelper13.getY()), new Integer(anchoringHelper13.getWidth()), new Integer(anchoringHelper13.getHeight()), new Integer(startTabIndex.intValue() + 31), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT,Boolean.TRUE, Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, new Integer(9)}));
				...
				super.addControl(factory.getControl(RichTextControl.class, new Object[] { control, new Integer(startControlID.intValue() + 1014), new Integer(anchoringHelper14.getX()), new Integer(anchoringHelper14.getY()), new Integer(anchoringHelper14.getWidth()), new Integer(anchoringHelper14.getHeight()), new Integer(startTabIndex.intValue() + 30), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.ALL, Boolean.FALSE, Boolean.FALSE, new Integer(5000)} ));
			}
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		contextMenus.contextMenuGenericGridCOPYItem = factory.createMenuItem(startControlID.intValue() + 23, "Copy", true, false, new Integer(102222), true, false);
		...
		contextMenus.contextMenuGenericGridREMOVE_UNVERIFIED_NHS_NUMBERItem = factory.createMenuItem(startControlID.intValue() + 24, "Remove Unverified NHS Number", true, false, new Integer(102300), true, false);
		...
		contextMenus.contextMenuLIPNewItem = factory.createMenuItem(startControlID.intValue() + 25, "New", true, false, new Integer(102179), true, false);
		contextMenus.contextMenuLIP.add(contextMenus.contextMenuLIPNewItem);
		contextMenus.contextMenuLIPUpdateItem = factory.createMenuItem(startControlID.intValue() + 26, "Edit", true, false, new Integer(102150), true, false);
		...
		contextMenus.Assessment.contextMenuServiceMenuUPDATEItem = factory.createMenuItem(startControlID.intValue() + 27, "Update Services", true, false, new Integer(102179), true, false);
		...
		contextMenus.Assessment.contextMenuServiceMenuREMOVEItem = factory.createMenuItem(startControlID.intValue() + 28, "Remove Service", true, false, new Integer(102300), true, false);
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1040), new Integer(anchoringHelper40.getX()), new Integer(anchoringHelper40.getY()), new Integer(anchoringHelper40.getWidth()), new Integer(anchoringHelper40.getHeight()), new Integer(startTabIndex.intValue() + 35), ControlState.HIDDEN, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Cancel", Boolean.FALSE, null, Boolean.FALSE, Boolean.FALSE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1041), new Integer(anchoringHelper41.getX()), new Integer(anchoringHelper41.getY()), new Integer(anchoringHelper41.getWidth()), new Integer(anchoringHelper41.getHeight()), new Integer(startTabIndex.intValue() + 34), ControlState.HIDDEN, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Save", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1043), new Integer(anchoringHelper43.getX()), new Integer(anchoringHelper43.getY()), new Integer(anchoringHelper43.getWidth()), new Integer(anchoringHelper43.getHeight()), new Integer(startTabIndex.intValue() + 8), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT,Boolean.FALSE, new Integer(1024), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
		...
		super.addControl(factory.getControl(CheckBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1053), new Integer(anchoringHelper53.getX()), new Integer(anchoringHelper53.getY()), new Integer(anchoringHelper53.getWidth()), new Integer(anchoringHelper53.getHeight()), new Integer(startTabIndex.intValue() + 18), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,"Custom Group/Question Width:", Boolean.TRUE, null}));
		...
		super.addControl(factory.getControl(CheckBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1055), new Integer(anchoringHelper55.getX()), new Integer(anchoringHelper55.getY()), new Integer(anchoringHelper55.getWidth()), new Integer(anchoringHelper55.getHeight()), new Integer(startTabIndex.intValue() + 16), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,"Contains Multiple Groups", Boolean.TRUE, null}));
		...
		super.addControl(factory.getControl(CheckBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1056), new Integer(anchoringHelper56.getX()), new Integer(anchoringHelper56.getY()), new Integer(anchoringHelper56.getWidth()), new Integer(anchoringHelper56.getHeight()), new Integer(startTabIndex.intValue() + 17), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,"Flat view", Boolean.TRUE, null}));
		...
		super.addControl(factory.getControl(IntBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1057), new Integer(anchoringHelper57.getX()), new Integer(anchoringHelper57.getY()), new Integer(anchoringHelper57.getWidth()), new Integer(anchoringHelper57.getHeight()), new Integer(startTabIndex.intValue() + 19), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.TRUE, Boolean.FALSE, Boolean.FALSE, null, null, Boolean.FALSE, new Integer(9)}));
	...
	public final class ContextMenus implements java.io.Serializable
	{
		...
		public final class GenericGrid implements java.io.Serializable
		{
			...
			public static final int REMOVE_UNVERIFIED_NHS_NUMBER = 24;
		}
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedUserAssessment", "BO-1003100043-ID", "ID_UserAssessment");
			fields[145] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedUserAssessment", "BO-1003100043-NAME", "Name");
			fields[146] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedUserAssessment", "BO-1003100043-DESCRIPTION", "Description");
			fields[147] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedUserAssessment", "BO-1003100043-ASSESSMENTTYPE", "AssessmentType");
			fields[148] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedUserAssessment", "BO-1003100043-ACTIVESTATUS", "ActiveStatus");
			fields[149] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedUserAssessment", "BO-1003100043-HELPURL", "HelpURL");
			fields[150] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedUserAssessment", "BO-1003100043-SCORINGMETHOD", "ScoringMethod");
			fields[151] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedUserAssessment", "BO-1003100043-ISFLATVIEW", "IsFlatView");
			fields[152] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedUserAssessment", "BO-1003100043-CATEGORY", "Category");
			fields[153] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedUserAssessment", "BO-1003100043-ISMULTIPLEGROUP", "IsMultipleGroup");
			fields[154] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedUserAssessment", "BO-1003100043-GROUPQUESTIONWIDTH", "GroupQuestionWidth");
			fields[155] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedUserAssessment", "BO-1003100043-STOREPRINTEDASSESSMENT", "StorePrintedAssessment");
			fields[156] = new ims.framework.ReportField(this.context, "_cv_Core.UserAssessmentFilter", "BO-1003100043-ID", "ID_UserAssessment");
			fields[157] = new ims.framework.ReportField(this.context, "_cv_Core.UserAssessmentFilter", "BO-1003100043-NAME", "Name");
			fields[158] = new ims.framework.ReportField(this.context, "_cv_Core.UserAssessmentFilter", "BO-1003100043-DESCRIPTION", "Description");
			fields[159] = new ims.framework.ReportField(this.context, "_cv_Core.UserAssessmentFilter", "BO-1003100043-ASSESSMENTTYPE", "AssessmentType");
			fields[160] = new ims.framework.ReportField(this.context, "_cv_Core.UserAssessmentFilter", "BO-1003100043-ACTIVESTATUS", "ActiveStatus");
			fields[161] = new ims.framework.ReportField(this.context, "_cv_Core.UserAssessmentFilter", "BO-1003100043-HELPURL", "HelpURL");
			fields[162] = new ims.framework.ReportField(this.context, "_cv_Core.UserAssessmentFilter", "BO-1003100043-SCORINGMETHOD", "ScoringMethod");
			fields[163] = new ims.framework.ReportField(this.context, "_cv_Core.UserAssessmentFilter", "BO-1003100043-ISFLATVIEW", "IsFlatView");
			fields[164] = new ims.framework.ReportField(this.context, "_cv_Core.UserAssessmentFilter", "BO-1003100043-CATEGORY", "Category");
			fields[165] = new ims.framework.ReportField(this.context, "_cv_Core.UserAssessmentFilter", "BO-1003100043-ISMULTIPLEGROUP", "IsMultipleGroup");
			fields[166] = new ims.framework.ReportField(this.context, "_cv_Core.UserAssessmentFilter", "BO-1003100043-GROUPQUESTIONWIDTH", "GroupQuestionWidth");
			fields[167] = new ims.framework.ReportField(this.context, "_cv_Core.UserAssessmentFilter", "BO-1003100043-STOREPRINTEDASSESSMENT", "StorePrintedAssessment");
			fields[168] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedAssessmentQuestion", "BO-1003100045-ID", "ID_AssessmentQuestion");
			fields[169] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedAssessmentQuestion", "BO-1003100045-ISMANDATORY", "IsMandatory");
			fields[170] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedAssessmentQuestion", "BO-1003100045-ACTIVESTATUS", "ActiveStatus");
			fields[171] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedAssessmentQuestion", "BO-1003100045-SEQUENCE", "Sequence");
			fields[172] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedAssessmentQuestion", "BO-1003100045-ALLOWSMULTIPLEANSWERS", "AllowsMultipleAnswers");
			fields[173] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedAssessmentQuestion", "BO-1003100045-ISNONSTANDARD", "IsNonStandard");
			fields[174] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedAssessmentQuestion", "BO-1003100045-URL", "URL");
			fields[175] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedAssessmentQuestion", "BO-1003100045-PROTOCOL", "Protocol");
			fields[176] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedAssessmentQuestion", "BO-1003100045-LEGENDTEXT", "LegendText");
			fields[177] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedQuestionGroup", "BO-1003100047-ID", "ID_AssessmentQuestionGroup");
			fields[178] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedQuestionGroup", "BO-1003100047-NAME", "Name");
			fields[179] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedQuestionGroup", "BO-1003100047-ACTIVESTATUS", "ActiveStatus");
			fields[180] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedQuestionGroup", "BO-1003100047-GROUPSCORE", "GroupScore");
			fields[181] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedQuestionGroup", "BO-1003100047-DESCRIPTION", "Description");
			fields[182] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedQuestionGroup", "BO-1003100047-LEGENDTEXT", "LegendText");
			fields[183] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedQuestion", "BO-1058100000-ID", "ID_QuestionInformation");
			fields[184] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedQuestion", "BO-1058100000-TEXT", "Text");
			fields[185] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedQuestion", "BO-1058100000-SHORTTEXT", "ShortText");
			fields[186] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedQuestion", "BO-1058100000-ISQUESTION", "IsQuestion");
			fields[187] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedQuestion", "BO-1058100000-GENDERSPECIFIC", "GenderSpecific");
			fields[188] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedQuestion", "BO-1058100000-AGERANGEMIN", "AgeRangeMin");
			fields[189] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedQuestion", "BO-1058100000-AGERANGEMAX", "AgeRangeMax");
			fields[190] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedQuestion", "BO-1058100000-STATUS", "Status");
			fields[191] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedQuestion", "BO-1058100000-LEGENDTEXT", "LegendText");
			fields[192] = new ims.framework.ReportField(this.context, "_cv_Core.ReportTemplateRef", "BO-1004100008-ID", "ID_TemplateBo");
			fields[193] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.UserAssessmentNew.__internal_x_context__UserAssessment_" + componentIdentifier, "BO-1003100043-ID", "ID_UserAssessment");
			fields[194] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.UserAssessmentNew.__internal_x_context__UserAssessment_" + componentIdentifier, "BO-1003100043-NAME", "Name");
			fields[195] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.UserAssessmentNew.__internal_x_context__UserAssessment_" + componentIdentifier, "BO-1003100043-DESCRIPTION", "Description");
			fields[196] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.UserAssessmentNew.__internal_x_context__UserAssessment_" + componentIdentifier, "BO-1003100043-ASSESSMENTTYPE", "AssessmentType");
			fields[197] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.UserAssessmentNew.__internal_x_context__UserAssessment_" + componentIdentifier, "BO-1003100043-ACTIVESTATUS", "ActiveStatus");
			fields[198] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.UserAssessmentNew.__internal_x_context__UserAssessment_" + componentIdentifier, "BO-1003100043-HELPURL", "HelpURL");
			fields[199] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.UserAssessmentNew.__internal_x_context__UserAssessment_" + componentIdentifier, "BO-1003100043-SCORINGMETHOD", "ScoringMethod");
			fields[200] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.UserAssessmentNew.__internal_x_context__UserAssessment_" + componentIdentifier, "BO-1003100043-ISFLATVIEW", "IsFlatView");
			fields[201] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.UserAssessmentNew.__internal_x_context__UserAssessment_" + componentIdentifier, "BO-1003100043-CATEGORY", "Category");
			fields[202] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.UserAssessmentNew.__internal_x_context__UserAssessment_" + componentIdentifier, "BO-1003100043-ISMULTIPLEGROUP", "IsMultipleGroup");
			fields[203] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.UserAssessmentNew.__internal_x_context__UserAssessment_" + componentIdentifier, "BO-1003100043-GROUPQUESTIONWIDTH", "GroupQuestionWidth");
			fields[204] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.UserAssessmentNew.__internal_x_context__UserAssessment_" + componentIdentifier, "BO-1003100043-STOREPRINTEDASSESSMENT", "StorePrintedAssessment");
			fields[205] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.UserAssessmentNew.__internal_x_context__UserAssessment_" + componentIdentifier, "BO-1003100043-ISMULTIROLE", "IsMultiRole");
			fields[206] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.UserAssessmentNew.__internal_x_context__UserAssessment_" + componentIdentifier, "BO-1003100043-HEADERTEXT", "HeaderText");
			fields[207] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.UserAssessmentNew.__internal_x_context__UserAssessment_" + componentIdentifier, "BO-1003100043-FOOTERTEXT", "FooterText");
			fields[208] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.UserAssessmentNew.__internal_x_context__UserAssessment_" + componentIdentifier, "BO-1003100043-MAXHEADERHEIGHT", "MaxHeaderHeight");
			fields[209] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.UserAssessmentNew.__internal_x_context__UserAssessment_" + componentIdentifier, "BO-1003100043-MAXFOOTERHEIGHT", "MaxFooterHeight");
			fields[210] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.UserAssessmentNew.__internal_x_context__UserAssessment_" + componentIdentifier, "BO-1003100043-ASSOCIATEDREPORT", "AssociatedReport");
			fields[211] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.UserAssessmentNew.__internal_x_context__UserAssessment_" + componentIdentifier, "BO-1003100043-CANCOPYLAST", "CanCopyLast");
			fields[212] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.UserAssessmentNew.__internal_x_context__UserAssessment_" + componentIdentifier, "BO-1003100043-COPYLASTFROMCONTEXT", "CopyLastFromContext");
			fields[213] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.UserAssessmentNew.__internal_x_context__LinkedTemplate_" + componentIdentifier, "BO-1004100008-ID", "ID_TemplateBo");
			return fields;
		}
