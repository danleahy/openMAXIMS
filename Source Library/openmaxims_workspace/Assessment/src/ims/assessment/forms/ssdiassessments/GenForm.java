...
public class GenForm extends FormBridge
{
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.SSDIAssessments.__internal_x_context__FirstSiteAssess_" + componentIdentifier, "BO-1105100044-ID", "ID_SiteAssess");
			fields[145] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.SSDIAssessments.__internal_x_context__FirstSiteAssess_" + componentIdentifier, "BO-1105100044-PKEY", "Pkey");
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.SSDIAssessments.__internal_x_context__FirstSiteAssess_" + componentIdentifier, "BO-1105100044-PATIENT", "Patient");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.SSDIAssessments.__internal_x_context__FirstSiteAssess_" + componentIdentifier, "BO-1105100044-EPISODE", "Episode");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.SSDIAssessments.__internal_x_context__FirstSiteAssess_" + componentIdentifier, "BO-1105100044-ASSESSNAME", "AssessName");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.SSDIAssessments.__internal_x_context__FirstSiteAssess_" + componentIdentifier, "BO-1105100044-ASSESSSPECIALTY", "AssessSpecialty");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.SSDIAssessments.__internal_x_context__FirstSiteAssess_" + componentIdentifier, "BO-1105100044-CREATIONDATE", "CreationDate");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.SSDIAssessments.__internal_x_context__FirstSiteAssess_" + componentIdentifier, "BO-1105100044-CREATIONTIME", "CreationTime");
			return fields;
		}
