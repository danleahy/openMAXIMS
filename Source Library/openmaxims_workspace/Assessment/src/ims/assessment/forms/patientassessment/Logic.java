...
public class Logic extends BaseLogic
{
	...
	protected void onFormOpen() throws ims.framework.exceptions.PresentationLogicException
	{
		initialize();
		open();
		if (form.getLocalContext().getVoPatientAssessmentIsNotNull()) //WDEV-20161
		{	
			form.getLocalContext().setVoPatientAssessment(domain.getPatientAssessmentList(form.getLocalContext().getVoPatientAssessment()));
		}
	}
