...
public class GenForm extends FormBridge
{
	...
	public static class lyrAssessmentLayer extends Layer
	{
		...
		public static class tabDrawingContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				super.addControl(factory.getControl(DrawingControl.class, new Object[] { control, new Integer(startControlID.intValue() + 1003), new Integer(anchoringHelper4.getX()), new Integer(anchoringHelper4.getY()), new Integer(anchoringHelper4.getWidth()), new Integer(anchoringHelper4.getHeight()), new Integer(startTabIndex.intValue() + 10), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Boolean(true)}));
			}
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[163] = new ims.framework.ReportField(this.context, "_cv_Core.Patient_AssessmentFull", "BO-1003100048-ID", "ID_PatientAssessment");
			fields[164] = new ims.framework.ReportField(this.context, "_cv_Core.Patient_AssessmentFull", "BO-1003100048-STATUS", "Status");
			fields[165] = new ims.framework.ReportField(this.context, "_cv_Core.Patient_AssessmentFull", "BO-1003100048-COMPLETEDDATETIME", "CompletedDateTime");
			fields[166] = new ims.framework.ReportField(this.context, "_cv_Core.Patient_AssessmentFull", "BO-1003100048-PATIENT", "Patient");
			fields[167] = new ims.framework.ReportField(this.context, "_cv_Core.Patient_AssessmentFull", "BO-1003100048-CLINICALCONTACT", "ClinicalContact");
			fields[168] = new ims.framework.ReportField(this.context, "_cv_Core.Patient_AssessmentFull", "BO-1003100048-CARECONTEXT", "CareContext");
			fields[169] = new ims.framework.ReportField(this.context, "_cv_Core.Patient_AssessmentFull", "BO-1003100048-EPISODEOFCARE", "EpisodeOfCare");
			fields[170] = new ims.framework.ReportField(this.context, "_cv_Core.Patient_AssessmentFull", "BO-1003100048-SCORE", "Score");
			fields[171] = new ims.framework.ReportField(this.context, "_cv_Core.Patient_AssessmentFull", "BO-1003100048-ISASSESSMENTDOCUMENTSAVED", "IsAssessmentDocumentSaved");
			fields[172] = new ims.framework.ReportField(this.context, "_cv_Core.Patient_AssessmentFull", "BO-1003100048-ASSOCIATEDDOCUMENT", "AssociatedDocument");
			fields[173] = new ims.framework.ReportField(this.context, "_cv_Core.Patient_AssessmentFull", "BO-1003100048-STATUSREASON", "StatusReason");
			fields[174] = new ims.framework.ReportField(this.context, "_cv_Core.Patient_GraphicAssessmentFinding", "BO-1003100051-ID", "ID_PatientGraphicAssessmentFinding");
			fields[175] = new ims.framework.ReportField(this.context, "_cv_Core.Patient_GraphicAssessmentFinding", "BO-1003100051-AREANAME", "AreaName");
			fields[176] = new ims.framework.ReportField(this.context, "_cv_Core.Patient_GraphicAssessmentFinding", "BO-1003100051-AREADRAWN", "AreaDrawn");
			fields[177] = new ims.framework.ReportField(this.context, "_cv_Core.Patient_GraphicAssessmentFinding", "BO-1003100051-AREADETAILS", "AreaDetails");
			fields[178] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.GraphicalAssessment.__internal_x_context__CurrentImage_" + componentIdentifier, "BO-1028100007-ID", "ID_DrawingGraphicImage");
			fields[179] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.GraphicalAssessment.__internal_x_context__CurrentImage_" + componentIdentifier, "BO-1028100007-IMAGENAME", "ImageName");
			fields[180] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.GraphicalAssessment.__internal_x_context__CurrentImage_" + componentIdentifier, "BO-1028100007-IMAGEDESCRIPTION", "ImageDescription");
			fields[181] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.GraphicalAssessment.__internal_x_context__CurrentImage_" + componentIdentifier, "BO-1028100007-VERSIONNUMBER", "VersionNumber");
			fields[182] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.GraphicalAssessment.__internal_x_context__CurrentImage_" + componentIdentifier, "BO-1028100007-IMAGESTATUS", "ImageStatus");
			fields[183] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.GraphicalAssessment.__internal_x_context__PatientAssessment_" + componentIdentifier, "BO-1003100048-ID", "ID_PatientAssessment");
			fields[184] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.GraphicalAssessment.__internal_x_context__PatientAssessment_" + componentIdentifier, "BO-1003100048-STATUS", "Status");
			fields[185] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.GraphicalAssessment.__internal_x_context__PatientAssessment_" + componentIdentifier, "BO-1003100048-COMPLETEDDATETIME", "CompletedDateTime");
			fields[186] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.GraphicalAssessment.__internal_x_context__PatientAssessment_" + componentIdentifier, "BO-1003100048-STATUSREASON", "StatusReason");
			fields[187] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.GraphicalAssessment.__internal_x_context__PatientAssessment_" + componentIdentifier, "BO-1003100048-STATUSREASONTEXT", "StatusReasonText");
			fields[188] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.GraphicalAssessment.__internal_x_context__PatientAssessment_" + componentIdentifier, "BO-1003100048-DPPTYPE", "DPPType");
			fields[189] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.GraphicalAssessment.__internal_x_context__PatientAssessment_" + componentIdentifier, "BO-1003100048-DPPTYPETEXT", "DPPTypeText");
			fields[190] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.GraphicalAssessment.__internal_x_context__PatientAssessment_" + componentIdentifier, "BO-1003100048-ISCURRENTFORTYPE", "IsCurrentForType");
			fields[191] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.GraphicalAssessment.__internal_x_context__PatientAssessment_" + componentIdentifier, "BO-1003100048-CLINICALCONTACT", "ClinicalContact");
			fields[192] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.GraphicalAssessment.__internal_x_context__PatientAssessment_" + componentIdentifier, "BO-1003100048-CARECONTEXT", "CareContext");
			fields[193] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.GraphicalAssessment.__internal_x_context__PatientAssessment_" + componentIdentifier, "BO-1003100048-EPISODEOFCARE", "EpisodeOfCare");
			fields[194] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.GraphicalAssessment.__internal_x_context__PatientAssessment_" + componentIdentifier, "BO-1003100048-PATIENT", "Patient");
			fields[195] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.GraphicalAssessment.__internal_x_context__PatientAssessment_" + componentIdentifier, "BO-1003100048-SCORE", "Score");
			fields[196] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.GraphicalAssessment.__internal_x_context__PatientAssessment_" + componentIdentifier, "BO-1003100048-ISASSESSMENTDOCUMENTSAVED", "IsAssessmentDocumentSaved");
			fields[197] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.GraphicalAssessment.__internal_x_context__Patient_Assessment_" + componentIdentifier, "BO-1003100048-ID", "ID_PatientAssessment");
			fields[198] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.GraphicalAssessment.__internal_x_context__Patient_Assessment_" + componentIdentifier, "BO-1003100048-STATUS", "Status");
			fields[199] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.GraphicalAssessment.__internal_x_context__Patient_Assessment_" + componentIdentifier, "BO-1003100048-COMPLETEDDATETIME", "CompletedDateTime");
			fields[200] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.GraphicalAssessment.__internal_x_context__Patient_Assessment_" + componentIdentifier, "BO-1003100048-PATIENT", "Patient");
			fields[201] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.GraphicalAssessment.__internal_x_context__Patient_Assessment_" + componentIdentifier, "BO-1003100048-CLINICALCONTACT", "ClinicalContact");
			fields[202] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.GraphicalAssessment.__internal_x_context__Patient_Assessment_" + componentIdentifier, "BO-1003100048-CARECONTEXT", "CareContext");
			fields[203] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.GraphicalAssessment.__internal_x_context__Patient_Assessment_" + componentIdentifier, "BO-1003100048-EPISODEOFCARE", "EpisodeOfCare");
			fields[204] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.GraphicalAssessment.__internal_x_context__Patient_Assessment_" + componentIdentifier, "BO-1003100048-SCORE", "Score");
			fields[205] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.GraphicalAssessment.__internal_x_context__Patient_Assessment_" + componentIdentifier, "BO-1003100048-ISASSESSMENTDOCUMENTSAVED", "IsAssessmentDocumentSaved");
			fields[206] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.GraphicalAssessment.__internal_x_context__Patient_Assessment_" + componentIdentifier, "BO-1003100048-ASSOCIATEDDOCUMENT", "AssociatedDocument");
			fields[207] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.GraphicalAssessment.__internal_x_context__Patient_Assessment_" + componentIdentifier, "BO-1003100048-STATUSREASON", "StatusReason");
			fields[208] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.GraphicalAssessment.__internal_x_context__PatientGraphicAssessmentFinding_" + componentIdentifier, "BO-1003100051-ID", "ID_PatientGraphicAssessmentFinding");
			fields[209] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.GraphicalAssessment.__internal_x_context__PatientGraphicAssessmentFinding_" + componentIdentifier, "BO-1003100051-AREADRAWN", "AreaDrawn");
			fields[210] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.GraphicalAssessment.__internal_x_context__PatientGraphicAssessmentFinding_" + componentIdentifier, "BO-1003100051-AREANAME", "AreaName");
			fields[211] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.GraphicalAssessment.__internal_x_context__PatientGraphicAssessmentFinding_" + componentIdentifier, "BO-1003100051-AREADETAILS", "AreaDetails");
			fields[212] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.GraphicalAssessment.__internal_x_context__PatientGraphicAssessmentFinding_" + componentIdentifier, "BO-1003100051-ISCOPIED", "IsCopied");
			fields[213] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.GraphicalAssessment.__internal_x_context__Patient_GraphicAssessmentFinding_" + componentIdentifier, "BO-1003100051-ID", "ID_PatientGraphicAssessmentFinding");
			fields[214] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.GraphicalAssessment.__internal_x_context__Patient_GraphicAssessmentFinding_" + componentIdentifier, "BO-1003100051-AREANAME", "AreaName");
			fields[215] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.GraphicalAssessment.__internal_x_context__Patient_GraphicAssessmentFinding_" + componentIdentifier, "BO-1003100051-AREADRAWN", "AreaDrawn");
			fields[216] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.GraphicalAssessment.__internal_x_context__Patient_GraphicAssessmentFinding_" + componentIdentifier, "BO-1003100051-AREADETAILS", "AreaDetails");
			return fields;
		}
