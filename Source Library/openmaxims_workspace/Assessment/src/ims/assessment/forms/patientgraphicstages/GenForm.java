...
public class GenForm extends FormBridge
{
	...
	public static class lyrAssessmentsLayer extends Layer
	{
		...
		public static class tabPageGraphicalContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1004), new Integer(anchoringHelper3.getX()), new Integer(anchoringHelper3.getY()), new Integer(anchoringHelper3.getWidth()), new Integer(anchoringHelper3.getHeight()), new Integer(startTabIndex.intValue() + 5), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "New", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
				...
				super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1005), new Integer(anchoringHelper4.getX()), new Integer(anchoringHelper4.getY()), new Integer(anchoringHelper4.getWidth()), new Integer(anchoringHelper4.getHeight()), new Integer(startTabIndex.intValue() + 6), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Edit", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		public static class tabPageFindingsContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1010), new Integer(anchoringHelper9.getX()), new Integer(anchoringHelper9.getY()), new Integer(anchoringHelper9.getWidth()), new Integer(anchoringHelper9.getHeight()), new Integer(startTabIndex.intValue() + 12), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Edit", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
				...
				super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1011), new Integer(anchoringHelper10.getX()), new Integer(anchoringHelper10.getY()), new Integer(anchoringHelper10.getWidth()), new Integer(anchoringHelper10.getHeight()), new Integer(startTabIndex.intValue() + 11), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Last >>", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
				...
				super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1012), new Integer(anchoringHelper11.getX()), new Integer(anchoringHelper11.getY()), new Integer(anchoringHelper11.getWidth()), new Integer(anchoringHelper11.getHeight()), new Integer(startTabIndex.intValue() + 10), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "<< First", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
				...
				super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1013), new Integer(anchoringHelper12.getX()), new Integer(anchoringHelper12.getY()), new Integer(anchoringHelper12.getWidth()), new Integer(anchoringHelper12.getHeight()), new Integer(startTabIndex.intValue() + 9), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Next >", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, "_cv_Core.PatientAssessmentFull", "BO-1003100048-ID", "ID_PatientAssessment");
			fields[145] = new ims.framework.ReportField(this.context, "_cv_Core.PatientAssessmentFull", "BO-1003100048-STATUS", "Status");
			fields[146] = new ims.framework.ReportField(this.context, "_cv_Core.PatientAssessmentFull", "BO-1003100048-COMPLETEDDATETIME", "CompletedDateTime");
			fields[147] = new ims.framework.ReportField(this.context, "_cv_Core.PatientAssessmentFull", "BO-1003100048-STATUSREASON", "StatusReason");
			fields[148] = new ims.framework.ReportField(this.context, "_cv_Core.PatientAssessmentFull", "BO-1003100048-STATUSREASONTEXT", "StatusReasonText");
			fields[149] = new ims.framework.ReportField(this.context, "_cv_Core.PatientAssessmentFull", "BO-1003100048-DPPTYPE", "DPPType");
			fields[150] = new ims.framework.ReportField(this.context, "_cv_Core.PatientAssessmentFull", "BO-1003100048-DPPTYPETEXT", "DPPTypeText");
			fields[151] = new ims.framework.ReportField(this.context, "_cv_Core.PatientAssessmentFull", "BO-1003100048-ISCURRENTFORTYPE", "IsCurrentForType");
			fields[152] = new ims.framework.ReportField(this.context, "_cv_Core.PatientAssessmentFull", "BO-1003100048-CLINICALCONTACT", "ClinicalContact");
			fields[153] = new ims.framework.ReportField(this.context, "_cv_Core.PatientAssessmentFull", "BO-1003100048-CARECONTEXT", "CareContext");
			fields[154] = new ims.framework.ReportField(this.context, "_cv_Core.PatientAssessmentFull", "BO-1003100048-EPISODEOFCARE", "EpisodeOfCare");
			fields[155] = new ims.framework.ReportField(this.context, "_cv_Core.PatientAssessmentFull", "BO-1003100048-PATIENT", "Patient");
			fields[156] = new ims.framework.ReportField(this.context, "_cv_Core.PatientAssessmentFull", "BO-1003100048-SCORE", "Score");
			fields[157] = new ims.framework.ReportField(this.context, "_cv_Core.PatientAssessmentFull", "BO-1003100048-ISASSESSMENTDOCUMENTSAVED", "IsAssessmentDocumentSaved");
			fields[158] = new ims.framework.ReportField(this.context, "_cv_Core.PatientGraphicAssessmentFinding", "BO-1003100051-ID", "ID_PatientGraphicAssessmentFinding");
			fields[159] = new ims.framework.ReportField(this.context, "_cv_Core.PatientGraphicAssessmentFinding", "BO-1003100051-AREADRAWN", "AreaDrawn");
			fields[160] = new ims.framework.ReportField(this.context, "_cv_Core.PatientGraphicAssessmentFinding", "BO-1003100051-AREANAME", "AreaName");
			fields[161] = new ims.framework.ReportField(this.context, "_cv_Core.PatientGraphicAssessmentFinding", "BO-1003100051-AREADETAILS", "AreaDetails");
			fields[162] = new ims.framework.ReportField(this.context, "_cv_Core.PatientGraphicAssessmentFinding", "BO-1003100051-ISCOPIED", "IsCopied");
			fields[163] = new ims.framework.ReportField(this.context, "_cv_Assessment.PatientGraphicalAssessmentStage", "BO-1085100002-ID", "ID_PatientGraphicalAssessmentStage");
			fields[164] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.PatientGraphicStages.__internal_x_context__PatientAssessment_" + componentIdentifier, "BO-1003100048-ID", "ID_PatientAssessment");
			fields[165] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.PatientGraphicStages.__internal_x_context__PatientAssessment_" + componentIdentifier, "BO-1003100048-STATUS", "Status");
			fields[166] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.PatientGraphicStages.__internal_x_context__PatientAssessment_" + componentIdentifier, "BO-1003100048-COMPLETEDDATETIME", "CompletedDateTime");
			fields[167] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.PatientGraphicStages.__internal_x_context__PatientAssessment_" + componentIdentifier, "BO-1003100048-STATUSREASON", "StatusReason");
			fields[168] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.PatientGraphicStages.__internal_x_context__PatientAssessment_" + componentIdentifier, "BO-1003100048-STATUSREASONTEXT", "StatusReasonText");
			fields[169] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.PatientGraphicStages.__internal_x_context__PatientAssessment_" + componentIdentifier, "BO-1003100048-DPPTYPE", "DPPType");
			fields[170] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.PatientGraphicStages.__internal_x_context__PatientAssessment_" + componentIdentifier, "BO-1003100048-DPPTYPETEXT", "DPPTypeText");
			fields[171] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.PatientGraphicStages.__internal_x_context__PatientAssessment_" + componentIdentifier, "BO-1003100048-ISCURRENTFORTYPE", "IsCurrentForType");
			fields[172] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.PatientGraphicStages.__internal_x_context__PatientAssessment_" + componentIdentifier, "BO-1003100048-CLINICALCONTACT", "ClinicalContact");
			fields[173] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.PatientGraphicStages.__internal_x_context__PatientAssessment_" + componentIdentifier, "BO-1003100048-CARECONTEXT", "CareContext");
			fields[174] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.PatientGraphicStages.__internal_x_context__PatientAssessment_" + componentIdentifier, "BO-1003100048-EPISODEOFCARE", "EpisodeOfCare");
			fields[175] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.PatientGraphicStages.__internal_x_context__PatientAssessment_" + componentIdentifier, "BO-1003100048-PATIENT", "Patient");
			fields[176] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.PatientGraphicStages.__internal_x_context__PatientAssessment_" + componentIdentifier, "BO-1003100048-SCORE", "Score");
			fields[177] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.PatientGraphicStages.__internal_x_context__PatientAssessment_" + componentIdentifier, "BO-1003100048-ISASSESSMENTDOCUMENTSAVED", "IsAssessmentDocumentSaved");
			fields[178] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.PatientGraphicStages.__internal_x_context__PatientAssessmentActive_" + componentIdentifier, "BO-1003100048-ID", "ID_PatientAssessment");
			fields[179] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.PatientGraphicStages.__internal_x_context__PatientAssessmentActive_" + componentIdentifier, "BO-1003100048-CLINICALCONTACT", "ClinicalContact");
			fields[180] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.PatientGraphicStages.__internal_x_context__PatientAssessmentActive_" + componentIdentifier, "BO-1003100048-CARECONTEXT", "CareContext");
			fields[181] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.PatientGraphicStages.__internal_x_context__PatientAssessmentActive_" + componentIdentifier, "BO-1003100048-STATUS", "Status");
			fields[182] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.PatientGraphicStages.__internal_x_context__PatientAssessmentActive_" + componentIdentifier, "BO-1003100048-STATUSREASON", "StatusReason");
			fields[183] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.PatientGraphicStages.__internal_x_context__PatientAssessmentActive_" + componentIdentifier, "BO-1003100048-ISCURRENTFORTYPE", "IsCurrentForType");
			fields[184] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.PatientGraphicStages.__internal_x_context__PatientAssessmentActive_" + componentIdentifier, "BO-1003100048-DPPTYPE", "DPPType");
			fields[185] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.PatientGraphicStages.__internal_x_context__PatientAssessmentActive_" + componentIdentifier, "BO-1003100048-COMPLETEDDATETIME", "CompletedDateTime");
			fields[186] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.PatientGraphicStages.__internal_x_context__PatientAssessmentActive_" + componentIdentifier, "BO-1003100048-EPISODEOFCARE", "EpisodeOfCare");
			fields[187] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.PatientGraphicStages.__internal_x_context__PatientAssessmentActive_" + componentIdentifier, "BO-1003100048-PATIENT", "Patient");
			fields[188] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.PatientGraphicStages.__internal_x_context__SelectedStage_" + componentIdentifier, "BO-1083100003-ID", "ID_GraphicAssessmentStage");
			fields[189] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.PatientGraphicStages.__internal_x_context__SelectedStage_" + componentIdentifier, "BO-1083100003-ISANNOTATED", "IsAnnotated");
			fields[190] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.PatientGraphicStages.__internal_x_context__SelectedStage_" + componentIdentifier, "BO-1083100003-STAGENAME", "StageName");
			fields[191] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.PatientGraphicStages.__internal_x_context__SelectedStage_" + componentIdentifier, "BO-1083100003-ISACTIVE", "IsActive");
			fields[192] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.PatientGraphicStages.__internal_x_context__InitialAssessment_" + componentIdentifier, "BO-1003100048-ID", "ID_PatientAssessment");
			fields[193] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.PatientGraphicStages.__internal_x_context__InitialAssessment_" + componentIdentifier, "BO-1003100048-STATUS", "Status");
			fields[194] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.PatientGraphicStages.__internal_x_context__InitialAssessment_" + componentIdentifier, "BO-1003100048-COMPLETEDDATETIME", "CompletedDateTime");
			fields[195] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.PatientGraphicStages.__internal_x_context__InitialAssessment_" + componentIdentifier, "BO-1003100048-STATUSREASON", "StatusReason");
			fields[196] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.PatientGraphicStages.__internal_x_context__InitialAssessment_" + componentIdentifier, "BO-1003100048-STATUSREASONTEXT", "StatusReasonText");
			fields[197] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.PatientGraphicStages.__internal_x_context__InitialAssessment_" + componentIdentifier, "BO-1003100048-DPPTYPE", "DPPType");
			fields[198] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.PatientGraphicStages.__internal_x_context__InitialAssessment_" + componentIdentifier, "BO-1003100048-DPPTYPETEXT", "DPPTypeText");
			fields[199] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.PatientGraphicStages.__internal_x_context__InitialAssessment_" + componentIdentifier, "BO-1003100048-ISCURRENTFORTYPE", "IsCurrentForType");
			fields[200] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.PatientGraphicStages.__internal_x_context__InitialAssessment_" + componentIdentifier, "BO-1003100048-CLINICALCONTACT", "ClinicalContact");
			fields[201] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.PatientGraphicStages.__internal_x_context__InitialAssessment_" + componentIdentifier, "BO-1003100048-CARECONTEXT", "CareContext");
			fields[202] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.PatientGraphicStages.__internal_x_context__InitialAssessment_" + componentIdentifier, "BO-1003100048-EPISODEOFCARE", "EpisodeOfCare");
			fields[203] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.PatientGraphicStages.__internal_x_context__InitialAssessment_" + componentIdentifier, "BO-1003100048-PATIENT", "Patient");
			fields[204] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.PatientGraphicStages.__internal_x_context__InitialAssessment_" + componentIdentifier, "BO-1003100048-SCORE", "Score");
			fields[205] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.PatientGraphicStages.__internal_x_context__InitialAssessment_" + componentIdentifier, "BO-1003100048-ISASSESSMENTDOCUMENTSAVED", "IsAssessmentDocumentSaved");
			return fields;
		}
