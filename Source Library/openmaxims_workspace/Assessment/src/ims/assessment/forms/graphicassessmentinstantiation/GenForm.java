...
public class GenForm extends FormBridge
{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		ims.framework.FormUiLogic m_customControlCompletedForm = loader.loadComponent(102228, appForm, startControlID * 10 + 1000, anchoringHelper6.getSize(), instance1, startTabIndex.intValue() + 10, skipContextValidation);
		//ims.framework.Control m_customControlCompletedControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1005), new Integer(548), new Integer(520), new Integer(304), new Integer(56), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFTRIGHT, new Integer(startTabIndex.intValue() + 10), m_customControlCompletedForm, instance1 } );
		ims.framework.Control m_customControlCompletedControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1006),  new Integer(anchoringHelper6.getX()), new Integer(anchoringHelper6.getY()), new Integer(anchoringHelper6.getWidth()), new Integer(anchoringHelper6.getHeight()), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFTRIGHT, new Integer(startTabIndex.intValue() + 10), m_customControlCompletedForm, instance1, Boolean.FALSE } );
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1012), new Integer(anchoringHelper11.getX()), new Integer(anchoringHelper11.getY()), new Integer(anchoringHelper11.getWidth()), new Integer(anchoringHelper11.getHeight()), new Integer(startTabIndex.intValue() + 13), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Edit", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1014), new Integer(anchoringHelper13.getX()), new Integer(anchoringHelper13.getY()), new Integer(anchoringHelper13.getWidth()), new Integer(anchoringHelper13.getHeight()), new Integer(startTabIndex.intValue() + 14), ControlState.HIDDEN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Save", Boolean.FALSE, null, Boolean.TRUE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		ComboBox m_cmbReasonTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1015), new Integer(anchoringHelper14.getX()), new Integer(anchoringHelper14.getY()), new Integer(anchoringHelper14.getWidth()), new Integer(anchoringHelper14.getHeight()), new Integer(startTabIndex.intValue() + 9), ControlState.DISABLED, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
		...
		ComboBox m_cmbStatusTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1016), new Integer(anchoringHelper15.getX()), new Integer(anchoringHelper15.getY()), new Integer(anchoringHelper15.getWidth()), new Integer(anchoringHelper15.getHeight()), new Integer(startTabIndex.intValue() + 8), ControlState.DISABLED, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT ,Boolean.TRUE, Boolean.TRUE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.TRUE, new Integer(-1)});
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, "_cv_Core.PatientGraphicAssessmentFinding", "BO-1003100051-ID", "ID_PatientGraphicAssessmentFinding");
			fields[145] = new ims.framework.ReportField(this.context, "_cv_Core.PatientGraphicAssessmentFinding", "BO-1003100051-AREADRAWN", "AreaDrawn");
			fields[146] = new ims.framework.ReportField(this.context, "_cv_Core.PatientGraphicAssessmentFinding", "BO-1003100051-AREANAME", "AreaName");
			fields[147] = new ims.framework.ReportField(this.context, "_cv_Core.PatientGraphicAssessmentFinding", "BO-1003100051-AREADETAILS", "AreaDetails");
			fields[148] = new ims.framework.ReportField(this.context, "_cv_Core.PatientGraphicAssessmentFinding", "BO-1003100051-ISCOPIED", "IsCopied");
			fields[149] = new ims.framework.ReportField(this.context, "_cv_Core.PatientAssessmentFull", "BO-1003100048-ID", "ID_PatientAssessment");
			fields[150] = new ims.framework.ReportField(this.context, "_cv_Core.PatientAssessmentFull", "BO-1003100048-STATUS", "Status");
			fields[151] = new ims.framework.ReportField(this.context, "_cv_Core.PatientAssessmentFull", "BO-1003100048-COMPLETEDDATETIME", "CompletedDateTime");
			fields[152] = new ims.framework.ReportField(this.context, "_cv_Core.PatientAssessmentFull", "BO-1003100048-STATUSREASON", "StatusReason");
			fields[153] = new ims.framework.ReportField(this.context, "_cv_Core.PatientAssessmentFull", "BO-1003100048-STATUSREASONTEXT", "StatusReasonText");
			fields[154] = new ims.framework.ReportField(this.context, "_cv_Core.PatientAssessmentFull", "BO-1003100048-DPPTYPE", "DPPType");
			fields[155] = new ims.framework.ReportField(this.context, "_cv_Core.PatientAssessmentFull", "BO-1003100048-DPPTYPETEXT", "DPPTypeText");
			fields[156] = new ims.framework.ReportField(this.context, "_cv_Core.PatientAssessmentFull", "BO-1003100048-ISCURRENTFORTYPE", "IsCurrentForType");
			fields[157] = new ims.framework.ReportField(this.context, "_cv_Core.PatientAssessmentFull", "BO-1003100048-CLINICALCONTACT", "ClinicalContact");
			fields[158] = new ims.framework.ReportField(this.context, "_cv_Core.PatientAssessmentFull", "BO-1003100048-CARECONTEXT", "CareContext");
			fields[159] = new ims.framework.ReportField(this.context, "_cv_Core.PatientAssessmentFull", "BO-1003100048-EPISODEOFCARE", "EpisodeOfCare");
			fields[160] = new ims.framework.ReportField(this.context, "_cv_Core.PatientAssessmentFull", "BO-1003100048-PATIENT", "Patient");
			fields[161] = new ims.framework.ReportField(this.context, "_cv_Core.PatientAssessmentFull", "BO-1003100048-SCORE", "Score");
			fields[162] = new ims.framework.ReportField(this.context, "_cv_Core.PatientAssessmentFull", "BO-1003100048-ISASSESSMENTDOCUMENTSAVED", "IsAssessmentDocumentSaved");
			fields[163] = new ims.framework.ReportField(this.context, "_cv_Assessment.PatientUserDefinedObject", "BO-1085100000-ID", "ID_PatientUserDefinedObject");
			fields[164] = new ims.framework.ReportField(this.context, "_cv_Clinical.PatientAssessment.EditedComponent", "BO-1028100005-ID", "ID_UserDefinedObjectComponent");
			fields[165] = new ims.framework.ReportField(this.context, "_cv_Clinical.PatientAssessment.SelectedAssessment", "BO-1003100048-ID", "ID_PatientAssessment");
			fields[166] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.GraphicAssessmentInstantiation.__internal_x_context__CurrentPatientAssessment_" + componentIdentifier, "BO-1003100048-ID", "ID_PatientAssessment");
			fields[167] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.GraphicAssessmentInstantiation.__internal_x_context__CurrentPatientAssessment_" + componentIdentifier, "BO-1003100048-STATUS", "Status");
			fields[168] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.GraphicAssessmentInstantiation.__internal_x_context__CurrentPatientAssessment_" + componentIdentifier, "BO-1003100048-COMPLETEDDATETIME", "CompletedDateTime");
			fields[169] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.GraphicAssessmentInstantiation.__internal_x_context__CurrentPatientAssessment_" + componentIdentifier, "BO-1003100048-STATUSREASON", "StatusReason");
			fields[170] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.GraphicAssessmentInstantiation.__internal_x_context__CurrentPatientAssessment_" + componentIdentifier, "BO-1003100048-STATUSREASONTEXT", "StatusReasonText");
			fields[171] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.GraphicAssessmentInstantiation.__internal_x_context__CurrentPatientAssessment_" + componentIdentifier, "BO-1003100048-DPPTYPE", "DPPType");
			fields[172] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.GraphicAssessmentInstantiation.__internal_x_context__CurrentPatientAssessment_" + componentIdentifier, "BO-1003100048-DPPTYPETEXT", "DPPTypeText");
			fields[173] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.GraphicAssessmentInstantiation.__internal_x_context__CurrentPatientAssessment_" + componentIdentifier, "BO-1003100048-ISCURRENTFORTYPE", "IsCurrentForType");
			fields[174] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.GraphicAssessmentInstantiation.__internal_x_context__CurrentPatientAssessment_" + componentIdentifier, "BO-1003100048-CLINICALCONTACT", "ClinicalContact");
			fields[175] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.GraphicAssessmentInstantiation.__internal_x_context__CurrentPatientAssessment_" + componentIdentifier, "BO-1003100048-CARECONTEXT", "CareContext");
			fields[176] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.GraphicAssessmentInstantiation.__internal_x_context__CurrentPatientAssessment_" + componentIdentifier, "BO-1003100048-EPISODEOFCARE", "EpisodeOfCare");
			fields[177] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.GraphicAssessmentInstantiation.__internal_x_context__CurrentPatientAssessment_" + componentIdentifier, "BO-1003100048-PATIENT", "Patient");
			fields[178] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.GraphicAssessmentInstantiation.__internal_x_context__CurrentPatientAssessment_" + componentIdentifier, "BO-1003100048-SCORE", "Score");
			fields[179] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.GraphicAssessmentInstantiation.__internal_x_context__CurrentPatientAssessment_" + componentIdentifier, "BO-1003100048-ISASSESSMENTDOCUMENTSAVED", "IsAssessmentDocumentSaved");
			fields[180] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.GraphicAssessmentInstantiation.__internal_x_context__InitialPatientAssessment_" + componentIdentifier, "BO-1003100048-ID", "ID_PatientAssessment");
			fields[181] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.GraphicAssessmentInstantiation.__internal_x_context__InitialPatientAssessment_" + componentIdentifier, "BO-1003100048-STATUS", "Status");
			fields[182] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.GraphicAssessmentInstantiation.__internal_x_context__InitialPatientAssessment_" + componentIdentifier, "BO-1003100048-COMPLETEDDATETIME", "CompletedDateTime");
			fields[183] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.GraphicAssessmentInstantiation.__internal_x_context__InitialPatientAssessment_" + componentIdentifier, "BO-1003100048-STATUSREASON", "StatusReason");
			fields[184] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.GraphicAssessmentInstantiation.__internal_x_context__InitialPatientAssessment_" + componentIdentifier, "BO-1003100048-STATUSREASONTEXT", "StatusReasonText");
			fields[185] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.GraphicAssessmentInstantiation.__internal_x_context__InitialPatientAssessment_" + componentIdentifier, "BO-1003100048-DPPTYPE", "DPPType");
			fields[186] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.GraphicAssessmentInstantiation.__internal_x_context__InitialPatientAssessment_" + componentIdentifier, "BO-1003100048-DPPTYPETEXT", "DPPTypeText");
			fields[187] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.GraphicAssessmentInstantiation.__internal_x_context__InitialPatientAssessment_" + componentIdentifier, "BO-1003100048-ISCURRENTFORTYPE", "IsCurrentForType");
			fields[188] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.GraphicAssessmentInstantiation.__internal_x_context__InitialPatientAssessment_" + componentIdentifier, "BO-1003100048-CLINICALCONTACT", "ClinicalContact");
			fields[189] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.GraphicAssessmentInstantiation.__internal_x_context__InitialPatientAssessment_" + componentIdentifier, "BO-1003100048-CARECONTEXT", "CareContext");
			fields[190] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.GraphicAssessmentInstantiation.__internal_x_context__InitialPatientAssessment_" + componentIdentifier, "BO-1003100048-EPISODEOFCARE", "EpisodeOfCare");
			fields[191] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.GraphicAssessmentInstantiation.__internal_x_context__InitialPatientAssessment_" + componentIdentifier, "BO-1003100048-PATIENT", "Patient");
			fields[192] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.GraphicAssessmentInstantiation.__internal_x_context__InitialPatientAssessment_" + componentIdentifier, "BO-1003100048-SCORE", "Score");
			fields[193] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.GraphicAssessmentInstantiation.__internal_x_context__InitialPatientAssessment_" + componentIdentifier, "BO-1003100048-ISASSESSMENTDOCUMENTSAVED", "IsAssessmentDocumentSaved");
			return fields;
		}
