...
public class SessionVoCollection extends ims.vo.ValueObjectCollection implements ims.vo.ImsCloneable, Iterable<SessionVo>
{
	...
	public ims.dto_move.vo.SessionRefVoCollection toRefVoCollection()
	{
		ims.dto_move.vo.SessionRefVoCollection result = new ims.dto_move.vo.SessionRefVoCollection();
		for(int x = 0; x < this.col.size(); x++)
		{
	...
	public ims.dtomove.vo.beans.SessionVoBean[] getBeanCollection()
	{
		return getBeanCollectionArray();
	}
	public ims.dtomove.vo.beans.SessionVoBean[] getBeanCollectionArray()
	{
		ims.dtomove.vo.beans.SessionVoBean[] result = new ims.dtomove.vo.beans.SessionVoBean[col.size()];
		for(int i = 0; i < col.size(); i++)
		{
			SessionVo vo = ((SessionVo)col.get(i));
			result[i] = (ims.dtomove.vo.beans.SessionVoBean)vo.getBean();
		}
		return result;
	}
	public static SessionVoCollection buildFromBeanCollection(java.util.Collection beans)
	{
		...
		while (iter.hasNext())
		{
			coll.add(((ims.dtomove.vo.beans.SessionVoBean)iter.next()).buildVo());
		}
		return coll;
	}
	public static SessionVoCollection buildFromBeanCollection(ims.dtomove.vo.beans.SessionVoBean[] beans)
	{
		SessionVoCollection coll = new SessionVoCollection();
		if(beans == null)
			return coll;
