...
public class MachineExclusionTimeVoBean extends ims.vo.ValueObjectBean
{
	public MachineExclusionTimeVoBean()
	{
	}
	public MachineExclusionTimeVoBean(ims.dtomove.vo.MachineExclusionTimeVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.dtomove.vo.MachineExclusionTimeVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.starttime = vo.getStartTime() == null ? null : (ims.framework.utils.beans.TimeBean)vo.getStartTime().getBean();
	...
	public ims.dtomove.vo.MachineExclusionTimeVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.dtomove.vo.MachineExclusionTimeVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.dtomove.vo.MachineExclusionTimeVo vo = null;
		if(map != null)
			vo = (ims.dtomove.vo.MachineExclusionTimeVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.dtomove.vo.MachineExclusionTimeVo();
