...
public class MachineExclusionDateVoBean extends ims.vo.ValueObjectBean
{
	public MachineExclusionDateVoBean()
	{
	}
	public MachineExclusionDateVoBean(ims.dtomove.vo.MachineExclusionDateVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.dtomove.vo.MachineExclusionDateVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.startdate = vo.getStartDate() == null ? null : (ims.framework.utils.beans.DateBean)vo.getStartDate().getBean();
	...
	public ims.dtomove.vo.MachineExclusionDateVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.dtomove.vo.MachineExclusionDateVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.dtomove.vo.MachineExclusionDateVo vo = null;
		if(map != null)
			vo = (ims.dtomove.vo.MachineExclusionDateVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.dtomove.vo.MachineExclusionDateVo();
