...
public class ClientShortVoBean extends ims.vo.ValueObjectBean
{
	public ClientShortVoBean()
	{
	}
	public ClientShortVoBean(ims.pci.vo.ClientShortVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.pci.vo.ClientShortVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
	...
	public ims.pci.vo.ClientShortVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.pci.vo.ClientShortVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.pci.vo.ClientShortVo vo = null;
		if(map != null)
			vo = (ims.pci.vo.ClientShortVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.pci.vo.ClientShortVo();
