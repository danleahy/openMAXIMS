...
public class ClientVoBean extends ims.vo.ValueObjectBean
{
	public ClientVoBean()
	{
	}
	public ClientVoBean(ims.pci.vo.ClientVo vo)
	{
		this.id = vo.getBoId();
		...
		this.confidentialreason = vo.getConfidentialReason() == null ? null : (ims.vo.LookupInstanceBean)vo.getConfidentialReason().getBean();
	}

	public void populate(ims.vo.ValueObjectBeanMap map, ims.pci.vo.ClientVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
	...
	public ims.pci.vo.ClientVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.pci.vo.ClientVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.pci.vo.ClientVo vo = null;
		if(map != null)
			vo = (ims.pci.vo.ClientVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.pci.vo.ClientVo();
	...
	public ims.vo.LookupInstanceBean getConfidentialReason()
	{
		return this.confidentialreason;
	}
	public void setConfidentialReason(ims.vo.LookupInstanceBean value)
	{
	...
	private ims.vo.LookupInstanceBean confidentialreason;
}
