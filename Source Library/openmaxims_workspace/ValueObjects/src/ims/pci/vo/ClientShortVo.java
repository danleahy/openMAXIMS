 ...
 */
public class ClientShortVo extends ims.core.vo.PatientShort implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public ClientShortVo()
	{
	}
	public ClientShortVo(Integer id, int version)
	{
		super(id, version);
	}
	public ClientShortVo(ims.pci.vo.beans.ClientShortVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.pci.vo.beans.ClientShortVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.pci.vo.beans.ClientShortVoBean bean = null;
		if(map != null)
			bean = (ims.pci.vo.beans.ClientShortVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.pci.vo.beans.ClientShortVoBean();
	...
	public Object clone()
	{
		...
		ClientShortVo clone = new ClientShortVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(ClientShortVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A ClientShortVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((ClientShortVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((ClientShortVo)obj).getBoId());
	}
