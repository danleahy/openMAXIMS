...
public class PlanOfCareActionsSearchCriteriaVoBean extends ims.vo.ValueObjectBean
{
	public PlanOfCareActionsSearchCriteriaVoBean()
	{
	}
	public PlanOfCareActionsSearchCriteriaVoBean(ims.nursing.vo.PlanOfCareActionsSearchCriteriaVo vo)
	{
		this.interval = vo.getInterval() == null ? null : (ims.vo.LookupInstanceBean)vo.getInterval().getBean();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.nursing.vo.PlanOfCareActionsSearchCriteriaVo vo)
	{
		this.interval = vo.getInterval() == null ? null : (ims.vo.LookupInstanceBean)vo.getInterval().getBean();
		this.fromdate = vo.getFromDate() == null ? null : (ims.framework.utils.beans.DateBean)vo.getFromDate().getBean();
		this.todate = vo.getToDate() == null ? null : (ims.framework.utils.beans.DateBean)vo.getToDate().getBean();
	...
	public ims.nursing.vo.PlanOfCareActionsSearchCriteriaVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.nursing.vo.PlanOfCareActionsSearchCriteriaVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.nursing.vo.PlanOfCareActionsSearchCriteriaVo vo = null;
		if(map != null)
			vo = (ims.nursing.vo.PlanOfCareActionsSearchCriteriaVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.nursing.vo.PlanOfCareActionsSearchCriteriaVo();
	...
	public ims.vo.LookupInstanceBean getInterval()
	{
		return this.interval;
	}
	public void setInterval(ims.vo.LookupInstanceBean value)
	{
		this.interval = value;
	}
	...
	private ims.vo.LookupInstanceBean interval;
