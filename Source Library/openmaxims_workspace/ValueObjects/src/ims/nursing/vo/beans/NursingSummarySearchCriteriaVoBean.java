...
public class NursingSummarySearchCriteriaVoBean extends ims.vo.ValueObjectBean
{
	public NursingSummarySearchCriteriaVoBean()
	{
	}
	public NursingSummarySearchCriteriaVoBean(ims.nursing.vo.NursingSummarySearchCriteriaVo vo)
	{
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.nursing.vo.NursingSummarySearchCriteriaVo vo)
	{
		this.action = vo.getAction() == null ? null : (ims.vo.LookupInstanceBean)vo.getAction().getBean();
		this.carecontext = vo.getCareContext() == null ? null : (ims.core.vo.beans.CareContextShortVoBean)vo.getCareContext().getBean(map);
	}

	public ims.nursing.vo.NursingSummarySearchCriteriaVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.nursing.vo.NursingSummarySearchCriteriaVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.nursing.vo.NursingSummarySearchCriteriaVo vo = null;
		if(map != null)
			vo = (ims.nursing.vo.NursingSummarySearchCriteriaVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.nursing.vo.NursingSummarySearchCriteriaVo();
