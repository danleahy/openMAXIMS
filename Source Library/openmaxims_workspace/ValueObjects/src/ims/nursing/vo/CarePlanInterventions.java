...
public class CarePlanInterventions extends ims.nursing.careplans.vo.CarePlanInterventionRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public CarePlanInterventions(ims.nursing.vo.beans.CarePlanInterventionsBean bean)
	{
		...
		this.removalauthoringinformation = bean.getRemovalAuthoringInformation() == null ? null : bean.getRemovalAuthoringInformation().buildVo();
		this.reinstatingauthoringinformation = bean.getReinstatingAuthoringInformation() == null ? null : bean.getReinstatingAuthoringInformation().buildVo();
	}
	public void populate(ims.vo.ValueObjectBeanMap map, ims.nursing.vo.beans.CarePlanInterventionsBean bean)
	{
		...
		this.additionalinfo = bean.getAdditionalInfo();
		this.isremoved = bean.getIsRemoved();
		this.removalauthoringinformation = bean.getRemovalAuthoringInformation() == null ? null : bean.getRemovalAuthoringInformation().buildVo(map);
		this.reinstatingauthoringinformation = bean.getReinstatingAuthoringInformation() == null ? null : bean.getReinstatingAuthoringInformation().buildVo(map);
	}
	...
	public Object getFieldValueByFieldName(String fieldName)
	{
		...
		if(fieldName.equals("ISREMOVED"))
			return getIsRemoved();
		if(fieldName.equals("REMOVALAUTHORINGINFORMATION"))
			return getRemovalAuthoringInformation();
		if(fieldName.equals("REINSTATINGAUTHORINGINFORMATION"))
			return getReinstatingAuthoringInformation();
	...
	public boolean getRemovalAuthoringInformationIsNotNull()
	{
		return this.removalauthoringinformation != null;
	}
	public ims.core.vo.AuthoringInformationVo getRemovalAuthoringInformation()
	{
		return this.removalauthoringinformation;
	}
	public void setRemovalAuthoringInformation(ims.core.vo.AuthoringInformationVo value)
	{
		this.isValidated = false;
		this.removalauthoringinformation = value;
	}
	public boolean getReinstatingAuthoringInformationIsNotNull()
	{
		return this.reinstatingauthoringinformation != null;
	}
	public ims.core.vo.AuthoringInformationVo getReinstatingAuthoringInformation()
	{
		return this.reinstatingauthoringinformation;
	}
	public void setReinstatingAuthoringInformation(ims.core.vo.AuthoringInformationVo value)
	{
		this.isValidated = false;
		this.reinstatingauthoringinformation = value;
	}
	public boolean isValidated()
	{
		...
		if(this.removalauthoringinformation != null)
		{
			if(!this.removalauthoringinformation.isValidated())
			{
				this.isBusy = false;
				return false;
			}
		}
		if(this.reinstatingauthoringinformation != null)
		{
			if(!this.reinstatingauthoringinformation.isValidated())
			{
				this.isBusy = false;
				return false;
			}
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.removalauthoringinformation != null)
		{
			String[] listOfOtherErrors = this.removalauthoringinformation.validate();
		...
		if(this.reinstatingauthoringinformation != null)
		{
			String[] listOfOtherErrors = this.reinstatingauthoringinformation.validate();
			if(listOfOtherErrors != null)
			{
				for(int x = 0; x < listOfOtherErrors.length; x++)
				{
	...
	public Object clone()
	{
		...
		if(this.removalauthoringinformation == null)
			clone.removalauthoringinformation = null;
		else
			clone.removalauthoringinformation = (ims.core.vo.AuthoringInformationVo)this.removalauthoringinformation.clone();
		if(this.reinstatingauthoringinformation == null)
			clone.reinstatingauthoringinformation = null;
		else
			clone.reinstatingauthoringinformation = (ims.core.vo.AuthoringInformationVo)this.reinstatingauthoringinformation.clone();
	...
	protected ims.core.vo.AuthoringInformationVo removalauthoringinformation;
	protected ims.core.vo.AuthoringInformationVo reinstatingauthoringinformation;
