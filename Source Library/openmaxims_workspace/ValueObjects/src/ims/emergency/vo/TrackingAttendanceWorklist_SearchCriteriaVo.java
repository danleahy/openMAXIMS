...
public class TrackingAttendanceWorklist_SearchCriteriaVo extends ims.vo.ValueObject implements ims.vo.ImsCloneable, Comparable
{
	...
	public TrackingAttendanceWorklist_SearchCriteriaVo(ims.emergency.vo.beans.TrackingAttendanceWorklist_SearchCriteriaVoBean bean)
	{
		...
		this.clinicalproblem = bean.getClinicalProblem() == null ? null : bean.getClinicalProblem().buildVo();
		this.showtemporaryregistrations = bean.getShowTemporaryRegistrations();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.emergency.vo.beans.TrackingAttendanceWorklist_SearchCriteriaVoBean bean)
	{
		...
		this.presentingproblem = bean.getPresentingProblem() == null ? null : ims.emergency.vo.lookups.PresentingComplaint.buildLookup(bean.getPresentingProblem());
		this.attendancenotcoded = bean.getAttendanceNotCoded();
		this.clinicalproblem = bean.getClinicalProblem() == null ? null : bean.getClinicalProblem().buildVo(map);
		this.showtemporaryregistrations = bean.getShowTemporaryRegistrations();
		this.idvalue = bean.getIDValue();
		this.includerequiresdischargedocumentationreview = bean.getIncludeRequiresDischargeDocumentationReview();
	}
	...
	{
		return this.clinicalproblem != null;
	}
	public ims.clinical.vo.ClinicalProblemShortVo getClinicalProblem()
	{
		return this.clinicalproblem;
	}
	public void setClinicalProblem(ims.clinical.vo.ClinicalProblemShortVo value)
	{
		this.isValidated = false;
		this.clinicalproblem = value;
	}
	public boolean getShowTemporaryRegistrationsIsNotNull()
	{
		return this.showtemporaryregistrations != null;
	}
	public Boolean getShowTemporaryRegistrations()
	{
		return this.showtemporaryregistrations;
	}
	public void setShowTemporaryRegistrations(Boolean value)
	{
		this.isValidated = false;
		this.showtemporaryregistrations = value;
	}
	...
	public Object clone()
	{
		...
		if(this.clinicalproblem == null)
			clone.clinicalproblem = null;
		else
			clone.clinicalproblem = (ims.clinical.vo.ClinicalProblemShortVo)this.clinicalproblem.clone();
		clone.showtemporaryregistrations = this.showtemporaryregistrations;
	...
	public int countFieldsWithValue()
	{
		...
		if(this.clinicalproblem != null)
			count++;
		if(this.showtemporaryregistrations != null)
			count++;
	...
	protected ims.clinical.vo.ClinicalProblemShortVo clinicalproblem;
	protected Boolean showtemporaryregistrations;
