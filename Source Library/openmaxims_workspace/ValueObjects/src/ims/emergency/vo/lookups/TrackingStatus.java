...
public class TrackingStatus extends ims.vo.LookupInstVo implements TreeNode
{
	...
	public static ims.framework.IItemCollection getNegativeInstancesAsIItemCollection()
	{
		...
		result.add(DECISION_TO_TRANSFER);
		return result;
	}
	public static TrackingStatus[] getNegativeInstances()
	{
		TrackingStatus[] instances = new TrackingStatus[15];
		...
		instances[14] = DECISION_TO_TRANSFER;
		return instances;
	}
	public static String[] getNegativeInstanceNames()
	{
		...
		negativeInstances[14] = "DECISION_TO_TRANSFER";
	...
	public static final TrackingStatus DECISION_TO_TRANSFER = new TrackingStatus(-2786, "Decision to Transfer", true, null, null, Color.Default);
}
