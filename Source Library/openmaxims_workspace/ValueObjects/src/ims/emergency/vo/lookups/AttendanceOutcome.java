...
public class AttendanceOutcome extends ims.vo.LookupInstVo implements TreeNode
{
	...
	public static ims.framework.IItemCollection getNegativeInstancesAsIItemCollection()
	{
		...
		result.add(AGAINST_MEDICAL_ADVISE);
		result.add(OTHER);
		result.add(ADCC_CLINIC);
		return result;
	}
	public static AttendanceOutcome[] getNegativeInstances()
	{
		AttendanceOutcome[] instances = new AttendanceOutcome[12];
		...
		instances[9] = AGAINST_MEDICAL_ADVISE;
		instances[10] = OTHER;
		instances[11] = ADCC_CLINIC;
		return instances;
	}
	public static String[] getNegativeInstanceNames()
	{
		...
		negativeInstances[9] = "AGAINST_MEDICAL_ADVISE";
		negativeInstances[10] = "OTHER";
		negativeInstances[11] = "ADCC_CLINIC";
	...
	public static final AttendanceOutcome AGAINST_MEDICAL_ADVISE = new AttendanceOutcome(-2785, "Against Medical Advice", true, null, null, Color.Default);
	public static final AttendanceOutcome OTHER = new AttendanceOutcome(-2826, "Other", true, null, null, Color.Default);
	public static final AttendanceOutcome ADCC_CLINIC = new AttendanceOutcome(-2849, "ADCC Clinic", true, null, null, Color.Default);
}
