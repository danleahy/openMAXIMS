...
public class AttendanceType extends ims.vo.LookupInstVo implements TreeNode
{
	...
	public static ims.framework.IItemCollection getNegativeInstancesAsIItemCollection()
	{
		...
		result.add(UNSCHEDULED_7_DAYS);
		result.add(UNSCHEDULED_28_DAYS);
		return result;
	}
	public static AttendanceType[] getNegativeInstances()
	{
		AttendanceType[] instances = new AttendanceType[5];
		instances[0] = FIRST;
		instances[1] = SCHEDULED;
		instances[2] = UNSCHEDULED;
		instances[3] = UNSCHEDULED_7_DAYS;
		instances[4] = UNSCHEDULED_28_DAYS;
		return instances;
	}
	public static String[] getNegativeInstanceNames()
	{
		...
		negativeInstances[3] = "UNSCHEDULED_7_DAYS";
		negativeInstances[4] = "UNSCHEDULED_28_DAYS";
	...
	public static final AttendanceType UNSCHEDULED_7_DAYS = new AttendanceType(-2789, "Unscheduled in 7 days ", true, null, null, Color.Default);
	public static final AttendanceType UNSCHEDULED_28_DAYS = new AttendanceType(-2790, "Unscheduled in 28 days", true, null, null, Color.Default);
}
