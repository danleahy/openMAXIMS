...
public class TrackingAttendanceOutcomeVo extends ims.emergency.vo.TrackingRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public Object getFieldValueByFieldName(String fieldName)
	{
		...
		if(fieldName.equals("REASONFORBREACHCOMMENTS"))
			return getReasonForBreachComments();
	...
	public ims.emergency.vo.EDPartialAdmissionForDischargeDetailOutcomeVo getCurrentPartialAdmission()
	{
		return this.currentpartialadmission;
	}
	public void setCurrentPartialAdmission(ims.emergency.vo.EDPartialAdmissionForDischargeDetailOutcomeVo value)
	{
		this.isValidated = false;
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.reasonforbreachcomments != null)
			if(this.reasonforbreachcomments.length() > 1500)
				listOfErrors.add("The length of the field [reasonforbreachcomments] in the value object [ims.emergency.vo.TrackingAttendanceOutcomeVo] is too big. It should be less or equal to 1500");
	...
	public Object clone()
	{
		...
		if(this.currentpartialadmission == null)
			...
			clone.currentpartialadmission = (ims.emergency.vo.EDPartialAdmissionForDischargeDetailOutcomeVo)this.currentpartialadmission.clone();
	...
	protected ims.emergency.vo.EDPartialAdmissionForDischargeDetailOutcomeVo currentpartialadmission;
