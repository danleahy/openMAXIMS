 ...
 */
public class SeenByHCPForTrackingVo extends ims.emergency.vo.SeenByHCPRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public SeenByHCPForTrackingVo()
	{
	}
	public SeenByHCPForTrackingVo(Integer id, int version)
	{
		super(id, version);
	}
	public SeenByHCPForTrackingVo(ims.emergency.vo.beans.SeenByHCPForTrackingVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.emergency.vo.beans.SeenByHCPForTrackingVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.allocateddatetime = bean.getAllocatedDateTime() == null ? null : bean.getAllocatedDateTime().buildDateTime();
	...
	{
		ims.emergency.vo.beans.SeenByHCPForTrackingVoBean bean = null;
		if(map != null)
			bean = (ims.emergency.vo.beans.SeenByHCPForTrackingVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.emergency.vo.beans.SeenByHCPForTrackingVoBean();
	...
	public ims.emergency.vo.MedicForTrackingVo getAllocatedMedic()
	{
		return this.allocatedmedic;
	}
	public void setAllocatedMedic(ims.emergency.vo.MedicForTrackingVo value)
	{
		this.isValidated = false;
	...
	public ims.emergency.vo.NurseForTrackingVo getAllocatedNurse()
	{
		return this.allocatednurse;
	}
	public void setAllocatedNurse(ims.emergency.vo.NurseForTrackingVo value)
	{
		this.isValidated = false;
	...
	public Object clone()
	{
		...
		SeenByHCPForTrackingVo clone = new SeenByHCPForTrackingVo(this.id, this.version);
		...
		if(this.allocatedmedic == null)
			...
			clone.allocatedmedic = (ims.emergency.vo.MedicForTrackingVo)this.allocatedmedic.clone();
		if(this.allocatednurse == null)
			clone.allocatednurse = null;
		else
			clone.allocatednurse = (ims.emergency.vo.NurseForTrackingVo)this.allocatednurse.clone();
		if(this.seendatetime == null)
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(SeenByHCPForTrackingVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A SeenByHCPForTrackingVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((SeenByHCPForTrackingVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((SeenByHCPForTrackingVo)obj).getBoId());
	}
	...
	protected ims.emergency.vo.MedicForTrackingVo allocatedmedic;
	protected ims.emergency.vo.NurseForTrackingVo allocatednurse;
