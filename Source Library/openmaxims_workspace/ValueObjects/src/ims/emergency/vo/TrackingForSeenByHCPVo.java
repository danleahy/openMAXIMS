...
public class TrackingForSeenByHCPVo extends ims.emergency.vo.TrackingRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public ims.emergency.vo.SeenByHCPVo getSeenByNurse()
	{
		return this.seenbynurse;
	}
	public void setSeenByNurse(ims.emergency.vo.SeenByHCPVo value)
	{
		this.isValidated = false;
	...
	public ims.emergency.vo.AttendanceForSeenByHCPVo getAttendance()
	{
		return this.attendance;
	}
	public void setAttendance(ims.emergency.vo.AttendanceForSeenByHCPVo value)
	{
		this.isValidated = false;
	...
	public boolean isValidated()
	{
		...
		{
			if(!this.seenbynurse.isValidated())
			{
				this.isBusy = false;
				return false;
			}
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.seenbynurse != null)
		{
			String[] listOfOtherErrors = this.seenbynurse.validate();
			if(listOfOtherErrors != null)
			{
				for(int x = 0; x < listOfOtherErrors.length; x++)
				{
	...
	public Object clone()
	{
		...
		if(this.seenbynurse == null)
			...
			clone.seenbynurse = (ims.emergency.vo.SeenByHCPVo)this.seenbynurse.clone();
		if(this.attendance == null)
			clone.attendance = null;
		else
			clone.attendance = (ims.emergency.vo.AttendanceForSeenByHCPVo)this.attendance.clone();
	...
	protected ims.emergency.vo.SeenByHCPVo seenbynurse;
	protected ims.emergency.vo.AttendanceForSeenByHCPVo attendance;
