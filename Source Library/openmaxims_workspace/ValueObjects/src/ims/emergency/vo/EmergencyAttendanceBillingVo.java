...
public class EmergencyAttendanceBillingVo extends ims.core.admin.vo.EmergencyAttendanceBillingRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public EmergencyAttendanceBillingVo(ims.emergency.vo.beans.EmergencyAttendanceBillingVoBean bean)
	{
		...
		this.invoiceamount = bean.getInvoiceAmount() == null ? null : ims.emergency.vo.lookups.InvoiceAmount.buildLookup(bean.getInvoiceAmount());
	}
	...
	public ims.emergency.vo.lookups.InvoiceAmount getInvoiceAmount()
	{
		return this.invoiceamount;
	}
	public void setInvoiceAmount(ims.emergency.vo.lookups.InvoiceAmount value)
	{
		this.isValidated = false;
	...
	public Object clone()
	{
		...
		if(this.invoiceamount == null)
			clone.invoiceamount = null;
		else
			clone.invoiceamount = (ims.emergency.vo.lookups.InvoiceAmount)this.invoiceamount.clone();
	...
	protected ims.emergency.vo.lookups.InvoiceAmount invoiceamount;
