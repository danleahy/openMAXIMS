...
public class TrackingAreaVo extends ims.emergency.configuration.vo.TrackingAreaRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public TrackingAreaVo(ims.emergency.vo.beans.TrackingAreaVoBean bean)
	{
		...
		this.workflowconfig = bean.getWorkflowConfig() == null ? null : bean.getWorkflowConfig().buildVo();
		this.associatedworkflowmandatory = bean.getAssociatedWorkflowMandatory();
		this.allocatedcubicle = bean.getAllocatedCubicle() == null ? null : bean.getAllocatedCubicle().buildVo();
	}
	public void populate(ims.vo.ValueObjectBeanMap map, ims.emergency.vo.beans.TrackingAreaVoBean bean)
	{
		...
		this.columns = ims.emergency.vo.ColumnDetailVoCollection.buildFromBeanCollection(bean.getColumns());
		this.areatype = bean.getAreaType() == null ? null : ims.emergency.vo.lookups.AreaType.buildLookup(bean.getAreaType());
		this.workflowconfig = bean.getWorkflowConfig() == null ? null : bean.getWorkflowConfig().buildVo(map);
		this.associatedworkflowmandatory = bean.getAssociatedWorkflowMandatory();
		this.allocatedcubicle = bean.getAllocatedCubicle() == null ? null : bean.getAllocatedCubicle().buildVo(map);
	}
	...
	public Object getFieldValueByFieldName(String fieldName)
	{
		...
		if(fieldName.equals("AREATYPE"))
			return getAreaType();
		if(fieldName.equals("WORKFLOWCONFIG"))
			return getWorkflowConfig();
		if(fieldName.equals("ASSOCIATEDWORKFLOWMANDATORY"))
			return getAssociatedWorkflowMandatory();
		if(fieldName.equals("ALLOCATEDCUBICLE"))
			return getAllocatedCubicle();
	...
	public boolean getWorkflowConfigIsNotNull()
	{
		return this.workflowconfig != null;
	}
	public ims.emergency.vo.TrackingStatusWorkflowLightVo getWorkflowConfig()
	{
		return this.workflowconfig;
	}
	public void setWorkflowConfig(ims.emergency.vo.TrackingStatusWorkflowLightVo value)
	{
		this.isValidated = false;
		this.workflowconfig = value;
	}
	public boolean getAssociatedWorkflowMandatoryIsNotNull()
	{
		return this.associatedworkflowmandatory != null;
	}
	...
	public boolean getAllocatedCubicleIsNotNull()
	{
		return this.allocatedcubicle != null;
	}
	public ims.emergency.vo.TrackingCubicleRoomBedVo getAllocatedCubicle()
	{
		return this.allocatedcubicle;
	}
	public void setAllocatedCubicle(ims.emergency.vo.TrackingCubicleRoomBedVo value)
	{
		this.isValidated = false;
	...
	public boolean isValidated()
	{
		...
		{
			if(!this.workflowconfig.isValidated())
			{
				this.isBusy = false;
				return false;
			}
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.workflowconfig != null)
		{
			String[] listOfOtherErrors = this.workflowconfig.validate();
			if(listOfOtherErrors != null)
			{
				for(int x = 0; x < listOfOtherErrors.length; x++)
				{
	...
	public Object clone()
	{
		...
		if(this.workflowconfig == null)
			clone.workflowconfig = null;
		else
			clone.workflowconfig = (ims.emergency.vo.TrackingStatusWorkflowLightVo)this.workflowconfig.clone();
		clone.associatedworkflowmandatory = this.associatedworkflowmandatory;
		if(this.allocatedcubicle == null)
			clone.allocatedcubicle = null;
		else
			clone.allocatedcubicle = (ims.emergency.vo.TrackingCubicleRoomBedVo)this.allocatedcubicle.clone();
	...
	public int countFieldsWithValue()
	{
		...
		if(this.workflowconfig != null)
			count++;
		if(this.associatedworkflowmandatory != null)
			count++;
		if(this.allocatedcubicle != null)
			count++;
		return count;
	...
	protected ims.emergency.vo.TrackingStatusWorkflowLightVo workflowconfig;
	protected Boolean associatedworkflowmandatory;
	protected ims.emergency.vo.TrackingCubicleRoomBedVo allocatedcubicle;
