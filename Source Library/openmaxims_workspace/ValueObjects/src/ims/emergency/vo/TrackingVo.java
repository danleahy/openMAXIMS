...
public class TrackingVo extends ims.emergency.vo.TrackingRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public Object getFieldValueByFieldName(String fieldName)
	{
		...
		if(fieldName.equals("NOOFREFERRALS"))
			return getNoOfReferrals();
		if(fieldName.equals("CURRENTPARTIALADMISSION"))
			return getCurrentPartialAdmission();
		if(fieldName.equals("NOOFATTENDANCENOTES"))
			return getNoOfAttendanceNotes();
	...
	public ims.emergency.vo.SeenByHCPForTrackingVo getSeenBy()
	{
		return this.seenby;
	}
	public void setSeenBy(ims.emergency.vo.SeenByHCPForTrackingVo value)
	{
		this.isValidated = false;
		this.seenby = value;
	}
	...
	public ims.emergency.vo.EDTransferForTrackingVo getCurrentTransferRecord()
	{
		return this.currenttransferrecord;
	}
	public void setCurrentTransferRecord(ims.emergency.vo.EDTransferForTrackingVo value)
	{
		this.isValidated = false;
		this.currenttransferrecord = value;
	}
	public boolean getNoOfReferralsIsNotNull()
	{
		return this.noofreferrals != null;
	}
	...
	public ims.emergency.vo.EDPartialAdmissionForTrackingVo getCurrentPartialAdmission()
	{
		return this.currentpartialadmission;
	}
	public void setCurrentPartialAdmission(ims.emergency.vo.EDPartialAdmissionForTrackingVo value)
	{
		this.isValidated = false;
		this.currentpartialadmission = value;
	}
	public boolean getNoOfAttendanceNotesIsNotNull()
	{
		return this.noofattendancenotes != null;
	}
	...
	public ims.emergency.vo.SeenByHCPForTrackingVo getSeenByNurse()
	{
		return this.seenbynurse;
	}
	public void setSeenByNurse(ims.emergency.vo.SeenByHCPForTrackingVo value)
	{
		this.isValidated = false;
	...
	public ims.emergency.vo.PendingEmergencyAdmissionForTrackingFormVo getAssociatedPendingEmergencyAdmission()
	{
		return this.associatedpendingemergencyadmission;
	}
	public void setAssociatedPendingEmergencyAdmission(ims.emergency.vo.PendingEmergencyAdmissionForTrackingFormVo value)
	{
		this.isValidated = false;
	...
	public Object clone()
	{
		...
		if(this.seenby == null)
			...
			clone.seenby = (ims.emergency.vo.SeenByHCPForTrackingVo)this.seenby.clone();
		...
		if(this.currenttransferrecord == null)
			...
			clone.currenttransferrecord = (ims.emergency.vo.EDTransferForTrackingVo)this.currenttransferrecord.clone();
		clone.noofreferrals = this.noofreferrals;
		if(this.currentpartialadmission == null)
			clone.currentpartialadmission = null;
		else
			clone.currentpartialadmission = (ims.emergency.vo.EDPartialAdmissionForTrackingVo)this.currentpartialadmission.clone();
		clone.noofattendancenotes = this.noofattendancenotes;
		if(this.seenbynurse == null)
			clone.seenbynurse = null;
		else
			clone.seenbynurse = (ims.emergency.vo.SeenByHCPForTrackingVo)this.seenbynurse.clone();
		...
		if(this.associatedpendingemergencyadmission == null)
			...
			clone.associatedpendingemergencyadmission = (ims.emergency.vo.PendingEmergencyAdmissionForTrackingFormVo)this.associatedpendingemergencyadmission.clone();
	...
	public int countFieldsWithValue()
	{
		...
		if(this.currenttransferrecord != null)
			count++;
		if(this.noofreferrals != null)
			count++;
		if(this.currentpartialadmission != null)
			count++;
		if(this.noofattendancenotes != null)
			count++;
		if(this.seenbynurse != null)
			count++;
	...
	protected ims.emergency.vo.SeenByHCPForTrackingVo seenby;
	protected ims.emergency.vo.PatientDiagnosisForTrackingVo primarydiagnosis;
	protected ims.emergency.vo.EDTransferForTrackingVo currenttransferrecord;
	protected Integer noofreferrals;
	protected ims.emergency.vo.EDPartialAdmissionForTrackingVo currentpartialadmission;
	protected Integer noofattendancenotes;
	protected ims.emergency.vo.SeenByHCPForTrackingVo seenbynurse;
	protected Boolean requiringdischargedocumentationreview;
	protected ims.emergency.vo.PendingEmergencyAdmissionForTrackingFormVo associatedpendingemergencyadmission;
