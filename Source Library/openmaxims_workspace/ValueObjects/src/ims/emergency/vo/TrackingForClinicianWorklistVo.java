...
public class TrackingForClinicianWorklistVo extends ims.emergency.vo.TrackingRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public TrackingForClinicianWorklistVo(ims.emergency.vo.beans.TrackingForClinicianWorklistVoBean bean)
	{
		...
		this.seenbynurse = bean.getSeenByNurse() == null ? null : new ims.emergency.vo.SeenByHCPRefVo(new Integer(bean.getSeenByNurse().getId()), bean.getSeenByNurse().getVersion());
	}
	...
	public ims.emergency.vo.SeenByHCPRefVo getSeenByNurse()
	{
		return this.seenbynurse;
	}
	public void setSeenByNurse(ims.emergency.vo.SeenByHCPRefVo value)
	{
		this.isValidated = false;
	...
	public Object clone()
	{
		...
		clone.seenbynurse = this.seenbynurse;
	...
	protected ims.emergency.vo.SeenByHCPRefVo seenbynurse;
