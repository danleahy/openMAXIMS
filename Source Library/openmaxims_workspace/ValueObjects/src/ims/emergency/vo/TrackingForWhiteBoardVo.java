 ...
 */
public class TrackingForWhiteBoardVo extends ims.emergency.vo.TrackingRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public TrackingForWhiteBoardVo()
	{
	}
	public TrackingForWhiteBoardVo(Integer id, int version)
	{
		super(id, version);
	}
	public TrackingForWhiteBoardVo(ims.emergency.vo.beans.TrackingForWhiteBoardVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.emergency.vo.beans.TrackingForWhiteBoardVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.emergency.vo.beans.TrackingForWhiteBoardVoBean bean = null;
		if(map != null)
			bean = (ims.emergency.vo.beans.TrackingForWhiteBoardVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.emergency.vo.beans.TrackingForWhiteBoardVoBean();
	...
	public ims.emergency.vo.TriageForTrackingWhiteVo getTriageDetails()
	{
		return this.triagedetails;
	}
	public void setTriageDetails(ims.emergency.vo.TriageForTrackingWhiteVo value)
	{
		this.isValidated = false;
	...
	public ims.emergency.vo.TrackingAreaShortVo getCurrentArea()
	{
		return this.currentarea;
	}
	public void setCurrentArea(ims.emergency.vo.TrackingAreaShortVo value)
	{
		this.isValidated = false;
	...
	public Object clone()
	{
		...
		TrackingForWhiteBoardVo clone = new TrackingForWhiteBoardVo(this.id, this.version);
		...
		if(this.triagedetails == null)
			...
			clone.triagedetails = (ims.emergency.vo.TriageForTrackingWhiteVo)this.triagedetails.clone();
		if(this.currentarea == null)
			clone.currentarea = null;
		else
			clone.currentarea = (ims.emergency.vo.TrackingAreaShortVo)this.currentarea.clone();
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(TrackingForWhiteBoardVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A TrackingForWhiteBoardVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((TrackingForWhiteBoardVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((TrackingForWhiteBoardVo)obj).getBoId());
	}
	...
	protected ims.emergency.vo.TriageForTrackingWhiteVo triagedetails;
	protected ims.emergency.vo.TrackingAreaShortVo currentarea;
