 ...
 */
public class AttendanceClinicalNotesForWhiteBoardVoAssembler
{
  	/**
	 ...
	 */
	 public static ims.emergency.vo.AttendanceClinicalNotesForWhiteBoardVo copy(ims.emergency.vo.AttendanceClinicalNotesForWhiteBoardVo valueObjectDest, ims.emergency.vo.AttendanceClinicalNotesForWhiteBoardVo valueObjectSrc) 
	 {
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createAttendanceClinicalNotesForWhiteBoardVoCollectionFromAttendanceClinicalNotes(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.emergency.domain.objects.AttendanceClinicalNotes objects.
	 */
	public static ims.emergency.vo.AttendanceClinicalNotesForWhiteBoardVoCollection createAttendanceClinicalNotesForWhiteBoardVoCollectionFromAttendanceClinicalNotes(java.util.Set domainObjectSet)	
	{
		return createAttendanceClinicalNotesForWhiteBoardVoCollectionFromAttendanceClinicalNotes(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.emergency.domain.objects.AttendanceClinicalNotes objects.
	 */
	public static ims.emergency.vo.AttendanceClinicalNotesForWhiteBoardVoCollection createAttendanceClinicalNotesForWhiteBoardVoCollectionFromAttendanceClinicalNotes(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.emergency.vo.AttendanceClinicalNotesForWhiteBoardVoCollection voList = new ims.emergency.vo.AttendanceClinicalNotesForWhiteBoardVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.emergency.vo.AttendanceClinicalNotesForWhiteBoardVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.emergency.vo.AttendanceClinicalNotesForWhiteBoardVoCollection createAttendanceClinicalNotesForWhiteBoardVoCollectionFromAttendanceClinicalNotes(java.util.List domainObjectList) 
	{
		return createAttendanceClinicalNotesForWhiteBoardVoCollectionFromAttendanceClinicalNotes(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.emergency.domain.objects.AttendanceClinicalNotes objects.
	 */
	public static ims.emergency.vo.AttendanceClinicalNotesForWhiteBoardVoCollection createAttendanceClinicalNotesForWhiteBoardVoCollectionFromAttendanceClinicalNotes(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.emergency.vo.AttendanceClinicalNotesForWhiteBoardVoCollection voList = new ims.emergency.vo.AttendanceClinicalNotesForWhiteBoardVoCollection();
	 ...
	 */
	 public static java.util.Set extractAttendanceClinicalNotesSet(ims.domain.ILightweightDomainFactory domainFactory, ims.emergency.vo.AttendanceClinicalNotesForWhiteBoardVoCollection voCollection) 
	 {
	 	return extractAttendanceClinicalNotesSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractAttendanceClinicalNotesSet(ims.domain.ILightweightDomainFactory domainFactory, ims.emergency.vo.AttendanceClinicalNotesForWhiteBoardVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.emergency.vo.AttendanceClinicalNotesForWhiteBoardVo vo = voCollection.get(i);
			ims.emergency.domain.objects.AttendanceClinicalNotes domainObject = AttendanceClinicalNotesForWhiteBoardVoAssembler.extractAttendanceClinicalNotes(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractAttendanceClinicalNotesList(ims.domain.ILightweightDomainFactory domainFactory, ims.emergency.vo.AttendanceClinicalNotesForWhiteBoardVoCollection voCollection) 
	 {
	 	return extractAttendanceClinicalNotesList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractAttendanceClinicalNotesList(ims.domain.ILightweightDomainFactory domainFactory, ims.emergency.vo.AttendanceClinicalNotesForWhiteBoardVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.emergency.vo.AttendanceClinicalNotesForWhiteBoardVo create(ims.emergency.domain.objects.AttendanceClinicalNotes domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.emergency.vo.AttendanceClinicalNotesForWhiteBoardVo create(DomainObjectMap map, ims.emergency.domain.objects.AttendanceClinicalNotes domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.emergency.vo.AttendanceClinicalNotesForWhiteBoardVo valueObject = (ims.emergency.vo.AttendanceClinicalNotesForWhiteBoardVo) map.getValueObject(domainObject, ims.emergency.vo.AttendanceClinicalNotesForWhiteBoardVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.emergency.vo.AttendanceClinicalNotesForWhiteBoardVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.emergency.domain.objects.AttendanceClinicalNotes
	 */
	 public static ims.emergency.vo.AttendanceClinicalNotesForWhiteBoardVo insert(ims.emergency.vo.AttendanceClinicalNotesForWhiteBoardVo valueObject, ims.emergency.domain.objects.AttendanceClinicalNotes domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.emergency.domain.objects.AttendanceClinicalNotes
	 */
	 public static ims.emergency.vo.AttendanceClinicalNotesForWhiteBoardVo insert(DomainObjectMap map, ims.emergency.vo.AttendanceClinicalNotesForWhiteBoardVo valueObject, ims.emergency.domain.objects.AttendanceClinicalNotes domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 */
	public static ims.emergency.domain.objects.AttendanceClinicalNotes extractAttendanceClinicalNotes(ims.domain.ILightweightDomainFactory domainFactory, ims.emergency.vo.AttendanceClinicalNotesForWhiteBoardVo valueObject) 
	{
		return 	extractAttendanceClinicalNotes(domainFactory, valueObject, new HashMap());
	}

	public static ims.emergency.domain.objects.AttendanceClinicalNotes extractAttendanceClinicalNotes(ims.domain.ILightweightDomainFactory domainFactory, ims.emergency.vo.AttendanceClinicalNotesForWhiteBoardVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.emergency.vo.AttendanceClinicalNotesForWhiteBoardVo ID_AttendanceClinicalNotes field is unknown
