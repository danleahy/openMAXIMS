...
public class TrackingAreaVoAssembler
{
	 ...
	 */
	 public static ims.emergency.vo.TrackingAreaVo copy(ims.emergency.vo.TrackingAreaVo valueObjectDest, ims.emergency.vo.TrackingAreaVo valueObjectSrc) 
	 {
		...
		// WorkflowConfig
		valueObjectDest.setWorkflowConfig(valueObjectSrc.getWorkflowConfig());
		// AssociatedWorkflowMandatory
		valueObjectDest.setAssociatedWorkflowMandatory(valueObjectSrc.getAssociatedWorkflowMandatory());
	 ...
	 public static ims.emergency.vo.TrackingAreaVo insert(DomainObjectMap map, ims.emergency.vo.TrackingAreaVo valueObject, ims.emergency.configuration.domain.objects.TrackingArea domainObject) 
	 {
		...
		if ( null != instance10 ) {
			...
			valueObject.setAreaType(voLookup10);
				...
				// WorkflowConfig
		valueObject.setWorkflowConfig(ims.emergency.vo.domain.TrackingStatusWorkflowLightVoAssembler.create(map, domainObject.getWorkflowConfig()) );
		// AssociatedWorkflowMandatory
		valueObject.setAssociatedWorkflowMandatory( domainObject.isAssociatedWorkflowMandatory() );
 		return valueObject;
	 }
	...
	ims.core.resource.place.domain.objects.Location value8 = null;
		...
		domainObject.setWorkflowConfig(ims.emergency.vo.domain.TrackingStatusWorkflowLightVoAssembler.extractTrackingWorkflowConfig(domainFactory, valueObject.getWorkflowConfig(), domMap));
		domainObject.setAssociatedWorkflowMandatory(valueObject.getAssociatedWorkflowMandatory());
