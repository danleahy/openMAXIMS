 ...
 */
public class EDPrescriptionVoAssembler
{
  	/**
	 ...
	 */
	 public static ims.emergency.vo.EDPrescriptionVo copy(ims.emergency.vo.EDPrescriptionVo valueObjectDest, ims.emergency.vo.EDPrescriptionVo valueObjectSrc) 
	 {
		...
		valueObjectDest.setCompletingInformation(valueObjectSrc.getCompletingInformation());
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createEDPrescriptionVoCollectionFromEDPrescription(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.emergency.domain.objects.EDPrescription objects.
	 */
	public static ims.emergency.vo.EDPrescriptionVoCollection createEDPrescriptionVoCollectionFromEDPrescription(java.util.Set domainObjectSet)	
	{
		return createEDPrescriptionVoCollectionFromEDPrescription(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.emergency.domain.objects.EDPrescription objects.
	 */
	public static ims.emergency.vo.EDPrescriptionVoCollection createEDPrescriptionVoCollectionFromEDPrescription(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.emergency.vo.EDPrescriptionVoCollection voList = new ims.emergency.vo.EDPrescriptionVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.emergency.vo.EDPrescriptionVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.emergency.vo.EDPrescriptionVoCollection createEDPrescriptionVoCollectionFromEDPrescription(java.util.List domainObjectList) 
	{
		return createEDPrescriptionVoCollectionFromEDPrescription(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.emergency.domain.objects.EDPrescription objects.
	 */
	public static ims.emergency.vo.EDPrescriptionVoCollection createEDPrescriptionVoCollectionFromEDPrescription(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.emergency.vo.EDPrescriptionVoCollection voList = new ims.emergency.vo.EDPrescriptionVoCollection();
	 ...
	 */
	 public static java.util.Set extractEDPrescriptionSet(ims.domain.ILightweightDomainFactory domainFactory, ims.emergency.vo.EDPrescriptionVoCollection voCollection) 
	 {
	 	return extractEDPrescriptionSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractEDPrescriptionSet(ims.domain.ILightweightDomainFactory domainFactory, ims.emergency.vo.EDPrescriptionVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.emergency.vo.EDPrescriptionVo vo = voCollection.get(i);
			ims.emergency.domain.objects.EDPrescription domainObject = EDPrescriptionVoAssembler.extractEDPrescription(domainFactory, vo, domMap);
	 ...
	 */
	 ...
	 public static java.util.List extractEDPrescriptionList(ims.domain.ILightweightDomainFactory domainFactory, ims.emergency.vo.EDPrescriptionVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.emergency.vo.EDPrescriptionVo create(ims.emergency.domain.objects.EDPrescription domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.emergency.vo.EDPrescriptionVo create(DomainObjectMap map, ims.emergency.domain.objects.EDPrescription domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.emergency.vo.EDPrescriptionVo valueObject = (ims.emergency.vo.EDPrescriptionVo) map.getValueObject(domainObject, ims.emergency.vo.EDPrescriptionVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.emergency.vo.EDPrescriptionVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.emergency.domain.objects.EDPrescription
	 */
	 public static ims.emergency.vo.EDPrescriptionVo insert(ims.emergency.vo.EDPrescriptionVo valueObject, ims.emergency.domain.objects.EDPrescription domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.emergency.domain.objects.EDPrescription
	 */
	 public static ims.emergency.vo.EDPrescriptionVo insert(DomainObjectMap map, ims.emergency.vo.EDPrescriptionVo valueObject, ims.emergency.domain.objects.EDPrescription domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
		...
		// CompletingInformation
		valueObject.setCompletingInformation(ims.core.vo.domain.AuthoringInformationVoAssembler.create(map, domainObject.getCompletingInformation()) );
 		return valueObject;
	 }
	 ...
	 */
	public static ims.emergency.domain.objects.EDPrescription extractEDPrescription(ims.domain.ILightweightDomainFactory domainFactory, ims.emergency.vo.EDPrescriptionVo valueObject) 
	{
		return 	extractEDPrescription(domainFactory, valueObject, new HashMap());
	}

	public static ims.emergency.domain.objects.EDPrescription extractEDPrescription(ims.domain.ILightweightDomainFactory domainFactory, ims.emergency.vo.EDPrescriptionVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.emergency.vo.EDPrescriptionVo ID_EDPrescription field is unknown
	...
	ims.core.admin.domain.objects.CareContext value3 = null;
		...
		domainObject.setCompletingInformation(ims.core.vo.domain.AuthoringInformationVoAssembler.extractAuthoringInformation(domainFactory, valueObject.getCompletingInformation(), domMap));
