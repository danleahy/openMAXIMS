 ...
 */
public class TrackingForWhiteBoardVoAssembler
{
  	/**
	 ...
	 */
	 public static ims.emergency.vo.TrackingForWhiteBoardVo copy(ims.emergency.vo.TrackingForWhiteBoardVo valueObjectDest, ims.emergency.vo.TrackingForWhiteBoardVo valueObjectSrc) 
	 {
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createTrackingForWhiteBoardVoCollectionFromTracking(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.emergency.domain.objects.Tracking objects.
	 */
	public static ims.emergency.vo.TrackingForWhiteBoardVoCollection createTrackingForWhiteBoardVoCollectionFromTracking(java.util.Set domainObjectSet)	
	{
		return createTrackingForWhiteBoardVoCollectionFromTracking(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.emergency.domain.objects.Tracking objects.
	 */
	public static ims.emergency.vo.TrackingForWhiteBoardVoCollection createTrackingForWhiteBoardVoCollectionFromTracking(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.emergency.vo.TrackingForWhiteBoardVoCollection voList = new ims.emergency.vo.TrackingForWhiteBoardVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.emergency.vo.TrackingForWhiteBoardVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.emergency.vo.TrackingForWhiteBoardVoCollection createTrackingForWhiteBoardVoCollectionFromTracking(java.util.List domainObjectList) 
	{
		return createTrackingForWhiteBoardVoCollectionFromTracking(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.emergency.domain.objects.Tracking objects.
	 */
	public static ims.emergency.vo.TrackingForWhiteBoardVoCollection createTrackingForWhiteBoardVoCollectionFromTracking(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.emergency.vo.TrackingForWhiteBoardVoCollection voList = new ims.emergency.vo.TrackingForWhiteBoardVoCollection();
	 ...
	 */
	 public static java.util.Set extractTrackingSet(ims.domain.ILightweightDomainFactory domainFactory, ims.emergency.vo.TrackingForWhiteBoardVoCollection voCollection) 
	 {
	 	return extractTrackingSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractTrackingSet(ims.domain.ILightweightDomainFactory domainFactory, ims.emergency.vo.TrackingForWhiteBoardVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.emergency.vo.TrackingForWhiteBoardVo vo = voCollection.get(i);
			ims.emergency.domain.objects.Tracking domainObject = TrackingForWhiteBoardVoAssembler.extractTracking(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractTrackingList(ims.domain.ILightweightDomainFactory domainFactory, ims.emergency.vo.TrackingForWhiteBoardVoCollection voCollection) 
	 {
	 	return extractTrackingList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractTrackingList(ims.domain.ILightweightDomainFactory domainFactory, ims.emergency.vo.TrackingForWhiteBoardVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.emergency.vo.TrackingForWhiteBoardVo create(ims.emergency.domain.objects.Tracking domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.emergency.vo.TrackingForWhiteBoardVo create(DomainObjectMap map, ims.emergency.domain.objects.Tracking domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.emergency.vo.TrackingForWhiteBoardVo valueObject = (ims.emergency.vo.TrackingForWhiteBoardVo) map.getValueObject(domainObject, ims.emergency.vo.TrackingForWhiteBoardVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.emergency.vo.TrackingForWhiteBoardVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.emergency.domain.objects.Tracking
	 */
	 public static ims.emergency.vo.TrackingForWhiteBoardVo insert(ims.emergency.vo.TrackingForWhiteBoardVo valueObject, ims.emergency.domain.objects.Tracking domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.emergency.domain.objects.Tracking
	 */
	 public static ims.emergency.vo.TrackingForWhiteBoardVo insert(DomainObjectMap map, ims.emergency.vo.TrackingForWhiteBoardVo valueObject, ims.emergency.domain.objects.Tracking domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
		...
		// TriageDetails
		valueObject.setTriageDetails(ims.emergency.vo.domain.TriageForTrackingWhiteVoAssembler.create(map, domainObject.getTriageDetails()) );
		// CurrentArea
		valueObject.setCurrentArea(ims.emergency.vo.domain.TrackingAreaShortVoAssembler.create(map, domainObject.getCurrentArea()) );
		// CurrentStatus
	 ...
	 */
	public static ims.emergency.domain.objects.Tracking extractTracking(ims.domain.ILightweightDomainFactory domainFactory, ims.emergency.vo.TrackingForWhiteBoardVo valueObject) 
	{
		return 	extractTracking(domainFactory, valueObject, new HashMap());
	}

	public static ims.emergency.domain.objects.Tracking extractTracking(ims.domain.ILightweightDomainFactory domainFactory, ims.emergency.vo.TrackingForWhiteBoardVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.emergency.vo.TrackingForWhiteBoardVo ID_Tracking field is unknown
