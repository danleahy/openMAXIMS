...
public class TrackingVoBean extends ims.vo.ValueObjectBean
{
	...
	public TrackingVoBean(ims.emergency.vo.TrackingVo vo)
	{
		...
		this.seenby = vo.getSeenBy() == null ? null : (ims.emergency.vo.beans.SeenByHCPForTrackingVoBean)vo.getSeenBy().getBean();
		...
		this.currenttransferrecord = vo.getCurrentTransferRecord() == null ? null : (ims.emergency.vo.beans.EDTransferForTrackingVoBean)vo.getCurrentTransferRecord().getBean();
		this.noofreferrals = vo.getNoOfReferrals();
		this.currentpartialadmission = vo.getCurrentPartialAdmission() == null ? null : (ims.emergency.vo.beans.EDPartialAdmissionForTrackingVoBean)vo.getCurrentPartialAdmission().getBean();
		this.noofattendancenotes = vo.getNoOfAttendanceNotes();
		this.seenbynurse = vo.getSeenByNurse() == null ? null : (ims.emergency.vo.beans.SeenByHCPForTrackingVoBean)vo.getSeenByNurse().getBean();
		this.requiringdischargedocumentationreview = vo.getRequiringDischargeDocumentationReview();
		this.associatedpendingemergencyadmission = vo.getAssociatedPendingEmergencyAdmission() == null ? null : (ims.emergency.vo.beans.PendingEmergencyAdmissionForTrackingFormVoBean)vo.getAssociatedPendingEmergencyAdmission().getBean();
	}
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.emergency.vo.TrackingVo vo)
	{
		...
		this.lastmovementdateinminutes = vo.getLastMovementDateInMinutes();
		this.isdischarged = vo.getIsDischarged();
		this.seenby = vo.getSeenBy() == null ? null : (ims.emergency.vo.beans.SeenByHCPForTrackingVoBean)vo.getSeenBy().getBean(map);
		...
		this.currenttransferrecord = vo.getCurrentTransferRecord() == null ? null : (ims.emergency.vo.beans.EDTransferForTrackingVoBean)vo.getCurrentTransferRecord().getBean(map);
		this.noofreferrals = vo.getNoOfReferrals();
		this.currentpartialadmission = vo.getCurrentPartialAdmission() == null ? null : (ims.emergency.vo.beans.EDPartialAdmissionForTrackingVoBean)vo.getCurrentPartialAdmission().getBean(map);
		this.noofattendancenotes = vo.getNoOfAttendanceNotes();
		this.seenbynurse = vo.getSeenByNurse() == null ? null : (ims.emergency.vo.beans.SeenByHCPForTrackingVoBean)vo.getSeenByNurse().getBean(map);
		this.requiringdischargedocumentationreview = vo.getRequiringDischargeDocumentationReview();
		this.associatedpendingemergencyadmission = vo.getAssociatedPendingEmergencyAdmission() == null ? null : (ims.emergency.vo.beans.PendingEmergencyAdmissionForTrackingFormVoBean)vo.getAssociatedPendingEmergencyAdmission().getBean(map);
	}
	...
	public ims.emergency.vo.beans.SeenByHCPForTrackingVoBean getSeenBy()
	{
		return this.seenby;
	}
	public void setSeenBy(ims.emergency.vo.beans.SeenByHCPForTrackingVoBean value)
	{
		this.seenby = value;
	}
	...
	public ims.emergency.vo.beans.EDTransferForTrackingVoBean getCurrentTransferRecord()
	{
		return this.currenttransferrecord;
	}
	public void setCurrentTransferRecord(ims.emergency.vo.beans.EDTransferForTrackingVoBean value)
	{
	...
	public void setNoOfReferrals(Integer value)
	{
		this.noofreferrals = value;
	}
	public ims.emergency.vo.beans.EDPartialAdmissionForTrackingVoBean getCurrentPartialAdmission()
	{
		return this.currentpartialadmission;
	}
	public void setCurrentPartialAdmission(ims.emergency.vo.beans.EDPartialAdmissionForTrackingVoBean value)
	{
		this.currentpartialadmission = value;
	}
	public Integer getNoOfAttendanceNotes()
	{
		return this.noofattendancenotes;
	}
	public void setNoOfAttendanceNotes(Integer value)
	{
		this.noofattendancenotes = value;
	}
	public ims.emergency.vo.beans.SeenByHCPForTrackingVoBean getSeenByNurse()
	{
		return this.seenbynurse;
	}
	public void setSeenByNurse(ims.emergency.vo.beans.SeenByHCPForTrackingVoBean value)
	{
	...
	public ims.emergency.vo.beans.PendingEmergencyAdmissionForTrackingFormVoBean getAssociatedPendingEmergencyAdmission()
	{
		return this.associatedpendingemergencyadmission;
	}
	public void setAssociatedPendingEmergencyAdmission(ims.emergency.vo.beans.PendingEmergencyAdmissionForTrackingFormVoBean value)
	{
	...
	private ims.emergency.vo.beans.SeenByHCPForTrackingVoBean seenby;
	private ims.emergency.vo.beans.PatientDiagnosisForTrackingVoBean primarydiagnosis;
	private ims.emergency.vo.beans.EDTransferForTrackingVoBean currenttransferrecord;
	private Integer noofreferrals;
	private ims.emergency.vo.beans.EDPartialAdmissionForTrackingVoBean currentpartialadmission;
	private Integer noofattendancenotes;
	private ims.emergency.vo.beans.SeenByHCPForTrackingVoBean seenbynurse;
	private Boolean requiringdischargedocumentationreview;
	private ims.emergency.vo.beans.PendingEmergencyAdmissionForTrackingFormVoBean associatedpendingemergencyadmission;
}
