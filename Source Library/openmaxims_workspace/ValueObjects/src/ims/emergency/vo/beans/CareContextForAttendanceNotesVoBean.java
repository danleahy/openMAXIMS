...
public class CareContextForAttendanceNotesVoBean extends ims.vo.ValueObjectBean
{
	public CareContextForAttendanceNotesVoBean()
	{
	}
	public CareContextForAttendanceNotesVoBean(ims.emergency.vo.CareContextForAttendanceNotesVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.emergency.vo.CareContextForAttendanceNotesVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.startdatetime = vo.getStartDateTime() == null ? null : (ims.framework.utils.beans.DateTimeBean)vo.getStartDateTime().getBean();
	...
	public ims.emergency.vo.CareContextForAttendanceNotesVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.emergency.vo.CareContextForAttendanceNotesVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.emergency.vo.CareContextForAttendanceNotesVo vo = null;
		if(map != null)
			vo = (ims.emergency.vo.CareContextForAttendanceNotesVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.emergency.vo.CareContextForAttendanceNotesVo();
