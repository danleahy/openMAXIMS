...
public class TriageDetailsForWhiteBoardVoBean extends ims.vo.ValueObjectBean
{
	public TriageDetailsForWhiteBoardVoBean()
	{
	}
	public TriageDetailsForWhiteBoardVoBean(ims.emergency.vo.TriageDetailsForWhiteBoardVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.emergency.vo.TriageDetailsForWhiteBoardVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.currenttriagepriority = vo.getCurrentTriagePriority() == null ? null : (ims.vo.LookupInstanceBean)vo.getCurrentTriagePriority().getBean();
	...
	public ims.emergency.vo.TriageDetailsForWhiteBoardVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.emergency.vo.TriageDetailsForWhiteBoardVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.emergency.vo.TriageDetailsForWhiteBoardVo vo = null;
		if(map != null)
			vo = (ims.emergency.vo.TriageDetailsForWhiteBoardVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.emergency.vo.TriageDetailsForWhiteBoardVo();
