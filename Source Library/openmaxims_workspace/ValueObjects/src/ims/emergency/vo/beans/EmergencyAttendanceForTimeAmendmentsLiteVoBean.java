...
public class EmergencyAttendanceForTimeAmendmentsLiteVoBean extends ims.vo.ValueObjectBean
{
	public EmergencyAttendanceForTimeAmendmentsLiteVoBean()
	{
	}
	public EmergencyAttendanceForTimeAmendmentsLiteVoBean(ims.emergency.vo.EmergencyAttendanceForTimeAmendmentsLiteVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.emergency.vo.EmergencyAttendanceForTimeAmendmentsLiteVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.registrationdatetime = vo.getRegistrationDateTime() == null ? null : (ims.framework.utils.beans.DateTimeBean)vo.getRegistrationDateTime().getBean();
	...
	public ims.emergency.vo.EmergencyAttendanceForTimeAmendmentsLiteVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.emergency.vo.EmergencyAttendanceForTimeAmendmentsLiteVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.emergency.vo.EmergencyAttendanceForTimeAmendmentsLiteVo vo = null;
		if(map != null)
			vo = (ims.emergency.vo.EmergencyAttendanceForTimeAmendmentsLiteVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.emergency.vo.EmergencyAttendanceForTimeAmendmentsLiteVo();
