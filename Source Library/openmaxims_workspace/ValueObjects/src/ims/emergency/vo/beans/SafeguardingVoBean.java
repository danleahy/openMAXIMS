...
public class SafeguardingVoBean extends ims.vo.ValueObjectBean
{
	public SafeguardingVoBean()
	{
	}
	public SafeguardingVoBean(ims.emergency.vo.SafeguardingVo vo)
	{
		this.id = vo.getBoId();
		...
		this.nameofotheradultsinhouse = vo.getNameOfOtherAdultsInHouse();
		this.socialworkers = vo.getSocialWorkers();
		this.comments = vo.getComments();
	}

	public void populate(ims.vo.ValueObjectBeanMap map, ims.emergency.vo.SafeguardingVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.patient = vo.getPatient() == null ? null : new ims.vo.RefVoBean(vo.getPatient().getBoId(), vo.getPatient().getBoVersion());
	...
	public ims.emergency.vo.SafeguardingVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.emergency.vo.SafeguardingVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.emergency.vo.SafeguardingVo vo = null;
		if(map != null)
			vo = (ims.emergency.vo.SafeguardingVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.emergency.vo.SafeguardingVo();
