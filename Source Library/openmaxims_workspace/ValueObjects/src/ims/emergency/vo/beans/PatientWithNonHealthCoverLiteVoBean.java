...
public class PatientWithNonHealthCoverLiteVoBean extends ims.vo.ValueObjectBean
{
	public PatientWithNonHealthCoverLiteVoBean()
	{
	}
	public PatientWithNonHealthCoverLiteVoBean(ims.emergency.vo.PatientWithNonHealthCoverLiteVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.emergency.vo.PatientWithNonHealthCoverLiteVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
	...
	public ims.emergency.vo.PatientWithNonHealthCoverLiteVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.emergency.vo.PatientWithNonHealthCoverLiteVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.emergency.vo.PatientWithNonHealthCoverLiteVo vo = null;
		if(map != null)
			vo = (ims.emergency.vo.PatientWithNonHealthCoverLiteVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.emergency.vo.PatientWithNonHealthCoverLiteVo();
