...
public class EmergencyAttendanceLiteVoBean extends ims.vo.ValueObjectBean
{
	public EmergencyAttendanceLiteVoBean()
	{
	}
	public EmergencyAttendanceLiteVoBean(ims.emergency.vo.EmergencyAttendanceLiteVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.emergency.vo.EmergencyAttendanceLiteVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.customid = vo.getCustomID();
	...
	public ims.emergency.vo.EmergencyAttendanceLiteVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.emergency.vo.EmergencyAttendanceLiteVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.emergency.vo.EmergencyAttendanceLiteVo vo = null;
		if(map != null)
			vo = (ims.emergency.vo.EmergencyAttendanceLiteVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.emergency.vo.EmergencyAttendanceLiteVo();
