...
public class TrackingforDecisionToAdmitDialogVoBean extends ims.vo.ValueObjectBean
{
	public TrackingforDecisionToAdmitDialogVoBean()
	{
	}
	public TrackingforDecisionToAdmitDialogVoBean(ims.emergency.vo.TrackingforDecisionToAdmitDialogVo vo)
	{
		this.id = vo.getBoId();
		...
		this.seenby = vo.getSeenBy() == null ? null : (ims.emergency.vo.beans.SeenByHCPForEDAssessmentComponentVoBean)vo.getSeenBy().getBean();
		this.currentreferral = vo.getCurrentReferral() == null ? null : (ims.emergency.vo.beans.ReferralToSpecialtyTeamForEDAssessmentComponentVoBean)vo.getCurrentReferral().getBean();
		this.seenbynurse = vo.getSeenByNurse() == null ? null : (ims.emergency.vo.beans.SeenByHCPForEDAssessmentComponentVoBean)vo.getSeenByNurse().getBean();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.emergency.vo.TrackingforDecisionToAdmitDialogVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		...
		this.seenby = vo.getSeenBy() == null ? null : (ims.emergency.vo.beans.SeenByHCPForEDAssessmentComponentVoBean)vo.getSeenBy().getBean(map);
		this.currentreferral = vo.getCurrentReferral() == null ? null : (ims.emergency.vo.beans.ReferralToSpecialtyTeamForEDAssessmentComponentVoBean)vo.getCurrentReferral().getBean(map);
		this.seenbynurse = vo.getSeenByNurse() == null ? null : (ims.emergency.vo.beans.SeenByHCPForEDAssessmentComponentVoBean)vo.getSeenByNurse().getBean(map);
	...
	public ims.emergency.vo.TrackingforDecisionToAdmitDialogVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.emergency.vo.TrackingforDecisionToAdmitDialogVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.emergency.vo.TrackingforDecisionToAdmitDialogVo vo = null;
		if(map != null)
			vo = (ims.emergency.vo.TrackingforDecisionToAdmitDialogVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.emergency.vo.TrackingforDecisionToAdmitDialogVo();
	...
	public ims.emergency.vo.beans.SeenByHCPForEDAssessmentComponentVoBean getSeenBy()
	{
		return this.seenby;
	}
	public void setSeenBy(ims.emergency.vo.beans.SeenByHCPForEDAssessmentComponentVoBean value)
	{
		this.seenby = value;
	}
	public ims.emergency.vo.beans.ReferralToSpecialtyTeamForEDAssessmentComponentVoBean getCurrentReferral()
	{
		return this.currentreferral;
	}
	public void setCurrentReferral(ims.emergency.vo.beans.ReferralToSpecialtyTeamForEDAssessmentComponentVoBean value)
	{
		this.currentreferral = value;
	}
	public ims.emergency.vo.beans.SeenByHCPForEDAssessmentComponentVoBean getSeenByNurse()
	{
		return this.seenbynurse;
	}
	public void setSeenByNurse(ims.emergency.vo.beans.SeenByHCPForEDAssessmentComponentVoBean value)
	{
	...
	private ims.emergency.vo.beans.SeenByHCPForEDAssessmentComponentVoBean seenby;
	private ims.emergency.vo.beans.ReferralToSpecialtyTeamForEDAssessmentComponentVoBean currentreferral;
	private ims.emergency.vo.beans.SeenByHCPForEDAssessmentComponentVoBean seenbynurse;
