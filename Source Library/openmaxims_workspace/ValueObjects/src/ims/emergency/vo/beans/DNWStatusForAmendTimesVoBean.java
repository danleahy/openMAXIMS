...
public class DNWStatusForAmendTimesVoBean extends ims.vo.ValueObjectBean
{
	public DNWStatusForAmendTimesVoBean()
	{
	}
	public DNWStatusForAmendTimesVoBean(ims.emergency.vo.DNWStatusForAmendTimesVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.emergency.vo.DNWStatusForAmendTimesVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.statusdatetime = vo.getStatusDateTime() == null ? null : (ims.framework.utils.beans.DateTimeBean)vo.getStatusDateTime().getBean();
	...
	public ims.emergency.vo.DNWStatusForAmendTimesVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.emergency.vo.DNWStatusForAmendTimesVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.emergency.vo.DNWStatusForAmendTimesVo vo = null;
		if(map != null)
			vo = (ims.emergency.vo.DNWStatusForAmendTimesVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.emergency.vo.DNWStatusForAmendTimesVo();
