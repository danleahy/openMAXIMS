...
public class TrackingForPatientWhiteBoardVoBean extends ims.vo.ValueObjectBean
{
	public TrackingForPatientWhiteBoardVoBean()
	{
	}
	public TrackingForPatientWhiteBoardVoBean(ims.emergency.vo.TrackingForPatientWhiteBoardVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.patient = vo.getPatient() == null ? null : (ims.emergency.vo.beans.PatientForTriageVoBean)vo.getPatient().getBean();
		this.attendance = vo.getAttendance() == null ? null : (ims.emergency.vo.beans.EmergencyAttendanceForWhiteBoardVoBean)vo.getAttendance().getBean();
		this.triagedetails = vo.getTriageDetails() == null ? null : (ims.emergency.vo.beans.TriageDetailsForWhiteBoardVoBean)vo.getTriageDetails().getBean();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.emergency.vo.TrackingForPatientWhiteBoardVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.patient = vo.getPatient() == null ? null : (ims.emergency.vo.beans.PatientForTriageVoBean)vo.getPatient().getBean(map);
		this.attendance = vo.getAttendance() == null ? null : (ims.emergency.vo.beans.EmergencyAttendanceForWhiteBoardVoBean)vo.getAttendance().getBean(map);
		this.triagedetails = vo.getTriageDetails() == null ? null : (ims.emergency.vo.beans.TriageDetailsForWhiteBoardVoBean)vo.getTriageDetails().getBean(map);
	...
	public ims.emergency.vo.TrackingForPatientWhiteBoardVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.emergency.vo.TrackingForPatientWhiteBoardVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.emergency.vo.TrackingForPatientWhiteBoardVo vo = null;
		if(map != null)
			vo = (ims.emergency.vo.TrackingForPatientWhiteBoardVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.emergency.vo.TrackingForPatientWhiteBoardVo();
	...
	public ims.emergency.vo.beans.EmergencyAttendanceForWhiteBoardVoBean getAttendance()
	{
		return this.attendance;
	}
	public void setAttendance(ims.emergency.vo.beans.EmergencyAttendanceForWhiteBoardVoBean value)
	{
		this.attendance = value;
	}
	public ims.emergency.vo.beans.TriageDetailsForWhiteBoardVoBean getTriageDetails()
	{
		return this.triagedetails;
	}
	public void setTriageDetails(ims.emergency.vo.beans.TriageDetailsForWhiteBoardVoBean value)
	{
	...
	private ims.emergency.vo.beans.EmergencyAttendanceForWhiteBoardVoBean attendance;
	private ims.emergency.vo.beans.TriageDetailsForWhiteBoardVoBean triagedetails;
