...
public class ReferralToSpecialtyTeamForPartialAdmissionVoBean extends ims.vo.ValueObjectBean
{
	public ReferralToSpecialtyTeamForPartialAdmissionVoBean()
	{
	}
	public ReferralToSpecialtyTeamForPartialAdmissionVoBean(ims.emergency.vo.ReferralToSpecialtyTeamForPartialAdmissionVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.emergency.vo.ReferralToSpecialtyTeamForPartialAdmissionVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.attendance = vo.getAttendance() == null ? null : new ims.vo.RefVoBean(vo.getAttendance().getBoId(), vo.getAttendance().getBoVersion());
	...
	public ims.emergency.vo.ReferralToSpecialtyTeamForPartialAdmissionVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.emergency.vo.ReferralToSpecialtyTeamForPartialAdmissionVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.emergency.vo.ReferralToSpecialtyTeamForPartialAdmissionVo vo = null;
		if(map != null)
			vo = (ims.emergency.vo.ReferralToSpecialtyTeamForPartialAdmissionVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.emergency.vo.ReferralToSpecialtyTeamForPartialAdmissionVo();
