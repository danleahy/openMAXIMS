...
public class TrackingForClinicianWorklistVoBean extends ims.vo.ValueObjectBean
{
	...
	public TrackingForClinicianWorklistVoBean(ims.emergency.vo.TrackingForClinicianWorklistVo vo)
	{
		...
		this.seenbynurse = vo.getSeenByNurse() == null ? null : new ims.vo.RefVoBean(vo.getSeenByNurse().getBoId(), vo.getSeenByNurse().getBoVersion());
	}
	...
	public ims.vo.RefVoBean getSeenByNurse()
	{
		return this.seenbynurse;
	}
	public void setSeenByNurse(ims.vo.RefVoBean value)
	{
	...
	private ims.vo.RefVoBean seenbynurse;
}
