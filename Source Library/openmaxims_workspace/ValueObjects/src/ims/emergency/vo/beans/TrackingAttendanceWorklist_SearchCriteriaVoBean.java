...
public class TrackingAttendanceWorklist_SearchCriteriaVoBean extends ims.vo.ValueObjectBean
{
	...
	public TrackingAttendanceWorklist_SearchCriteriaVoBean(ims.emergency.vo.TrackingAttendanceWorklist_SearchCriteriaVo vo)
	{
		...
		this.clinicalproblem = vo.getClinicalProblem() == null ? null : (ims.clinical.vo.beans.ClinicalProblemShortVoBean)vo.getClinicalProblem().getBean();
		this.showtemporaryregistrations = vo.getShowTemporaryRegistrations();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.emergency.vo.TrackingAttendanceWorklist_SearchCriteriaVo vo)
	{
		...
		this.presentingproblem = vo.getPresentingProblem() == null ? null : (ims.vo.LookupInstanceBean)vo.getPresentingProblem().getBean();
		this.attendancenotcoded = vo.getAttendanceNotCoded();
		this.clinicalproblem = vo.getClinicalProblem() == null ? null : (ims.clinical.vo.beans.ClinicalProblemShortVoBean)vo.getClinicalProblem().getBean(map);
		this.showtemporaryregistrations = vo.getShowTemporaryRegistrations();
		this.idvalue = vo.getIDValue();
		this.includerequiresdischargedocumentationreview = vo.getIncludeRequiresDischargeDocumentationReview();
	}
	...
	public ims.clinical.vo.beans.ClinicalProblemShortVoBean getClinicalProblem()
	{
		return this.clinicalproblem;
	}
	public void setClinicalProblem(ims.clinical.vo.beans.ClinicalProblemShortVoBean value)
	{
	...
	private ims.clinical.vo.beans.ClinicalProblemShortVoBean clinicalproblem;
	private Boolean showtemporaryregistrations;
