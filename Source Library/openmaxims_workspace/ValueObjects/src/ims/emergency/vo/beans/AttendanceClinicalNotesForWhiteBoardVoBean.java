...
public class AttendanceClinicalNotesForWhiteBoardVoBean extends ims.vo.ValueObjectBean
{
	public AttendanceClinicalNotesForWhiteBoardVoBean()
	{
	}
	public AttendanceClinicalNotesForWhiteBoardVoBean(ims.emergency.vo.AttendanceClinicalNotesForWhiteBoardVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.emergency.vo.AttendanceClinicalNotesForWhiteBoardVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.patient = vo.getPatient() == null ? null : new ims.vo.RefVoBean(vo.getPatient().getBoId(), vo.getPatient().getBoVersion());
	...
	public ims.emergency.vo.AttendanceClinicalNotesForWhiteBoardVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.emergency.vo.AttendanceClinicalNotesForWhiteBoardVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.emergency.vo.AttendanceClinicalNotesForWhiteBoardVo vo = null;
		if(map != null)
			vo = (ims.emergency.vo.AttendanceClinicalNotesForWhiteBoardVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.emergency.vo.AttendanceClinicalNotesForWhiteBoardVo();
