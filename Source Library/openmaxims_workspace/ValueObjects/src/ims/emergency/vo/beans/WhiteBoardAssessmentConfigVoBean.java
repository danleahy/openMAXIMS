...
public class WhiteBoardAssessmentConfigVoBean extends ims.vo.ValueObjectBean
{
	...
	public WhiteBoardAssessmentConfigVoBean(ims.emergency.vo.WhiteBoardAssessmentConfigVo vo)
	{
		...
		this.associatedassessment = vo.getAssociatedAssessment() == null ? null : (ims.emergency.vo.beans.UserAssessmentForWhiteboardConfigVoBean)vo.getAssociatedAssessment().getBean();
	}
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.emergency.vo.WhiteBoardAssessmentConfigVo vo)
	{
		...
		this.name = vo.getName();
		this.icon = vo.getIcon() == null ? null : new ims.vo.RefVoBean(vo.getIcon().getBoId(), vo.getIcon().getBoVersion());
		this.associatedassessment = vo.getAssociatedAssessment() == null ? null : (ims.emergency.vo.beans.UserAssessmentForWhiteboardConfigVoBean)vo.getAssociatedAssessment().getBean(map);
	}
	...
	public ims.emergency.vo.beans.UserAssessmentForWhiteboardConfigVoBean getAssociatedAssessment()
	{
		return this.associatedassessment;
	}
	public void setAssociatedAssessment(ims.emergency.vo.beans.UserAssessmentForWhiteboardConfigVoBean value)
	{
	...
	private ims.emergency.vo.beans.UserAssessmentForWhiteboardConfigVoBean associatedassessment;
}
