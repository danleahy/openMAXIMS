...
public class TriageForTriageProtocolAssessmentVo extends ims.emergency.vo.TriageRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public ims.emergency.vo.TriageProtocolAssessmentLiteVo getInitialTriageAssessment()
	{
		return this.initialtriageassessment;
	}
	public void setInitialTriageAssessment(ims.emergency.vo.TriageProtocolAssessmentLiteVo value)
	{
		this.isValidated = false;
	...
	public boolean isValidated()
	{
		...
		{
			if(!this.initialtriageassessment.isValidated())
			{
				this.isBusy = false;
				return false;
			}
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.initialtriageassessment != null)
		{
			String[] listOfOtherErrors = this.initialtriageassessment.validate();
			if(listOfOtherErrors != null)
			{
				for(int x = 0; x < listOfOtherErrors.length; x++)
				{
	...
	public Object clone()
	{
		...
		if(this.initialtriageassessment == null)
			...
			clone.initialtriageassessment = (ims.emergency.vo.TriageProtocolAssessmentLiteVo)this.initialtriageassessment.clone();
	...
	protected ims.emergency.vo.TriageProtocolAssessmentLiteVo initialtriageassessment;
