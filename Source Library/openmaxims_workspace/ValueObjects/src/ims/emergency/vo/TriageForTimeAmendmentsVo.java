 ...
 */
public class TriageForTimeAmendmentsVo extends ims.emergency.vo.TriageRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public TriageForTimeAmendmentsVo()
	{
	}
	public TriageForTimeAmendmentsVo(Integer id, int version)
	{
		super(id, version);
	}
	public TriageForTimeAmendmentsVo(ims.emergency.vo.beans.TriageForTimeAmendmentsVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.emergency.vo.beans.TriageForTimeAmendmentsVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.triagestartdatetime = bean.getTriageStartDateTime() == null ? null : bean.getTriageStartDateTime().buildDateTime();
	...
	{
		ims.emergency.vo.beans.TriageForTimeAmendmentsVoBean bean = null;
		if(map != null)
			bean = (ims.emergency.vo.beans.TriageForTimeAmendmentsVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.emergency.vo.beans.TriageForTimeAmendmentsVoBean();
	...
	public Object clone()
	{
		...
		TriageForTimeAmendmentsVo clone = new TriageForTimeAmendmentsVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(TriageForTimeAmendmentsVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A TriageForTimeAmendmentsVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((TriageForTimeAmendmentsVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((TriageForTimeAmendmentsVo)obj).getBoId());
	}
