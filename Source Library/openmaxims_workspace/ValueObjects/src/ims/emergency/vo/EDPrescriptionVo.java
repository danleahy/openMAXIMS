 ...
 */
public class EDPrescriptionVo extends ims.emergency.vo.EDPrescriptionRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public EDPrescriptionVo()
	{
	}
	public EDPrescriptionVo(Integer id, int version)
	{
		super(id, version);
	}
	public EDPrescriptionVo(ims.emergency.vo.beans.EDPrescriptionVoBean bean)
	{
		this.id = bean.getId();
		...
		this.completinginformation = bean.getCompletingInformation() == null ? null : bean.getCompletingInformation().buildVo();
	}
	public void populate(ims.vo.ValueObjectBeanMap map, ims.emergency.vo.beans.EDPrescriptionVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.patient = bean.getPatient() == null ? null : new ims.core.patient.vo.PatientRefVo(new Integer(bean.getPatient().getId()), bean.getPatient().getVersion());
		...
		this.iscompleted = bean.getIsCompleted();
		this.isprinted = bean.getIsPrinted();
		this.completinginformation = bean.getCompletingInformation() == null ? null : bean.getCompletingInformation().buildVo(map);
	}
	...
	{
		ims.emergency.vo.beans.EDPrescriptionVoBean bean = null;
		if(map != null)
			bean = (ims.emergency.vo.beans.EDPrescriptionVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.emergency.vo.beans.EDPrescriptionVoBean();
	...
	public Object getFieldValueByFieldName(String fieldName)
	{
		...
		if(fieldName.equals("ISPRINTED"))
			return getIsPrinted();
		if(fieldName.equals("COMPLETINGINFORMATION"))
			return getCompletingInformation();
	...
	public boolean getCompletingInformationIsNotNull()
	{
		return this.completinginformation != null;
	}
	public ims.core.vo.AuthoringInformationVo getCompletingInformation()
	{
		return this.completinginformation;
	}
	public void setCompletingInformation(ims.core.vo.AuthoringInformationVo value)
	{
		this.isValidated = false;
	...
	public boolean isValidated()
	{
		...
		if(this.completinginformation != null)
		{
			if(!this.completinginformation.isValidated())
			{
				this.isBusy = false;
				return false;
			}
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.completinginformation != null)
		{
			String[] listOfOtherErrors = this.completinginformation.validate();
			if(listOfOtherErrors != null)
			{
				for(int x = 0; x < listOfOtherErrors.length; x++)
				{
	...
	public Object clone()
	{
		...
		EDPrescriptionVo clone = new EDPrescriptionVo(this.id, this.version);
		...
		if(this.completinginformation == null)
			clone.completinginformation = null;
		else
			clone.completinginformation = (ims.core.vo.AuthoringInformationVo)this.completinginformation.clone();
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(EDPrescriptionVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A EDPrescriptionVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((EDPrescriptionVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((EDPrescriptionVo)obj).getBoId());
	}
	...
	protected ims.core.vo.AuthoringInformationVo completinginformation;
