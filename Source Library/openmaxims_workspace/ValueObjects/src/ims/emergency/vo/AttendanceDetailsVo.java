...
public class AttendanceDetailsVo extends ims.core.admin.vo.EmergencyAttendanceRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public AttendanceDetailsVo(ims.emergency.vo.beans.AttendanceDetailsVoBean bean)
	{
		...
		this.useprivatehealthinsurance = bean.getUsePrivateHealthInsurance();
	...
	public Object getFieldValueByFieldName(String fieldName)
	{
		...
		if(fieldName.equals("USEPRIVATEHEALTHINSURANCE"))
			return getUsePrivateHealthInsurance();
	...
	public boolean getUsePrivateHealthInsuranceIsNotNull()
	{
		return this.useprivatehealthinsurance != null;
	}
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.endofregistrationdatetime == null)
			listOfErrors.add("Registration End Time is mandatory!");
		if(this.customid != null)
			if(this.customid.length() > 20)
				listOfErrors.add("The length of the field [customid] in the value object [ims.emergency.vo.AttendanceDetailsVo] is too big. It should be less or equal to 20");
	...
	public Object clone()
	{
		...
		clone.useprivatehealthinsurance = this.useprivatehealthinsurance;
		if(this.endofregistrationdatetime == null)
	...
	public int countFieldsWithValue()
	{
		...
		if(this.bedtyperequested != null)
			count++;
		if(this.useprivatehealthinsurance != null)
			count++;
		if(this.endofregistrationdatetime != null)
			count++;
		if(this.ambulancehandoverdatetime != null)
	...
	protected Boolean useprivatehealthinsurance;
