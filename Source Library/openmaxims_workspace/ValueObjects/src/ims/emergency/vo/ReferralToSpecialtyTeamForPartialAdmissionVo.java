 ...
 */
public class ReferralToSpecialtyTeamForPartialAdmissionVo extends ims.emergency.vo.ReferralToSpecTeamRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public ReferralToSpecialtyTeamForPartialAdmissionVo()
	{
	}
	public ReferralToSpecialtyTeamForPartialAdmissionVo(Integer id, int version)
	{
		super(id, version);
	}
	public ReferralToSpecialtyTeamForPartialAdmissionVo(ims.emergency.vo.beans.ReferralToSpecialtyTeamForPartialAdmissionVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.emergency.vo.beans.ReferralToSpecialtyTeamForPartialAdmissionVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.attendance = bean.getAttendance() == null ? null : new ims.core.admin.vo.CareContextRefVo(new Integer(bean.getAttendance().getId()), bean.getAttendance().getVersion());
	...
	{
		ims.emergency.vo.beans.ReferralToSpecialtyTeamForPartialAdmissionVoBean bean = null;
		if(map != null)
			bean = (ims.emergency.vo.beans.ReferralToSpecialtyTeamForPartialAdmissionVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.emergency.vo.beans.ReferralToSpecialtyTeamForPartialAdmissionVoBean();
	...
	public Object clone()
	{
		...
		ReferralToSpecialtyTeamForPartialAdmissionVo clone = new ReferralToSpecialtyTeamForPartialAdmissionVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(ReferralToSpecialtyTeamForPartialAdmissionVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A ReferralToSpecialtyTeamForPartialAdmissionVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((ReferralToSpecialtyTeamForPartialAdmissionVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((ReferralToSpecialtyTeamForPartialAdmissionVo)obj).getBoId());
	}
