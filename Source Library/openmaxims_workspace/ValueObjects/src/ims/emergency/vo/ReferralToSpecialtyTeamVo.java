...
public class ReferralToSpecialtyTeamVo extends ims.emergency.vo.ReferralToSpecTeamRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public ReferralToSpecialtyTeamVo(ims.emergency.vo.beans.ReferralToSpecialtyTeamVoBean bean)
	{
		...
		this.issafeguardingconcern = bean.getIsSafeguardingConcern();
		this.safeguardingcomments = bean.getSafeguardingComments();
	}
	...
	public Object getFieldValueByFieldName(String fieldName)
	{
		...
		if(fieldName.equals("ISSAFEGUARDINGCONCERN"))
			return getIsSafeguardingConcern();
		if(fieldName.equals("SAFEGUARDINGCOMMENTS"))
			return getSafeguardingComments();
	...
	public boolean getIsSafeguardingConcernIsNotNull()
	{
		return this.issafeguardingconcern != null;
	}
	public Boolean getIsSafeguardingConcern()
	{
		return this.issafeguardingconcern;
	}
	public void setIsSafeguardingConcern(Boolean value)
	{
		this.isValidated = false;
		this.issafeguardingconcern = value;
	}
	public boolean getSafeguardingCommentsIsNotNull()
	{
		return this.safeguardingcomments != null;
	}
	public String getSafeguardingComments()
	{
		return this.safeguardingcomments;
	}
	public static int getSafeguardingCommentsMaxLength()
	{
		return 500;
	}
	public void setSafeguardingComments(String value)
	{
		this.isValidated = false;
		this.safeguardingcomments = value;
	}
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.safeguardingcomments != null)
			if(this.safeguardingcomments.length() > 500)
				listOfErrors.add("The length of the field [safeguardingcomments] in the value object [ims.emergency.vo.ReferralToSpecialtyTeamVo] is too big. It should be less or equal to 500");
	...
	public Object clone()
	{
		...
		clone.issafeguardingconcern = this.issafeguardingconcern;
		clone.safeguardingcomments = this.safeguardingcomments;
	...
	public int countFieldsWithValue()
	{
		...
		if(this.notaccepted != null)
			count++;
		if(this.issafeguardingconcern != null)
			count++;
		if(this.safeguardingcomments != null)
			count++;
		return count;
	...
	protected Boolean issafeguardingconcern;
	protected String safeguardingcomments;
