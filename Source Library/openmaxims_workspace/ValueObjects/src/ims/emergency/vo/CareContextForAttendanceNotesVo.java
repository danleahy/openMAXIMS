 ...
 */
public class CareContextForAttendanceNotesVo extends ims.core.admin.vo.CareContextRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public CareContextForAttendanceNotesVo()
	{
	}
	public CareContextForAttendanceNotesVo(Integer id, int version)
	{
		super(id, version);
	}
	public CareContextForAttendanceNotesVo(ims.emergency.vo.beans.CareContextForAttendanceNotesVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.emergency.vo.beans.CareContextForAttendanceNotesVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.startdatetime = bean.getStartDateTime() == null ? null : bean.getStartDateTime().buildDateTime();
	...
	{
		ims.emergency.vo.beans.CareContextForAttendanceNotesVoBean bean = null;
		if(map != null)
			bean = (ims.emergency.vo.beans.CareContextForAttendanceNotesVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.emergency.vo.beans.CareContextForAttendanceNotesVoBean();
	...
	public Object clone()
	{
		...
		CareContextForAttendanceNotesVo clone = new CareContextForAttendanceNotesVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(CareContextForAttendanceNotesVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A CareContextForAttendanceNotesVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((CareContextForAttendanceNotesVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((CareContextForAttendanceNotesVo)obj).getBoId());
	}
