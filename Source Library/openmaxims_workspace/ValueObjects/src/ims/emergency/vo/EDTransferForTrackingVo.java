 ...
 */
public class EDTransferForTrackingVo extends ims.emergency.vo.EDTransferRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public EDTransferForTrackingVo()
	{
	}
	public EDTransferForTrackingVo(Integer id, int version)
	{
		super(id, version);
	}
	public EDTransferForTrackingVo(ims.emergency.vo.beans.EDTransferForTrackingVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.emergency.vo.beans.EDTransferForTrackingVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.accepteddatetime = bean.getAcceptedDateTime() == null ? null : bean.getAcceptedDateTime().buildDateTime();
	...
	{
		ims.emergency.vo.beans.EDTransferForTrackingVoBean bean = null;
		if(map != null)
			bean = (ims.emergency.vo.beans.EDTransferForTrackingVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.emergency.vo.beans.EDTransferForTrackingVoBean();
	...
	public Object clone()
	{
		...
		EDTransferForTrackingVo clone = new EDTransferForTrackingVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(EDTransferForTrackingVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A EDTransferForTrackingVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((EDTransferForTrackingVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((EDTransferForTrackingVo)obj).getBoId());
	}
