 ...
 */
public class TrackingForPatientWhiteBoardVo extends ims.emergency.vo.TrackingRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public TrackingForPatientWhiteBoardVo()
	{
	}
	public TrackingForPatientWhiteBoardVo(Integer id, int version)
	{
		super(id, version);
	}
	public TrackingForPatientWhiteBoardVo(ims.emergency.vo.beans.TrackingForPatientWhiteBoardVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.emergency.vo.beans.TrackingForPatientWhiteBoardVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.emergency.vo.beans.TrackingForPatientWhiteBoardVoBean bean = null;
		if(map != null)
			bean = (ims.emergency.vo.beans.TrackingForPatientWhiteBoardVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.emergency.vo.beans.TrackingForPatientWhiteBoardVoBean();
	...
	public ims.emergency.vo.EmergencyAttendanceForWhiteBoardVo getAttendance()
	{
		return this.attendance;
	}
	public void setAttendance(ims.emergency.vo.EmergencyAttendanceForWhiteBoardVo value)
	{
		this.isValidated = false;
	...
	public ims.emergency.vo.TriageDetailsForWhiteBoardVo getTriageDetails()
	{
		return this.triagedetails;
	}
	public void setTriageDetails(ims.emergency.vo.TriageDetailsForWhiteBoardVo value)
	{
		this.isValidated = false;
	...
	public Object clone()
	{
		...
		TrackingForPatientWhiteBoardVo clone = new TrackingForPatientWhiteBoardVo(this.id, this.version);
		...
		if(this.attendance == null)
			...
			clone.attendance = (ims.emergency.vo.EmergencyAttendanceForWhiteBoardVo)this.attendance.clone();
		if(this.triagedetails == null)
			clone.triagedetails = null;
		else
			clone.triagedetails = (ims.emergency.vo.TriageDetailsForWhiteBoardVo)this.triagedetails.clone();
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(TrackingForPatientWhiteBoardVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A TrackingForPatientWhiteBoardVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((TrackingForPatientWhiteBoardVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((TrackingForPatientWhiteBoardVo)obj).getBoId());
	}
	...
	protected ims.emergency.vo.EmergencyAttendanceForWhiteBoardVo attendance;
	protected ims.emergency.vo.TriageDetailsForWhiteBoardVo triagedetails;
