	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.adviceleafletname != null)
			if(this.adviceleafletname.length() > 100)
				listOfErrors.add("The length of the field [adviceleafletname] in the value object [ims.emergency.vo.AdviceLeafletsForSelectAndPrinterVo] is too big. It should be less or equal to 100");
