	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.customid != null)
			if(this.customid.length() > 20)
				listOfErrors.add("The length of the field [customid] in the value object [ims.emergency.vo.EmergencyAttendanceForQuickRegistrationVo] is too big. It should be less or equal to 20");
