...
public class PatientShortListVo extends ims.core.patient.vo.PatientRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public ims.core.vo.LocationMinVo getWard()
	{
		return this.ward;
	}
	public void setWard(ims.core.vo.LocationMinVo value)
	{
		this.isValidated = false;
		this.ward = value;
	}
	...
	*/
	...
	/**
	* getDisplayId() - returns the patient's display ID as set by DISPLAY_PATID_TYPE flag
	*/
	...
	public Object clone()
	{
		...
		if(this.ward == null)
			...
			clone.ward = (ims.core.vo.LocationMinVo)this.ward.clone();
		if(this.identifiers == null)
	...
	protected ims.core.vo.LocationMinVo ward;
