...
public class CareContextForPatientDocumentVo extends ims.core.admin.vo.CareContextRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public ims.core.vo.CareContextPasEventDetailsVo getPasEvent()
	{
		return this.pasevent;
	}
	public void setPasEvent(ims.core.vo.CareContextPasEventDetailsVo value)
	{
		this.isValidated = false;
		this.pasevent = value;
	}
	...
	*/
	...
	public Object clone()
	{
		...
		if(this.pasevent == null)
			...
			clone.pasevent = (ims.core.vo.CareContextPasEventDetailsVo)this.pasevent.clone();
	...
	protected ims.core.vo.CareContextPasEventDetailsVo pasevent;
