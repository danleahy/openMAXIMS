 ...
 */
public class CareContextLiteERVo extends ims.core.admin.vo.CareContextRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public CareContextLiteERVo()
	{
	}
	public CareContextLiteERVo(Integer id, int version)
	{
		super(id, version);
	}
	public CareContextLiteERVo(ims.core.vo.beans.CareContextLiteERVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.beans.CareContextLiteERVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.context = bean.getContext() == null ? null : ims.core.vo.lookups.ContextType.buildLookup(bean.getContext());
	...
	{
		ims.core.vo.beans.CareContextLiteERVoBean bean = null;
		if(map != null)
			bean = (ims.core.vo.beans.CareContextLiteERVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.core.vo.beans.CareContextLiteERVoBean();
	...
	public Object clone()
	{
		...
		CareContextLiteERVo clone = new CareContextLiteERVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(CareContextLiteERVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A CareContextLiteERVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((CareContextLiteERVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((CareContextLiteERVo)obj).getBoId());
	}
