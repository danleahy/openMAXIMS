 ...
 */
public class DEDFullVo extends ims.core.vo.DEDLiteVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public DEDFullVo(Integer id, int version)
	{
		super(id, version);
	}
	public DEDFullVo(ims.core.vo.beans.DEDFullVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.beans.DEDFullVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.name = bean.getName();
	...
	{
		ims.core.vo.beans.DEDFullVoBean bean = null;
		if(map != null)
			bean = (ims.core.vo.beans.DEDFullVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.core.vo.beans.DEDFullVoBean();
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.name == null || this.name.length() == 0)
			...
			listOfErrors.add("The length of the field [name] in the value object [ims.core.vo.DEDFullVo] is too big. It should be less or equal to 120");
		if(this.uppername == null || this.uppername.length() == 0)
			listOfErrors.add("UpperName is mandatory");
		else if(this.uppername.length() > 120)
			listOfErrors.add("The length of the field [uppername] in the value object [ims.core.vo.DEDFullVo] is too big. It should be less or equal to 120");
		if(this.county == null)
	...
	public Object clone()
	{
		...
		DEDFullVo clone = new DEDFullVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(DEDFullVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A DEDFullVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((DEDFullVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((DEDFullVo)obj).getBoId());
	}
