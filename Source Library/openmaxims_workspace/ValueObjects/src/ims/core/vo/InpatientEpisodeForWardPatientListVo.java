 ...
 */
public class InpatientEpisodeForWardPatientListVo extends ims.core.admin.pas.vo.InpatientEpisodeRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public InpatientEpisodeForWardPatientListVo()
	{
	}
	public InpatientEpisodeForWardPatientListVo(Integer id, int version)
	{
		super(id, version);
	}
	public InpatientEpisodeForWardPatientListVo(ims.core.vo.beans.InpatientEpisodeForWardPatientListVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.beans.InpatientEpisodeForWardPatientListVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.estdischargedate = bean.getEstDischargeDate() == null ? null : bean.getEstDischargeDate().buildDateTime();
	...
	{
		ims.core.vo.beans.InpatientEpisodeForWardPatientListVoBean bean = null;
		if(map != null)
			bean = (ims.core.vo.beans.InpatientEpisodeForWardPatientListVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.core.vo.beans.InpatientEpisodeForWardPatientListVoBean();
	...
	*/
	...
	public Object clone()
	{
		...
		InpatientEpisodeForWardPatientListVo clone = new InpatientEpisodeForWardPatientListVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(InpatientEpisodeForWardPatientListVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A InpatientEpisodeForWardPatientListVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((InpatientEpisodeForWardPatientListVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((InpatientEpisodeForWardPatientListVo)obj).getBoId());
	}
