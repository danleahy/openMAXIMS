 ...
 */
public class CatsReferralEmergencyAdmissionLiteVo extends ims.RefMan.vo.CatsReferralRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public CatsReferralEmergencyAdmissionLiteVo()
	{
	}
	public CatsReferralEmergencyAdmissionLiteVo(Integer id, int version)
	{
		super(id, version);
	}
	public CatsReferralEmergencyAdmissionLiteVo(ims.core.vo.beans.CatsReferralEmergencyAdmissionLiteVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.beans.CatsReferralEmergencyAdmissionLiteVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.patient = bean.getPatient() == null ? null : new ims.core.patient.vo.PatientRefVo(new Integer(bean.getPatient().getId()), bean.getPatient().getVersion());
	...
	{
		ims.core.vo.beans.CatsReferralEmergencyAdmissionLiteVoBean bean = null;
		if(map != null)
			bean = (ims.core.vo.beans.CatsReferralEmergencyAdmissionLiteVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.core.vo.beans.CatsReferralEmergencyAdmissionLiteVoBean();
	...
	public Object clone()
	{
		...
		CatsReferralEmergencyAdmissionLiteVo clone = new CatsReferralEmergencyAdmissionLiteVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(CatsReferralEmergencyAdmissionLiteVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A CatsReferralEmergencyAdmissionLiteVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((CatsReferralEmergencyAdmissionLiteVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((CatsReferralEmergencyAdmissionLiteVo)obj).getBoId());
	}
