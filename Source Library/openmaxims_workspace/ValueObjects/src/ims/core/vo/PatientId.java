...
public class PatientId extends ims.core.patient.vo.PatientIdRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public PatientId(ims.core.vo.beans.PatientIdBean bean)
	{
		...
		this.superseeded = bean.getSuperseeded();
	}
	...
	public Object getFieldValueByFieldName(String fieldName)
	{
		...
		if(fieldName.equals("SUPERSEEDED"))
			return getSuperseeded();
	...
	public boolean getSuperseededIsNotNull()
	{
		return this.superseeded != null;
	}
	...
	*/
	...
	public Object clone()
	{
		...
		clone.superseeded = this.superseeded;
