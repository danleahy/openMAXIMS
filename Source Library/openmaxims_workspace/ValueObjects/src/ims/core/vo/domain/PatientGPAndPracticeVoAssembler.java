 ...
 */
public class PatientGPAndPracticeVoAssembler
{
  	/**
	 ...
	 */
	 public static ims.core.vo.PatientGPAndPracticeVo copy(ims.core.vo.PatientGPAndPracticeVo valueObjectDest, ims.core.vo.PatientGPAndPracticeVo valueObjectSrc) 
	 {
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createPatientGPAndPracticeVoCollectionFromPatientGP(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.core.domain.objects.PatientGP objects.
	 */
	public static ims.core.vo.PatientGPAndPracticeVoCollection createPatientGPAndPracticeVoCollectionFromPatientGP(java.util.Set domainObjectSet)	
	{
		return createPatientGPAndPracticeVoCollectionFromPatientGP(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.core.domain.objects.PatientGP objects.
	 */
	public static ims.core.vo.PatientGPAndPracticeVoCollection createPatientGPAndPracticeVoCollectionFromPatientGP(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.core.vo.PatientGPAndPracticeVoCollection voList = new ims.core.vo.PatientGPAndPracticeVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.core.vo.PatientGPAndPracticeVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.core.vo.PatientGPAndPracticeVoCollection createPatientGPAndPracticeVoCollectionFromPatientGP(java.util.List domainObjectList) 
	{
		return createPatientGPAndPracticeVoCollectionFromPatientGP(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.core.domain.objects.PatientGP objects.
	 */
	public static ims.core.vo.PatientGPAndPracticeVoCollection createPatientGPAndPracticeVoCollectionFromPatientGP(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.core.vo.PatientGPAndPracticeVoCollection voList = new ims.core.vo.PatientGPAndPracticeVoCollection();
	 ...
	 */
	 public static java.util.Set extractPatientGPSet(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.PatientGPAndPracticeVoCollection voCollection) 
	 {
	 	return extractPatientGPSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractPatientGPSet(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.PatientGPAndPracticeVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.core.vo.PatientGPAndPracticeVo vo = voCollection.get(i);
			ims.core.domain.objects.PatientGP domainObject = PatientGPAndPracticeVoAssembler.extractPatientGP(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractPatientGPList(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.PatientGPAndPracticeVoCollection voCollection) 
	 {
	 	return extractPatientGPList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractPatientGPList(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.PatientGPAndPracticeVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.core.vo.PatientGPAndPracticeVo create(ims.core.domain.objects.PatientGP domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.core.vo.PatientGPAndPracticeVo create(DomainObjectMap map, ims.core.domain.objects.PatientGP domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.core.vo.PatientGPAndPracticeVo valueObject = (ims.core.vo.PatientGPAndPracticeVo) map.getValueObject(domainObject, ims.core.vo.PatientGPAndPracticeVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.core.vo.PatientGPAndPracticeVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.core.domain.objects.PatientGP
	 */
	 public static ims.core.vo.PatientGPAndPracticeVo insert(ims.core.vo.PatientGPAndPracticeVo valueObject, ims.core.domain.objects.PatientGP domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.core.domain.objects.PatientGP
	 */
	 public static ims.core.vo.PatientGPAndPracticeVo insert(DomainObjectMap map, ims.core.vo.PatientGPAndPracticeVo valueObject, ims.core.domain.objects.PatientGP domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 */
	public static ims.core.domain.objects.PatientGP extractPatientGP(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.PatientGPAndPracticeVo valueObject) 
	{
		return 	extractPatientGP(domainFactory, valueObject, new HashMap());
	}

	public static ims.core.domain.objects.PatientGP extractPatientGP(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.PatientGPAndPracticeVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.core.vo.PatientGPAndPracticeVo ID_PatientGP field is unknown
