 ...
 */
public class CareContextRepatriationVoAssembler
{
  	/**
	 ...
	 */
	 public static ims.core.vo.CareContextRepatriationVo copy(ims.core.vo.CareContextRepatriationVo valueObjectDest, ims.core.vo.CareContextRepatriationVo valueObjectSrc) 
	 {
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createCareContextRepatriationVoCollectionFromCareContext(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.core.admin.domain.objects.CareContext objects.
	 */
	public static ims.core.vo.CareContextRepatriationVoCollection createCareContextRepatriationVoCollectionFromCareContext(java.util.Set domainObjectSet)	
	{
		return createCareContextRepatriationVoCollectionFromCareContext(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.core.admin.domain.objects.CareContext objects.
	 */
	public static ims.core.vo.CareContextRepatriationVoCollection createCareContextRepatriationVoCollectionFromCareContext(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.core.vo.CareContextRepatriationVoCollection voList = new ims.core.vo.CareContextRepatriationVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.core.vo.CareContextRepatriationVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.core.vo.CareContextRepatriationVoCollection createCareContextRepatriationVoCollectionFromCareContext(java.util.List domainObjectList) 
	{
		return createCareContextRepatriationVoCollectionFromCareContext(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.core.admin.domain.objects.CareContext objects.
	 */
	public static ims.core.vo.CareContextRepatriationVoCollection createCareContextRepatriationVoCollectionFromCareContext(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.core.vo.CareContextRepatriationVoCollection voList = new ims.core.vo.CareContextRepatriationVoCollection();
	 ...
	 */
	 public static java.util.Set extractCareContextSet(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.CareContextRepatriationVoCollection voCollection) 
	 {
	 	return extractCareContextSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractCareContextSet(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.CareContextRepatriationVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.core.vo.CareContextRepatriationVo vo = voCollection.get(i);
			ims.core.admin.domain.objects.CareContext domainObject = CareContextRepatriationVoAssembler.extractCareContext(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractCareContextList(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.CareContextRepatriationVoCollection voCollection) 
	 {
	 	return extractCareContextList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractCareContextList(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.CareContextRepatriationVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.core.vo.CareContextRepatriationVo create(ims.core.admin.domain.objects.CareContext domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.core.vo.CareContextRepatriationVo create(DomainObjectMap map, ims.core.admin.domain.objects.CareContext domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.core.vo.CareContextRepatriationVo valueObject = (ims.core.vo.CareContextRepatriationVo) map.getValueObject(domainObject, ims.core.vo.CareContextRepatriationVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.core.vo.CareContextRepatriationVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.core.admin.domain.objects.CareContext
	 */
	 public static ims.core.vo.CareContextRepatriationVo insert(ims.core.vo.CareContextRepatriationVo valueObject, ims.core.admin.domain.objects.CareContext domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.core.admin.domain.objects.CareContext
	 */
	 public static ims.core.vo.CareContextRepatriationVo insert(DomainObjectMap map, ims.core.vo.CareContextRepatriationVo valueObject, ims.core.admin.domain.objects.CareContext domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
		...
		// pasEvent
		valueObject.setPasEvent(ims.core.vo.domain.PasEventRepatriationVoAssembler.create(map, domainObject.getPasEvent()) );
		// CurrentStatus
	 ...
	 */
	public static ims.core.admin.domain.objects.CareContext extractCareContext(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.CareContextRepatriationVo valueObject) 
	{
		return 	extractCareContext(domainFactory, valueObject, new HashMap());
	}

	public static ims.core.admin.domain.objects.CareContext extractCareContext(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.CareContextRepatriationVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.core.vo.CareContextRepatriationVo ID_CareContext field is unknown
		...
		domainObject.setPasEvent(ims.core.vo.domain.PasEventRepatriationVoAssembler.extractPASEvent(domainFactory, valueObject.getPasEvent(), domMap));
