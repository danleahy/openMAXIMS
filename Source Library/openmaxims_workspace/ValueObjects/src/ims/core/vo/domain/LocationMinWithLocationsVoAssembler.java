 ...
 */
public class LocationMinWithLocationsVoAssembler
{
  	/**
	 ...
	 */
	 public static ims.core.vo.LocationMinWithLocationsVo copy(ims.core.vo.LocationMinWithLocationsVo valueObjectDest, ims.core.vo.LocationMinWithLocationsVo valueObjectSrc) 
	 {
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createLocationMinWithLocationsVoCollectionFromLocation(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.core.resource.place.domain.objects.Location objects.
	 */
	public static ims.core.vo.LocationMinWithLocationsVoCollection createLocationMinWithLocationsVoCollectionFromLocation(java.util.Set domainObjectSet)	
	{
		return createLocationMinWithLocationsVoCollectionFromLocation(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.core.resource.place.domain.objects.Location objects.
	 */
	public static ims.core.vo.LocationMinWithLocationsVoCollection createLocationMinWithLocationsVoCollectionFromLocation(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.core.vo.LocationMinWithLocationsVoCollection voList = new ims.core.vo.LocationMinWithLocationsVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.core.vo.LocationMinWithLocationsVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.core.vo.LocationMinWithLocationsVoCollection createLocationMinWithLocationsVoCollectionFromLocation(java.util.List domainObjectList) 
	{
		return createLocationMinWithLocationsVoCollectionFromLocation(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.core.resource.place.domain.objects.Location objects.
	 */
	public static ims.core.vo.LocationMinWithLocationsVoCollection createLocationMinWithLocationsVoCollectionFromLocation(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.core.vo.LocationMinWithLocationsVoCollection voList = new ims.core.vo.LocationMinWithLocationsVoCollection();
	 ...
	 */
	 public static java.util.Set extractLocationSet(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.LocationMinWithLocationsVoCollection voCollection) 
	 {
	 	return extractLocationSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractLocationSet(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.LocationMinWithLocationsVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.core.vo.LocationMinWithLocationsVo vo = voCollection.get(i);
			ims.core.resource.place.domain.objects.Location domainObject = LocationMinWithLocationsVoAssembler.extractLocation(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractLocationList(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.LocationMinWithLocationsVoCollection voCollection) 
	 {
	 	return extractLocationList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractLocationList(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.LocationMinWithLocationsVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.core.vo.LocationMinWithLocationsVo create(ims.core.resource.place.domain.objects.Location domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.core.vo.LocationMinWithLocationsVo create(DomainObjectMap map, ims.core.resource.place.domain.objects.Location domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.core.vo.LocationMinWithLocationsVo valueObject = (ims.core.vo.LocationMinWithLocationsVo) map.getValueObject(domainObject, ims.core.vo.LocationMinWithLocationsVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.core.vo.LocationMinWithLocationsVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.core.resource.place.domain.objects.Location
	 */
	 public static ims.core.vo.LocationMinWithLocationsVo insert(ims.core.vo.LocationMinWithLocationsVo valueObject, ims.core.resource.place.domain.objects.Location domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.core.resource.place.domain.objects.Location
	 */
	 public static ims.core.vo.LocationMinWithLocationsVo insert(DomainObjectMap map, ims.core.vo.LocationMinWithLocationsVo valueObject, ims.core.resource.place.domain.objects.Location domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 */
	public static ims.core.resource.place.domain.objects.Location extractLocation(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.LocationMinWithLocationsVo valueObject) 
	{
		return 	extractLocation(domainFactory, valueObject, new HashMap());
	}

	public static ims.core.resource.place.domain.objects.Location extractLocation(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.LocationMinWithLocationsVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.core.vo.LocationMinWithLocationsVo ID_Location field is unknown
