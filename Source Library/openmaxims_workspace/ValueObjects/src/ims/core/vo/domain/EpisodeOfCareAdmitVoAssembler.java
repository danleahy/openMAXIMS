 ...
 */
public class EpisodeOfCareAdmitVoAssembler
{
  	/**
	 ...
	 */
	 public static ims.core.vo.EpisodeOfCareAdmitVo copy(ims.core.vo.EpisodeOfCareAdmitVo valueObjectDest, ims.core.vo.EpisodeOfCareAdmitVo valueObjectSrc) 
	 {
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createEpisodeOfCareAdmitVoCollectionFromEpisodeOfCare(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.core.admin.domain.objects.EpisodeOfCare objects.
	 */
	public static ims.core.vo.EpisodeOfCareAdmitVoCollection createEpisodeOfCareAdmitVoCollectionFromEpisodeOfCare(java.util.Set domainObjectSet)	
	{
		return createEpisodeOfCareAdmitVoCollectionFromEpisodeOfCare(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.core.admin.domain.objects.EpisodeOfCare objects.
	 */
	public static ims.core.vo.EpisodeOfCareAdmitVoCollection createEpisodeOfCareAdmitVoCollectionFromEpisodeOfCare(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.core.vo.EpisodeOfCareAdmitVoCollection voList = new ims.core.vo.EpisodeOfCareAdmitVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.core.vo.EpisodeOfCareAdmitVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.core.vo.EpisodeOfCareAdmitVoCollection createEpisodeOfCareAdmitVoCollectionFromEpisodeOfCare(java.util.List domainObjectList) 
	{
		return createEpisodeOfCareAdmitVoCollectionFromEpisodeOfCare(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.core.admin.domain.objects.EpisodeOfCare objects.
	 */
	public static ims.core.vo.EpisodeOfCareAdmitVoCollection createEpisodeOfCareAdmitVoCollectionFromEpisodeOfCare(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.core.vo.EpisodeOfCareAdmitVoCollection voList = new ims.core.vo.EpisodeOfCareAdmitVoCollection();
	 ...
	 */
	 public static java.util.Set extractEpisodeOfCareSet(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.EpisodeOfCareAdmitVoCollection voCollection) 
	 {
	 	return extractEpisodeOfCareSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractEpisodeOfCareSet(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.EpisodeOfCareAdmitVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.core.vo.EpisodeOfCareAdmitVo vo = voCollection.get(i);
			ims.core.admin.domain.objects.EpisodeOfCare domainObject = EpisodeOfCareAdmitVoAssembler.extractEpisodeOfCare(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractEpisodeOfCareList(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.EpisodeOfCareAdmitVoCollection voCollection) 
	 {
	 	return extractEpisodeOfCareList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractEpisodeOfCareList(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.EpisodeOfCareAdmitVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.core.vo.EpisodeOfCareAdmitVo create(ims.core.admin.domain.objects.EpisodeOfCare domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.core.vo.EpisodeOfCareAdmitVo create(DomainObjectMap map, ims.core.admin.domain.objects.EpisodeOfCare domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.core.vo.EpisodeOfCareAdmitVo valueObject = (ims.core.vo.EpisodeOfCareAdmitVo) map.getValueObject(domainObject, ims.core.vo.EpisodeOfCareAdmitVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.core.vo.EpisodeOfCareAdmitVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.core.admin.domain.objects.EpisodeOfCare
	 */
	 public static ims.core.vo.EpisodeOfCareAdmitVo insert(ims.core.vo.EpisodeOfCareAdmitVo valueObject, ims.core.admin.domain.objects.EpisodeOfCare domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.core.admin.domain.objects.EpisodeOfCare
	 */
	 public static ims.core.vo.EpisodeOfCareAdmitVo insert(DomainObjectMap map, ims.core.vo.EpisodeOfCareAdmitVo valueObject, ims.core.admin.domain.objects.EpisodeOfCare domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
		...
		if ( null != instance4 ) {
			...
			ims.core.vo.lookups.CareSpelltoEpisodeRelationship voLookup4 = new ims.core.vo.lookups.CareSpelltoEpisodeRelationship(instance4.getId(),instance4.getText(), instance4.isActive(), null, img, color);
			ims.core.vo.lookups.CareSpelltoEpisodeRelationship parentVoLookup4 = voLookup4;
			...
			while (parent4 != null)
			{
    			...
    			if (color != null) 
    				color.getValue();
								parentVoLookup4.setParent(new ims.core.vo.lookups.CareSpelltoEpisodeRelationship(parent4.getId(),parent4.getText(), parent4.isActive(), null, img, color));
		...
		// CareContexts
		valueObject.setCareContexts(ims.core.vo.domain.CareContextAdmitVoAssembler.createCareContextAdmitVoCollectionFromCareContext(map, domainObject.getCareContexts()) );
 		return valueObject;
	 }
	 ...
	 */
	public static ims.core.admin.domain.objects.EpisodeOfCare extractEpisodeOfCare(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.EpisodeOfCareAdmitVo valueObject) 
	{
		return 	extractEpisodeOfCare(domainFactory, valueObject, new HashMap());
	}

	public static ims.core.admin.domain.objects.EpisodeOfCare extractEpisodeOfCare(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.EpisodeOfCareAdmitVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.core.vo.EpisodeOfCareAdmitVo ID_EpisodeOfCare field is unknown
		...
		domainObject.setCareContexts(ims.core.vo.domain.CareContextAdmitVoAssembler.extractCareContextSet(domainFactory, valueObject.getCareContexts(), domainObject.getCareContexts(), domMap));		
