 ...
 */
public class PasEventPatientDetailsVoAssembler
{
  	/**
	 ...
	 */
	 public static ims.core.vo.PasEventPatientDetailsVo copy(ims.core.vo.PasEventPatientDetailsVo valueObjectDest, ims.core.vo.PasEventPatientDetailsVo valueObjectSrc) 
	 {
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createPasEventPatientDetailsVoCollectionFromPASEvent(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.core.admin.pas.domain.objects.PASEvent objects.
	 */
	public static ims.core.vo.PasEventPatientDetailsVoCollection createPasEventPatientDetailsVoCollectionFromPASEvent(java.util.Set domainObjectSet)	
	{
		return createPasEventPatientDetailsVoCollectionFromPASEvent(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.core.admin.pas.domain.objects.PASEvent objects.
	 */
	public static ims.core.vo.PasEventPatientDetailsVoCollection createPasEventPatientDetailsVoCollectionFromPASEvent(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.core.vo.PasEventPatientDetailsVoCollection voList = new ims.core.vo.PasEventPatientDetailsVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.core.vo.PasEventPatientDetailsVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.core.vo.PasEventPatientDetailsVoCollection createPasEventPatientDetailsVoCollectionFromPASEvent(java.util.List domainObjectList) 
	{
		return createPasEventPatientDetailsVoCollectionFromPASEvent(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.core.admin.pas.domain.objects.PASEvent objects.
	 */
	public static ims.core.vo.PasEventPatientDetailsVoCollection createPasEventPatientDetailsVoCollectionFromPASEvent(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.core.vo.PasEventPatientDetailsVoCollection voList = new ims.core.vo.PasEventPatientDetailsVoCollection();
	 ...
	 */
	 public static java.util.Set extractPASEventSet(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.PasEventPatientDetailsVoCollection voCollection) 
	 {
	 	return extractPASEventSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractPASEventSet(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.PasEventPatientDetailsVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.core.vo.PasEventPatientDetailsVo vo = voCollection.get(i);
			ims.core.admin.pas.domain.objects.PASEvent domainObject = PasEventPatientDetailsVoAssembler.extractPASEvent(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractPASEventList(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.PasEventPatientDetailsVoCollection voCollection) 
	 {
	 	return extractPASEventList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractPASEventList(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.PasEventPatientDetailsVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.core.vo.PasEventPatientDetailsVo create(ims.core.admin.pas.domain.objects.PASEvent domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.core.vo.PasEventPatientDetailsVo create(DomainObjectMap map, ims.core.admin.pas.domain.objects.PASEvent domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.core.vo.PasEventPatientDetailsVo valueObject = (ims.core.vo.PasEventPatientDetailsVo) map.getValueObject(domainObject, ims.core.vo.PasEventPatientDetailsVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.core.vo.PasEventPatientDetailsVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.core.admin.pas.domain.objects.PASEvent
	 */
	 public static ims.core.vo.PasEventPatientDetailsVo insert(ims.core.vo.PasEventPatientDetailsVo valueObject, ims.core.admin.pas.domain.objects.PASEvent domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.core.admin.pas.domain.objects.PASEvent
	 */
	 public static ims.core.vo.PasEventPatientDetailsVo insert(DomainObjectMap map, ims.core.vo.PasEventPatientDetailsVo valueObject, ims.core.admin.pas.domain.objects.PASEvent domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 */
	public static ims.core.admin.pas.domain.objects.PASEvent extractPASEvent(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.PasEventPatientDetailsVo valueObject) 
	{
		return 	extractPASEvent(domainFactory, valueObject, new HashMap());
	}

	public static ims.core.admin.pas.domain.objects.PASEvent extractPASEvent(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.PasEventPatientDetailsVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.core.vo.PasEventPatientDetailsVo ID_PASEvent field is unknown
