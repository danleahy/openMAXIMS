 ...
 */
public class WardBayConfigForWardViewVoAssembler
{
  	/**
	 ...
	 */
	 public static ims.core.vo.WardBayConfigForWardViewVo copy(ims.core.vo.WardBayConfigForWardViewVo valueObjectDest, ims.core.vo.WardBayConfigForWardViewVo valueObjectSrc) 
	 {
		...
		// BedsAllocated
		valueObjectDest.setBedsAllocated(valueObjectSrc.getBedsAllocated());
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createWardBayConfigForWardViewVoCollectionFromWardBayConfig(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.core.admin.pas.domain.objects.WardBayConfig objects.
	 */
	public static ims.core.vo.WardBayConfigForWardViewVoCollection createWardBayConfigForWardViewVoCollectionFromWardBayConfig(java.util.Set domainObjectSet)	
	{
		return createWardBayConfigForWardViewVoCollectionFromWardBayConfig(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.core.admin.pas.domain.objects.WardBayConfig objects.
	 */
	public static ims.core.vo.WardBayConfigForWardViewVoCollection createWardBayConfigForWardViewVoCollectionFromWardBayConfig(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.core.vo.WardBayConfigForWardViewVoCollection voList = new ims.core.vo.WardBayConfigForWardViewVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.core.vo.WardBayConfigForWardViewVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.core.vo.WardBayConfigForWardViewVoCollection createWardBayConfigForWardViewVoCollectionFromWardBayConfig(java.util.List domainObjectList) 
	{
		return createWardBayConfigForWardViewVoCollectionFromWardBayConfig(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.core.admin.pas.domain.objects.WardBayConfig objects.
	 */
	public static ims.core.vo.WardBayConfigForWardViewVoCollection createWardBayConfigForWardViewVoCollectionFromWardBayConfig(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.core.vo.WardBayConfigForWardViewVoCollection voList = new ims.core.vo.WardBayConfigForWardViewVoCollection();
	 ...
	 */
	 public static java.util.Set extractWardBayConfigSet(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.WardBayConfigForWardViewVoCollection voCollection) 
	 {
	 	return extractWardBayConfigSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractWardBayConfigSet(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.WardBayConfigForWardViewVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.core.vo.WardBayConfigForWardViewVo vo = voCollection.get(i);
			ims.core.admin.pas.domain.objects.WardBayConfig domainObject = WardBayConfigForWardViewVoAssembler.extractWardBayConfig(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractWardBayConfigList(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.WardBayConfigForWardViewVoCollection voCollection) 
	 {
	 	return extractWardBayConfigList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractWardBayConfigList(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.WardBayConfigForWardViewVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.core.vo.WardBayConfigForWardViewVo create(ims.core.admin.pas.domain.objects.WardBayConfig domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.core.vo.WardBayConfigForWardViewVo create(DomainObjectMap map, ims.core.admin.pas.domain.objects.WardBayConfig domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.core.vo.WardBayConfigForWardViewVo valueObject = (ims.core.vo.WardBayConfigForWardViewVo) map.getValueObject(domainObject, ims.core.vo.WardBayConfigForWardViewVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.core.vo.WardBayConfigForWardViewVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.core.admin.pas.domain.objects.WardBayConfig
	 */
	 public static ims.core.vo.WardBayConfigForWardViewVo insert(ims.core.vo.WardBayConfigForWardViewVo valueObject, ims.core.admin.pas.domain.objects.WardBayConfig domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.core.admin.pas.domain.objects.WardBayConfig
	 */
	 public static ims.core.vo.WardBayConfigForWardViewVo insert(DomainObjectMap map, ims.core.vo.WardBayConfigForWardViewVo valueObject, ims.core.admin.pas.domain.objects.WardBayConfig domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
		...
		// Bays
		valueObject.setBays(ims.core.vo.domain.BayConfigForWardViewVoAssembler.createBayConfigForWardViewVoCollectionFromBayConfig(map, domainObject.getBays()) );
		// MainSpecialty
		...
		// BedsAllocated
		valueObject.setBedsAllocated(ims.core.vo.domain.BedsAllocatedVoAssembler.createBedsAllocatedVoCollectionFromBedsAllocatedSpecialty(map, domainObject.getBedsAllocated()) );
		// WardAvailabilityStatus
		ims.domain.lookups.LookupInstance instance7 = domainObject.getWardStatus();
		if ( null != instance7 ) {
			ims.framework.utils.ImagePath img = null;
			ims.framework.utils.Color color = null;		
			img = null;
			...
			valueObject.setWardAvailabilityStatus(voLookup7);
		}
				// ClosingDetails
	 ...
	 */
	public static ims.core.admin.pas.domain.objects.WardBayConfig extractWardBayConfig(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.WardBayConfigForWardViewVo valueObject) 
	{
		return 	extractWardBayConfig(domainFactory, valueObject, new HashMap());
	}

	public static ims.core.admin.pas.domain.objects.WardBayConfig extractWardBayConfig(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.WardBayConfigForWardViewVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.core.vo.WardBayConfigForWardViewVo ID_WardBayConfig field is unknown
	...
	ims.core.resource.place.domain.objects.Location value1 = null;
		...
		domainObject.setBays(ims.core.vo.domain.BayConfigForWardViewVoAssembler.extractBayConfigSet(domainFactory, valueObject.getBays(), domainObject.getBays(), domMap));		
	...
	valueObject.getSpecialties();
		...
		domainObject.setBedsAllocated(ims.core.vo.domain.BedsAllocatedVoAssembler.extractBedsAllocatedSpecialtyList(domainFactory, valueObject.getBedsAllocated(), domainObject.getBedsAllocated(), domMap));		
		// create LookupInstance from vo LookupType
		...
		domainObject.setWardStatus(value7);
