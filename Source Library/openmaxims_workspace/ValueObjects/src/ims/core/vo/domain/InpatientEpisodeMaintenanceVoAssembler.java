 ...
 */
public class InpatientEpisodeMaintenanceVoAssembler
{
  	/**
	 ...
	 */
	 public static ims.core.vo.InpatientEpisodeMaintenanceVo copy(ims.core.vo.InpatientEpisodeMaintenanceVo valueObjectDest, ims.core.vo.InpatientEpisodeMaintenanceVo valueObjectSrc) 
	 {
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createInpatientEpisodeMaintenanceVoCollectionFromInpatientEpisode(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.core.admin.pas.domain.objects.InpatientEpisode objects.
	 */
	public static ims.core.vo.InpatientEpisodeMaintenanceVoCollection createInpatientEpisodeMaintenanceVoCollectionFromInpatientEpisode(java.util.Set domainObjectSet)	
	{
		return createInpatientEpisodeMaintenanceVoCollectionFromInpatientEpisode(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.core.admin.pas.domain.objects.InpatientEpisode objects.
	 */
	public static ims.core.vo.InpatientEpisodeMaintenanceVoCollection createInpatientEpisodeMaintenanceVoCollectionFromInpatientEpisode(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.core.vo.InpatientEpisodeMaintenanceVoCollection voList = new ims.core.vo.InpatientEpisodeMaintenanceVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.core.vo.InpatientEpisodeMaintenanceVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.core.vo.InpatientEpisodeMaintenanceVoCollection createInpatientEpisodeMaintenanceVoCollectionFromInpatientEpisode(java.util.List domainObjectList) 
	{
		return createInpatientEpisodeMaintenanceVoCollectionFromInpatientEpisode(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.core.admin.pas.domain.objects.InpatientEpisode objects.
	 */
	public static ims.core.vo.InpatientEpisodeMaintenanceVoCollection createInpatientEpisodeMaintenanceVoCollectionFromInpatientEpisode(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.core.vo.InpatientEpisodeMaintenanceVoCollection voList = new ims.core.vo.InpatientEpisodeMaintenanceVoCollection();
	 ...
	 */
	 public static java.util.Set extractInpatientEpisodeSet(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.InpatientEpisodeMaintenanceVoCollection voCollection) 
	 {
	 	return extractInpatientEpisodeSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractInpatientEpisodeSet(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.InpatientEpisodeMaintenanceVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.core.vo.InpatientEpisodeMaintenanceVo vo = voCollection.get(i);
			ims.core.admin.pas.domain.objects.InpatientEpisode domainObject = InpatientEpisodeMaintenanceVoAssembler.extractInpatientEpisode(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractInpatientEpisodeList(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.InpatientEpisodeMaintenanceVoCollection voCollection) 
	 {
	 	return extractInpatientEpisodeList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractInpatientEpisodeList(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.InpatientEpisodeMaintenanceVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.core.vo.InpatientEpisodeMaintenanceVo create(ims.core.admin.pas.domain.objects.InpatientEpisode domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.core.vo.InpatientEpisodeMaintenanceVo create(DomainObjectMap map, ims.core.admin.pas.domain.objects.InpatientEpisode domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.core.vo.InpatientEpisodeMaintenanceVo valueObject = (ims.core.vo.InpatientEpisodeMaintenanceVo) map.getValueObject(domainObject, ims.core.vo.InpatientEpisodeMaintenanceVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.core.vo.InpatientEpisodeMaintenanceVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.core.admin.pas.domain.objects.InpatientEpisode
	 */
	 public static ims.core.vo.InpatientEpisodeMaintenanceVo insert(ims.core.vo.InpatientEpisodeMaintenanceVo valueObject, ims.core.admin.pas.domain.objects.InpatientEpisode domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.core.admin.pas.domain.objects.InpatientEpisode
	 */
	 public static ims.core.vo.InpatientEpisodeMaintenanceVo insert(DomainObjectMap map, ims.core.vo.InpatientEpisodeMaintenanceVo valueObject, ims.core.admin.pas.domain.objects.InpatientEpisode domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 */
	public static ims.core.admin.pas.domain.objects.InpatientEpisode extractInpatientEpisode(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.InpatientEpisodeMaintenanceVo valueObject) 
	{
		return 	extractInpatientEpisode(domainFactory, valueObject, new HashMap());
	}

	public static ims.core.admin.pas.domain.objects.InpatientEpisode extractInpatientEpisode(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.InpatientEpisodeMaintenanceVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.core.vo.InpatientEpisodeMaintenanceVo ID_InpatientEpisode field is unknown
