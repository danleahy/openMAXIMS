 ...
 */
public class CatsReferralDetailsRepatriationRequestVoAssembler
{
  	/**
	 ...
	 */
	 public static ims.core.vo.CatsReferralDetailsRepatriationRequestVo copy(ims.core.vo.CatsReferralDetailsRepatriationRequestVo valueObjectDest, ims.core.vo.CatsReferralDetailsRepatriationRequestVo valueObjectSrc) 
	 {
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createCatsReferralDetailsRepatriationRequestVoCollectionFromReferralLetterDetails(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.core.clinical.domain.objects.ReferralLetterDetails objects.
	 */
	public static ims.core.vo.CatsReferralDetailsRepatriationRequestVoCollection createCatsReferralDetailsRepatriationRequestVoCollectionFromReferralLetterDetails(java.util.Set domainObjectSet)	
	{
		return createCatsReferralDetailsRepatriationRequestVoCollectionFromReferralLetterDetails(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.core.clinical.domain.objects.ReferralLetterDetails objects.
	 */
	public static ims.core.vo.CatsReferralDetailsRepatriationRequestVoCollection createCatsReferralDetailsRepatriationRequestVoCollectionFromReferralLetterDetails(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.core.vo.CatsReferralDetailsRepatriationRequestVoCollection voList = new ims.core.vo.CatsReferralDetailsRepatriationRequestVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.core.vo.CatsReferralDetailsRepatriationRequestVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.core.vo.CatsReferralDetailsRepatriationRequestVoCollection createCatsReferralDetailsRepatriationRequestVoCollectionFromReferralLetterDetails(java.util.List domainObjectList) 
	{
		return createCatsReferralDetailsRepatriationRequestVoCollectionFromReferralLetterDetails(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.core.clinical.domain.objects.ReferralLetterDetails objects.
	 */
	public static ims.core.vo.CatsReferralDetailsRepatriationRequestVoCollection createCatsReferralDetailsRepatriationRequestVoCollectionFromReferralLetterDetails(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.core.vo.CatsReferralDetailsRepatriationRequestVoCollection voList = new ims.core.vo.CatsReferralDetailsRepatriationRequestVoCollection();
	 ...
	 */
	 public static java.util.Set extractReferralLetterDetailsSet(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.CatsReferralDetailsRepatriationRequestVoCollection voCollection) 
	 {
	 	return extractReferralLetterDetailsSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractReferralLetterDetailsSet(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.CatsReferralDetailsRepatriationRequestVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.core.vo.CatsReferralDetailsRepatriationRequestVo vo = voCollection.get(i);
			ims.core.clinical.domain.objects.ReferralLetterDetails domainObject = CatsReferralDetailsRepatriationRequestVoAssembler.extractReferralLetterDetails(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractReferralLetterDetailsList(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.CatsReferralDetailsRepatriationRequestVoCollection voCollection) 
	 {
	 	return extractReferralLetterDetailsList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractReferralLetterDetailsList(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.CatsReferralDetailsRepatriationRequestVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.core.vo.CatsReferralDetailsRepatriationRequestVo create(ims.core.clinical.domain.objects.ReferralLetterDetails domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.core.vo.CatsReferralDetailsRepatriationRequestVo create(DomainObjectMap map, ims.core.clinical.domain.objects.ReferralLetterDetails domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.core.vo.CatsReferralDetailsRepatriationRequestVo valueObject = (ims.core.vo.CatsReferralDetailsRepatriationRequestVo) map.getValueObject(domainObject, ims.core.vo.CatsReferralDetailsRepatriationRequestVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.core.vo.CatsReferralDetailsRepatriationRequestVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.core.clinical.domain.objects.ReferralLetterDetails
	 */
	 public static ims.core.vo.CatsReferralDetailsRepatriationRequestVo insert(ims.core.vo.CatsReferralDetailsRepatriationRequestVo valueObject, ims.core.clinical.domain.objects.ReferralLetterDetails domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.core.clinical.domain.objects.ReferralLetterDetails
	 */
	 public static ims.core.vo.CatsReferralDetailsRepatriationRequestVo insert(DomainObjectMap map, ims.core.vo.CatsReferralDetailsRepatriationRequestVo valueObject, ims.core.clinical.domain.objects.ReferralLetterDetails domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
		...
		// ReferrerType
		ims.domain.lookups.LookupInstance instance1 = domainObject.getReferrerType();
		if ( null != instance1 ) {
			...
			valueObject.setReferrerType(voLookup1);
		}
				// DateOfReferral
	 ...
	 */
	public static ims.core.clinical.domain.objects.ReferralLetterDetails extractReferralLetterDetails(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.CatsReferralDetailsRepatriationRequestVo valueObject) 
	{
		return 	extractReferralLetterDetails(domainFactory, valueObject, new HashMap());
	}

	public static ims.core.clinical.domain.objects.ReferralLetterDetails extractReferralLetterDetails(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.CatsReferralDetailsRepatriationRequestVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.core.vo.CatsReferralDetailsRepatriationRequestVo ID_ReferralLetterDetails field is unknown
		...
		domainObject.setReferrerType(value1);
		java.util.Date value2 = null;
		ims.framework.utils.Date date2 = valueObject.getDateOfReferral();		
		if ( date2 != null ) 
		{
			value2 = date2.getDate();
		}
		domainObject.setDateOfReferral(value2);
		java.util.Date value3 = null;
		ims.framework.utils.Date date3 = valueObject.getDateReferralReceived();		
		if ( date3 != null ) 
		{
			value3 = date3.getDate();
		}
		domainObject.setDateReferralReceived(value3);
		java.util.Date value4 = null;
		ims.framework.utils.Date date4 = valueObject.getEndDateKPI();		
		if ( date4 != null ) 
		{
			value4 = date4.getDate();
		}
		domainObject.setEndDateKPI(value4);
		...
		if ( null != valueObject.getService() ) 
		{
			...
			{
				value7 = domainObject.getService();	
			}
			else
			{
	...
	ims.core.resource.people.domain.objects.Hcp value8 = null;
		...
		if ( null != valueObject.getAuthoringUser() ) 
		{
			if (valueObject.getAuthoringUser().getBoId() == null)
			{
				...
				{
					value9 = (ims.core.resource.people.domain.objects.MemberOfStaff)domMap.get(valueObject.getAuthoringUser());
				}
			}
			else if (valueObject.getBoVersion() == -1) // RefVo was not modified since obtained from the Assembler, no need to update the BO field
			{
				value9 = domainObject.getAuthoringUser();	
			}
			else
			{
				value9 = (ims.core.resource.people.domain.objects.MemberOfStaff)domainFactory.getDomainObject(ims.core.resource.people.domain.objects.MemberOfStaff.class, valueObject.getAuthoringUser().getBoId());
			}
		}
		domainObject.setAuthoringUser(value9);
		ims.framework.utils.DateTime dateTime10 = valueObject.getAuthoringDateTime();
		java.util.Date value10 = null;
		if ( dateTime10 != null ) 
		{
			value10 = dateTime10.getJavaDate();
		}
		domainObject.setAuthoringDateTime(value10);
