 ...
 */
public class CareContextAdmitVoAssembler
{
  	/**
	 ...
	 */
	 public static ims.core.vo.CareContextAdmitVo copy(ims.core.vo.CareContextAdmitVo valueObjectDest, ims.core.vo.CareContextAdmitVo valueObjectSrc) 
	 {
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createCareContextAdmitVoCollectionFromCareContext(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.core.admin.domain.objects.CareContext objects.
	 */
	public static ims.core.vo.CareContextAdmitVoCollection createCareContextAdmitVoCollectionFromCareContext(java.util.Set domainObjectSet)	
	{
		return createCareContextAdmitVoCollectionFromCareContext(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.core.admin.domain.objects.CareContext objects.
	 */
	public static ims.core.vo.CareContextAdmitVoCollection createCareContextAdmitVoCollectionFromCareContext(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.core.vo.CareContextAdmitVoCollection voList = new ims.core.vo.CareContextAdmitVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.core.vo.CareContextAdmitVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.core.vo.CareContextAdmitVoCollection createCareContextAdmitVoCollectionFromCareContext(java.util.List domainObjectList) 
	{
		return createCareContextAdmitVoCollectionFromCareContext(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.core.admin.domain.objects.CareContext objects.
	 */
	public static ims.core.vo.CareContextAdmitVoCollection createCareContextAdmitVoCollectionFromCareContext(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.core.vo.CareContextAdmitVoCollection voList = new ims.core.vo.CareContextAdmitVoCollection();
	 ...
	 */
	 public static java.util.Set extractCareContextSet(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.CareContextAdmitVoCollection voCollection) 
	 {
	 	return extractCareContextSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractCareContextSet(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.CareContextAdmitVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.core.vo.CareContextAdmitVo vo = voCollection.get(i);
			ims.core.admin.domain.objects.CareContext domainObject = CareContextAdmitVoAssembler.extractCareContext(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractCareContextList(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.CareContextAdmitVoCollection voCollection) 
	 {
	 	return extractCareContextList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractCareContextList(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.CareContextAdmitVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.core.vo.CareContextAdmitVo create(ims.core.admin.domain.objects.CareContext domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.core.vo.CareContextAdmitVo create(DomainObjectMap map, ims.core.admin.domain.objects.CareContext domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.core.vo.CareContextAdmitVo valueObject = (ims.core.vo.CareContextAdmitVo) map.getValueObject(domainObject, ims.core.vo.CareContextAdmitVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.core.vo.CareContextAdmitVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.core.admin.domain.objects.CareContext
	 */
	 public static ims.core.vo.CareContextAdmitVo insert(ims.core.vo.CareContextAdmitVo valueObject, ims.core.admin.domain.objects.CareContext domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.core.admin.domain.objects.CareContext
	 */
	 public static ims.core.vo.CareContextAdmitVo insert(DomainObjectMap map, ims.core.vo.CareContextAdmitVo valueObject, ims.core.admin.domain.objects.CareContext domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 */
	public static ims.core.admin.domain.objects.CareContext extractCareContext(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.CareContextAdmitVo valueObject) 
	{
		return 	extractCareContext(domainFactory, valueObject, new HashMap());
	}

	public static ims.core.admin.domain.objects.CareContext extractCareContext(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.CareContextAdmitVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.core.vo.CareContextAdmitVo ID_CareContext field is unknown
	...
	ims.core.admin.pas.domain.objects.PASEvent value4 = null;
		...
		if ( null != valueObject.getResponsibleHCP() ) 
		{
			...
			{
				value7 = domainObject.getResponsibleHCP();	
			}
			else
			{
		...
		ims.framework.utils.Date date8 = valueObject.getEstimatedDischargeDate();		
		if ( date8 != null ) 
		{
			value8 = date8.getDate();
		}
		domainObject.setEstimatedDischargeDate(value8);
	// SaveAsRefVO - treated as a refVo in extract methods
	ims.core.admin.domain.objects.CareContextStatusHistory value9 = null;
		if ( null != valueObject.getCurrentStatus() ) 
		{
			if (valueObject.getCurrentStatus().getBoId() == null)
			{
				...
				{
					value9 = (ims.core.admin.domain.objects.CareContextStatusHistory)domMap.get(valueObject.getCurrentStatus());
				}
			}
			else
			{
				value9 = (ims.core.admin.domain.objects.CareContextStatusHistory)domainFactory.getDomainObject(ims.core.admin.domain.objects.CareContextStatusHistory.class, valueObject.getCurrentStatus().getBoId());
			}
		}
		domainObject.setCurrentStatus(value9);

		// SaveAsRefVO treated as RefValueObject
		ims.core.admin.vo.CareContextStatusHistoryRefVoCollection refCollection10 = new ims.core.admin.vo.CareContextStatusHistoryRefVoCollection();
		if (valueObject.getStatusHistory() != null)
		{
			for (int i10=0; i10<valueObject.getStatusHistory().size(); i10++)
			{
				ims.core.admin.vo.CareContextStatusHistoryRefVo ref10 = (ims.core.admin.vo.CareContextStatusHistoryRefVo)valueObject.getStatusHistory().get(i10);
				refCollection10.add(ref10);
			}
		}
		int size10 = (null == refCollection10) ? 0 : refCollection10.size();		
		java.util.List domainStatusHistory10 = domainObject.getStatusHistory();
		if (domainStatusHistory10 == null)
		{
			domainStatusHistory10 = new java.util.ArrayList();
		}
		for(int i=0; i < size10; i++) 
		{
			ims.core.admin.vo.CareContextStatusHistoryRefVo vo = refCollection10.get(i);			
			ims.core.admin.domain.objects.CareContextStatusHistory dom = null;
			if ( null != vo ) 
			{
				if (vo.getBoId() == null)
				{
					...
					{
						dom = (ims.core.admin.domain.objects.CareContextStatusHistory)domMap.get(vo);
					}
				}
				else
				{
					dom = (ims.core.admin.domain.objects.CareContextStatusHistory)domainFactory.getDomainObject( ims.core.admin.domain.objects.CareContextStatusHistory.class, vo.getBoId());
				}
			}

			int domIdx = domainStatusHistory10.indexOf(dom);
			if (domIdx == -1)
			{
				domainStatusHistory10.add(i, dom);
			}
			else if (i != domIdx && i < domainStatusHistory10.size())
			{
				Object tmp = domainStatusHistory10.get(i);
				domainStatusHistory10.set(i, domainStatusHistory10.get(domIdx));
				domainStatusHistory10.set(domIdx, tmp);
			}
		}
		
		//Remove all ones in domList where index > voCollection.size() as these should
		//now represent the ones removed from the VO collection. No longer referenced.
		int i10 = domainStatusHistory10.size();
		while (i10 > size10)
		{
			domainStatusHistory10.remove(i10-1);
			i10 = domainStatusHistory10.size();
		}
