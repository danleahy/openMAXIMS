 ...
 */
public class CaseNoteForWorklistVoAssembler
{
  	/**
	 ...
	 */
	 public static ims.core.vo.CaseNoteForWorklistVo copy(ims.core.vo.CaseNoteForWorklistVo valueObjectDest, ims.core.vo.CaseNoteForWorklistVo valueObjectSrc) 
	 {
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createCaseNoteForWorklistVoCollectionFromPatientCaseNote(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.core.clinical.domain.objects.PatientCaseNote objects.
	 */
	public static ims.core.vo.CaseNoteForWorklistVoCollection createCaseNoteForWorklistVoCollectionFromPatientCaseNote(java.util.Set domainObjectSet)	
	{
		return createCaseNoteForWorklistVoCollectionFromPatientCaseNote(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.core.clinical.domain.objects.PatientCaseNote objects.
	 */
	public static ims.core.vo.CaseNoteForWorklistVoCollection createCaseNoteForWorklistVoCollectionFromPatientCaseNote(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.core.vo.CaseNoteForWorklistVoCollection voList = new ims.core.vo.CaseNoteForWorklistVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.core.vo.CaseNoteForWorklistVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.core.vo.CaseNoteForWorklistVoCollection createCaseNoteForWorklistVoCollectionFromPatientCaseNote(java.util.List domainObjectList) 
	{
		return createCaseNoteForWorklistVoCollectionFromPatientCaseNote(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.core.clinical.domain.objects.PatientCaseNote objects.
	 */
	public static ims.core.vo.CaseNoteForWorklistVoCollection createCaseNoteForWorklistVoCollectionFromPatientCaseNote(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.core.vo.CaseNoteForWorklistVoCollection voList = new ims.core.vo.CaseNoteForWorklistVoCollection();
	 ...
	 */
	 public static java.util.Set extractPatientCaseNoteSet(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.CaseNoteForWorklistVoCollection voCollection) 
	 {
	 	return extractPatientCaseNoteSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractPatientCaseNoteSet(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.CaseNoteForWorklistVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.core.vo.CaseNoteForWorklistVo vo = voCollection.get(i);
			ims.core.clinical.domain.objects.PatientCaseNote domainObject = CaseNoteForWorklistVoAssembler.extractPatientCaseNote(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractPatientCaseNoteList(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.CaseNoteForWorklistVoCollection voCollection) 
	 {
	 	return extractPatientCaseNoteList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractPatientCaseNoteList(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.CaseNoteForWorklistVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.core.vo.CaseNoteForWorklistVo create(ims.core.clinical.domain.objects.PatientCaseNote domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.core.vo.CaseNoteForWorklistVo create(DomainObjectMap map, ims.core.clinical.domain.objects.PatientCaseNote domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.core.vo.CaseNoteForWorklistVo valueObject = (ims.core.vo.CaseNoteForWorklistVo) map.getValueObject(domainObject, ims.core.vo.CaseNoteForWorklistVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.core.vo.CaseNoteForWorklistVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.core.clinical.domain.objects.PatientCaseNote
	 */
	 public static ims.core.vo.CaseNoteForWorklistVo insert(ims.core.vo.CaseNoteForWorklistVo valueObject, ims.core.clinical.domain.objects.PatientCaseNote domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.core.clinical.domain.objects.PatientCaseNote
	 */
	 public static ims.core.vo.CaseNoteForWorklistVo insert(DomainObjectMap map, ims.core.vo.CaseNoteForWorklistVo valueObject, ims.core.clinical.domain.objects.PatientCaseNote domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
		...
		// CurrentLocation
		valueObject.setCurrentLocation(ims.core.vo.domain.LocationForCaseNoteWorklistVoAssembler.create(map, domainObject.getCurrentLocation()) );
		// CreatedBy
		...
		// Folder
		ims.domain.lookups.LookupInstance instance8 = domainObject.getFolder();
		if ( null != instance8 ) {
			ims.framework.utils.ImagePath img = null;
			ims.framework.utils.Color color = null;		
			img = null;
			...
			ims.core.vo.lookups.FolderCaseNote voLookup8 = new ims.core.vo.lookups.FolderCaseNote(instance8.getId(),instance8.getText(), instance8.isActive(), null, img, color);
			ims.core.vo.lookups.FolderCaseNote parentVoLookup8 = voLookup8;
			...
			while (parent8 != null)
			{
    			...
    			if (color != null) 
    				color.getValue();
								parentVoLookup8.setParent(new ims.core.vo.lookups.FolderCaseNote(parent8.getId(),parent8.getText(), parent8.isActive(), null, img, color));
				parentVoLookup8 = parentVoLookup8.getParent();
								parent8 = parent8.getParent();
			}			
			valueObject.setFolder(voLookup8);
		}
				// LastTransferDate
	 ...
	 */
	public static ims.core.clinical.domain.objects.PatientCaseNote extractPatientCaseNote(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.CaseNoteForWorklistVo valueObject) 
	{
		return 	extractPatientCaseNote(domainFactory, valueObject, new HashMap());
	}

	public static ims.core.clinical.domain.objects.PatientCaseNote extractPatientCaseNote(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.CaseNoteForWorklistVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.core.vo.CaseNoteForWorklistVo ID_PatientCaseNote field is unknown
	...
	ims.core.resource.people.domain.objects.MemberOfStaff value6 = null;
		...
		domainObject.setFolder(value8);
		ims.framework.utils.DateTime dateTime9 = valueObject.getLastTransferDate();
		java.util.Date value9 = null;
		if ( dateTime9 != null ) 
		{
			value9 = dateTime9.getJavaDate();
		}
		domainObject.setLastTransferDate(value9);
