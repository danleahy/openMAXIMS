 ...
 * @author Sean Nesbitt
 */
public class PDSConvVoAssembler
{
  	/**
	 ...
	 */
	 public static ims.core.vo.PDSConvVo copy(ims.core.vo.PDSConvVo valueObjectDest, ims.core.vo.PDSConvVo valueObjectSrc) 
	 {
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createPDSConvVoCollectionFromPDSConv(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.choose_book.domain.objects.PDSConv objects.
	 */
	public static ims.core.vo.PDSConvVoCollection createPDSConvVoCollectionFromPDSConv(java.util.Set domainObjectSet)	
	{
		return createPDSConvVoCollectionFromPDSConv(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.choose_book.domain.objects.PDSConv objects.
	 */
	public static ims.core.vo.PDSConvVoCollection createPDSConvVoCollectionFromPDSConv(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.core.vo.PDSConvVoCollection voList = new ims.core.vo.PDSConvVoCollection();
		...
		{
			ims.choose_book.domain.objects.PDSConv domainObject = (ims.choose_book.domain.objects.PDSConv) iterator.next();
			ims.core.vo.PDSConvVo vo = create(map, domainObject);
	 ...
	 * @param domainObjectList - List of ims.choose_book.domain.objects.PDSConv objects.
	 */
	public static ims.core.vo.PDSConvVoCollection createPDSConvVoCollectionFromPDSConv(java.util.List domainObjectList) 
	{
		return createPDSConvVoCollectionFromPDSConv(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.choose_book.domain.objects.PDSConv objects.
	 */
	public static ims.core.vo.PDSConvVoCollection createPDSConvVoCollectionFromPDSConv(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.core.vo.PDSConvVoCollection voList = new ims.core.vo.PDSConvVoCollection();
		...
		{
			ims.choose_book.domain.objects.PDSConv domainObject = (ims.choose_book.domain.objects.PDSConv) domainObjectList.get(i);
			ims.core.vo.PDSConvVo vo = create(map, domainObject);
	...
	/**
	 * Create the ims.choose_book.domain.objects.PDSConv set from the value object collection.
	 * @param domainFactory - used to create existing (persistent) domain objects.
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.Set extractPDSConvSet(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.PDSConvVoCollection voCollection) 
	 {
	 	return extractPDSConvSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractPDSConvSet(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.PDSConvVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.core.vo.PDSConvVo vo = voCollection.get(i);
			ims.choose_book.domain.objects.PDSConv domainObject = PDSConvVoAssembler.extractPDSConv(domainFactory, vo, domMap);
	...
	/**
	 * Create the ims.choose_book.domain.objects.PDSConv list from the value object collection.
	 * @param domainFactory - used to create existing (persistent) domain objects.
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractPDSConvList(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.PDSConvVoCollection voCollection) 
	 {
	 	return extractPDSConvList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractPDSConvList(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.PDSConvVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	...
	/**
	 * Create the ValueObject from the ims.choose_book.domain.objects.PDSConv object.
	 * @param domainObject ims.choose_book.domain.objects.PDSConv
	 */
	 public static ims.core.vo.PDSConvVo create(ims.choose_book.domain.objects.PDSConv domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.core.vo.PDSConvVo create(DomainObjectMap map, ims.choose_book.domain.objects.PDSConv domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.core.vo.PDSConvVo valueObject = (ims.core.vo.PDSConvVo) map.getValueObject(domainObject, ims.core.vo.PDSConvVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.core.vo.PDSConvVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.choose_book.domain.objects.PDSConv
	 */
	 public static ims.core.vo.PDSConvVo insert(ims.core.vo.PDSConvVo valueObject, ims.choose_book.domain.objects.PDSConv domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.choose_book.domain.objects.PDSConv
	 */
	 public static ims.core.vo.PDSConvVo insert(DomainObjectMap map, ims.core.vo.PDSConvVo valueObject, ims.choose_book.domain.objects.PDSConv domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 */
	public static ims.choose_book.domain.objects.PDSConv extractPDSConv(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.PDSConvVo valueObject) 
	{
		return 	extractPDSConv(domainFactory, valueObject, new HashMap());
	}

	public static ims.choose_book.domain.objects.PDSConv extractPDSConv(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.PDSConvVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		ims.choose_book.domain.objects.PDSConv domainObject = null;
		if ( null == id) 
		{
			if (domMap.get(valueObject) != null)
			{
				return (ims.choose_book.domain.objects.PDSConv)domMap.get(valueObject);
			}
			// ims.core.vo.PDSConvVo ID_PDSConv field is unknown
			domainObject = new ims.choose_book.domain.objects.PDSConv();
		...
		else 
		{
			...
			{
				return (ims.choose_book.domain.objects.PDSConv)domMap.get(key);
			}
			domainObject = (ims.choose_book.domain.objects.PDSConv) domainFactory.getDomainObject(ims.choose_book.domain.objects.PDSConv.class, id );
