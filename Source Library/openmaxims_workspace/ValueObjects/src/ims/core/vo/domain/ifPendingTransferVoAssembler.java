 ...
 */
public class ifPendingTransferVoAssembler
{
  	/**
	 ...
	 */
	 public static ims.core.vo.ifPendingTransferVo copy(ims.core.vo.ifPendingTransferVo valueObjectDest, ims.core.vo.ifPendingTransferVo valueObjectSrc) 
	 {
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createifPendingTransferVoCollectionFromPendingTransfers(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.core.admin.pas.domain.objects.PendingTransfers objects.
	 */
	public static ims.core.vo.ifPendingTransferVoCollection createifPendingTransferVoCollectionFromPendingTransfers(java.util.Set domainObjectSet)	
	{
		return createifPendingTransferVoCollectionFromPendingTransfers(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.core.admin.pas.domain.objects.PendingTransfers objects.
	 */
	public static ims.core.vo.ifPendingTransferVoCollection createifPendingTransferVoCollectionFromPendingTransfers(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.core.vo.ifPendingTransferVoCollection voList = new ims.core.vo.ifPendingTransferVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.core.vo.ifPendingTransferVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.core.vo.ifPendingTransferVoCollection createifPendingTransferVoCollectionFromPendingTransfers(java.util.List domainObjectList) 
	{
		return createifPendingTransferVoCollectionFromPendingTransfers(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.core.admin.pas.domain.objects.PendingTransfers objects.
	 */
	public static ims.core.vo.ifPendingTransferVoCollection createifPendingTransferVoCollectionFromPendingTransfers(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.core.vo.ifPendingTransferVoCollection voList = new ims.core.vo.ifPendingTransferVoCollection();
	 ...
	 */
	 public static java.util.Set extractPendingTransfersSet(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.ifPendingTransferVoCollection voCollection) 
	 {
	 	return extractPendingTransfersSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractPendingTransfersSet(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.ifPendingTransferVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.core.vo.ifPendingTransferVo vo = voCollection.get(i);
			ims.core.admin.pas.domain.objects.PendingTransfers domainObject = ifPendingTransferVoAssembler.extractPendingTransfers(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractPendingTransfersList(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.ifPendingTransferVoCollection voCollection) 
	 {
	 	return extractPendingTransfersList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractPendingTransfersList(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.ifPendingTransferVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.core.vo.ifPendingTransferVo create(ims.core.admin.pas.domain.objects.PendingTransfers domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.core.vo.ifPendingTransferVo create(DomainObjectMap map, ims.core.admin.pas.domain.objects.PendingTransfers domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.core.vo.ifPendingTransferVo valueObject = (ims.core.vo.ifPendingTransferVo) map.getValueObject(domainObject, ims.core.vo.ifPendingTransferVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.core.vo.ifPendingTransferVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.core.admin.pas.domain.objects.PendingTransfers
	 */
	 public static ims.core.vo.ifPendingTransferVo insert(ims.core.vo.ifPendingTransferVo valueObject, ims.core.admin.pas.domain.objects.PendingTransfers domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.core.admin.pas.domain.objects.PendingTransfers
	 */
	 public static ims.core.vo.ifPendingTransferVo insert(DomainObjectMap map, ims.core.vo.ifPendingTransferVo valueObject, ims.core.admin.pas.domain.objects.PendingTransfers domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
		...
		// WardType
		ims.domain.lookups.LookupInstance instance1 = domainObject.getWardType();
		if ( null != instance1 ) {
			...
			ims.core.vo.lookups.WardType voLookup1 = new ims.core.vo.lookups.WardType(instance1.getId(),instance1.getText(), instance1.isActive(), null, img, color);
			ims.core.vo.lookups.WardType parentVoLookup1 = voLookup1;
			...
			while (parent1 != null)
			{
    			...
    			if (color != null) 
    				color.getValue();
								parentVoLookup1.setParent(new ims.core.vo.lookups.WardType(parent1.getId(),parent1.getText(), parent1.isActive(), null, img, color));
				parentVoLookup1 = parentVoLookup1.getParent();
								parent1 = parent1.getParent();
			}			
			valueObject.setWardType(voLookup1);
		}
				// TransferRequestDateTime
		...
		if ( null != instance4 ) {
			...
			ims.core.vo.lookups.TransferReason voLookup4 = new ims.core.vo.lookups.TransferReason(instance4.getId(),instance4.getText(), instance4.isActive(), null, img, color);
			ims.core.vo.lookups.TransferReason parentVoLookup4 = voLookup4;
			...
			while (parent4 != null)
			{
    			...
    			if (color != null) 
    				color.getValue();
								parentVoLookup4.setParent(new ims.core.vo.lookups.TransferReason(parent4.getId(),parent4.getText(), parent4.isActive(), null, img, color));
		...
		// destinationWard
		valueObject.setDestinationWard(ims.core.vo.domain.LocMostVoAssembler.create(map, domainObject.getDestinationWard()) );
		// PatientStatus
	 ...
	 */
	public static ims.core.admin.pas.domain.objects.PendingTransfers extractPendingTransfers(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.ifPendingTransferVo valueObject) 
	{
		return 	extractPendingTransfers(domainFactory, valueObject, new HashMap());
	}

	public static ims.core.admin.pas.domain.objects.PendingTransfers extractPendingTransfers(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.ifPendingTransferVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.core.vo.ifPendingTransferVo ID_PendingTransfers field is unknown
		...
		domainObject.setWardType(value1);
