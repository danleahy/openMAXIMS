 ...
 */
public class PatientShortICABVoAssembler
{
  	/**
	 ...
	 */
	 public static ims.core.vo.PatientShortICABVo copy(ims.core.vo.PatientShortICABVo valueObjectDest, ims.core.vo.PatientShortICABVo valueObjectSrc) 
	 {
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createPatientShortICABVoCollectionFromPatient(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.core.patient.domain.objects.Patient objects.
	 */
	public static ims.core.vo.PatientShortICABVoCollection createPatientShortICABVoCollectionFromPatient(java.util.Set domainObjectSet)	
	{
		return createPatientShortICABVoCollectionFromPatient(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.core.patient.domain.objects.Patient objects.
	 */
	public static ims.core.vo.PatientShortICABVoCollection createPatientShortICABVoCollectionFromPatient(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.core.vo.PatientShortICABVoCollection voList = new ims.core.vo.PatientShortICABVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.core.vo.PatientShortICABVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.core.vo.PatientShortICABVoCollection createPatientShortICABVoCollectionFromPatient(java.util.List domainObjectList) 
	{
		return createPatientShortICABVoCollectionFromPatient(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.core.patient.domain.objects.Patient objects.
	 */
	public static ims.core.vo.PatientShortICABVoCollection createPatientShortICABVoCollectionFromPatient(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.core.vo.PatientShortICABVoCollection voList = new ims.core.vo.PatientShortICABVoCollection();
	 ...
	 */
	 public static java.util.Set extractPatientSet(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.PatientShortICABVoCollection voCollection) 
	 {
	 	return extractPatientSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractPatientSet(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.PatientShortICABVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.core.vo.PatientShortICABVo vo = voCollection.get(i);
			ims.core.patient.domain.objects.Patient domainObject = PatientShortICABVoAssembler.extractPatient(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractPatientList(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.PatientShortICABVoCollection voCollection) 
	 {
	 	return extractPatientList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractPatientList(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.PatientShortICABVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.core.vo.PatientShortICABVo create(ims.core.patient.domain.objects.Patient domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.core.vo.PatientShortICABVo create(DomainObjectMap map, ims.core.patient.domain.objects.Patient domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.core.vo.PatientShortICABVo valueObject = (ims.core.vo.PatientShortICABVo) map.getValueObject(domainObject, ims.core.vo.PatientShortICABVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.core.vo.PatientShortICABVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.core.patient.domain.objects.Patient
	 */
	 public static ims.core.vo.PatientShortICABVo insert(ims.core.vo.PatientShortICABVo valueObject, ims.core.patient.domain.objects.Patient domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.core.patient.domain.objects.Patient
	 */
	 public static ims.core.vo.PatientShortICABVo insert(DomainObjectMap map, ims.core.vo.PatientShortICABVo valueObject, ims.core.patient.domain.objects.Patient domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
		...
		// SourceOfInformation
		ims.domain.lookups.LookupInstance instance10 = domainObject.getSourceOfInformation();
		if ( null != instance10 ) {
			ims.framework.utils.ImagePath img = null;
			ims.framework.utils.Color color = null;		
			img = null;
			...
			ims.core.vo.lookups.RegistrationSourceOfInfo voLookup10 = new ims.core.vo.lookups.RegistrationSourceOfInfo(instance10.getId(),instance10.getText(), instance10.isActive(), null, img, color);
			ims.core.vo.lookups.RegistrationSourceOfInfo parentVoLookup10 = voLookup10;
			...
			while (parent10 != null)
			{
    			...
    			if (color != null) 
    				color.getValue();
								parentVoLookup10.setParent(new ims.core.vo.lookups.RegistrationSourceOfInfo(parent10.getId(),parent10.getText(), parent10.isActive(), null, img, color));
				parentVoLookup10 = parentVoLookup10.getParent();
								parent10 = parent10.getParent();
			}			
			valueObject.setSourceOfInformation(voLookup10);
		}
		 		return valueObject;
	 }
	 ...
	 */
	public static ims.core.patient.domain.objects.Patient extractPatient(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.PatientShortICABVo valueObject) 
	{
		return 	extractPatient(domainFactory, valueObject, new HashMap());
	}

	public static ims.core.patient.domain.objects.Patient extractPatient(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.PatientShortICABVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.core.vo.PatientShortICABVo ID_Patient field is unknown
		...
		domainObject.setSourceOfInformation(value10);
