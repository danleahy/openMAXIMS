 ...
 * @author Bogdan Tofei
 */
public class WardAttenderAppointmentVoAssembler
{
  	/**
	 ...
	 */
	 public static ims.core.vo.WardAttenderAppointmentVo copy(ims.core.vo.WardAttenderAppointmentVo valueObjectDest, ims.core.vo.WardAttenderAppointmentVo valueObjectSrc) 
	 {
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createWardAttenderAppointmentVoCollectionFromBooking_Appointment(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.scheduling.domain.objects.Booking_Appointment objects.
	 */
	public static ims.core.vo.WardAttenderAppointmentVoCollection createWardAttenderAppointmentVoCollectionFromBooking_Appointment(java.util.Set domainObjectSet)	
	{
		return createWardAttenderAppointmentVoCollectionFromBooking_Appointment(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.scheduling.domain.objects.Booking_Appointment objects.
	 */
	public static ims.core.vo.WardAttenderAppointmentVoCollection createWardAttenderAppointmentVoCollectionFromBooking_Appointment(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.core.vo.WardAttenderAppointmentVoCollection voList = new ims.core.vo.WardAttenderAppointmentVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.core.vo.WardAttenderAppointmentVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.core.vo.WardAttenderAppointmentVoCollection createWardAttenderAppointmentVoCollectionFromBooking_Appointment(java.util.List domainObjectList) 
	{
		return createWardAttenderAppointmentVoCollectionFromBooking_Appointment(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.scheduling.domain.objects.Booking_Appointment objects.
	 */
	public static ims.core.vo.WardAttenderAppointmentVoCollection createWardAttenderAppointmentVoCollectionFromBooking_Appointment(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.core.vo.WardAttenderAppointmentVoCollection voList = new ims.core.vo.WardAttenderAppointmentVoCollection();
	 ...
	 */
	 public static java.util.Set extractBooking_AppointmentSet(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.WardAttenderAppointmentVoCollection voCollection) 
	 {
	 	return extractBooking_AppointmentSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractBooking_AppointmentSet(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.WardAttenderAppointmentVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.core.vo.WardAttenderAppointmentVo vo = voCollection.get(i);
			ims.scheduling.domain.objects.Booking_Appointment domainObject = WardAttenderAppointmentVoAssembler.extractBooking_Appointment(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractBooking_AppointmentList(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.WardAttenderAppointmentVoCollection voCollection) 
	 {
	 	return extractBooking_AppointmentList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractBooking_AppointmentList(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.WardAttenderAppointmentVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.core.vo.WardAttenderAppointmentVo create(ims.scheduling.domain.objects.Booking_Appointment domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.core.vo.WardAttenderAppointmentVo create(DomainObjectMap map, ims.scheduling.domain.objects.Booking_Appointment domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.core.vo.WardAttenderAppointmentVo valueObject = (ims.core.vo.WardAttenderAppointmentVo) map.getValueObject(domainObject, ims.core.vo.WardAttenderAppointmentVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.core.vo.WardAttenderAppointmentVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.scheduling.domain.objects.Booking_Appointment
	 */
	 public static ims.core.vo.WardAttenderAppointmentVo insert(ims.core.vo.WardAttenderAppointmentVo valueObject, ims.scheduling.domain.objects.Booking_Appointment domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.scheduling.domain.objects.Booking_Appointment
	 */
	 public static ims.core.vo.WardAttenderAppointmentVo insert(DomainObjectMap map, ims.core.vo.WardAttenderAppointmentVo valueObject, ims.scheduling.domain.objects.Booking_Appointment domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
		...
		// Activity
		valueObject.setActivity(ims.core.vo.domain.ActivityWithImageLiteVoAssembler.create(map, domainObject.getActivity()) );
		// Session
		...
		// WardAttendanceOutcome
		ims.domain.lookups.LookupInstance instance13 = domainObject.getWardAttendanceOutcome();
		if ( null != instance13 ) {
			ims.framework.utils.ImagePath img = null;
			ims.framework.utils.Color color = null;		
			img = null;
			...
			ims.core.vo.lookups.WardAttendanceOutcome voLookup13 = new ims.core.vo.lookups.WardAttendanceOutcome(instance13.getId(),instance13.getText(), instance13.isActive(), null, img, color);
			ims.core.vo.lookups.WardAttendanceOutcome parentVoLookup13 = voLookup13;
			...
			while (parent13 != null)
			{
    			...
    			if (color != null) 
    				color.getValue();
								parentVoLookup13.setParent(new ims.core.vo.lookups.WardAttendanceOutcome(parent13.getId(),parent13.getText(), parent13.isActive(), null, img, color));
				parentVoLookup13 = parentVoLookup13.getParent();
								parent13 = parent13.getParent();
			}			
			valueObject.setWardAttendanceOutcome(voLookup13);
		}
				// WardAttendanceOutcomeComment
	 ...
	 */
	public static ims.scheduling.domain.objects.Booking_Appointment extractBooking_Appointment(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.WardAttenderAppointmentVo valueObject) 
	{
		return 	extractBooking_Appointment(domainFactory, valueObject, new HashMap());
	}

	public static ims.scheduling.domain.objects.Booking_Appointment extractBooking_Appointment(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.WardAttenderAppointmentVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.core.vo.WardAttenderAppointmentVo ID_Booking_Appointment field is unknown
	...
	ims.core.documents.domain.objects.PatientDocument value11 = null;
		...
		domainObject.setWardAttendanceOutcome(value13);
		//This is to overcome a bug in both Sybase and Oracle which prevents them from storing an empty string correctly
		//Sybase stores it as a single space, Oracle stores it as NULL. This fix will make them consistent at least.
