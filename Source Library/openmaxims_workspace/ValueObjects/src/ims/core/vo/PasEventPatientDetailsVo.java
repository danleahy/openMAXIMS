 ...
 */
public class PasEventPatientDetailsVo extends ims.core.admin.pas.vo.PASEventRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public PasEventPatientDetailsVo()
	{
	}
	public PasEventPatientDetailsVo(Integer id, int version)
	{
		super(id, version);
	}
	public PasEventPatientDetailsVo(ims.core.vo.beans.PasEventPatientDetailsVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.beans.PasEventPatientDetailsVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.core.vo.beans.PasEventPatientDetailsVoBean bean = null;
		if(map != null)
			bean = (ims.core.vo.beans.PasEventPatientDetailsVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.core.vo.beans.PasEventPatientDetailsVoBean();
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.paseventid != null)
			if(this.paseventid.length() > 100)
				listOfErrors.add("The length of the field [paseventid] in the value object [ims.core.vo.PasEventPatientDetailsVo] is too big. It should be less or equal to 100");
	...
	public Object clone()
	{
		...
		PasEventPatientDetailsVo clone = new PasEventPatientDetailsVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(PasEventPatientDetailsVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A PasEventPatientDetailsVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((PasEventPatientDetailsVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((PasEventPatientDetailsVo)obj).getBoId());
	}
