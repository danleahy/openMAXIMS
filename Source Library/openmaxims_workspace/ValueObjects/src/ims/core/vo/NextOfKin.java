	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.objectidentifier != null)
			if(this.objectidentifier.length() > 14)
				listOfErrors.add("The length of the field [objectidentifier] in the value object [ims.core.vo.NextOfKin] is too big. It should be less or equal to 14");
		if(this.nhsnum != null)
			if(this.nhsnum.length() > 50)
				listOfErrors.add("The length of the field [nhsnum] in the value object [ims.core.vo.NextOfKin] is too big. It should be less or equal to 50");
		if(this.contactrank != null)
			if(this.contactrank.length() > 2)
				listOfErrors.add("The length of the field [contactrank] in the value object [ims.core.vo.NextOfKin] is too big. It should be less or equal to 2");
		if(this.pdscontactpreferences != null)
		{
