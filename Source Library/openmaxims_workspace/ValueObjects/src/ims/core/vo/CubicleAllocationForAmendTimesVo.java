 ...
 */
public class CubicleAllocationForAmendTimesVo extends ims.emergency.vo.CubicleAllocationRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public CubicleAllocationForAmendTimesVo()
	{
	}
	public CubicleAllocationForAmendTimesVo(Integer id, int version)
	{
		super(id, version);
	}
	public CubicleAllocationForAmendTimesVo(ims.core.vo.beans.CubicleAllocationForAmendTimesVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.beans.CubicleAllocationForAmendTimesVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.allocatedcubicledatetime = bean.getAllocatedCubicleDateTime() == null ? null : bean.getAllocatedCubicleDateTime().buildDateTime();
	...
	{
		ims.core.vo.beans.CubicleAllocationForAmendTimesVoBean bean = null;
		if(map != null)
			bean = (ims.core.vo.beans.CubicleAllocationForAmendTimesVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.core.vo.beans.CubicleAllocationForAmendTimesVoBean();
	...
	public Object clone()
	{
		...
		CubicleAllocationForAmendTimesVo clone = new CubicleAllocationForAmendTimesVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(CubicleAllocationForAmendTimesVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A CubicleAllocationForAmendTimesVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((CubicleAllocationForAmendTimesVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((CubicleAllocationForAmendTimesVo)obj).getBoId());
	}
