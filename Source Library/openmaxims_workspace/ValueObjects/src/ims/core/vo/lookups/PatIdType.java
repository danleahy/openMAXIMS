...
public class PatIdType extends ims.vo.LookupInstVo implements TreeNode
{
	...
	public static ims.framework.IItemCollection getNegativeInstancesAsIItemCollection()
	{
		...
		result.add(PXNUMBER);
		result.add(MRNNUM);
		result.add(NHSN_TEMP);
		return result;
	}
	public static PatIdType[] getNegativeInstances()
	{
		PatIdType[] instances = new PatIdType[17];
		instances[0] = PKEY;
		instances[1] = HOSPNUM;
		instances[2] = NHSN;
		instances[3] = PPSN;
	...
	public static String[] getNegativeInstanceNames()
	{
		...
		negativeInstances[16] = "NHSN_TEMP";
	...
	public static final PatIdType NHSN_TEMP = new PatIdType(-3150, "Temporary NHS number", true, null, null, Color.Black);
}
