...
public class OrganisationType extends ims.vo.LookupInstVo implements TreeNode
{
	...
	{
		OrganisationType[] instances = new OrganisationType[6];
		instances[0] = GPP;
		instances[1] = SUPPLIER;
		instances[2] = UNKNOWN_TYPE;
		instances[3] = NHS_TRUST_ACUTE;
		instances[4] = LHO;
		instances[5] = NHS_PCT;
		return instances;
	}
	public static String[] getNegativeInstanceNames()
	{
		...
		negativeInstances[1] = "SUPPLIER";
		negativeInstances[2] = "UNKNOWN_TYPE";
		negativeInstances[3] = "NHS_TRUST_ACUTE";
		negativeInstances[4] = "LHO";
		negativeInstances[5] = "NHS_PCT";
