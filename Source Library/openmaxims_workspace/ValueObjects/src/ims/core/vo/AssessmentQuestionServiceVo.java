 ...
 */
public class AssessmentQuestionServiceVo extends ims.assessment.configuration.vo.AssessmentQuestionRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public AssessmentQuestionServiceVo()
	{
	}
	public AssessmentQuestionServiceVo(Integer id, int version)
	{
		super(id, version);
	}
	public AssessmentQuestionServiceVo(ims.core.vo.beans.AssessmentQuestionServiceVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.beans.AssessmentQuestionServiceVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.core.vo.beans.AssessmentQuestionServiceVoBean bean = null;
		if(map != null)
			bean = (ims.core.vo.beans.AssessmentQuestionServiceVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.core.vo.beans.AssessmentQuestionServiceVoBean();
	...
	public Object clone()
	{
		...
		AssessmentQuestionServiceVo clone = new AssessmentQuestionServiceVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(AssessmentQuestionServiceVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A AssessmentQuestionServiceVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((AssessmentQuestionServiceVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((AssessmentQuestionServiceVo)obj).getBoId());
	}
