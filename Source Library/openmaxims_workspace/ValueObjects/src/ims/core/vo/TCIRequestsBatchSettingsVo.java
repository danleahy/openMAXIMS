 ...
 */
public class TCIRequestsBatchSettingsVo extends ims.core.configuration.vo.TCIRequestsBatchRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public TCIRequestsBatchSettingsVo()
	{
	}
	public TCIRequestsBatchSettingsVo(Integer id, int version)
	{
		super(id, version);
	}
	public TCIRequestsBatchSettingsVo(ims.core.vo.beans.TCIRequestsBatchSettingsVoBean bean)
	{
		this.id = bean.getId();
		...
		this.printrequestsfortcisinndays = bean.getPrintRequestsForTCIsInNdays();
	}
	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.beans.TCIRequestsBatchSettingsVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.configuredjobdetails = bean.getConfiguredJobDetails() == null ? null : new ims.core.configuration.vo.ConfiguredJobRefVo(new Integer(bean.getConfiguredJobDetails().getId()), bean.getConfiguredJobDetails().getVersion());
	...
	{
		ims.core.vo.beans.TCIRequestsBatchSettingsVoBean bean = null;
		if(map != null)
			bean = (ims.core.vo.beans.TCIRequestsBatchSettingsVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.core.vo.beans.TCIRequestsBatchSettingsVoBean();
	...
	public Object getFieldValueByFieldName(String fieldName)
	{
		...
		if(fieldName.equals("PRINTREQUESTSFORTCISINNDAYS"))
			return getPrintRequestsForTCIsInNdays();
	...
	public boolean getPrintRequestsForTCIsInNdaysIsNotNull()
	{
		return this.printrequestsfortcisinndays != null;
	}
	public Integer getPrintRequestsForTCIsInNdays()
	{
		return this.printrequestsfortcisinndays;
	}
	public void setPrintRequestsForTCIsInNdays(Integer value)
	{
		this.isValidated = false;
		this.printrequestsfortcisinndays = value;
	}
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.printagentto != null)
			if(this.printagentto.length() > 500)
				listOfErrors.add("The length of the field [printagentto] in the value object [ims.core.vo.TCIRequestsBatchSettingsVo] is too big. It should be less or equal to 500");
	...
	public Object clone()
	{
		...
		TCIRequestsBatchSettingsVo clone = new TCIRequestsBatchSettingsVo(this.id, this.version);
		...
		clone.printrequestsfortcisinndays = this.printrequestsfortcisinndays;
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(TCIRequestsBatchSettingsVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A TCIRequestsBatchSettingsVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((TCIRequestsBatchSettingsVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((TCIRequestsBatchSettingsVo)obj).getBoId());
	}
	...
	public int countFieldsWithValue()
	{
		...
		if(this.printagentto != null)
			count++;
		if(this.printrequestsfortcisinndays != null)
			count++;
		return count;
	}
	...
	protected Integer printrequestsfortcisinndays;
