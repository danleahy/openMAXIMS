 ...
 */
public class PatientCaseNoteTypeVo extends ims.core.clinical.vo.PatientCaseNoteRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public PatientCaseNoteTypeVo()
	{
	}
	public PatientCaseNoteTypeVo(Integer id, int version)
	{
		super(id, version);
	}
	public PatientCaseNoteTypeVo(ims.core.vo.beans.PatientCaseNoteTypeVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.beans.PatientCaseNoteTypeVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.type = bean.getType() == null ? null : ims.core.vo.lookups.CaseNoteType.buildLookup(bean.getType());
	...
	{
		ims.core.vo.beans.PatientCaseNoteTypeVoBean bean = null;
		if(map != null)
			bean = (ims.core.vo.beans.PatientCaseNoteTypeVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.core.vo.beans.PatientCaseNoteTypeVoBean();
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.trackingid == null || this.trackingid.length() == 0)
			...
			listOfErrors.add("The length of the field [trackingid] in the value object [ims.core.vo.PatientCaseNoteTypeVo] is too big. It should be less or equal to 20");
	...
	public Object clone()
	{
		...
		PatientCaseNoteTypeVo clone = new PatientCaseNoteTypeVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(PatientCaseNoteTypeVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A PatientCaseNoteTypeVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((PatientCaseNoteTypeVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((PatientCaseNoteTypeVo)obj).getBoId());
	}
