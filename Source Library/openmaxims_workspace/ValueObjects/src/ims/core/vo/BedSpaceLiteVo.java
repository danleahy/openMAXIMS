...
public class BedSpaceLiteVo extends ims.core.layout.vo.BedSpaceRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public BedSpaceLiteVo(ims.core.vo.beans.BedSpaceLiteVoBean bean)
	{
		...
		this.privatebed = bean.getPrivateBed();
	}
	...
	public Object getFieldValueByFieldName(String fieldName)
	{
		...
		if(fieldName.equals("BEDNUMBER"))
			return getBedNumber();
		if(fieldName.equals("PRIVATEBED"))
			return getPrivateBed();
	...
	public boolean getPrivateBedIsNotNull()
	{
		return this.privatebed != null;
	}
	...
	/**
	* isChair() - method that will return true if the type chosen for the BedSpace object is CHAIR
	*/
	public Boolean isChair()
	{
		return ims.core.vo.lookups.BedSpaceType.CHAIR.getId() == this.bedspacetype.getId();
	}
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.bedspacetype == null)
			listOfErrors.add("Bed Space Type is mandatory");
		...
		if(this.wardtype == null)
			listOfErrors.add("Ward Type - Main/Side is mandatory");
		if(this.bednumber != null)
			if(this.bednumber.length() > 255)
				listOfErrors.add("The length of the field [bednumber] in the value object [ims.core.vo.BedSpaceLiteVo] is too big. It should be less or equal to 255");
	...
	public Object clone()
	{
		...
		clone.privatebed = this.privatebed;
