 ...
 */
public class AuthoringInformationLiteVo extends ims.core.clinical.vo.AuthoringInformationRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public AuthoringInformationLiteVo()
	{
	}
	public AuthoringInformationLiteVo(Integer id, int version)
	{
		super(id, version);
	}
	public AuthoringInformationLiteVo(ims.core.vo.beans.AuthoringInformationLiteVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.beans.AuthoringInformationLiteVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.authoringhcp = bean.getAuthoringHcp() == null ? null : new ims.core.resource.people.vo.HcpRefVo(new Integer(bean.getAuthoringHcp().getId()), bean.getAuthoringHcp().getVersion());
	...
	{
		ims.core.vo.beans.AuthoringInformationLiteVoBean bean = null;
		if(map != null)
			bean = (ims.core.vo.beans.AuthoringInformationLiteVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.core.vo.beans.AuthoringInformationLiteVoBean();
	...
	public Object clone()
	{
		...
		AuthoringInformationLiteVo clone = new AuthoringInformationLiteVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(AuthoringInformationLiteVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A AuthoringInformationLiteVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((AuthoringInformationLiteVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((AuthoringInformationLiteVo)obj).getBoId());
	}
