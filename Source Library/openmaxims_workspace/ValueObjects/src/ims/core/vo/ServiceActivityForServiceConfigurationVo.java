 ...
 */
public class ServiceActivityForServiceConfigurationVo extends ims.core.resource.vo.ServiceActivityRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public ServiceActivityForServiceConfigurationVo()
	{
	}
	public ServiceActivityForServiceConfigurationVo(Integer id, int version)
	{
		super(id, version);
	}
	public ServiceActivityForServiceConfigurationVo(ims.core.vo.beans.ServiceActivityForServiceConfigurationVoBean bean)
	{
		this.id = bean.getId();
		...
		this.isflexible = bean.getIsFlexible();
	}
	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.beans.ServiceActivityForServiceConfigurationVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.service = bean.getService() == null ? null : new ims.core.clinical.vo.ServiceRefVo(new Integer(bean.getService().getId()), bean.getService().getVersion());
	...
	{
		ims.core.vo.beans.ServiceActivityForServiceConfigurationVoBean bean = null;
		if(map != null)
			bean = (ims.core.vo.beans.ServiceActivityForServiceConfigurationVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.core.vo.beans.ServiceActivityForServiceConfigurationVoBean();
	...
	public Object getFieldValueByFieldName(String fieldName)
	{
		...
		if(fieldName.equals("ISACTIVE"))
			return getIsActive();
		if(fieldName.equals("ISFLEXIBLE"))
			return getIsFlexible();
	...
	public Object clone()
	{
		...
		ServiceActivityForServiceConfigurationVo clone = new ServiceActivityForServiceConfigurationVo(this.id, this.version);
		...
		clone.isflexible = this.isflexible;
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(ServiceActivityForServiceConfigurationVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A ServiceActivityForServiceConfigurationVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((ServiceActivityForServiceConfigurationVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((ServiceActivityForServiceConfigurationVo)obj).getBoId());
	}
