	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.bedno != null)
			if(this.bedno.length() > 10)
				listOfErrors.add("The length of the field [bedno] in the value object [ims.core.vo.InPatientEpisodeADTVo] is too big. It should be less or equal to 10");
		if(this.vacatedbednumber != null)
			if(this.vacatedbednumber.length() > 255)
				listOfErrors.add("The length of the field [vacatedbednumber] in the value object [ims.core.vo.InPatientEpisodeADTVo] is too big. It should be less or equal to 255");
