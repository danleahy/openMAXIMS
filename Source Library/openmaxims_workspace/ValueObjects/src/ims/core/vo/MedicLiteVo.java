...
public class MedicLiteVo extends ims.core.resource.people.vo.MedicRefVo implements ims.vo.ImsCloneable, Comparable, ims.vo.interfaces.ICspTypeSpecifier, ims.vo.interfaces.IHcp, ims.vo.interfaces.IMos
{
	...
	*/
	...
	{
		HcpLiteVo hcp = new HcpLiteVo(id, version);
		
		hcp.mos = this.mos;
		hcp.isactive = this.isactive;
		hcp.ishcparesponsiblehcp = this.ishcparesponsiblehcp;
		hcp.isaresponsibleedclinician = this.isaresponsibleedclinician;
		hcp.ishcpaendoscopist = this.ishcpaendoscopist;
