 ...
 */
public class CareContextAdmitLiteVo extends ims.core.admin.vo.CareContextRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public CareContextAdmitLiteVo()
	{
	}
	public CareContextAdmitLiteVo(Integer id, int version)
	{
		super(id, version);
	}
	public CareContextAdmitLiteVo(ims.core.vo.beans.CareContextAdmitLiteVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.beans.CareContextAdmitLiteVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.context = bean.getContext() == null ? null : ims.core.vo.lookups.ContextType.buildLookup(bean.getContext());
	...
	{
		ims.core.vo.beans.CareContextAdmitLiteVoBean bean = null;
		if(map != null)
			bean = (ims.core.vo.beans.CareContextAdmitLiteVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.core.vo.beans.CareContextAdmitLiteVoBean();
	...
	public ims.core.vo.PasEventAdmitLiteVo getPasEvent()
	{
		return this.pasevent;
	}
	public void setPasEvent(ims.core.vo.PasEventAdmitLiteVo value)
	{
		this.isValidated = false;
		this.pasevent = value;
	}
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.bednumber != null)
			if(this.bednumber.length() > 10)
				listOfErrors.add("The length of the field [bednumber] in the value object [ims.core.vo.CareContextAdmitLiteVo] is too big. It should be less or equal to 10");
		if(this.currentstatus != null)
		{
	...
	public Object clone()
	{
		...
		CareContextAdmitLiteVo clone = new CareContextAdmitLiteVo(this.id, this.version);
		...
		if(this.pasevent == null)
			...
			clone.pasevent = (ims.core.vo.PasEventAdmitLiteVo)this.pasevent.clone();
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(CareContextAdmitLiteVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A CareContextAdmitLiteVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((CareContextAdmitLiteVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((CareContextAdmitLiteVo)obj).getBoId());
	}
	...
	protected ims.core.vo.PasEventAdmitLiteVo pasevent;
