 ...
 */
public class CancelClinicRequestsBatchVo extends ims.core.configuration.vo.CancelClinicRequestsBatchRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public CancelClinicRequestsBatchVo()
	{
	}
	public CancelClinicRequestsBatchVo(Integer id, int version)
	{
		super(id, version);
	}
	public CancelClinicRequestsBatchVo(ims.core.vo.beans.CancelClinicRequestsBatchVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.beans.CancelClinicRequestsBatchVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.configuredjobdetails = bean.getConfiguredJobDetails() == null ? null : new ims.core.configuration.vo.ConfiguredJobRefVo(new Integer(bean.getConfiguredJobDetails().getId()), bean.getConfiguredJobDetails().getVersion());
	...
	{
		ims.core.vo.beans.CancelClinicRequestsBatchVoBean bean = null;
		if(map != null)
			bean = (ims.core.vo.beans.CancelClinicRequestsBatchVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.core.vo.beans.CancelClinicRequestsBatchVoBean();
	...
	public Object clone()
	{
		...
		CancelClinicRequestsBatchVo clone = new CancelClinicRequestsBatchVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(CancelClinicRequestsBatchVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A CancelClinicRequestsBatchVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((CancelClinicRequestsBatchVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((CancelClinicRequestsBatchVo)obj).getBoId());
	}
