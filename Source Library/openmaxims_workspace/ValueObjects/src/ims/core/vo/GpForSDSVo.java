 ...
 */
public class GpForSDSVo extends ims.core.resource.people.vo.GpRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public GpForSDSVo(Integer id, int version)
	{
		super(id, version);
	}
	public GpForSDSVo(ims.core.vo.beans.GpForSDSVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.beans.GpForSDSVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.codemappings = ims.core.vo.TaxonomyMapCollection.buildFromBeanCollection(bean.getCodeMappings());
	...
	{
		ims.core.vo.beans.GpForSDSVoBean bean = null;
		if(map != null)
			bean = (ims.core.vo.beans.GpForSDSVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.core.vo.beans.GpForSDSVoBean();
	...
	public Object clone()
	{
		...
		GpForSDSVo clone = new GpForSDSVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(GpForSDSVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A GpForSDSVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((GpForSDSVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((GpForSDSVo)obj).getBoId());
	}
