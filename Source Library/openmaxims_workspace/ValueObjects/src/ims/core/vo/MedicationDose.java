...
public class MedicationDose extends ims.core.clinical.vo.PatientMedicationDoseRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public MedicationDose(ims.core.vo.beans.MedicationDoseBean bean)
	{
		...
		this.stoppedbytype = bean.getStoppedByType() == null ? null : ims.core.vo.lookups.MedicationCommencedDiscontinuedType.buildLookup(bean.getStoppedByType());
	...
	public ims.core.vo.lookups.MedicationCommencedDiscontinuedType getStoppedByType()
	{
		return this.stoppedbytype;
	}
	public void setStoppedByType(ims.core.vo.lookups.MedicationCommencedDiscontinuedType value)
	{
		this.isValidated = false;
	...
	*/
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.comment != null)
			if(this.comment.length() > 255)
				listOfErrors.add("The length of the field [comment] in the value object [ims.core.vo.MedicationDose] is too big. It should be less or equal to 255");
	...
	public Object clone()
	{
		...
		if(this.stoppedbytype == null)
			...
			clone.stoppedbytype = (ims.core.vo.lookups.MedicationCommencedDiscontinuedType)this.stoppedbytype.clone();
		if(this.authoringinformation == null)
	...
	protected ims.core.vo.lookups.MedicationCommencedDiscontinuedType stoppedbytype;
