 ...
 */
public class PatientForOutpatientBookingWorklistVo extends ims.core.patient.vo.PatientRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public PatientForOutpatientBookingWorklistVo()
	{
	}
	public PatientForOutpatientBookingWorklistVo(Integer id, int version)
	{
		super(id, version);
	}
	public PatientForOutpatientBookingWorklistVo(ims.core.vo.beans.PatientForOutpatientBookingWorklistVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.beans.PatientForOutpatientBookingWorklistVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.core.vo.beans.PatientForOutpatientBookingWorklistVoBean bean = null;
		if(map != null)
			bean = (ims.core.vo.beans.PatientForOutpatientBookingWorklistVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.core.vo.beans.PatientForOutpatientBookingWorklistVoBean();
	...
	*/
	...
	public Object clone()
	{
		...
		PatientForOutpatientBookingWorklistVo clone = new PatientForOutpatientBookingWorklistVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(PatientForOutpatientBookingWorklistVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A PatientForOutpatientBookingWorklistVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((PatientForOutpatientBookingWorklistVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((PatientForOutpatientBookingWorklistVo)obj).getBoId());
	}
