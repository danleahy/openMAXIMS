 ...
 */
public class CodedDiagnosisStatusVo extends ims.core.clinical.vo.CodedDiagnosisStatusRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public CodedDiagnosisStatusVo()
	{
	}
	public CodedDiagnosisStatusVo(Integer id, int version)
	{
		super(id, version);
	}
	public CodedDiagnosisStatusVo(ims.core.vo.beans.CodedDiagnosisStatusVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.beans.CodedDiagnosisStatusVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.status = bean.getStatus() == null ? null : ims.core.vo.lookups.DiagnosisStatus.buildLookup(bean.getStatus());
	...
	{
		ims.core.vo.beans.CodedDiagnosisStatusVoBean bean = null;
		if(map != null)
			bean = (ims.core.vo.beans.CodedDiagnosisStatusVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.core.vo.beans.CodedDiagnosisStatusVoBean();
	...
	public Object clone()
	{
		...
		CodedDiagnosisStatusVo clone = new CodedDiagnosisStatusVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(CodedDiagnosisStatusVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A CodedDiagnosisStatusVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((CodedDiagnosisStatusVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((CodedDiagnosisStatusVo)obj).getBoId());
	}
