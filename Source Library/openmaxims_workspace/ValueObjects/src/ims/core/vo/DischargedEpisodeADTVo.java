...
public class DischargedEpisodeADTVo extends ims.core.admin.pas.vo.DischargedEpisodeRefVo implements ims.vo.ImsCloneable, Comparable, ims.vo.interfaces.IGenericItemType
{
	...
	public DischargedEpisodeADTVo(ims.core.vo.beans.DischargedEpisodeADTVoBean bean)
	{
		...
		this.wasdiagnosticdeferred = bean.getWasDiagnosticDeferred();
		this.wastreatmentgiven = bean.getWasTreatmentGiven();
		...
		this.dischargingward = bean.getDischargingWard() == null ? null : new ims.core.resource.place.vo.LocationRefVo(new Integer(bean.getDischargingWard().getId()), bean.getDischargingWard().getVersion());
	}
	...
	public Object getFieldValueByFieldName(String fieldName)
	{
		...
		if(fieldName.equals("WASDIAGNOSTICDEFERRED"))
			return getWasDiagnosticDeferred();
		if(fieldName.equals("WASTREATMENTGIVEN"))
			return getWasTreatmentGiven();
	...
	public boolean getWasDiagnosticDeferredIsNotNull()
	{
		return this.wasdiagnosticdeferred != null;
	}
	...
	public boolean getWasTreatmentGivenIsNotNull()
	{
		return this.wastreatmentgiven != null;
	}
	...
	public ims.core.resource.place.vo.LocationRefVo getDischargingWard()
	{
		return this.dischargingward;
	}
	public void setDischargingWard(ims.core.resource.place.vo.LocationRefVo value)
	{
		this.isValidated = false;
	...
	*/
	...
	public Object clone()
	{
		...
		clone.wasdiagnosticdeferred = this.wasdiagnosticdeferred;
		clone.wastreatmentgiven = this.wastreatmentgiven;
		...
		clone.dischargingward = this.dischargingward;
	...
	public int countFieldsWithValue()
	{
		...
		if(this.vteriskassessment != null)
			count++;
		if(this.wasdiagnosticdeferred != null)
			count++;
		if(this.wastreatmentgiven != null)
			count++;
		if(this.deferredreason != null)
			count++;
		if(this.deferredreasonconfig != null)
	...
	protected Boolean wasdiagnosticdeferred;
	protected Boolean wastreatmentgiven;
	...
	protected ims.core.resource.place.vo.LocationRefVo dischargingward;
