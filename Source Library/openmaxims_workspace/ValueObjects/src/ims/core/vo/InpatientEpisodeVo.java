...
public class InpatientEpisodeVo extends ims.core.admin.pas.vo.InpatientEpisodeRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public Object getFieldValueByFieldName(String fieldName)
	{
		...
		if(fieldName.equals("ADMISSIONDETAILS"))
		...
		if(fieldName.equals("ADMISSIONDETAILUPDATES"))
			return getAdmissionDetailUpdates();
	...
	{
		return this.admissiondetails != null;
	}
	public ims.core.admin.pas.vo.AdmissionDetailRefVo getAdmissionDetails()
	{
		return this.admissiondetails;
	}
	public void setAdmissionDetails(ims.core.admin.pas.vo.AdmissionDetailRefVo value)
	{
		this.isValidated = false;
	...
	public boolean getAdmissionDetailUpdatesIsNotNull()
	{
		return this.admissiondetailupdates != null;
	}
	public ims.core.vo.AdmissionDetailForADTUpdateAdmissionVo getAdmissionDetailUpdates()
	{
		return this.admissiondetailupdates;
	}
	public void setAdmissionDetailUpdates(ims.core.vo.AdmissionDetailForADTUpdateAdmissionVo value)
	{
		this.isValidated = false;
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.reasonforadmission != null)
			if(this.reasonforadmission.length() > 255)
				listOfErrors.add("The length of the field [reasonforadmission] in the value object [ims.core.vo.InpatientEpisodeVo] is too big. It should be less or equal to 255");
		if(this.extendeddetails != null)
		{
	...
	protected ims.core.admin.pas.vo.AdmissionDetailRefVo admissiondetails;
	...
	protected ims.core.vo.AdmissionDetailForADTUpdateAdmissionVo admissiondetailupdates;
