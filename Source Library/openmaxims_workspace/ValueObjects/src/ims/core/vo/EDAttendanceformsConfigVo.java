...
public class EDAttendanceformsConfigVo extends ims.core.admin.vo.EDAttendenceformsConfigRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public EDAttendanceformsConfigVo(ims.core.vo.beans.EDAttendanceformsConfigVoBean bean)
	{
		...
		this.insurancetabvisible = bean.getInsuranceTabVisible();
		this.displayprintdialog = bean.getDisplayPrintDialog();
	}
	...
	public Object getFieldValueByFieldName(String fieldName)
	{
		...
		if(fieldName.equals("INSURANCETABVISIBLE"))
			return getInsuranceTabVisible();
		if(fieldName.equals("DISPLAYPRINTDIALOG"))
			return getDisplayPrintDialog();
	...
	public boolean getInsuranceTabVisibleIsNotNull()
	{
		return this.insurancetabvisible != null;
	}
	public Boolean getInsuranceTabVisible()
	{
		return this.insurancetabvisible;
	}
	public void setInsuranceTabVisible(Boolean value)
	{
		this.isValidated = false;
		this.insurancetabvisible = value;
	}
	public boolean getDisplayPrintDialogIsNotNull()
	{
		return this.displayprintdialog != null;
	}
	public Boolean getDisplayPrintDialog()
	{
		return this.displayprintdialog;
	}
	public void setDisplayPrintDialog(Boolean value)
	{
		this.isValidated = false;
		this.displayprintdialog = value;
	}
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.insurancetabvisible == null)
			listOfErrors.add("InsuranceTabVisible is mandatory");
	...
	public Object clone()
	{
		...
		clone.insurancetabvisible = this.insurancetabvisible;
		clone.displayprintdialog = this.displayprintdialog;
	...
	public int countFieldsWithValue()
	{
		...
		if(this.insurancetabvisible != null)
			count++;
		if(this.displayprintdialog != null)
			count++;
		return count;
	}
	...
	protected Boolean insurancetabvisible;
