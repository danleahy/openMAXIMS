...
public class PendingDischargesVo extends ims.core.admin.pas.vo.InpatientEpisodeRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public PendingDischargesVo(ims.core.vo.beans.PendingDischargesVoBean bean)
	{
		...
		this.potentialdischarge = bean.getPotentialDischarge();
		this.confirmeddischarge = bean.getConfirmedDischarge();
		this.readytoleave = bean.getReadyToLeave();
	}
	...
	public Object getFieldValueByFieldName(String fieldName)
	{
		...
		if(fieldName.equals("IDTYPE"))
			return getIDType();
		if(fieldName.equals("POTENTIALDISCHARGE"))
			return getPotentialDischarge();
		if(fieldName.equals("CONFIRMEDDISCHARGE"))
			return getConfirmedDischarge();
		if(fieldName.equals("READYTOLEAVE"))
			return getReadyToLeave();
	...
	public boolean getPotentialDischargeIsNotNull()
	{
		return this.potentialdischarge != null;
	}
	...
	public boolean getConfirmedDischargeIsNotNull()
	{
		return this.confirmeddischarge != null;
	}
	...
	public boolean getReadyToLeaveIsNotNull()
	{
		return this.readytoleave != null;
	}
	...
	public Object clone()
	{
		...
		clone.potentialdischarge = this.potentialdischarge;
		clone.confirmeddischarge = this.confirmeddischarge;
		clone.readytoleave = this.readytoleave;
	...
	public int countFieldsWithValue()
	{
		...
		if(this.idtype != null)
			count++;
		if(this.potentialdischarge != null)
			count++;
		if(this.confirmeddischarge != null)
			count++;
		if(this.readytoleave != null)
			count++;
		return count;
	}
	...
	protected Boolean potentialdischarge;
	protected Boolean confirmeddischarge;
