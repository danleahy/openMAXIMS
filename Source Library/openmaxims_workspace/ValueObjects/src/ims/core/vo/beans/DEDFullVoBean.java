...
public class DEDFullVoBean extends ims.vo.ValueObjectBean
{
	public DEDFullVoBean()
	{
	}
	public DEDFullVoBean(ims.core.vo.DEDFullVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.DEDFullVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.name = vo.getName();
	...
	public ims.core.vo.DEDFullVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.core.vo.DEDFullVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.core.vo.DEDFullVo vo = null;
		if(map != null)
			vo = (ims.core.vo.DEDFullVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.core.vo.DEDFullVo();
