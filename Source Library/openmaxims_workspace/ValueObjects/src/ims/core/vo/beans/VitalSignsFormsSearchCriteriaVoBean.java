...
public class VitalSignsFormsSearchCriteriaVoBean extends ims.vo.ValueObjectBean
{
	public VitalSignsFormsSearchCriteriaVoBean()
	{
	}
	public VitalSignsFormsSearchCriteriaVoBean(ims.core.vo.VitalSignsFormsSearchCriteriaVo vo)
	{
		this.viewby = vo.getViewBy();
		this.byday = vo.getByDay() == null ? null : (ims.framework.utils.beans.DateBean)vo.getByDay().getBean();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.VitalSignsFormsSearchCriteriaVo vo)
	{
		this.viewby = vo.getViewBy();
		this.byday = vo.getByDay() == null ? null : (ims.framework.utils.beans.DateBean)vo.getByDay().getBean();
		this.fromdate = vo.getFromDate() == null ? null : (ims.framework.utils.beans.DateBean)vo.getFromDate().getBean();
	...
	public ims.core.vo.VitalSignsFormsSearchCriteriaVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.core.vo.VitalSignsFormsSearchCriteriaVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.core.vo.VitalSignsFormsSearchCriteriaVo vo = null;
		if(map != null)
			vo = (ims.core.vo.VitalSignsFormsSearchCriteriaVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.core.vo.VitalSignsFormsSearchCriteriaVo();
	...
	public ims.framework.utils.beans.DateBean getByDay()
	{
		return this.byday;
	}
	public void setByDay(ims.framework.utils.beans.DateBean value)
	{
		this.byday = value;
	}
	...
	private ims.framework.utils.beans.DateBean byday;
