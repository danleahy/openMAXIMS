...
public class CareContextRepatriationVoBean extends ims.vo.ValueObjectBean
{
	public CareContextRepatriationVoBean()
	{
	}
	public CareContextRepatriationVoBean(ims.core.vo.CareContextRepatriationVo vo)
	{
		this.id = vo.getBoId();
		...
		this.pasevent = vo.getPasEvent() == null ? null : (ims.core.vo.beans.PasEventRepatriationVoBean)vo.getPasEvent().getBean();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.CareContextRepatriationVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.context = vo.getContext() == null ? null : (ims.vo.LookupInstanceBean)vo.getContext().getBean();
		...
		this.responsiblehcp = vo.getResponsibleHCP() == null ? null : new ims.vo.RefVoBean(vo.getResponsibleHCP().getBoId(), vo.getResponsibleHCP().getBoVersion());
		this.episodeofcare = vo.getEpisodeOfCare() == null ? null : new ims.vo.RefVoBean(vo.getEpisodeOfCare().getBoId(), vo.getEpisodeOfCare().getBoVersion());
		this.pasevent = vo.getPasEvent() == null ? null : (ims.core.vo.beans.PasEventRepatriationVoBean)vo.getPasEvent().getBean(map);
	...
	public ims.core.vo.CareContextRepatriationVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.core.vo.CareContextRepatriationVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.core.vo.CareContextRepatriationVo vo = null;
		if(map != null)
			vo = (ims.core.vo.CareContextRepatriationVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.core.vo.CareContextRepatriationVo();
	...
	public ims.core.vo.beans.PasEventRepatriationVoBean getPasEvent()
	{
		return this.pasevent;
	}
	public void setPasEvent(ims.core.vo.beans.PasEventRepatriationVoBean value)
	{
		this.pasevent = value;
	}
	...
	private ims.core.vo.beans.PasEventRepatriationVoBean pasevent;
