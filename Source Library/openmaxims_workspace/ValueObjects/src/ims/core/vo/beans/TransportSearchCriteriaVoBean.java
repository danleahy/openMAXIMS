...
public class TransportSearchCriteriaVoBean extends ims.vo.ValueObjectBean
{
	public TransportSearchCriteriaVoBean()
	{
	}
	public TransportSearchCriteriaVoBean(ims.core.vo.TransportSearchCriteriaVo vo)
	{
		...
		this.displaycancelled = vo.getDisplayCancelled();
	}

	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.TransportSearchCriteriaVo vo)
	{
		this.fromdate = vo.getFromDate() == null ? null : (ims.framework.utils.beans.DateBean)vo.getFromDate().getBean();
		this.todate = vo.getToDate() == null ? null : (ims.framework.utils.beans.DateBean)vo.getToDate().getBean();
		this.displaycancelled = vo.getDisplayCancelled();
	...
	public ims.core.vo.TransportSearchCriteriaVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.core.vo.TransportSearchCriteriaVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.core.vo.TransportSearchCriteriaVo vo = null;
		if(map != null)
			vo = (ims.core.vo.TransportSearchCriteriaVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.core.vo.TransportSearchCriteriaVo();
	...
	private Boolean displaycancelled;
}
