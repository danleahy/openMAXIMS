...
public class CatsReferralDetailsRepatriationRequestLiteVoBean extends ims.vo.ValueObjectBean
{
	public CatsReferralDetailsRepatriationRequestLiteVoBean()
	{
	}
	public CatsReferralDetailsRepatriationRequestLiteVoBean(ims.core.vo.CatsReferralDetailsRepatriationRequestLiteVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.CatsReferralDetailsRepatriationRequestLiteVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.service = vo.getService() == null ? null : new ims.vo.RefVoBean(vo.getService().getBoId(), vo.getService().getBoVersion());
	...
	public ims.core.vo.CatsReferralDetailsRepatriationRequestLiteVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.core.vo.CatsReferralDetailsRepatriationRequestLiteVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.core.vo.CatsReferralDetailsRepatriationRequestLiteVo vo = null;
		if(map != null)
			vo = (ims.core.vo.CatsReferralDetailsRepatriationRequestLiteVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.core.vo.CatsReferralDetailsRepatriationRequestLiteVo();
