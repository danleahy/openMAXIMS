...
public class CareContextAdmitLiteVoBean extends ims.vo.ValueObjectBean
{
	public CareContextAdmitLiteVoBean()
	{
	}
	public CareContextAdmitLiteVoBean(ims.core.vo.CareContextAdmitLiteVo vo)
	{
		this.id = vo.getBoId();
		...
		this.pasevent = vo.getPasEvent() == null ? null : (ims.core.vo.beans.PasEventAdmitLiteVoBean)vo.getPasEvent().getBean();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.CareContextAdmitLiteVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.context = vo.getContext() == null ? null : (ims.vo.LookupInstanceBean)vo.getContext().getBean();
		...
		this.responsiblehcp = vo.getResponsibleHCP() == null ? null : new ims.vo.RefVoBean(vo.getResponsibleHCP().getBoId(), vo.getResponsibleHCP().getBoVersion());
		this.episodeofcare = vo.getEpisodeOfCare() == null ? null : new ims.vo.RefVoBean(vo.getEpisodeOfCare().getBoId(), vo.getEpisodeOfCare().getBoVersion());
		this.pasevent = vo.getPasEvent() == null ? null : (ims.core.vo.beans.PasEventAdmitLiteVoBean)vo.getPasEvent().getBean(map);
		this.locationtype = vo.getLocationType() == null ? null : (ims.vo.LookupInstanceBean)vo.getLocationType().getBean();
		this.bednumber = vo.getBedNumber();
		this.estimateddischargedate = vo.getEstimatedDischargeDate() == null ? null : (ims.framework.utils.beans.DateBean)vo.getEstimatedDischargeDate().getBean();
	...
	public ims.core.vo.CareContextAdmitLiteVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.core.vo.CareContextAdmitLiteVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.core.vo.CareContextAdmitLiteVo vo = null;
		if(map != null)
			vo = (ims.core.vo.CareContextAdmitLiteVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.core.vo.CareContextAdmitLiteVo();
	...
	public ims.core.vo.beans.PasEventAdmitLiteVoBean getPasEvent()
	{
		return this.pasevent;
	}
	public void setPasEvent(ims.core.vo.beans.PasEventAdmitLiteVoBean value)
	{
		this.pasevent = value;
	}
	...
	private ims.core.vo.beans.PasEventAdmitLiteVoBean pasevent;
