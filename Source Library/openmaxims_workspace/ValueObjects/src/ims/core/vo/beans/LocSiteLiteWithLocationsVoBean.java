...
public class LocSiteLiteWithLocationsVoBean extends ims.vo.ValueObjectBean
{
	public LocSiteLiteWithLocationsVoBean()
	{
	}
	public LocSiteLiteWithLocationsVoBean(ims.core.vo.LocSiteLiteWithLocationsVo vo)
	{
		this.id = vo.getBoId();
		...
		this.parentorganisation = vo.getParentOrganisation() == null ? null : new ims.vo.RefVoBean(vo.getParentOrganisation().getBoId(), vo.getParentOrganisation().getBoVersion());
	}

	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.LocSiteLiteWithLocationsVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.name = vo.getName();
	...
	public ims.core.vo.LocSiteLiteWithLocationsVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.core.vo.LocSiteLiteWithLocationsVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.core.vo.LocSiteLiteWithLocationsVo vo = null;
		if(map != null)
			vo = (ims.core.vo.LocSiteLiteWithLocationsVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.core.vo.LocSiteLiteWithLocationsVo();
	...
	public ims.core.vo.beans.LocationMinWithLocationsVoBean[] getLocations()
	{
		return this.locations;
	}
	public void setLocations(ims.core.vo.beans.LocationMinWithLocationsVoBean[] value)
	{
		this.locations = value;
	}
	public ims.vo.RefVoBean getParentOrganisation()
	{
		return this.parentorganisation;
	}
	public void setParentOrganisation(ims.vo.RefVoBean value)
	{
	...
	private ims.core.vo.beans.LocationMinWithLocationsVoBean[] locations;
	private ims.vo.RefVoBean parentorganisation;
}
