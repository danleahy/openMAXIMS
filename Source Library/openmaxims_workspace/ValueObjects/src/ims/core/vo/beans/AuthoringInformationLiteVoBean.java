...
public class AuthoringInformationLiteVoBean extends ims.vo.ValueObjectBean
{
	public AuthoringInformationLiteVoBean()
	{
	}
	public AuthoringInformationLiteVoBean(ims.core.vo.AuthoringInformationLiteVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.AuthoringInformationLiteVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.authoringhcp = vo.getAuthoringHcp() == null ? null : new ims.vo.RefVoBean(vo.getAuthoringHcp().getBoId(), vo.getAuthoringHcp().getBoVersion());
	...
	public ims.core.vo.AuthoringInformationLiteVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.core.vo.AuthoringInformationLiteVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.core.vo.AuthoringInformationLiteVo vo = null;
		if(map != null)
			vo = (ims.core.vo.AuthoringInformationLiteVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.core.vo.AuthoringInformationLiteVo();
