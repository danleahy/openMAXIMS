...
public class TotalFluidBalanceSearchCriteriaVoBean extends ims.vo.ValueObjectBean
{
	public TotalFluidBalanceSearchCriteriaVoBean()
	{
	}
	public TotalFluidBalanceSearchCriteriaVoBean(ims.core.vo.TotalFluidBalanceSearchCriteriaVo vo)
	{
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.TotalFluidBalanceSearchCriteriaVo vo)
	{
		this.fromdate = vo.getFromDate() == null ? null : (ims.framework.utils.beans.DateBean)vo.getFromDate().getBean();
	...
	public ims.core.vo.TotalFluidBalanceSearchCriteriaVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.core.vo.TotalFluidBalanceSearchCriteriaVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.core.vo.TotalFluidBalanceSearchCriteriaVo vo = null;
		if(map != null)
			vo = (ims.core.vo.TotalFluidBalanceSearchCriteriaVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.core.vo.TotalFluidBalanceSearchCriteriaVo();
