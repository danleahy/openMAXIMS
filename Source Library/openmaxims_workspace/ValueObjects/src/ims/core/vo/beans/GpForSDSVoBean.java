...
public class GpForSDSVoBean extends ims.vo.ValueObjectBean
{
	public GpForSDSVoBean()
	{
	}
	public GpForSDSVoBean(ims.core.vo.GpForSDSVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.GpForSDSVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.codemappings = vo.getCodeMappings() == null ? null : vo.getCodeMappings().getBeanCollection();
	...
	public ims.core.vo.GpForSDSVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.core.vo.GpForSDSVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.core.vo.GpForSDSVo vo = null;
		if(map != null)
			vo = (ims.core.vo.GpForSDSVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.core.vo.GpForSDSVo();
