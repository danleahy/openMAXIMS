...
public class PendingEmergencyAdmissionCancellationVoBean extends ims.vo.ValueObjectBean
{
	public PendingEmergencyAdmissionCancellationVoBean()
	{
	}
	public PendingEmergencyAdmissionCancellationVoBean(ims.core.vo.PendingEmergencyAdmissionCancellationVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.PendingEmergencyAdmissionCancellationVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.type = vo.getType() == null ? null : (ims.vo.LookupInstanceBean)vo.getType().getBean();
	...
	public ims.core.vo.PendingEmergencyAdmissionCancellationVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.core.vo.PendingEmergencyAdmissionCancellationVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.core.vo.PendingEmergencyAdmissionCancellationVo vo = null;
		if(map != null)
			vo = (ims.core.vo.PendingEmergencyAdmissionCancellationVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.core.vo.PendingEmergencyAdmissionCancellationVo();
