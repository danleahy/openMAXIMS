...
public class CatsReferralRepatriationRequestVoBean extends ims.vo.ValueObjectBean
{
	public CatsReferralRepatriationRequestVoBean()
	{
	}
	public CatsReferralRepatriationRequestVoBean(ims.core.vo.CatsReferralRepatriationRequestVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.patient = vo.getPatient() == null ? null : new ims.vo.RefVoBean(vo.getPatient().getBoId(), vo.getPatient().getBoVersion());
		this.referraldetails = vo.getReferralDetails() == null ? null : (ims.core.vo.beans.CatsReferralDetailsRepatriationRequestVoBean)vo.getReferralDetails().getBean();
		...
		this.repatriationrequest = vo.getRepatriationRequest() == null ? null : (ims.core.vo.beans.PendingEmergencyAdmissionRepatriationVoBean)vo.getRepatriationRequest().getBean();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.CatsReferralRepatriationRequestVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.patient = vo.getPatient() == null ? null : new ims.vo.RefVoBean(vo.getPatient().getBoId(), vo.getPatient().getBoVersion());
		this.referraldetails = vo.getReferralDetails() == null ? null : (ims.core.vo.beans.CatsReferralDetailsRepatriationRequestVoBean)vo.getReferralDetails().getBean(map);
		this.episodeofcare = vo.getEpisodeOfCare() == null ? null : new ims.vo.RefVoBean(vo.getEpisodeOfCare().getBoId(), vo.getEpisodeOfCare().getBoVersion());
		this.carecontext = vo.getCareContext() == null ? null : new ims.vo.RefVoBean(vo.getCareContext().getBoId(), vo.getCareContext().getBoVersion());
		...
		this.repatriationrequest = vo.getRepatriationRequest() == null ? null : (ims.core.vo.beans.PendingEmergencyAdmissionRepatriationVoBean)vo.getRepatriationRequest().getBean(map);
		this.patientcategory = vo.getPatientCategory() == null ? null : (ims.vo.LookupInstanceBean)vo.getPatientCategory().getBean();
		this.isemergencyreferral = vo.getIsEmergencyReferral();
	}

	public ims.core.vo.CatsReferralRepatriationRequestVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.core.vo.CatsReferralRepatriationRequestVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.core.vo.CatsReferralRepatriationRequestVo vo = null;
		if(map != null)
			vo = (ims.core.vo.CatsReferralRepatriationRequestVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.core.vo.CatsReferralRepatriationRequestVo();
	...
	public ims.core.vo.beans.CatsReferralDetailsRepatriationRequestVoBean getReferralDetails()
	{
		return this.referraldetails;
	}
	public void setReferralDetails(ims.core.vo.beans.CatsReferralDetailsRepatriationRequestVoBean value)
	{
	...
	public ims.core.vo.beans.PendingEmergencyAdmissionRepatriationVoBean getRepatriationRequest()
	{
		return this.repatriationrequest;
	}
	public void setRepatriationRequest(ims.core.vo.beans.PendingEmergencyAdmissionRepatriationVoBean value)
	{
	...
	private ims.core.vo.beans.CatsReferralDetailsRepatriationRequestVoBean referraldetails;
	...
	private ims.core.vo.beans.PendingEmergencyAdmissionRepatriationVoBean repatriationrequest;
