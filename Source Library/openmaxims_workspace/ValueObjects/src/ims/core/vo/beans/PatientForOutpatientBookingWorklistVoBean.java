...
public class PatientForOutpatientBookingWorklistVoBean extends ims.vo.ValueObjectBean
{
	public PatientForOutpatientBookingWorklistVoBean()
	{
	}
	public PatientForOutpatientBookingWorklistVoBean(ims.core.vo.PatientForOutpatientBookingWorklistVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.PatientForOutpatientBookingWorklistVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
	...
	public ims.core.vo.PatientForOutpatientBookingWorklistVo buildVo()
	{
