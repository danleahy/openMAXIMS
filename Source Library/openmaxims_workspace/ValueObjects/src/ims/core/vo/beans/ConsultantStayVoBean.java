...
public class ConsultantStayVoBean extends ims.vo.ValueObjectBean
{
	...
	public ConsultantStayVoBean(ims.core.vo.ConsultantStayVo vo)
	{
		...
		if(vo.getCodingComment() != null)
		{
			this.codingcomment = new ims.vo.RefVoBean[vo.getCodingComment().size()];
			for(int codingcomment_i = 0; codingcomment_i < vo.getCodingComment().size(); codingcomment_i++)
			{
				this.codingcomment[codingcomment_i] = new ims.vo.RefVoBean(vo.getCodingComment().get(codingcomment_i).getBoId(),vo.getCodingComment().get(codingcomment_i).getBoVersion());
			}
		}
	...
	public ims.vo.RefVoBean[] getCodingComment()
	{
		return this.codingcomment;
	}
	public void setCodingComment(ims.vo.RefVoBean[] value)
	{
	...
	private ims.vo.RefVoBean[] codingcomment;
