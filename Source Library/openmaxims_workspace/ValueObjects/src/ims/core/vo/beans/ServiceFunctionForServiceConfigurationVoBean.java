...
public class ServiceFunctionForServiceConfigurationVoBean extends ims.vo.ValueObjectBean
{
	public ServiceFunctionForServiceConfigurationVoBean()
	{
	}
	public ServiceFunctionForServiceConfigurationVoBean(ims.core.vo.ServiceFunctionForServiceConfigurationVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.ServiceFunctionForServiceConfigurationVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.service = vo.getService() == null ? null : new ims.vo.RefVoBean(vo.getService().getBoId(), vo.getService().getBoVersion());
	...
	public ims.core.vo.ServiceFunctionForServiceConfigurationVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.core.vo.ServiceFunctionForServiceConfigurationVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.core.vo.ServiceFunctionForServiceConfigurationVo vo = null;
		if(map != null)
			vo = (ims.core.vo.ServiceFunctionForServiceConfigurationVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.core.vo.ServiceFunctionForServiceConfigurationVo();
