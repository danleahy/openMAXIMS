...
public class PasEventPatientDetailsVoBean extends ims.vo.ValueObjectBean
{
	public PasEventPatientDetailsVoBean()
	{
	}
	public PasEventPatientDetailsVoBean(ims.core.vo.PasEventPatientDetailsVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.PasEventPatientDetailsVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
	...
	public ims.core.vo.PasEventPatientDetailsVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.core.vo.PasEventPatientDetailsVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.core.vo.PasEventPatientDetailsVo vo = null;
		if(map != null)
			vo = (ims.core.vo.PasEventPatientDetailsVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.core.vo.PasEventPatientDetailsVo();
