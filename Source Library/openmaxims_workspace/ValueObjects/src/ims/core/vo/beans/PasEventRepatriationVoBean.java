...
public class PasEventRepatriationVoBean extends ims.vo.ValueObjectBean
{
	public PasEventRepatriationVoBean()
	{
	}
	public PasEventRepatriationVoBean(ims.core.vo.PasEventRepatriationVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.PasEventRepatriationVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.eventdatetime = vo.getEventDateTime() == null ? null : (ims.framework.utils.beans.DateTimeBean)vo.getEventDateTime().getBean();
	...
	public ims.core.vo.PasEventRepatriationVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.core.vo.PasEventRepatriationVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.core.vo.PasEventRepatriationVo vo = null;
		if(map != null)
			vo = (ims.core.vo.PasEventRepatriationVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.core.vo.PasEventRepatriationVo();
