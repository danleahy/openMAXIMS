 ...
 */
public class PDSGeneralUpdateRequestVo extends ims.core.patient.vo.PDSGeneralUpdateRequestRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public PDSGeneralUpdateRequestVo()
	{
	}
	public PDSGeneralUpdateRequestVo(Integer id, int version)
	{
		super(id, version);
	}
	public PDSGeneralUpdateRequestVo(ims.core.vo.beans.PDSGeneralUpdateRequestVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.beans.PDSGeneralUpdateRequestVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.sdsroleprofileid = bean.getSDSRoleProfileId();
	...
	{
		ims.core.vo.beans.PDSGeneralUpdateRequestVoBean bean = null;
		if(map != null)
			bean = (ims.core.vo.beans.PDSGeneralUpdateRequestVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.core.vo.beans.PDSGeneralUpdateRequestVoBean();
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.sdsroleprofileid != null)
			if(this.sdsroleprofileid.length() > 50)
				listOfErrors.add("The length of the field [sdsroleprofileid] in the value object [ims.core.vo.PDSGeneralUpdateRequestVo] is too big. It should be less or equal to 50");
		if(this.sdsuserid != null)
			if(this.sdsuserid.length() > 50)
				listOfErrors.add("The length of the field [sdsuserid] in the value object [ims.core.vo.PDSGeneralUpdateRequestVo] is too big. It should be less or equal to 50");
		if(this.comment != null)
			if(this.comment.length() > 200)
				listOfErrors.add("The length of the field [comment] in the value object [ims.core.vo.PDSGeneralUpdateRequestVo] is too big. It should be less or equal to 200");
		...
		if(this.pdsackexception != null)
			if(this.pdsackexception.length() > 200)
				listOfErrors.add("The length of the field [pdsackexception] in the value object [ims.core.vo.PDSGeneralUpdateRequestVo] is too big. It should be less or equal to 200");
		if(this.sdsjobrolecode != null)
			if(this.sdsjobrolecode.length() > 20)
				listOfErrors.add("The length of the field [sdsjobrolecode] in the value object [ims.core.vo.PDSGeneralUpdateRequestVo] is too big. It should be less or equal to 20");
	...
	public Object clone()
	{
		...
		PDSGeneralUpdateRequestVo clone = new PDSGeneralUpdateRequestVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(PDSGeneralUpdateRequestVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A PDSGeneralUpdateRequestVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((PDSGeneralUpdateRequestVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((PDSGeneralUpdateRequestVo)obj).getBoId());
	}
