...
public class Hcp extends ims.core.vo.HcpFilter implements ims.vo.ImsCloneable, Comparable, ims.vo.interfaces.IHcp, ims.vo.interfaces.IMos
{
	...
	*/
	public HcpLiteVo toHcpLiteVo()
	{
		...
		hcp.setIsHCPaResponsibleHCP(this.ishcparesponsiblehcp);
		hcp.setIsAResponsibleEDClinician(this.isaresponsibleedclinician);
		hcp.setIsHCPaEndoscopist(this.ishcpaendoscopist);
