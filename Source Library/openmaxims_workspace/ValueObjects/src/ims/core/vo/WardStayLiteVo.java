 ...
 */
public class WardStayLiteVo extends ims.core.admin.pas.vo.WardStayRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public WardStayLiteVo()
	{
	}
	public WardStayLiteVo(Integer id, int version)
	{
		super(id, version);
	}
	public WardStayLiteVo(ims.core.vo.beans.WardStayLiteVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.beans.WardStayLiteVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.transferdatetime = bean.getTransferDateTime() == null ? null : bean.getTransferDateTime().buildDateTime();
	...
	{
		ims.core.vo.beans.WardStayLiteVoBean bean = null;
		if(map != null)
			bean = (ims.core.vo.beans.WardStayLiteVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.core.vo.beans.WardStayLiteVoBean();
	...
	public Object clone()
	{
		...
		WardStayLiteVo clone = new WardStayLiteVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(WardStayLiteVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A WardStayLiteVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((WardStayLiteVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((WardStayLiteVo)obj).getBoId());
	}
