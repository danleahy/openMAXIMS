 ...
 */
public class PDSPatientGPVo extends ims.core.vo.PatientGPRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public PDSPatientGPVo()
	{
	}
	public PDSPatientGPVo(Integer id, int version)
	{
		super(id, version);
	}
	public PDSPatientGPVo(ims.core.vo.beans.PDSPatientGPVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.beans.PDSPatientGPVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.lkp_provisiontype = bean.getLkp_provisiontype() == null ? null : ims.core.vo.lookups.PDSProvisionType.buildLookup(bean.getLkp_provisiontype());
	...
	{
		ims.core.vo.beans.PDSPatientGPVoBean bean = null;
		if(map != null)
			bean = (ims.core.vo.beans.PDSPatientGPVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.core.vo.beans.PDSPatientGPVoBean();
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.primarycareidentifier != null)
			if(this.primarycareidentifier.length() > 8)
				listOfErrors.add("The length of the field [primarycareidentifier] in the value object [ims.core.vo.PDSPatientGPVo] is too big. It should be less or equal to 8");
		if(this.objectidentifier != null)
			if(this.objectidentifier.length() > 14)
				listOfErrors.add("The length of the field [objectidentifier] in the value object [ims.core.vo.PDSPatientGPVo] is too big. It should be less or equal to 14");
	...
	public Object clone()
	{
		...
		PDSPatientGPVo clone = new PDSPatientGPVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(PDSPatientGPVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A PDSPatientGPVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((PDSPatientGPVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((PDSPatientGPVo)obj).getBoId());
	}
