...
public class MergedPatientVo extends ims.core.patient.vo.MergedPatientRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public MergedPatientVo(ims.core.vo.beans.MergedPatientVoBean bean)
	{
		...
		this.identifiers = ims.core.vo.NonUniquePatientIdVoCollection.buildFromBeanCollection(bean.getIdentifiers());
	...
	public ims.core.vo.NonUniquePatientIdVoCollection getIdentifiers()
	{
		return this.identifiers;
	}
	public void setIdentifiers(ims.core.vo.NonUniquePatientIdVoCollection value)
	{
		this.isValidated = false;
	...
	public Object clone()
	{
		...
		if(this.identifiers == null)
			...
			clone.identifiers = (ims.core.vo.NonUniquePatientIdVoCollection)this.identifiers.clone();
		clone.gp = this.gp;
	...
	protected ims.core.vo.NonUniquePatientIdVoCollection identifiers;
