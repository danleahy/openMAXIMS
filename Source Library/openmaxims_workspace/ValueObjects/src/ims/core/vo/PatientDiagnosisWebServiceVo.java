...
public class PatientDiagnosisWebServiceVo extends ims.core.vo.PatientDiagnosisWebServiceListVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public ims.core.vo.HcpLiteVo getResolvedHCP()
	{
		return this.resolvedhcp;
	}
	public void setResolvedHCP(ims.core.vo.HcpLiteVo value)
	{
		this.isValidated = false;
	...
	public Object clone()
	{
		...
		if(this.resolvedhcp == null)
			...
			clone.resolvedhcp = (ims.core.vo.HcpLiteVo)this.resolvedhcp.clone();
	...
	protected ims.core.vo.HcpLiteVo resolvedhcp;
