...
public class PatientShort extends ims.core.patient.vo.PatientRefVo implements ims.vo.ImsCloneable, Comparable, ims.framework.interfaces.ISelectedPatient
{
	...
	public Object getFieldValueByFieldName(String fieldName)
	{
		...
		if(fieldName.equals("MRNSTATUS"))
			return getMRNStatus();
		if(fieldName.equals("HASSCANNEDCASENOTEFOLDERS"))
			return getHasScannedCaseNoteFolders();
		...
		if(fieldName.equals("PDSPATIENTGP"))
			return getPDSPatientGP();
		...
		if(fieldName.equals("FUTUREAPPTSCANCELONMARKDECEASEDANSWER"))
			return getFutureApptsCancelOnMarkDeceasedAnswer();
	...
	public boolean getHasScannedCaseNoteFoldersIsNotNull()
	{
		return this.hasscannedcasenotefolders != null;
	}
	...
	public ims.framework.utils.Time getTimeOfBirth()
	{
		return this.timeofbirth;
	}
	public void setTimeOfBirth(ims.framework.utils.Time value)
	{
		this.isValidated = false;
	...
	public boolean getPDSPatientGPIsNotNull()
	{
		return this.pdspatientgp != null;
	}
	public ims.core.vo.PDSPatientGPVo getPDSPatientGP()
	{
		return this.pdspatientgp;
	}
	public void setPDSPatientGP(ims.core.vo.PDSPatientGPVo value)
	{
		this.isValidated = false;
	...
	public boolean getFutureApptsCancelOnMarkDeceasedAnswerIsNotNull()
	{
		return this.futureapptscancelonmarkdeceasedanswer != null;
	}
	...
	*/
	public String getPatientInfo()
	{
		...
		else if (ims.core.vo.lookups.PatIdType.getNegativeInstance(ims.configuration.ConfigFlag.UI.DISPLAY_PATID_TYPE.getValue()).equals(ims.core.vo.lookups.PatIdType.MRNNUM)
				&& getPatId(ims.core.vo.lookups.PatIdType.MRNNUM) == null)
		{
			sb.append(ims.core.vo.lookups.PatIdType.MRNNUM.getText()).append(": ").append(mrnstatus != null ? mrnstatus.getIItemText() : "");
		}
	...
	*/
	...
	/**
	* public ims.core.vo.PatientId getMrnnum
	*/
	public ims.core.vo.PatientId getMrnnum()
	{
		return getPatId(ims.core.vo.lookups.PatIdType.MRNNUM);
	}
	
	/**
	* toPatientLite()
	*/
	public PatientLiteVo toPatientLite()
	{
		PatientLiteVo patientLite = new PatientLiteVo(id, version);
		patientLite.name = this.name;
		patientLite.sex = this.sex;
		patientLite.dob = this.dob;
		patientLite.isactive = this.isactive;
		patientLite.isquickregistrationpatient = this.isquickregistrationpatient;
	...
	*/
	public PatientLite_IdentifiersVo toPatientLite_IdentifiersVo()
	{
		...
		// The patient alerts cannot be filled in from PatientShort
		patient.patientalerts = null;
		
		return patient;
	}
	
	/**
	* getAgeInYearsOn: Gets patients age on a particular date
	*/
	public Integer getAgeInYearsOn(ims.framework.utils.Date date)
	{
		if (dob != null&&date!=null)
		{		
			int patAge = 0;
			ims.framework.utils.Date endDate = null;
			if(dod!=null)
			{
				endDate=dod.isGreaterThan(date)?date:dod;
			}
			else
			{
				endDate=date;
			}
			patAge = new ims.framework.utils.Age(this.dob, endDate).getYears();
			return new Integer(patAge); 
		}
		return null; // No Age
	}
	/**
	* isPaediatricOn: checks if the patient is Paediatric on a particular date
	*/
	public Boolean isPaediatricOn(ims.framework.utils.Date date)
	{
	...
	public int countFieldsWithValue()
	{
		...
		if(this.mrnstatus != null)
			count++;
		if(this.hasscannedcasenotefolders != null)
			count++;
		...
		if(this.hasalertcategoryother != null)
			count++;
		if(this.futureapptscancelonmarkdeceasedanswer != null)
			count++;
		return count;
	}
	...
	protected Boolean hasscannedcasenotefolders;
	protected Boolean isconfidential;
	protected ims.framework.utils.Time timeofbirth;
	protected Boolean isselfadmitpatient;
	protected ims.core.vo.lookups.PatientStatus patientcategory;
	protected ims.core.vo.PDSPatientGPVo pdspatientgp;
	...
	protected Boolean futureapptscancelonmarkdeceasedanswer;
