...
public class PatientProcedureMinVo extends ims.core.clinical.vo.PatientProcedureRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	/**
	* getTheatresProcedureDisplayText
	*/
	public String getTheatresProcedureDisplayText()
	{
		String displayText = "";
		if(this.getProcedureIsNotNull())
		{
			displayText = this.getProcedure().getProcedureName();
		}
		if(this.getProcLateralityIsNotNull())
		{
			displayText += " - " + this.getProcLaterality().getText();
		}
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.notes != null)
			if(this.notes.length() > 500)
				listOfErrors.add("The length of the field [notes] in the value object [ims.core.vo.PatientProcedureMinVo] is too big. It should be less or equal to 500");
