...
public class PatientMedicalInsuranceVo extends ims.core.clinical.vo.PatientMedicalInsuranceRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.planorunits != null)
			if(this.planorunits.length() > 100)
				listOfErrors.add("The length of the field [planorunits] in the value object [ims.core.vo.PatientMedicalInsuranceVo] is too big. It should be less or equal to 100");
