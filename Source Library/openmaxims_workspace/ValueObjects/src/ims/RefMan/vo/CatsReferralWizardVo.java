...
public class CatsReferralWizardVo extends ims.RefMan.vo.CatsReferralRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public CatsReferralWizardVo(ims.RefMan.vo.beans.CatsReferralWizardVoBean bean)
	{
		...
		this.consultantupgradedate = bean.getConsultantUpgradeDate() == null ? null : bean.getConsultantUpgradeDate().buildDate();
		...
		this.haspatientjourneylinked = bean.getHasPatientJourneyLinked();
	...
	public Object getFieldValueByFieldName(String fieldName)
	{
		...
		if(fieldName.equals("CONSULTANTUPGRADEDATE"))
			return getConsultantUpgradeDate();
		...
		if(fieldName.equals("HASPATIENTJOURNEYLINKED"))
			return getHasPatientJourneyLinked();
	...
	public boolean getConsultantUpgradeDateIsNotNull()
	{
		return this.consultantupgradedate != null;
	}
	public ims.framework.utils.Date getConsultantUpgradeDate()
	{
		return this.consultantupgradedate;
	}
	public void setConsultantUpgradeDate(ims.framework.utils.Date value)
	{
		this.isValidated = false;
		this.consultantupgradedate = value;
	}
	...
	public boolean getHasPatientJourneyLinkedIsNotNull()
	{
		return this.haspatientjourneylinked != null;
	}
	public Boolean getHasPatientJourneyLinked()
	{
		return this.haspatientjourneylinked;
	}
	public void setHasPatientJourneyLinked(Boolean value)
	{
		this.isValidated = false;
		this.haspatientjourneylinked = value;
	}
	...
	public Object clone()
	{
		...
		if(this.consultantupgradedate == null)
			clone.consultantupgradedate = null;
		else
			clone.consultantupgradedate = (ims.framework.utils.Date)this.consultantupgradedate.clone();
		...
		clone.haspatientjourneylinked = this.haspatientjourneylinked;
	...
	public int countFieldsWithValue()
	{
		...
		if(this.isemergencyreferral != null)
			count++;
		if(this.haspatientjourneylinked != null)
			count++;
	...
	protected ims.framework.utils.Date consultantupgradedate;
	...
	protected Boolean haspatientjourneylinked;
