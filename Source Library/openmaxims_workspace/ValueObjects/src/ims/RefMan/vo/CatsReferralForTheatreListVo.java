 ...
 */
public class CatsReferralForTheatreListVo extends ims.RefMan.vo.CatsReferralRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public CatsReferralForTheatreListVo(ims.RefMan.vo.beans.CatsReferralForTheatreListVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.RefMan.vo.beans.CatsReferralForTheatreListVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.RefMan.vo.beans.CatsReferralForTheatreListVoBean bean = null;
		if(map != null)
			bean = (ims.RefMan.vo.beans.CatsReferralForTheatreListVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.RefMan.vo.beans.CatsReferralForTheatreListVoBean();
