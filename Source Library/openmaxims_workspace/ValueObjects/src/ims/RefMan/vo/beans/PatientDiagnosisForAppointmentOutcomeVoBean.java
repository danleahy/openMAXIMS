...
public class PatientDiagnosisForAppointmentOutcomeVoBean extends ims.vo.ValueObjectBean
{
	public PatientDiagnosisForAppointmentOutcomeVoBean()
	{
	}
	public PatientDiagnosisForAppointmentOutcomeVoBean(ims.RefMan.vo.PatientDiagnosisForAppointmentOutcomeVo vo)
	{
		this.id = vo.getBoId();
		...
		this.currentstatus = vo.getCurrentStatus() == null ? null : (ims.RefMan.vo.beans.PatientDiagnosisStatusForAppointmentOutcomeVoBean)vo.getCurrentStatus().getBean();
		this.diagnosedonadmission = vo.getDiagnosedOnAdmission();
	}

	public void populate(ims.vo.ValueObjectBeanMap map, ims.RefMan.vo.PatientDiagnosisForAppointmentOutcomeVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		...
		this.diagnoseddate = vo.getDiagnosedDate() == null ? null : (ims.framework.utils.beans.PartialDateBean)vo.getDiagnosedDate().getBean();
		this.carecontext = vo.getCareContext() == null ? null : new ims.vo.RefVoBean(vo.getCareContext().getBoId(), vo.getCareContext().getBoVersion());
		this.currentstatus = vo.getCurrentStatus() == null ? null : (ims.RefMan.vo.beans.PatientDiagnosisStatusForAppointmentOutcomeVoBean)vo.getCurrentStatus().getBean(map);
		this.diagnosedonadmission = vo.getDiagnosedOnAdmission();
	}

	public ims.RefMan.vo.PatientDiagnosisForAppointmentOutcomeVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.RefMan.vo.PatientDiagnosisForAppointmentOutcomeVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.RefMan.vo.PatientDiagnosisForAppointmentOutcomeVo vo = null;
		if(map != null)
			vo = (ims.RefMan.vo.PatientDiagnosisForAppointmentOutcomeVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.RefMan.vo.PatientDiagnosisForAppointmentOutcomeVo();
	...
	public ims.RefMan.vo.beans.PatientDiagnosisStatusForAppointmentOutcomeVoBean getCurrentStatus()
	{
		return this.currentstatus;
	}
	public void setCurrentStatus(ims.RefMan.vo.beans.PatientDiagnosisStatusForAppointmentOutcomeVoBean value)
	{
	...
	private ims.RefMan.vo.beans.PatientDiagnosisStatusForAppointmentOutcomeVoBean currentstatus;
