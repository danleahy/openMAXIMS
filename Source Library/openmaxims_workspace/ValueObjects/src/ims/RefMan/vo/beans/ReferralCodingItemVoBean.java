...
public class ReferralCodingItemVoBean extends ims.vo.ValueObjectBean
{
	...
	public ReferralCodingItemVoBean(ims.RefMan.vo.ReferralCodingItemVo vo)
	{
		...
		this.investigation = vo.getInvestigation() == null ? null : (ims.ocrr.vo.beans.OrderInvestigationLiteVoBean)vo.getInvestigation().getBean();
		this.hrg = vo.getHRG();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.RefMan.vo.ReferralCodingItemVo vo)
	{
		...
		this.icd10 = vo.getICD10();
		this.proclaterality = vo.getProcLaterality() == null ? null : (ims.vo.LookupInstanceBean)vo.getProcLaterality().getBean();
		this.investigation = vo.getInvestigation() == null ? null : (ims.ocrr.vo.beans.OrderInvestigationLiteVoBean)vo.getInvestigation().getBean(map);
		this.hrg = vo.getHRG();
		this.daggerasterisk = vo.getDaggerAsterisk();
		this.codingtypeindicator = vo.getCodingTypeIndicator();
		this.firstinset = vo.getFirstInSet();
	...
	public ims.ocrr.vo.beans.OrderInvestigationLiteVoBean getInvestigation()
	{
		return this.investigation;
	}
	public void setInvestigation(ims.ocrr.vo.beans.OrderInvestigationLiteVoBean value)
	{
	...
	private ims.ocrr.vo.beans.OrderInvestigationLiteVoBean investigation;
	private String hrg;
