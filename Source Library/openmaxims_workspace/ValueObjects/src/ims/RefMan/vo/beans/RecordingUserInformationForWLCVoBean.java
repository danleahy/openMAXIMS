...
public class RecordingUserInformationForWLCVoBean extends ims.vo.ValueObjectBean
{
	public RecordingUserInformationForWLCVoBean()
	{
	}
	public RecordingUserInformationForWLCVoBean(ims.RefMan.vo.RecordingUserInformationForWLCVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.RefMan.vo.RecordingUserInformationForWLCVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
	...
	public ims.RefMan.vo.RecordingUserInformationForWLCVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.RefMan.vo.RecordingUserInformationForWLCVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.RefMan.vo.RecordingUserInformationForWLCVo vo = null;
		if(map != null)
			vo = (ims.RefMan.vo.RecordingUserInformationForWLCVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.RefMan.vo.RecordingUserInformationForWLCVo();
