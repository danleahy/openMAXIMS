...
public class TCIDetailsLiteVoBean extends ims.vo.ValueObjectBean
{
	public TCIDetailsLiteVoBean()
	{
	}
	public TCIDetailsLiteVoBean(ims.RefMan.vo.TCIDetailsLiteVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.RefMan.vo.TCIDetailsLiteVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.tcidate = vo.getTCIDate() == null ? null : (ims.framework.utils.beans.DateBean)vo.getTCIDate().getBean();
	...
	public ims.RefMan.vo.TCIDetailsLiteVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.RefMan.vo.TCIDetailsLiteVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.RefMan.vo.TCIDetailsLiteVo vo = null;
		if(map != null)
			vo = (ims.RefMan.vo.TCIDetailsLiteVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.RefMan.vo.TCIDetailsLiteVo();
