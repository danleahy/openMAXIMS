...
public class Booking_AppointmentOutcomeForElectiveListVoBean extends ims.vo.ValueObjectBean
{
	public Booking_AppointmentOutcomeForElectiveListVoBean()
	{
	}
	public Booking_AppointmentOutcomeForElectiveListVoBean(ims.RefMan.vo.Booking_AppointmentOutcomeForElectiveListVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.RefMan.vo.Booking_AppointmentOutcomeForElectiveListVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.appointmentdate = vo.getAppointmentDate() == null ? null : (ims.framework.utils.beans.DateBean)vo.getAppointmentDate().getBean();
	...
	public ims.RefMan.vo.Booking_AppointmentOutcomeForElectiveListVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.RefMan.vo.Booking_AppointmentOutcomeForElectiveListVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.RefMan.vo.Booking_AppointmentOutcomeForElectiveListVo vo = null;
		if(map != null)
			vo = (ims.RefMan.vo.Booking_AppointmentOutcomeForElectiveListVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.RefMan.vo.Booking_AppointmentOutcomeForElectiveListVo();
