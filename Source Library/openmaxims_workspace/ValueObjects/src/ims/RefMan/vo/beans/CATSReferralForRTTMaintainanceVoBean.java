...
public class CATSReferralForRTTMaintainanceVoBean extends ims.vo.ValueObjectBean
{
	public CATSReferralForRTTMaintainanceVoBean()
	{
	}
	public CATSReferralForRTTMaintainanceVoBean(ims.RefMan.vo.CATSReferralForRTTMaintainanceVo vo)
	{
		this.id = vo.getBoId();
		...
		this.journey = vo.getJourney() == null ? null : (ims.pathways.vo.beans.Journey_ClockImpactVoBean)vo.getJourney().getBean();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.RefMan.vo.CATSReferralForRTTMaintainanceVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.patient = vo.getPatient() == null ? null : new ims.vo.RefVoBean(vo.getPatient().getBoId(), vo.getPatient().getBoVersion());
		...
		this.journey = vo.getJourney() == null ? null : (ims.pathways.vo.beans.Journey_ClockImpactVoBean)vo.getJourney().getBean(map);
	...
	public ims.RefMan.vo.CATSReferralForRTTMaintainanceVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.RefMan.vo.CATSReferralForRTTMaintainanceVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.RefMan.vo.CATSReferralForRTTMaintainanceVo vo = null;
		if(map != null)
			vo = (ims.RefMan.vo.CATSReferralForRTTMaintainanceVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.RefMan.vo.CATSReferralForRTTMaintainanceVo();
	...
	public ims.pathways.vo.beans.Journey_ClockImpactVoBean getJourney()
	{
		return this.journey;
	}
	public void setJourney(ims.pathways.vo.beans.Journey_ClockImpactVoBean value)
	{
		this.journey = value;
	}
	...
	private ims.pathways.vo.beans.Journey_ClockImpactVoBean journey;
