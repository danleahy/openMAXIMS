...
public class RecordingUserInformationForPreassessOutCVoBean extends ims.vo.ValueObjectBean
{
	public RecordingUserInformationForPreassessOutCVoBean()
	{
	}
	public RecordingUserInformationForPreassessOutCVoBean(ims.RefMan.vo.RecordingUserInformationForPreassessOutCVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.RefMan.vo.RecordingUserInformationForPreassessOutCVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
	...
	public ims.RefMan.vo.RecordingUserInformationForPreassessOutCVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.RefMan.vo.RecordingUserInformationForPreassessOutCVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.RefMan.vo.RecordingUserInformationForPreassessOutCVo vo = null;
		if(map != null)
			vo = (ims.RefMan.vo.RecordingUserInformationForPreassessOutCVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.RefMan.vo.RecordingUserInformationForPreassessOutCVo();
