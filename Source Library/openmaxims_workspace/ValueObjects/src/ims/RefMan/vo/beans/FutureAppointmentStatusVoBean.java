...
public class FutureAppointmentStatusVoBean extends ims.vo.ValueObjectBean
{
	public FutureAppointmentStatusVoBean()
	{
	}
	public FutureAppointmentStatusVoBean(ims.RefMan.vo.FutureAppointmentStatusVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.pendingstatus = vo.getPendingStatus() == null ? null : (ims.vo.LookupInstanceBean)vo.getPendingStatus().getBean();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.RefMan.vo.FutureAppointmentStatusVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.pendingstatus = vo.getPendingStatus() == null ? null : (ims.vo.LookupInstanceBean)vo.getPendingStatus().getBean();
	...
	public ims.RefMan.vo.FutureAppointmentStatusVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.RefMan.vo.FutureAppointmentStatusVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.RefMan.vo.FutureAppointmentStatusVo vo = null;
		if(map != null)
			vo = (ims.RefMan.vo.FutureAppointmentStatusVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.RefMan.vo.FutureAppointmentStatusVo();
	...
	public ims.vo.LookupInstanceBean getPendingStatus()
	{
		return this.pendingstatus;
	}
	public void setPendingStatus(ims.vo.LookupInstanceBean value)
	{
	...
	private Integer id;
	private int version;
	private ims.vo.LookupInstanceBean pendingstatus;
