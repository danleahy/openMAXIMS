...
public class BookingAppointmentForTCIVoBean extends ims.vo.ValueObjectBean
{
	public BookingAppointmentForTCIVoBean()
	{
	}
	public BookingAppointmentForTCIVoBean(ims.RefMan.vo.BookingAppointmentForTCIVo vo)
	{
		this.id = vo.getBoId();
		...
		this.session = vo.getSession() == null ? null : (ims.RefMan.vo.beans.SessionForTCIVoBean)vo.getSession().getBean();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.RefMan.vo.BookingAppointmentForTCIVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.theatrebooking = vo.getTheatreBooking() == null ? null : new ims.vo.RefVoBean(vo.getTheatreBooking().getBoId(), vo.getTheatreBooking().getBoVersion());
		this.appointmentdate = vo.getAppointmentDate() == null ? null : (ims.framework.utils.beans.DateBean)vo.getAppointmentDate().getBean();
		this.apptstarttime = vo.getApptStartTime() == null ? null : (ims.framework.utils.beans.TimeBean)vo.getApptStartTime().getBean();
		this.session = vo.getSession() == null ? null : (ims.RefMan.vo.beans.SessionForTCIVoBean)vo.getSession().getBean(map);
	...
	public ims.RefMan.vo.BookingAppointmentForTCIVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.RefMan.vo.BookingAppointmentForTCIVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.RefMan.vo.BookingAppointmentForTCIVo vo = null;
		if(map != null)
			vo = (ims.RefMan.vo.BookingAppointmentForTCIVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.RefMan.vo.BookingAppointmentForTCIVo();
	...
	public ims.RefMan.vo.beans.SessionForTCIVoBean getSession()
	{
		return this.session;
	}
	public void setSession(ims.RefMan.vo.beans.SessionForTCIVoBean value)
	{
		this.session = value;
	}
	...
	private ims.RefMan.vo.beans.SessionForTCIVoBean session;
