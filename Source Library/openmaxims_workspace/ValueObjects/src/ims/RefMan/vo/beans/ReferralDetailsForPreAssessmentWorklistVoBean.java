...
public class ReferralDetailsForPreAssessmentWorklistVoBean extends ims.vo.ValueObjectBean
{
	public ReferralDetailsForPreAssessmentWorklistVoBean()
	{
	}
	public ReferralDetailsForPreAssessmentWorklistVoBean(ims.RefMan.vo.ReferralDetailsForPreAssessmentWorklistVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.RefMan.vo.ReferralDetailsForPreAssessmentWorklistVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
	...
	public ims.RefMan.vo.ReferralDetailsForPreAssessmentWorklistVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.RefMan.vo.ReferralDetailsForPreAssessmentWorklistVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.RefMan.vo.ReferralDetailsForPreAssessmentWorklistVo vo = null;
		if(map != null)
			vo = (ims.RefMan.vo.ReferralDetailsForPreAssessmentWorklistVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.RefMan.vo.ReferralDetailsForPreAssessmentWorklistVo();
