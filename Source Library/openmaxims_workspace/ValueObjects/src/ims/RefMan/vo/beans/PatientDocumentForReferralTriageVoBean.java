...
public class PatientDocumentForReferralTriageVoBean extends ims.vo.ValueObjectBean
{
	public PatientDocumentForReferralTriageVoBean()
	{
	}
	public PatientDocumentForReferralTriageVoBean(ims.RefMan.vo.PatientDocumentForReferralTriageVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.RefMan.vo.PatientDocumentForReferralTriageVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
	...
	public ims.RefMan.vo.PatientDocumentForReferralTriageVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.RefMan.vo.PatientDocumentForReferralTriageVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.RefMan.vo.PatientDocumentForReferralTriageVo vo = null;
		if(map != null)
			vo = (ims.RefMan.vo.PatientDocumentForReferralTriageVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.RefMan.vo.PatientDocumentForReferralTriageVo();
