...
public class ReferralDetailsForJouneyVoBean extends ims.vo.ValueObjectBean
{
	public ReferralDetailsForJouneyVoBean()
	{
	}
	public ReferralDetailsForJouneyVoBean(ims.RefMan.vo.ReferralDetailsForJouneyVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.RefMan.vo.ReferralDetailsForJouneyVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.dateofreferral = vo.getDateOfReferral() == null ? null : (ims.framework.utils.beans.DateBean)vo.getDateOfReferral().getBean();
	...
	public ims.RefMan.vo.ReferralDetailsForJouneyVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.RefMan.vo.ReferralDetailsForJouneyVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.RefMan.vo.ReferralDetailsForJouneyVo vo = null;
		if(map != null)
			vo = (ims.RefMan.vo.ReferralDetailsForJouneyVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.RefMan.vo.ReferralDetailsForJouneyVo();
