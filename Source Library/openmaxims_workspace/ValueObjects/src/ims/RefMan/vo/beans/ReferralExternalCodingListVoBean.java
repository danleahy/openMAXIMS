...
public class ReferralExternalCodingListVoBean extends ims.vo.ValueObjectBean
{
	public ReferralExternalCodingListVoBean()
	{
	}
	public ReferralExternalCodingListVoBean(ims.RefMan.vo.ReferralExternalCodingListVo vo)
	{
		this.id = vo.getBoId();
		...
		this.fce = vo.getFCE() == null ? null : new ims.vo.RefVoBean(vo.getFCE().getBoId(), vo.getFCE().getBoVersion());
	}

	public void populate(ims.vo.ValueObjectBeanMap map, ims.RefMan.vo.ReferralExternalCodingListVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
	...
	public ims.RefMan.vo.ReferralExternalCodingListVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.RefMan.vo.ReferralExternalCodingListVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.RefMan.vo.ReferralExternalCodingListVo vo = null;
		if(map != null)
			vo = (ims.RefMan.vo.ReferralExternalCodingListVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.RefMan.vo.ReferralExternalCodingListVo();
	...
	public ims.vo.RefVoBean getFCE()
	{
		return this.fce;
	}
	public void setFCE(ims.vo.RefVoBean value)
	{
		this.fce = value;
	}
