...
public class CATSReferralDetailsForRTTMaintainanceVoBean extends ims.vo.ValueObjectBean
{
	public CATSReferralDetailsForRTTMaintainanceVoBean()
	{
	}
	public CATSReferralDetailsForRTTMaintainanceVoBean(ims.RefMan.vo.CATSReferralDetailsForRTTMaintainanceVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.RefMan.vo.CATSReferralDetailsForRTTMaintainanceVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.dateofreferral = vo.getDateOfReferral() == null ? null : (ims.framework.utils.beans.DateBean)vo.getDateOfReferral().getBean();
	...
	public ims.RefMan.vo.CATSReferralDetailsForRTTMaintainanceVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.RefMan.vo.CATSReferralDetailsForRTTMaintainanceVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.RefMan.vo.CATSReferralDetailsForRTTMaintainanceVo vo = null;
		if(map != null)
			vo = (ims.RefMan.vo.CATSReferralDetailsForRTTMaintainanceVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.RefMan.vo.CATSReferralDetailsForRTTMaintainanceVo();
