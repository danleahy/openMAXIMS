...
public class AwaitingHistologyVoBean extends ims.vo.ValueObjectBean
{
	public AwaitingHistologyVoBean()
	{
	}
	public AwaitingHistologyVoBean(ims.RefMan.vo.AwaitingHistologyVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.RefMan.vo.AwaitingHistologyVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.authoringdatetime = vo.getAuthoringDateTime() == null ? null : (ims.framework.utils.beans.DateTimeBean)vo.getAuthoringDateTime().getBean();
	...
	public ims.RefMan.vo.AwaitingHistologyVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.RefMan.vo.AwaitingHistologyVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.RefMan.vo.AwaitingHistologyVo vo = null;
		if(map != null)
			vo = (ims.RefMan.vo.AwaitingHistologyVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.RefMan.vo.AwaitingHistologyVo();
