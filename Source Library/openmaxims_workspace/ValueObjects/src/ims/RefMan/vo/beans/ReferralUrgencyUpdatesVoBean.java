...
public class ReferralUrgencyUpdatesVoBean extends ims.vo.ValueObjectBean
{
	public ReferralUrgencyUpdatesVoBean()
	{
	}
	public ReferralUrgencyUpdatesVoBean(ims.RefMan.vo.ReferralUrgencyUpdatesVo vo)
	{
		this.id = vo.getBoId();
		...
		this.reasonforchangeurgency = vo.getReasonForChangeUrgency() == null ? null : (ims.vo.LookupInstanceBean)vo.getReasonForChangeUrgency().getBean();
	}

	public void populate(ims.vo.ValueObjectBeanMap map, ims.RefMan.vo.ReferralUrgencyUpdatesVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.urgency = vo.getUrgency() == null ? null : (ims.vo.LookupInstanceBean)vo.getUrgency().getBean();
	...
	public ims.RefMan.vo.ReferralUrgencyUpdatesVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.RefMan.vo.ReferralUrgencyUpdatesVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.RefMan.vo.ReferralUrgencyUpdatesVo vo = null;
		if(map != null)
			vo = (ims.RefMan.vo.ReferralUrgencyUpdatesVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.RefMan.vo.ReferralUrgencyUpdatesVo();
	...
	public ims.vo.LookupInstanceBean getReasonForChangeUrgency()
	{
		return this.reasonforchangeurgency;
	}
	public void setReasonForChangeUrgency(ims.vo.LookupInstanceBean value)
	{
	...
	private ims.vo.LookupInstanceBean reasonforchangeurgency;
}
