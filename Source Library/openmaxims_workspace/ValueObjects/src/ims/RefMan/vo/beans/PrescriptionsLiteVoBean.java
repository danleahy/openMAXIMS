...
public class PrescriptionsLiteVoBean extends ims.vo.ValueObjectBean
{
	...
	public PrescriptionsLiteVoBean(ims.RefMan.vo.PrescriptionsLiteVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.RefMan.vo.PrescriptionsLiteVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.catsreferral = vo.getCatsReferral() == null ? null : new ims.vo.RefVoBean(vo.getCatsReferral().getBoId(), vo.getCatsReferral().getBoVersion());
	...
	public ims.RefMan.vo.PrescriptionsLiteVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.RefMan.vo.PrescriptionsLiteVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.RefMan.vo.PrescriptionsLiteVo vo = null;
		if(map != null)
			vo = (ims.RefMan.vo.PrescriptionsLiteVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.RefMan.vo.PrescriptionsLiteVo();
