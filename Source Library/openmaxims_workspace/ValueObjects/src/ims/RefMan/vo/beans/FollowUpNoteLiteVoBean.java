...
public class FollowUpNoteLiteVoBean extends ims.vo.ValueObjectBean
{
	...
	public FollowUpNoteLiteVoBean(ims.RefMan.vo.FollowUpNoteLiteVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.RefMan.vo.FollowUpNoteLiteVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.catsreferral = vo.getCatsReferral() == null ? null : new ims.vo.RefVoBean(vo.getCatsReferral().getBoId(), vo.getCatsReferral().getBoVersion());
	...
	public ims.RefMan.vo.FollowUpNoteLiteVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.RefMan.vo.FollowUpNoteLiteVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.RefMan.vo.FollowUpNoteLiteVo vo = null;
		if(map != null)
			vo = (ims.RefMan.vo.FollowUpNoteLiteVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.RefMan.vo.FollowUpNoteLiteVo();
