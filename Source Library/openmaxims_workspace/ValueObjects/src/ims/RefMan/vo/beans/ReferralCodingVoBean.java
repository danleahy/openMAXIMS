...
public class ReferralCodingVoBean extends ims.vo.ValueObjectBean
{
	...
	public ReferralCodingVoBean(ims.RefMan.vo.ReferralCodingVo vo)
	{
		...
		this.fce = vo.getFCE() == null ? null : (ims.core.vo.beans.ConsultantStayVoBean)vo.getFCE().getBean();
	}
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.RefMan.vo.ReferralCodingVo vo)
	{
		...
		this.active = vo.getActive();
		this.stagingcodeexport = vo.getStagingCodeExport() == null ? null : vo.getStagingCodeExport().getBeanCollection();
		this.fce = vo.getFCE() == null ? null : (ims.core.vo.beans.ConsultantStayVoBean)vo.getFCE().getBean(map);
	}
	...
	public ims.core.vo.beans.ConsultantStayVoBean getFCE()
	{
		return this.fce;
	}
	public void setFCE(ims.core.vo.beans.ConsultantStayVoBean value)
	{
		this.fce = value;
	}
	...
	private ims.core.vo.beans.ConsultantStayVoBean fce;
}
