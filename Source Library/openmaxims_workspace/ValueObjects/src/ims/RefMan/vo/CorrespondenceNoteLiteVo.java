 ...
 */
public class CorrespondenceNoteLiteVo extends ims.RefMan.vo.ReportNoteRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public CorrespondenceNoteLiteVo(ims.RefMan.vo.beans.CorrespondenceNoteLiteVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.RefMan.vo.beans.CorrespondenceNoteLiteVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.catsreferral = bean.getCatsReferral() == null ? null : new ims.RefMan.vo.CatsReferralRefVo(new Integer(bean.getCatsReferral().getId()), bean.getCatsReferral().getVersion());
	...
	{
		ims.RefMan.vo.beans.CorrespondenceNoteLiteVoBean bean = null;
		if(map != null)
			bean = (ims.RefMan.vo.beans.CorrespondenceNoteLiteVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.RefMan.vo.beans.CorrespondenceNoteLiteVoBean();
