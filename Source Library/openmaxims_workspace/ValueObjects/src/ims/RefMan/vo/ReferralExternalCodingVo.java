 ...
 */
public class ReferralExternalCodingVo extends ims.RefMan.vo.ReferralCodingRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public ReferralExternalCodingVo()
	{
	}
	public ReferralExternalCodingVo(Integer id, int version)
	{
		super(id, version);
	}
	public ReferralExternalCodingVo(ims.RefMan.vo.beans.ReferralExternalCodingVoBean bean)
	{
		this.id = bean.getId();
		...
		this.codingitems = ims.RefMan.vo.ReferralExternalCodingItemVoCollection.buildFromBeanCollection(bean.getCodingItems());
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.RefMan.vo.beans.ReferralExternalCodingVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.catsreferral = bean.getCatsReferral() == null ? null : new ims.RefMan.vo.CatsReferralRefVo(new Integer(bean.getCatsReferral().getId()), bean.getCatsReferral().getVersion());
	...
	{
		ims.RefMan.vo.beans.ReferralExternalCodingVoBean bean = null;
		if(map != null)
			bean = (ims.RefMan.vo.beans.ReferralExternalCodingVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.RefMan.vo.beans.ReferralExternalCodingVoBean();
	...
	public ims.RefMan.vo.ReferralExternalCodingItemVoCollection getCodingItems()
	{
		return this.codingitems;
	}
	public void setCodingItems(ims.RefMan.vo.ReferralExternalCodingItemVoCollection value)
	{
		this.isValidated = false;
	...
	public boolean isValidated()
	{
		...
		{
			if(!this.stagingcodeexport.isValidated())
			{
				this.isBusy = false;
				return false;
			}
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.comments != null)
			if(this.comments.length() > 1000)
				listOfErrors.add("The length of the field [comments] in the value object [ims.RefMan.vo.ReferralExternalCodingVo] is too big. It should be less or equal to 1000");
		if(this.stagingcodeexport != null)
		{
			String[] listOfOtherErrors = this.stagingcodeexport.validate();
			if(listOfOtherErrors != null)
			{
				for(int x = 0; x < listOfOtherErrors.length; x++)
				{
	...
	public Object clone()
	{
		...
		ReferralExternalCodingVo clone = new ReferralExternalCodingVo(this.id, this.version);
		...
		if(this.codingitems == null)
			...
			clone.codingitems = (ims.RefMan.vo.ReferralExternalCodingItemVoCollection)this.codingitems.clone();
		if(this.authoringmos == null)
		...
		if(this.fce == null)
			...
			clone.fce = (ims.RefMan.vo.ConsultantStayForPatientCodingListVo)this.fce.clone();
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(ReferralExternalCodingVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A ReferralExternalCodingVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((ReferralExternalCodingVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((ReferralExternalCodingVo)obj).getBoId());
	}
	...
	protected ims.RefMan.vo.ReferralExternalCodingItemVoCollection codingitems;
	...
	protected ims.RefMan.vo.ConsultantStayForPatientCodingListVo fce;
