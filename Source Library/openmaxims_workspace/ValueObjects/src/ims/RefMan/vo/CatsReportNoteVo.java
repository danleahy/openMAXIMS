 ...
 */
public class CatsReportNoteVo extends ims.RefMan.vo.CatsReportNoteRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public CatsReportNoteVo(ims.RefMan.vo.beans.CatsReportNoteVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.RefMan.vo.beans.CatsReportNoteVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.catsreferral = bean.getCatsReferral() == null ? null : new ims.RefMan.vo.CatsReferralRefVo(new Integer(bean.getCatsReferral().getId()), bean.getCatsReferral().getVersion());
	...
	{
		ims.RefMan.vo.beans.CatsReportNoteVoBean bean = null;
		if(map != null)
			bean = (ims.RefMan.vo.beans.CatsReportNoteVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.RefMan.vo.beans.CatsReportNoteVoBean();
