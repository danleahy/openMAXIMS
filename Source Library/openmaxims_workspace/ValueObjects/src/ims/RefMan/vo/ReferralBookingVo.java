...
public class ReferralBookingVo extends ims.vo.ValueObject implements ims.vo.ImsCloneable, Comparable
{
	...
	public ReferralBookingVo(ims.RefMan.vo.beans.ReferralBookingVoBean bean)
	{
		...
		this.currenttcis = ims.RefMan.vo.TCIForReferralBookingVoCollection.buildFromBeanCollection(bean.getCurrentTCIs());
	...
	public boolean getCurrentTCIsIsNotNull()
	{
		return this.currenttcis != null;
	}
	public ims.RefMan.vo.TCIForReferralBookingVoCollection getCurrentTCIs()
	{
		return this.currenttcis;
	}
	public void setCurrentTCIs(ims.RefMan.vo.TCIForReferralBookingVoCollection value)
	{
		this.isValidated = false;
	...
	public ims.RefMan.vo.TriageOutcomeForBookAppointmentVo getTriageOutcome()
	{
		return this.triageoutcome;
	}
	public void setTriageOutcome(ims.RefMan.vo.TriageOutcomeForBookAppointmentVo value)
	{
		this.isValidated = false;
	...
	public Object clone()
	{
		...
		if(this.currenttcis == null)
			clone.currenttcis = null;
		else
			clone.currenttcis = (ims.RefMan.vo.TCIForReferralBookingVoCollection)this.currenttcis.clone();
		if(this.triageoutcome == null)
			clone.triageoutcome = null;
		else
			clone.triageoutcome = (ims.RefMan.vo.TriageOutcomeForBookAppointmentVo)this.triageoutcome.clone();
	...
	protected ims.RefMan.vo.TCIForReferralBookingVoCollection currenttcis;
	protected ims.RefMan.vo.TriageOutcomeForBookAppointmentVo triageoutcome;
