...
public class ClinicalOutcomeDisplayVoAssembler
{
	 ...
	 */
	 public static ims.RefMan.vo.ClinicalOutcomeDisplayVo copy(ims.RefMan.vo.ClinicalOutcomeDisplayVo valueObjectDest, ims.RefMan.vo.ClinicalOutcomeDisplayVo valueObjectSrc) 
	 {
	 ...
	 */
	public static ims.RefMan.vo.ClinicalOutcomeDisplayVoCollection createClinicalOutcomeDisplayVoCollectionFromClinicalOutcome(java.util.Set domainObjectSet)	
	{
	 ...
	 * @param domainObjectSet - Set of ims.RefMan.domain.objects.ClinicalOutcome objects.
	 */
	public static ims.RefMan.vo.ClinicalOutcomeDisplayVoCollection createClinicalOutcomeDisplayVoCollectionFromClinicalOutcome(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.RefMan.vo.ClinicalOutcomeDisplayVoCollection voList = new ims.RefMan.vo.ClinicalOutcomeDisplayVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.RefMan.vo.ClinicalOutcomeDisplayVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.RefMan.vo.ClinicalOutcomeDisplayVoCollection createClinicalOutcomeDisplayVoCollectionFromClinicalOutcome(java.util.List domainObjectList) 
	{
	 ...
	 * @param domainObjectList - List of ims.RefMan.domain.objects.ClinicalOutcome objects.
	 */
	public static ims.RefMan.vo.ClinicalOutcomeDisplayVoCollection createClinicalOutcomeDisplayVoCollectionFromClinicalOutcome(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.RefMan.vo.ClinicalOutcomeDisplayVoCollection voList = new ims.RefMan.vo.ClinicalOutcomeDisplayVoCollection();
	 ...
	 */
	 public static java.util.Set extractClinicalOutcomeSet(ims.domain.ILightweightDomainFactory domainFactory, ims.RefMan.vo.ClinicalOutcomeDisplayVoCollection voCollection) 
	 {
	 	return extractClinicalOutcomeSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractClinicalOutcomeSet(ims.domain.ILightweightDomainFactory domainFactory, ims.RefMan.vo.ClinicalOutcomeDisplayVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.RefMan.vo.ClinicalOutcomeDisplayVo vo = voCollection.get(i);
			ims.RefMan.domain.objects.ClinicalOutcome domainObject = ClinicalOutcomeDisplayVoAssembler.extractClinicalOutcome(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractClinicalOutcomeList(ims.domain.ILightweightDomainFactory domainFactory, ims.RefMan.vo.ClinicalOutcomeDisplayVoCollection voCollection) 
	 {
	 	return extractClinicalOutcomeList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractClinicalOutcomeList(ims.domain.ILightweightDomainFactory domainFactory, ims.RefMan.vo.ClinicalOutcomeDisplayVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.RefMan.vo.ClinicalOutcomeDisplayVo create(ims.RefMan.domain.objects.ClinicalOutcome domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.RefMan.vo.ClinicalOutcomeDisplayVo create(DomainObjectMap map, ims.RefMan.domain.objects.ClinicalOutcome domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.RefMan.vo.ClinicalOutcomeDisplayVo valueObject = (ims.RefMan.vo.ClinicalOutcomeDisplayVo) map.getValueObject(domainObject, ims.RefMan.vo.ClinicalOutcomeDisplayVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.RefMan.vo.ClinicalOutcomeDisplayVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.RefMan.domain.objects.ClinicalOutcome
	 */
	 public static ims.RefMan.vo.ClinicalOutcomeDisplayVo insert(ims.RefMan.vo.ClinicalOutcomeDisplayVo valueObject, ims.RefMan.domain.objects.ClinicalOutcome domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.RefMan.domain.objects.ClinicalOutcome
	 */
	 public static ims.RefMan.vo.ClinicalOutcomeDisplayVo insert(DomainObjectMap map, ims.RefMan.vo.ClinicalOutcomeDisplayVo valueObject, ims.RefMan.domain.objects.ClinicalOutcome domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 */
	public static ims.RefMan.domain.objects.ClinicalOutcome extractClinicalOutcome(ims.domain.ILightweightDomainFactory domainFactory, ims.RefMan.vo.ClinicalOutcomeDisplayVo valueObject) 
	{
		return 	extractClinicalOutcome(domainFactory, valueObject, new HashMap());
	}

	public static ims.RefMan.domain.objects.ClinicalOutcome extractClinicalOutcome(ims.domain.ILightweightDomainFactory domainFactory, ims.RefMan.vo.ClinicalOutcomeDisplayVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.RefMan.vo.ClinicalOutcomeDisplayVo ID_ClinicalOutcome field is unknown
