...
public class ContractConfigShortVoAssembler
{
	 ...
	 */
	 public static ims.RefMan.vo.ContractConfigShortVo copy(ims.RefMan.vo.ContractConfigShortVo valueObjectDest, ims.RefMan.vo.ContractConfigShortVo valueObjectSrc) 
	 {
	 ...
	 */
	public static ims.RefMan.vo.ContractConfigShortVoCollection createContractConfigShortVoCollectionFromContractConfig(java.util.Set domainObjectSet)	
	{
	 ...
	 * @param domainObjectSet - Set of ims.core.configuration.domain.objects.ContractConfig objects.
	 */
	public static ims.RefMan.vo.ContractConfigShortVoCollection createContractConfigShortVoCollectionFromContractConfig(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.RefMan.vo.ContractConfigShortVoCollection voList = new ims.RefMan.vo.ContractConfigShortVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.RefMan.vo.ContractConfigShortVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.RefMan.vo.ContractConfigShortVoCollection createContractConfigShortVoCollectionFromContractConfig(java.util.List domainObjectList) 
	{
	 ...
	 * @param domainObjectList - List of ims.core.configuration.domain.objects.ContractConfig objects.
	 */
	public static ims.RefMan.vo.ContractConfigShortVoCollection createContractConfigShortVoCollectionFromContractConfig(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.RefMan.vo.ContractConfigShortVoCollection voList = new ims.RefMan.vo.ContractConfigShortVoCollection();
	 ...
	 */
	 public static java.util.Set extractContractConfigSet(ims.domain.ILightweightDomainFactory domainFactory, ims.RefMan.vo.ContractConfigShortVoCollection voCollection) 
	 {
	 	return extractContractConfigSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractContractConfigSet(ims.domain.ILightweightDomainFactory domainFactory, ims.RefMan.vo.ContractConfigShortVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.RefMan.vo.ContractConfigShortVo vo = voCollection.get(i);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractContractConfigList(ims.domain.ILightweightDomainFactory domainFactory, ims.RefMan.vo.ContractConfigShortVoCollection voCollection) 
	 {
	 	return extractContractConfigList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractContractConfigList(ims.domain.ILightweightDomainFactory domainFactory, ims.RefMan.vo.ContractConfigShortVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.RefMan.vo.ContractConfigShortVo create(ims.core.configuration.domain.objects.ContractConfig domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.RefMan.vo.ContractConfigShortVo create(DomainObjectMap map, ims.core.configuration.domain.objects.ContractConfig domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.RefMan.vo.ContractConfigShortVo valueObject = (ims.RefMan.vo.ContractConfigShortVo) map.getValueObject(domainObject, ims.RefMan.vo.ContractConfigShortVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.RefMan.vo.ContractConfigShortVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.core.configuration.domain.objects.ContractConfig
	 */
	 public static ims.RefMan.vo.ContractConfigShortVo insert(ims.RefMan.vo.ContractConfigShortVo valueObject, ims.core.configuration.domain.objects.ContractConfig domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.core.configuration.domain.objects.ContractConfig
	 */
	 public static ims.RefMan.vo.ContractConfigShortVo insert(DomainObjectMap map, ims.RefMan.vo.ContractConfigShortVo valueObject, ims.core.configuration.domain.objects.ContractConfig domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 */
	public static ims.core.configuration.domain.objects.ContractConfig extractContractConfig(ims.domain.ILightweightDomainFactory domainFactory, ims.RefMan.vo.ContractConfigShortVo valueObject) 
	{
		return 	extractContractConfig(domainFactory, valueObject, new HashMap());
	}

	public static ims.core.configuration.domain.objects.ContractConfig extractContractConfig(ims.domain.ILightweightDomainFactory domainFactory, ims.RefMan.vo.ContractConfigShortVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.RefMan.vo.ContractConfigShortVo ID_ContractConfig field is unknown
