...
public class PatientElectiveListLiteVoAssembler
{
	 ...
	 */
	 public static ims.RefMan.vo.PatientElectiveListLiteVo copy(ims.RefMan.vo.PatientElectiveListLiteVo valueObjectDest, ims.RefMan.vo.PatientElectiveListLiteVo valueObjectSrc) 
	 {
	 ...
	 */
	public static ims.RefMan.vo.PatientElectiveListLiteVoCollection createPatientElectiveListLiteVoCollectionFromPatientElectiveList(java.util.Set domainObjectSet)	
	{
	 ...
	 * @param domainObjectSet - Set of ims.RefMan.domain.objects.PatientElectiveList objects.
	 */
	public static ims.RefMan.vo.PatientElectiveListLiteVoCollection createPatientElectiveListLiteVoCollectionFromPatientElectiveList(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.RefMan.vo.PatientElectiveListLiteVoCollection voList = new ims.RefMan.vo.PatientElectiveListLiteVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.RefMan.vo.PatientElectiveListLiteVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.RefMan.vo.PatientElectiveListLiteVoCollection createPatientElectiveListLiteVoCollectionFromPatientElectiveList(java.util.List domainObjectList) 
	{
	 ...
	 * @param domainObjectList - List of ims.RefMan.domain.objects.PatientElectiveList objects.
	 */
	public static ims.RefMan.vo.PatientElectiveListLiteVoCollection createPatientElectiveListLiteVoCollectionFromPatientElectiveList(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.RefMan.vo.PatientElectiveListLiteVoCollection voList = new ims.RefMan.vo.PatientElectiveListLiteVoCollection();
	 ...
	 */
	 public static java.util.Set extractPatientElectiveListSet(ims.domain.ILightweightDomainFactory domainFactory, ims.RefMan.vo.PatientElectiveListLiteVoCollection voCollection) 
	 {
	 	return extractPatientElectiveListSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractPatientElectiveListSet(ims.domain.ILightweightDomainFactory domainFactory, ims.RefMan.vo.PatientElectiveListLiteVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.RefMan.vo.PatientElectiveListLiteVo vo = voCollection.get(i);
			ims.RefMan.domain.objects.PatientElectiveList domainObject = PatientElectiveListLiteVoAssembler.extractPatientElectiveList(domainFactory, vo, domMap);
	 ...
	 */
	 ...
	 public static java.util.List extractPatientElectiveListList(ims.domain.ILightweightDomainFactory domainFactory, ims.RefMan.vo.PatientElectiveListLiteVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.RefMan.vo.PatientElectiveListLiteVo create(ims.RefMan.domain.objects.PatientElectiveList domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.RefMan.vo.PatientElectiveListLiteVo create(DomainObjectMap map, ims.RefMan.domain.objects.PatientElectiveList domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.RefMan.vo.PatientElectiveListLiteVo valueObject = (ims.RefMan.vo.PatientElectiveListLiteVo) map.getValueObject(domainObject, ims.RefMan.vo.PatientElectiveListLiteVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.RefMan.vo.PatientElectiveListLiteVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.RefMan.domain.objects.PatientElectiveList
	 */
	 public static ims.RefMan.vo.PatientElectiveListLiteVo insert(ims.RefMan.vo.PatientElectiveListLiteVo valueObject, ims.RefMan.domain.objects.PatientElectiveList domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.RefMan.domain.objects.PatientElectiveList
	 */
	 public static ims.RefMan.vo.PatientElectiveListLiteVo insert(DomainObjectMap map, ims.RefMan.vo.PatientElectiveListLiteVo valueObject, ims.RefMan.domain.objects.PatientElectiveList domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
		...
		// ElectiveListStatus
		valueObject.setElectiveListStatus(ims.RefMan.vo.domain.ElectiveListStatusForBookTheatreVoAssembler.create(map, domainObject.getElectiveListStatus()) );
		// PrimaryProcedure
	 ...
	 */
	public static ims.RefMan.domain.objects.PatientElectiveList extractPatientElectiveList(ims.domain.ILightweightDomainFactory domainFactory, ims.RefMan.vo.PatientElectiveListLiteVo valueObject) 
	{
		return 	extractPatientElectiveList(domainFactory, valueObject, new HashMap());
	}

	public static ims.RefMan.domain.objects.PatientElectiveList extractPatientElectiveList(ims.domain.ILightweightDomainFactory domainFactory, ims.RefMan.vo.PatientElectiveListLiteVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.RefMan.vo.PatientElectiveListLiteVo ID_PatientElectiveList field is unknown
	...
	// SaveAsRefVO - treated as a refVo in extract methods
	ims.RefMan.domain.objects.ElectiveListStatus value3 = null;
		if ( null != valueObject.getElectiveListStatus() ) 
		{
			if (valueObject.getElectiveListStatus().getBoId() == null)
			{
				...
				{
					value3 = (ims.RefMan.domain.objects.ElectiveListStatus)domMap.get(valueObject.getElectiveListStatus());
				}
			}
			else
			{
				value3 = (ims.RefMan.domain.objects.ElectiveListStatus)domainFactory.getDomainObject(ims.RefMan.domain.objects.ElectiveListStatus.class, valueObject.getElectiveListStatus().getBoId());
			}
		}
