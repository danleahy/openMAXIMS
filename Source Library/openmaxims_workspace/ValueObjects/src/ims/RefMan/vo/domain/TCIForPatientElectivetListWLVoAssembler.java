 ...
 */
public class TCIForPatientElectivetListWLVoAssembler
{
  	/**
	 ...
	 */
	 public static ims.RefMan.vo.TCIForPatientElectivetListWLVo copy(ims.RefMan.vo.TCIForPatientElectivetListWLVo valueObjectDest, ims.RefMan.vo.TCIForPatientElectivetListWLVo valueObjectSrc) 
	 {
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createTCIForPatientElectivetListWLVoCollectionFromTCIForPatientElectiveList(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.RefMan.domain.objects.TCIForPatientElectiveList objects.
	 */
	public static ims.RefMan.vo.TCIForPatientElectivetListWLVoCollection createTCIForPatientElectivetListWLVoCollectionFromTCIForPatientElectiveList(java.util.Set domainObjectSet)	
	{
		return createTCIForPatientElectivetListWLVoCollectionFromTCIForPatientElectiveList(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.RefMan.domain.objects.TCIForPatientElectiveList objects.
	 */
	public static ims.RefMan.vo.TCIForPatientElectivetListWLVoCollection createTCIForPatientElectivetListWLVoCollectionFromTCIForPatientElectiveList(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.RefMan.vo.TCIForPatientElectivetListWLVoCollection voList = new ims.RefMan.vo.TCIForPatientElectivetListWLVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.RefMan.vo.TCIForPatientElectivetListWLVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.RefMan.vo.TCIForPatientElectivetListWLVoCollection createTCIForPatientElectivetListWLVoCollectionFromTCIForPatientElectiveList(java.util.List domainObjectList) 
	{
		return createTCIForPatientElectivetListWLVoCollectionFromTCIForPatientElectiveList(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.RefMan.domain.objects.TCIForPatientElectiveList objects.
	 */
	public static ims.RefMan.vo.TCIForPatientElectivetListWLVoCollection createTCIForPatientElectivetListWLVoCollectionFromTCIForPatientElectiveList(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.RefMan.vo.TCIForPatientElectivetListWLVoCollection voList = new ims.RefMan.vo.TCIForPatientElectivetListWLVoCollection();
	 ...
	 */
	 public static java.util.Set extractTCIForPatientElectiveListSet(ims.domain.ILightweightDomainFactory domainFactory, ims.RefMan.vo.TCIForPatientElectivetListWLVoCollection voCollection) 
	 {
	 	return extractTCIForPatientElectiveListSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractTCIForPatientElectiveListSet(ims.domain.ILightweightDomainFactory domainFactory, ims.RefMan.vo.TCIForPatientElectivetListWLVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.RefMan.vo.TCIForPatientElectivetListWLVo vo = voCollection.get(i);
			ims.RefMan.domain.objects.TCIForPatientElectiveList domainObject = TCIForPatientElectivetListWLVoAssembler.extractTCIForPatientElectiveList(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractTCIForPatientElectiveListList(ims.domain.ILightweightDomainFactory domainFactory, ims.RefMan.vo.TCIForPatientElectivetListWLVoCollection voCollection) 
	 {
	 	return extractTCIForPatientElectiveListList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractTCIForPatientElectiveListList(ims.domain.ILightweightDomainFactory domainFactory, ims.RefMan.vo.TCIForPatientElectivetListWLVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.RefMan.vo.TCIForPatientElectivetListWLVo create(ims.RefMan.domain.objects.TCIForPatientElectiveList domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.RefMan.vo.TCIForPatientElectivetListWLVo create(DomainObjectMap map, ims.RefMan.domain.objects.TCIForPatientElectiveList domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.RefMan.vo.TCIForPatientElectivetListWLVo valueObject = (ims.RefMan.vo.TCIForPatientElectivetListWLVo) map.getValueObject(domainObject, ims.RefMan.vo.TCIForPatientElectivetListWLVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.RefMan.vo.TCIForPatientElectivetListWLVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.RefMan.domain.objects.TCIForPatientElectiveList
	 */
	 public static ims.RefMan.vo.TCIForPatientElectivetListWLVo insert(ims.RefMan.vo.TCIForPatientElectivetListWLVo valueObject, ims.RefMan.domain.objects.TCIForPatientElectiveList domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.RefMan.domain.objects.TCIForPatientElectiveList
	 */
	 public static ims.RefMan.vo.TCIForPatientElectivetListWLVo insert(DomainObjectMap map, ims.RefMan.vo.TCIForPatientElectivetListWLVo valueObject, ims.RefMan.domain.objects.TCIForPatientElectiveList domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
		...
		// RTTBreachReason
		ims.domain.lookups.LookupInstance instance7 = domainObject.getRTTBreachReason();
		if ( null != instance7 ) {
			ims.framework.utils.ImagePath img = null;
			ims.framework.utils.Color color = null;		
			img = null;
			...
			ims.scheduling.vo.lookups.RTTWeekWaitOr28DayRuleBreachReason voLookup7 = new ims.scheduling.vo.lookups.RTTWeekWaitOr28DayRuleBreachReason(instance7.getId(),instance7.getText(), instance7.isActive(), null, img, color);
			ims.scheduling.vo.lookups.RTTWeekWaitOr28DayRuleBreachReason parentVoLookup7 = voLookup7;
			...
			while (parent7 != null)
			{
    			...
    			if (color != null) 
    				color.getValue();
								parentVoLookup7.setParent(new ims.scheduling.vo.lookups.RTTWeekWaitOr28DayRuleBreachReason(parent7.getId(),parent7.getText(), parent7.isActive(), null, img, color));
				parentVoLookup7 = parentVoLookup7.getParent();
								parent7 = parent7.getParent();
			}			
			valueObject.setRTTBreachReason(voLookup7);
		}
				// PlanningElective
		...
		// Day28BreachReason
		ims.domain.lookups.LookupInstance instance15 = domainObject.getDay28BreachReason();
		if ( null != instance15 ) {
			ims.framework.utils.ImagePath img = null;
			ims.framework.utils.Color color = null;		
			img = null;
			...
			ims.scheduling.vo.lookups.RTTWeekWaitOr28DayRuleBreachReason voLookup15 = new ims.scheduling.vo.lookups.RTTWeekWaitOr28DayRuleBreachReason(instance15.getId(),instance15.getText(), instance15.isActive(), null, img, color);
			ims.scheduling.vo.lookups.RTTWeekWaitOr28DayRuleBreachReason parentVoLookup15 = voLookup15;
			...
			while (parent15 != null)
			{
    			...
    			if (color != null) 
    				color.getValue();
								parentVoLookup15.setParent(new ims.scheduling.vo.lookups.RTTWeekWaitOr28DayRuleBreachReason(parent15.getId(),parent15.getText(), parent15.isActive(), null, img, color));
				parentVoLookup15 = parentVoLookup15.getParent();
								parent15 = parent15.getParent();
			}			
			valueObject.setDay28BreachReason(voLookup15);
		}
				// Day28BreachComment
	 ...
	 */
	public static ims.RefMan.domain.objects.TCIForPatientElectiveList extractTCIForPatientElectiveList(ims.domain.ILightweightDomainFactory domainFactory, ims.RefMan.vo.TCIForPatientElectivetListWLVo valueObject) 
	{
		return 	extractTCIForPatientElectiveList(domainFactory, valueObject, new HashMap());
	}

	public static ims.RefMan.domain.objects.TCIForPatientElectiveList extractTCIForPatientElectiveList(ims.domain.ILightweightDomainFactory domainFactory, ims.RefMan.vo.TCIForPatientElectivetListWLVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.RefMan.vo.TCIForPatientElectivetListWLVo ID_TCIForPatientElectiveList field is unknown
		...
		domainObject.setRTTBreachReason(value7);
		// create LookupInstance from vo LookupType
		...
		domainObject.setTCIHospital(ims.core.vo.domain.LocationLiteVoAssembler.extractLocation(domainFactory, valueObject.getTCIHospital(), domMap));
	...
	ims.core.resource.place.domain.objects.Location value10 = null;
		...
		domainObject.setDay28BreachReason(value15);
		//This is to overcome a bug in both Sybase and Oracle which prevents them from storing an empty string correctly
		//Sybase stores it as a single space, Oracle stores it as NULL. This fix will make them consistent at least.
