...
public class ReferralERODVoAssembler
{
	 ...
	 */
	 public static ims.RefMan.vo.ReferralERODVo copy(ims.RefMan.vo.ReferralERODVo valueObjectDest, ims.RefMan.vo.ReferralERODVo valueObjectSrc) 
	 {
	 ...
	 */
	public static ims.RefMan.vo.ReferralERODVoCollection createReferralERODVoCollectionFromReferralEROD(java.util.Set domainObjectSet)	
	{
	 ...
	 * @param domainObjectSet - Set of ims.RefMan.domain.objects.ReferralEROD objects.
	 */
	public static ims.RefMan.vo.ReferralERODVoCollection createReferralERODVoCollectionFromReferralEROD(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.RefMan.vo.ReferralERODVoCollection voList = new ims.RefMan.vo.ReferralERODVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.RefMan.vo.ReferralERODVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.RefMan.vo.ReferralERODVoCollection createReferralERODVoCollectionFromReferralEROD(java.util.List domainObjectList) 
	{
	 ...
	 * @param domainObjectList - List of ims.RefMan.domain.objects.ReferralEROD objects.
	 */
	public static ims.RefMan.vo.ReferralERODVoCollection createReferralERODVoCollectionFromReferralEROD(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.RefMan.vo.ReferralERODVoCollection voList = new ims.RefMan.vo.ReferralERODVoCollection();
	 ...
	 */
	 public static java.util.Set extractReferralERODSet(ims.domain.ILightweightDomainFactory domainFactory, ims.RefMan.vo.ReferralERODVoCollection voCollection) 
	 {
	 	return extractReferralERODSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractReferralERODSet(ims.domain.ILightweightDomainFactory domainFactory, ims.RefMan.vo.ReferralERODVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.RefMan.vo.ReferralERODVo vo = voCollection.get(i);
			ims.RefMan.domain.objects.ReferralEROD domainObject = ReferralERODVoAssembler.extractReferralEROD(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractReferralERODList(ims.domain.ILightweightDomainFactory domainFactory, ims.RefMan.vo.ReferralERODVoCollection voCollection) 
	 {
	 	return extractReferralERODList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractReferralERODList(ims.domain.ILightweightDomainFactory domainFactory, ims.RefMan.vo.ReferralERODVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.RefMan.vo.ReferralERODVo create(ims.RefMan.domain.objects.ReferralEROD domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.RefMan.vo.ReferralERODVo create(DomainObjectMap map, ims.RefMan.domain.objects.ReferralEROD domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.RefMan.vo.ReferralERODVo valueObject = (ims.RefMan.vo.ReferralERODVo) map.getValueObject(domainObject, ims.RefMan.vo.ReferralERODVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.RefMan.vo.ReferralERODVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.RefMan.domain.objects.ReferralEROD
	 */
	 public static ims.RefMan.vo.ReferralERODVo insert(ims.RefMan.vo.ReferralERODVo valueObject, ims.RefMan.domain.objects.ReferralEROD domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.RefMan.domain.objects.ReferralEROD
	 */
	 public static ims.RefMan.vo.ReferralERODVo insert(DomainObjectMap map, ims.RefMan.vo.ReferralERODVo valueObject, ims.RefMan.domain.objects.ReferralEROD domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
		...
		if ( null != instance5 ) {
			...
			valueObject.setERODType(voLookup5);
				...
				// Appointment
		valueObject.setAppointment(ims.RefMan.vo.domain.Booking_AppointmentERODVoAssembler.create(map, domainObject.getAppointment()) );
		// Sequence
		...
		// ErodStatus
		ims.domain.lookups.LookupInstance instance12 = domainObject.getErodStatus();
		if ( null != instance12 ) {
			ims.framework.utils.ImagePath img = null;
			ims.framework.utils.Color color = null;		
			img = null;
			...
			ims.RefMan.vo.lookups.ERODStatus voLookup12 = new ims.RefMan.vo.lookups.ERODStatus(instance12.getId(),instance12.getText(), instance12.isActive(), null, img, color);
			ims.RefMan.vo.lookups.ERODStatus parentVoLookup12 = voLookup12;
			...
			while (parent12 != null)
			{
    			...
    			if (color != null) 
    				color.getValue();
								parentVoLookup12.setParent(new ims.RefMan.vo.lookups.ERODStatus(parent12.getId(),parent12.getText(), parent12.isActive(), null, img, color));
				parentVoLookup12 = parentVoLookup12.getParent();
								parent12 = parent12.getParent();
			}			
			valueObject.setErodStatus(voLookup12);
		}
				// isExtendedDelay
	 ...
	 */
	public static ims.RefMan.domain.objects.ReferralEROD extractReferralEROD(ims.domain.ILightweightDomainFactory domainFactory, ims.RefMan.vo.ReferralERODVo valueObject) 
	{
		return 	extractReferralEROD(domainFactory, valueObject, new HashMap());
	}

	public static ims.RefMan.domain.objects.ReferralEROD extractReferralEROD(ims.domain.ILightweightDomainFactory domainFactory, ims.RefMan.vo.ReferralERODVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.RefMan.vo.ReferralERODVo ID_ReferralEROD field is unknown
	...
	ims.scheduling.domain.objects.Booking_Appointment value6 = null;
		...
		domainObject.setErodStatus(value12);
		domainObject.setIsExtendedDelay(valueObject.getIsExtendedDelay());
		java.util.Date value14 = null;
		ims.framework.utils.Date date14 = valueObject.getDateOfOffer();		
		if ( date14 != null ) 
		{
			value14 = date14.getDate();
		}
		domainObject.setDateOfOffer(value14);
