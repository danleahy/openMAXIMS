 ...
 */
public class CSPrimaryDiagnosisForReferralCodingVoAssembler
{
  	/**
	 ...
	 */
	 public static ims.RefMan.vo.CSPrimaryDiagnosisForReferralCodingVo copy(ims.RefMan.vo.CSPrimaryDiagnosisForReferralCodingVo valueObjectDest, ims.RefMan.vo.CSPrimaryDiagnosisForReferralCodingVo valueObjectSrc) 
	 {
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createCSPrimaryDiagnosisForReferralCodingVoCollectionFromCsPrimaryDiagnosis(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.core.clinical.domain.objects.CsPrimaryDiagnosis objects.
	 */
	public static ims.RefMan.vo.CSPrimaryDiagnosisForReferralCodingVoCollection createCSPrimaryDiagnosisForReferralCodingVoCollectionFromCsPrimaryDiagnosis(java.util.Set domainObjectSet)	
	{
		return createCSPrimaryDiagnosisForReferralCodingVoCollectionFromCsPrimaryDiagnosis(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.core.clinical.domain.objects.CsPrimaryDiagnosis objects.
	 */
	public static ims.RefMan.vo.CSPrimaryDiagnosisForReferralCodingVoCollection createCSPrimaryDiagnosisForReferralCodingVoCollectionFromCsPrimaryDiagnosis(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.RefMan.vo.CSPrimaryDiagnosisForReferralCodingVoCollection voList = new ims.RefMan.vo.CSPrimaryDiagnosisForReferralCodingVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.RefMan.vo.CSPrimaryDiagnosisForReferralCodingVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.RefMan.vo.CSPrimaryDiagnosisForReferralCodingVoCollection createCSPrimaryDiagnosisForReferralCodingVoCollectionFromCsPrimaryDiagnosis(java.util.List domainObjectList) 
	{
		return createCSPrimaryDiagnosisForReferralCodingVoCollectionFromCsPrimaryDiagnosis(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.core.clinical.domain.objects.CsPrimaryDiagnosis objects.
	 */
	public static ims.RefMan.vo.CSPrimaryDiagnosisForReferralCodingVoCollection createCSPrimaryDiagnosisForReferralCodingVoCollectionFromCsPrimaryDiagnosis(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.RefMan.vo.CSPrimaryDiagnosisForReferralCodingVoCollection voList = new ims.RefMan.vo.CSPrimaryDiagnosisForReferralCodingVoCollection();
	 ...
	 */
	 public static java.util.Set extractCsPrimaryDiagnosisSet(ims.domain.ILightweightDomainFactory domainFactory, ims.RefMan.vo.CSPrimaryDiagnosisForReferralCodingVoCollection voCollection) 
	 {
	 	return extractCsPrimaryDiagnosisSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractCsPrimaryDiagnosisSet(ims.domain.ILightweightDomainFactory domainFactory, ims.RefMan.vo.CSPrimaryDiagnosisForReferralCodingVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.RefMan.vo.CSPrimaryDiagnosisForReferralCodingVo vo = voCollection.get(i);
			ims.core.clinical.domain.objects.CsPrimaryDiagnosis domainObject = CSPrimaryDiagnosisForReferralCodingVoAssembler.extractCsPrimaryDiagnosis(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractCsPrimaryDiagnosisList(ims.domain.ILightweightDomainFactory domainFactory, ims.RefMan.vo.CSPrimaryDiagnosisForReferralCodingVoCollection voCollection) 
	 {
	 	return extractCsPrimaryDiagnosisList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractCsPrimaryDiagnosisList(ims.domain.ILightweightDomainFactory domainFactory, ims.RefMan.vo.CSPrimaryDiagnosisForReferralCodingVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.RefMan.vo.CSPrimaryDiagnosisForReferralCodingVo create(ims.core.clinical.domain.objects.CsPrimaryDiagnosis domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.RefMan.vo.CSPrimaryDiagnosisForReferralCodingVo create(DomainObjectMap map, ims.core.clinical.domain.objects.CsPrimaryDiagnosis domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.RefMan.vo.CSPrimaryDiagnosisForReferralCodingVo valueObject = (ims.RefMan.vo.CSPrimaryDiagnosisForReferralCodingVo) map.getValueObject(domainObject, ims.RefMan.vo.CSPrimaryDiagnosisForReferralCodingVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.RefMan.vo.CSPrimaryDiagnosisForReferralCodingVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.core.clinical.domain.objects.CsPrimaryDiagnosis
	 */
	 public static ims.RefMan.vo.CSPrimaryDiagnosisForReferralCodingVo insert(ims.RefMan.vo.CSPrimaryDiagnosisForReferralCodingVo valueObject, ims.core.clinical.domain.objects.CsPrimaryDiagnosis domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.core.clinical.domain.objects.CsPrimaryDiagnosis
	 */
	 public static ims.RefMan.vo.CSPrimaryDiagnosisForReferralCodingVo insert(DomainObjectMap map, ims.RefMan.vo.CSPrimaryDiagnosisForReferralCodingVo valueObject, ims.core.clinical.domain.objects.CsPrimaryDiagnosis domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 */
	public static ims.core.clinical.domain.objects.CsPrimaryDiagnosis extractCsPrimaryDiagnosis(ims.domain.ILightweightDomainFactory domainFactory, ims.RefMan.vo.CSPrimaryDiagnosisForReferralCodingVo valueObject) 
	{
		return 	extractCsPrimaryDiagnosis(domainFactory, valueObject, new HashMap());
	}

	public static ims.core.clinical.domain.objects.CsPrimaryDiagnosis extractCsPrimaryDiagnosis(ims.domain.ILightweightDomainFactory domainFactory, ims.RefMan.vo.CSPrimaryDiagnosisForReferralCodingVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.RefMan.vo.CSPrimaryDiagnosisForReferralCodingVo ID_CsPrimaryDiagnosis field is unknown
