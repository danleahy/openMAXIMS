...
public class TCIOutcomeForPatientElectiveListVoAssembler
{
	 ...
	 */
	 public static ims.RefMan.vo.TCIOutcomeForPatientElectiveListVo copy(ims.RefMan.vo.TCIOutcomeForPatientElectiveListVo valueObjectDest, ims.RefMan.vo.TCIOutcomeForPatientElectiveListVo valueObjectSrc) 
	 {
	 ...
	 */
	public static ims.RefMan.vo.TCIOutcomeForPatientElectiveListVoCollection createTCIOutcomeForPatientElectiveListVoCollectionFromTCIOutcomeForPatientElectiveList(java.util.Set domainObjectSet)	
	{
	 ...
	 * @param domainObjectSet - Set of ims.RefMan.domain.objects.TCIOutcomeForPatientElectiveList objects.
	 */
	public static ims.RefMan.vo.TCIOutcomeForPatientElectiveListVoCollection createTCIOutcomeForPatientElectiveListVoCollectionFromTCIOutcomeForPatientElectiveList(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.RefMan.vo.TCIOutcomeForPatientElectiveListVoCollection voList = new ims.RefMan.vo.TCIOutcomeForPatientElectiveListVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.RefMan.vo.TCIOutcomeForPatientElectiveListVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.RefMan.vo.TCIOutcomeForPatientElectiveListVoCollection createTCIOutcomeForPatientElectiveListVoCollectionFromTCIOutcomeForPatientElectiveList(java.util.List domainObjectList) 
	{
	 ...
	 * @param domainObjectList - List of ims.RefMan.domain.objects.TCIOutcomeForPatientElectiveList objects.
	 */
	public static ims.RefMan.vo.TCIOutcomeForPatientElectiveListVoCollection createTCIOutcomeForPatientElectiveListVoCollectionFromTCIOutcomeForPatientElectiveList(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.RefMan.vo.TCIOutcomeForPatientElectiveListVoCollection voList = new ims.RefMan.vo.TCIOutcomeForPatientElectiveListVoCollection();
	 ...
	 */
	 public static java.util.Set extractTCIOutcomeForPatientElectiveListSet(ims.domain.ILightweightDomainFactory domainFactory, ims.RefMan.vo.TCIOutcomeForPatientElectiveListVoCollection voCollection) 
	 {
	 	return extractTCIOutcomeForPatientElectiveListSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractTCIOutcomeForPatientElectiveListSet(ims.domain.ILightweightDomainFactory domainFactory, ims.RefMan.vo.TCIOutcomeForPatientElectiveListVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.RefMan.vo.TCIOutcomeForPatientElectiveListVo vo = voCollection.get(i);
			ims.RefMan.domain.objects.TCIOutcomeForPatientElectiveList domainObject = TCIOutcomeForPatientElectiveListVoAssembler.extractTCIOutcomeForPatientElectiveList(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractTCIOutcomeForPatientElectiveListList(ims.domain.ILightweightDomainFactory domainFactory, ims.RefMan.vo.TCIOutcomeForPatientElectiveListVoCollection voCollection) 
	 {
	 	return extractTCIOutcomeForPatientElectiveListList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractTCIOutcomeForPatientElectiveListList(ims.domain.ILightweightDomainFactory domainFactory, ims.RefMan.vo.TCIOutcomeForPatientElectiveListVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.RefMan.vo.TCIOutcomeForPatientElectiveListVo create(ims.RefMan.domain.objects.TCIOutcomeForPatientElectiveList domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.RefMan.vo.TCIOutcomeForPatientElectiveListVo create(DomainObjectMap map, ims.RefMan.domain.objects.TCIOutcomeForPatientElectiveList domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.RefMan.vo.TCIOutcomeForPatientElectiveListVo valueObject = (ims.RefMan.vo.TCIOutcomeForPatientElectiveListVo) map.getValueObject(domainObject, ims.RefMan.vo.TCIOutcomeForPatientElectiveListVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.RefMan.vo.TCIOutcomeForPatientElectiveListVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.RefMan.domain.objects.TCIOutcomeForPatientElectiveList
	 */
	 public static ims.RefMan.vo.TCIOutcomeForPatientElectiveListVo insert(ims.RefMan.vo.TCIOutcomeForPatientElectiveListVo valueObject, ims.RefMan.domain.objects.TCIOutcomeForPatientElectiveList domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.RefMan.domain.objects.TCIOutcomeForPatientElectiveList
	 */
	 public static ims.RefMan.vo.TCIOutcomeForPatientElectiveListVo insert(DomainObjectMap map, ims.RefMan.vo.TCIOutcomeForPatientElectiveListVo valueObject, ims.RefMan.domain.objects.TCIOutcomeForPatientElectiveList domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 */
	public static ims.RefMan.domain.objects.TCIOutcomeForPatientElectiveList extractTCIOutcomeForPatientElectiveList(ims.domain.ILightweightDomainFactory domainFactory, ims.RefMan.vo.TCIOutcomeForPatientElectiveListVo valueObject) 
	{
		return 	extractTCIOutcomeForPatientElectiveList(domainFactory, valueObject, new HashMap());
	}

	public static ims.RefMan.domain.objects.TCIOutcomeForPatientElectiveList extractTCIOutcomeForPatientElectiveList(ims.domain.ILightweightDomainFactory domainFactory, ims.RefMan.vo.TCIOutcomeForPatientElectiveListVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.RefMan.vo.TCIOutcomeForPatientElectiveListVo ID_TCIOutcomeForPatientElectiveList field is unknown
