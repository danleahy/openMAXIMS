...
public class ReferralERODForBookAppointmentVoAssembler
{
	 ...
	 */
	 public static ims.RefMan.vo.ReferralERODForBookAppointmentVo copy(ims.RefMan.vo.ReferralERODForBookAppointmentVo valueObjectDest, ims.RefMan.vo.ReferralERODForBookAppointmentVo valueObjectSrc) 
	 {
	 ...
	 */
	public static ims.RefMan.vo.ReferralERODForBookAppointmentVoCollection createReferralERODForBookAppointmentVoCollectionFromReferralEROD(java.util.Set domainObjectSet)	
	{
	 ...
	 * @param domainObjectSet - Set of ims.RefMan.domain.objects.ReferralEROD objects.
	 */
	public static ims.RefMan.vo.ReferralERODForBookAppointmentVoCollection createReferralERODForBookAppointmentVoCollectionFromReferralEROD(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.RefMan.vo.ReferralERODForBookAppointmentVoCollection voList = new ims.RefMan.vo.ReferralERODForBookAppointmentVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.RefMan.vo.ReferralERODForBookAppointmentVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.RefMan.vo.ReferralERODForBookAppointmentVoCollection createReferralERODForBookAppointmentVoCollectionFromReferralEROD(java.util.List domainObjectList) 
	{
	 ...
	 * @param domainObjectList - List of ims.RefMan.domain.objects.ReferralEROD objects.
	 */
	public static ims.RefMan.vo.ReferralERODForBookAppointmentVoCollection createReferralERODForBookAppointmentVoCollectionFromReferralEROD(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.RefMan.vo.ReferralERODForBookAppointmentVoCollection voList = new ims.RefMan.vo.ReferralERODForBookAppointmentVoCollection();
	 ...
	 */
	 public static java.util.Set extractReferralERODSet(ims.domain.ILightweightDomainFactory domainFactory, ims.RefMan.vo.ReferralERODForBookAppointmentVoCollection voCollection) 
	 {
	 	return extractReferralERODSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractReferralERODSet(ims.domain.ILightweightDomainFactory domainFactory, ims.RefMan.vo.ReferralERODForBookAppointmentVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.RefMan.vo.ReferralERODForBookAppointmentVo vo = voCollection.get(i);
			ims.RefMan.domain.objects.ReferralEROD domainObject = ReferralERODForBookAppointmentVoAssembler.extractReferralEROD(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractReferralERODList(ims.domain.ILightweightDomainFactory domainFactory, ims.RefMan.vo.ReferralERODForBookAppointmentVoCollection voCollection) 
	 {
	 	return extractReferralERODList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractReferralERODList(ims.domain.ILightweightDomainFactory domainFactory, ims.RefMan.vo.ReferralERODForBookAppointmentVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.RefMan.vo.ReferralERODForBookAppointmentVo create(ims.RefMan.domain.objects.ReferralEROD domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.RefMan.vo.ReferralERODForBookAppointmentVo create(DomainObjectMap map, ims.RefMan.domain.objects.ReferralEROD domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.RefMan.vo.ReferralERODForBookAppointmentVo valueObject = (ims.RefMan.vo.ReferralERODForBookAppointmentVo) map.getValueObject(domainObject, ims.RefMan.vo.ReferralERODForBookAppointmentVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.RefMan.vo.ReferralERODForBookAppointmentVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.RefMan.domain.objects.ReferralEROD
	 */
	 public static ims.RefMan.vo.ReferralERODForBookAppointmentVo insert(ims.RefMan.vo.ReferralERODForBookAppointmentVo valueObject, ims.RefMan.domain.objects.ReferralEROD domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.RefMan.domain.objects.ReferralEROD
	 */
	 public static ims.RefMan.vo.ReferralERODForBookAppointmentVo insert(DomainObjectMap map, ims.RefMan.vo.ReferralERODForBookAppointmentVo valueObject, ims.RefMan.domain.objects.ReferralEROD domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 */
	public static ims.RefMan.domain.objects.ReferralEROD extractReferralEROD(ims.domain.ILightweightDomainFactory domainFactory, ims.RefMan.vo.ReferralERODForBookAppointmentVo valueObject) 
	{
		return 	extractReferralEROD(domainFactory, valueObject, new HashMap());
	}

	public static ims.RefMan.domain.objects.ReferralEROD extractReferralEROD(ims.domain.ILightweightDomainFactory domainFactory, ims.RefMan.vo.ReferralERODForBookAppointmentVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.RefMan.vo.ReferralERODForBookAppointmentVo ID_ReferralEROD field is unknown
