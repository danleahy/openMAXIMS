...
public class CatsReferralBreachDatesVoAssembler
{
	 ...
	 */
	 public static ims.RefMan.vo.CatsReferralBreachDatesVo copy(ims.RefMan.vo.CatsReferralBreachDatesVo valueObjectDest, ims.RefMan.vo.CatsReferralBreachDatesVo valueObjectSrc) 
	 {
	 ...
	 */
	public static ims.RefMan.vo.CatsReferralBreachDatesVoCollection createCatsReferralBreachDatesVoCollectionFromCatsReferral(java.util.Set domainObjectSet)	
	{
	 ...
	 * @param domainObjectSet - Set of ims.RefMan.domain.objects.CatsReferral objects.
	 */
	public static ims.RefMan.vo.CatsReferralBreachDatesVoCollection createCatsReferralBreachDatesVoCollectionFromCatsReferral(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.RefMan.vo.CatsReferralBreachDatesVoCollection voList = new ims.RefMan.vo.CatsReferralBreachDatesVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.RefMan.vo.CatsReferralBreachDatesVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.RefMan.vo.CatsReferralBreachDatesVoCollection createCatsReferralBreachDatesVoCollectionFromCatsReferral(java.util.List domainObjectList) 
	{
	 ...
	 * @param domainObjectList - List of ims.RefMan.domain.objects.CatsReferral objects.
	 */
	public static ims.RefMan.vo.CatsReferralBreachDatesVoCollection createCatsReferralBreachDatesVoCollectionFromCatsReferral(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.RefMan.vo.CatsReferralBreachDatesVoCollection voList = new ims.RefMan.vo.CatsReferralBreachDatesVoCollection();
	 ...
	 */
	 public static java.util.Set extractCatsReferralSet(ims.domain.ILightweightDomainFactory domainFactory, ims.RefMan.vo.CatsReferralBreachDatesVoCollection voCollection) 
	 {
	 	return extractCatsReferralSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractCatsReferralSet(ims.domain.ILightweightDomainFactory domainFactory, ims.RefMan.vo.CatsReferralBreachDatesVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.RefMan.vo.CatsReferralBreachDatesVo vo = voCollection.get(i);
			ims.RefMan.domain.objects.CatsReferral domainObject = CatsReferralBreachDatesVoAssembler.extractCatsReferral(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractCatsReferralList(ims.domain.ILightweightDomainFactory domainFactory, ims.RefMan.vo.CatsReferralBreachDatesVoCollection voCollection) 
	 {
	 	return extractCatsReferralList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractCatsReferralList(ims.domain.ILightweightDomainFactory domainFactory, ims.RefMan.vo.CatsReferralBreachDatesVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.RefMan.vo.CatsReferralBreachDatesVo create(ims.RefMan.domain.objects.CatsReferral domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.RefMan.vo.CatsReferralBreachDatesVo create(DomainObjectMap map, ims.RefMan.domain.objects.CatsReferral domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.RefMan.vo.CatsReferralBreachDatesVo valueObject = (ims.RefMan.vo.CatsReferralBreachDatesVo) map.getValueObject(domainObject, ims.RefMan.vo.CatsReferralBreachDatesVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.RefMan.vo.CatsReferralBreachDatesVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.RefMan.domain.objects.CatsReferral
	 */
	 public static ims.RefMan.vo.CatsReferralBreachDatesVo insert(ims.RefMan.vo.CatsReferralBreachDatesVo valueObject, ims.RefMan.domain.objects.CatsReferral domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.RefMan.domain.objects.CatsReferral
	 */
	 public static ims.RefMan.vo.CatsReferralBreachDatesVo insert(DomainObjectMap map, ims.RefMan.vo.CatsReferralBreachDatesVo valueObject, ims.RefMan.domain.objects.CatsReferral domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 */
	public static ims.RefMan.domain.objects.CatsReferral extractCatsReferral(ims.domain.ILightweightDomainFactory domainFactory, ims.RefMan.vo.CatsReferralBreachDatesVo valueObject) 
	{
		return 	extractCatsReferral(domainFactory, valueObject, new HashMap());
	}

	public static ims.RefMan.domain.objects.CatsReferral extractCatsReferral(ims.domain.ILightweightDomainFactory domainFactory, ims.RefMan.vo.CatsReferralBreachDatesVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.RefMan.vo.CatsReferralBreachDatesVo ID_CatsReferral field is unknown
