...
public class PatientForClinicalCodingWorklistVoAssembler
{
	 ...
	 */
	 public static ims.RefMan.vo.PatientForClinicalCodingWorklistVo copy(ims.RefMan.vo.PatientForClinicalCodingWorklistVo valueObjectDest, ims.RefMan.vo.PatientForClinicalCodingWorklistVo valueObjectSrc) 
	 {
	 ...
	 */
	public static ims.RefMan.vo.PatientForClinicalCodingWorklistVoCollection createPatientForClinicalCodingWorklistVoCollectionFromPatient(java.util.Set domainObjectSet)	
	{
	 ...
	 * @param domainObjectSet - Set of ims.core.patient.domain.objects.Patient objects.
	 */
	public static ims.RefMan.vo.PatientForClinicalCodingWorklistVoCollection createPatientForClinicalCodingWorklistVoCollectionFromPatient(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.RefMan.vo.PatientForClinicalCodingWorklistVoCollection voList = new ims.RefMan.vo.PatientForClinicalCodingWorklistVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.RefMan.vo.PatientForClinicalCodingWorklistVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.RefMan.vo.PatientForClinicalCodingWorklistVoCollection createPatientForClinicalCodingWorklistVoCollectionFromPatient(java.util.List domainObjectList) 
	{
	 ...
	 * @param domainObjectList - List of ims.core.patient.domain.objects.Patient objects.
	 */
	public static ims.RefMan.vo.PatientForClinicalCodingWorklistVoCollection createPatientForClinicalCodingWorklistVoCollectionFromPatient(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.RefMan.vo.PatientForClinicalCodingWorklistVoCollection voList = new ims.RefMan.vo.PatientForClinicalCodingWorklistVoCollection();
	 ...
	 */
	 public static java.util.Set extractPatientSet(ims.domain.ILightweightDomainFactory domainFactory, ims.RefMan.vo.PatientForClinicalCodingWorklistVoCollection voCollection) 
	 {
	 	return extractPatientSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractPatientSet(ims.domain.ILightweightDomainFactory domainFactory, ims.RefMan.vo.PatientForClinicalCodingWorklistVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.RefMan.vo.PatientForClinicalCodingWorklistVo vo = voCollection.get(i);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractPatientList(ims.domain.ILightweightDomainFactory domainFactory, ims.RefMan.vo.PatientForClinicalCodingWorklistVoCollection voCollection) 
	 {
	 	return extractPatientList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractPatientList(ims.domain.ILightweightDomainFactory domainFactory, ims.RefMan.vo.PatientForClinicalCodingWorklistVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.RefMan.vo.PatientForClinicalCodingWorklistVo create(ims.core.patient.domain.objects.Patient domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.RefMan.vo.PatientForClinicalCodingWorklistVo create(DomainObjectMap map, ims.core.patient.domain.objects.Patient domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.RefMan.vo.PatientForClinicalCodingWorklistVo valueObject = (ims.RefMan.vo.PatientForClinicalCodingWorklistVo) map.getValueObject(domainObject, ims.RefMan.vo.PatientForClinicalCodingWorklistVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.RefMan.vo.PatientForClinicalCodingWorklistVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.core.patient.domain.objects.Patient
	 */
	 public static ims.RefMan.vo.PatientForClinicalCodingWorklistVo insert(ims.RefMan.vo.PatientForClinicalCodingWorklistVo valueObject, ims.core.patient.domain.objects.Patient domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.core.patient.domain.objects.Patient
	 */
	 public static ims.RefMan.vo.PatientForClinicalCodingWorklistVo insert(DomainObjectMap map, ims.RefMan.vo.PatientForClinicalCodingWorklistVo valueObject, ims.core.patient.domain.objects.Patient domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 */
	public static ims.core.patient.domain.objects.Patient extractPatient(ims.domain.ILightweightDomainFactory domainFactory, ims.RefMan.vo.PatientForClinicalCodingWorklistVo valueObject) 
	{
		return 	extractPatient(domainFactory, valueObject, new HashMap());
	}

	public static ims.core.patient.domain.objects.Patient extractPatient(ims.domain.ILightweightDomainFactory domainFactory, ims.RefMan.vo.PatientForClinicalCodingWorklistVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.RefMan.vo.PatientForClinicalCodingWorklistVo ID_Patient field is unknown
