 ...
 */
public class PatientDiagnosisForAppointmentOutcomeVoAssembler
{
  	/**
	 ...
	 */
	 public static ims.RefMan.vo.PatientDiagnosisForAppointmentOutcomeVo copy(ims.RefMan.vo.PatientDiagnosisForAppointmentOutcomeVo valueObjectDest, ims.RefMan.vo.PatientDiagnosisForAppointmentOutcomeVo valueObjectSrc) 
	 {
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createPatientDiagnosisForAppointmentOutcomeVoCollectionFromPatientDiagnosis(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.core.clinical.domain.objects.PatientDiagnosis objects.
	 */
	public static ims.RefMan.vo.PatientDiagnosisForAppointmentOutcomeVoCollection createPatientDiagnosisForAppointmentOutcomeVoCollectionFromPatientDiagnosis(java.util.Set domainObjectSet)	
	{
		return createPatientDiagnosisForAppointmentOutcomeVoCollectionFromPatientDiagnosis(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.core.clinical.domain.objects.PatientDiagnosis objects.
	 */
	public static ims.RefMan.vo.PatientDiagnosisForAppointmentOutcomeVoCollection createPatientDiagnosisForAppointmentOutcomeVoCollectionFromPatientDiagnosis(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.RefMan.vo.PatientDiagnosisForAppointmentOutcomeVoCollection voList = new ims.RefMan.vo.PatientDiagnosisForAppointmentOutcomeVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.RefMan.vo.PatientDiagnosisForAppointmentOutcomeVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.RefMan.vo.PatientDiagnosisForAppointmentOutcomeVoCollection createPatientDiagnosisForAppointmentOutcomeVoCollectionFromPatientDiagnosis(java.util.List domainObjectList) 
	{
		return createPatientDiagnosisForAppointmentOutcomeVoCollectionFromPatientDiagnosis(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.core.clinical.domain.objects.PatientDiagnosis objects.
	 */
	public static ims.RefMan.vo.PatientDiagnosisForAppointmentOutcomeVoCollection createPatientDiagnosisForAppointmentOutcomeVoCollectionFromPatientDiagnosis(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.RefMan.vo.PatientDiagnosisForAppointmentOutcomeVoCollection voList = new ims.RefMan.vo.PatientDiagnosisForAppointmentOutcomeVoCollection();
	 ...
	 */
	 public static java.util.Set extractPatientDiagnosisSet(ims.domain.ILightweightDomainFactory domainFactory, ims.RefMan.vo.PatientDiagnosisForAppointmentOutcomeVoCollection voCollection) 
	 {
	 	return extractPatientDiagnosisSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractPatientDiagnosisSet(ims.domain.ILightweightDomainFactory domainFactory, ims.RefMan.vo.PatientDiagnosisForAppointmentOutcomeVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.RefMan.vo.PatientDiagnosisForAppointmentOutcomeVo vo = voCollection.get(i);
			ims.core.clinical.domain.objects.PatientDiagnosis domainObject = PatientDiagnosisForAppointmentOutcomeVoAssembler.extractPatientDiagnosis(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractPatientDiagnosisList(ims.domain.ILightweightDomainFactory domainFactory, ims.RefMan.vo.PatientDiagnosisForAppointmentOutcomeVoCollection voCollection) 
	 {
	 	return extractPatientDiagnosisList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractPatientDiagnosisList(ims.domain.ILightweightDomainFactory domainFactory, ims.RefMan.vo.PatientDiagnosisForAppointmentOutcomeVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.RefMan.vo.PatientDiagnosisForAppointmentOutcomeVo create(ims.core.clinical.domain.objects.PatientDiagnosis domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.RefMan.vo.PatientDiagnosisForAppointmentOutcomeVo create(DomainObjectMap map, ims.core.clinical.domain.objects.PatientDiagnosis domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.RefMan.vo.PatientDiagnosisForAppointmentOutcomeVo valueObject = (ims.RefMan.vo.PatientDiagnosisForAppointmentOutcomeVo) map.getValueObject(domainObject, ims.RefMan.vo.PatientDiagnosisForAppointmentOutcomeVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.RefMan.vo.PatientDiagnosisForAppointmentOutcomeVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.core.clinical.domain.objects.PatientDiagnosis
	 */
	 public static ims.RefMan.vo.PatientDiagnosisForAppointmentOutcomeVo insert(ims.RefMan.vo.PatientDiagnosisForAppointmentOutcomeVo valueObject, ims.core.clinical.domain.objects.PatientDiagnosis domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.core.clinical.domain.objects.PatientDiagnosis
	 */
	 public static ims.RefMan.vo.PatientDiagnosisForAppointmentOutcomeVo insert(DomainObjectMap map, ims.RefMan.vo.PatientDiagnosisForAppointmentOutcomeVo valueObject, ims.core.clinical.domain.objects.PatientDiagnosis domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
		...
		// CurrentStatus
		valueObject.setCurrentStatus(ims.RefMan.vo.domain.PatientDiagnosisStatusForAppointmentOutcomeVoAssembler.create(map, domainObject.getCurrentStatus()) );
		// diagnosedOnAdmission
	 ...
	 */
	public static ims.core.clinical.domain.objects.PatientDiagnosis extractPatientDiagnosis(ims.domain.ILightweightDomainFactory domainFactory, ims.RefMan.vo.PatientDiagnosisForAppointmentOutcomeVo valueObject) 
	{
		return 	extractPatientDiagnosis(domainFactory, valueObject, new HashMap());
	}

	public static ims.core.clinical.domain.objects.PatientDiagnosis extractPatientDiagnosis(ims.domain.ILightweightDomainFactory domainFactory, ims.RefMan.vo.PatientDiagnosisForAppointmentOutcomeVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.RefMan.vo.PatientDiagnosisForAppointmentOutcomeVo ID_PatientDiagnosis field is unknown
	...
	// SaveAsRefVO - treated as a refVo in extract methods
	ims.core.clinical.domain.objects.PatientDiagnosisStatus value8 = null;
		if ( null != valueObject.getCurrentStatus() ) 
		{
			if (valueObject.getCurrentStatus().getBoId() == null)
			{
				...
				{
					value8 = (ims.core.clinical.domain.objects.PatientDiagnosisStatus)domMap.get(valueObject.getCurrentStatus());
				}
			}
			else
			{
				value8 = (ims.core.clinical.domain.objects.PatientDiagnosisStatus)domainFactory.getDomainObject(ims.core.clinical.domain.objects.PatientDiagnosisStatus.class, valueObject.getCurrentStatus().getBoId());
			}
		}
		domainObject.setCurrentStatus(value8);
