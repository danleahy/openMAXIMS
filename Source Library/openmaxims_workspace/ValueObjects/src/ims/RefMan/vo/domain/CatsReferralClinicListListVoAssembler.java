...
public class CatsReferralClinicListListVoAssembler
{
	 ...
	 */
	 public static ims.RefMan.vo.CatsReferralClinicListListVo copy(ims.RefMan.vo.CatsReferralClinicListListVo valueObjectDest, ims.RefMan.vo.CatsReferralClinicListListVo valueObjectSrc) 
	 {
	 ...
	 */
	public static ims.RefMan.vo.CatsReferralClinicListListVoCollection createCatsReferralClinicListListVoCollectionFromCatsReferral(java.util.Set domainObjectSet)	
	{
	 ...
	 * @param domainObjectSet - Set of ims.RefMan.domain.objects.CatsReferral objects.
	 */
	public static ims.RefMan.vo.CatsReferralClinicListListVoCollection createCatsReferralClinicListListVoCollectionFromCatsReferral(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.RefMan.vo.CatsReferralClinicListListVoCollection voList = new ims.RefMan.vo.CatsReferralClinicListListVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.RefMan.vo.CatsReferralClinicListListVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.RefMan.vo.CatsReferralClinicListListVoCollection createCatsReferralClinicListListVoCollectionFromCatsReferral(java.util.List domainObjectList) 
	{
	 ...
	 * @param domainObjectList - List of ims.RefMan.domain.objects.CatsReferral objects.
	 */
	public static ims.RefMan.vo.CatsReferralClinicListListVoCollection createCatsReferralClinicListListVoCollectionFromCatsReferral(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.RefMan.vo.CatsReferralClinicListListVoCollection voList = new ims.RefMan.vo.CatsReferralClinicListListVoCollection();
	 ...
	 */
	 public static java.util.Set extractCatsReferralSet(ims.domain.ILightweightDomainFactory domainFactory, ims.RefMan.vo.CatsReferralClinicListListVoCollection voCollection) 
	 {
	 	return extractCatsReferralSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractCatsReferralSet(ims.domain.ILightweightDomainFactory domainFactory, ims.RefMan.vo.CatsReferralClinicListListVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.RefMan.vo.CatsReferralClinicListListVo vo = voCollection.get(i);
			ims.RefMan.domain.objects.CatsReferral domainObject = CatsReferralClinicListListVoAssembler.extractCatsReferral(domainFactory, vo, domMap);
	 ...
	 */
	 ...
	 public static java.util.List extractCatsReferralList(ims.domain.ILightweightDomainFactory domainFactory, ims.RefMan.vo.CatsReferralClinicListListVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.RefMan.vo.CatsReferralClinicListListVo create(ims.RefMan.domain.objects.CatsReferral domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.RefMan.vo.CatsReferralClinicListListVo create(DomainObjectMap map, ims.RefMan.domain.objects.CatsReferral domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.RefMan.vo.CatsReferralClinicListListVo valueObject = (ims.RefMan.vo.CatsReferralClinicListListVo) map.getValueObject(domainObject, ims.RefMan.vo.CatsReferralClinicListListVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.RefMan.vo.CatsReferralClinicListListVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.RefMan.domain.objects.CatsReferral
	 */
	 public static ims.RefMan.vo.CatsReferralClinicListListVo insert(ims.RefMan.vo.CatsReferralClinicListListVo valueObject, ims.RefMan.domain.objects.CatsReferral domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.RefMan.domain.objects.CatsReferral
	 */
	 public static ims.RefMan.vo.CatsReferralClinicListListVo insert(DomainObjectMap map, ims.RefMan.vo.CatsReferralClinicListListVo valueObject, ims.RefMan.domain.objects.CatsReferral domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
		...
		if ( null != instance9 ) {
			...
			ims.RefMan.vo.lookups.OnwardReferralStatus voLookup9 = new ims.RefMan.vo.lookups.OnwardReferralStatus(instance9.getId(),instance9.getText(), instance9.isActive(), null, img, color);
			ims.RefMan.vo.lookups.OnwardReferralStatus parentVoLookup9 = voLookup9;
			...
			while (parent9 != null)
			{
    			...
    			if (color != null) 
    				color.getValue();
								parentVoLookup9.setParent(new ims.RefMan.vo.lookups.OnwardReferralStatus(parent9.getId(),parent9.getText(), parent9.isActive(), null, img, color));
	 ...
	 */
	public static ims.RefMan.domain.objects.CatsReferral extractCatsReferral(ims.domain.ILightweightDomainFactory domainFactory, ims.RefMan.vo.CatsReferralClinicListListVo valueObject) 
	{
		return 	extractCatsReferral(domainFactory, valueObject, new HashMap());
	}

	public static ims.RefMan.domain.objects.CatsReferral extractCatsReferral(ims.domain.ILightweightDomainFactory domainFactory, ims.RefMan.vo.CatsReferralClinicListListVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.RefMan.vo.CatsReferralClinicListListVo ID_CatsReferral field is unknown
	...
	ims.RefMan.domain.objects.CATSReferralStatus value4 = null;
		if ( null != valueObject.getCurrentStatus() ) 
		{
			if (valueObject.getCurrentStatus().getBoId() == null)
			{
				...
				{
					value4 = (ims.RefMan.domain.objects.CATSReferralStatus)domMap.get(valueObject.getCurrentStatus());
				}
			}
			else
			{
				value4 = (ims.RefMan.domain.objects.CATSReferralStatus)domainFactory.getDomainObject(ims.RefMan.domain.objects.CATSReferralStatus.class, valueObject.getCurrentStatus().getBoId());
			}
		}
	...
	ims.core.clinical.domain.objects.ReferralLetterDetails value10 = null;
		...
		ims.RefMan.domain.objects.ProviderCancellation value11 = null;
		if ( null != valueObject.getProviderCancellation() ) 
		{
			if (valueObject.getProviderCancellation().getBoId() == null)
			{
				...
				{
					value11 = (ims.RefMan.domain.objects.ProviderCancellation)domMap.get(valueObject.getProviderCancellation());
				}
			}
			else if (valueObject.getBoVersion() == -1) // RefVo was not modified since obtained from the Assembler, no need to update the BO field
			{
			...
			{
				value11 = (ims.RefMan.domain.objects.ProviderCancellation)domainFactory.getDomainObject(ims.RefMan.domain.objects.ProviderCancellation.class, valueObject.getProviderCancellation().getBoId());
			}
		}
