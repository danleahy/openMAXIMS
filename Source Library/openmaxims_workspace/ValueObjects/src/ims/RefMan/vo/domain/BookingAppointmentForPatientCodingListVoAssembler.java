 ...
 */
public class BookingAppointmentForPatientCodingListVoAssembler
{
  	/**
	 ...
	 */
	 public static ims.RefMan.vo.BookingAppointmentForPatientCodingListVo copy(ims.RefMan.vo.BookingAppointmentForPatientCodingListVo valueObjectDest, ims.RefMan.vo.BookingAppointmentForPatientCodingListVo valueObjectSrc) 
	 {
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createBookingAppointmentForPatientCodingListVoCollectionFromBooking_Appointment(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.scheduling.domain.objects.Booking_Appointment objects.
	 */
	public static ims.RefMan.vo.BookingAppointmentForPatientCodingListVoCollection createBookingAppointmentForPatientCodingListVoCollectionFromBooking_Appointment(java.util.Set domainObjectSet)	
	{
		return createBookingAppointmentForPatientCodingListVoCollectionFromBooking_Appointment(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.scheduling.domain.objects.Booking_Appointment objects.
	 */
	public static ims.RefMan.vo.BookingAppointmentForPatientCodingListVoCollection createBookingAppointmentForPatientCodingListVoCollectionFromBooking_Appointment(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.RefMan.vo.BookingAppointmentForPatientCodingListVoCollection voList = new ims.RefMan.vo.BookingAppointmentForPatientCodingListVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.RefMan.vo.BookingAppointmentForPatientCodingListVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.RefMan.vo.BookingAppointmentForPatientCodingListVoCollection createBookingAppointmentForPatientCodingListVoCollectionFromBooking_Appointment(java.util.List domainObjectList) 
	{
		return createBookingAppointmentForPatientCodingListVoCollectionFromBooking_Appointment(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.scheduling.domain.objects.Booking_Appointment objects.
	 */
	public static ims.RefMan.vo.BookingAppointmentForPatientCodingListVoCollection createBookingAppointmentForPatientCodingListVoCollectionFromBooking_Appointment(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.RefMan.vo.BookingAppointmentForPatientCodingListVoCollection voList = new ims.RefMan.vo.BookingAppointmentForPatientCodingListVoCollection();
	 ...
	 */
	 public static java.util.Set extractBooking_AppointmentSet(ims.domain.ILightweightDomainFactory domainFactory, ims.RefMan.vo.BookingAppointmentForPatientCodingListVoCollection voCollection) 
	 {
	 	return extractBooking_AppointmentSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractBooking_AppointmentSet(ims.domain.ILightweightDomainFactory domainFactory, ims.RefMan.vo.BookingAppointmentForPatientCodingListVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.RefMan.vo.BookingAppointmentForPatientCodingListVo vo = voCollection.get(i);
			ims.scheduling.domain.objects.Booking_Appointment domainObject = BookingAppointmentForPatientCodingListVoAssembler.extractBooking_Appointment(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractBooking_AppointmentList(ims.domain.ILightweightDomainFactory domainFactory, ims.RefMan.vo.BookingAppointmentForPatientCodingListVoCollection voCollection) 
	 {
	 	return extractBooking_AppointmentList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractBooking_AppointmentList(ims.domain.ILightweightDomainFactory domainFactory, ims.RefMan.vo.BookingAppointmentForPatientCodingListVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.RefMan.vo.BookingAppointmentForPatientCodingListVo create(ims.scheduling.domain.objects.Booking_Appointment domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.RefMan.vo.BookingAppointmentForPatientCodingListVo create(DomainObjectMap map, ims.scheduling.domain.objects.Booking_Appointment domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.RefMan.vo.BookingAppointmentForPatientCodingListVo valueObject = (ims.RefMan.vo.BookingAppointmentForPatientCodingListVo) map.getValueObject(domainObject, ims.RefMan.vo.BookingAppointmentForPatientCodingListVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.RefMan.vo.BookingAppointmentForPatientCodingListVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.scheduling.domain.objects.Booking_Appointment
	 */
	 public static ims.RefMan.vo.BookingAppointmentForPatientCodingListVo insert(ims.RefMan.vo.BookingAppointmentForPatientCodingListVo valueObject, ims.scheduling.domain.objects.Booking_Appointment domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.scheduling.domain.objects.Booking_Appointment
	 */
	 public static ims.RefMan.vo.BookingAppointmentForPatientCodingListVo insert(DomainObjectMap map, ims.RefMan.vo.BookingAppointmentForPatientCodingListVo valueObject, ims.scheduling.domain.objects.Booking_Appointment domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
		...
		if ( null != instance3 ) {
			...
			valueObject.setApptStatus(voLookup3);
				...
				// Activity
		valueObject.setActivity(ims.RefMan.vo.domain.ActivityForPatientCodingListVoAssembler.create(map, domainObject.getActivity()) );
		// PASEvent
		...
		// Session
		valueObject.setSession(ims.RefMan.vo.domain.Sch_SessionForPatientCodingListVoAssembler.create(map, domainObject.getSession()) );
		// SessionSlot
		valueObject.setSessionSlot(ims.RefMan.vo.domain.SessionSlotForPatientCodingListVoAssembler.create(map, domainObject.getSessionSlot()) );
 		return valueObject;
	 }
	 ...
	 */
	public static ims.scheduling.domain.objects.Booking_Appointment extractBooking_Appointment(ims.domain.ILightweightDomainFactory domainFactory, ims.RefMan.vo.BookingAppointmentForPatientCodingListVo valueObject) 
	{
		return 	extractBooking_Appointment(domainFactory, valueObject, new HashMap());
	}

	public static ims.scheduling.domain.objects.Booking_Appointment extractBooking_Appointment(ims.domain.ILightweightDomainFactory domainFactory, ims.RefMan.vo.BookingAppointmentForPatientCodingListVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.RefMan.vo.BookingAppointmentForPatientCodingListVo ID_Booking_Appointment field is unknown
		...
		domainObject.setActivity(ims.RefMan.vo.domain.ActivityForPatientCodingListVoAssembler.extractActivity(domainFactory, valueObject.getActivity(), domMap));
		...
		if ( null != valueObject.getTheatreBooking() ) 
		{
			...
			{
				value6 = domainObject.getTheatreBooking();	
			}
			else
			{
	...
	ims.scheduling.domain.objects.Sch_Session value8 = null;
		if ( null != valueObject.getSession() ) 
		{
			if (valueObject.getSession().getBoId() == null)
			{
				...
				{
					value8 = (ims.scheduling.domain.objects.Sch_Session)domMap.get(valueObject.getSession());
				}
			}
			else
			{
				value8 = (ims.scheduling.domain.objects.Sch_Session)domainFactory.getDomainObject(ims.scheduling.domain.objects.Sch_Session.class, valueObject.getSession().getBoId());
			}
		}
		domainObject.setSession(value8);
	// SaveAsRefVO - treated as a refVo in extract methods
	ims.scheduling.domain.objects.Session_Slot value9 = null;
		if ( null != valueObject.getSessionSlot() ) 
		{
			if (valueObject.getSessionSlot().getBoId() == null)
			{
				...
				{
					value9 = (ims.scheduling.domain.objects.Session_Slot)domMap.get(valueObject.getSessionSlot());
				}
			}
			else
			{
				value9 = (ims.scheduling.domain.objects.Session_Slot)domainFactory.getDomainObject(ims.scheduling.domain.objects.Session_Slot.class, valueObject.getSessionSlot().getBoId());
			}
		}
		domainObject.setSessionSlot(value9);
