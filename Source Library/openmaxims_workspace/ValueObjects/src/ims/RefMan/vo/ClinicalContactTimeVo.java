 ...
 */
public class ClinicalContactTimeVo extends ims.RefMan.vo.ClinicalContactTimeRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public ClinicalContactTimeVo(ims.RefMan.vo.beans.ClinicalContactTimeVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.RefMan.vo.beans.ClinicalContactTimeVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.RefMan.vo.beans.ClinicalContactTimeVoBean bean = null;
		if(map != null)
			bean = (ims.RefMan.vo.beans.ClinicalContactTimeVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.RefMan.vo.beans.ClinicalContactTimeVoBean();
