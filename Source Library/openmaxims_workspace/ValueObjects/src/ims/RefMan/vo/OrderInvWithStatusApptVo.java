 ...
 */
public class OrderInvWithStatusApptVo extends ims.RefMan.vo.OrderInvApptRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public OrderInvWithStatusApptVo(ims.RefMan.vo.beans.OrderInvWithStatusApptVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.RefMan.vo.beans.OrderInvWithStatusApptVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.RefMan.vo.beans.OrderInvWithStatusApptVoBean bean = null;
		if(map != null)
			bean = (ims.RefMan.vo.beans.OrderInvWithStatusApptVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.RefMan.vo.beans.OrderInvWithStatusApptVoBean();
