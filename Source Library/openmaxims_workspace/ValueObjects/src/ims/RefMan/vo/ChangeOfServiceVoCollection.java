...
public class ChangeOfServiceVoCollection extends ims.vo.ValueObjectCollection implements ims.vo.ImsCloneable, Iterable<ChangeOfServiceVo>
{
	...
	public ims.RefMan.vo.ChangeOfServiceRefVoCollection toRefVoCollection()
	{
		ims.RefMan.vo.ChangeOfServiceRefVoCollection result = new ims.RefMan.vo.ChangeOfServiceRefVoCollection();
		for(int x = 0; x < this.col.size(); x++)
		{
	...
	public ims.RefMan.vo.beans.ChangeOfServiceVoBean[] getBeanCollection()
	{
		return getBeanCollectionArray();
	}
	public ims.RefMan.vo.beans.ChangeOfServiceVoBean[] getBeanCollectionArray()
	{
		ims.RefMan.vo.beans.ChangeOfServiceVoBean[] result = new ims.RefMan.vo.beans.ChangeOfServiceVoBean[col.size()];
		for(int i = 0; i < col.size(); i++)
		{
			ChangeOfServiceVo vo = ((ChangeOfServiceVo)col.get(i));
			result[i] = (ims.RefMan.vo.beans.ChangeOfServiceVoBean)vo.getBean();
		}
		return result;
	}
	public static ChangeOfServiceVoCollection buildFromBeanCollection(java.util.Collection beans)
	{
		...
		while (iter.hasNext())
		{
			coll.add(((ims.RefMan.vo.beans.ChangeOfServiceVoBean)iter.next()).buildVo());
		}
		return coll;
	}
	public static ChangeOfServiceVoCollection buildFromBeanCollection(ims.RefMan.vo.beans.ChangeOfServiceVoBean[] beans)
	{
		ChangeOfServiceVoCollection coll = new ChangeOfServiceVoCollection();
		if(beans == null)
			return coll;
