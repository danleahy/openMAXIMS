 ...
 */
public class DischargeEpisodeForPatientCodingListShortVo extends ims.core.admin.pas.vo.DischargedEpisodeRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public DischargeEpisodeForPatientCodingListShortVo()
	{
	}
	public DischargeEpisodeForPatientCodingListShortVo(Integer id, int version)
	{
		super(id, version);
	}
	public DischargeEpisodeForPatientCodingListShortVo(ims.RefMan.vo.beans.DischargeEpisodeForPatientCodingListShortVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.RefMan.vo.beans.DischargeEpisodeForPatientCodingListShortVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.wardstays = ims.RefMan.vo.WardStayForPatientCodingListVoCollection.buildFromBeanCollection(bean.getWardStays());
	...
	{
		ims.RefMan.vo.beans.DischargeEpisodeForPatientCodingListShortVoBean bean = null;
		if(map != null)
			bean = (ims.RefMan.vo.beans.DischargeEpisodeForPatientCodingListShortVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.RefMan.vo.beans.DischargeEpisodeForPatientCodingListShortVoBean();
	...
	public Object clone()
	{
		...
		DischargeEpisodeForPatientCodingListShortVo clone = new DischargeEpisodeForPatientCodingListShortVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(DischargeEpisodeForPatientCodingListShortVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A DischargeEpisodeForPatientCodingListShortVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((DischargeEpisodeForPatientCodingListShortVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((DischargeEpisodeForPatientCodingListShortVo)obj).getBoId());
	}
