 ...
 */
public class AwaitingHistologyVo extends ims.clinical.vo.AwaitingHistologyRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public AwaitingHistologyVo()
	{
	}
	public AwaitingHistologyVo(Integer id, int version)
	{
		super(id, version);
	}
	public AwaitingHistologyVo(ims.RefMan.vo.beans.AwaitingHistologyVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.RefMan.vo.beans.AwaitingHistologyVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.authoringdatetime = bean.getAuthoringDateTime() == null ? null : bean.getAuthoringDateTime().buildDateTime();
	...
	{
		ims.RefMan.vo.beans.AwaitingHistologyVoBean bean = null;
		if(map != null)
			bean = (ims.RefMan.vo.beans.AwaitingHistologyVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.RefMan.vo.beans.AwaitingHistologyVoBean();
	...
	public Object clone()
	{
		...
		AwaitingHistologyVo clone = new AwaitingHistologyVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(AwaitingHistologyVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A AwaitingHistologyVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((AwaitingHistologyVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((AwaitingHistologyVo)obj).getBoId());
	}
