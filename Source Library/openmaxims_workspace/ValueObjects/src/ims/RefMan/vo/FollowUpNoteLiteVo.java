 ...
 */
public class FollowUpNoteLiteVo extends ims.RefMan.vo.FollowUpNoteRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public FollowUpNoteLiteVo(ims.RefMan.vo.beans.FollowUpNoteLiteVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.RefMan.vo.beans.FollowUpNoteLiteVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.catsreferral = bean.getCatsReferral() == null ? null : new ims.RefMan.vo.CatsReferralRefVo(new Integer(bean.getCatsReferral().getId()), bean.getCatsReferral().getVersion());
	...
	{
		ims.RefMan.vo.beans.FollowUpNoteLiteVoBean bean = null;
		if(map != null)
			bean = (ims.RefMan.vo.beans.FollowUpNoteLiteVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.RefMan.vo.beans.FollowUpNoteLiteVoBean();
