 ...
 */
public class ReferralERODForBookAppointmentVo extends ims.RefMan.vo.ReferralERODRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public ReferralERODForBookAppointmentVo(ims.RefMan.vo.beans.ReferralERODForBookAppointmentVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.RefMan.vo.beans.ReferralERODForBookAppointmentVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.eroddate1 = bean.getERODDate1() == null ? null : bean.getERODDate1().buildDate();
	...
	{
		ims.RefMan.vo.beans.ReferralERODForBookAppointmentVoBean bean = null;
		if(map != null)
			bean = (ims.RefMan.vo.beans.ReferralERODForBookAppointmentVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.RefMan.vo.beans.ReferralERODForBookAppointmentVoBean();
