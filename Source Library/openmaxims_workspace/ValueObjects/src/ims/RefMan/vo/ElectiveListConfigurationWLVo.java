 ...
 */
public class ElectiveListConfigurationWLVo extends ims.core.configuration.vo.ElectiveListConfigurationRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public ElectiveListConfigurationWLVo()
	{
	}
	public ElectiveListConfigurationWLVo(Integer id, int version)
	{
		super(id, version);
	}
	public ElectiveListConfigurationWLVo(ims.RefMan.vo.beans.ElectiveListConfigurationWLVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.RefMan.vo.beans.ElectiveListConfigurationWLVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.waitinglistname = bean.getWaitingListName();
	...
	{
		ims.RefMan.vo.beans.ElectiveListConfigurationWLVoBean bean = null;
		if(map != null)
			bean = (ims.RefMan.vo.beans.ElectiveListConfigurationWLVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.RefMan.vo.beans.ElectiveListConfigurationWLVoBean();
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.waitinglistname == null || this.waitinglistname.length() == 0)
			...
			listOfErrors.add("The length of the field [waitinglistname] in the value object [ims.RefMan.vo.ElectiveListConfigurationWLVo] is too big. It should be less or equal to 150");
		...
		if(this.waitinglistcode != null)
			if(this.waitinglistcode.length() > 20)
				listOfErrors.add("The length of the field [waitinglistcode] in the value object [ims.RefMan.vo.ElectiveListConfigurationWLVo] is too big. It should be less or equal to 20");
	...
	public Object clone()
	{
		...
		ElectiveListConfigurationWLVo clone = new ElectiveListConfigurationWLVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(ElectiveListConfigurationWLVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A ElectiveListConfigurationWLVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((ElectiveListConfigurationWLVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((ElectiveListConfigurationWLVo)obj).getBoId());
	}
