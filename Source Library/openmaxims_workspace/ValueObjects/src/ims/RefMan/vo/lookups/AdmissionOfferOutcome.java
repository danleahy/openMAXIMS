...
public class AdmissionOfferOutcome extends ims.vo.LookupInstVo implements TreeNode
{
	...
	public static ims.framework.IItemCollection getNegativeInstancesAsIItemCollection()
	{
		...
		result.add(TCI_AMENDED);
		return result;
	}
	public static AdmissionOfferOutcome[] getNegativeInstances()
	{
		AdmissionOfferOutcome[] instances = new AdmissionOfferOutcome[10];
	...
	public static String[] getNegativeInstanceNames()
	{
		...
		negativeInstances[9] = "TCI_AMENDED";
	...
	public static final AdmissionOfferOutcome NOT_APPLICABLE_OR_REMOVED_ETC_9 = new AdmissionOfferOutcome(-2677, "Not Applicable or Removed or Similar", true, null, null, Color.Default);
	public static final AdmissionOfferOutcome TCI_AMENDED = new AdmissionOfferOutcome(-3455, "TCI Amended", true, null, null, Color.Black);
}
