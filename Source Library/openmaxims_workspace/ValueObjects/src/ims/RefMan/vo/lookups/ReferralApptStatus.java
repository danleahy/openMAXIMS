...
public class ReferralApptStatus extends ims.vo.LookupInstVo implements TreeNode
{
	...
	public static ims.framework.IItemCollection getNegativeInstancesAsIItemCollection()
	{
		...
		result.add(FIRST_CONSULTATION_APPOINTMENT_CANCELLED);
		result.add(TRANSFERRED);
		return result;
	}
	public static ReferralApptStatus[] getNegativeInstances()
	{
		ReferralApptStatus[] instances = new ReferralApptStatus[17];
		...
		instances[15] = FIRST_CONSULTATION_APPOINTMENT_CANCELLED;
		instances[16] = TRANSFERRED;
		return instances;
	}
	public static String[] getNegativeInstanceNames()
	{
		...
		negativeInstances[15] = "FIRST_CONSULTATION_APPOINTMENT_CANCELLED";
		negativeInstances[16] = "TRANSFERRED";
	...
	public static final ReferralApptStatus END_OF_CARE = new ReferralApptStatus(-2134, "End Of Treatment", true, null, null, Color.Default);
	...
	public static final ReferralApptStatus FIRST_CONSULTATION_APPOINTMENT_CANCELLED = new ReferralApptStatus(-3006, "First Consultation Appointment Cancelled", true, null, null, Color.Default);
	public static final ReferralApptStatus TRANSFERRED = new ReferralApptStatus(-3155, "Transferred", true, null, null, Color.Default);
}
