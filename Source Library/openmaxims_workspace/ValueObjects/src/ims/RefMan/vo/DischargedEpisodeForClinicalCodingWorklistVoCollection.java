...
public class DischargedEpisodeForClinicalCodingWorklistVoCollection extends ims.vo.ValueObjectCollection implements ims.vo.ImsCloneable, Iterable<DischargedEpisodeForClinicalCodingWorklistVo>
{
	...
	public ims.RefMan.vo.beans.DischargedEpisodeForClinicalCodingWorklistVoBean[] getBeanCollection()
	{
		return getBeanCollectionArray();
	}
	public ims.RefMan.vo.beans.DischargedEpisodeForClinicalCodingWorklistVoBean[] getBeanCollectionArray()
	{
		ims.RefMan.vo.beans.DischargedEpisodeForClinicalCodingWorklistVoBean[] result = new ims.RefMan.vo.beans.DischargedEpisodeForClinicalCodingWorklistVoBean[col.size()];
		for(int i = 0; i < col.size(); i++)
		{
			DischargedEpisodeForClinicalCodingWorklistVo vo = ((DischargedEpisodeForClinicalCodingWorklistVo)col.get(i));
			result[i] = (ims.RefMan.vo.beans.DischargedEpisodeForClinicalCodingWorklistVoBean)vo.getBean();
		}
		return result;
	}
	public static DischargedEpisodeForClinicalCodingWorklistVoCollection buildFromBeanCollection(java.util.Collection beans)
	{
		...
		while (iter.hasNext())
		{
			coll.add(((ims.RefMan.vo.beans.DischargedEpisodeForClinicalCodingWorklistVoBean)iter.next()).buildVo());
		}
		return coll;
	}
	public static DischargedEpisodeForClinicalCodingWorklistVoCollection buildFromBeanCollection(ims.RefMan.vo.beans.DischargedEpisodeForClinicalCodingWorklistVoBean[] beans)
	{
		DischargedEpisodeForClinicalCodingWorklistVoCollection coll = new DischargedEpisodeForClinicalCodingWorklistVoCollection();
		if(beans == null)
			return coll;
