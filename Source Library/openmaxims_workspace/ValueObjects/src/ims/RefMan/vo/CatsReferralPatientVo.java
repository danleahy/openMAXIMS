 ...
 */
public class CatsReferralPatientVo extends ims.RefMan.vo.CatsReferralRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public CatsReferralPatientVo()
	{
	}
	public CatsReferralPatientVo(Integer id, int version)
	{
		super(id, version);
	}
	public CatsReferralPatientVo(ims.RefMan.vo.beans.CatsReferralPatientVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.RefMan.vo.beans.CatsReferralPatientVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.RefMan.vo.beans.CatsReferralPatientVoBean bean = null;
		if(map != null)
			bean = (ims.RefMan.vo.beans.CatsReferralPatientVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.RefMan.vo.beans.CatsReferralPatientVoBean();
	...
	public Object clone()
	{
		...
		CatsReferralPatientVo clone = new CatsReferralPatientVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(CatsReferralPatientVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A CatsReferralPatientVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((CatsReferralPatientVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((CatsReferralPatientVo)obj).getBoId());
	}
