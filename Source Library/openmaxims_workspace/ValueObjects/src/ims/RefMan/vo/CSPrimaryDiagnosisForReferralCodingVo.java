 ...
 */
public class CSPrimaryDiagnosisForReferralCodingVo extends ims.core.clinical.vo.CsPrimaryDiagnosisRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public CSPrimaryDiagnosisForReferralCodingVo()
	{
	}
	public CSPrimaryDiagnosisForReferralCodingVo(Integer id, int version)
	{
		super(id, version);
	}
	public CSPrimaryDiagnosisForReferralCodingVo(ims.RefMan.vo.beans.CSPrimaryDiagnosisForReferralCodingVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.RefMan.vo.beans.CSPrimaryDiagnosisForReferralCodingVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.carecontext = bean.getCareContext() == null ? null : new ims.core.admin.vo.CareContextRefVo(new Integer(bean.getCareContext().getId()), bean.getCareContext().getVersion());
	...
	{
		ims.RefMan.vo.beans.CSPrimaryDiagnosisForReferralCodingVoBean bean = null;
		if(map != null)
			bean = (ims.RefMan.vo.beans.CSPrimaryDiagnosisForReferralCodingVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.RefMan.vo.beans.CSPrimaryDiagnosisForReferralCodingVoBean();
	...
	public Object clone()
	{
		...
		CSPrimaryDiagnosisForReferralCodingVo clone = new CSPrimaryDiagnosisForReferralCodingVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(CSPrimaryDiagnosisForReferralCodingVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A CSPrimaryDiagnosisForReferralCodingVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((CSPrimaryDiagnosisForReferralCodingVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((CSPrimaryDiagnosisForReferralCodingVo)obj).getBoId());
	}
