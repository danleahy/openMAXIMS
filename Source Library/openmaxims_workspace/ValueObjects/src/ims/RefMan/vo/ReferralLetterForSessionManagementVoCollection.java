...
public class ReferralLetterForSessionManagementVoCollection extends ims.vo.ValueObjectCollection implements ims.vo.ImsCloneable, Iterable<ReferralLetterForSessionManagementVo>
{
	...
	public ims.RefMan.vo.beans.ReferralLetterForSessionManagementVoBean[] getBeanCollection()
	{
		return getBeanCollectionArray();
	}
	public ims.RefMan.vo.beans.ReferralLetterForSessionManagementVoBean[] getBeanCollectionArray()
	{
		ims.RefMan.vo.beans.ReferralLetterForSessionManagementVoBean[] result = new ims.RefMan.vo.beans.ReferralLetterForSessionManagementVoBean[col.size()];
		for(int i = 0; i < col.size(); i++)
		{
			ReferralLetterForSessionManagementVo vo = ((ReferralLetterForSessionManagementVo)col.get(i));
			result[i] = (ims.RefMan.vo.beans.ReferralLetterForSessionManagementVoBean)vo.getBean();
		}
		return result;
	}
	public static ReferralLetterForSessionManagementVoCollection buildFromBeanCollection(java.util.Collection beans)
	{
		...
		while (iter.hasNext())
		{
			coll.add(((ims.RefMan.vo.beans.ReferralLetterForSessionManagementVoBean)iter.next()).buildVo());
		}
		return coll;
	}
	public static ReferralLetterForSessionManagementVoCollection buildFromBeanCollection(ims.RefMan.vo.beans.ReferralLetterForSessionManagementVoBean[] beans)
	{
		ReferralLetterForSessionManagementVoCollection coll = new ReferralLetterForSessionManagementVoCollection();
		if(beans == null)
			return coll;
