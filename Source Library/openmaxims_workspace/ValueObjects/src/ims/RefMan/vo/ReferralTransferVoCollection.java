...
public class ReferralTransferVoCollection extends ims.vo.ValueObjectCollection implements ims.vo.ImsCloneable, Iterable<ReferralTransferVo>
{
	...
	public ims.RefMan.vo.ReferralTransferRefVoCollection toRefVoCollection()
	{
		ims.RefMan.vo.ReferralTransferRefVoCollection result = new ims.RefMan.vo.ReferralTransferRefVoCollection();
		for(int x = 0; x < this.col.size(); x++)
		{
	...
	public ims.RefMan.vo.beans.ReferralTransferVoBean[] getBeanCollection()
	{
		return getBeanCollectionArray();
	}
	public ims.RefMan.vo.beans.ReferralTransferVoBean[] getBeanCollectionArray()
	{
		ims.RefMan.vo.beans.ReferralTransferVoBean[] result = new ims.RefMan.vo.beans.ReferralTransferVoBean[col.size()];
		for(int i = 0; i < col.size(); i++)
		{
			ReferralTransferVo vo = ((ReferralTransferVo)col.get(i));
			result[i] = (ims.RefMan.vo.beans.ReferralTransferVoBean)vo.getBean();
		}
		return result;
	}
	public static ReferralTransferVoCollection buildFromBeanCollection(java.util.Collection beans)
	{
		...
		while (iter.hasNext())
		{
			coll.add(((ims.RefMan.vo.beans.ReferralTransferVoBean)iter.next()).buildVo());
		}
		return coll;
	}
	public static ReferralTransferVoCollection buildFromBeanCollection(ims.RefMan.vo.beans.ReferralTransferVoBean[] beans)
	{
		ReferralTransferVoCollection coll = new ReferralTransferVoCollection();
		if(beans == null)
			return coll;
