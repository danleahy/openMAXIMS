 ...
 */
public class ReferralLetterLiteForWorklistVo extends ims.core.clinical.vo.ReferralLetterDetailsRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public ReferralLetterLiteForWorklistVo()
	{
	}
	public ReferralLetterLiteForWorklistVo(Integer id, int version)
	{
		super(id, version);
	}
	public ReferralLetterLiteForWorklistVo(ims.RefMan.vo.beans.ReferralLetterLiteForWorklistVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.RefMan.vo.beans.ReferralLetterLiteForWorklistVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.dateofreferral = bean.getDateOfReferral() == null ? null : bean.getDateOfReferral().buildDate();
	...
	{
		ims.RefMan.vo.beans.ReferralLetterLiteForWorklistVoBean bean = null;
		if(map != null)
			bean = (ims.RefMan.vo.beans.ReferralLetterLiteForWorklistVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.RefMan.vo.beans.ReferralLetterLiteForWorklistVoBean();
	...
	public Object clone()
	{
		...
		ReferralLetterLiteForWorklistVo clone = new ReferralLetterLiteForWorklistVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(ReferralLetterLiteForWorklistVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A ReferralLetterLiteForWorklistVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((ReferralLetterLiteForWorklistVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((ReferralLetterLiteForWorklistVo)obj).getBoId());
	}
