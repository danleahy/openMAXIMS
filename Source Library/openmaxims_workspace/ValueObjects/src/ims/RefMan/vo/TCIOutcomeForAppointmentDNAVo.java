	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.reasoncomments != null)
			if(this.reasoncomments.length() > 255)
				listOfErrors.add("The length of the field [reasoncomments] in the value object [ims.RefMan.vo.TCIOutcomeForAppointmentDNAVo] is too big. It should be less or equal to 255");
