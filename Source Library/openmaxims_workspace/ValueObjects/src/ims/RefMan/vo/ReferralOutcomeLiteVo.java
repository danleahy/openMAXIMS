 ...
 */
public class ReferralOutcomeLiteVo extends ims.RefMan.vo.ReferralOutcomeRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public ReferralOutcomeLiteVo(ims.RefMan.vo.beans.ReferralOutcomeLiteVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.RefMan.vo.beans.ReferralOutcomeLiteVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.catsreferral = bean.getCatsReferral() == null ? null : new ims.RefMan.vo.CatsReferralRefVo(new Integer(bean.getCatsReferral().getId()), bean.getCatsReferral().getVersion());
	...
	{
		ims.RefMan.vo.beans.ReferralOutcomeLiteVoBean bean = null;
		if(map != null)
			bean = (ims.RefMan.vo.beans.ReferralOutcomeLiteVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.RefMan.vo.beans.ReferralOutcomeLiteVoBean();
