 ...
 */
public class PatientJourneyBreachForTransferOfCareVo extends ims.pathways.vo.PatientJourneyBreachRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public PatientJourneyBreachForTransferOfCareVo()
	{
	}
	public PatientJourneyBreachForTransferOfCareVo(Integer id, int version)
	{
		super(id, version);
	}
	public PatientJourneyBreachForTransferOfCareVo(ims.RefMan.vo.beans.PatientJourneyBreachForTransferOfCareVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.RefMan.vo.beans.PatientJourneyBreachForTransferOfCareVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.breachreason = bean.getBreachReason() == null ? null : ims.pathways.vo.lookups.PatientJourneyBreachReason.buildLookup(bean.getBreachReason());
	...
	{
		ims.RefMan.vo.beans.PatientJourneyBreachForTransferOfCareVoBean bean = null;
		if(map != null)
			bean = (ims.RefMan.vo.beans.PatientJourneyBreachForTransferOfCareVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.RefMan.vo.beans.PatientJourneyBreachForTransferOfCareVoBean();
	...
	public boolean isValidated()
	{
		...
		{
			if(!this.breachreasonrecordingmos.isValidated())
			{
				this.isBusy = false;
				return false;
			}
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.breachreasonrecordingmos != null)
		{
			String[] listOfOtherErrors = this.breachreasonrecordingmos.validate();
	...
	public Object clone()
	{
		...
		PatientJourneyBreachForTransferOfCareVo clone = new PatientJourneyBreachForTransferOfCareVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(PatientJourneyBreachForTransferOfCareVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A PatientJourneyBreachForTransferOfCareVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((PatientJourneyBreachForTransferOfCareVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((PatientJourneyBreachForTransferOfCareVo)obj).getBoId());
	}
