 ...
 */
public class RecordingUserInformationForWLCVo extends ims.core.clinical.vo.RecordingUserInformationRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public RecordingUserInformationForWLCVo()
	{
	}
	public RecordingUserInformationForWLCVo(Integer id, int version)
	{
		super(id, version);
	}
	public RecordingUserInformationForWLCVo(ims.RefMan.vo.beans.RecordingUserInformationForWLCVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.RefMan.vo.beans.RecordingUserInformationForWLCVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.RefMan.vo.beans.RecordingUserInformationForWLCVoBean bean = null;
		if(map != null)
			bean = (ims.RefMan.vo.beans.RecordingUserInformationForWLCVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.RefMan.vo.beans.RecordingUserInformationForWLCVoBean();
	...
	public Object clone()
	{
		...
		RecordingUserInformationForWLCVo clone = new RecordingUserInformationForWLCVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(RecordingUserInformationForWLCVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A RecordingUserInformationForWLCVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((RecordingUserInformationForWLCVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((RecordingUserInformationForWLCVo)obj).getBoId());
	}
