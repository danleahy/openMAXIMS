	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.erodreasoncomment != null)
			if(this.erodreasoncomment.length() > 1500)
				listOfErrors.add("The length of the field [erodreasoncomment] in the value object [ims.RefMan.vo.ReferralERODVo] is too big. It should be less or equal to 1500");
