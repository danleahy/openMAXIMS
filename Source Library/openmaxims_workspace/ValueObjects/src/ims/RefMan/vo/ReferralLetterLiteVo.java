 ...
 */
public class ReferralLetterLiteVo extends ims.core.clinical.vo.ReferralLetterDetailsRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public ReferralLetterLiteVo()
	{
	}
	public ReferralLetterLiteVo(Integer id, int version)
	{
		super(id, version);
	}
	public ReferralLetterLiteVo(ims.RefMan.vo.beans.ReferralLetterLiteVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.RefMan.vo.beans.ReferralLetterLiteVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.end18ww = bean.getEnd18WW() == null ? null : bean.getEnd18WW().buildDate();
	...
	{
		ims.RefMan.vo.beans.ReferralLetterLiteVoBean bean = null;
		if(map != null)
			bean = (ims.RefMan.vo.beans.ReferralLetterLiteVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.RefMan.vo.beans.ReferralLetterLiteVoBean();
	...
	public Object clone()
	{
		...
		ReferralLetterLiteVo clone = new ReferralLetterLiteVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(ReferralLetterLiteVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A ReferralLetterLiteVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((ReferralLetterLiteVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((ReferralLetterLiteVo)obj).getBoId());
	}
