...
public class PathologyOrdersResultsSearchCriteriaVoBean extends ims.vo.ValueObjectBean
{
	public PathologyOrdersResultsSearchCriteriaVoBean()
	{
	}
	public PathologyOrdersResultsSearchCriteriaVoBean(ims.ocrr.vo.PathologyOrdersResultsSearchCriteriaVo vo)
	{
		...
		this.inpatientoutpatientsearchtype = vo.getInpatientOutpatientSearchType();
		this.checked = vo.getChecked();
		this.unchecked = vo.getUnchecked();
	}

	public void populate(ims.vo.ValueObjectBeanMap map, ims.ocrr.vo.PathologyOrdersResultsSearchCriteriaVo vo)
	{
		this.fromdate = vo.getFromDate() == null ? null : (ims.framework.utils.beans.DateBean)vo.getFromDate().getBean();
		this.todate = vo.getToDate() == null ? null : (ims.framework.utils.beans.DateBean)vo.getToDate().getBean();
	...
	public ims.ocrr.vo.PathologyOrdersResultsSearchCriteriaVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.ocrr.vo.PathologyOrdersResultsSearchCriteriaVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.ocrr.vo.PathologyOrdersResultsSearchCriteriaVo vo = null;
		if(map != null)
			vo = (ims.ocrr.vo.PathologyOrdersResultsSearchCriteriaVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.ocrr.vo.PathologyOrdersResultsSearchCriteriaVo();
	...
	private Integer inpatientoutpatientsearchtype;
