...
public class ClinicalOrdersResultsSearchCriteriaVo extends ims.vo.ValueObject implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public ClinicalOrdersResultsSearchCriteriaVo()
	{
	}
	public ClinicalOrdersResultsSearchCriteriaVo(ims.ocrr.vo.beans.ClinicalOrdersResultsSearchCriteriaVoBean bean)
	{
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.ocrr.vo.beans.ClinicalOrdersResultsSearchCriteriaVoBean bean)
	{
		this.fromdate = bean.getFromDate() == null ? null : bean.getFromDate().buildDate();
		this.todate = bean.getToDate() == null ? null : bean.getToDate().buildDate();
	...
	{
		ims.ocrr.vo.beans.ClinicalOrdersResultsSearchCriteriaVoBean bean = null;
		if(map != null)
			bean = (ims.ocrr.vo.beans.ClinicalOrdersResultsSearchCriteriaVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.ocrr.vo.beans.ClinicalOrdersResultsSearchCriteriaVoBean();
	...
	public Object clone()
	{
		...
		ClinicalOrdersResultsSearchCriteriaVo clone = new ClinicalOrdersResultsSearchCriteriaVo();
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(ClinicalOrdersResultsSearchCriteriaVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A ClinicalOrdersResultsSearchCriteriaVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		ClinicalOrdersResultsSearchCriteriaVo compareObj = (ClinicalOrdersResultsSearchCriteriaVo)obj;
		int retVal = 0;
		if (retVal == 0)
		{
