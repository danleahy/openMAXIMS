...
public class PathologyOrdersSearchCriteriaVo extends ims.vo.ValueObject implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public PathologyOrdersSearchCriteriaVo()
	{
	}
	public PathologyOrdersSearchCriteriaVo(ims.ocrr.vo.beans.PathologyOrdersSearchCriteriaVoBean bean)
	{
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.ocrr.vo.beans.PathologyOrdersSearchCriteriaVoBean bean)
	{
	...
	{
		ims.ocrr.vo.beans.PathologyOrdersSearchCriteriaVoBean bean = null;
		if(map != null)
			bean = (ims.ocrr.vo.beans.PathologyOrdersSearchCriteriaVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.ocrr.vo.beans.PathologyOrdersSearchCriteriaVoBean();
	...
	public Object clone()
	{
		...
		PathologyOrdersSearchCriteriaVo clone = new PathologyOrdersSearchCriteriaVo();
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(PathologyOrdersSearchCriteriaVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A PathologyOrdersSearchCriteriaVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		PathologyOrdersSearchCriteriaVo compareObj = (PathologyOrdersSearchCriteriaVo)obj;
		int retVal = 0;
		if (retVal == 0)
		{
