...
public class RadiologyOrdersResultsSearchCriteriaVo extends ims.vo.ValueObject implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public RadiologyOrdersResultsSearchCriteriaVo()
	{
	}
	public RadiologyOrdersResultsSearchCriteriaVo(ims.ocrr.vo.beans.RadiologyOrdersResultsSearchCriteriaVoBean bean)
	{
		...
		this.inpatientoutpatientoption = bean.getInpatientOutpatientOption();
		this.checked = bean.getChecked();
		this.unchecked = bean.getUnchecked();
	}
	public void populate(ims.vo.ValueObjectBeanMap map, ims.ocrr.vo.beans.RadiologyOrdersResultsSearchCriteriaVoBean bean)
	{
		this.fromdate = bean.getFromDate() == null ? null : bean.getFromDate().buildDate();
		this.todate = bean.getToDate() == null ? null : bean.getToDate().buildDate();
	...
	{
		ims.ocrr.vo.beans.RadiologyOrdersResultsSearchCriteriaVoBean bean = null;
		if(map != null)
			bean = (ims.ocrr.vo.beans.RadiologyOrdersResultsSearchCriteriaVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.ocrr.vo.beans.RadiologyOrdersResultsSearchCriteriaVoBean();
	...
	public boolean getInpatientOutpatientOptionIsNotNull()
	{
		return this.inpatientoutpatientoption != null;
	}
	...
	public Object clone()
	{
		...
		RadiologyOrdersResultsSearchCriteriaVo clone = new RadiologyOrdersResultsSearchCriteriaVo();
		...
		clone.inpatientoutpatientoption = this.inpatientoutpatientoption;
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(RadiologyOrdersResultsSearchCriteriaVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A RadiologyOrdersResultsSearchCriteriaVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		RadiologyOrdersResultsSearchCriteriaVo compareObj = (RadiologyOrdersResultsSearchCriteriaVo)obj;
		int retVal = 0;
		if (retVal == 0)
		{
	...
	public int countFieldsWithValue()
	{
		...
		if(this.patient != null)
			count++;
		if(this.inpatientoutpatientoption != null)
			count++;
	...
	protected Integer inpatientoutpatientoption;
