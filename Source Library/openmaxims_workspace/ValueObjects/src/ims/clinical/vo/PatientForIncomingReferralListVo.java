 ...
 */
public class PatientForIncomingReferralListVo extends ims.core.patient.vo.PatientRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public PatientForIncomingReferralListVo()
	{
	}
	public PatientForIncomingReferralListVo(Integer id, int version)
	{
		super(id, version);
	}
	public PatientForIncomingReferralListVo(ims.clinical.vo.beans.PatientForIncomingReferralListVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.clinical.vo.beans.PatientForIncomingReferralListVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.clinical.vo.beans.PatientForIncomingReferralListVoBean bean = null;
		if(map != null)
			bean = (ims.clinical.vo.beans.PatientForIncomingReferralListVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.clinical.vo.beans.PatientForIncomingReferralListVoBean();
	...
	*/
	...
	public Object clone()
	{
		...
		PatientForIncomingReferralListVo clone = new PatientForIncomingReferralListVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(PatientForIncomingReferralListVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A PatientForIncomingReferralListVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		PatientForIncomingReferralListVo compareObj = (PatientForIncomingReferralListVo)obj;
		int retVal = 0;
		if (retVal == 0)
		{
