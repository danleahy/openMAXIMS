...
public class DementiaAssessAndInvestigateVo extends ims.core.clinical.vo.DementiaAssessAndInvestigateRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	*/
	public String getRecordBrowserText()
	{
		...
		recordBrowserText.append(getAuthoringInformation().toString(" "));
		recordBrowserText.append(" - Score: ");
		recordBrowserText.append(getAMTSScore());
			
		return recordBrowserText.toString();
	}
