...
public class DischargeLetterStatus extends ims.vo.LookupInstVo implements TreeNode
{
	...
	{
		DischargeLetterStatus[] instances = new DischargeLetterStatus[3];
		instances[0] = IN_PROGRESS;
		instances[1] = GENERATED;
		instances[2] = ARCHIVED;
		return instances;
	}
	...
	public static final DischargeLetterStatus ARCHIVED = new DischargeLetterStatus(-2691, "Archived", true, null, null, Color.Default);
}
