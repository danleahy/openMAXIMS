...
public class ReferralLetterDetailsVo extends ims.core.clinical.vo.ReferralLetterDetailsRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public ReferralLetterDetailsVo(ims.clinical.vo.beans.ReferralLetterDetailsVoBean bean)
	{
		...
		this.othercommchannels = ims.core.vo.CommChannelVoCollection.buildFromBeanCollection(bean.getOtherCommChannels());
		this.initiatedfrom = bean.getInitiatedFrom() == null ? null : ims.RefMan.vo.lookups.ReferralInitiatedFrom.buildLookup(bean.getInitiatedFrom());
	...
	public Object getFieldValueByFieldName(String fieldName)
	{
		...
		if(fieldName.equals("OTHERCOMMCHANNELS"))
			return getOtherCommChannels();
		if(fieldName.equals("INITIATEDFROM"))
			return getInitiatedFrom();
	...
	public boolean getOtherCommChannelsIsNotNull()
	{
		return this.othercommchannels != null;
	}
	public ims.core.vo.CommChannelVoCollection getOtherCommChannels()
	{
		return this.othercommchannels;
	}
	public void setOtherCommChannels(ims.core.vo.CommChannelVoCollection value)
	{
		this.isValidated = false;
		this.othercommchannels = value;
	}
	public boolean getInitiatedFromIsNotNull()
	{
		return this.initiatedfrom != null;
	}
	public ims.RefMan.vo.lookups.ReferralInitiatedFrom getInitiatedFrom()
	{
		return this.initiatedfrom;
	}
	public void setInitiatedFrom(ims.RefMan.vo.lookups.ReferralInitiatedFrom value)
	{
		this.isValidated = false;
	...
	public boolean isValidated()
	{
		...
		if(this.othercommchannels != null)
		{
			if(!this.othercommchannels.isValidated())
			{
				this.isBusy = false;
				return false;
			}
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.othercommchannels != null)
		{
			String[] listOfOtherErrors = this.othercommchannels.validate();
			if(listOfOtherErrors != null)
			{
				for(int x = 0; x < listOfOtherErrors.length; x++)
				{
		...
		if(this.otherlocation != null)
			if(this.otherlocation.length() > 500)
				listOfErrors.add("The length of the field [otherlocation] in the value object [ims.clinical.vo.ReferralLetterDetailsVo] is too big. It should be less or equal to 500");
		if(this.serviceupdatehistory != null)
		{
	...
	public Object clone()
	{
		...
		if(this.othercommchannels == null)
			clone.othercommchannels = null;
		else
			clone.othercommchannels = (ims.core.vo.CommChannelVoCollection)this.othercommchannels.clone();
		if(this.initiatedfrom == null)
			clone.initiatedfrom = null;
		else
			clone.initiatedfrom = (ims.RefMan.vo.lookups.ReferralInitiatedFrom)this.initiatedfrom.clone();
	...
	protected ims.core.vo.CommChannelVoCollection othercommchannels;
	protected ims.RefMan.vo.lookups.ReferralInitiatedFrom initiatedfrom;
