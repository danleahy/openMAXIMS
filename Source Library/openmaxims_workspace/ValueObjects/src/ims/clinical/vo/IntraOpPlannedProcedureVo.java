 ...
 */
public class IntraOpPlannedProcedureVo extends ims.clinical.vo.IntraOpPlannedProcedureRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public IntraOpPlannedProcedureVo()
	{
	}
	public IntraOpPlannedProcedureVo(Integer id, int version)
	{
		super(id, version);
	}
	public IntraOpPlannedProcedureVo(ims.clinical.vo.beans.IntraOpPlannedProcedureVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.clinical.vo.beans.IntraOpPlannedProcedureVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.theatreappointment = bean.getTheatreAppointment() == null ? null : new ims.scheduling.vo.Booking_AppointmentRefVo(new Integer(bean.getTheatreAppointment().getId()), bean.getTheatreAppointment().getVersion());
	...
	{
		ims.clinical.vo.beans.IntraOpPlannedProcedureVoBean bean = null;
		if(map != null)
			bean = (ims.clinical.vo.beans.IntraOpPlannedProcedureVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.clinical.vo.beans.IntraOpPlannedProcedureVoBean();
	...
	public ims.core.vo.PatientProcedureMinVo getPlannedProcedure()
	{
		return this.plannedprocedure;
	}
	public void setPlannedProcedure(ims.core.vo.PatientProcedureMinVo value)
	{
		this.isValidated = false;
	...
	public Object clone()
	{
		...
		IntraOpPlannedProcedureVo clone = new IntraOpPlannedProcedureVo(this.id, this.version);
		
		clone.theatreappointment = this.theatreappointment;
		if(this.plannedprocedure == null)
			clone.plannedprocedure = null;
		else
			clone.plannedprocedure = (ims.core.vo.PatientProcedureMinVo)this.plannedprocedure.clone();
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(IntraOpPlannedProcedureVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A IntraOpPlannedProcedureVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((IntraOpPlannedProcedureVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((IntraOpPlannedProcedureVo)obj).getBoId());
	}
	...
	protected ims.core.vo.PatientProcedureMinVo plannedprocedure;
