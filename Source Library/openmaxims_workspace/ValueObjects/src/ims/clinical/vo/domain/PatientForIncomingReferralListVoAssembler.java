 ...
 */
public class PatientForIncomingReferralListVoAssembler
{
  	/**
	 ...
	 */
	 public static ims.clinical.vo.PatientForIncomingReferralListVo copy(ims.clinical.vo.PatientForIncomingReferralListVo valueObjectDest, ims.clinical.vo.PatientForIncomingReferralListVo valueObjectSrc) 
	 {
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createPatientForIncomingReferralListVoCollectionFromPatient(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.core.patient.domain.objects.Patient objects.
	 */
	public static ims.clinical.vo.PatientForIncomingReferralListVoCollection createPatientForIncomingReferralListVoCollectionFromPatient(java.util.Set domainObjectSet)	
	{
		return createPatientForIncomingReferralListVoCollectionFromPatient(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.core.patient.domain.objects.Patient objects.
	 */
	public static ims.clinical.vo.PatientForIncomingReferralListVoCollection createPatientForIncomingReferralListVoCollectionFromPatient(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.clinical.vo.PatientForIncomingReferralListVoCollection voList = new ims.clinical.vo.PatientForIncomingReferralListVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.clinical.vo.PatientForIncomingReferralListVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.clinical.vo.PatientForIncomingReferralListVoCollection createPatientForIncomingReferralListVoCollectionFromPatient(java.util.List domainObjectList) 
	{
		return createPatientForIncomingReferralListVoCollectionFromPatient(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.core.patient.domain.objects.Patient objects.
	 */
	public static ims.clinical.vo.PatientForIncomingReferralListVoCollection createPatientForIncomingReferralListVoCollectionFromPatient(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.clinical.vo.PatientForIncomingReferralListVoCollection voList = new ims.clinical.vo.PatientForIncomingReferralListVoCollection();
	 ...
	 */
	 public static java.util.Set extractPatientSet(ims.domain.ILightweightDomainFactory domainFactory, ims.clinical.vo.PatientForIncomingReferralListVoCollection voCollection) 
	 {
	 	return extractPatientSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractPatientSet(ims.domain.ILightweightDomainFactory domainFactory, ims.clinical.vo.PatientForIncomingReferralListVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.clinical.vo.PatientForIncomingReferralListVo vo = voCollection.get(i);
			ims.core.patient.domain.objects.Patient domainObject = PatientForIncomingReferralListVoAssembler.extractPatient(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractPatientList(ims.domain.ILightweightDomainFactory domainFactory, ims.clinical.vo.PatientForIncomingReferralListVoCollection voCollection) 
	 {
	 	return extractPatientList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractPatientList(ims.domain.ILightweightDomainFactory domainFactory, ims.clinical.vo.PatientForIncomingReferralListVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.clinical.vo.PatientForIncomingReferralListVo create(ims.core.patient.domain.objects.Patient domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.clinical.vo.PatientForIncomingReferralListVo create(DomainObjectMap map, ims.core.patient.domain.objects.Patient domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.clinical.vo.PatientForIncomingReferralListVo valueObject = (ims.clinical.vo.PatientForIncomingReferralListVo) map.getValueObject(domainObject, ims.clinical.vo.PatientForIncomingReferralListVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.clinical.vo.PatientForIncomingReferralListVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.core.patient.domain.objects.Patient
	 */
	 public static ims.clinical.vo.PatientForIncomingReferralListVo insert(ims.clinical.vo.PatientForIncomingReferralListVo valueObject, ims.core.patient.domain.objects.Patient domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.core.patient.domain.objects.Patient
	 */
	 public static ims.clinical.vo.PatientForIncomingReferralListVo insert(DomainObjectMap map, ims.clinical.vo.PatientForIncomingReferralListVo valueObject, ims.core.patient.domain.objects.Patient domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 */
	public static ims.core.patient.domain.objects.Patient extractPatient(ims.domain.ILightweightDomainFactory domainFactory, ims.clinical.vo.PatientForIncomingReferralListVo valueObject) 
	{
		return 	extractPatient(domainFactory, valueObject, new HashMap());
	}

	public static ims.core.patient.domain.objects.Patient extractPatient(ims.domain.ILightweightDomainFactory domainFactory, ims.clinical.vo.PatientForIncomingReferralListVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.clinical.vo.PatientForIncomingReferralListVo ID_Patient field is unknown
