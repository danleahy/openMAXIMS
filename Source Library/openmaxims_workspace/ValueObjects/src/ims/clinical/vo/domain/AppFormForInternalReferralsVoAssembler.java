 ...
 */
public class AppFormForInternalReferralsVoAssembler
{
  	/**
	 ...
	 */
	 public static ims.clinical.vo.AppFormForInternalReferralsVo copy(ims.clinical.vo.AppFormForInternalReferralsVo valueObjectDest, ims.clinical.vo.AppFormForInternalReferralsVo valueObjectSrc) 
	 {
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createAppFormForInternalReferralsVoCollectionFromAppForm(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.core.configuration.domain.objects.AppForm objects.
	 */
	public static ims.clinical.vo.AppFormForInternalReferralsVoCollection createAppFormForInternalReferralsVoCollectionFromAppForm(java.util.Set domainObjectSet)	
	{
		return createAppFormForInternalReferralsVoCollectionFromAppForm(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.core.configuration.domain.objects.AppForm objects.
	 */
	public static ims.clinical.vo.AppFormForInternalReferralsVoCollection createAppFormForInternalReferralsVoCollectionFromAppForm(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.clinical.vo.AppFormForInternalReferralsVoCollection voList = new ims.clinical.vo.AppFormForInternalReferralsVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.clinical.vo.AppFormForInternalReferralsVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.clinical.vo.AppFormForInternalReferralsVoCollection createAppFormForInternalReferralsVoCollectionFromAppForm(java.util.List domainObjectList) 
	{
		return createAppFormForInternalReferralsVoCollectionFromAppForm(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.core.configuration.domain.objects.AppForm objects.
	 */
	public static ims.clinical.vo.AppFormForInternalReferralsVoCollection createAppFormForInternalReferralsVoCollectionFromAppForm(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.clinical.vo.AppFormForInternalReferralsVoCollection voList = new ims.clinical.vo.AppFormForInternalReferralsVoCollection();
	 ...
	 */
	 public static java.util.Set extractAppFormSet(ims.domain.ILightweightDomainFactory domainFactory, ims.clinical.vo.AppFormForInternalReferralsVoCollection voCollection) 
	 {
	 	return extractAppFormSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractAppFormSet(ims.domain.ILightweightDomainFactory domainFactory, ims.clinical.vo.AppFormForInternalReferralsVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.clinical.vo.AppFormForInternalReferralsVo vo = voCollection.get(i);
			ims.core.configuration.domain.objects.AppForm domainObject = AppFormForInternalReferralsVoAssembler.extractAppForm(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractAppFormList(ims.domain.ILightweightDomainFactory domainFactory, ims.clinical.vo.AppFormForInternalReferralsVoCollection voCollection) 
	 {
	 	return extractAppFormList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractAppFormList(ims.domain.ILightweightDomainFactory domainFactory, ims.clinical.vo.AppFormForInternalReferralsVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.clinical.vo.AppFormForInternalReferralsVo create(ims.core.configuration.domain.objects.AppForm domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.clinical.vo.AppFormForInternalReferralsVo create(DomainObjectMap map, ims.core.configuration.domain.objects.AppForm domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.clinical.vo.AppFormForInternalReferralsVo valueObject = (ims.clinical.vo.AppFormForInternalReferralsVo) map.getValueObject(domainObject, ims.clinical.vo.AppFormForInternalReferralsVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.clinical.vo.AppFormForInternalReferralsVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.core.configuration.domain.objects.AppForm
	 */
	 public static ims.clinical.vo.AppFormForInternalReferralsVo insert(ims.clinical.vo.AppFormForInternalReferralsVo valueObject, ims.core.configuration.domain.objects.AppForm domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.core.configuration.domain.objects.AppForm
	 */
	 public static ims.clinical.vo.AppFormForInternalReferralsVo insert(DomainObjectMap map, ims.clinical.vo.AppFormForInternalReferralsVo valueObject, ims.core.configuration.domain.objects.AppForm domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 */
	public static ims.core.configuration.domain.objects.AppForm extractAppForm(ims.domain.ILightweightDomainFactory domainFactory, ims.clinical.vo.AppFormForInternalReferralsVo valueObject) 
	{
		return 	extractAppForm(domainFactory, valueObject, new HashMap());
	}

	public static ims.core.configuration.domain.objects.AppForm extractAppForm(ims.domain.ILightweightDomainFactory domainFactory, ims.clinical.vo.AppFormForInternalReferralsVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.clinical.vo.AppFormForInternalReferralsVo ID_AppForm field is unknown
		...
		ims.core.configuration.vo.MenuActionRefVoCollection refCollection2 = new ims.core.configuration.vo.MenuActionRefVoCollection();
		if (valueObject.getMenuActions() != null)
		{
			for (int i2=0; i2<valueObject.getMenuActions().size(); i2++)
			{
				ims.core.configuration.vo.MenuActionRefVo ref2 = (ims.core.configuration.vo.MenuActionRefVo)valueObject.getMenuActions().get(i2);
				refCollection2.add(ref2);
			}
		}
		int size2 = (null == refCollection2) ? 0 : refCollection2.size();		
		java.util.Set domainMenuActions2 = domainObject.getMenuActions();
		if (domainMenuActions2 == null)
		{
			domainMenuActions2 = new java.util.HashSet();
		}
		java.util.Set newSet2  = new java.util.HashSet();
		for(int i=0; i<size2; i++) 
		{
			ims.core.configuration.vo.MenuActionRefVo vo = refCollection2.get(i);					
			...
			//Trying to avoid the hibernate collection being marked as dirty via its public interface methods. (like add)
			if (!domainMenuActions2.contains(dom))
			{
				domainMenuActions2.add(dom);
			}
			newSet2.add(dom);			
		}
		java.util.Set removedSet2 = new java.util.HashSet();
		java.util.Iterator iter2 = domainMenuActions2.iterator();
		//Find out which objects need to be removed
		while (iter2.hasNext())
		{
		...
		while (iter2.hasNext())
		{
			domainMenuActions2.remove(iter2.next());
		}		
		
		domainObject.setMenuActions(domainMenuActions2);		
		//This is to overcome a bug in both Sybase and Oracle which prevents them from storing an empty string correctly
		//Sybase stores it as a single space, Oracle stores it as NULL. This fix will make them consistent at least.
	...
	ims.core.configuration.domain.objects.AppImage value10 = null;
		if ( null != valueObject.getImage() ) 
		{
			if (valueObject.getImage().getBoId() == null)
			{
				...
				{
					value10 = (ims.core.configuration.domain.objects.AppImage)domMap.get(valueObject.getImage());
				}
			}
			else
			{
				value10 = (ims.core.configuration.domain.objects.AppImage)domainFactory.getDomainObject(ims.core.configuration.domain.objects.AppImage.class, valueObject.getImage().getBoId());
			}
		}
		domainObject.setImage(value10);
	// SaveAsRefVO - treated as a refVo in extract methods
	ims.core.configuration.domain.objects.AppNameSpace value11 = null;
		if ( null != valueObject.getNamespace() ) 
		{
			if (valueObject.getNamespace().getBoId() == null)
			{
				...
				{
					value11 = (ims.core.configuration.domain.objects.AppNameSpace)domMap.get(valueObject.getNamespace());
				}
			}
			else
			{
				value11 = (ims.core.configuration.domain.objects.AppNameSpace)domainFactory.getDomainObject(ims.core.configuration.domain.objects.AppNameSpace.class, valueObject.getNamespace().getBoId());
			}
		}
		domainObject.setNamespace(value11);
		//This is to overcome a bug in both Sybase and Oracle which prevents them from storing an empty string correctly
		//Sybase stores it as a single space, Oracle stores it as NULL. This fix will make them consistent at least.
