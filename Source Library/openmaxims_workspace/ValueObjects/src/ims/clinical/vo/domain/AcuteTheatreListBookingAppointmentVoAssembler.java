 ...
 */
public class AcuteTheatreListBookingAppointmentVoAssembler
{
  	/**
	 ...
	 */
	 public static ims.clinical.vo.AcuteTheatreListBookingAppointmentVo copy(ims.clinical.vo.AcuteTheatreListBookingAppointmentVo valueObjectDest, ims.clinical.vo.AcuteTheatreListBookingAppointmentVo valueObjectSrc) 
	 {
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createAcuteTheatreListBookingAppointmentVoCollectionFromBooking_Appointment(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.scheduling.domain.objects.Booking_Appointment objects.
	 */
	public static ims.clinical.vo.AcuteTheatreListBookingAppointmentVoCollection createAcuteTheatreListBookingAppointmentVoCollectionFromBooking_Appointment(java.util.Set domainObjectSet)	
	{
		return createAcuteTheatreListBookingAppointmentVoCollectionFromBooking_Appointment(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.scheduling.domain.objects.Booking_Appointment objects.
	 */
	public static ims.clinical.vo.AcuteTheatreListBookingAppointmentVoCollection createAcuteTheatreListBookingAppointmentVoCollectionFromBooking_Appointment(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.clinical.vo.AcuteTheatreListBookingAppointmentVoCollection voList = new ims.clinical.vo.AcuteTheatreListBookingAppointmentVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.clinical.vo.AcuteTheatreListBookingAppointmentVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.clinical.vo.AcuteTheatreListBookingAppointmentVoCollection createAcuteTheatreListBookingAppointmentVoCollectionFromBooking_Appointment(java.util.List domainObjectList) 
	{
		return createAcuteTheatreListBookingAppointmentVoCollectionFromBooking_Appointment(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.scheduling.domain.objects.Booking_Appointment objects.
	 */
	public static ims.clinical.vo.AcuteTheatreListBookingAppointmentVoCollection createAcuteTheatreListBookingAppointmentVoCollectionFromBooking_Appointment(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.clinical.vo.AcuteTheatreListBookingAppointmentVoCollection voList = new ims.clinical.vo.AcuteTheatreListBookingAppointmentVoCollection();
	 ...
	 */
	 public static java.util.Set extractBooking_AppointmentSet(ims.domain.ILightweightDomainFactory domainFactory, ims.clinical.vo.AcuteTheatreListBookingAppointmentVoCollection voCollection) 
	 {
	 	return extractBooking_AppointmentSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractBooking_AppointmentSet(ims.domain.ILightweightDomainFactory domainFactory, ims.clinical.vo.AcuteTheatreListBookingAppointmentVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.clinical.vo.AcuteTheatreListBookingAppointmentVo vo = voCollection.get(i);
			ims.scheduling.domain.objects.Booking_Appointment domainObject = AcuteTheatreListBookingAppointmentVoAssembler.extractBooking_Appointment(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractBooking_AppointmentList(ims.domain.ILightweightDomainFactory domainFactory, ims.clinical.vo.AcuteTheatreListBookingAppointmentVoCollection voCollection) 
	 {
	 	return extractBooking_AppointmentList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractBooking_AppointmentList(ims.domain.ILightweightDomainFactory domainFactory, ims.clinical.vo.AcuteTheatreListBookingAppointmentVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.clinical.vo.AcuteTheatreListBookingAppointmentVo create(ims.scheduling.domain.objects.Booking_Appointment domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.clinical.vo.AcuteTheatreListBookingAppointmentVo create(DomainObjectMap map, ims.scheduling.domain.objects.Booking_Appointment domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.clinical.vo.AcuteTheatreListBookingAppointmentVo valueObject = (ims.clinical.vo.AcuteTheatreListBookingAppointmentVo) map.getValueObject(domainObject, ims.clinical.vo.AcuteTheatreListBookingAppointmentVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.clinical.vo.AcuteTheatreListBookingAppointmentVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.scheduling.domain.objects.Booking_Appointment
	 */
	 public static ims.clinical.vo.AcuteTheatreListBookingAppointmentVo insert(ims.clinical.vo.AcuteTheatreListBookingAppointmentVo valueObject, ims.scheduling.domain.objects.Booking_Appointment domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.scheduling.domain.objects.Booking_Appointment
	 */
	 public static ims.clinical.vo.AcuteTheatreListBookingAppointmentVo insert(DomainObjectMap map, ims.clinical.vo.AcuteTheatreListBookingAppointmentVo valueObject, ims.scheduling.domain.objects.Booking_Appointment domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 */
	public static ims.scheduling.domain.objects.Booking_Appointment extractBooking_Appointment(ims.domain.ILightweightDomainFactory domainFactory, ims.clinical.vo.AcuteTheatreListBookingAppointmentVo valueObject) 
	{
		return 	extractBooking_Appointment(domainFactory, valueObject, new HashMap());
	}

	public static ims.scheduling.domain.objects.Booking_Appointment extractBooking_Appointment(ims.domain.ILightweightDomainFactory domainFactory, ims.clinical.vo.AcuteTheatreListBookingAppointmentVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.clinical.vo.AcuteTheatreListBookingAppointmentVo ID_Booking_Appointment field is unknown
	...
	ims.scheduling.domain.objects.TheatreBooking value3 = null;
		...
		if ( null != valueObject.getSession() ) 
		{
			...
			{
				value8 = domainObject.getSession();	
			}
			else
			{
