 ...
 */
public class PatientChartableOccurenceVo extends ims.clinical.vo.PatientChartableOccuranceRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public PatientChartableOccurenceVo()
	{
	}
	public PatientChartableOccurenceVo(Integer id, int version)
	{
		super(id, version);
	}
	public PatientChartableOccurenceVo(ims.clinical.vo.beans.PatientChartableOccurenceVoBean bean)
	{
		this.id = bean.getId();
		...
		this.periopstage = bean.getPeriOpStage() == null ? null : ims.clinical.vo.lookups.PeriOpStage.buildLookup(bean.getPeriOpStage());
	}
	public void populate(ims.vo.ValueObjectBeanMap map, ims.clinical.vo.beans.PatientChartableOccurenceVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.theatreappointment = bean.getTheatreAppointment() == null ? null : new ims.scheduling.vo.Booking_AppointmentRefVo(new Integer(bean.getTheatreAppointment().getId()), bean.getTheatreAppointment().getVersion());
	...
	{
		ims.clinical.vo.beans.PatientChartableOccurenceVoBean bean = null;
		if(map != null)
			bean = (ims.clinical.vo.beans.PatientChartableOccurenceVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.clinical.vo.beans.PatientChartableOccurenceVoBean();
	...
	public Object getFieldValueByFieldName(String fieldName)
	{
		...
		if(fieldName.equals("PERIOPSTAGE"))
			return getPeriOpStage();
	...
	public ims.vo.interfaces.IMos getReportedBy()
	{
		return this.reportedby;
	}
	public void setReportedBy(ims.vo.interfaces.IMos value)
	{
		this.isValidated = false;
		this.reportedby = (ims.core.vo.MemberOfStaffLiteVo)value;
	}
	...
	public boolean getPeriOpStageIsNotNull()
	{
		return this.periopstage != null;
	}
	public ims.clinical.vo.lookups.PeriOpStage getPeriOpStage()
	{
		return this.periopstage;
	}
	public void setPeriOpStage(ims.clinical.vo.lookups.PeriOpStage value)
	{
		this.isValidated = false;
		this.periopstage = value;
	}
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.timeobserved == null)
			listOfErrors.add("Date and Time Observed are mandatory");
		if(this.chartableoccurancetype == null)
			listOfErrors.add("Chartable Occurrence Type is mandatory");
		if(this.reportedby == null)
			listOfErrors.add("Reported By is mandatory");
		if(this.incidentnumber == null || this.incidentnumber.length() == 0)
			listOfErrors.add("Incident Number is mandatory");
		else if(this.incidentnumber.length() > 25)
			listOfErrors.add("The length of the field [incidentnumber] in the value object [ims.clinical.vo.PatientChartableOccurenceVo] is too big. It should be less or equal to 25");
		if(this.periopstage == null)
			listOfErrors.add("PeriOpStage is mandatory");
	...
	public Object clone()
	{
		...
		PatientChartableOccurenceVo clone = new PatientChartableOccurenceVo(this.id, this.version);
		...
		if(this.periopstage == null)
			clone.periopstage = null;
		else
			clone.periopstage = (ims.clinical.vo.lookups.PeriOpStage)this.periopstage.clone();
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(PatientChartableOccurenceVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A PatientChartableOccurenceVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((PatientChartableOccurenceVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((PatientChartableOccurenceVo)obj).getBoId());
	}
	...
	protected ims.core.vo.MemberOfStaffLiteVo reportedby;
	protected String incidentnumber;
	protected ims.clinical.vo.lookups.PeriOpStage periopstage;
