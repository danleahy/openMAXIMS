 ...
 */
public class LinkPatientDocumentVo extends ims.core.documents.vo.PatientDocumentRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public LinkPatientDocumentVo()
	{
	}
	public LinkPatientDocumentVo(Integer id, int version)
	{
		super(id, version);
	}
	public LinkPatientDocumentVo(ims.clinical.vo.beans.LinkPatientDocumentVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.clinical.vo.beans.LinkPatientDocumentVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.creationtype = bean.getCreationType() == null ? null : ims.core.vo.lookups.DocumentCreationType.buildLookup(bean.getCreationType());
	...
	{
		ims.clinical.vo.beans.LinkPatientDocumentVoBean bean = null;
		if(map != null)
			bean = (ims.clinical.vo.beans.LinkPatientDocumentVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.clinical.vo.beans.LinkPatientDocumentVoBean();
	...
	public Object clone()
	{
		...
		LinkPatientDocumentVo clone = new LinkPatientDocumentVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(LinkPatientDocumentVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A LinkPatientDocumentVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((LinkPatientDocumentVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((LinkPatientDocumentVo)obj).getBoId());
	}
