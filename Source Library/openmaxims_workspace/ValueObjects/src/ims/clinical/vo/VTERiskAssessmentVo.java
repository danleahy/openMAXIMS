...
public class VTERiskAssessmentVo extends ims.core.clinical.vo.VTERiskAssessmentRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public VTERiskAssessmentVo(ims.clinical.vo.beans.VTERiskAssessmentVoBean bean)
	{
		...
		this.prophylaxisoffered = ims.clinical.vo.lookups.ProphylaxisOfferedCollection.buildFromBeanCollection(bean.getProphylaxisOffered());
		this.comments = bean.getComments();
		this.contexttype = bean.getContextType() == null ? null : ims.clinical.vo.lookups.VTEAssessmentContextType.buildLookup(bean.getContextType());
		this.used = bean.getUsed();
		this.declinedinformation = bean.getDeclinedInformation() == null ? null : bean.getDeclinedInformation().buildVo();
		this.validatedinformation = bean.getValidatedInformation() == null ? null : bean.getValidatedInformation().buildVo();
		this.declinedreason = bean.getDeclinedReason() == null ? null : ims.clinical.vo.lookups.VTEAssessmentStatusReason.buildLookup(bean.getDeclinedReason());
	}
	public void populate(ims.vo.ValueObjectBeanMap map, ims.clinical.vo.beans.VTERiskAssessmentVoBean bean)
	{
		...
		this.contexttype = bean.getContextType() == null ? null : ims.clinical.vo.lookups.VTEAssessmentContextType.buildLookup(bean.getContextType());
		this.used = bean.getUsed();
		this.declinedinformation = bean.getDeclinedInformation() == null ? null : bean.getDeclinedInformation().buildVo(map);
		this.validatedinformation = bean.getValidatedInformation() == null ? null : bean.getValidatedInformation().buildVo(map);
		this.declinedreason = bean.getDeclinedReason() == null ? null : ims.clinical.vo.lookups.VTEAssessmentStatusReason.buildLookup(bean.getDeclinedReason());
	}
	...
	public Object getFieldValueByFieldName(String fieldName)
	{
		...
		if(fieldName.equals("USED"))
			return getUsed();
		if(fieldName.equals("DECLINEDINFORMATION"))
			return getDeclinedInformation();
		if(fieldName.equals("VALIDATEDINFORMATION"))
			return getValidatedInformation();
		if(fieldName.equals("DECLINEDREASON"))
	...
	public ims.clinical.vo.lookups.ProphylaxisOfferedCollection getProphylaxisOffered()
	{
		return this.prophylaxisoffered;
	}
	public void setProphylaxisOffered(ims.clinical.vo.lookups.ProphylaxisOfferedCollection value)
	{
		this.isValidated = false;
	...
	public ims.clinical.vo.lookups.VTEAssessmentContextType getContextType()
	{
		return this.contexttype;
	}
	public void setContextType(ims.clinical.vo.lookups.VTEAssessmentContextType value)
	{
		this.isValidated = false;
		this.contexttype = value;
	}
	public boolean getUsedIsNotNull()
	{
	...
	public boolean getDeclinedInformationIsNotNull()
	{
		return this.declinedinformation != null;
	}
	public ims.core.vo.AuthoringInformationVo getDeclinedInformation()
	{
		return this.declinedinformation;
	}
	public void setDeclinedInformation(ims.core.vo.AuthoringInformationVo value)
	{
		this.isValidated = false;
		this.declinedinformation = value;
	}
	public boolean getValidatedInformationIsNotNull()
	{
		return this.validatedinformation != null;
	}
	public ims.core.vo.AuthoringInformationVo getValidatedInformation()
	{
		return this.validatedinformation;
	}
	public void setValidatedInformation(ims.core.vo.AuthoringInformationVo value)
	{
		this.isValidated = false;
		this.validatedinformation = value;
	}
	public boolean getDeclinedReasonIsNotNull()
	{
		return this.declinedreason != null;
	}
	public ims.clinical.vo.lookups.VTEAssessmentStatusReason getDeclinedReason()
	{
		return this.declinedreason;
	}
	public void setDeclinedReason(ims.clinical.vo.lookups.VTEAssessmentStatusReason value)
	{
		this.isValidated = false;
	...
	public boolean isValidated()
	{
		...
		if(this.declinedinformation != null)
		{
			if(!this.declinedinformation.isValidated())
			{
				this.isBusy = false;
				return false;
			}
		}
		if(this.validatedinformation != null)
		{
			if(!this.validatedinformation.isValidated())
			{
				this.isBusy = false;
				return false;
			}
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.comments != null)
			if(this.comments.length() > 250)
				listOfErrors.add("The length of the field [comments] in the value object [ims.clinical.vo.VTERiskAssessmentVo] is too big. It should be less or equal to 250");
		if(this.declinedinformation != null)
		{
			String[] listOfOtherErrors = this.declinedinformation.validate();
			if(listOfOtherErrors != null)
			{
				for(int x = 0; x < listOfOtherErrors.length; x++)
				{
		...
		if(this.validatedinformation != null)
		{
			String[] listOfOtherErrors = this.validatedinformation.validate();
			if(listOfOtherErrors != null)
			{
				for(int x = 0; x < listOfOtherErrors.length; x++)
				{
	...
	public Object clone()
	{
		...
		if(this.prophylaxisoffered == null)
			...
			clone.prophylaxisoffered = (ims.clinical.vo.lookups.ProphylaxisOfferedCollection)this.prophylaxisoffered.clone();
		clone.comments = this.comments;
		if(this.contexttype == null)
			clone.contexttype = null;
		else
			clone.contexttype = (ims.clinical.vo.lookups.VTEAssessmentContextType)this.contexttype.clone();
		clone.used = this.used;
		if(this.declinedinformation == null)
			clone.declinedinformation = null;
		else
			clone.declinedinformation = (ims.core.vo.AuthoringInformationVo)this.declinedinformation.clone();
		if(this.validatedinformation == null)
			clone.validatedinformation = null;
		else
			clone.validatedinformation = (ims.core.vo.AuthoringInformationVo)this.validatedinformation.clone();
		if(this.declinedreason == null)
			clone.declinedreason = null;
		else
			clone.declinedreason = (ims.clinical.vo.lookups.VTEAssessmentStatusReason)this.declinedreason.clone();
	...
	protected ims.clinical.vo.lookups.ProphylaxisOfferedCollection prophylaxisoffered;
	protected String comments;
	protected ims.clinical.vo.lookups.VTEAssessmentContextType contexttype;
	protected Boolean used;
	protected ims.core.vo.AuthoringInformationVo declinedinformation;
	protected ims.core.vo.AuthoringInformationVo validatedinformation;
	protected ims.clinical.vo.lookups.VTEAssessmentStatusReason declinedreason;
