...
public class InternalReferralStatusForBookingWorklistVoBean extends ims.vo.ValueObjectBean
{
	public InternalReferralStatusForBookingWorklistVoBean()
	{
	}
	public InternalReferralStatusForBookingWorklistVoBean(ims.clinical.vo.InternalReferralStatusForBookingWorklistVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.clinical.vo.InternalReferralStatusForBookingWorklistVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.referralstatus = vo.getReferralStatus() == null ? null : (ims.vo.LookupInstanceBean)vo.getReferralStatus().getBean();
	...
	public ims.clinical.vo.InternalReferralStatusForBookingWorklistVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.clinical.vo.InternalReferralStatusForBookingWorklistVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.clinical.vo.InternalReferralStatusForBookingWorklistVo vo = null;
		if(map != null)
			vo = (ims.clinical.vo.InternalReferralStatusForBookingWorklistVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.clinical.vo.InternalReferralStatusForBookingWorklistVo();
