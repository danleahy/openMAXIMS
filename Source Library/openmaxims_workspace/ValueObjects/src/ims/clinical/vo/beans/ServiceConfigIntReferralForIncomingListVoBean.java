...
public class ServiceConfigIntReferralForIncomingListVoBean extends ims.vo.ValueObjectBean
{
	public ServiceConfigIntReferralForIncomingListVoBean()
	{
	}
	public ServiceConfigIntReferralForIncomingListVoBean(ims.clinical.vo.ServiceConfigIntReferralForIncomingListVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.clinical.vo.ServiceConfigIntReferralForIncomingListVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
	...
	public ims.clinical.vo.ServiceConfigIntReferralForIncomingListVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.clinical.vo.ServiceConfigIntReferralForIncomingListVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.clinical.vo.ServiceConfigIntReferralForIncomingListVo vo = null;
		if(map != null)
			vo = (ims.clinical.vo.ServiceConfigIntReferralForIncomingListVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.clinical.vo.ServiceConfigIntReferralForIncomingListVo();
