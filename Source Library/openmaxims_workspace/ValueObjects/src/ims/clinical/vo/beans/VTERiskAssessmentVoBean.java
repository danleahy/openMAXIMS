...
public class VTERiskAssessmentVoBean extends ims.vo.ValueObjectBean
{
	...
	public VTERiskAssessmentVoBean(ims.clinical.vo.VTERiskAssessmentVo vo)
	{
		...
		this.prophylaxisoffered = vo.getProphylaxisOffered() == null ? null : vo.getProphylaxisOffered().getBeanCollection();
		this.comments = vo.getComments();
		this.contexttype = vo.getContextType() == null ? null : (ims.vo.LookupInstanceBean)vo.getContextType().getBean();
		this.used = vo.getUsed();
		this.declinedinformation = vo.getDeclinedInformation() == null ? null : (ims.core.vo.beans.AuthoringInformationVoBean)vo.getDeclinedInformation().getBean();
		this.validatedinformation = vo.getValidatedInformation() == null ? null : (ims.core.vo.beans.AuthoringInformationVoBean)vo.getValidatedInformation().getBean();
		this.declinedreason = vo.getDeclinedReason() == null ? null : (ims.vo.LookupInstanceBean)vo.getDeclinedReason().getBean();
	}
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.clinical.vo.VTERiskAssessmentVo vo)
	{
		...
		this.contexttype = vo.getContextType() == null ? null : (ims.vo.LookupInstanceBean)vo.getContextType().getBean();
		this.used = vo.getUsed();
		this.declinedinformation = vo.getDeclinedInformation() == null ? null : (ims.core.vo.beans.AuthoringInformationVoBean)vo.getDeclinedInformation().getBean(map);
		this.validatedinformation = vo.getValidatedInformation() == null ? null : (ims.core.vo.beans.AuthoringInformationVoBean)vo.getValidatedInformation().getBean(map);
		this.declinedreason = vo.getDeclinedReason() == null ? null : (ims.vo.LookupInstanceBean)vo.getDeclinedReason().getBean();
	}
	...
	public java.util.Collection getProphylaxisOffered()
	{
		return this.prophylaxisoffered;
	}
	public void setProphylaxisOffered(java.util.Collection value)
	{
		this.prophylaxisoffered = value;
	}
	public void addProphylaxisOffered(java.util.Collection value)
	{
		if(this.prophylaxisoffered == null)
			this.prophylaxisoffered = new java.util.ArrayList();
		this.prophylaxisoffered.add(value);
	}
	...
	public ims.core.vo.beans.AuthoringInformationVoBean getDeclinedInformation()
	{
		return this.declinedinformation;
	}
	public void setDeclinedInformation(ims.core.vo.beans.AuthoringInformationVoBean value)
	{
		this.declinedinformation = value;
	}
	public ims.core.vo.beans.AuthoringInformationVoBean getValidatedInformation()
	{
		return this.validatedinformation;
	}
	public void setValidatedInformation(ims.core.vo.beans.AuthoringInformationVoBean value)
	{
		this.validatedinformation = value;
	}
	public ims.vo.LookupInstanceBean getDeclinedReason()
	{
		return this.declinedreason;
	}
	public void setDeclinedReason(ims.vo.LookupInstanceBean value)
	{
	...
	private java.util.Collection prophylaxisoffered;
	private String comments;
	private ims.vo.LookupInstanceBean contexttype;
	private Boolean used;
	private ims.core.vo.beans.AuthoringInformationVoBean declinedinformation;
	private ims.core.vo.beans.AuthoringInformationVoBean validatedinformation;
	private ims.vo.LookupInstanceBean declinedreason;
}
