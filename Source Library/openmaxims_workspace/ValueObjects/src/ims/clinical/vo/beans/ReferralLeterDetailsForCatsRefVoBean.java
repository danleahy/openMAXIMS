...
public class ReferralLeterDetailsForCatsRefVoBean extends ims.vo.ValueObjectBean
{
	public ReferralLeterDetailsForCatsRefVoBean()
	{
	}
	public ReferralLeterDetailsForCatsRefVoBean(ims.clinical.vo.ReferralLeterDetailsForCatsRefVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.clinical.vo.ReferralLeterDetailsForCatsRefVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
	...
	public ims.clinical.vo.ReferralLeterDetailsForCatsRefVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.clinical.vo.ReferralLeterDetailsForCatsRefVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.clinical.vo.ReferralLeterDetailsForCatsRefVo vo = null;
		if(map != null)
			vo = (ims.clinical.vo.ReferralLeterDetailsForCatsRefVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.clinical.vo.ReferralLeterDetailsForCatsRefVo();
