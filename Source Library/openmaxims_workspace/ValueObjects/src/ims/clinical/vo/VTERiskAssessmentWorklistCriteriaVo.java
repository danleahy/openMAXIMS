...
public class VTERiskAssessmentWorklistCriteriaVo extends ims.vo.ValueObject implements ims.vo.ImsCloneable, Comparable
{
	...
	public VTERiskAssessmentWorklistCriteriaVo(ims.clinical.vo.beans.VTERiskAssessmentWorklistCriteriaVoBean bean)
	{
		...
		this.currentinpatients = bean.getCurrentInpatients();
		this.dischargedpatients = bean.getDischargedPatients();
		this.tcifortoday = bean.getTciForToday();
	}
	...
	public boolean getCurrentInpatientsIsNotNull()
	{
		return this.currentinpatients != null;
	}
	...
	public boolean getDischargedPatientsIsNotNull()
	{
		return this.dischargedpatients != null;
	}
	...
	public boolean getTciForTodayIsNotNull()
	{
		return this.tcifortoday != null;
	}
	...
	public Object clone()
	{
		...
		clone.currentinpatients = this.currentinpatients;
		clone.dischargedpatients = this.dischargedpatients;
		clone.tcifortoday = this.tcifortoday;
	...
	public int countFieldsWithValue()
	{
		...
		if(this.currentward != null)
			count++;
		if(this.currentinpatients != null)
			count++;
		if(this.dischargedpatients != null)
			count++;
		if(this.tcifortoday != null)
			count++;
		return count;
	}
	...
	protected Boolean currentinpatients;
	protected Boolean dischargedpatients;
	protected Boolean tcifortoday;
