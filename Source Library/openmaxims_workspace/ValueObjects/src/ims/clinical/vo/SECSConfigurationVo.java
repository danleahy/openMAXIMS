...
public class SECSConfigurationVo extends ims.clinical.configuration.vo.SECSConfigurationRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public SECSConfigurationVo(ims.clinical.vo.beans.SECSConfigurationVoBean bean)
	{
		...
		this.type = bean.getType() == null ? null : ims.core.vo.lookups.OBSType.buildLookup(bean.getType());
		...
		this.isrequiredforscore = bean.getIsRequiredForScore();
	}
	...
	public Object getFieldValueByFieldName(String fieldName)
	{
		...
		if(fieldName.equals("ISREQUIREDFORSCORE"))
			return getIsRequiredForScore();
	...
	public ims.core.vo.lookups.OBSType getType()
	{
		return this.type;
	}
	public void setType(ims.core.vo.lookups.OBSType value)
	{
	...
	public boolean getIsRequiredForScoreIsNotNull()
	{
		return this.isrequiredforscore != null;
	}
	...
	public Object clone()
	{
		...
		if(this.type == null)
			...
			clone.type = (ims.core.vo.lookups.OBSType)this.type.clone();
		if(this.rangeconfig == null)
		...
		clone.isrequiredforscore = this.isrequiredforscore;
	...
	public int countFieldsWithValue()
	{
		...
		if(this.effectiveto != null)
			count++;
		if(this.isrequiredforscore != null)
			count++;
		return count;
	}
	...
	protected ims.core.vo.lookups.OBSType type;
	...
	protected Boolean isrequiredforscore;
