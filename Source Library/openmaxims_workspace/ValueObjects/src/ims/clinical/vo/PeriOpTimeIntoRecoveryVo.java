 ...
 */
public class PeriOpTimeIntoRecoveryVo extends ims.clinical.vo.PeriOpTimeIntoRecoveryRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public PeriOpTimeIntoRecoveryVo()
	{
	}
	public PeriOpTimeIntoRecoveryVo(Integer id, int version)
	{
		super(id, version);
	}
	public PeriOpTimeIntoRecoveryVo(ims.clinical.vo.beans.PeriOpTimeIntoRecoveryVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.clinical.vo.beans.PeriOpTimeIntoRecoveryVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.theatreappointment = bean.getTheatreAppointment() == null ? null : new ims.scheduling.vo.Booking_AppointmentRefVo(new Integer(bean.getTheatreAppointment().getId()), bean.getTheatreAppointment().getVersion());
	...
	{
		ims.clinical.vo.beans.PeriOpTimeIntoRecoveryVoBean bean = null;
		if(map != null)
			bean = (ims.clinical.vo.beans.PeriOpTimeIntoRecoveryVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.clinical.vo.beans.PeriOpTimeIntoRecoveryVoBean();
	...
	public Object clone()
	{
		...
		PeriOpTimeIntoRecoveryVo clone = new PeriOpTimeIntoRecoveryVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(PeriOpTimeIntoRecoveryVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A PeriOpTimeIntoRecoveryVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((PeriOpTimeIntoRecoveryVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((PeriOpTimeIntoRecoveryVo)obj).getBoId());
	}
