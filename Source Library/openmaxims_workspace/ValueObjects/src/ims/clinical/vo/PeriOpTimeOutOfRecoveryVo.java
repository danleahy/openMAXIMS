 ...
 */
public class PeriOpTimeOutOfRecoveryVo extends ims.clinical.vo.PeriOpTimeOutOfRecoveryTiRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public PeriOpTimeOutOfRecoveryVo()
	{
	}
	public PeriOpTimeOutOfRecoveryVo(Integer id, int version)
	{
		super(id, version);
	}
	public PeriOpTimeOutOfRecoveryVo(ims.clinical.vo.beans.PeriOpTimeOutOfRecoveryVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.clinical.vo.beans.PeriOpTimeOutOfRecoveryVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.theatreappointment = bean.getTheatreAppointment() == null ? null : new ims.scheduling.vo.Booking_AppointmentRefVo(new Integer(bean.getTheatreAppointment().getId()), bean.getTheatreAppointment().getVersion());
	...
	{
		ims.clinical.vo.beans.PeriOpTimeOutOfRecoveryVoBean bean = null;
		if(map != null)
			bean = (ims.clinical.vo.beans.PeriOpTimeOutOfRecoveryVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.clinical.vo.beans.PeriOpTimeOutOfRecoveryVoBean();
	...
	public Object clone()
	{
		...
		PeriOpTimeOutOfRecoveryVo clone = new PeriOpTimeOutOfRecoveryVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(PeriOpTimeOutOfRecoveryVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A PeriOpTimeOutOfRecoveryVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((PeriOpTimeOutOfRecoveryVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((PeriOpTimeOutOfRecoveryVo)obj).getBoId());
	}
