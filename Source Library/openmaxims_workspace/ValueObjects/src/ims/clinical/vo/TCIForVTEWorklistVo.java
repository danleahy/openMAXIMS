 ...
 */
public class TCIForVTEWorklistVo extends ims.core.admin.pas.vo.PendingElectiveAdmissionRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public TCIForVTEWorklistVo()
	{
	}
	public TCIForVTEWorklistVo(Integer id, int version)
	{
		super(id, version);
	}
	public TCIForVTEWorklistVo(ims.clinical.vo.beans.TCIForVTEWorklistVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.clinical.vo.beans.TCIForVTEWorklistVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.clinical.vo.beans.TCIForVTEWorklistVoBean bean = null;
		if(map != null)
			bean = (ims.clinical.vo.beans.TCIForVTEWorklistVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.clinical.vo.beans.TCIForVTEWorklistVoBean();
	...
	public Object clone()
	{
		...
		TCIForVTEWorklistVo clone = new TCIForVTEWorklistVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(TCIForVTEWorklistVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A TCIForVTEWorklistVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((TCIForVTEWorklistVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((TCIForVTEWorklistVo)obj).getBoId());
	}
