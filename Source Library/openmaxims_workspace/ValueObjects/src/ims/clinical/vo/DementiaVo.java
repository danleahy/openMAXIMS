...
public class DementiaVo extends ims.core.clinical.vo.DementiaRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public ims.core.vo.PatientForDementiaLiteVo getPatient()
	{
		return this.patient;
	}
	public void setPatient(ims.core.vo.PatientForDementiaLiteVo value)
	{
	...
	public Object clone()
	{
		...
		if(this.patient == null)
			...
			clone.patient = (ims.core.vo.PatientForDementiaLiteVo)this.patient.clone();
		if(this.admissiondatetime == null)
	...
	protected ims.core.vo.PatientForDementiaLiteVo patient;
