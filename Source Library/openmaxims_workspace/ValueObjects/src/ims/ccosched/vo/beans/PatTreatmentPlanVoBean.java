...
public class PatTreatmentPlanVoBean extends ims.vo.ValueObjectBean
{
	public PatTreatmentPlanVoBean()
	{
	}
	public PatTreatmentPlanVoBean(ims.ccosched.vo.PatTreatmentPlanVo vo)
	{
		this.id = vo.getBoId();
		...
		this.creationuser = vo.getCreationUser() == null ? null : new ims.vo.RefVoBean(vo.getCreationUser().getBoId(), vo.getCreationUser().getBoVersion());
		this.patientstatus = vo.getPatientStatus() == null ? null : (ims.vo.LookupInstanceBean)vo.getPatientStatus().getBean();
		this.authuser = vo.getAuthUser() == null ? null : new ims.vo.RefVoBean(vo.getAuthUser().getBoId(), vo.getAuthUser().getBoVersion());
		this.modu = vo.getModu();
		this.surgeryrequired = vo.getSurgeryRequired() == null ? null : (ims.vo.LookupInstanceBean)vo.getSurgeryRequired().getBean();
		this.seenlocation = vo.getSeenLocation() == null ? null : (ims.vo.LookupInstanceBean)vo.getSeenLocation().getBean();
	}

	public void populate(ims.vo.ValueObjectBeanMap map, ims.ccosched.vo.PatTreatmentPlanVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.treatmentintent = vo.getTreatmentIntent() == null ? null : (ims.vo.LookupInstanceBean)vo.getTreatmentIntent().getBean();
	...
	public ims.ccosched.vo.PatTreatmentPlanVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.ccosched.vo.PatTreatmentPlanVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.ccosched.vo.PatTreatmentPlanVo vo = null;
		if(map != null)
			vo = (ims.ccosched.vo.PatTreatmentPlanVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.ccosched.vo.PatTreatmentPlanVo();
	...
	public ims.vo.RefVoBean getCreationUser()
	{
		return this.creationuser;
	}
	public void setCreationUser(ims.vo.RefVoBean value)
	{
	...
	public ims.vo.RefVoBean getAuthUser()
	{
		return this.authuser;
	}
	public void setAuthUser(ims.vo.RefVoBean value)
	{
		this.authuser = value;
	}
	...
	public ims.vo.LookupInstanceBean getSurgeryRequired()
	{
		return this.surgeryrequired;
	}
	public void setSurgeryRequired(ims.vo.LookupInstanceBean value)
	{
		this.surgeryrequired = value;
	}
	public ims.vo.LookupInstanceBean getSeenLocation()
	{
		return this.seenlocation;
	}
	public void setSeenLocation(ims.vo.LookupInstanceBean value)
	{
	...
	private ims.vo.RefVoBean creationuser;
	private ims.vo.LookupInstanceBean patientstatus;
	private ims.vo.RefVoBean authuser;
	private Integer modu;
	private ims.vo.LookupInstanceBean surgeryrequired;
	private ims.vo.LookupInstanceBean seenlocation;
}
