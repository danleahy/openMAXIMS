	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.helpurl != null)
			if(this.helpurl.length() > 1024)
				listOfErrors.add("The length of the field [helpurl] in the value object [ims.assessment.vo.UserAssessmentShortVo] is too big. It should be less or equal to 1024");
