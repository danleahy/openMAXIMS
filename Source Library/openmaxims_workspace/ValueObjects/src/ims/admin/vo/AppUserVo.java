	...
	*/
		...
		{		
			...
			{				
				...
				{
					if (this.getRoles().get(i).isactive)
					{
						coll.add(this.getRoles().get(i));
					}
				}
			}
		...
		{
			this.setLocked(new Boolean(value));
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.sdsuserid != null)
			if(this.sdsuserid.length() > 30)
				listOfErrors.add("The length of the field [sdsuserid] in the value object [ims.admin.vo.AppUserVo] is too big. It should be less or equal to 30");
