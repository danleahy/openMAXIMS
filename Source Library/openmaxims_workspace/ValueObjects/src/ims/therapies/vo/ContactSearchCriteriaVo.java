...
public class ContactSearchCriteriaVo extends ims.vo.ValueObject implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public ContactSearchCriteriaVo()
	{
	}
	public ContactSearchCriteriaVo(ims.therapies.vo.beans.ContactSearchCriteriaVoBean bean)
	{
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.therapies.vo.beans.ContactSearchCriteriaVoBean bean)
	{
	...
	{
		ims.therapies.vo.beans.ContactSearchCriteriaVoBean bean = null;
		if(map != null)
			bean = (ims.therapies.vo.beans.ContactSearchCriteriaVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.therapies.vo.beans.ContactSearchCriteriaVoBean();
	...
	public boolean equals(Object obj)
	{
		if(obj == null)
			return false;
		if(!(obj instanceof ContactSearchCriteriaVo))
			return false;
		ContactSearchCriteriaVo compareObj = (ContactSearchCriteriaVo)obj;
		if(this.getHcpLite() == null && compareObj.getHcpLite() != null)
			return false;
		if(this.getHcpLite() != null && compareObj.getHcpLite() == null)
			return false;
		if(this.getHcpLite() != null && compareObj.getHcpLite() != null)
			if(!this.getHcpLite().equals(compareObj.getHcpLite()))
				return false;
		...
		if(this.getHCPDiscipline() != null && compareObj.getHCPDiscipline() == null)
			return false;
		if(this.getHCPDiscipline() != null && compareObj.getHCPDiscipline() != null)
			if(!this.getHCPDiscipline().equals(compareObj.getHCPDiscipline()))
				return false;
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.hcplite != null)
		{
			String[] listOfOtherErrors = this.hcplite.validate();
	...
	public Object clone()
	{
		...
		ContactSearchCriteriaVo clone = new ContactSearchCriteriaVo();
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(ContactSearchCriteriaVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A ContactSearchCriteriaVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		ContactSearchCriteriaVo compareObj = (ContactSearchCriteriaVo)obj;
		int retVal = 0;
		if (retVal == 0)
		...
		if (retVal == 0)
		{
			...
			if(this.getHCPDiscipline() != null && compareObj.getHCPDiscipline() == null)
				return 1;
			if(this.getHCPDiscipline() != null && compareObj.getHCPDiscipline() != null)
				retVal = this.getHCPDiscipline().compareTo(compareObj.getHCPDiscipline());
		}
		if (retVal == 0)
		{
			if(this.getDateFrom() == null && compareObj.getDateFrom() != null)
