 ...
 */
public class ifWardMessageQueueVo extends ims.core.resource.place.vo.LocationRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public ifWardMessageQueueVo()
	{
	}
	public ifWardMessageQueueVo(Integer id, int version)
	{
		super(id, version);
	}
	public ifWardMessageQueueVo(ims.hl7.vo.beans.ifWardMessageQueueVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.hl7.vo.beans.ifWardMessageQueueVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.name = bean.getName();
	...
	{
		ims.hl7.vo.beans.ifWardMessageQueueVoBean bean = null;
		if(map != null)
			bean = (ims.hl7.vo.beans.ifWardMessageQueueVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.hl7.vo.beans.ifWardMessageQueueVoBean();
	...
	public ims.core.vo.LocShortMappingsVo getParentLocation()
	{
		return this.parentlocation;
	}
	public void setParentLocation(ims.core.vo.LocShortMappingsVo value)
	{
		this.isValidated = false;
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.name == null || this.name.length() == 0)
			...
			listOfErrors.add("The length of the field [name] in the value object [ims.hl7.vo.ifWardMessageQueueVo] is too big. It should be less or equal to 120");
		if(this.address != null)
		{
	...
	public Object clone()
	{
		...
		ifWardMessageQueueVo clone = new ifWardMessageQueueVo(this.id, this.version);
		...
		if(this.parentlocation == null)
			...
			clone.parentlocation = (ims.core.vo.LocShortMappingsVo)this.parentlocation.clone();
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(ifWardMessageQueueVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A ifWardMessageQueueVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((ifWardMessageQueueVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((ifWardMessageQueueVo)obj).getBoId());
	}
	...
	protected ims.core.vo.LocShortMappingsVo parentlocation;
