 ...
 */
public class FinTransMessQueueVo extends ims.hl7adtout.vo.FinTransMessQueueRefVo implements ims.vo.ImsCloneable, Comparable, ims.vo.interfaces.IHL7OutboundMessageHandler
{
	private static final long serialVersionUID = 1L;

	public FinTransMessQueueVo()
	{
	}
	public FinTransMessQueueVo(Integer id, int version)
	{
		super(id, version);
	}
	public FinTransMessQueueVo(ims.hl7.vo.beans.FinTransMessQueueVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.hl7.vo.beans.FinTransMessQueueVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.hl7.vo.beans.FinTransMessQueueVoBean bean = null;
		if(map != null)
			bean = (ims.hl7.vo.beans.FinTransMessQueueVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.hl7.vo.beans.FinTransMessQueueVoBean();
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.acktext != null)
			if(this.acktext.length() > 1000)
				listOfErrors.add("The length of the field [acktext] in the value object [ims.hl7.vo.FinTransMessQueueVo] is too big. It should be less or equal to 1000");
		if(this.failuremsg != null)
			if(this.failuremsg.length() > 1000)
				listOfErrors.add("The length of the field [failuremsg] in the value object [ims.hl7.vo.FinTransMessQueueVo] is too big. It should be less or equal to 1000");
	...
	public Object clone()
	{
		...
		FinTransMessQueueVo clone = new FinTransMessQueueVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(FinTransMessQueueVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A FinTransMessQueueVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((FinTransMessQueueVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((FinTransMessQueueVo)obj).getBoId());
	}
