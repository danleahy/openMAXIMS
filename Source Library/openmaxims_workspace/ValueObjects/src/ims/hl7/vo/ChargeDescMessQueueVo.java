 ...
 */
public class ChargeDescMessQueueVo extends ims.hl7adtout.vo.ChargeDescMessQueueRefVo implements ims.vo.ImsCloneable, Comparable, ims.vo.interfaces.IHL7OutboundMessageHandler
{
	private static final long serialVersionUID = 1L;

	public ChargeDescMessQueueVo()
	{
	}
	public ChargeDescMessQueueVo(Integer id, int version)
	{
		super(id, version);
	}
	public ChargeDescMessQueueVo(ims.hl7.vo.beans.ChargeDescMessQueueVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.hl7.vo.beans.ChargeDescMessQueueVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.hl7.vo.beans.ChargeDescMessQueueVoBean bean = null;
		if(map != null)
			bean = (ims.hl7.vo.beans.ChargeDescMessQueueVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.hl7.vo.beans.ChargeDescMessQueueVoBean();
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.acktext != null)
			if(this.acktext.length() > 1000)
				listOfErrors.add("The length of the field [acktext] in the value object [ims.hl7.vo.ChargeDescMessQueueVo] is too big. It should be less or equal to 1000");
		if(this.failuremsg != null)
			if(this.failuremsg.length() > 1000)
				listOfErrors.add("The length of the field [failuremsg] in the value object [ims.hl7.vo.ChargeDescMessQueueVo] is too big. It should be less or equal to 1000");
	...
	public Object clone()
	{
		...
		ChargeDescMessQueueVo clone = new ChargeDescMessQueueVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(ChargeDescMessQueueVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A ChargeDescMessQueueVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((ChargeDescMessQueueVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((ChargeDescMessQueueVo)obj).getBoId());
	}
