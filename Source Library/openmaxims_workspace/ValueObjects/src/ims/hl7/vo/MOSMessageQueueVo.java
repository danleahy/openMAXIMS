 ...
 */
public class MOSMessageQueueVo extends ims.hl7adtout.vo.MOSMessageQueueRefVo implements ims.vo.ImsCloneable, Comparable, ims.vo.interfaces.IHL7OutboundMessageHandler
{
	private static final long serialVersionUID = 1L;

	public MOSMessageQueueVo()
	{
	}
	public MOSMessageQueueVo(Integer id, int version)
	{
		super(id, version);
	}
	public MOSMessageQueueVo(ims.hl7.vo.beans.MOSMessageQueueVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.hl7.vo.beans.MOSMessageQueueVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.hl7.vo.beans.MOSMessageQueueVoBean bean = null;
		if(map != null)
			bean = (ims.hl7.vo.beans.MOSMessageQueueVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.hl7.vo.beans.MOSMessageQueueVoBean();
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.acktext != null)
			if(this.acktext.length() > 1000)
				listOfErrors.add("The length of the field [acktext] in the value object [ims.hl7.vo.MOSMessageQueueVo] is too big. It should be less or equal to 1000");
		if(this.failuremsg != null)
			if(this.failuremsg.length() > 1000)
				listOfErrors.add("The length of the field [failuremsg] in the value object [ims.hl7.vo.MOSMessageQueueVo] is too big. It should be less or equal to 1000");
	...
	public Object clone()
	{
		...
		MOSMessageQueueVo clone = new MOSMessageQueueVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(MOSMessageQueueVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A MOSMessageQueueVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((MOSMessageQueueVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((MOSMessageQueueVo)obj).getBoId());
	}
