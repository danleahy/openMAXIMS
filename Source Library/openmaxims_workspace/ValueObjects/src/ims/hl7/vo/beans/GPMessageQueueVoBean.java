...
public class GPMessageQueueVoBean extends ims.vo.ValueObjectBean
{
	public GPMessageQueueVoBean()
	{
	}
	public GPMessageQueueVoBean(ims.hl7.vo.GPMessageQueueVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.hl7.vo.GPMessageQueueVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
	...
	public ims.hl7.vo.GPMessageQueueVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.hl7.vo.GPMessageQueueVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.hl7.vo.GPMessageQueueVo vo = null;
		if(map != null)
			vo = (ims.hl7.vo.GPMessageQueueVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.hl7.vo.GPMessageQueueVo();
