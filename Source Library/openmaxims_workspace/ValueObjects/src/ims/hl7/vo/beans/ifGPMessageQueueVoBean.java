...
public class ifGPMessageQueueVoBean extends ims.vo.ValueObjectBean
{
	public ifGPMessageQueueVoBean()
	{
	}
	public ifGPMessageQueueVoBean(ims.hl7.vo.ifGPMessageQueueVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.hl7.vo.ifGPMessageQueueVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
	...
	public ims.hl7.vo.ifGPMessageQueueVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.hl7.vo.ifGPMessageQueueVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.hl7.vo.ifGPMessageQueueVo vo = null;
		if(map != null)
			vo = (ims.hl7.vo.ifGPMessageQueueVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.hl7.vo.ifGPMessageQueueVo();
