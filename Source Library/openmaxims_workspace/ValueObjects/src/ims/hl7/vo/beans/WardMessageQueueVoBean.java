...
public class WardMessageQueueVoBean extends ims.vo.ValueObjectBean
{
	public WardMessageQueueVoBean()
	{
	}
	public WardMessageQueueVoBean(ims.hl7.vo.WardMessageQueueVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.hl7.vo.WardMessageQueueVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
	...
	public ims.hl7.vo.WardMessageQueueVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.hl7.vo.WardMessageQueueVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.hl7.vo.WardMessageQueueVo vo = null;
		if(map != null)
			vo = (ims.hl7.vo.WardMessageQueueVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.hl7.vo.WardMessageQueueVo();
