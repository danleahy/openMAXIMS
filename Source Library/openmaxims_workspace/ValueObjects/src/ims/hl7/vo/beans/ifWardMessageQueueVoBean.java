...
public class ifWardMessageQueueVoBean extends ims.vo.ValueObjectBean
{
	public ifWardMessageQueueVoBean()
	{
	}
	public ifWardMessageQueueVoBean(ims.hl7.vo.ifWardMessageQueueVo vo)
	{
		this.id = vo.getBoId();
		...
		this.parentlocation = vo.getParentLocation() == null ? null : (ims.core.vo.beans.LocShortMappingsVoBean)vo.getParentLocation().getBean();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.hl7.vo.ifWardMessageQueueVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.name = vo.getName();
		...
		this.type = vo.getType() == null ? null : (ims.vo.LookupInstanceBean)vo.getType().getBean();
		this.isactive = vo.getIsActive();
		this.parentlocation = vo.getParentLocation() == null ? null : (ims.core.vo.beans.LocShortMappingsVoBean)vo.getParentLocation().getBean(map);
		this.codemappings = vo.getCodeMappings() == null ? null : vo.getCodeMappings().getBeanCollection();
		this.systeminformation = vo.getSystemInformation() == null ? null : (ims.vo.SysInfoBean)vo.getSystemInformation().getBean();
	}

	public ims.hl7.vo.ifWardMessageQueueVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.hl7.vo.ifWardMessageQueueVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.hl7.vo.ifWardMessageQueueVo vo = null;
		if(map != null)
			vo = (ims.hl7.vo.ifWardMessageQueueVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.hl7.vo.ifWardMessageQueueVo();
	...
	public ims.core.vo.beans.LocShortMappingsVoBean getParentLocation()
	{
		return this.parentlocation;
	}
	public void setParentLocation(ims.core.vo.beans.LocShortMappingsVoBean value)
	{
	...
	private ims.core.vo.beans.LocShortMappingsVoBean parentlocation;
