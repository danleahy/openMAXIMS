 ...
 */
public class GPPracticeMessageQueueVo extends ims.hl7adtout.vo.GPPracticeMessageQueueRefVo implements ims.vo.ImsCloneable, Comparable, ims.vo.interfaces.IHL7OutboundMessageHandler
{
	private static final long serialVersionUID = 1L;

	public GPPracticeMessageQueueVo()
	{
	}
	public GPPracticeMessageQueueVo(Integer id, int version)
	{
		super(id, version);
	}
	public GPPracticeMessageQueueVo(ims.hl7.vo.beans.GPPracticeMessageQueueVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.hl7.vo.beans.GPPracticeMessageQueueVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.hl7.vo.beans.GPPracticeMessageQueueVoBean bean = null;
		if(map != null)
			bean = (ims.hl7.vo.beans.GPPracticeMessageQueueVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.hl7.vo.beans.GPPracticeMessageQueueVoBean();
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.acktext != null)
			if(this.acktext.length() > 1000)
				listOfErrors.add("The length of the field [acktext] in the value object [ims.hl7.vo.GPPracticeMessageQueueVo] is too big. It should be less or equal to 1000");
		if(this.failuremsg != null)
			if(this.failuremsg.length() > 1000)
				listOfErrors.add("The length of the field [failuremsg] in the value object [ims.hl7.vo.GPPracticeMessageQueueVo] is too big. It should be less or equal to 1000");
	...
	public Object clone()
	{
		...
		GPPracticeMessageQueueVo clone = new GPPracticeMessageQueueVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(GPPracticeMessageQueueVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A GPPracticeMessageQueueVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((GPPracticeMessageQueueVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((GPPracticeMessageQueueVo)obj).getBoId());
	}
