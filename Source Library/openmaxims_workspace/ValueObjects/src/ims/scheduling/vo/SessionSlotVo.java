...
public class SessionSlotVo extends ims.scheduling.vo.SessionSlotLiteVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public SessionSlotVo(ims.scheduling.vo.beans.SessionSlotVoBean bean)
	{
		...
		this.wasblockedcabslot = bean.getWasBlockedCABSlot();
	}
	...
	public Object getFieldValueByFieldName(String fieldName)
	{
		...
		if(fieldName.equals("FUNCTIONS"))
			return getFunctions();
		if(fieldName.equals("WASBLOCKEDCABSLOT"))
			return getWasBlockedCABSlot();
	...
	public boolean getWasBlockedCABSlotIsNotNull()
	{
		return this.wasblockedcabslot != null;
	}
	...
	*/
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.cancelblockcomment != null)
			if(this.cancelblockcomment.length() > 250)
				listOfErrors.add("The length of the field [cancelblockcomment] in the value object [ims.scheduling.vo.SessionSlotVo] is too big. It should be less or equal to 250");
		if(this.comment != null)
			if(this.comment.length() > 500)
				listOfErrors.add("The length of the field [comment] in the value object [ims.scheduling.vo.SessionSlotVo] is too big. It should be less or equal to 500");
	...
	public Object clone()
	{
		...
		clone.wasblockedcabslot = this.wasblockedcabslot;
	...
	public int countFieldsWithValue()
	{
		...
		if(this.functions != null)
			count++;
		if(this.wasblockedcabslot != null)
			count++;
		return count;
	}
	...
	protected Boolean wasblockedcabslot;
