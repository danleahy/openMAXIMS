...
public class CancellationTypeReasonVo extends ims.scheduling.vo.CancellationTypeReasonRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public CancellationTypeReasonVo(ims.scheduling.vo.beans.CancellationTypeReasonVoBean bean)
	{
		...
		this.isnonmedicalreason = bean.getIsNonMedicalReason();
		this.outpatients = bean.getOutpatients();
		this.tcitheatre = bean.getTCITheatre();
	}
	...
	public Object getFieldValueByFieldName(String fieldName)
	{
		...
		if(fieldName.equals("ISNONMEDICALREASON"))
			return getIsNonMedicalReason();
		if(fieldName.equals("OUTPATIENTS"))
			return getOutpatients();
		if(fieldName.equals("TCITHEATRE"))
			return getTCITheatre();
	...
	public boolean getIsNonMedicalReasonIsNotNull()
	{
		return this.isnonmedicalreason != null;
	}
	...
	public boolean getOutpatientsIsNotNull()
	{
		return this.outpatients != null;
	}
	...
	public boolean getTCITheatreIsNotNull()
	{
		return this.tcitheatre != null;
	}
	...
	public Object clone()
	{
		...
		clone.isnonmedicalreason = this.isnonmedicalreason;
		clone.outpatients = this.outpatients;
		clone.tcitheatre = this.tcitheatre;
	...
	public int countFieldsWithValue()
	{
		...
		if(this.cancellationreason != null)
			count++;
		if(this.isnonmedicalreason != null)
			count++;
		if(this.outpatients != null)
			count++;
		if(this.tcitheatre != null)
			count++;
		return count;
	}
	...
	protected Boolean isnonmedicalreason;
	protected Boolean outpatients;
	protected Boolean tcitheatre;
