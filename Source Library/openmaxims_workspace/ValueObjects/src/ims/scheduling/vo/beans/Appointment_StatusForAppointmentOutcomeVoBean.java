...
public class Appointment_StatusForAppointmentOutcomeVoBean extends ims.vo.ValueObjectBean
{
	public Appointment_StatusForAppointmentOutcomeVoBean()
	{
	}
	public Appointment_StatusForAppointmentOutcomeVoBean(ims.scheduling.vo.Appointment_StatusForAppointmentOutcomeVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.scheduling.vo.Appointment_StatusForAppointmentOutcomeVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.status = vo.getStatus() == null ? null : (ims.vo.LookupInstanceBean)vo.getStatus().getBean();
	...
	public ims.scheduling.vo.Appointment_StatusForAppointmentOutcomeVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.scheduling.vo.Appointment_StatusForAppointmentOutcomeVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.scheduling.vo.Appointment_StatusForAppointmentOutcomeVo vo = null;
		if(map != null)
			vo = (ims.scheduling.vo.Appointment_StatusForAppointmentOutcomeVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.scheduling.vo.Appointment_StatusForAppointmentOutcomeVo();
