...
public class BookingAppointmentFlexibleLiteVoBean extends ims.vo.ValueObjectBean
{
	public BookingAppointmentFlexibleLiteVoBean()
	{
	}
	public BookingAppointmentFlexibleLiteVoBean(ims.scheduling.vo.BookingAppointmentFlexibleLiteVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.scheduling.vo.BookingAppointmentFlexibleLiteVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
	...
	public ims.scheduling.vo.BookingAppointmentFlexibleLiteVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.scheduling.vo.BookingAppointmentFlexibleLiteVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.scheduling.vo.BookingAppointmentFlexibleLiteVo vo = null;
		if(map != null)
			vo = (ims.scheduling.vo.BookingAppointmentFlexibleLiteVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.scheduling.vo.BookingAppointmentFlexibleLiteVo();
