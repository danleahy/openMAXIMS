...
public class BookAppointmentStartDateVoBean extends ims.vo.ValueObjectBean
{
	public BookAppointmentStartDateVoBean()
	{
	}
	public BookAppointmentStartDateVoBean(ims.scheduling.vo.BookAppointmentStartDateVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.scheduling.vo.BookAppointmentStartDateVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.appointmentdate = vo.getAppointmentDate() == null ? null : (ims.framework.utils.beans.DateBean)vo.getAppointmentDate().getBean();
	...
	public ims.scheduling.vo.BookAppointmentStartDateVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.scheduling.vo.BookAppointmentStartDateVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.scheduling.vo.BookAppointmentStartDateVo vo = null;
		if(map != null)
			vo = (ims.scheduling.vo.BookAppointmentStartDateVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.scheduling.vo.BookAppointmentStartDateVo();
