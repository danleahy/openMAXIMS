...
public class AppointmentMessageQueueVoBean extends ims.vo.ValueObjectBean
{
	public AppointmentMessageQueueVoBean()
	{
	}
	public AppointmentMessageQueueVoBean(ims.scheduling.vo.AppointmentMessageQueueVo vo)
	{
		this.id = vo.getBoId();
		...
		this.appointment = vo.getAppointment() == null ? null : (ims.scheduling.vo.beans.ifSch_BookingLiteVoBean)vo.getAppointment().getBean();
		this.apptdetail = vo.getApptDetail() == null ? null : new ims.vo.RefVoBean(vo.getApptDetail().getBoId(), vo.getApptDetail().getBoVersion());
	}

	public void populate(ims.vo.ValueObjectBeanMap map, ims.scheduling.vo.AppointmentMessageQueueVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.wasprocessed = vo.getWasProcessed();
		...
		this.referral = vo.getReferral() == null ? null : new ims.vo.RefVoBean(vo.getReferral().getBoId(), vo.getReferral().getBoVersion());
		this.appointment = vo.getAppointment() == null ? null : (ims.scheduling.vo.beans.ifSch_BookingLiteVoBean)vo.getAppointment().getBean(map);
		this.apptdetail = vo.getApptDetail() == null ? null : new ims.vo.RefVoBean(vo.getApptDetail().getBoId(), vo.getApptDetail().getBoVersion());
	}

	public ims.scheduling.vo.AppointmentMessageQueueVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.scheduling.vo.AppointmentMessageQueueVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.scheduling.vo.AppointmentMessageQueueVo vo = null;
		if(map != null)
			vo = (ims.scheduling.vo.AppointmentMessageQueueVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.scheduling.vo.AppointmentMessageQueueVo();
	...
	public ims.scheduling.vo.beans.ifSch_BookingLiteVoBean getAppointment()
	{
		return this.appointment;
	}
	public void setAppointment(ims.scheduling.vo.beans.ifSch_BookingLiteVoBean value)
	{
	...
	private ims.scheduling.vo.beans.ifSch_BookingLiteVoBean appointment;
