...
public class ExclusionTimesVoBean extends ims.vo.ValueObjectBean
{
	public ExclusionTimesVoBean()
	{
	}
	public ExclusionTimesVoBean(ims.scheduling.vo.ExclusionTimesVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.scheduling.vo.ExclusionTimesVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.starttime = vo.getStartTime() == null ? null : (ims.framework.utils.beans.TimeBean)vo.getStartTime().getBean();
	...
	public ims.scheduling.vo.ExclusionTimesVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.scheduling.vo.ExclusionTimesVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.scheduling.vo.ExclusionTimesVo vo = null;
		if(map != null)
			vo = (ims.scheduling.vo.ExclusionTimesVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.scheduling.vo.ExclusionTimesVo();
