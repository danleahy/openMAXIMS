...
public class SessionSlotForDisplacedAppointmentsVoBean extends ims.vo.ValueObjectBean
{
	public SessionSlotForDisplacedAppointmentsVoBean()
	{
	}
	public SessionSlotForDisplacedAppointmentsVoBean(ims.scheduling.vo.SessionSlotForDisplacedAppointmentsVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.scheduling.vo.SessionSlotForDisplacedAppointmentsVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.starttm = vo.getStartTm() == null ? null : (ims.framework.utils.beans.TimeBean)vo.getStartTm().getBean();
	...
	public ims.scheduling.vo.SessionSlotForDisplacedAppointmentsVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.scheduling.vo.SessionSlotForDisplacedAppointmentsVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.scheduling.vo.SessionSlotForDisplacedAppointmentsVo vo = null;
		if(map != null)
			vo = (ims.scheduling.vo.SessionSlotForDisplacedAppointmentsVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.scheduling.vo.SessionSlotForDisplacedAppointmentsVo();
