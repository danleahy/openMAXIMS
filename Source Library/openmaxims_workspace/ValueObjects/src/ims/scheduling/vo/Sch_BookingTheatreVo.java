	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.bookingcomments != null)
			if(this.bookingcomments.length() > 500)
				listOfErrors.add("The length of the field [bookingcomments] in the value object [ims.scheduling.vo.Sch_BookingTheatreVo] is too big. It should be less or equal to 500");
		if(this.appointments != null)
		{
