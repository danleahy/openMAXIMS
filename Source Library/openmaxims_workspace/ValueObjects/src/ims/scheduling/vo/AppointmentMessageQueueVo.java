 ...
 */
public class AppointmentMessageQueueVo extends ims.hl7adtout.vo.AppointmentMessageQueueRefVo implements ims.vo.ImsCloneable, Comparable, ims.vo.interfaces.IHL7OutboundMessageHandler
{
	private static final long serialVersionUID = 1L;

	public AppointmentMessageQueueVo()
	{
	}
	public AppointmentMessageQueueVo(Integer id, int version)
	{
		super(id, version);
	}
	public AppointmentMessageQueueVo(ims.scheduling.vo.beans.AppointmentMessageQueueVoBean bean)
	{
		this.id = bean.getId();
		...
		this.apptdetail = bean.getApptDetail() == null ? null : new ims.scheduling.vo.Booking_AppointmentRefVo(new Integer(bean.getApptDetail().getId()), bean.getApptDetail().getVersion());
	}
	public void populate(ims.vo.ValueObjectBeanMap map, ims.scheduling.vo.beans.AppointmentMessageQueueVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.wasprocessed = bean.getWasProcessed();
	...
	{
		ims.scheduling.vo.beans.AppointmentMessageQueueVoBean bean = null;
		if(map != null)
			bean = (ims.scheduling.vo.beans.AppointmentMessageQueueVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.scheduling.vo.beans.AppointmentMessageQueueVoBean();
	...
	public ims.scheduling.vo.ifSch_BookingLiteVo getAppointment()
	{
		return this.appointment;
	}
	public void setAppointment(ims.scheduling.vo.ifSch_BookingLiteVo value)
	{
		this.isValidated = false;
	...
	public ims.scheduling.vo.Booking_AppointmentRefVo getApptDetail()
	{
		return this.apptdetail;
	}
	public void setApptDetail(ims.scheduling.vo.Booking_AppointmentRefVo value)
	{
		this.isValidated = false;
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.acktext != null)
			if(this.acktext.length() > 1000)
				listOfErrors.add("The length of the field [acktext] in the value object [ims.scheduling.vo.AppointmentMessageQueueVo] is too big. It should be less or equal to 1000");
		if(this.msgtype == null)
			listOfErrors.add("msgType is mandatory");
		if(this.failuremsg != null)
			if(this.failuremsg.length() > 1000)
				listOfErrors.add("The length of the field [failuremsg] in the value object [ims.scheduling.vo.AppointmentMessageQueueVo] is too big. It should be less or equal to 1000");
		if(this.apptdetail == null)
			listOfErrors.add("ApptDetail is mandatory");
	...
	public Object clone()
	{
		...
		AppointmentMessageQueueVo clone = new AppointmentMessageQueueVo(this.id, this.version);
		...
		if(this.appointment == null)
			...
			clone.appointment = (ims.scheduling.vo.ifSch_BookingLiteVo)this.appointment.clone();
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(AppointmentMessageQueueVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A AppointmentMessageQueueVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((AppointmentMessageQueueVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((AppointmentMessageQueueVo)obj).getBoId());
	}
	...
	protected ims.scheduling.vo.ifSch_BookingLiteVo appointment;
	protected ims.scheduling.vo.Booking_AppointmentRefVo apptdetail;
