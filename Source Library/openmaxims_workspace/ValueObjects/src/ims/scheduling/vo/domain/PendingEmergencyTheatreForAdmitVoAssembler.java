 ...
 * @author Bogdan Tofei
 */
public class PendingEmergencyTheatreForAdmitVoAssembler
{
  	/**
	 ...
	 */
	 public static ims.scheduling.vo.PendingEmergencyTheatreForAdmitVo copy(ims.scheduling.vo.PendingEmergencyTheatreForAdmitVo valueObjectDest, ims.scheduling.vo.PendingEmergencyTheatreForAdmitVo valueObjectSrc) 
	 {
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createPendingEmergencyTheatreForAdmitVoCollectionFromPendingEmergencyTheatre(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.scheduling.domain.objects.PendingEmergencyTheatre objects.
	 */
	public static ims.scheduling.vo.PendingEmergencyTheatreForAdmitVoCollection createPendingEmergencyTheatreForAdmitVoCollectionFromPendingEmergencyTheatre(java.util.Set domainObjectSet)	
	{
		return createPendingEmergencyTheatreForAdmitVoCollectionFromPendingEmergencyTheatre(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.scheduling.domain.objects.PendingEmergencyTheatre objects.
	 */
	public static ims.scheduling.vo.PendingEmergencyTheatreForAdmitVoCollection createPendingEmergencyTheatreForAdmitVoCollectionFromPendingEmergencyTheatre(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.scheduling.vo.PendingEmergencyTheatreForAdmitVoCollection voList = new ims.scheduling.vo.PendingEmergencyTheatreForAdmitVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.scheduling.vo.PendingEmergencyTheatreForAdmitVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.scheduling.vo.PendingEmergencyTheatreForAdmitVoCollection createPendingEmergencyTheatreForAdmitVoCollectionFromPendingEmergencyTheatre(java.util.List domainObjectList) 
	{
		return createPendingEmergencyTheatreForAdmitVoCollectionFromPendingEmergencyTheatre(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.scheduling.domain.objects.PendingEmergencyTheatre objects.
	 */
	public static ims.scheduling.vo.PendingEmergencyTheatreForAdmitVoCollection createPendingEmergencyTheatreForAdmitVoCollectionFromPendingEmergencyTheatre(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.scheduling.vo.PendingEmergencyTheatreForAdmitVoCollection voList = new ims.scheduling.vo.PendingEmergencyTheatreForAdmitVoCollection();
	 ...
	 */
	 public static java.util.Set extractPendingEmergencyTheatreSet(ims.domain.ILightweightDomainFactory domainFactory, ims.scheduling.vo.PendingEmergencyTheatreForAdmitVoCollection voCollection) 
	 {
	 	return extractPendingEmergencyTheatreSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractPendingEmergencyTheatreSet(ims.domain.ILightweightDomainFactory domainFactory, ims.scheduling.vo.PendingEmergencyTheatreForAdmitVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.scheduling.vo.PendingEmergencyTheatreForAdmitVo vo = voCollection.get(i);
			ims.scheduling.domain.objects.PendingEmergencyTheatre domainObject = PendingEmergencyTheatreForAdmitVoAssembler.extractPendingEmergencyTheatre(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractPendingEmergencyTheatreList(ims.domain.ILightweightDomainFactory domainFactory, ims.scheduling.vo.PendingEmergencyTheatreForAdmitVoCollection voCollection) 
	 {
	 	return extractPendingEmergencyTheatreList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractPendingEmergencyTheatreList(ims.domain.ILightweightDomainFactory domainFactory, ims.scheduling.vo.PendingEmergencyTheatreForAdmitVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.scheduling.vo.PendingEmergencyTheatreForAdmitVo create(ims.scheduling.domain.objects.PendingEmergencyTheatre domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.scheduling.vo.PendingEmergencyTheatreForAdmitVo create(DomainObjectMap map, ims.scheduling.domain.objects.PendingEmergencyTheatre domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.scheduling.vo.PendingEmergencyTheatreForAdmitVo valueObject = (ims.scheduling.vo.PendingEmergencyTheatreForAdmitVo) map.getValueObject(domainObject, ims.scheduling.vo.PendingEmergencyTheatreForAdmitVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.scheduling.vo.PendingEmergencyTheatreForAdmitVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.scheduling.domain.objects.PendingEmergencyTheatre
	 */
	 public static ims.scheduling.vo.PendingEmergencyTheatreForAdmitVo insert(ims.scheduling.vo.PendingEmergencyTheatreForAdmitVo valueObject, ims.scheduling.domain.objects.PendingEmergencyTheatre domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.scheduling.domain.objects.PendingEmergencyTheatre
	 */
	 public static ims.scheduling.vo.PendingEmergencyTheatreForAdmitVo insert(DomainObjectMap map, ims.scheduling.vo.PendingEmergencyTheatreForAdmitVo valueObject, ims.scheduling.domain.objects.PendingEmergencyTheatre domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
		...
		// Referral
		valueObject.setReferral(ims.RefMan.vo.domain.CatsReferralForClinicListVoAssembler.create(map, domainObject.getCatsReferral()) );
		// CurrentStatus
	 ...
	 */
	public static ims.scheduling.domain.objects.PendingEmergencyTheatre extractPendingEmergencyTheatre(ims.domain.ILightweightDomainFactory domainFactory, ims.scheduling.vo.PendingEmergencyTheatreForAdmitVo valueObject) 
	{
		return 	extractPendingEmergencyTheatre(domainFactory, valueObject, new HashMap());
	}

	public static ims.scheduling.domain.objects.PendingEmergencyTheatre extractPendingEmergencyTheatre(ims.domain.ILightweightDomainFactory domainFactory, ims.scheduling.vo.PendingEmergencyTheatreForAdmitVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.scheduling.vo.PendingEmergencyTheatreForAdmitVo ID_PendingEmergencyTheatre field is unknown
	...
	ims.RefMan.domain.objects.CatsReferral value2 = null;
		...
		ims.framework.utils.DateTime dateTime4 = valueObject.getExpectedDateTime();
		java.util.Date value4 = null;
		if ( dateTime4 != null ) 
		{
			value4 = dateTime4.getJavaDate();
		}
		domainObject.setExpectedDateTime(value4);
	// SaveAsRefVO - treated as a refVo in extract methods
	ims.core.clinical.domain.objects.Service value5 = null;
		...
		ims.core.admin.pas.domain.objects.AdmissionDetail value6 = null;
		if ( null != valueObject.getAdmissionDetail() ) 
		{
			if (valueObject.getAdmissionDetail().getBoId() == null)
			{
				...
				{
					value6 = (ims.core.admin.pas.domain.objects.AdmissionDetail)domMap.get(valueObject.getAdmissionDetail());
				}
			}
			else if (valueObject.getBoVersion() == -1) // RefVo was not modified since obtained from the Assembler, no need to update the BO field
			{
				value6 = domainObject.getAdmissionDetail();	
			}
			else
			{
				value6 = (ims.core.admin.pas.domain.objects.AdmissionDetail)domainFactory.getDomainObject(ims.core.admin.pas.domain.objects.AdmissionDetail.class, valueObject.getAdmissionDetail().getBoId());
			}
		}
		domainObject.setAdmissionDetail(value6);
	// SaveAsRefVO - treated as a refVo in extract methods
