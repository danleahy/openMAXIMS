 ...
 * @author Bogdan Tofei
 */
public class SessionParentChildSlotListVoAssembler
{
  	/**
	 ...
	 */
	 public static ims.scheduling.vo.SessionParentChildSlotListVo copy(ims.scheduling.vo.SessionParentChildSlotListVo valueObjectDest, ims.scheduling.vo.SessionParentChildSlotListVo valueObjectSrc) 
	 {
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createSessionParentChildSlotListVoCollectionFromSessionParentChildSlot(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.scheduling.domain.objects.SessionParentChildSlot objects.
	 */
	public static ims.scheduling.vo.SessionParentChildSlotListVoCollection createSessionParentChildSlotListVoCollectionFromSessionParentChildSlot(java.util.Set domainObjectSet)	
	{
		return createSessionParentChildSlotListVoCollectionFromSessionParentChildSlot(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.scheduling.domain.objects.SessionParentChildSlot objects.
	 */
	public static ims.scheduling.vo.SessionParentChildSlotListVoCollection createSessionParentChildSlotListVoCollectionFromSessionParentChildSlot(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.scheduling.vo.SessionParentChildSlotListVoCollection voList = new ims.scheduling.vo.SessionParentChildSlotListVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.scheduling.vo.SessionParentChildSlotListVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.scheduling.vo.SessionParentChildSlotListVoCollection createSessionParentChildSlotListVoCollectionFromSessionParentChildSlot(java.util.List domainObjectList) 
	{
		return createSessionParentChildSlotListVoCollectionFromSessionParentChildSlot(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.scheduling.domain.objects.SessionParentChildSlot objects.
	 */
	public static ims.scheduling.vo.SessionParentChildSlotListVoCollection createSessionParentChildSlotListVoCollectionFromSessionParentChildSlot(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.scheduling.vo.SessionParentChildSlotListVoCollection voList = new ims.scheduling.vo.SessionParentChildSlotListVoCollection();
	 ...
	 */
	 public static java.util.Set extractSessionParentChildSlotSet(ims.domain.ILightweightDomainFactory domainFactory, ims.scheduling.vo.SessionParentChildSlotListVoCollection voCollection) 
	 {
	 	return extractSessionParentChildSlotSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractSessionParentChildSlotSet(ims.domain.ILightweightDomainFactory domainFactory, ims.scheduling.vo.SessionParentChildSlotListVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.scheduling.vo.SessionParentChildSlotListVo vo = voCollection.get(i);
			ims.scheduling.domain.objects.SessionParentChildSlot domainObject = SessionParentChildSlotListVoAssembler.extractSessionParentChildSlot(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractSessionParentChildSlotList(ims.domain.ILightweightDomainFactory domainFactory, ims.scheduling.vo.SessionParentChildSlotListVoCollection voCollection) 
	 {
	 	return extractSessionParentChildSlotList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractSessionParentChildSlotList(ims.domain.ILightweightDomainFactory domainFactory, ims.scheduling.vo.SessionParentChildSlotListVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.scheduling.vo.SessionParentChildSlotListVo create(ims.scheduling.domain.objects.SessionParentChildSlot domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.scheduling.vo.SessionParentChildSlotListVo create(DomainObjectMap map, ims.scheduling.domain.objects.SessionParentChildSlot domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.scheduling.vo.SessionParentChildSlotListVo valueObject = (ims.scheduling.vo.SessionParentChildSlotListVo) map.getValueObject(domainObject, ims.scheduling.vo.SessionParentChildSlotListVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.scheduling.vo.SessionParentChildSlotListVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.scheduling.domain.objects.SessionParentChildSlot
	 */
	 public static ims.scheduling.vo.SessionParentChildSlotListVo insert(ims.scheduling.vo.SessionParentChildSlotListVo valueObject, ims.scheduling.domain.objects.SessionParentChildSlot domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.scheduling.domain.objects.SessionParentChildSlot
	 */
	 public static ims.scheduling.vo.SessionParentChildSlotListVo insert(DomainObjectMap map, ims.scheduling.vo.SessionParentChildSlotListVo valueObject, ims.scheduling.domain.objects.SessionParentChildSlot domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
		...
		// Appointment
		valueObject.setAppointment(ims.scheduling.vo.domain.BookingAppointmentFlexibleLiteVoAssembler.create(map, domainObject.getAppointment()) );
		// Status
	 ...
	 */
	public static ims.scheduling.domain.objects.SessionParentChildSlot extractSessionParentChildSlot(ims.domain.ILightweightDomainFactory domainFactory, ims.scheduling.vo.SessionParentChildSlotListVo valueObject) 
	{
		return 	extractSessionParentChildSlot(domainFactory, valueObject, new HashMap());
	}

	public static ims.scheduling.domain.objects.SessionParentChildSlot extractSessionParentChildSlot(ims.domain.ILightweightDomainFactory domainFactory, ims.scheduling.vo.SessionParentChildSlotListVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.scheduling.vo.SessionParentChildSlotListVo ID_SessionParentChildSlot field is unknown
