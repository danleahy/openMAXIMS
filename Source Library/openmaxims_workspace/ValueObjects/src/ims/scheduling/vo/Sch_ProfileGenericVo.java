...
public class Sch_ProfileGenericVo extends ims.scheduling.vo.Sch_ProfileVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public Sch_ProfileGenericVo(ims.scheduling.vo.beans.Sch_ProfileGenericVoBean bean)
	{
		...
		this.isotherhospital = bean.getIsOtherHospital();
		this.otherhospital = bean.getOtherHospital() == null ? null : bean.getOtherHospital().buildVo();
	}
	public void populate(ims.vo.ValueObjectBeanMap map, ims.scheduling.vo.beans.Sch_ProfileGenericVoBean bean)
	{
		...
		this.profiletype = bean.getProfileType() == null ? null : ims.scheduling.vo.lookups.SchProfileType.buildLookup(bean.getProfileType());
		this.isotherhospital = bean.getIsOtherHospital();
		this.otherhospital = bean.getOtherHospital() == null ? null : bean.getOtherHospital().buildVo(map);
	}
	...
	public Object getFieldValueByFieldName(String fieldName)
	{
		...
		if(fieldName.equals("ISOTHERHOSPITAL"))
			return getIsOtherHospital();
	...
	public boolean getIsOtherHospitalIsNotNull()
	{
		return this.isotherhospital != null;
	}
	public Boolean getIsOtherHospital()
	{
		return this.isotherhospital;
	}
	public void setIsOtherHospital(Boolean value)
	{
		this.isValidated = false;
		this.isotherhospital = value;
	}
	public boolean getOtherHospitalIsNotNull()
	{
		return this.otherhospital != null;
	}
	public ims.core.vo.LocationLiteVo getOtherHospital()
	{
		return this.otherhospital;
	}
	public void setOtherHospital(ims.core.vo.LocationLiteVo value)
	{
		this.isValidated = false;
	...
	public Object clone()
	{
		...
		clone.isotherhospital = this.isotherhospital;
		if(this.otherhospital == null)
			clone.otherhospital = null;
		else
			clone.otherhospital = (ims.core.vo.LocationLiteVo)this.otherhospital.clone();
	...
	protected Boolean isotherhospital;
	protected ims.core.vo.LocationLiteVo otherhospital;
