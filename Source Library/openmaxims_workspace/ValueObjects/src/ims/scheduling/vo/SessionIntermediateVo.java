	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.sessioncomment != null)
			if(this.sessioncomment.length() > 500)
				listOfErrors.add("The length of the field [sessioncomment] in the value object [ims.scheduling.vo.SessionIntermediateVo] is too big. It should be less or equal to 500");
