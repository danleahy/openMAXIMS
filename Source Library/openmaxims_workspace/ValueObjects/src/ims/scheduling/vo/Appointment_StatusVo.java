...
public class Appointment_StatusVo extends ims.scheduling.vo.Appointment_StatusRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public Appointment_StatusVo(ims.scheduling.vo.beans.Appointment_StatusVoBean bean)
	{
		...
		this.wasletterprinted = bean.getWasLetterPrinted();
	...
	public Object getFieldValueByFieldName(String fieldName)
	{
		...
		if(fieldName.equals("TCIDATE"))
			return getTCIDate();
		if(fieldName.equals("WASLETTERPRINTED"))
			return getWasLetterPrinted();
		if(fieldName.equals("COULDNOTBESEEN"))
			return getCouldnotbeseen();
		if(fieldName.equals("CAREPROFESSIONALREADYTOSEE"))
			return getCareProfessionalReadyToSee();
		if(fieldName.equals("CAREPROFESSIONALNOTREADYTOSEE"))
			return getCareProfessionalNotReadyToSee();
	...
	public boolean getWasLetterPrintedIsNotNull()
	{
		return this.wasletterprinted != null;
	}
	...
	public Object clone()
	{
		...
		clone.wasletterprinted = this.wasletterprinted;
	...
	protected Boolean wasletterprinted;
