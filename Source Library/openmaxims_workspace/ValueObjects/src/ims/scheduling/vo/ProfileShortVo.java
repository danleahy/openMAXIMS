...
public class ProfileShortVo extends ims.scheduling.vo.ProfileLiteVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public Object getFieldValueByFieldName(String fieldName)
	{
		...
		if(fieldName.equals("AUTOGENERATEPERIOD"))
			return getAutoGeneratePeriod();
		if(fieldName.equals("READYTOGENERATE"))
			return getReadyToGenerate();
	...
	public boolean getAutoGeneratePeriodIsNotNull()
	{
		return this.autogenerateperiod != null;
	}
	...
	public boolean getReadyToGenerateIsNotNull()
	{
		return this.readytogenerate != null;
	}
	...
	public int countFieldsWithValue()
	{
		...
		if(this.lastgendate != null)
			count++;
		if(this.autogenerateperiod != null)
			count++;
		if(this.readytogenerate != null)
			count++;
		if(this.isfixed != null)
			count++;
		return count;
	...
	protected Integer autogenerateperiod;
	protected Boolean readytogenerate;
