...
public class SessionVo extends ims.scheduling.vo.SessionShortVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public SessionVo(ims.scheduling.vo.beans.SessionVoBean bean)
	{
		...
		this.casenotefoldernotrequired = bean.getCaseNoteFolderNotRequired();
		...
		this.letterrequired = bean.getLetterRequired();
		...
		this.locationmoveddatetime = bean.getLocationMovedDateTime() == null ? null : bean.getLocationMovedDateTime().buildDateTime();
	...
	public Object getFieldValueByFieldName(String fieldName)
	{
		...
		if(fieldName.equals("LOCATIONMOVEDDATETIME"))
			return getLocationMovedDateTime();
	...
	public boolean getLocationMovedDateTimeIsNotNull()
	{
		return this.locationmoveddatetime != null;
	}
	public ims.framework.utils.DateTime getLocationMovedDateTime()
	{
		return this.locationmoveddatetime;
	}
	public void setLocationMovedDateTime(ims.framework.utils.DateTime value)
	{
		this.isValidated = false;
	...
	*/
	...
	public boolean isValidated()
	{
		...
		{
			if(!this.sessionmove.isValidated())
			{
				this.isBusy = false;
				return false;
			}
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.sessioncomment != null)
			if(this.sessioncomment.length() > 500)
				listOfErrors.add("The length of the field [sessioncomment] in the value object [ims.scheduling.vo.SessionVo] is too big. It should be less or equal to 500");
		...
		if(this.sessionmove != null)
		{
			String[] listOfOtherErrors = this.sessionmove.validate();
			if(listOfOtherErrors != null)
			{
				for(int x = 0; x < listOfOtherErrors.length; x++)
				{
	...
	public Object clone()
	{
		...
		if(this.casenotefolderlocation == null)
			...
			clone.casenotefolderlocation = (ims.core.vo.LocShortVo)this.casenotefolderlocation.clone();
		...
		clone.casenotefoldernotrequired = this.casenotefoldernotrequired;
		if(this.sessionprofiletype == null)
		...
		clone.letterrequired = this.letterrequired;
		...
		if(this.locationmoveddatetime == null)
			clone.locationmoveddatetime = null;
		else
			clone.locationmoveddatetime = (ims.framework.utils.DateTime)this.locationmoveddatetime.clone();
		if(this.responsiblehcp == null)
	...
	protected ims.framework.utils.DateTime locationmoveddatetime;
