 ...
 */
public class Appointment_withLinkedAppointmentsSummaryVo extends ims.scheduling.vo.Booking_AppointmentRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public Appointment_withLinkedAppointmentsSummaryVo()
	{
	}
	public Appointment_withLinkedAppointmentsSummaryVo(Integer id, int version)
	{
		super(id, version);
	}
	public Appointment_withLinkedAppointmentsSummaryVo(ims.scheduling.vo.beans.Appointment_withLinkedAppointmentsSummaryVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.scheduling.vo.beans.Appointment_withLinkedAppointmentsSummaryVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.appointmentdate = bean.getAppointmentDate() == null ? null : bean.getAppointmentDate().buildDate();
	...
	{
		ims.scheduling.vo.beans.Appointment_withLinkedAppointmentsSummaryVoBean bean = null;
		if(map != null)
			bean = (ims.scheduling.vo.beans.Appointment_withLinkedAppointmentsSummaryVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.scheduling.vo.beans.Appointment_withLinkedAppointmentsSummaryVoBean();
	...
	public Object clone()
	{
		...
		Appointment_withLinkedAppointmentsSummaryVo clone = new Appointment_withLinkedAppointmentsSummaryVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(Appointment_withLinkedAppointmentsSummaryVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A Appointment_withLinkedAppointmentsSummaryVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((Appointment_withLinkedAppointmentsSummaryVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((Appointment_withLinkedAppointmentsSummaryVo)obj).getBoId());
	}
