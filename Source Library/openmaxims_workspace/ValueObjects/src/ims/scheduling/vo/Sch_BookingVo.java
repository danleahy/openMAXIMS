...
public class Sch_BookingVo extends ims.scheduling.vo.Sch_BookingRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public Sch_BookingVo(ims.scheduling.vo.beans.Sch_BookingVoBean bean)
	{
		...
		this.sessionslotdnaordisplaced = bean.getSessionSlotDNAorDisplaced() == null ? null : bean.getSessionSlotDNAorDisplaced().buildVo();
	}
	public void populate(ims.vo.ValueObjectBeanMap map, ims.scheduling.vo.beans.Sch_BookingVoBean bean)
	{
		...
		this.referrersdsorgid = bean.getReferrerSdsOrgId();
		this.appointments = ims.scheduling.vo.Booking_AppointmentVoCollection.buildFromBeanCollection(bean.getAppointments());
		this.sessionslotdnaordisplaced = bean.getSessionSlotDNAorDisplaced() == null ? null : bean.getSessionSlotDNAorDisplaced().buildVo(map);
	}
	...
	public Object getFieldValueByFieldName(String fieldName)
	{
		...
		if(fieldName.equals("SESSIONSLOTDNAORDISPLACED"))
			return getSessionSlotDNAorDisplaced();
	...
	{
		return this.sessionslotdnaordisplaced != null;
	}
	...
	*/
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.bookingcomments != null)
			if(this.bookingcomments.length() > 500)
				listOfErrors.add("The length of the field [bookingcomments] in the value object [ims.scheduling.vo.Sch_BookingVo] is too big. It should be less or equal to 500");
		if(this.ubrn != null)
	...
	public Object clone()
	{
		...
		if(this.sessionslotdnaordisplaced == null)
			clone.sessionslotdnaordisplaced = null;
		else
			clone.sessionslotdnaordisplaced = (ims.scheduling.vo.SessionSlotVo)this.sessionslotdnaordisplaced.clone();
	...
	protected ims.scheduling.vo.SessionSlotVo sessionslotdnaordisplaced;
