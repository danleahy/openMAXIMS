 ...
 */
public class BookingAppointmentForDisplacedAppointmentVo extends ims.scheduling.vo.Booking_AppointmentRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public BookingAppointmentForDisplacedAppointmentVo()
	{
	}
	public BookingAppointmentForDisplacedAppointmentVo(Integer id, int version)
	{
		super(id, version);
	}
	public BookingAppointmentForDisplacedAppointmentVo(ims.scheduling.vo.beans.BookingAppointmentForDisplacedAppointmentVoBean bean)
	{
		this.id = bean.getId();
		...
		if(bean.getLinkedAppointments() != null)
		{
			...
			{
				this.linkedappointments.add(new ims.scheduling.vo.Booking_AppointmentRefVo(new Integer(bean.getLinkedAppointments()[linkedappointments_i].getId()), bean.getLinkedAppointments()[linkedappointments_i].getVersion()));
			}
		}
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.scheduling.vo.beans.BookingAppointmentForDisplacedAppointmentVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.appointmentdate = bean.getAppointmentDate() == null ? null : bean.getAppointmentDate().buildDate();
	...
	public ims.vo.ValueObjectBean getBean(ims.vo.ValueObjectBeanMap map)
	{
		...
		if(map != null)
			bean = (ims.scheduling.vo.beans.BookingAppointmentForDisplacedAppointmentVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
	...
	public ims.scheduling.vo.Booking_AppointmentRefVoCollection getLinkedAppointments()
	{
		return this.linkedappointments;
	}
	public void setLinkedAppointments(ims.scheduling.vo.Booking_AppointmentRefVoCollection value)
	{
		this.isValidated = false;
	...
	public ims.scheduling.vo.AppointmentStatusForDisplacedApptsVo getCurrentStatusRecord()
	{
		return this.currentstatusrecord;
	}
	public void setCurrentStatusRecord(ims.scheduling.vo.AppointmentStatusForDisplacedApptsVo value)
	{
		this.isValidated = false;
	...
	public ims.scheduling.vo.SessionSlotForDisplacedAppointmentsVo getSessionSlot()
	{
		return this.sessionslot;
	}
	public void setSessionSlot(ims.scheduling.vo.SessionSlotForDisplacedAppointmentsVo value)
	{
		this.isValidated = false;
	...
	public Object clone()
	{
		...
		BookingAppointmentForDisplacedAppointmentVo clone = new BookingAppointmentForDisplacedAppointmentVo(this.id, this.version);
		...
		clone.linkedappointments = this.linkedappointments;
		...
		if(this.currentstatusrecord == null)
			...
			clone.currentstatusrecord = (ims.scheduling.vo.AppointmentStatusForDisplacedApptsVo)this.currentstatusrecord.clone();
		if(this.sessionslot == null)
			clone.sessionslot = null;
		else
			clone.sessionslot = (ims.scheduling.vo.SessionSlotForDisplacedAppointmentsVo)this.sessionslot.clone();
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(BookingAppointmentForDisplacedAppointmentVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A BookingAppointmentForDisplacedAppointmentVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((BookingAppointmentForDisplacedAppointmentVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((BookingAppointmentForDisplacedAppointmentVo)obj).getBoId());
	}
	...
	protected ims.scheduling.vo.Booking_AppointmentRefVoCollection linkedappointments;
	...
	protected ims.scheduling.vo.AppointmentStatusForDisplacedApptsVo currentstatusrecord;
	protected ims.scheduling.vo.SessionSlotForDisplacedAppointmentsVo sessionslot;
