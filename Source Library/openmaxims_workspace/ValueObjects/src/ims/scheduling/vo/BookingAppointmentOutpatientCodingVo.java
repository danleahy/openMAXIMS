 ...
 */
public class BookingAppointmentOutpatientCodingVo extends ims.scheduling.vo.Booking_AppointmentRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public BookingAppointmentOutpatientCodingVo()
	{
	}
	public BookingAppointmentOutpatientCodingVo(Integer id, int version)
	{
		super(id, version);
	}
	public BookingAppointmentOutpatientCodingVo(ims.scheduling.vo.beans.BookingAppointmentOutpatientCodingVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.scheduling.vo.beans.BookingAppointmentOutpatientCodingVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.appointmentdate = bean.getAppointmentDate() == null ? null : bean.getAppointmentDate().buildDate();
	...
	{
		ims.scheduling.vo.beans.BookingAppointmentOutpatientCodingVoBean bean = null;
		if(map != null)
			bean = (ims.scheduling.vo.beans.BookingAppointmentOutpatientCodingVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.scheduling.vo.beans.BookingAppointmentOutpatientCodingVoBean();
	...
	public Object clone()
	{
		...
		BookingAppointmentOutpatientCodingVo clone = new BookingAppointmentOutpatientCodingVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(BookingAppointmentOutpatientCodingVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A BookingAppointmentOutpatientCodingVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((BookingAppointmentOutpatientCodingVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((BookingAppointmentOutpatientCodingVo)obj).getBoId());
	}
