...
public class SessionShortVo extends ims.scheduling.vo.SessionIntermediateVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public Object getFieldValueByFieldName(String fieldName)
	{
		...
		if(fieldName.equals("CASENOTEFOLDERNOTREQUIRED"))
			return getCaseNoteFolderNotRequired();
		if(fieldName.equals("SESSIONPROFILETYPE"))
			return getSessionProfileType();
		if(fieldName.equals("LETTERREQUIRED"))
			return getLetterRequired();
	...
	public boolean getCaseNoteFolderNotRequiredIsNotNull()
	{
		return this.casenotefoldernotrequired != null;
	}
	...
	public boolean getLetterRequiredIsNotNull()
	{
		return this.letterrequired != null;
	}
	...
	*/
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.sessioncomment != null)
			if(this.sessioncomment.length() > 500)
				listOfErrors.add("The length of the field [sessioncomment] in the value object [ims.scheduling.vo.SessionShortVo] is too big. It should be less or equal to 500");
	...
	public int countFieldsWithValue()
	{
		...
		if(this.calendarslots != null)
			count++;
		if(this.casenotefoldernotrequired != null)
			count++;
		if(this.sessionprofiletype != null)
			count++;
	...
	protected Boolean casenotefoldernotrequired;
