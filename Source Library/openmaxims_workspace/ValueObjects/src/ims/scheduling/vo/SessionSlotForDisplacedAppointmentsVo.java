 ...
 */
public class SessionSlotForDisplacedAppointmentsVo extends ims.scheduling.vo.Session_SlotRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public SessionSlotForDisplacedAppointmentsVo()
	{
	}
	public SessionSlotForDisplacedAppointmentsVo(Integer id, int version)
	{
		super(id, version);
	}
	public SessionSlotForDisplacedAppointmentsVo(ims.scheduling.vo.beans.SessionSlotForDisplacedAppointmentsVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.scheduling.vo.beans.SessionSlotForDisplacedAppointmentsVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.starttm = bean.getStartTm() == null ? null : bean.getStartTm().buildTime();
	...
	{
		ims.scheduling.vo.beans.SessionSlotForDisplacedAppointmentsVoBean bean = null;
		if(map != null)
			bean = (ims.scheduling.vo.beans.SessionSlotForDisplacedAppointmentsVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.scheduling.vo.beans.SessionSlotForDisplacedAppointmentsVoBean();
	...
	public Object clone()
	{
		...
		SessionSlotForDisplacedAppointmentsVo clone = new SessionSlotForDisplacedAppointmentsVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(SessionSlotForDisplacedAppointmentsVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A SessionSlotForDisplacedAppointmentsVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((SessionSlotForDisplacedAppointmentsVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((SessionSlotForDisplacedAppointmentsVo)obj).getBoId());
	}
