 ...
 */
public class AppointmentDateTimeVo extends ims.scheduling.vo.Booking_AppointmentRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public AppointmentDateTimeVo()
	{
	}
	public AppointmentDateTimeVo(Integer id, int version)
	{
		super(id, version);
	}
	public AppointmentDateTimeVo(ims.scheduling.vo.beans.AppointmentDateTimeVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.scheduling.vo.beans.AppointmentDateTimeVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.appointmentdate = bean.getAppointmentDate() == null ? null : bean.getAppointmentDate().buildDate();
	...
	{
		ims.scheduling.vo.beans.AppointmentDateTimeVoBean bean = null;
		if(map != null)
			bean = (ims.scheduling.vo.beans.AppointmentDateTimeVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.scheduling.vo.beans.AppointmentDateTimeVoBean();
	...
	public Object clone()
	{
		...
		AppointmentDateTimeVo clone = new AppointmentDateTimeVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(AppointmentDateTimeVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A AppointmentDateTimeVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((AppointmentDateTimeVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((AppointmentDateTimeVo)obj).getBoId());
	}
