 ...
 */
public class SessionForReferralAppointmentVo extends ims.scheduling.vo.Sch_SessionRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public SessionForReferralAppointmentVo(Integer id, int version)
	{
		super(id, version);
	}
	public SessionForReferralAppointmentVo(ims.scheduling.vo.beans.SessionForReferralAppointmentVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.scheduling.vo.beans.SessionForReferralAppointmentVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.name = bean.getName();
	...
	public ims.vo.ValueObjectBean getBean(ims.vo.ValueObjectBeanMap map)
	{
		...
		if(map != null)
			bean = (ims.scheduling.vo.beans.SessionForReferralAppointmentVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
	...
	public ims.core.vo.LocationListVo getSchLocation()
	{
		return this.schlocation;
	}
	public void setSchLocation(ims.core.vo.LocationListVo value)
	{
		this.isValidated = false;
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.name != null)
			if(this.name.length() > 100)
				listOfErrors.add("The length of the field [name] in the value object [ims.scheduling.vo.SessionForReferralAppointmentVo] is too big. It should be less or equal to 100");
	...
	public Object clone()
	{
		...
		SessionForReferralAppointmentVo clone = new SessionForReferralAppointmentVo(this.id, this.version);
		...
		if(this.schlocation == null)
			...
			clone.schlocation = (ims.core.vo.LocationListVo)this.schlocation.clone();
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(SessionForReferralAppointmentVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A SessionForReferralAppointmentVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((SessionForReferralAppointmentVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((SessionForReferralAppointmentVo)obj).getBoId());
	}
	...
	protected ims.core.vo.LocationListVo schlocation;
