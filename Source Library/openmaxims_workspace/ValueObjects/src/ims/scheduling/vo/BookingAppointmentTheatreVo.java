	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.comments != null)
			if(this.comments.length() > 500)
				listOfErrors.add("The length of the field [comments] in the value object [ims.scheduling.vo.BookingAppointmentTheatreVo] is too big. It should be less or equal to 500");
		if(this.session != null)
		{
		...
		if(this.day28breachcomment != null)
			if(this.day28breachcomment.length() > 255)
				listOfErrors.add("The length of the field [day28breachcomment] in the value object [ims.scheduling.vo.BookingAppointmentTheatreVo] is too big. It should be less or equal to 255");
		if(this.proceduredetails != null)
			if(this.proceduredetails.length() > 500)
				listOfErrors.add("The length of the field [proceduredetails] in the value object [ims.scheduling.vo.BookingAppointmentTheatreVo] is too big. It should be less or equal to 500");
