 ...
 * @author Sean Nesbitt
 */
public class PrimaryTumourLiteVoAssembler
{
  	/**
	 ...
	 */
	 public static ims.eas.vo.PrimaryTumourLiteVo copy(ims.eas.vo.PrimaryTumourLiteVo valueObjectDest, ims.eas.vo.PrimaryTumourLiteVo valueObjectSrc) 
	 {
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createPrimaryTumourLiteVoCollectionFromPrimaryTumour(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.eas.configuration.domain.objects.PrimaryTumour objects.
	 */
	public static ims.eas.vo.PrimaryTumourLiteVoCollection createPrimaryTumourLiteVoCollectionFromPrimaryTumour(java.util.Set domainObjectSet)	
	{
		return createPrimaryTumourLiteVoCollectionFromPrimaryTumour(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.eas.configuration.domain.objects.PrimaryTumour objects.
	 */
	public static ims.eas.vo.PrimaryTumourLiteVoCollection createPrimaryTumourLiteVoCollectionFromPrimaryTumour(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.eas.vo.PrimaryTumourLiteVoCollection voList = new ims.eas.vo.PrimaryTumourLiteVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.eas.vo.PrimaryTumourLiteVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.eas.vo.PrimaryTumourLiteVoCollection createPrimaryTumourLiteVoCollectionFromPrimaryTumour(java.util.List domainObjectList) 
	{
		return createPrimaryTumourLiteVoCollectionFromPrimaryTumour(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.eas.configuration.domain.objects.PrimaryTumour objects.
	 */
	public static ims.eas.vo.PrimaryTumourLiteVoCollection createPrimaryTumourLiteVoCollectionFromPrimaryTumour(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.eas.vo.PrimaryTumourLiteVoCollection voList = new ims.eas.vo.PrimaryTumourLiteVoCollection();
	 ...
	 */
	 public static java.util.Set extractPrimaryTumourSet(ims.domain.ILightweightDomainFactory domainFactory, ims.eas.vo.PrimaryTumourLiteVoCollection voCollection) 
	 {
	 	return extractPrimaryTumourSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractPrimaryTumourSet(ims.domain.ILightweightDomainFactory domainFactory, ims.eas.vo.PrimaryTumourLiteVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.eas.vo.PrimaryTumourLiteVo vo = voCollection.get(i);
			ims.eas.configuration.domain.objects.PrimaryTumour domainObject = PrimaryTumourLiteVoAssembler.extractPrimaryTumour(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractPrimaryTumourList(ims.domain.ILightweightDomainFactory domainFactory, ims.eas.vo.PrimaryTumourLiteVoCollection voCollection) 
	 {
	 	return extractPrimaryTumourList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractPrimaryTumourList(ims.domain.ILightweightDomainFactory domainFactory, ims.eas.vo.PrimaryTumourLiteVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.eas.vo.PrimaryTumourLiteVo create(ims.eas.configuration.domain.objects.PrimaryTumour domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.eas.vo.PrimaryTumourLiteVo create(DomainObjectMap map, ims.eas.configuration.domain.objects.PrimaryTumour domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.eas.vo.PrimaryTumourLiteVo valueObject = (ims.eas.vo.PrimaryTumourLiteVo) map.getValueObject(domainObject, ims.eas.vo.PrimaryTumourLiteVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.eas.vo.PrimaryTumourLiteVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.eas.configuration.domain.objects.PrimaryTumour
	 */
	 public static ims.eas.vo.PrimaryTumourLiteVo insert(ims.eas.vo.PrimaryTumourLiteVo valueObject, ims.eas.configuration.domain.objects.PrimaryTumour domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.eas.configuration.domain.objects.PrimaryTumour
	 */
	 public static ims.eas.vo.PrimaryTumourLiteVo insert(DomainObjectMap map, ims.eas.vo.PrimaryTumourLiteVo valueObject, ims.eas.configuration.domain.objects.PrimaryTumour domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 */
	public static ims.eas.configuration.domain.objects.PrimaryTumour extractPrimaryTumour(ims.domain.ILightweightDomainFactory domainFactory, ims.eas.vo.PrimaryTumourLiteVo valueObject) 
	{
		return 	extractPrimaryTumour(domainFactory, valueObject, new HashMap());
	}

	public static ims.eas.configuration.domain.objects.PrimaryTumour extractPrimaryTumour(ims.domain.ILightweightDomainFactory domainFactory, ims.eas.vo.PrimaryTumourLiteVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.eas.vo.PrimaryTumourLiteVo ID_PrimaryTumour field is unknown
