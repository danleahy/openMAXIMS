 ...
 */
public class PrimaryTumourLiteVo extends ims.eas.vo.PrimaryTumourNameVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public PrimaryTumourLiteVo()
	{
	}
	public PrimaryTumourLiteVo(Integer id, int version)
	{
		super(id, version);
	}
	public PrimaryTumourLiteVo(ims.eas.vo.beans.PrimaryTumourLiteVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.eas.vo.beans.PrimaryTumourLiteVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.primarytumour = bean.getPrimaryTumour() == null ? null : ims.eas.vo.lookups.PrimaryTumour.buildLookup(bean.getPrimaryTumour());
	...
	{
		ims.eas.vo.beans.PrimaryTumourLiteVoBean bean = null;
		if(map != null)
			bean = (ims.eas.vo.beans.PrimaryTumourLiteVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.eas.vo.beans.PrimaryTumourLiteVoBean();
	...
	public ims.eas.vo.TreatmentSiteNameVoCollection getTreatmentSites()
	{
		return this.treatmentsites;
	}
	public void setTreatmentSites(ims.eas.vo.TreatmentSiteNameVoCollection value)
	{
		this.isValidated = false;
	...
	public Object clone()
	{
		...
		PrimaryTumourLiteVo clone = new PrimaryTumourLiteVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(PrimaryTumourLiteVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A PrimaryTumourLiteVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((PrimaryTumourLiteVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((PrimaryTumourLiteVo)obj).getBoId());
	}
	...
	protected ims.eas.vo.TreatmentSiteNameVoCollection treatmentsites;
