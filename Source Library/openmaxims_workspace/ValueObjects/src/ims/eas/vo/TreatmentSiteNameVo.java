 ...
 */
public class TreatmentSiteNameVo extends ims.eas.configuration.vo.TreatmentSitesRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public TreatmentSiteNameVo()
	{
	}
	public TreatmentSiteNameVo(Integer id, int version)
	{
		super(id, version);
	}
	public TreatmentSiteNameVo(ims.eas.vo.beans.TreatmentSiteNameVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.eas.vo.beans.TreatmentSiteNameVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.treatmentsite = bean.getTreatmentSite() == null ? null : ims.eas.vo.lookups.TreatmentSites.buildLookup(bean.getTreatmentSite());
	...
	{
		ims.eas.vo.beans.TreatmentSiteNameVoBean bean = null;
		if(map != null)
			bean = (ims.eas.vo.beans.TreatmentSiteNameVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.eas.vo.beans.TreatmentSiteNameVoBean();
	...
	public Object clone()
	{
		...
		TreatmentSiteNameVo clone = new TreatmentSiteNameVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(TreatmentSiteNameVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A TreatmentSiteNameVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((TreatmentSiteNameVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((TreatmentSiteNameVo)obj).getBoId());
	}
