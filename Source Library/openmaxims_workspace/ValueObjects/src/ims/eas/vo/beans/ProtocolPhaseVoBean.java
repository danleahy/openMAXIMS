...
public class ProtocolPhaseVoBean extends ims.vo.ValueObjectBean
{
	public ProtocolPhaseVoBean()
	{
	}
	public ProtocolPhaseVoBean(ims.eas.vo.ProtocolPhaseVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.eas.vo.ProtocolPhaseVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.phasename = vo.getPhaseName() == null ? null : (ims.vo.LookupInstanceBean)vo.getPhaseName().getBean();
	...
	public ims.eas.vo.ProtocolPhaseVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.eas.vo.ProtocolPhaseVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.eas.vo.ProtocolPhaseVo vo = null;
		if(map != null)
			vo = (ims.eas.vo.ProtocolPhaseVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.eas.vo.ProtocolPhaseVo();
