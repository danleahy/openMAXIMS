...
public class ClinicalTrialLinkVoBean extends ims.vo.ValueObjectBean
{
	public ClinicalTrialLinkVoBean()
	{
	}
	public ClinicalTrialLinkVoBean(ims.eas.vo.ClinicalTrialLinkVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.eas.vo.ClinicalTrialLinkVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.treatmentsite = vo.getTreatmentSite() == null ? null : (ims.vo.LookupInstanceBean)vo.getTreatmentSite().getBean();
	...
	public ims.eas.vo.ClinicalTrialLinkVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.eas.vo.ClinicalTrialLinkVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.eas.vo.ClinicalTrialLinkVo vo = null;
		if(map != null)
			vo = (ims.eas.vo.ClinicalTrialLinkVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.eas.vo.ClinicalTrialLinkVo();
