...
public class PrimaryTumourInsVoBean extends ims.vo.ValueObjectBean
{
	public PrimaryTumourInsVoBean()
	{
	}
	public PrimaryTumourInsVoBean(ims.eas.vo.PrimaryTumourInsVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.eas.vo.PrimaryTumourInsVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.primarytumour = vo.getPrimaryTumour() == null ? null : (ims.vo.LookupInstanceBean)vo.getPrimaryTumour().getBean();
	...
	public ims.eas.vo.PrimaryTumourInsVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.eas.vo.PrimaryTumourInsVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.eas.vo.PrimaryTumourInsVo vo = null;
		if(map != null)
			vo = (ims.eas.vo.PrimaryTumourInsVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.eas.vo.PrimaryTumourInsVo();
	...
	public ims.eas.vo.beans.TreatmentSiteInsVoBean[] getTreatmentSites()
	{
		return this.treatmentsites;
	}
	public void setTreatmentSites(ims.eas.vo.beans.TreatmentSiteInsVoBean[] value)
	{
	...
	private ims.eas.vo.beans.TreatmentSiteInsVoBean[] treatmentsites;
