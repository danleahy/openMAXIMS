...
public class EASAnnotationVoBean extends ims.vo.ValueObjectBean
{
	public EASAnnotationVoBean()
	{
	}
	public EASAnnotationVoBean(ims.eas.vo.EASAnnotationVo vo)
	{
		this.id = vo.getBoId();
		...
		this.annotation = vo.getAnnotation();
	}

	public void populate(ims.vo.ValueObjectBeanMap map, ims.eas.vo.EASAnnotationVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
	...
	public ims.eas.vo.EASAnnotationVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.eas.vo.EASAnnotationVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.eas.vo.EASAnnotationVo vo = null;
		if(map != null)
			vo = (ims.eas.vo.EASAnnotationVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.eas.vo.EASAnnotationVo();
