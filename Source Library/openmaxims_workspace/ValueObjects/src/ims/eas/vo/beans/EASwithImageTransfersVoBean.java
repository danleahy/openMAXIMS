...
public class EASwithImageTransfersVoBean extends ims.vo.ValueObjectBean
{
	public EASwithImageTransfersVoBean()
	{
	}
	public EASwithImageTransfersVoBean(ims.eas.vo.EASwithImageTransfersVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.eas.vo.EASwithImageTransfersVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.imagetransfers = vo.getImageTransfers() == null ? null : vo.getImageTransfers().getBeanCollection();
	...
	public ims.eas.vo.EASwithImageTransfersVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.eas.vo.EASwithImageTransfersVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.eas.vo.EASwithImageTransfersVo vo = null;
		if(map != null)
			vo = (ims.eas.vo.EASwithImageTransfersVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.eas.vo.EASwithImageTransfersVo();
