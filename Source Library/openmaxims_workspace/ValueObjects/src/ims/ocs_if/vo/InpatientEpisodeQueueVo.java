 ...
 */
public class InpatientEpisodeQueueVo extends ims.hl7adtout.vo.InpatientEpisodeQueueRefVo implements ims.vo.ImsCloneable, Comparable, ims.vo.interfaces.IHL7OutboundMessageHandler
{
	private static final long serialVersionUID = 1L;

	public InpatientEpisodeQueueVo()
	{
	}
	public InpatientEpisodeQueueVo(Integer id, int version)
	{
		super(id, version);
	}
	public InpatientEpisodeQueueVo(ims.ocs_if.vo.beans.InpatientEpisodeQueueVoBean bean)
	{
		this.id = bean.getId();
		...
		this.updatetype = bean.getUpdateType() == null ? null : ims.core.vo.lookups.MsgUpdateType.buildLookup(bean.getUpdateType());
		this.sysinfo = bean.getSysInfo() == null ? null : bean.getSysInfo().buildSystemInformation();
	}
	public void populate(ims.vo.ValueObjectBeanMap map, ims.ocs_if.vo.beans.InpatientEpisodeQueueVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.wasprocessed = bean.getWasProcessed();
	...
	{
		ims.ocs_if.vo.beans.InpatientEpisodeQueueVoBean bean = null;
		if(map != null)
			bean = (ims.ocs_if.vo.beans.InpatientEpisodeQueueVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.ocs_if.vo.beans.InpatientEpisodeQueueVoBean();
	...
	public ims.core.vo.lookups.MsgUpdateType getUpdateType()
	{
		return this.updatetype;
	}
	public void setUpdateType(ims.core.vo.lookups.MsgUpdateType value)
	{
		this.isValidated = false;
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.acktext != null)
			if(this.acktext.length() > 1000)
				listOfErrors.add("The length of the field [acktext] in the value object [ims.ocs_if.vo.InpatientEpisodeQueueVo] is too big. It should be less or equal to 1000");
		if(this.failuremsg != null)
			if(this.failuremsg.length() > 1000)
				listOfErrors.add("The length of the field [failuremsg] in the value object [ims.ocs_if.vo.InpatientEpisodeQueueVo] is too big. It should be less or equal to 1000");
	...
	public Object clone()
	{
		...
		InpatientEpisodeQueueVo clone = new InpatientEpisodeQueueVo(this.id, this.version);
		...
		if(this.updatetype == null)
			...
			clone.updatetype = (ims.core.vo.lookups.MsgUpdateType)this.updatetype.clone();
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(InpatientEpisodeQueueVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A InpatientEpisodeQueueVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((InpatientEpisodeQueueVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((InpatientEpisodeQueueVo)obj).getBoId());
	}
	...
	protected ims.core.vo.lookups.MsgUpdateType updatetype;
