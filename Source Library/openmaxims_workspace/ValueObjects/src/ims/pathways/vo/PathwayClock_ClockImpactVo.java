 ...
 */
public class PathwayClock_ClockImpactVo extends ims.pathways.vo.PathwayClockRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public PathwayClock_ClockImpactVo()
	{
	}
	public PathwayClock_ClockImpactVo(Integer id, int version)
	{
		super(id, version);
	}
	public PathwayClock_ClockImpactVo(ims.pathways.vo.beans.PathwayClock_ClockImpactVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.pathways.vo.beans.PathwayClock_ClockImpactVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.extclockid = bean.getExtClockId();
	...
	{
		ims.pathways.vo.beans.PathwayClock_ClockImpactVoBean bean = null;
		if(map != null)
			bean = (ims.pathways.vo.beans.PathwayClock_ClockImpactVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.pathways.vo.beans.PathwayClock_ClockImpactVoBean();
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.extclockid != null)
			if(this.extclockid.length() > 20)
				listOfErrors.add("The length of the field [extclockid] in the value object [ims.pathways.vo.PathwayClock_ClockImpactVo] is too big. It should be less or equal to 20");
		if(this.extclockname != null)
			if(this.extclockname.length() > 20)
				listOfErrors.add("The length of the field [extclockname] in the value object [ims.pathways.vo.PathwayClock_ClockImpactVo] is too big. It should be less or equal to 20");
		if(this.currentrttstatus != null)
		{
	...
	public Object clone()
	{
		...
		PathwayClock_ClockImpactVo clone = new PathwayClock_ClockImpactVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(PathwayClock_ClockImpactVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A PathwayClock_ClockImpactVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((PathwayClock_ClockImpactVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((PathwayClock_ClockImpactVo)obj).getBoId());
	}
