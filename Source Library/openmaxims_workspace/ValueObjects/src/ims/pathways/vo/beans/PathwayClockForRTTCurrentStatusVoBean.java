...
public class PathwayClockForRTTCurrentStatusVoBean extends ims.vo.ValueObjectBean
{
	public PathwayClockForRTTCurrentStatusVoBean()
	{
	}
	public PathwayClockForRTTCurrentStatusVoBean(ims.pathways.vo.PathwayClockForRTTCurrentStatusVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.pathways.vo.PathwayClockForRTTCurrentStatusVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
	...
	public ims.pathways.vo.PathwayClockForRTTCurrentStatusVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.pathways.vo.PathwayClockForRTTCurrentStatusVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.pathways.vo.PathwayClockForRTTCurrentStatusVo vo = null;
		if(map != null)
			vo = (ims.pathways.vo.PathwayClockForRTTCurrentStatusVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.pathways.vo.PathwayClockForRTTCurrentStatusVo();
