...
public class PatientJourneyBreachReasonVoBean extends ims.vo.ValueObjectBean
{
	public PatientJourneyBreachReasonVoBean()
	{
	}
	public PatientJourneyBreachReasonVoBean(ims.pathways.vo.PatientJourneyBreachReasonVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.pathways.vo.PatientJourneyBreachReasonVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.breachreason = vo.getBreachReason() == null ? null : (ims.vo.LookupInstanceBean)vo.getBreachReason().getBean();
	...
	public ims.pathways.vo.PatientJourneyBreachReasonVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.pathways.vo.PatientJourneyBreachReasonVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.pathways.vo.PatientJourneyBreachReasonVo vo = null;
		if(map != null)
			vo = (ims.pathways.vo.PatientJourneyBreachReasonVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.pathways.vo.PatientJourneyBreachReasonVo();
