...
public class AdminEventOutcome extends ims.vo.LookupInstVo implements TreeNode
{
	...
	public static ims.framework.IItemCollection getNegativeInstancesAsIItemCollection()
	{
		...
		result.add(DECISION_TO_TREAT_ACTIVE_MONITORING);
		return result;
	}
	public static AdminEventOutcome[] getNegativeInstances()
	{
		AdminEventOutcome[] instances = new AdminEventOutcome[7];
		...
		instances[5] = DECISION_TO_TREAT;
		instances[6] = DECISION_TO_TREAT_ACTIVE_MONITORING;
		return instances;
	}
	public static String[] getNegativeInstanceNames()
	{
		...
		negativeInstances[5] = "DECISION_TO_TREAT";
		negativeInstances[6] = "DECISION_TO_TREAT_ACTIVE_MONITORING";
	...
	public static final AdminEventOutcome DECISION_TO_TREAT = new AdminEventOutcome(-3332, "Decision to Treat", true, null, null, Color.Default);
	public static final AdminEventOutcome DECISION_TO_TREAT_ACTIVE_MONITORING = new AdminEventOutcome(-3333, "Decision to Treat following Active Monitoring", true, null, null, Color.Default);
}
