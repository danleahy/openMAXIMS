...
public class EventVoAssembler
{
	 ...
	 */
	 public static ims.pathways.vo.EventVo insert(DomainObjectMap map, ims.pathways.vo.EventVo valueObject, ims.pathways.configuration.domain.objects.Event domainObject) 
	 {
		...
		// CancellationType
		ims.domain.lookups.LookupInstance instance13 = domainObject.getCancellationType();
		if ( null != instance13 ) {
			ims.framework.utils.ImagePath img = null;
			ims.framework.utils.Color color = null;		
			img = null;
			...
			ims.scheduling.vo.lookups.Status_Reason voLookup13 = new ims.scheduling.vo.lookups.Status_Reason(instance13.getId(),instance13.getText(), instance13.isActive(), null, img, color);
			ims.scheduling.vo.lookups.Status_Reason parentVoLookup13 = voLookup13;
			...
			while (parent13 != null)
			{
    			...
    			if (color != null) 
    				color.getValue();
								parentVoLookup13.setParent(new ims.scheduling.vo.lookups.Status_Reason(parent13.getId(),parent13.getText(), parent13.isActive(), null, img, color));
				parentVoLookup13 = parentVoLookup13.getParent();
								parent13 = parent13.getParent();
			}			
			valueObject.setCancellationType(voLookup13);
		}
				// CancellationReason
		ims.domain.lookups.LookupInstance instance14 = domainObject.getCancellationReason();
		if ( null != instance14 ) {
			ims.framework.utils.ImagePath img = null;
			ims.framework.utils.Color color = null;		
			img = null;
			...
			ims.scheduling.vo.lookups.CancelAppointmentReason voLookup14 = new ims.scheduling.vo.lookups.CancelAppointmentReason(instance14.getId(),instance14.getText(), instance14.isActive(), null, img, color);
			ims.scheduling.vo.lookups.CancelAppointmentReason parentVoLookup14 = voLookup14;
			...
			while (parent14 != null)
			{
    			...
    			if (color != null) 
    				color.getValue();
								parentVoLookup14.setParent(new ims.scheduling.vo.lookups.CancelAppointmentReason(parent14.getId(),parent14.getText(), parent14.isActive(), null, img, color));
				parentVoLookup14 = parentVoLookup14.getParent();
								parent14 = parent14.getParent();
			}			
			valueObject.setCancellationReason(voLookup14);
		}
		 		return valueObject;
	 }
	...
	public static ims.pathways.configuration.domain.objects.Event extractEvent(ims.domain.ILightweightDomainFactory domainFactory, ims.pathways.vo.EventVo valueObject, HashMap domMap) 
	{
		...
		domainObject.setCancellationType(value13);
		// create LookupInstance from vo LookupType
		...
		domainObject.setCancellationReason(value14);
