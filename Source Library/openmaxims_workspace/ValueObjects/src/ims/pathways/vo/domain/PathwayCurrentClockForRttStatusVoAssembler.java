 ...
 * @author Mara Iroaie
 */
public class PathwayCurrentClockForRttStatusVoAssembler
{
  	/**
	 ...
	 */
	 public static ims.pathways.vo.PathwayCurrentClockForRttStatusVo copy(ims.pathways.vo.PathwayCurrentClockForRttStatusVo valueObjectDest, ims.pathways.vo.PathwayCurrentClockForRttStatusVo valueObjectSrc) 
	 {
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createPathwayCurrentClockForRttStatusVoCollectionFromPathwayClock(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.pathways.domain.objects.PathwayClock objects.
	 */
	public static ims.pathways.vo.PathwayCurrentClockForRttStatusVoCollection createPathwayCurrentClockForRttStatusVoCollectionFromPathwayClock(java.util.Set domainObjectSet)	
	{
		return createPathwayCurrentClockForRttStatusVoCollectionFromPathwayClock(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.pathways.domain.objects.PathwayClock objects.
	 */
	public static ims.pathways.vo.PathwayCurrentClockForRttStatusVoCollection createPathwayCurrentClockForRttStatusVoCollectionFromPathwayClock(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.pathways.vo.PathwayCurrentClockForRttStatusVoCollection voList = new ims.pathways.vo.PathwayCurrentClockForRttStatusVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.pathways.vo.PathwayCurrentClockForRttStatusVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.pathways.vo.PathwayCurrentClockForRttStatusVoCollection createPathwayCurrentClockForRttStatusVoCollectionFromPathwayClock(java.util.List domainObjectList) 
	{
		return createPathwayCurrentClockForRttStatusVoCollectionFromPathwayClock(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.pathways.domain.objects.PathwayClock objects.
	 */
	public static ims.pathways.vo.PathwayCurrentClockForRttStatusVoCollection createPathwayCurrentClockForRttStatusVoCollectionFromPathwayClock(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.pathways.vo.PathwayCurrentClockForRttStatusVoCollection voList = new ims.pathways.vo.PathwayCurrentClockForRttStatusVoCollection();
	 ...
	 */
	 public static java.util.Set extractPathwayClockSet(ims.domain.ILightweightDomainFactory domainFactory, ims.pathways.vo.PathwayCurrentClockForRttStatusVoCollection voCollection) 
	 {
	 	return extractPathwayClockSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractPathwayClockSet(ims.domain.ILightweightDomainFactory domainFactory, ims.pathways.vo.PathwayCurrentClockForRttStatusVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.pathways.vo.PathwayCurrentClockForRttStatusVo vo = voCollection.get(i);
			ims.pathways.domain.objects.PathwayClock domainObject = PathwayCurrentClockForRttStatusVoAssembler.extractPathwayClock(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractPathwayClockList(ims.domain.ILightweightDomainFactory domainFactory, ims.pathways.vo.PathwayCurrentClockForRttStatusVoCollection voCollection) 
	 {
	 	return extractPathwayClockList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractPathwayClockList(ims.domain.ILightweightDomainFactory domainFactory, ims.pathways.vo.PathwayCurrentClockForRttStatusVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.pathways.vo.PathwayCurrentClockForRttStatusVo create(ims.pathways.domain.objects.PathwayClock domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.pathways.vo.PathwayCurrentClockForRttStatusVo create(DomainObjectMap map, ims.pathways.domain.objects.PathwayClock domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.pathways.vo.PathwayCurrentClockForRttStatusVo valueObject = (ims.pathways.vo.PathwayCurrentClockForRttStatusVo) map.getValueObject(domainObject, ims.pathways.vo.PathwayCurrentClockForRttStatusVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.pathways.vo.PathwayCurrentClockForRttStatusVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.pathways.domain.objects.PathwayClock
	 */
	 public static ims.pathways.vo.PathwayCurrentClockForRttStatusVo insert(ims.pathways.vo.PathwayCurrentClockForRttStatusVo valueObject, ims.pathways.domain.objects.PathwayClock domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.pathways.domain.objects.PathwayClock
	 */
	 public static ims.pathways.vo.PathwayCurrentClockForRttStatusVo insert(DomainObjectMap map, ims.pathways.vo.PathwayCurrentClockForRttStatusVo valueObject, ims.pathways.domain.objects.PathwayClock domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
		...
		// RTTStatusHistory
		valueObject.setRTTStatusHistory(ims.pathways.vo.domain.PathwayRTTCurrentStatusVoAssembler.createPathwayRTTCurrentStatusVoCollectionFromPathwayRTTStatus(map, domainObject.getRTTStatusHistory()) );
		// PauseDetails
	 ...
	 */
	public static ims.pathways.domain.objects.PathwayClock extractPathwayClock(ims.domain.ILightweightDomainFactory domainFactory, ims.pathways.vo.PathwayCurrentClockForRttStatusVo valueObject) 
	{
		return 	extractPathwayClock(domainFactory, valueObject, new HashMap());
	}

	public static ims.pathways.domain.objects.PathwayClock extractPathwayClock(ims.domain.ILightweightDomainFactory domainFactory, ims.pathways.vo.PathwayCurrentClockForRttStatusVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.pathways.vo.PathwayCurrentClockForRttStatusVo ID_PathwayClock field is unknown
