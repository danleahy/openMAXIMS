...
public class GenForm extends FormBridge
{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1012), new Integer(anchoringHelper13.getX()), new Integer(anchoringHelper13.getY()), new Integer(anchoringHelper13.getWidth()), new Integer(anchoringHelper13.getHeight()), new Integer(startTabIndex.intValue() + 13), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Edit", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1013), new Integer(anchoringHelper14.getX()), new Integer(anchoringHelper14.getY()), new Integer(anchoringHelper14.getWidth()), new Integer(anchoringHelper14.getHeight()), new Integer(startTabIndex.intValue() + 12), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "New", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.RespiratoryTreatment.__internal_x_context__RespiratoryTreatment_" + componentIdentifier, "BO-1019100101-ID", "ID_RespiratoryTreatment");
			fields[145] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.RespiratoryTreatment.__internal_x_context__RespiratoryTreatment_" + componentIdentifier, "BO-1019100101-AUTHORINGDATETIME", "AuthoringDateTime");
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.RespiratoryTreatment.__internal_x_context__RespiratoryTreatment_" + componentIdentifier, "BO-1019100101-POSTURALDRAINAGE", "PosturalDrainage");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.RespiratoryTreatment.__internal_x_context__RespiratoryTreatment_" + componentIdentifier, "BO-1019100101-ASSISTEDCOUGH", "AssistedCough");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.RespiratoryTreatment.__internal_x_context__RespiratoryTreatment_" + componentIdentifier, "BO-1019100101-IPPB", "IPPB");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.RespiratoryTreatment.__internal_x_context__RespiratoryTreatment_" + componentIdentifier, "BO-1019100101-CONTRAINDICATIONCHECKED", "ContraindicationChecked");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.RespiratoryTreatment.__internal_x_context__RespiratoryTreatment_" + componentIdentifier, "BO-1019100101-COUGHASSIST", "CoughAssist");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.RespiratoryTreatment.__internal_x_context__RespiratoryTreatment_" + componentIdentifier, "BO-1019100101-TREATMENTANALYSIS", "TreatmentAnalysis");
			fields[152] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.RespiratoryTreatment.__internal_x_context__RespiratoryTreatment_" + componentIdentifier, "BO-1019100101-REFERONCALLPHYSIO", "ReferOnCallPhysio");
			return fields;
		}
