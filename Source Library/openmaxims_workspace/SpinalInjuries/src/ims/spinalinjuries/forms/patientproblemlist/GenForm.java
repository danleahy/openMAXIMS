...
public class GenForm extends FormBridge
{
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.PatientProblemList.__internal_x_context__SelectedMedicalProbOnAdmisVo_" + componentIdentifier, "BO-1023100001-ID", "ID_PatientProblem");
			fields[145] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.PatientProblemList.__internal_x_context__SelectedMedicalProbOnAdmisVo_" + componentIdentifier, "BO-1023100001-PROBLEMCONTEXT", "ProblemContext");
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.PatientProblemList.__internal_x_context__SelectedMedicalProbOnAdmisVo_" + componentIdentifier, "BO-1023100001-PATIENTPROBLEM", "PatientProblem");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.PatientProblemList.__internal_x_context__SelectedMedicalProbOnAdmisVo_" + componentIdentifier, "BO-1023100001-ISACTIVE", "IsActive");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.PatientProblemList.__internal_x_context__SelectedMedicalProbOnAdmisVo_" + componentIdentifier, "BO-1023100001-CARECONTEXT", "CareContext");
			return fields;
		}
