...
public class GenForm extends FormBridge
{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1017), new Integer(anchoringHelper18.getX()), new Integer(anchoringHelper18.getY()), new Integer(anchoringHelper18.getWidth()), new Integer(anchoringHelper18.getHeight()), new Integer(startTabIndex.intValue() + 18), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Edit", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(DateControl.class, new Object[] { control, new Integer(startControlID.intValue() + 1027), new Integer(anchoringHelper28.getX()), new Integer(anchoringHelper28.getY()), new Integer(anchoringHelper28.getWidth()), new Integer(anchoringHelper28.getHeight()), new Integer(startTabIndex.intValue() + 6), ControlState.DISABLED, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.TRUE, null, Boolean.FALSE, null, Boolean.FALSE, null}));
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, "_cv_SpinalInjuries.NeedsAssessment.SelectedAssessment", "BO-1072100026-ID", "ID_NeedsAssessment");
			fields[145] = new ims.framework.ReportField(this.context, "_cv_SpinalInjuries.NeedsAssessment.SelectedAssessment", "BO-1072100026-GOALPLANMEETINGDATE", "GoalPlanMeetingDate");
			fields[146] = new ims.framework.ReportField(this.context, "_cv_SpinalInjuries.NeedsAssessment.SelectedAssessment", "BO-1072100026-NEEDASSESSMENTNUMBER", "NeedAssessmentNumber");
			fields[147] = new ims.framework.ReportField(this.context, "_cv_SpinalInjuries.NeedsAssessment.SelectedAssessment", "BO-1072100026-HADBOOKLET", "HadBooklet");
			fields[148] = new ims.framework.ReportField(this.context, "_cv_SpinalInjuries.NeedsAssessment.SelectedAssessment", "BO-1072100026-ATTACHBOOKLETTOSUMMARYSHEET", "AttachBookletToSummarySheet");
			fields[149] = new ims.framework.ReportField(this.context, "_cv_SpinalInjuries.NeedsAssessment.SelectedAssessment", "BO-1072100026-DATESTARTED", "DateStarted");
			fields[150] = new ims.framework.ReportField(this.context, "_cv_SpinalInjuries.NeedsAssessment.EditedAssessment", "BO-1003100048-ID", "ID_PatientAssessment");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.NeedsAssessment.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1072100026-ID", "ID_NeedsAssessment");
			fields[152] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.NeedsAssessment.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1072100026-GOALPLANMEETINGDATE", "GoalPlanMeetingDate");
			fields[153] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.NeedsAssessment.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1072100026-NEEDASSESSMENTNUMBER", "NeedAssessmentNumber");
			fields[154] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.NeedsAssessment.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1072100026-HADBOOKLET", "HadBooklet");
			fields[155] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.NeedsAssessment.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1072100026-ATTACHBOOKLETTOSUMMARYSHEET", "AttachBookletToSummarySheet");
			fields[156] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.NeedsAssessment.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1072100026-DATESTARTED", "DateStarted");
			fields[157] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.NeedsAssessment.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1072100026-MOBILISATIONDATE", "MobilisationDate");
			fields[158] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.NeedsAssessment.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1072100026-CARECONTEXT", "CareContext");
			fields[159] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.NeedsAssessment.__internal_x_context__CurrentUserDefinedObject_" + componentIdentifier, "BO-1028100004-ID", "ID_UserDefinedObject");
			fields[160] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.NeedsAssessment.__internal_x_context__CurrentUserDefinedObject_" + componentIdentifier, "BO-1028100004-NAME", "Name");
			fields[161] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.NeedsAssessment.__internal_x_context__CurrentUserDefinedObject_" + componentIdentifier, "BO-1028100004-OBJECTTYPE", "ObjectType");
			fields[162] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.NeedsAssessment.__internal_x_context__CurrentUserDefinedObject_" + componentIdentifier, "BO-1028100004-ACTIVESTATUS", "ActiveStatus");
			return fields;
		}
