...
public class GenForm extends FormBridge
{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		RuntimeAnchoring anchoringHelper2 = new RuntimeAnchoring(designSize, runtimeSize, 6, 37, 428, 54, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		// Label Controls
		RuntimeAnchoring anchoringHelper3 = new RuntimeAnchoring(designSize, runtimeSize, 12, 496, 74, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1003), new Integer(anchoringHelper3.getX()), new Integer(anchoringHelper3.getY()), new Integer(anchoringHelper3.getWidth()), new Integer(anchoringHelper3.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Movements:", new Integer(1), null, new Integer(0)}));
		RuntimeAnchoring anchoringHelper4 = new RuntimeAnchoring(designSize, runtimeSize, 736, 45, 105, 17, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
		...
		// Button Controls
		RuntimeAnchoring anchoringHelper5 = new RuntimeAnchoring(designSize, runtimeSize, 12, 600, 80, 24, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT);
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1005), new Integer(anchoringHelper5.getX()), new Integer(anchoringHelper5.getY()), new Integer(anchoringHelper5.getWidth()), new Integer(anchoringHelper5.getHeight()), new Integer(startTabIndex.intValue() + 8), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "New", Boolean.TRUE, null, Boolean.TRUE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		RuntimeAnchoring anchoringHelper6 = new RuntimeAnchoring(designSize, runtimeSize, 100, 600, 80, 24, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT);
		...
		RuntimeAnchoring anchoringHelper7 = new RuntimeAnchoring(designSize, runtimeSize, 670, 600, 80, 24, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT);
		...
		RuntimeAnchoring anchoringHelper8 = new RuntimeAnchoring(designSize, runtimeSize, 756, 600, 80, 24, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT);
		...
		// TextBox Controls
		RuntimeAnchoring anchoringHelper9 = new RuntimeAnchoring(designSize, runtimeSize, 12, 512, 824, 80, ims.framework.enumerations.ControlAnchoring.ALL);
		...
		// Grid Controls
		RuntimeAnchoring anchoringHelper11 = new RuntimeAnchoring(designSize, runtimeSize, 12, 96, 408, 392, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT);
		...
		grdSiteFinding.addIntColumn("DrawingIndex", 0, 0, 0, true, true, null, false, 0, true, 0);
		...
		// Drawing Controls
		RuntimeAnchoring anchoringHelper12 = new RuntimeAnchoring(designSize, runtimeSize, 428, 96, 408, 392, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, "_cv_SpinalInjuries.Back.MskSpineExamFindingVo", "BO-1023100023-ID", "ID_MskSpineExamFinding");
			fields[145] = new ims.framework.ReportField(this.context, "_cv_SpinalInjuries.Back.MskSpineExamFindingVo", "BO-1023100023-SPINESITENAME", "SpineSiteName");
			fields[146] = new ims.framework.ReportField(this.context, "_cv_SpinalInjuries.Back.MskSpineExamFindingVo", "BO-1023100023-SPINESITEDETAILS", "SpineSiteDetails");
			fields[147] = new ims.framework.ReportField(this.context, "_cv_SpinalInjuries.Back.MskSpineExamFindingVo", "BO-1023100023-SPINEFINDINTERPRETATION", "SpineFindInterpretation");
			fields[148] = new ims.framework.ReportField(this.context, "_cv_SpinalInjuries.Back.MskSpineExamFindingVo", "BO-1023100023-ISPROBLEM", "IsProblem");
			fields[149] = new ims.framework.ReportField(this.context, "_cv_SpinalInjuries.Back.MskSpineExamFindingVo", "BO-1023100023-FINDINGTYPE", "FindingType");
			fields[150] = new ims.framework.ReportField(this.context, "_cv_SpinalInjuries.MedicalProbToSave", "BO-1023100001-ID", "ID_PatientProblem");
			fields[151] = new ims.framework.ReportField(this.context, "_cv_SpinalInjuries.MedicalProbToSave", "BO-1023100001-PROBLEMCONTEXT", "ProblemContext");
			fields[152] = new ims.framework.ReportField(this.context, "_cv_SpinalInjuries.MedicalProbToSave", "BO-1023100001-PATIENTPROBLEM", "PatientProblem");
			fields[153] = new ims.framework.ReportField(this.context, "_cv_SpinalInjuries.MedicalProbToSave", "BO-1023100001-ISACTIVE", "IsActive");
			fields[154] = new ims.framework.ReportField(this.context, "_cv_SpinalInjuries.MedicalProbToSave", "BO-1023100001-CARECONTEXT", "CareContext");
			fields[155] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.MedMskSpineExam.__internal_x_context__SelectedMskSpineExaminationVo_" + componentIdentifier, "BO-1023100010-ID", "ID_MskSpineExam");
			fields[156] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.MedMskSpineExam.__internal_x_context__SelectedMskSpineExaminationVo_" + componentIdentifier, "BO-1023100010-SPINEMOVEMENTS", "SpineMovements");
			fields[157] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.MedMskSpineExam.__internal_x_context__SelectedMskSpineExaminationVo_" + componentIdentifier, "BO-1023100010-AUTHORINGDATETIME", "AuthoringDateTime");
			return fields;
		}
