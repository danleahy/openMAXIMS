...
public class GenForm extends FormBridge
{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1014), new Integer(anchoringHelper14.getX()), new Integer(anchoringHelper14.getY()), new Integer(anchoringHelper14.getWidth()), new Integer(anchoringHelper14.getHeight()), new Integer(startTabIndex.intValue() + 16), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Edit", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(DateControl.class, new Object[] { control, new Integer(startControlID.intValue() + 1015), new Integer(anchoringHelper15.getX()), new Integer(anchoringHelper15.getY()), new Integer(anchoringHelper15.getWidth()), new Integer(anchoringHelper15.getHeight()), new Integer(startTabIndex.intValue() + 5), ControlState.DISABLED, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.TRUE, null, Boolean.FALSE, null, Boolean.FALSE, null}));
		...
		super.addControl(factory.getControl(PartialDateBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1016), new Integer(anchoringHelper16.getX()), new Integer(anchoringHelper16.getY()), new Integer(anchoringHelper16.getWidth()), new Integer(anchoringHelper16.getHeight()), new Integer(startTabIndex.intValue() + 10), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT, null, Boolean.FALSE, Boolean.FALSE}));
		...
		Grid m_grdLeafletsGivenTemp = (Grid)factory.getControl(Grid.class, new Object[] { control, new Integer(startControlID.intValue() + 1025), new Integer(anchoringHelper25.getX()), new Integer(anchoringHelper25.getY()), new Integer(anchoringHelper25.getWidth()), new Integer(anchoringHelper25.getHeight()), new Integer(startTabIndex.intValue() + 13), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT,Boolean.FALSE, Boolean.FALSE, new Integer(24), Boolean.TRUE, null, Boolean.FALSE, Boolean.FALSE, new Integer(0), null, Boolean.FALSE, Boolean.TRUE});
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.OPDEDClinicNotes.__internal_x_context__voOPDErectDysfxn_" + componentIdentifier, "BO-1031100008-ID", "ID_OPDErectDysfxn");
			fields[145] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.OPDEDClinicNotes.__internal_x_context__voOPDErectDysfxn_" + componentIdentifier, "BO-1031100008-ERECTIONQUAL", "ErectionQual");
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.OPDEDClinicNotes.__internal_x_context__voOPDErectDysfxn_" + componentIdentifier, "BO-1031100008-CONSETNFORMSIGNED", "ConsetnFormSigned");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.OPDEDClinicNotes.__internal_x_context__voOPDErectDysfxn_" + componentIdentifier, "BO-1031100008-TREATDISCUSSED", "TreatDiscussed");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.OPDEDClinicNotes.__internal_x_context__voOPDErectDysfxn_" + componentIdentifier, "BO-1031100008-ADVLEAFLETGIVEN", "AdvLeafletGiven");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.OPDEDClinicNotes.__internal_x_context__SelectedCareContextShort_" + componentIdentifier, "BO-1004100019-ID", "ID_CareContext");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.OPDEDClinicNotes.__internal_x_context__SelectedCareContextShort_" + componentIdentifier, "BO-1004100019-CONTEXT", "Context");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.OPDEDClinicNotes.__internal_x_context__SelectedCareContextShort_" + componentIdentifier, "BO-1004100019-ORDERINGHOSPITAL", "OrderingHospital");
			fields[152] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.OPDEDClinicNotes.__internal_x_context__SelectedCareContextShort_" + componentIdentifier, "BO-1004100019-ESTIMATEDDISCHARGEDATE", "EstimatedDischargeDate");
			fields[153] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.OPDEDClinicNotes.__internal_x_context__SelectedCareContextShort_" + componentIdentifier, "BO-1004100019-STARTDATETIME", "StartDateTime");
			fields[154] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.OPDEDClinicNotes.__internal_x_context__SelectedCareContextShort_" + componentIdentifier, "BO-1004100019-ENDDATETIME", "EndDateTime");
			fields[155] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.OPDEDClinicNotes.__internal_x_context__SelectedCareContextShort_" + componentIdentifier, "BO-1004100019-LOCATIONTYPE", "LocationType");
			fields[156] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.OPDEDClinicNotes.__internal_x_context__SelectedCareContextShort_" + componentIdentifier, "BO-1004100019-RESPONSIBLEHCP", "ResponsibleHCP");
			fields[157] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.OPDEDClinicNotes.__internal_x_context__MedSocialHistory_" + componentIdentifier, "BO-1003100026-ID", "ID_SocialHistory");
			fields[158] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.OPDEDClinicNotes.__internal_x_context__MedSocialHistory_" + componentIdentifier, "BO-1003100026-CARECONTEXT", "CareContext");
			fields[159] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.OPDEDClinicNotes.__internal_x_context__MedSocialHistory_" + componentIdentifier, "BO-1003100026-SMOKINGSTATUS", "SmokingStatus");
			fields[160] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.OPDEDClinicNotes.__internal_x_context__MedSocialHistory_" + componentIdentifier, "BO-1003100026-ILLICITDRUGS", "IllicitDrugs");
			fields[161] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.OPDEDClinicNotes.__internal_x_context__MedSocialHistory_" + componentIdentifier, "BO-1003100026-OCCUPATION", "Occupation");
			fields[162] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.OPDEDClinicNotes.__internal_x_context__MedSocialHistory_" + componentIdentifier, "BO-1003100026-LIVESWITH", "LivesWith");
			fields[163] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.OPDEDClinicNotes.__internal_x_context__MedSocialHistory_" + componentIdentifier, "BO-1003100026-FITTOCAREFORPATIENT", "FitToCareForPatient");
			fields[164] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.OPDEDClinicNotes.__internal_x_context__MedSocialHistory_" + componentIdentifier, "BO-1003100026-FITTOTAKEHOME", "FitToTakeHome");
			fields[165] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.OPDEDClinicNotes.__internal_x_context__MedSocialHistory_" + componentIdentifier, "BO-1003100026-OCCUPATIONTEXT", "OccupationText");
			fields[166] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.OPDEDClinicNotes.__internal_x_context__MedSocialHistory_" + componentIdentifier, "BO-1003100026-SOCIALHISTORYNOTES", "SocialHistoryNotes");
			fields[167] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.OPDEDClinicNotes.__internal_x_context__MedSocialHistory_" + componentIdentifier, "BO-1003100026-MOBILITYINDEPENDENCE", "MobilityIndependence");
			fields[168] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.OPDEDClinicNotes.__internal_x_context__MedSocialHistory_" + componentIdentifier, "BO-1003100026-OCCUPATIONSTATUS", "OccupationStatus");
			fields[169] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.OPDEDClinicNotes.__internal_x_context__MedSocialHistory_" + componentIdentifier, "BO-1003100026-DIET", "Diet");
			return fields;
		}
