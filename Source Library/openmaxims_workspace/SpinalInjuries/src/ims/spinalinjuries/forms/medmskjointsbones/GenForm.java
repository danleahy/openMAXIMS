...
public class GenForm extends FormBridge
{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1012), new Integer(anchoringHelper12.getX()), new Integer(anchoringHelper12.getY()), new Integer(anchoringHelper12.getWidth()), new Integer(anchoringHelper12.getHeight()), new Integer(startTabIndex.intValue() + 19), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Close", Boolean.FALSE, null, Boolean.FALSE, Boolean.FALSE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1014), new Integer(anchoringHelper14.getX()), new Integer(anchoringHelper14.getY()), new Integer(anchoringHelper14.getWidth()), new Integer(anchoringHelper14.getHeight()), new Integer(startTabIndex.intValue() + 18), ControlState.HIDDEN, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Cancel", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1015), new Integer(anchoringHelper15.getX()), new Integer(anchoringHelper15.getY()), new Integer(anchoringHelper15.getWidth()), new Integer(anchoringHelper15.getHeight()), new Integer(startTabIndex.intValue() + 16), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Clear", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1016), new Integer(anchoringHelper16.getX()), new Integer(anchoringHelper16.getY()), new Integer(anchoringHelper16.getWidth()), new Integer(anchoringHelper16.getHeight()), new Integer(startTabIndex.intValue() + 15), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Add/Apply", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		ComboBox m_cmbGroupTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1019), new Integer(anchoringHelper19.getX()), new Integer(anchoringHelper19.getY()), new Integer(anchoringHelper19.getWidth()), new Integer(anchoringHelper19.getHeight()), new Integer(startTabIndex.intValue() + 7), ControlState.DISABLED, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT ,Boolean.TRUE, Boolean.TRUE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.TRUE, new Integer(-1)});
		...
		ComboBox m_cmbJBTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1021), new Integer(anchoringHelper21.getX()), new Integer(anchoringHelper21.getY()), new Integer(anchoringHelper21.getWidth()), new Integer(anchoringHelper21.getHeight()), new Integer(startTabIndex.intValue() + 8), ControlState.DISABLED, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT ,Boolean.TRUE, Boolean.TRUE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.TRUE, new Integer(-1)});
		...
		super.addControl(factory.getControl(CheckBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1024), new Integer(anchoringHelper24.getX()), new Integer(anchoringHelper24.getY()), new Integer(anchoringHelper24.getWidth()), new Integer(anchoringHelper24.getHeight()), new Integer(startTabIndex.intValue() + 14), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT ,"Add to Problems", Boolean.FALSE, null}));
		...
		grdMovements.addIntColumn("MovementId", 0, 0, 0, false, true, null, false, 0, true, 0);
		...
		grdMovements.addIntColumn("SOR", 0, 0, 40, false, true, null, false, 0, true, 0);
		grdMovements.addIntColumn("EOR", 0, 0, -1, false, true, null, false, 0, true, 0);
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.MedMskJointsBones.__internal_x_context__SelectedChildInstance_" + componentIdentifier, "BO-1072100035-ID", "ID_MSkExamJointBonesDetail");
			fields[145] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.MedMskJointsBones.__internal_x_context__SelectedChildInstance_" + componentIdentifier, "BO-1072100035-ISJOINT", "IsJoint");
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.MedMskJointsBones.__internal_x_context__SelectedChildInstance_" + componentIdentifier, "BO-1072100035-BONE", "Bone");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.MedMskJointsBones.__internal_x_context__SelectedChildInstance_" + componentIdentifier, "BO-1072100035-LATERALITY", "Laterality");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.MedMskJointsBones.__internal_x_context__SelectedChildInstance_" + componentIdentifier, "BO-1072100035-LIGAMENTSTESTS", "LigamentsTests");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.MedMskJointsBones.__internal_x_context__SelectedChildInstance_" + componentIdentifier, "BO-1072100035-INTERPRETATION", "Interpretation");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.MedMskJointsBones.__internal_x_context__SelectedChildInstance_" + componentIdentifier, "BO-1072100035-ISPROBLEM", "IsProblem");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.MedMskJointsBones.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1031100003-ID", "ID_MskExamJointBones");
			fields[152] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.MedMskJointsBones.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1031100003-AUTHORINGDATETIME", "AuthoringDateTime");
			fields[153] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.MedMskJointsBones.__internal_x_context__UpdatedChildInstance_" + componentIdentifier, "BO-1072100035-ID", "ID_MSkExamJointBonesDetail");
			fields[154] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.MedMskJointsBones.__internal_x_context__UpdatedChildInstance_" + componentIdentifier, "BO-1072100035-ISJOINT", "IsJoint");
			fields[155] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.MedMskJointsBones.__internal_x_context__UpdatedChildInstance_" + componentIdentifier, "BO-1072100035-BONE", "Bone");
			fields[156] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.MedMskJointsBones.__internal_x_context__UpdatedChildInstance_" + componentIdentifier, "BO-1072100035-LATERALITY", "Laterality");
			fields[157] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.MedMskJointsBones.__internal_x_context__UpdatedChildInstance_" + componentIdentifier, "BO-1072100035-LIGAMENTSTESTS", "LigamentsTests");
			fields[158] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.MedMskJointsBones.__internal_x_context__UpdatedChildInstance_" + componentIdentifier, "BO-1072100035-INTERPRETATION", "Interpretation");
			fields[159] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.MedMskJointsBones.__internal_x_context__UpdatedChildInstance_" + componentIdentifier, "BO-1072100035-ISPROBLEM", "IsProblem");
			return fields;
		}
