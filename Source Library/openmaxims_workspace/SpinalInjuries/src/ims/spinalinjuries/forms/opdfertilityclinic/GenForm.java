...
public class GenForm extends FormBridge
{
	...
	public static class container1Container extends ContainerBridge
	{
		...
		protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
		{
			...
			super.addControl(factory.getControl(PartialDateBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1018), new Integer(anchoringHelper19.getX()), new Integer(anchoringHelper19.getY()), new Integer(anchoringHelper19.getWidth()), new Integer(anchoringHelper19.getHeight()), new Integer(startTabIndex.intValue() + 6), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, null, Boolean.FALSE, Boolean.FALSE}));
			...
			grdSperm.addIntColumn("Score", 0, 0, -1, false, true, null, false, 0, true, 0);
			...
			Grid m_grdBladDrainageTemp = (Grid)factory.getControl(Grid.class, new Object[] { control, new Integer(startControlID.intValue() + 1030), new Integer(anchoringHelper31.getX()), new Integer(anchoringHelper31.getY()), new Integer(anchoringHelper31.getWidth()), new Integer(anchoringHelper31.getHeight()), new Integer(startTabIndex.intValue() + 11), ControlState.READONLY, ControlState.EDITABLE, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.FALSE, Boolean.FALSE, new Integer(24), Boolean.TRUE, null, Boolean.FALSE, Boolean.FALSE, new Integer(0), null, Boolean.FALSE, Boolean.TRUE});
			...
			Grid m_grdTxOfferedTemp = (Grid)factory.getControl(Grid.class, new Object[] { control, new Integer(startControlID.intValue() + 1034), new Integer(anchoringHelper35.getX()), new Integer(anchoringHelper35.getY()), new Integer(anchoringHelper35.getWidth()), new Integer(anchoringHelper35.getHeight()), new Integer(startTabIndex.intValue() + 22), ControlState.READONLY, ControlState.EDITABLE, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.FALSE, Boolean.FALSE, new Integer(24), Boolean.TRUE, null, Boolean.FALSE, Boolean.FALSE, new Integer(0), null, Boolean.FALSE, Boolean.TRUE});
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1040), new Integer(anchoringHelper40.getX()), new Integer(anchoringHelper40.getY()), new Integer(anchoringHelper40.getWidth()), new Integer(anchoringHelper40.getHeight()), new Integer(startTabIndex.intValue() + 26), ControlState.HIDDEN, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Save", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1041), new Integer(anchoringHelper41.getX()), new Integer(anchoringHelper41.getY()), new Integer(anchoringHelper41.getWidth()), new Integer(anchoringHelper41.getHeight()), new Integer(startTabIndex.intValue() + 24), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "New", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1042), new Integer(anchoringHelper42.getX()), new Integer(anchoringHelper42.getY()), new Integer(anchoringHelper42.getWidth()), new Integer(anchoringHelper42.getHeight()), new Integer(startTabIndex.intValue() + 25), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Edit", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1043), new Integer(anchoringHelper43.getX()), new Integer(anchoringHelper43.getY()), new Integer(anchoringHelper43.getWidth()), new Integer(anchoringHelper43.getHeight()), new Integer(startTabIndex.intValue() + 28), ControlState.HIDDEN, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Cancel", Boolean.FALSE, null, Boolean.FALSE, Boolean.FALSE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(DateControl.class, new Object[] { control, new Integer(startControlID.intValue() + 1044), new Integer(anchoringHelper44.getX()), new Integer(anchoringHelper44.getY()), new Integer(anchoringHelper44.getWidth()), new Integer(anchoringHelper44.getHeight()), new Integer(startTabIndex.intValue() + 23), ControlState.HIDDEN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT,Boolean.TRUE, null, Boolean.FALSE, null, Boolean.FALSE, null}));
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.OPDFertilityCLinic.__internal_x_context__voOPDFertClinic_" + componentIdentifier, "BO-1023100027-ID", "ID_OPDFertClinic");
			fields[145] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.OPDFertilityCLinic.__internal_x_context__voOPDFertClinic_" + componentIdentifier, "BO-1023100027-ACHIEVEERECTION", "AchieveErection");
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.OPDFertilityCLinic.__internal_x_context__voOPDFertClinic_" + componentIdentifier, "BO-1023100027-SEXDRIVE", "SexDrive");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.OPDFertilityCLinic.__internal_x_context__voOPDFertClinic_" + componentIdentifier, "BO-1023100027-EJACULATION", "Ejaculation");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.OPDFertilityCLinic.__internal_x_context__voOPDFertClinic_" + componentIdentifier, "BO-1023100027-BLADDERDRAINAGETXT", "BladderDrainagetxt");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.OPDFertilityCLinic.__internal_x_context__voOPDFertClinic_" + componentIdentifier, "BO-1023100027-TESTATROPHY", "TestAtrophy");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.OPDFertilityCLinic.__internal_x_context__voOPDFertClinic_" + componentIdentifier, "BO-1023100027-SCREENCONSENT", "ScreenConsent");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.OPDFertilityCLinic.__internal_x_context__voOPDFertClinic_" + componentIdentifier, "BO-1023100027-SEMENCULTURE", "SemenCulture");
			fields[152] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.OPDFertilityCLinic.__internal_x_context__voOPDFertClinic_" + componentIdentifier, "BO-1023100027-ELISA", "Elisa");
			fields[153] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.OPDFertilityCLinic.__internal_x_context__voOPDFertClinic_" + componentIdentifier, "BO-1023100027-SPERMFROZEN", "SpermFrozen");
			fields[154] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.OPDFertilityCLinic.__internal_x_context__voOPDFertClinic_" + componentIdentifier, "BO-1023100027-CARECONTEXT", "CareContext");
			fields[155] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.OPDFertilityCLinic.__internal_x_context__SelectedCareContextShort_" + componentIdentifier, "BO-1004100019-ID", "ID_CareContext");
			fields[156] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.OPDFertilityCLinic.__internal_x_context__SelectedCareContextShort_" + componentIdentifier, "BO-1004100019-CONTEXT", "Context");
			fields[157] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.OPDFertilityCLinic.__internal_x_context__SelectedCareContextShort_" + componentIdentifier, "BO-1004100019-ORDERINGHOSPITAL", "OrderingHospital");
			fields[158] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.OPDFertilityCLinic.__internal_x_context__SelectedCareContextShort_" + componentIdentifier, "BO-1004100019-ESTIMATEDDISCHARGEDATE", "EstimatedDischargeDate");
			fields[159] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.OPDFertilityCLinic.__internal_x_context__SelectedCareContextShort_" + componentIdentifier, "BO-1004100019-STARTDATETIME", "StartDateTime");
			fields[160] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.OPDFertilityCLinic.__internal_x_context__SelectedCareContextShort_" + componentIdentifier, "BO-1004100019-ENDDATETIME", "EndDateTime");
			fields[161] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.OPDFertilityCLinic.__internal_x_context__SelectedCareContextShort_" + componentIdentifier, "BO-1004100019-LOCATIONTYPE", "LocationType");
			fields[162] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.OPDFertilityCLinic.__internal_x_context__SelectedCareContextShort_" + componentIdentifier, "BO-1004100019-RESPONSIBLEHCP", "ResponsibleHCP");
			fields[163] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.OPDFertilityCLinic.__internal_x_context__MedSocialHistory_" + componentIdentifier, "BO-1003100026-ID", "ID_SocialHistory");
			fields[164] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.OPDFertilityCLinic.__internal_x_context__MedSocialHistory_" + componentIdentifier, "BO-1003100026-CARECONTEXT", "CareContext");
			fields[165] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.OPDFertilityCLinic.__internal_x_context__MedSocialHistory_" + componentIdentifier, "BO-1003100026-SMOKINGSTATUS", "SmokingStatus");
			fields[166] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.OPDFertilityCLinic.__internal_x_context__MedSocialHistory_" + componentIdentifier, "BO-1003100026-ILLICITDRUGS", "IllicitDrugs");
			fields[167] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.OPDFertilityCLinic.__internal_x_context__MedSocialHistory_" + componentIdentifier, "BO-1003100026-OCCUPATION", "Occupation");
			fields[168] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.OPDFertilityCLinic.__internal_x_context__MedSocialHistory_" + componentIdentifier, "BO-1003100026-LIVESWITH", "LivesWith");
			fields[169] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.OPDFertilityCLinic.__internal_x_context__MedSocialHistory_" + componentIdentifier, "BO-1003100026-FITTOCAREFORPATIENT", "FitToCareForPatient");
			fields[170] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.OPDFertilityCLinic.__internal_x_context__MedSocialHistory_" + componentIdentifier, "BO-1003100026-FITTOTAKEHOME", "FitToTakeHome");
			fields[171] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.OPDFertilityCLinic.__internal_x_context__MedSocialHistory_" + componentIdentifier, "BO-1003100026-OCCUPATIONTEXT", "OccupationText");
			fields[172] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.OPDFertilityCLinic.__internal_x_context__MedSocialHistory_" + componentIdentifier, "BO-1003100026-SOCIALHISTORYNOTES", "SocialHistoryNotes");
			fields[173] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.OPDFertilityCLinic.__internal_x_context__MedSocialHistory_" + componentIdentifier, "BO-1003100026-MOBILITYINDEPENDENCE", "MobilityIndependence");
			fields[174] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.OPDFertilityCLinic.__internal_x_context__MedSocialHistory_" + componentIdentifier, "BO-1003100026-OCCUPATIONSTATUS", "OccupationStatus");
			fields[175] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.OPDFertilityCLinic.__internal_x_context__MedSocialHistory_" + componentIdentifier, "BO-1003100026-DIET", "Diet");
			return fields;
		}
