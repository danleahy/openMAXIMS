...
public class Logic extends BaseLogic
{
	...
	{
		if (voNeuroMotorFind != null) //WDEV-18846
		{
			AuthoringInformationVo authoringInfo = new AuthoringInformationVo(); 
			authoringInfo.setAuthoringDateTime(voNeuroMotorFind.getAuthoringDateTime());
			authoringInfo.setAuthoringHcp(voNeuroMotorFind.getAuthoringCP());
	...
	protected void onBtnNewClick() throws ims.framework.exceptions.PresentationLogicException
	{
		...
		if (engine.getFormName().equals(form.getForms().SpinalInjuries.MedNeuroMotorInpatient))
		{
			...
			form.grdMotor().getRows().clear();
			loadFindingsGrid();
			setDefaultAuthoringInfo();	//WDEV-18846
		}
	}
	//WDEV-18846 - start
	...
	private void checkAuthoringControls()
	{
		...
		{
			enableAuthoringControls(true); //WDEV-18846
		}
	}

	private void enableAuthoringControls(boolean enable)
	{
		form.ccAuthoring().setEnabledAuthoringHCP(enable); //WDEV-18846
		form.ccAuthoring().setEnabledDateTime(enable);	//WDEV-18846
	}
	...
	protected void onBtnSaveClick() throws ims.framework.exceptions.PresentationLogicException
	{
		...
		{
			listOfErrors.add(voMotorExam.validate().toString());
		}
		String[] uIErrors = listOfErrors.toArray(new String[listOfErrors.size()]);
		
		if (uIErrors != null && uIErrors.length > 0)  //WDEV-18846 -end
		{
	...
	private void populateDataFromScreen(NeuroMotorExaminationVo voMotorExam)
	{
		...
		if (form.ccAuthoring().getValue() != null) //WDEV-18846
		{	
