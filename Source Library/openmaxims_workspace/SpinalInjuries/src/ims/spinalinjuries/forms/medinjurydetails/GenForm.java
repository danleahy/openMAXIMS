...
public class GenForm extends FormBridge
{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1016), new Integer(anchoringHelper17.getX()), new Integer(anchoringHelper17.getY()), new Integer(anchoringHelper17.getWidth()), new Integer(anchoringHelper17.getHeight()), new Integer(startTabIndex.intValue() + 18), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "New", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		ComboBox m_cmbUnitDurLOCTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1028), new Integer(anchoringHelper29.getX()), new Integer(anchoringHelper29.getY()), new Integer(anchoringHelper29.getWidth()), new Integer(anchoringHelper29.getHeight()), new Integer(startTabIndex.intValue() + 9), ControlState.DISABLED, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
		...
		super.addControl(factory.getControl(IntBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1036), new Integer(anchoringHelper37.getX()), new Integer(anchoringHelper37.getY()), new Integer(anchoringHelper37.getWidth()), new Integer(anchoringHelper37.getHeight()), new Integer(startTabIndex.intValue() + 8), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.TRUE, Boolean.TRUE, Boolean.FALSE, "Please enter a valid number", null, Boolean.FALSE, new Integer(9)}));
	}
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.MedInjuryDetails.__internal_x_context__InjuryDetails_" + componentIdentifier, "BO-1023100000-ID", "ID_InjuryDetails");
			fields[145] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.MedInjuryDetails.__internal_x_context__InjuryDetails_" + componentIdentifier, "BO-1023100000-INJURYDATE", "InjuryDate");
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.MedInjuryDetails.__internal_x_context__InjuryDetails_" + componentIdentifier, "BO-1023100000-INJURYTIME", "InjuryTime");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.MedInjuryDetails.__internal_x_context__InjuryDetails_" + componentIdentifier, "BO-1023100000-REFERRALDATE", "ReferralDate");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.MedInjuryDetails.__internal_x_context__InjuryDetails_" + componentIdentifier, "BO-1023100000-TRANSFERDATE", "TransferDate");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.MedInjuryDetails.__internal_x_context__InjuryDetails_" + componentIdentifier, "BO-1023100000-SUFFEREDLOC", "SufferedLOC");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.MedInjuryDetails.__internal_x_context__InjuryDetails_" + componentIdentifier, "BO-1023100000-DURLOC", "DurLOC");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.MedInjuryDetails.__internal_x_context__InjuryDetails_" + componentIdentifier, "BO-1023100000-DURLOCUNIT", "DurLOCUnit");
			fields[152] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.MedInjuryDetails.__internal_x_context__InjuryDetails_" + componentIdentifier, "BO-1023100000-REQUIRESVENTILLATION", "RequiresVentillation");
			fields[153] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.MedInjuryDetails.__internal_x_context__InjuryDetails_" + componentIdentifier, "BO-1023100000-DESCRIPTIONOFINJURY", "DescriptionOfInjury");
			fields[154] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.MedInjuryDetails.__internal_x_context__InjuryDetails_" + componentIdentifier, "BO-1023100000-PRESENTINGCOMPLAINTS", "PresentingComplaints");
			fields[155] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.MedInjuryDetails.__internal_x_context__InjuryDetails_" + componentIdentifier, "BO-1023100000-MODEOFINJURY", "ModeOfInjury");
			fields[156] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.MedInjuryDetails.__internal_x_context__InjuryDetails_" + componentIdentifier, "BO-1023100000-CAUSEOFINJURY", "CauseOfInjury");
			fields[157] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.MedInjuryDetails.__internal_x_context__InjuryDetails_" + componentIdentifier, "BO-1023100000-MECHANISMOFINJURY", "MechanismOfInjury");
			return fields;
		}
