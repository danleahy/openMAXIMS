...
import ims.spinalinjuries.vo.MedMskSpinepathSearchCriteriaVo;
...
public class Logic extends BaseLogic
{
	...
	{		
		...
		{
			if (form.getGlobalContext().SpinalInjuries.getMedMskSpinePathInpatientSearchCriteriaIsNotNull() && form.getGlobalContext().SpinalInjuries.getMedMskSpinePathInpatientSearchCriteria().getPatientClinicalContactIsNotNull())
			{
				if (!(form.getGlobalContext().Core.getCurrentClinicalContactIsNotNull() && form.getGlobalContext().Core.getCurrentClinicalContact().equals(form.getGlobalContext().SpinalInjuries.getMedMskSpinePathInpatientSearchCriteria().getPatientClinicalContact())))
					form.getGlobalContext().SpinalInjuries.setMedMskSpinePathInpatientSearchCriteria(null);
			}
			else if(form.getGlobalContext().SpinalInjuries.getMedMskSpinePathInpatientSearchCriteriaIsNotNull() && form.getGlobalContext().SpinalInjuries.getMedMskSpinePathInpatientSearchCriteria().getPatientCareContextIsNotNull())
			{
				if (!(form.getGlobalContext().Core.getCurrentCareContextIsNotNull() && form.getGlobalContext().Core.getCurrentCareContext().equals(form.getGlobalContext().SpinalInjuries.getMedMskSpinePathInpatientSearchCriteria().getPatientCareContext()) && !form.getGlobalContext().Core.getCurrentClinicalContactIsNotNull()))
					form.getGlobalContext().SpinalInjuries.setMedMskSpinePathInpatientSearchCriteria(null);
			}
			else
				form.getGlobalContext().SpinalInjuries.setMedMskSpinePathInpatientSearchCriteria(null);
			
			if (form.getGlobalContext().SpinalInjuries.getMedMskSpinePathInpatientSearchCriteria() != null)
			{
				fillRecordBrowser();
				setInpatientSearchCriteria(form.getGlobalContext().SpinalInjuries.getMedMskSpinePathInpatientSearchCriteria());
				browseRecord();
			}
			else 
				open();
		}
		else if (engine.getFormName().equals(form.getForms().SpinalInjuries.MedMskSpinePath))
		{
			if (form.getGlobalContext().SpinalInjuries.getMedMskSpinepathSearchCriteriaIsNotNull() && form.getGlobalContext().SpinalInjuries.getMedMskSpinepathSearchCriteria().getPatientClinicalContactIsNotNull())
			{
				if (!(form.getGlobalContext().Core.getCurrentClinicalContactIsNotNull() && form.getGlobalContext().Core.getCurrentClinicalContact().equals(form.getGlobalContext().SpinalInjuries.getMedMskSpinepathSearchCriteria().getPatientClinicalContact())))
					form.getGlobalContext().SpinalInjuries.setMedMskSpinepathSearchCriteria(null);
			}
			else if(form.getGlobalContext().SpinalInjuries.getMedMskSpinepathSearchCriteriaIsNotNull() && form.getGlobalContext().SpinalInjuries.getMedMskSpinepathSearchCriteria().getPatientCareContextIsNotNull())
			{
				if (!(form.getGlobalContext().Core.getCurrentCareContextIsNotNull() && form.getGlobalContext().Core.getCurrentCareContext().equals(form.getGlobalContext().SpinalInjuries.getMedMskSpinepathSearchCriteria().getPatientCareContext()) && !form.getGlobalContext().Core.getCurrentClinicalContactIsNotNull()))
					form.getGlobalContext().SpinalInjuries.setMedMskSpinepathSearchCriteria(null);
			}
			
			setSearchCriteria(form.getGlobalContext().SpinalInjuries.getMedMskSpinepathSearchCriteria());
			open();
		}
		//WDEV-19389 - end
	...
	private MedMskSpinepathSearchCriteriaVo getSearchCriteria()
	{
		MedMskSpinepathSearchCriteriaVo searchCriteria = new MedMskSpinepathSearchCriteriaVo();
		
		searchCriteria.setActiveOnly(Boolean.TRUE.equals(form.chkActive().getValue()) ? true : false);
		searchCriteria.setPatientCareContext(form.getGlobalContext().Core.getCurrentCareContext());
		searchCriteria.setPatientClinicalContact(form.getGlobalContext().Core.getCurrentClinicalContact());
		
		return searchCriteria;
	}
	
	private MedMskSpinepathSearchCriteriaVo getInpatientSearchCriteria()
	{
		MedMskSpinepathSearchCriteriaVo searchCriteria = new MedMskSpinepathSearchCriteriaVo();
		
		searchCriteria.setActiveOnly(Boolean.TRUE.equals(form.chkActiveOnly().getValue()) ? true : false);
		
		if (form.recbrPathology().getValue() != null && form.recbrPathology().getValue() instanceof CareContextShortVo)
			searchCriteria.setCareContext((CareContextShortVo) form.recbrPathology().getValue());
		else if (form.recbrPathology().getValue() != null && form.recbrPathology().getValue() instanceof ClinicalContactShortVo)
			searchCriteria.setClinicalContact((ClinicalContactShortVo) form.recbrPathology().getValue());
	...
	private void setInpatientSearchCriteria(MedMskSpinepathSearchCriteriaVo medMskSpinepathSearchCriteriaVo)
	{
		form.chkActiveOnly().setValue(medMskSpinepathSearchCriteriaVo.getActiveOnly());
		if(engine.getFormName().equals(form.getForms().SpinalInjuries.MedMskSpinePathInpatient))
		{
			if (medMskSpinepathSearchCriteriaVo != null && medMskSpinepathSearchCriteriaVo.getCareContextIsNotNull() && !medMskSpinepathSearchCriteriaVo.getClinicalContactIsNotNull())
			{
				form.recbrPathology().newRow(medMskSpinepathSearchCriteriaVo.getCareContext(), "Care Context:    " + medMskSpinepathSearchCriteriaVo.getCareContext().getStartDateTime() + " - " + medMskSpinepathSearchCriteriaVo.getCareContext().getEpisodeOfCare().getResponsibleHCP(), Color.Green);
				form.recbrPathology().setValue(medMskSpinepathSearchCriteriaVo.getCareContext());
			}
			else if (medMskSpinepathSearchCriteriaVo != null && !medMskSpinepathSearchCriteriaVo.getCareContextIsNotNull() && medMskSpinepathSearchCriteriaVo.getClinicalContactIsNotNull())
			{
				form.recbrPathology().newRow(medMskSpinepathSearchCriteriaVo.getClinicalContact(), "Clinical Contact: " + medMskSpinepathSearchCriteriaVo.getClinicalContact().getStartDateTime() + " - " + medMskSpinepathSearchCriteriaVo.getClinicalContact().getSeenBy());	
				form.recbrPathology().setValue(medMskSpinepathSearchCriteriaVo.getClinicalContact());
			}
		}		
	}
	
	
	private void setSearchCriteria(MedMskSpinepathSearchCriteriaVo medMskSpinepathSearchCriteriaVo)
	{
		if (medMskSpinepathSearchCriteriaVo == null)
			return;
	...
	protected void onChkActiveOnlyValueChanged() throws PresentationLogicException
	{
		...
		if (engine.getFormName().equals(form.getForms().SpinalInjuries.MedMskSpinePathInpatient))
		{
			form.getGlobalContext().SpinalInjuries.setMedMskSpinePathInpatientSearchCriteria(getInpatientSearchCriteria());
		}
		else if (engine.getFormName().equals(form.getForms().SpinalInjuries.MedMskSpinePath))
		{
			form.getGlobalContext().SpinalInjuries.setMedMskSpinepathSearchCriteria(getSearchCriteria());
		}
		open();
	}
