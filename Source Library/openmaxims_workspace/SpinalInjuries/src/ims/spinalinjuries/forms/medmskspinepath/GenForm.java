...
public class GenForm extends FormBridge
{
	...
	private void validateContext(ims.framework.Context context)
	{
		...
		if(!context.isValidContextType(ims.spinalinjuries.vo.MedMskSpinepathSearchCriteriaVo.class))
			throw new ims.framework.exceptions.CodingRuntimeException("The type 'ims.spinalinjuries.vo.MedMskSpinepathSearchCriteriaVo' of the global context variable 'SpinalInjuries.MedMskSpinepathSearchCriteria' is not supported.");
		if(!context.isValidContextType(ims.spinalinjuries.vo.MedMskSpinepathSearchCriteriaVo.class))
			throw new ims.framework.exceptions.CodingRuntimeException("The type 'ims.spinalinjuries.vo.MedMskSpinepathSearchCriteriaVo' of the global context variable 'SpinalInjuries.MedMskSpinePathInpatientSearchCriteria' is not supported.");
	}
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1011), new Integer(anchoringHelper11.getX()), new Integer(anchoringHelper11.getY()), new Integer(anchoringHelper11.getWidth()), new Integer(anchoringHelper11.getHeight()), new Integer(startTabIndex.intValue() + 14), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "New", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1012), new Integer(anchoringHelper12.getX()), new Integer(anchoringHelper12.getY()), new Integer(anchoringHelper12.getWidth()), new Integer(anchoringHelper12.getHeight()), new Integer(startTabIndex.intValue() + 15), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Edit", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		ComboBox m_cmbTypeOfInjuryTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1014), new Integer(anchoringHelper14.getX()), new Integer(anchoringHelper14.getY()), new Integer(anchoringHelper14.getWidth()), new Integer(anchoringHelper14.getHeight()), new Integer(startTabIndex.intValue() + 8), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.TRUE, new Integer(-1)});
		...
		super.addControl(factory.getControl(CheckBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1021), new Integer(anchoringHelper21.getX()), new Integer(anchoringHelper21.getY()), new Integer(anchoringHelper21.getWidth()), new Integer(anchoringHelper21.getHeight()), new Integer(startTabIndex.intValue() + 13), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT ,"Add to Problems", Boolean.FALSE, null}));
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.MedMskSpinePath.__internal_x_context__finding_" + componentIdentifier, "BO-1023100008-ID", "ID_MskSpinePath");
			fields[145] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.MedMskSpinePath.__internal_x_context__finding_" + componentIdentifier, "BO-1023100008-MODEOFINJURY", "ModeOfInjury");
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.MedMskSpinePath.__internal_x_context__finding_" + componentIdentifier, "BO-1023100008-TYPEOFINJURY", "TypeOfInjury");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.MedMskSpinePath.__internal_x_context__finding_" + componentIdentifier, "BO-1023100008-MECHANISMOFINJURY", "MechanismOfInjury");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.MedMskSpinePath.__internal_x_context__finding_" + componentIdentifier, "BO-1023100008-ISPRIMARYPATHOLOGY", "IsPrimaryPathology");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.MedMskSpinePath.__internal_x_context__finding_" + componentIdentifier, "BO-1023100008-ISPROBLEM", "IsProblem");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.MedMskSpinePath.__internal_x_context__finding_" + componentIdentifier, "BO-1023100008-ISACTIVE", "IsActive");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.MedMskSpinePath.__internal_x_context__finding_" + componentIdentifier, "BO-1023100008-AUTHORINGDATETIME", "AuthoringDateTime");
			return fields;
		}
