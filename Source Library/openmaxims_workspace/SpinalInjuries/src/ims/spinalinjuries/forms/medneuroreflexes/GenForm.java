...
public class GenForm extends FormBridge
{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1008), new Integer(anchoringHelper8.getX()), new Integer(anchoringHelper8.getY()), new Integer(anchoringHelper8.getWidth()), new Integer(anchoringHelper8.getHeight()), new Integer(startTabIndex.intValue() + 9), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "New", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.MedNeuroReflexes.__internal_x_context__SelectedNeuroReflexesVo_" + componentIdentifier, "BO-1023100007-ID", "ID_NeuExamReflxs");
			fields[145] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.MedNeuroReflexes.__internal_x_context__SelectedNeuroReflexesVo_" + componentIdentifier, "BO-1023100007-AUTHORINGDATETIME", "AuthoringDateTime");
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.MedNeuroReflexes.__internal_x_context__SelectedNeuroReflexesVo_" + componentIdentifier, "BO-1023100007-CARECONTEXT", "CareContext");
			return fields;
		}
