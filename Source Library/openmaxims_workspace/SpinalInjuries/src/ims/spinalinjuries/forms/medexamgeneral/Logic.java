...
public class Logic extends BaseLogic
{
	...
	private void populateContactInfo(ClinicalContactShortVo voClinicalContactShort) 
	{
		...
		else if (isMedExamgeneralDefaultForm())
		{			
	...
	{
		java.util.ArrayList<String> listOfErrors = new java.util.ArrayList<String>();//WDEV-18762	
	...
	private MedicalProbOnAdmisVoCollection populateProblemsOnAdmissionDataFromScreen() 
	{
		...
		for(int i=0;i<form.grdProblems().getRows().size();i++)
		{
			...
			item.setCareContext(form.getGlobalContext().Core.getCurrentCareContext()); //WDEV-19903
	...
	{
		form.customControlAuthoring().setValue(null); //WDEV-18707
