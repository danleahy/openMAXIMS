...
public class GenForm extends FormBridge
{
	...
	public static class cntDetailsContainer extends ContainerBridge
	{
		...
		protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
		{
			...
			grdAssessment.addIntColumn("ObjectId", 0, 0, 0, true, true, null, false, 0, true, 0);
			grdAssessment.addIntColumn("Active ROM (L)", 0, 0, 100, false, true, null, false, 0, true, 0);
			grdAssessment.addIntColumn(" Active ROM (R)", 0, 0, 100, false, true, null, false, 0, true, 0);
			grdAssessment.addIntColumn("Passive ROM (L)", 0, 0, 100, false, true, null, false, 0, true, 0);
			grdAssessment.addIntColumn("Passive ROM (R)", 0, 0, 100, false, true, null, false, 0, true, 0);
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1011), new Integer(anchoringHelper11.getX()), new Integer(anchoringHelper11.getY()), new Integer(anchoringHelper11.getWidth()), new Integer(anchoringHelper11.getHeight()), new Integer(startTabIndex.intValue() + 4), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "New", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.OPDSpasticityAssess.__internal_x_context__voOpdSpastAssessTreat_" + componentIdentifier, "BO-1031100005-ID", "ID_OPDSpasticityAssessTreat");
			fields[145] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.OPDSpasticityAssess.__internal_x_context__voOpdSpastAssessTreat_" + componentIdentifier, "BO-1031100005-JOINTCONTRACTURE", "JointContracture");
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.OPDSpasticityAssess.__internal_x_context__SelectedCareContextShort_" + componentIdentifier, "BO-1004100019-ID", "ID_CareContext");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.OPDSpasticityAssess.__internal_x_context__SelectedCareContextShort_" + componentIdentifier, "BO-1004100019-CONTEXT", "Context");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.OPDSpasticityAssess.__internal_x_context__SelectedCareContextShort_" + componentIdentifier, "BO-1004100019-ORDERINGHOSPITAL", "OrderingHospital");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.OPDSpasticityAssess.__internal_x_context__SelectedCareContextShort_" + componentIdentifier, "BO-1004100019-ESTIMATEDDISCHARGEDATE", "EstimatedDischargeDate");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.OPDSpasticityAssess.__internal_x_context__SelectedCareContextShort_" + componentIdentifier, "BO-1004100019-STARTDATETIME", "StartDateTime");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.OPDSpasticityAssess.__internal_x_context__SelectedCareContextShort_" + componentIdentifier, "BO-1004100019-ENDDATETIME", "EndDateTime");
			fields[152] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.OPDSpasticityAssess.__internal_x_context__SelectedCareContextShort_" + componentIdentifier, "BO-1004100019-LOCATIONTYPE", "LocationType");
			fields[153] = new ims.framework.ReportField(this.context, prefix + "_lv_SpinalInjuries.OPDSpasticityAssess.__internal_x_context__SelectedCareContextShort_" + componentIdentifier, "BO-1004100019-RESPONSIBLEHCP", "ResponsibleHCP");
			return fields;
		}
