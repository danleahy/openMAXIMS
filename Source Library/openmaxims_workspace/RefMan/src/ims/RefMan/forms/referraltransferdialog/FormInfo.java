...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_RefMan.ReferralTransfer" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_RefMan.ReferralTransferDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
