...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_RefMan.PatientElectiveListRef", "_cv_Core.RieMessage" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_RefMan.SuspensionDetails.__internal_x_context__" + String.valueOf(getFormId());
	}
