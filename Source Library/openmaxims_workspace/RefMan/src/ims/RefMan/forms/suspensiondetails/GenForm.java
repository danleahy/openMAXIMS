...
public class GenForm extends FormBridge
{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		contextMenus.RefMan.contextMenuSuspensionsMenu = factory.createMenu(startControlID.intValue() + 1);
		contextMenus.RefMan.contextMenuSuspensionsMenuRIEItem = factory.createMenuItem(startControlID.intValue() + 1, "RIE Suspension", true, false, new Integer(102142), true, false);
		if(factory.getUIEngine().getLoggedInRole().hasMenuActionRight(appForm, new ims.framework.MenuAction(6220001)))
			contextMenus.RefMan.contextMenuSuspensionsMenu.add(contextMenus.RefMan.contextMenuSuspensionsMenuRIEItem);
		form.registerMenu(contextMenus.RefMan.contextMenuSuspensionsMenu);
	...
	public final class ContextMenus implements java.io.Serializable
	{
		...
		{
			private static final long serialVersionUID = 1L;
			public final class SuspensionsMenu implements java.io.Serializable
			{
				private static final long serialVersionUID = 1L;
				public static final int RIE = 1;
			}
			public void disableAllSuspensionsMenuMenuItems()
			{
				this.contextMenuSuspensionsMenuRIEItem.setEnabled(false);
			}
			public void hideAllSuspensionsMenuMenuItems()
			{
				this.contextMenuSuspensionsMenuRIEItem.setVisible(false);
			}
			private Menu contextMenuSuspensionsMenu;
			public ReadOnlyMenuItem getSuspensionsMenuRIEItem()
			{
				return this.contextMenuSuspensionsMenuRIEItem;
			}
			private MenuItem contextMenuSuspensionsMenuRIEItem;
		}
	}
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[145] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.SuspensionDetails.__internal_x_context__PatientElectiveList_" + componentIdentifier, "BO-1014100020-ID", "ID_PatientElectiveList");
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.SuspensionDetails.__internal_x_context__PatientElectiveList_" + componentIdentifier, "BO-1014100020-CURRENTSUSPENSIONENDDATE", "CurrentSuspensionEndDate");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.SuspensionDetails.__internal_x_context__CurrentSuspensionDetail_" + componentIdentifier, "BO-1096100063-ID", "ID_SuspensionDetailsForPatientElectiveList");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.SuspensionDetails.__internal_x_context__CurrentSuspensionDetail_" + componentIdentifier, "BO-1096100063-STARTDATE", "StartDate");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.SuspensionDetails.__internal_x_context__CurrentSuspensionDetail_" + componentIdentifier, "BO-1096100063-ENDDATE", "EndDate");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.SuspensionDetails.__internal_x_context__CurrentSuspensionDetail_" + componentIdentifier, "BO-1096100063-INITATOR", "Initator");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.SuspensionDetails.__internal_x_context__CurrentSuspensionDetail_" + componentIdentifier, "BO-1096100063-COMMENTS", "Comments");
			fields[152] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.SuspensionDetails.__internal_x_context__CurrentSuspensionDetail_" + componentIdentifier, "BO-1096100063-SUSPENSIONREASON", "SuspensionReason");
			return fields;
		}
