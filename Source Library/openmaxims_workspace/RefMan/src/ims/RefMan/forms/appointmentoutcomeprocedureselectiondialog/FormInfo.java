...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "AppointmentOutcomeProcedureSelectionDialog";
	}
	public int getWidth()
	{
		return 848;
	...
	{
		return new String[] { "_cv_RefMan.SelectedProceduresApptOutcomeList" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_RefMan.AppointmentOutcomeProcedureSelectionDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
