...
public class GenForm extends FormBridge
{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1023), new Integer(anchoringHelper23.getX()), new Integer(anchoringHelper23.getY()), new Integer(anchoringHelper23.getWidth()), new Integer(anchoringHelper23.getHeight()), new Integer(startTabIndex.intValue() + 15), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Edit", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.BaselineObsComponent.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1096100002-ID", "ID_NursingNotes");
			fields[145] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.BaselineObsComponent.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1096100002-CATSREFERRAL", "CatsReferral");
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.BaselineObsComponent.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1096100002-AUTHORINGDATETIME", "AuthoringDateTime");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.BaselineObsComponent.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1096100002-SMOKINGSTATUS", "SmokingStatus");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.BaselineObsComponent.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1096100002-OBSERVATIONNOTES", "ObservationNotes");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.BaselineObsComponent.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1096100002-ADVICEGIVEN", "AdviceGiven");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.BaselineObsComponent.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1096100002-UNITSOFALCOHOLCONSUMEDPERWEEK", "UnitsOfAlcoholConsumedPerWeek");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.BaselineObsComponent.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1096100002-REFERREDTOSOMKINGCESSATION", "ReferredToSomkingCessation");
			fields[152] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.BaselineObsComponent.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1096100002-MRSARESULT", "MRSAResult");
			return fields;
		}
