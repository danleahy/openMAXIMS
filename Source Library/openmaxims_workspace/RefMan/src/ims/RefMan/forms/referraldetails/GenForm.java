...
public class GenForm extends FormBridge
{
	...
	public static class lyrDetailLayer extends Layer
	{
		...
		public static class tabOverviewContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				RuntimeAnchoring anchoringHelper1 = new RuntimeAnchoring(designSize, runtimeSize, 8, 0, 808, 544, ims.framework.enumerations.ControlAnchoring.ALL);
				...
				//ims.framework.Control m_ccReferralOverviewAndKpisControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1000), new Integer(8), new Integer(0), new Integer(808), new Integer(544), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 1), m_ccReferralOverviewAndKpisForm, instance1 } );
		...
		public static class tabPayerDetailsContainer extends LayerBridge
		{
			...
			public static class lyrDetailsLayer extends Layer
			{
				...
				public static class tabInsuranceDetailsContainer extends LayerBridge
				{
					...
					protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
					{
						...
						super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1012), new Integer(anchoringHelper11.getX()), new Integer(anchoringHelper11.getY()), new Integer(anchoringHelper11.getWidth()), new Integer(anchoringHelper11.getHeight()), new Integer(startTabIndex.intValue() + 52), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.FALSE, new Integer(0), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
						...
						super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1013), new Integer(anchoringHelper12.getX()), new Integer(anchoringHelper12.getY()), new Integer(anchoringHelper12.getWidth()), new Integer(anchoringHelper12.getHeight()), new Integer(startTabIndex.intValue() + 55), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.FALSE, new Integer(0), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
						...
						super.addControl(factory.getControl(DateControl.class, new Object[] { control, new Integer(startControlID.intValue() + 1014), new Integer(anchoringHelper13.getX()), new Integer(anchoringHelper13.getY()), new Integer(anchoringHelper13.getWidth()), new Integer(anchoringHelper13.getHeight()), new Integer(startTabIndex.intValue() + 53), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.TRUE, null, Boolean.FALSE, null, Boolean.FALSE, null}));
						...
						super.addControl(factory.getControl(DateControl.class, new Object[] { control, new Integer(startControlID.intValue() + 1015), new Integer(anchoringHelper14.getX()), new Integer(anchoringHelper14.getY()), new Integer(anchoringHelper14.getWidth()), new Integer(anchoringHelper14.getHeight()), new Integer(startTabIndex.intValue() + 54), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.TRUE, null, Boolean.FALSE, null, Boolean.FALSE, null}));
						...
						ComboBox m_cmbInsurerCompanyTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1016), new Integer(anchoringHelper15.getX()), new Integer(anchoringHelper15.getY()), new Integer(anchoringHelper15.getWidth()), new Integer(anchoringHelper15.getHeight()), new Integer(startTabIndex.intValue() + 49), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
						...
						ComboBox m_cmbInsurarPlanTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1017), new Integer(anchoringHelper16.getX()), new Integer(anchoringHelper16.getY()), new Integer(anchoringHelper16.getWidth()), new Integer(anchoringHelper16.getHeight()), new Integer(startTabIndex.intValue() + 50), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
				...
				public static class tabSelfPayContainer extends LayerBridge
				{
					...
					public static class Group1RadioButton extends RadioButtonBridge
					{
						...
						protected void setContext(Integer startTabIndex, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize)
						{
							...
							control.addButton(0, anchoringHelper17.getX(), anchoringHelper17.getY(), anchoringHelper17.getWidth(), "Line by Line", startTabIndex.intValue() + 58);
							...
							control.addButton(1, anchoringHelper18.getX(), anchoringHelper18.getY(), anchoringHelper18.getWidth(), "Package", startTabIndex.intValue() + 56);
						}
				...
				public static class tab3rdPartyContainer extends LayerBridge
				{
					...
					protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
					{
						...
						super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1028), new Integer(anchoringHelper28.getX()), new Integer(anchoringHelper28.getY()), new Integer(anchoringHelper28.getWidth()), new Integer(anchoringHelper28.getHeight()), new Integer(startTabIndex.intValue() + 60), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.FALSE, new Integer(0), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
						...
						super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1029), new Integer(anchoringHelper29.getX()), new Integer(anchoringHelper29.getY()), new Integer(anchoringHelper29.getWidth()), new Integer(anchoringHelper29.getHeight()), new Integer(startTabIndex.intValue() + 64), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.FALSE, new Integer(0), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
						...
						super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1030), new Integer(anchoringHelper30.getX()), new Integer(anchoringHelper30.getY()), new Integer(anchoringHelper30.getWidth()), new Integer(anchoringHelper30.getHeight()), new Integer(startTabIndex.intValue() + 63), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.FALSE, new Integer(0), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
						...
						super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1031), new Integer(anchoringHelper31.getX()), new Integer(anchoringHelper31.getY()), new Integer(anchoringHelper31.getWidth()), new Integer(anchoringHelper31.getHeight()), new Integer(startTabIndex.intValue() + 62), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.FALSE, new Integer(0), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
						...
						super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1032), new Integer(anchoringHelper32.getX()), new Integer(anchoringHelper32.getY()), new Integer(anchoringHelper32.getWidth()), new Integer(anchoringHelper32.getHeight()), new Integer(startTabIndex.intValue() + 61), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.FALSE, new Integer(0), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
						...
						ComboBox m_cmbPostCodeTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1033), new Integer(anchoringHelper33.getX()), new Integer(anchoringHelper33.getY()), new Integer(anchoringHelper33.getWidth()), new Integer(anchoringHelper33.getHeight()), new Integer(startTabIndex.intValue() + 65), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
						...
						ComboBox m_cmbRelationshipTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1034), new Integer(anchoringHelper34.getX()), new Integer(anchoringHelper34.getY()), new Integer(anchoringHelper34.getWidth()), new Integer(anchoringHelper34.getHeight()), new Integer(startTabIndex.intValue() + 66), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
			...
			public static class Group1RadioButton extends RadioButtonBridge
			{
				...
				protected void setContext(Integer startTabIndex, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize)
				{
					...
					control.addButton(0, anchoringHelper42.getX(), anchoringHelper42.getY(), anchoringHelper42.getWidth(), "NHS/PCT", startTabIndex.intValue() + 48);
					...
					control.addButton(1, anchoringHelper43.getX(), anchoringHelper43.getY(), anchoringHelper43.getWidth(), "Self-Pay", startTabIndex.intValue() + 47);
					...
					control.addButton(2, anchoringHelper44.getX(), anchoringHelper44.getY(), anchoringHelper44.getWidth(), "3rd Party", startTabIndex.intValue() + 46);
					...
					control.addButton(3, anchoringHelper45.getX(), anchoringHelper45.getY(), anchoringHelper45.getWidth(), "Insurance", startTabIndex.intValue() + 45);
				}
				public void setText(Group1Enumeration option, String value)
				{
					if(option != null && option.id >= 0 && value != null)
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1049), new Integer(anchoringHelper53.getX()), new Integer(anchoringHelper53.getY()), new Integer(anchoringHelper53.getWidth()), new Integer(anchoringHelper53.getHeight()), new Integer(startTabIndex.intValue() + 71), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.FALSE, new Integer(0), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
				...
				super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1050), new Integer(anchoringHelper54.getX()), new Integer(anchoringHelper54.getY()), new Integer(anchoringHelper54.getWidth()), new Integer(anchoringHelper54.getHeight()), new Integer(startTabIndex.intValue() + 72), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.TRUE, new Integer(0), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
				...
				super.addControl(factory.getControl(DateControl.class, new Object[] { control, new Integer(startControlID.intValue() + 1051), new Integer(anchoringHelper55.getX()), new Integer(anchoringHelper55.getY()), new Integer(anchoringHelper55.getWidth()), new Integer(anchoringHelper55.getHeight()), new Integer(startTabIndex.intValue() + 70), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.TRUE, null, Boolean.FALSE, null, Boolean.FALSE, null}));
				...
				ComboBox m_cmbCardTypeTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1052), new Integer(anchoringHelper56.getX()), new Integer(anchoringHelper56.getY()), new Integer(anchoringHelper56.getWidth()), new Integer(anchoringHelper56.getHeight()), new Integer(startTabIndex.intValue() + 68), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
				...
				super.addControl(factory.getControl(IntBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1054), new Integer(anchoringHelper58.getX()), new Integer(anchoringHelper58.getY()), new Integer(anchoringHelper58.getWidth()), new Integer(anchoringHelper58.getHeight()), new Integer(startTabIndex.intValue() + 69), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.TRUE, Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, new Integer(9)}));
		...
		public static class tabContractDetailsContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1066), new Integer(anchoringHelper69.getX()), new Integer(anchoringHelper69.getY()), new Integer(anchoringHelper69.getWidth()), new Integer(anchoringHelper69.getHeight()), new Integer(startTabIndex.intValue() + 81), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "View Contract and cover Details", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
				...
				super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1067), new Integer(anchoringHelper70.getX()), new Integer(anchoringHelper70.getY()), new Integer(anchoringHelper70.getWidth()), new Integer(anchoringHelper70.getHeight()), new Integer(startTabIndex.intValue() + 80), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.FALSE, new Integer(0), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
				...
				super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1068), new Integer(anchoringHelper71.getX()), new Integer(anchoringHelper71.getY()), new Integer(anchoringHelper71.getWidth()), new Integer(anchoringHelper71.getHeight()), new Integer(startTabIndex.intValue() + 79), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.FALSE, new Integer(0), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
				...
				super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1069), new Integer(anchoringHelper72.getX()), new Integer(anchoringHelper72.getY()), new Integer(anchoringHelper72.getWidth()), new Integer(anchoringHelper72.getHeight()), new Integer(startTabIndex.intValue() + 78), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.FALSE, new Integer(0), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
				...
				super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1070), new Integer(anchoringHelper73.getX()), new Integer(anchoringHelper73.getY()), new Integer(anchoringHelper73.getWidth()), new Integer(anchoringHelper73.getHeight()), new Integer(startTabIndex.intValue() + 77), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.FALSE, new Integer(0), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
				...
				super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1071), new Integer(anchoringHelper74.getX()), new Integer(anchoringHelper74.getY()), new Integer(anchoringHelper74.getWidth()), new Integer(anchoringHelper74.getHeight()), new Integer(startTabIndex.intValue() + 76), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.FALSE, new Integer(0), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
				...
				ComboBox m_cmbPlanTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1073), new Integer(anchoringHelper76.getX()), new Integer(anchoringHelper76.getY()), new Integer(anchoringHelper76.getWidth()), new Integer(anchoringHelper76.getHeight()), new Integer(startTabIndex.intValue() + 74), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
				...
				Grid m_grdAuthorisationDetailsTemp = (Grid)factory.getControl(Grid.class, new Object[] { control, new Integer(startControlID.intValue() + 1074), new Integer(anchoringHelper77.getX()), new Integer(anchoringHelper77.getY()), new Integer(anchoringHelper77.getWidth()), new Integer(anchoringHelper77.getHeight()), new Integer(startTabIndex.intValue() + 82), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.FALSE, Boolean.FALSE, new Integer(24), Boolean.TRUE, null, Boolean.FALSE, Boolean.FALSE, new Integer(0), null, Boolean.TRUE, Boolean.TRUE});
		...
		public static class tabLetterContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				// Custom Controls
				ims.framework.CustomComponent instance1 = factory.getEmptyCustomComponent();
				RuntimeAnchoring anchoringHelper79 = new RuntimeAnchoring(designSize, runtimeSize, 0, 0, 824, 544, ims.framework.enumerations.ControlAnchoring.ALL);
				ims.framework.FormUiLogic m_ccUploadForm = loader.loadComponent(102264, appForm, startControlID * 10 + 4000, anchoringHelper79.getSize(), instance1, startTabIndex.intValue() + 98, skipContextValidation);
				//ims.framework.Control m_ccUploadControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1077), new Integer(0), new Integer(0), new Integer(824), new Integer(544), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 98), m_ccUploadForm, instance1 } );
				ims.framework.Control m_ccUploadControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1078),  new Integer(anchoringHelper79.getX()), new Integer(anchoringHelper79.getY()), new Integer(anchoringHelper79.getWidth()), new Integer(anchoringHelper79.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 98), m_ccUploadForm, instance1, Boolean.FALSE } );
		...
		public static class tabApptContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				ims.framework.FormUiLogic m_ccApptDetailForm = loader.loadComponent(134117, appForm, startControlID * 10 + 5000, anchoringHelper80.getSize(), instance1, startTabIndex.intValue() + 102, skipContextValidation);
				//ims.framework.Control m_ccApptDetailControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1079), new Integer(8), new Integer(8), new Integer(816), new Integer(552), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, new Integer(startTabIndex.intValue() + 102), m_ccApptDetailForm, instance1 } );
		...
		public static class tabJourneyContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				// Custom Controls
				ims.framework.CustomComponent instance1 = factory.getEmptyCustomComponent();
				RuntimeAnchoring anchoringHelper81 = new RuntimeAnchoring(designSize, runtimeSize, 6, 4, 816, 536, ims.framework.enumerations.ControlAnchoring.ALL);
				ims.framework.FormUiLogic m_ccPatientJourneyForm = loader.loadComponent(134276, appForm, startControlID * 10 + 6000, anchoringHelper81.getSize(), instance1, startTabIndex.intValue() + 124, skipContextValidation);
				//ims.framework.Control m_ccPatientJourneyControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1081), new Integer(6), new Integer(4), new Integer(816), new Integer(536), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 124), m_ccPatientJourneyForm, instance1 } );
				ims.framework.Control m_ccPatientJourneyControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1082),  new Integer(anchoringHelper81.getX()), new Integer(anchoringHelper81.getY()), new Integer(anchoringHelper81.getWidth()), new Integer(anchoringHelper81.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 124), m_ccPatientJourneyForm, instance1, Boolean.FALSE } );
			...
			public ims.core.forms.patientjourneycomponent.IComponent ccPatientJourney()
			{
				return (ims.core.forms.patientjourneycomponent.IComponent)((ims.framework.cn.controls.CustomComponent)super.getControl(0)).getLogic();
			}
		...
		public static class tabNotesContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				// Custom Controls
				ims.framework.CustomComponent instance1 = factory.getEmptyCustomComponent();
				RuntimeAnchoring anchoringHelper82 = new RuntimeAnchoring(designSize, runtimeSize, 8, 8, 808, 536, ims.framework.enumerations.ControlAnchoring.ALL);
				ims.framework.FormUiLogic m_ccNotesForm = loader.loadComponent(134140, appForm, startControlID * 10 + 7000, anchoringHelper82.getSize(), instance1, startTabIndex.intValue() + 126, skipContextValidation);
				//ims.framework.Control m_ccNotesControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1083), new Integer(8), new Integer(8), new Integer(808), new Integer(536), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 126), m_ccNotesForm, instance1 } );
				ims.framework.Control m_ccNotesControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1084),  new Integer(anchoringHelper82.getX()), new Integer(anchoringHelper82.getY()), new Integer(anchoringHelper82.getWidth()), new Integer(anchoringHelper82.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 126), m_ccNotesForm, instance1, Boolean.FALSE } );
		...
		public static class tabOnwardReferralContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				// Label Controls
				RuntimeAnchoring anchoringHelper83 = new RuntimeAnchoring(designSize, runtimeSize, 32, 352, 160, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
				...
				RuntimeAnchoring anchoringHelper84 = new RuntimeAnchoring(designSize, runtimeSize, 32, 288, 131, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
				...
				RuntimeAnchoring anchoringHelper85 = new RuntimeAnchoring(designSize, runtimeSize, 32, 256, 148, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
				...
				RuntimeAnchoring anchoringHelper86 = new RuntimeAnchoring(designSize, runtimeSize, 32, 320, 188, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
				...
				RuntimeAnchoring anchoringHelper87 = new RuntimeAnchoring(designSize, runtimeSize, 32, 128, 41, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
				...
				RuntimeAnchoring anchoringHelper88 = new RuntimeAnchoring(designSize, runtimeSize, 32, 88, 123, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
				...
				RuntimeAnchoring anchoringHelper89 = new RuntimeAnchoring(designSize, runtimeSize, 32, 56, 106, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
				...
				// Button Controls
				RuntimeAnchoring anchoringHelper90 = new RuntimeAnchoring(designSize, runtimeSize, 240, 520, 296, 23, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
				super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1092), new Integer(anchoringHelper90.getX()), new Integer(anchoringHelper90.getY()), new Integer(anchoringHelper90.getWidth()), new Integer(anchoringHelper90.getHeight()), new Integer(startTabIndex.intValue() + 136), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Remove from Onward Referral Requested Worklist", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
				RuntimeAnchoring anchoringHelper91 = new RuntimeAnchoring(designSize, runtimeSize, 736, 512, 75, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT);
				super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1093), new Integer(anchoringHelper91.getX()), new Integer(anchoringHelper91.getY()), new Integer(anchoringHelper91.getWidth()), new Integer(anchoringHelper91.getHeight()), new Integer(startTabIndex.intValue() + 138), ControlState.HIDDEN, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Cancel", Boolean.FALSE, null, Boolean.FALSE, Boolean.FALSE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
				RuntimeAnchoring anchoringHelper92 = new RuntimeAnchoring(designSize, runtimeSize, 656, 512, 75, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT);
				super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1094), new Integer(anchoringHelper92.getX()), new Integer(anchoringHelper92.getY()), new Integer(anchoringHelper92.getWidth()), new Integer(anchoringHelper92.getHeight()), new Integer(startTabIndex.intValue() + 137), ControlState.HIDDEN, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Save", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
				RuntimeAnchoring anchoringHelper93 = new RuntimeAnchoring(designSize, runtimeSize, 16, 512, 75, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT);
				super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1095), new Integer(anchoringHelper93.getX()), new Integer(anchoringHelper93.getY()), new Integer(anchoringHelper93.getWidth()), new Integer(anchoringHelper93.getHeight()), new Integer(startTabIndex.intValue() + 135), ControlState.ENABLED, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Edit", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		
				// TextBox Controls
				RuntimeAnchoring anchoringHelper94 = new RuntimeAnchoring(designSize, runtimeSize, 232, 128, 344, 112, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
				super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1096), new Integer(anchoringHelper94.getX()), new Integer(anchoringHelper94.getY()), new Integer(anchoringHelper94.getWidth()), new Integer(anchoringHelper94.getHeight()), new Integer(startTabIndex.intValue() + 130), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.TRUE, new Integer(2000), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
		
				// Date Time Controls
				RuntimeAnchoring anchoringHelper95 = new RuntimeAnchoring(designSize, runtimeSize, 232, 320, 176, 20, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
				super.addControl(factory.getControl(DateTimeControl.class, new Object[] { control, new Integer(startControlID.intValue() + 1097), new Integer(anchoringHelper95.getX()), new Integer(anchoringHelper95.getY()), new Integer(anchoringHelper95.getWidth()), new Integer(anchoringHelper95.getHeight()), new Integer(startTabIndex.intValue() + 133), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.TRUE, null, Boolean.FALSE, null, Boolean.FALSE, null}));
		
				// ComboBox Controls
				RuntimeAnchoring anchoringHelper96 = new RuntimeAnchoring(designSize, runtimeSize, 232, 288, 216, 20, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT);
				ComboBox m_cmbReferredIntoTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1098), new Integer(anchoringHelper96.getX()), new Integer(anchoringHelper96.getY()), new Integer(anchoringHelper96.getWidth()), new Integer(anchoringHelper96.getHeight()), new Integer(startTabIndex.intValue() + 132), ControlState.DISABLED, ControlState.ENABLED,ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT ,Boolean.TRUE, Boolean.TRUE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
				...
				RuntimeAnchoring anchoringHelper97 = new RuntimeAnchoring(designSize, runtimeSize, 232, 256, 216, 20, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT);
				ComboBox m_cmbSecondaryCareProviderTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1099), new Integer(anchoringHelper97.getX()), new Integer(anchoringHelper97.getY()), new Integer(anchoringHelper97.getWidth()), new Integer(anchoringHelper97.getHeight()), new Integer(startTabIndex.intValue() + 131), ControlState.DISABLED, ControlState.ENABLED,ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT ,Boolean.TRUE, Boolean.FALSE, SortOrder.ASCENDING, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
				...
				RuntimeAnchoring anchoringHelper100 = new RuntimeAnchoring(designSize, runtimeSize, 232, 56, 16, 16, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
				AnswerBox tmpansRequestedByGP = (AnswerBox)factory.getControl(AnswerBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1102), new Integer(anchoringHelper100.getX()), new Integer(anchoringHelper100.getY()), new Integer(anchoringHelper100.getWidth()), new Integer(anchoringHelper100.getHeight()), new Integer(startTabIndex.intValue() + 128), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "", Boolean.FALSE, Boolean.TRUE, new Integer(10), Boolean.TRUE});
		...
		protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
		{
			...
			if(startTabIndex == null)
				throw new RuntimeException("Invalid startTabIndex");
			RuntimeAnchoring anchoringHelper101 = new RuntimeAnchoring(designSize, runtimeSize, 8, 3, 832, 576, ims.framework.enumerations.ControlAnchoring.ALL);
			...
			ims.framework.utils.SizeInfo m_tabOverviewDesignSize = new ims.framework.utils.SizeInfo(832, 576);
			ims.framework.utils.SizeInfo m_tabOverviewRuntimeSize = new ims.framework.utils.SizeInfo(anchoringHelper101.getWidth(), anchoringHelper101.getHeight());
			...
			RuntimeAnchoring anchoringHelper102 = new RuntimeAnchoring(designSize, runtimeSize, 8, 3, 832, 576, ims.framework.enumerations.ControlAnchoring.ALL);
			...
			ims.framework.utils.SizeInfo m_tabDetailsDesignSize = new ims.framework.utils.SizeInfo(832, 576);
			ims.framework.utils.SizeInfo m_tabDetailsRuntimeSize = new ims.framework.utils.SizeInfo(anchoringHelper102.getWidth(), anchoringHelper102.getHeight());
			...
			RuntimeAnchoring anchoringHelper103 = new RuntimeAnchoring(designSize, runtimeSize, 8, 3, 832, 576, ims.framework.enumerations.ControlAnchoring.ALL);
			...
			ims.framework.utils.SizeInfo m_tabPayerDetailsDesignSize = new ims.framework.utils.SizeInfo(832, 576);
			ims.framework.utils.SizeInfo m_tabPayerDetailsRuntimeSize = new ims.framework.utils.SizeInfo(anchoringHelper103.getWidth(), anchoringHelper103.getHeight());
			...
			RuntimeAnchoring anchoringHelper104 = new RuntimeAnchoring(designSize, runtimeSize, 8, 3, 832, 576, ims.framework.enumerations.ControlAnchoring.ALL);
			...
			ims.framework.utils.SizeInfo m_tabContractDetailsDesignSize = new ims.framework.utils.SizeInfo(832, 576);
			ims.framework.utils.SizeInfo m_tabContractDetailsRuntimeSize = new ims.framework.utils.SizeInfo(anchoringHelper104.getWidth(), anchoringHelper104.getHeight());
			...
			RuntimeAnchoring anchoringHelper105 = new RuntimeAnchoring(designSize, runtimeSize, 8, 3, 832, 576, ims.framework.enumerations.ControlAnchoring.ALL);
			...
			ims.framework.utils.SizeInfo m_tabPresentationDesignSize = new ims.framework.utils.SizeInfo(832, 576);
			ims.framework.utils.SizeInfo m_tabPresentationRuntimeSize = new ims.framework.utils.SizeInfo(anchoringHelper105.getWidth(), anchoringHelper105.getHeight());
			...
			RuntimeAnchoring anchoringHelper106 = new RuntimeAnchoring(designSize, runtimeSize, 8, 3, 832, 576, ims.framework.enumerations.ControlAnchoring.ALL);
			...
			ims.framework.utils.SizeInfo m_tabLetterDesignSize = new ims.framework.utils.SizeInfo(832, 576);
			ims.framework.utils.SizeInfo m_tabLetterRuntimeSize = new ims.framework.utils.SizeInfo(anchoringHelper106.getWidth(), anchoringHelper106.getHeight());
			...
			RuntimeAnchoring anchoringHelper107 = new RuntimeAnchoring(designSize, runtimeSize, 8, 3, 832, 576, ims.framework.enumerations.ControlAnchoring.ALL);
			...
			ims.framework.utils.SizeInfo m_tabApptDesignSize = new ims.framework.utils.SizeInfo(832, 576);
			ims.framework.utils.SizeInfo m_tabApptRuntimeSize = new ims.framework.utils.SizeInfo(anchoringHelper107.getWidth(), anchoringHelper107.getHeight());
			...
			RuntimeAnchoring anchoringHelper108 = new RuntimeAnchoring(designSize, runtimeSize, 8, 3, 832, 576, ims.framework.enumerations.ControlAnchoring.ALL);
			...
			ims.framework.utils.SizeInfo m_tabJourneyDesignSize = new ims.framework.utils.SizeInfo(832, 576);
			ims.framework.utils.SizeInfo m_tabJourneyRuntimeSize = new ims.framework.utils.SizeInfo(anchoringHelper108.getWidth(), anchoringHelper108.getHeight());
			m_tabJourneyContainer.setContext(form, appForm, m_tabJourney, loader, form_images_local, startControlID, m_tabJourneyDesignSize, m_tabJourneyRuntimeSize, startTabIndex, skipContextValidation);
			RuntimeAnchoring anchoringHelper109 = new RuntimeAnchoring(designSize, runtimeSize, 8, 3, 832, 576, ims.framework.enumerations.ControlAnchoring.ALL);
			...
			ims.framework.utils.SizeInfo m_tabNotesDesignSize = new ims.framework.utils.SizeInfo(832, 576);
			ims.framework.utils.SizeInfo m_tabNotesRuntimeSize = new ims.framework.utils.SizeInfo(anchoringHelper109.getWidth(), anchoringHelper109.getHeight());
			...
			RuntimeAnchoring anchoringHelper110 = new RuntimeAnchoring(designSize, runtimeSize, 8, 3, 832, 576, ims.framework.enumerations.ControlAnchoring.ALL);
			...
			ims.framework.utils.SizeInfo m_tabOnwardReferralDesignSize = new ims.framework.utils.SizeInfo(832, 576);
			ims.framework.utils.SizeInfo m_tabOnwardReferralRuntimeSize = new ims.framework.utils.SizeInfo(anchoringHelper110.getWidth(), anchoringHelper110.getHeight());
		...
		{
			return (tabJourneyContainer)super.layers.get(7);
		}
		public tabNotesContainer tabNotes()
		{
			return (tabNotesContainer)super.layers.get(8);
		}
		public tabOnwardReferralContainer tabOnwardReferral()
		{
			return (tabOnwardReferralContainer)super.layers.get(9);
		}
	}
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		// Label Controls
		RuntimeAnchoring anchoringHelper111 = new RuntimeAnchoring(designSize, runtimeSize, 59, 585, 0, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		RuntimeAnchoring anchoringHelper112 = new RuntimeAnchoring(designSize, runtimeSize, 11, 585, 45, 17, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT);
		...
		// Button Controls
		RuntimeAnchoring anchoringHelper113 = new RuntimeAnchoring(designSize, runtimeSize, 308, 582, 232, 23, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1115), new Integer(anchoringHelper113.getX()), new Integer(anchoringHelper113.getY()), new Integer(anchoringHelper113.getWidth()), new Integer(anchoringHelper113.getHeight()), new Integer(startTabIndex.intValue() + 139), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Accepted on C&B", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		RuntimeAnchoring anchoringHelper114 = new RuntimeAnchoring(designSize, runtimeSize, 269, 607, 128, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT);
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1116), new Integer(anchoringHelper114.getX()), new Integer(anchoringHelper114.getY()), new Integer(anchoringHelper114.getWidth()), new Integer(anchoringHelper114.getHeight()), new Integer(startTabIndex.intValue() + 147), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Transfer of Care", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		RuntimeAnchoring anchoringHelper115 = new RuntimeAnchoring(designSize, runtimeSize, 138, 607, 128, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT);
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1117), new Integer(anchoringHelper115.getX()), new Integer(anchoringHelper115.getY()), new Integer(anchoringHelper115.getWidth()), new Integer(anchoringHelper115.getHeight()), new Integer(startTabIndex.intValue() + 146), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Request for Service", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		RuntimeAnchoring anchoringHelper116 = new RuntimeAnchoring(designSize, runtimeSize, 8, 607, 128, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT);
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1118), new Integer(anchoringHelper116.getX()), new Integer(anchoringHelper116.getY()), new Integer(anchoringHelper116.getWidth()), new Integer(anchoringHelper116.getHeight()), new Integer(startTabIndex.intValue() + 145), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Update Urgency", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		RuntimeAnchoring anchoringHelper117 = new RuntimeAnchoring(designSize, runtimeSize, 140, 607, 64, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT);
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1119), new Integer(anchoringHelper117.getX()), new Integer(anchoringHelper117.getY()), new Integer(anchoringHelper117.getWidth()), new Integer(anchoringHelper117.getHeight()), new Integer(startTabIndex.intValue() + 142), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Reject", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		RuntimeAnchoring anchoringHelper118 = new RuntimeAnchoring(designSize, runtimeSize, 207, 607, 120, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT);
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1120), new Integer(anchoringHelper118.getX()), new Integer(anchoringHelper118.getY()), new Integer(anchoringHelper118.getWidth()), new Integer(anchoringHelper118.getHeight()), new Integer(startTabIndex.intValue() + 144), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Edit Second Opinion", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		RuntimeAnchoring anchoringHelper119 = new RuntimeAnchoring(designSize, runtimeSize, 8, 607, 64, 23, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1121), new Integer(anchoringHelper119.getX()), new Integer(anchoringHelper119.getY()), new Integer(anchoringHelper119.getWidth()), new Integer(anchoringHelper119.getHeight()), new Integer(startTabIndex.intValue() + 140), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Complete", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		RuntimeAnchoring anchoringHelper120 = new RuntimeAnchoring(designSize, runtimeSize, 543, 607, 57, 23, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1122), new Integer(anchoringHelper120.getX()), new Integer(anchoringHelper120.getY()), new Integer(anchoringHelper120.getWidth()), new Integer(anchoringHelper120.getHeight()), new Integer(startTabIndex.intValue() + 150), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Link ICP", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		RuntimeAnchoring anchoringHelper121 = new RuntimeAnchoring(designSize, runtimeSize, 602, 607, 184, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT);
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1123), new Integer(anchoringHelper121.getX()), new Integer(anchoringHelper121.getY()), new Integer(anchoringHelper121.getWidth()), new Integer(anchoringHelper121.getHeight()), new Integer(startTabIndex.intValue() + 151), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Flag for Review + Review Detail", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		RuntimeAnchoring anchoringHelper122 = new RuntimeAnchoring(designSize, runtimeSize, 212, 607, 96, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT);
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1124), new Integer(anchoringHelper122.getX()), new Integer(anchoringHelper122.getY()), new Integer(anchoringHelper122.getWidth()), new Integer(anchoringHelper122.getHeight()), new Integer(startTabIndex.intValue() + 143), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Second Opinion", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		RuntimeAnchoring anchoringHelper123 = new RuntimeAnchoring(designSize, runtimeSize, 74, 607, 64, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT);
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1125), new Integer(anchoringHelper123.getX()), new Integer(anchoringHelper123.getY()), new Integer(anchoringHelper123.getWidth()), new Integer(anchoringHelper123.getHeight()), new Integer(startTabIndex.intValue() + 141), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Accept", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		RuntimeAnchoring anchoringHelper124 = new RuntimeAnchoring(designSize, runtimeSize, 789, 607, 56, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT);
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1126), new Integer(anchoringHelper124.getX()), new Integer(anchoringHelper124.getY()), new Integer(anchoringHelper124.getWidth()), new Integer(anchoringHelper124.getHeight()), new Integer(startTabIndex.intValue() + 152), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Close", Boolean.FALSE, null, Boolean.FALSE, Boolean.FALSE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		RuntimeAnchoring anchoringHelper125 = new RuntimeAnchoring(designSize, runtimeSize, 328, 607, 90, 23, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1127), new Integer(anchoringHelper125.getX()), new Integer(anchoringHelper125.getY()), new Integer(anchoringHelper125.getWidth()), new Integer(anchoringHelper125.getHeight()), new Integer(startTabIndex.intValue() + 148), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Onward Referral", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		RuntimeAnchoring anchoringHelper126 = new RuntimeAnchoring(designSize, runtimeSize, 420, 607, 120, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT);
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1128), new Integer(anchoringHelper126.getX()), new Integer(anchoringHelper126.getY()), new Integer(anchoringHelper126.getWidth()), new Integer(anchoringHelper126.getHeight()), new Integer(startTabIndex.intValue() + 149), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Record Admin Event", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
	}
	...
	public class LocalContext extends ContextBridge
	{
		...
		public LocalContext(Context context, ims.framework.FormInfo formInfo, String componentIdentifier)
		{
			...
			cxl_TransferOrRequestButtonActions = new ims.framework.ContextVariable("TransferOrRequestButtonActions", prefix + "_lv_RefMan.ReferralDetails.__internal_x_context__TransferOrRequestButtonActions_" + componentIdentifier + "");
			cxl_OpenForReferralTriage = new ims.framework.ContextVariable("OpenForReferralTriage", prefix + "_lv_RefMan.ReferralDetails.__internal_x_context__OpenForReferralTriage_" + componentIdentifier + "");
		}
		...
		public boolean getTransferOrRequestButtonActionsIsNotNull()
		{
			return !cxl_TransferOrRequestButtonActions.getValueIsNull(context);
		}
		public ims.RefMan.vo.enums.ReferralAppointmentOutcomeAction getTransferOrRequestButtonActions()
		{
			return (ims.RefMan.vo.enums.ReferralAppointmentOutcomeAction)cxl_TransferOrRequestButtonActions.getValue(context);
		}
		public void setTransferOrRequestButtonActions(ims.RefMan.vo.enums.ReferralAppointmentOutcomeAction value)
		{
			cxl_TransferOrRequestButtonActions.setValue(context, value);
		}
		private ims.framework.ContextVariable cxl_TransferOrRequestButtonActions = null;
		public boolean getOpenForReferralTriageIsNotNull()
		{
			return !cxl_OpenForReferralTriage.getValueIsNull(context);
		}
		public Boolean getOpenForReferralTriage()
		{
			return (Boolean)cxl_OpenForReferralTriage.getValue(context);
		}
		public void setOpenForReferralTriage(Boolean value)
		{
			cxl_OpenForReferralTriage.setValue(context, value);
		}
		private ims.framework.ContextVariable cxl_OpenForReferralTriage = null;
	}
	...
	private class ReportFields
	{
		...
		{
			String prefix = formInfo.getLocalVariablesPrefix();
			IReportField[] fields = new IReportField[255];
			...
			fields[146] = new ims.framework.ReportField(this.context, "_cv_RefMan.CatsReferralStatus", "BO-1096100007-STATUSDATETIME", "StatusDateTime");
			fields[147] = new ims.framework.ReportField(this.context, "_cv_RefMan.CatsReferralStatus", "BO-1096100007-AUTHORINGUSER", "AuthoringUser");
			...
			fields[150] = new ims.framework.ReportField(this.context, "_cv_RefMan.RejectionReason", "BO-1096100014-ID", "ID_ReferralReject");
			fields[151] = new ims.framework.ReportField(this.context, "_cv_RefMan.RejectionReason", "BO-1096100014-REASON", "Reason");
			fields[152] = new ims.framework.ReportField(this.context, "_cv_RefMan.RejectionReason", "BO-1096100014-REJECTIONCOMMENTS", "RejectionComments");
			fields[153] = new ims.framework.ReportField(this.context, "_cv_RefMan.RejectionReason", "BO-1096100014-WASGPCONTACTED", "WasGPContacted");
			fields[154] = new ims.framework.ReportField(this.context, "_cv_RefMan.RejectionReason", "BO-1096100014-WASPATIENTCONTACTED", "WasPatientContacted");
			fields[155] = new ims.framework.ReportField(this.context, "_cv_RefMan.ReferralNote", "BO-1096100013-ID", "ID_CorrespondenceNote");
			fields[156] = new ims.framework.ReportField(this.context, "_cv_RefMan.ReferralNote", "BO-1096100013-CARECONTEXT", "CareContext");
			fields[157] = new ims.framework.ReportField(this.context, "_cv_RefMan.ReferralNote", "BO-1096100013-RECORDINGDATETIME", "RecordingDateTime");
			fields[158] = new ims.framework.ReportField(this.context, "_cv_RefMan.ReferralNote", "BO-1096100013-NOTE", "Note");
			fields[159] = new ims.framework.ReportField(this.context, "_cv_RefMan.ReferralNote", "BO-1096100013-NOTETYPE", "NoteType");
			fields[160] = new ims.framework.ReportField(this.context, "_cv_RefMan.SecondOpinionReferralStatus", "BO-1096100007-ID", "ID_CATSReferralStatus");
			fields[161] = new ims.framework.ReportField(this.context, "_cv_RefMan.SecondOpinionReferralStatus", "BO-1096100007-REFERRALSTATUS", "ReferralStatus");
			fields[162] = new ims.framework.ReportField(this.context, "_cv_RefMan.SecondOpinionReferralStatus", "BO-1096100007-STATUSDATETIME", "StatusDateTime");
			fields[163] = new ims.framework.ReportField(this.context, "_cv_RefMan.SecondOpinionReferralStatus", "BO-1096100007-AUTHORINGUSER", "AuthoringUser");
			fields[164] = new ims.framework.ReportField(this.context, "_cv_RefMan.SecondOpinionReferralStatus", "BO-1096100007-COMMENT", "Comment");
			fields[165] = new ims.framework.ReportField(this.context, "_cv_RefMan.SecondOpinionReferralStatus", "BO-1096100007-SECONDOPINIONCATEGORY", "SecondOpinionCategory");
			fields[166] = new ims.framework.ReportField(this.context, "_cv_RefMan.CurrentServiceLiteVo", "BO-1003100032-ID", "ID_Service");
			fields[167] = new ims.framework.ReportField(this.context, "_cv_RefMan.CurrentServiceLiteVo", "BO-1003100032-SERVICENAME", "ServiceName");
			fields[168] = new ims.framework.ReportField(this.context, "_cv_RefMan.CurrentServiceLiteVo", "BO-1003100032-SERVICECATEGORY", "ServiceCategory");
			fields[169] = new ims.framework.ReportField(this.context, "_cv_RefMan.CurrentServiceLiteVo", "BO-1003100032-CANBESCHEDULED", "CanBeScheduled");
			fields[170] = new ims.framework.ReportField(this.context, "_cv_RefMan.CurrentServiceLiteVo", "BO-1003100032-SPECIALTY", "Specialty");
			fields[171] = new ims.framework.ReportField(this.context, "_cv_RefMan.CurrentServiceLiteVo", "BO-1003100032-EXPECTEDTURNAROUND", "ExpectedTurnaround");
			fields[172] = new ims.framework.ReportField(this.context, "_cv_RefMan.CurrentServiceLiteVo", "BO-1003100032-TURNAROUNDMEASURE", "TurnaroundMeasure");
			fields[173] = new ims.framework.ReportField(this.context, "_cv_RefMan.CurrentServiceLiteVo", "BO-1003100032-MATERNITYINDICATOR", "MaternityIndicator");
			fields[174] = new ims.framework.ReportField(this.context, "_cv_RefMan.CurrentServiceLiteVo", "BO-1003100032-ISACTIVE", "IsActive");
			fields[175] = new ims.framework.ReportField(this.context, "_cv_RefMan.CurrentServiceLiteVo", "BO-1003100032-ISSUBJECTTORTTCLOCK", "IsSubjectToRTTClock");
			fields[176] = new ims.framework.ReportField(this.context, "_cv_RefMan.CurrentServiceLiteVo", "BO-1003100032-DIRECTSELFREFERRALSACCEPTED", "DirectSelfReferralsAccepted");
			fields[177] = new ims.framework.ReportField(this.context, "_cv_RefMan.CurrentServiceLiteVo", "BO-1003100032-ISPREASSESSMENTCOMPLETIONEXEMPT", "IsPreAssessmentCompletionExempt");
			fields[178] = new ims.framework.ReportField(this.context, "_cv_RefMan.ChildCatsReferral", "BO-1004100035-ID", "ID_CatsReferral");
			fields[179] = new ims.framework.ReportField(this.context, "_cv_RefMan.ChildCatsReferral", "BO-1004100035-PATIENT", "Patient");
			fields[180] = new ims.framework.ReportField(this.context, "_cv_RefMan.ChildCatsReferral", "BO-1004100035-URGENCY", "Urgency");
			fields[181] = new ims.framework.ReportField(this.context, "_cv_RefMan.ChildCatsReferral", "BO-1004100035-RTTCLOCKIMPACT", "RTTClockImpact");
			fields[182] = new ims.framework.ReportField(this.context, "_cv_RefMan.ChildCatsReferral", "BO-1004100035-CREATINGAPPOINTMENT", "CreatingAppointment");
			fields[183] = new ims.framework.ReportField(this.context, "_cv_RefMan.ChildCatsReferral", "BO-1004100035-PATHWAYID", "PathwayID");
			fields[184] = new ims.framework.ReportField(this.context, "_cv_RefMan.ChildCatsReferral", "BO-1004100035-JOURNEY", "Journey");
			fields[185] = new ims.framework.ReportField(this.context, "_cv_RefMan.ChildCatsReferral", "BO-1004100035-ISCAB", "IsCAB");
			fields[186] = new ims.framework.ReportField(this.context, "_cv_RefMan.ChildCatsReferral", "BO-1004100035-CONSUPGRADEDATE", "ConsUpgradeDate");
			fields[187] = new ims.framework.ReportField(this.context, "_cv_RefMan.ChildCatsReferral", "BO-1004100035-CANCERTYPE", "CancerType");
			fields[188] = new ims.framework.ReportField(this.context, "_cv_RefMan.ChildCatsReferral", "BO-1004100035-ISEMERGENCYREFERRAL", "IsEmergencyReferral");
			fields[189] = new ims.framework.ReportField(this.context, "_cv_ICP.Service", "BO-1003100032-ID", "ID_Service");
			fields[190] = new ims.framework.ReportField(this.context, "_cv_ICP.ProcedureID", "BO-1003100019-ID", "ID_Procedure");
			fields[191] = new ims.framework.ReportField(this.context, "_cv_Scheduling.BookingService", "BO-1003100032-ID", "ID_Service");
			fields[192] = new ims.framework.ReportField(this.context, "_cv_RefMan.SelectedBookAppointmentForPrint", "BO-1055100007-ID", "ID_Booking_Appointment");
			fields[193] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralDetails.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1004100035-ID", "ID_CatsReferral");
			fields[194] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralDetails.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1004100035-CARECONTEXT", "CareContext");
			fields[195] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralDetails.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1004100035-ADDITIONALINVAPPTSSTATUS", "AdditionalInvApptsStatus");
			fields[196] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralDetails.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1004100035-HASINVESTIGATIONS", "HasInvestigations");
			fields[197] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralDetails.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1004100035-HASAPPOINTMENTS", "HasAppointments");
			fields[198] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralDetails.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1004100035-HASDOCUMENTS", "HasDocuments");
			fields[199] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralDetails.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1004100035-HASREFERRALLETTER", "HasReferralLetter");
			fields[200] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralDetails.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1004100035-ISCAB", "IsCAB");
			fields[201] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralDetails.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1004100035-HASREJECTEDINV", "HasRejectedInv");
			fields[202] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralDetails.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1004100035-ONWARDREFERRALSTATUS", "OnwardReferralStatus");
			fields[203] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralDetails.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1004100035-PROVIDERCANCELLATION", "ProviderCancellation");
			fields[204] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralDetails.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1004100035-HASCONSULTATIONDETAILS", "HasConsultationDetails");
			fields[205] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralDetails.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1004100035-DISCHARGEDATE", "DischargeDate");
			fields[206] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralDetails.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1004100035-ISFINALREPORTREQUIRED", "IsFinalReportRequired");
			fields[207] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralDetails.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1004100035-TRIAGEDATETIME", "TriageDateTime");
			fields[208] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralDetails.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1004100035-LASTAPPTARRIVEDDATE", "LastApptArrivedDate");
			fields[209] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralDetails.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1004100035-ISACCEPTEDONCAB", "IsAcceptedOnCAB");
			fields[210] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralDetails.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1004100035-ISREFERRALREJECTEDONCAB", "IsReferralRejectedOnCAB");
			fields[211] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralDetails.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1004100035-WASPATIENTREJECTIONLETTERSENT", "WasPatientRejectionLetterSent");
			fields[212] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralDetails.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1004100035-WASPATIENTPROVIDERCANCELLATIONLETTERSENT", "WasPatientProviderCancellationLetterSent");
			fields[213] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralDetails.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1004100035-REQUIRESDISCHARGEREP", "RequiresDischargeRep");
			fields[214] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralDetails.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1004100035-ISSECONDARYREPORTREQUIRED", "IsSecondaryReportRequired");
			fields[215] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralDetails.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1004100035-WASFURTHERMANAGEMENTDETAILSREVIEWED", "WasFurtherManagementDetailsReviewed");
			fields[216] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralDetails.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1004100035-ONWARDREFERRALREASON", "OnwardReferralReason");
			fields[217] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralDetails.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1004100035-DISCHARGETOGPDETAILSREVIEWSTATUS", "DischargeToGPDetailsReviewStatus");
			fields[218] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralDetails.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1004100035-ISSUITABLEFORSURGERY", "IsSuitableForSurgery");
			fields[219] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralDetails.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1004100035-ISFITFORSURGERY", "IsFitForSurgery");
			fields[220] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralDetails.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1004100035-ISAWAITINGCLINICALINFO", "IsAwaitingClinicalInfo");
			fields[221] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralDetails.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1004100035-ISACTIVEMONITORAPPTREQUIRED", "IsActiveMonitorApptRequired");
			fields[222] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralDetails.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1004100035-CATSREPORTSENTDATE", "CATSReportSentDate");
			fields[223] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralDetails.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1004100035-ENDOFCAREDATE", "EndOfCareDate");
			fields[224] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralDetails.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1004100035-PROCEDUREFORPOSTOPREVIEW", "ProcedureForPostOpReview");
			fields[225] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralDetails.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1004100035-REFERRALCATEGORY", "ReferralCategory");
			fields[226] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralDetails.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1004100035-ISONWARDREFERRALTRIAGE", "IsOnwardReferralTriage");
			fields[227] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralDetails.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1004100035-URGENCY", "Urgency");
			fields[228] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralDetails.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1004100035-PATHWAYID", "PathwayID");
			fields[229] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralDetails.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1004100035-RTTCLOCKIMPACT", "RTTClockImpact");
			fields[230] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralDetails.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1004100035-CONSUPGRADEDATE", "ConsUpgradeDate");
			fields[231] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralDetails.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1004100035-CANCERTYPE", "CancerType");
			fields[232] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralDetails.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1004100035-EPISODEOFCARE", "EpisodeOfCare");
			fields[233] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralDetails.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1004100035-CURRENT31TARGETDATE", "Current31TargetDate");
			fields[234] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralDetails.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1004100035-CURRENT62TARGETDATE", "Current62TargetDate");
			fields[235] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralDetails.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1004100035-PATIENTCATEGORY", "PatientCategory");
			fields[236] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralDetails.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1004100035-ISEMERGENCYREFERRAL", "IsEmergencyReferral");
			fields[237] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralDetails.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1004100035-MANUALLYMARKEDASNOTRTTIMPACT", "ManuallyMarkedAsNotRTTImpact");
			fields[238] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralDetails.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1004100035-CHANGECBAPPOINTMENT", "ChangeCBAppointment");
			fields[239] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralDetails.__internal_x_context__WorkAllocation_" + componentIdentifier, "BO-1096100033-ID", "ID_WorkAllocation");
			fields[240] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralDetails.__internal_x_context__WorkAllocation_" + componentIdentifier, "BO-1096100033-CATSREFERRAL", "CatsReferral");
			fields[241] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralDetails.__internal_x_context__WorkAllocation_" + componentIdentifier, "BO-1096100033-DATEALLOCATED", "DateAllocated");
			fields[242] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralDetails.__internal_x_context__WorkAllocation_" + componentIdentifier, "BO-1096100033-COMPLETEDDATETIME", "CompletedDateTime");
			fields[243] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralDetails.__internal_x_context__WorkAllocation_" + componentIdentifier, "BO-1096100033-COMPLETEDBY", "CompletedBy");
			fields[244] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralDetails.__internal_x_context__WorkAllocation_" + componentIdentifier, "BO-1096100033-UNALLOCATEDBY", "UnallocatedBy");
			fields[245] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralDetails.__internal_x_context__WorkAllocation_" + componentIdentifier, "BO-1096100033-UNALLOCATEDDATE", "UnallocatedDate");
			fields[246] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralDetails.__internal_x_context__WorkAllocation_" + componentIdentifier, "BO-1096100033-REFERRALSTATUS", "ReferralStatus");
			fields[247] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralDetails.__internal_x_context__OnwardReferral_" + componentIdentifier, "BO-1096100055-ID", "ID_OnwardReferralFromTriage");
			fields[248] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralDetails.__internal_x_context__OnwardReferral_" + componentIdentifier, "BO-1096100055-CATSREFERRAL", "CatsReferral");
			fields[249] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralDetails.__internal_x_context__OnwardReferral_" + componentIdentifier, "BO-1096100055-REFERREDDATE", "ReferredDate");
			fields[250] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralDetails.__internal_x_context__OnwardReferral_" + componentIdentifier, "BO-1096100055-REQUESTEDBYGP", "RequestedByGP");
			fields[251] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralDetails.__internal_x_context__OnwardReferral_" + componentIdentifier, "BO-1096100055-AGREEWITHDECISION", "AgreeWithDecision");
			fields[252] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralDetails.__internal_x_context__OnwardReferral_" + componentIdentifier, "BO-1096100055-NOTES", "Notes");
			fields[253] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralDetails.__internal_x_context__OnwardReferral_" + componentIdentifier, "BO-1096100055-SERVICEREFERREDINTO", "ServiceReferredInto");
			fields[254] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralDetails.__internal_x_context__OnwardReferral_" + componentIdentifier, "BO-1096100055-REFERRALCOMPLETE", "ReferralComplete");
			return fields;
		}
