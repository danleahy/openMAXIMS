...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_RefMan.PatientMedication", "_cv_RefMan.DrugsAlreadyAddedToPrescription" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_RefMan.Medications.__internal_x_context__" + String.valueOf(getFormId());
	}
