...
public class GenForm extends FormBridge
{
	...
	public static class lyrLayer extends Layer
	{
		...
		public static class tabReviewContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				ims.framework.FormUiLogic m_ccReviewByForm = loader.loadComponent(102256, appForm, startControlID * 10 + 1000, anchoringHelper10.getSize(), instance1, startTabIndex.intValue() + 6, skipContextValidation);
				//ims.framework.Control m_ccReviewByControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1009), new Integer(160), new Integer(16), new Integer(256), new Integer(20), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFT, new Integer(startTabIndex.intValue() + 6), m_ccReviewByForm, instance1 } );
				ims.framework.Control m_ccReviewByControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1010),  new Integer(anchoringHelper10.getX()), new Integer(anchoringHelper10.getY()), new Integer(anchoringHelper10.getWidth()), new Integer(anchoringHelper10.getHeight()), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFT, new Integer(startTabIndex.intValue() + 6), m_ccReviewByForm, instance1, Boolean.FALSE } );
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1020), new Integer(anchoringHelper20.getX()), new Integer(anchoringHelper20.getY()), new Integer(anchoringHelper20.getWidth()), new Integer(anchoringHelper20.getHeight()), new Integer(startTabIndex.intValue() + 11), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Edit", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		RuntimeAnchoring anchoringHelper21 = new RuntimeAnchoring(designSize, runtimeSize, 279, 248, 75, 23, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		RuntimeAnchoring anchoringHelper23 = new RuntimeAnchoring(designSize, runtimeSize, 550, 248, 75, 23, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		RuntimeAnchoring anchoringHelper24 = new RuntimeAnchoring(designSize, runtimeSize, 470, 248, 75, 23, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1024), new Integer(anchoringHelper24.getX()), new Integer(anchoringHelper24.getY()), new Integer(anchoringHelper24.getWidth()), new Integer(anchoringHelper24.getHeight()), new Integer(startTabIndex.intValue() + 13), ControlState.HIDDEN, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Save", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
	}
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralReviewDetails.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1096100019-ID", "ID_ReviewReferralDetail");
			fields[145] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralReviewDetails.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1096100019-REVIEWTYPE", "ReviewType");
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralReviewDetails.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1096100019-REASONNOTES", "ReasonNotes");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralReviewDetails.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1096100019-REVIEWEDDATE", "ReviewedDate");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralReviewDetails.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1096100019-REVIEWNOTES", "ReviewNotes");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralReviewDetails.__internal_x_context__CurrectReferral_" + componentIdentifier, "BO-1004100035-ID", "ID_CatsReferral");
			return fields;
		}
