...
public class Logic extends BaseLogic
{
	...
	private void initialize() 
	{
		...
		//WDEV-20556 - Commented out, Code to  populate combo changed below.
...
//		}
		...
		if (form.getGlobalContext().RefMan.getCatsReferralIsNotNull())
		{
			...
			if (servicesColl != null && servicesColl.size() > 0)
			{
				...
				{
					if (!serviceShortVo.getID_Service().equals(form.getGlobalContext().RefMan.getCurrentServiceLiteVo().getID_Service()))
					{
						form.cmbService().newRow(serviceShortVo, serviceShortVo.getServiceName());
					}
				}
			}
		}
...
//		ServiceLiteVoCollection services = domain.listServicesByContract(form.getGlobalContext().RefMan.getCatsReferral().get);
//				//form.cmbContract().getValue());
//		if (services != null)
//		{
