...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_RefMan.CurrentServiceLiteVo" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_RefMan.ChangeServiceDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
	...
	{
		return "Images/RefMan/change_service_48.png";
	}
}
