...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "PatientElectiveListAndTCIForCancellationDialog";
	}
	public int getWidth()
	{
		return 816;
	...
	{
		return new String[] { "_cv_RefMan.PatientElectiveListsForCancellationDialog" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_RefMan.PatientElectiveListAndTCIForCancellationDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
