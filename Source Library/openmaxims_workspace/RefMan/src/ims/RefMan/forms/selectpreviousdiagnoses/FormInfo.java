...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "SelectPreviousDiagnoses";
	}
	public int getWidth()
	{
		return 840;
	...
	{
		return new String[] { "_cv_RefMan.SelectedPatientDiagnosisListVoCollection" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_RefMan.SelectPreviousDiagnoses.__internal_x_context__" + String.valueOf(getFormId());
	}
