...
public class GenForm extends FormBridge
{
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.SelectPreviousDiagnoses.__internal_x_context__CurrentCareContext_" + componentIdentifier, "BO-1004100019-ID", "ID_CareContext");
			fields[145] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.SelectPreviousDiagnoses.__internal_x_context__CurrentCareContext_" + componentIdentifier, "BO-1004100019-CONTEXT", "Context");
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.SelectPreviousDiagnoses.__internal_x_context__CurrentCareContext_" + componentIdentifier, "BO-1004100019-ORDERINGHOSPITAL", "OrderingHospital");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.SelectPreviousDiagnoses.__internal_x_context__CurrentCareContext_" + componentIdentifier, "BO-1004100019-ESTIMATEDDISCHARGEDATE", "EstimatedDischargeDate");
			return fields;
		}
