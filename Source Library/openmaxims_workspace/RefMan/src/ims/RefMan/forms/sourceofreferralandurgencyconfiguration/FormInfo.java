...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "SourceOfReferralAndUrgencyConfiguration";
	}
	public int getWidth()
	{
		return 848;
	...
	{
		return "_lv_RefMan.SourceOfReferralAndUrgencyConfiguration.__internal_x_context__" + String.valueOf(getFormId());
	}
