...
public class GenForm extends FormBridge
{
	...
	public static class lyrPageLayer extends Layer
	{
		...
		public static class tabPageDemographicsContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				ims.framework.FormUiLogic m_ccDemographicsForm = loader.loadComponent(134124, appForm, startControlID * 10 + 2000, anchoringHelper2.getSize(), instance1, startTabIndex.intValue() + 17, skipContextValidation);
				//ims.framework.Control m_ccDemographicsControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1002), new Integer(0), new Integer(0), new Integer(824), new Integer(558), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 17), m_ccDemographicsForm, instance1 } );
				ims.framework.Control m_ccDemographicsControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1003),  new Integer(anchoringHelper2.getX()), new Integer(anchoringHelper2.getY()), new Integer(anchoringHelper2.getWidth()), new Integer(anchoringHelper2.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 17), m_ccDemographicsForm, instance1, Boolean.FALSE } );
		...
		public static class tabPageReferralContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				// Custom Controls
				ims.framework.CustomComponent instance1 = factory.getEmptyCustomComponent();
				RuntimeAnchoring anchoringHelper3 = new RuntimeAnchoring(designSize, runtimeSize, 8, 0, 809, 584, ims.framework.enumerations.ControlAnchoring.ALL);
				ims.framework.FormUiLogic m_ccReferralDetailsForm = loader.loadComponent(134118, appForm, startControlID * 10 + 3000, anchoringHelper3.getSize(), instance1, startTabIndex.intValue() + 59, skipContextValidation);
				//ims.framework.Control m_ccReferralDetailsControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1004), new Integer(8), new Integer(0), new Integer(809), new Integer(584), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 59), m_ccReferralDetailsForm, instance1 } );
				ims.framework.Control m_ccReferralDetailsControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1005),  new Integer(anchoringHelper3.getX()), new Integer(anchoringHelper3.getY()), new Integer(anchoringHelper3.getWidth()), new Integer(anchoringHelper3.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 59), m_ccReferralDetailsForm, instance1, Boolean.FALSE } );
		...
		public static class tabPayorContainer extends LayerBridge
		{
			...
			public static class Group1RadioButton extends RadioButtonBridge
			{
				...
				protected void setContext(Integer startTabIndex, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize)
				{
					...
					control.addButton(0, anchoringHelper44.getX(), anchoringHelper44.getY(), anchoringHelper44.getWidth(), "Insurance", startTabIndex.intValue() + 112);
					...
					control.addButton(1, anchoringHelper45.getX(), anchoringHelper45.getY(), anchoringHelper45.getWidth(), "NHS/PCT", startTabIndex.intValue() + 110);
					...
					control.addButton(2, anchoringHelper46.getX(), anchoringHelper46.getY(), anchoringHelper46.getWidth(), "Self-Pay", startTabIndex.intValue() + 109);
					...
					control.addButton(3, anchoringHelper47.getX(), anchoringHelper47.getY(), anchoringHelper47.getWidth(), "3rd Party", startTabIndex.intValue() + 108);
				}
				public void setText(Group1Enumeration option, String value)
				{
					if(option != null && option.id >= 0 && value != null)
		...
		public static class tabPageLetterContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				ims.framework.FormUiLogic m_ccUploadDocForm = loader.loadComponent(102264, appForm, startControlID * 10 + 4000, anchoringHelper80.getSize(), instance1, startTabIndex.intValue() + 100, skipContextValidation);
				//ims.framework.Control m_ccUploadDocControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1078), new Integer(8), new Integer(8), new Integer(808), new Integer(546), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 100), m_ccUploadDocForm, instance1 } );
				ims.framework.Control m_ccUploadDocControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1079),  new Integer(anchoringHelper80.getX()), new Integer(anchoringHelper80.getY()), new Integer(anchoringHelper80.getWidth()), new Integer(anchoringHelper80.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 100), m_ccUploadDocForm, instance1, Boolean.FALSE } );
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1086), new Integer(anchoringHelper87.getX()), new Integer(anchoringHelper87.getY()), new Integer(anchoringHelper87.getWidth()), new Integer(anchoringHelper87.getHeight()), new Integer(startTabIndex.intValue() + 104), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "New", Boolean.TRUE, null, Boolean.FALSE, Boolean.FALSE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1087), new Integer(anchoringHelper88.getX()), new Integer(anchoringHelper88.getY()), new Integer(anchoringHelper88.getWidth()), new Integer(anchoringHelper88.getHeight()), new Integer(startTabIndex.intValue() + 105), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Edit", Boolean.TRUE, null, Boolean.FALSE, Boolean.FALSE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1089), new Integer(anchoringHelper90.getX()), new Integer(anchoringHelper90.getY()), new Integer(anchoringHelper90.getWidth()), new Integer(anchoringHelper90.getHeight()), new Integer(startTabIndex.intValue() + 107), ControlState.HIDDEN, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Cancel", Boolean.FALSE, null, Boolean.FALSE, Boolean.FALSE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
	}
	...
	public class LocalContext extends ContextBridge
	{
		...
		public LocalContext(Context context, ims.framework.FormInfo formInfo, String componentIdentifier)
		{
			...
			cxl_CancerTypeConfig = new ims.framework.ContextVariable("CancerTypeConfig", prefix + "_lv_RefMan.ReferralWizard.__internal_x_context__CancerTypeConfig_" + componentIdentifier + "");
			cxl_isCreatingReferral = new ims.framework.ContextVariable("isCreatingReferral", prefix + "_lv_RefMan.ReferralWizard.__internal_x_context__isCreatingReferral_" + componentIdentifier + "");
		}
		...
		public boolean getisCreatingReferralIsNotNull()
		{
			return !cxl_isCreatingReferral.getValueIsNull(context);
		}
		public Boolean getisCreatingReferral()
		{
			return (Boolean)cxl_isCreatingReferral.getValue(context);
		}
		public void setisCreatingReferral(Boolean value)
		{
			cxl_isCreatingReferral.setValue(context, value);
		}
		private ims.framework.ContextVariable cxl_isCreatingReferral = null;
	}
	...
	private class ReportFields
	{
		...
		{
			String prefix = formInfo.getLocalVariablesPrefix();
			IReportField[] fields = new IReportField[275];
			...
			fields[166] = new ims.framework.ReportField(this.context, "_cv_Admin.Practice", "BO-1007100003-ID", "ID_Organisation");
			fields[167] = new ims.framework.ReportField(this.context, "_cv_Admin.Practice", "BO-1007100003-NAME", "Name");
			fields[168] = new ims.framework.ReportField(this.context, "_cv_Admin.Practice", "BO-1007100003-TYPE", "Type");
			fields[169] = new ims.framework.ReportField(this.context, "_cv_Admin.Practice", "BO-1007100003-ISACTIVE", "IsActive");
			fields[170] = new ims.framework.ReportField(this.context, "_cv_Admin.Practice", "BO-1007100003-COMMENT", "Comment");
			fields[171] = new ims.framework.ReportField(this.context, "_cv_Admin.Practice", "BO-1007100003-PCTCODE", "PctCode");
			fields[172] = new ims.framework.ReportField(this.context, "_cv_RefMan.CatsReferralWizard", "BO-1004100035-ID", "ID_CatsReferral");
			fields[173] = new ims.framework.ReportField(this.context, "_cv_RefMan.CatsReferralWizard", "BO-1004100035-CARECONTEXT", "CareContext");
			fields[174] = new ims.framework.ReportField(this.context, "_cv_RefMan.CatsReferralWizard", "BO-1004100035-ADDITIONALINVAPPTSSTATUS", "AdditionalInvApptsStatus");
			fields[175] = new ims.framework.ReportField(this.context, "_cv_RefMan.CatsReferralWizard", "BO-1004100035-HASINVESTIGATIONS", "HasInvestigations");
			fields[176] = new ims.framework.ReportField(this.context, "_cv_RefMan.CatsReferralWizard", "BO-1004100035-HASAPPOINTMENTS", "HasAppointments");
			fields[177] = new ims.framework.ReportField(this.context, "_cv_RefMan.CatsReferralWizard", "BO-1004100035-HASDOCUMENTS", "HasDocuments");
			fields[178] = new ims.framework.ReportField(this.context, "_cv_RefMan.CatsReferralWizard", "BO-1004100035-HASREFERRALLETTER", "HasReferralLetter");
			fields[179] = new ims.framework.ReportField(this.context, "_cv_RefMan.CatsReferralWizard", "BO-1004100035-ISCAB", "IsCAB");
			fields[180] = new ims.framework.ReportField(this.context, "_cv_RefMan.CatsReferralWizard", "BO-1004100035-HASREJECTEDINV", "HasRejectedInv");
			fields[181] = new ims.framework.ReportField(this.context, "_cv_RefMan.CatsReferralWizard", "BO-1004100035-ONWARDREFERRALSTATUS", "OnwardReferralStatus");
			fields[182] = new ims.framework.ReportField(this.context, "_cv_RefMan.CatsReferralWizard", "BO-1004100035-PROVIDERCANCELLATION", "ProviderCancellation");
			fields[183] = new ims.framework.ReportField(this.context, "_cv_RefMan.CatsReferralWizard", "BO-1004100035-HASCONSULTATIONDETAILS", "HasConsultationDetails");
			fields[184] = new ims.framework.ReportField(this.context, "_cv_RefMan.CatsReferralWizard", "BO-1004100035-DISCHARGEDATE", "DischargeDate");
			fields[185] = new ims.framework.ReportField(this.context, "_cv_RefMan.CatsReferralWizard", "BO-1004100035-ISFINALREPORTREQUIRED", "IsFinalReportRequired");
			fields[186] = new ims.framework.ReportField(this.context, "_cv_RefMan.CatsReferralWizard", "BO-1004100035-TRIAGEDATETIME", "TriageDateTime");
			fields[187] = new ims.framework.ReportField(this.context, "_cv_RefMan.CatsReferralWizard", "BO-1004100035-LASTAPPTARRIVEDDATE", "LastApptArrivedDate");
			fields[188] = new ims.framework.ReportField(this.context, "_cv_RefMan.CatsReferralWizard", "BO-1004100035-ISACCEPTEDONCAB", "IsAcceptedOnCAB");
			fields[189] = new ims.framework.ReportField(this.context, "_cv_RefMan.CatsReferralWizard", "BO-1004100035-ISREFERRALREJECTEDONCAB", "IsReferralRejectedOnCAB");
			fields[190] = new ims.framework.ReportField(this.context, "_cv_RefMan.CatsReferralWizard", "BO-1004100035-WASPATIENTREJECTIONLETTERSENT", "WasPatientRejectionLetterSent");
			fields[191] = new ims.framework.ReportField(this.context, "_cv_RefMan.CatsReferralWizard", "BO-1004100035-WASPATIENTPROVIDERCANCELLATIONLETTERSENT", "WasPatientProviderCancellationLetterSent");
			fields[192] = new ims.framework.ReportField(this.context, "_cv_RefMan.CatsReferralWizard", "BO-1004100035-REQUIRESDISCHARGEREP", "RequiresDischargeRep");
			fields[193] = new ims.framework.ReportField(this.context, "_cv_RefMan.CatsReferralWizard", "BO-1004100035-ISSECONDARYREPORTREQUIRED", "IsSecondaryReportRequired");
			fields[194] = new ims.framework.ReportField(this.context, "_cv_RefMan.CatsReferralWizard", "BO-1004100035-WASFURTHERMANAGEMENTDETAILSREVIEWED", "WasFurtherManagementDetailsReviewed");
			fields[195] = new ims.framework.ReportField(this.context, "_cv_RefMan.CatsReferralWizard", "BO-1004100035-ONWARDREFERRALREASON", "OnwardReferralReason");
			fields[196] = new ims.framework.ReportField(this.context, "_cv_RefMan.CatsReferralWizard", "BO-1004100035-DISCHARGETOGPDETAILSREVIEWSTATUS", "DischargeToGPDetailsReviewStatus");
			fields[197] = new ims.framework.ReportField(this.context, "_cv_RefMan.CatsReferralWizard", "BO-1004100035-ISSUITABLEFORSURGERY", "IsSuitableForSurgery");
			fields[198] = new ims.framework.ReportField(this.context, "_cv_RefMan.CatsReferralWizard", "BO-1004100035-ISFITFORSURGERY", "IsFitForSurgery");
			fields[199] = new ims.framework.ReportField(this.context, "_cv_RefMan.CatsReferralWizard", "BO-1004100035-ISAWAITINGCLINICALINFO", "IsAwaitingClinicalInfo");
			fields[200] = new ims.framework.ReportField(this.context, "_cv_RefMan.CatsReferralWizard", "BO-1004100035-ISACTIVEMONITORAPPTREQUIRED", "IsActiveMonitorApptRequired");
			fields[201] = new ims.framework.ReportField(this.context, "_cv_RefMan.CatsReferralWizard", "BO-1004100035-CATSREPORTSENTDATE", "CATSReportSentDate");
			fields[202] = new ims.framework.ReportField(this.context, "_cv_RefMan.CatsReferralWizard", "BO-1004100035-ENDOFCAREDATE", "EndOfCareDate");
			fields[203] = new ims.framework.ReportField(this.context, "_cv_RefMan.CatsReferralWizard", "BO-1004100035-PROCEDUREFORPOSTOPREVIEW", "ProcedureForPostOpReview");
			fields[204] = new ims.framework.ReportField(this.context, "_cv_RefMan.CatsReferralWizard", "BO-1004100035-REFERRALCATEGORY", "ReferralCategory");
			fields[205] = new ims.framework.ReportField(this.context, "_cv_RefMan.CatsReferralWizard", "BO-1004100035-ISONWARDREFERRALTRIAGE", "IsOnwardReferralTriage");
			fields[206] = new ims.framework.ReportField(this.context, "_cv_RefMan.CatsReferralWizard", "BO-1004100035-URGENCY", "Urgency");
			fields[207] = new ims.framework.ReportField(this.context, "_cv_RefMan.CatsReferralWizard", "BO-1004100035-PATHWAYID", "PathwayID");
			fields[208] = new ims.framework.ReportField(this.context, "_cv_RefMan.CatsReferralWizard", "BO-1004100035-RTTCLOCKIMPACT", "RTTClockImpact");
			fields[209] = new ims.framework.ReportField(this.context, "_cv_RefMan.CatsReferralWizard", "BO-1004100035-CONSUPGRADEDATE", "ConsUpgradeDate");
			fields[210] = new ims.framework.ReportField(this.context, "_cv_RefMan.CatsReferralWizard", "BO-1004100035-CANCERTYPE", "CancerType");
			fields[211] = new ims.framework.ReportField(this.context, "_cv_RefMan.CatsReferralWizard", "BO-1004100035-EPISODEOFCARE", "EpisodeOfCare");
			fields[212] = new ims.framework.ReportField(this.context, "_cv_RefMan.CatsReferralWizard", "BO-1004100035-CURRENT31TARGETDATE", "Current31TargetDate");
			fields[213] = new ims.framework.ReportField(this.context, "_cv_RefMan.CatsReferralWizard", "BO-1004100035-CURRENT62TARGETDATE", "Current62TargetDate");
			fields[214] = new ims.framework.ReportField(this.context, "_cv_RefMan.CatsReferralWizard", "BO-1004100035-PATIENTCATEGORY", "PatientCategory");
			fields[215] = new ims.framework.ReportField(this.context, "_cv_RefMan.CatsReferralWizard", "BO-1004100035-ISEMERGENCYREFERRAL", "IsEmergencyReferral");
			fields[216] = new ims.framework.ReportField(this.context, "_cv_RefMan.CatsReferralWizard", "BO-1004100035-MANUALLYMARKEDASNOTRTTIMPACT", "ManuallyMarkedAsNotRTTImpact");
			fields[217] = new ims.framework.ReportField(this.context, "_cv_RefMan.CatsReferralWizard", "BO-1004100035-CHANGECBAPPOINTMENT", "ChangeCBAppointment");
			fields[218] = new ims.framework.ReportField(this.context, "_cv_RefMan.ReferralTransfer", "BO-1096100070-ID", "ID_ReferralTransfer");
			fields[219] = new ims.framework.ReportField(this.context, "_cv_RefMan.ReferralTransfer", "BO-1096100070-OTHERPATIENTNUMBER", "OtherPatientNumber");
			fields[220] = new ims.framework.ReportField(this.context, "_cv_RefMan.ReferralTransfer", "BO-1096100070-OTHERORGANISATIONCODE", "OTherOrganisationCode");
			fields[221] = new ims.framework.ReportField(this.context, "_cv_RefMan.ReferralTransfer", "BO-1096100070-REFERRINGORGANISATIONCODE", "ReferringOrganisationCode");
			fields[222] = new ims.framework.ReportField(this.context, "_cv_RefMan.ReferralTransfer", "BO-1096100070-PATHWAYID", "PathwayID");
			fields[223] = new ims.framework.ReportField(this.context, "_cv_RefMan.ReferralTransfer", "BO-1096100070-RTTSTARTDATE", "RTTStartDate");
			fields[224] = new ims.framework.ReportField(this.context, "_cv_RefMan.ReferralTransfer", "BO-1096100070-RTTSTATUSDATE", "RTTStatusDate");
			fields[225] = new ims.framework.ReportField(this.context, "_cv_RefMan.PatientsGP", "BO-1006100001-ID", "ID_Gp");
			fields[226] = new ims.framework.ReportField(this.context, "_cv_RefMan.PatientsGP", "BO-1006100001-STATUS", "Status");
			fields[227] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralWizard.__internal_x_context__Record_" + componentIdentifier, "BO-1004100035-ID", "ID_CatsReferral");
			fields[228] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralWizard.__internal_x_context__Record_" + componentIdentifier, "BO-1004100035-CARECONTEXT", "CareContext");
			fields[229] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralWizard.__internal_x_context__Record_" + componentIdentifier, "BO-1004100035-ADDITIONALINVAPPTSSTATUS", "AdditionalInvApptsStatus");
			fields[230] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralWizard.__internal_x_context__Record_" + componentIdentifier, "BO-1004100035-HASINVESTIGATIONS", "HasInvestigations");
			fields[231] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralWizard.__internal_x_context__Record_" + componentIdentifier, "BO-1004100035-HASAPPOINTMENTS", "HasAppointments");
			fields[232] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralWizard.__internal_x_context__Record_" + componentIdentifier, "BO-1004100035-HASDOCUMENTS", "HasDocuments");
			fields[233] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralWizard.__internal_x_context__Record_" + componentIdentifier, "BO-1004100035-HASREFERRALLETTER", "HasReferralLetter");
			fields[234] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralWizard.__internal_x_context__Record_" + componentIdentifier, "BO-1004100035-ISCAB", "IsCAB");
			fields[235] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralWizard.__internal_x_context__Record_" + componentIdentifier, "BO-1004100035-HASREJECTEDINV", "HasRejectedInv");
			fields[236] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralWizard.__internal_x_context__Record_" + componentIdentifier, "BO-1004100035-ONWARDREFERRALSTATUS", "OnwardReferralStatus");
			fields[237] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralWizard.__internal_x_context__Record_" + componentIdentifier, "BO-1004100035-PROVIDERCANCELLATION", "ProviderCancellation");
			fields[238] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralWizard.__internal_x_context__Record_" + componentIdentifier, "BO-1004100035-HASCONSULTATIONDETAILS", "HasConsultationDetails");
			fields[239] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralWizard.__internal_x_context__Record_" + componentIdentifier, "BO-1004100035-DISCHARGEDATE", "DischargeDate");
			fields[240] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralWizard.__internal_x_context__Record_" + componentIdentifier, "BO-1004100035-ISFINALREPORTREQUIRED", "IsFinalReportRequired");
			fields[241] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralWizard.__internal_x_context__Record_" + componentIdentifier, "BO-1004100035-TRIAGEDATETIME", "TriageDateTime");
			fields[242] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralWizard.__internal_x_context__Record_" + componentIdentifier, "BO-1004100035-LASTAPPTARRIVEDDATE", "LastApptArrivedDate");
			fields[243] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralWizard.__internal_x_context__Record_" + componentIdentifier, "BO-1004100035-ISACCEPTEDONCAB", "IsAcceptedOnCAB");
			fields[244] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralWizard.__internal_x_context__Record_" + componentIdentifier, "BO-1004100035-ISREFERRALREJECTEDONCAB", "IsReferralRejectedOnCAB");
			fields[245] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralWizard.__internal_x_context__Record_" + componentIdentifier, "BO-1004100035-WASPATIENTREJECTIONLETTERSENT", "WasPatientRejectionLetterSent");
			fields[246] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralWizard.__internal_x_context__Record_" + componentIdentifier, "BO-1004100035-WASPATIENTPROVIDERCANCELLATIONLETTERSENT", "WasPatientProviderCancellationLetterSent");
			fields[247] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralWizard.__internal_x_context__Record_" + componentIdentifier, "BO-1004100035-REQUIRESDISCHARGEREP", "RequiresDischargeRep");
			fields[248] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralWizard.__internal_x_context__Record_" + componentIdentifier, "BO-1004100035-ISSECONDARYREPORTREQUIRED", "IsSecondaryReportRequired");
			fields[249] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralWizard.__internal_x_context__Record_" + componentIdentifier, "BO-1004100035-WASFURTHERMANAGEMENTDETAILSREVIEWED", "WasFurtherManagementDetailsReviewed");
			fields[250] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralWizard.__internal_x_context__Record_" + componentIdentifier, "BO-1004100035-ONWARDREFERRALREASON", "OnwardReferralReason");
			fields[251] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralWizard.__internal_x_context__Record_" + componentIdentifier, "BO-1004100035-DISCHARGETOGPDETAILSREVIEWSTATUS", "DischargeToGPDetailsReviewStatus");
			fields[252] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralWizard.__internal_x_context__Record_" + componentIdentifier, "BO-1004100035-ISSUITABLEFORSURGERY", "IsSuitableForSurgery");
			fields[253] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralWizard.__internal_x_context__Record_" + componentIdentifier, "BO-1004100035-ISFITFORSURGERY", "IsFitForSurgery");
			fields[254] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralWizard.__internal_x_context__Record_" + componentIdentifier, "BO-1004100035-ISAWAITINGCLINICALINFO", "IsAwaitingClinicalInfo");
			fields[255] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralWizard.__internal_x_context__Record_" + componentIdentifier, "BO-1004100035-ISACTIVEMONITORAPPTREQUIRED", "IsActiveMonitorApptRequired");
			fields[256] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralWizard.__internal_x_context__Record_" + componentIdentifier, "BO-1004100035-CATSREPORTSENTDATE", "CATSReportSentDate");
			fields[257] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralWizard.__internal_x_context__Record_" + componentIdentifier, "BO-1004100035-ENDOFCAREDATE", "EndOfCareDate");
			fields[258] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralWizard.__internal_x_context__Record_" + componentIdentifier, "BO-1004100035-PROCEDUREFORPOSTOPREVIEW", "ProcedureForPostOpReview");
			fields[259] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralWizard.__internal_x_context__Record_" + componentIdentifier, "BO-1004100035-REFERRALCATEGORY", "ReferralCategory");
			fields[260] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralWizard.__internal_x_context__Record_" + componentIdentifier, "BO-1004100035-ISONWARDREFERRALTRIAGE", "IsOnwardReferralTriage");
			fields[261] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralWizard.__internal_x_context__Record_" + componentIdentifier, "BO-1004100035-URGENCY", "Urgency");
			fields[262] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralWizard.__internal_x_context__Record_" + componentIdentifier, "BO-1004100035-PATHWAYID", "PathwayID");
			fields[263] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralWizard.__internal_x_context__Record_" + componentIdentifier, "BO-1004100035-RTTCLOCKIMPACT", "RTTClockImpact");
			fields[264] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralWizard.__internal_x_context__Record_" + componentIdentifier, "BO-1004100035-CONSUPGRADEDATE", "ConsUpgradeDate");
			fields[265] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralWizard.__internal_x_context__Record_" + componentIdentifier, "BO-1004100035-CANCERTYPE", "CancerType");
			fields[266] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralWizard.__internal_x_context__Record_" + componentIdentifier, "BO-1004100035-EPISODEOFCARE", "EpisodeOfCare");
			fields[267] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralWizard.__internal_x_context__Record_" + componentIdentifier, "BO-1004100035-CURRENT31TARGETDATE", "Current31TargetDate");
			fields[268] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralWizard.__internal_x_context__Record_" + componentIdentifier, "BO-1004100035-CURRENT62TARGETDATE", "Current62TargetDate");
			fields[269] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralWizard.__internal_x_context__Record_" + componentIdentifier, "BO-1004100035-PATIENTCATEGORY", "PatientCategory");
			fields[270] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralWizard.__internal_x_context__Record_" + componentIdentifier, "BO-1004100035-ISEMERGENCYREFERRAL", "IsEmergencyReferral");
			fields[271] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralWizard.__internal_x_context__Record_" + componentIdentifier, "BO-1004100035-MANUALLYMARKEDASNOTRTTIMPACT", "ManuallyMarkedAsNotRTTImpact");
			fields[272] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralWizard.__internal_x_context__Record_" + componentIdentifier, "BO-1004100035-CHANGECBAPPOINTMENT", "ChangeCBAppointment");
			fields[273] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralWizard.__internal_x_context__SelectedReferralService_" + componentIdentifier, "BO-1003100032-ID", "ID_Service");
			fields[274] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralWizard.__internal_x_context__CancerTypeConfig_" + componentIdentifier, "BO-1096100071-ID", "ID_CancerTypeConfig");
			return fields;
		}
