...
public class GenForm extends FormBridge
{
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, "_cv_RefMan.AppointmentClinicalNote", "BO-1096100059-ID", "ID_AppointmentClinicalNotes");
			fields[145] = new ims.framework.ReportField(this.context, "_cv_RefMan.AppointmentClinicalNote", "BO-1096100059-CATSREFERRAL", "CatsReferral");
			fields[146] = new ims.framework.ReportField(this.context, "_cv_RefMan.AppointmentClinicalNote", "BO-1096100059-CLINICALNOTE", "ClinicalNote");
			fields[147] = new ims.framework.ReportField(this.context, "_cv_RefMan.AppointmentClinicalNote", "BO-1096100059-CLINICALNOTETYPE", "ClinicalNoteType");
			fields[148] = new ims.framework.ReportField(this.context, "_cv_RefMan.AppointmentClinicalNote", "BO-1096100059-APPOINTMENT", "Appointment");
			fields[149] = new ims.framework.ReportField(this.context, "_cv_RefMan.AppointmentClinicalNote", "BO-1096100059-AUTHORINGUSER", "AuthoringUser");
			fields[150] = new ims.framework.ReportField(this.context, "_cv_RefMan.AppointmentClinicalNote", "BO-1096100059-NOTETYPE", "NoteType");
			fields[151] = new ims.framework.ReportField(this.context, "_cv_RefMan.AppointmentClinicalNote", "BO-1096100059-NOTESTATUS", "NoteStatus");
			fields[152] = new ims.framework.ReportField(this.context, "_cv_RefMan.AppointmentClinicalNote", "BO-1096100059-COPYTOGP", "CopyToGP");
			fields[153] = new ims.framework.ReportField(this.context, "_cv_RefMan.AppointmentClinicalNote", "BO-1096100059-COPYTOPATIENT", "CopyToPatient");
			fields[154] = new ims.framework.ReportField(this.context, "_cv_RefMan.AppointmentClinicalNote", "BO-1096100059-COPYTOSECONDARYCARE", "CopyToSecondaryCare");
			fields[155] = new ims.framework.ReportField(this.context, "_cv_RefMan.AppointmentClinicalNote", "BO-1096100059-CORRESPONDENCEMADEACTIVEDATETIME", "CorrespondenceMadeActiveDateTime");
			fields[156] = new ims.framework.ReportField(this.context, "_cv_RefMan.AppointmentPatientDiagnosis", "BO-1003100016-ID", "ID_PatientDiagnosis");
			fields[157] = new ims.framework.ReportField(this.context, "_cv_RefMan.AppointmentPatientDiagnosis", "BO-1003100016-DIAGNOSISDESCRIPTION", "DiagnosisDescription");
			fields[158] = new ims.framework.ReportField(this.context, "_cv_RefMan.AppointmentPatientDiagnosis", "BO-1003100016-SOURCEOFINFORMATION", "SourceofInformation");
			fields[159] = new ims.framework.ReportField(this.context, "_cv_RefMan.AppointmentPatientDiagnosis", "BO-1003100016-CARECONTEXT", "CareContext");
			fields[160] = new ims.framework.ReportField(this.context, "_cv_RefMan.AppointmentPatientDiagnosis", "BO-1003100016-EPISODEOFCARE", "EpisodeOfCare");
			fields[161] = new ims.framework.ReportField(this.context, "_cv_RefMan.AppointmentPatientDiagnosis", "BO-1003100016-DIAGNOSEDDATE", "DiagnosedDate");
			fields[162] = new ims.framework.ReportField(this.context, "_cv_RefMan.AppointmentPatientDiagnosis", "BO-1096100061-APPOINTMENT", "Appointment");
			fields[163] = new ims.framework.ReportField(this.context, "_cv_RefMan.AppointmentPatientProcedure", "BO-1003100017-ID", "ID_PatientProcedure");
			fields[164] = new ims.framework.ReportField(this.context, "_cv_RefMan.AppointmentPatientProcedure", "BO-1003100017-PROCEDUREDESCRIPTION", "ProcedureDescription");
			fields[165] = new ims.framework.ReportField(this.context, "_cv_RefMan.AppointmentPatientProcedure", "BO-1003100017-INFOSOURCE", "InfoSource");
			fields[166] = new ims.framework.ReportField(this.context, "_cv_RefMan.AppointmentPatientProcedure", "BO-1003100017-CARECONTEXT", "CareContext");
			fields[167] = new ims.framework.ReportField(this.context, "_cv_RefMan.AppointmentPatientProcedure", "BO-1003100017-EPISODEOFCARE", "EpisodeOfCare");
			fields[168] = new ims.framework.ReportField(this.context, "_cv_RefMan.AppointmentPatientProcedure", "BO-1003100017-PROCDATE", "ProcDate");
			fields[169] = new ims.framework.ReportField(this.context, "_cv_RefMan.AppointmentPatientProcedure", "BO-1003100017-PROCEDURESTATUS", "ProcedureStatus");
			fields[170] = new ims.framework.ReportField(this.context, "_cv_RefMan.AppointmentPatientProcedure", "BO-1003100017-INCOMPLETEREASON", "IncompleteReason");
			fields[171] = new ims.framework.ReportField(this.context, "_cv_RefMan.AppointmentPatientProcedure", "BO-1096100060-APPOINTMENT", "Appointment");
			fields[172] = new ims.framework.ReportField(this.context, "_cv_RefMan.AppointmentPatientProcedure", "BO-1096100060-ISPRIMARYPROCEDURE", "IsPrimaryProcedure");
			fields[173] = new ims.framework.ReportField(this.context, "_cv_RefMan.ReferralClinicalNotes", "BO-1096100058-ID", "ID_ReferralClinicalNotes");
			fields[174] = new ims.framework.ReportField(this.context, "_cv_RefMan.ReferralClinicalNotes", "BO-1096100058-CATSREFERRAL", "CatsReferral");
			fields[175] = new ims.framework.ReportField(this.context, "_cv_RefMan.AppointmentForPatientDiagnosisOrProcedures", "BO-1055100007-ID", "ID_Booking_Appointment");
			fields[176] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ClinicalNotesCustomControl.__internal_x_context__ReferralClinicalNotes_" + componentIdentifier, "BO-1096100058-ID", "ID_ReferralClinicalNotes");
			fields[177] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ClinicalNotesCustomControl.__internal_x_context__ReferralClinicalNotes_" + componentIdentifier, "BO-1096100058-CATSREFERRAL", "CatsReferral");
			fields[178] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ClinicalNotesCustomControl.__internal_x_context__HcpUser_" + componentIdentifier, "BO-1006100000-ID", "ID_Hcp");
			fields[179] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ClinicalNotesCustomControl.__internal_x_context__HcpUser_" + componentIdentifier, "BO-1006100000-HCPTYPE", "HcpType");
			fields[180] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ClinicalNotesCustomControl.__internal_x_context__HcpUser_" + componentIdentifier, "BO-1006100000-ISACTIVE", "IsActive");
			fields[181] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ClinicalNotesCustomControl.__internal_x_context__HcpUser_" + componentIdentifier, "BO-1006100000-ISHCPARESPONSIBLEHCP", "IsHCPaResponsibleHCP");
			fields[182] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ClinicalNotesCustomControl.__internal_x_context__HcpUser_" + componentIdentifier, "BO-1006100000-ISARESPONSIBLEEDCLINICIAN", "IsAResponsibleEDClinician");
			fields[183] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ClinicalNotesCustomControl.__internal_x_context__HcpUser_" + componentIdentifier, "BO-1006100000-ISHCPAENDOSCOPIST", "IsHCPaEndoscopist");
			fields[184] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ClinicalNotesCustomControl.__internal_x_context__MosUser_" + componentIdentifier, "BO-1006100006-ID", "ID_MemberOfStaff");
			return fields;
		}
