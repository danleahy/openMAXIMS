...
public class GenForm extends FormBridge
{
	...
	public static class grpFilterRadioButton extends RadioButtonBridge
	{
		...
		protected void setContext(Integer startTabIndex, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize)
		{
			...
			RuntimeAnchoring anchoringHelper1 = new RuntimeAnchoring(designSize, runtimeSize, 192, 40, 88, 16, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
			...
			RuntimeAnchoring anchoringHelper2 = new RuntimeAnchoring(designSize, runtimeSize, 72, 40, 104, 16, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		ims.framework.utils.SizeInfo designSize = new ims.framework.utils.SizeInfo(800, 264);
		if(runtimeSize == null)
		...
		// Panel Controls
		RuntimeAnchoring anchoringHelper3 = new RuntimeAnchoring(designSize, runtimeSize, 8, 0, 784, 32, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT);
		...
		RuntimeAnchoring anchoringHelper4 = new RuntimeAnchoring(designSize, runtimeSize, 224, 136, 576, 56, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		ims.framework.FormUiLogic m_ccAuthInfoForm = loader.loadComponent(102228, appForm, startControlID * 10 + 1000, anchoringHelper4.getSize(), instance1, startTabIndex.intValue() + 8, skipContextValidation);
		//ims.framework.Control m_ccAuthInfoControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1001), new Integer(224), new Integer(136), new Integer(576), new Integer(56), ControlState.DISABLED, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFT, new Integer(startTabIndex.intValue() + 8), m_ccAuthInfoForm, instance1 } );
		ims.framework.Control m_ccAuthInfoControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1002),  new Integer(anchoringHelper4.getX()), new Integer(anchoringHelper4.getY()), new Integer(anchoringHelper4.getWidth()), new Integer(anchoringHelper4.getHeight()), ControlState.DISABLED, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFT, new Integer(startTabIndex.intValue() + 8), m_ccAuthInfoForm, instance1, Boolean.FALSE } );
		...
		RuntimeAnchoring anchoringHelper5 = new RuntimeAnchoring(designSize, runtimeSize, 8, 72, 792, 64, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		//ims.framework.Control m_ccDiagnosisControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1003), new Integer(8), new Integer(72), new Integer(792), new Integer(64), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, new Integer(startTabIndex.intValue() + 3), m_ccDiagnosisForm, instance2 } );
		ims.framework.Control m_ccDiagnosisControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1004),  new Integer(anchoringHelper5.getX()), new Integer(anchoringHelper5.getY()), new Integer(anchoringHelper5.getWidth()), new Integer(anchoringHelper5.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, new Integer(startTabIndex.intValue() + 3), m_ccDiagnosisForm, instance2, Boolean.FALSE } );
		...
		// Label Controls
		RuntimeAnchoring anchoringHelper6 = new RuntimeAnchoring(designSize, runtimeSize, 16, 131, 100, 23, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		// Button Controls
		RuntimeAnchoring anchoringHelper8 = new RuntimeAnchoring(designSize, runtimeSize, 632, 232, 75, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT);
		...
		RuntimeAnchoring anchoringHelper9 = new RuntimeAnchoring(designSize, runtimeSize, 712, 232, 75, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT);
		...
		// CheckBox Controls
		RuntimeAnchoring anchoringHelper10 = new RuntimeAnchoring(designSize, runtimeSize, 120, 145, 16, 16, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, "_cv_RefMan.SelectedOutcomePatientDiagnosis", "BO-1003100016-ID", "ID_PatientDiagnosis");
			fields[145] = new ims.framework.ReportField(this.context, "_cv_RefMan.SelectedOutcomePatientDiagnosis", "BO-1003100016-DIAGNOSISDESCRIPTION", "DiagnosisDescription");
			fields[146] = new ims.framework.ReportField(this.context, "_cv_RefMan.SelectedOutcomePatientDiagnosis", "BO-1003100016-SOURCEOFINFORMATION", "SourceofInformation");
			fields[147] = new ims.framework.ReportField(this.context, "_cv_RefMan.SelectedOutcomePatientDiagnosis", "BO-1003100016-EPISODEOFCARE", "EpisodeOfCare");
			fields[148] = new ims.framework.ReportField(this.context, "_cv_RefMan.SelectedOutcomePatientDiagnosis", "BO-1003100016-DIAGNOSEDDATE", "DiagnosedDate");
			fields[149] = new ims.framework.ReportField(this.context, "_cv_RefMan.SelectedOutcomePatientDiagnosis", "BO-1003100016-CARECONTEXT", "CareContext");
			fields[150] = new ims.framework.ReportField(this.context, "_cv_RefMan.SelectedOutcomePatientDiagnosis", "BO-1003100016-DIAGNOSEDONADMISSION", "DiagnosedOnAdmission");
			return fields;
		}
