...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "AppointmentOutcomeDiagnosisDialog";
	}
	public int getWidth()
	{
		return 800;
	...
	{
		return new String[] { "_cv_RefMan.SelectedOutcomePatientDiagnosis" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_RefMan.AppointmentOutcomeDiagnosisDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
