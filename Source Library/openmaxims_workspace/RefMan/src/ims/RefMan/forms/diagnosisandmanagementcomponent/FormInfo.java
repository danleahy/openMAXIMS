...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "DiagnosisAndManagementComponent";
	}
	public int getWidth()
	{
		return 800;
	...
	{
		return new String[] { "_cv_RefMan.IsComponentInEditMode", "_cv_Core.PatientDiagnosisAtConsultationList", "_cv_Core.PatientDiagnosisAtConsultation", "_cv_Clinical.DisableMainCheckbox", "_cv_Core.ProceduresAtConsultation" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_RefMan.DiagnosisAndManagementComponent.__internal_x_context__" + String.valueOf(getFormId());
	}
