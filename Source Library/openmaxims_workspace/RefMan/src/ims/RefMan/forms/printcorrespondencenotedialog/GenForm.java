...
public class GenForm extends FormBridge
{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1004), new Integer(anchoringHelper4.getX()), new Integer(anchoringHelper4.getY()), new Integer(anchoringHelper4.getWidth()), new Integer(anchoringHelper4.getHeight()), new Integer(startTabIndex.intValue() + 5), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Preview", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.PrintCorrespondenceNoteDialog.__internal_x_context__SelectedNoteType_" + componentIdentifier, "BO-1096100045-ID", "ID_ReportsRequiredForPrinting");
			fields[145] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.PrintCorrespondenceNoteDialog.__internal_x_context__SelectedNoteType_" + componentIdentifier, "BO-1096100045-PRINTEDDATE", "PrintedDate");
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.PrintCorrespondenceNoteDialog.__internal_x_context__SelectedNoteType_" + componentIdentifier, "BO-1096100045-PRINTEDBY", "PrintedBy");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.PrintCorrespondenceNoteDialog.__internal_x_context__SelectedNoteType_" + componentIdentifier, "BO-1096100045-REPORTSREQUIRED", "ReportsRequired");
			return fields;
		}
