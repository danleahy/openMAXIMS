...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "ReferralServiceSelectionDialog";
	}
	public int getWidth()
	{
		return 592;
	...
	{
		return new String[] { "_cv_RefMan.ReferralServiceSearchList" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_RefMan.ReferralServiceSelectionDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
