...
public class GenForm extends FormBridge
{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		ims.framework.FormUiLogic m_ccLastUpdatingForm = loader.loadComponent(102228, appForm, startControlID * 10 + 1000, anchoringHelper1.getSize(), instance1, startTabIndex.intValue() + 22, skipContextValidation);
		//ims.framework.Control m_ccLastUpdatingControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1000), new Integer(400), new Integer(5), new Integer(408), new Integer(56), ControlState.DISABLED, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.TOPRIGHT, new Integer(startTabIndex.intValue() + 22), m_ccLastUpdatingForm, instance1 } );
		ims.framework.Control m_ccLastUpdatingControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1001),  new Integer(anchoringHelper1.getX()), new Integer(anchoringHelper1.getY()), new Integer(anchoringHelper1.getWidth()), new Integer(anchoringHelper1.getHeight()), ControlState.DISABLED, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.TOPRIGHT, new Integer(startTabIndex.intValue() + 22), m_ccLastUpdatingForm, instance1, Boolean.FALSE } );
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1015), new Integer(anchoringHelper14.getX()), new Integer(anchoringHelper14.getY()), new Integer(anchoringHelper14.getWidth()), new Integer(anchoringHelper14.getHeight()), new Integer(startTabIndex.intValue() + 18), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Edit", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(CheckBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1021), new Integer(anchoringHelper20.getX()), new Integer(anchoringHelper20.getY()), new Integer(anchoringHelper20.getWidth()), new Integer(anchoringHelper20.getHeight()), new Integer(startTabIndex.intValue() + 7), ControlState.DISABLED, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,"No Known Allergies", Boolean.TRUE, null}));
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, "_cv_RefMan.LastUpdatingHCP", "BO-1003100069-ID", "ID_AuthoringInformation");
			fields[145] = new ims.framework.ReportField(this.context, "_cv_RefMan.LastUpdatingHCP", "BO-1003100069-AUTHORINGDATETIME", "AuthoringDateTime");
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ClinicalNotesComponent.__internal_x_context__ConsultationClinicalNotesVo_" + componentIdentifier, "BO-1096100029-ID", "ID_ConsultationClinicalNotes");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ClinicalNotesComponent.__internal_x_context__ConsultationClinicalNotesVo_" + componentIdentifier, "BO-1096100029-CATSREFERRAL", "CatsReferral");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ClinicalNotesComponent.__internal_x_context__ConsultationClinicalNotesVo_" + componentIdentifier, "BO-1096100029-HISTORYPRESENTINGCOMPLAINT", "HistoryPresentingComplaint");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ClinicalNotesComponent.__internal_x_context__ConsultationClinicalNotesVo_" + componentIdentifier, "BO-1096100029-RELEVANTPMH", "RelevantPMH");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ClinicalNotesComponent.__internal_x_context__ConsultationClinicalNotesVo_" + componentIdentifier, "BO-1096100029-OTHERRELEVANTHISTORY", "OtherRelevantHistory");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ClinicalNotesComponent.__internal_x_context__ConsultationClinicalNotesVo_" + componentIdentifier, "BO-1096100029-RELEVANTMEDICATION", "RelevantMedication");
			fields[152] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ClinicalNotesComponent.__internal_x_context__ConsultationClinicalNotesVo_" + componentIdentifier, "BO-1096100029-EXAMINATION", "Examination");
			fields[153] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ClinicalNotesComponent.__internal_x_context__ConsultationClinicalNotesVo_" + componentIdentifier, "BO-1096100029-HASNOKNOWNALLERGIES", "HasNoKnownAllergies");
			fields[154] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ClinicalNotesComponent.__internal_x_context__ConsultationClinicalNotesVo_" + componentIdentifier, "BO-1096100029-SEESCANNEDNOTES", "SeeScannedNotes");
			fields[155] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ClinicalNotesComponent.__internal_x_context__ConsultationClinicalNotesVo_" + componentIdentifier, "BO-1096100029-NOTESDICTATED", "NotesDictated");
			fields[156] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ClinicalNotesComponent.__internal_x_context__ConsultationClinicalNotesVo_" + componentIdentifier, "BO-1096100029-INCLUDENOTESINGPREPORT", "IncludeNotesInGpReport");
			fields[157] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ClinicalNotesComponent.__internal_x_context__ConsultationClinicalNotesVo_" + componentIdentifier, "BO-1096100029-CLINICALIMPRESSION", "ClinicalImpression");
			fields[158] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ClinicalNotesComponent.__internal_x_context__ConsultationClinicalNotesVo_" + componentIdentifier, "BO-1096100029-HEALTHQUESTIONNAIRECOMPLETED", "HealthQuestionnaireCompleted");
			return fields;
		}
