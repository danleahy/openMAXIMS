...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "ReasonForBookingPast28DayKPI";
	}
	public int getWidth()
	{
		return 464;
	...
	{
		return new String[] { "_cv_RefMan.ReasonRTTWeekWaitBreach", "_cv_RefMan.Reason28DayRuleBreach" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_RefMan.ReasonForBookingPast28DayKPI.__internal_x_context__" + String.valueOf(getFormId());
	}
