...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_RefMan.IsComponentInEditMode", "_cv_RefMan.DrugsAlreadyAddedToPrescription", "_cv_RefMan.PrescriptionMedication", "_cv_Core.RieMessage" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_RefMan.PrescriptionComponent.__internal_x_context__" + String.valueOf(getFormId());
	}
