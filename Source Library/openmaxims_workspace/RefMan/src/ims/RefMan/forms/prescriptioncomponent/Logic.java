...
public class Logic extends BaseLogic
{
	...
	private void updateDateGridCells() //WDEV-19144
	{
		DynamicGridRowCollection rowscoll = form.dyngrdPrescription().getRows();
		...
		for (int i=0; i<rowscoll.size();i++)
		{
			if (rowscoll.get(i) == null)
				continue;
			if (rowscoll.get(i).getIdentifier().equals(PrescriptionRecord))
			{	
				rowscoll.get(i).getCells().get(form.dyngrdPrescription().getColumns().getByIdentifier(COL_DATE)).setReadOnly(FormMode.VIEW.equals(form.getMode()));
			}	
		}
	}
