...
public class GenForm extends FormBridge
{
	...
	{
		private static final long serialVersionUID = 1L;
		public static class cmbDelayReasonComboBox extends ComboBoxBridge
		{
			private static final long serialVersionUID = 1L;
		...
		protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
		{
			...
			// Label Controls
			RuntimeAnchoring anchoringHelper1 = new RuntimeAnchoring(designSize, runtimeSize, 320, 40, 97, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
			super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1000), new Integer(anchoringHelper1.getX()), new Integer(anchoringHelper1.getY()), new Integer(anchoringHelper1.getWidth()), new Integer(anchoringHelper1.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Extended Delay:", new Integer(1), null, new Integer(0)}));
			RuntimeAnchoring anchoringHelper2 = new RuntimeAnchoring(designSize, runtimeSize, 320, 152, 63, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
			super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1001), new Integer(anchoringHelper2.getX()), new Integer(anchoringHelper2.getY()), new Integer(anchoringHelper2.getWidth()), new Integer(anchoringHelper2.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Comment:", new Integer(1), null, new Integer(0)}));
			RuntimeAnchoring anchoringHelper3 = new RuntimeAnchoring(designSize, runtimeSize, 320, 136, 85, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
			super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1002), new Integer(anchoringHelper3.getX()), new Integer(anchoringHelper3.getY()), new Integer(anchoringHelper3.getWidth()), new Integer(anchoringHelper3.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "EROD Reason ", new Integer(1), null, new Integer(0)}));
			RuntimeAnchoring anchoringHelper4 = new RuntimeAnchoring(designSize, runtimeSize, 8, 138, 86, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
			super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1003), new Integer(anchoringHelper4.getX()), new Integer(anchoringHelper4.getY()), new Integer(anchoringHelper4.getWidth()), new Integer(anchoringHelper4.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "EROD Reason:", new Integer(1), null, new Integer(0)}));
			RuntimeAnchoring anchoringHelper5 = new RuntimeAnchoring(designSize, runtimeSize, 8, 50, 65, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
			super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1004), new Integer(anchoringHelper5.getX()), new Integer(anchoringHelper5.getY()), new Integer(anchoringHelper5.getWidth()), new Integer(anchoringHelper5.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "from Date:", new Integer(1), null, new Integer(0)}));
			RuntimeAnchoring anchoringHelper6 = new RuntimeAnchoring(designSize, runtimeSize, 8, 10, 127, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
			super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1005), new Integer(anchoringHelper6.getX()), new Integer(anchoringHelper6.getY()), new Integer(anchoringHelper6.getWidth()), new Integer(anchoringHelper6.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Earliest Date Offered:", new Integer(1), null, new Integer(0)}));
			RuntimeAnchoring anchoringHelper7 = new RuntimeAnchoring(designSize, runtimeSize, 320, 10, 126, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
			super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1006), new Integer(anchoringHelper7.getX()), new Integer(anchoringHelper7.getY()), new Integer(anchoringHelper7.getWidth()), new Integer(anchoringHelper7.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Second Date Offered:", new Integer(1), null, new Integer(0)}));
			RuntimeAnchoring anchoringHelper8 = new RuntimeAnchoring(designSize, runtimeSize, 8, 34, 101, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
			super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1007), new Integer(anchoringHelper8.getX()), new Integer(anchoringHelper8.getY()), new Integer(anchoringHelper8.getWidth()), new Integer(anchoringHelper8.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Patient Available", new Integer(1), null, new Integer(0)}));
			RuntimeAnchoring anchoringHelper9 = new RuntimeAnchoring(designSize, runtimeSize, 320, 72, 107, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
			super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1008), new Integer(anchoringHelper9.getX()), new Integer(anchoringHelper9.getY()), new Integer(anchoringHelper9.getWidth()), new Integer(anchoringHelper9.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Reasonable Offer:", new Integer(1), null, new Integer(0)}));
			RuntimeAnchoring anchoringHelper10 = new RuntimeAnchoring(designSize, runtimeSize, 8, 74, 71, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
			super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1009), new Integer(anchoringHelper10.getX()), new Integer(anchoringHelper10.getY()), new Integer(anchoringHelper10.getWidth()), new Integer(anchoringHelper10.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "EROD Type:", new Integer(1), null, new Integer(0)}));
			RuntimeAnchoring anchoringHelper11 = new RuntimeAnchoring(designSize, runtimeSize, 320, 106, 76, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
			super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1010), new Integer(anchoringHelper11.getX()), new Integer(anchoringHelper11.getY()), new Integer(anchoringHelper11.getWidth()), new Integer(anchoringHelper11.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Clinic Name:", new Integer(1), null, new Integer(0)}));
			RuntimeAnchoring anchoringHelper12 = new RuntimeAnchoring(designSize, runtimeSize, 8, 106, 112, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
			super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1011), new Integer(anchoringHelper12.getX()), new Integer(anchoringHelper12.getY()), new Integer(anchoringHelper12.getWidth()), new Integer(anchoringHelper12.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Appointment Date:", new Integer(1), null, new Integer(0)}));
	
			// TextBox Controls
			RuntimeAnchoring anchoringHelper13 = new RuntimeAnchoring(designSize, runtimeSize, 448, 136, 224, 56, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
			...
			RuntimeAnchoring anchoringHelper14 = new RuntimeAnchoring(designSize, runtimeSize, 448, 104, 224, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
			...
			// Date Controls
			RuntimeAnchoring anchoringHelper15 = new RuntimeAnchoring(designSize, runtimeSize, 136, 8, 168, 20, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
			...
			RuntimeAnchoring anchoringHelper16 = new RuntimeAnchoring(designSize, runtimeSize, 448, 8, 224, 20, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
			...
			RuntimeAnchoring anchoringHelper17 = new RuntimeAnchoring(designSize, runtimeSize, 136, 40, 168, 20, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
			...
			RuntimeAnchoring anchoringHelper18 = new RuntimeAnchoring(designSize, runtimeSize, 136, 104, 168, 20, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
			...
			// ComboBox Controls
			RuntimeAnchoring anchoringHelper19 = new RuntimeAnchoring(designSize, runtimeSize, 136, 136, 168, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
			ComboBox m_cmbDelayReasonTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1018), new Integer(anchoringHelper19.getX()), new Integer(anchoringHelper19.getY()), new Integer(anchoringHelper19.getWidth()), new Integer(anchoringHelper19.getHeight()), new Integer(startTabIndex.intValue() + 11), ControlState.DISABLED, ControlState.ENABLED,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
			addControl(m_cmbDelayReasonTemp);
			cmbDelayReasonComboBox cmbDelayReason = (cmbDelayReasonComboBox)ComboBoxFlyweightFactory.getInstance().createComboBoxBridge(cmbDelayReasonComboBox.class, m_cmbDelayReasonTemp);
			super.addComboBox(cmbDelayReason);
			RuntimeAnchoring anchoringHelper20 = new RuntimeAnchoring(designSize, runtimeSize, 136, 72, 168, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
			ComboBox m_cmbERODTypeTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1019), new Integer(anchoringHelper20.getX()), new Integer(anchoringHelper20.getY()), new Integer(anchoringHelper20.getWidth()), new Integer(anchoringHelper20.getHeight()), new Integer(startTabIndex.intValue() + 6), ControlState.DISABLED, ControlState.DISABLED,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.TRUE, new Integer(-1)});
			...
			// CheckBox Controls
			RuntimeAnchoring anchoringHelper21 = new RuntimeAnchoring(designSize, runtimeSize, 448, 40, 16, 16, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
			...
			RuntimeAnchoring anchoringHelper22 = new RuntimeAnchoring(designSize, runtimeSize, 448, 72, 16, 16, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		public cmbDelayReasonComboBox cmbDelayReason()
		{
			return (cmbDelayReasonComboBox)super.getComboBox(0);
		}
		public cmbERODTypeComboBox cmbERODType()
		{
			return (cmbERODTypeComboBox)super.getComboBox(1);
		}
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		// Container Clasess
		RuntimeAnchoring anchoringHelper23 = new RuntimeAnchoring(designSize, runtimeSize, 8, 264, 688, 216, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFTRIGHT);
		...
		ims.framework.utils.SizeInfo m_ctnDetailsDesignSize = new ims.framework.utils.SizeInfo(688, 216);
		...
		// Button Controls
		RuntimeAnchoring anchoringHelper24 = new RuntimeAnchoring(designSize, runtimeSize, 621, 488, 75, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT);
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1023), new Integer(anchoringHelper24.getX()), new Integer(anchoringHelper24.getY()), new Integer(anchoringHelper24.getWidth()), new Integer(anchoringHelper24.getHeight()), new Integer(startTabIndex.intValue() + 16), ControlState.ENABLED, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Close", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		RuntimeAnchoring anchoringHelper25 = new RuntimeAnchoring(designSize, runtimeSize, 86, 488, 75, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT);
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1024), new Integer(anchoringHelper25.getX()), new Integer(anchoringHelper25.getY()), new Integer(anchoringHelper25.getWidth()), new Integer(anchoringHelper25.getHeight()), new Integer(startTabIndex.intValue() + 13), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Edit", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		RuntimeAnchoring anchoringHelper26 = new RuntimeAnchoring(designSize, runtimeSize, 8, 488, 75, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT);
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1025), new Integer(anchoringHelper26.getX()), new Integer(anchoringHelper26.getY()), new Integer(anchoringHelper26.getWidth()), new Integer(anchoringHelper26.getHeight()), new Integer(startTabIndex.intValue() + 12), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "New", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		RuntimeAnchoring anchoringHelper27 = new RuntimeAnchoring(designSize, runtimeSize, 621, 488, 75, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT);
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1026), new Integer(anchoringHelper27.getX()), new Integer(anchoringHelper27.getY()), new Integer(anchoringHelper27.getWidth()), new Integer(anchoringHelper27.getHeight()), new Integer(startTabIndex.intValue() + 15), ControlState.HIDDEN, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Cancel", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		RuntimeAnchoring anchoringHelper28 = new RuntimeAnchoring(designSize, runtimeSize, 544, 488, 75, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT);
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1027), new Integer(anchoringHelper28.getX()), new Integer(anchoringHelper28.getY()), new Integer(anchoringHelper28.getWidth()), new Integer(anchoringHelper28.getHeight()), new Integer(startTabIndex.intValue() + 14), ControlState.HIDDEN, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Save", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));

		// Grid Controls
		RuntimeAnchoring anchoringHelper29 = new RuntimeAnchoring(designSize, runtimeSize, 8, 8, 688, 248, ims.framework.enumerations.ControlAnchoring.ALL);
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, "_cv_RefMan.ReferralEROD", "BO-1096100062-ID", "ID_ReferralEROD");
			fields[145] = new ims.framework.ReportField(this.context, "_cv_RefMan.ReferralEROD", "BO-1096100062-ERODDATE1", "ERODDate1");
			fields[146] = new ims.framework.ReportField(this.context, "_cv_RefMan.ReferralEROD", "BO-1096100062-ERODDATE2", "ERODDate2");
			fields[147] = new ims.framework.ReportField(this.context, "_cv_RefMan.ReferralEROD", "BO-1096100062-PATAVAILFROMDATE", "PatAvailFromDate");
			fields[148] = new ims.framework.ReportField(this.context, "_cv_RefMan.ReferralEROD", "BO-1096100062-REASONABLEOFFER", "ReasonableOffer");
			fields[149] = new ims.framework.ReportField(this.context, "_cv_RefMan.ReferralEROD", "BO-1096100062-ERODTYPE", "ERODType");
			fields[150] = new ims.framework.ReportField(this.context, "_cv_RefMan.ReferralEROD", "BO-1096100062-SEQUENCE", "Sequence");
			fields[151] = new ims.framework.ReportField(this.context, "_cv_RefMan.ReferralEROD", "BO-1096100062-ISACTIVE", "IsActive");
			fields[152] = new ims.framework.ReportField(this.context, "_cv_RefMan.ReferralEROD", "BO-1096100062-PATHWAYCLOCK", "PathWayClock");
			fields[153] = new ims.framework.ReportField(this.context, "_cv_RefMan.ReferralEROD", "BO-1096100062-ERODREASON", "ERODReason");
			fields[154] = new ims.framework.ReportField(this.context, "_cv_RefMan.ReferralEROD", "BO-1096100062-ERODREASONCOMMENT", "ERODReasonComment");
			fields[155] = new ims.framework.ReportField(this.context, "_cv_RefMan.ReferralEROD", "BO-1096100062-ERODSTATUS", "ErodStatus");
			fields[156] = new ims.framework.ReportField(this.context, "_cv_RefMan.ReferralEROD", "BO-1096100062-ISEXTENDEDDELAY", "IsExtendedDelay");
			fields[157] = new ims.framework.ReportField(this.context, "_cv_RefMan.ReferralEROD", "BO-1096100062-DATEOFOFFER", "DateOfOffer");
			fields[158] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ERODDialog.__internal_x_context__CatsReferralEROD_" + componentIdentifier, "BO-1004100035-ID", "ID_CatsReferral");
			fields[159] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ERODDialog.__internal_x_context__CatsReferralEROD_" + componentIdentifier, "BO-1004100035-ISCAB", "IsCAB");
			fields[160] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ERODDialog.__internal_x_context__SelectedEROD_" + componentIdentifier, "BO-1096100062-ID", "ID_ReferralEROD");
			fields[161] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ERODDialog.__internal_x_context__SelectedEROD_" + componentIdentifier, "BO-1096100062-ERODDATE1", "ERODDate1");
			fields[162] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ERODDialog.__internal_x_context__SelectedEROD_" + componentIdentifier, "BO-1096100062-ERODDATE2", "ERODDate2");
			fields[163] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ERODDialog.__internal_x_context__SelectedEROD_" + componentIdentifier, "BO-1096100062-PATAVAILFROMDATE", "PatAvailFromDate");
			fields[164] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ERODDialog.__internal_x_context__SelectedEROD_" + componentIdentifier, "BO-1096100062-REASONABLEOFFER", "ReasonableOffer");
			fields[165] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ERODDialog.__internal_x_context__SelectedEROD_" + componentIdentifier, "BO-1096100062-ERODTYPE", "ERODType");
			fields[166] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ERODDialog.__internal_x_context__SelectedEROD_" + componentIdentifier, "BO-1096100062-SEQUENCE", "Sequence");
			fields[167] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ERODDialog.__internal_x_context__SelectedEROD_" + componentIdentifier, "BO-1096100062-ISACTIVE", "IsActive");
			fields[168] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ERODDialog.__internal_x_context__SelectedEROD_" + componentIdentifier, "BO-1096100062-PATHWAYCLOCK", "PathWayClock");
			fields[169] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ERODDialog.__internal_x_context__SelectedEROD_" + componentIdentifier, "BO-1096100062-ERODREASON", "ERODReason");
			fields[170] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ERODDialog.__internal_x_context__SelectedEROD_" + componentIdentifier, "BO-1096100062-ERODREASONCOMMENT", "ERODReasonComment");
			fields[171] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ERODDialog.__internal_x_context__SelectedEROD_" + componentIdentifier, "BO-1096100062-ERODSTATUS", "ErodStatus");
			fields[172] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ERODDialog.__internal_x_context__SelectedEROD_" + componentIdentifier, "BO-1096100062-ISEXTENDEDDELAY", "IsExtendedDelay");
			fields[173] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ERODDialog.__internal_x_context__SelectedEROD_" + componentIdentifier, "BO-1096100062-DATEOFOFFER", "DateOfOffer");
			fields[174] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ERODDialog.__internal_x_context__RIERecord_" + componentIdentifier, "BO-1096100062-ID", "ID_ReferralEROD");
			fields[175] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ERODDialog.__internal_x_context__RIERecord_" + componentIdentifier, "BO-1096100062-ERODDATE1", "ERODDate1");
			fields[176] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ERODDialog.__internal_x_context__RIERecord_" + componentIdentifier, "BO-1096100062-ERODDATE2", "ERODDate2");
			fields[177] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ERODDialog.__internal_x_context__RIERecord_" + componentIdentifier, "BO-1096100062-PATAVAILFROMDATE", "PatAvailFromDate");
			fields[178] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ERODDialog.__internal_x_context__RIERecord_" + componentIdentifier, "BO-1096100062-REASONABLEOFFER", "ReasonableOffer");
			fields[179] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ERODDialog.__internal_x_context__RIERecord_" + componentIdentifier, "BO-1096100062-ERODTYPE", "ERODType");
			fields[180] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ERODDialog.__internal_x_context__RIERecord_" + componentIdentifier, "BO-1096100062-SEQUENCE", "Sequence");
			fields[181] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ERODDialog.__internal_x_context__RIERecord_" + componentIdentifier, "BO-1096100062-ISACTIVE", "IsActive");
			fields[182] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ERODDialog.__internal_x_context__RIERecord_" + componentIdentifier, "BO-1096100062-PATHWAYCLOCK", "PathWayClock");
			fields[183] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ERODDialog.__internal_x_context__RIERecord_" + componentIdentifier, "BO-1096100062-ERODREASON", "ERODReason");
			fields[184] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ERODDialog.__internal_x_context__RIERecord_" + componentIdentifier, "BO-1096100062-ERODREASONCOMMENT", "ERODReasonComment");
			fields[185] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ERODDialog.__internal_x_context__RIERecord_" + componentIdentifier, "BO-1096100062-ERODSTATUS", "ErodStatus");
			fields[186] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ERODDialog.__internal_x_context__RIERecord_" + componentIdentifier, "BO-1096100062-ISEXTENDEDDELAY", "IsExtendedDelay");
			fields[187] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ERODDialog.__internal_x_context__RIERecord_" + componentIdentifier, "BO-1096100062-DATEOFOFFER", "DateOfOffer");
			return fields;
		}
