...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_RefMan.Language" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_RefMan.InterpreterDetails.__internal_x_context__" + String.valueOf(getFormId());
	}
	...
	{
		return "Images/RefMan/interpreter_details_48.png";
	}
}
