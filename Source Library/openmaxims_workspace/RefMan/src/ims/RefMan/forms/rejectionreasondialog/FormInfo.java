...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_RefMan.RejectionReason", "_cv_RefMan.PrintRejectionLetters" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_RefMan.RejectionReasondialog.__internal_x_context__" + String.valueOf(getFormId());
	}
	...
	{
		return "Images/RefMan/rejection_reason_48.png";
	}
}
