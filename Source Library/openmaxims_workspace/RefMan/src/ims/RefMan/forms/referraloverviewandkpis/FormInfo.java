...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "ReferralOverviewAndKpis";
	}
	public int getWidth()
	{
		return 848;
	...
	{
		return new String[] { "_cv_RefMan.CatsReferralStatusHistory", "_cv_RefMan.ReferralTransfer" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_RefMan.ReferralOverviewAndKpis.__internal_x_context__" + String.valueOf(getFormId());
	}
	public ims.framework.FormInfo[] getComponentsFormInfo()
	{
		ims.framework.FormInfo[] componentsInfo = new ims.framework.FormInfo[1];
		componentsInfo[0] = new ims.RefMan.forms.erodhistory.FormInfo(134223);
