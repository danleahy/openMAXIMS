...
public class GenForm extends FormBridge
{
	...
	public static class lyrContentLayer extends Layer
	{
		...
		public static class tabDischargeSummaryContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				super.addControl(factory.getControl(HTMLViewer.class, new Object[] { control, new Integer(startControlID.intValue() + 1010), new Integer(anchoringHelper11.getX()), new Integer(anchoringHelper11.getY()), new Integer(anchoringHelper11.getWidth()), new Integer(anchoringHelper11.getHeight()), new Integer(startTabIndex.intValue() + 6), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE}));
			}
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.DischargeSummaryConsultatntWardAndPacu.__internal_x_context__DischargeSummaryWardAndPACU_" + componentIdentifier, "BO-1096100034-ID", "ID_DischargeSummaryPacuAndWard");
			fields[145] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.DischargeSummaryConsultatntWardAndPacu.__internal_x_context__DischargeSummaryWardAndPACU_" + componentIdentifier, "BO-1096100034-CATSREFERRAL", "CatsReferral");
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.DischargeSummaryConsultatntWardAndPacu.__internal_x_context__DischargeSummaryWardAndPACU_" + componentIdentifier, "BO-1096100034-DISCHARGEDATETIME", "DischargeDateTime");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.DischargeSummaryConsultatntWardAndPacu.__internal_x_context__DischargeSummaryWardAndPACU_" + componentIdentifier, "BO-1096100034-DISCHARGETYPE", "DischargeType");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.DischargeSummaryConsultatntWardAndPacu.__internal_x_context__DischargeSummaryWardAndPACU_" + componentIdentifier, "BO-1096100034-DISCHARGEEPISODE", "DischargeEpisode");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.DischargeSummaryConsultatntWardAndPacu.__internal_x_context__DischargeSummaryWardAndPACU_" + componentIdentifier, "BO-1096100034-ISCURRENT", "IsCurrent");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.DischargeSummaryConsultatntWardAndPacu.__internal_x_context__DischargeSummaryWardAndPACU_" + componentIdentifier, "BO-1096100034-ADMISSIONSUMMARY", "AdmissionSummary");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.DischargeSummaryConsultatntWardAndPacu.__internal_x_context__DischargeSummaryWardAndPACU_" + componentIdentifier, "BO-1096100034-PROBLEMSANDNEEDS", "ProblemsAndNeeds");
			fields[152] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.DischargeSummaryConsultatntWardAndPacu.__internal_x_context__DischargeSummaryWardAndPACU_" + componentIdentifier, "BO-1096100034-ADDITIONALCOMMENTS", "AdditionalComments");
			fields[153] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.DischargeSummaryConsultatntWardAndPacu.__internal_x_context__DischargeSummaryWardAndPACU_" + componentIdentifier, "BO-1096100034-FOLLOWUPTYPE", "FollowupType");
			fields[154] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.DischargeSummaryConsultatntWardAndPacu.__internal_x_context__DischargeSummaryWardAndPACU_" + componentIdentifier, "BO-1096100034-FURTHERMANAGEMENTINSTRUCTIONS", "FurtherManagementInstructions");
			fields[155] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.DischargeSummaryConsultatntWardAndPacu.__internal_x_context__DischargeSummaryWardAndPACU_" + componentIdentifier, "BO-1096100034-MEDICALLYINCOMPLETE", "MedicallyIncomplete");
			fields[156] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.DischargeSummaryConsultatntWardAndPacu.__internal_x_context__DischargeSummaryWardAndPACU_" + componentIdentifier, "BO-1096100034-INCOMPLETENOOFDAYS", "IncompleteNoOfDays");
			fields[157] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.DischargeSummaryConsultatntWardAndPacu.__internal_x_context__DischargeSummaryWardAndPACU_" + componentIdentifier, "BO-1096100034-CURRENTONWARDREFERRAL", "CurrentOnwardReferral");
			fields[158] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.DischargeSummaryConsultatntWardAndPacu.__internal_x_context__DischargeSummaryWardAndPACU_" + componentIdentifier, "BO-1096100034-ACTIONSFORGPANDCOMMUNITY", "ActionsforGPandCommunity");
			fields[159] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.DischargeSummaryConsultatntWardAndPacu.__internal_x_context__Inpatient_" + componentIdentifier, "BO-1014100000-ID", "ID_InpatientEpisode");
			fields[160] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.DischargeSummaryConsultatntWardAndPacu.__internal_x_context__Inpatient_" + componentIdentifier, "BO-1014100000-ISONLEAVE", "IsOnLeave");
			fields[161] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.DischargeSummaryConsultatntWardAndPacu.__internal_x_context__Inpatient_" + componentIdentifier, "BO-1014100000-COMMENTS", "Comments");
			fields[162] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.DischargeSummaryConsultatntWardAndPacu.__internal_x_context__Inpatient_" + componentIdentifier, "BO-1014100000-ADMISSIONDATETIME", "AdmissionDateTime");
			fields[163] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.DischargeSummaryConsultatntWardAndPacu.__internal_x_context__Inpatient_" + componentIdentifier, "BO-1014100000-ESTDISCHARGEDATE", "EstDischargeDate");
			fields[164] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.DischargeSummaryConsultatntWardAndPacu.__internal_x_context__Inpatient_" + componentIdentifier, "BO-1014100000-BEDNO", "BedNo");
			fields[165] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.DischargeSummaryConsultatntWardAndPacu.__internal_x_context__Inpatient_" + componentIdentifier, "BO-1014100000-ADMISSIONTYPE", "AdmissionType");
			fields[166] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.DischargeSummaryConsultatntWardAndPacu.__internal_x_context__Inpatient_" + componentIdentifier, "BO-1014100000-ISMATERNITYINPATIENT", "IsMaternityInpatient");
			fields[167] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.DischargeSummaryConsultatntWardAndPacu.__internal_x_context__Inpatient_" + componentIdentifier, "BO-1014100000-REASONFORADMISSION", "ReasonForAdmission");
			fields[168] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.DischargeSummaryConsultatntWardAndPacu.__internal_x_context__Inpatient_" + componentIdentifier, "BO-1014100000-WARDTYPE", "WardType");
			fields[169] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.DischargeSummaryConsultatntWardAndPacu.__internal_x_context__Inpatient_" + componentIdentifier, "BO-1014100000-READMISSIONTYPE", "ReadmissionType");
			fields[170] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.DischargeSummaryConsultatntWardAndPacu.__internal_x_context__Inpatient_" + componentIdentifier, "BO-1014100000-DISCHARGEREADYDATE", "DischargeReadyDate");
			return fields;
		}
