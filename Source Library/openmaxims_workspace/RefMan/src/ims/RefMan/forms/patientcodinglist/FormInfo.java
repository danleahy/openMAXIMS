...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_RefMan.AdmissionDetailRef" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_RefMan.PatientCodingList.__internal_x_context__" + String.valueOf(getFormId());
	}
