...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "BookSpecimenAppointmentDialog";
	}
	public int getWidth()
	{
		return 544;
	...
	{
		return new String[] { "_cv_RefMan.SpecimenWorkListItems", "_cv_RefMan.SpecimenWorkListItem" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_RefMan.BookSpecimenAppointmentDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
