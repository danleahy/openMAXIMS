...
public class GenForm extends FormBridge
{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		super.addControl(factory.getControl(CheckBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1011), new Integer(anchoringHelper11.getX()), new Integer(anchoringHelper11.getY()), new Integer(anchoringHelper11.getWidth()), new Integer(anchoringHelper11.getHeight()), new Integer(startTabIndex.intValue() + 4), ControlState.DISABLED, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,"First Definitive Treatment", Boolean.TRUE, null}));
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[150] = new ims.framework.ReportField(this.context, "_cv_Core.PatientDiagnosisAtConsultation", "BO-1003100016-ID", "ID_PatientDiagnosis");
			fields[151] = new ims.framework.ReportField(this.context, "_cv_Core.PatientDiagnosisAtConsultation", "BO-1003100016-SPECIALTY", "Specialty");
			fields[152] = new ims.framework.ReportField(this.context, "_cv_Core.PatientDiagnosisAtConsultation", "BO-1003100016-DIAGNOSISDESCRIPTION", "DiagnosisDescription");
			fields[153] = new ims.framework.ReportField(this.context, "_cv_Core.PatientDiagnosisAtConsultation", "BO-1003100016-DIAGNOSEDDATE", "DiagnosedDate");
			fields[154] = new ims.framework.ReportField(this.context, "_cv_Core.PatientDiagnosisAtConsultation", "BO-1003100016-SOURCEOFINFORMATION", "SourceofInformation");
			fields[155] = new ims.framework.ReportField(this.context, "_cv_Core.PatientDiagnosisAtConsultation", "BO-1003100016-CARECONTEXT", "CareContext");
			fields[156] = new ims.framework.ReportField(this.context, "_cv_Core.PatientDiagnosisAtConsultation", "BO-1003100016-EPISODEOFCARE", "EpisodeOfCare");
			fields[157] = new ims.framework.ReportField(this.context, "_cv_Core.PatientDiagnosisAtConsultation", "BO-1003100016-ADDEDDURINGCODING", "AddedDuringCoding");
			fields[158] = new ims.framework.ReportField(this.context, "_cv_Core.PatientDiagnosisAtConsultation", "BO-1003100016-CODINGSEQUENCE", "CodingSequence");
			fields[159] = new ims.framework.ReportField(this.context, "_cv_Core.PatientDiagnosisAtConsultation", "BO-1003100016-DIAGLATERALITY", "DiagLaterality");
			fields[160] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.AtConsultationComponent.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1096100004-ID", "ID_AtConsultation");
			fields[161] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.AtConsultationComponent.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1096100004-CATSREFERRAL", "CatsReferral");
			fields[162] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.AtConsultationComponent.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1096100004-FIRSTDEFINITIVETREATMENTDATE", "FirstDefinitiveTreatmentDate");
			fields[163] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.AtConsultationComponent.__internal_x_context__CurrentService_" + componentIdentifier, "BO-1003100032-ID", "ID_Service");
			fields[164] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.AtConsultationComponent.__internal_x_context__CurrentService_" + componentIdentifier, "BO-1003100032-SERVICENAME", "ServiceName");
			fields[165] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.AtConsultationComponent.__internal_x_context__CurrentService_" + componentIdentifier, "BO-1003100032-SERVICECATEGORY", "ServiceCategory");
			fields[166] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.AtConsultationComponent.__internal_x_context__CurrentService_" + componentIdentifier, "BO-1003100032-CANBESCHEDULED", "CanBeScheduled");
			fields[167] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.AtConsultationComponent.__internal_x_context__CurrentService_" + componentIdentifier, "BO-1003100032-SPECIALTY", "Specialty");
			fields[168] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.AtConsultationComponent.__internal_x_context__CurrentService_" + componentIdentifier, "BO-1003100032-EXPECTEDTURNAROUND", "ExpectedTurnaround");
			fields[169] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.AtConsultationComponent.__internal_x_context__CurrentService_" + componentIdentifier, "BO-1003100032-TURNAROUNDMEASURE", "TurnaroundMeasure");
			fields[170] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.AtConsultationComponent.__internal_x_context__CurrentService_" + componentIdentifier, "BO-1003100032-MATERNITYINDICATOR", "MaternityIndicator");
			fields[171] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.AtConsultationComponent.__internal_x_context__CurrentService_" + componentIdentifier, "BO-1003100032-ISACTIVE", "IsActive");
			fields[172] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.AtConsultationComponent.__internal_x_context__CurrentService_" + componentIdentifier, "BO-1003100032-ISSUBJECTTORTTCLOCK", "IsSubjectToRTTClock");
			fields[173] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.AtConsultationComponent.__internal_x_context__CurrentService_" + componentIdentifier, "BO-1003100032-DIRECTSELFREFERRALSACCEPTED", "DirectSelfReferralsAccepted");
			fields[174] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.AtConsultationComponent.__internal_x_context__CurrentService_" + componentIdentifier, "BO-1003100032-ISPREASSESSMENTCOMPLETIONEXEMPT", "IsPreAssessmentCompletionExempt");
			fields[175] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.AtConsultationComponent.__internal_x_context__CurrentService_" + componentIdentifier, "BO-1003100032-SERVICEDESCRIPTION", "ServiceDescription");
			fields[176] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.AtConsultationComponent.__internal_x_context__CurrentService_" + componentIdentifier, "BO-1003100032-ALTERNATESERVICECODE", "AlternateServiceCode");
			return fields;
		}
