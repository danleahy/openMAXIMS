...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "AppointmentPatientProcedureDialog";
	}
	public int getWidth()
	{
		return 752;
	...
	{
		return new String[] { "_cv_RefMan.AppointmentPatientProcedure" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_RefMan.AppointmentPatientProcedureDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
