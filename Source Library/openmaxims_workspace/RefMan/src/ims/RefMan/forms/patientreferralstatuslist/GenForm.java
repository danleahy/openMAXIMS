...
public class GenForm extends FormBridge
{
	...
	public class LocalContext extends ContextBridge
	{
		...
		public LocalContext(Context context, ims.framework.FormInfo formInfo, String componentIdentifier)
		{
			...
			cxl_IdUndoEndOfCareMessageBox = new ims.framework.ContextVariable("IdUndoEndOfCareMessageBox", prefix + "_lv_RefMan.PatientReferralStatusList.__internal_x_context__IdUndoEndOfCareMessageBox_" + componentIdentifier + "");
		}
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[152] = new ims.framework.ReportField(this.context, "_cv_RefMan.PatientElectiveListRef", "BO-1014100020-ID", "ID_PatientElectiveList");
			fields[153] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.PatientReferralStatusList.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1004100035-ID", "ID_CatsReferral");
			fields[154] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.PatientReferralStatusList.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1004100035-HASDOCUMENTS", "HasDocuments");
			fields[155] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.PatientReferralStatusList.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1004100035-HASINVESTIGATIONS", "HasInvestigations");
			fields[156] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.PatientReferralStatusList.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1004100035-HASAPPOINTMENTS", "HasAppointments");
			fields[157] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.PatientReferralStatusList.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1004100035-CARECONTEXT", "CareContext");
			fields[158] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.PatientReferralStatusList.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1004100035-HASREFERRALLETTER", "HasReferralLetter");
			fields[159] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.PatientReferralStatusList.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1004100035-ISCAB", "IsCAB");
			fields[160] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.PatientReferralStatusList.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1004100035-ADDITIONALINVAPPTSSTATUS", "AdditionalInvApptsStatus");
			fields[161] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.PatientReferralStatusList.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1004100035-HASREJECTEDINV", "HasRejectedInv");
			fields[162] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.PatientReferralStatusList.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1004100035-PROVIDERCANCELLATION", "ProviderCancellation");
			fields[163] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.PatientReferralStatusList.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1004100035-ISFLAGGEDFORREVIEW", "IsFlaggedForReview");
			fields[164] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.PatientReferralStatusList.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1004100035-ONWARDREFERRALSTATUS", "OnwardReferralStatus");
			fields[165] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.PatientReferralStatusList.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1004100035-HASCONSULTATIONDETAILS", "HasConsultationDetails");
			fields[166] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.PatientReferralStatusList.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1004100035-LASTAPPTARRIVEDDATE", "LastApptArrivedDate");
			fields[167] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.PatientReferralStatusList.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1004100035-HASTLTSTARTCONTACT", "HasTLTStartContact");
			fields[168] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.PatientReferralStatusList.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1004100035-ISSUITABLEFORSURGERY", "IsSuitableForSurgery");
			fields[169] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.PatientReferralStatusList.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1004100035-ISFITFORSURGERY", "IsFitForSurgery");
			fields[170] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.PatientReferralStatusList.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1004100035-HASTHEATREAPPT", "HasTheatreAppt");
			fields[171] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.PatientReferralStatusList.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1004100035-ISCURRENTLYALLOCATED", "IsCurrentlyAllocated");
			fields[172] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.PatientReferralStatusList.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1004100035-ISAWAITINGCLINICALINFO", "IsAwaitingClinicalInfo");
			fields[173] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.PatientReferralStatusList.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1004100035-OPDLOCATION", "OPDLocation");
			fields[174] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.PatientReferralStatusList.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1004100035-SUITABLEFORSURGERYDATE", "SuitableForSurgeryDate");
			fields[175] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.PatientReferralStatusList.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1004100035-ENDOFCAREDATE", "EndOfCareDate");
			fields[176] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.PatientReferralStatusList.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1004100035-PATHWAYID", "PathwayID");
			fields[177] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.PatientReferralStatusList.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1004100035-NUMPROVIDERCANCELLEDAPPTS", "NumProviderCancelledAppts");
			fields[178] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.PatientReferralStatusList.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1004100035-NUMPATIENTCANCELLEDAPPTS", "NumPatientCancelledAppts");
			fields[179] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.PatientReferralStatusList.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1004100035-CONSULTATIONACTIVITYREQUIRED", "ConsultationActivityRequired");
			fields[180] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.PatientReferralStatusList.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1004100035-PATIENTCATEGORY", "PatientCategory");
			fields[181] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.PatientReferralStatusList.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1004100035-ISEMERGENCYREFERRAL", "IsEmergencyReferral");
			return fields;
		}
