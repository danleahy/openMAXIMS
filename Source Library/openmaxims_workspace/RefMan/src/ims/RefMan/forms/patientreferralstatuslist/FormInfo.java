...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "PatientReferralStatusList";
	}
	public int getWidth()
	{
		return 848;
	...
	{
		return new String[] { "_cv_RefMan.IsConsultationStarted", "_cv_RefMan.IsClinicalContactStarted", "_cv_RefMan.SpecimenWorkListItemForReports", "_cv_RefMan.PatientElectiveListRef", "_cv_RefMan.OpenApptAndInvTab" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_RefMan.PatientReferralStatusList.__internal_x_context__" + String.valueOf(getFormId());
	}
