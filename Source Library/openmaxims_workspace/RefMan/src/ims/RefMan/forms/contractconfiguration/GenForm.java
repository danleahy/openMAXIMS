...
public class GenForm extends FormBridge
{
		...
		public static class lyrDetailsLayer extends Layer
		{
			...
			public static class tabPage1Container extends LayerBridge
			{
				...
				protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
				{
					...
					RuntimeAnchoring anchoringHelper2 = new RuntimeAnchoring(designSize, runtimeSize, 424, 48, 233, 17, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
					super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1001), new Integer(anchoringHelper2.getX()), new Integer(anchoringHelper2.getY()), new Integer(anchoringHelper2.getWidth()), new Integer(anchoringHelper2.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT, "No. of Days to 1st Activity Appointment:", new Integer(1), null, new Integer(0)}));
					RuntimeAnchoring anchoringHelper3 = new RuntimeAnchoring(designSize, runtimeSize, 424, 24, 158, 17, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
					super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1002), new Integer(anchoringHelper3.getX()), new Integer(anchoringHelper3.getY()), new Integer(anchoringHelper3.getWidth()), new Integer(anchoringHelper3.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT, "Week(s) to Treatment KPI:", new Integer(1), null, new Integer(0)}));
					...
					super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1007), new Integer(anchoringHelper8.getX()), new Integer(anchoringHelper8.getY()), new Integer(anchoringHelper8.getWidth()), new Integer(anchoringHelper8.getHeight()), new Integer(startTabIndex.intValue() + 19), ControlState.HIDDEN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT, "Edit KPI", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
					...
					super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1008), new Integer(anchoringHelper9.getX()), new Integer(anchoringHelper9.getY()), new Integer(anchoringHelper9.getWidth()), new Integer(anchoringHelper9.getHeight()), new Integer(startTabIndex.intValue() + 12), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT,Boolean.FALSE, new Integer(255), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.TRUE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
					...
					super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1009), new Integer(anchoringHelper10.getX()), new Integer(anchoringHelper10.getY()), new Integer(anchoringHelper10.getWidth()), new Integer(anchoringHelper10.getHeight()), new Integer(startTabIndex.intValue() + 11), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT,Boolean.FALSE, new Integer(25), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.TRUE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
					...
					ComboBox m_cmbContractTypeTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1010), new Integer(anchoringHelper11.getX()), new Integer(anchoringHelper11.getY()), new Integer(anchoringHelper11.getWidth()), new Integer(anchoringHelper11.getHeight()), new Integer(startTabIndex.intValue() + 15), ControlState.DISABLED, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.TRUE, new Integer(-1)});
					...
					ComboBox m_cmbStatusTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1011), new Integer(anchoringHelper12.getX()), new Integer(anchoringHelper12.getY()), new Integer(anchoringHelper12.getWidth()), new Integer(anchoringHelper12.getHeight()), new Integer(startTabIndex.intValue() + 16), ControlState.DISABLED, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.TRUE, new Integer(-1)});
					...
					ComboBox m_cmbOrganisationTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1012), new Integer(anchoringHelper13.getX()), new Integer(anchoringHelper13.getY()), new Integer(anchoringHelper13.getWidth()), new Integer(anchoringHelper13.getHeight()), new Integer(startTabIndex.intValue() + 13), ControlState.DISABLED, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.TRUE, new Integer(-1)});
					...
					super.addControl(factory.getControl(IntBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1013), new Integer(anchoringHelper14.getX()), new Integer(anchoringHelper14.getY()), new Integer(anchoringHelper14.getWidth()), new Integer(anchoringHelper14.getHeight()), new Integer(startTabIndex.intValue() + 18), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT,Boolean.TRUE, Boolean.FALSE, Boolean.FALSE, null, null, Boolean.TRUE, new Integer(4)}));
					...
					super.addControl(factory.getControl(IntBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1014), new Integer(anchoringHelper15.getX()), new Integer(anchoringHelper15.getY()), new Integer(anchoringHelper15.getWidth()), new Integer(anchoringHelper15.getHeight()), new Integer(startTabIndex.intValue() + 17), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT,Boolean.TRUE, Boolean.FALSE, Boolean.FALSE, null, null, Boolean.TRUE, new Integer(4)}));
				}
			...
			public static class tabPage2Container extends LayerBridge
			{
				...
				protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
				{
					...
					RuntimeAnchoring anchoringHelper16 = new RuntimeAnchoring(designSize, runtimeSize, 8, 8, 776, 152, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT);
					super.addControl(factory.getControl(DynamicGrid.class, new Object[] { control, new Integer(startControlID.intValue() + 1015), new Integer(anchoringHelper16.getX()), new Integer(anchoringHelper16.getY()), new Integer(anchoringHelper16.getWidth()), new Integer(anchoringHelper16.getHeight()), new Integer(-1), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT, contextMenus.RefMan.contextMenuServiceLocationMenu, Boolean.FALSE, Boolean.FALSE, Boolean.TRUE}));
				}
	
				public DynamicGrid dyngrdService()
				{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		contextMenus.RefMan.contextMenuServiceLocationMenuAddEditServiceKpiItem = factory.createMenuItem(startControlID.intValue() + 5, "Add/Edit Service KPIs", true, false, new Integer(102235), true, false);
		if(factory.getUIEngine().getLoggedInRole().hasMenuActionRight(appForm, new ims.framework.MenuAction(4240001)))
			contextMenus.RefMan.contextMenuServiceLocationMenu.add(contextMenus.RefMan.contextMenuServiceLocationMenuAddEditServiceKpiItem);
		...
		contextMenus.RefMan.contextMenuCCGContextMenuADDItem = factory.createMenuItem(startControlID.intValue() + 6, "Add", true, false, new Integer(102179), true, false);
		...
		contextMenus.RefMan.contextMenuCCGContextMenuEDITItem = factory.createMenuItem(startControlID.intValue() + 7, "Edit", true, false, new Integer(102150), true, false);
		...
		contextMenus.RefMan.contextMenuCCGContextMenuREMOVEItem = factory.createMenuItem(startControlID.intValue() + 8, "Remove", true, false, new Integer(102300), true, false);
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1030), new Integer(anchoringHelper31.getX()), new Integer(anchoringHelper31.getY()), new Integer(anchoringHelper31.getWidth()), new Integer(anchoringHelper31.getHeight()), new Integer(startTabIndex.intValue() + 23), ControlState.HIDDEN, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Save", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(CheckBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1037), new Integer(anchoringHelper38.getX()), new Integer(anchoringHelper38.getY()), new Integer(anchoringHelper38.getWidth()), new Integer(anchoringHelper38.getHeight()), new Integer(startTabIndex.intValue() + 7), ControlState.ENABLED, ControlState.DISABLED,ims.framework.enumerations.ControlAnchoring.TOPRIGHT ,"", Boolean.FALSE, null}));
		...
		grdDetails.addIntColumn("Days to RTT Breach Date", 0, 0, 150, true, true, null, false, 0, true, 0);
	...
	public static class Forms implements java.io.Serializable
	{
		...
		public final class RefManForms implements java.io.Serializable
		{
			...
			private RefManForms()
			{
				ServiceKPIs = new LocalFormName(134280);
			}
			public final FormName ServiceKPIs;
		}
	...
	public final class ContextMenus implements java.io.Serializable
	{
		...
		public final class RefManNamespace implements java.io.Serializable
		{
			...
			public final class ServiceLocationMenu implements java.io.Serializable
			{
				...
				public static final int AddEditServiceKpi = 5;
			}
			public void disableAllServiceLocationMenuMenuItems()
			{
				...
				this.contextMenuServiceLocationMenuAddEditServiceKpiItem.setEnabled(false);
			}
			public void hideAllServiceLocationMenuMenuItems()
			{
				...
				this.contextMenuServiceLocationMenuAddEditServiceKpiItem.setVisible(false);
			}
			...
			public ReadOnlyMenuItem getServiceLocationMenuAddEditServiceKpiItem()
			{
				return this.contextMenuServiceLocationMenuAddEditServiceKpiItem;
			}
			private MenuItem contextMenuServiceLocationMenuAddEditServiceKpiItem;
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, "_cv_RefMan.SelectedServiceForKpi", "BO-1028100065-ID", "ID_ContractServiceLocationsConfig");
			fields[145] = new ims.framework.ReportField(this.context, "_cv_RefMan.SelectedServiceForKpi", "BO-1028100065-CONTRACTID", "ContractId");
			fields[146] = new ims.framework.ReportField(this.context, "_cv_RefMan.SelectedServiceForKpi", "BO-1028100065-DAYSTORTTBREACHDATE", "DaysToRTTBreachDate");
			fields[147] = new ims.framework.ReportField(this.context, "_cv_RefMan.SelectedServiceForKpi", "BO-1028100065-DAYSTO1STAPPT", "DaysTo1stAppt");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ContractConfiguration.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1096100047-ID", "ID_ContractConfig");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ContractConfiguration.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1096100047-CONTRACTID", "ContractId");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ContractConfiguration.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1096100047-CONTRACTNAME", "ContractName");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ContractConfiguration.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1096100047-STATUS", "Status");
			fields[152] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ContractConfiguration.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1096100047-DAYSTORTTBREACHDATE", "DaysToRTTBreachDate");
			fields[153] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ContractConfiguration.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1096100047-CONTRACTTYPE", "ContractType");
			fields[154] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ContractConfiguration.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1096100047-DAYSTO1STAPPT", "DaysTo1stAppt");
			return fields;
		}
