...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_RefMan.IsComponentInEditMode", "_cv_RefMan.EditedFollowUpNote" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_RefMan.FollowUpNotesComponent.__internal_x_context__" + String.valueOf(getFormId());
	}
