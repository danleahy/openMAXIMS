...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "CancelTCIForPatientElectiveListDialog";
	}
	public int getWidth()
	{
		return 536;
	...
	{
		return new String[] { "_cv_RefMan.TCIOutcomeForPatientElectiveList", "_cv_RefMan.TheatreBookingAppointment" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_RefMan.CancelTCIForPatientElectiveListDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
