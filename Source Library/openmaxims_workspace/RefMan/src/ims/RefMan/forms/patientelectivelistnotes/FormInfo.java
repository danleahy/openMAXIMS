...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "PatientElectiveListNotes";
	}
	public int getWidth()
	{
		return 432;
	...
	{
		return new String[] { "_cv_RefMan.PatientElectiveListNotes" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_RefMan.PatientElectiveListNotes.__internal_x_context__" + String.valueOf(getFormId());
	}
