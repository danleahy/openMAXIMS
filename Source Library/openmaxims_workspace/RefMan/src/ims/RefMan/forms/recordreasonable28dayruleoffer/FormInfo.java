...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "RecordReasonable28DayRuleOffer";
	}
	public int getWidth()
	{
		return 456;
	...
	{
		return new String[] { "_cv_RefMan.TCIHistorySelected" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_RefMan.RecordReasonable28DayRuleOffer.__internal_x_context__" + String.valueOf(getFormId());
	}
