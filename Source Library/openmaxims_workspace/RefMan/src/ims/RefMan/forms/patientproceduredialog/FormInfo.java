...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_RefMan.AppointmentForPatientDiagnosisOrProcedures", "_cv_RefMan.ReferralClinicalNotes" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_RefMan.PatientProcedureDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
