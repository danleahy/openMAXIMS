...
public class GenForm extends FormBridge
{
	...
	public static class lyr1Layer extends Layer
	{
		...
		public static class tabFurtherManagementContainer extends LayerBridge
		{
			...
			public static class Group2RadioButton extends RadioButtonBridge
			{
				...
				protected void setContext(Integer startTabIndex, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize)
				{
					...
					control.addButton(1, anchoringHelper2.getX(), anchoringHelper2.getY(), anchoringHelper2.getWidth(), "", startTabIndex.intValue() + 13);
					...
					control.addButton(2, anchoringHelper3.getX(), anchoringHelper3.getY(), anchoringHelper3.getWidth(), "", startTabIndex.intValue() + 15);
				}
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				ims.framework.FormUiLogic m_ccAForm = loader.loadComponent(102228, appForm, startControlID * 10 + 1000, anchoringHelper4.getSize(), instance1, startTabIndex.intValue() + 9, skipContextValidation);
				//ims.framework.Control m_ccAControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1000), new Integer(8), new Integer(88), new Integer(300), new Integer(56), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT, new Integer(startTabIndex.intValue() + 9), m_ccAForm, instance1 } );
				ims.framework.Control m_ccAControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1001),  new Integer(anchoringHelper4.getX()), new Integer(anchoringHelper4.getY()), new Integer(anchoringHelper4.getWidth()), new Integer(anchoringHelper4.getHeight()), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT, new Integer(startTabIndex.intValue() + 9), m_ccAForm, instance1, Boolean.TRUE } );
				...
				super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1019), new Integer(anchoringHelper22.getX()), new Integer(anchoringHelper22.getY()), new Integer(anchoringHelper22.getWidth()), new Integer(anchoringHelper22.getHeight()), new Integer(startTabIndex.intValue() + 49), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT, "Cancel", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
				...
				super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1020), new Integer(anchoringHelper23.getX()), new Integer(anchoringHelper23.getY()), new Integer(anchoringHelper23.getWidth()), new Integer(anchoringHelper23.getHeight()), new Integer(startTabIndex.intValue() + 48), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT, "OK", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
				...
				super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1021), new Integer(anchoringHelper24.getX()), new Integer(anchoringHelper24.getY()), new Integer(anchoringHelper24.getWidth()), new Integer(anchoringHelper24.getHeight()), new Integer(startTabIndex.intValue() + 17), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT,Boolean.TRUE, new Integer(3000), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
				...
				super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1022), new Integer(anchoringHelper25.getX()), new Integer(anchoringHelper25.getY()), new Integer(anchoringHelper25.getWidth()), new Integer(anchoringHelper25.getHeight()), new Integer(startTabIndex.intValue() + 12), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT,Boolean.TRUE, new Integer(3000), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
				...
				ComboBox m_qmbProcedureTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1026), new Integer(anchoringHelper29.getX()), new Integer(anchoringHelper29.getY()), new Integer(anchoringHelper29.getWidth()), new Integer(anchoringHelper29.getHeight()), new Integer(startTabIndex.intValue() + 18), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT,Boolean.TRUE, Boolean.TRUE, SortOrder.NONE, Boolean.TRUE, new Integer(1), null, Boolean.FALSE, new Integer(-1), Boolean.FALSE});
				...
				Grid m_grdFurtherTemp = (Grid)factory.getControl(Grid.class, new Object[] { control, new Integer(startControlID.intValue() + 1028), new Integer(anchoringHelper31.getX()), new Integer(anchoringHelper31.getY()), new Integer(anchoringHelper31.getWidth()), new Integer(anchoringHelper31.getHeight()), new Integer(startTabIndex.intValue() + 8), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT,Boolean.TRUE, Boolean.FALSE, new Integer(24), Boolean.TRUE, contextMenus.contextMenuGenericGrid, Boolean.FALSE, Boolean.FALSE, new Integer(0), null, Boolean.FALSE, Boolean.TRUE});
		...
		public static class tabActiveMonitoringContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				ims.framework.FormUiLogic m_ccAMAuthoringForm = loader.loadComponent(102228, appForm, startControlID * 10 + 2000, anchoringHelper35.getSize(), instance1, startTabIndex.intValue() + 24, skipContextValidation);
				//ims.framework.Control m_ccAMAuthoringControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1033), new Integer(8), new Integer(8), new Integer(392), new Integer(56), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT, new Integer(startTabIndex.intValue() + 24), m_ccAMAuthoringForm, instance1 } );
				...
				super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1042), new Integer(anchoringHelper43.getX()), new Integer(anchoringHelper43.getY()), new Integer(anchoringHelper43.getWidth()), new Integer(anchoringHelper43.getHeight()), new Integer(startTabIndex.intValue() + 31), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT,Boolean.TRUE, new Integer(3000), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
				...
				super.addControl(factory.getControl(DateControl.class, new Object[] { control, new Integer(startControlID.intValue() + 1043), new Integer(anchoringHelper44.getX()), new Integer(anchoringHelper44.getY()), new Integer(anchoringHelper44.getWidth()), new Integer(anchoringHelper44.getHeight()), new Integer(startTabIndex.intValue() + 30), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.TRUE, null, Boolean.FALSE, null, Boolean.TRUE, null}));
				...
				super.addControl(factory.getControl(DateTimeControl.class, new Object[] { control, new Integer(startControlID.intValue() + 1044), new Integer(anchoringHelper45.getX()), new Integer(anchoringHelper45.getY()), new Integer(anchoringHelper45.getWidth()), new Integer(anchoringHelper45.getHeight()), new Integer(startTabIndex.intValue() + 27), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.TRUE, null, Boolean.FALSE, null, Boolean.TRUE, null}));
				...
				ComboBox m_cmbAMTypeTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1045), new Integer(anchoringHelper46.getX()), new Integer(anchoringHelper46.getY()), new Integer(anchoringHelper46.getWidth()), new Integer(anchoringHelper46.getHeight()), new Integer(startTabIndex.intValue() + 28), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT ,Boolean.TRUE, Boolean.TRUE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
				...
				super.addControl(factory.getControl(IntBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1047), new Integer(anchoringHelper48.getX()), new Integer(anchoringHelper48.getY()), new Integer(anchoringHelper48.getWidth()), new Integer(anchoringHelper48.getHeight()), new Integer(startTabIndex.intValue() + 29), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.TRUE, Boolean.TRUE, Boolean.TRUE, null, null, Boolean.TRUE, new Integer(9)}));
			}
		...
		public static class tabDischargePatientContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				ims.framework.FormUiLogic m_cc2Form = loader.loadComponent(102228, appForm, startControlID * 10 + 3000, anchoringHelper49.getSize(), instance1, startTabIndex.intValue() + 34, skipContextValidation);
				//ims.framework.Control m_cc2Control = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1048), new Integer(0), new Integer(8), new Integer(300), new Integer(64), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT, new Integer(startTabIndex.intValue() + 34), m_cc2Form, instance1 } );
				ims.framework.Control m_cc2Control = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1049),  new Integer(anchoringHelper49.getX()), new Integer(anchoringHelper49.getY()), new Integer(anchoringHelper49.getWidth()), new Integer(anchoringHelper49.getHeight()), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT, new Integer(startTabIndex.intValue() + 34), m_cc2Form, instance1, Boolean.TRUE } );
				...
				super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1058), new Integer(anchoringHelper58.getX()), new Integer(anchoringHelper58.getY()), new Integer(anchoringHelper58.getWidth()), new Integer(anchoringHelper58.getHeight()), new Integer(startTabIndex.intValue() + 42), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT,Boolean.TRUE, new Integer(3000), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
				...
				super.addControl(factory.getControl(DateControl.class, new Object[] { control, new Integer(startControlID.intValue() + 1059), new Integer(anchoringHelper59.getX()), new Integer(anchoringHelper59.getY()), new Integer(anchoringHelper59.getWidth()), new Integer(anchoringHelper59.getHeight()), new Integer(startTabIndex.intValue() + 37), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.TRUE, null, Boolean.FALSE, null, Boolean.TRUE, null}));
				...
				ComboBox m_cmbOnwardRefReasonTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1060), new Integer(anchoringHelper60.getX()), new Integer(anchoringHelper60.getY()), new Integer(anchoringHelper60.getWidth()), new Integer(anchoringHelper60.getHeight()), new Integer(startTabIndex.intValue() + 39), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.TRUE, new Integer(-1)});
				...
				ComboBox m_cmbSecondaryOrganisationTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1061), new Integer(anchoringHelper61.getX()), new Integer(anchoringHelper61.getY()), new Integer(anchoringHelper61.getWidth()), new Integer(anchoringHelper61.getHeight()), new Integer(startTabIndex.intValue() + 41), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT ,Boolean.TRUE, Boolean.FALSE, SortOrder.ASCENDING, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
				...
				ComboBox m_cmbOtherTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1062), new Integer(anchoringHelper62.getX()), new Integer(anchoringHelper62.getY()), new Integer(anchoringHelper62.getWidth()), new Integer(anchoringHelper62.getHeight()), new Integer(startTabIndex.intValue() + 40), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT ,Boolean.TRUE, Boolean.TRUE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
				...
				super.addControl(factory.getControl(CheckBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1064), new Integer(anchoringHelper64.getX()), new Integer(anchoringHelper64.getY()), new Integer(anchoringHelper64.getWidth()), new Integer(anchoringHelper64.getHeight()), new Integer(startTabIndex.intValue() + 47), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT ,"Copy To Secondary Care", Boolean.FALSE, null}));
				...
				super.addControl(factory.getControl(CheckBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1065), new Integer(anchoringHelper65.getX()), new Integer(anchoringHelper65.getY()), new Integer(anchoringHelper65.getWidth()), new Integer(anchoringHelper65.getHeight()), new Integer(startTabIndex.intValue() + 46), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT ,"Copy To Patient", Boolean.FALSE, null}));
				...
				super.addControl(factory.getControl(CheckBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1066), new Integer(anchoringHelper66.getX()), new Integer(anchoringHelper66.getY()), new Integer(anchoringHelper66.getWidth()), new Integer(anchoringHelper66.getHeight()), new Integer(startTabIndex.intValue() + 45), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT ,"Copy To GP", Boolean.FALSE, null}));
				...
				Grid m_grdInvestigationTemp = (Grid)factory.getControl(Grid.class, new Object[] { control, new Integer(startControlID.intValue() + 1068), new Integer(anchoringHelper68.getX()), new Integer(anchoringHelper68.getY()), new Integer(anchoringHelper68.getWidth()), new Integer(anchoringHelper68.getHeight()), new Integer(startTabIndex.intValue() + 43), ControlState.READONLY, ControlState.EDITABLE, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT,Boolean.FALSE, Boolean.FALSE, new Integer(24), Boolean.TRUE, null, Boolean.TRUE, Boolean.FALSE, new Integer(0), null, Boolean.FALSE, Boolean.TRUE});
	...
	public static class GrpDischPatientRadioButton extends RadioButtonBridge
	{
		...
		protected void setContext(Integer startTabIndex, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize)
		{
			...
			control.addButton(1, anchoringHelper73.getX(), anchoringHelper73.getY(), anchoringHelper73.getWidth(), "", startTabIndex.intValue() + 3);
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1077), new Integer(anchoringHelper80.getX()), new Integer(anchoringHelper80.getY()), new Integer(anchoringHelper80.getWidth()), new Integer(anchoringHelper80.getHeight()), new Integer(startTabIndex.intValue() + 7), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT, "Edit Date", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1078), new Integer(anchoringHelper81.getX()), new Integer(anchoringHelper81.getY()), new Integer(anchoringHelper81.getWidth()), new Integer(anchoringHelper81.getHeight()), new Integer(startTabIndex.intValue() + 53), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Remove Patient from Active Monitoring", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1079), new Integer(anchoringHelper82.getX()), new Integer(anchoringHelper82.getY()), new Integer(anchoringHelper82.getWidth()), new Integer(anchoringHelper82.getHeight()), new Integer(startTabIndex.intValue() + 54), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "GP Discharge Outcome Reviewed", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1080), new Integer(anchoringHelper83.getX()), new Integer(anchoringHelper83.getY()), new Integer(anchoringHelper83.getWidth()), new Integer(anchoringHelper83.getHeight()), new Integer(startTabIndex.intValue() + 55), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Onward Referral Completed", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1081), new Integer(anchoringHelper84.getX()), new Integer(anchoringHelper84.getY()), new Integer(anchoringHelper84.getWidth()), new Integer(anchoringHelper84.getHeight()), new Integer(startTabIndex.intValue() + 52), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Undo Discharge", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1083), new Integer(anchoringHelper86.getX()), new Integer(anchoringHelper86.getY()), new Integer(anchoringHelper86.getWidth()), new Integer(anchoringHelper86.getHeight()), new Integer(startTabIndex.intValue() + 5), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT, "Print Prescription", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1084), new Integer(anchoringHelper87.getX()), new Integer(anchoringHelper87.getY()), new Integer(anchoringHelper87.getWidth()), new Integer(anchoringHelper87.getHeight()), new Integer(startTabIndex.intValue() + 6), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT, "Print Disch Report", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1086), new Integer(anchoringHelper89.getX()), new Integer(anchoringHelper89.getY()), new Integer(anchoringHelper89.getWidth()), new Integer(anchoringHelper89.getHeight()), new Integer(startTabIndex.intValue() + 56), ControlState.HIDDEN, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Save", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1087), new Integer(anchoringHelper90.getX()), new Integer(anchoringHelper90.getY()), new Integer(anchoringHelper90.getWidth()), new Integer(anchoringHelper90.getHeight()), new Integer(startTabIndex.intValue() + 51), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Edit", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(DateTimeControl.class, new Object[] { control, new Integer(startControlID.intValue() + 1088), new Integer(anchoringHelper91.getX()), new Integer(anchoringHelper91.getY()), new Integer(anchoringHelper91.getWidth()), new Integer(anchoringHelper91.getHeight()), new Integer(startTabIndex.intValue() + 4), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT,Boolean.TRUE, null, Boolean.FALSE, null, Boolean.FALSE, null}));
	...
	private class ReportFields
	{
		...
		{
			String prefix = formInfo.getLocalVariablesPrefix();
			IReportField[] fields = new IReportField[229];
			...
			fields[144] = new ims.framework.ReportField(this.context, "_cv_Core.SelectMedication.SelectedMedication", "BO-1003100024-ID", "ID_Medication");
			fields[145] = new ims.framework.ReportField(this.context, "_cv_Core.SelectMedication.SelectedMedication", "BO-1003100024-MEDICATIONNAME", "MedicationName");
			fields[146] = new ims.framework.ReportField(this.context, "_cv_Core.SelectMedication.SelectedMedication", "BO-1003100024-ISACTIVE", "IsActive");
			fields[147] = new ims.framework.ReportField(this.context, "_cv_Core.SelectMedication.SelectedMedication", "BO-1003100024-ISCONTROLLEDDRUG", "IsControlledDrug");
			fields[148] = new ims.framework.ReportField(this.context, "_cv_Core.SelectMedication.SelectedMedication", "BO-1003100024-FREQUENCYDEFAULT", "FrequencyDefault");
			fields[149] = new ims.framework.ReportField(this.context, "_cv_Core.SelectMedication.SelectedMedication", "BO-1003100024-NOOFDAYSSUPPLYDEFAULT", "NoOfDaysSupplyDefault");
			fields[150] = new ims.framework.ReportField(this.context, "_cv_RefMan.SelectedReferralOutcomeVo", "BO-1096100005-ID", "ID_ReferralOutcome");
			fields[151] = new ims.framework.ReportField(this.context, "_cv_RefMan.SelectedReferralOutcomeVo", "BO-1096100005-CATSREFERRAL", "CatsReferral");
			fields[152] = new ims.framework.ReportField(this.context, "_cv_RefMan.SelectedReferralOutcomeVo", "BO-1096100005-CATSFINALREPORTSTATUS", "CatsFinalReportStatus");
			fields[153] = new ims.framework.ReportField(this.context, "_cv_RefMan.CatsReferralReports", "BO-1004100035-ID", "ID_CatsReferral");
			fields[154] = new ims.framework.ReportField(this.context, "_cv_RefMan.CatsReferralReports", "BO-1004100035-ISFINALREPORTREQUIRED", "IsFinalReportRequired");
			fields[155] = new ims.framework.ReportField(this.context, "_cv_RefMan.CatsReferralReports", "BO-1004100035-CATSREPORTSENTDATE", "CATSReportSentDate");
			fields[156] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralOutcomeComponent.__internal_x_context__currentOutcomeVo_" + componentIdentifier, "BO-1096100005-ID", "ID_ReferralOutcome");
			fields[157] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralOutcomeComponent.__internal_x_context__currentOutcomeVo_" + componentIdentifier, "BO-1096100005-CATSREFERRAL", "CatsReferral");
			fields[158] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralOutcomeComponent.__internal_x_context__currentOutcomeVo_" + componentIdentifier, "BO-1096100005-CATSFINALREPORTSTATUS", "CatsFinalReportStatus");
			fields[159] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralOutcomeComponent.__internal_x_context__CurrentService_" + componentIdentifier, "BO-1003100032-ID", "ID_Service");
			fields[160] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralOutcomeComponent.__internal_x_context__CurrentService_" + componentIdentifier, "BO-1003100032-SERVICENAME", "ServiceName");
			fields[161] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralOutcomeComponent.__internal_x_context__CurrentService_" + componentIdentifier, "BO-1003100032-SERVICECATEGORY", "ServiceCategory");
			fields[162] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralOutcomeComponent.__internal_x_context__CurrentService_" + componentIdentifier, "BO-1003100032-CANBESCHEDULED", "CanBeScheduled");
			fields[163] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralOutcomeComponent.__internal_x_context__CurrentService_" + componentIdentifier, "BO-1003100032-SPECIALTY", "Specialty");
			fields[164] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralOutcomeComponent.__internal_x_context__CurrentService_" + componentIdentifier, "BO-1003100032-EXPECTEDTURNAROUND", "ExpectedTurnaround");
			fields[165] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralOutcomeComponent.__internal_x_context__CurrentService_" + componentIdentifier, "BO-1003100032-TURNAROUNDMEASURE", "TurnaroundMeasure");
			fields[166] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralOutcomeComponent.__internal_x_context__CurrentService_" + componentIdentifier, "BO-1003100032-MATERNITYINDICATOR", "MaternityIndicator");
			fields[167] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralOutcomeComponent.__internal_x_context__CurrentService_" + componentIdentifier, "BO-1003100032-ISACTIVE", "IsActive");
			fields[168] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralOutcomeComponent.__internal_x_context__CurrentService_" + componentIdentifier, "BO-1003100032-ISSUBJECTTORTTCLOCK", "IsSubjectToRTTClock");
			fields[169] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralOutcomeComponent.__internal_x_context__CurrentService_" + componentIdentifier, "BO-1003100032-DIRECTSELFREFERRALSACCEPTED", "DirectSelfReferralsAccepted");
			fields[170] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralOutcomeComponent.__internal_x_context__CurrentService_" + componentIdentifier, "BO-1003100032-ISPREASSESSMENTCOMPLETIONEXEMPT", "IsPreAssessmentCompletionExempt");
			fields[171] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralOutcomeComponent.__internal_x_context__CurrentService_" + componentIdentifier, "BO-1003100032-SERVICEDESCRIPTION", "ServiceDescription");
			fields[172] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralOutcomeComponent.__internal_x_context__CurrentService_" + componentIdentifier, "BO-1003100032-ALTERNATESERVICECODE", "AlternateServiceCode");
			fields[173] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralOutcomeComponent.__internal_x_context__InvalidOnwardReferral_" + componentIdentifier, "BO-1096100020-ID", "ID_OnwardReferral");
			fields[174] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralOutcomeComponent.__internal_x_context__InvalidOnwardReferral_" + componentIdentifier, "BO-1096100020-DISCHARGEDATE", "DischargeDate");
			fields[175] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralOutcomeComponent.__internal_x_context__InvalidOnwardReferral_" + componentIdentifier, "BO-1096100020-ONWARDREFERRAL", "OnwardReferral");
			fields[176] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralOutcomeComponent.__internal_x_context__InvalidOnwardReferral_" + componentIdentifier, "BO-1096100020-REJECTEDDATE", "RejectedDate");
			fields[177] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralOutcomeComponent.__internal_x_context__InvalidOnwardReferral_" + componentIdentifier, "BO-1096100020-REJECTIONREASON", "RejectionReason");
			fields[178] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralOutcomeComponent.__internal_x_context__InvalidOnwardReferral_" + componentIdentifier, "BO-1096100020-REJECTEDBY", "RejectedBy");
			fields[179] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralOutcomeComponent.__internal_x_context__InvalidOnwardReferral_" + componentIdentifier, "BO-1096100020-ONWARDREFERRALREASON", "OnwardReferralReason");
			fields[180] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralOutcomeComponent.__internal_x_context__InvalidOnwardReferral_" + componentIdentifier, "BO-1096100020-COPYTOGP", "CopyToGP");
			fields[181] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralOutcomeComponent.__internal_x_context__InvalidOnwardReferral_" + componentIdentifier, "BO-1096100020-COPYTOPATIENT", "CopyToPatient");
			fields[182] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralOutcomeComponent.__internal_x_context__InvalidOnwardReferral_" + componentIdentifier, "BO-1096100020-COPYTOSECONDARYCARE", "CopyToSecondaryCare");
			fields[183] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralOutcomeComponent.__internal_x_context__CurrentCatsReferral_" + componentIdentifier, "BO-1004100035-ID", "ID_CatsReferral");
			fields[184] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralOutcomeComponent.__internal_x_context__CurrentCatsReferral_" + componentIdentifier, "BO-1004100035-CARECONTEXT", "CareContext");
			fields[185] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralOutcomeComponent.__internal_x_context__CurrentCatsReferral_" + componentIdentifier, "BO-1004100035-ADDITIONALINVAPPTSSTATUS", "AdditionalInvApptsStatus");
			fields[186] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralOutcomeComponent.__internal_x_context__CurrentCatsReferral_" + componentIdentifier, "BO-1004100035-HASINVESTIGATIONS", "HasInvestigations");
			fields[187] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralOutcomeComponent.__internal_x_context__CurrentCatsReferral_" + componentIdentifier, "BO-1004100035-HASAPPOINTMENTS", "HasAppointments");
			fields[188] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralOutcomeComponent.__internal_x_context__CurrentCatsReferral_" + componentIdentifier, "BO-1004100035-HASDOCUMENTS", "HasDocuments");
			fields[189] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralOutcomeComponent.__internal_x_context__CurrentCatsReferral_" + componentIdentifier, "BO-1004100035-HASREFERRALLETTER", "HasReferralLetter");
			fields[190] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralOutcomeComponent.__internal_x_context__CurrentCatsReferral_" + componentIdentifier, "BO-1004100035-ISCAB", "IsCAB");
			fields[191] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralOutcomeComponent.__internal_x_context__CurrentCatsReferral_" + componentIdentifier, "BO-1004100035-HASREJECTEDINV", "HasRejectedInv");
			fields[192] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralOutcomeComponent.__internal_x_context__CurrentCatsReferral_" + componentIdentifier, "BO-1004100035-ONWARDREFERRALSTATUS", "OnwardReferralStatus");
			fields[193] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralOutcomeComponent.__internal_x_context__CurrentCatsReferral_" + componentIdentifier, "BO-1004100035-PROVIDERCANCELLATION", "ProviderCancellation");
			fields[194] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralOutcomeComponent.__internal_x_context__CurrentCatsReferral_" + componentIdentifier, "BO-1004100035-HASCONSULTATIONDETAILS", "HasConsultationDetails");
			fields[195] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralOutcomeComponent.__internal_x_context__CurrentCatsReferral_" + componentIdentifier, "BO-1004100035-DISCHARGEDATE", "DischargeDate");
			fields[196] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralOutcomeComponent.__internal_x_context__CurrentCatsReferral_" + componentIdentifier, "BO-1004100035-ISFINALREPORTREQUIRED", "IsFinalReportRequired");
			fields[197] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralOutcomeComponent.__internal_x_context__CurrentCatsReferral_" + componentIdentifier, "BO-1004100035-TRIAGEDATETIME", "TriageDateTime");
			fields[198] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralOutcomeComponent.__internal_x_context__CurrentCatsReferral_" + componentIdentifier, "BO-1004100035-LASTAPPTARRIVEDDATE", "LastApptArrivedDate");
			fields[199] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralOutcomeComponent.__internal_x_context__CurrentCatsReferral_" + componentIdentifier, "BO-1004100035-ISACCEPTEDONCAB", "IsAcceptedOnCAB");
			fields[200] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralOutcomeComponent.__internal_x_context__CurrentCatsReferral_" + componentIdentifier, "BO-1004100035-ISREFERRALREJECTEDONCAB", "IsReferralRejectedOnCAB");
			fields[201] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralOutcomeComponent.__internal_x_context__CurrentCatsReferral_" + componentIdentifier, "BO-1004100035-WASPATIENTREJECTIONLETTERSENT", "WasPatientRejectionLetterSent");
			fields[202] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralOutcomeComponent.__internal_x_context__CurrentCatsReferral_" + componentIdentifier, "BO-1004100035-WASPATIENTPROVIDERCANCELLATIONLETTERSENT", "WasPatientProviderCancellationLetterSent");
			fields[203] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralOutcomeComponent.__internal_x_context__CurrentCatsReferral_" + componentIdentifier, "BO-1004100035-REQUIRESDISCHARGEREP", "RequiresDischargeRep");
			fields[204] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralOutcomeComponent.__internal_x_context__CurrentCatsReferral_" + componentIdentifier, "BO-1004100035-ISSECONDARYREPORTREQUIRED", "IsSecondaryReportRequired");
			fields[205] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralOutcomeComponent.__internal_x_context__CurrentCatsReferral_" + componentIdentifier, "BO-1004100035-WASFURTHERMANAGEMENTDETAILSREVIEWED", "WasFurtherManagementDetailsReviewed");
			fields[206] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralOutcomeComponent.__internal_x_context__CurrentCatsReferral_" + componentIdentifier, "BO-1004100035-ONWARDREFERRALREASON", "OnwardReferralReason");
			fields[207] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralOutcomeComponent.__internal_x_context__CurrentCatsReferral_" + componentIdentifier, "BO-1004100035-DISCHARGETOGPDETAILSREVIEWSTATUS", "DischargeToGPDetailsReviewStatus");
			fields[208] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralOutcomeComponent.__internal_x_context__CurrentCatsReferral_" + componentIdentifier, "BO-1004100035-ISSUITABLEFORSURGERY", "IsSuitableForSurgery");
			fields[209] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralOutcomeComponent.__internal_x_context__CurrentCatsReferral_" + componentIdentifier, "BO-1004100035-ISFITFORSURGERY", "IsFitForSurgery");
			fields[210] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralOutcomeComponent.__internal_x_context__CurrentCatsReferral_" + componentIdentifier, "BO-1004100035-ISAWAITINGCLINICALINFO", "IsAwaitingClinicalInfo");
			fields[211] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralOutcomeComponent.__internal_x_context__CurrentCatsReferral_" + componentIdentifier, "BO-1004100035-ISACTIVEMONITORAPPTREQUIRED", "IsActiveMonitorApptRequired");
			fields[212] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralOutcomeComponent.__internal_x_context__CurrentCatsReferral_" + componentIdentifier, "BO-1004100035-CATSREPORTSENTDATE", "CATSReportSentDate");
			fields[213] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralOutcomeComponent.__internal_x_context__CurrentCatsReferral_" + componentIdentifier, "BO-1004100035-ENDOFCAREDATE", "EndOfCareDate");
			fields[214] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralOutcomeComponent.__internal_x_context__CurrentCatsReferral_" + componentIdentifier, "BO-1004100035-PROCEDUREFORPOSTOPREVIEW", "ProcedureForPostOpReview");
			fields[215] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralOutcomeComponent.__internal_x_context__CurrentCatsReferral_" + componentIdentifier, "BO-1004100035-REFERRALCATEGORY", "ReferralCategory");
			fields[216] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralOutcomeComponent.__internal_x_context__CurrentCatsReferral_" + componentIdentifier, "BO-1004100035-ISONWARDREFERRALTRIAGE", "IsOnwardReferralTriage");
			fields[217] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralOutcomeComponent.__internal_x_context__CurrentCatsReferral_" + componentIdentifier, "BO-1004100035-URGENCY", "Urgency");
			fields[218] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralOutcomeComponent.__internal_x_context__CurrentCatsReferral_" + componentIdentifier, "BO-1004100035-PATHWAYID", "PathwayID");
			fields[219] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralOutcomeComponent.__internal_x_context__CurrentCatsReferral_" + componentIdentifier, "BO-1004100035-RTTCLOCKIMPACT", "RTTClockImpact");
			fields[220] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralOutcomeComponent.__internal_x_context__CurrentCatsReferral_" + componentIdentifier, "BO-1004100035-CONSUPGRADEDATE", "ConsUpgradeDate");
			fields[221] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralOutcomeComponent.__internal_x_context__CurrentCatsReferral_" + componentIdentifier, "BO-1004100035-CANCERTYPE", "CancerType");
			fields[222] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralOutcomeComponent.__internal_x_context__CurrentCatsReferral_" + componentIdentifier, "BO-1004100035-EPISODEOFCARE", "EpisodeOfCare");
			fields[223] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralOutcomeComponent.__internal_x_context__CurrentCatsReferral_" + componentIdentifier, "BO-1004100035-CURRENT31TARGETDATE", "Current31TargetDate");
			fields[224] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralOutcomeComponent.__internal_x_context__CurrentCatsReferral_" + componentIdentifier, "BO-1004100035-CURRENT62TARGETDATE", "Current62TargetDate");
			fields[225] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralOutcomeComponent.__internal_x_context__CurrentCatsReferral_" + componentIdentifier, "BO-1004100035-PATIENTCATEGORY", "PatientCategory");
			fields[226] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralOutcomeComponent.__internal_x_context__CurrentCatsReferral_" + componentIdentifier, "BO-1004100035-ISEMERGENCYREFERRAL", "IsEmergencyReferral");
			fields[227] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralOutcomeComponent.__internal_x_context__CurrentCatsReferral_" + componentIdentifier, "BO-1004100035-MANUALLYMARKEDASNOTRTTIMPACT", "ManuallyMarkedAsNotRTTImpact");
			fields[228] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.ReferralOutcomeComponent.__internal_x_context__CurrentCatsReferral_" + componentIdentifier, "BO-1004100035-CHANGECBAPPOINTMENT", "ChangeCBAppointment");
			return fields;
		}
