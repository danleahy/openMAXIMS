...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_RefMan.LinkApptsOnMultipleBooking", "_cv_RefMan.LinkedAppointmentsCollection" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_RefMan.LinkAppointments.__internal_x_context__" + String.valueOf(getFormId());
	}
