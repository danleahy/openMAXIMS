...
abstract public class Handlers implements ims.framework.UILogic, IFormUILogicCode
{
	...
	abstract protected void onGrdAppointmetsGridCheckBoxClicked(int column, GenForm.grdAppointmetsRow row, boolean isChecked) throws ims.framework.exceptions.PresentationLogicException;
	...
	public final void setContext(ims.framework.UIEngine engine, GenForm form)
	{
		...
		this.form.grdAppointmets().setGridCheckBoxClickedEvent(new GridCheckBoxClicked()
		{
			private static final long serialVersionUID = 1L;
			...
			{
				onGrdAppointmetsGridCheckBoxClicked(column, new GenForm.grdAppointmetsRow(row), isChecked);
			}
		});
