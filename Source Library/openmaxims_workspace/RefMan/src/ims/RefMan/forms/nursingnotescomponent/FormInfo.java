...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_RefMan.SelectedSpecialty", "_cv_Core.SelectMedication.SelectedMedication", "_cv_Core.YesNoDialogMessage" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_RefMan.NursingNotesComponent.__internal_x_context__" + String.valueOf(getFormId());
	}
