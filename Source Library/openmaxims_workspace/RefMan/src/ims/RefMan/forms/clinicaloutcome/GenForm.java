...
public class GenForm extends FormBridge
{
	...
	private void validateContext(ims.framework.Context context)
	{
		...
		if(!context.isValidContextType(ims.RefMan.vo.ClinicalOutcomeSearchCriteriaVo.class))
			throw new ims.framework.exceptions.CodingRuntimeException("The type 'ims.RefMan.vo.ClinicalOutcomeSearchCriteriaVo' of the global context variable 'RefMan.ClinicalOutcomeSearchCriteria' is not supported.");
	}
