...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Core.TaxonomyMap", "_cv_Core.TaxonomySearchForName", "_cv_RefMan.SelectedPatientDiagnosisListVoCollection", "_cv_Clinical.PatientProcedureForIntraOperativeDialog", "_cv_RefMan.DischargedEpisodeForReferralCoding" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_RefMan.ReferralCoding.__internal_x_context__" + String.valueOf(getFormId());
	}
