...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "CatsReferralRequestServiceDlg";
	}
	public int getWidth()
	{
		return 640;
	...
	{
		return new String[] { "_cv_Core.RieMessage", "_cv_RefMan.ReferralServiceRequests" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_RefMan.CatsReferralRequestServiceDlg.__internal_x_context__" + String.valueOf(getFormId());
	}
