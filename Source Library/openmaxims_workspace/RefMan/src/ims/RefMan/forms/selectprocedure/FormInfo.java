...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_RefMan.procedureListForActivity", "_cv_RefMan.unavailableProcedures", "_cv_RefMan.AssociatedProcedures" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_RefMan.SelectProcedure.__internal_x_context__" + String.valueOf(getFormId());
	}
