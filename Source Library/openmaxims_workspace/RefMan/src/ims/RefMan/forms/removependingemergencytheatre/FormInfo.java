...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "RemovePendingEmergencyTheatre";
	}
	public int getWidth()
	{
		return 536;
	...
	{
		return new String[] { "_cv_Scheduling.PendingEmergencyTheatreRemoval" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_RefMan.RemovePendingEmergencyTheatre.__internal_x_context__" + String.valueOf(getFormId());
	}
