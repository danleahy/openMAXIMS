...
public class GenForm extends FormBridge
{
	...
	public static class ctnContainer extends ContainerBridge
	{
		...
		protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
		{
			...
			ims.framework.FormUiLogic m_ccAuthForm = loader.loadComponent(102228, appForm, startControlID * 10 + 1000, anchoringHelper1.getSize(), instance1, startTabIndex.intValue() + 24, skipContextValidation);
			//ims.framework.Control m_ccAuthControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1000), new Integer(392), new Integer(576), new Integer(423), new Integer(56), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, new Integer(startTabIndex.intValue() + 24), m_ccAuthForm, instance1 } );
			ims.framework.Control m_ccAuthControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1001),  new Integer(anchoringHelper1.getX()), new Integer(anchoringHelper1.getY()), new Integer(anchoringHelper1.getWidth()), new Integer(anchoringHelper1.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, new Integer(startTabIndex.intValue() + 24), m_ccAuthForm, instance1, Boolean.FALSE } );
			...
			super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1028), new Integer(anchoringHelper28.getX()), new Integer(anchoringHelper28.getY()), new Integer(anchoringHelper28.getWidth()), new Integer(anchoringHelper28.getHeight()), new Integer(startTabIndex.intValue() + 19), ControlState.DISABLED, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT,Boolean.FALSE, new Integer(10), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
			...
			super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1031), new Integer(anchoringHelper31.getX()), new Integer(anchoringHelper31.getY()), new Integer(anchoringHelper31.getWidth()), new Integer(anchoringHelper31.getHeight()), new Integer(startTabIndex.intValue() + 18), ControlState.DISABLED, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT,Boolean.FALSE, new Integer(0), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
			...
			super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1036), new Integer(anchoringHelper36.getX()), new Integer(anchoringHelper36.getY()), new Integer(anchoringHelper36.getWidth()), new Integer(anchoringHelper36.getHeight()), new Integer(startTabIndex.intValue() + 8), ControlState.DISABLED, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.TOPRIGHT,Boolean.FALSE, new Integer(0), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
			...
			super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1037), new Integer(anchoringHelper37.getX()), new Integer(anchoringHelper37.getY()), new Integer(anchoringHelper37.getWidth()), new Integer(anchoringHelper37.getHeight()), new Integer(startTabIndex.intValue() + 16), ControlState.DISABLED, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT,Boolean.FALSE, new Integer(0), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
			...
			super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1038), new Integer(anchoringHelper38.getX()), new Integer(anchoringHelper38.getY()), new Integer(anchoringHelper38.getWidth()), new Integer(anchoringHelper38.getHeight()), new Integer(startTabIndex.intValue() + 17), ControlState.DISABLED, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT,Boolean.FALSE, new Integer(0), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
			...
			ComboBox m_cmbFollowUpTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1041), new Integer(anchoringHelper41.getX()), new Integer(anchoringHelper41.getY()), new Integer(anchoringHelper41.getWidth()), new Integer(anchoringHelper41.getHeight()), new Integer(startTabIndex.intValue() + 22), ControlState.DISABLED, ControlState.ENABLED,ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
			...
			super.addControl(factory.getControl(RichTextControl.class, new Object[] { control, new Integer(startControlID.intValue() + 1043), new Integer(anchoringHelper43.getX()), new Integer(anchoringHelper43.getY()), new Integer(anchoringHelper43.getWidth()), new Integer(anchoringHelper43.getHeight()), new Integer(startTabIndex.intValue() + 13), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.ALL, Boolean.FALSE, Boolean.TRUE, new Integer(5000)} ));
			...
			super.addControl(factory.getControl(RichTextControl.class, new Object[] { control, new Integer(startControlID.intValue() + 1044), new Integer(anchoringHelper44.getX()), new Integer(anchoringHelper44.getY()), new Integer(anchoringHelper44.getWidth()), new Integer(anchoringHelper44.getHeight()), new Integer(startTabIndex.intValue() + 14), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.TOPBOTTOMRIGHT, Boolean.FALSE, Boolean.TRUE, new Integer(5000)} ));
			...
			super.addControl(factory.getControl(RichTextControl.class, new Object[] { control, new Integer(startControlID.intValue() + 1045), new Integer(anchoringHelper45.getX()), new Integer(anchoringHelper45.getY()), new Integer(anchoringHelper45.getWidth()), new Integer(anchoringHelper45.getHeight()), new Integer(startTabIndex.intValue() + 15), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFTRIGHT, Boolean.FALSE, Boolean.TRUE, new Integer(5000)} ));
			...
			super.addControl(factory.getControl(RichTextControl.class, new Object[] { control, new Integer(startControlID.intValue() + 1046), new Integer(anchoringHelper46.getX()), new Integer(anchoringHelper46.getY()), new Integer(anchoringHelper46.getWidth()), new Integer(anchoringHelper46.getHeight()), new Integer(startTabIndex.intValue() + 20), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFTRIGHT, Boolean.FALSE, Boolean.TRUE, new Integer(2000)} ));
			...
			super.addControl(factory.getControl(RichTextControl.class, new Object[] { control, new Integer(startControlID.intValue() + 1048), new Integer(anchoringHelper48.getX()), new Integer(anchoringHelper48.getY()), new Integer(anchoringHelper48.getWidth()), new Integer(anchoringHelper48.getHeight()), new Integer(startTabIndex.intValue() + 21), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFTRIGHT, Boolean.FALSE, Boolean.TRUE, new Integer(5000)} ));
		}
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1050), new Integer(anchoringHelper50.getX()), new Integer(anchoringHelper50.getY()), new Integer(anchoringHelper50.getWidth()), new Integer(anchoringHelper50.getHeight()), new Integer(startTabIndex.intValue() + 28), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Edit", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1052), new Integer(anchoringHelper52.getX()), new Integer(anchoringHelper52.getY()), new Integer(anchoringHelper52.getWidth()), new Integer(anchoringHelper52.getHeight()), new Integer(startTabIndex.intValue() + 29), ControlState.HIDDEN, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Save", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1053), new Integer(anchoringHelper53.getX()), new Integer(anchoringHelper53.getY()), new Integer(anchoringHelper53.getWidth()), new Integer(anchoringHelper53.getHeight()), new Integer(startTabIndex.intValue() + 30), ControlState.HIDDEN, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Cancel", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[175] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.SurgicalOperationNotes.__internal_x_context__CurrentRecord_" + componentIdentifier, "BO-1096100053-ID", "ID_SurgicalOpNotes");
			fields[176] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.SurgicalOperationNotes.__internal_x_context__CurrentRecord_" + componentIdentifier, "BO-1096100053-CARECONTEXT", "CareContext");
			fields[177] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.SurgicalOperationNotes.__internal_x_context__CurrentRecord_" + componentIdentifier, "BO-1096100053-INTRAOPERATIVECARERECORD", "IntraOperativeCareRecord");
			fields[178] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.SurgicalOperationNotes.__internal_x_context__CurrentRecord_" + componentIdentifier, "BO-1096100053-INCISION", "Incision");
			fields[179] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.SurgicalOperationNotes.__internal_x_context__CurrentRecord_" + componentIdentifier, "BO-1096100053-FINDINGS", "Findings");
			fields[180] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.SurgicalOperationNotes.__internal_x_context__CurrentRecord_" + componentIdentifier, "BO-1096100053-PROCEDURE", "Procedure");
			fields[181] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.SurgicalOperationNotes.__internal_x_context__CurrentRecord_" + componentIdentifier, "BO-1096100053-CLOSURE", "Closure");
			fields[182] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.SurgicalOperationNotes.__internal_x_context__CurrentRecord_" + componentIdentifier, "BO-1096100053-POSTOPINSTRUCTIONS", "PostOpInstructions");
			fields[183] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.SurgicalOperationNotes.__internal_x_context__CurrentRecord_" + componentIdentifier, "BO-1096100053-COMPLICATIONS", "Complications");
			fields[184] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.SurgicalOperationNotes.__internal_x_context__CurrentRecord_" + componentIdentifier, "BO-1096100053-LAINFILTRATION", "LAInfiltration");
			fields[185] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.SurgicalOperationNotes.__internal_x_context__CurrentRecord_" + componentIdentifier, "BO-1096100053-PREOPERATIVEDIAGNOSIS", "PreOperativeDiagnosis");
			fields[186] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.SurgicalOperationNotes.__internal_x_context__CurrentRecord_" + componentIdentifier, "BO-1096100053-ANTIBIOTICS", "Antibiotics");
			fields[187] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.SurgicalOperationNotes.__internal_x_context__CurrentRecord_" + componentIdentifier, "BO-1096100053-VTE", "VTE");
			fields[188] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.SurgicalOperationNotes.__internal_x_context__CurrentRecord_" + componentIdentifier, "BO-1096100053-EBI", "EBI");
			fields[189] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.SurgicalOperationNotes.__internal_x_context__CurrentRecord_" + componentIdentifier, "BO-1096100053-FOLLOWUPTYPE", "FollowUpType");
			fields[190] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.SurgicalOperationNotes.__internal_x_context__CurrentRecord_" + componentIdentifier, "BO-1096100053-FOLLOWUPTYPEIN", "FollowUpTypeIn");
			fields[191] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.SurgicalOperationNotes.__internal_x_context__CurrentSurgicalConfig_" + componentIdentifier, "BO-1073100029-ID", "ID_SurgicalOperationDetailsConfig");
			fields[192] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.SurgicalOperationNotes.__internal_x_context__CurrentSurgicalConfig_" + componentIdentifier, "BO-1073100029-PROCEDURE", "Procedure");
			fields[193] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.SurgicalOperationNotes.__internal_x_context__CurrentSurgicalConfig_" + componentIdentifier, "BO-1073100029-INCISION", "Incision");
			fields[194] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.SurgicalOperationNotes.__internal_x_context__CurrentSurgicalConfig_" + componentIdentifier, "BO-1073100029-FINDINGS", "Findings");
			fields[195] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.SurgicalOperationNotes.__internal_x_context__CurrentSurgicalConfig_" + componentIdentifier, "BO-1073100029-CLOSURE", "Closure");
			fields[196] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.SurgicalOperationNotes.__internal_x_context__CurrentSurgicalConfig_" + componentIdentifier, "BO-1073100029-POSTOPINSTRUCTIONS", "PostOpInstructions");
			fields[197] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.SurgicalOperationNotes.__internal_x_context__CurrentSurgicalConfig_" + componentIdentifier, "BO-1073100029-PROSTHESIS", "Prosthesis");
			fields[198] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.SurgicalOperationNotes.__internal_x_context__CurrentSurgicalConfig_" + componentIdentifier, "BO-1073100029-DRAIN", "Drain");
			fields[199] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.SurgicalOperationNotes.__internal_x_context__CurrentSurgicalConfig_" + componentIdentifier, "BO-1073100029-ACTIONSFORGP", "ActionsforGP");
			fields[200] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.SurgicalOperationNotes.__internal_x_context__CurrentSurgicalConfig_" + componentIdentifier, "BO-1073100029-NURSEENABLEDINSTRUCTIONS", "NurseEnabledInstructions");
			fields[201] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.SurgicalOperationNotes.__internal_x_context__CurrentSurgicalConfig_" + componentIdentifier, "BO-1073100029-HOSPITALPLAN", "HospitalPlan");
			return fields;
		}
