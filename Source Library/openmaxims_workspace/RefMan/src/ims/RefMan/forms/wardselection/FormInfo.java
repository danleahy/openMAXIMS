...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_RefMan.SelectedCaseNoteFolderLocations", "_cv_RefMan.SelectedHospital", "_cv_RefMan.SelectedWards" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_RefMan.WardSelection.__internal_x_context__" + String.valueOf(getFormId());
	}
