...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_RefMan.PatientElectiveListAddLaterVo", "_cv_Scheduling.LinkedOPA" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_RefMan.ReferralTriageAccepted.__internal_x_context__" + String.valueOf(getFormId());
	}
	public ims.framework.FormInfo[] getComponentsFormInfo()
	{
		...
		componentsInfo[2] = new ims.RefMan.forms.opacomponent.FormInfo(134270);
