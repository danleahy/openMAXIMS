...
public class Logic extends BaseLogic
{
	...
	private void initializeDynamicGridColumns()
	{
		...
		recAwait.setHeaderAlignment(Alignment.CENTER);//WDEV-20881
		...
		colRecieve.setHeaderAlignment(Alignment.CENTER);//WDEV-20881
	...
	private void open() throws PresentationLogicException
	{
		...
		if (!form.getForms().RefMan.ReferralTriage.equals(engine.getPreviosFormName()) && form.getLocalContext().getCatsReferralWizzardIsNotNull())
		{
	...
	private boolean save(SaveMode saveMode) throws PresentationLogicException
	{
		...
		if (form.getLocalContext().getCatsReferralWizzardIsNotNull())
		{
			try
			{
				...
				if(!form.getForms().RefMan.ReferralTriage.equals(engine.getPreviosFormName()))
				{
					// Attempt save
	...
	private void updateControlsState()
	{
		...
		form.btnAllInformationReceived().setText(referral != null && Boolean.TRUE.equals(referral.getIsAwaitingClinicalInfo()) && !arrived ?
															"All information received and remove from awaiting clinical information worklist" : "All clinical information received");//WDEV-21182
