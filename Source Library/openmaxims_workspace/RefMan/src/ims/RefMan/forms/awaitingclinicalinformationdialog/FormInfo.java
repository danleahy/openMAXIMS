...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "AwaitingClinicalInformationDialog";
	}
	public int getWidth()
	{
		return 760;
	...
	{
		return new String[] { "_cv_RefMan.AwaitingClinicalInfoBoolean", "_cv_RefMan.AwaitingClinicalInfo", "_cv_Core.ParentFormMode", "_cv_RefMan.CatsReferralWizard" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_RefMan.AwaitingClinicalInformationDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
