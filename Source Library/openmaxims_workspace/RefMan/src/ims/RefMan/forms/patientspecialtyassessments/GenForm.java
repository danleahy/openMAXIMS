...
public class GenForm extends FormBridge
{
	...
	public static class ctnGraphicalContainer extends ContainerBridge
	{
		...
		protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
		{
			...
			ims.framework.FormUiLogic m_ccGraphicalForm = loader.loadComponent(127114, appForm, startControlID * 10 + 2000, anchoringHelper2.getSize(), instance1, startTabIndex.intValue() + 4, skipContextValidation);
			//ims.framework.Control m_ccGraphicalControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1002), new Integer(0), new Integer(0), new Integer(792), new Integer(592), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 4), m_ccGraphicalForm, instance1 } );
			ims.framework.Control m_ccGraphicalControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1003),  new Integer(anchoringHelper2.getX()), new Integer(anchoringHelper2.getY()), new Integer(anchoringHelper2.getWidth()), new Integer(anchoringHelper2.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 4), m_ccGraphicalForm, instance1, Boolean.FALSE } );
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1006), new Integer(anchoringHelper5.getX()), new Integer(anchoringHelper5.getY()), new Integer(anchoringHelper5.getWidth()), new Integer(anchoringHelper5.getHeight()), new Integer(startTabIndex.intValue() + 19), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Copy Last", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1007), new Integer(anchoringHelper6.getX()), new Integer(anchoringHelper6.getY()), new Integer(anchoringHelper6.getWidth()), new Integer(anchoringHelper6.getHeight()), new Integer(startTabIndex.intValue() + 20), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Print", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1008), new Integer(anchoringHelper7.getX()), new Integer(anchoringHelper7.getY()), new Integer(anchoringHelper7.getWidth()), new Integer(anchoringHelper7.getHeight()), new Integer(startTabIndex.intValue() + 17), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "New Structured", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1009), new Integer(anchoringHelper8.getX()), new Integer(anchoringHelper8.getY()), new Integer(anchoringHelper8.getWidth()), new Integer(anchoringHelper8.getHeight()), new Integer(startTabIndex.intValue() + 18), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Edit", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1010), new Integer(anchoringHelper9.getX()), new Integer(anchoringHelper9.getY()), new Integer(anchoringHelper9.getWidth()), new Integer(anchoringHelper9.getHeight()), new Integer(startTabIndex.intValue() + 22), ControlState.HIDDEN, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Save", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1012), new Integer(anchoringHelper11.getX()), new Integer(anchoringHelper11.getY()), new Integer(anchoringHelper11.getWidth()), new Integer(anchoringHelper11.getHeight()), new Integer(startTabIndex.intValue() + 16), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "New Graphical", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedGraphicAssessmentLite", "BO-1028100006-ID", "ID_GraphicAssessment");
			fields[145] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedGraphicAssessmentLite", "BO-1028100006-NAME", "Name");
			fields[146] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedGraphicAssessmentLite", "BO-1028100006-ASSESSMENTTYPE", "AssessmentType");
			fields[147] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedGraphicAssessmentLite", "BO-1028100006-ACTIVESTATUS", "ActiveStatus");
			fields[148] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedGraphicAssessmentLite", "BO-1028100006-HELPURL", "HelpUrl");
			fields[149] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedGraphicAssessmentLite", "BO-1028100006-STOREPRINTEDREPORT", "StorePrintedReport");
			fields[150] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedUserAssessmentLite", "BO-1003100043-ID", "ID_UserAssessment");
			fields[151] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedUserAssessmentLite", "BO-1003100043-NAME", "Name");
			fields[152] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedUserAssessmentLite", "BO-1003100043-DESCRIPTION", "Description");
			fields[153] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedUserAssessmentLite", "BO-1003100043-ASSESSMENTTYPE", "AssessmentType");
			fields[154] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedUserAssessmentLite", "BO-1003100043-ACTIVESTATUS", "ActiveStatus");
			fields[155] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedUserAssessmentLite", "BO-1003100043-HELPURL", "HelpURL");
			fields[156] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.PatientSpecialtyAssessments.__internal_x_context__ConsultationAssessments_" + componentIdentifier, "BO-1096100043-ID", "ID_ConsultationAssessments");
			fields[157] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.PatientSpecialtyAssessments.__internal_x_context__ConsultationAssessments_" + componentIdentifier, "BO-1096100043-CATSREFERRAL", "CatsReferral");
			fields[158] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.PatientSpecialtyAssessments.__internal_x_context__PatientAssessment_" + componentIdentifier, "BO-1003100048-ID", "ID_PatientAssessment");
			fields[159] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.PatientSpecialtyAssessments.__internal_x_context__PatientAssessment_" + componentIdentifier, "BO-1003100048-STATUS", "Status");
			fields[160] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.PatientSpecialtyAssessments.__internal_x_context__PatientAssessment_" + componentIdentifier, "BO-1003100048-COMPLETEDDATETIME", "CompletedDateTime");
			fields[161] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.PatientSpecialtyAssessments.__internal_x_context__PatientAssessment_" + componentIdentifier, "BO-1003100048-STATUSREASON", "StatusReason");
			fields[162] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.PatientSpecialtyAssessments.__internal_x_context__PatientAssessment_" + componentIdentifier, "BO-1003100048-STATUSREASONTEXT", "StatusReasonText");
			fields[163] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.PatientSpecialtyAssessments.__internal_x_context__PatientAssessment_" + componentIdentifier, "BO-1003100048-DPPTYPE", "DPPType");
			fields[164] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.PatientSpecialtyAssessments.__internal_x_context__PatientAssessment_" + componentIdentifier, "BO-1003100048-DPPTYPETEXT", "DPPTypeText");
			fields[165] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.PatientSpecialtyAssessments.__internal_x_context__PatientAssessment_" + componentIdentifier, "BO-1003100048-ISCURRENTFORTYPE", "IsCurrentForType");
			fields[166] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.PatientSpecialtyAssessments.__internal_x_context__PatientAssessment_" + componentIdentifier, "BO-1003100048-CLINICALCONTACT", "ClinicalContact");
			fields[167] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.PatientSpecialtyAssessments.__internal_x_context__PatientAssessment_" + componentIdentifier, "BO-1003100048-CARECONTEXT", "CareContext");
			fields[168] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.PatientSpecialtyAssessments.__internal_x_context__PatientAssessment_" + componentIdentifier, "BO-1003100048-EPISODEOFCARE", "EpisodeOfCare");
			fields[169] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.PatientSpecialtyAssessments.__internal_x_context__PatientAssessment_" + componentIdentifier, "BO-1003100048-PATIENT", "Patient");
			fields[170] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.PatientSpecialtyAssessments.__internal_x_context__PatientAssessment_" + componentIdentifier, "BO-1003100048-SCORE", "Score");
			fields[171] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.PatientSpecialtyAssessments.__internal_x_context__PatientAssessment_" + componentIdentifier, "BO-1003100048-ISASSESSMENTDOCUMENTSAVED", "IsAssessmentDocumentSaved");
			fields[172] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.PatientSpecialtyAssessments.__internal_x_context__SelectedUserAssessmentLite_" + componentIdentifier, "BO-1003100043-ID", "ID_UserAssessment");
			fields[173] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.PatientSpecialtyAssessments.__internal_x_context__SelectedUserAssessmentLite_" + componentIdentifier, "BO-1003100043-NAME", "Name");
			fields[174] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.PatientSpecialtyAssessments.__internal_x_context__SelectedUserAssessmentLite_" + componentIdentifier, "BO-1003100043-DESCRIPTION", "Description");
			fields[175] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.PatientSpecialtyAssessments.__internal_x_context__SelectedUserAssessmentLite_" + componentIdentifier, "BO-1003100043-ASSESSMENTTYPE", "AssessmentType");
			fields[176] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.PatientSpecialtyAssessments.__internal_x_context__SelectedUserAssessmentLite_" + componentIdentifier, "BO-1003100043-ACTIVESTATUS", "ActiveStatus");
			fields[177] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.PatientSpecialtyAssessments.__internal_x_context__SelectedUserAssessmentLite_" + componentIdentifier, "BO-1003100043-HELPURL", "HelpURL");
			fields[178] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.PatientSpecialtyAssessments.__internal_x_context__ParAss_" + componentIdentifier, "BO-1003100048-ID", "ID_PatientAssessment");
			fields[179] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.PatientSpecialtyAssessments.__internal_x_context__ParAss_" + componentIdentifier, "BO-1003100048-STATUS", "Status");
			fields[180] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.PatientSpecialtyAssessments.__internal_x_context__ParAss_" + componentIdentifier, "BO-1003100048-COMPLETEDDATETIME", "CompletedDateTime");
			fields[181] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.PatientSpecialtyAssessments.__internal_x_context__ParAss_" + componentIdentifier, "BO-1003100048-STATUSREASON", "StatusReason");
			fields[182] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.PatientSpecialtyAssessments.__internal_x_context__ParAss_" + componentIdentifier, "BO-1003100048-STATUSREASONTEXT", "StatusReasonText");
			fields[183] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.PatientSpecialtyAssessments.__internal_x_context__ParAss_" + componentIdentifier, "BO-1003100048-DPPTYPE", "DPPType");
			fields[184] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.PatientSpecialtyAssessments.__internal_x_context__ParAss_" + componentIdentifier, "BO-1003100048-DPPTYPETEXT", "DPPTypeText");
			fields[185] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.PatientSpecialtyAssessments.__internal_x_context__ParAss_" + componentIdentifier, "BO-1003100048-ISCURRENTFORTYPE", "IsCurrentForType");
			fields[186] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.PatientSpecialtyAssessments.__internal_x_context__ParAss_" + componentIdentifier, "BO-1003100048-CLINICALCONTACT", "ClinicalContact");
			fields[187] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.PatientSpecialtyAssessments.__internal_x_context__ParAss_" + componentIdentifier, "BO-1003100048-CARECONTEXT", "CareContext");
			fields[188] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.PatientSpecialtyAssessments.__internal_x_context__ParAss_" + componentIdentifier, "BO-1003100048-EPISODEOFCARE", "EpisodeOfCare");
			fields[189] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.PatientSpecialtyAssessments.__internal_x_context__ParAss_" + componentIdentifier, "BO-1003100048-PATIENT", "Patient");
			fields[190] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.PatientSpecialtyAssessments.__internal_x_context__ParAss_" + componentIdentifier, "BO-1003100048-SCORE", "Score");
			fields[191] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.PatientSpecialtyAssessments.__internal_x_context__ParAss_" + componentIdentifier, "BO-1003100048-ISASSESSMENTDOCUMENTSAVED", "IsAssessmentDocumentSaved");
			return fields;
		}
