...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_RefMan.SelectedSpecialty", "_cv_RefMan.IsComponentInEditMode", "_cv_PresentationReferalSummaryChanged", "_cv_savedPresentationReferralSummary", "_cv_Core.SelectMedication.SelectedMedication" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_RefMan.PresentationComponent.__internal_x_context__" + String.valueOf(getFormId());
	}
