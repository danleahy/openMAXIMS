...
public class GenForm extends FormBridge
{
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, "_cv_savedPresentationReferralSummary", "BO-1096100001-ID", "ID_PresentationReferralSummary");
			fields[145] = new ims.framework.ReportField(this.context, "_cv_savedPresentationReferralSummary", "BO-1096100001-CATSREFERRAL", "CatsReferral");
			fields[146] = new ims.framework.ReportField(this.context, "_cv_savedPresentationReferralSummary", "BO-1096100001-AUTHORINGDATETIME", "AuthoringDateTime");
			fields[147] = new ims.framework.ReportField(this.context, "_cv_savedPresentationReferralSummary", "BO-1096100001-PRESENTINGISSUESNONINDICATED", "PresentingIssuesNonIndicated");
			fields[148] = new ims.framework.ReportField(this.context, "_cv_savedPresentationReferralSummary", "BO-1096100001-MEDICATIONNONINDICATED", "MedicationNonIndicated");
			fields[149] = new ims.framework.ReportField(this.context, "_cv_savedPresentationReferralSummary", "BO-1096100001-ALLERGIESISSUESNONINDICATED", "AllergiesIssuesNonIndicated");
			fields[150] = new ims.framework.ReportField(this.context, "_cv_savedPresentationReferralSummary", "BO-1096100001-COMORBIDITIESISSUESNONINDICATED", "ComorbiditiesIssuesNonIndicated");
			fields[151] = new ims.framework.ReportField(this.context, "_cv_Core.SelectMedication.SelectedMedication", "BO-1003100024-ID", "ID_Medication");
			fields[152] = new ims.framework.ReportField(this.context, "_cv_Core.SelectMedication.SelectedMedication", "BO-1003100024-MEDICATIONNAME", "MedicationName");
			fields[153] = new ims.framework.ReportField(this.context, "_cv_Core.SelectMedication.SelectedMedication", "BO-1003100024-ISACTIVE", "IsActive");
			fields[154] = new ims.framework.ReportField(this.context, "_cv_Core.SelectMedication.SelectedMedication", "BO-1003100024-ISCONTROLLEDDRUG", "IsControlledDrug");
			fields[155] = new ims.framework.ReportField(this.context, "_cv_Core.SelectMedication.SelectedMedication", "BO-1003100024-FREQUENCYDEFAULT", "FrequencyDefault");
			fields[156] = new ims.framework.ReportField(this.context, "_cv_Core.SelectMedication.SelectedMedication", "BO-1003100024-NOOFDAYSSUPPLYDEFAULT", "NoOfDaysSupplyDefault");
			fields[157] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.PresentationComponent.__internal_x_context__CurrentPresentationReferralSummary_" + componentIdentifier, "BO-1096100001-ID", "ID_PresentationReferralSummary");
			fields[158] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.PresentationComponent.__internal_x_context__CurrentPresentationReferralSummary_" + componentIdentifier, "BO-1096100001-CATSREFERRAL", "CatsReferral");
			fields[159] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.PresentationComponent.__internal_x_context__CurrentPresentationReferralSummary_" + componentIdentifier, "BO-1096100001-AUTHORINGDATETIME", "AuthoringDateTime");
			fields[160] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.PresentationComponent.__internal_x_context__CurrentPresentationReferralSummary_" + componentIdentifier, "BO-1096100001-PRESENTINGISSUESNONINDICATED", "PresentingIssuesNonIndicated");
			fields[161] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.PresentationComponent.__internal_x_context__CurrentPresentationReferralSummary_" + componentIdentifier, "BO-1096100001-MEDICATIONNONINDICATED", "MedicationNonIndicated");
			fields[162] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.PresentationComponent.__internal_x_context__CurrentPresentationReferralSummary_" + componentIdentifier, "BO-1096100001-ALLERGIESISSUESNONINDICATED", "AllergiesIssuesNonIndicated");
			fields[163] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.PresentationComponent.__internal_x_context__CurrentPresentationReferralSummary_" + componentIdentifier, "BO-1096100001-COMORBIDITIESISSUESNONINDICATED", "ComorbiditiesIssuesNonIndicated");
			fields[164] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.PresentationComponent.__internal_x_context__OriginalPresentationReferralSummaryVo_" + componentIdentifier, "BO-1096100001-ID", "ID_PresentationReferralSummary");
			fields[165] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.PresentationComponent.__internal_x_context__OriginalPresentationReferralSummaryVo_" + componentIdentifier, "BO-1096100001-CATSREFERRAL", "CatsReferral");
			fields[166] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.PresentationComponent.__internal_x_context__OriginalPresentationReferralSummaryVo_" + componentIdentifier, "BO-1096100001-AUTHORINGDATETIME", "AuthoringDateTime");
			fields[167] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.PresentationComponent.__internal_x_context__OriginalPresentationReferralSummaryVo_" + componentIdentifier, "BO-1096100001-PRESENTINGISSUESNONINDICATED", "PresentingIssuesNonIndicated");
			fields[168] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.PresentationComponent.__internal_x_context__OriginalPresentationReferralSummaryVo_" + componentIdentifier, "BO-1096100001-MEDICATIONNONINDICATED", "MedicationNonIndicated");
			fields[169] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.PresentationComponent.__internal_x_context__OriginalPresentationReferralSummaryVo_" + componentIdentifier, "BO-1096100001-ALLERGIESISSUESNONINDICATED", "AllergiesIssuesNonIndicated");
			fields[170] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.PresentationComponent.__internal_x_context__OriginalPresentationReferralSummaryVo_" + componentIdentifier, "BO-1096100001-COMORBIDITIESISSUESNONINDICATED", "ComorbiditiesIssuesNonIndicated");
			return fields;
		}
