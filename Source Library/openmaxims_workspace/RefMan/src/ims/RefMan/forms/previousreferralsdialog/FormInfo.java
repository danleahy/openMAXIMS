...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "PreviousReferralsDialog";
	}
	public int getWidth()
	{
		return 520;
	...
	{
		return new String[] { "_cv_RefMan.PreviousReferrals" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_RefMan.PreviousReferralsDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
