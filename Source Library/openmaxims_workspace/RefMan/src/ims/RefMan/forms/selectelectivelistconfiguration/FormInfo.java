...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "SelectElectiveListConfiguration";
	}
	public int getWidth()
	{
		return 888;
	...
	{
		return new String[] { "_cv_RefMan.SelectedWaitingListConfig", "_cv_RefMan.SelectedPatientElectiveList" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_RefMan.SelectElectiveListConfiguration.__internal_x_context__" + String.valueOf(getFormId());
	}
