...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "PendingEmergencyTheatreForWard";
	}
	public int getWidth()
	{
		return 848;
	...
	{
		return new String[] { "_cv_Scheduling.PendingEmergencyTheatre" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_RefMan.PendingEmergencyTheatreForWard.__internal_x_context__" + String.valueOf(getFormId());
	}
