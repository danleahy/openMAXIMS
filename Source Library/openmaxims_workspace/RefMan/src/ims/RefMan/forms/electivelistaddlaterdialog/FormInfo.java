...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "ElectiveListAddLaterDialog";
	}
	public int getWidth()
	{
		return 848;
	...
	{
		return new String[] { "_cv_RefMan.PatientElectiveListAddLaterVo", "_cv_Core.RieMessage", "_cv_RefMan.PatientElectiveListRef" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_RefMan.ElectiveListAddLaterDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
