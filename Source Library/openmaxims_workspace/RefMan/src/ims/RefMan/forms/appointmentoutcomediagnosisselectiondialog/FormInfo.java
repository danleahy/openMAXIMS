...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "AppointmentOutcomeDiagnosisSelectionDialog";
	}
	public int getWidth()
	{
		return 848;
	...
	{
		return new String[] { "_cv_RefMan.SelectedDiagnosisApptOutcomeList" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_RefMan.AppointmentOutcomeDiagnosisSelectionDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
