...
public class GenForm extends FormBridge
{
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.Presentation.__internal_x_context__PresentationReferralSummaryvo_" + componentIdentifier, "BO-1096100001-ID", "ID_PresentationReferralSummary");
			fields[152] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.Presentation.__internal_x_context__PresentationReferralSummaryvo_" + componentIdentifier, "BO-1096100001-CATSREFERRAL", "CatsReferral");
			fields[153] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.Presentation.__internal_x_context__PresentationReferralSummaryvo_" + componentIdentifier, "BO-1096100001-AUTHORINGDATETIME", "AuthoringDateTime");
			fields[154] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.Presentation.__internal_x_context__PresentationReferralSummaryvo_" + componentIdentifier, "BO-1096100001-PRESENTINGISSUESNONINDICATED", "PresentingIssuesNonIndicated");
			fields[155] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.Presentation.__internal_x_context__PresentationReferralSummaryvo_" + componentIdentifier, "BO-1096100001-MEDICATIONNONINDICATED", "MedicationNonIndicated");
			fields[156] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.Presentation.__internal_x_context__PresentationReferralSummaryvo_" + componentIdentifier, "BO-1096100001-ALLERGIESISSUESNONINDICATED", "AllergiesIssuesNonIndicated");
			fields[157] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.Presentation.__internal_x_context__PresentationReferralSummaryvo_" + componentIdentifier, "BO-1096100001-COMORBIDITIESISSUESNONINDICATED", "ComorbiditiesIssuesNonIndicated");
			return fields;
		}
