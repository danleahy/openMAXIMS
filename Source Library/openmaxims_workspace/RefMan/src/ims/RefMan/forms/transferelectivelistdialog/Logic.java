...
public class Logic extends BaseLogic
{
	...
	public static final Integer		COLPATIENT			= new Integer(1);
	public static final Integer		COLPATIENTID		= new Integer(2);
	public static final Integer		COLWAITINGLIST		= new Integer(3);
	public static final Integer		COLCONS				= new Integer(4);
	public static final Integer		COLSERVICE			= new Integer(5);
	public static final Integer		COLLISTDATE			= new Integer(6);
	public static final Integer		COLSTATUS			= new Integer(7);
	public static final Integer		COLSEL				= new Integer(8);
	...
	private String search() 
	{
		...
		try
		{
			...
			if (voColl == null || voColl.size() == 0)
			{
				...
				form.chkSelectAll().setEnabled(false);
	...
	protected void onDyngrdElectiveListEntriesCellValueChanged(DynamicGridCell cell) 
	{			
		enableTransfer();
		
		//WDEV-20027
		if(Boolean.FALSE.equals(cell.getValue()))
		{
			form.chkSelectAll().setValue(null);
		}
	}
	...
	private void searchTargetElectiveList(boolean extendedSearch) 
	{
		...
		if(!extendedSearch)
		{
			voCollElect = domain.listElectiveListConfiguration(form.qmbService().getValue()!=null && form.qmbService().getValue().getSpecialtyIsNotNull() ? form.qmbService().getValue().getSpecialty():null, null, form.ccListOwner().getValue() != null ? "(" + form.ccListOwner().getValue().getIMosHcpId() + ")" : null , enteredTargetText); //WDEV-19417
		}
		else
		{
		...
		{
			form.qmbTargetElectiveList().setValue((ElectiveListConfigurationLiteVo)(form.qmbTargetElectiveList().getValues().get(0))); //WDEV-19417
		}
		else
		{
