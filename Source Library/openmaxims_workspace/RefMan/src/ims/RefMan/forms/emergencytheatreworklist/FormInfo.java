...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "EmergencyTheatreWorklist";
	}
	public int getWidth()
	{
		return 848;
	...
	{
		return new String[] { "_cv_Scheduling.PendingEmergencyTheatreRemoval", "_cv_RefMan.ReferralServiceSearchList", "_cv_Scheduling.PendingEmergencyTheatre" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_RefMan.EmergencyTheatreWorklist.__internal_x_context__" + String.valueOf(getFormId());
	}
