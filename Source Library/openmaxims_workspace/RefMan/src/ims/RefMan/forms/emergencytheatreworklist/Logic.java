...
import ims.RefMan.forms.emergencytheatreworklist.GenForm.grdServicesRow;
...
public class Logic extends BaseLogic
{
	...
	private void initialise()
	{
		...
		populateSearchCriteriaFromGC(form.getGlobalContext().Scheduling.getPendingEmergencyTheatreWorklistSearchCriteria());
	...
	private void open()
	{
		if (form.getGlobalContext().Scheduling.getPendingEmergencyTheatreWorklistSearchCriteria() != null)
		{
			doSearch();
		}
	...
	private void updateControlsState()
	{
		...
		form.lblExpectedHospital().setVisible(Boolean.TRUE.equals(form.chkNotInpatient().getValue()));
		form.qmbExpectedHospital().setVisible(Boolean.TRUE.equals(form.chkNotInpatient().getValue()));
		
		form.lblExpectedWard().setVisible(Boolean.TRUE.equals(form.chkNotInpatient().getValue()));
		form.qmbExpectedWard().setVisible(Boolean.TRUE.equals(form.chkNotInpatient().getValue()));
		
		form.lblExpectedDate().setVisible(Boolean.TRUE.equals(form.chkNotInpatient().getValue()));
	...
	private void clearScreen()
	{
		...
		form.getGlobalContext().Scheduling.setPendingEmergencyTheatreWorklistSearchCriteria(null);
	}
	...
	private void doSearch()
	{
		...
		form.getGlobalContext().Scheduling.setPendingEmergencyTheatreWorklistSearchCriteria(searchCriteria);
	...
	private void populateResultsGrid(PendingEmergencyTheatreListVoCollection records)
	{
		...
		for (int i = 0; i < records.size(); i++)
		{
			...
			createdDateTime += pendingEmergencyTheatre.getSystemInformation() != null && pendingEmergencyTheatre.getSystemInformation().getCreationDateTime() != null ? "<b>" + pendingEmergencyTheatre.getSystemInformation().getCreationDateTime().toString() + "</b> <br><br>" : "<br><br>";
			...
			cellPatID.setTooltip(createdDateTime + (pendingEmergencyTheatre.getPatient() != null && pendingEmergencyTheatre.getPatient().getDisplayId() != null ? pendingEmergencyTheatre.getPatient().getDisplayId().getIdValue() : ""));
	...
	protected void onContextMenuItemClick(int menuItemID, ims.framework.Control sender) throws ims.framework.exceptions.PresentationLogicException
	{
		switch (menuItemID)
		{
			case GenForm.ContextMenus.RefManNamespace.PendingEmergencyTheatre.VIEW_EDIT_EMERGENCY_THEATRE:
				engine.open(form.getForms().RefMan.AddEmergencyTheatre, "View/Edit Pending Emergency Theatre Details"); //WDEV-22733
			break;
	...
	@Override
	protected void onChkNotInpatientValueChanged() throws PresentationLogicException
	{
		form.qmbExpectedHospital().clear();
		form.qmbExpectedWard().clear();
		form.dteExpected().setValue(null);
	...
	@Override
	protected void onChkListEndoscopyValueChanged() throws PresentationLogicException
	{
		form.chkExcludeEndoscopy().setValue(null);
	...
	@Override
	protected void onChkExcludeEndoscopyValueChanged() throws PresentationLogicException
	{
		form.chkListEndoscopy().setValue(null);
