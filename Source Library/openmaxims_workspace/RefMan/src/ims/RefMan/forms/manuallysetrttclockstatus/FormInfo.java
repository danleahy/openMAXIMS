...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "ManuallySetRTTClockStatus";
	}
	public int getWidth()
	{
		return 656;
	...
	{
		return new String[] { "_cv_RefMan.CatsReferralSetRTTClockStatus" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_RefMan.ManuallySetRTTClockStatus.__internal_x_context__" + String.valueOf(getFormId());
	}
