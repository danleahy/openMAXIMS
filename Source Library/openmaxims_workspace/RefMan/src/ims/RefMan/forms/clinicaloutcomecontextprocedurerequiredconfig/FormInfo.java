...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "ClinicalOutcomeContextProcedureRequiredConfig";
	}
	public int getWidth()
	{
		return 848;
	...
	{
		return "_lv_RefMan.ClinicalOutcomeContextProcedureRequiredConfig.__internal_x_context__" + String.valueOf(getFormId());
	}
