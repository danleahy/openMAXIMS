...
public class GenForm extends FormBridge
{
	...
	public static class lyrContentLayer extends Layer
	{
		...
		public static class tabDischargeDetailsContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				RuntimeAnchoring anchoringHelper6 = new RuntimeAnchoring(designSize, runtimeSize, 24, 66, 129, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
				...
				super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1007), new Integer(anchoringHelper7.getX()), new Integer(anchoringHelper7.getY()), new Integer(anchoringHelper7.getWidth()), new Integer(anchoringHelper7.getHeight()), new Integer(startTabIndex.intValue() + 9), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Book Appointment", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		
				// Date Time Controls
				RuntimeAnchoring anchoringHelper8 = new RuntimeAnchoring(designSize, runtimeSize, 157, 64, 200, 20, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
				...
				// Grid Controls
				RuntimeAnchoring anchoringHelper11 = new RuntimeAnchoring(designSize, runtimeSize, 24, 168, 704, 179, ims.framework.enumerations.ControlAnchoring.ALL);
		...
		public static class tabNursingContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				grdMedications.addIntColumn("No of Days Supply", 0, 0, -1, true, true, null, false, 0, true, 0);
				...
				grdDressingAndAids.addIntColumn("Period", 0, 0, 100, false, true, null, false, 0, false, 0);
		...
		public static class tabDischargeSummaryContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1022), new Integer(anchoringHelper22.getX()), new Integer(anchoringHelper22.getY()), new Integer(anchoringHelper22.getWidth()), new Integer(anchoringHelper22.getHeight()), new Integer(startTabIndex.intValue() + 17), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Print Discharge Report", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
				...
				super.addControl(factory.getControl(HTMLViewer.class, new Object[] { control, new Integer(startControlID.intValue() + 1024), new Integer(anchoringHelper24.getX()), new Integer(anchoringHelper24.getY()), new Integer(anchoringHelper24.getWidth()), new Integer(anchoringHelper24.getHeight()), new Integer(startTabIndex.intValue() + 15), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE}));
			}
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		contextMenus.RefMan.contextMenuReferralAppointmentDetailsComponentBOOK_WARD_ATTENDANCEItem = factory.createMenuItem(startControlID.intValue() + 2, "Book New Ward Attendance", true, false, new Integer(102179), true, false);
		...
		contextMenus.RefMan.contextMenuReferralAppointmentDetailsComponentCANCEL_APPTItem = factory.createMenuItem(startControlID.intValue() + 3, "Cancel / Rebook Appointment", true, false, new Integer(102148), true, false);
		...
		contextMenus.RefMan.contextMenuReferralAppointmentDetailsComponentREBOOK_APPTItem = factory.createMenuItem(startControlID.intValue() + 4, "Rebook Appointment", true, false, new Integer(102186), true, false);
		...
		contextMenus.RefMan.contextMenuReferralAppointmentDetailsComponentAMEND_BOOKING_COMMENTSItem = factory.createMenuItem(startControlID.intValue() + 5, "Amend Booking Comments", true, false, new Integer(102136), true, false);
		...
		contextMenus.RefMan.contextMenuReferralAppointmentDetailsComponentORDER_INVESTIGATIONItem = factory.createMenuItem(startControlID.intValue() + 6, "Order Investigation", true, false, new Integer(116112), true, false);
		...
		contextMenus.RefMan.contextMenuReferralAppointmentDetailsComponentBOOK_THEATRE_APPTItem = factory.createMenuItem(startControlID.intValue() + 7, "Book Non-Elective Theatre", true, false, new Integer(102179), true, true);
		...
		contextMenus.RefMan.contextMenuReferralAppointmentDetailsComponentCANCEL_THEATRE_APPTItem = factory.createMenuItem(startControlID.intValue() + 8, "Cancel / Rebook Theatre Appointment", true, false, new Integer(102148), true, false);
		...
		contextMenus.RefMan.contextMenuReferralAppointmentDetailsComponentREBOOK_THEATRE_APPTItem = factory.createMenuItem(startControlID.intValue() + 9, "Rebook Theatre Appointment", true, false, new Integer(102186), true, false);
		...
		contextMenus.RefMan.contextMenuReferralAppointmentDetailsComponentVIEW_APPT_HISTORYItem = factory.createMenuItem(startControlID.intValue() + 10, "View Appointment History", true, false, new Integer(102555), true, false);
		...
		contextMenus.RefMan.contextMenuReferralAppointmentDetailsComponentPRINTItem = factory.createMenuItem(startControlID.intValue() + 11, "Print", true, false, new Integer(102556), true, false);
		...
		contextMenus.RefMan.contextMenuReferralAppointmentDetailsComponentCANCEL_CAB_APPTItem = factory.createMenuItem(startControlID.intValue() + 12, "Cancel Appointment", true, false, new Integer(102148), true, false);
		...
		contextMenus.RefMan.contextMenuReferralAppointmentDetailsComponentVIEW_APPOINTMENT_OUTCOMEItem = factory.createMenuItem(startControlID.intValue() + 13, "View Appointment Outcome", true, false, new Integer(123175), true, false);
		...
		contextMenus.RefMan.contextMenumedicationsMenuaddMedicationItem = factory.createMenuItem(startControlID.intValue() + 14, "Add", true, false, new Integer(102179), true, false);
		contextMenus.RefMan.contextMenumedicationsMenu.add(contextMenus.RefMan.contextMenumedicationsMenuaddMedicationItem);
		contextMenus.RefMan.contextMenumedicationsMenuremoveMedicationItem = factory.createMenuItem(startControlID.intValue() + 15, "Remove", true, false, new Integer(102300), true, false);
		contextMenus.RefMan.contextMenumedicationsMenu.add(contextMenus.RefMan.contextMenumedicationsMenuremoveMedicationItem);
		contextMenus.RefMan.contextMenumedicationsMenueditMedicationItem = factory.createMenuItem(startControlID.intValue() + 16, "Edit", true, false, new Integer(103102), true, false);
		...
		contextMenus.RefMan.contextMenuDischargeSummaryWardPacuADDItem = factory.createMenuItem(startControlID.intValue() + 17, "Add", true, false, new Integer(102179), true, false);
		...
		contextMenus.RefMan.contextMenuDischargeSummaryWardPacuREMOVEItem = factory.createMenuItem(startControlID.intValue() + 18, "Remove", true, false, new Integer(102148), true, false);
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1029), new Integer(anchoringHelper29.getX()), new Integer(anchoringHelper29.getY()), new Integer(anchoringHelper29.getWidth()), new Integer(anchoringHelper29.getHeight()), new Integer(startTabIndex.intValue() + 24), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Close", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1032), new Integer(anchoringHelper32.getX()), new Integer(anchoringHelper32.getY()), new Integer(anchoringHelper32.getWidth()), new Integer(anchoringHelper32.getHeight()), new Integer(startTabIndex.intValue() + 22), ControlState.HIDDEN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Discharge", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
	...
	public final class ContextMenus implements java.io.Serializable
	{
		...
		public final class RefManNamespace implements java.io.Serializable
		{
			...
			public final class ReferralAppointmentDetailsComponent implements java.io.Serializable
			{
				...
				public static final int BOOK_WARD_ATTENDANCE = 2;
				public static final int CANCEL_APPT = 3;
				public static final int REBOOK_APPT = 4;
				public static final int AMEND_BOOKING_COMMENTS = 5;
				public static final int ORDER_INVESTIGATION = 6;
				public static final int BOOK_THEATRE_APPT = 7;
				public static final int CANCEL_THEATRE_APPT = 8;
				public static final int REBOOK_THEATRE_APPT = 9;
				public static final int VIEW_APPT_HISTORY = 10;
				public static final int PRINT = 11;
				public static final int CANCEL_CAB_APPT = 12;
				public static final int VIEW_APPOINTMENT_OUTCOME = 13;
			}
			...
			{
				private static final long serialVersionUID = 1L;
				public static final int addMedication = 14;
				public static final int removeMedication = 15;
				public static final int editMedication = 16;
			}
	...
	private class ReportFields
	{
		...
		{
			String prefix = formInfo.getLocalVariablesPrefix();
			IReportField[] fields = new IReportField[331];
			...
			fields[170] = new ims.framework.ReportField(this.context, "_cv_Scheduling.ApptCancelStatus", "BO-1055100008-ID", "ID_Appointment_Status");
			fields[171] = new ims.framework.ReportField(this.context, "_cv_Scheduling.ApptCancelStatus", "BO-1055100008-STATUS", "Status");
			fields[172] = new ims.framework.ReportField(this.context, "_cv_Scheduling.ApptCancelStatus", "BO-1055100008-STATUSREASON", "StatusReason");
			fields[173] = new ims.framework.ReportField(this.context, "_cv_Scheduling.ApptCancelStatus", "BO-1055100008-APPTDATE", "ApptDate");
			fields[174] = new ims.framework.ReportField(this.context, "_cv_Scheduling.ApptCancelStatus", "BO-1055100008-APPTTIME", "ApptTime");
			fields[175] = new ims.framework.ReportField(this.context, "_cv_Scheduling.ApptCancelStatus", "BO-1055100008-PASCLINIC", "PASClinic");
			fields[176] = new ims.framework.ReportField(this.context, "_cv_Scheduling.ApptCancelStatus", "BO-1055100008-DOS", "DoS");
			fields[177] = new ims.framework.ReportField(this.context, "_cv_Scheduling.ApptCancelStatus", "BO-1055100008-PRIORITY", "Priority");
			fields[178] = new ims.framework.ReportField(this.context, "_cv_Scheduling.ApptCancelStatus", "BO-1055100008-CANCELLATIONREASON", "CancellationReason");
			fields[179] = new ims.framework.ReportField(this.context, "_cv_Scheduling.ApptCancelStatus", "BO-1055100008-COMMENT", "Comment");
			fields[180] = new ims.framework.ReportField(this.context, "_cv_Scheduling.ApptCancelStatus", "BO-1055100008-REBOOKSELECTED", "RebookSelected");
			fields[181] = new ims.framework.ReportField(this.context, "_cv_Scheduling.ApptCancelStatus", "BO-1055100008-EARLIESTOFFEREDDATE", "EarliestOfferedDate");
			fields[182] = new ims.framework.ReportField(this.context, "_cv_Scheduling.ApptCancelStatus", "BO-1055100008-STATUSCHANGEDATETIME", "StatusChangeDateTime");
			fields[183] = new ims.framework.ReportField(this.context, "_cv_Scheduling.ApptCancelStatus", "BO-1055100008-WASLETTERPRINTED", "WasLetterPrinted");
			fields[184] = new ims.framework.ReportField(this.context, "_cv_Scheduling.ApptCancelStatus", "BO-1055100008-COULDNOTBESEEN", "Couldnotbeseen");
			fields[185] = new ims.framework.ReportField(this.context, "_cv_Scheduling.ApptCancelStatus", "BO-1055100008-CAREPROFESSIONALREADYTOSEE", "CareProfessionalReadyToSee");
			fields[186] = new ims.framework.ReportField(this.context, "_cv_Scheduling.ApptCancelStatus", "BO-1055100008-CAREPROFESSIONALNOTREADYTOSEE", "CareProfessionalNotReadyToSee");
			fields[187] = new ims.framework.ReportField(this.context, "_cv_Scheduling.ApptCancelStatus", "BO-1055100008-SESSION", "Session");
			fields[188] = new ims.framework.ReportField(this.context, "_cv_Scheduling.BookingAppointment", "BO-1055100007-ID", "ID_Booking_Appointment");
			fields[189] = new ims.framework.ReportField(this.context, "_cv_Scheduling.BookingAppointment", "BO-1055100007-APPOINTMENTDATE", "AppointmentDate");
			fields[190] = new ims.framework.ReportField(this.context, "_cv_Scheduling.BookingAppointment", "BO-1055100007-APPTSTARTTIME", "ApptStartTime");
			fields[191] = new ims.framework.ReportField(this.context, "_cv_Scheduling.BookingAppointment", "BO-1055100007-APPTENDTIME", "ApptEndTime");
			fields[192] = new ims.framework.ReportField(this.context, "_cv_Scheduling.BookingAppointment", "BO-1055100007-APPTSTATUS", "ApptStatus");
			fields[193] = new ims.framework.ReportField(this.context, "_cv_Scheduling.BookingAppointment", "BO-1055100007-APPTSTATUSREAS", "ApptStatusReas");
			fields[194] = new ims.framework.ReportField(this.context, "_cv_Scheduling.BookingAppointment", "BO-1055100007-PRIORITY", "Priority");
			fields[195] = new ims.framework.ReportField(this.context, "_cv_Scheduling.BookingAppointment", "BO-1055100007-ISCABBOOKING", "IsCABBooking");
			fields[196] = new ims.framework.ReportField(this.context, "_cv_Scheduling.BookingAppointment", "BO-1055100007-REQUIRESREBOOK", "RequiresRebook");
			fields[197] = new ims.framework.ReportField(this.context, "_cv_Scheduling.BookingAppointment", "BO-1055100007-EARLIESTOFFEREDDATE", "EarliestOfferedDate");
			fields[198] = new ims.framework.ReportField(this.context, "_cv_Scheduling.BookingAppointment", "BO-1055100007-TRANSPORTTYPE", "TransportType");
			fields[199] = new ims.framework.ReportField(this.context, "_cv_Scheduling.BookingAppointment", "BO-1055100007-ISTRANSPORTREQUIRED", "IsTransportRequired");
			fields[200] = new ims.framework.ReportField(this.context, "_cv_Scheduling.BookingAppointment", "BO-1055100007-ISTRANSPORTBOOKED", "IsTransportBooked");
			fields[201] = new ims.framework.ReportField(this.context, "_cv_Scheduling.BookingAppointment", "BO-1055100007-OUTCOME", "Outcome");
			fields[202] = new ims.framework.ReportField(this.context, "_cv_Scheduling.BookingAppointment", "BO-1055100007-COMMENTS", "Comments");
			fields[203] = new ims.framework.ReportField(this.context, "_cv_Scheduling.BookingAppointment", "BO-1055100007-ARRIVALTIME", "ArrivalTime");
			fields[204] = new ims.framework.ReportField(this.context, "_cv_Scheduling.BookingAppointment", "BO-1055100007-SEENTIME", "SeenTime");
			fields[205] = new ims.framework.ReportField(this.context, "_cv_Scheduling.BookingAppointment", "BO-1055100007-CARECONTEXT", "CareContext");
			fields[206] = new ims.framework.ReportField(this.context, "_cv_Scheduling.BookingAppointment", "BO-1055100007-WASREVIEWED", "WasReviewed");
			fields[207] = new ims.framework.ReportField(this.context, "_cv_Scheduling.BookingAppointment", "BO-1055100007-SEENBY", "SeenBy");
			fields[208] = new ims.framework.ReportField(this.context, "_cv_Scheduling.BookingAppointment", "BO-1055100007-OUTCOMECOMMENTS", "OutcomeComments");
			fields[209] = new ims.framework.ReportField(this.context, "_cv_Scheduling.BookingAppointment", "BO-1055100007-PATHWAYCLOCK", "PathwayClock");
			fields[210] = new ims.framework.ReportField(this.context, "_cv_Scheduling.BookingAppointment", "BO-1055100007-CONSMEDIATYPE", "ConsMediaType");
			fields[211] = new ims.framework.ReportField(this.context, "_cv_Scheduling.BookingAppointment", "BO-1055100007-CATEGORY", "Category");
			fields[212] = new ims.framework.ReportField(this.context, "_cv_Scheduling.BookingAppointment", "BO-1055100007-NUMPROVIDERCANCELLATIONS", "NumProviderCancellations");
			fields[213] = new ims.framework.ReportField(this.context, "_cv_Scheduling.BookingAppointment", "BO-1055100007-WASPRINTED", "WasPrinted");
			fields[214] = new ims.framework.ReportField(this.context, "_cv_Scheduling.BookingAppointment", "BO-1055100007-NUMPATIENTCANCELLATIONS", "NumPatientCancellations");
			fields[215] = new ims.framework.ReportField(this.context, "_cv_Scheduling.BookingAppointment", "BO-1055100007-FIRSTAPPTKPIDATE", "FirstApptKPIDate");
			fields[216] = new ims.framework.ReportField(this.context, "_cv_Scheduling.BookingAppointment", "BO-1055100007-RTTBREACHKPIDATE", "RTTBreachKPIDate");
			fields[217] = new ims.framework.ReportField(this.context, "_cv_Scheduling.BookingAppointment", "BO-1055100007-REASONFORBREACHINGFIRSTAPPTKPI", "ReasonForBreachingFirstApptKPI");
			fields[218] = new ims.framework.ReportField(this.context, "_cv_Scheduling.BookingAppointment", "BO-1055100007-COMMENTSFORBREACHINGFIRSTAPPTKPI", "CommentsForBreachingFirstApptKPI");
			fields[219] = new ims.framework.ReportField(this.context, "_cv_Scheduling.BookingAppointment", "BO-1055100007-DATE28DAYRULEBREACH", "Date28DayRuleBreach");
			fields[220] = new ims.framework.ReportField(this.context, "_cv_Scheduling.BookingAppointment", "BO-1055100007-DONOTMOVE", "DoNotMove");
			fields[221] = new ims.framework.ReportField(this.context, "_cv_Scheduling.BookingAppointment", "BO-1055100007-DAY28BREACHREASON", "Day28BreachReason");
			fields[222] = new ims.framework.ReportField(this.context, "_cv_Scheduling.BookingAppointment", "BO-1055100007-DAY28BREACHCOMMENT", "Day28BreachComment");
			fields[223] = new ims.framework.ReportField(this.context, "_cv_Scheduling.BookingAppointment", "BO-1055100007-ISFLEXIBLEAPPOINTMENT", "IsFlexibleAppointment");
			fields[224] = new ims.framework.ReportField(this.context, "_cv_Scheduling.BookingAppointment", "BO-1055100007-ISWARDATTENDANCE", "IsWardAttendance");
			fields[225] = new ims.framework.ReportField(this.context, "_cv_Scheduling.BookingAppointment", "BO-1055100007-FIRSTCONSULTATIONACTIVITY", "FirstConsultationActivity");
			fields[226] = new ims.framework.ReportField(this.context, "_cv_Scheduling.BookingAppointment", "BO-1055100007-ELECTIVELIST", "ElectiveList");
			fields[227] = new ims.framework.ReportField(this.context, "_cv_Scheduling.BookingAppointment", "BO-1055100007-PATIENTCATEGORY", "PatientCategory");
			fields[228] = new ims.framework.ReportField(this.context, "_cv_Scheduling.BookingAppointment", "BO-1055100007-APPTBOOKEDONSAMEDAY", "ApptBookedOnSameDay");
			fields[229] = new ims.framework.ReportField(this.context, "_cv_Scheduling.BookingAppointment", "BO-1055100007-WASAPPTCOMMUNICATED", "WasApptCommunicated");
			fields[230] = new ims.framework.ReportField(this.context, "_cv_Scheduling.BookingAppointment", "BO-1055100007-ISDISPLACED", "IsDisplaced");
			fields[231] = new ims.framework.ReportField(this.context, "_cv_Scheduling.BookingAppointment", "BO-1055100007-OUTCOMEDATETIME", "OutcomeDateTime");
			...
			fields[248] = new ims.framework.ReportField(this.context, "_cv_RefMan.PatientMedication", "BO-1003100014-ID", "ID_PatientMedication");
			fields[249] = new ims.framework.ReportField(this.context, "_cv_RefMan.PatientMedication", "BO-1003100014-OTHERMEDICATIONTEXT", "OtherMedicationText");
			fields[250] = new ims.framework.ReportField(this.context, "_cv_RefMan.PatientMedication", "BO-1003100014-PATIENT", "Patient");
			fields[251] = new ims.framework.ReportField(this.context, "_cv_RefMan.PatientMedication", "BO-1003100014-FREQUENCY", "Frequency");
			fields[252] = new ims.framework.ReportField(this.context, "_cv_RefMan.PatientMedication", "BO-1003100014-SOURCEOFINFORMATION", "SourceofInformation");
			fields[253] = new ims.framework.ReportField(this.context, "_cv_RefMan.PatientMedication", "BO-1003100014-COMMENCEDDATE", "CommencedDate");
			fields[254] = new ims.framework.ReportField(this.context, "_cv_RefMan.PatientMedication", "BO-1003100014-NODAYSSUPPLY", "NoDaysSupply");
			fields[255] = new ims.framework.ReportField(this.context, "_cv_RefMan.PatientMedication", "BO-1003100014-BATCHNO", "BatchNo");
			fields[256] = new ims.framework.ReportField(this.context, "_cv_RefMan.PatientMedication", "BO-1003100014-EXPIRYDATE", "ExpiryDate");
			fields[257] = new ims.framework.ReportField(this.context, "_cv_RefMan.PatientMedication", "BO-1003100014-ISDISCONTINUED", "IsDiscontinued");
			fields[258] = new ims.framework.ReportField(this.context, "_cv_RefMan.PatientMedication", "BO-1003100014-DIFFICULTIESWITHMED", "DifficultiesWithMed");
			fields[259] = new ims.framework.ReportField(this.context, "_cv_RefMan.PatientMedication", "BO-1003100014-SUPPLIED", "Supplied");
			fields[260] = new ims.framework.ReportField(this.context, "_cv_RefMan.PatientMedication", "BO-1003100014-INPOSSESSION", "InPossession");
			fields[261] = new ims.framework.ReportField(this.context, "_cv_RefMan.PatientMedication", "BO-1003100014-ISMEDICATIONONADMISSION", "IsMedicationonAdmission");
			fields[262] = new ims.framework.ReportField(this.context, "_cv_RefMan.PatientMedication", "BO-1003100014-ISDISCHARGEMEDICATION", "IsDischargeMedication");
			fields[263] = new ims.framework.ReportField(this.context, "_cv_RefMan.PatientMedication", "BO-1003100014-CARECONTEXT", "CareContext");
			fields[264] = new ims.framework.ReportField(this.context, "_cv_RefMan.PatientMedication", "BO-1003100014-ISINTTO", "IsInTTO");
			fields[265] = new ims.framework.ReportField(this.context, "_cv_RefMan.PatientMedication", "BO-1003100014-ISDISCONTINUEDDATE", "IsDiscontinuedDate");
			fields[266] = new ims.framework.ReportField(this.context, "_cv_RefMan.PatientMedication", "BO-1003100014-ISDISCONTINUEDREASON", "IsDiscontinuedReason");
			fields[267] = new ims.framework.ReportField(this.context, "_cv_RefMan.PatientMedication", "BO-1003100014-ISDISCONTINUEDREASONTEXT", "IsDiscontinuedReasonText");
			fields[268] = new ims.framework.ReportField(this.context, "_cv_RefMan.PatientMedication", "BO-1003100014-ISCOPIED", "IsCopied");
			fields[269] = new ims.framework.ReportField(this.context, "_cv_RefMan.PatientMedication", "BO-1003100014-COMMENCEDBYTYPE", "CommencedByType");
			fields[270] = new ims.framework.ReportField(this.context, "_cv_RefMan.PatientMedication", "BO-1003100014-DISCONTINUEDBYTYPE", "DiscontinuedByType");
			fields[271] = new ims.framework.ReportField(this.context, "_cv_RefMan.PatientMedication", "BO-1003100014-SELFMEDICATING", "SelfMedicating");
			fields[272] = new ims.framework.ReportField(this.context, "_cv_RefMan.PatientMedication", "BO-1003100014-COMMENT", "Comment");
			fields[273] = new ims.framework.ReportField(this.context, "_cv_RefMan.CatsReferralStatus", "BO-1096100007-ID", "ID_CATSReferralStatus");
			fields[274] = new ims.framework.ReportField(this.context, "_cv_RefMan.CatsReferralStatus", "BO-1096100007-REFERRALSTATUS", "ReferralStatus");
			fields[275] = new ims.framework.ReportField(this.context, "_cv_RefMan.CatsReferralStatus", "BO-1096100007-STATUSDATETIME", "StatusDateTime");
			fields[276] = new ims.framework.ReportField(this.context, "_cv_RefMan.CatsReferralStatus", "BO-1096100007-AUTHORINGUSER", "AuthoringUser");
			fields[277] = new ims.framework.ReportField(this.context, "_cv_RefMan.CatsReferralStatus", "BO-1096100007-COMMENT", "Comment");
			fields[278] = new ims.framework.ReportField(this.context, "_cv_RefMan.CatsReferralStatus", "BO-1096100007-SECONDOPINIONCATEGORY", "SecondOpinionCategory");
			fields[279] = new ims.framework.ReportField(this.context, "_cv_Scheduling.BookingActivity", "BO-1007100005-ID", "ID_Activity");
			fields[280] = new ims.framework.ReportField(this.context, "_cv_Scheduling.BookingService", "BO-1003100032-ID", "ID_Service");
			fields[281] = new ims.framework.ReportField(this.context, "_cv_Scheduling.BookingSession", "BO-1055100010-ID", "ID_Sch_Session");
			fields[282] = new ims.framework.ReportField(this.context, "_cv_Rotherham.AppointmentToLink", "BO-1055100007-ID", "ID_Booking_Appointment");
			fields[283] = new ims.framework.ReportField(this.context, "_cv_Scheduling.BookingAppointmentRef", "BO-1055100007-ID", "ID_Booking_Appointment");
			fields[284] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.DischargeSummaryWardPacu.__internal_x_context__AppointmentToCancel_" + componentIdentifier, "BO-1055100007-ID", "ID_Booking_Appointment");
			fields[285] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.DischargeSummaryWardPacu.__internal_x_context__AppointmentToCancel_" + componentIdentifier, "BO-1055100007-APPOINTMENTDATE", "AppointmentDate");
			fields[286] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.DischargeSummaryWardPacu.__internal_x_context__AppointmentToCancel_" + componentIdentifier, "BO-1055100007-APPTSTATUS", "ApptStatus");
			fields[287] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.DischargeSummaryWardPacu.__internal_x_context__AppointmentToCancel_" + componentIdentifier, "BO-1055100007-APPTSTARTTIME", "ApptStartTime");
			fields[288] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.DischargeSummaryWardPacu.__internal_x_context__AppointmentToCancel_" + componentIdentifier, "BO-1055100007-REQUIRESREBOOK", "RequiresRebook");
			fields[289] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.DischargeSummaryWardPacu.__internal_x_context__AppointmentToCancel_" + componentIdentifier, "BO-1055100007-ISCABBOOKING", "IsCABBooking");
			fields[290] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.DischargeSummaryWardPacu.__internal_x_context__AppointmentToCancel_" + componentIdentifier, "BO-1055100007-WASPRINTED", "WasPrinted");
			fields[291] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.DischargeSummaryWardPacu.__internal_x_context__AppointmentToCancel_" + componentIdentifier, "BO-1055100007-NUMPROVIDERCANCELLATIONS", "NumProviderCancellations");
			fields[292] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.DischargeSummaryWardPacu.__internal_x_context__AppointmentToCancel_" + componentIdentifier, "BO-1055100007-NUMPATIENTCANCELLATIONS", "NumPatientCancellations");
			fields[293] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.DischargeSummaryWardPacu.__internal_x_context__AppointmentToCancel_" + componentIdentifier, "BO-1055100007-ISFLEXIBLEAPPOINTMENT", "IsFlexibleAppointment");
			fields[294] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.DischargeSummaryWardPacu.__internal_x_context__AppointmentToCancel_" + componentIdentifier, "BO-1055100007-ISWARDATTENDANCE", "IsWardAttendance");
			fields[295] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.DischargeSummaryWardPacu.__internal_x_context__AppointmentToCancel_" + componentIdentifier, "BO-1055100007-REASONFORBREACHINGFIRSTAPPTKPI", "ReasonForBreachingFirstApptKPI");
			fields[296] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.DischargeSummaryWardPacu.__internal_x_context__AppointmentToCancel_" + componentIdentifier, "BO-1055100007-OUTCOME", "Outcome");
			fields[297] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.DischargeSummaryWardPacu.__internal_x_context__AppointmentToCancel_" + componentIdentifier, "BO-1055100007-COMMENTS", "Comments");
			fields[298] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.DischargeSummaryWardPacu.__internal_x_context__DischargeSummaryPacuAndWard_" + componentIdentifier, "BO-1096100034-ID", "ID_DischargeSummaryPacuAndWard");
			fields[299] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.DischargeSummaryWardPacu.__internal_x_context__DischargeSummaryPacuAndWard_" + componentIdentifier, "BO-1096100034-CATSREFERRAL", "CatsReferral");
			fields[300] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.DischargeSummaryWardPacu.__internal_x_context__DischargeSummaryPacuAndWard_" + componentIdentifier, "BO-1096100034-DISCHARGEDATETIME", "DischargeDateTime");
			fields[301] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.DischargeSummaryWardPacu.__internal_x_context__DischargeSummaryPacuAndWard_" + componentIdentifier, "BO-1096100034-DISCHARGETYPE", "DischargeType");
			fields[302] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.DischargeSummaryWardPacu.__internal_x_context__DischargeSummaryPacuAndWard_" + componentIdentifier, "BO-1096100034-DISCHARGEEPISODE", "DischargeEpisode");
			fields[303] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.DischargeSummaryWardPacu.__internal_x_context__DischargeSummaryPacuAndWard_" + componentIdentifier, "BO-1096100034-ISCURRENT", "IsCurrent");
			fields[304] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.DischargeSummaryWardPacu.__internal_x_context__DischargeSummaryPacuAndWard_" + componentIdentifier, "BO-1096100034-ADMISSIONSUMMARY", "AdmissionSummary");
			fields[305] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.DischargeSummaryWardPacu.__internal_x_context__DischargeSummaryPacuAndWard_" + componentIdentifier, "BO-1096100034-PROBLEMSANDNEEDS", "ProblemsAndNeeds");
			fields[306] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.DischargeSummaryWardPacu.__internal_x_context__DischargeSummaryPacuAndWard_" + componentIdentifier, "BO-1096100034-ADDITIONALCOMMENTS", "AdditionalComments");
			fields[307] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.DischargeSummaryWardPacu.__internal_x_context__DischargeSummaryPacuAndWard_" + componentIdentifier, "BO-1096100034-FOLLOWUPTYPE", "FollowupType");
			fields[308] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.DischargeSummaryWardPacu.__internal_x_context__DischargeSummaryPacuAndWard_" + componentIdentifier, "BO-1096100034-FURTHERMANAGEMENTINSTRUCTIONS", "FurtherManagementInstructions");
			fields[309] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.DischargeSummaryWardPacu.__internal_x_context__DischargeSummaryPacuAndWard_" + componentIdentifier, "BO-1096100034-MEDICALLYINCOMPLETE", "MedicallyIncomplete");
			fields[310] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.DischargeSummaryWardPacu.__internal_x_context__DischargeSummaryPacuAndWard_" + componentIdentifier, "BO-1096100034-INCOMPLETENOOFDAYS", "IncompleteNoOfDays");
			fields[311] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.DischargeSummaryWardPacu.__internal_x_context__DischargeSummaryPacuAndWard_" + componentIdentifier, "BO-1096100034-CURRENTONWARDREFERRAL", "CurrentOnwardReferral");
			fields[312] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.DischargeSummaryWardPacu.__internal_x_context__DischargeSummaryPacuAndWard_" + componentIdentifier, "BO-1096100034-ACTIONSFORGPANDCOMMUNITY", "ActionsforGPandCommunity");
			fields[313] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.DischargeSummaryWardPacu.__internal_x_context__Inpatient_" + componentIdentifier, "BO-1014100000-ID", "ID_InpatientEpisode");
			fields[314] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.DischargeSummaryWardPacu.__internal_x_context__Inpatient_" + componentIdentifier, "BO-1014100000-ISONLEAVE", "IsOnLeave");
			fields[315] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.DischargeSummaryWardPacu.__internal_x_context__Inpatient_" + componentIdentifier, "BO-1014100000-COMMENTS", "Comments");
			fields[316] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.DischargeSummaryWardPacu.__internal_x_context__Inpatient_" + componentIdentifier, "BO-1014100000-ADMISSIONDATETIME", "AdmissionDateTime");
			fields[317] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.DischargeSummaryWardPacu.__internal_x_context__Inpatient_" + componentIdentifier, "BO-1014100000-ESTDISCHARGEDATE", "EstDischargeDate");
			fields[318] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.DischargeSummaryWardPacu.__internal_x_context__Inpatient_" + componentIdentifier, "BO-1014100000-BEDNO", "BedNo");
			fields[319] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.DischargeSummaryWardPacu.__internal_x_context__Inpatient_" + componentIdentifier, "BO-1014100000-ADMISSIONTYPE", "AdmissionType");
			fields[320] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.DischargeSummaryWardPacu.__internal_x_context__Inpatient_" + componentIdentifier, "BO-1014100000-ISMATERNITYINPATIENT", "IsMaternityInpatient");
			fields[321] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.DischargeSummaryWardPacu.__internal_x_context__Inpatient_" + componentIdentifier, "BO-1014100000-REASONFORADMISSION", "ReasonForAdmission");
			fields[322] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.DischargeSummaryWardPacu.__internal_x_context__Inpatient_" + componentIdentifier, "BO-1014100000-WARDTYPE", "WardType");
			fields[323] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.DischargeSummaryWardPacu.__internal_x_context__Inpatient_" + componentIdentifier, "BO-1014100000-READMISSIONTYPE", "ReadmissionType");
			fields[324] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.DischargeSummaryWardPacu.__internal_x_context__Inpatient_" + componentIdentifier, "BO-1014100000-DISCHARGEREADYDATE", "DischargeReadyDate");
			fields[325] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.DischargeSummaryWardPacu.__internal_x_context__CurrentEditableRecord_" + componentIdentifier, "BO-1096100034-ID", "ID_DischargeSummaryPacuAndWard");
			fields[326] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.DischargeSummaryWardPacu.__internal_x_context__CurrentEditableRecord_" + componentIdentifier, "BO-1096100034-CATSREFERRAL", "CatsReferral");
			fields[327] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.DischargeSummaryWardPacu.__internal_x_context__CurrentEditableRecord_" + componentIdentifier, "BO-1096100034-DISCHARGEDATETIME", "DischargeDateTime");
			fields[328] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.DischargeSummaryWardPacu.__internal_x_context__CurrentEditableRecord_" + componentIdentifier, "BO-1096100034-DISCHARGETYPE", "DischargeType");
			fields[329] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.DischargeSummaryWardPacu.__internal_x_context__CurrentEditableRecord_" + componentIdentifier, "BO-1096100034-DISCHARGEEPISODE", "DischargeEpisode");
			fields[330] = new ims.framework.ReportField(this.context, prefix + "_lv_RefMan.DischargeSummaryWardPacu.__internal_x_context__CurrentEditableRecord_" + componentIdentifier, "BO-1096100034-ISCURRENT", "IsCurrent");
			return fields;
		}
