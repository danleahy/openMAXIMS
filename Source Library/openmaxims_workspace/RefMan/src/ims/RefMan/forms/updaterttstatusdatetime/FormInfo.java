...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "UpdateRTTStatusDateTime";
	}
	public int getWidth()
	{
		return 480;
	...
	{
		return new String[] { "_cv_RefMan.PreviousRTTStatusDate", "_cv_RefMan.RTTManagementValue", "_cv_RefMan.NextRTTStatusDate" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_RefMan.UpdateRTTStatusDateTime.__internal_x_context__" + String.valueOf(getFormId());
	}
