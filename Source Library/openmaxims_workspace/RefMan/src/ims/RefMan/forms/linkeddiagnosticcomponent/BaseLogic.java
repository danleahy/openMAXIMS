...
public abstract class BaseLogic extends Handlers implements IComponent
{
	...
	{
		return ims.RefMan.domain.LinkedDiagnosticComponent.class;
	}
	public final void setContext(ims.framework.UIComponentEngine engine, GenForm form, ims.RefMan.domain.LinkedDiagnosticComponent domain)
	{
	...
	{
		this.form.cmbType().setValue((ims.core.vo.lookups.TimeUnitsSecondsToMonths)domain.getLookupService().getDefaultInstance(ims.core.vo.lookups.TimeUnitsSecondsToMonths.class, engine.getFormName().getID(), ims.core.vo.lookups.TimeUnitsSecondsToMonths.TYPE_ID));
	}
	...
	protected ims.RefMan.domain.LinkedDiagnosticComponent domain;
}
