...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "CorrespondenceNoteDialog";
	}
	public int getWidth()
	{
		return 800;
	...
	{
		return new String[] { "_cv_RefMan.EditedReportNote" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_RefMan.CorrespondenceNoteDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
