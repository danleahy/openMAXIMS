...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "SelectPreviousDiagnosisForReferralCoding";
	}
	public int getWidth()
	{
		return 840;
	...
	{
		return new String[] { "_cv_RefMan.SelectedPatientDiagnosisForReferralCoding" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_RefMan.SelectPreviousDiagnosisForReferralCoding.__internal_x_context__" + String.valueOf(getFormId());
	}
