...
public abstract class BaseLogic extends Handlers implements IComponent
{
	...
	{
		return ims.RefMan.domain.OPAComponent.class;
	}
	public final void setContext(ims.framework.UIComponentEngine engine, GenForm form, ims.RefMan.domain.OPAComponent domain)
	{
	...
	protected ims.RefMan.domain.OPAComponent domain;
}
