...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "LinkReportNoteToTemplate";
	}
	public int getWidth()
	{
		return 848;
	...
	{
		return new String[] { "_cv_Core.Template", "_cv_Core.ReportTemplateRef" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_RefMan.LinkReportNoteToTemplate.__internal_x_context__" + String.valueOf(getFormId());
	}
