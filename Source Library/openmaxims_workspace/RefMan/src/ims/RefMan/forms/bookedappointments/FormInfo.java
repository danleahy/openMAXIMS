...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Rotherham.BookedAppointments", "_cv_Rotherham.AppointmentToLink" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_RefMan.BookedAppointments.__internal_x_context__" + String.valueOf(getFormId());
	}
