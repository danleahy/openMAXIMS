...
public class Logic extends BaseLogic
{
	...
	private void initialise() 
	{
		...
		else//	WDEV-13307
		{
			...
			form.dteDisch().setValue(form.getLocalContext().getInpatienEpisode().getEstDischargeDateIsNotNull() ? form.getLocalContext().getInpatienEpisode().getEstDischargeDate().getDate() : null);
		}
	...
	private boolean saveAdmission(PatientElectiveListBedAdmissionVo patientElectiveList, PatientElectiveListBedAdmissionVoCollection differentPatientElectiveListForService)
	{
		...
		voInpatientEpis.setEstDischargeDate(form.dteDisch().getValue() != null ? new DateTime(form.dteDisch().getValue(), new Time(0,0)) : null);
