...
import ims.RefMan.vo.MaintenanceSearchCriteriaVo;
...
public class Logic extends BaseLogic
{
	...
	protected void onFormOpen(Object[] args) throws ims.framework.exceptions.PresentationLogicException
	{
		initialise();
		//WDEV-19389 - start
		if (form.getGlobalContext().RefMan.getMaintenanceSearchCriteriaIsNotNull())
		{
			setBookExSearchCriteria(form.getGlobalContext().RefMan.getMaintenanceSearchCriteria());
	...
	private MaintenanceSearchCriteriaVo getBookExSearchCriteria()
	{
		MaintenanceSearchCriteriaVo searchCriteria = new MaintenanceSearchCriteriaVo();
		
		searchCriteria.setSpecialty(form.lyrMaintenance().tabBookExc().cmbBookSpecialty().getValue());
		searchCriteria.setClinic(form.lyrMaintenance().tabBookExc().cmbBookClinic().getValue());
		searchCriteria.setDateFrom(form.lyrMaintenance().tabBookExc().dteBookFrom().getValue());
		searchCriteria.setDateTo(form.lyrMaintenance().tabBookExc().dteBookTo().getValue());
		
		return searchCriteria;
	}
	
	private void setBookExSearchCriteria(MaintenanceSearchCriteriaVo maintenanceBookExSearchCriteriaVo) throws PresentationLogicException
	{
		form.lyrMaintenance().tabBookExc().cmbBookSpecialty().setValue(maintenanceBookExSearchCriteriaVo.getSpecialty());	
		onCmbBookSpecialtyValueChanged();
		form.lyrMaintenance().tabBookExc().cmbBookClinic().setValue(maintenanceBookExSearchCriteriaVo.getClinic());
		form.lyrMaintenance().tabBookExc().dteBookFrom().setValue(maintenanceBookExSearchCriteriaVo.getDateFrom());
		form.lyrMaintenance().tabBookExc().dteBookTo().setValue(maintenanceBookExSearchCriteriaVo.getDateTo());
	}
	
	private MaintenanceSearchCriteriaVo getCancelExSearchCriteria()
	{
		MaintenanceSearchCriteriaVo searchCriteria = new MaintenanceSearchCriteriaVo();
		
		searchCriteria.setSpecialty(form.lyrMaintenance().tabCancelExc().cmbCancelSpecialty().getValue());
		searchCriteria.setClinic(form.lyrMaintenance().tabCancelExc().cmbCancelClinic().getValue());
		searchCriteria.setDateFrom(form.lyrMaintenance().tabCancelExc().dteCancelFrom().getValue());
		searchCriteria.setDateTo(form.lyrMaintenance().tabCancelExc().dteCancelTo().getValue());
		
		return searchCriteria;
	}
	
	private void setCancelExSearchCriteria(MaintenanceSearchCriteriaVo maintenanceBookExSearchCriteriaVo) throws PresentationLogicException
	{
		form.lyrMaintenance().tabCancelExc().cmbCancelSpecialty().setValue(maintenanceBookExSearchCriteriaVo.getSpecialty());	
		onCmbCancelSpecialtyValueChanged();
		form.lyrMaintenance().tabCancelExc().cmbCancelClinic().setValue(maintenanceBookExSearchCriteriaVo.getClinic());
		form.lyrMaintenance().tabCancelExc().dteCancelFrom().setValue(maintenanceBookExSearchCriteriaVo.getDateFrom());
		form.lyrMaintenance().tabCancelExc().dteCancelTo().setValue(maintenanceBookExSearchCriteriaVo.getDateTo());
	}
	
	private MaintenanceSearchCriteriaVo getSlootPollsSearchCriteria()
	{
		MaintenanceSearchCriteriaVo searchCriteria = new MaintenanceSearchCriteriaVo();

		searchCriteria.setDateFrom(form.lyrMaintenance().tabSlotPoll().dteSlotDateFrom().getValue());
		searchCriteria.setDateTo(form.lyrMaintenance().tabSlotPoll().dteSlotDateTo().getValue());
		
		return searchCriteria;
	}
	
	private void setSlootPollsSearchCriteria(MaintenanceSearchCriteriaVo maintenanceBookExSearchCriteriaVo)
	{
		form.lyrMaintenance().tabSlotPoll().dteSlotDateFrom().setValue(maintenanceBookExSearchCriteriaVo.getDateFrom());
		form.lyrMaintenance().tabSlotPoll().dteSlotDateTo().setValue(maintenanceBookExSearchCriteriaVo.getDateTo());
	}
	
	private MaintenanceSearchCriteriaVo getPSDRequestsSearchCriteria()
	{
		MaintenanceSearchCriteriaVo searchCriteria = new MaintenanceSearchCriteriaVo();
		
		searchCriteria.setDateFrom(form.lyrMaintenance().tabPdsRequests().dtePdsFrom().getValue());
		searchCriteria.setDateTo(form.lyrMaintenance().tabPdsRequests().dtePdsTo().getValue());
		searchCriteria.setNHSNo(form.lyrMaintenance().tabPdsRequests().txtNHSN().getValue());
		searchCriteria.setFailedRequests(Boolean.TRUE.equals(form.lyrMaintenance().tabPdsRequests().chkFailedItemsOnly().getValue() ? true : false));
		searchCriteria.setDateUpdatedFrom(form.lyrMaintenance().tabPdsRequests().dtePdsUpdatedFrom().getValue());
		searchCriteria.setDateUpdatedTo(form.lyrMaintenance().tabPdsRequests().dtePdsUpdatedTo().getValue());
		
		return searchCriteria;
	}
	
	private void setPSDRequestsSearchCriteria(MaintenanceSearchCriteriaVo maintenanceBookExSearchCriteriaVo)
	{
		form.lyrMaintenance().tabPdsRequests().dtePdsFrom().setValue(maintenanceBookExSearchCriteriaVo.getDateFrom());
		form.lyrMaintenance().tabPdsRequests().dtePdsTo().setValue(maintenanceBookExSearchCriteriaVo.getDateTo());
		form.lyrMaintenance().tabPdsRequests().txtNHSN().setValue(maintenanceBookExSearchCriteriaVo.getNHSNo());
		form.lyrMaintenance().tabPdsRequests().chkFailedItemsOnly().setValue(maintenanceBookExSearchCriteriaVo.getFailedRequests());
		form.lyrMaintenance().tabPdsRequests().dtePdsUpdatedFrom().setValue(maintenanceBookExSearchCriteriaVo.getDateUpdatedFrom());
		form.lyrMaintenance().tabPdsRequests().dtePdsUpdatedTo().setValue(maintenanceBookExSearchCriteriaVo.getDateUpdatedTo());
	}

	private MaintenanceSearchCriteriaVo getSDSRequestsSearchCriteria()
	{
		MaintenanceSearchCriteriaVo searchCriteria = new MaintenanceSearchCriteriaVo();
		
		searchCriteria.setDateFrom(form.lyrMaintenance().tabSdsRequests().dteSdsFrom().getValue());
		searchCriteria.setDateTo(form.lyrMaintenance().tabSdsRequests().dteSdsTo().getValue());
		searchCriteria.setDateUpdatedFrom(form.lyrMaintenance().tabSdsRequests().dteSdsUpdatedFrom().getValue());
		searchCriteria.setDateUpdatedTo(form.lyrMaintenance().tabSdsRequests().dteSdsUpdatedTo().getValue());
		
		return searchCriteria;
	}
	
	private void setSDSRequestsSearchCriteria(MaintenanceSearchCriteriaVo maintenanceBookExSearchCriteriaVo)
	{
		form.lyrMaintenance().tabSdsRequests().dteSdsFrom().setValue(maintenanceBookExSearchCriteriaVo.getDateFrom());
		form.lyrMaintenance().tabSdsRequests().dteSdsTo().setValue(maintenanceBookExSearchCriteriaVo.getDateTo());
		form.lyrMaintenance().tabSdsRequests().dteSdsUpdatedFrom().setValue(maintenanceBookExSearchCriteriaVo.getDateUpdatedFrom());
		form.lyrMaintenance().tabSdsRequests().dteSdsUpdatedTo().setValue(maintenanceBookExSearchCriteriaVo.getDateUpdatedTo());
	}
	protected void onImbBookSearchClick() throws ims.framework.exceptions.PresentationLogicException
	{
		...
		{
			searchBook();
			form.getGlobalContext().RefMan.setMaintenanceSearchCriteria(getBookExSearchCriteria());//WDEV-19389 
	...
	protected void onImbCancelSearchClick() throws ims.framework.exceptions.PresentationLogicException
	{
		...
		{
			searchCancel();
			form.getGlobalContext().RefMan.setMaintenanceCancelExSearchCriteria(getCancelExSearchCriteria());//WDEV-19389 
			updateContextMenuState();
		}
		else
			engine.showErrors(errors);
	...
	{
		clearScreen();
		form.getGlobalContext().RefMan.setMaintenanceCancelExSearchCriteria(null);//WDEV-19389 
	}
	protected void onImbBookClearClick() throws ims.framework.exceptions.PresentationLogicException
	{
		clearScreen();
		form.getGlobalContext().RefMan.setMaintenanceSearchCriteria(null);//WDEV-19389
	}
	protected void onImbSlotClearClick() throws PresentationLogicException 
	{
		clearScreen();
		form.getGlobalContext().RefMan.setMaintenanceSlotPollsSearchCriteria(null);//WDEV-19389 
	}
	protected void onImbPdsClearClick() throws PresentationLogicException 
	{
		clearScreen();
		form.getGlobalContext().RefMan.setMaintenancePDSRequestSearchCriteria(null);//WDEV-19389 
	}
	...
	private void undoSlotCancel()
	{
		...
		if(voSlot != null)
		{
			voSlot.setStatus(voSlot.getSession().getAppropiateSessionSlotStatus()); //WDEV-18940 
	...
	protected void onFormDialogClosed(FormName formName, DialogResult result) throws PresentationLogicException
	{
		if(formName.equals(form.getForms().Scheduling.CancelAppointmentDialog) && result.equals(DialogResult.OK))
		{
			...
			if(voSlot != null && voSlot.getAppointmentIsNotNull())
			{
				voSlot.setStatus(voSlot.getAppointment().getSession().getAppropiateSessionSlotStatus()); //WDEV-18940
				...
				voSlot.getAppointment().setLinkedApptsToBeCancelled(form.getGlobalContext().RefMan.getLinkedAppointmentsCollection());//WDEV-19543
	...
	protected void onImbPollSearchClick() throws PresentationLogicException 
	{
		...
		searchPoll();
		form.getGlobalContext().RefMan.setMaintenanceSlotPollsSearchCriteria(getSlootPollsSearchCriteria());//WDEV-19389 
		updateContextMenuState();
	}
	...
	protected void onImbPdsSearchClick() throws PresentationLogicException 
	{
		...
		searchPds();
		form.getGlobalContext().RefMan.setMaintenancePDSRequestSearchCriteria(getPSDRequestsSearchCriteria());//WDEV-19389 
		updateContextMenuState();
	}
	...
	{
		clearScreen();
		form.getGlobalContext().RefMan.setMaintenanceSDSRequestSearchCriteria(null);//WDEV-19389 
	}
	...
	protected void onImbSearchSdsClick() throws PresentationLogicException
	{
		...
		searchSds();
		form.getGlobalContext().RefMan.setMaintenanceSDSRequestSearchCriteria(getSDSRequestsSearchCriteria());//WDEV-19389 
		updateContextMenuState();
	}
	...
	protected void onlyrMaintenanceTabChanged(LayerBridge tab)
	{
		...
		else if(tab.equals(form.lyrMaintenance().tabCancelExc()))
		{
			...
			//WDEV-19389 - start
			if (form.getGlobalContext().RefMan.getMaintenanceCancelExSearchCriteriaIsNotNull())
			{	
				try
				{
					setCancelExSearchCriteria(form.getGlobalContext().RefMan.getMaintenanceCancelExSearchCriteria());
		...
		else if(tab.equals(form.lyrMaintenance().tabPdsRequests()))
		{
			...
			//WDEV-19389 - start
			if (form.getGlobalContext().RefMan.getMaintenancePDSRequestSearchCriteriaIsNotNull())
			{
				setPSDRequestsSearchCriteria(form.getGlobalContext().RefMan.getMaintenancePDSRequestSearchCriteria());
				try
				{
					onImbPdsSearchClick();
				}
		...
		else if(tab.equals(form.lyrMaintenance().tabSdsRequests()))
		{
			...
			//WDEV-19389 - start
			if (form.getGlobalContext().RefMan.getMaintenanceSDSRequestSearchCriteriaIsNotNull())
			{
				setSDSRequestsSearchCriteria(form.getGlobalContext().RefMan.getMaintenanceSDSRequestSearchCriteria());
				try
				{
					onImbSearchSdsClick();
				}
		...
		else if(tab.equals(form.lyrMaintenance().tabSlotPoll()))
		{
			...
			//WDEV-19389 - start
			if (form.getGlobalContext().RefMan.getMaintenanceSlotPollsSearchCriteriaIsNotNull())
			{
				setSlootPollsSearchCriteria(form.getGlobalContext().RefMan.getMaintenanceSlotPollsSearchCriteria());
				try
				{
