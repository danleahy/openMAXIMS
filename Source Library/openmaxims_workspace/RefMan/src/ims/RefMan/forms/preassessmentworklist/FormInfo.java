...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_RefMan.PatientElectiveListRef", "_cv_RefMan.ReferralServiceSearchList" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_RefMan.PreAssessmentWorklist.__internal_x_context__" + String.valueOf(getFormId());
	}
