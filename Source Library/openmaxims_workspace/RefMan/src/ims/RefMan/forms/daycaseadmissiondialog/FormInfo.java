...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Scheduling.BookingAppointmentRef", "_cv_Core.HospitalLoc", "_cv_RefMan.DayCaseAdmApptTime", "_cv_RefMan.DayCaseAdmClinicName", "_cv_RefMan.DayCaseAdmApptDate" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_RefMan.DayCaseAdmissionDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
