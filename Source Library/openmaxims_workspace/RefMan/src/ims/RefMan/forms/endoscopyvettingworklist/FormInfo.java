...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "EndoscopyVettingWorklist";
	}
	public int getWidth()
	{
		return 848;
	...
	{
		return new String[] { "_cv_RefMan.PatientElectiveListAddLaterVo" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_RefMan.EndoscopyVettingWorklist.__internal_x_context__" + String.valueOf(getFormId());
	}
