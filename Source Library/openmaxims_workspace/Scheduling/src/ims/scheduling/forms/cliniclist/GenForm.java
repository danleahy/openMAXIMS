...
public class GenForm extends FormBridge
{
	...
	public static class grdSlotsRow extends GridRowBridge
	{
		...
		public void setColIsCABReadOnly(boolean value)
		{
			super.row.setReadOnly(5, value);
		}
		public boolean isColIsCABReadOnly()
		{
			return super.row.isReadOnly(5);
		}
		public void showColIsCABOpened()
		{
			super.row.showOpened(5);
		}
		public void setTooltipForColIsCAB(String value)
		{
			super.row.setTooltip(5, value);
		}
		public ims.framework.utils.Image getColIsCAB()
		{
			return (ims.framework.utils.Image)super.row.get(5);
		}
		public void setColIsCAB(ims.framework.utils.Image value)
		{
			super.row.set(5, value);
		}
		public void setCellColIsCABTooltip(String value)
		{
			super.row.setTooltip(5, value);
		}
		...
		{
			return (ims.core.vo.PatientShort)super.row.get(7);
		}
	...
	public static class grdSlotsGrid extends GridBridge
	{
		...
		public void setColIsCABHeaderTooltip(String value)
		{
			super.grid.setColumnHeaderTooltip(5, value);
		}
		public String getColIsCABHeaderTooltip()
		{
	...
	private void validateContext(ims.framework.Context context)
	{
		...
		if(!context.isValidContextType(ims.scheduling.vo.ClinicListsSearchCriteriaVo.class))
			throw new ims.framework.exceptions.CodingRuntimeException("The type 'ims.scheduling.vo.ClinicListsSearchCriteriaVo' of the global context variable 'Scheduling.ClinicListsSearchCriteria' is not supported.");
	}
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		contextMenus.Scheduling.contextMenuClinicListCANCELItem = factory.createMenuItem(startControlID.intValue() + 2, "Cancel / Rebook Appointment", true, false, new Integer(102148), true, false);
		...
		// Label Controls
		RuntimeAnchoring anchoringHelper1 = new RuntimeAnchoring(designSize, runtimeSize, 504, 76, 59, 17, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
		...
		RuntimeAnchoring anchoringHelper2 = new RuntimeAnchoring(designSize, runtimeSize, 504, 51, 82, 17, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
		...
		RuntimeAnchoring anchoringHelper3 = new RuntimeAnchoring(designSize, runtimeSize, 16, 19, 46, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1002), new Integer(anchoringHelper3.getX()), new Integer(anchoringHelper3.getY()), new Integer(anchoringHelper3.getWidth()), new Integer(anchoringHelper3.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Profile:", new Integer(1), null, new Integer(0)}));
		RuntimeAnchoring anchoringHelper4 = new RuntimeAnchoring(designSize, runtimeSize, 16, 51, 48, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1003), new Integer(anchoringHelper4.getX()), new Integer(anchoringHelper4.getY()), new Integer(anchoringHelper4.getWidth()), new Integer(anchoringHelper4.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Clinics: ", new Integer(1), null, new Integer(0)}));
		RuntimeAnchoring anchoringHelper5 = new RuntimeAnchoring(designSize, runtimeSize, 504, 19, 35, 17, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
		...
		// Button Controls
		RuntimeAnchoring anchoringHelper6 = new RuntimeAnchoring(designSize, runtimeSize, 376, 600, 152, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT);
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1005), new Integer(anchoringHelper6.getX()), new Integer(anchoringHelper6.getY()), new Integer(anchoringHelper6.getWidth()), new Integer(anchoringHelper6.getHeight()), new Integer(startTabIndex.intValue() + 9), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Cancel Slot", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		RuntimeAnchoring anchoringHelper7 = new RuntimeAnchoring(designSize, runtimeSize, 536, 600, 152, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT);
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1006), new Integer(anchoringHelper7.getX()), new Integer(anchoringHelper7.getY()), new Integer(anchoringHelper7.getWidth()), new Integer(anchoringHelper7.getHeight()), new Integer(startTabIndex.intValue() + 10), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Cancel Appointment", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		RuntimeAnchoring anchoringHelper8 = new RuntimeAnchoring(designSize, runtimeSize, 696, 600, 144, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT);
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1007), new Integer(anchoringHelper8.getX()), new Integer(anchoringHelper8.getY()), new Integer(anchoringHelper8.getWidth()), new Integer(anchoringHelper8.getHeight()), new Integer(startTabIndex.intValue() + 11), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "DNA", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));

		// Date Controls
		RuntimeAnchoring anchoringHelper9 = new RuntimeAnchoring(designSize, runtimeSize, 592, 16, 120, 20, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
		...
		// ComboBox Controls
		RuntimeAnchoring anchoringHelper10 = new RuntimeAnchoring(designSize, runtimeSize, 592, 74, 176, 21, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
		ComboBox m_cmbListTypeTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1009), new Integer(anchoringHelper10.getX()), new Integer(anchoringHelper10.getY()), new Integer(anchoringHelper10.getWidth()), new Integer(anchoringHelper10.getHeight()), new Integer(startTabIndex.intValue() + 5), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPRIGHT ,Boolean.TRUE, Boolean.TRUE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
		...
		RuntimeAnchoring anchoringHelper11 = new RuntimeAnchoring(designSize, runtimeSize, 592, 48, 176, 21, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
		ComboBox m_cmbStatusTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1010), new Integer(anchoringHelper11.getX()), new Integer(anchoringHelper11.getY()), new Integer(anchoringHelper11.getWidth()), new Integer(anchoringHelper11.getHeight()), new Integer(startTabIndex.intValue() + 4), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPRIGHT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
		...
		RuntimeAnchoring anchoringHelper12 = new RuntimeAnchoring(designSize, runtimeSize, 64, 16, 424, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT);
		...
		RuntimeAnchoring anchoringHelper13 = new RuntimeAnchoring(designSize, runtimeSize, 64, 48, 424, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT);
		...
		// Grid Controls
		RuntimeAnchoring anchoringHelper14 = new RuntimeAnchoring(designSize, runtimeSize, 8, 112, 832, 472, ims.framework.enumerations.ControlAnchoring.ALL);
		Grid m_grdSlotsTemp = (Grid)factory.getControl(Grid.class, new Object[] { control, new Integer(startControlID.intValue() + 1013), new Integer(anchoringHelper14.getX()), new Integer(anchoringHelper14.getY()), new Integer(anchoringHelper14.getWidth()), new Integer(anchoringHelper14.getHeight()), new Integer(startTabIndex.intValue() + 8), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL,Boolean.TRUE, Boolean.FALSE, new Integer(24), Boolean.TRUE, contextMenus.Scheduling.contextMenuClinicList, Boolean.FALSE, Boolean.FALSE, new Integer(0), null, Boolean.TRUE, Boolean.TRUE});
		...
		grdSlots.addStringColumn("Appt. Type", 0, 0, 110, true, false, 0, 0, true, ims.framework.enumerations.CharacterCasing.NORMAL);
		...
		grdSlots.addImageColumn(" ", 0, 1, 24, false, 0);
		grdSlots.addStringColumn("Booking Details", 0, 0, 235, true, false, 0, 0, true, ims.framework.enumerations.CharacterCasing.NORMAL);
		...
		RuntimeAnchoring anchoringHelper15 = new RuntimeAnchoring(designSize, runtimeSize, 808, 12, 30, 30, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
		super.addControl(factory.getControl(ImageButton.class, new Object[] { control, new Integer(startControlID.intValue() + 1014), new Integer(anchoringHelper15.getX()), new Integer(anchoringHelper15.getY()), new Integer(anchoringHelper15.getWidth()), new Integer(anchoringHelper15.getHeight()), new Integer(startTabIndex.intValue() + 7), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT, this.getImages().Core.ClearEnabled24, this.getImages().Core.ClearDisabled24, null, Boolean.FALSE, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null}));
		RuntimeAnchoring anchoringHelper16 = new RuntimeAnchoring(designSize, runtimeSize, 776, 12, 30, 30, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
		super.addControl(factory.getControl(ImageButton.class, new Object[] { control, new Integer(startControlID.intValue() + 1015), new Integer(anchoringHelper16.getX()), new Integer(anchoringHelper16.getY()), new Integer(anchoringHelper16.getWidth()), new Integer(anchoringHelper16.getHeight()), new Integer(startTabIndex.intValue() + 6), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT, this.getImages().Core.FindEnabled24, this.getImages().Core.FindDisabled24, null, Boolean.FALSE, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null}));
	}
	...
	{
		return (cmbProfileComboBox)super.getComboBox(2);
	}
	public cmbSessionsComboBox cmbSessions()
	{
		return (cmbSessionsComboBox)super.getComboBox(3);
	}
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[206] = new ims.framework.ReportField(this.context, "_cv_Core.PatientToBeDisplayed", "BO-1001100000-ID", "ID_Patient");
			fields[207] = new ims.framework.ReportField(this.context, "_cv_Core.PatientToBeDisplayed", "BO-1001100000-SEX", "Sex");
			fields[208] = new ims.framework.ReportField(this.context, "_cv_Core.PatientToBeDisplayed", "BO-1001100000-DOB", "Dob");
			fields[209] = new ims.framework.ReportField(this.context, "_cv_Core.PatientToBeDisplayed", "BO-1001100000-DOD", "Dod");
			fields[210] = new ims.framework.ReportField(this.context, "_cv_Core.PatientToBeDisplayed", "BO-1001100000-RELIGION", "Religion");
			fields[211] = new ims.framework.ReportField(this.context, "_cv_Core.PatientToBeDisplayed", "BO-1001100000-ISACTIVE", "IsActive");
			fields[212] = new ims.framework.ReportField(this.context, "_cv_Core.PatientToBeDisplayed", "BO-1001100000-ETHNICORIGIN", "EthnicOrigin");
			fields[213] = new ims.framework.ReportField(this.context, "_cv_Core.PatientToBeDisplayed", "BO-1001100000-MARITALSTATUS", "MaritalStatus");
			fields[214] = new ims.framework.ReportField(this.context, "_cv_Core.PatientToBeDisplayed", "BO-1001100000-SCN", "SCN");
			fields[215] = new ims.framework.ReportField(this.context, "_cv_Core.PatientToBeDisplayed", "BO-1001100000-SOURCEOFINFORMATION", "SourceOfInformation");
			fields[216] = new ims.framework.ReportField(this.context, "_cv_Core.PatientToBeDisplayed", "BO-1001100000-TIMEOFDEATH", "TimeOfDeath");
			fields[217] = new ims.framework.ReportField(this.context, "_cv_Core.PatientToBeDisplayed", "BO-1001100000-ISQUICKREGISTRATIONPATIENT", "IsQuickRegistrationPatient");
			fields[218] = new ims.framework.ReportField(this.context, "_cv_Core.PatientToBeDisplayed", "BO-1001100000-CURRENTRESPONSIBLECONSULTANT", "CurrentResponsibleConsultant");
			fields[219] = new ims.framework.ReportField(this.context, "_cv_Core.PatientToBeDisplayed", "BO-1001100000-DEMENTIABREACHDATETIME", "DementiaBreachDateTime");
			fields[220] = new ims.framework.ReportField(this.context, "_cv_Core.PatientToBeDisplayed", "BO-1001100000-DEMENTIAWORKLISTSTATUS", "DementiaWorklistStatus");
			fields[221] = new ims.framework.ReportField(this.context, "_cv_Core.PatientToBeDisplayed", "BO-1001100000-MRNSTATUS", "MRNStatus");
			fields[222] = new ims.framework.ReportField(this.context, "_cv_Core.PatientToBeDisplayed", "BO-1001100000-HASSCANNEDCASENOTEFOLDERS", "HasScannedCaseNoteFolders");
			fields[223] = new ims.framework.ReportField(this.context, "_cv_Core.PatientToBeDisplayed", "BO-1001100000-ISCONFIDENTIAL", "IsConfidential");
			fields[224] = new ims.framework.ReportField(this.context, "_cv_Core.PatientToBeDisplayed", "BO-1001100000-TIMEOFBIRTH", "TimeOfBirth");
			fields[225] = new ims.framework.ReportField(this.context, "_cv_Core.PatientToBeDisplayed", "BO-1001100000-PATIENTCATEGORY", "PatientCategory");
			fields[226] = new ims.framework.ReportField(this.context, "_cv_Clinical.PatientSummary.CareContext", "BO-1004100019-ID", "ID_CareContext");
			fields[227] = new ims.framework.ReportField(this.context, "_cv_Scheduling.BookingSession", "BO-1055100010-ID", "ID_Sch_Session");
			fields[228] = new ims.framework.ReportField(this.context, "_cv_Scheduling.BookingService", "BO-1003100032-ID", "ID_Service");
			fields[229] = new ims.framework.ReportField(this.context, "_cv_Scheduling.BookingAppointmentRef", "BO-1055100007-ID", "ID_Booking_Appointment");
			fields[230] = new ims.framework.ReportField(this.context, "_cv_Scheduling.BookingActivity", "BO-1007100005-ID", "ID_Activity");
			fields[231] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.ClinicList.__internal_x_context__SessionSlot_" + componentIdentifier, "BO-1055100016-ID", "ID_Session_Slot");
			fields[232] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.ClinicList.__internal_x_context__SessionSlot_" + componentIdentifier, "BO-1055100016-STARTTM", "StartTm");
			fields[233] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.ClinicList.__internal_x_context__SessionSlot_" + componentIdentifier, "BO-1055100016-DURATION", "Duration");
			fields[234] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.ClinicList.__internal_x_context__SessionSlot_" + componentIdentifier, "BO-1055100016-PRIORITY", "Priority");
			fields[235] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.ClinicList.__internal_x_context__SessionSlot_" + componentIdentifier, "BO-1055100016-ISACTIVE", "IsActive");
			fields[236] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.ClinicList.__internal_x_context__SessionSlot_" + componentIdentifier, "BO-1055100016-DIRECTACCESSSLOT", "DirectAccessSlot");
			fields[237] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.ClinicList.__internal_x_context__SessionSlot_" + componentIdentifier, "BO-1055100016-DEALLOCDATE", "DeallocDate");
			fields[238] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.ClinicList.__internal_x_context__SessionSlot_" + componentIdentifier, "BO-1055100016-STATUS", "Status");
			fields[239] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.ClinicList.__internal_x_context__SessionSlot_" + componentIdentifier, "BO-1055100016-STATUSREASON", "StatusReason");
			fields[240] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.ClinicList.__internal_x_context__SessionSlot_" + componentIdentifier, "BO-1055100016-SESSDATETIME", "SessDateTime");
			fields[241] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.ClinicList.__internal_x_context__SessionSlot_" + componentIdentifier, "BO-1055100016-CANCELBLOCKREASON", "CancelBlockReason");
			fields[242] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.ClinicList.__internal_x_context__SessionSlot_" + componentIdentifier, "BO-1055100016-CANCELBLOCKCOMMENT", "CancelBlockComment");
			fields[243] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.ClinicList.__internal_x_context__SessionSlot_" + componentIdentifier, "BO-1055100016-COMMENT", "Comment");
			fields[244] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.ClinicList.__internal_x_context__SessionSlot_" + componentIdentifier, "BO-1055100016-WASBLOCKEDCABSLOT", "WasBlockedCABSlot");
			fields[245] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.ClinicList.__internal_x_context__LastSelectedPatient_" + componentIdentifier, "BO-1001100000-ID", "ID_Patient");
			fields[246] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.ClinicList.__internal_x_context__LastSelectedPatient_" + componentIdentifier, "BO-1001100000-SEX", "Sex");
			fields[247] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.ClinicList.__internal_x_context__LastSelectedPatient_" + componentIdentifier, "BO-1001100000-DOB", "Dob");
			fields[248] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.ClinicList.__internal_x_context__LastSelectedPatient_" + componentIdentifier, "BO-1001100000-DOD", "Dod");
			fields[249] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.ClinicList.__internal_x_context__LastSelectedPatient_" + componentIdentifier, "BO-1001100000-RELIGION", "Religion");
			fields[250] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.ClinicList.__internal_x_context__LastSelectedPatient_" + componentIdentifier, "BO-1001100000-ISACTIVE", "IsActive");
			fields[251] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.ClinicList.__internal_x_context__LastSelectedPatient_" + componentIdentifier, "BO-1001100000-ETHNICORIGIN", "EthnicOrigin");
			fields[252] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.ClinicList.__internal_x_context__LastSelectedPatient_" + componentIdentifier, "BO-1001100000-MARITALSTATUS", "MaritalStatus");
			fields[253] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.ClinicList.__internal_x_context__LastSelectedPatient_" + componentIdentifier, "BO-1001100000-SCN", "SCN");
			fields[254] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.ClinicList.__internal_x_context__LastSelectedPatient_" + componentIdentifier, "BO-1001100000-SOURCEOFINFORMATION", "SourceOfInformation");
			fields[255] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.ClinicList.__internal_x_context__LastSelectedPatient_" + componentIdentifier, "BO-1001100000-TIMEOFDEATH", "TimeOfDeath");
			fields[256] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.ClinicList.__internal_x_context__LastSelectedPatient_" + componentIdentifier, "BO-1001100000-ISQUICKREGISTRATIONPATIENT", "IsQuickRegistrationPatient");
			fields[257] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.ClinicList.__internal_x_context__LastSelectedPatient_" + componentIdentifier, "BO-1001100000-CURRENTRESPONSIBLECONSULTANT", "CurrentResponsibleConsultant");
			fields[258] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.ClinicList.__internal_x_context__LastSelectedPatient_" + componentIdentifier, "BO-1001100000-DEMENTIABREACHDATETIME", "DementiaBreachDateTime");
			fields[259] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.ClinicList.__internal_x_context__LastSelectedPatient_" + componentIdentifier, "BO-1001100000-DEMENTIAWORKLISTSTATUS", "DementiaWorklistStatus");
			fields[260] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.ClinicList.__internal_x_context__LastSelectedPatient_" + componentIdentifier, "BO-1001100000-MRNSTATUS", "MRNStatus");
			fields[261] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.ClinicList.__internal_x_context__LastSelectedPatient_" + componentIdentifier, "BO-1001100000-HASSCANNEDCASENOTEFOLDERS", "HasScannedCaseNoteFolders");
			fields[262] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.ClinicList.__internal_x_context__LastSelectedPatient_" + componentIdentifier, "BO-1001100000-ISCONFIDENTIAL", "IsConfidential");
			fields[263] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.ClinicList.__internal_x_context__LastSelectedPatient_" + componentIdentifier, "BO-1001100000-TIMEOFBIRTH", "TimeOfBirth");
			fields[264] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.ClinicList.__internal_x_context__LastSelectedPatient_" + componentIdentifier, "BO-1001100000-PATIENTCATEGORY", "PatientCategory");
			return fields;
		}
