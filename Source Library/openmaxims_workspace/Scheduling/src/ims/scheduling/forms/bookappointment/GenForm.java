...
public class GenForm extends FormBridge
{
	...
	public static class grdSessionSlotsRow extends GridRowBridge
	{
		...
		public void setColSlotCommentReadOnly(boolean value)
		{
			super.row.setReadOnly(5, value);
		}
		public boolean isColSlotCommentReadOnly()
		{
			return super.row.isReadOnly(5);
		}
		public void showColSlotCommentOpened()
		{
			super.row.showOpened(5);
		}
		public void setTooltipForColSlotComment(String value)
		{
			super.row.setTooltip(5, value);
		}
		public String getColSlotComment()
		{
			return (String)super.row.get(5);
		}
		public void setColSlotComment(String value)
		{
			super.row.set(5, value);
		}
		public void setCellColSlotCommentTooltip(String value)
		{
			super.row.setTooltip(5, value);
		}
	...
	public static class grdSessionSlotsGrid extends GridBridge
	{
		...
		public void setColSlotCommentHeaderTooltip(String value)
		{
			super.grid.setColumnHeaderTooltip(5, value);
		}
		public String getColSlotCommentHeaderTooltip()
		{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1010), new Integer(anchoringHelper10.getX()), new Integer(anchoringHelper10.getY()), new Integer(anchoringHelper10.getWidth()), new Integer(anchoringHelper10.getHeight()), new Integer(startTabIndex.intValue() + 19), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Close", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1011), new Integer(anchoringHelper11.getX()), new Integer(anchoringHelper11.getY()), new Integer(anchoringHelper11.getWidth()), new Integer(anchoringHelper11.getHeight()), new Integer(startTabIndex.intValue() + 20), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Book", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1012), new Integer(anchoringHelper12.getX()), new Integer(anchoringHelper12.getY()), new Integer(anchoringHelper12.getWidth()), new Integer(anchoringHelper12.getHeight()), new Integer(startTabIndex.intValue() + 14), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "<<", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1013), new Integer(anchoringHelper13.getX()), new Integer(anchoringHelper13.getY()), new Integer(anchoringHelper13.getWidth()), new Integer(anchoringHelper13.getHeight()), new Integer(startTabIndex.intValue() + 13), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, ">>", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1014), new Integer(anchoringHelper14.getX()), new Integer(anchoringHelper14.getY()), new Integer(anchoringHelper14.getWidth()), new Integer(anchoringHelper14.getHeight()), new Integer(startTabIndex.intValue() + 21), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Cancel", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		ComboBox m_cmbPriorityTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1019), new Integer(anchoringHelper19.getX()), new Integer(anchoringHelper19.getY()), new Integer(anchoringHelper19.getWidth()), new Integer(anchoringHelper19.getHeight()), new Integer(startTabIndex.intValue() + 6), ControlState.ENABLED, ControlState.DISABLED,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
		...
		Grid m_grdSessionSlotsTemp = (Grid)factory.getControl(Grid.class, new Object[] { control, new Integer(startControlID.intValue() + 1023), new Integer(anchoringHelper23.getX()), new Integer(anchoringHelper23.getY()), new Integer(anchoringHelper23.getWidth()), new Integer(anchoringHelper23.getHeight()), new Integer(startTabIndex.intValue() + 15), ControlState.EDITABLE, ControlState.EDITABLE, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT,Boolean.FALSE, Boolean.FALSE, new Integer(24), Boolean.TRUE, null, Boolean.FALSE, Boolean.FALSE, new Integer(0), null, Boolean.TRUE, Boolean.TRUE});
		...
		grdSessionSlots.addStringColumn("   ", 2, 1, 15, true, false, 1, 0, false, ims.framework.enumerations.CharacterCasing.NORMAL);
		grdSessionSlots.setColSlotCommentHeaderTooltip("Slot/Session<br/>Has Comment");
		...
		Grid m_grdApptsTemp = (Grid)factory.getControl(Grid.class, new Object[] { control, new Integer(startControlID.intValue() + 1024), new Integer(anchoringHelper24.getX()), new Integer(anchoringHelper24.getY()), new Integer(anchoringHelper24.getWidth()), new Integer(anchoringHelper24.getHeight()), new Integer(startTabIndex.intValue() + 16), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL,Boolean.FALSE, Boolean.FALSE, new Integer(24), Boolean.TRUE, null, Boolean.FALSE, Boolean.FALSE, new Integer(0), null, Boolean.TRUE, Boolean.TRUE});
		...
		grdAppts.addIntColumn("Duration", 0, 0, 100, true, true, null, false, 0, true, 0);
		...
		super.addControl(factory.getControl(ImageButton.class, new Object[] { control, new Integer(startControlID.intValue() + 1026), new Integer(anchoringHelper26.getX()), new Integer(anchoringHelper26.getY()), new Integer(anchoringHelper26.getWidth()), new Integer(anchoringHelper26.getHeight()), new Integer(startTabIndex.intValue() + 11), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT, this.getImages().Core.ClearEnabled24, this.getImages().Core.ClearDisabled24, "Reset search criteria and results", Boolean.FALSE, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null}));
		...
		super.addControl(factory.getControl(BookingCalendar.class, new Object[] { control, new Integer(startControlID.intValue() + 1028), new Integer(anchoringHelper28.getX()), new Integer(anchoringHelper28.getY()), new Integer(anchoringHelper28.getWidth()), new Integer(anchoringHelper28.getHeight()), new Integer(startTabIndex.intValue() + 12), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, Boolean.FALSE}));
	}
	...
	public class LocalContext extends ContextBridge
	{
		...
		public LocalContext(Context context, ims.framework.FormInfo formInfo, String componentIdentifier)
		{
			...
			cxl_ApptInThePastMessageid = new ims.framework.ContextVariable("ApptInThePastMessageid", prefix + "_lv_Scheduling.BookAppointment.__internal_x_context__ApptInThePastMessageid_" + componentIdentifier + "");
			cxl_CurrentEmergencyAttendance = new ims.framework.ContextVariable("CurrentEmergencyAttendance", prefix + "_lv_Scheduling.BookAppointment.__internal_x_context__CurrentEmergencyAttendance_" + componentIdentifier + "");
		}
		...
		public boolean getApptInThePastMessageidIsNotNull()
		{
			return !cxl_ApptInThePastMessageid.getValueIsNull(context);
		}
		public Integer getApptInThePastMessageid()
		{
			return (Integer)cxl_ApptInThePastMessageid.getValue(context);
		}
		public void setApptInThePastMessageid(Integer value)
		{
			cxl_ApptInThePastMessageid.setValue(context, value);
		}
		private ims.framework.ContextVariable cxl_ApptInThePastMessageid = null;
		public boolean getCurrentEmergencyAttendanceIsNotNull()
		{
			return !cxl_CurrentEmergencyAttendance.getValueIsNull(context);
		}
		public ims.emergency.vo.EmergencyAttendanceOutcomeVo getCurrentEmergencyAttendance()
		{
			return (ims.emergency.vo.EmergencyAttendanceOutcomeVo)cxl_CurrentEmergencyAttendance.getValue(context);
		}
		public void setCurrentEmergencyAttendance(ims.emergency.vo.EmergencyAttendanceOutcomeVo value)
		{
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[188] = new ims.framework.ReportField(this.context, "_cv_Scheduling.BookingService", "BO-1003100032-ID", "ID_Service");
			fields[189] = new ims.framework.ReportField(this.context, "_cv_Scheduling.BookingActivity", "BO-1007100005-ID", "ID_Activity");
			fields[190] = new ims.framework.ReportField(this.context, "_cv_Scheduling.BookingSession", "BO-1055100010-ID", "ID_Sch_Session");
			fields[191] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.BookAppointment.__internal_x_context__Patient_" + componentIdentifier, "BO-1001100000-ID", "ID_Patient");
			fields[192] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.BookAppointment.__internal_x_context__Patient_" + componentIdentifier, "BO-1001100000-SEX", "Sex");
			fields[193] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.BookAppointment.__internal_x_context__Patient_" + componentIdentifier, "BO-1001100000-DOB", "Dob");
			fields[194] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.BookAppointment.__internal_x_context__Patient_" + componentIdentifier, "BO-1001100000-DOD", "Dod");
			fields[195] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.BookAppointment.__internal_x_context__Patient_" + componentIdentifier, "BO-1001100000-RELIGION", "Religion");
			fields[196] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.BookAppointment.__internal_x_context__Patient_" + componentIdentifier, "BO-1001100000-ISACTIVE", "IsActive");
			fields[197] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.BookAppointment.__internal_x_context__Patient_" + componentIdentifier, "BO-1001100000-ETHNICORIGIN", "EthnicOrigin");
			fields[198] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.BookAppointment.__internal_x_context__Patient_" + componentIdentifier, "BO-1001100000-MARITALSTATUS", "MaritalStatus");
			fields[199] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.BookAppointment.__internal_x_context__Patient_" + componentIdentifier, "BO-1001100000-SCN", "SCN");
			fields[200] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.BookAppointment.__internal_x_context__Patient_" + componentIdentifier, "BO-1001100000-SOURCEOFINFORMATION", "SourceOfInformation");
			fields[201] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.BookAppointment.__internal_x_context__Patient_" + componentIdentifier, "BO-1001100000-TIMEOFDEATH", "TimeOfDeath");
			fields[202] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.BookAppointment.__internal_x_context__Patient_" + componentIdentifier, "BO-1001100000-ISQUICKREGISTRATIONPATIENT", "IsQuickRegistrationPatient");
			fields[203] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.BookAppointment.__internal_x_context__Patient_" + componentIdentifier, "BO-1001100000-CURRENTRESPONSIBLECONSULTANT", "CurrentResponsibleConsultant");
			fields[204] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.BookAppointment.__internal_x_context__Patient_" + componentIdentifier, "BO-1001100000-DEMENTIABREACHDATETIME", "DementiaBreachDateTime");
			fields[205] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.BookAppointment.__internal_x_context__Patient_" + componentIdentifier, "BO-1001100000-DEMENTIAWORKLISTSTATUS", "DementiaWorklistStatus");
			fields[206] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.BookAppointment.__internal_x_context__Patient_" + componentIdentifier, "BO-1001100000-MRNSTATUS", "MRNStatus");
			fields[207] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.BookAppointment.__internal_x_context__Patient_" + componentIdentifier, "BO-1001100000-HASSCANNEDCASENOTEFOLDERS", "HasScannedCaseNoteFolders");
			fields[208] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.BookAppointment.__internal_x_context__Patient_" + componentIdentifier, "BO-1001100000-ISCONFIDENTIAL", "IsConfidential");
			fields[209] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.BookAppointment.__internal_x_context__Patient_" + componentIdentifier, "BO-1001100000-TIMEOFBIRTH", "TimeOfBirth");
			fields[210] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.BookAppointment.__internal_x_context__Patient_" + componentIdentifier, "BO-1001100000-PATIENTCATEGORY", "PatientCategory");
			fields[211] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.BookAppointment.__internal_x_context__Sch_Booking_" + componentIdentifier, "BO-1055100006-ID", "ID_Sch_Booking");
			fields[212] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.BookAppointment.__internal_x_context__Sch_Booking_" + componentIdentifier, "BO-1055100006-BOOKINGCOMMENTS", "BookingComments");
			fields[213] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.BookAppointment.__internal_x_context__Sch_Booking_" + componentIdentifier, "BO-1055100006-UBRN", "UBRN");
			fields[214] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.BookAppointment.__internal_x_context__Sch_Booking_" + componentIdentifier, "BO-1055100006-REFERRERSDSID", "ReferrerSdsId");
			fields[215] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.BookAppointment.__internal_x_context__Sch_Booking_" + componentIdentifier, "BO-1055100006-REFERRERSDSROLEID", "ReferrerSdsRoleId");
			fields[216] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.BookAppointment.__internal_x_context__Sch_Booking_" + componentIdentifier, "BO-1055100006-REFERRERSDSORGID", "ReferrerSdsOrgId");
			fields[217] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.BookAppointment.__internal_x_context__CareContextRef_" + componentIdentifier, "BO-1004100019-ID", "ID_CareContext");
			fields[218] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.BookAppointment.__internal_x_context__CurrentEmergencyAttendance_" + componentIdentifier, "BO-1004100025-ID", "ID_EmergencyAttendance");
			fields[219] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.BookAppointment.__internal_x_context__CurrentEmergencyAttendance_" + componentIdentifier, "BO-1004100025-CONCLUSIONDATETIME", "ConclusionDateTime");
			fields[220] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.BookAppointment.__internal_x_context__CurrentEmergencyAttendance_" + componentIdentifier, "BO-1004100025-BEDTYPEREQUESTED", "BedTypeRequested");
			fields[221] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.BookAppointment.__internal_x_context__CurrentEmergencyAttendance_" + componentIdentifier, "BO-1004100025-OUTCOME", "Outcome");
			fields[222] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.BookAppointment.__internal_x_context__CurrentEmergencyAttendance_" + componentIdentifier, "BO-1004100025-DESTINATION", "Destination");
			fields[223] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.BookAppointment.__internal_x_context__CurrentEmergencyAttendance_" + componentIdentifier, "BO-1004100025-DISCHARGEDATETIME", "DischargeDateTime");
			fields[224] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.BookAppointment.__internal_x_context__CurrentEmergencyAttendance_" + componentIdentifier, "BO-1004100025-REGISTRATIONDATETIME", "RegistrationDateTime");
			fields[225] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.BookAppointment.__internal_x_context__CurrentEmergencyAttendance_" + componentIdentifier, "BO-1004100025-ATTENDANCETYPE", "AttendanceType");
			fields[226] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.BookAppointment.__internal_x_context__CurrentEmergencyAttendance_" + componentIdentifier, "BO-1004100025-ATTENDANCEOUTCOMECOMMENT", "AttendanceOutcomeComment");
			fields[227] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.BookAppointment.__internal_x_context__CurrentEmergencyAttendance_" + componentIdentifier, "BO-1004100025-ATTENDANCEDISCHARGECOMMENT", "AttendanceDischargeComment");
			fields[228] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.BookAppointment.__internal_x_context__CurrentEmergencyAttendance_" + componentIdentifier, "BO-1004100025-GPLETTERSTATUS", "GPLetterStatus");
			fields[229] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.BookAppointment.__internal_x_context__CurrentEmergencyAttendance_" + componentIdentifier, "BO-1004100025-ARRIVALDATETIME", "ArrivalDateTime");
			fields[230] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.BookAppointment.__internal_x_context__CurrentEmergencyAttendance_" + componentIdentifier, "BO-1004100025-REQUIRESSIGNOFF", "RequiresSignOff");
			return fields;
		}
