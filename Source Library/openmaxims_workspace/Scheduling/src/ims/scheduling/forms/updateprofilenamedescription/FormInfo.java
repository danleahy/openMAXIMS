...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "UpdateProfileNameDescription";
	}
	public int getWidth()
	{
		return 528;
	...
	{
		return new String[] { "_cv_Scheduling.ProfileForProfileRippleVo" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Scheduling.UpdateProfileNameDescription.__internal_x_context__" + String.valueOf(getFormId());
	}
