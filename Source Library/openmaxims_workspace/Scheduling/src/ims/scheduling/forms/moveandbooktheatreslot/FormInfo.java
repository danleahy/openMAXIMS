...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Scheduling.SessionParentChildSlot", "_cv_Clinical.TheatreAppointmentRef" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Scheduling.MoveAndBookTheatreSlot.__internal_x_context__" + String.valueOf(getFormId());
	}
