...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Core.CommentDialogString", "_cv_Core.CommentDialogTitle", "_cv_Core.CommentDialogReadOnly" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Scheduling.SlotComment.__internal_x_context__" + String.valueOf(getFormId());
	}
