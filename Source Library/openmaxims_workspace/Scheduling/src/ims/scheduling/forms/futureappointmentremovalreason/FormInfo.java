...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "FutureAppointmentRemovalReason";
	}
	public int getWidth()
	{
		return 488;
	...
	{
		return new String[] { "_cv_Scheduling.FutureAppointmentRemoval" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Scheduling.FutureAppointmentRemovalReason.__internal_x_context__" + String.valueOf(getFormId());
	}
