...
public abstract class BaseLogic extends Handlers
{
	...
	{
		java.util.ArrayList listOfValues = this.form.lyrDetails().tabListOwners().cmbListType().getValues();
		...
		else if(value instanceof ims.scheduling.vo.lookups.ProfileListType)
		{
			...
			this.form.lyrDetails().tabListOwners().cmbListType().newRow(instance, instance.getText(), instance.getImage(), instance.getTextColor());
		}
	}
	protected final void bindcmbListTypeLookup()
	{
		this.form.lyrDetails().tabListOwners().cmbListType().clear();
		...
		for(int x = 0; x < lookupCollection.size(); x++)
		{
			this.form.lyrDetails().tabListOwners().cmbListType().newRow(lookupCollection.get(x), lookupCollection.get(x).getText(), lookupCollection.get(x).getImage(), lookupCollection.get(x).getTextColor());
		}
	}
	protected final void setcmbListTypeLookupValue(int id)
	{
		...
		if(instance != null)
			this.form.lyrDetails().tabListOwners().cmbListType().setValue(instance);
	}
	protected final void defaultcmbListTypeLookupValue()
	{
		this.form.lyrDetails().tabListOwners().cmbListType().setValue((ims.scheduling.vo.lookups.ProfileListType)domain.getLookupService().getDefaultInstance(ims.scheduling.vo.lookups.ProfileListType.class, engine.getFormName().getID(), ims.scheduling.vo.lookups.ProfileListType.TYPE_ID));
	}
