...
public class GenForm extends FormBridge
{
	...
	public static class lyrDetailsLayer extends Layer
	{
		...
		public static class tabGeneralDetailsContainer extends LayerBridge
		{
			...
			public static class cmbOtherHospComboBox extends ComboBoxBridge
			{
				private static final long serialVersionUID = 1L;
			...
			public static class qmbCaseNoteLocationComboBox extends ComboBoxBridge
			{
				private static final long serialVersionUID = 1L;
			...
			public static class grdServiceFunctionsRow extends GridRowBridge
			{
				...
				public void setColumnFunctionsReadOnly(boolean value)
				{
					super.row.setReadOnly(0, value);
				}
				public boolean isColumnFunctionsReadOnly()
				{
					return super.row.isReadOnly(0);
				}
				public void showColumnFunctionsOpened()
				{
				...
				public void setColumnFunctions(String value)
				{
					super.row.set(0, value);
				}
				public void setCellColumnFunctionsTooltip(String value)
				{
			...
			public static class grdServiceFunctionsGrid extends GridBridge
			{
				...
				public grdServiceFunctionsRow getRowByValue(ims.core.vo.lookups.ServiceFunction value)
				{
					GridRow row = super.grid.getRowByValue(value);
					return row == null?null:new grdServiceFunctionsRow(row);
				}
				public void setColumnFunctionsHeaderTooltip(String value)
				{
					super.grid.setColumnHeaderTooltip(0, value);
				}
				public String getColumnFunctionsHeaderTooltip()
				{
			...
			public static class GroupHospitalRadioButton extends RadioButtonBridge
			{
				private static final long serialVersionUID = 1L;
				...
				protected void setContext(Integer startTabIndex, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize)
				{
					...
					RuntimeAnchoring anchoringHelper1 = new RuntimeAnchoring(designSize, runtimeSize, 528, 104, 104, 16, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
					control.addButton(0, anchoringHelper1.getX(), anchoringHelper1.getY(), anchoringHelper1.getWidth(), "Other Hospital", startTabIndex.intValue() + 28);
					RuntimeAnchoring anchoringHelper2 = new RuntimeAnchoring(designSize, runtimeSize, 413, 104, 104, 16, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
					control.addButton(1, anchoringHelper2.getX(), anchoringHelper2.getY(), anchoringHelper2.getWidth(), "Profile Hospital", startTabIndex.intValue() + 27);
				}
				public void setText(GroupHospitalEnumeration option, String value)
				{
					if(option != null && option.id >= 0 && value != null)
						control.setText(option.id, value);
				}
				public GroupHospitalEnumeration getValue()
				{
					switch (super.control.getValue())
					{
						case -1: return GroupHospitalEnumeration.None;
						case 0: return GroupHospitalEnumeration.rdoOtherHospital;
						case 1: return GroupHospitalEnumeration.rdoProfileHospital;
					}
					return null;
				}
				public void setValue(GroupHospitalEnumeration value)
				{
					if(value != null)
						super.control.setValue(value.id);
					else
						super.control.setValue(GroupHospitalEnumeration.None.id);
				}
				public boolean isEnabled(GroupHospitalEnumeration option)
				{
					return super.control.isEnabled(option.id);
				}
				public void setEnabled(GroupHospitalEnumeration option, boolean value)
				{
					super.control.setEnabled(option.id, value);
				}
				public boolean isVisible(GroupHospitalEnumeration option)
				{
					return super.control.isVisible(option.id);
				}
				public void setVisible(GroupHospitalEnumeration option, boolean value)
				{
			...
			public static class GroupHospitalEnumeration implements java.io.Serializable
			{
				private static final long serialVersionUID = 1L;
				public static GroupHospitalEnumeration None = new GroupHospitalEnumeration(-1);
				public static GroupHospitalEnumeration rdoOtherHospital = new GroupHospitalEnumeration(0);
				public static GroupHospitalEnumeration rdoProfileHospital = new GroupHospitalEnumeration(1);
				private GroupHospitalEnumeration(int id)
				{
					this.id = id;
				}
				public boolean equals(Object o)
				{
					return this.id == ((GroupHospitalEnumeration)o).id;
				}
				private int id;
			}
		
			public static class GroupFlexibleProfileRadioButton extends RadioButtonBridge
			{
				private static final long serialVersionUID = 1L;
				...
				protected void setContext(Integer startTabIndex, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize)
				{
					if(startTabIndex == null)
						throw new RuntimeException("Invalid startTabIndex ");
					RuntimeAnchoring anchoringHelper3 = new RuntimeAnchoring(designSize, runtimeSize, 613, 16, 40, 16, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
					control.addButton(0, anchoringHelper3.getX(), anchoringHelper3.getY(), anchoringHelper3.getWidth(), "No", startTabIndex.intValue() + 24);
					RuntimeAnchoring anchoringHelper4 = new RuntimeAnchoring(designSize, runtimeSize, 549, 16, 40, 16, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
					control.addButton(1, anchoringHelper4.getX(), anchoringHelper4.getY(), anchoringHelper4.getWidth(), "Yes", startTabIndex.intValue() + 23);
				}
				public void setText(GroupFlexibleProfileEnumeration option, String value)
				{
					if(option != null && option.id >= 0 && value != null)
						control.setText(option.id, value);
				}
				public GroupFlexibleProfileEnumeration getValue()
				{
					switch (super.control.getValue())
					{
						case -1: return GroupFlexibleProfileEnumeration.None;
						case 0: return GroupFlexibleProfileEnumeration.rdoNo;
						case 1: return GroupFlexibleProfileEnumeration.rdoYes;
					}
					return null;
				}
				public void setValue(GroupFlexibleProfileEnumeration value)
				{
					if(value != null)
						super.control.setValue(value.id);
					else
						super.control.setValue(GroupFlexibleProfileEnumeration.None.id);
				}
				public boolean isEnabled(GroupFlexibleProfileEnumeration option)
				{
					return super.control.isEnabled(option.id);
				}
				public void setEnabled(GroupFlexibleProfileEnumeration option, boolean value)
				{
					super.control.setEnabled(option.id, value);
				}
				public boolean isVisible(GroupFlexibleProfileEnumeration option)
				{
					return super.control.isVisible(option.id);
				}
				public void setVisible(GroupFlexibleProfileEnumeration option, boolean value)
				{
					super.control.setVisible(option.id, value);
				}
				public void setVisible(boolean value)
			...
			public static class GroupFlexibleProfileEnumeration implements java.io.Serializable
			{
				private static final long serialVersionUID = 1L;
				public static GroupFlexibleProfileEnumeration None = new GroupFlexibleProfileEnumeration(-1);
				public static GroupFlexibleProfileEnumeration rdoNo = new GroupFlexibleProfileEnumeration(0);
				public static GroupFlexibleProfileEnumeration rdoYes = new GroupFlexibleProfileEnumeration(1);
				private GroupFlexibleProfileEnumeration(int id)
				{
					this.id = id;
				}
				public boolean equals(Object o)
				{
					return this.id == ((GroupFlexibleProfileEnumeration)o).id;
				}
				private int id;
			}
		
			public static class GroupProfileTypeRadioButton extends RadioButtonBridge
			{
				private static final long serialVersionUID = 1L;
				...
				protected void setContext(Integer startTabIndex, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize)
				{
					if(startTabIndex == null)
						throw new RuntimeException("Invalid startTabIndex ");
					RuntimeAnchoring anchoringHelper5 = new RuntimeAnchoring(designSize, runtimeSize, 256, 16, 112, 16, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
					control.addButton(0, anchoringHelper5.getX(), anchoringHelper5.getY(), anchoringHelper5.getWidth(), "Ward Attendance", startTabIndex.intValue() + 16);
					RuntimeAnchoring anchoringHelper6 = new RuntimeAnchoring(designSize, runtimeSize, 184, 16, 64, 16, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
					control.addButton(1, anchoringHelper6.getX(), anchoringHelper6.getY(), anchoringHelper6.getWidth(), "Theatre", startTabIndex.intValue() + 15);
					RuntimeAnchoring anchoringHelper7 = new RuntimeAnchoring(designSize, runtimeSize, 96, 16, 72, 16, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
					control.addButton(2, anchoringHelper7.getX(), anchoringHelper7.getY(), anchoringHelper7.getWidth(), "Outpatient", startTabIndex.intValue() + 14);
				}
				public void setText(GroupProfileTypeEnumeration option, String value)
				{
					if(option != null && option.id >= 0 && value != null)
						control.setText(option.id, value);
				}
				public GroupProfileTypeEnumeration getValue()
				{
					switch (super.control.getValue())
					{
						case -1: return GroupProfileTypeEnumeration.None;
						case 0: return GroupProfileTypeEnumeration.rdoWardAttendance;
						case 1: return GroupProfileTypeEnumeration.rdoTheatre;
						case 2: return GroupProfileTypeEnumeration.rdoOutpatient;
					}
					return null;
				}
				public void setValue(GroupProfileTypeEnumeration value)
				{
					if(value != null)
						super.control.setValue(value.id);
					else
						super.control.setValue(GroupProfileTypeEnumeration.None.id);
				}
				public boolean isEnabled(GroupProfileTypeEnumeration option)
				{
					return super.control.isEnabled(option.id);
				}
				public void setEnabled(GroupProfileTypeEnumeration option, boolean value)
				{
					super.control.setEnabled(option.id, value);
				}
				public boolean isVisible(GroupProfileTypeEnumeration option)
				{
					return super.control.isVisible(option.id);
				}
				public void setVisible(GroupProfileTypeEnumeration option, boolean value)
				{
					super.control.setVisible(option.id, value);
				}
				public void setVisible(boolean value)
			...
			public static class GroupProfileTypeEnumeration implements java.io.Serializable
			{
				private static final long serialVersionUID = 1L;
				public static GroupProfileTypeEnumeration None = new GroupProfileTypeEnumeration(-1);
				public static GroupProfileTypeEnumeration rdoWardAttendance = new GroupProfileTypeEnumeration(0);
				public static GroupProfileTypeEnumeration rdoTheatre = new GroupProfileTypeEnumeration(1);
				public static GroupProfileTypeEnumeration rdoOutpatient = new GroupProfileTypeEnumeration(2);
				private GroupProfileTypeEnumeration(int id)
				{
					this.id = id;
				}
				public boolean equals(Object o)
				{
					return this.id == ((GroupProfileTypeEnumeration)o).id;
				}
				private int id;
			}
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				// Label Controls
				RuntimeAnchoring anchoringHelper8 = new RuntimeAnchoring(designSize, runtimeSize, 8, 88, 55, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
				...
				RuntimeAnchoring anchoringHelper9 = new RuntimeAnchoring(designSize, runtimeSize, 376, 13, 14, 22, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
				super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1001), new Integer(anchoringHelper9.getX()), new Integer(anchoringHelper9.getY()), new Integer(anchoringHelper9.getWidth()), new Integer(anchoringHelper9.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "*", new Integer(0), null, new Integer(1)}));
				RuntimeAnchoring anchoringHelper10 = new RuntimeAnchoring(designSize, runtimeSize, 649, 13, 14, 22, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
				super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1002), new Integer(anchoringHelper10.getX()), new Integer(anchoringHelper10.getY()), new Integer(anchoringHelper10.getWidth()), new Integer(anchoringHelper10.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "*", new Integer(0), null, new Integer(1)}));
				RuntimeAnchoring anchoringHelper11 = new RuntimeAnchoring(designSize, runtimeSize, 621, 208, 42, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
				super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1003), new Integer(anchoringHelper11.getX()), new Integer(anchoringHelper11.getY()), new Integer(anchoringHelper11.getWidth()), new Integer(anchoringHelper11.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Weeks", new Integer(1), null, new Integer(0)}));
				RuntimeAnchoring anchoringHelper12 = new RuntimeAnchoring(designSize, runtimeSize, 413, 208, 132, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
				super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1004), new Integer(anchoringHelper12.getX()), new Integer(anchoringHelper12.getY()), new Integer(anchoringHelper12.getWidth()), new Integer(anchoringHelper12.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Auto-Generate Period:", new Integer(1), null, new Integer(0)}));
				RuntimeAnchoring anchoringHelper13 = new RuntimeAnchoring(designSize, runtimeSize, 413, 16, 93, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
				super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1005), new Integer(anchoringHelper13.getX()), new Integer(anchoringHelper13.getY()), new Integer(anchoringHelper13.getWidth()), new Integer(anchoringHelper13.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Flexible Profile:", new Integer(1), null, new Integer(0)}));
				RuntimeAnchoring anchoringHelper14 = new RuntimeAnchoring(designSize, runtimeSize, 7, 16, 76, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
				super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1006), new Integer(anchoringHelper14.getX()), new Integer(anchoringHelper14.getY()), new Integer(anchoringHelper14.getWidth()), new Integer(anchoringHelper14.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Profile Type:", new Integer(1), null, new Integer(0)}));
				RuntimeAnchoring anchoringHelper15 = new RuntimeAnchoring(designSize, runtimeSize, 413, 128, 107, 32, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
				super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1007), new Integer(anchoringHelper15.getX()), new Integer(anchoringHelper15.getY()), new Integer(anchoringHelper15.getWidth()), new Integer(anchoringHelper15.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Case Note Folders\nLocation:", new Integer(1), null, new Integer(0)}));
				RuntimeAnchoring anchoringHelper16 = new RuntimeAnchoring(designSize, runtimeSize, 413, 160, 118, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
				super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1008), new Integer(anchoringHelper16.getX()), new Integer(anchoringHelper16.getY()), new Integer(anchoringHelper16.getWidth()), new Integer(anchoringHelper16.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Consultation Media:", new Integer(1), null, new Integer(0)}));
				RuntimeAnchoring anchoringHelper17 = new RuntimeAnchoring(designSize, runtimeSize, 413, 264, 61, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
				...
				RuntimeAnchoring anchoringHelper18 = new RuntimeAnchoring(designSize, runtimeSize, 413, 77, 106, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
				super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1010), new Integer(anchoringHelper18.getX()), new Integer(anchoringHelper18.getY()), new Integer(anchoringHelper18.getWidth()), new Integer(anchoringHelper18.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Anaesthetic Type:", new Integer(1), null, new Integer(0)}));
				RuntimeAnchoring anchoringHelper19 = new RuntimeAnchoring(designSize, runtimeSize, 413, 46, 130, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
				super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1011), new Integer(anchoringHelper19.getX()), new Integer(anchoringHelper19.getY()), new Integer(anchoringHelper19.getWidth()), new Integer(anchoringHelper19.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Theatre Session Type:", new Integer(1), null, new Integer(0)}));
				RuntimeAnchoring anchoringHelper20 = new RuntimeAnchoring(designSize, runtimeSize, 7, 113, 57, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
				super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1012), new Integer(anchoringHelper20.getX()), new Integer(anchoringHelper20.getY()), new Integer(anchoringHelper20.getWidth()), new Integer(anchoringHelper20.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Location:", new Integer(1), null, new Integer(0)}));
				RuntimeAnchoring anchoringHelper21 = new RuntimeAnchoring(designSize, runtimeSize, 7, 139, 53, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
				super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1013), new Integer(anchoringHelper21.getX()), new Integer(anchoringHelper21.getY()), new Integer(anchoringHelper21.getWidth()), new Integer(anchoringHelper21.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Service: ", new Integer(1), null, new Integer(0)}));
				RuntimeAnchoring anchoringHelper22 = new RuntimeAnchoring(designSize, runtimeSize, 7, 39, 82, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
				super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1014), new Integer(anchoringHelper22.getX()), new Integer(anchoringHelper22.getY()), new Integer(anchoringHelper22.getWidth()), new Integer(anchoringHelper22.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Profile Name:", new Integer(1), null, new Integer(0)}));
		
				// TextBox Controls
				RuntimeAnchoring anchoringHelper23 = new RuntimeAnchoring(designSize, runtimeSize, 96, 37, 240, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
				super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1015), new Integer(anchoringHelper23.getX()), new Integer(anchoringHelper23.getY()), new Integer(anchoringHelper23.getWidth()), new Integer(anchoringHelper23.getHeight()), new Integer(startTabIndex.intValue() + 17), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.FALSE, new Integer(100), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.TRUE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
		
				// ComboBox Controls
				RuntimeAnchoring anchoringHelper24 = new RuntimeAnchoring(designSize, runtimeSize, 643, 104, 121, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
				ComboBox m_cmbOtherHospTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1016), new Integer(anchoringHelper24.getX()), new Integer(anchoringHelper24.getY()), new Integer(anchoringHelper24.getWidth()), new Integer(anchoringHelper24.getHeight()), new Integer(startTabIndex.intValue() + 29), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,Boolean.TRUE, Boolean.TRUE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
				addControl(m_cmbOtherHospTemp);
				cmbOtherHospComboBox cmbOtherHosp = (cmbOtherHospComboBox)ComboBoxFlyweightFactory.getInstance().createComboBoxBridge(cmbOtherHospComboBox.class, m_cmbOtherHospTemp);
				super.addComboBox(cmbOtherHosp);
				RuntimeAnchoring anchoringHelper25 = new RuntimeAnchoring(designSize, runtimeSize, 96, 86, 240, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
				ComboBox m_cmbHospitalTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1017), new Integer(anchoringHelper25.getX()), new Integer(anchoringHelper25.getY()), new Integer(anchoringHelper25.getWidth()), new Integer(anchoringHelper25.getHeight()), new Integer(startTabIndex.intValue() + 19), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,Boolean.TRUE, Boolean.TRUE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
				...
				RuntimeAnchoring anchoringHelper26 = new RuntimeAnchoring(designSize, runtimeSize, 549, 160, 216, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
				ComboBox m_cmbConsMediaTypeTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1018), new Integer(anchoringHelper26.getX()), new Integer(anchoringHelper26.getY()), new Integer(anchoringHelper26.getWidth()), new Integer(anchoringHelper26.getHeight()), new Integer(startTabIndex.intValue() + 31), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
				...
				RuntimeAnchoring anchoringHelper27 = new RuntimeAnchoring(designSize, runtimeSize, 549, 264, 219, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
				ComboBox m_cmbSlotTypeTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1019), new Integer(anchoringHelper27.getX()), new Integer(anchoringHelper27.getY()), new Integer(anchoringHelper27.getWidth()), new Integer(anchoringHelper27.getHeight()), new Integer(startTabIndex.intValue() + 36), ControlState.HIDDEN, ControlState.HIDDEN,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,Boolean.TRUE, Boolean.TRUE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
				...
				RuntimeAnchoring anchoringHelper28 = new RuntimeAnchoring(designSize, runtimeSize, 549, 44, 219, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
				ComboBox m_cmbTheatreTypeTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1020), new Integer(anchoringHelper28.getX()), new Integer(anchoringHelper28.getY()), new Integer(anchoringHelper28.getWidth()), new Integer(anchoringHelper28.getHeight()), new Integer(startTabIndex.intValue() + 32), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,Boolean.TRUE, Boolean.TRUE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.TRUE, new Integer(-1)});
				...
				RuntimeAnchoring anchoringHelper29 = new RuntimeAnchoring(designSize, runtimeSize, 96, 137, 240, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
				ComboBox m_cmbSpecialityTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1021), new Integer(anchoringHelper29.getX()), new Integer(anchoringHelper29.getY()), new Integer(anchoringHelper29.getWidth()), new Integer(anchoringHelper29.getHeight()), new Integer(startTabIndex.intValue() + 21), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,Boolean.TRUE, Boolean.TRUE, SortOrder.ASCENDING, Boolean.FALSE, new Integer(1), null, Boolean.TRUE, new Integer(-1)});
				...
				RuntimeAnchoring anchoringHelper30 = new RuntimeAnchoring(designSize, runtimeSize, 549, 136, 216, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
				ComboBox m_qmbCaseNoteLocationTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1022), new Integer(anchoringHelper30.getX()), new Integer(anchoringHelper30.getY()), new Integer(anchoringHelper30.getWidth()), new Integer(anchoringHelper30.getHeight()), new Integer(startTabIndex.intValue() + 30), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.TRUE, Boolean.TRUE, SortOrder.NONE, Boolean.TRUE, new Integer(1), null, Boolean.TRUE, new Integer(-1), Boolean.FALSE});
				addControl(m_qmbCaseNoteLocationTemp);
				qmbCaseNoteLocationComboBox qmbCaseNoteLocation = (qmbCaseNoteLocationComboBox)ComboBoxFlyweightFactory.getInstance().createComboBoxBridge(qmbCaseNoteLocationComboBox.class, m_qmbCaseNoteLocationTemp);
				super.addComboBox(qmbCaseNoteLocation);
				RuntimeAnchoring anchoringHelper31 = new RuntimeAnchoring(designSize, runtimeSize, 96, 111, 240, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
				ComboBox m_qmbLocationTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1023), new Integer(anchoringHelper31.getX()), new Integer(anchoringHelper31.getY()), new Integer(anchoringHelper31.getWidth()), new Integer(anchoringHelper31.getHeight()), new Integer(startTabIndex.intValue() + 20), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.TRUE, new Integer(1), null, Boolean.TRUE, new Integer(-1), Boolean.FALSE});
				...
				RuntimeAnchoring anchoringHelper32 = new RuntimeAnchoring(designSize, runtimeSize, 549, 77, 216, 94, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
				CheckedListBox m_chklistAnaesthetictypeTemp = (CheckedListBox)factory.getControl(CheckedListBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1024), new Integer(anchoringHelper32.getX()), new Integer(anchoringHelper32.getY()), new Integer(anchoringHelper32.getWidth()), new Integer(anchoringHelper32.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFT, null, Boolean.FALSE, null, new Integer(startTabIndex.intValue() + 33), Boolean.FALSE, null});
				...
				// CheckBox Controls
				RuntimeAnchoring anchoringHelper33 = new RuntimeAnchoring(designSize, runtimeSize, 413, 232, 168, 16, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
				super.addControl(factory.getControl(CheckBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1025), new Integer(anchoringHelper33.getX()), new Integer(anchoringHelper33.getY()), new Integer(anchoringHelper33.getWidth()), new Integer(anchoringHelper33.getHeight()), new Integer(startTabIndex.intValue() + 35), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,"Ready to Generate Sessions", Boolean.FALSE, null}));
				RuntimeAnchoring anchoringHelper34 = new RuntimeAnchoring(designSize, runtimeSize, 413, 48, 216, 16, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
				super.addControl(factory.getControl(CheckBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1026), new Integer(anchoringHelper34.getX()), new Integer(anchoringHelper34.getY()), new Integer(anchoringHelper34.getWidth()), new Integer(anchoringHelper34.getHeight()), new Integer(startTabIndex.intValue() + 25), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,"The Profile has Choose and Book Activity", Boolean.TRUE, null}));
				RuntimeAnchoring anchoringHelper35 = new RuntimeAnchoring(designSize, runtimeSize, 413, 68, 160, 16, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
				...
				RuntimeAnchoring anchoringHelper36 = new RuntimeAnchoring(designSize, runtimeSize, 96, 65, 128, 16, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
				super.addControl(factory.getControl(CheckBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1028), new Integer(anchoringHelper36.getX()), new Integer(anchoringHelper36.getY()), new Integer(anchoringHelper36.getWidth()), new Integer(anchoringHelper36.getHeight()), new Integer(startTabIndex.intValue() + 18), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,"Profile is Active", Boolean.TRUE, null}));
		
				// Grid Controls
				RuntimeAnchoring anchoringHelper37 = new RuntimeAnchoring(designSize, runtimeSize, 8, 168, 352, 120, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
				Grid m_grdServiceFunctionsTemp = (Grid)factory.getControl(Grid.class, new Object[] { control, new Integer(startControlID.intValue() + 1029), new Integer(anchoringHelper37.getX()), new Integer(anchoringHelper37.getY()), new Integer(anchoringHelper37.getWidth()), new Integer(anchoringHelper37.getHeight()), new Integer(startTabIndex.intValue() + 22), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.FALSE, Boolean.FALSE, new Integer(24), Boolean.TRUE, contextMenus.Scheduling.contextMenuProfileServiceFunctions, Boolean.FALSE, Boolean.FALSE, new Integer(0), null, Boolean.FALSE, Boolean.TRUE});
				...
				grdServiceFunctions.addStringColumn("Clinic Type / Function", 0, 0, 250, true, false, 0, 0, true, ims.framework.enumerations.CharacterCasing.NORMAL);
				grdServiceFunctions.addBoolColumn("Select", 1, 1, -1, false, true, 0, true);
				super.addGrid(grdServiceFunctions);
		
				// IntBox Controls
				RuntimeAnchoring anchoringHelper38 = new RuntimeAnchoring(designSize, runtimeSize, 549, 208, 56, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
				super.addControl(factory.getControl(IntBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1030), new Integer(anchoringHelper38.getX()), new Integer(anchoringHelper38.getY()), new Integer(anchoringHelper38.getWidth()), new Integer(anchoringHelper38.getHeight()), new Integer(startTabIndex.intValue() + 34), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.TRUE, Boolean.FALSE, Boolean.FALSE, null, null, Boolean.FALSE, new Integer(9)}));
		
				// RadioButton Controls
				RadioButton tmpGroupHospital = (RadioButton)factory.getControl(RadioButton.class, new Object[] { control, new Integer(startControlID.intValue() + 1031), new Integer(0), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.TRUE});
				super.addControl(tmpGroupHospital);
				GroupHospitalRadioButton GroupHospital = (GroupHospitalRadioButton)RadioButtonBridgeFlyweightFactory.getInstance().createRadioButtonBridge(GroupHospitalRadioButton.class, tmpGroupHospital);
				GroupHospital.setContext(startTabIndex, designSize, runtimeSize);
				super.addRadioButton(GroupHospital);
				RadioButton tmpGroupFlexibleProfile = (RadioButton)factory.getControl(RadioButton.class, new Object[] { control, new Integer(startControlID.intValue() + 1032), new Integer(0), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.TRUE});
				super.addControl(tmpGroupFlexibleProfile);
				GroupFlexibleProfileRadioButton GroupFlexibleProfile = (GroupFlexibleProfileRadioButton)RadioButtonBridgeFlyweightFactory.getInstance().createRadioButtonBridge(GroupFlexibleProfileRadioButton.class, tmpGroupFlexibleProfile);
				GroupFlexibleProfile.setContext(startTabIndex, designSize, runtimeSize);
				super.addRadioButton(GroupFlexibleProfile);
				RadioButton tmpGroupProfileType = (RadioButton)factory.getControl(RadioButton.class, new Object[] { control, new Integer(startControlID.intValue() + 1033), new Integer(0), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.TRUE});
				super.addControl(tmpGroupProfileType);
				GroupProfileTypeRadioButton GroupProfileType = (GroupProfileTypeRadioButton)RadioButtonBridgeFlyweightFactory.getInstance().createRadioButtonBridge(GroupProfileTypeRadioButton.class, tmpGroupProfileType);
				GroupProfileType.setContext(startTabIndex, designSize, runtimeSize);
				super.addRadioButton(GroupProfileType);
			}

			public Label lblProfileTypeStar()
			{
				return (Label)super.getControl(1);
			}
			public Label lblFlexibleProfileStar()
			{
				return (Label)super.getControl(2);
			}
			public Label lblWeeks()
			{
				return (Label)super.getControl(3);
			}
			public Label lblAutoGeneratePeriod()
			{
				return (Label)super.getControl(4);
			}
			public Label lblFlexibleProfile()
			{
			...
			public Label lblConsultationType()
			{
			...
			public cmbOtherHospComboBox cmbOtherHosp()
			{
				return (cmbOtherHospComboBox)super.getComboBox(0);
			}
			...
			{
				return (cmbConsMediaTypeComboBox)super.getComboBox(2);
			}
			public cmbSlotTypeComboBox cmbSlotType()
			{
				return (cmbSlotTypeComboBox)super.getComboBox(3);
			}
			...
			{
				return (cmbSpecialityComboBox)super.getComboBox(5);
			}
			public qmbCaseNoteLocationComboBox qmbCaseNoteLocation()
			{
				return (qmbCaseNoteLocationComboBox)super.getComboBox(6);
			}
			public qmbLocationComboBox qmbLocation()
			{
				return (qmbLocationComboBox)super.getComboBox(7);
			}
			...
			public CheckBox chkReadyToGenerateSessions()
			{
				return (CheckBox)super.getControl(25);
			}
			public CheckBox chkProfileHasChooseAndBookActivity()
			{
			...
			public IntBox intAutoGeneratePeriodWeeks()
			{
				return (IntBox)super.getControl(30);
			}
			public GroupHospitalRadioButton GroupHospital()
			{
				return (GroupHospitalRadioButton)super.getRadioButton(0);
			}
			public GroupFlexibleProfileRadioButton GroupFlexibleProfile()
			{
				return (GroupFlexibleProfileRadioButton)super.getRadioButton(1);
			}
			public GroupProfileTypeRadioButton GroupProfileType()
			{
				return (GroupProfileTypeRadioButton)super.getRadioButton(2);
			}
		}
		public static class tabProfileDetailsContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				// Label Controls
				RuntimeAnchoring anchoringHelper39 = new RuntimeAnchoring(designSize, runtimeSize, 744, 26, 11, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
				super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1034), new Integer(anchoringHelper39.getX()), new Integer(anchoringHelper39.getY()), new Integer(anchoringHelper39.getWidth()), new Integer(anchoringHelper39.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "  ", new Integer(1), null, new Integer(0)}));
				RuntimeAnchoring anchoringHelper40 = new RuntimeAnchoring(designSize, runtimeSize, 360, 179, 140, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
				super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1035), new Integer(anchoringHelper40.getX()), new Integer(anchoringHelper40.getY()), new Integer(anchoringHelper40.getWidth()), new Integer(anchoringHelper40.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "of week day(s) selected", new Integer(1), null, new Integer(0)}));
				RuntimeAnchoring anchoringHelper41 = new RuntimeAnchoring(designSize, runtimeSize, 624, 26, 40, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
				...
				RuntimeAnchoring anchoringHelper42 = new RuntimeAnchoring(designSize, runtimeSize, 360, 65, 75, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
				...
				RuntimeAnchoring anchoringHelper43 = new RuntimeAnchoring(designSize, runtimeSize, 360, 160, 79, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
				super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1038), new Integer(anchoringHelper43.getX()), new Integer(anchoringHelper43.getY()), new Integer(anchoringHelper43.getWidth()), new Integer(anchoringHelper43.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Occurrence:  ", new Integer(1), null, new Integer(0)}));
				RuntimeAnchoring anchoringHelper44 = new RuntimeAnchoring(designSize, runtimeSize, 16, 128, 64, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
				...
				RuntimeAnchoring anchoringHelper45 = new RuntimeAnchoring(designSize, runtimeSize, 16, 94, 71, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
				...
				RuntimeAnchoring anchoringHelper46 = new RuntimeAnchoring(designSize, runtimeSize, 360, 26, 52, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
				super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1041), new Integer(anchoringHelper46.getX()), new Integer(anchoringHelper46.getY()), new Integer(anchoringHelper46.getWidth()), new Integer(anchoringHelper46.getHeight()), ControlState.UNKNOWN, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Repeat: ", new Integer(1), null, new Integer(0)}));
				RuntimeAnchoring anchoringHelper47 = new RuntimeAnchoring(designSize, runtimeSize, 16, 60, 63, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
				super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1042), new Integer(anchoringHelper47.getX()), new Integer(anchoringHelper47.getY()), new Integer(anchoringHelper47.getWidth()), new Integer(anchoringHelper47.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "End Date: ", new Integer(1), null, new Integer(0)}));
				RuntimeAnchoring anchoringHelper48 = new RuntimeAnchoring(designSize, runtimeSize, 16, 26, 90, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
				...
				// Date Controls
				RuntimeAnchoring anchoringHelper49 = new RuntimeAnchoring(designSize, runtimeSize, 128, 58, 144, 20, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
				...
				RuntimeAnchoring anchoringHelper50 = new RuntimeAnchoring(designSize, runtimeSize, 128, 24, 144, 20, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
				super.addControl(factory.getControl(DateControl.class, new Object[] { control, new Integer(startControlID.intValue() + 1045), new Integer(anchoringHelper50.getX()), new Integer(anchoringHelper50.getY()), new Integer(anchoringHelper50.getWidth()), new Integer(anchoringHelper50.getHeight()), new Integer(startTabIndex.intValue() + 37), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.TRUE, null, Boolean.TRUE, null, Boolean.TRUE, null}));
		
				// ComboBox Controls
				RuntimeAnchoring anchoringHelper51 = new RuntimeAnchoring(designSize, runtimeSize, 464, 24, 144, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
				...
				// CheckBox Controls
				RuntimeAnchoring anchoringHelper52 = new RuntimeAnchoring(designSize, runtimeSize, 464, 112, 64, 16, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
				super.addControl(factory.getControl(CheckBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1047), new Integer(anchoringHelper52.getX()), new Integer(anchoringHelper52.getY()), new Integer(anchoringHelper52.getWidth()), new Integer(anchoringHelper52.getHeight()), new Integer(startTabIndex.intValue() + 45), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,"Tuesday", Boolean.FALSE, null}));
				RuntimeAnchoring anchoringHelper53 = new RuntimeAnchoring(designSize, runtimeSize, 464, 136, 80, 16, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
				super.addControl(factory.getControl(CheckBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1048), new Integer(anchoringHelper53.getX()), new Integer(anchoringHelper53.getY()), new Integer(anchoringHelper53.getWidth()), new Integer(anchoringHelper53.getHeight()), new Integer(startTabIndex.intValue() + 46), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,"Wednesday", Boolean.FALSE, null}));
				RuntimeAnchoring anchoringHelper54 = new RuntimeAnchoring(designSize, runtimeSize, 560, 65, 72, 16, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
				super.addControl(factory.getControl(CheckBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1049), new Integer(anchoringHelper54.getX()), new Integer(anchoringHelper54.getY()), new Integer(anchoringHelper54.getWidth()), new Integer(anchoringHelper54.getHeight()), new Integer(startTabIndex.intValue() + 47), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,"Thursday", Boolean.FALSE, null}));
				RuntimeAnchoring anchoringHelper55 = new RuntimeAnchoring(designSize, runtimeSize, 560, 88, 72, 16, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
				super.addControl(factory.getControl(CheckBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1050), new Integer(anchoringHelper55.getX()), new Integer(anchoringHelper55.getY()), new Integer(anchoringHelper55.getWidth()), new Integer(anchoringHelper55.getHeight()), new Integer(startTabIndex.intValue() + 48), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,"Friday", Boolean.FALSE, null}));
				RuntimeAnchoring anchoringHelper56 = new RuntimeAnchoring(designSize, runtimeSize, 560, 112, 64, 16, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
				super.addControl(factory.getControl(CheckBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1051), new Integer(anchoringHelper56.getX()), new Integer(anchoringHelper56.getY()), new Integer(anchoringHelper56.getWidth()), new Integer(anchoringHelper56.getHeight()), new Integer(startTabIndex.intValue() + 49), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,"Saturday", Boolean.FALSE, null}));
				RuntimeAnchoring anchoringHelper57 = new RuntimeAnchoring(designSize, runtimeSize, 464, 65, 64, 16, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
				super.addControl(factory.getControl(CheckBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1052), new Integer(anchoringHelper57.getX()), new Integer(anchoringHelper57.getY()), new Integer(anchoringHelper57.getWidth()), new Integer(anchoringHelper57.getHeight()), new Integer(startTabIndex.intValue() + 43), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,"Sunday", Boolean.FALSE, null}));
				RuntimeAnchoring anchoringHelper58 = new RuntimeAnchoring(designSize, runtimeSize, 464, 88, 72, 16, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
				super.addControl(factory.getControl(CheckBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1053), new Integer(anchoringHelper58.getX()), new Integer(anchoringHelper58.getY()), new Integer(anchoringHelper58.getWidth()), new Integer(anchoringHelper58.getHeight()), new Integer(startTabIndex.intValue() + 44), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,"Monday", Boolean.FALSE, null}));
				RuntimeAnchoring anchoringHelper59 = new RuntimeAnchoring(designSize, runtimeSize, 512, 160, 40, 16, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
				super.addControl(factory.getControl(CheckBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1054), new Integer(anchoringHelper59.getX()), new Integer(anchoringHelper59.getY()), new Integer(anchoringHelper59.getWidth()), new Integer(anchoringHelper59.getHeight()), new Integer(startTabIndex.intValue() + 51), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,"2nd", Boolean.FALSE, null}));
				RuntimeAnchoring anchoringHelper60 = new RuntimeAnchoring(designSize, runtimeSize, 560, 160, 40, 16, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
				super.addControl(factory.getControl(CheckBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1055), new Integer(anchoringHelper60.getX()), new Integer(anchoringHelper60.getY()), new Integer(anchoringHelper60.getWidth()), new Integer(anchoringHelper60.getHeight()), new Integer(startTabIndex.intValue() + 52), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,"3rd", Boolean.FALSE, null}));
				RuntimeAnchoring anchoringHelper61 = new RuntimeAnchoring(designSize, runtimeSize, 608, 160, 48, 16, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
				super.addControl(factory.getControl(CheckBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1056), new Integer(anchoringHelper61.getX()), new Integer(anchoringHelper61.getY()), new Integer(anchoringHelper61.getWidth()), new Integer(anchoringHelper61.getHeight()), new Integer(startTabIndex.intValue() + 53), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,"4th", Boolean.FALSE, null}));
				RuntimeAnchoring anchoringHelper62 = new RuntimeAnchoring(designSize, runtimeSize, 656, 160, 40, 16, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
				super.addControl(factory.getControl(CheckBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1057), new Integer(anchoringHelper62.getX()), new Integer(anchoringHelper62.getY()), new Integer(anchoringHelper62.getWidth()), new Integer(anchoringHelper62.getHeight()), new Integer(startTabIndex.intValue() + 54), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,"5th", Boolean.FALSE, null}));
				RuntimeAnchoring anchoringHelper63 = new RuntimeAnchoring(designSize, runtimeSize, 464, 160, 40, 16, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
				super.addControl(factory.getControl(CheckBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1058), new Integer(anchoringHelper63.getX()), new Integer(anchoringHelper63.getY()), new Integer(anchoringHelper63.getWidth()), new Integer(anchoringHelper63.getHeight()), new Integer(startTabIndex.intValue() + 50), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,"1st", Boolean.FALSE, null}));
		
				// Time Controls
				RuntimeAnchoring anchoringHelper64 = new RuntimeAnchoring(designSize, runtimeSize, 128, 126, 64, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
				super.addControl(factory.getControl(TimeControl.class, new Object[] { control, new Integer(startControlID.intValue() + 1059), new Integer(anchoringHelper64.getX()), new Integer(anchoringHelper64.getY()), new Integer(anchoringHelper64.getWidth()), new Integer(anchoringHelper64.getHeight()), new Integer(startTabIndex.intValue() + 40), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.TRUE, Boolean.FALSE, null, Boolean.TRUE, ""}));
				RuntimeAnchoring anchoringHelper65 = new RuntimeAnchoring(designSize, runtimeSize, 128, 92, 64, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
				super.addControl(factory.getControl(TimeControl.class, new Object[] { control, new Integer(startControlID.intValue() + 1060), new Integer(anchoringHelper65.getX()), new Integer(anchoringHelper65.getY()), new Integer(anchoringHelper65.getWidth()), new Integer(anchoringHelper65.getHeight()), new Integer(startTabIndex.intValue() + 39), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.TRUE, Boolean.FALSE, null, Boolean.TRUE, ""}));
		
				// IntBox Controls
				RuntimeAnchoring anchoringHelper66 = new RuntimeAnchoring(designSize, runtimeSize, 672, 24, 56, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
				super.addControl(factory.getControl(IntBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1061), new Integer(anchoringHelper66.getX()), new Integer(anchoringHelper66.getY()), new Integer(anchoringHelper66.getWidth()), new Integer(anchoringHelper66.getHeight()), new Integer(startTabIndex.intValue() + 42), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.TRUE, Boolean.TRUE, Boolean.FALSE, null, null, Boolean.TRUE, new Integer(9)}));
			}

			public Label lblMonthWeek()
			{
		...
		public static class tabListOwnersContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				// Label Controls
				RuntimeAnchoring anchoringHelper67 = new RuntimeAnchoring(designSize, runtimeSize, 8, 10, 59, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
				...
				// ComboBox Controls
				RuntimeAnchoring anchoringHelper68 = new RuntimeAnchoring(designSize, runtimeSize, 80, 8, 280, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
				ComboBox m_cmbListTypeTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1063), new Integer(anchoringHelper68.getX()), new Integer(anchoringHelper68.getY()), new Integer(anchoringHelper68.getWidth()), new Integer(anchoringHelper68.getHeight()), new Integer(startTabIndex.intValue() + 55), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
				...
				// Grid Controls
				RuntimeAnchoring anchoringHelper69 = new RuntimeAnchoring(designSize, runtimeSize, 8, 48, 784, 232, ims.framework.enumerations.ControlAnchoring.ALL);
				Grid m_grdListOwnerTemp = (Grid)factory.getControl(Grid.class, new Object[] { control, new Integer(startControlID.intValue() + 1064), new Integer(anchoringHelper69.getX()), new Integer(anchoringHelper69.getY()), new Integer(anchoringHelper69.getWidth()), new Integer(anchoringHelper69.getHeight()), new Integer(startTabIndex.intValue() + 56), ControlState.READONLY, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL,Boolean.TRUE, Boolean.FALSE, new Integer(24), Boolean.TRUE, contextMenus.Scheduling.contextMenuProfileListOwners, Boolean.FALSE, Boolean.FALSE, new Integer(0), null, Boolean.FALSE, Boolean.TRUE});
				...
				grdListOwner.addMutableComboBoxColumn("HCP", 0, 0, 550, false, true, true, false, true, true, -1);
		...
		public static class tabDOSContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				// Grid Controls
				RuntimeAnchoring anchoringHelper70 = new RuntimeAnchoring(designSize, runtimeSize, 8, 8, 784, 272, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT);
				Grid m_grdDOSTemp = (Grid)factory.getControl(Grid.class, new Object[] { control, new Integer(startControlID.intValue() + 1065), new Integer(anchoringHelper70.getX()), new Integer(anchoringHelper70.getY()), new Integer(anchoringHelper70.getWidth()), new Integer(anchoringHelper70.getHeight()), new Integer(startTabIndex.intValue() + 57), ControlState.READONLY, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT,Boolean.FALSE, Boolean.FALSE, new Integer(24), Boolean.TRUE, contextMenus.Scheduling.contextMenuProfileDOS, Boolean.FALSE, Boolean.FALSE, new Integer(0), null, Boolean.FALSE, Boolean.TRUE});
		...
		public static class tabSlotsContainer extends LayerBridge
		{
			...
			public static class grdSlotsGeneralRow extends GridRowBridge
			{
				...
				public void setcolSlotsEndTimeReadOnly(boolean value)
				{
					super.row.setReadOnly(2, value);
				}
				public boolean iscolSlotsEndTimeReadOnly()
				{
					return super.row.isReadOnly(2);
				}
				public void showcolSlotsEndTimeOpened()
				{
					super.row.showOpened(2);
				}
				public String getcolSlotsEndTime()
				{
					return (String)super.row.get(2);
				}
				public void setcolSlotsEndTime(String value)
				{
					super.row.set(2, value);
				}
				public void setCellcolSlotsEndTimeTooltip(String value)
				{
					super.row.setTooltip(2, value);
				}
				...
				public void setcolSlotsFunctionReadOnly(boolean value)
				{
					super.row.setReadOnly(5, value);
				}
				public boolean iscolSlotsFunctionReadOnly()
				{
					return super.row.isReadOnly(5);
				}
				public void showcolSlotsFunctionOpened()
				{
					super.row.showOpened(5);
				}
				public String getcolSlotsFunction()
				{
					return (String)super.row.get(5);
				}
				public void setcolSlotsFunction(String value)
				{
					super.row.set(5, value);
				}
				public void setCellcolSlotsFunctionTooltip(String value)
				{
			...
			public static class grdSlotsGeneralGrid extends GridBridge
			{
				...
				public void setcolSlotsEndTimeHeaderTooltip(String value)
				{
					super.grid.setColumnHeaderTooltip(2, value);
				}
				public String getcolSlotsEndTimeHeaderTooltip()
				{
					return super.grid.getColumnHeaderTooltip(2);
				}
				...
				public void setcolSlotsFunctionHeaderTooltip(String value)
				{
					super.grid.setColumnHeaderTooltip(5, value);
				}
				public String getcolSlotsFunctionHeaderTooltip()
				{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				// Label Controls
				RuntimeAnchoring anchoringHelper71 = new RuntimeAnchoring(designSize, runtimeSize, 693, 8, 73, 17, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT);
				...
				// CheckBox Controls
				RuntimeAnchoring anchoringHelper72 = new RuntimeAnchoring(designSize, runtimeSize, 776, 8, 16, 16, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT);
				super.addControl(factory.getControl(CheckBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1067), new Integer(anchoringHelper72.getX()), new Integer(anchoringHelper72.getY()), new Integer(anchoringHelper72.getWidth()), new Integer(anchoringHelper72.getHeight()), new Integer(startTabIndex.intValue() + 58), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT ,"", Boolean.TRUE, null}));
		
				// Grid Controls
				RuntimeAnchoring anchoringHelper73 = new RuntimeAnchoring(designSize, runtimeSize, 12, 32, 780, 248, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFTRIGHT);
				Grid m_grdSlotsGeneralTemp = (Grid)factory.getControl(Grid.class, new Object[] { control, new Integer(startControlID.intValue() + 1068), new Integer(anchoringHelper73.getX()), new Integer(anchoringHelper73.getY()), new Integer(anchoringHelper73.getWidth()), new Integer(anchoringHelper73.getHeight()), new Integer(startTabIndex.intValue() + 59), ControlState.READONLY, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFTRIGHT,Boolean.TRUE, Boolean.FALSE, new Integer(24), Boolean.TRUE, contextMenus.Scheduling.contextMenuProfileSlotsGeneral, Boolean.FALSE, Boolean.FALSE, new Integer(0), null, Boolean.FALSE, Boolean.TRUE});
				...
				grdSlotsGeneral.addStringColumn("Activity", 0, 0, 250, true, false, 0, 0, true, ims.framework.enumerations.CharacterCasing.NORMAL);
				grdSlotsGeneral.addStringColumn("Start Time", 0, 0, 70, true, false, 0, 0, true, ims.framework.enumerations.CharacterCasing.NORMAL);
				grdSlotsGeneral.addStringColumn("End Time", 0, 0, 70, true, false, 0, 0, true, ims.framework.enumerations.CharacterCasing.NORMAL);
				...
				grdSlotsGeneral.addStringColumn("Function", 0, 0, 100, true, false, 0, 0, true, ims.framework.enumerations.CharacterCasing.NORMAL);
				grdSlotsGeneral.addBoolColumn("Active", 1, 1, -1, true, false, 0, true);
		...
		public static class tabActivitiesContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				grdActivities.addBoolColumn("Include", 0, 1, -1, false, false, 0, true);
		...
		public static class tabActivitiesWithSlotsContainer extends LayerBridge
		{
			...
			public static class grdSlotsGrid extends GridBridge
			{
				...
				public grdSlotsRow getRowByValue(ims.scheduling.vo.ProfileParentChildSlotVo value)
				{
					GridRow row = super.grid.getRowByValue(value);
			...
			public static class grdActivitiesSlotsGrid extends GridBridge
			{
				...
				public grdActivitiesSlotsRow getRowByValue(ims.scheduling.vo.ProfileActivityVo value)
				{
					GridRow row = super.grid.getRowByValue(value);
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				// Panel Controls
				RuntimeAnchoring anchoringHelper75 = new RuntimeAnchoring(designSize, runtimeSize, 408, 8, 392, 280, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT);
				...
				// Grid Controls
				RuntimeAnchoring anchoringHelper76 = new RuntimeAnchoring(designSize, runtimeSize, 416, 32, 376, 195, ims.framework.enumerations.ControlAnchoring.TOPBOTTOMRIGHT);
				Grid m_grdSlotsTemp = (Grid)factory.getControl(Grid.class, new Object[] { control, new Integer(startControlID.intValue() + 1071), new Integer(anchoringHelper76.getX()), new Integer(anchoringHelper76.getY()), new Integer(anchoringHelper76.getWidth()), new Integer(anchoringHelper76.getHeight()), new Integer(startTabIndex.intValue() + 62), ControlState.READONLY, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPBOTTOMRIGHT,Boolean.TRUE, Boolean.FALSE, new Integer(24), Boolean.TRUE, contextMenus.Scheduling.contextMenuFlexibleProfileSlot, Boolean.FALSE, Boolean.FALSE, new Integer(0), null, Boolean.FALSE, Boolean.TRUE});
				...
				grdSlots.addStringColumn("Start Time", 0, 0, 90, true, false, 0, 0, true, ims.framework.enumerations.CharacterCasing.NORMAL);
				grdSlots.addStringColumn("Duration", 0, 0, 90, true, false, 0, 0, true, ims.framework.enumerations.CharacterCasing.NORMAL);
				grdSlots.addStringColumn("Priority", 0, 0, 130, true, false, 0, 0, true, ims.framework.enumerations.CharacterCasing.NORMAL);
				grdSlots.addBoolColumn("Active", 0, 0, -1, true, false, 0, true);
				super.addGrid(grdSlots);
				RuntimeAnchoring anchoringHelper77 = new RuntimeAnchoring(designSize, runtimeSize, 8, 8, 392, 272, ims.framework.enumerations.ControlAnchoring.ALL);
				Grid m_grdActivitiesSlotsTemp = (Grid)factory.getControl(Grid.class, new Object[] { control, new Integer(startControlID.intValue() + 1072), new Integer(anchoringHelper77.getX()), new Integer(anchoringHelper77.getY()), new Integer(anchoringHelper77.getWidth()), new Integer(anchoringHelper77.getHeight()), new Integer(startTabIndex.intValue() + 61), ControlState.READONLY, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL,Boolean.TRUE, Boolean.FALSE, new Integer(24), Boolean.TRUE, contextMenus.Scheduling.contextMenuProfileActivity, Boolean.FALSE, Boolean.FALSE, new Integer(0), null, Boolean.FALSE, Boolean.TRUE});
				...
				grdActivitiesSlots.addMutableComboBoxColumn("Activity", 0, 0, 330, false, true, false, false, false, true, -1);
				grdActivitiesSlots.addBoolColumn("Include", 0, 1, -1, false, false, 0, true);
		...
		public static class tabTheatreContainer extends LayerBridge
		{
			...
			public static class lyrSlotsLayer extends Layer
			{
				...
				public static class tabTCIContainer extends LayerBridge
				{
					...
					protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
					{
						...
						// Grid Controls
						RuntimeAnchoring anchoringHelper78 = new RuntimeAnchoring(designSize, runtimeSize, 16, 16, 280, 216, ims.framework.enumerations.ControlAnchoring.TOPBOTTOMRIGHT);
						Grid m_grdTCITimesTemp = (Grid)factory.getControl(Grid.class, new Object[] { control, new Integer(startControlID.intValue() + 1073), new Integer(anchoringHelper78.getX()), new Integer(anchoringHelper78.getY()), new Integer(anchoringHelper78.getWidth()), new Integer(anchoringHelper78.getHeight()), new Integer(startTabIndex.intValue() + 65), ControlState.READONLY, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPBOTTOMRIGHT,Boolean.TRUE, Boolean.FALSE, new Integer(24), Boolean.TRUE, contextMenus.Scheduling.contextMenuProfileTheatreTCITimes, Boolean.FALSE, Boolean.FALSE, new Integer(0), null, Boolean.FALSE, Boolean.TRUE});
						...
						grdTCITimes.addIntColumn("Instances", 0, 0, -1, false, true, "Invalid Time", false, 0, true, 0);
				...
				public static class tabTheatreSlotsContainer extends LayerBridge
				{
					...
					protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
					{
						...
						// Grid Controls
						RuntimeAnchoring anchoringHelper79 = new RuntimeAnchoring(designSize, runtimeSize, 16, 16, 280, 216, ims.framework.enumerations.ControlAnchoring.TOPBOTTOMRIGHT);
						Grid m_grdParentChildSlotsTemp = (Grid)factory.getControl(Grid.class, new Object[] { control, new Integer(startControlID.intValue() + 1074), new Integer(anchoringHelper79.getX()), new Integer(anchoringHelper79.getY()), new Integer(anchoringHelper79.getWidth()), new Integer(anchoringHelper79.getHeight()), new Integer(startTabIndex.intValue() + 66), ControlState.READONLY, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPBOTTOMRIGHT,Boolean.TRUE, Boolean.FALSE, new Integer(24), Boolean.TRUE, contextMenus.Scheduling.contextMenuProfileTheatreSlots, Boolean.FALSE, Boolean.FALSE, new Integer(0), null, Boolean.FALSE, Boolean.TRUE});
				...
				protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
				{
					...
					if(startTabIndex == null)
						throw new RuntimeException("Invalid startTabIndex");
					RuntimeAnchoring anchoringHelper80 = new RuntimeAnchoring(designSize, runtimeSize, 480, 8, 320, 272, ims.framework.enumerations.ControlAnchoring.TOPBOTTOMRIGHT);
					...
					ims.framework.utils.SizeInfo m_tabTCIDesignSize = new ims.framework.utils.SizeInfo(320, 272);
					ims.framework.utils.SizeInfo m_tabTCIRuntimeSize = new ims.framework.utils.SizeInfo(anchoringHelper80.getWidth(), anchoringHelper80.getHeight());
					...
					RuntimeAnchoring anchoringHelper81 = new RuntimeAnchoring(designSize, runtimeSize, 480, 8, 320, 272, ims.framework.enumerations.ControlAnchoring.TOPBOTTOMRIGHT);
					...
					ims.framework.utils.SizeInfo m_tabTheatreSlotsDesignSize = new ims.framework.utils.SizeInfo(320, 272);
					ims.framework.utils.SizeInfo m_tabTheatreSlotsRuntimeSize = new ims.framework.utils.SizeInfo(anchoringHelper81.getWidth(), anchoringHelper81.getHeight());
			...
			public static class grdTheatreServiceRow extends GridRowBridge
			{
				private static final long serialVersionUID = 1L;
				
				protected grdTheatreServiceRow(GridRow row)
				{
					super(row);
				}
				public void showOpened(int column)
			...
			public static class grdTheatreServiceRowCollection extends GridRowCollectionBridge
			{
				private static final long serialVersionUID = 1L;
				
				private grdTheatreServiceRowCollection(GridRowCollection collection)
				{
					super(collection);
				}
				public grdTheatreServiceRow get(int index)
				{
					return new grdTheatreServiceRow(super.collection.get(index));
				}
				public grdTheatreServiceRow newRow()
				{
					return new grdTheatreServiceRow(super.collection.newRow());
				}
				public grdTheatreServiceRow newRow(boolean autoSelect)
				{
					return new grdTheatreServiceRow(super.collection.newRow(autoSelect));
				}
				public grdTheatreServiceRow newRowAt(int index)
				{
					return new grdTheatreServiceRow(super.collection.newRowAt(index));
				}
				public grdTheatreServiceRow newRowAt(int index, boolean autoSelect)
				{
					return new grdTheatreServiceRow(super.collection.newRowAt(index, autoSelect));
				}
			}
			public static class grdTheatreServiceGrid extends GridBridge
			{
				private static final long serialVersionUID = 1L;
				...
				public grdTheatreServiceRow getSelectedRow()
				{
					return super.grid.getSelectedRow() == null ? null : new grdTheatreServiceRow(super.grid.getSelectedRow());
				}
				public int getSelectedRowIndex()
				{
					return super.grid.getSelectedRowIndex();
				}
				public grdTheatreServiceRowCollection getRows()
				{
					return new grdTheatreServiceRowCollection(super.grid.getRows());
				}
				public grdTheatreServiceRow getRowByValue(ims.scheduling.vo.TheatreDetailLiteVo value)
				{
					GridRow row = super.grid.getRowByValue(value);
					return row == null?null:new grdTheatreServiceRow(row);
				}
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				// Grid Controls
				RuntimeAnchoring anchoringHelper82 = new RuntimeAnchoring(designSize, runtimeSize, 16, 8, 456, 272, ims.framework.enumerations.ControlAnchoring.ALL);
				Grid m_grdTheatreServiceTemp = (Grid)factory.getControl(Grid.class, new Object[] { control, new Integer(startControlID.intValue() + 1077), new Integer(anchoringHelper82.getX()), new Integer(anchoringHelper82.getY()), new Integer(anchoringHelper82.getWidth()), new Integer(anchoringHelper82.getHeight()), new Integer(startTabIndex.intValue() + 64), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL,Boolean.TRUE, Boolean.FALSE, new Integer(24), Boolean.TRUE, contextMenus.Scheduling.contextMenuProfileTheatre, Boolean.FALSE, Boolean.FALSE, new Integer(0), null, Boolean.FALSE, Boolean.TRUE});
				addControl(m_grdTheatreServiceTemp);
				grdTheatreServiceGrid grdTheatreService = (grdTheatreServiceGrid)GridFlyweightFactory.getInstance().createGridBridge(grdTheatreServiceGrid.class, m_grdTheatreServiceTemp);
				grdTheatreService.addStringColumn("Procedure", 0, 0, 350, false, false, 0, 0, true, ims.framework.enumerations.CharacterCasing.NORMAL);
				grdTheatreService.addIntColumn("Max No", 0, 0, 0, false, true, null, false, 0, false, 0);
				grdTheatreService.addBoolColumn("Active", 0, 0, -1, false, false, 0, true);
				super.addGrid(grdTheatreService);
				RuntimeAnchoring anchoringHelper83 = new RuntimeAnchoring(designSize, runtimeSize, 16, 8, 456, 272, ims.framework.enumerations.ControlAnchoring.ALL);
				Grid m_grdTheatreTemp = (Grid)factory.getControl(Grid.class, new Object[] { control, new Integer(startControlID.intValue() + 1078), new Integer(anchoringHelper83.getX()), new Integer(anchoringHelper83.getY()), new Integer(anchoringHelper83.getWidth()), new Integer(anchoringHelper83.getHeight()), new Integer(startTabIndex.intValue() + 63), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL,Boolean.TRUE, Boolean.FALSE, new Integer(24), Boolean.TRUE, contextMenus.Scheduling.contextMenuProfileTheatre, Boolean.FALSE, Boolean.FALSE, new Integer(0), null, Boolean.FALSE, Boolean.TRUE});
				...
				grdTheatre.addMutableComboBoxColumn("Procedure", 0, 0, 350, false, true, true, false, true, true, -1);
				grdTheatre.addIntColumn("Max No", 0, 0, 60, false, true, null, false, 0, true, 0);
			...
			public grdTheatreServiceGrid grdTheatreService()
			{
				return (grdTheatreServiceGrid)super.getGrid(0);
			}
			public grdTheatreGrid grdTheatre()
			{
				return (grdTheatreGrid)super.getGrid(1);
			}
		}
		...
		public static class tabExclusionContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				// Label Controls
				RuntimeAnchoring anchoringHelper85 = new RuntimeAnchoring(designSize, runtimeSize, 392, 8, 364, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
				super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1080), new Integer(anchoringHelper85.getX()), new Integer(anchoringHelper85.getY()), new Integer(anchoringHelper85.getWidth()), new Integer(anchoringHelper85.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Do not generate slots during the following times (for any Date)", new Integer(1), null, new Integer(0)}));
				RuntimeAnchoring anchoringHelper86 = new RuntimeAnchoring(designSize, runtimeSize, 12, 8, 278, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
				super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1081), new Integer(anchoringHelper86.getX()), new Integer(anchoringHelper86.getY()), new Integer(anchoringHelper86.getWidth()), new Integer(anchoringHelper86.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Do not generate sessions on the following dates", new Integer(1), null, new Integer(0)}));
		
				// Grid Controls
				RuntimeAnchoring anchoringHelper87 = new RuntimeAnchoring(designSize, runtimeSize, 384, 24, 408, 256, ims.framework.enumerations.ControlAnchoring.TOPBOTTOMLEFT);
				Grid m_grdExclPeriodsTemp = (Grid)factory.getControl(Grid.class, new Object[] { control, new Integer(startControlID.intValue() + 1082), new Integer(anchoringHelper87.getX()), new Integer(anchoringHelper87.getY()), new Integer(anchoringHelper87.getWidth()), new Integer(anchoringHelper87.getHeight()), new Integer(startTabIndex.intValue() + 69), ControlState.READONLY, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPBOTTOMLEFT,Boolean.TRUE, Boolean.FALSE, new Integer(24), Boolean.TRUE, contextMenus.Scheduling.contextMenuProfileExclusionTimes, Boolean.FALSE, Boolean.FALSE, new Integer(0), null, Boolean.FALSE, Boolean.TRUE});
		...
		public static class tabTemplatesContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				// Grid Controls
				RuntimeAnchoring anchoringHelper89 = new RuntimeAnchoring(designSize, runtimeSize, 16, 8, 776, 272, ims.framework.enumerations.ControlAnchoring.TOPBOTTOMLEFT);
				Grid m_grdTemplatesTemp = (Grid)factory.getControl(Grid.class, new Object[] { control, new Integer(startControlID.intValue() + 1084), new Integer(anchoringHelper89.getX()), new Integer(anchoringHelper89.getY()), new Integer(anchoringHelper89.getWidth()), new Integer(anchoringHelper89.getHeight()), new Integer(startTabIndex.intValue() + 70), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPBOTTOMLEFT,Boolean.TRUE, Boolean.FALSE, new Integer(24), Boolean.TRUE, contextMenus.Scheduling.contextMenuProfileTemplates, Boolean.FALSE, Boolean.FALSE, new Integer(0), null, Boolean.FALSE, Boolean.TRUE});
		...
		protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
		{
			...
			if(startTabIndex == null)
				throw new RuntimeException("Invalid startTabIndex");
			RuntimeAnchoring anchoringHelper90 = new RuntimeAnchoring(designSize, runtimeSize, 16, 278, 816, 320, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFTRIGHT);
			...
			ims.framework.utils.SizeInfo m_tabGeneralDetailsDesignSize = new ims.framework.utils.SizeInfo(816, 320);
			ims.framework.utils.SizeInfo m_tabGeneralDetailsRuntimeSize = new ims.framework.utils.SizeInfo(anchoringHelper90.getWidth(), anchoringHelper90.getHeight());
			...
			RuntimeAnchoring anchoringHelper91 = new RuntimeAnchoring(designSize, runtimeSize, 16, 278, 816, 320, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFTRIGHT);
			...
			ims.framework.utils.SizeInfo m_tabProfileDetailsDesignSize = new ims.framework.utils.SizeInfo(816, 320);
			ims.framework.utils.SizeInfo m_tabProfileDetailsRuntimeSize = new ims.framework.utils.SizeInfo(anchoringHelper91.getWidth(), anchoringHelper91.getHeight());
			...
			ims.framework.utils.SizeInfo m_tabListOwnersDesignSize = new ims.framework.utils.SizeInfo(816, 320);
			ims.framework.utils.SizeInfo m_tabListOwnersRuntimeSize = new ims.framework.utils.SizeInfo(anchoringHelper92.getWidth(), anchoringHelper92.getHeight());
			...
			RuntimeAnchoring anchoringHelper93 = new RuntimeAnchoring(designSize, runtimeSize, 16, 278, 816, 320, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFTRIGHT);
			...
			ims.framework.utils.SizeInfo m_tabDOSDesignSize = new ims.framework.utils.SizeInfo(816, 320);
			ims.framework.utils.SizeInfo m_tabDOSRuntimeSize = new ims.framework.utils.SizeInfo(anchoringHelper93.getWidth(), anchoringHelper93.getHeight());
			...
			RuntimeAnchoring anchoringHelper94 = new RuntimeAnchoring(designSize, runtimeSize, 16, 278, 816, 320, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFTRIGHT);
			...
			ims.framework.utils.SizeInfo m_tabSlotsDesignSize = new ims.framework.utils.SizeInfo(816, 320);
			ims.framework.utils.SizeInfo m_tabSlotsRuntimeSize = new ims.framework.utils.SizeInfo(anchoringHelper94.getWidth(), anchoringHelper94.getHeight());
			...
			RuntimeAnchoring anchoringHelper95 = new RuntimeAnchoring(designSize, runtimeSize, 16, 278, 816, 320, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFTRIGHT);
			...
			ims.framework.utils.SizeInfo m_tabActivitiesDesignSize = new ims.framework.utils.SizeInfo(816, 320);
			ims.framework.utils.SizeInfo m_tabActivitiesRuntimeSize = new ims.framework.utils.SizeInfo(anchoringHelper95.getWidth(), anchoringHelper95.getHeight());
			...
			RuntimeAnchoring anchoringHelper96 = new RuntimeAnchoring(designSize, runtimeSize, 16, 278, 816, 320, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFTRIGHT);
			...
			ims.framework.utils.SizeInfo m_tabActivitiesWithSlotsDesignSize = new ims.framework.utils.SizeInfo(816, 320);
			ims.framework.utils.SizeInfo m_tabActivitiesWithSlotsRuntimeSize = new ims.framework.utils.SizeInfo(anchoringHelper96.getWidth(), anchoringHelper96.getHeight());
			...
			RuntimeAnchoring anchoringHelper97 = new RuntimeAnchoring(designSize, runtimeSize, 16, 278, 816, 320, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFTRIGHT);
			...
			ims.framework.utils.SizeInfo m_tabTheatreDesignSize = new ims.framework.utils.SizeInfo(816, 320);
			ims.framework.utils.SizeInfo m_tabTheatreRuntimeSize = new ims.framework.utils.SizeInfo(anchoringHelper97.getWidth(), anchoringHelper97.getHeight());
			...
			RuntimeAnchoring anchoringHelper98 = new RuntimeAnchoring(designSize, runtimeSize, 16, 278, 816, 320, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFTRIGHT);
			...
			ims.framework.utils.SizeInfo m_tabBookingRightsDesignSize = new ims.framework.utils.SizeInfo(816, 320);
			ims.framework.utils.SizeInfo m_tabBookingRightsRuntimeSize = new ims.framework.utils.SizeInfo(anchoringHelper98.getWidth(), anchoringHelper98.getHeight());
			...
			RuntimeAnchoring anchoringHelper99 = new RuntimeAnchoring(designSize, runtimeSize, 16, 278, 816, 320, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFTRIGHT);
			...
			ims.framework.utils.SizeInfo m_tabExclusionDesignSize = new ims.framework.utils.SizeInfo(816, 320);
			ims.framework.utils.SizeInfo m_tabExclusionRuntimeSize = new ims.framework.utils.SizeInfo(anchoringHelper99.getWidth(), anchoringHelper99.getHeight());
			...
			RuntimeAnchoring anchoringHelper100 = new RuntimeAnchoring(designSize, runtimeSize, 16, 278, 816, 320, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFTRIGHT);
			...
			ims.framework.utils.SizeInfo m_tabTemplatesDesignSize = new ims.framework.utils.SizeInfo(816, 320);
			ims.framework.utils.SizeInfo m_tabTemplatesRuntimeSize = new ims.framework.utils.SizeInfo(anchoringHelper100.getWidth(), anchoringHelper100.getHeight());
		...
		{
			return (tabActivitiesWithSlotsContainer)super.layers.get(6);
		}
		public tabTheatreContainer tabTheatre()
		{
			return (tabTheatreContainer)super.layers.get(7);
		}
		public tabBookingRightsContainer tabBookingRights()
		{
			return (tabBookingRightsContainer)super.layers.get(8);
		}
		public tabExclusionContainer tabExclusion()
		{
			return (tabExclusionContainer)super.layers.get(9);
		}
		public tabTemplatesContainer tabTemplates()
		{
			return (tabTemplatesContainer)super.layers.get(10);
		}
	}
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		contextMenus.Scheduling.contextMenuProfileServiceFunctions = factory.createMenu(startControlID.intValue() + 1);
		contextMenus.Scheduling.contextMenuProfileServiceFunctionsSELECT_ALLItem = factory.createMenuItem(startControlID.intValue() + 1, "Select All", true, false, null, true, false);
		if(factory.getUIEngine().getLoggedInRole().hasMenuActionRight(appForm, new ims.framework.MenuAction(6110001)))
			contextMenus.Scheduling.contextMenuProfileServiceFunctions.add(contextMenus.Scheduling.contextMenuProfileServiceFunctionsSELECT_ALLItem);
		contextMenus.Scheduling.contextMenuProfileServiceFunctionsDESELECT_ALLItem = factory.createMenuItem(startControlID.intValue() + 2, "Deselect All", true, false, null, true, false);
		if(factory.getUIEngine().getLoggedInRole().hasMenuActionRight(appForm, new ims.framework.MenuAction(6110002)))
			contextMenus.Scheduling.contextMenuProfileServiceFunctions.add(contextMenus.Scheduling.contextMenuProfileServiceFunctionsDESELECT_ALLItem);
		form.registerMenu(contextMenus.Scheduling.contextMenuProfileServiceFunctions);
		contextMenus.Scheduling.contextMenuProfileListOwners = factory.createMenu(startControlID.intValue() + 2);
		contextMenus.Scheduling.contextMenuProfileListOwnersADDItem = factory.createMenuItem(startControlID.intValue() + 3, "Add", true, false, new Integer(102179), true, false);
		contextMenus.Scheduling.contextMenuProfileListOwners.add(contextMenus.Scheduling.contextMenuProfileListOwnersADDItem);
		contextMenus.Scheduling.contextMenuProfileListOwnersEDITItem = factory.createMenuItem(startControlID.intValue() + 4, "Edit", true, false, new Integer(102150), true, false);
		contextMenus.Scheduling.contextMenuProfileListOwners.add(contextMenus.Scheduling.contextMenuProfileListOwnersEDITItem);
		contextMenus.Scheduling.contextMenuProfileListOwnersREMOVEItem = factory.createMenuItem(startControlID.intValue() + 5, "Remove", true, false, new Integer(102148), true, false);
		...
		contextMenus.Scheduling.contextMenuProfileDOS = factory.createMenu(startControlID.intValue() + 3);
		contextMenus.Scheduling.contextMenuProfileDOSADD_SPECIALTY_DOSItem = factory.createMenuItem(startControlID.intValue() + 6, "Add Specialty DOS", true, false, new Integer(102179), true, false);
		if(factory.getUIEngine().getLoggedInRole().hasMenuActionRight(appForm, new ims.framework.MenuAction(6300001)))
			contextMenus.Scheduling.contextMenuProfileDOS.add(contextMenus.Scheduling.contextMenuProfileDOSADD_SPECIALTY_DOSItem);
		form.registerMenu(contextMenus.Scheduling.contextMenuProfileDOS);
		contextMenus.Scheduling.contextMenuProfileSlotsGeneral = factory.createMenu(startControlID.intValue() + 4);
		contextMenus.Scheduling.contextMenuProfileSlotsGeneralADDItem = factory.createMenuItem(startControlID.intValue() + 7, "Add", true, false, new Integer(102179), true, false);
		contextMenus.Scheduling.contextMenuProfileSlotsGeneral.add(contextMenus.Scheduling.contextMenuProfileSlotsGeneralADDItem);
		contextMenus.Scheduling.contextMenuProfileSlotsGeneralEDITItem = factory.createMenuItem(startControlID.intValue() + 8, "Edit", true, false, new Integer(102150), true, false);
		...
		contextMenus.Scheduling.contextMenuProfileSlotsGeneralREMOVEItem = factory.createMenuItem(startControlID.intValue() + 9, "Inactivate", true, false, new Integer(102148), true, false);
		...
		contextMenus.Scheduling.contextMenuProfileActivity = factory.createMenu(startControlID.intValue() + 5);
		contextMenus.Scheduling.contextMenuProfileActivityADDItem = factory.createMenuItem(startControlID.intValue() + 10, "Add", true, false, new Integer(102179), true, false);
		contextMenus.Scheduling.contextMenuProfileActivity.add(contextMenus.Scheduling.contextMenuProfileActivityADDItem);
		contextMenus.Scheduling.contextMenuProfileActivityREMOVEItem = factory.createMenuItem(startControlID.intValue() + 11, "Remove", true, false, new Integer(102148), true, false);
		...
		contextMenus.Scheduling.contextMenuFlexibleProfileSlot = factory.createMenu(startControlID.intValue() + 6);
		contextMenus.Scheduling.contextMenuFlexibleProfileSlotADDItem = factory.createMenuItem(startControlID.intValue() + 12, "Add", true, false, new Integer(102179), true, false);
		if(factory.getUIEngine().getLoggedInRole().hasMenuActionRight(appForm, new ims.framework.MenuAction(5800001)))
			contextMenus.Scheduling.contextMenuFlexibleProfileSlot.add(contextMenus.Scheduling.contextMenuFlexibleProfileSlotADDItem);
		contextMenus.Scheduling.contextMenuFlexibleProfileSlotEDITItem = factory.createMenuItem(startControlID.intValue() + 13, "Edit", true, false, new Integer(102150), true, false);
		if(factory.getUIEngine().getLoggedInRole().hasMenuActionRight(appForm, new ims.framework.MenuAction(5800002)))
			contextMenus.Scheduling.contextMenuFlexibleProfileSlot.add(contextMenus.Scheduling.contextMenuFlexibleProfileSlotEDITItem);
		contextMenus.Scheduling.contextMenuFlexibleProfileSlotINACTIVATEItem = factory.createMenuItem(startControlID.intValue() + 14, "Inactivate", true, false, new Integer(102148), true, false);
		if(factory.getUIEngine().getLoggedInRole().hasMenuActionRight(appForm, new ims.framework.MenuAction(5800003)))
			contextMenus.Scheduling.contextMenuFlexibleProfileSlot.add(contextMenus.Scheduling.contextMenuFlexibleProfileSlotINACTIVATEItem);
		form.registerMenu(contextMenus.Scheduling.contextMenuFlexibleProfileSlot);
		contextMenus.Scheduling.contextMenuProfileTheatre = factory.createMenu(startControlID.intValue() + 7);
		contextMenus.Scheduling.contextMenuProfileTheatreADDItem = factory.createMenuItem(startControlID.intValue() + 15, "Add", true, false, new Integer(102179), true, false);
		contextMenus.Scheduling.contextMenuProfileTheatre.add(contextMenus.Scheduling.contextMenuProfileTheatreADDItem);
		contextMenus.Scheduling.contextMenuProfileTheatreREMOVEItem = factory.createMenuItem(startControlID.intValue() + 16, "Remove", true, false, new Integer(102148), true, false);
		...
		contextMenus.Scheduling.contextMenuProfileTheatreTCITimes = factory.createMenu(startControlID.intValue() + 8);
		contextMenus.Scheduling.contextMenuProfileTheatreTCITimesADDItem = factory.createMenuItem(startControlID.intValue() + 17, "Add", true, false, new Integer(102179), true, false);
		...
		contextMenus.Scheduling.contextMenuProfileTheatreTCITimesREMOVEItem = factory.createMenuItem(startControlID.intValue() + 18, "Remove", true, false, new Integer(102148), true, false);
		...
		contextMenus.Scheduling.contextMenuProfileTheatreSlots = factory.createMenu(startControlID.intValue() + 9);
		contextMenus.Scheduling.contextMenuProfileTheatreSlotsADDItem = factory.createMenuItem(startControlID.intValue() + 19, "Add", true, false, new Integer(102179), true, false);
		...
		contextMenus.Scheduling.contextMenuProfileTheatreSlotsEDITItem = factory.createMenuItem(startControlID.intValue() + 20, "Edit", true, false, new Integer(102150), true, false);
		...
		contextMenus.Scheduling.contextMenuProfileTheatreSlotsREMOVEItem = factory.createMenuItem(startControlID.intValue() + 21, "Remove", true, false, new Integer(102148), true, false);
		...
		contextMenus.Scheduling.contextMenuProfileBookingRights = factory.createMenu(startControlID.intValue() + 10);
		contextMenus.Scheduling.contextMenuProfileBookingRightsADDItem = factory.createMenuItem(startControlID.intValue() + 22, "Add", true, false, new Integer(102179), true, false);
		...
		contextMenus.Scheduling.contextMenuProfileBookingRightsEDITItem = factory.createMenuItem(startControlID.intValue() + 23, "Edit", true, false, new Integer(102150), true, false);
		...
		contextMenus.Scheduling.contextMenuProfileBookingRightsREMOVEItem = factory.createMenuItem(startControlID.intValue() + 24, "Remove", true, false, new Integer(102148), true, false);
		...
		contextMenus.Scheduling.contextMenuProfileExclusionTimes = factory.createMenu(startControlID.intValue() + 11);
		contextMenus.Scheduling.contextMenuProfileExclusionTimesADDItem = factory.createMenuItem(startControlID.intValue() + 25, "Add", true, false, new Integer(102179), true, false);
		...
		contextMenus.Scheduling.contextMenuProfileExclusionTimesEDITItem = factory.createMenuItem(startControlID.intValue() + 26, "Edit", true, false, new Integer(102150), true, false);
		...
		contextMenus.Scheduling.contextMenuProfileExclusionTimesREMOVEItem = factory.createMenuItem(startControlID.intValue() + 27, "Remove", true, false, new Integer(102148), true, false);
		...
		contextMenus.Scheduling.contextMenuProfileExclusionDates = factory.createMenu(startControlID.intValue() + 12);
		contextMenus.Scheduling.contextMenuProfileExclusionDatesADDItem = factory.createMenuItem(startControlID.intValue() + 28, "Add", true, false, new Integer(102179), true, false);
		...
		contextMenus.Scheduling.contextMenuProfileExclusionDatesEDITItem = factory.createMenuItem(startControlID.intValue() + 29, "Edit", true, false, new Integer(102150), true, false);
		...
		contextMenus.Scheduling.contextMenuProfileExclusionDatesREMOVEItem = factory.createMenuItem(startControlID.intValue() + 30, "Remove", true, false, new Integer(102148), true, false);
		...
		contextMenus.Scheduling.contextMenuProfileTemplates = factory.createMenu(startControlID.intValue() + 13);
		contextMenus.Scheduling.contextMenuProfileTemplatesADDTEMPLATEItem = factory.createMenuItem(startControlID.intValue() + 31, "Add Template", true, false, new Integer(102179), true, false);
		...
		contextMenus.Scheduling.contextMenuProfileTemplatesREMOVETEMPLATEItem = factory.createMenuItem(startControlID.intValue() + 32, "Remove Template", true, false, new Integer(102148), true, false);
		...
		contextMenus.Scheduling.contextMenuProfilesMenu = factory.createMenu(startControlID.intValue() + 14);
		contextMenus.Scheduling.contextMenuProfilesMenuADDItem = factory.createMenuItem(startControlID.intValue() + 33, "Add", true, false, new Integer(102179), true, false);
		contextMenus.Scheduling.contextMenuProfilesMenu.add(contextMenus.Scheduling.contextMenuProfilesMenuADDItem);
		contextMenus.Scheduling.contextMenuProfilesMenuUPDATEItem = factory.createMenuItem(startControlID.intValue() + 34, "Edit", true, false, new Integer(102150), true, false);
		contextMenus.Scheduling.contextMenuProfilesMenu.add(contextMenus.Scheduling.contextMenuProfilesMenuUPDATEItem);
		contextMenus.Scheduling.contextMenuProfilesMenuCLONE_PROFILEItem = factory.createMenuItem(startControlID.intValue() + 35, "Clone this Profile", true, false, new Integer(102222), true, false);
		...
		RuntimeAnchoring anchoringHelper101 = new RuntimeAnchoring(designSize, runtimeSize, 432, 58, 240, 20, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT);
		ims.framework.FormUiLogic m_ccListOwnerForm = loader.loadComponent(102256, appForm, startControlID * 10 + 1000, anchoringHelper101.getSize(), instance1, startTabIndex.intValue() + 8, skipContextValidation);
		//ims.framework.Control m_ccListOwnerControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1096), new Integer(432), new Integer(58), new Integer(240), new Integer(20), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT, new Integer(startTabIndex.intValue() + 8), m_ccListOwnerForm, instance1 } );
		ims.framework.Control m_ccListOwnerControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1097),  new Integer(anchoringHelper101.getX()), new Integer(anchoringHelper101.getY()), new Integer(anchoringHelper101.getWidth()), new Integer(anchoringHelper101.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT, new Integer(startTabIndex.intValue() + 8), m_ccListOwnerForm, instance1, Boolean.FALSE } );
		...
		// Label Controls
		RuntimeAnchoring anchoringHelper102 = new RuntimeAnchoring(designSize, runtimeSize, 360, 60, 70, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		RuntimeAnchoring anchoringHelper103 = new RuntimeAnchoring(designSize, runtimeSize, 360, 8, 36, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		RuntimeAnchoring anchoringHelper104 = new RuntimeAnchoring(designSize, runtimeSize, 16, 8, 41, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		RuntimeAnchoring anchoringHelper105 = new RuntimeAnchoring(designSize, runtimeSize, 360, 34, 55, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		RuntimeAnchoring anchoringHelper106 = new RuntimeAnchoring(designSize, runtimeSize, 16, 34, 50, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		RuntimeAnchoring anchoringHelper107 = new RuntimeAnchoring(designSize, runtimeSize, 672, 60, 73, 17, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
		...
		RuntimeAnchoring anchoringHelper108 = new RuntimeAnchoring(designSize, runtimeSize, 16, 60, 31, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		// Button Controls
		RuntimeAnchoring anchoringHelper109 = new RuntimeAnchoring(designSize, runtimeSize, 256, 602, 120, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT);
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1105), new Integer(anchoringHelper109.getX()), new Integer(anchoringHelper109.getY()), new Integer(anchoringHelper109.getWidth()), new Integer(anchoringHelper109.getHeight()), new Integer(startTabIndex.intValue() + 73), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, " Clone this Profile", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		RuntimeAnchoring anchoringHelper110 = new RuntimeAnchoring(designSize, runtimeSize, 135, 602, 116, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT);
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1106), new Integer(anchoringHelper110.getX()), new Integer(anchoringHelper110.getY()), new Integer(anchoringHelper110.getWidth()), new Integer(anchoringHelper110.getHeight()), new Integer(startTabIndex.intValue() + 72), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, " Edit", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		RuntimeAnchoring anchoringHelper111 = new RuntimeAnchoring(designSize, runtimeSize, 15, 602, 116, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT);
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1107), new Integer(anchoringHelper111.getX()), new Integer(anchoringHelper111.getY()), new Integer(anchoringHelper111.getWidth()), new Integer(anchoringHelper111.getHeight()), new Integer(startTabIndex.intValue() + 71), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, " Add", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		RuntimeAnchoring anchoringHelper112 = new RuntimeAnchoring(designSize, runtimeSize, 380, 602, 132, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT);
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1108), new Integer(anchoringHelper112.getX()), new Integer(anchoringHelper112.getY()), new Integer(anchoringHelper112.getWidth()), new Integer(anchoringHelper112.getHeight()), new Integer(startTabIndex.intValue() + 74), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Preview", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		RuntimeAnchoring anchoringHelper113 = new RuntimeAnchoring(designSize, runtimeSize, 678, 602, 75, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT);
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1109), new Integer(anchoringHelper113.getX()), new Integer(anchoringHelper113.getY()), new Integer(anchoringHelper113.getWidth()), new Integer(anchoringHelper113.getHeight()), new Integer(startTabIndex.intValue() + 75), ControlState.HIDDEN, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Save", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		RuntimeAnchoring anchoringHelper114 = new RuntimeAnchoring(designSize, runtimeSize, 757, 602, 75, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT);
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1110), new Integer(anchoringHelper114.getX()), new Integer(anchoringHelper114.getY()), new Integer(anchoringHelper114.getWidth()), new Integer(anchoringHelper114.getHeight()), new Integer(startTabIndex.intValue() + 76), ControlState.HIDDEN, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Cancel", Boolean.FALSE, null, Boolean.FALSE, Boolean.FALSE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));

		// TextBox Controls
		RuntimeAnchoring anchoringHelper115 = new RuntimeAnchoring(designSize, runtimeSize, 88, 6, 256, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		// ComboBox Controls
		RuntimeAnchoring anchoringHelper116 = new RuntimeAnchoring(designSize, runtimeSize, 432, 32, 224, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT);
		ComboBox m_cmbHospFilterTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1112), new Integer(anchoringHelper116.getX()), new Integer(anchoringHelper116.getY()), new Integer(anchoringHelper116.getWidth()), new Integer(anchoringHelper116.getHeight()), new Integer(startTabIndex.intValue() + 7), ControlState.ENABLED, ControlState.DISABLED,ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
		...
		RuntimeAnchoring anchoringHelper117 = new RuntimeAnchoring(designSize, runtimeSize, 88, 32, 256, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		ComboBox m_cmbFilterSpecialtyTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1113), new Integer(anchoringHelper117.getX()), new Integer(anchoringHelper117.getY()), new Integer(anchoringHelper117.getWidth()), new Integer(anchoringHelper117.getHeight()), new Integer(startTabIndex.intValue() + 2), ControlState.ENABLED, ControlState.DISABLED,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,Boolean.TRUE, Boolean.FALSE, SortOrder.ASCENDING, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
		...
		// Query ComboBox Controls
		RuntimeAnchoring anchoringHelper118 = new RuntimeAnchoring(designSize, runtimeSize, 88, 58, 256, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		// CheckBox Controls
		RuntimeAnchoring anchoringHelper119 = new RuntimeAnchoring(designSize, runtimeSize, 616, 8, 112, 16, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(CheckBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1115), new Integer(anchoringHelper119.getX()), new Integer(anchoringHelper119.getY()), new Integer(anchoringHelper119.getWidth()), new Integer(anchoringHelper119.getHeight()), new Integer(startTabIndex.intValue() + 6), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,"Ward Attendance", Boolean.FALSE, null}));
		RuntimeAnchoring anchoringHelper120 = new RuntimeAnchoring(designSize, runtimeSize, 536, 8, 64, 16, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(CheckBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1116), new Integer(anchoringHelper120.getX()), new Integer(anchoringHelper120.getY()), new Integer(anchoringHelper120.getWidth()), new Integer(anchoringHelper120.getHeight()), new Integer(startTabIndex.intValue() + 5), ControlState.ENABLED, ControlState.DISABLED,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,"Theatre", Boolean.FALSE, null}));
		RuntimeAnchoring anchoringHelper121 = new RuntimeAnchoring(designSize, runtimeSize, 432, 8, 80, 16, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(CheckBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1117), new Integer(anchoringHelper121.getX()), new Integer(anchoringHelper121.getY()), new Integer(anchoringHelper121.getWidth()), new Integer(anchoringHelper121.getHeight()), new Integer(startTabIndex.intValue() + 4), ControlState.ENABLED, ControlState.DISABLED,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,"Outpatient", Boolean.FALSE, null}));
		RuntimeAnchoring anchoringHelper122 = new RuntimeAnchoring(designSize, runtimeSize, 752, 60, 16, 16, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
		super.addControl(factory.getControl(CheckBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1118), new Integer(anchoringHelper122.getX()), new Integer(anchoringHelper122.getY()), new Integer(anchoringHelper122.getWidth()), new Integer(anchoringHelper122.getHeight()), new Integer(startTabIndex.intValue() + 10), ControlState.ENABLED, ControlState.DISABLED,ims.framework.enumerations.ControlAnchoring.TOPRIGHT ,"", Boolean.FALSE, null}));

		// Grid Controls
		RuntimeAnchoring anchoringHelper123 = new RuntimeAnchoring(designSize, runtimeSize, 16, 104, 816, 168, ims.framework.enumerations.ControlAnchoring.ALL);
		Grid m_grdProfilesTemp = (Grid)factory.getControl(Grid.class, new Object[] { control, new Integer(startControlID.intValue() + 1119), new Integer(anchoringHelper123.getX()), new Integer(anchoringHelper123.getY()), new Integer(anchoringHelper123.getWidth()), new Integer(anchoringHelper123.getHeight()), new Integer(startTabIndex.intValue() + 13), ControlState.READONLY, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.ALL,Boolean.TRUE, Boolean.FALSE, new Integer(24), Boolean.TRUE, contextMenus.Scheduling.contextMenuProfilesMenu, Boolean.FALSE, Boolean.FALSE, new Integer(0), null, Boolean.FALSE, Boolean.FALSE});
		...
		RuntimeAnchoring anchoringHelper124 = new RuntimeAnchoring(designSize, runtimeSize, 800, 16, 32, 32, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
		super.addControl(factory.getControl(ImageButton.class, new Object[] { control, new Integer(startControlID.intValue() + 1120), new Integer(anchoringHelper124.getX()), new Integer(anchoringHelper124.getY()), new Integer(anchoringHelper124.getWidth()), new Integer(anchoringHelper124.getHeight()), new Integer(startTabIndex.intValue() + 12), ControlState.ENABLED, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.TOPRIGHT, this.getImages().Core.ClearEnabled24, this.getImages().Core.ClearDisabled24, "Clear search criteria and results", Boolean.FALSE, Boolean.FALSE, Boolean.FALSE, Boolean.FALSE, null}));
		RuntimeAnchoring anchoringHelper125 = new RuntimeAnchoring(designSize, runtimeSize, 764, 16, 32, 32, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
		super.addControl(factory.getControl(ImageButton.class, new Object[] { control, new Integer(startControlID.intValue() + 1121), new Integer(anchoringHelper125.getX()), new Integer(anchoringHelper125.getY()), new Integer(anchoringHelper125.getWidth()), new Integer(anchoringHelper125.getHeight()), new Integer(startTabIndex.intValue() + 11), ControlState.ENABLED, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.TOPRIGHT, this.getImages().Core.FindEnabled24, this.getImages().Core.FindDisabled24, "Search for profiles matching 'Search Criteria'", Boolean.FALSE, Boolean.TRUE, Boolean.TRUE, Boolean.FALSE, null}));
	}
	...
	public Button btnCloneThisProfile()
	{
	...
	public CheckBox chkFilterWardAttendance()
	{
	...
	public static class Forms implements java.io.Serializable
	{
		...
		public final class SchedulingForms implements java.io.Serializable
		{
			...
			private SchedulingForms()
			{
				...
				FlexibleProfileSlot = new LocalFormName(114116);
				ProfilePreview = new LocalFormName(114118);
				DosSpecialtySelection = new LocalFormName(114129);
			}
			public final FormName ProfilesSlotGeneric;
			public final FormName ProfileTheatreSlotDialog;
			public final FormName FlexibleProfileSlot;
			public final FormName ProfilePreview;
			public final FormName DosSpecialtySelection;
		}
	...
	public class LocalContext extends ContextBridge
	{
		...
		public LocalContext(Context context, ims.framework.FormInfo formInfo, String componentIdentifier)
		{
			...
			cxl_listOwnerRemoveConfirm = new ims.framework.ContextVariable("listOwnerRemoveConfirm", prefix + "_lv_Scheduling.Profiles.__internal_x_context__listOwnerRemoveConfirm_" + componentIdentifier + "");
			cxl_profileHasSessions = new ims.framework.ContextVariable("profileHasSessions", prefix + "_lv_Scheduling.Profiles.__internal_x_context__profileHasSessions_" + componentIdentifier + "");
		}
		...
		public boolean getprofileHasSessionsIsNotNull()
		{
			return !cxl_profileHasSessions.getValueIsNull(context);
		}
		public Boolean getprofileHasSessions()
		{
			return (Boolean)cxl_profileHasSessions.getValue(context);
		}
		public void setprofileHasSessions(Boolean value)
		{
			cxl_profileHasSessions.setValue(context, value);
		}
		private ims.framework.ContextVariable cxl_profileHasSessions = null;
	}
	...
	public final class ContextMenus implements java.io.Serializable
	{
		...
		{
			private static final long serialVersionUID = 1L;
			public final class ProfileServiceFunctions implements java.io.Serializable
			{
				private static final long serialVersionUID = 1L;
				public static final int SELECT_ALL = 1;
				public static final int DESELECT_ALL = 2;
			}
			public void disableAllProfileServiceFunctionsMenuItems()
			{
				this.contextMenuProfileServiceFunctionsSELECT_ALLItem.setEnabled(false);
				this.contextMenuProfileServiceFunctionsDESELECT_ALLItem.setEnabled(false);
			}
			public void hideAllProfileServiceFunctionsMenuItems()
			{
				this.contextMenuProfileServiceFunctionsSELECT_ALLItem.setVisible(false);
				this.contextMenuProfileServiceFunctionsDESELECT_ALLItem.setVisible(false);
			}
			private Menu contextMenuProfileServiceFunctions;
			public ReadOnlyMenuItem getProfileServiceFunctionsSELECT_ALLItem()
			{
				return this.contextMenuProfileServiceFunctionsSELECT_ALLItem;
			}
			private MenuItem contextMenuProfileServiceFunctionsSELECT_ALLItem;
			public ReadOnlyMenuItem getProfileServiceFunctionsDESELECT_ALLItem()
			{
				return this.contextMenuProfileServiceFunctionsDESELECT_ALLItem;
			}
			private MenuItem contextMenuProfileServiceFunctionsDESELECT_ALLItem;
			...
			public final class ProfileDOS implements java.io.Serializable
			{
				private static final long serialVersionUID = 1L;
				public static final int ADD_SPECIALTY_DOS = 6;
			}
			public void disableAllProfileDOSMenuItems()
			{
				this.contextMenuProfileDOSADD_SPECIALTY_DOSItem.setEnabled(false);
			}
			public void hideAllProfileDOSMenuItems()
			{
				this.contextMenuProfileDOSADD_SPECIALTY_DOSItem.setVisible(false);
			}
			private Menu contextMenuProfileDOS;
			public ReadOnlyMenuItem getProfileDOSADD_SPECIALTY_DOSItem()
			{
				return this.contextMenuProfileDOSADD_SPECIALTY_DOSItem;
			}
			private MenuItem contextMenuProfileDOSADD_SPECIALTY_DOSItem;
			...
			public final class FlexibleProfileSlot implements java.io.Serializable
			{
				private static final long serialVersionUID = 1L;
				public static final int ADD = 12;
				public static final int EDIT = 13;
				public static final int INACTIVATE = 14;
			}
			public void disableAllFlexibleProfileSlotMenuItems()
			{
				this.contextMenuFlexibleProfileSlotADDItem.setEnabled(false);
				this.contextMenuFlexibleProfileSlotEDITItem.setEnabled(false);
				this.contextMenuFlexibleProfileSlotINACTIVATEItem.setEnabled(false);
			}
			public void hideAllFlexibleProfileSlotMenuItems()
			{
				this.contextMenuFlexibleProfileSlotADDItem.setVisible(false);
				this.contextMenuFlexibleProfileSlotEDITItem.setVisible(false);
				this.contextMenuFlexibleProfileSlotINACTIVATEItem.setVisible(false);
			}
			private Menu contextMenuFlexibleProfileSlot;
			public ReadOnlyMenuItem getFlexibleProfileSlotADDItem()
			{
				return this.contextMenuFlexibleProfileSlotADDItem;
			}
			private MenuItem contextMenuFlexibleProfileSlotADDItem;
			public ReadOnlyMenuItem getFlexibleProfileSlotEDITItem()
			{
				return this.contextMenuFlexibleProfileSlotEDITItem;
			}
			private MenuItem contextMenuFlexibleProfileSlotEDITItem;
			public ReadOnlyMenuItem getFlexibleProfileSlotINACTIVATEItem()
			{
				return this.contextMenuFlexibleProfileSlotINACTIVATEItem;
			}
			private MenuItem contextMenuFlexibleProfileSlotINACTIVATEItem;
			...
			{
				private static final long serialVersionUID = 1L;
				public static final int ADDTEMPLATE = 31;
				public static final int REMOVETEMPLATE = 32;
			}
			...
			public final class ProfilesMenu implements java.io.Serializable
			{
				...
				public static final int CLONE_PROFILE = 35;
			}
	...
	private class ReportFields
	{
		...
		{
			String prefix = formInfo.getLocalVariablesPrefix();
			IReportField[] fields = new IReportField[253];
			...
			fields[144] = new ims.framework.ReportField(this.context, "_cv_Scheduling.ProfileSlotGeneric", "BO-1055100000-ID", "ID_Profile_Slot");
			fields[145] = new ims.framework.ReportField(this.context, "_cv_Scheduling.ProfileSlotGeneric", "BO-1055100000-STARTTM", "StartTm");
			fields[146] = new ims.framework.ReportField(this.context, "_cv_Scheduling.ProfileSlotGeneric", "BO-1055100000-DURATION", "Duration");
			fields[147] = new ims.framework.ReportField(this.context, "_cv_Scheduling.ProfileSlotGeneric", "BO-1055100000-PRIORITY", "Priority");
			fields[148] = new ims.framework.ReportField(this.context, "_cv_Scheduling.ProfileSlotGeneric", "BO-1055100000-NUMBERSLOTSREQ", "NumberSlotsReq");
			fields[149] = new ims.framework.ReportField(this.context, "_cv_Scheduling.ProfileSlotGeneric", "BO-1055100000-NOOFINSTANCES", "NoOfInstances");
			fields[150] = new ims.framework.ReportField(this.context, "_cv_Scheduling.ProfileSlotGeneric", "BO-1055100000-DEALLOCNOOFDAYS", "DeallocNoOfDays");
			fields[151] = new ims.framework.ReportField(this.context, "_cv_Scheduling.ProfileSlotGeneric", "BO-1055100000-ISACTIVE", "IsActive");
			fields[152] = new ims.framework.ReportField(this.context, "_cv_Scheduling.ProfileSlotGeneric", "BO-1055100000-DIRECTACCESSSLOT", "Type");
			fields[153] = new ims.framework.ReportField(this.context, "_cv_Scheduling.ProfileSlotGeneric", "BO-1055100000-ENDTIME", "EndTime");
			fields[154] = new ims.framework.ReportField(this.context, "_cv_Admin.ProfileLocation", "BO-1007100007-ID", "ID_Location");
			fields[155] = new ims.framework.ReportField(this.context, "_cv_Admin.ProfileLocation", "BO-1007100007-NAME", "Name");
			fields[156] = new ims.framework.ReportField(this.context, "_cv_Admin.ProfileLocation", "BO-1007100007-ISACTIVE", "IsActive");
			fields[157] = new ims.framework.ReportField(this.context, "_cv_Admin.ProfileLocation", "BO-1007100007-ISVIRTUAL", "IsVirtual");
			fields[158] = new ims.framework.ReportField(this.context, "_cv_Admin.ProfileLocation", "BO-1007100007-TYPE", "Type");
			fields[159] = new ims.framework.ReportField(this.context, "_cv_Admin.ProfileLocation", "BO-1007100007-DISPLAYINEDTRACKING", "DisplayInEDTracking");
			fields[160] = new ims.framework.ReportField(this.context, "_cv_Admin.ProfileLocation", "BO-1007100007-CASENOTEFOLDERLOCATION", "CaseNoteFolderLocation");
			fields[161] = new ims.framework.ReportField(this.context, "_cv_Admin.ProfileLocation", "BO-1007100007-SECUREACCOMMODATION", "SecureAccommodation");
			fields[162] = new ims.framework.ReportField(this.context, "_cv_Admin.ProfileLocation", "BO-1007100007-TREATINGHOSP", "TreatingHosp");
			fields[163] = new ims.framework.ReportField(this.context, "_cv_Admin.ProfileLocation", "BO-1007100007-REFERRINGHOSPITAL", "ReferringHospital");
			fields[164] = new ims.framework.ReportField(this.context, "_cv_Pathway.SelectedEventLiteVo", "BO-1089100000-ID", "ID_Event");
			fields[165] = new ims.framework.ReportField(this.context, "_cv_Pathway.SelectedEventLiteVo", "BO-1089100000-NAME", "Name");
			fields[166] = new ims.framework.ReportField(this.context, "_cv_Pathway.SelectedEventLiteVo", "BO-1089100000-DESCRIPTION", "Description");
			fields[167] = new ims.framework.ReportField(this.context, "_cv_Pathway.SelectedEventLiteVo", "BO-1089100000-STATUS", "Status");
			fields[168] = new ims.framework.ReportField(this.context, "_cv_Pathway.SelectedEventLiteVo", "BO-1089100000-PATIENTDIARYIMPACT", "PatientDiaryImpact");
			fields[169] = new ims.framework.ReportField(this.context, "_cv_Pathway.SelectedEventLiteVo", "BO-1089100000-EVENTTYPE", "EventType");
			fields[170] = new ims.framework.ReportField(this.context, "_cv_Pathway.SelectedEventLiteVo", "BO-1089100000-STARTSCLOCK", "StartsClock");
			fields[171] = new ims.framework.ReportField(this.context, "_cv_Pathway.SelectedEventLiteVo", "BO-1089100000-STOPSCLOCK", "StopsClock");
			fields[172] = new ims.framework.ReportField(this.context, "_cv_Pathway.SelectedEventLiteVo", "BO-1089100000-ENDSPATHWAY", "EndsPathway");
			fields[173] = new ims.framework.ReportField(this.context, "_cv_Pathway.SelectedEventLiteVo", "BO-1089100000-ISMANUALSCHEDULEDEVENT", "IsManualScheduledEvent");
			fields[174] = new ims.framework.ReportField(this.context, "_cv_Pathway.SelectedEventLiteVo", "BO-1089100000-CANCELLATIONTYPE", "CancellationType");
			fields[175] = new ims.framework.ReportField(this.context, "_cv_Pathway.SelectedEventLiteVo", "BO-1089100000-CANCELLATIONREASON", "CancellationReason");
			fields[176] = new ims.framework.ReportField(this.context, "_cv_Scheduling.ProfileParentChildSlot", "BO-1090100018-ID", "ID_ProfileParentChildSlot");
			fields[177] = new ims.framework.ReportField(this.context, "_cv_Scheduling.ProfileParentChildSlot", "BO-1090100018-STARTTIME", "StartTime");
			fields[178] = new ims.framework.ReportField(this.context, "_cv_Scheduling.ProfileParentChildSlot", "BO-1090100018-NOOFINSTANCES", "NoOfInstances");
			fields[179] = new ims.framework.ReportField(this.context, "_cv_Scheduling.ProfileParentChildSlot", "BO-1090100018-ISACTIVE", "IsActive");
			fields[180] = new ims.framework.ReportField(this.context, "_cv_Scheduling.ProfileParentChildSlot", "BO-1090100018-DURATION", "Duration");
			fields[181] = new ims.framework.ReportField(this.context, "_cv_Scheduling.ProfileParentChildSlot", "BO-1090100018-ENDTM", "EndTm");
			fields[182] = new ims.framework.ReportField(this.context, "_cv_Scheduling.ProfileParentChildSlot", "BO-1090100018-PRIORITY", "Priority");
			fields[183] = new ims.framework.ReportField(this.context, "_cv_Scheduling.ProfileParentChildSlot", "BO-1090100018-NUMBERSLOTSREQ", "NumberSlotsReq");
			fields[184] = new ims.framework.ReportField(this.context, "_cv_Scheduling.ProfileTheatreSlot", "BO-1090100016-ID", "ID_ProfileTheatreTCISlot");
			fields[185] = new ims.framework.ReportField(this.context, "_cv_Scheduling.ProfileTheatreSlot", "BO-1090100016-TOCOMEINTIME", "ToComeInTime");
			fields[186] = new ims.framework.ReportField(this.context, "_cv_Scheduling.ProfileTheatreSlot", "BO-1090100016-NOOFINSTANCES", "NoOfInstances");
			fields[187] = new ims.framework.ReportField(this.context, "_cv_Scheduling.ProfileTheatreSlot", "BO-1090100016-ISACTIVE", "IsActive");
			fields[188] = new ims.framework.ReportField(this.context, "_cv_Scheduling.OutpatientFlexibleProfileSlot", "BO-1090100018-ID", "ID_ProfileParentChildSlot");
			fields[189] = new ims.framework.ReportField(this.context, "_cv_Scheduling.OutpatientFlexibleProfileSlot", "BO-1090100018-STARTTIME", "StartTime");
			fields[190] = new ims.framework.ReportField(this.context, "_cv_Scheduling.OutpatientFlexibleProfileSlot", "BO-1090100018-NOOFINSTANCES", "NoOfInstances");
			fields[191] = new ims.framework.ReportField(this.context, "_cv_Scheduling.OutpatientFlexibleProfileSlot", "BO-1090100018-ISACTIVE", "IsActive");
			fields[192] = new ims.framework.ReportField(this.context, "_cv_Scheduling.OutpatientFlexibleProfileSlot", "BO-1090100018-DURATION", "Duration");
			fields[193] = new ims.framework.ReportField(this.context, "_cv_Scheduling.OutpatientFlexibleProfileSlot", "BO-1090100018-ENDTM", "EndTm");
			fields[194] = new ims.framework.ReportField(this.context, "_cv_Scheduling.OutpatientFlexibleProfileSlot", "BO-1090100018-PRIORITY", "Priority");
			fields[195] = new ims.framework.ReportField(this.context, "_cv_Scheduling.OutpatientFlexibleProfileSlot", "BO-1090100018-NUMBERSLOTSREQ", "NumberSlotsReq");
			fields[196] = new ims.framework.ReportField(this.context, "_cv_Admin.ProfileCaseNoteFoldersLocation", "BO-1007100007-ID", "ID_Location");
			fields[197] = new ims.framework.ReportField(this.context, "_cv_Admin.ProfileCaseNoteFoldersLocation", "BO-1007100007-NAME", "Name");
			fields[198] = new ims.framework.ReportField(this.context, "_cv_Admin.ProfileCaseNoteFoldersLocation", "BO-1007100007-ISACTIVE", "IsActive");
			fields[199] = new ims.framework.ReportField(this.context, "_cv_Admin.ProfileCaseNoteFoldersLocation", "BO-1007100007-ISVIRTUAL", "IsVirtual");
			fields[200] = new ims.framework.ReportField(this.context, "_cv_Admin.ProfileCaseNoteFoldersLocation", "BO-1007100007-TYPE", "Type");
			fields[201] = new ims.framework.ReportField(this.context, "_cv_Admin.ProfileCaseNoteFoldersLocation", "BO-1007100007-DISPLAYINEDTRACKING", "DisplayInEDTracking");
			fields[202] = new ims.framework.ReportField(this.context, "_cv_Admin.ProfileCaseNoteFoldersLocation", "BO-1007100007-CASENOTEFOLDERLOCATION", "CaseNoteFolderLocation");
			fields[203] = new ims.framework.ReportField(this.context, "_cv_Admin.ProfileCaseNoteFoldersLocation", "BO-1007100007-SECUREACCOMMODATION", "SecureAccommodation");
			fields[204] = new ims.framework.ReportField(this.context, "_cv_Admin.ProfileCaseNoteFoldersLocation", "BO-1007100007-TREATINGHOSP", "TreatingHosp");
			fields[205] = new ims.framework.ReportField(this.context, "_cv_Admin.ProfileCaseNoteFoldersLocation", "BO-1007100007-REFERRINGHOSPITAL", "ReferringHospital");
			fields[206] = new ims.framework.ReportField(this.context, "_cv_Core.ReportTemplateRef", "BO-1004100008-ID", "ID_TemplateBo");
			fields[207] = new ims.framework.ReportField(this.context, "_cv_Scheduling.ProfileService", "BO-1003100032-ID", "ID_Service");
			fields[208] = new ims.framework.ReportField(this.context, "_cv_Scheduling.Profile", "BO-1005100001-ID", "ID_Sch_Profile");
			fields[209] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.Profiles.__internal_x_context__CurrentProfile_" + componentIdentifier, "BO-1005100001-ID", "ID_Sch_Profile");
			fields[210] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.Profiles.__internal_x_context__CurrentProfile_" + componentIdentifier, "BO-1005100001-NAME", "Name");
			fields[211] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.Profiles.__internal_x_context__CurrentProfile_" + componentIdentifier, "BO-1005100001-DESCRIPTION", "Description");
			fields[212] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.Profiles.__internal_x_context__CurrentProfile_" + componentIdentifier, "BO-1005100001-PRFCATEGORY", "PrfCategory");
			fields[213] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.Profiles.__internal_x_context__CurrentProfile_" + componentIdentifier, "BO-1005100001-PRFTYPE", "Prftype");
			fields[214] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.Profiles.__internal_x_context__CurrentProfile_" + componentIdentifier, "BO-1005100001-EFFFRM", "EffFrm");
			fields[215] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.Profiles.__internal_x_context__CurrentProfile_" + componentIdentifier, "BO-1005100001-EFFTO", "EffTo");
			fields[216] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.Profiles.__internal_x_context__CurrentProfile_" + componentIdentifier, "BO-1005100001-ISACTIVE", "IsActive");
			fields[217] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.Profiles.__internal_x_context__CurrentProfile_" + componentIdentifier, "BO-1005100001-LASTACTUALGENDATE", "LastActualGenDate");
			fields[218] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.Profiles.__internal_x_context__CurrentProfile_" + componentIdentifier, "BO-1005100001-LASTGENDATE", "LastGenDate");
			fields[219] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.Profiles.__internal_x_context__CurrentProfile_" + componentIdentifier, "BO-1005100001-AUTOGENERATEPERIOD", "AutoGeneratePeriod");
			fields[220] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.Profiles.__internal_x_context__CurrentProfile_" + componentIdentifier, "BO-1005100001-READYTOGENERATE", "ReadyToGenerate");
			fields[221] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.Profiles.__internal_x_context__CurrentProfile_" + componentIdentifier, "BO-1005100001-ISFIXED", "IsFixed");
			fields[222] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.Profiles.__internal_x_context__CurrentProfile_" + componentIdentifier, "BO-1005100001-ISUNDERCONTRACT", "IsUnderContract");
			fields[223] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.Profiles.__internal_x_context__CurrentProfile_" + componentIdentifier, "BO-1005100001-INTERVALTYPE", "IntervalType");
			fields[224] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.Profiles.__internal_x_context__CurrentProfile_" + componentIdentifier, "BO-1005100001-INTERVALSIZE", "IntervalSize");
			fields[225] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.Profiles.__internal_x_context__CurrentProfile_" + componentIdentifier, "BO-1005100001-ISSCHMON", "IsSchMon");
			fields[226] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.Profiles.__internal_x_context__CurrentProfile_" + componentIdentifier, "BO-1005100001-ISSCHTUE", "IsSchTue");
			fields[227] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.Profiles.__internal_x_context__CurrentProfile_" + componentIdentifier, "BO-1005100001-ISSCHWED", "IsSchWed");
			fields[228] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.Profiles.__internal_x_context__CurrentProfile_" + componentIdentifier, "BO-1005100001-ISSCHTHUR", "IsSchThur");
			fields[229] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.Profiles.__internal_x_context__CurrentProfile_" + componentIdentifier, "BO-1005100001-ISSCHFRI", "IsSchFri");
			fields[230] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.Profiles.__internal_x_context__CurrentProfile_" + componentIdentifier, "BO-1005100001-ISSCHSAT", "IsSchSat");
			fields[231] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.Profiles.__internal_x_context__CurrentProfile_" + componentIdentifier, "BO-1005100001-ISSCHSUN", "IsSchSun");
			fields[232] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.Profiles.__internal_x_context__CurrentProfile_" + componentIdentifier, "BO-1005100001-ISFIRSTINSTANCE", "IsFirstInstance");
			fields[233] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.Profiles.__internal_x_context__CurrentProfile_" + componentIdentifier, "BO-1005100001-ISSECONDINSTANCE", "IsSecondInstance");
			fields[234] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.Profiles.__internal_x_context__CurrentProfile_" + componentIdentifier, "BO-1005100001-ISTHIRDINSTANCE", "IsThirdInstance");
			fields[235] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.Profiles.__internal_x_context__CurrentProfile_" + componentIdentifier, "BO-1005100001-ISFOURTHINSTANCE", "IsFourthInstance");
			fields[236] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.Profiles.__internal_x_context__CurrentProfile_" + componentIdentifier, "BO-1005100001-ISFIFTHINSTANCE", "IsFifthInstance");
			fields[237] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.Profiles.__internal_x_context__CurrentProfile_" + componentIdentifier, "BO-1005100001-MININT", "MinInt");
			fields[238] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.Profiles.__internal_x_context__CurrentProfile_" + componentIdentifier, "BO-1005100001-ROUNDATTTIME", "RoundAttTime");
			fields[239] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.Profiles.__internal_x_context__CurrentProfile_" + componentIdentifier, "BO-1005100001-LASTAPPINTERVAL", "LastAppInterval");
			fields[240] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.Profiles.__internal_x_context__CurrentProfile_" + componentIdentifier, "BO-1005100001-STARTTM", "StartTm");
			fields[241] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.Profiles.__internal_x_context__CurrentProfile_" + componentIdentifier, "BO-1005100001-ENDTM", "EndTm");
			fields[242] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.Profiles.__internal_x_context__CurrentProfile_" + componentIdentifier, "BO-1005100001-PASCLINIC", "PASClinic");
			fields[243] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.Profiles.__internal_x_context__CurrentProfile_" + componentIdentifier, "BO-1005100001-MAXNOAPPTS", "MaxNoAppts");
			fields[244] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.Profiles.__internal_x_context__CurrentProfile_" + componentIdentifier, "BO-1005100001-CONSMEDIATYPE", "ConsMediaType");
			fields[245] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.Profiles.__internal_x_context__CurrentProfile_" + componentIdentifier, "BO-1005100001-CASENOTEFOLDERNOTREQUIRED", "CaseNoteFolderNotRequired");
			fields[246] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.Profiles.__internal_x_context__CurrentProfile_" + componentIdentifier, "BO-1005100001-THEATRETYPE", "TheatreType");
			fields[247] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.Profiles.__internal_x_context__CurrentProfile_" + componentIdentifier, "BO-1005100001-SLOTTYPE", "SlotType");
			fields[248] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.Profiles.__internal_x_context__CurrentProfile_" + componentIdentifier, "BO-1005100001-LISTTYPE", "ListType");
			fields[249] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.Profiles.__internal_x_context__CurrentProfile_" + componentIdentifier, "BO-1005100001-HASCHOOSEBOOKACTIVITY", "HasChooseBookActivity");
			fields[250] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.Profiles.__internal_x_context__CurrentProfile_" + componentIdentifier, "BO-1005100001-PROFILETYPE", "ProfileType");
			fields[251] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.Profiles.__internal_x_context__CurrentProfile_" + componentIdentifier, "BO-1005100001-ISOTHERHOSPITAL", "IsOtherHospital");
			fields[252] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.Profiles.__internal_x_context__SelectedDos_" + componentIdentifier, "BO-1055100011-ID", "ID_DirectoryofService");
			return fields;
		}
