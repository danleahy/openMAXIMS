...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "SessionFlexibleSlotDialog";
	}
	public int getWidth()
	{
		return 464;
	...
	{
		return new String[] { "_cv_Scheduling.SelectedSessionListOwners", "_cv_Scheduling.FlexibleSessionSlots", "_cv_RefMan.SelectedSessions", "_cv_RefMan.SelectedSession" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Scheduling.SessionFlexibleSlotDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
