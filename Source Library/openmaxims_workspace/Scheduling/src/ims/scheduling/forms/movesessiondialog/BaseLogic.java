...
public abstract class BaseLogic extends Handlers
{
	...
	protected final void oncmbMoveReasonValueSet(Object value)
	{
		java.util.ArrayList listOfValues = this.form.cmbMoveReason().getValues();
		...
		else if(value instanceof ims.scheduling.vo.lookups.CancelAppointmentReason)
		{
			...
			this.form.cmbMoveReason().newRow(instance, instance.getText(), instance.getImage(), instance.getTextColor());
		}
	}
	protected final void bindcmbMoveReasonLookup()
	{
		this.form.cmbMoveReason().clear();
		...
		{
			this.form.cmbMoveReason().newRow(lookupCollection.get(x), lookupCollection.get(x).getText(), lookupCollection.get(x).getImage(), lookupCollection.get(x).getTextColor());
		}
	}
	protected final void setcmbMoveReasonLookupValue(int id)
	{
		...
		if(instance != null)
			this.form.cmbMoveReason().setValue(instance);
	}
	protected final void defaultcmbMoveReasonLookupValue()
	{
		this.form.cmbMoveReason().setValue((ims.scheduling.vo.lookups.CancelAppointmentReason)domain.getLookupService().getDefaultInstance(ims.scheduling.vo.lookups.CancelAppointmentReason.class, engine.getFormName().getID(), ims.scheduling.vo.lookups.CancelAppointmentReason.TYPE_ID));
	}
