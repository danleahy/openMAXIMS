...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "InterProviderTransferOutDialog";
	}
	public int getWidth()
	{
		return 544;
	...
	{
		return new String[] { "_cv_Scheduling.InterProviderTransferOut" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Scheduling.InterProviderTransferOutDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
