...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "LinkedAppointmentDetailsCB";
	}
	public int getWidth()
	{
		return 848;
	...
	{
		return new String[] { "_cv_Scheduling.LinkedOPA" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Scheduling.LinkedAppointmentDetailsCB.__internal_x_context__" + String.valueOf(getFormId());
	}
	public ims.framework.FormInfo[] getComponentsFormInfo()
	{
		ims.framework.FormInfo[] componentsInfo = new ims.framework.FormInfo[1];
		componentsInfo[0] = new ims.scheduling.forms.linkedappointmentdetailscomponent.FormInfo(114125);
