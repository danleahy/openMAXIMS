...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "FutureAppointmentWorklist";
	}
	public int getWidth()
	{
		return 848;
	...
	{
		return new String[] { "_cv_Scheduling.BookingAppointmentRef", "_cv_Scheduling.ServiceFunctionRef", "_cv_RefMan.AppointmentSaved", "_cv_Scheduling.FutureAppointmentRemoval", "_cv_Scheduling.BookingService", "_cv_Scheduling.FutureAppointmentDetails" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Scheduling.FutureAppointmentWorklist.__internal_x_context__" + String.valueOf(getFormId());
	}
