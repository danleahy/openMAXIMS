...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Scheduling.ListOwnerCollection", "_cv_Scheduling.ProfileEndTime", "_cv_Scheduling.ProfileStartTime", "_cv_Scheduling.OutpatientFlexibleProfileSlot" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Scheduling.FlexibleProfileSlot.__internal_x_context__" + String.valueOf(getFormId());
	}
