...
abstract public class Handlers implements ims.framework.UILogic, IFormUILogicCode
{
	...
	abstract protected void onGrdCancellationReasonsGridCheckBoxClicked(int column, GenForm.grdCancellationReasonsRow row, boolean isChecked) throws ims.framework.exceptions.PresentationLogicException;
	...
	public final void setContext(ims.framework.UIEngine engine, GenForm form)
	{
		...
		this.form.grdCancellationReasons().setGridCheckBoxClickedEvent(new GridCheckBoxClicked()
		{
			private static final long serialVersionUID = 1L;
			...
			{
				onGrdCancellationReasonsGridCheckBoxClicked(column, new GenForm.grdCancellationReasonsRow(row), isChecked);
			}
		});
