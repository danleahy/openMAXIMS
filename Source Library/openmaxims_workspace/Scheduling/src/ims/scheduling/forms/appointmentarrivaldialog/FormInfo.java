...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "AppointmentArrivalDialog";
	}
	public int getWidth()
	{
		return 384;
	...
	{
		return new String[] { "_cv_Scheduling.LateArrivalRecord" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Scheduling.AppointmentArrivalDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
