...
public abstract class BaseSessionAdminImpl extends DomainImpl implements ims.scheduling.domain.SessionAdmin, ims.domain.impl.Transactional
{
	...
	public void validatelistSession(ims.scheduling.vo.Sch_ProfileRefVo profile, ims.scheduling.vo.DirectoryofServiceRefVo dos, ims.framework.utils.Date startDate, ims.framework.utils.Date endDate, ims.scheduling.vo.lookups.Session_Status_and_Reason status)
	{
	}
	...
	@SuppressWarnings("unused")
	public void validateupdateCatsReferralCancelStatus(ims.RefMan.vo.CatsReferralRefVo catsRefVo)
	{
	}
