...
public abstract class BaseBookAppointmentImpl extends DomainImpl implements ims.scheduling.domain.BookAppointment, ims.domain.impl.Transactional
{
	...
	@SuppressWarnings("unused")
	public void validatesaveBooking(ims.scheduling.vo.Sch_BookingVo voBooking, ims.scheduling.vo.SlotEventPathwayVoCollection voCollSlotEvPathway, ims.scheduling.vo.SessionShortVo session, ims.emergency.vo.EmergencyAttendanceOutcomeVo emergencyAttendance)
	{
	}
