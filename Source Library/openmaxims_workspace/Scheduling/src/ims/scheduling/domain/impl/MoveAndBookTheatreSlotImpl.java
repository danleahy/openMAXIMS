...
import ims.scheduling.domain.base.impl.BaseMoveAndBookTheatreSlotImpl;
...
import ims.scheduling.vo.domain.AppointmentForTheatreMoveVoAssembler;
...
public class MoveAndBookTheatreSlotImpl extends BaseMoveAndBookTheatreSlotImpl
{

	private static final long serialVersionUID = 1L;

	public SessionEmergencyTheatreVoCollection listSessions(Date date, LocationRefVo hospital, Integer duration, Boolean allowOverBook)
	{
		...
		if (!Boolean.TRUE.equals(allowOverBook))
		{
			if (duration != null)
			{
	...
	public AppointmentForTheatreMoveVo getAppointmentToMove(Booking_AppointmentRefVo appointment)
	{
		if (appointment == null || appointment.getID_Booking_Appointment() == null)
			return null;
		
		return AppointmentForTheatreMoveVoAssembler.create((Booking_Appointment) getDomainFactory().getDomainObject(Booking_Appointment.class, appointment.getID_Booking_Appointment()));
	}
	...
	public void moveAppointment(SessionParentChildSlotVo fromSlot, SessionParentChildSlotVo toSlot) throws StaleObjectException
	{
		...
		impl.moveAppointment(fromSlot, toSlot);
	}
