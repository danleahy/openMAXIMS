...
public class GenForm extends FormBridge
{
	...
	public static class container1Container extends ContainerBridge
	{
		...
		protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
		{
			...
			super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1010), new Integer(anchoringHelper11.getX()), new Integer(anchoringHelper11.getY()), new Integer(anchoringHelper11.getWidth()), new Integer(anchoringHelper11.getHeight()), new Integer(startTabIndex.intValue() + 16), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT, "Save", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
			...
			super.addControl(factory.getControl(CheckBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1017), new Integer(anchoringHelper18.getX()), new Integer(anchoringHelper18.getY()), new Integer(anchoringHelper18.getWidth()), new Integer(anchoringHelper18.getHeight()), new Integer(startTabIndex.intValue() + 15), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPRIGHT ,"", Boolean.FALSE, null}));
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[155] = new ims.framework.ReportField(this.context, "_cv_COE.MNARecord", "BO-1003100002-ID", "ID_Assessment");
			fields[156] = new ims.framework.ReportField(this.context, "_cv_COE.MNARecord", "BO-1003100002-DATETIMEINITIATED", "DateTimeInitiated");
			fields[157] = new ims.framework.ReportField(this.context, "_cv_COE.MNARecord", "BO-1003100002-CLINICALCONTACT", "ClinicalContact");
			fields[158] = new ims.framework.ReportField(this.context, "_cv_COE.MNARecord", "BO-1003100002-CARECONTEXT", "CareContext");
			fields[159] = new ims.framework.ReportField(this.context, "_cv_COE.AssessmentEatingAndDrinking", "BO-1015100001-ID", "ID_AssessmentComponent");
			fields[160] = new ims.framework.ReportField(this.context, "_cv_COE.AssessmentEatingAndDrinking", "BO-1015100001-ISCOMPLETE", "IsComplete");
			fields[161] = new ims.framework.ReportField(this.context, "_cv_COE.AssessmentEatingAndDrinking", "BO-1015100001-COPY", "Copy");
			fields[162] = new ims.framework.ReportField(this.context, "_cv_COE.AssessmentEatingAndDrinking", "BO-1015100001-COMPONENTTYPE", "ComponentType");
			fields[163] = new ims.framework.ReportField(this.context, "_cv_COE.AssessmentEatingAndDrinking", "BO-1012100022-DIFFICULTIESWITHSWALLOWING", "DifficultiesWithSwallowing");
			fields[164] = new ims.framework.ReportField(this.context, "_cv_COE.AssessmentEatingAndDrinking", "BO-1012100022-DESCRIBEAPPETITE", "DescribeAppetite");
			fields[165] = new ims.framework.ReportField(this.context, "_cv_COE.AssessmentEatingAndDrinking", "BO-1012100022-ANYSPECIALDIET", "AnySpecialDiet");
			fields[166] = new ims.framework.ReportField(this.context, "_cv_COE.AssessmentEatingAndDrinking", "BO-1012100022-SPECIALDIET", "SpecialDiet");
			fields[167] = new ims.framework.ReportField(this.context, "_cv_COE.AssessmentEatingAndDrinking", "BO-1012100022-FOODPATIENTLIKES", "FoodPatientLikes");
			fields[168] = new ims.framework.ReportField(this.context, "_cv_COE.AssessmentEatingAndDrinking", "BO-1012100022-FOODPATIENTDISLIKES", "FoodPatientDislikes");
			fields[169] = new ims.framework.ReportField(this.context, "_cv_COE.AssessmentEatingAndDrinking", "BO-1012100022-FOODPATIENTFAVOURITE", "FoodPatientFavourite");
			fields[170] = new ims.framework.ReportField(this.context, "_cv_COE.AssessmentEatingAndDrinking", "BO-1012100022-REQUIREASSISTANCE", "RequireAssistance");
			fields[171] = new ims.framework.ReportField(this.context, "_cv_COE.AssessmentEatingAndDrinking", "BO-1012100022-MNASCORE", "MNAScore");
			return fields;
		}
