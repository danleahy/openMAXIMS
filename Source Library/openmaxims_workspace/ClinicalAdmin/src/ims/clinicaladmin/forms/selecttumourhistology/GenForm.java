...
public class GenForm extends FormBridge
{
	...
	public static class ctnDetailsContainer extends ContainerBridge
	{
		...
		protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
		{
			...
			ims.framework.FormUiLogic m_ccTaxonomyCodesForm = loader.loadComponent(104124, appForm, startControlID * 10 + 1000, anchoringHelper1.getSize(), instance1, startTabIndex.intValue() + 6, skipContextValidation);
			//ims.framework.Control m_ccTaxonomyCodesControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1000), new Integer(16), new Integer(32), new Integer(624), new Integer(112), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 6), m_ccTaxonomyCodesForm, instance1 } );
			ims.framework.Control m_ccTaxonomyCodesControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1001),  new Integer(anchoringHelper1.getX()), new Integer(anchoringHelper1.getY()), new Integer(anchoringHelper1.getWidth()), new Integer(anchoringHelper1.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 6), m_ccTaxonomyCodesForm, instance1, Boolean.FALSE } );
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1008), new Integer(anchoringHelper8.getX()), new Integer(anchoringHelper8.getY()), new Integer(anchoringHelper8.getWidth()), new Integer(anchoringHelper8.getHeight()), new Integer(startTabIndex.intValue() + 8), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Select", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.TumourHistology", "BO-1074100012-ID", "ID_TumourHistology");
			fields[145] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.TumourHistology", "BO-1074100012-HISTOLOGYDESCRIPTION", "HistologyDescription");
			fields[146] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.TumourHistology", "BO-1074100012-ISACTIVE", "IsActive");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.SelectTumourHistology.__internal_x_context__SelectedHistology_" + componentIdentifier, "BO-1074100012-ID", "ID_TumourHistology");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.SelectTumourHistology.__internal_x_context__SelectedHistology_" + componentIdentifier, "BO-1074100012-HISTOLOGYDESCRIPTION", "HistologyDescription");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.SelectTumourHistology.__internal_x_context__SelectedHistology_" + componentIdentifier, "BO-1074100012-ISACTIVE", "IsActive");
			return fields;
		}
