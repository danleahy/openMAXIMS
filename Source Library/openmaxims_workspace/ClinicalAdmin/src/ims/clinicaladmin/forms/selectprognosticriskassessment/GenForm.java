...
public class GenForm extends FormBridge
{
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.SelectedPrognosticRiskAssessment", "BO-1075100018-ID", "ID_PrognosticRiskConfiguration");
			fields[145] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.SelectedPrognosticRiskAssessment", "BO-1075100018-RISKNAME", "RiskName");
			fields[146] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.SelectedPrognosticRiskAssessment", "BO-1075100018-RISKDESCRIPTION", "RiskDescription");
			fields[147] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.SelectedPrognosticRiskAssessment", "BO-1075100018-ISACTIVE", "IsActive");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.SelectPrognosticRiskAssessment.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1075100018-ID", "ID_PrognosticRiskConfiguration");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.SelectPrognosticRiskAssessment.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1075100018-RISKNAME", "RiskName");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.SelectPrognosticRiskAssessment.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1075100018-RISKDESCRIPTION", "RiskDescription");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.SelectPrognosticRiskAssessment.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1075100018-ISACTIVE", "IsActive");
			return fields;
		}
