...
public class GenForm extends FormBridge
{
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.TumourGroup", "BO-1074100009-ID", "ID_TumourGroup");
			fields[145] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.TumourGroup", "BO-1074100009-GROUPNAME", "GroupName");
			fields[146] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.TumourGroup", "BO-1074100009-ISACTIVE", "IsActive");
			fields[147] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.TumourGroup", "BO-1074100009-HASTNM", "HasTNM");
			fields[148] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.TumourGroup", "BO-1074100009-ISPROGNOSTICGROUPINGRELEVANT", "IsPrognosticGroupingRelevant");
			fields[149] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.TumourGroup", "BO-1074100009-GROUPDESCRIPTION", "GroupDescription");
			fields[150] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.TumourGroup", "BO-1074100009-HASOTHERCLASSIFICATIONS", "HasOtherClassifications");
			fields[151] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.TumourGroup", "BO-1074100009-TNMREQUIRESDIFF", "TnmRequiresDiff");
			fields[152] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.TumourGroup", "BO-1074100009-TNMREQUIRESOVER45", "TnmRequiresOver45");
			fields[153] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.TumourGroup", "BO-1074100009-TNMREQUIRESHISTO", "TnmRequiresHisto");
			fields[154] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.TumourGroup", "BO-1074100009-TNMREQUIRESSMARKERS", "TnmRequiresSMarkers");
			fields[155] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.TumourGroup", "BO-1074100009-TNMVERSION", "TNMVersion");
			fields[156] = new ims.framework.ReportField(this.context, "_cv_Oncology.SelectedRecordForOverallPrognosticDialog", "BO-1075100019-ID", "ID_PrognosticGrouping");
			fields[157] = new ims.framework.ReportField(this.context, "_cv_Oncology.SelectedRecordForOverallPrognosticDialog", "BO-1075100019-PROGNOSTICGROUP", "PrognosticGroup");
			fields[158] = new ims.framework.ReportField(this.context, "_cv_Oncology.SelectedRecordForOverallPrognosticDialog", "BO-1075100019-ISACTIVE", "IsActive");
			fields[159] = new ims.framework.ReportField(this.context, "_cv_Oncology.SelectedRecordForOverallPrognosticDialog", "BO-1075100019-TGROUP", "TGroup");
			fields[160] = new ims.framework.ReportField(this.context, "_cv_Oncology.SelectedRecordForOverallPrognosticDialog", "BO-1075100019-TSITE", "TSite");
			fields[161] = new ims.framework.ReportField(this.context, "_cv_Oncology.SelectedRecordForOverallPrognosticDialog", "BO-1075100019-O45", "O45");
			return fields;
		}
