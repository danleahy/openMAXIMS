...
public class GenForm extends FormBridge
{
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.SelectedPrognosticPSA", "BO-1075100015-ID", "ID_PSAConfig");
			fields[145] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.SelectedPrognosticPSA", "BO-1075100015-PSANAME", "PSAName");
			fields[146] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.SelectedPrognosticPSA", "BO-1075100015-PSADESCRIPTION", "PSADescription");
			fields[147] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.SelectedPrognosticPSA", "BO-1075100015-ISACTIVE", "IsActive");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.SelecPrognosticPSA.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1075100015-ID", "ID_PSAConfig");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.SelecPrognosticPSA.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1075100015-PSANAME", "PSAName");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.SelecPrognosticPSA.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1075100015-PSADESCRIPTION", "PSADescription");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.SelecPrognosticPSA.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1075100015-ISACTIVE", "IsActive");
			return fields;
		}
