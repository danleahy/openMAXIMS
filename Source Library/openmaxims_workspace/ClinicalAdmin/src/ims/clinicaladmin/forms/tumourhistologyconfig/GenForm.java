...
public class GenForm extends FormBridge
{
	...
	public static class ctnDetailsContainer extends ContainerBridge
	{
		...
		protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
		{
			...
			ims.framework.FormUiLogic m_ccTaxonomyMappingsForm = loader.loadComponent(104124, appForm, startControlID * 10 + 1000, anchoringHelper1.getSize(), instance1, startTabIndex.intValue() + 8, skipContextValidation);
			//ims.framework.Control m_ccTaxonomyMappingsControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1000), new Integer(16), new Integer(48), new Integer(800), new Integer(112), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 8), m_ccTaxonomyMappingsForm, instance1 } );
			ims.framework.Control m_ccTaxonomyMappingsControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1001),  new Integer(anchoringHelper1.getX()), new Integer(anchoringHelper1.getY()), new Integer(anchoringHelper1.getWidth()), new Integer(anchoringHelper1.getHeight()), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 8), m_ccTaxonomyMappingsForm, instance1, Boolean.FALSE } );
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.TumourHistologyConfig.__internal_x_context__SelectedHistology_" + componentIdentifier, "BO-1074100012-ID", "ID_TumourHistology");
			fields[145] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.TumourHistologyConfig.__internal_x_context__SelectedHistology_" + componentIdentifier, "BO-1074100012-HISTOLOGYDESCRIPTION", "HistologyDescription");
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.TumourHistologyConfig.__internal_x_context__SelectedHistology_" + componentIdentifier, "BO-1074100012-ISACTIVE", "IsActive");
			return fields;
		}
