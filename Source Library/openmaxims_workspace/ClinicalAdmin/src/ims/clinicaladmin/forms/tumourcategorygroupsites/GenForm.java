...
public class GenForm extends FormBridge
{
	...
	public static class lyrConfigLayer extends Layer
	{
		...
		public static class tabTVersionContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1014), new Integer(anchoringHelper14.getX()), new Integer(anchoringHelper14.getY()), new Integer(anchoringHelper14.getWidth()), new Integer(anchoringHelper14.getHeight()), new Integer(startTabIndex.intValue() + 9), ControlState.DISABLED, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.ALL,Boolean.TRUE, new Integer(0), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
				...
				super.addControl(factory.getControl(DateControl.class, new Object[] { control, new Integer(startControlID.intValue() + 1015), new Integer(anchoringHelper15.getX()), new Integer(anchoringHelper15.getY()), new Integer(anchoringHelper15.getWidth()), new Integer(anchoringHelper15.getHeight()), new Integer(startTabIndex.intValue() + 8), ControlState.DISABLED, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.TRUE, null, Boolean.FALSE, null, Boolean.FALSE, null}));
				...
				super.addControl(factory.getControl(DateControl.class, new Object[] { control, new Integer(startControlID.intValue() + 1016), new Integer(anchoringHelper16.getX()), new Integer(anchoringHelper16.getY()), new Integer(anchoringHelper16.getWidth()), new Integer(anchoringHelper16.getHeight()), new Integer(startTabIndex.intValue() + 7), ControlState.DISABLED, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.TRUE, null, Boolean.FALSE, null, Boolean.FALSE, null}));
				...
				ComboBox m_cmbVersionTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1017), new Integer(anchoringHelper17.getX()), new Integer(anchoringHelper17.getY()), new Integer(anchoringHelper17.getWidth()), new Integer(anchoringHelper17.getHeight()), new Integer(startTabIndex.intValue() + 6), ControlState.DISABLED, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT ,Boolean.TRUE, Boolean.TRUE, SortOrder.ASCENDING, Boolean.FALSE, new Integer(1), null, Boolean.TRUE, new Integer(-1)});
		...
		public static class tabTGroupContainer extends LayerBridge
		{
			...
			public static class lyrGroupDetailsLayer extends Layer
			{
				...
				public static class tabGroupTNMContainer extends LayerBridge
				{
					...
					protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
					{
						...
						super.addControl(factory.getControl(CheckBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1029), new Integer(anchoringHelper29.getX()), new Integer(anchoringHelper29.getY()), new Integer(anchoringHelper29.getWidth()), new Integer(anchoringHelper29.getHeight()), new Integer(startTabIndex.intValue() + 18), ControlState.DISABLED, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,"", Boolean.TRUE, null}));
						...
						super.addControl(factory.getControl(CheckBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1031), new Integer(anchoringHelper31.getX()), new Integer(anchoringHelper31.getY()), new Integer(anchoringHelper31.getWidth()), new Integer(anchoringHelper31.getHeight()), new Integer(startTabIndex.intValue() + 22), ControlState.DISABLED, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,"", Boolean.TRUE, null}));
						...
						super.addControl(factory.getControl(CheckBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1032), new Integer(anchoringHelper32.getX()), new Integer(anchoringHelper32.getY()), new Integer(anchoringHelper32.getWidth()), new Integer(anchoringHelper32.getHeight()), new Integer(startTabIndex.intValue() + 19), ControlState.DISABLED, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,"", Boolean.TRUE, null}));
				...
				public static class tabClassificationContainer extends LayerBridge
				{
					...
					protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
					{
						...
						super.addControl(factory.getControl(TreeView.class, new Object[] { control, new Integer(startControlID.intValue() + 1035), new Integer(anchoringHelper35.getX()), new Integer(anchoringHelper35.getY()), new Integer(anchoringHelper35.getWidth()), new Integer(anchoringHelper35.getHeight()), new Integer(startTabIndex.intValue() + 23), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL,Boolean.TRUE, Boolean.FALSE, Boolean.FALSE, contextMenus.Oncology.contextMenuTumourGroupOtherClassification, Boolean.TRUE, Boolean.FALSE, Boolean.FALSE, Boolean.FALSE, Boolean.FALSE}));
					}
				...
				public static class tabPrognosticGroupingContainer extends LayerBridge
				{
					...
					protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
					{
						...
						super.addControl(factory.getControl(CheckBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1045), new Integer(anchoringHelper45.getX()), new Integer(anchoringHelper45.getY()), new Integer(anchoringHelper45.getWidth()), new Integer(anchoringHelper45.getHeight()), new Integer(startTabIndex.intValue() + 26), ControlState.DISABLED, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,"", Boolean.FALSE, null}));
						...
						super.addControl(factory.getControl(CheckBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1046), new Integer(anchoringHelper46.getX()), new Integer(anchoringHelper46.getY()), new Integer(anchoringHelper46.getWidth()), new Integer(anchoringHelper46.getHeight()), new Integer(startTabIndex.intValue() + 25), ControlState.DISABLED, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,"", Boolean.FALSE, null}));
						...
						super.addControl(factory.getControl(CheckBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1048), new Integer(anchoringHelper48.getX()), new Integer(anchoringHelper48.getY()), new Integer(anchoringHelper48.getWidth()), new Integer(anchoringHelper48.getHeight()), new Integer(startTabIndex.intValue() + 32), ControlState.DISABLED, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,"", Boolean.TRUE, null}));
						...
						super.addControl(factory.getControl(CheckBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1049), new Integer(anchoringHelper49.getX()), new Integer(anchoringHelper49.getY()), new Integer(anchoringHelper49.getWidth()), new Integer(anchoringHelper49.getHeight()), new Integer(startTabIndex.intValue() + 31), ControlState.DISABLED, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,"", Boolean.TRUE, null}));
						...
						super.addControl(factory.getControl(CheckBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1050), new Integer(anchoringHelper50.getX()), new Integer(anchoringHelper50.getY()), new Integer(anchoringHelper50.getWidth()), new Integer(anchoringHelper50.getHeight()), new Integer(startTabIndex.intValue() + 30), ControlState.DISABLED, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,"", Boolean.TRUE, null}));
						...
						super.addControl(factory.getControl(CheckBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1051), new Integer(anchoringHelper51.getX()), new Integer(anchoringHelper51.getY()), new Integer(anchoringHelper51.getWidth()), new Integer(anchoringHelper51.getHeight()), new Integer(startTabIndex.intValue() + 29), ControlState.DISABLED, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,"", Boolean.TRUE, null}));
						...
						super.addControl(factory.getControl(CheckBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1052), new Integer(anchoringHelper52.getX()), new Integer(anchoringHelper52.getY()), new Integer(anchoringHelper52.getWidth()), new Integer(anchoringHelper52.getHeight()), new Integer(startTabIndex.intValue() + 28), ControlState.DISABLED, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,"", Boolean.TRUE, null}));
				...
				public static class tabPageTumourLocationContainer extends LayerBridge
				{
					...
					protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
					{
						...
						Grid m_grdPrognosticLocationTemp = (Grid)factory.getControl(Grid.class, new Object[] { control, new Integer(startControlID.intValue() + 1054), new Integer(anchoringHelper54.getX()), new Integer(anchoringHelper54.getY()), new Integer(anchoringHelper54.getWidth()), new Integer(anchoringHelper54.getHeight()), new Integer(startTabIndex.intValue() + 33), ControlState.DISABLED, ControlState.READONLY, ims.framework.enumerations.ControlAnchoring.ALL,Boolean.TRUE, Boolean.TRUE, new Integer(24), Boolean.TRUE, contextMenus.ClinicalAdmin.contextMenuTumourGroupPrognosticLocation, Boolean.FALSE, Boolean.FALSE, new Integer(0), null, Boolean.FALSE, Boolean.TRUE});
				...
				public static class tabPageRiskCategoryContainer extends LayerBridge
				{
					...
					protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
					{
						...
						Grid m_grdRiskCategoryTemp = (Grid)factory.getControl(Grid.class, new Object[] { control, new Integer(startControlID.intValue() + 1055), new Integer(anchoringHelper55.getX()), new Integer(anchoringHelper55.getY()), new Integer(anchoringHelper55.getWidth()), new Integer(anchoringHelper55.getHeight()), new Integer(startTabIndex.intValue() + 34), ControlState.DISABLED, ControlState.READONLY, ims.framework.enumerations.ControlAnchoring.ALL,Boolean.TRUE, Boolean.TRUE, new Integer(24), Boolean.TRUE, contextMenus.ClinicalAdmin.contextMenuTumourGroupPrognosticRisk, Boolean.FALSE, Boolean.FALSE, new Integer(0), null, Boolean.FALSE, Boolean.TRUE});
				...
				public static class tabPagePSAContainer extends LayerBridge
				{
					...
					protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
					{
						...
						Grid m_grdPSATemp = (Grid)factory.getControl(Grid.class, new Object[] { control, new Integer(startControlID.intValue() + 1056), new Integer(anchoringHelper56.getX()), new Integer(anchoringHelper56.getY()), new Integer(anchoringHelper56.getWidth()), new Integer(anchoringHelper56.getHeight()), new Integer(startTabIndex.intValue() + 35), ControlState.DISABLED, ControlState.READONLY, ims.framework.enumerations.ControlAnchoring.ALL,Boolean.TRUE, Boolean.TRUE, new Integer(24), Boolean.TRUE, contextMenus.ClinicalAdmin.contextMenuTumourGroupPrognosticPSA, Boolean.FALSE, Boolean.FALSE, new Integer(0), null, Boolean.FALSE, Boolean.TRUE});
				...
				public static class tabPageGleasonContainer extends LayerBridge
				{
					...
					protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
					{
						...
						Grid m_grdGleasonTemp = (Grid)factory.getControl(Grid.class, new Object[] { control, new Integer(startControlID.intValue() + 1057), new Integer(anchoringHelper57.getX()), new Integer(anchoringHelper57.getY()), new Integer(anchoringHelper57.getWidth()), new Integer(anchoringHelper57.getHeight()), new Integer(startTabIndex.intValue() + 36), ControlState.DISABLED, ControlState.READONLY, ims.framework.enumerations.ControlAnchoring.ALL,Boolean.TRUE, Boolean.TRUE, new Integer(24), Boolean.TRUE, contextMenus.ClinicalAdmin.contextMenuTumourGroupPrognosticGleason, Boolean.FALSE, Boolean.FALSE, new Integer(0), null, Boolean.FALSE, Boolean.TRUE});
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1069), new Integer(anchoringHelper69.getX()), new Integer(anchoringHelper69.getY()), new Integer(anchoringHelper69.getWidth()), new Integer(anchoringHelper69.getHeight()), new Integer(startTabIndex.intValue() + 11), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT,Boolean.TRUE, new Integer(255), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
				...
				super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1070), new Integer(anchoringHelper70.getX()), new Integer(anchoringHelper70.getY()), new Integer(anchoringHelper70.getWidth()), new Integer(anchoringHelper70.getHeight()), new Integer(startTabIndex.intValue() + 10), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT,Boolean.FALSE, new Integer(255), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.TRUE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
		...
		public static class tabTSiteContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				ims.framework.FormUiLogic m_customSiteMappingsForm = loader.loadComponent(104124, appForm, startControlID * 10 + 2000, anchoringHelper72.getSize(), instance1, startTabIndex.intValue() + 42, skipContextValidation);
				//ims.framework.Control m_customSiteMappingsControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1072), new Integer(8), new Integer(216), new Integer(576), new Integer(328), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 42), m_customSiteMappingsForm, instance1 } );
				ims.framework.Control m_customSiteMappingsControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1073),  new Integer(anchoringHelper72.getX()), new Integer(anchoringHelper72.getY()), new Integer(anchoringHelper72.getWidth()), new Integer(anchoringHelper72.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 42), m_customSiteMappingsForm, instance1, Boolean.FALSE } );
				...
				super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1080), new Integer(anchoringHelper79.getX()), new Integer(anchoringHelper79.getY()), new Integer(anchoringHelper79.getWidth()), new Integer(anchoringHelper79.getHeight()), new Integer(startTabIndex.intValue() + 38), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT,Boolean.TRUE, new Integer(255), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
				...
				super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1081), new Integer(anchoringHelper80.getX()), new Integer(anchoringHelper80.getY()), new Integer(anchoringHelper80.getWidth()), new Integer(anchoringHelper80.getHeight()), new Integer(startTabIndex.intValue() + 37), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT,Boolean.FALSE, new Integer(255), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.TRUE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
				...
				super.addControl(factory.getControl(CheckBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1082), new Integer(anchoringHelper81.getX()), new Integer(anchoringHelper81.getY()), new Integer(anchoringHelper81.getWidth()), new Integer(anchoringHelper81.getHeight()), new Integer(startTabIndex.intValue() + 41), ControlState.DISABLED, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,"", Boolean.TRUE, null}));
				...
				super.addControl(factory.getControl(CheckBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1083), new Integer(anchoringHelper82.getX()), new Integer(anchoringHelper82.getY()), new Integer(anchoringHelper82.getWidth()), new Integer(anchoringHelper82.getHeight()), new Integer(startTabIndex.intValue() + 40), ControlState.DISABLED, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,"", Boolean.TRUE, null}));
				...
				super.addControl(factory.getControl(CheckBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1084), new Integer(anchoringHelper83.getX()), new Integer(anchoringHelper83.getY()), new Integer(anchoringHelper83.getWidth()), new Integer(anchoringHelper83.getHeight()), new Integer(startTabIndex.intValue() + 39), ControlState.DISABLED, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,"", Boolean.FALSE, null}));
			}
		...
		public static class tabTNMContainer extends LayerBridge
		{
			...
			public static class lyrTNMLayer extends Layer
			{
				...
				public static class tabTNMMappingsContainer extends LayerBridge
				{
					...
					protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
					{
						...
						ims.framework.FormUiLogic m_customTNMMappingsForm = loader.loadComponent(104124, appForm, startControlID * 10 + 3000, anchoringHelper85.getSize(), instance1, startTabIndex.intValue() + 52, skipContextValidation);
						//ims.framework.Control m_customTNMMappingsControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1086), new Integer(8), new Integer(80), new Integer(544), new Integer(360), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 52), m_customTNMMappingsForm, instance1 } );
						ims.framework.Control m_customTNMMappingsControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1087),  new Integer(anchoringHelper85.getX()), new Integer(anchoringHelper85.getY()), new Integer(anchoringHelper85.getWidth()), new Integer(anchoringHelper85.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 52), m_customTNMMappingsForm, instance1, Boolean.FALSE } );
						...
						super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1090), new Integer(anchoringHelper88.getX()), new Integer(anchoringHelper88.getY()), new Integer(anchoringHelper88.getWidth()), new Integer(anchoringHelper88.getHeight()), new Integer(startTabIndex.intValue() + 50), ControlState.DISABLED, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.FALSE, new Integer(0), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
						...
						super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1091), new Integer(anchoringHelper89.getX()), new Integer(anchoringHelper89.getY()), new Integer(anchoringHelper89.getWidth()), new Integer(anchoringHelper89.getHeight()), new Integer(startTabIndex.intValue() + 51), ControlState.DISABLED, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.FALSE, new Integer(0), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
					}
			...
			public static class GroupTNMValuesRadioButton extends RadioButtonBridge
			{
				...
				protected void setContext(Integer startTabIndex, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize)
				{
					...
					control.addButton(0, anchoringHelper92.getX(), anchoringHelper92.getY(), anchoringHelper92.getWidth(), "All", startTabIndex.intValue() + 44);
					...
					control.addButton(1, anchoringHelper93.getX(), anchoringHelper93.getY(), anchoringHelper93.getWidth(), "M Values Only", startTabIndex.intValue() + 47);
					...
					control.addButton(2, anchoringHelper94.getX(), anchoringHelper94.getY(), anchoringHelper94.getWidth(), "N Values Only", startTabIndex.intValue() + 46);
					...
					control.addButton(3, anchoringHelper95.getX(), anchoringHelper95.getY(), anchoringHelper95.getWidth(), "T Values Only", startTabIndex.intValue() + 45);
				}
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				super.addControl(factory.getControl(CheckBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1095), new Integer(anchoringHelper97.getX()), new Integer(anchoringHelper97.getY()), new Integer(anchoringHelper97.getWidth()), new Integer(anchoringHelper97.getHeight()), new Integer(startTabIndex.intValue() + 48), ControlState.ENABLED, ControlState.DISABLED,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,"Active Only", Boolean.TRUE, null}));
		...
		public static class tabSpecialtiesContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				super.addControl(factory.getControl(TreeView.class, new Object[] { control, new Integer(startControlID.intValue() + 1102), new Integer(anchoringHelper103.getX()), new Integer(anchoringHelper103.getY()), new Integer(anchoringHelper103.getWidth()), new Integer(anchoringHelper103.getHeight()), new Integer(startTabIndex.intValue() + 56), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL,Boolean.TRUE, Boolean.FALSE, Boolean.FALSE, contextMenus.contextMenuGenericGrid, Boolean.TRUE, Boolean.FALSE, Boolean.FALSE, Boolean.FALSE, Boolean.FALSE}));
			}
		...
		public static class tabPagTaxonomyContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				ims.framework.FormUiLogic m_customGroupMappingForm = loader.loadComponent(104124, appForm, startControlID * 10 + 4000, anchoringHelper106.getSize(), instance1, startTabIndex.intValue() + 58, skipContextValidation);
				//ims.framework.Control m_customGroupMappingControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1105), new Integer(8), new Integer(8), new Integer(576), new Integer(536), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 58), m_customGroupMappingForm, instance1 } );
				ims.framework.Control m_customGroupMappingControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1106),  new Integer(anchoringHelper106.getX()), new Integer(anchoringHelper106.getY()), new Integer(anchoringHelper106.getWidth()), new Integer(anchoringHelper106.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 58), m_customGroupMappingForm, instance1, Boolean.FALSE } );
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		contextMenus.contextMenuGenericGridCOPYItem = factory.createMenuItem(startControlID.intValue() + 13, "Copy", true, false, new Integer(102222), true, false);
		...
		contextMenus.contextMenuGenericGridREMOVE_UNVERIFIED_NHS_NUMBERItem = factory.createMenuItem(startControlID.intValue() + 14, "Remove Unverified NHS Number", true, false, new Integer(102300), true, false);
		...
		contextMenus.ClinicalAdmin.contextMenuTumourGroupPrognosticLocationADDItem = factory.createMenuItem(startControlID.intValue() + 15, "Add Location", true, false, new Integer(102179), true, false);
		...
		contextMenus.ClinicalAdmin.contextMenuTumourGroupPrognosticLocationREMOVEItem = factory.createMenuItem(startControlID.intValue() + 16, "Remove Location", true, false, new Integer(102300), true, false);
		...
		contextMenus.ClinicalAdmin.contextMenuTumourGroupPrognosticRiskADDItem = factory.createMenuItem(startControlID.intValue() + 17, "Add Risk Category", true, false, new Integer(102179), true, false);
		...
		contextMenus.ClinicalAdmin.contextMenuTumourGroupPrognosticRiskREMOVEItem = factory.createMenuItem(startControlID.intValue() + 18, "Remove Risk Category", true, false, new Integer(102300), true, false);
		...
		contextMenus.ClinicalAdmin.contextMenuTumourGroupPrognosticPSAADDItem = factory.createMenuItem(startControlID.intValue() + 19, "Add PSA", true, false, new Integer(102179), true, false);
		...
		contextMenus.ClinicalAdmin.contextMenuTumourGroupPrognosticPSAREMOVEItem = factory.createMenuItem(startControlID.intValue() + 20, "Remove PSA", true, false, new Integer(102300), true, false);
		...
		contextMenus.ClinicalAdmin.contextMenuTumourGroupPrognosticGleasonADDItem = factory.createMenuItem(startControlID.intValue() + 21, "Add Gleason", true, false, new Integer(102179), true, false);
		...
		contextMenus.ClinicalAdmin.contextMenuTumourGroupPrognosticGleasonREMOVEItem = factory.createMenuItem(startControlID.intValue() + 22, "Remove Gleason", true, false, new Integer(102300), true, false);
		...
		contextMenus.ClinicalAdmin.contextMenuTumourGroupHistologyGradeADDItem = factory.createMenuItem(startControlID.intValue() + 23, "Add Histology Grade", true, false, new Integer(102179), true, false);
		...
		contextMenus.ClinicalAdmin.contextMenuTumourGroupHistologyGradeINACTIVATEItem = factory.createMenuItem(startControlID.intValue() + 24, "Inactivate Histology Grade", true, false, new Integer(102300), true, false);
		...
		contextMenus.ClinicalAdmin.contextMenuTumourGroupHistologyGradeREACTIVATEItem = factory.createMenuItem(startControlID.intValue() + 25, "Reactivate Histology Grade", true, false, null, true, false);
		...
		contextMenus.ClinicalAdmin.contextMenuTumourGroupHistologyGradeLOAD_DEFAULTSItem = factory.createMenuItem(startControlID.intValue() + 26, "Load default Histology Grade records", true, false, null, true, false);
		...
		contextMenus.Oncology.contextMenuTumourGroupOtherClassificationUpdateClassificationItem = factory.createMenuItem(startControlID.intValue() + 27, "Update Classification", true, false, new Integer(102150), true, false);
		...
		contextMenus.Oncology.contextMenuTumourGroupOtherClassificationRemoveClassificationItem = factory.createMenuItem(startControlID.intValue() + 28, "Remove Classification", true, false, new Integer(102300), true, false);
		...
		contextMenus.Oncology.contextMenuTumourHistologyLayerADDItem = factory.createMenuItem(startControlID.intValue() + 29, "Add Histology", true, false, new Integer(102179), true, false);
		contextMenus.Oncology.contextMenuTumourHistologyLayer.add(contextMenus.Oncology.contextMenuTumourHistologyLayerADDItem);
		contextMenus.Oncology.contextMenuTumourHistologyLayerSELECTFROMTAXONOMYItem = factory.createMenuItem(startControlID.intValue() + 30, "Select Histology from taxonomy", true, false, new Integer(102223), true, false);
		...
		contextMenus.Oncology.contextMenuTumourHistologyLayerREMOVEItem = factory.createMenuItem(startControlID.intValue() + 31, "Remove Histology", true, false, new Integer(102300), true, false);
		...
		contextMenus.Oncology.contextMenuTumourHistologyLayerREACTIVATEItem = factory.createMenuItem(startControlID.intValue() + 32, "Reactivate Histology", true, false, new Integer(102150), true, false);
		...
		contextMenus.Oncology.contextMenuTumourSerumMarkersADDItem = factory.createMenuItem(startControlID.intValue() + 33, "AddSerumMarkers", true, false, new Integer(102149), true, false);
		contextMenus.Oncology.contextMenuTumourSerumMarkers.add(contextMenus.Oncology.contextMenuTumourSerumMarkersADDItem);
		contextMenus.Oncology.contextMenuTumourSerumMarkersSLECTFROMTAXONOMYItem = factory.createMenuItem(startControlID.intValue() + 34, "SelectSerumMarkersfromTaxonomy", true, false, new Integer(102223), true, false);
		...
		contextMenus.Oncology.contextMenuTumourSerumMarkersREMOVEItem = factory.createMenuItem(startControlID.intValue() + 35, "RemoveSerumMarkers", true, false, new Integer(102300), true, false);
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1121), new Integer(anchoringHelper120.getX()), new Integer(anchoringHelper120.getY()), new Integer(anchoringHelper120.getWidth()), new Integer(anchoringHelper120.getHeight()), new Integer(startTabIndex.intValue() + 61), ControlState.HIDDEN, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Cancel", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
	...
	public final class ContextMenus implements java.io.Serializable
	{
		...
		public final class GenericGrid implements java.io.Serializable
		{
			...
			public static final int REMOVE_UNVERIFIED_NHS_NUMBER = 14;
		}
		...
		public final class ClinicalAdminNamespace implements java.io.Serializable
		{
			...
			public final class TumourGroupHistologyGrade implements java.io.Serializable
			{
				...
				public static final int INACTIVATE = 24;
				public static final int REACTIVATE = 25;
				public static final int LOAD_DEFAULTS = 26;
			}
		...
		public final class OncologyNamespace implements java.io.Serializable
		{
			...
			{
				private static final long serialVersionUID = 1L;
				public static final int UpdateClassification = 27;
				public static final int RemoveClassification = 28;
			}
			...
			public final class TumourHistologyLayer implements java.io.Serializable
			{
				...
				public static final int SELECTFROMTAXONOMY = 30;
				public static final int REMOVE = 31;
				public static final int REACTIVATE = 32;
			}
			...
			public final class TumourSerumMarkers implements java.io.Serializable
			{
				...
				public static final int SLECTFROMTAXONOMY = 34;
	...
	private class ReportFields
	{
		...
		{
			String prefix = formInfo.getLocalVariablesPrefix();
			IReportField[] fields = new IReportField[221];
			...
			fields[147] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.TumourDifferentiaion", "BO-1075100006-ID", "ID_HistopathologicGrade");
			fields[148] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.TumourDifferentiaion", "BO-1075100006-TUMOURDIFFERENTATION", "TumourDifferentation");
			fields[149] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.TumourDifferentiaion", "BO-1075100006-ISDEFAULT", "IsDefault");
			fields[150] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.TumourDifferentiaion", "BO-1075100006-ISACTIVE", "IsActive");
			fields[151] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.TumourDifferentiaion", "BO-1075100006-GRADE", "Grade");
			fields[152] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.TumourSerumMarker", "BO-1075100005-ID", "ID_TumourSerumMarker");
			fields[153] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.TumourSerumMarker", "BO-1075100005-SERUMMARKERVALUE", "SerumMarkerValue");
			fields[154] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.TumourSerumMarker", "BO-1075100005-SERUMMARKERDESCRIPTION", "SerumMarkerDescription");
			fields[155] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.TumourSerumMarker", "BO-1075100005-ISACTIVE", "IsActive");
			fields[156] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.TumourSite", "BO-1074100010-ID", "ID_TumourSite");
			fields[157] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.TumourSite", "BO-1074100010-NAME", "Name");
			fields[158] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.TumourSite", "BO-1074100010-ISACTIVE", "IsActive");
			fields[159] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.TumourSite", "BO-1074100010-HASSITESPECIFICTNM", "HasSiteSpecificTNM");
			fields[160] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.TumourSite", "BO-1074100010-HASSITESPECIFICHISTOLOGY", "HasSiteSpecificHistology");
			fields[161] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.TumourSite", "BO-1074100010-DESCRIPTION", "Description");
			fields[162] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.TumourSite", "BO-1074100010-TNMVERSION", "TNMVersion");
			fields[163] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.TumourHistology", "BO-1074100012-ID", "ID_TumourHistology");
			fields[164] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.TumourHistology", "BO-1074100012-HISTOLOGYDESCRIPTION", "HistologyDescription");
			fields[165] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.TumourHistology", "BO-1074100012-ISACTIVE", "IsActive");
			fields[166] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.SelectedPrognosticGleason", "BO-1075100016-ID", "ID_GleasonConfig");
			fields[167] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.SelectedPrognosticGleason", "BO-1075100016-GLEASONNAME", "GleasonName");
			fields[168] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.SelectedPrognosticGleason", "BO-1075100016-GLEASONDESCRIPTION", "GleasonDescription");
			fields[169] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.SelectedPrognosticGleason", "BO-1075100016-ISACTIVE", "IsActive");
			fields[170] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.SelectedPrognosticLocation", "BO-1075100017-ID", "ID_PrognosticLocationConfig");
			fields[171] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.SelectedPrognosticLocation", "BO-1075100017-LOCATIONNAME", "LocationName");
			fields[172] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.SelectedPrognosticLocation", "BO-1075100017-LOCATIONDESCRIPTION", "LocationDescription");
			fields[173] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.SelectedPrognosticLocation", "BO-1075100017-ISACTIVE", "IsActive");
			fields[174] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.SelectedPrognosticPSA", "BO-1075100015-ID", "ID_PSAConfig");
			fields[175] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.SelectedPrognosticPSA", "BO-1075100015-PSANAME", "PSAName");
			fields[176] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.SelectedPrognosticPSA", "BO-1075100015-PSADESCRIPTION", "PSADescription");
			fields[177] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.SelectedPrognosticPSA", "BO-1075100015-ISACTIVE", "IsActive");
			fields[178] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.SelectedPrognosticRiskAssessment", "BO-1075100018-ID", "ID_PrognosticRiskConfiguration");
			fields[179] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.SelectedPrognosticRiskAssessment", "BO-1075100018-RISKNAME", "RiskName");
			fields[180] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.SelectedPrognosticRiskAssessment", "BO-1075100018-RISKDESCRIPTION", "RiskDescription");
			fields[181] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.SelectedPrognosticRiskAssessment", "BO-1075100018-ISACTIVE", "IsActive");
			fields[182] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.TumourGroup", "BO-1074100009-ID", "ID_TumourGroup");
			fields[183] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.TumourGroup", "BO-1074100009-GROUPNAME", "GroupName");
			fields[184] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.TumourGroup", "BO-1074100009-ISACTIVE", "IsActive");
			fields[185] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.TumourGroup", "BO-1074100009-HASTNM", "HasTNM");
			fields[186] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.TumourGroup", "BO-1074100009-ISPROGNOSTICGROUPINGRELEVANT", "IsPrognosticGroupingRelevant");
			fields[187] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.TumourGroup", "BO-1074100009-GROUPDESCRIPTION", "GroupDescription");
			fields[188] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.TumourGroup", "BO-1074100009-HASOTHERCLASSIFICATIONS", "HasOtherClassifications");
			fields[189] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.TumourGroup", "BO-1074100009-TNMREQUIRESDIFF", "TnmRequiresDiff");
			fields[190] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.TumourGroup", "BO-1074100009-TNMREQUIRESOVER45", "TnmRequiresOver45");
			fields[191] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.TumourGroup", "BO-1074100009-TNMREQUIRESHISTO", "TnmRequiresHisto");
			fields[192] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.TumourGroup", "BO-1074100009-TNMREQUIRESSMARKERS", "TnmRequiresSMarkers");
			fields[193] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.TumourGroup", "BO-1074100009-TNMVERSION", "TNMVersion");
			fields[194] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.TumourCategoryGroupSites.__internal_x_context__ParentCategory_" + componentIdentifier, "BO-1074100008-ID", "ID_TumourCategory");
			fields[195] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.TumourCategoryGroupSites.__internal_x_context__ParentCategory_" + componentIdentifier, "BO-1074100008-CATEGORYNAME", "CategoryName");
			fields[196] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.TumourCategoryGroupSites.__internal_x_context__ParentCategory_" + componentIdentifier, "BO-1074100008-CATEGORYDESCRIPTION", "CategoryDescription");
			fields[197] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.TumourCategoryGroupSites.__internal_x_context__ParentCategory_" + componentIdentifier, "BO-1074100008-ISACTIVE", "IsActive");
			fields[198] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.TumourCategoryGroupSites.__internal_x_context__ParentGroup_" + componentIdentifier, "BO-1074100009-ID", "ID_TumourGroup");
			fields[199] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.TumourCategoryGroupSites.__internal_x_context__ParentGroup_" + componentIdentifier, "BO-1074100009-GROUPNAME", "GroupName");
			fields[200] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.TumourCategoryGroupSites.__internal_x_context__ParentGroup_" + componentIdentifier, "BO-1074100009-ISACTIVE", "IsActive");
			fields[201] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.TumourCategoryGroupSites.__internal_x_context__ParentGroup_" + componentIdentifier, "BO-1074100009-HASTNM", "HasTNM");
			fields[202] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.TumourCategoryGroupSites.__internal_x_context__ParentGroup_" + componentIdentifier, "BO-1074100009-ISPROGNOSTICGROUPINGRELEVANT", "IsPrognosticGroupingRelevant");
			fields[203] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.TumourCategoryGroupSites.__internal_x_context__ParentGroup_" + componentIdentifier, "BO-1074100009-GROUPDESCRIPTION", "GroupDescription");
			fields[204] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.TumourCategoryGroupSites.__internal_x_context__ParentGroup_" + componentIdentifier, "BO-1074100009-HASOTHERCLASSIFICATIONS", "HasOtherClassifications");
			fields[205] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.TumourCategoryGroupSites.__internal_x_context__ParentGroup_" + componentIdentifier, "BO-1074100009-TNMREQUIRESDIFF", "TnmRequiresDiff");
			fields[206] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.TumourCategoryGroupSites.__internal_x_context__ParentGroup_" + componentIdentifier, "BO-1074100009-TNMREQUIRESOVER45", "TnmRequiresOver45");
			fields[207] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.TumourCategoryGroupSites.__internal_x_context__ParentGroup_" + componentIdentifier, "BO-1074100009-TNMREQUIRESHISTO", "TnmRequiresHisto");
			fields[208] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.TumourCategoryGroupSites.__internal_x_context__ParentGroup_" + componentIdentifier, "BO-1074100009-TNMREQUIRESSMARKERS", "TnmRequiresSMarkers");
			fields[209] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.TumourCategoryGroupSites.__internal_x_context__SelectedHistologyRecord_" + componentIdentifier, "BO-1075100011-ID", "ID_TumourGroupHistology");
			fields[210] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.TumourCategoryGroupSites.__internal_x_context__SelectedHistologyRecord_" + componentIdentifier, "BO-1075100011-ISACTIVE", "IsActive");
			fields[211] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.TumourCategoryGroupSites.__internal_x_context__SelectedTNMRecord_" + componentIdentifier, "BO-1074100011-ID", "ID_TumourGroupSiteTNMValue");
			fields[212] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.TumourCategoryGroupSites.__internal_x_context__SelectedTNMRecord_" + componentIdentifier, "BO-1074100011-TNMTYPE", "TNMType");
			fields[213] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.TumourCategoryGroupSites.__internal_x_context__SelectedTNMRecord_" + componentIdentifier, "BO-1074100011-TNMVALUE", "TNMValue");
			fields[214] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.TumourCategoryGroupSites.__internal_x_context__SelectedTNMRecord_" + componentIdentifier, "BO-1074100011-TNMDESCRIPTION", "TNMDescription");
			fields[215] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.TumourCategoryGroupSites.__internal_x_context__SelectedTNMRecord_" + componentIdentifier, "BO-1074100011-CLINICALPATHOLOGICAL", "ClinicalPathological");
			fields[216] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.TumourCategoryGroupSites.__internal_x_context__SelectedTNMRecord_" + componentIdentifier, "BO-1074100011-ISACTIVE", "IsActive");
			fields[217] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.TumourCategoryGroupSites.__internal_x_context__SelectedSerumRecord_" + componentIdentifier, "BO-1075100005-ID", "ID_TumourSerumMarker");
			fields[218] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.TumourCategoryGroupSites.__internal_x_context__SelectedSerumRecord_" + componentIdentifier, "BO-1075100005-SERUMMARKERVALUE", "SerumMarkerValue");
			fields[219] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.TumourCategoryGroupSites.__internal_x_context__SelectedSerumRecord_" + componentIdentifier, "BO-1075100005-SERUMMARKERDESCRIPTION", "SerumMarkerDescription");
			fields[220] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.TumourCategoryGroupSites.__internal_x_context__SelectedSerumRecord_" + componentIdentifier, "BO-1075100005-ISACTIVE", "IsActive");
			return fields;
		}
