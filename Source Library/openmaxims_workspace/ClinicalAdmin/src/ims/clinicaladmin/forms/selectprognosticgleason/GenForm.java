...
public class GenForm extends FormBridge
{
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.SelectedPrognosticGleason", "BO-1075100016-ID", "ID_GleasonConfig");
			fields[145] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.SelectedPrognosticGleason", "BO-1075100016-GLEASONNAME", "GleasonName");
			fields[146] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.SelectedPrognosticGleason", "BO-1075100016-GLEASONDESCRIPTION", "GleasonDescription");
			fields[147] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.SelectedPrognosticGleason", "BO-1075100016-ISACTIVE", "IsActive");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.SelectPrognosticGleason.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1075100016-ID", "ID_GleasonConfig");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.SelectPrognosticGleason.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1075100016-GLEASONNAME", "GleasonName");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.SelectPrognosticGleason.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1075100016-GLEASONDESCRIPTION", "GleasonDescription");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.SelectPrognosticGleason.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1075100016-ISACTIVE", "IsActive");
			return fields;
		}
