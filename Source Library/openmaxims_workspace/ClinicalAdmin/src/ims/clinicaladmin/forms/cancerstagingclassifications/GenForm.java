...
public class GenForm extends FormBridge
{
	...
	public static class lyrValuesLayer extends Layer
	{
		...
		public static class tabClassificationValuesContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				super.addControl(factory.getControl(CheckBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1000), new Integer(anchoringHelper1.getX()), new Integer(anchoringHelper1.getY()), new Integer(anchoringHelper1.getWidth()), new Integer(anchoringHelper1.getHeight()), new Integer(startTabIndex.intValue() + 4), ControlState.ENABLED, ControlState.DISABLED,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,"View Active Only", Boolean.TRUE, null}));
		...
		public static class tabValueMappingsContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1003), new Integer(anchoringHelper4.getX()), new Integer(anchoringHelper4.getY()), new Integer(anchoringHelper4.getWidth()), new Integer(anchoringHelper4.getHeight()), new Integer(startTabIndex.intValue() + 6), ControlState.DISABLED, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT,Boolean.FALSE, new Integer(0), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		contextMenus.contextMenuAddContactNewContactItem = factory.createMenuItem(startControlID.intValue() + 12, "New Clinical Contact", true, false, new Integer(102149), true, false);
		contextMenus.contextMenuAddContact.add(contextMenus.contextMenuAddContactNewContactItem);
		contextMenus.contextMenuAddContactViewContactItem = factory.createMenuItem(startControlID.intValue() + 13, "View Clinical Contact", true, false, new Integer(102182), true, false);
		...
		contextMenus.Oncology.contextMenuStagingClassificationAddFindingItem = factory.createMenuItem(startControlID.intValue() + 14, "Add Finding", true, false, new Integer(102179), true, false);
		...
		contextMenus.Oncology.contextMenuStagingClassificationSelectFindingItem = factory.createMenuItem(startControlID.intValue() + 15, "Select Finding from Taxonomy", true, false, new Integer(102120), true, false);
		...
		contextMenus.Oncology.contextMenuStagingClassificationRemoveFindingItem = factory.createMenuItem(startControlID.intValue() + 16, "Remove Finding", true, false, new Integer(102300), true, false);
		...
		contextMenus.Oncology.contextMenuStagingClassificationREACTIVATEItem = factory.createMenuItem(startControlID.intValue() + 17, "Re-activate Finding", true, false, new Integer(102169), true, false);
		...
		contextMenus.Oncology.contextMenuTumourFindingADDItem = factory.createMenuItem(startControlID.intValue() + 18, "Add Finding", true, false, new Integer(102179), true, false);
		contextMenus.Oncology.contextMenuTumourFinding.add(contextMenus.Oncology.contextMenuTumourFindingADDItem);
		contextMenus.Oncology.contextMenuTumourFindingRemoveItem = factory.createMenuItem(startControlID.intValue() + 19, "Remove Finding", true, false, new Integer(102300), true, false);
		contextMenus.Oncology.contextMenuTumourFinding.add(contextMenus.Oncology.contextMenuTumourFindingRemoveItem);
		contextMenus.Oncology.contextMenuTumourFindingSelectItem = factory.createMenuItem(startControlID.intValue() + 20, "Select Finding", true, false, new Integer(102120), true, false);
		contextMenus.Oncology.contextMenuTumourFinding.add(contextMenus.Oncology.contextMenuTumourFindingSelectItem);
		contextMenus.Oncology.contextMenuTumourFindingMoveUpItem = factory.createMenuItem(startControlID.intValue() + 21, "Move Up", true, false, new Integer(102197), true, false);
		contextMenus.Oncology.contextMenuTumourFinding.add(contextMenus.Oncology.contextMenuTumourFindingMoveUpItem);
		contextMenus.Oncology.contextMenuTumourFindingMoveDownItem = factory.createMenuItem(startControlID.intValue() + 22, "Move Down", true, false, new Integer(102198), true, false);
		contextMenus.Oncology.contextMenuTumourFinding.add(contextMenus.Oncology.contextMenuTumourFindingMoveDownItem);
		contextMenus.Oncology.contextMenuTumourFindingREACTIVATEItem = factory.createMenuItem(startControlID.intValue() + 23, "Re Activate finding", true, false, new Integer(102170), true, false);
	...
	public final class ContextMenus implements java.io.Serializable
	{
		...
		{
			private static final long serialVersionUID = 1L;
			public static final int NewContact = 12;
			public static final int ViewContact = 13;
		}
		...
		public final class OncologyNamespace implements java.io.Serializable
		{
			...
			{
				private static final long serialVersionUID = 1L;
				public static final int AddFinding = 14;
				public static final int SelectFinding = 15;
				public static final int RemoveFinding = 16;
				public static final int REACTIVATE = 17;
			}
			...
			public final class TumourFinding implements java.io.Serializable
			{
				...
				public static final int MoveUp = 21;
				public static final int MoveDown = 22;
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, "_cv_SelectedStagingClassificationVo", "BO-1075100000-ID", "ID_StagingClassification");
			fields[145] = new ims.framework.ReportField(this.context, "_cv_SelectedStagingClassificationVo", "BO-1075100000-NAME", "Name");
			fields[146] = new ims.framework.ReportField(this.context, "_cv_SelectedStagingClassificationVo", "BO-1075100000-ISACTIVE", "IsActive");
			fields[147] = new ims.framework.ReportField(this.context, "_cv_Core.TaxonomyMap", "BO-1003100010-ID", "ID_TaxonomyMap");
			fields[148] = new ims.framework.ReportField(this.context, "_cv_Core.TaxonomyMap", "BO-1003100010-TAXONOMYNAME", "TaxonomyName");
			fields[149] = new ims.framework.ReportField(this.context, "_cv_Core.TaxonomyMap", "BO-1003100010-TAXONOMYCODE", "TaxonomyCode");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.CancerStagingClassifications.__internal_x_context__SelectStagingClassification_" + componentIdentifier, "BO-1075100000-ID", "ID_StagingClassification");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.CancerStagingClassifications.__internal_x_context__SelectStagingClassification_" + componentIdentifier, "BO-1075100000-NAME", "Name");
			fields[152] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.CancerStagingClassifications.__internal_x_context__SelectStagingClassification_" + componentIdentifier, "BO-1075100000-ISACTIVE", "IsActive");
			return fields;
		}
