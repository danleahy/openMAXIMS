...
public class GenForm extends FormBridge
{
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.TNMStagingClassificationVersionConfig.__internal_x_context__ClassificationVersion_" + componentIdentifier, "BO-1075100012-ID", "ID_TNMStagingClassificationVersion");
			fields[145] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.TNMStagingClassificationVersionConfig.__internal_x_context__ClassificationVersion_" + componentIdentifier, "BO-1075100012-VERSIONNUMBER", "VersionNumber");
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.TNMStagingClassificationVersionConfig.__internal_x_context__ClassificationVersion_" + componentIdentifier, "BO-1075100012-VERSIONDESCRIPTION", "VersionDescription");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.TNMStagingClassificationVersionConfig.__internal_x_context__ClassificationVersion_" + componentIdentifier, "BO-1075100012-ACTIVEFROM", "ActiveFrom");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.TNMStagingClassificationVersionConfig.__internal_x_context__ClassificationVersion_" + componentIdentifier, "BO-1075100012-ACTIVETO", "ActiveTo");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.TNMStagingClassificationVersionConfig.__internal_x_context__ClassificationVersion_" + componentIdentifier, "BO-1075100012-STATUS", "Status");
			return fields;
		}
