...
public class GenForm extends FormBridge
{
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.MotorChartDetails", "BO-1003100105-ID", "ID_MotorChartAreaDetail");
			fields[145] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.MotorChartDetails", "BO-1003100105-MOTORAREADESCRIPTION", "MotorAreaDescription");
			fields[146] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.MotorChartDetails", "BO-1003100105-ISUPPERLIMB", "IsUpperLimb");
			fields[147] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.MotorChartDetails", "BO-1003100105-ISLOWERLIMB", "IsLowerLimb");
			fields[148] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.MotorChartDetails", "BO-1003100105-ISACTIVE", "IsActive");
			fields[149] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.MotorChartDetails", "BO-1003100105-ORDERNO", "OrderNo");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.MotorChartConfiguration.__internal_x_context__TempSelection_" + componentIdentifier, "BO-1003100105-ID", "ID_MotorChartAreaDetail");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.MotorChartConfiguration.__internal_x_context__TempSelection_" + componentIdentifier, "BO-1003100105-MOTORAREADESCRIPTION", "MotorAreaDescription");
			fields[152] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.MotorChartConfiguration.__internal_x_context__TempSelection_" + componentIdentifier, "BO-1003100105-ISUPPERLIMB", "IsUpperLimb");
			fields[153] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.MotorChartConfiguration.__internal_x_context__TempSelection_" + componentIdentifier, "BO-1003100105-ISLOWERLIMB", "IsLowerLimb");
			fields[154] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.MotorChartConfiguration.__internal_x_context__TempSelection_" + componentIdentifier, "BO-1003100105-ISACTIVE", "IsActive");
			fields[155] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.MotorChartConfiguration.__internal_x_context__TempSelection_" + componentIdentifier, "BO-1003100105-ORDERNO", "OrderNo");
			return fields;
		}
