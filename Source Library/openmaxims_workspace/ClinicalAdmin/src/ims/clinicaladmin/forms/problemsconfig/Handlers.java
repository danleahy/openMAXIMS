...
abstract public class Handlers implements ims.framework.UILogic, IFormUILogicCode, ims.framework.interfaces.IClearInfo
{
	...
	abstract protected void onGrdExternalGridButtonClicked(int column, GenForm.grdExtCodesRow row) throws ims.framework.exceptions.PresentationLogicException;
	...
	public final void setContext(ims.framework.UIEngine engine, GenForm form)
	{
		...
		this.form.grdExtCodes().setGridButtonClickedEvent(new GridButtonClicked()
		{
			...
			{
				onGrdExternalGridButtonClicked(column, new GenForm.grdExtCodesRow(row));
			}
		});
