...
public class GenForm extends FormBridge
{
	...
	public static class ctnDetailsContainer extends ContainerBridge
	{
		...
		protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
		{
			...
			Grid m_grdSizeTemp = (Grid)factory.getControl(Grid.class, new Object[] { control, new Integer(startControlID.intValue() + 1011), new Integer(anchoringHelper12.getX()), new Integer(anchoringHelper12.getY()), new Integer(anchoringHelper12.getWidth()), new Integer(anchoringHelper12.getHeight()), new Integer(startTabIndex.intValue() + 11), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.TRUE, Boolean.FALSE, new Integer(24), Boolean.TRUE, contextMenus.contextMenuGenericGrid, Boolean.FALSE, Boolean.FALSE, new Integer(0), null, Boolean.FALSE, Boolean.TRUE});
			...
			Grid m_grdTypeTemp = (Grid)factory.getControl(Grid.class, new Object[] { control, new Integer(startControlID.intValue() + 1012), new Integer(anchoringHelper13.getX()), new Integer(anchoringHelper13.getY()), new Integer(anchoringHelper13.getWidth()), new Integer(anchoringHelper13.getHeight()), new Integer(startTabIndex.intValue() + 12), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT,Boolean.TRUE, Boolean.FALSE, new Integer(24), Boolean.TRUE, contextMenus.contextMenuInvasiveDeviceConfigType, Boolean.FALSE, Boolean.FALSE, new Integer(0), null, Boolean.FALSE, Boolean.TRUE});
			...
			grdType.addIntColumn("Duration", 0, 0, 100, false, true, null, false, 0, true, 4);
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		contextMenus.contextMenuInvasiveDeviceConfigTypeAddItem = factory.createMenuItem(startControlID.intValue() + 12, "Add Type", true, false, new Integer(102179), true, false);
		contextMenus.contextMenuInvasiveDeviceConfigType.add(contextMenus.contextMenuInvasiveDeviceConfigTypeAddItem);
		contextMenus.contextMenuInvasiveDeviceConfigTypeRemoveItem = factory.createMenuItem(startControlID.intValue() + 13, "Remove Type", true, false, new Integer(102148), true, false);
		contextMenus.contextMenuInvasiveDeviceConfigType.add(contextMenus.contextMenuInvasiveDeviceConfigTypeRemoveItem);
		contextMenus.contextMenuInvasiveDeviceConfigTypeUpdateItem = factory.createMenuItem(startControlID.intValue() + 14, "Edit Type", true, false, new Integer(102150), true, false);
		contextMenus.contextMenuInvasiveDeviceConfigType.add(contextMenus.contextMenuInvasiveDeviceConfigTypeUpdateItem);
		contextMenus.contextMenuInvasiveDeviceConfigTypeInactivateItem = factory.createMenuItem(startControlID.intValue() + 15, "Inactivate Type", true, false, new Integer(102151), true, false);
		...
		contextMenus.contextMenuLIPNewItem = factory.createMenuItem(startControlID.intValue() + 16, "New", true, false, new Integer(102179), true, false);
		contextMenus.contextMenuLIP.add(contextMenus.contextMenuLIPNewItem);
		contextMenus.contextMenuLIPUpdateItem = factory.createMenuItem(startControlID.intValue() + 17, "Edit", true, false, new Integer(102150), true, false);
		...
		grdList.addIntColumn("Duration", 0, 0, 150, true, true, null, false, 0, true, 0);
	...
	public final class ContextMenus implements java.io.Serializable
	{
		...
		public final class InvasiveDeviceConfigType implements java.io.Serializable
		{
			...
			public static final int Inactivate = 15;
		}
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.InvasiveDeviceConfig.__internal_x_context__EditedRecord_" + componentIdentifier, "BO-1073100015-ID", "ID_InvasiveDeviceConfig");
			fields[145] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.InvasiveDeviceConfig.__internal_x_context__EditedRecord_" + componentIdentifier, "BO-1073100015-INVASIVEDEVICE", "InvasiveDevice");
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.InvasiveDeviceConfig.__internal_x_context__EditedRecord_" + componentIdentifier, "BO-1073100015-DURATIONINT", "DurationInt");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.InvasiveDeviceConfig.__internal_x_context__EditedRecord_" + componentIdentifier, "BO-1073100015-DURATIONUNIT", "DurationUnit");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.InvasiveDeviceConfig.__internal_x_context__EditedRecord_" + componentIdentifier, "BO-1073100015-ISACTIVE", "IsActive");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.InvasiveDeviceConfig.__internal_x_context__EditedRecord_" + componentIdentifier, "BO-1073100015-REQUIRESVIP", "RequiresVIP");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.InvasiveDeviceConfig.__internal_x_context__EditedRecord_" + componentIdentifier, "BO-1073100015-HASSITE", "HasSite");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.InvasiveDeviceConfig.__internal_x_context__EditedRecord_" + componentIdentifier, "BO-1073100015-HASTYPES", "HasTypes");
			return fields;
		}
