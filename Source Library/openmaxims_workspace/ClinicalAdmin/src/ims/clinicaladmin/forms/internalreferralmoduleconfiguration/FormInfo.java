...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "InternalReferralModuleConfiguration";
	}
	public int getWidth()
	{
		return 848;
	...
	{
		return new String[] { "_cv_Core.QuestionType", "_cv_Admin.SelectedQuestions" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_ClinicalAdmin.InternalReferralModuleConfiguration.__internal_x_context__" + String.valueOf(getFormId());
	}
