...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "DivisionalDiagnosesSelectionDialog";
	}
	public int getWidth()
	{
		return 720;
	...
	{
		return new String[] { "_cv_ClinicalAdmin.DivisionalDiagnoses" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_ClinicalAdmin.DivisionalDiagnosesSelectionDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
