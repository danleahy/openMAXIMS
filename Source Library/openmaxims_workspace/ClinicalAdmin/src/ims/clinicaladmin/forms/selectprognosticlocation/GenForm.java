...
public class GenForm extends FormBridge
{
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.SelectedPrognosticLocation", "BO-1075100017-ID", "ID_PrognosticLocationConfig");
			fields[145] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.SelectedPrognosticLocation", "BO-1075100017-LOCATIONNAME", "LocationName");
			fields[146] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.SelectedPrognosticLocation", "BO-1075100017-LOCATIONDESCRIPTION", "LocationDescription");
			fields[147] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.SelectedPrognosticLocation", "BO-1075100017-ISACTIVE", "IsActive");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.SelectPrognosticLocation.__internal_x_context__SelctedRecord_" + componentIdentifier, "BO-1075100017-ID", "ID_PrognosticLocationConfig");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.SelectPrognosticLocation.__internal_x_context__SelctedRecord_" + componentIdentifier, "BO-1075100017-LOCATIONNAME", "LocationName");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.SelectPrognosticLocation.__internal_x_context__SelctedRecord_" + componentIdentifier, "BO-1075100017-LOCATIONDESCRIPTION", "LocationDescription");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.SelectPrognosticLocation.__internal_x_context__SelctedRecord_" + componentIdentifier, "BO-1075100017-ISACTIVE", "IsActive");
			return fields;
		}
