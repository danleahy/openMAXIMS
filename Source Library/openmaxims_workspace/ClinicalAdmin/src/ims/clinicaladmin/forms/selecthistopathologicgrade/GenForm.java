...
public class GenForm extends FormBridge
{
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.TumourDifferentiaion", "BO-1075100006-ID", "ID_HistopathologicGrade");
			fields[145] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.TumourDifferentiaion", "BO-1075100006-TUMOURDIFFERENTATION", "TumourDifferentation");
			fields[146] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.TumourDifferentiaion", "BO-1075100006-ISDEFAULT", "IsDefault");
			fields[147] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.TumourDifferentiaion", "BO-1075100006-ISACTIVE", "IsActive");
			fields[148] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.TumourDifferentiaion", "BO-1075100006-GRADE", "Grade");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.SelectHistopathologicGrade.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1075100006-ID", "ID_HistopathologicGrade");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.SelectHistopathologicGrade.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1075100006-TUMOURDIFFERENTATION", "TumourDifferentation");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.SelectHistopathologicGrade.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1075100006-ISDEFAULT", "IsDefault");
			fields[152] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.SelectHistopathologicGrade.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1075100006-ISACTIVE", "IsActive");
			fields[153] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.SelectHistopathologicGrade.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1075100006-GRADE", "Grade");
			return fields;
		}
