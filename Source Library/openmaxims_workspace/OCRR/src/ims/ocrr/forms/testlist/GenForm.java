...
public class GenForm extends FormBridge
{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		super.addControl(factory.getControl(ImageButton.class, new Object[] { control, new Integer(startControlID.intValue() + 1011), new Integer(anchoringHelper12.getX()), new Integer(anchoringHelper12.getY()), new Integer(anchoringHelper12.getWidth()), new Integer(anchoringHelper12.getHeight()), new Integer(startTabIndex.intValue() + 7), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT, this.getImages().Core.FindEnabled24, this.getImages().Core.FindDisabled24, "Search", Boolean.FALSE, Boolean.TRUE, Boolean.TRUE, Boolean.FALSE, null}));
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, "_cv_OCRR.SelectedTest", "BO-1061100003-ID", "ID_InvestigationIndex");
			fields[145] = new ims.framework.ReportField(this.context, "_cv_OCRR.SelectedTest", "BO-1061100003-NAME", "Name");
			fields[146] = new ims.framework.ReportField(this.context, "_cv_OCRR.SelectedTest", "BO-1061100003-CATEGORY", "Category");
			fields[147] = new ims.framework.ReportField(this.context, "_cv_OCRR.SelectedTest", "BO-1061100003-ORDERABILITY", "Orderability");
			fields[148] = new ims.framework.ReportField(this.context, "_cv_OCRR.SelectedTest", "BO-1061100003-TIMESERIESINSTRUCTIONSURL", "TimeSeriesInstructionsURL");
			fields[149] = new ims.framework.ReportField(this.context, "_cv_OCRR.SelectedTest", "BO-1061100003-DESCRIPTION", "Description");
			fields[150] = new ims.framework.ReportField(this.context, "_cv_OCRR.SelectedTest", "BO-1061100003-COLOUR", "Colour");
			fields[151] = new ims.framework.ReportField(this.context, "_cv_OCRR.SelectedTest", "BO-1061100003-ISPROFILE", "IsProfile");
			fields[152] = new ims.framework.ReportField(this.context, "_cv_OCRR.SelectedTest", "BO-1061100003-ACTIVESTATUS", "ActiveStatus");
			fields[153] = new ims.framework.ReportField(this.context, "_cv_OCRR.SelectedTest", "BO-1061100003-GENDERSPECIFIC", "GenderSpecific");
			fields[154] = new ims.framework.ReportField(this.context, "_cv_OCRR.SelectedTest", "BO-1061100003-PHLEBMAYCOLLECT", "PhlebMayCollect");
			fields[155] = new ims.framework.ReportField(this.context, "_cv_OCRR.SelectedTest", "BO-1061100003-REQUIRESSITESPECIFIER", "RequiresSiteSpecifier");
			fields[156] = new ims.framework.ReportField(this.context, "_cv_OCRR.SelectedTest", "BO-1061100003-SHOWLAST", "ShowLast");
			fields[157] = new ims.framework.ReportField(this.context, "_cv_OCRR.SelectedTest", "BO-1061100003-NOINTERFACE", "NoInterface");
			return fields;
		}
