...
public class GenForm extends FormBridge
{
	...
	public static class lyrTemplatesLayer extends Layer
	{
		...
		public static class tabPreviewContainer extends LayerBridge
		{
			...
			public static class lyrPreviewLayer extends Layer
			{
				...
				public static class tabQuestionsContainer extends LayerBridge
				{
					...
					protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
					{
						...
						super.addControl(factory.getControl(DynamicGrid.class, new Object[] { control, new Integer(startControlID.intValue() + 1009), new Integer(anchoringHelper11.getX()), new Integer(anchoringHelper11.getY()), new Integer(anchoringHelper11.getWidth()), new Integer(anchoringHelper11.getHeight()), new Integer(startTabIndex.intValue() + 11), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, null, Boolean.FALSE, Boolean.FALSE, Boolean.TRUE}));
					}
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1012), new Integer(anchoringHelper14.getX()), new Integer(anchoringHelper14.getY()), new Integer(anchoringHelper14.getWidth()), new Integer(anchoringHelper14.getHeight()), new Integer(startTabIndex.intValue() + 12), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Place Order", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
			}
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		contextMenus.contextMenuOCRRSelectAndOrderFAVOURITESItem = factory.createMenuItem(startControlID.intValue() + 3, "Add to My Favourites", true, false, new Integer(102257), true, false);
		if(factory.getUIEngine().getLoggedInRole().hasMenuActionRight(appForm, new ims.framework.MenuAction(610001)))
			contextMenus.contextMenuOCRRSelectAndOrder.add(contextMenus.contextMenuOCRRSelectAndOrderFAVOURITESItem);
	...
	public final class ContextMenus implements java.io.Serializable
	{
		...
		public void disableAllOCRRSelectAndOrderMenuItems()
		{
			...
			this.contextMenuOCRRSelectAndOrderFAVOURITESItem.setEnabled(false);
		}
		public void hideAllOCRRSelectAndOrderMenuItems()
		{
			...
			this.contextMenuOCRRSelectAndOrderFAVOURITESItem.setVisible(false);
		}
		...
		public ReadOnlyMenuItem getOCRRSelectAndOrderFAVOURITESItem()
		{
			return this.contextMenuOCRRSelectAndOrderFAVOURITESItem;
		}
		private MenuItem contextMenuOCRRSelectAndOrderFAVOURITESItem;
	}
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[145] = new ims.framework.ReportField(this.context, "_cv_Core.CareContextSelectDialog.ChosenCareContext", "BO-1004100019-ID", "ID_CareContext");
			fields[146] = new ims.framework.ReportField(this.context, "_cv_Core.CareContextSelectDialog.ChosenCareContext", "BO-1004100019-CONTEXT", "Context");
			fields[147] = new ims.framework.ReportField(this.context, "_cv_Core.CareContextSelectDialog.ChosenCareContext", "BO-1004100019-ORDERINGHOSPITAL", "OrderingHospital");
			fields[148] = new ims.framework.ReportField(this.context, "_cv_OCRR.OrderInvestigationToAmend", "BO-1070100002-ID", "ID_OrderInvestigation");
			fields[149] = new ims.framework.ReportField(this.context, "_cv_OCRR.OrderInvestigationToAmend", "BO-1070100002-REPDATETIME", "RepDateTime");
			fields[150] = new ims.framework.ReportField(this.context, "_cv_OCRR.OrderInvestigationToAmend", "BO-1070100002-DISPLAYDATETIME", "DisplayDateTime");
			fields[151] = new ims.framework.ReportField(this.context, "_cv_OCRR.OrderInvestigationToAmend", "BO-1070100002-RESULTSTATUS", "ResultStatus");
			fields[152] = new ims.framework.ReportField(this.context, "_cv_OCRR.OrderInvestigationToAmend", "BO-1070100002-DISPLAYFLAG", "DisplayFlag");
			fields[153] = new ims.framework.ReportField(this.context, "_cv_OCRR.OrderInvestigationToAmend", "BO-1070100002-APPOINTMENTDATE", "AppointmentDate");
			fields[154] = new ims.framework.ReportField(this.context, "_cv_Core.OutpatientAttendanceForOrder", "BO-1014100001-ID", "ID_OutpatientAttendance");
			fields[155] = new ims.framework.ReportField(this.context, "_cv_Core.OutpatientAttendanceForOrder", "BO-1014100001-APPOINTMENTDATETIME", "AppointmentDateTime");
			fields[156] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedLocationForOrdering", "BO-1007100007-ID", "ID_Location");
			fields[157] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedLocationForOrdering", "BO-1007100007-NAME", "Name");
			fields[158] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedLocationForOrdering", "BO-1007100007-ISACTIVE", "IsActive");
			fields[159] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedLocationForOrdering", "BO-1007100007-ISVIRTUAL", "IsVirtual");
			fields[160] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedLocationForOrdering", "BO-1007100007-TYPE", "Type");
			fields[161] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedLocationForOrdering", "BO-1007100007-DISPLAYINEDTRACKING", "DisplayInEDTracking");
			fields[162] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedLocationForOrdering", "BO-1007100007-CASENOTEFOLDERLOCATION", "CaseNoteFolderLocation");
			fields[163] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedLocationForOrdering", "BO-1007100007-SECUREACCOMMODATION", "SecureAccommodation");
			fields[164] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedLocationForOrdering", "BO-1007100007-TREATINGHOSP", "TreatingHosp");
			fields[165] = new ims.framework.ReportField(this.context, "_cv_Core.SelectedLocationForOrdering", "BO-1007100007-REFERRINGHOSPITAL", "ReferringHospital");
			fields[166] = new ims.framework.ReportField(this.context, "_cv_Rotherham.AppointmentToLink", "BO-1055100007-ID", "ID_Booking_Appointment");
			return fields;
		}
