...
public class GenForm extends FormBridge
{
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, "_cv_OCRR.AdultSpecimenContainer", "BO-1061100022-ID", "ID_Container");
			fields[145] = new ims.framework.ReportField(this.context, "_cv_OCRR.AdultSpecimenContainer", "BO-1061100022-TYPE", "Type");
			fields[146] = new ims.framework.ReportField(this.context, "_cv_OCRR.AdultSpecimenContainer", "BO-1061100022-VOLUME", "Volume");
			fields[147] = new ims.framework.ReportField(this.context, "_cv_OCRR.AdultSpecimenContainer", "BO-1061100022-VOLUMEUNITS", "VolumeUnits");
			fields[148] = new ims.framework.ReportField(this.context, "_cv_OCRR.AdultSpecimenContainer", "BO-1061100022-LABELSUFFIX", "LabelSuffix");
			fields[149] = new ims.framework.ReportField(this.context, "_cv_OCRR.PaediatricsContainer", "BO-1061100022-ID", "ID_Container");
			fields[150] = new ims.framework.ReportField(this.context, "_cv_OCRR.PaediatricsContainer", "BO-1061100022-TYPE", "Type");
			fields[151] = new ims.framework.ReportField(this.context, "_cv_OCRR.PaediatricsContainer", "BO-1061100022-VOLUME", "Volume");
			fields[152] = new ims.framework.ReportField(this.context, "_cv_OCRR.PaediatricsContainer", "BO-1061100022-VOLUMEUNITS", "VolumeUnits");
			fields[153] = new ims.framework.ReportField(this.context, "_cv_OCRR.PaediatricsContainer", "BO-1061100022-LABELSUFFIX", "LabelSuffix");
			fields[154] = new ims.framework.ReportField(this.context, "_cv_OCRR.AlternativePaediatricsContainer", "BO-1061100022-ID", "ID_Container");
			fields[155] = new ims.framework.ReportField(this.context, "_cv_OCRR.AlternativePaediatricsContainer", "BO-1061100022-TYPE", "Type");
			fields[156] = new ims.framework.ReportField(this.context, "_cv_OCRR.AlternativePaediatricsContainer", "BO-1061100022-VOLUME", "Volume");
			fields[157] = new ims.framework.ReportField(this.context, "_cv_OCRR.AlternativePaediatricsContainer", "BO-1061100022-VOLUMEUNITS", "VolumeUnits");
			fields[158] = new ims.framework.ReportField(this.context, "_cv_OCRR.AlternativePaediatricsContainer", "BO-1061100022-LABELSUFFIX", "LabelSuffix");
			fields[159] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.SpecimenConfiguration.__internal_x_context__Specimen_" + componentIdentifier, "BO-1061100026-ID", "ID_Specimen");
			fields[160] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.SpecimenConfiguration.__internal_x_context__Specimen_" + componentIdentifier, "BO-1061100026-TYPE", "Type");
			return fields;
		}
