...
import ims.ocrr.vo.OrdersRequiringAuthorisationSearchCriteriaVo;
...
public class Logic extends BaseLogic
{
	...
	private static final int WARD_LOCATION		= 1;
	private static final int CLINIC_LOCATION	= 2;
	private static final int ED_LOCATION		= 3;
	...
	protected void onFormOpen() throws ims.framework.exceptions.PresentationLogicException
	{
		...
		//WDEV-19389 
		if (form.getGlobalContext().OCRR.getOrdersRequiringAuthorisationSearchCriteriaIsNotNull())
		{
			setSearchCriteria(form.getGlobalContext().OCRR.getOrdersRequiringAuthorisationSearchCriteria());
			if (search(true))
				form.getGlobalContext().OCRR.setOrdersRequiringAuthorisationSearchCriteria(getSearchCriteria());
		}	
	}
	...
	private void setSearchCriteria(OrdersRequiringAuthorisationSearchCriteriaVo ordersRequiringAuthorisationSearchCriteriaVo) 
	{
		clearScreen();
		if (ordersRequiringAuthorisationSearchCriteriaVo.getRespClinicianIsNotNull() && ordersRequiringAuthorisationSearchCriteriaVo.getRespClinician().getMosIsNotNull() && ordersRequiringAuthorisationSearchCriteriaVo.getRespClinician().getMos().getNameIsNotNull())
		{
			form.qmbRespClinician().newRow(ordersRequiringAuthorisationSearchCriteriaVo.getRespClinician(), ordersRequiringAuthorisationSearchCriteriaVo.getRespClinician().getMos().getName().toString());
			form.qmbRespClinician().setValue(ordersRequiringAuthorisationSearchCriteriaVo.getRespClinician());
		}
		
		if (ordersRequiringAuthorisationSearchCriteriaVo.getHospitalIsNotNull())
		{
			LocationLiteVo serchHosp = domain.getHospital(ordersRequiringAuthorisationSearchCriteriaVo.getHospital());
			form.cmbHospital().setValue(serchHosp);
		}
		hospitalValueChanged();
		
		setLocationType(ordersRequiringAuthorisationSearchCriteriaVo.getLoctype());
		
		if (ordersRequiringAuthorisationSearchCriteriaVo.getPatientLocationIsNotNull() && !ordersRequiringAuthorisationSearchCriteriaVo.getPatientClinicIsNotNull())
		{
			form.qmbPatLocation().newRow(ordersRequiringAuthorisationSearchCriteriaVo.getPatientLocation(), ordersRequiringAuthorisationSearchCriteriaVo.getPatientLocation() != null ? ordersRequiringAuthorisationSearchCriteriaVo.getPatientLocation().getName() : null);
			form.qmbPatLocation().setValue(ordersRequiringAuthorisationSearchCriteriaVo.getPatientLocation());
		}
			
		if (!ordersRequiringAuthorisationSearchCriteriaVo.getPatientLocationIsNotNull() && ordersRequiringAuthorisationSearchCriteriaVo.getPatientClinicIsNotNull())
		{
			form.qmbPatLocation().newRow(ordersRequiringAuthorisationSearchCriteriaVo.getPatientClinic(), ordersRequiringAuthorisationSearchCriteriaVo.getPatientClinic() != null ? ordersRequiringAuthorisationSearchCriteriaVo.getPatientClinic().getClinicName() : null);
			form.qmbPatLocation().setValue(ordersRequiringAuthorisationSearchCriteriaVo.getPatientClinic());
		}
		
		form.dteFrom().setValue(ordersRequiringAuthorisationSearchCriteriaVo.getFromDate());
		form.dteTo().setValue(ordersRequiringAuthorisationSearchCriteriaVo.getToDate());	
	}
	
	private void setLocationType(Integer loctype) 
	{
		switch (loctype)
		{
		case WARD_LOCATION:
		...
		case CLINIC_LOCATION:
			form.grpPatientLocation().setValue(grpPatientLocationEnumeration.rdoClinic);
			break;
		case ED_LOCATION:
			form.grpPatientLocation().setValue(grpPatientLocationEnumeration.rdoED);
			break;
		case OTHER_LOCATION:
			form.grpPatientLocation().setValue(grpPatientLocationEnumeration.rdoOther);
			break;
		}		
	}

	private Integer getLocationType() 
	{
		grpPatientLocationEnumeration searchType = form.grpPatientLocation().getValue();
		if (grpPatientLocationEnumeration.rdoWard.equals(searchType))
		{
			return WARD_LOCATION;
		}
		if (grpPatientLocationEnumeration.rdoClinic.equals(searchType))
		{
			return CLINIC_LOCATION;
		}
		if (grpPatientLocationEnumeration.rdoED.equals(searchType))
		{
			return ED_LOCATION;
		}
		if (grpPatientLocationEnumeration.rdoOther.equals(searchType))
		{
	...
	private boolean search(boolean bShowMessage)
	{
	...
	{
		form.getGlobalContext().OCRR.setOrdersRequiringAuthorisationSearchCriteria(null);//WDEV-19389 
		form.dteFrom().setValue(null);
		form.dteTo().setValue(null);
		form.cmbHospital().setValue(null);
		form.qmbPatLocation().setValue(null);
		form.qmbRespClinician().setValue(null);
		form.qmbRespClinician().clear(); //WDEV-19389 
		form.grdOrders().getRows().clear();
	}
