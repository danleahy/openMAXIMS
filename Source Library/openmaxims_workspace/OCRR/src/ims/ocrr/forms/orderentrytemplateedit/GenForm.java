...
public class GenForm extends FormBridge
{
	...
	public static class lyrDetailsLayer extends Layer
	{
		...
		public static class tabComponentsContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1005), new Integer(anchoringHelper6.getX()), new Integer(anchoringHelper6.getY()), new Integer(anchoringHelper6.getWidth()), new Integer(anchoringHelper6.getHeight()), new Integer(startTabIndex.intValue() + 9), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT,Boolean.FALSE, new Integer(30), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
				...
				ComboBox m_cmbColorSeparatorTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1006), new Integer(anchoringHelper7.getX()), new Integer(anchoringHelper7.getY()), new Integer(anchoringHelper7.getWidth()), new Integer(anchoringHelper7.getHeight()), new Integer(startTabIndex.intValue() + 10), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT ,Boolean.TRUE, Boolean.TRUE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
				...
				super.addControl(factory.getControl(CheckBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1007), new Integer(anchoringHelper8.getX()), new Integer(anchoringHelper8.getY()), new Integer(anchoringHelper8.getWidth()), new Integer(anchoringHelper8.getHeight()), new Integer(startTabIndex.intValue() + 11), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT ,"Bold", Boolean.TRUE, null}));
				...
				Grid m_grdComponentsTemp = (Grid)factory.getControl(Grid.class, new Object[] { control, new Integer(startControlID.intValue() + 1009), new Integer(anchoringHelper10.getX()), new Integer(anchoringHelper10.getY()), new Integer(anchoringHelper10.getWidth()), new Integer(anchoringHelper10.getHeight()), new Integer(startTabIndex.intValue() + 7), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL,Boolean.TRUE, Boolean.TRUE, new Integer(24), Boolean.TRUE, contextMenus.contextMenuOCRROrderEntryTemplateEdit, Boolean.FALSE, Boolean.FALSE, new Integer(0), null, Boolean.FALSE, Boolean.TRUE});
		...
		public static class tabRolesContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				Grid m_grdRolesTemp = (Grid)factory.getControl(Grid.class, new Object[] { control, new Integer(startControlID.intValue() + 1012), new Integer(anchoringHelper13.getX()), new Integer(anchoringHelper13.getY()), new Integer(anchoringHelper13.getWidth()), new Integer(anchoringHelper13.getHeight()), new Integer(startTabIndex.intValue() + 14), ControlState.READONLY, ControlState.EDITABLE, ims.framework.enumerations.ControlAnchoring.ALL,Boolean.FALSE, Boolean.FALSE, new Integer(24), Boolean.TRUE, null, Boolean.FALSE, Boolean.FALSE, new Integer(0), null, Boolean.FALSE, Boolean.TRUE});
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, "_cv_OCRR.PreviewedOrderEntryTemplate", "BO-1061100005-ID", "ID_OrderEntryTemplate");
			fields[145] = new ims.framework.ReportField(this.context, "_cv_OCRR.PreviewedOrderEntryTemplate", "BO-1061100005-FORMNAME", "FormName");
			fields[146] = new ims.framework.ReportField(this.context, "_cv_OCRR.PreviewedOrderEntryTemplate", "BO-1061100005-MENUNAME", "MenuName");
			fields[147] = new ims.framework.ReportField(this.context, "_cv_OCRR.PreviewedOrderEntryTemplate", "BO-1061100005-DESCRIPTION", "Description");
			fields[148] = new ims.framework.ReportField(this.context, "_cv_OCRR.PreviewedOrderEntryTemplate", "BO-1061100005-TEMPLATECATEGORY", "TemplateCategory");
			fields[149] = new ims.framework.ReportField(this.context, "_cv_OCRR.PreviewedOrderEntryTemplate", "BO-1061100005-ACTIVESTATUS", "ActiveStatus");
			fields[150] = new ims.framework.ReportField(this.context, "_cv_OCRR.PreviewedOrderEntryTemplate", "BO-1061100005-FORMTEXT", "FormText");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.OrderEntryTemplateEdit.__internal_x_context__EditedRecord_" + componentIdentifier, "BO-1061100005-ID", "ID_OrderEntryTemplate");
			fields[152] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.OrderEntryTemplateEdit.__internal_x_context__EditedRecord_" + componentIdentifier, "BO-1061100005-FORMNAME", "FormName");
			fields[153] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.OrderEntryTemplateEdit.__internal_x_context__EditedRecord_" + componentIdentifier, "BO-1061100005-MENUNAME", "MenuName");
			fields[154] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.OrderEntryTemplateEdit.__internal_x_context__EditedRecord_" + componentIdentifier, "BO-1061100005-DESCRIPTION", "Description");
			fields[155] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.OrderEntryTemplateEdit.__internal_x_context__EditedRecord_" + componentIdentifier, "BO-1061100005-TEMPLATECATEGORY", "TemplateCategory");
			fields[156] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.OrderEntryTemplateEdit.__internal_x_context__EditedRecord_" + componentIdentifier, "BO-1061100005-ACTIVESTATUS", "ActiveStatus");
			fields[157] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.OrderEntryTemplateEdit.__internal_x_context__EditedRecord_" + componentIdentifier, "BO-1061100005-FORMTEXT", "FormText");
			return fields;
		}
