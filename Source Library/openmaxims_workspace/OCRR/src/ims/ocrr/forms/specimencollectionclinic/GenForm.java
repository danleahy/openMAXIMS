...
public class GenForm extends FormBridge
{
	...
	public static class lyrPatDetailsLayer extends Layer
	{
		...
		public static class tabPagePatientListContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				Grid m_grdPatientTemp = (Grid)factory.getControl(Grid.class, new Object[] { control, new Integer(startControlID.intValue() + 1019), new Integer(anchoringHelper20.getX()), new Integer(anchoringHelper20.getY()), new Integer(anchoringHelper20.getWidth()), new Integer(anchoringHelper20.getHeight()), new Integer(startTabIndex.intValue() + 9), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT,Boolean.TRUE, Boolean.FALSE, new Integer(24), Boolean.TRUE, null, Boolean.FALSE, Boolean.FALSE, new Integer(0), null, Boolean.FALSE, Boolean.TRUE});
	...
	public static class GroupStatusRadioButton extends RadioButtonBridge
	{
		...
		protected void setContext(Integer startTabIndex, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize)
		{
			...
			control.addButton(0, anchoringHelper23.getX(), anchoringHelper23.getY(), anchoringHelper23.getWidth(), "Could Not Collect", startTabIndex.intValue() + 13);
			...
			control.addButton(1, anchoringHelper24.getX(), anchoringHelper24.getY(), anchoringHelper24.getWidth(), "Collected", startTabIndex.intValue() + 12);
			...
			control.addButton(2, anchoringHelper25.getX(), anchoringHelper25.getY(), anchoringHelper25.getWidth(), "All", startTabIndex.intValue() + 10);
			...
			control.addButton(3, anchoringHelper26.getX(), anchoringHelper26.getY(), anchoringHelper26.getWidth(), "For Collection", startTabIndex.intValue() + 11);
		}
	...
	private void validateContext(ims.framework.Context context)
	{
		...
		if(!context.isValidContextType(ims.ocrr.vo.SpecimenCollectionClinicSearchCriteriaVo.class))
			throw new ims.framework.exceptions.CodingRuntimeException("The type 'ims.ocrr.vo.SpecimenCollectionClinicSearchCriteriaVo' of the global context variable 'OCRR.SpecimenCollectionClinicSearchCriteria' is not supported.");
	}
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1028), new Integer(anchoringHelper33.getX()), new Integer(anchoringHelper33.getY()), new Integer(anchoringHelper33.getWidth()), new Integer(anchoringHelper33.getHeight()), new Integer(startTabIndex.intValue() + 15), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Print Labels", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(DynamicGrid.class, new Object[] { control, new Integer(startControlID.intValue() + 1035), new Integer(anchoringHelper40.getX()), new Integer(anchoringHelper40.getY()), new Integer(anchoringHelper40.getWidth()), new Integer(anchoringHelper40.getHeight()), new Integer(startTabIndex.intValue() + 14), ControlState.EDITABLE, ControlState.EDITABLE, ims.framework.enumerations.ControlAnchoring.ALL, null, Boolean.FALSE, Boolean.TRUE, Boolean.TRUE}));
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[164] = new ims.framework.ReportField(this.context, "_cv_Core.SecondPatientShort", "BO-1001100000-ID", "ID_Patient");
			fields[165] = new ims.framework.ReportField(this.context, "_cv_Core.SecondPatientShort", "BO-1001100000-SEX", "Sex");
			fields[166] = new ims.framework.ReportField(this.context, "_cv_Core.SecondPatientShort", "BO-1001100000-DOB", "Dob");
			fields[167] = new ims.framework.ReportField(this.context, "_cv_Core.SecondPatientShort", "BO-1001100000-DOD", "Dod");
			fields[168] = new ims.framework.ReportField(this.context, "_cv_Core.SecondPatientShort", "BO-1001100000-RELIGION", "Religion");
			fields[169] = new ims.framework.ReportField(this.context, "_cv_Core.SecondPatientShort", "BO-1001100000-ISACTIVE", "IsActive");
			fields[170] = new ims.framework.ReportField(this.context, "_cv_Core.SecondPatientShort", "BO-1001100000-ETHNICORIGIN", "EthnicOrigin");
			fields[171] = new ims.framework.ReportField(this.context, "_cv_Core.SecondPatientShort", "BO-1001100000-MARITALSTATUS", "MaritalStatus");
			fields[172] = new ims.framework.ReportField(this.context, "_cv_Core.SecondPatientShort", "BO-1001100000-SCN", "SCN");
			fields[173] = new ims.framework.ReportField(this.context, "_cv_Core.SecondPatientShort", "BO-1001100000-SOURCEOFINFORMATION", "SourceOfInformation");
			fields[174] = new ims.framework.ReportField(this.context, "_cv_Core.SecondPatientShort", "BO-1001100000-TIMEOFDEATH", "TimeOfDeath");
			fields[175] = new ims.framework.ReportField(this.context, "_cv_Core.SecondPatientShort", "BO-1001100000-ISQUICKREGISTRATIONPATIENT", "IsQuickRegistrationPatient");
			fields[176] = new ims.framework.ReportField(this.context, "_cv_Core.SecondPatientShort", "BO-1001100000-CURRENTRESPONSIBLECONSULTANT", "CurrentResponsibleConsultant");
			fields[177] = new ims.framework.ReportField(this.context, "_cv_Core.SecondPatientShort", "BO-1001100000-DEMENTIABREACHDATETIME", "DementiaBreachDateTime");
			fields[178] = new ims.framework.ReportField(this.context, "_cv_Core.SecondPatientShort", "BO-1001100000-DEMENTIAWORKLISTSTATUS", "DementiaWorklistStatus");
			fields[179] = new ims.framework.ReportField(this.context, "_cv_Core.SecondPatientShort", "BO-1001100000-MRNSTATUS", "MRNStatus");
			fields[180] = new ims.framework.ReportField(this.context, "_cv_Core.SecondPatientShort", "BO-1001100000-HASSCANNEDCASENOTEFOLDERS", "HasScannedCaseNoteFolders");
			fields[181] = new ims.framework.ReportField(this.context, "_cv_Core.SecondPatientShort", "BO-1001100000-ISCONFIDENTIAL", "IsConfidential");
			fields[182] = new ims.framework.ReportField(this.context, "_cv_Core.SecondPatientShort", "BO-1001100000-TIMEOFBIRTH", "TimeOfBirth");
			fields[183] = new ims.framework.ReportField(this.context, "_cv_Core.SecondPatientShort", "BO-1001100000-PATIENTCATEGORY", "PatientCategory");
			fields[184] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.SpecimenCollectionClinic.__internal_x_context__ContextDummyForReports_" + componentIdentifier, "BO-1061100014-ID", "ID_SpecimenWorkListItem");
			fields[185] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.SpecimenCollectionClinic.__internal_x_context__ContextDummyForReports_" + componentIdentifier, "BO-1061100014-SPECIMEN", "Specimen");
			fields[186] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.SpecimenCollectionClinic.__internal_x_context__ContextDummyForReports_" + componentIdentifier, "BO-1061100014-LISTTYPE", "ListType");
			fields[187] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.SpecimenCollectionClinic.__internal_x_context__ContextDummyForReports_" + componentIdentifier, "BO-1061100014-DATETOCOLLECT", "DateToCollect");
			fields[188] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.SpecimenCollectionClinic.__internal_x_context__ContextDummyForReports_" + componentIdentifier, "BO-1061100014-ROUNDTOCOLLECT", "RoundToCollect");
			fields[189] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.SpecimenCollectionClinic.__internal_x_context__ContextDummyForReports_" + componentIdentifier, "BO-1061100014-TIMETOCOLLECT", "TimeToCollect");
			fields[190] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.SpecimenCollectionClinic.__internal_x_context__ContextDummyForReports_" + componentIdentifier, "BO-1061100014-COLLECTIONSTATUS", "CollectionStatus");
			fields[191] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.SpecimenCollectionClinic.__internal_x_context__ContextDummyForReports_" + componentIdentifier, "BO-1061100014-DFTORDERINVESTIGATION", "DFTOrderInvestigation");
			return fields;
		}
