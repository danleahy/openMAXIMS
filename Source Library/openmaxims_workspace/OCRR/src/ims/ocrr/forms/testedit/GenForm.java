...
public class GenForm extends FormBridge
{
	...
	public static class lyrInvestigationsLayer extends Layer
	{
		...
		public static class tabProviderContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				Grid m_grdHeadersTemp = (Grid)factory.getControl(Grid.class, new Object[] { control, new Integer(startControlID.intValue() + 1000), new Integer(anchoringHelper1.getX()), new Integer(anchoringHelper1.getY()), new Integer(anchoringHelper1.getWidth()), new Integer(anchoringHelper1.getHeight()), new Integer(startTabIndex.intValue() + 23), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL,Boolean.TRUE, Boolean.FALSE, new Integer(24), Boolean.TRUE, contextMenus.contextMenuOCRRProvider, Boolean.FALSE, Boolean.FALSE, new Integer(0), null, Boolean.FALSE, Boolean.TRUE});
		...
		public static class tabGeneralDetContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				ComboBox m_cmbTurnAroundMeasureTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1015), new Integer(anchoringHelper16.getX()), new Integer(anchoringHelper16.getY()), new Integer(anchoringHelper16.getWidth()), new Integer(anchoringHelper16.getHeight()), new Integer(startTabIndex.intValue() + 28), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
				...
				ComboBox m_cmbMinReOrderFemaleTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1016), new Integer(anchoringHelper17.getX()), new Integer(anchoringHelper17.getY()), new Integer(anchoringHelper17.getWidth()), new Integer(anchoringHelper17.getHeight()), new Integer(startTabIndex.intValue() + 35), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
				...
				ComboBox m_cmbMinReOrderPeriodTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1017), new Integer(anchoringHelper18.getX()), new Integer(anchoringHelper18.getY()), new Integer(anchoringHelper18.getWidth()), new Integer(anchoringHelper18.getHeight()), new Integer(startTabIndex.intValue() + 33), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
				...
				ComboBox m_cmbTestColorTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1018), new Integer(anchoringHelper19.getX()), new Integer(anchoringHelper19.getY()), new Integer(anchoringHelper19.getWidth()), new Integer(anchoringHelper19.getHeight()), new Integer(startTabIndex.intValue() + 31), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT ,Boolean.TRUE, Boolean.TRUE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
				...
				ComboBox m_cmbTestStatusTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1019), new Integer(anchoringHelper20.getX()), new Integer(anchoringHelper20.getY()), new Integer(anchoringHelper20.getWidth()), new Integer(anchoringHelper20.getHeight()), new Integer(startTabIndex.intValue() + 30), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.TRUE, new Integer(-1)});
				...
				ComboBox m_cmbProviderServiceTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1020), new Integer(anchoringHelper21.getX()), new Integer(anchoringHelper21.getY()), new Integer(anchoringHelper21.getWidth()), new Integer(anchoringHelper21.getHeight()), new Integer(startTabIndex.intValue() + 25), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,Boolean.TRUE, Boolean.TRUE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.TRUE, new Integer(-1)});
				...
				super.addControl(factory.getControl(CheckBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1023), new Integer(anchoringHelper24.getX()), new Integer(anchoringHelper24.getY()), new Integer(anchoringHelper24.getWidth()), new Integer(anchoringHelper24.getHeight()), new Integer(startTabIndex.intValue() + 37), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,"", Boolean.TRUE, null}));
				...
				super.addControl(factory.getControl(IntBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1024), new Integer(anchoringHelper25.getX()), new Integer(anchoringHelper25.getY()), new Integer(anchoringHelper25.getWidth()), new Integer(anchoringHelper25.getHeight()), new Integer(startTabIndex.intValue() + 29), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.TRUE, Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, new Integer(9)}));
				...
				super.addControl(factory.getControl(IntBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1026), new Integer(anchoringHelper27.getX()), new Integer(anchoringHelper27.getY()), new Integer(anchoringHelper27.getWidth()), new Integer(anchoringHelper27.getHeight()), new Integer(startTabIndex.intValue() + 32), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.TRUE, Boolean.TRUE, Boolean.TRUE, null, null, Boolean.FALSE, new Integer(9)}));
			}
			...
			public static class lyrSpecimensLayer extends Layer
			{
				...
				public static class tabSpecimen1Container extends LayerBridge
				{
					...
					protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
					{
						...
						ims.framework.FormUiLogic m_ccSpecimen1Form = loader.loadComponent(116170, appForm, startControlID * 10 + 1000, anchoringHelper28.getSize(), instance1, startTabIndex.intValue() + 39, skipContextValidation);
						//ims.framework.Control m_ccSpecimen1Control = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1027), new Integer(0), new Integer(0), new Integer(800), new Integer(196), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 39), m_ccSpecimen1Form, instance1 } );
						ims.framework.Control m_ccSpecimen1Control = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1028),  new Integer(anchoringHelper28.getX()), new Integer(anchoringHelper28.getY()), new Integer(anchoringHelper28.getWidth()), new Integer(anchoringHelper28.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 39), m_ccSpecimen1Form, instance1, Boolean.FALSE } );
				...
				public static class tabSpecimen2Container extends LayerBridge
				{
					...
					protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
					{
						...
						ims.framework.FormUiLogic m_ccSpecimen2Form = loader.loadComponent(116170, appForm, startControlID * 10 + 2000, anchoringHelper29.getSize(), instance1, startTabIndex.intValue() + 44, skipContextValidation);
						//ims.framework.Control m_ccSpecimen2Control = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1029), new Integer(0), new Integer(0), new Integer(800), new Integer(196), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 44), m_ccSpecimen2Form, instance1 } );
						ims.framework.Control m_ccSpecimen2Control = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1030),  new Integer(anchoringHelper29.getX()), new Integer(anchoringHelper29.getY()), new Integer(anchoringHelper29.getWidth()), new Integer(anchoringHelper29.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 44), m_ccSpecimen2Form, instance1, Boolean.FALSE } );
				...
				public static class tabSpecimen3Container extends LayerBridge
				{
					...
					protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
					{
						...
						ims.framework.FormUiLogic m_ccSpecimen3Form = loader.loadComponent(116170, appForm, startControlID * 10 + 3000, anchoringHelper30.getSize(), instance1, startTabIndex.intValue() + 49, skipContextValidation);
						//ims.framework.Control m_ccSpecimen3Control = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1031), new Integer(0), new Integer(0), new Integer(800), new Integer(196), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 49), m_ccSpecimen3Form, instance1 } );
						ims.framework.Control m_ccSpecimen3Control = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1032),  new Integer(anchoringHelper30.getX()), new Integer(anchoringHelper30.getY()), new Integer(anchoringHelper30.getWidth()), new Integer(anchoringHelper30.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 49), m_ccSpecimen3Form, instance1, Boolean.FALSE } );
				...
				public static class tabSpecimen4Container extends LayerBridge
				{
					...
					protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
					{
						...
						ims.framework.FormUiLogic m_ccSpecimen4Form = loader.loadComponent(116170, appForm, startControlID * 10 + 4000, anchoringHelper31.getSize(), instance1, startTabIndex.intValue() + 54, skipContextValidation);
						//ims.framework.Control m_ccSpecimen4Control = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1033), new Integer(0), new Integer(0), new Integer(800), new Integer(196), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 54), m_ccSpecimen4Form, instance1 } );
						ims.framework.Control m_ccSpecimen4Control = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1034),  new Integer(anchoringHelper31.getX()), new Integer(anchoringHelper31.getY()), new Integer(anchoringHelper31.getWidth()), new Integer(anchoringHelper31.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 54), m_ccSpecimen4Form, instance1, Boolean.FALSE } );
				...
				public static class tabSpecimen5Container extends LayerBridge
				{
					...
					protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
					{
						...
						ims.framework.FormUiLogic m_ccSpecimen5Form = loader.loadComponent(116170, appForm, startControlID * 10 + 5000, anchoringHelper32.getSize(), instance1, startTabIndex.intValue() + 59, skipContextValidation);
						//ims.framework.Control m_ccSpecimen5Control = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1035), new Integer(0), new Integer(0), new Integer(800), new Integer(196), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 59), m_ccSpecimen5Form, instance1 } );
						ims.framework.Control m_ccSpecimen5Control = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1036),  new Integer(anchoringHelper32.getX()), new Integer(anchoringHelper32.getY()), new Integer(anchoringHelper32.getWidth()), new Integer(anchoringHelper32.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 59), m_ccSpecimen5Form, instance1, Boolean.FALSE } );
				...
				public static class tabSpecimen6Container extends LayerBridge
				{
					...
					protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
					{
						...
						ims.framework.FormUiLogic m_ccSpecimen6Form = loader.loadComponent(116170, appForm, startControlID * 10 + 6000, anchoringHelper33.getSize(), instance1, startTabIndex.intValue() + 64, skipContextValidation);
						//ims.framework.Control m_ccSpecimen6Control = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1037), new Integer(0), new Integer(0), new Integer(800), new Integer(196), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 64), m_ccSpecimen6Form, instance1 } );
						ims.framework.Control m_ccSpecimen6Control = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1038),  new Integer(anchoringHelper33.getX()), new Integer(anchoringHelper33.getY()), new Integer(anchoringHelper33.getWidth()), new Integer(anchoringHelper33.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 64), m_ccSpecimen6Form, instance1, Boolean.FALSE } );
				...
				public static class tabSpecimen7Container extends LayerBridge
				{
					...
					protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
					{
						...
						ims.framework.FormUiLogic m_ccSpecimen7Form = loader.loadComponent(116170, appForm, startControlID * 10 + 7000, anchoringHelper34.getSize(), instance1, startTabIndex.intValue() + 69, skipContextValidation);
						//ims.framework.Control m_ccSpecimen7Control = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1039), new Integer(0), new Integer(0), new Integer(800), new Integer(196), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 69), m_ccSpecimen7Form, instance1 } );
						ims.framework.Control m_ccSpecimen7Control = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1040),  new Integer(anchoringHelper34.getX()), new Integer(anchoringHelper34.getY()), new Integer(anchoringHelper34.getWidth()), new Integer(anchoringHelper34.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 69), m_ccSpecimen7Form, instance1, Boolean.FALSE } );
				...
				public static class tabSpecimen8Container extends LayerBridge
				{
					...
					protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
					{
						...
						ims.framework.FormUiLogic m_ccSpecimen8Form = loader.loadComponent(116170, appForm, startControlID * 10 + 8000, anchoringHelper35.getSize(), instance1, startTabIndex.intValue() + 74, skipContextValidation);
						//ims.framework.Control m_ccSpecimen8Control = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1041), new Integer(0), new Integer(0), new Integer(800), new Integer(196), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 74), m_ccSpecimen8Form, instance1 } );
						ims.framework.Control m_ccSpecimen8Control = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1042),  new Integer(anchoringHelper35.getX()), new Integer(anchoringHelper35.getY()), new Integer(anchoringHelper35.getWidth()), new Integer(anchoringHelper35.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 74), m_ccSpecimen8Form, instance1, Boolean.FALSE } );
				...
				public static class tabSpecimen9Container extends LayerBridge
				{
					...
					protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
					{
						...
						ims.framework.FormUiLogic m_ccSpecimen9Form = loader.loadComponent(116170, appForm, startControlID * 10 + 9000, anchoringHelper36.getSize(), instance1, startTabIndex.intValue() + 79, skipContextValidation);
						//ims.framework.Control m_ccSpecimen9Control = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1043), new Integer(0), new Integer(0), new Integer(800), new Integer(196), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 79), m_ccSpecimen9Form, instance1 } );
						ims.framework.Control m_ccSpecimen9Control = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1044),  new Integer(anchoringHelper36.getX()), new Integer(anchoringHelper36.getY()), new Integer(anchoringHelper36.getWidth()), new Integer(anchoringHelper36.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 79), m_ccSpecimen9Form, instance1, Boolean.FALSE } );
		...
		public static class tabClinicalImagingDetailsContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				ComboBox m_cmbDurationTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1057), new Integer(anchoringHelper49.getX()), new Integer(anchoringHelper49.getY()), new Integer(anchoringHelper49.getWidth()), new Integer(anchoringHelper49.getHeight()), new Integer(startTabIndex.intValue() + 85), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
				...
				super.addControl(factory.getControl(IntBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1058), new Integer(anchoringHelper50.getX()), new Integer(anchoringHelper50.getY()), new Integer(anchoringHelper50.getWidth()), new Integer(anchoringHelper50.getHeight()), new Integer(startTabIndex.intValue() + 84), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.TRUE, Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, new Integer(9)}));
			}
		...
		public static class tabLinkedInvestigationsContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				Grid m_grdTestsTemp = (Grid)factory.getControl(Grid.class, new Object[] { control, new Integer(startControlID.intValue() + 1059), new Integer(anchoringHelper51.getX()), new Integer(anchoringHelper51.getY()), new Integer(anchoringHelper51.getWidth()), new Integer(anchoringHelper51.getHeight()), new Integer(startTabIndex.intValue() + 86), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL,Boolean.TRUE, Boolean.FALSE, new Integer(24), Boolean.TRUE, contextMenus.contextMenuOCRRAssociatedTests, Boolean.FALSE, Boolean.FALSE, new Integer(0), null, Boolean.FALSE, Boolean.TRUE});
		...
		public static class tabQuestionsContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				Grid m_grdQuestionsTemp = (Grid)factory.getControl(Grid.class, new Object[] { control, new Integer(startControlID.intValue() + 1060), new Integer(anchoringHelper52.getX()), new Integer(anchoringHelper52.getY()), new Integer(anchoringHelper52.getWidth()), new Integer(anchoringHelper52.getHeight()), new Integer(startTabIndex.intValue() + 87), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL,Boolean.TRUE, Boolean.FALSE, new Integer(24), Boolean.TRUE, contextMenus.contextMenuOCRRAssociatedQuestions, Boolean.FALSE, Boolean.FALSE, new Integer(0), null, Boolean.FALSE, Boolean.TRUE});
		...
		public static class tabHelpTextsContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				Grid m_grdTestHelpTemp = (Grid)factory.getControl(Grid.class, new Object[] { control, new Integer(startControlID.intValue() + 1061), new Integer(anchoringHelper53.getX()), new Integer(anchoringHelper53.getY()), new Integer(anchoringHelper53.getWidth()), new Integer(anchoringHelper53.getHeight()), new Integer(startTabIndex.intValue() + 88), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL,Boolean.TRUE, Boolean.FALSE, new Integer(24), Boolean.TRUE, contextMenus.contextMenuOCRRHelpText, Boolean.FALSE, Boolean.FALSE, new Integer(0), null, Boolean.FALSE, Boolean.TRUE});
	...
	public static class lyrSelectionLayer extends Layer
	{
		...
		public static class tabTaxContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				Grid m_grdTaxonomyTemp = (Grid)factory.getControl(Grid.class, new Object[] { control, new Integer(startControlID.intValue() + 1069), new Integer(anchoringHelper61.getX()), new Integer(anchoringHelper61.getY()), new Integer(anchoringHelper61.getWidth()), new Integer(anchoringHelper61.getHeight()), new Integer(startTabIndex.intValue() + 20), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL,Boolean.TRUE, Boolean.FALSE, new Integer(24), Boolean.TRUE, contextMenus.contextMenuOCRRTaxonomy, Boolean.FALSE, Boolean.FALSE, new Integer(0), null, Boolean.FALSE, Boolean.TRUE});
				...
				grdTaxonomy.addStringColumn("Code", 0, 0, -1, false, false, 0, 25, true, ims.framework.enumerations.CharacterCasing.NORMAL);
		...
		public static class tabSynContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				Grid m_grdSynonymsTemp = (Grid)factory.getControl(Grid.class, new Object[] { control, new Integer(startControlID.intValue() + 1070), new Integer(anchoringHelper62.getX()), new Integer(anchoringHelper62.getY()), new Integer(anchoringHelper62.getWidth()), new Integer(anchoringHelper62.getHeight()), new Integer(startTabIndex.intValue() + 21), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL,Boolean.TRUE, Boolean.FALSE, new Integer(24), Boolean.TRUE, contextMenus.contextMenuOCRRSynonyms, Boolean.FALSE, Boolean.FALSE, new Integer(0), null, Boolean.FALSE, Boolean.TRUE});
		...
		public static class tabSitesContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				Grid m_grdSitesTemp = (Grid)factory.getControl(Grid.class, new Object[] { control, new Integer(startControlID.intValue() + 1071), new Integer(anchoringHelper63.getX()), new Integer(anchoringHelper63.getY()), new Integer(anchoringHelper63.getWidth()), new Integer(anchoringHelper63.getHeight()), new Integer(startTabIndex.intValue() + 22), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL,Boolean.TRUE, Boolean.FALSE, new Integer(24), Boolean.TRUE, contextMenus.contextMenuOCRRSpecimenSite, Boolean.FALSE, Boolean.FALSE, new Integer(0), null, Boolean.FALSE, Boolean.TRUE});
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1094), new Integer(anchoringHelper90.getX()), new Integer(anchoringHelper90.getY()), new Integer(anchoringHelper90.getWidth()), new Integer(anchoringHelper90.getHeight()), new Integer(startTabIndex.intValue() + 89), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Edit", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1095), new Integer(anchoringHelper91.getX()), new Integer(anchoringHelper91.getY()), new Integer(anchoringHelper91.getWidth()), new Integer(anchoringHelper91.getHeight()), new Integer(startTabIndex.intValue() + 90), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Save", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1096), new Integer(anchoringHelper92.getX()), new Integer(anchoringHelper92.getY()), new Integer(anchoringHelper92.getWidth()), new Integer(anchoringHelper92.getHeight()), new Integer(startTabIndex.intValue() + 91), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Cancel", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(CheckBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1105), new Integer(anchoringHelper101.getX()), new Integer(anchoringHelper101.getY()), new Integer(anchoringHelper101.getWidth()), new Integer(anchoringHelper101.getHeight()), new Integer(startTabIndex.intValue() + 17), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,"", Boolean.TRUE, null}));
		...
		super.addControl(factory.getControl(CheckBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1109), new Integer(anchoringHelper105.getX()), new Integer(anchoringHelper105.getY()), new Integer(anchoringHelper105.getWidth()), new Integer(anchoringHelper105.getHeight()), new Integer(startTabIndex.intValue() + 18), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,"", Boolean.FALSE, null}));
	...
	private class ReportFields
	{
		...
		{
			String prefix = formInfo.getLocalVariablesPrefix();
			IReportField[] fields = new IReportField[252];
			...
			fields[144] = new ims.framework.ReportField(this.context, "_cv_OCRR.CurrentInvestigation", "BO-1058100001-ID", "ID_Investigation");
			fields[145] = new ims.framework.ReportField(this.context, "_cv_OCRR.CurrentInvestigation", "BO-1058100001-ACTIVESTATUS", "ActiveStatus");
			fields[146] = new ims.framework.ReportField(this.context, "_cv_OCRR.CurrentInvestigation", "BO-1058100001-COLOUR", "Colour");
			fields[147] = new ims.framework.ReportField(this.context, "_cv_OCRR.CurrentInvestigation", "BO-1058100001-PROVIDERINVCODE", "ProviderInvCode");
			fields[148] = new ims.framework.ReportField(this.context, "_cv_OCRR.CurrentInvestigation", "BO-1058100001-SEPARATEORDER", "SeparateOrder");
			fields[149] = new ims.framework.ReportField(this.context, "_cv_OCRR.CurrentInvestigation", "BO-1058100001-ISADDON", "IsAddon");
			fields[150] = new ims.framework.ReportField(this.context, "_cv_OCRR.CurrentInvestigation", "BO-1058100001-MINREORDERPERIODVAL", "MinReorderPeriodVal");
			fields[151] = new ims.framework.ReportField(this.context, "_cv_OCRR.CurrentInvestigation", "BO-1058100001-MINREORDERPERIODUNIT", "MinReorderPeriodUnit");
			fields[152] = new ims.framework.ReportField(this.context, "_cv_OCRR.CurrentInvestigation", "BO-1058100001-FEMALEMINREORDERPERIODVAL", "FemaleMinReorderPeriodVal");
			fields[153] = new ims.framework.ReportField(this.context, "_cv_OCRR.CurrentInvestigation", "BO-1058100001-FEMALEMINREORDERPERIODUNIT", "FemaleMinReorderPeriodUnit");
			fields[154] = new ims.framework.ReportField(this.context, "_cv_OCRR.CurrentInvestigation", "BO-1058100001-TYPE", "Type");
			fields[155] = new ims.framework.ReportField(this.context, "_cv_OCRR.CurrentInvestigation", "BO-1058100001-EVENTTYPE", "EventType");
			fields[156] = new ims.framework.ReportField(this.context, "_cv_OCRR.CurrentInvestigation", "BO-1058100001-NOLABELSETS", "NoLabelSets");
			fields[157] = new ims.framework.ReportField(this.context, "_cv_OCRR.CurrentInvestigation", "BO-1058100001-TURNAROUNDMEASURE", "TurnaroundMeasure");
			fields[158] = new ims.framework.ReportField(this.context, "_cv_OCRR.CurrentInvestigation", "BO-1058100001-EXPECTEDTURNAROUND", "ExpectedTurnaround");
			fields[159] = new ims.framework.ReportField(this.context, "_cv_OCRR.SelectedTest", "BO-1061100003-ID", "ID_InvestigationIndex");
			fields[160] = new ims.framework.ReportField(this.context, "_cv_OCRR.SelectedTest", "BO-1061100003-NAME", "Name");
			fields[161] = new ims.framework.ReportField(this.context, "_cv_OCRR.SelectedTest", "BO-1061100003-CATEGORY", "Category");
			fields[162] = new ims.framework.ReportField(this.context, "_cv_OCRR.SelectedTest", "BO-1061100003-ORDERABILITY", "Orderability");
			fields[163] = new ims.framework.ReportField(this.context, "_cv_OCRR.SelectedTest", "BO-1061100003-TIMESERIESINSTRUCTIONSURL", "TimeSeriesInstructionsURL");
			fields[164] = new ims.framework.ReportField(this.context, "_cv_OCRR.SelectedTest", "BO-1061100003-DESCRIPTION", "Description");
			fields[165] = new ims.framework.ReportField(this.context, "_cv_OCRR.SelectedTest", "BO-1061100003-COLOUR", "Colour");
			fields[166] = new ims.framework.ReportField(this.context, "_cv_OCRR.SelectedTest", "BO-1061100003-ISPROFILE", "IsProfile");
			fields[167] = new ims.framework.ReportField(this.context, "_cv_OCRR.SelectedTest", "BO-1061100003-ACTIVESTATUS", "ActiveStatus");
			fields[168] = new ims.framework.ReportField(this.context, "_cv_OCRR.SelectedTest", "BO-1061100003-GENDERSPECIFIC", "GenderSpecific");
			fields[169] = new ims.framework.ReportField(this.context, "_cv_OCRR.SelectedTest", "BO-1061100003-PHLEBMAYCOLLECT", "PhlebMayCollect");
			fields[170] = new ims.framework.ReportField(this.context, "_cv_OCRR.SelectedTest", "BO-1061100003-REQUIRESSITESPECIFIER", "RequiresSiteSpecifier");
			fields[171] = new ims.framework.ReportField(this.context, "_cv_OCRR.SelectedTest", "BO-1061100003-SHOWLAST", "ShowLast");
			fields[172] = new ims.framework.ReportField(this.context, "_cv_OCRR.SelectedTest", "BO-1061100003-NOINTERFACE", "NoInterface");
			fields[173] = new ims.framework.ReportField(this.context, "_cv_OCRR.Provider", "BO-1007100007-ID", "ID_Location");
			fields[174] = new ims.framework.ReportField(this.context, "_cv_OCRR.Provider", "BO-1007100007-NAME", "Name");
			fields[175] = new ims.framework.ReportField(this.context, "_cv_OCRR.Provider", "BO-1007100007-ISACTIVE", "IsActive");
			fields[176] = new ims.framework.ReportField(this.context, "_cv_OCRR.Provider", "BO-1007100007-ISVIRTUAL", "IsVirtual");
			fields[177] = new ims.framework.ReportField(this.context, "_cv_OCRR.Provider", "BO-1007100007-TYPE", "Type");
			fields[178] = new ims.framework.ReportField(this.context, "_cv_OCRR.Provider", "BO-1007100007-DISPLAYINEDTRACKING", "DisplayInEDTracking");
			fields[179] = new ims.framework.ReportField(this.context, "_cv_OCRR.Provider", "BO-1007100007-CASENOTEFOLDERLOCATION", "CaseNoteFolderLocation");
			fields[180] = new ims.framework.ReportField(this.context, "_cv_Core.TaxonomyMap", "BO-1003100010-ID", "ID_TaxonomyMap");
			fields[181] = new ims.framework.ReportField(this.context, "_cv_Core.TaxonomyMap", "BO-1003100010-TAXONOMYNAME", "TaxonomyName");
			fields[182] = new ims.framework.ReportField(this.context, "_cv_Core.TaxonomyMap", "BO-1003100010-TAXONOMYCODE", "TaxonomyCode");
			fields[183] = new ims.framework.ReportField(this.context, "_cv_OCRR.ProviderService", "BO-1003100032-ID", "ID_Service");
			fields[184] = new ims.framework.ReportField(this.context, "_cv_OCRR.ProviderService", "BO-1003100032-SERVICENAME", "ServiceName");
			fields[185] = new ims.framework.ReportField(this.context, "_cv_OCRR.ProviderService", "BO-1003100032-SERVICECATEGORY", "ServiceCategory");
			fields[186] = new ims.framework.ReportField(this.context, "_cv_OCRR.ProviderService", "BO-1003100032-CANBESCHEDULED", "CanBeScheduled");
			fields[187] = new ims.framework.ReportField(this.context, "_cv_OCRR.ProviderService", "BO-1003100032-SPECIALTY", "Specialty");
			fields[188] = new ims.framework.ReportField(this.context, "_cv_OCRR.ProviderService", "BO-1003100032-EXPECTEDTURNAROUND", "ExpectedTurnaround");
			fields[189] = new ims.framework.ReportField(this.context, "_cv_OCRR.ProviderService", "BO-1003100032-TURNAROUNDMEASURE", "TurnaroundMeasure");
			fields[190] = new ims.framework.ReportField(this.context, "_cv_OCRR.ProviderService", "BO-1003100032-MATERNITYINDICATOR", "MaternityIndicator");
			fields[191] = new ims.framework.ReportField(this.context, "_cv_OCRR.ProviderService", "BO-1003100032-ISACTIVE", "IsActive");
			fields[192] = new ims.framework.ReportField(this.context, "_cv_OCRR.ProviderService", "BO-1003100032-ISSUBJECTTORTTCLOCK", "IsSubjectToRTTClock");
			fields[193] = new ims.framework.ReportField(this.context, "_cv_OCRR.ProviderService", "BO-1003100032-DIRECTSELFREFERRALSACCEPTED", "DirectSelfReferralsAccepted");
			fields[194] = new ims.framework.ReportField(this.context, "_cv_OCRR.ProviderService", "BO-1003100032-ISPREASSESSMENTCOMPLETIONEXEMPT", "IsPreAssessmentCompletionExempt");
			fields[195] = new ims.framework.ReportField(this.context, "_cv_OCRR.ProviderService", "BO-1003100032-SERVICEDESCRIPTION", "ServiceDescription");
			fields[196] = new ims.framework.ReportField(this.context, "_cv_OCRR.ProviderService", "BO-1003100032-ALTERNATESERVICECODE", "AlternateServiceCode");
			fields[197] = new ims.framework.ReportField(this.context, "_cv_OCRR.AlternativePaedContainer", "BO-1061100022-ID", "ID_Container");
			fields[198] = new ims.framework.ReportField(this.context, "_cv_OCRR.AlternativePaedContainer", "BO-1061100022-TYPE", "Type");
			fields[199] = new ims.framework.ReportField(this.context, "_cv_OCRR.AlternativePaedContainer", "BO-1061100022-VOLUME", "Volume");
			fields[200] = new ims.framework.ReportField(this.context, "_cv_OCRR.AlternativePaedContainer", "BO-1061100022-VOLUMEUNITS", "VolumeUnits");
			fields[201] = new ims.framework.ReportField(this.context, "_cv_OCRR.AlternativePaedContainer", "BO-1061100022-LABELSUFFIX", "LabelSuffix");
			fields[202] = new ims.framework.ReportField(this.context, "_cv_OCRR.AlternativeAdultContainer", "BO-1061100021-ID", "ID_AlternativeAdultContainers");
			fields[203] = new ims.framework.ReportField(this.context, "_cv_OCRR.AlternativeAdultContainer", "BO-1061100021-ADULTSPECVOLVAL", "AdultSpecVolVal");
			fields[204] = new ims.framework.ReportField(this.context, "_cv_OCRR.AlternativeAdultContainer", "BO-1061100021-ADULTSPECVOLUNIT", "AdultSpecVolUnit");
			fields[205] = new ims.framework.ReportField(this.context, "_cv_OCRR.AlternativeAdultContainer", "BO-1061100021-LABELSUFFIX", "LabelSuffix");
			fields[206] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.TestEdit.__internal_x_context__SelectedInvestigation_" + componentIdentifier, "BO-1058100001-ID", "ID_Investigation");
			fields[207] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.TestEdit.__internal_x_context__SelectedInvestigation_" + componentIdentifier, "BO-1058100001-ACTIVESTATUS", "ActiveStatus");
			fields[208] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.TestEdit.__internal_x_context__SelectedInvestigation_" + componentIdentifier, "BO-1058100001-COLOUR", "Colour");
			fields[209] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.TestEdit.__internal_x_context__SelectedInvestigation_" + componentIdentifier, "BO-1058100001-PROVIDERINVCODE", "ProviderInvCode");
			fields[210] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.TestEdit.__internal_x_context__SelectedInvestigation_" + componentIdentifier, "BO-1058100001-SEPARATEORDER", "SeparateOrder");
			fields[211] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.TestEdit.__internal_x_context__SelectedInvestigation_" + componentIdentifier, "BO-1058100001-ISADDON", "IsAddon");
			fields[212] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.TestEdit.__internal_x_context__SelectedInvestigation_" + componentIdentifier, "BO-1058100001-MINREORDERPERIODVAL", "MinReorderPeriodVal");
			fields[213] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.TestEdit.__internal_x_context__SelectedInvestigation_" + componentIdentifier, "BO-1058100001-MINREORDERPERIODUNIT", "MinReorderPeriodUnit");
			fields[214] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.TestEdit.__internal_x_context__SelectedInvestigation_" + componentIdentifier, "BO-1058100001-FEMALEMINREORDERPERIODVAL", "FemaleMinReorderPeriodVal");
			fields[215] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.TestEdit.__internal_x_context__SelectedInvestigation_" + componentIdentifier, "BO-1058100001-FEMALEMINREORDERPERIODUNIT", "FemaleMinReorderPeriodUnit");
			fields[216] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.TestEdit.__internal_x_context__SelectedInvestigation_" + componentIdentifier, "BO-1058100001-TYPE", "Type");
			fields[217] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.TestEdit.__internal_x_context__SelectedInvestigation_" + componentIdentifier, "BO-1058100001-EVENTTYPE", "EventType");
			fields[218] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.TestEdit.__internal_x_context__SelectedInvestigation_" + componentIdentifier, "BO-1058100001-NOLABELSETS", "NoLabelSets");
			fields[219] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.TestEdit.__internal_x_context__SelectedInvestigation_" + componentIdentifier, "BO-1058100001-TURNAROUNDMEASURE", "TurnaroundMeasure");
			fields[220] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.TestEdit.__internal_x_context__SelectedInvestigation_" + componentIdentifier, "BO-1058100001-EXPECTEDTURNAROUND", "ExpectedTurnaround");
			fields[221] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.TestEdit.__internal_x_context__RemovedQuestions_" + componentIdentifier, "BO-1061100002-ID", "ID_InvestigationQuestion");
			fields[222] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.TestEdit.__internal_x_context__RemovedQuestions_" + componentIdentifier, "BO-1061100002-ISMANDATORY", "IsMandatory");
			fields[223] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.TestEdit.__internal_x_context__InvIndexBackup_" + componentIdentifier, "BO-1061100003-ID", "ID_InvestigationIndex");
			fields[224] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.TestEdit.__internal_x_context__InvIndexBackup_" + componentIdentifier, "BO-1061100003-NAME", "Name");
			fields[225] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.TestEdit.__internal_x_context__InvIndexBackup_" + componentIdentifier, "BO-1061100003-CATEGORY", "Category");
			fields[226] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.TestEdit.__internal_x_context__InvIndexBackup_" + componentIdentifier, "BO-1061100003-ORDERABILITY", "Orderability");
			fields[227] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.TestEdit.__internal_x_context__InvIndexBackup_" + componentIdentifier, "BO-1061100003-TIMESERIESINSTRUCTIONSURL", "TimeSeriesInstructionsURL");
			fields[228] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.TestEdit.__internal_x_context__InvIndexBackup_" + componentIdentifier, "BO-1061100003-DESCRIPTION", "Description");
			fields[229] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.TestEdit.__internal_x_context__InvIndexBackup_" + componentIdentifier, "BO-1061100003-COLOUR", "Colour");
			fields[230] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.TestEdit.__internal_x_context__InvIndexBackup_" + componentIdentifier, "BO-1061100003-ISPROFILE", "IsProfile");
			fields[231] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.TestEdit.__internal_x_context__InvIndexBackup_" + componentIdentifier, "BO-1061100003-ACTIVESTATUS", "ActiveStatus");
			fields[232] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.TestEdit.__internal_x_context__InvIndexBackup_" + componentIdentifier, "BO-1061100003-GENDERSPECIFIC", "GenderSpecific");
			fields[233] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.TestEdit.__internal_x_context__InvIndexBackup_" + componentIdentifier, "BO-1061100003-PHLEBMAYCOLLECT", "PhlebMayCollect");
			fields[234] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.TestEdit.__internal_x_context__InvIndexBackup_" + componentIdentifier, "BO-1061100003-REQUIRESSITESPECIFIER", "RequiresSiteSpecifier");
			fields[235] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.TestEdit.__internal_x_context__InvIndexBackup_" + componentIdentifier, "BO-1061100003-SHOWLAST", "ShowLast");
			fields[236] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.TestEdit.__internal_x_context__InvIndexBackup_" + componentIdentifier, "BO-1061100003-NOINTERFACE", "NoInterface");
			fields[237] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.TestEdit.__internal_x_context__InvestigationBackup_" + componentIdentifier, "BO-1058100001-ID", "ID_Investigation");
			fields[238] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.TestEdit.__internal_x_context__InvestigationBackup_" + componentIdentifier, "BO-1058100001-ACTIVESTATUS", "ActiveStatus");
			fields[239] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.TestEdit.__internal_x_context__InvestigationBackup_" + componentIdentifier, "BO-1058100001-COLOUR", "Colour");
			fields[240] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.TestEdit.__internal_x_context__InvestigationBackup_" + componentIdentifier, "BO-1058100001-PROVIDERINVCODE", "ProviderInvCode");
			fields[241] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.TestEdit.__internal_x_context__InvestigationBackup_" + componentIdentifier, "BO-1058100001-SEPARATEORDER", "SeparateOrder");
			fields[242] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.TestEdit.__internal_x_context__InvestigationBackup_" + componentIdentifier, "BO-1058100001-ISADDON", "IsAddon");
			fields[243] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.TestEdit.__internal_x_context__InvestigationBackup_" + componentIdentifier, "BO-1058100001-MINREORDERPERIODVAL", "MinReorderPeriodVal");
			fields[244] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.TestEdit.__internal_x_context__InvestigationBackup_" + componentIdentifier, "BO-1058100001-MINREORDERPERIODUNIT", "MinReorderPeriodUnit");
			fields[245] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.TestEdit.__internal_x_context__InvestigationBackup_" + componentIdentifier, "BO-1058100001-FEMALEMINREORDERPERIODVAL", "FemaleMinReorderPeriodVal");
			fields[246] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.TestEdit.__internal_x_context__InvestigationBackup_" + componentIdentifier, "BO-1058100001-FEMALEMINREORDERPERIODUNIT", "FemaleMinReorderPeriodUnit");
			fields[247] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.TestEdit.__internal_x_context__InvestigationBackup_" + componentIdentifier, "BO-1058100001-TYPE", "Type");
			fields[248] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.TestEdit.__internal_x_context__InvestigationBackup_" + componentIdentifier, "BO-1058100001-EVENTTYPE", "EventType");
			fields[249] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.TestEdit.__internal_x_context__InvestigationBackup_" + componentIdentifier, "BO-1058100001-NOLABELSETS", "NoLabelSets");
			fields[250] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.TestEdit.__internal_x_context__InvestigationBackup_" + componentIdentifier, "BO-1058100001-TURNAROUNDMEASURE", "TurnaroundMeasure");
			fields[251] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.TestEdit.__internal_x_context__InvestigationBackup_" + componentIdentifier, "BO-1058100001-EXPECTEDTURNAROUND", "ExpectedTurnaround");
			return fields;
		}
