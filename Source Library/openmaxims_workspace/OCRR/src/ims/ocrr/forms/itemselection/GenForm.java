...
public class GenForm extends FormBridge
{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1006), new Integer(anchoringHelper7.getX()), new Integer(anchoringHelper7.getY()), new Integer(anchoringHelper7.getWidth()), new Integer(anchoringHelper7.getHeight()), new Integer(startTabIndex.intValue() + 1), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT,Boolean.FALSE, new Integer(100), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
		...
		Grid m_grdSelectedTestsTemp = (Grid)factory.getControl(Grid.class, new Object[] { control, new Integer(startControlID.intValue() + 1008), new Integer(anchoringHelper9.getX()), new Integer(anchoringHelper9.getY()), new Integer(anchoringHelper9.getWidth()), new Integer(anchoringHelper9.getHeight()), new Integer(startTabIndex.intValue() + 8), ControlState.EDITABLE, ControlState.EDITABLE, ims.framework.enumerations.ControlAnchoring.ALL,Boolean.FALSE, Boolean.FALSE, new Integer(24), Boolean.TRUE, null, Boolean.FALSE, Boolean.FALSE, new Integer(0), null, Boolean.FALSE, Boolean.TRUE});
		...
		super.addControl(factory.getControl(ImageButton.class, new Object[] { control, new Integer(startControlID.intValue() + 1011), new Integer(anchoringHelper12.getX()), new Integer(anchoringHelper12.getY()), new Integer(anchoringHelper12.getWidth()), new Integer(anchoringHelper12.getHeight()), new Integer(startTabIndex.intValue() + 4), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT, this.getImages().Core.ClearEnabled24, this.getImages().Core.ClearDisabled24, "Reset search criteria and results", Boolean.FALSE, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null}));
		...
		super.addControl(factory.getControl(ImageButton.class, new Object[] { control, new Integer(startControlID.intValue() + 1012), new Integer(anchoringHelper13.getX()), new Integer(anchoringHelper13.getY()), new Integer(anchoringHelper13.getWidth()), new Integer(anchoringHelper13.getHeight()), new Integer(startTabIndex.intValue() + 3), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT, this.getImages().Core.FindEnabled24, this.getImages().Core.FindDisabled24, "Search for Items matching 'Search Criteria'", Boolean.FALSE, Boolean.TRUE, Boolean.TRUE, Boolean.FALSE, null}));
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[159] = new ims.framework.ReportField(this.context, "_cv_OCRR.Provider", "BO-1007100007-ID", "ID_Location");
			fields[160] = new ims.framework.ReportField(this.context, "_cv_OCRR.Provider", "BO-1007100007-NAME", "Name");
			fields[161] = new ims.framework.ReportField(this.context, "_cv_OCRR.Provider", "BO-1007100007-ISACTIVE", "IsActive");
			fields[162] = new ims.framework.ReportField(this.context, "_cv_OCRR.Provider", "BO-1007100007-ISVIRTUAL", "IsVirtual");
			fields[163] = new ims.framework.ReportField(this.context, "_cv_OCRR.Provider", "BO-1007100007-TYPE", "Type");
			fields[164] = new ims.framework.ReportField(this.context, "_cv_OCRR.Provider", "BO-1007100007-DISPLAYINEDTRACKING", "DisplayInEDTracking");
			fields[165] = new ims.framework.ReportField(this.context, "_cv_OCRR.Provider", "BO-1007100007-CASENOTEFOLDERLOCATION", "CaseNoteFolderLocation");
			fields[166] = new ims.framework.ReportField(this.context, "_cv_OCRR.ProviderService", "BO-1003100032-ID", "ID_Service");
			fields[167] = new ims.framework.ReportField(this.context, "_cv_OCRR.ProviderService", "BO-1003100032-SERVICENAME", "ServiceName");
			fields[168] = new ims.framework.ReportField(this.context, "_cv_OCRR.ProviderService", "BO-1003100032-SERVICECATEGORY", "ServiceCategory");
			fields[169] = new ims.framework.ReportField(this.context, "_cv_OCRR.ProviderService", "BO-1003100032-CANBESCHEDULED", "CanBeScheduled");
			fields[170] = new ims.framework.ReportField(this.context, "_cv_OCRR.ProviderService", "BO-1003100032-SPECIALTY", "Specialty");
			fields[171] = new ims.framework.ReportField(this.context, "_cv_OCRR.ProviderService", "BO-1003100032-EXPECTEDTURNAROUND", "ExpectedTurnaround");
			fields[172] = new ims.framework.ReportField(this.context, "_cv_OCRR.ProviderService", "BO-1003100032-TURNAROUNDMEASURE", "TurnaroundMeasure");
			fields[173] = new ims.framework.ReportField(this.context, "_cv_OCRR.ProviderService", "BO-1003100032-MATERNITYINDICATOR", "MaternityIndicator");
			fields[174] = new ims.framework.ReportField(this.context, "_cv_OCRR.ProviderService", "BO-1003100032-ISACTIVE", "IsActive");
			fields[175] = new ims.framework.ReportField(this.context, "_cv_OCRR.ProviderService", "BO-1003100032-ISSUBJECTTORTTCLOCK", "IsSubjectToRTTClock");
			fields[176] = new ims.framework.ReportField(this.context, "_cv_OCRR.ProviderService", "BO-1003100032-DIRECTSELFREFERRALSACCEPTED", "DirectSelfReferralsAccepted");
			fields[177] = new ims.framework.ReportField(this.context, "_cv_OCRR.ProviderService", "BO-1003100032-ISPREASSESSMENTCOMPLETIONEXEMPT", "IsPreAssessmentCompletionExempt");
			fields[178] = new ims.framework.ReportField(this.context, "_cv_OCRR.ProviderService", "BO-1003100032-SERVICEDESCRIPTION", "ServiceDescription");
			fields[179] = new ims.framework.ReportField(this.context, "_cv_OCRR.ProviderService", "BO-1003100032-ALTERNATESERVICECODE", "AlternateServiceCode");
			return fields;
		}
