...
public class GenForm extends FormBridge
{
	...
	private void validateContext(ims.framework.Context context)
	{
		...
		if(!context.isValidContextType(ims.ocrr.vo.PhlebotomyCollectSearchCriteriaVo.class))
			throw new ims.framework.exceptions.CodingRuntimeException("The type 'ims.ocrr.vo.PhlebotomyCollectSearchCriteriaVo' of the global context variable 'OCRR.PhlebotomyCollectSearchCriteria' is not supported.");
	}
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		// CheckBox Controls
		RuntimeAnchoring anchoringHelper11 = new RuntimeAnchoring(designSize, runtimeSize, 8, 581, 152, 16, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT);
		super.addControl(factory.getControl(CheckBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1006), new Integer(anchoringHelper11.getX()), new Integer(anchoringHelper11.getY()), new Integer(anchoringHelper11.getWidth()), new Integer(anchoringHelper11.getHeight()), new Integer(startTabIndex.intValue() + 8), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT ,"Select All for Printing", Boolean.TRUE, null}));

		// Dynamic Grid Controls
		RuntimeAnchoring anchoringHelper12 = new RuntimeAnchoring(designSize, runtimeSize, 8, 96, 832, 480, ims.framework.enumerations.ControlAnchoring.ALL);
		super.addControl(factory.getControl(DynamicGrid.class, new Object[] { control, new Integer(startControlID.intValue() + 1007), new Integer(anchoringHelper12.getX()), new Integer(anchoringHelper12.getY()), new Integer(anchoringHelper12.getWidth()), new Integer(anchoringHelper12.getHeight()), new Integer(startTabIndex.intValue() + 7), ControlState.EDITABLE, ControlState.EDITABLE, ims.framework.enumerations.ControlAnchoring.ALL, null, Boolean.FALSE, Boolean.TRUE, Boolean.TRUE}));

		// RadioButton Controls
		RadioButton tmpGroupFilter = (RadioButton)factory.getControl(RadioButton.class, new Object[] { control, new Integer(startControlID.intValue() + 1008), new Integer(0), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.TRUE});
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.PhlebotomyCollect.__internal_x_context__SelectedRound_" + componentIdentifier, "BO-1070100006-ID", "ID_PhlebotomyRound");
			fields[145] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.PhlebotomyCollect.__internal_x_context__SelectedRound_" + componentIdentifier, "BO-1070100006-DATE", "Date");
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.PhlebotomyCollect.__internal_x_context__SelectedRound_" + componentIdentifier, "BO-1070100006-ROUNDTOCOLLECT", "RoundToCollect");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.PhlebotomyCollect.__internal_x_context__SelectedPatient_" + componentIdentifier, "BO-1001100000-ID", "ID_Patient");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.PhlebotomyCollect.__internal_x_context__SelectedPatient_" + componentIdentifier, "BO-1001100000-SEX", "Sex");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.PhlebotomyCollect.__internal_x_context__SelectedPatient_" + componentIdentifier, "BO-1001100000-DOB", "Dob");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.PhlebotomyCollect.__internal_x_context__SelectedPatient_" + componentIdentifier, "BO-1001100000-DOD", "Dod");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.PhlebotomyCollect.__internal_x_context__SelectedPatient_" + componentIdentifier, "BO-1001100000-RELIGION", "Religion");
			fields[152] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.PhlebotomyCollect.__internal_x_context__SelectedPatient_" + componentIdentifier, "BO-1001100000-ISACTIVE", "IsActive");
			fields[153] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.PhlebotomyCollect.__internal_x_context__SelectedPatient_" + componentIdentifier, "BO-1001100000-ETHNICORIGIN", "EthnicOrigin");
			fields[154] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.PhlebotomyCollect.__internal_x_context__SelectedPatient_" + componentIdentifier, "BO-1001100000-MARITALSTATUS", "MaritalStatus");
			fields[155] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.PhlebotomyCollect.__internal_x_context__SelectedPatient_" + componentIdentifier, "BO-1001100000-SCN", "SCN");
			fields[156] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.PhlebotomyCollect.__internal_x_context__SelectedPatient_" + componentIdentifier, "BO-1001100000-SOURCEOFINFORMATION", "SourceOfInformation");
			fields[157] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.PhlebotomyCollect.__internal_x_context__SelectedPatient_" + componentIdentifier, "BO-1001100000-TIMEOFDEATH", "TimeOfDeath");
			fields[158] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.PhlebotomyCollect.__internal_x_context__SelectedPatient_" + componentIdentifier, "BO-1001100000-ISQUICKREGISTRATIONPATIENT", "IsQuickRegistrationPatient");
			fields[159] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.PhlebotomyCollect.__internal_x_context__SelectedPatient_" + componentIdentifier, "BO-1001100000-CURRENTRESPONSIBLECONSULTANT", "CurrentResponsibleConsultant");
			fields[160] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.PhlebotomyCollect.__internal_x_context__SelectedPatient_" + componentIdentifier, "BO-1001100000-DEMENTIABREACHDATETIME", "DementiaBreachDateTime");
			fields[161] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.PhlebotomyCollect.__internal_x_context__SelectedPatient_" + componentIdentifier, "BO-1001100000-DEMENTIAWORKLISTSTATUS", "DementiaWorklistStatus");
			fields[162] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.PhlebotomyCollect.__internal_x_context__SelectedPatient_" + componentIdentifier, "BO-1001100000-MRNSTATUS", "MRNStatus");
			fields[163] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.PhlebotomyCollect.__internal_x_context__SelectedPatient_" + componentIdentifier, "BO-1001100000-HASSCANNEDCASENOTEFOLDERS", "HasScannedCaseNoteFolders");
			fields[164] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.PhlebotomyCollect.__internal_x_context__SelectedPatient_" + componentIdentifier, "BO-1001100000-ISCONFIDENTIAL", "IsConfidential");
			fields[165] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.PhlebotomyCollect.__internal_x_context__SelectedPatient_" + componentIdentifier, "BO-1001100000-TIMEOFBIRTH", "TimeOfBirth");
			fields[166] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.PhlebotomyCollect.__internal_x_context__SelectedPatient_" + componentIdentifier, "BO-1001100000-PATIENTCATEGORY", "PatientCategory");
			fields[167] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.PhlebotomyCollect.__internal_x_context__ContextDummyForReportsLabel_" + componentIdentifier, "BO-1070100010-ID", "ID_OrderSpecimen");
			fields[168] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.PhlebotomyCollect.__internal_x_context__ContextDummyForReportsLabel_" + componentIdentifier, "BO-1070100010-COLLDATETIMEPLACER", "CollDateTimePlacer");
			fields[169] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.PhlebotomyCollect.__internal_x_context__ContextDummyForReportsLabel_" + componentIdentifier, "BO-1070100010-COLLECTINGMOS", "CollectingMos");
			fields[170] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.PhlebotomyCollect.__internal_x_context__ContextDummyForReportsLabel_" + componentIdentifier, "BO-1070100010-ISPATIENTCOLLECT", "IsPatientCollect");
			fields[171] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.PhlebotomyCollect.__internal_x_context__ContextDummyForReportsLabel_" + componentIdentifier, "BO-1070100010-ISAWAITINGCOLLECTION", "IsAwaitingCollection");
			fields[172] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.PhlebotomyCollect.__internal_x_context__ContextDummyForReportsLabel_" + componentIdentifier, "BO-1070100010-SPECIMENSOURCE", "SpecimenSource");
			fields[173] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.PhlebotomyCollect.__internal_x_context__ContextDummyForReportsLabel_" + componentIdentifier, "BO-1070100010-DISCIPLINE", "Discipline");
			fields[174] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.PhlebotomyCollect.__internal_x_context__ContextDummyForReportsLabel_" + componentIdentifier, "BO-1070100010-ORDER", "Order");
			fields[175] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.PhlebotomyCollect.__internal_x_context__ContextDummyForReportsLabel_" + componentIdentifier, "BO-1070100010-INSTRUCTIONSTOCOLLECTOR", "InstructionsToCollector");
			fields[176] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.PhlebotomyCollect.__internal_x_context__ContextDummyForReportsLabel_" + componentIdentifier, "BO-1070100010-COLLECTORCOMMENT", "CollectorComment");
			fields[177] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.PhlebotomyCollect.__internal_x_context__ContextDummyForReportsLabel_" + componentIdentifier, "BO-1070100010-SITECD", "SiteCd");
			fields[178] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.PhlebotomyCollect.__internal_x_context__ContextDummyForReportsLabel_" + componentIdentifier, "BO-1070100010-REQUESTEDTYPE", "RequestedType");
			return fields;
		}
