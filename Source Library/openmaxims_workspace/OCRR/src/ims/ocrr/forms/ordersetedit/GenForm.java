...
public class GenForm extends FormBridge
{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1007), new Integer(anchoringHelper8.getX()), new Integer(anchoringHelper8.getY()), new Integer(anchoringHelper8.getWidth()), new Integer(anchoringHelper8.getHeight()), new Integer(startTabIndex.intValue() + 9), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Edit", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.OrderSetEdit.__internal_x_context__EditedRecord_" + componentIdentifier, "BO-1058100008-ID", "ID_OrderSet");
			fields[145] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.OrderSetEdit.__internal_x_context__EditedRecord_" + componentIdentifier, "BO-1058100008-NAME", "Name");
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.OrderSetEdit.__internal_x_context__EditedRecord_" + componentIdentifier, "BO-1058100008-COMMONNAME", "CommonName");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.OrderSetEdit.__internal_x_context__EditedRecord_" + componentIdentifier, "BO-1058100008-DESCRIPTION", "Description");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.OrderSetEdit.__internal_x_context__EditedRecord_" + componentIdentifier, "BO-1058100008-ACTIVESTATUS", "ActiveStatus");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.OrderSetEdit.__internal_x_context__EditedRecord_" + componentIdentifier, "BO-1058100008-COLOR", "Color");
			return fields;
		}
