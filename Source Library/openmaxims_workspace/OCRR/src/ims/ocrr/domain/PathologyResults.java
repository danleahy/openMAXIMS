...
public interface PathologyResults extends ims.domain.DomainInterface
{
	...
	*/
	...
	// Generated from form domain interface definition
	public ims.ocrr.vo.PathologyResultListShortVoCollection listResults(ims.core.patient.vo.PatientRefVo patient, ims.framework.utils.Date fromDate, ims.framework.utils.Date toDate, ims.ocrr.configuration.vo.InvestigationIndexRefVo investigationType, ims.core.vo.ServiceLiteVo discipline, ims.core.resource.people.vo.HcpRefVo clinician, Integer inpatientOutpatientOption, Boolean resultsOnly, Boolean checked, Boolean unchecked) throws ims.domain.exceptions.DomainInterfaceException;
