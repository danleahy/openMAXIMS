...
public class OutpatientPhlebotomyImpl extends BaseSpecimenCollectionClinicImpl
{
	...
	public SpecimenWorkListItemListVoCollection listWorkListItems(Integer patientId, SpecimenCollectionMethod listType, SpecimenCollectionStatus status)
	{
		...
		if(patientId != null)
		{
			...
			hql.append(" sp.specimen.order.patient.id = :PATID");
			markers.add("PATID");
		...
		{
			hql.append(sqlClause);
			hql.append(" sp.collectionStatus != :STATUS");
			markers.add("STATUS");
