...
public class GenForm extends FormBridge
{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1011), new Integer(anchoringHelper12.getX()), new Integer(anchoringHelper12.getY()), new Integer(anchoringHelper12.getWidth()), new Integer(anchoringHelper12.getHeight()), new Integer(startTabIndex.intValue() + 14), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "New", Boolean.TRUE, null, Boolean.FALSE, Boolean.FALSE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1012), new Integer(anchoringHelper13.getX()), new Integer(anchoringHelper13.getY()), new Integer(anchoringHelper13.getWidth()), new Integer(anchoringHelper13.getHeight()), new Integer(startTabIndex.intValue() + 15), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Edit", Boolean.TRUE, null, Boolean.FALSE, Boolean.FALSE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, prefix + "_lv_RACPC.RACPCSymptomAndRiskFactor.__internal_x_context__RACPSymptomRiskFactorsVo_" + componentIdentifier, "BO-1072100072-ID", "ID_RACPSymptomRiskFactors");
			fields[145] = new ims.framework.ReportField(this.context, prefix + "_lv_RACPC.RACPCSymptomAndRiskFactor.__internal_x_context__RACPSymptomRiskFactorsVo_" + componentIdentifier, "BO-1072100072-SYMPTOMINDICATOR", "SymptomIndicator");
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_RACPC.RACPCSymptomAndRiskFactor.__internal_x_context__RACPSymptomRiskFactorsVo_" + componentIdentifier, "BO-1072100072-SYMPTOMDURATION", "SymptomDuration");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_RACPC.RACPCSymptomAndRiskFactor.__internal_x_context__RACPSymptomRiskFactorsVo_" + componentIdentifier, "BO-1072100072-SYMPTOMNOTES", "SymptomNotes");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_RACPC.RACPCSymptomAndRiskFactor.__internal_x_context__RACPSymptomRiskFactorsVo_" + componentIdentifier, "BO-1072100072-RISKFACTORINDICATOR", "RiskFactorIndicator");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_RACPC.RACPCSymptomAndRiskFactor.__internal_x_context__RACPSymptomRiskFactorsVo_" + componentIdentifier, "BO-1072100072-DIABETESSTATUS", "DiabetesStatus");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_RACPC.RACPCSymptomAndRiskFactor.__internal_x_context__RACPSymptomRiskFactorsVo_" + componentIdentifier, "BO-1072100072-OTHERNOTES", "OtherNotes");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_RACPC.RACPCSymptomAndRiskFactor.__internal_x_context__RACPSymptomRiskFactorsVo_" + componentIdentifier, "BO-1072100072-CARECONTEXT", "CareContext");
			fields[152] = new ims.framework.ReportField(this.context, prefix + "_lv_RACPC.RACPCSymptomAndRiskFactor.__internal_x_context__RACPSymptomRiskFactorsVo_" + componentIdentifier, "BO-1072100072-SYMPTOMDURATIONUNIT", "SymptomDurationUnit");
			return fields;
		}
