...
public class GenForm extends FormBridge
{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1006), new Integer(anchoringHelper7.getX()), new Integer(anchoringHelper7.getY()), new Integer(anchoringHelper7.getWidth()), new Integer(anchoringHelper7.getHeight()), new Integer(startTabIndex.intValue() + 6), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "New", Boolean.TRUE, null, Boolean.FALSE, Boolean.FALSE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, prefix + "_lv_RACPC.RACPCPlanAdvice.__internal_x_context__PlanAdviceVo_" + componentIdentifier, "BO-1072100077-ID", "ID_RACPPlanAdvice");
			fields[145] = new ims.framework.ReportField(this.context, prefix + "_lv_RACPC.RACPCPlanAdvice.__internal_x_context__PlanAdviceVo_" + componentIdentifier, "BO-1072100077-PRIMARYPLAN", "PrimaryPlan");
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_RACPC.RACPCPlanAdvice.__internal_x_context__PlanAdviceVo_" + componentIdentifier, "BO-1072100077-OVERALLIMPRESSION", "OverallImpression");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_RACPC.RACPCPlanAdvice.__internal_x_context__PlanAdviceVo_" + componentIdentifier, "BO-1072100077-OTHERDETAILS", "OtherDetails");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_RACPC.RACPCPlanAdvice.__internal_x_context__PlanAdviceVo_" + componentIdentifier, "BO-1072100077-CARECONTEXT", "CareContext");
			return fields;
		}
