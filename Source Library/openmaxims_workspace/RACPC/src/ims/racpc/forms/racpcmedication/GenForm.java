...
public class GenForm extends FormBridge
{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1002), new Integer(anchoringHelper3.getX()), new Integer(anchoringHelper3.getY()), new Integer(anchoringHelper3.getWidth()), new Integer(anchoringHelper3.getHeight()), new Integer(startTabIndex.intValue() + 4), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Edit", Boolean.TRUE, null, Boolean.FALSE, Boolean.FALSE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, prefix + "_lv_RACPC.RACPCMedication.__internal_x_context__RACPMedicationVo_" + componentIdentifier, "BO-1072100079-ID", "ID_RACPMedication");
			fields[145] = new ims.framework.ReportField(this.context, prefix + "_lv_RACPC.RACPCMedication.__internal_x_context__RACPMedicationVo_" + componentIdentifier, "BO-1072100079-MEDICATIONNOTES", "MedicationNotes");
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_RACPC.RACPCMedication.__internal_x_context__RACPMedicationVo_" + componentIdentifier, "BO-1072100079-CARECONTEXT", "CareContext");
			return fields;
		}
