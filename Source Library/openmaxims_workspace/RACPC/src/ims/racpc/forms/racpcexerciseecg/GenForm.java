...
public class GenForm extends FormBridge
{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1029), new Integer(anchoringHelper30.getX()), new Integer(anchoringHelper30.getY()), new Integer(anchoringHelper30.getWidth()), new Integer(anchoringHelper30.getHeight()), new Integer(startTabIndex.intValue() + 19), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "New", Boolean.TRUE, null, Boolean.FALSE, Boolean.FALSE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1030), new Integer(anchoringHelper31.getX()), new Integer(anchoringHelper31.getY()), new Integer(anchoringHelper31.getWidth()), new Integer(anchoringHelper31.getHeight()), new Integer(startTabIndex.intValue() + 20), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Edit", Boolean.TRUE, null, Boolean.FALSE, Boolean.FALSE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		ComboBox m_cmbCMDTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1033), new Integer(anchoringHelper34.getX()), new Integer(anchoringHelper34.getY()), new Integer(anchoringHelper34.getWidth()), new Integer(anchoringHelper34.getHeight()), new Integer(startTabIndex.intValue() + 1), ControlState.DISABLED, ControlState.ENABLED,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
		...
		super.addControl(factory.getControl(IntBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1043), new Integer(anchoringHelper44.getX()), new Integer(anchoringHelper44.getY()), new Integer(anchoringHelper44.getWidth()), new Integer(anchoringHelper44.getHeight()), new Integer(startTabIndex.intValue() + 12), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.TRUE, Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, new Integer(9)}));
		...
		super.addControl(factory.getControl(IntBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1049), new Integer(anchoringHelper50.getX()), new Integer(anchoringHelper50.getY()), new Integer(anchoringHelper50.getWidth()), new Integer(anchoringHelper50.getHeight()), new Integer(startTabIndex.intValue() + 4), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT,Boolean.TRUE, Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, new Integer(9)}));
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, prefix + "_lv_RACPC.RACPCExerciseECG.__internal_x_context__RACPExerciseECGVo_" + componentIdentifier, "BO-1072100078-ID", "ID_RACPExerciseECG");
			fields[145] = new ims.framework.ReportField(this.context, prefix + "_lv_RACPC.RACPCExerciseECG.__internal_x_context__RACPExerciseECGVo_" + componentIdentifier, "BO-1072100078-PREASSESSESCHD", "PreAssessesCHD");
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_RACPC.RACPCExerciseECG.__internal_x_context__RACPExerciseECGVo_" + componentIdentifier, "BO-1072100078-PROTOCOL", "Protocol");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_RACPC.RACPCExerciseECG.__internal_x_context__RACPExerciseECGVo_" + componentIdentifier, "BO-1072100078-DURATIONMINS", "DurationMins");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_RACPC.RACPCExerciseECG.__internal_x_context__RACPExerciseECGVo_" + componentIdentifier, "BO-1072100078-DURATIONSECS", "DurationSecs");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_RACPC.RACPCExerciseECG.__internal_x_context__RACPExerciseECGVo_" + componentIdentifier, "BO-1072100078-MAXPREDHEARTRATE", "MaxPredHeartRate");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_RACPC.RACPCExerciseECG.__internal_x_context__RACPExerciseECGVo_" + componentIdentifier, "BO-1072100078-DYSPONEA", "Dysponea");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_RACPC.RACPCExerciseECG.__internal_x_context__RACPExerciseECGVo_" + componentIdentifier, "BO-1072100078-SYMPOMONSET", "SympomOnset");
			fields[152] = new ims.framework.ReportField(this.context, prefix + "_lv_RACPC.RACPCExerciseECG.__internal_x_context__RACPExerciseECGVo_" + componentIdentifier, "BO-1072100078-MAXSTCHANGEMM", "MaxSTChangeMM");
			fields[153] = new ims.framework.ReportField(this.context, prefix + "_lv_RACPC.RACPCExerciseECG.__internal_x_context__RACPExerciseECGVo_" + componentIdentifier, "BO-1072100078-MINSTO1MMCHANGE", "MinsTo1mmChange");
			fields[154] = new ims.framework.ReportField(this.context, prefix + "_lv_RACPC.RACPCExerciseECG.__internal_x_context__RACPExerciseECGVo_" + componentIdentifier, "BO-1072100078-SECSTO1MMCHANGE", "SecsTo1mmChange");
			fields[155] = new ims.framework.ReportField(this.context, prefix + "_lv_RACPC.RACPCExerciseECG.__internal_x_context__RACPExerciseECGVo_" + componentIdentifier, "BO-1072100078-RESULT", "Result");
			fields[156] = new ims.framework.ReportField(this.context, prefix + "_lv_RACPC.RACPCExerciseECG.__internal_x_context__RACPExerciseECGVo_" + componentIdentifier, "BO-1072100078-INTERPRETATION", "Interpretation");
			fields[157] = new ims.framework.ReportField(this.context, prefix + "_lv_RACPC.RACPCExerciseECG.__internal_x_context__RACPExerciseECGVo_" + componentIdentifier, "BO-1072100078-CARECONTEXT", "CareContext");
			fields[158] = new ims.framework.ReportField(this.context, prefix + "_lv_RACPC.RACPCExerciseECG.__internal_x_context__RACPExerciseECGVo_" + componentIdentifier, "BO-1072100078-PAINEXPERIENCED", "PainExperienced");
			return fields;
		}
