...
public class GenForm extends FormBridge
{
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.HandTest.__internal_x_context__HandVo_" + componentIdentifier, "BO-1019100058-ID", "ID_HandTest");
			fields[145] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.HandTest.__internal_x_context__HandVo_" + componentIdentifier, "BO-1019100058-AUTHORINGDATETIME", "AuthoringDateTime");
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.HandTest.__internal_x_context__HandVo_" + componentIdentifier, "BO-1019100058-LEFTBULBDYNAMOMETER", "LeftBulbDynamometer");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.HandTest.__internal_x_context__HandVo_" + componentIdentifier, "BO-1019100058-RIGHTBULBDYNAMOMETER", "RightBulbDynamometer");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.HandTest.__internal_x_context__HandVo_" + componentIdentifier, "BO-1019100058-LEFTPINCHSTRENGTH", "LeftPinchStrength");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.HandTest.__internal_x_context__HandVo_" + componentIdentifier, "BO-1019100058-RIGHTPINCHSTRENGTH", "RightPinchStrength");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.HandTest.__internal_x_context__HandVo_" + componentIdentifier, "BO-1019100058-LEFTTHUMBINDEXSPANEXTENSION", "LeftThumbIndexSpanExtension");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.HandTest.__internal_x_context__HandVo_" + componentIdentifier, "BO-1019100058-RIGHTTHUMBINDEXSPANEXTENSION", "RightThumbIndexSpanExtension");
			fields[152] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.HandTest.__internal_x_context__HandVo_" + componentIdentifier, "BO-1019100058-DOMINANTHAND", "DominantHand");
			fields[153] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.HandTest.__internal_x_context__HandVo_" + componentIdentifier, "BO-1019100058-CARECONTEXT", "CareContext");
			fields[154] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.HandTest.__internal_x_context__ClinicalContact_" + componentIdentifier, "BO-1004100003-ID", "ID_ClinicalContact");
			fields[155] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.HandTest.__internal_x_context__ClinicalContact_" + componentIdentifier, "BO-1004100003-SPECIALTY", "Specialty");
			fields[156] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.HandTest.__internal_x_context__ClinicalContact_" + componentIdentifier, "BO-1004100003-CONTACTTYPE", "ContactType");
			fields[157] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.HandTest.__internal_x_context__ClinicalContact_" + componentIdentifier, "BO-1004100003-STARTDATETIME", "StartDateTime");
			fields[158] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.HandTest.__internal_x_context__ClinicalContact_" + componentIdentifier, "BO-1004100003-ENDDATETIME", "EndDateTime");
			fields[159] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.HandTest.__internal_x_context__ClinicalContact_" + componentIdentifier, "BO-1004100003-CARECONTEXT", "CareContext");
			fields[160] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.HandTest.__internal_x_context__ClinicalContact_" + componentIdentifier, "BO-1004100003-ISCLINICALNOTECREATED", "IsClinicalNoteCreated");
			return fields;
		}
