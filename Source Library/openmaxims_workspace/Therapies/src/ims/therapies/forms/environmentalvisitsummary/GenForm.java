...
public class GenForm extends FormBridge
{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1011), new Integer(anchoringHelper12.getX()), new Integer(anchoringHelper12.getY()), new Integer(anchoringHelper12.getWidth()), new Integer(anchoringHelper12.getHeight()), new Integer(startTabIndex.intValue() + 10), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Edit", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1012), new Integer(anchoringHelper13.getX()), new Integer(anchoringHelper13.getY()), new Integer(anchoringHelper13.getWidth()), new Integer(anchoringHelper13.getHeight()), new Integer(startTabIndex.intValue() + 9), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "New", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(DateTimeControl.class, new Object[] { control, new Integer(startControlID.intValue() + 1018), new Integer(anchoringHelper19.getX()), new Integer(anchoringHelper19.getY()), new Integer(anchoringHelper19.getWidth()), new Integer(anchoringHelper19.getHeight()), new Integer(startTabIndex.intValue() + 5), ControlState.DISABLED, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.TOPRIGHT,Boolean.TRUE, null, Boolean.FALSE, null, Boolean.FALSE, null}));
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[145] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.EnvironmentalVisitSummary.__internal_x_context__voEnvironmentalVisit_" + componentIdentifier, "BO-1019100096-ID", "ID_EnvironmentalVisit");
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.EnvironmentalVisitSummary.__internal_x_context__voEnvironmentalVisit_" + componentIdentifier, "BO-1019100096-VISITDATE", "VisitDate");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.EnvironmentalVisitSummary.__internal_x_context__voEnvironmentalVisit_" + componentIdentifier, "BO-1019100096-OTHERSPRESENT", "OthersPresent");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.EnvironmentalVisitSummary.__internal_x_context__voEnvironmentalVisit_" + componentIdentifier, "BO-1019100096-OCCUPATION", "Occupation");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.EnvironmentalVisitSummary.__internal_x_context__voEnvironmentalVisit_" + componentIdentifier, "BO-1019100096-JOBROLE", "JobRole");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.EnvironmentalVisitSummary.__internal_x_context__voEnvironmentalVisit_" + componentIdentifier, "BO-1019100096-LOCATION", "Location");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.EnvironmentalVisitSummary.__internal_x_context__voEnvironmentalVisit_" + componentIdentifier, "BO-1019100096-AUTHORINGDATETIME", "AuthoringDateTime");
			fields[152] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.EnvironmentalVisitSummary.__internal_x_context__voEnvironmentalVisit_" + componentIdentifier, "BO-1019100096-CARECONTEXT", "CareContext");
			fields[153] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.EnvironmentalVisitSummary.__internal_x_context__voEnvironmentalVisit_" + componentIdentifier, "BO-1019100096-CLINICALCONTACT", "ClinicalContact");
			fields[154] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.EnvironmentalVisitSummary.__internal_x_context__VisitSummaryVo_" + componentIdentifier, "BO-1019100095-ID", "ID_VisitSummary");
			fields[155] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.EnvironmentalVisitSummary.__internal_x_context__VisitSummaryVo_" + componentIdentifier, "BO-1019100095-PROBLEMSIDENTIFIED", "ProblemsIdentified");
			fields[156] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.EnvironmentalVisitSummary.__internal_x_context__VisitSummaryVo_" + componentIdentifier, "BO-1019100095-RECOMMENDATIONS", "Recommendations");
			fields[157] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.EnvironmentalVisitSummary.__internal_x_context__VisitSummaryVo_" + componentIdentifier, "BO-1019100095-EQUIPMENT", "Equipment");
			fields[158] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.EnvironmentalVisitSummary.__internal_x_context__VisitSummaryVo_" + componentIdentifier, "BO-1019100095-CONCLUSIONS", "Conclusions");
			return fields;
		}
