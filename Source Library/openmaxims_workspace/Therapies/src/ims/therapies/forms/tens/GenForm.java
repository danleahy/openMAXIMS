...
public class GenForm extends FormBridge
{
		...
		public static class lyrTENSLayer extends Layer
		{
			...
			public static class tabDetailsContainer extends LayerBridge
			{
				...
				protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
				{
					...
					super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1019), new Integer(anchoringHelper20.getX()), new Integer(anchoringHelper20.getY()), new Integer(anchoringHelper20.getWidth()), new Integer(anchoringHelper20.getHeight()), new Integer(startTabIndex.intValue() + 19), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Clear", Boolean.FALSE, null, Boolean.FALSE, Boolean.FALSE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
					...
					super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1020), new Integer(anchoringHelper21.getX()), new Integer(anchoringHelper21.getY()), new Integer(anchoringHelper21.getWidth()), new Integer(anchoringHelper21.getHeight()), new Integer(startTabIndex.intValue() + 18), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "OK", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1041), new Integer(anchoringHelper42.getX()), new Integer(anchoringHelper42.getY()), new Integer(anchoringHelper42.getWidth()), new Integer(anchoringHelper42.getHeight()), new Integer(startTabIndex.intValue() + 20), ControlState.HIDDEN, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Save", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1042), new Integer(anchoringHelper43.getX()), new Integer(anchoringHelper43.getY()), new Integer(anchoringHelper43.getWidth()), new Integer(anchoringHelper43.getHeight()), new Integer(startTabIndex.intValue() + 21), ControlState.HIDDEN, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Cancel", Boolean.FALSE, null, Boolean.FALSE, Boolean.FALSE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		Grid m_grdTENSTemp = (Grid)factory.getControl(Grid.class, new Object[] { control, new Integer(startControlID.intValue() + 1043), new Integer(anchoringHelper44.getX()), new Integer(anchoringHelper44.getY()), new Integer(anchoringHelper44.getWidth()), new Integer(anchoringHelper44.getHeight()), new Integer(startTabIndex.intValue() + 22), ControlState.UNKNOWN, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.ALL,Boolean.TRUE, Boolean.FALSE, new Integer(24), Boolean.TRUE, contextMenus.contextMenuGenericGrid, Boolean.FALSE, Boolean.FALSE, new Integer(0), null, Boolean.TRUE, Boolean.TRUE});
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.TENS.__internal_x_context__SelectedParentInstance_" + componentIdentifier, "BO-1044100006-ID", "ID_ElectrotherapyTENS");
			fields[145] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.TENS.__internal_x_context__SelectedParentInstance_" + componentIdentifier, "BO-1044100006-AUTHORINGDATETIME", "AuthoringDateTime");
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.TENS.__internal_x_context__SelectedParentInstance_" + componentIdentifier, "BO-1044100006-WARNINGGIVEN", "WarningGiven");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.TENS.__internal_x_context__SelectedChildInstance_" + componentIdentifier, "BO-1019100017-ID", "ID_ElectrotherapyTensTreatment");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.TENS.__internal_x_context__SelectedChildInstance_" + componentIdentifier, "BO-1019100017-AREA", "Area");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.TENS.__internal_x_context__SelectedChildInstance_" + componentIdentifier, "BO-1019100017-LATERALITY", "Laterality");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.TENS.__internal_x_context__SelectedChildInstance_" + componentIdentifier, "BO-1019100017-MODEL", "Model");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.TENS.__internal_x_context__SelectedChildInstance_" + componentIdentifier, "BO-1019100017-SERIALNR", "SerialNr");
			fields[152] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.TENS.__internal_x_context__SelectedChildInstance_" + componentIdentifier, "BO-1019100017-PROTOCOLFOLLOWED", "ProtocolFollowed");
			fields[153] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.TENS.__internal_x_context__SelectedChildInstance_" + componentIdentifier, "BO-1019100017-MODE", "Mode");
			fields[154] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.TENS.__internal_x_context__SelectedChildInstance_" + componentIdentifier, "BO-1019100017-PULSERATE", "PulseRate");
			fields[155] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.TENS.__internal_x_context__SelectedChildInstance_" + componentIdentifier, "BO-1019100017-PULSEWIDTH", "PulseWidth");
			fields[156] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.TENS.__internal_x_context__SelectedChildInstance_" + componentIdentifier, "BO-1019100017-DURATION", "Duration");
			fields[157] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.TENS.__internal_x_context__SelectedChildInstance_" + componentIdentifier, "BO-1019100017-DAILYUSAGE", "DailyUsage");
			fields[158] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.TENS.__internal_x_context__SelectedChildInstance_" + componentIdentifier, "BO-1019100017-ELECTRODES", "Electrodes");
			fields[159] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.TENS.__internal_x_context__SelectedChildInstance_" + componentIdentifier, "BO-1019100017-SIZE", "Size");
			fields[160] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.TENS.__internal_x_context__UpdatedChild_" + componentIdentifier, "BO-1019100017-ID", "ID_ElectrotherapyTensTreatment");
			fields[161] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.TENS.__internal_x_context__UpdatedChild_" + componentIdentifier, "BO-1019100017-AREA", "Area");
			fields[162] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.TENS.__internal_x_context__UpdatedChild_" + componentIdentifier, "BO-1019100017-LATERALITY", "Laterality");
			fields[163] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.TENS.__internal_x_context__UpdatedChild_" + componentIdentifier, "BO-1019100017-MODEL", "Model");
			fields[164] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.TENS.__internal_x_context__UpdatedChild_" + componentIdentifier, "BO-1019100017-SERIALNR", "SerialNr");
			fields[165] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.TENS.__internal_x_context__UpdatedChild_" + componentIdentifier, "BO-1019100017-PROTOCOLFOLLOWED", "ProtocolFollowed");
			fields[166] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.TENS.__internal_x_context__UpdatedChild_" + componentIdentifier, "BO-1019100017-MODE", "Mode");
			fields[167] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.TENS.__internal_x_context__UpdatedChild_" + componentIdentifier, "BO-1019100017-PULSERATE", "PulseRate");
			fields[168] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.TENS.__internal_x_context__UpdatedChild_" + componentIdentifier, "BO-1019100017-PULSEWIDTH", "PulseWidth");
			fields[169] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.TENS.__internal_x_context__UpdatedChild_" + componentIdentifier, "BO-1019100017-DURATION", "Duration");
			fields[170] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.TENS.__internal_x_context__UpdatedChild_" + componentIdentifier, "BO-1019100017-DAILYUSAGE", "DailyUsage");
			fields[171] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.TENS.__internal_x_context__UpdatedChild_" + componentIdentifier, "BO-1019100017-ELECTRODES", "Electrodes");
			fields[172] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.TENS.__internal_x_context__UpdatedChild_" + componentIdentifier, "BO-1019100017-SIZE", "Size");
			fields[173] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.TENS.__internal_x_context__UpdatingParentInstance_" + componentIdentifier, "BO-1044100006-ID", "ID_ElectrotherapyTENS");
			fields[174] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.TENS.__internal_x_context__UpdatingParentInstance_" + componentIdentifier, "BO-1044100006-AUTHORINGDATETIME", "AuthoringDateTime");
			fields[175] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.TENS.__internal_x_context__UpdatingParentInstance_" + componentIdentifier, "BO-1044100006-WARNINGGIVEN", "WarningGiven");
			return fields;
		}
