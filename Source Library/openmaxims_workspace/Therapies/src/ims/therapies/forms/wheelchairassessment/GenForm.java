...
public class GenForm extends FormBridge
{
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.WheelchairAssessment.__internal_x_context__WheelchairAssessmentVo_" + componentIdentifier, "BO-1019100047-ID", "ID_WheelchairAssessment");
			fields[145] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.WheelchairAssessment.__internal_x_context__WheelchairAssessmentVo_" + componentIdentifier, "BO-1019100047-AUTHORINGDATETIME", "AuthoringDateTime");
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.WheelchairAssessment.__internal_x_context__WheelchairAssessmentVo_" + componentIdentifier, "BO-1019100047-CHAIRTYPE", "ChairType");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.WheelchairAssessment.__internal_x_context__WheelchairAssessmentVo_" + componentIdentifier, "BO-1019100047-CLINICALCONTACT", "ClinicalContact");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.WheelchairAssessment.__internal_x_context__ClinicalContact_" + componentIdentifier, "BO-1004100003-ID", "ID_ClinicalContact");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.WheelchairAssessment.__internal_x_context__ClinicalContact_" + componentIdentifier, "BO-1004100003-SPECIALTY", "Specialty");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.WheelchairAssessment.__internal_x_context__ClinicalContact_" + componentIdentifier, "BO-1004100003-CONTACTTYPE", "ContactType");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.WheelchairAssessment.__internal_x_context__ClinicalContact_" + componentIdentifier, "BO-1004100003-STARTDATETIME", "StartDateTime");
			fields[152] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.WheelchairAssessment.__internal_x_context__ClinicalContact_" + componentIdentifier, "BO-1004100003-ENDDATETIME", "EndDateTime");
			fields[153] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.WheelchairAssessment.__internal_x_context__ClinicalContact_" + componentIdentifier, "BO-1004100003-CARECONTEXT", "CareContext");
			fields[154] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.WheelchairAssessment.__internal_x_context__ClinicalContact_" + componentIdentifier, "BO-1004100003-ISCLINICALNOTECREATED", "IsClinicalNoteCreated");
			return fields;
		}
