...
public class GenForm extends FormBridge
{
		...
		public static class lyrDetailsLayer extends Layer
		{
			...
			public static class tabHeaderContainer extends LayerBridge
			{
				...
				protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
				{
					...
					ims.framework.FormUiLogic m_customControlAuthoringHCPForm = loader.loadComponent(102228, appForm, startControlID * 10 + 1000, anchoringHelper1.getSize(), instance1, startTabIndex.intValue() + 4, skipContextValidation);
					//ims.framework.Control m_customControlAuthoringHCPControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1000), new Integer(16), new Integer(16), new Integer(432), new Integer(56), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, new Integer(startTabIndex.intValue() + 4), m_customControlAuthoringHCPForm, instance1 } );
					ims.framework.Control m_customControlAuthoringHCPControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1001),  new Integer(anchoringHelper1.getX()), new Integer(anchoringHelper1.getY()), new Integer(anchoringHelper1.getWidth()), new Integer(anchoringHelper1.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, new Integer(startTabIndex.intValue() + 4), m_customControlAuthoringHCPForm, instance1, Boolean.FALSE } );
			...
			public static class tabDetailsContainer extends LayerBridge
			{
				...
				protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
				{
					...
					super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1011), new Integer(anchoringHelper11.getX()), new Integer(anchoringHelper11.getY()), new Integer(anchoringHelper11.getWidth()), new Integer(anchoringHelper11.getHeight()), new Integer(startTabIndex.intValue() + 16), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Clear", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
					...
					super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1012), new Integer(anchoringHelper12.getX()), new Integer(anchoringHelper12.getY()), new Integer(anchoringHelper12.getWidth()), new Integer(anchoringHelper12.getHeight()), new Integer(startTabIndex.intValue() + 15), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "OK", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
					...
					ComboBox m_cmbDigitTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1013), new Integer(anchoringHelper13.getX()), new Integer(anchoringHelper13.getY()), new Integer(anchoringHelper13.getWidth()), new Integer(anchoringHelper13.getHeight()), new Integer(startTabIndex.intValue() + 9), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT ,Boolean.TRUE, Boolean.TRUE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.TRUE, new Integer(-1)});
					...
					ComboBox m_cmbActionTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1014), new Integer(anchoringHelper14.getX()), new Integer(anchoringHelper14.getY()), new Integer(anchoringHelper14.getWidth()), new Integer(anchoringHelper14.getHeight()), new Integer(startTabIndex.intValue() + 11), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPRIGHT ,Boolean.TRUE, Boolean.TRUE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.TRUE, new Integer(-1)});
					...
					ComboBox m_cmbMovementTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1015), new Integer(anchoringHelper15.getX()), new Integer(anchoringHelper15.getY()), new Integer(anchoringHelper15.getWidth()), new Integer(anchoringHelper15.getHeight()), new Integer(startTabIndex.intValue() + 12), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPRIGHT ,Boolean.TRUE, Boolean.TRUE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.TRUE, new Integer(-1)});
					...
					ComboBox m_cmbJointTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1016), new Integer(anchoringHelper16.getX()), new Integer(anchoringHelper16.getY()), new Integer(anchoringHelper16.getWidth()), new Integer(anchoringHelper16.getHeight()), new Integer(startTabIndex.intValue() + 10), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT ,Boolean.TRUE, Boolean.TRUE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.TRUE, new Integer(-1)});
					...
					super.addControl(factory.getControl(IntBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1018), new Integer(anchoringHelper18.getX()), new Integer(anchoringHelper18.getY()), new Integer(anchoringHelper18.getWidth()), new Integer(anchoringHelper18.getHeight()), new Integer(startTabIndex.intValue() + 14), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT,Boolean.TRUE, Boolean.TRUE, Boolean.FALSE, null, null, Boolean.TRUE, new Integer(9)}));
					...
					super.addControl(factory.getControl(IntBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1019), new Integer(anchoringHelper19.getX()), new Integer(anchoringHelper19.getY()), new Integer(anchoringHelper19.getWidth()), new Integer(anchoringHelper19.getHeight()), new Integer(startTabIndex.intValue() + 13), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT,Boolean.TRUE, Boolean.TRUE, Boolean.FALSE, null, null, Boolean.TRUE, new Integer(9)}));
				}
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1027), new Integer(anchoringHelper27.getX()), new Integer(anchoringHelper27.getY()), new Integer(anchoringHelper27.getWidth()), new Integer(anchoringHelper27.getHeight()), new Integer(startTabIndex.intValue() + 17), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "New", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.HandRangeOfMovement.__internal_x_context__SelectedHandRangeOfMovementInstance_" + componentIdentifier, "BO-1019100060-ID", "ID_HandRangeOfMovement");
			fields[145] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.HandRangeOfMovement.__internal_x_context__SelectedHandRangeOfMovementInstance_" + componentIdentifier, "BO-1019100060-AUTHORINGDATETIME", "AuthoringDateTime");
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.HandRangeOfMovement.__internal_x_context__SelectedHandRangeOfMovementInstance_" + componentIdentifier, "BO-1019100060-CLINICALCONTACT", "ClinicalContact");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.HandRangeOfMovement.__internal_x_context__SelectedHandRangeOfMovementInstance_" + componentIdentifier, "BO-1019100060-DOMINANTHAND", "DominantHand");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.HandRangeOfMovement.__internal_x_context__UpdatedMovement_" + componentIdentifier, "BO-1023100022-ID", "ID_MskJointMovement");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.HandRangeOfMovement.__internal_x_context__UpdatedMovement_" + componentIdentifier, "BO-1023100022-MOVETYPE", "MoveType");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.HandRangeOfMovement.__internal_x_context__UpdatedMovement_" + componentIdentifier, "BO-1023100022-MOVEFINDING", "MoveFinding");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.HandRangeOfMovement.__internal_x_context__UpdatedMovement_" + componentIdentifier, "BO-1023100022-MOVSOR", "MovSOR");
			fields[152] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.HandRangeOfMovement.__internal_x_context__UpdatedMovement_" + componentIdentifier, "BO-1023100022-MOVEOR", "MovEOR");
			fields[153] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.HandRangeOfMovement.__internal_x_context__UpdatedMovement_" + componentIdentifier, "BO-1023100022-QUALITATIVERANGE", "QualitativeRange");
			fields[154] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.HandRangeOfMovement.__internal_x_context__UpdatedMovement_" + componentIdentifier, "BO-1023100022-LIMITED", "Limited");
			fields[155] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.HandRangeOfMovement.__internal_x_context__UpdatedMovement_" + componentIdentifier, "BO-1023100022-MOVEACTION", "MoveAction");
			fields[156] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.HandRangeOfMovement.__internal_x_context__UpdatedHROM_" + componentIdentifier, "BO-1072100035-ID", "ID_MSkExamJointBonesDetail");
			fields[157] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.HandRangeOfMovement.__internal_x_context__UpdatedHROM_" + componentIdentifier, "BO-1072100035-LATERALITY", "Laterality");
			fields[158] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.HandRangeOfMovement.__internal_x_context__UpdatedHROM_" + componentIdentifier, "BO-1072100035-ISJOINT", "IsJoint");
			fields[159] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.HandRangeOfMovement.__internal_x_context__SelectedRangeOfMovementDetailInstance_" + componentIdentifier, "BO-1072100035-ID", "ID_MSkExamJointBonesDetail");
			fields[160] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.HandRangeOfMovement.__internal_x_context__SelectedRangeOfMovementDetailInstance_" + componentIdentifier, "BO-1072100035-LATERALITY", "Laterality");
			fields[161] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.HandRangeOfMovement.__internal_x_context__SelectedRangeOfMovementDetailInstance_" + componentIdentifier, "BO-1072100035-ISJOINT", "IsJoint");
			return fields;
		}
