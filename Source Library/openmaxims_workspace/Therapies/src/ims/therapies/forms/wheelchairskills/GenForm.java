...
public class GenForm extends FormBridge
{
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.WheelchairSkills.__internal_x_context__WheelchairSkillsVo_" + componentIdentifier, "BO-1019100051-ID", "ID_WheelchairSkills");
			fields[145] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.WheelchairSkills.__internal_x_context__WheelchairSkillsVo_" + componentIdentifier, "BO-1019100051-AUTHORINGDATETIME", "AuthoringDateTime");
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.WheelchairSkills.__internal_x_context__WheelchairSkillsVo_" + componentIdentifier, "BO-1019100051-DETAILS", "Details");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.WheelchairSkills.__internal_x_context__WheelchairSkillsVo_" + componentIdentifier, "BO-1019100051-CLINICALCONTACT", "ClinicalContact");
			return fields;
		}
