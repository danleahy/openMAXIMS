...
public class GenForm extends FormBridge
{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1017), new Integer(anchoringHelper17.getX()), new Integer(anchoringHelper17.getY()), new Integer(anchoringHelper17.getWidth()), new Integer(anchoringHelper17.getHeight()), new Integer(startTabIndex.intValue() + 7), ControlState.HIDDEN, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Cancel", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.ContactAonSumm.__internal_x_context__SelectedChildInstance_" + componentIdentifier, "BO-1003100064-ID", "ID_AreaofNeedsNotingDetail");
			fields[145] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.ContactAonSumm.__internal_x_context__SelectedChildInstance_" + componentIdentifier, "BO-1003100064-AREAOFNEED", "AreaofNeed");
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.ContactAonSumm.__internal_x_context__SelectedChildInstance_" + componentIdentifier, "BO-1003100064-THERAPYNOTE", "TherapyNote");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.ContactAonSumm.__internal_x_context__SelectedChildInstance_" + componentIdentifier, "BO-1003100064-SUMMARYNOTE", "SummaryNote");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.ContactAonSumm.__internal_x_context__UpdatedChild_" + componentIdentifier, "BO-1003100064-ID", "ID_AreaofNeedsNotingDetail");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.ContactAonSumm.__internal_x_context__UpdatedChild_" + componentIdentifier, "BO-1003100064-AREAOFNEED", "AreaofNeed");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.ContactAonSumm.__internal_x_context__UpdatedChild_" + componentIdentifier, "BO-1003100064-THERAPYNOTE", "TherapyNote");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.ContactAonSumm.__internal_x_context__UpdatedChild_" + componentIdentifier, "BO-1003100064-SUMMARYNOTE", "SummaryNote");
			fields[152] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.ContactAonSumm.__internal_x_context__SelectedParentInstance_" + componentIdentifier, "BO-1003100063-ID", "ID_AreaofNeedsNoting");
			return fields;
		}
