...
public class GenForm extends FormBridge
{
		...
		public static class lyrTherapyLayer extends Layer
		{
			...
			public static class tabDetailsContainer extends LayerBridge
			{
				...
				protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
				{
					...
					super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1007), new Integer(anchoringHelper8.getX()), new Integer(anchoringHelper8.getY()), new Integer(anchoringHelper8.getWidth()), new Integer(anchoringHelper8.getHeight()), new Integer(startTabIndex.intValue() + 7), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Add/Apply", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1018), new Integer(anchoringHelper19.getX()), new Integer(anchoringHelper19.getY()), new Integer(anchoringHelper19.getWidth()), new Integer(anchoringHelper19.getHeight()), new Integer(startTabIndex.intValue() + 10), ControlState.HIDDEN, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Cancel", Boolean.FALSE, null, Boolean.FALSE, Boolean.FALSE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.ComplementaryTherapy.__internal_x_context__SelectedParentInstance_" + componentIdentifier, "BO-1019100003-ID", "ID_ComplementaryTherapyTreatment");
			fields[145] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.ComplementaryTherapy.__internal_x_context__SelectedParentInstance_" + componentIdentifier, "BO-1019100003-AUTHORINGDATETIME", "AuthoringDateTime");
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.ComplementaryTherapy.__internal_x_context__SelectedChildInstance_" + componentIdentifier, "BO-1019100004-ID", "ID_ComplementaryTherapyDetails");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.ComplementaryTherapy.__internal_x_context__SelectedChildInstance_" + componentIdentifier, "BO-1019100004-COMPLEMENTARYTHERAPY", "ComplementaryTherapy");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.ComplementaryTherapy.__internal_x_context__SelectedChildInstance_" + componentIdentifier, "BO-1019100004-CONTRAINDICATIONSCHECKED", "ContraIndicationsChecked");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.ComplementaryTherapy.__internal_x_context__SelectedChildInstance_" + componentIdentifier, "BO-1019100004-TREATMENT", "Treatment");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.ComplementaryTherapy.__internal_x_context__UpdatedChild_" + componentIdentifier, "BO-1019100004-ID", "ID_ComplementaryTherapyDetails");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.ComplementaryTherapy.__internal_x_context__UpdatedChild_" + componentIdentifier, "BO-1019100004-COMPLEMENTARYTHERAPY", "ComplementaryTherapy");
			fields[152] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.ComplementaryTherapy.__internal_x_context__UpdatedChild_" + componentIdentifier, "BO-1019100004-CONTRAINDICATIONSCHECKED", "ContraIndicationsChecked");
			fields[153] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.ComplementaryTherapy.__internal_x_context__UpdatedChild_" + componentIdentifier, "BO-1019100004-TREATMENT", "Treatment");
			return fields;
		}
