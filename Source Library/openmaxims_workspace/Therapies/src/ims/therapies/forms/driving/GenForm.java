...
public class GenForm extends FormBridge
{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1005), new Integer(anchoringHelper6.getX()), new Integer(anchoringHelper6.getY()), new Integer(anchoringHelper6.getWidth()), new Integer(anchoringHelper6.getHeight()), new Integer(startTabIndex.intValue() + 7), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "New", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.Driving.__internal_x_context__DrivingVo_" + componentIdentifier, "BO-1019100032-ID", "ID_Driving");
			fields[145] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.Driving.__internal_x_context__DrivingVo_" + componentIdentifier, "BO-1019100032-CARECONTEXT", "CareContext");
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.Driving.__internal_x_context__DrivingVo_" + componentIdentifier, "BO-1019100032-AUTHORINGDATETIME", "AuthoringDateTime");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.Driving.__internal_x_context__DrivingVo_" + componentIdentifier, "BO-1019100032-DRIVINGCOMMENCEDDATE", "DrivingCommencedDate");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.Driving.__internal_x_context__DrivingVo_" + componentIdentifier, "BO-1019100032-VEHICLETYPE", "VehicleType");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.Driving.__internal_x_context__DrivingVo_" + componentIdentifier, "BO-1019100032-SPECIALISTINFOEQUIP", "SpecialistInfoEquip");
			return fields;
		}
