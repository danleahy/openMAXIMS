...
public class Logic extends BaseLogic
{
	...
	private void openTherapiesSOAP() throws PresentationLogicException
	{
		...
		{
			if (form.getGlobalContext().Core.getCurrentCareContextIsNotNull())  // WDEV-20525 Enable buttons for CareContext
			{
				//showBtnNew(true);
				showBtnEdit(false);	
			}
		...
		if( FormMode.VIEW.equals(form.getGlobalContext().Clinical.getReturnToFormMode()))
			showBtnEdit(false);
	}
	...
	protected void onFormModeChanged()
	{
		...
		if (form.getMode().equals(FormMode.EDIT))	//wdev-20525
		{
			form.btnUpdate().setVisible(false);
		}
	...
	private boolean saveTherapiesSOAP() throws PresentationLogicException 
	{
		...
		if (clinNoteVo.getID_ClinicalNotes() == null && clinNoteVo.getClinicalContactIsNotNull()) // WDEV-20525
	...
	protected void onChkMarkAsReviewedValueChanged() throws ims.framework.exceptions.PresentationLogicException
	{
