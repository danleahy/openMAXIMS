...
public class GenForm extends FormBridge
{
	...
	public static class ctnDetailsContainer extends ContainerBridge
	{
		...
		protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
		{
			...
			super.addControl(factory.getControl(DateControl.class, new Object[] { control, new Integer(startControlID.intValue() + 1013), new Integer(anchoringHelper14.getX()), new Integer(anchoringHelper14.getY()), new Integer(anchoringHelper14.getWidth()), new Integer(anchoringHelper14.getHeight()), new Integer(startTabIndex.intValue() + 16), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT,Boolean.TRUE, null, Boolean.FALSE, null, Boolean.FALSE, null}));
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1034), new Integer(anchoringHelper35.getX()), new Integer(anchoringHelper35.getY()), new Integer(anchoringHelper35.getWidth()), new Integer(anchoringHelper35.getHeight()), new Integer(startTabIndex.intValue() + 19), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Edit", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.Splints.__internal_x_context__updateVoSplintDetails_" + componentIdentifier, "BO-1019100041-ID", "ID_SplintDetails");
			fields[145] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.Splints.__internal_x_context__updateVoSplintDetails_" + componentIdentifier, "BO-1019100041-AUTHORINGDATETIME", "AuthoringDateTime");
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.Splints.__internal_x_context__updateVoSplintDetails_" + componentIdentifier, "BO-1019100041-STARTDATE", "StartDate");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.Splints.__internal_x_context__updateVoSplintDetails_" + componentIdentifier, "BO-1019100041-AREA", "Area");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.Splints.__internal_x_context__updateVoSplintDetails_" + componentIdentifier, "BO-1019100041-SPLINTCATEGORY", "SplintCategory");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.Splints.__internal_x_context__updateVoSplintDetails_" + componentIdentifier, "BO-1019100041-MATERIAL", "Material");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.Splints.__internal_x_context__updateVoSplintDetails_" + componentIdentifier, "BO-1019100041-PRODUCT", "Product");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.Splints.__internal_x_context__updateVoSplintDetails_" + componentIdentifier, "BO-1019100041-LATERALITY", "Laterality");
			fields[152] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.Splints.__internal_x_context__updateVoSplintDetails_" + componentIdentifier, "BO-1019100041-SPLINTTYPE", "SplintType");
			fields[153] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.Splints.__internal_x_context__updateVoSplintDetails_" + componentIdentifier, "BO-1019100041-SPLINTBASE", "SplintBase");
			fields[154] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.Splints.__internal_x_context__updateVoSplintDetails_" + componentIdentifier, "BO-1019100041-SPLINTSIZE", "SplintSize");
			fields[155] = new ims.framework.ReportField(this.context, prefix + "_lv_Therapies.Splints.__internal_x_context__updateVoSplintDetails_" + componentIdentifier, "BO-1019100041-ENDDATE", "EndDate");
			return fields;
		}
