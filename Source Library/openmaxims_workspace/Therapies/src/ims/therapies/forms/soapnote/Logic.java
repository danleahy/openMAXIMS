...
public class Logic extends BaseLogic
{
	...
	private void setCurrentClinicalNote() throws FormOpenException
	{
		...
		{
			// WDEV-20525 - Clinical Contact is null, is CareContext populated?
			if (form.getGlobalContext().Core.getCurrentCareContextIsNotNull())
			{
				clinicalNotesForContact = domain.getClinicalNotesForCareContext(form.getGlobalContext().Core.getCurrentCareContext());
			}
		}
