...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "NAESReferralNotesDialog";
	}
	public int getWidth()
	{
		return 792;
	...
	{
		return new String[] { "_cv_Naes.ReferralNote" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_NAES.NAESReferralNotesDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
