...
abstract public class Handlers implements ims.framework.UILogic, IFormUILogicCode
{
	...
	abstract protected void onqmbTechnicianTextSubmitted(String value) throws ims.framework.exceptions.PresentationLogicException;
	...
	abstract protected void onBtnOkClicked() throws ims.framework.exceptions.PresentationLogicException;
	abstract protected void onDynGridActionPlansCellValueChanged(ims.framework.controls.DynamicGridCell cell);
	...
	public final void setContext(ims.framework.UIEngine engine, GenForm form)
	{
		...
		this.form.qmbTechnician().setSearchEvent(new ComboBoxSearch()
		{
			private static final long serialVersionUID = 1L;
			public void handle(String value) throws ims.framework.exceptions.PresentationLogicException
			{
				onqmbTechnicianTextSubmitted(value);
			}
		});
		...
		this.form.dyngrdActionPlans().setDynamicGridCellValueChangedEvent(new DynamicGridCellValueChanged()
		{
			private static final long serialVersionUID = 1L;
			...
			{
				onDynGridActionPlansCellValueChanged(cell);
			}
		});
	}
