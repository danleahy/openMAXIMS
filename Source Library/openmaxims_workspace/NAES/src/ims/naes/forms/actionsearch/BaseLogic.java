...
public abstract class BaseLogic extends Handlers
{
	...
	{
		return ims.naes.domain.ActionSearch.class;
	}
	public final void setContext(ims.framework.UIEngine engine, GenForm form, ims.naes.domain.ActionSearch domain)
	{
		setContext(engine, form);
		this.domain = domain;
		if(domain.getLookupService().countLookupInstances(ims.naes.vo.lookups.ActionCollection.class, ims.naes.vo.lookups.Action.class, 1351000, true) == 0)
		{
			if(lookupUsageErrors == null)
				lookupUsageErrors = new java.util.ArrayList();
			lookupUsageErrors.add("The lookup type 'Action' (ID: 1351000) must have at least one active instance configured.");
		}
		if(domain.getLookupService().countLookupInstances(ims.naes.vo.lookups.NaesActionStatusCollection.class, ims.naes.vo.lookups.NaesActionStatus.class, 1351001, true) == 0)
		{
			if(lookupUsageErrors == null)
				lookupUsageErrors = new java.util.ArrayList();
			lookupUsageErrors.add("The lookup type 'NaesActionStatus' (ID: 1351001) must have at least one active instance configured.");
		}
	}
	...
	protected ims.naes.domain.ActionSearch domain;
}
