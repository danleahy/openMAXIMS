...
public class GenForm extends FormBridge
{
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, "_cv_ICP.LinkedGraphicAssessment", "BO-1028100006-ID", "ID_GraphicAssessment");
			fields[145] = new ims.framework.ReportField(this.context, "_cv_ICP.LinkedGraphicAssessment", "BO-1028100006-NAME", "Name");
			fields[146] = new ims.framework.ReportField(this.context, "_cv_ICP.LinkedGraphicAssessment", "BO-1028100006-ASSESSMENTTYPE", "AssessmentType");
			fields[147] = new ims.framework.ReportField(this.context, "_cv_ICP.LinkedGraphicAssessment", "BO-1028100006-ACTIVESTATUS", "ActiveStatus");
			fields[148] = new ims.framework.ReportField(this.context, "_cv_ICP.LinkedGraphicAssessment", "BO-1028100006-HELPURL", "HelpUrl");
			fields[149] = new ims.framework.ReportField(this.context, "_cv_ICP.LinkedGraphicAssessment", "BO-1028100006-STOREPRINTEDREPORT", "StorePrintedReport");
			fields[150] = new ims.framework.ReportField(this.context, "_cv_ICP.LinkedGraphicAssessment", "BO-1028100006-ASSOCIATEDREPORTFORPRINTING", "AssociatedReportForPrinting");
			fields[151] = new ims.framework.ReportField(this.context, "_cv_EAS.TreatmentSiteConfig", "BO-1028100006-ID", "ID_GraphicAssessment");
			fields[152] = new ims.framework.ReportField(this.context, "_cv_EAS.TreatmentSiteConfig", "BO-1028100006-NAME", "Name");
			fields[153] = new ims.framework.ReportField(this.context, "_cv_EAS.TreatmentSiteConfig", "BO-1028100006-ASSESSMENTTYPE", "AssessmentType");
			fields[154] = new ims.framework.ReportField(this.context, "_cv_EAS.TreatmentSiteConfig", "BO-1028100006-ACTIVESTATUS", "ActiveStatus");
			fields[155] = new ims.framework.ReportField(this.context, "_cv_EAS.TreatmentSiteConfig", "BO-1028100006-HELPURL", "HelpUrl");
			fields[156] = new ims.framework.ReportField(this.context, "_cv_EAS.TreatmentSiteConfig", "BO-1028100006-STOREPRINTEDREPORT", "StorePrintedReport");
			return fields;
		}
