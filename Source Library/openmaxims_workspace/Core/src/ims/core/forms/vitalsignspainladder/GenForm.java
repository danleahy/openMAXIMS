...
public class GenForm extends FormBridge
{
	...
	public static class grpShowByRadioButton extends RadioButtonBridge
	{
		...
		protected void setContext(Integer startTabIndex, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize)
		{
			...
			control.addButton(0, anchoringHelper1.getX(), anchoringHelper1.getY(), anchoringHelper1.getWidth(), "By Dates", startTabIndex.intValue() + 5);
			...
			control.addButton(1, anchoringHelper2.getX(), anchoringHelper2.getY(), anchoringHelper2.getWidth(), "By Day", startTabIndex.intValue() + 3);
		}
	...
	private void validateContext(ims.framework.Context context)
	{
		...
		if(!context.isValidContextType(ims.core.vo.VitalSignsFormsSearchCriteriaVo.class))
			throw new ims.framework.exceptions.CodingRuntimeException("The type 'ims.core.vo.VitalSignsFormsSearchCriteriaVo' of the global context variable 'Core.VitalSignsPLAliasSearchCriteria' is not supported.");
		if(!context.isValidContextType(ims.core.vo.VitalSignsFormsSearchCriteriaVo.class))
			throw new ims.framework.exceptions.CodingRuntimeException("The type 'ims.core.vo.VitalSignsFormsSearchCriteriaVo' of the global context variable 'Core.VitalSignsPLSearchCriteria' is not supported.");
	}
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		RuntimeAnchoring anchoringHelper6 = new RuntimeAnchoring(designSize, runtimeSize, 400, 472, 360, 56, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT);
		ims.framework.FormUiLogic m_customAuthoringForm = loader.loadComponent(102228, appForm, startControlID * 10 + 1000, anchoringHelper6.getSize(), instance1, startTabIndex.intValue() + 11, skipContextValidation);
		//ims.framework.Control m_customAuthoringControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1003), new Integer(400), new Integer(472), new Integer(360), new Integer(56), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, new Integer(startTabIndex.intValue() + 11), m_customAuthoringForm, instance1 } );
		ims.framework.Control m_customAuthoringControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1004),  new Integer(anchoringHelper6.getX()), new Integer(anchoringHelper6.getY()), new Integer(anchoringHelper6.getWidth()), new Integer(anchoringHelper6.getHeight()), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, new Integer(startTabIndex.intValue() + 11), m_customAuthoringForm, instance1, Boolean.FALSE } );
		...
		RuntimeAnchoring anchoringHelper8 = new RuntimeAnchoring(designSize, runtimeSize, 408, 535, 68, 17, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT);
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1009), new Integer(anchoringHelper11.getX()), new Integer(anchoringHelper11.getY()), new Integer(anchoringHelper11.getWidth()), new Integer(anchoringHelper11.getHeight()), new Integer(startTabIndex.intValue() + 16), ControlState.HIDDEN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Print", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1013), new Integer(anchoringHelper15.getX()), new Integer(anchoringHelper15.getY()), new Integer(anchoringHelper15.getWidth()), new Integer(anchoringHelper15.getHeight()), new Integer(startTabIndex.intValue() + 9), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Next >>", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(DateControl.class, new Object[] { control, new Integer(startControlID.intValue() + 1018), new Integer(anchoringHelper20.getX()), new Integer(anchoringHelper20.getY()), new Integer(anchoringHelper20.getWidth()), new Integer(anchoringHelper20.getHeight()), new Integer(startTabIndex.intValue() + 4), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT,Boolean.TRUE, null, Boolean.FALSE, null, Boolean.FALSE, null}));

		// ComboBox Controls
		RuntimeAnchoring anchoringHelper21 = new RuntimeAnchoring(designSize, runtimeSize, 541, 533, 124, 21, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT);
	...
	public static class Forms implements java.io.Serializable
	{
		...
		public final class CoreForms implements java.io.Serializable
		{
			...
			private CoreForms()
			{
				...
				VitalSignsPainLadderAlias = new LocalFormName(102348);
			...
			public final FormName VitalSignsPainLadderAlias;
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[152] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.VitalSignsPainLadder.__internal_x_context__VitalSign_" + componentIdentifier, "BO-1022100004-ID", "ID_VitalSigns");
			fields[153] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.VitalSignsPainLadder.__internal_x_context__VitalSign_" + componentIdentifier, "BO-1022100004-CARECONTEXT", "CareContext");
			fields[154] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.VitalSignsPainLadder.__internal_x_context__VitalSign_" + componentIdentifier, "BO-1022100004-ISVENTILATIONCHARTRECORD", "IsVentilationChartRecord");
			fields[155] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.VitalSignsPainLadder.__internal_x_context__VitalSign_" + componentIdentifier, "BO-1022100004-VITALSTAKENDATETIME", "VitalsTakenDateTime");
			fields[156] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.VitalSignsPainLadder.__internal_x_context__VitalSign_" + componentIdentifier, "BO-1022100004-PATIENTCONSCIOUS", "PatientConscious");
			fields[157] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.VitalSignsPainLadder.__internal_x_context__VitalSign_" + componentIdentifier, "BO-1022100004-URINE2MLKGKHR", "Urine2mlkgkhr");
			fields[158] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.VitalSignsPainLadder.__internal_x_context__VitalSign_" + componentIdentifier, "BO-1022100004-PATIENTCAUSINGCONCERN", "PatientCausingConcern");
			fields[159] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.VitalSignsPainLadder.__internal_x_context__VitalSign_" + componentIdentifier, "BO-1022100004-UNRECORDEDOBSERVATIONSREASON", "UnrecordedObservationsReason");
			return fields;
		}
