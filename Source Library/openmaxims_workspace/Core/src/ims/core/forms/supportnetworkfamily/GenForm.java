...
public class GenForm extends FormBridge
{
	...
	public static class ctnFamilySupportContainer extends ContainerBridge
	{
		...
		protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
		{
			...
			super.addControl(factory.getControl(DateTimeControl.class, new Object[] { control, new Integer(startControlID.intValue() + 1019), new Integer(anchoringHelper19.getX()), new Integer(anchoringHelper19.getY()), new Integer(anchoringHelper19.getWidth()), new Integer(anchoringHelper19.getHeight()), new Integer(startTabIndex.intValue() + 20), ControlState.DISABLED, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT,Boolean.TRUE, null, Boolean.FALSE, null, Boolean.FALSE, null}));
			...
			ComboBox m_cmbRecordingHCPTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1020), new Integer(anchoringHelper20.getX()), new Integer(anchoringHelper20.getY()), new Integer(anchoringHelper20.getWidth()), new Integer(anchoringHelper20.getHeight()), new Integer(startTabIndex.intValue() + 19), ControlState.DISABLED, ControlState.DISABLED,ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
			...
			super.addControl(factory.getControl(CheckBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1024), new Integer(anchoringHelper24.getX()), new Integer(anchoringHelper24.getY()), new Integer(anchoringHelper24.getWidth()), new Integer(anchoringHelper24.getHeight()), new Integer(startTabIndex.intValue() + 18), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT ,"Permission given to discuss issues with them ? ", Boolean.FALSE, null}));
	...
	private void validateContext(ims.framework.Context context)
	{
		...
		if(!context.isValidContextType(ims.core.vo.SupportNetworkSearchCriteriaVo.class))
			throw new ims.framework.exceptions.CodingRuntimeException("The type 'ims.core.vo.SupportNetworkSearchCriteriaVo' of the global context variable 'Core.SupportNetworkFamilySearchCriteria' is not supported.");
		if(!context.isValidContextType(ims.core.vo.SupportNetworkSearchCriteriaVo.class))
			throw new ims.framework.exceptions.CodingRuntimeException("The type 'ims.core.vo.SupportNetworkSearchCriteriaVo' of the global context variable 'Core.SupportNetworkFamilyAliasSearchCriteria' is not supported.");
	}
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1028), new Integer(anchoringHelper30.getX()), new Integer(anchoringHelper30.getY()), new Integer(anchoringHelper30.getWidth()), new Integer(anchoringHelper30.getHeight()), new Integer(startTabIndex.intValue() + 25), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Copy Patient Address", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1029), new Integer(anchoringHelper31.getX()), new Integer(anchoringHelper31.getY()), new Integer(anchoringHelper31.getWidth()), new Integer(anchoringHelper31.getHeight()), new Integer(startTabIndex.intValue() + 24), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Reactivate", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1032), new Integer(anchoringHelper34.getX()), new Integer(anchoringHelper34.getY()), new Integer(anchoringHelper34.getWidth()), new Integer(anchoringHelper34.getHeight()), new Integer(startTabIndex.intValue() + 23), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Inactivate", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
	...
	public static class Forms implements java.io.Serializable
	{
		...
		public final class CoreForms implements java.io.Serializable
		{
			...
			private CoreForms()
			{
				...
				SupportNetworkFamily = new LocalFormName(101158);
				SupportNetworkFamilyNursingAssessment = new LocalFormName(101192);
			}
			public final FormName YesNoDialog;
			public final FormName SupportNetworkFamily;
			public final FormName SupportNetworkFamilyNursingAssessment;
		}
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.SupportNetworkFamily.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1003100005-ID", "ID_SupportNetworkFamily");
			fields[145] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.SupportNetworkFamily.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1003100005-CARERNAME", "CarerName");
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.SupportNetworkFamily.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1003100005-CARERRELATIONSHIP", "CarerRelationship");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.SupportNetworkFamily.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1003100005-CARERADDRESS", "CarerAddress");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.SupportNetworkFamily.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1003100005-CARERHOMEPHONE", "CarerHomePhone");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.SupportNetworkFamily.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1003100005-CARERMOBILEPHONE", "CarerMobilePhone");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.SupportNetworkFamily.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1003100005-CARERWORKPHONE", "CarerWorkPhone");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.SupportNetworkFamily.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1003100005-CAREREMAIL", "CarerEmail");
			fields[152] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.SupportNetworkFamily.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1003100005-ISMAINCARER", "IsMainCarer");
			fields[153] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.SupportNetworkFamily.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1003100005-EMERGENCYCONTACTORDER", "EmergencyContactOrder");
			fields[154] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.SupportNetworkFamily.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1003100005-ISCURRENTLYACTIVEFAMILYSUPPORT", "IsCurrentlyActiveFamilySupport");
			fields[155] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.SupportNetworkFamily.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1003100005-DISCUSSPROGRESS", "DiscussProgress");
			fields[156] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.SupportNetworkFamily.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1003100005-PATIENT", "Patient");
			fields[157] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.SupportNetworkFamily.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1003100005-FITANDWELL", "FitAndWell");
			fields[158] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.SupportNetworkFamily.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1003100005-AWARECLIENTPOSITION", "AwareClientPosition");
			fields[159] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.SupportNetworkFamily.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1003100005-PERMISSIONTOCONTACT", "PermissionToContact");
			fields[160] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.SupportNetworkFamily.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1003100005-INACTIVATINGDATETIME", "InactivatingDateTime");
			fields[161] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.SupportNetworkFamily.__internal_x_context__NextOfKin_" + componentIdentifier, "BO-1001100002-ID", "ID_Relative");
			fields[162] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.SupportNetworkFamily.__internal_x_context__NextOfKin_" + componentIdentifier, "BO-1001100002-RELATIONSHIP", "Relationship");
			fields[163] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.SupportNetworkFamily.__internal_x_context__NextOfKin_" + componentIdentifier, "BO-1001100002-PDSUPDATEMODE", "PdsUpdateMode");
			fields[164] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.SupportNetworkFamily.__internal_x_context__NextOfKin_" + componentIdentifier, "BO-1001100002-OBJECTIDENTIFIER", "Objectidentifier");
			fields[165] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.SupportNetworkFamily.__internal_x_context__NextOfKin_" + componentIdentifier, "BO-1001100002-ROLE", "Role");
			fields[166] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.SupportNetworkFamily.__internal_x_context__NextOfKin_" + componentIdentifier, "BO-1001100002-NHSNUM", "NhsNum");
			fields[167] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.SupportNetworkFamily.__internal_x_context__NextOfKin_" + componentIdentifier, "BO-1001100002-CONTACTRANK", "ContactRank");
			fields[168] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.SupportNetworkFamily.__internal_x_context__NextOfKin_" + componentIdentifier, "BO-1001100002-NOKIND", "NokInd");
			fields[169] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.SupportNetworkFamily.__internal_x_context__NextOfKin_" + componentIdentifier, "BO-1001100002-CPYCORRESP", "CpyCorresp");
			fields[170] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.SupportNetworkFamily.__internal_x_context__NextOfKin_" + componentIdentifier, "BO-1001100002-CALLBCKCONS", "CallbckCons");
			fields[171] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.SupportNetworkFamily.__internal_x_context__NextOfKin_" + componentIdentifier, "BO-1001100002-BEFFDATECNF", "Beffdatecnf");
			fields[172] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.SupportNetworkFamily.__internal_x_context__NextOfKin_" + componentIdentifier, "BO-1001100002-BETDATECNF", "Betdatecnf");
			fields[173] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.SupportNetworkFamily.__internal_x_context__NextOfKin_" + componentIdentifier, "BO-1001100002-BEFFDATE", "Beffdate");
			fields[174] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.SupportNetworkFamily.__internal_x_context__NextOfKin_" + componentIdentifier, "BO-1001100002-BETDATE", "Betdate");
			fields[175] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.SupportNetworkFamily.__internal_x_context__NextOfKin_" + componentIdentifier, "BO-1001100002-DOB", "Dob");
			fields[176] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.SupportNetworkFamily.__internal_x_context__NextOfKin_" + componentIdentifier, "BO-1001100002-ACTIVE", "Active");
			fields[177] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.SupportNetworkFamily.__internal_x_context__NextOfKin_" + componentIdentifier, "BO-1001100002-PDSLANGUAGE", "PDSlanguage");
			fields[178] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.SupportNetworkFamily.__internal_x_context__NextOfKin_" + componentIdentifier, "BO-1001100002-PDSINTERPRETERREQUIRED", "PDSInterpreterRequired");
			fields[179] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.SupportNetworkFamily.__internal_x_context__NextOfKin_" + componentIdentifier, "BO-1001100002-PENDING", "Pending");
			fields[180] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.SupportNetworkFamily.__internal_x_context__NextOfKin_" + componentIdentifier, "BO-1001100002-ISCONFIDENTIAL", "IsConfidential");
			fields[181] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.SupportNetworkFamily.__internal_x_context__NextOfKin_" + componentIdentifier, "BO-1001100001-TEMPFIELD", "TempField");
			return fields;
		}
