...
import ims.core.vo.TransportSearchCriteriaVo;
...
public class Logic extends BaseLogic
{
	...
	protected void onFormOpen(Object[] args) throws ims.framework.exceptions.PresentationLogicException
	{
		...
		//WDEV-19389 - start
		if (form.getGlobalContext().Core.getTransportSearchCriteriaIsNotNull())
		{
			setSearchCriteria(form.getGlobalContext().Core.getTransportSearchCriteria());
			performSearch();
		}
		else
			open();
	...
	private TransportSearchCriteriaVo getSearchCriteria()
	{
		TransportSearchCriteriaVo searchCriteria = new TransportSearchCriteriaVo();
		
		searchCriteria.setFromDate(form.dteAppoinmentFrom().getValue());
		searchCriteria.setToDate(form.dteAppoinmentTo().getValue());
		searchCriteria.setDisplayCancelled(Boolean.TRUE.equals(form.chkDisplayBooked().getValue()) ?  true : false);
		
		return searchCriteria;
	}
	
	private void setSearchCriteria(TransportSearchCriteriaVo transportSearchCriteriaVo) 
	{
		form.dteAppoinmentFrom().setValue(transportSearchCriteriaVo.getFromDate());
		form.dteAppoinmentTo().setValue(transportSearchCriteriaVo.getToDate());
		form.chkDisplayBooked().setValue(transportSearchCriteriaVo.getDisplayCancelled());
	}
	...
	private void performSearch()
	{
		...
		form.getGlobalContext().Core.setTransportSearchCriteria(getSearchCriteria()); //WDEV-19389 
	...
	protected void onImbClearClick() throws PresentationLogicException
	{
		...
		// Clear the persistent search criteria
		form.getGlobalContext().Core.setTransportSearchCriteria(null); //WDEV-19389 
		// Update controls state
		updateControlsState();
	}
