...
public class GenForm extends FormBridge
{
	...
	public static class grdSearchResultsRow extends GridRowBridge
	{
		...
		public void setcolProfileNameReadOnly(boolean value)
		{
			super.row.setReadOnly(3, value);
		}
		public boolean iscolProfileNameReadOnly()
		{
			return super.row.isReadOnly(3);
		}
		public void showcolProfileNameOpened()
		{
		...
		public void setcolProfileName(String value)
		{
			super.row.set(3, value);
		}
		public void setCellcolProfileNameTooltip(String value)
		{
	...
	public static class grdSearchResultsGrid extends GridBridge
	{
		...
		public void setcolProfileNameHeaderTooltip(String value)
		{
			super.grid.setColumnHeaderTooltip(3, value);
		}
		public String getcolProfileNameHeaderTooltip()
		{
	...
	private void validateContext(ims.framework.Context context)
	{
		...
		if(!context.isValidContextType(ims.core.vo.TransportSearchCriteriaVo.class))
			throw new ims.framework.exceptions.CodingRuntimeException("The type 'ims.core.vo.TransportSearchCriteriaVo' of the global context variable 'Core.TransportSearchCriteria' is not supported.");
	}
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		// Label Controls
		RuntimeAnchoring anchoringHelper1 = new RuntimeAnchoring(designSize, runtimeSize, 320, 10, 22, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		RuntimeAnchoring anchoringHelper2 = new RuntimeAnchoring(designSize, runtimeSize, 8, 10, 145, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1001), new Integer(anchoringHelper2.getX()), new Integer(anchoringHelper2.getY()), new Integer(anchoringHelper2.getWidth()), new Integer(anchoringHelper2.getHeight()), ControlState.ENABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Appointment Date From:", new Integer(1), null, new Integer(0)}));

		// Date Controls
		RuntimeAnchoring anchoringHelper3 = new RuntimeAnchoring(designSize, runtimeSize, 344, 8, 144, 20, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		RuntimeAnchoring anchoringHelper4 = new RuntimeAnchoring(designSize, runtimeSize, 152, 8, 144, 20, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		// CheckBox Controls
		RuntimeAnchoring anchoringHelper5 = new RuntimeAnchoring(designSize, runtimeSize, 8, 32, 160, 16, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		// Grid Controls
		RuntimeAnchoring anchoringHelper6 = new RuntimeAnchoring(designSize, runtimeSize, 8, 72, 832, 544, ims.framework.enumerations.ControlAnchoring.ALL);
		...
		grdSearchResults.addDateColumn("Date", 0, 0, 70, true, true, null, false, 1, false);
		grdSearchResults.addStringColumn("Patient", 0, 0, 310, true, false, 1, 0, true, ims.framework.enumerations.CharacterCasing.NORMAL);
		grdSearchResults.addStringColumn("Clinic Location", 0, 0, 155, true, false, 1, 0, true, ims.framework.enumerations.CharacterCasing.NORMAL);
		grdSearchResults.addStringColumn("Clinic Profile Name", 0, 0, 155, true, false, 1, 0, true, ims.framework.enumerations.CharacterCasing.NORMAL);
		grdSearchResults.addTimeColumn("Start Time", 0, 0, 70, true, true, false, null, false, 1, false);
		grdSearchResults.addTimeColumn("End Time", 0, 0, 70, true, true, false, null, false, 1, false);
		super.addGrid(grdSearchResults);

		// Image Buttons Controls
		RuntimeAnchoring anchoringHelper7 = new RuntimeAnchoring(designSize, runtimeSize, 808, 16, 30, 30, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
		...
		RuntimeAnchoring anchoringHelper8 = new RuntimeAnchoring(designSize, runtimeSize, 776, 16, 30, 30, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.Transport.__internal_x_context__ReportContext_" + componentIdentifier, "BO-1055100007-ID", "ID_Booking_Appointment");
			fields[145] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.Transport.__internal_x_context__ReportContext_" + componentIdentifier, "BO-1055100007-APPOINTMENTDATE", "AppointmentDate");
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.Transport.__internal_x_context__ReportContext_" + componentIdentifier, "BO-1055100007-APPTSTARTTIME", "ApptStartTime");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.Transport.__internal_x_context__ReportContext_" + componentIdentifier, "BO-1055100007-APPTENDTIME", "ApptEndTime");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.Transport.__internal_x_context__ReportContext_" + componentIdentifier, "BO-1055100007-EARLIESTOFFEREDDATE", "EarliestOfferedDate");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.Transport.__internal_x_context__ReportContext_" + componentIdentifier, "BO-1055100007-TRANSPORTTYPE", "TransportType");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.Transport.__internal_x_context__ReportContext_" + componentIdentifier, "BO-1055100007-ISTRANSPORTREQUIRED", "IsTransportRequired");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.Transport.__internal_x_context__ReportContext_" + componentIdentifier, "BO-1055100007-ISTRANSPORTBOOKED", "IsTransportBooked");
			fields[152] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.Transport.__internal_x_context__ReportContext_" + componentIdentifier, "BO-1055100007-CARECONTEXT", "CareContext");
			return fields;
		}
