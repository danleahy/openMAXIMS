...
{
	abstract protected void bindcmbOBSProtocolTypeLookup();
	abstract protected void defaultcmbOBSProtocolTypeLookupValue();
	...
	abstract protected void oncmbOBSProtocolTypeValueSet(Object value);
	abstract protected void onCmbOBSProtocolTypeValueChanged() throws ims.framework.exceptions.PresentationLogicException;
	...
	public final void setContext(ims.framework.UIEngine engine, GenForm form)
	{
		...
		this.form.cmbOBSProtocolType().setValueSetEvent(new ComboBoxValueSet()
		{
			private static final long serialVersionUID = 1L;
			public void handle(Object value)
			{
				oncmbOBSProtocolTypeValueSet(value);
			}
		});
		this.form.cmbOBSProtocolType().setValueChangedEvent(new ValueChanged()
		{
			private static final long serialVersionUID = 1L;
			public void handle() throws ims.framework.exceptions.PresentationLogicException
			{
				onCmbOBSProtocolTypeValueChanged();
			}
		});
	...
	{
		defaultcmbOBSProtocolTypeLookupValue();
