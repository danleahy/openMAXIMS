...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "WardAttenderDetailsDialog";
	}
	public int getWidth()
	{
		return 648;
	...
	{
		return new String[] { "_cv_Scheduling.BookingAppointmentRef", "_cv_RefMan.SelectedProceduresApptOutcomeList", "_cv_RefMan.PatientProcedureForAppointmentOutcome" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Core.WardAttenderDetailsDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
