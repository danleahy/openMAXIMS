...
abstract public class Handlers implements ims.framework.UILogic, IFormUILogicCode
{
	...
	abstract protected void onCcPatientDetailstabValueChanged() throws ims.framework.exceptions.PresentationLogicException;
	abstract protected void onCcGPDetailsValueChanged() throws ims.framework.exceptions.PresentationLogicException;
	abstract protected void onCcAdditionalDetailsValueChanged() throws ims.framework.exceptions.PresentationLogicException;
	...
	public final void setContext(ims.framework.UIEngine engine, GenForm form)
	{
		...
		this.form.lyrTabsDetails().tabPatientDetails().setTabActivatedEvent(new ims.framework.delegates.TabActivated()
		{
			private static final long serialVersionUID = 1L;
			public void handle() throws ims.framework.exceptions.PresentationLogicException
			{
				onlyrTabsDetailstabPatientDetailsActivated();
			}
		});
		this.form.lyrTabsDetails().tabGP().setTabActivatedEvent(new ims.framework.delegates.TabActivated()
		{
			private static final long serialVersionUID = 1L;
			public void handle() throws ims.framework.exceptions.PresentationLogicException
			{
				onlyrTabsDetailstabGPActivated();
			}
		});
		this.form.lyrTabsDetails().tabInsuranceDetails().setTabActivatedEvent(new ims.framework.delegates.TabActivated()
		{
			private static final long serialVersionUID = 1L;
			public void handle() throws ims.framework.exceptions.PresentationLogicException
			{
				onlyrTabsDetailstabInsuranceDetailsActivated();
			}
		});
		this.form.lyrTabsDetails().tabConsentFlags().setTabActivatedEvent(new ims.framework.delegates.TabActivated()
		{
			private static final long serialVersionUID = 1L;
			public void handle() throws ims.framework.exceptions.PresentationLogicException
			{
				onlyrTabsDetailstabConsentFlagsActivated();
			}
		});
		this.form.lyrTabsDetails().tabAdditionalDetails().setTabActivatedEvent(new ims.framework.delegates.TabActivated()
		{
			private static final long serialVersionUID = 1L;
			public void handle() throws ims.framework.exceptions.PresentationLogicException
			{
				onlyrTabsDetailstabAdditionalDetailsActivated();
			}
		});
		this.form.lyrTabsDetails().tabPatientDetails().setccPatientDetailstabValueChangedEvent(new ValueChanged()
		{
			private static final long serialVersionUID = 1L;
			public void handle() throws ims.framework.exceptions.PresentationLogicException
			{
				onCcPatientDetailstabValueChanged();
			}
		});
		this.form.lyrTabsDetails().tabGP().setccGPDetailsValueChangedEvent(new ValueChanged()
		{
			private static final long serialVersionUID = 1L;
			public void handle() throws ims.framework.exceptions.PresentationLogicException
			{
		...
		this.form.lyrTabsDetails().tabAdditionalDetails().setccAdditionalDetailstabValueChangedEvent(new ValueChanged()
		{
			private static final long serialVersionUID = 1L;
			public void handle() throws ims.framework.exceptions.PresentationLogicException
			{
				onCcAdditionalDetailsValueChanged();
			}
		});
	...
	private void onlyrTabsDetailstabPatientDetailsActivated()
	{
		this.form.lyrTabsDetails().showtabPatientDetails();
	}
	private void onlyrTabsDetailstabGPActivated()
	{
		this.form.lyrTabsDetails().showtabGP();
	}
	private void onlyrTabsDetailstabInsuranceDetailsActivated()
	{
		this.form.lyrTabsDetails().showtabInsuranceDetails();
	}
	private void onlyrTabsDetailstabConsentFlagsActivated()
	{
		this.form.lyrTabsDetails().showtabConsentFlags();
	}
	private void onlyrTabsDetailstabAdditionalDetailsActivated()
	{
		this.form.lyrTabsDetails().showtabAdditionalDetails();
	}
