...
public class GenForm extends FormBridge
{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		ims.framework.utils.SizeInfo designSize = new ims.framework.utils.SizeInfo(280, 128);
		if(runtimeSize == null)
		...
		contextMenus.Core.contextMenuAlertsCcMenuVIEWItem = factory.createMenuItem(startControlID.intValue() + 2, "View", true, false, new Integer(102223), true, false);
		if(factory.getUIEngine().getLoggedInRole().hasMenuActionRight(appForm, new ims.framework.MenuAction(4630003)))
			contextMenus.Core.contextMenuAlertsCcMenu.add(contextMenus.Core.contextMenuAlertsCcMenuVIEWItem);
		contextMenus.Core.contextMenuAlertsCcMenuEDITItem = factory.createMenuItem(startControlID.intValue() + 3, "Edit", true, false, new Integer(102150), true, false);
		...
		// Grid Controls
		RuntimeAnchoring anchoringHelper2 = new RuntimeAnchoring(designSize, runtimeSize, 8, 17, 232, 103, ims.framework.enumerations.ControlAnchoring.ALL);
		...
		RuntimeAnchoring anchoringHelper3 = new RuntimeAnchoring(designSize, runtimeSize, 248, 52, 30, 30, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
		super.addControl(factory.getControl(ImageButton.class, new Object[] { control, new Integer(startControlID.intValue() + 1002), new Integer(anchoringHelper3.getX()), new Integer(anchoringHelper3.getY()), new Integer(anchoringHelper3.getWidth()), new Integer(anchoringHelper3.getHeight()), new Integer(startTabIndex.intValue() + 4), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT, this.getImages().Core.View, this.getImages().Core.ViewDisabled, "View Alert", Boolean.FALSE, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null}));
		RuntimeAnchoring anchoringHelper4 = new RuntimeAnchoring(designSize, runtimeSize, 248, 88, 30, 30, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
		super.addControl(factory.getControl(ImageButton.class, new Object[] { control, new Integer(startControlID.intValue() + 1003), new Integer(anchoringHelper4.getX()), new Integer(anchoringHelper4.getY()), new Integer(anchoringHelper4.getWidth()), new Integer(anchoringHelper4.getHeight()), new Integer(startTabIndex.intValue() + 5), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT, this.getImages().Core.Edit, this.getImages().Core.EditDisabled, "Edit Alert", Boolean.FALSE, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null}));
		RuntimeAnchoring anchoringHelper5 = new RuntimeAnchoring(designSize, runtimeSize, 248, 16, 30, 30, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
	...
	public final class ContextMenus implements java.io.Serializable
	{
		...
		public final class CoreNamespace implements java.io.Serializable
		{
			...
			public void disableAllAlertsCcMenuMenuItems()
			{
				...
				this.contextMenuAlertsCcMenuVIEWItem.setEnabled(false);
			...
			public void hideAllAlertsCcMenuMenuItems()
			{
				...
				this.contextMenuAlertsCcMenuVIEWItem.setVisible(false);
			...
			public ReadOnlyMenuItem getAlertsCcMenuVIEWItem()
			{
				return this.contextMenuAlertsCcMenuVIEWItem;
			}
			private MenuItem contextMenuAlertsCcMenuVIEWItem;
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.AlertsCc.__internal_x_context__NoAlert_" + componentIdentifier, "BO-1003100084-ID", "ID_PatientNoAlertInfo");
			fields[145] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.AlertsCc.__internal_x_context__NoAlert_" + componentIdentifier, "BO-1003100084-PATIENT", "Patient");
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.AlertsCc.__internal_x_context__NoAlert_" + componentIdentifier, "BO-1003100084-ALERTSTATUS", "AlertStatus");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.AlertsCc.__internal_x_context__NoAlert_" + componentIdentifier, "BO-1003100084-WHENIDENTIFIED", "WhenIdentified");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.AlertsCc.__internal_x_context__NoAlert_" + componentIdentifier, "BO-1003100084-NOALERTSOURCEOFINFORMATION", "NoAlertSourceofInformation");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.AlertsCc.__internal_x_context__selectedAlert_" + componentIdentifier, "BO-1003100012-ID", "ID_PatientAlert");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.AlertsCc.__internal_x_context__selectedAlert_" + componentIdentifier, "BO-1003100012-ALERTTYPE", "AlertType");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.AlertsCc.__internal_x_context__selectedAlert_" + componentIdentifier, "BO-1003100012-ISCURRENTLYACTIVEALERT", "IsCurrentlyActiveAlert");
			fields[152] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.AlertsCc.__internal_x_context__selectedAlert_" + componentIdentifier, "BO-1003100012-SOURCEOFINFORMATION", "SourceofInformation");
			fields[153] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.AlertsCc.__internal_x_context__selectedAlert_" + componentIdentifier, "BO-1003100012-PATIENT", "Patient");
			fields[154] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.AlertsCc.__internal_x_context__selectedAlert_" + componentIdentifier, "BO-1003100012-COMMENTS", "Comments");
			fields[155] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.AlertsCc.__internal_x_context__selectedAlert_" + componentIdentifier, "BO-1003100012-DATEIDENTIFIED", "DateIdentified");
			return fields;
		}
