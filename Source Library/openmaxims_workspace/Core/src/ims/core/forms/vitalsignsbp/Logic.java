...
import ims.core.forms.vitalsignsbp.GenForm.grpShowByEnumeration;
...
public class Logic extends BaseLogic
{
	...
	protected void onFormOpen() throws FormOpenException 
	{
		...
		{
			//WDEV-19389 - start
			if (isVitalSignsBP() && form.getGlobalContext().Core.getVitalSign() == null && form.getGlobalContext().Core.getVitalSignsBPSearchCriteriaIsNotNull())
			{
				if (form.getGlobalContext().Core.getVitalSign() == null && !(form.getGlobalContext().Core.getCurrentCareContextIsNotNull() && form.getGlobalContext().Core.getCurrentCareContext().equals(form.getGlobalContext().Core.getVitalSignsBPSearchCriteria().getCareContext())))
					form.getGlobalContext().Core.setVitalSignsBPSearchCriteria(null);
				
				doSeachCriteria(form.getGlobalContext().Core.getVitalSignsBPSearchCriteria());
			}
			else if (isVitalSignsBPAlias() && form.getGlobalContext().Core.getVitalSign() == null && form.getGlobalContext().Core.getVitalSignsBPAliasSearchCriteriaIsNotNull())
			{
				if (form.getGlobalContext().Core.getVitalSign() == null && !(form.getGlobalContext().Core.getCurrentCareContextIsNotNull() && form.getGlobalContext().Core.getCurrentCareContext().equals(form.getGlobalContext().Core.getVitalSignsBPAliasSearchCriteria().getCareContext())))
					form.getGlobalContext().Core.setVitalSignsBPAliasSearchCriteria(null);
				
				doSeachCriteria(form.getGlobalContext().Core.getVitalSignsBPAliasSearchCriteria());
			}
			else
			{
				try {
	...
	private boolean isVitalSignsBP()
	{
		return engine.getFormName().equals(form.getForms().Core.VitalSignsBP);
	}

	private boolean isVitalSignsBPAlias()
	{
		return engine.getFormName().equals(form.getForms().Core.VitalSignsBPAlias);
	}
	...
	protected void onBtnViewClick() throws PresentationLogicException 
	{
		...
		if (form.getGlobalContext().Core.getVitalSign() == null )
		{
			if (isVitalSignsBP())
			{
				form.getGlobalContext().Core.setVitalSignsBPSearchCriteria(getSearchCriteria());
			}
			else if (isVitalSignsBPAlias())
			{
				form.getGlobalContext().Core.setVitalSignsBPAliasSearchCriteria(getSearchCriteria());
			}				
		}
