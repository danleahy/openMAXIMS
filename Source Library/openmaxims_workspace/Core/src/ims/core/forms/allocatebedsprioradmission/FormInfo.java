...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "AllocateBedsPriorAdmission";
	}
	public int getWidth()
	{
		return 760;
	...
	{
		return new String[] { "_cv_Core.SelectedBedSpaceState" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Core.AllocateBedsPriorAdmission.__internal_x_context__" + String.valueOf(getFormId());
	}
