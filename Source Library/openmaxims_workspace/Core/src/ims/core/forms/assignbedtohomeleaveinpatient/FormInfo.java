...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "AssignBedToHomeLeaveInpatient";
	}
	public int getWidth()
	{
		return 648;
	...
	{
		return new String[] { "_cv_Core.WardViewPatientListWard", "_cv_Core.SelectedWaitingAreaPatient", "_cv_Core.BedRuleBreachReason" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Core.AssignBedToHomeLeaveInpatient.__internal_x_context__" + String.valueOf(getFormId());
	}
