...
public class GenForm extends FormBridge
{
	...
	public static class lyrListsLayer extends Layer
	{
		...
		public static class tabPageCurrentIPContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				RuntimeAnchoring anchoringHelper1 = new RuntimeAnchoring(designSize, runtimeSize, 0, 0, 824, 568, ims.framework.enumerations.ControlAnchoring.ALL);
				...
				//ims.framework.Control m_ccCurrentIPListControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1000), new Integer(0), new Integer(0), new Integer(824), new Integer(568), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 1), m_ccCurrentIPListForm, instance1 } );
		...
		public static class tabPagePendingElectiveAdmissionsContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				// Custom Controls
				ims.framework.CustomComponent instance1 = factory.getEmptyCustomComponent();
				RuntimeAnchoring anchoringHelper2 = new RuntimeAnchoring(designSize, runtimeSize, 0, 0, 824, 568, ims.framework.enumerations.ControlAnchoring.ALL);
				ims.framework.FormUiLogic m_ccPendingForm = loader.loadComponent(102293, appForm, startControlID * 10 + 2000, anchoringHelper2.getSize(), instance1, startTabIndex.intValue() + 14, skipContextValidation);
				//ims.framework.Control m_ccPendingControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1002), new Integer(0), new Integer(0), new Integer(824), new Integer(568), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 14), m_ccPendingForm, instance1 } );
				ims.framework.Control m_ccPendingControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1003),  new Integer(anchoringHelper2.getX()), new Integer(anchoringHelper2.getY()), new Integer(anchoringHelper2.getWidth()), new Integer(anchoringHelper2.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 14), m_ccPendingForm, instance1, Boolean.FALSE } );
		...
		public static class tabElectiveListPendingElectiveAdmsContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				// Custom Controls
				ims.framework.CustomComponent instance1 = factory.getEmptyCustomComponent();
				RuntimeAnchoring anchoringHelper3 = new RuntimeAnchoring(designSize, runtimeSize, 0, 0, 824, 566, ims.framework.enumerations.ControlAnchoring.ALL);
				ims.framework.FormUiLogic m_ccPendingELForm = loader.loadComponent(102424, appForm, startControlID * 10 + 3000, anchoringHelper3.getSize(), instance1, startTabIndex.intValue() + 29, skipContextValidation);
				//ims.framework.Control m_ccPendingELControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1004), new Integer(0), new Integer(0), new Integer(824), new Integer(566), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 29), m_ccPendingELForm, instance1 } );
				ims.framework.Control m_ccPendingELControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1005),  new Integer(anchoringHelper3.getX()), new Integer(anchoringHelper3.getY()), new Integer(anchoringHelper3.getWidth()), new Integer(anchoringHelper3.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 29), m_ccPendingELForm, instance1, Boolean.FALSE } );
		...
		public static class tabPageBedStateContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				// Custom Controls
				ims.framework.CustomComponent instance1 = factory.getEmptyCustomComponent();
				RuntimeAnchoring anchoringHelper4 = new RuntimeAnchoring(designSize, runtimeSize, 0, 0, 824, 568, ims.framework.enumerations.ControlAnchoring.ALL);
				ims.framework.FormUiLogic m_ccBedStateForm = loader.loadComponent(134149, appForm, startControlID * 10 + 4000, anchoringHelper4.getSize(), instance1, startTabIndex.intValue() + 46, skipContextValidation);
				//ims.framework.Control m_ccBedStateControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1006), new Integer(0), new Integer(0), new Integer(824), new Integer(568), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 46), m_ccBedStateForm, instance1 } );
				ims.framework.Control m_ccBedStateControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1007),  new Integer(anchoringHelper4.getX()), new Integer(anchoringHelper4.getY()), new Integer(anchoringHelper4.getWidth()), new Integer(anchoringHelper4.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 46), m_ccBedStateForm, instance1, Boolean.FALSE } );
		...
		public static class tabPageRecentDischargesContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				// Custom Controls
				ims.framework.CustomComponent instance1 = factory.getEmptyCustomComponent();
				RuntimeAnchoring anchoringHelper5 = new RuntimeAnchoring(designSize, runtimeSize, 0, 0, 824, 568, ims.framework.enumerations.ControlAnchoring.ALL);
				ims.framework.FormUiLogic m_ccRecentDischargesForm = loader.loadComponent(102289, appForm, startControlID * 10 + 5000, anchoringHelper5.getSize(), instance1, startTabIndex.intValue() + 56, skipContextValidation);
				//ims.framework.Control m_ccRecentDischargesControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1008), new Integer(0), new Integer(0), new Integer(824), new Integer(568), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 56), m_ccRecentDischargesForm, instance1 } );
				ims.framework.Control m_ccRecentDischargesControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1009),  new Integer(anchoringHelper5.getX()), new Integer(anchoringHelper5.getY()), new Integer(anchoringHelper5.getWidth()), new Integer(anchoringHelper5.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 56), m_ccRecentDischargesForm, instance1, Boolean.FALSE } );
		...
		public static class tabPagePendingEmergencyAdmissionsContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				// Custom Controls
				ims.framework.CustomComponent instance1 = factory.getEmptyCustomComponent();
				RuntimeAnchoring anchoringHelper6 = new RuntimeAnchoring(designSize, runtimeSize, 0, 0, 824, 568, ims.framework.enumerations.ControlAnchoring.ALL);
				ims.framework.FormUiLogic m_ccPendingEDAdmsForm = loader.loadComponent(102292, appForm, startControlID * 10 + 6000, anchoringHelper6.getSize(), instance1, startTabIndex.intValue() + 68, skipContextValidation);
				//ims.framework.Control m_ccPendingEDAdmsControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1010), new Integer(0), new Integer(0), new Integer(824), new Integer(568), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 68), m_ccPendingEDAdmsForm, instance1 } );
				ims.framework.Control m_ccPendingEDAdmsControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1011),  new Integer(anchoringHelper6.getX()), new Integer(anchoringHelper6.getY()), new Integer(anchoringHelper6.getWidth()), new Integer(anchoringHelper6.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 68), m_ccPendingEDAdmsForm, instance1, Boolean.FALSE } );
				super.addControl(m_ccPendingEDAdmsControl);
				Menu[] menus1 = m_ccPendingEDAdmsForm.getForm().getRegisteredMenus();
				for(int x = 0; x < menus1.length; x++)
				{
					form.registerMenu(menus1[x]);
				}
			...
			public ims.core.forms.pendingemergencyadmissions.IComponent ccPendingEDAdms()
			{
			...
			public void setccPendingEDAdmsValueChangedEvent(ims.framework.delegates.ValueChanged delegate)
			{
				((CustomComponent)super.getControl(0)).setValueChangedEvent(delegate);
			}
			public void setccPendingEDAdmsVisible(boolean value)
			{
				((ims.framework.Control)super.getControl(0)).setVisible(value);
			}
			public boolean isccPendingEDAdmsVisible()
			{
				return ((ims.framework.Control)super.getControl(0)).isVisible();
			}
			public void setccPendingEDAdmsEnabled(boolean value)
			{
				((ims.framework.Control)super.getControl(0)).setEnabled(value);
			}
			public boolean isccPendingEDAdmsEnabled()
			{
				return ((ims.framework.Control)super.getControl(0)).isEnabled();
			}
		}
		public static class tabPendingEmergenciesContainer extends LayerBridge
		{
			private static final long serialVersionUID = 1L;
			public void setTabActivatedEvent(ims.framework.delegates.TabActivated delegate)
			{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				// Custom Controls
				ims.framework.CustomComponent instance1 = factory.getEmptyCustomComponent();
				RuntimeAnchoring anchoringHelper7 = new RuntimeAnchoring(designSize, runtimeSize, 0, 0, 824, 568, ims.framework.enumerations.ControlAnchoring.ALL);
				ims.framework.FormUiLogic m_ccPendingEmergenciesAdmForm = loader.loadComponent(102505, appForm, startControlID * 10 + 7000, anchoringHelper7.getSize(), instance1, startTabIndex.intValue() + 82, skipContextValidation);
				//ims.framework.Control m_ccPendingEmergenciesAdmControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1012), new Integer(0), new Integer(0), new Integer(824), new Integer(568), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 82), m_ccPendingEmergenciesAdmForm, instance1 } );
				ims.framework.Control m_ccPendingEmergenciesAdmControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1013),  new Integer(anchoringHelper7.getX()), new Integer(anchoringHelper7.getY()), new Integer(anchoringHelper7.getWidth()), new Integer(anchoringHelper7.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 82), m_ccPendingEmergenciesAdmForm, instance1, Boolean.FALSE } );
				super.addControl(m_ccPendingEmergenciesAdmControl);
				Menu[] menus1 = m_ccPendingEmergenciesAdmForm.getForm().getRegisteredMenus();
				for(int x = 0; x < menus1.length; x++)
				{
					form.registerMenu(menus1[x]);
				}
			...
			public ims.core.forms.pendingemergencies.IComponent ccPendingEmergenciesAdm()
			{
				return (ims.core.forms.pendingemergencies.IComponent)((ims.framework.cn.controls.CustomComponent)super.getControl(0)).getLogic();
			}
			public void setccPendingEmergenciesAdmValueChangedEvent(ims.framework.delegates.ValueChanged delegate)
			{
				((CustomComponent)super.getControl(0)).setValueChangedEvent(delegate);
			}
			public void setccPendingEmergenciesAdmVisible(boolean value)
			{
				((ims.framework.Control)super.getControl(0)).setVisible(value);
			}
			public boolean isccPendingEmergenciesAdmVisible()
			{
				return ((ims.framework.Control)super.getControl(0)).isVisible();
			}
			public void setccPendingEmergenciesAdmEnabled(boolean value)
			{
				((ims.framework.Control)super.getControl(0)).setEnabled(value);
			}
			public boolean isccPendingEmergenciesAdmEnabled()
			{
				return ((ims.framework.Control)super.getControl(0)).isEnabled();
			}
		}
		public static class tabPendingEmergencyTheatreContainer extends LayerBridge
		{
			private static final long serialVersionUID = 1L;
			public void setTabActivatedEvent(ims.framework.delegates.TabActivated delegate)
			{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				// Custom Controls
				ims.framework.CustomComponent instance1 = factory.getEmptyCustomComponent();
				RuntimeAnchoring anchoringHelper8 = new RuntimeAnchoring(designSize, runtimeSize, 0, 0, 824, 566, ims.framework.enumerations.ControlAnchoring.ALL);
				ims.framework.FormUiLogic m_ccPendingEmergencyTheatreAdmForm = loader.loadComponent(102506, appForm, startControlID * 10 + 8000, anchoringHelper8.getSize(), instance1, startTabIndex.intValue() + 99, skipContextValidation);
				//ims.framework.Control m_ccPendingEmergencyTheatreAdmControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1014), new Integer(0), new Integer(0), new Integer(824), new Integer(566), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 99), m_ccPendingEmergencyTheatreAdmForm, instance1 } );
				ims.framework.Control m_ccPendingEmergencyTheatreAdmControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1015),  new Integer(anchoringHelper8.getX()), new Integer(anchoringHelper8.getY()), new Integer(anchoringHelper8.getWidth()), new Integer(anchoringHelper8.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 99), m_ccPendingEmergencyTheatreAdmForm, instance1, Boolean.FALSE } );
				super.addControl(m_ccPendingEmergencyTheatreAdmControl);
				Menu[] menus1 = m_ccPendingEmergencyTheatreAdmForm.getForm().getRegisteredMenus();
				for(int x = 0; x < menus1.length; x++)
				{
					form.registerMenu(menus1[x]);
				}
			...
			public ims.core.forms.pendingemergencytheatreworklist.IComponent ccPendingEmergencyTheatreAdm()
			{
				return (ims.core.forms.pendingemergencytheatreworklist.IComponent)((ims.framework.cn.controls.CustomComponent)super.getControl(0)).getLogic();
			}
			public void setccPendingEmergencyTheatreAdmValueChangedEvent(ims.framework.delegates.ValueChanged delegate)
			{
				((CustomComponent)super.getControl(0)).setValueChangedEvent(delegate);
			}
			public void setccPendingEmergencyTheatreAdmVisible(boolean value)
			{
				((ims.framework.Control)super.getControl(0)).setVisible(value);
			}
			public boolean isccPendingEmergencyTheatreAdmVisible()
			{
				return ((ims.framework.Control)super.getControl(0)).isVisible();
			}
			public void setccPendingEmergencyTheatreAdmEnabled(boolean value)
			{
				((ims.framework.Control)super.getControl(0)).setEnabled(value);
			}
			public boolean isccPendingEmergencyTheatreAdmEnabled()
			{
				return ((ims.framework.Control)super.getControl(0)).isEnabled();
			}
		}
		public static class tabPageTransfersContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				// Custom Controls
				ims.framework.CustomComponent instance1 = factory.getEmptyCustomComponent();
				RuntimeAnchoring anchoringHelper9 = new RuntimeAnchoring(designSize, runtimeSize, 0, 0, 824, 568, ims.framework.enumerations.ControlAnchoring.ALL);
				ims.framework.FormUiLogic m_ccTransfersForm = loader.loadComponent(102290, appForm, startControlID * 10 + 9000, anchoringHelper9.getSize(), instance1, startTabIndex.intValue() + 114, skipContextValidation);
				//ims.framework.Control m_ccTransfersControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1016), new Integer(0), new Integer(0), new Integer(824), new Integer(568), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 114), m_ccTransfersForm, instance1 } );
				ims.framework.Control m_ccTransfersControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1017),  new Integer(anchoringHelper9.getX()), new Integer(anchoringHelper9.getY()), new Integer(anchoringHelper9.getWidth()), new Integer(anchoringHelper9.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 114), m_ccTransfersForm, instance1, Boolean.FALSE } );
		...
		public static class tabPagePendingDischargesContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				// Custom Controls
				ims.framework.CustomComponent instance1 = factory.getEmptyCustomComponent();
				RuntimeAnchoring anchoringHelper10 = new RuntimeAnchoring(designSize, runtimeSize, 0, 0, 824, 568, ims.framework.enumerations.ControlAnchoring.ALL);
				ims.framework.FormUiLogic m_cc1Form = loader.loadComponent(102296, appForm, startControlID * 10 + 10000, anchoringHelper10.getSize(), instance1, startTabIndex.intValue() + 130, skipContextValidation);
				//ims.framework.Control m_cc1Control = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1018), new Integer(0), new Integer(0), new Integer(824), new Integer(568), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 130), m_cc1Form, instance1 } );
				ims.framework.Control m_cc1Control = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1019),  new Integer(anchoringHelper10.getX()), new Integer(anchoringHelper10.getY()), new Integer(anchoringHelper10.getWidth()), new Integer(anchoringHelper10.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 130), m_cc1Form, instance1, Boolean.FALSE } );
		...
		protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
		{
			...
			if(startTabIndex == null)
				throw new RuntimeException("Invalid startTabIndex");
			RuntimeAnchoring anchoringHelper11 = new RuntimeAnchoring(designSize, runtimeSize, 8, 8, 832, 592, ims.framework.enumerations.ControlAnchoring.ALL);
			Container m_tabPageCurrentIP = (Container)factory.getControl(Container.class, new Object[] { control, new Integer(startControlID.intValue() + 1020), new Integer(anchoringHelper11.getX()), new Integer(anchoringHelper11.getY()), new Integer(anchoringHelper11.getWidth()), new Integer(anchoringHelper11.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL,"Current Inpat.", new Integer(startControlID.intValue() + 0), new Boolean(true), new Boolean(true), new Boolean(true), new Boolean(true), new Boolean(true), new Boolean(false)});
			...
			ims.framework.utils.SizeInfo m_tabPageCurrentIPDesignSize = new ims.framework.utils.SizeInfo(832, 592);
			ims.framework.utils.SizeInfo m_tabPageCurrentIPRuntimeSize = new ims.framework.utils.SizeInfo(anchoringHelper11.getWidth(), anchoringHelper11.getHeight());
			...
			ims.framework.utils.SizeInfo m_tabPagePendingElectiveAdmissionsDesignSize = new ims.framework.utils.SizeInfo(832, 592);
			ims.framework.utils.SizeInfo m_tabPagePendingElectiveAdmissionsRuntimeSize = new ims.framework.utils.SizeInfo(anchoringHelper12.getWidth(), anchoringHelper12.getHeight());
			...
			RuntimeAnchoring anchoringHelper13 = new RuntimeAnchoring(designSize, runtimeSize, 8, 8, 832, 592, ims.framework.enumerations.ControlAnchoring.ALL);
			Container m_tabElectiveListPendingElectiveAdms = (Container)factory.getControl(Container.class, new Object[] { control, new Integer(startControlID.intValue() + 1022), new Integer(anchoringHelper13.getX()), new Integer(anchoringHelper13.getY()), new Integer(anchoringHelper13.getWidth()), new Integer(anchoringHelper13.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL,"Pending Elective TCIs", new Integer(startControlID.intValue() + 0), new Boolean(false), new Boolean(true), new Boolean(true), new Boolean(true), new Boolean(true), new Boolean(false)});
			...
			ims.framework.utils.SizeInfo m_tabElectiveListPendingElectiveAdmsDesignSize = new ims.framework.utils.SizeInfo(832, 592);
			ims.framework.utils.SizeInfo m_tabElectiveListPendingElectiveAdmsRuntimeSize = new ims.framework.utils.SizeInfo(anchoringHelper13.getWidth(), anchoringHelper13.getHeight());
			...
			RuntimeAnchoring anchoringHelper14 = new RuntimeAnchoring(designSize, runtimeSize, 8, 8, 832, 592, ims.framework.enumerations.ControlAnchoring.ALL);
			...
			ims.framework.utils.SizeInfo m_tabPageBedStateDesignSize = new ims.framework.utils.SizeInfo(832, 592);
			ims.framework.utils.SizeInfo m_tabPageBedStateRuntimeSize = new ims.framework.utils.SizeInfo(anchoringHelper14.getWidth(), anchoringHelper14.getHeight());
			...
			RuntimeAnchoring anchoringHelper15 = new RuntimeAnchoring(designSize, runtimeSize, 8, 8, 832, 592, ims.framework.enumerations.ControlAnchoring.ALL);
			...
			ims.framework.utils.SizeInfo m_tabPageRecentDischargesDesignSize = new ims.framework.utils.SizeInfo(832, 592);
			ims.framework.utils.SizeInfo m_tabPageRecentDischargesRuntimeSize = new ims.framework.utils.SizeInfo(anchoringHelper15.getWidth(), anchoringHelper15.getHeight());
			...
			RuntimeAnchoring anchoringHelper16 = new RuntimeAnchoring(designSize, runtimeSize, 8, 8, 832, 592, ims.framework.enumerations.ControlAnchoring.ALL);
			Container m_tabPagePendingEmergencyAdmissions = (Container)factory.getControl(Container.class, new Object[] { control, new Integer(startControlID.intValue() + 1025), new Integer(anchoringHelper16.getX()), new Integer(anchoringHelper16.getY()), new Integer(anchoringHelper16.getWidth()), new Integer(anchoringHelper16.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL,"Pending ED", new Integer(startControlID.intValue() + 0), new Boolean(false), new Boolean(true), new Boolean(true), new Boolean(true), new Boolean(true), new Boolean(false)});
			...
			ims.framework.utils.SizeInfo m_tabPagePendingEmergencyAdmissionsDesignSize = new ims.framework.utils.SizeInfo(832, 592);
			ims.framework.utils.SizeInfo m_tabPagePendingEmergencyAdmissionsRuntimeSize = new ims.framework.utils.SizeInfo(anchoringHelper16.getWidth(), anchoringHelper16.getHeight());
			...
			RuntimeAnchoring anchoringHelper17 = new RuntimeAnchoring(designSize, runtimeSize, 8, 8, 832, 592, ims.framework.enumerations.ControlAnchoring.ALL);
			Container m_tabPendingEmergencies = (Container)factory.getControl(Container.class, new Object[] { control, new Integer(startControlID.intValue() + 1026), new Integer(anchoringHelper17.getX()), new Integer(anchoringHelper17.getY()), new Integer(anchoringHelper17.getWidth()), new Integer(anchoringHelper17.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL,"Pending Emer.", new Integer(startControlID.intValue() + 0), new Boolean(false), new Boolean(true), new Boolean(true), new Boolean(true), new Boolean(true), new Boolean(false)});
			tabPendingEmergenciesContainer m_tabPendingEmergenciesContainer = (tabPendingEmergenciesContainer)LayerBridgeFlyweightFactory.getInstance().createLayerBridge(tabPendingEmergenciesContainer.class, m_tabPendingEmergencies, factory);
			super.addContainer(m_tabPendingEmergencies, m_tabPendingEmergenciesContainer);
			ims.framework.utils.SizeInfo m_tabPendingEmergenciesDesignSize = new ims.framework.utils.SizeInfo(832, 592);
			ims.framework.utils.SizeInfo m_tabPendingEmergenciesRuntimeSize = new ims.framework.utils.SizeInfo(anchoringHelper17.getWidth(), anchoringHelper17.getHeight());
			m_tabPendingEmergenciesContainer.setContext(form, appForm, m_tabPendingEmergencies, loader, startControlID, m_tabPendingEmergenciesDesignSize, m_tabPendingEmergenciesRuntimeSize, startTabIndex, skipContextValidation);
			RuntimeAnchoring anchoringHelper18 = new RuntimeAnchoring(designSize, runtimeSize, 8, 8, 832, 592, ims.framework.enumerations.ControlAnchoring.ALL);
			Container m_tabPendingEmergencyTheatre = (Container)factory.getControl(Container.class, new Object[] { control, new Integer(startControlID.intValue() + 1027), new Integer(anchoringHelper18.getX()), new Integer(anchoringHelper18.getY()), new Integer(anchoringHelper18.getWidth()), new Integer(anchoringHelper18.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL,"Pending Emer. Theatre", new Integer(startControlID.intValue() + 0), new Boolean(false), new Boolean(true), new Boolean(true), new Boolean(true), new Boolean(true), new Boolean(false)});
			tabPendingEmergencyTheatreContainer m_tabPendingEmergencyTheatreContainer = (tabPendingEmergencyTheatreContainer)LayerBridgeFlyweightFactory.getInstance().createLayerBridge(tabPendingEmergencyTheatreContainer.class, m_tabPendingEmergencyTheatre, factory);
			super.addContainer(m_tabPendingEmergencyTheatre, m_tabPendingEmergencyTheatreContainer);
			ims.framework.utils.SizeInfo m_tabPendingEmergencyTheatreDesignSize = new ims.framework.utils.SizeInfo(832, 592);
			ims.framework.utils.SizeInfo m_tabPendingEmergencyTheatreRuntimeSize = new ims.framework.utils.SizeInfo(anchoringHelper18.getWidth(), anchoringHelper18.getHeight());
			m_tabPendingEmergencyTheatreContainer.setContext(form, appForm, m_tabPendingEmergencyTheatre, loader, startControlID, m_tabPendingEmergencyTheatreDesignSize, m_tabPendingEmergencyTheatreRuntimeSize, startTabIndex, skipContextValidation);
			RuntimeAnchoring anchoringHelper19 = new RuntimeAnchoring(designSize, runtimeSize, 8, 8, 832, 592, ims.framework.enumerations.ControlAnchoring.ALL);
			...
			ims.framework.utils.SizeInfo m_tabPageTransfersDesignSize = new ims.framework.utils.SizeInfo(832, 592);
			ims.framework.utils.SizeInfo m_tabPageTransfersRuntimeSize = new ims.framework.utils.SizeInfo(anchoringHelper19.getWidth(), anchoringHelper19.getHeight());
			...
			RuntimeAnchoring anchoringHelper20 = new RuntimeAnchoring(designSize, runtimeSize, 8, 8, 832, 592, ims.framework.enumerations.ControlAnchoring.ALL);
			...
			ims.framework.utils.SizeInfo m_tabPagePendingDischargesDesignSize = new ims.framework.utils.SizeInfo(832, 592);
			ims.framework.utils.SizeInfo m_tabPagePendingDischargesRuntimeSize = new ims.framework.utils.SizeInfo(anchoringHelper20.getWidth(), anchoringHelper20.getHeight());
		...
		public void hide()
		{
			...
			tabPendingEmergencies().setVisible(false);
			tabPendingEmergencyTheatre().setVisible(false);
		...
		public void settabPendingEmergenciesEnabled(boolean value)
		{
			tabPendingEmergencies().setEnabled(value);
		}
		public void settabPendingEmergencyTheatreEnabled(boolean value)
		{
			tabPendingEmergencyTheatre().setEnabled(value);
		}
		...
		public void showtabPendingEmergencies()
		{
			tabPageCurrentIP().setVisible(false);
			tabPagePendingElectiveAdmissions().setVisible(false);
			tabElectiveListPendingElectiveAdms().setVisible(false);
			...
			tabPageTransfers().setVisible(false);
			tabPagePendingDischarges().setVisible(false);
			tabPendingEmergencies().setVisible(true);
		}
		public void showtabPendingEmergencyTheatre()
		{
			tabPageCurrentIP().setVisible(false);
			tabPagePendingElectiveAdmissions().setVisible(false);
			tabElectiveListPendingElectiveAdms().setVisible(false);
			...
			tabPageTransfers().setVisible(false);
			tabPagePendingDischarges().setVisible(false);
			tabPendingEmergencyTheatre().setVisible(true);
		}
		...
		public tabPendingEmergenciesContainer tabPendingEmergencies()
		{
			return (tabPendingEmergenciesContainer)super.layers.get(6);
		}
		public tabPendingEmergencyTheatreContainer tabPendingEmergencyTheatre()
		{
			return (tabPendingEmergencyTheatreContainer)super.layers.get(7);
		}
		public tabPageTransfersContainer tabPageTransfers()
		{
			return (tabPageTransfersContainer)super.layers.get(8);
		}
		public tabPagePendingDischargesContainer tabPagePendingDischarges()
		{
			return (tabPagePendingDischargesContainer)super.layers.get(9);
		}
	}
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		// Button Controls
		RuntimeAnchoring anchoringHelper21 = new RuntimeAnchoring(designSize, runtimeSize, 672, 604, 168, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT);
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1030), new Integer(anchoringHelper21.getX()), new Integer(anchoringHelper21.getY()), new Integer(anchoringHelper21.getWidth()), new Integer(anchoringHelper21.getHeight()), new Integer(startTabIndex.intValue() + 145), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Bed Management Dashboard", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
	}
