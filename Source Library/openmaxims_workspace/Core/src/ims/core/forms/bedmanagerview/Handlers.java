...
abstract public class Handlers implements ims.framework.UILogic, IFormUILogicCode
{
	...
	abstract protected void onCcPendingEDAdmsValueChanged() throws ims.framework.exceptions.PresentationLogicException;
	...
	public final void setContext(ims.framework.UIEngine engine, GenForm form)
	{
		...
		this.form.lyrLists().tabPendingEmergencies().setTabActivatedEvent(new ims.framework.delegates.TabActivated()
		{
			private static final long serialVersionUID = 1L;
			public void handle() throws ims.framework.exceptions.PresentationLogicException
			{
				onlyrListstabPendingEmergenciesActivated();
			}
		});
		this.form.lyrLists().tabPendingEmergencyTheatre().setTabActivatedEvent(new ims.framework.delegates.TabActivated()
		{
			private static final long serialVersionUID = 1L;
			public void handle() throws ims.framework.exceptions.PresentationLogicException
			{
				onlyrListstabPendingEmergencyTheatreActivated();
			}
		});
		...
		this.form.lyrLists().tabPagePendingEmergencyAdmissions().setccPendingEDAdmsValueChangedEvent(new ValueChanged()
		{
			private static final long serialVersionUID = 1L;
			public void handle() throws ims.framework.exceptions.PresentationLogicException
			{
				onCcPendingEDAdmsValueChanged();
			}
		});
	...
	private void onlyrListstabPendingEmergenciesActivated()
	{
		this.form.lyrLists().showtabPendingEmergencies();
		onlyrListsTabChanged(this.form.lyrLists().tabPendingEmergencies());
	}
	private void onlyrListstabPendingEmergencyTheatreActivated()
	{
		this.form.lyrLists().showtabPendingEmergencyTheatre();
		onlyrListsTabChanged(this.form.lyrLists().tabPendingEmergencyTheatre());
	}
