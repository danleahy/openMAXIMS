...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "WardViewPatientSummaryComponent";
	}
	public int getWidth()
	{
		return 456;
	...
	{
		return new String[] { "_cv_Core.MaleBedAdmissionWardCount", "_cv_Core.FemaleBedAdmissionWardCount", "_cv_Core.WardViewPatientListWard", "_cv_Core.WardViewPatientListBay" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Core.WardViewPatientSummaryComponent.__internal_x_context__" + String.valueOf(getFormId());
	}
