...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "AdditionalDetailsInDemographicsCC";
	}
	public int getWidth()
	{
		return 420;
	...
	{
		return new String[] { "_cv_Core.CommentDialogString", "_cv_Core.CommentDialogReadOnly", "_cv_Core.CommentDialogTitle" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Core.AdditionalDetailsInDemographicsCC.__internal_x_context__" + String.valueOf(getFormId());
	}
