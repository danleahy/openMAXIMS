...
abstract public class Handlers implements ims.framework.UILogic, IFormUILogicCode
{
	...
	public final void setContext(ims.framework.UIComponentEngine engine, GenForm form)
	{
		...
		this.form.cmbHomeFolder().setValueSetEvent(new ComboBoxValueSet()
		{
			private static final long serialVersionUID = 1L;
		...
		this.form.btnFolderComment().setClickEvent(new Click()
		{
			private static final long serialVersionUID = 1L;
		...
		this.form.btnOITRetrieve().setClickEvent(new Click()
		{
			private static final long serialVersionUID = 1L;
			public void handle() throws ims.framework.exceptions.PresentationLogicException
			{
		...
		this.form.btnOITUpload().setClickEvent(new Click()
		{
			private static final long serialVersionUID = 1L;
			public void handle() throws ims.framework.exceptions.PresentationLogicException
			{
