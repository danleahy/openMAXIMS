...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "AdmissionGenderWarningDialog";
	}
	public int getWidth()
	{
		return 568;
	...
	{
		return new String[] { "_cv_Core.AdmissionValidationMessage", "_cv_Core.BedRuleBreachReason" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Core.AdmissionGenderWarningDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
