...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Core.CaseFolderChange", "_cv_Core.CurrentCaseFolderLocation" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Core.CaseNoteTransferDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
