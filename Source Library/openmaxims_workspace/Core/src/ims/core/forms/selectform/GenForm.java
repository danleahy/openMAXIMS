...
public class GenForm extends FormBridge
{
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, "_cv_ICP.LinkedForm", "BO-1021100001-ID", "ID_AppForm");
			fields[145] = new ims.framework.ReportField(this.context, "_cv_ICP.LinkedForm", "BO-1021100001-NAME", "Name");
			fields[146] = new ims.framework.ReportField(this.context, "_cv_ICP.LinkedForm", "BO-1021100001-ALIASNAME", "AliasName");
			fields[147] = new ims.framework.ReportField(this.context, "_cv_ICP.LinkedForm", "BO-1021100001-CAPTION", "Caption");
			fields[148] = new ims.framework.ReportField(this.context, "_cv_ICP.LinkedForm", "BO-1021100001-ISDIALOG", "IsDialog");
			fields[149] = new ims.framework.ReportField(this.context, "_cv_ICP.LinkedForm", "BO-1021100001-ISALIAS", "IsAlias");
			fields[150] = new ims.framework.ReportField(this.context, "_cv_ICP.LinkedForm", "BO-1021100001-ISCOMPONENT", "IsComponent");
			fields[151] = new ims.framework.ReportField(this.context, "_cv_ICP.LinkedForm", "BO-1021100001-DESCRIPTION", "Description");
			fields[152] = new ims.framework.ReportField(this.context, "_cv_ICP.LinkedForm", "BO-1021100001-CANBEINNAVIGATION", "CanBeInNavigation");
			fields[153] = new ims.framework.ReportField(this.context, "_cv_ICP.LinkedForm", "BO-1021100001-CANBEINTOPBUTTONS", "CanBeInTopButtons");
			fields[154] = new ims.framework.ReportField(this.context, "_cv_ICP.LinkedForm", "BO-1021100001-LOGICCLASS", "LogicClass");
			fields[155] = new ims.framework.ReportField(this.context, "_cv_ICP.LinkedForm", "BO-1021100001-ACCESSCLASS", "AccessClass");
			fields[156] = new ims.framework.ReportField(this.context, "_cv_ICP.LinkedForm", "BO-1021100001-DOMAINCLASS", "DomainImpl");
			fields[157] = new ims.framework.ReportField(this.context, "_cv_ICP.LinkedForm", "BO-1021100001-HELPLINK", "HelpLink");
			fields[158] = new ims.framework.ReportField(this.context, "_cv_ICP.LinkedForm", "BO-1021100001-RIEBOCLASSNAME", "RieBoClassName");
			fields[159] = new ims.framework.ReportField(this.context, "_cv_ICP.LinkedForm", "BO-1021100001-ISSYSTEM", "IsSystem");
			fields[160] = new ims.framework.ReportField(this.context, "_cv_ICP.LinkedForm", "BO-1021100001-INFORMATIONBARVISIBLE", "InformationBarVisible");
			return fields;
		}
