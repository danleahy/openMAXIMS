...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Core.SpecimenWorkListItemsForPrint" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Core.PrintMultipleOrders.__internal_x_context__" + String.valueOf(getFormId());
	}
