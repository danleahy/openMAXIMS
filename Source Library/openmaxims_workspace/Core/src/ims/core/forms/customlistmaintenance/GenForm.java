...
public class GenForm extends FormBridge
{
	...
	public static class lyrCustomListSearchLayer extends Layer
	{
		...
		public static class tabCustomListSearchContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				ims.framework.FormUiLogic m_customControlMosForm = loader.loadComponent(102256, appForm, startControlID * 10 + 1000, anchoringHelper2.getSize(), instance1, startTabIndex.intValue() + 6, skipContextValidation);
				//ims.framework.Control m_customControlMosControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1001), new Integer(456), new Integer(56), new Integer(240), new Integer(20), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT, new Integer(startTabIndex.intValue() + 6), m_customControlMosForm, instance1 } );
				ims.framework.Control m_customControlMosControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1002),  new Integer(anchoringHelper2.getX()), new Integer(anchoringHelper2.getY()), new Integer(anchoringHelper2.getWidth()), new Integer(anchoringHelper2.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT, new Integer(startTabIndex.intValue() + 6), m_customControlMosForm, instance1, Boolean.FALSE } );
				...
				Grid m_grdPatientsTemp = (Grid)factory.getControl(Grid.class, new Object[] { control, new Integer(startControlID.intValue() + 1013), new Integer(anchoringHelper13.getX()), new Integer(anchoringHelper13.getY()), new Integer(anchoringHelper13.getWidth()), new Integer(anchoringHelper13.getHeight()), new Integer(startTabIndex.intValue() + 11), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL,Boolean.TRUE, Boolean.FALSE, new Integer(24), Boolean.TRUE, contextMenus.Core.contextMenuCustomList, Boolean.FALSE, Boolean.FALSE, new Integer(0), null, Boolean.FALSE, Boolean.TRUE});
				...
				super.addControl(factory.getControl(ImageButton.class, new Object[] { control, new Integer(startControlID.intValue() + 1014), new Integer(anchoringHelper14.getX()), new Integer(anchoringHelper14.getY()), new Integer(anchoringHelper14.getWidth()), new Integer(anchoringHelper14.getHeight()), new Integer(startTabIndex.intValue() + 10), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT, form_images_local.Core.ClearEnabled24, form_images_local.Core.ClearDisabled24, null, Boolean.FALSE, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null}));
				...
				super.addControl(factory.getControl(ImageButton.class, new Object[] { control, new Integer(startControlID.intValue() + 1015), new Integer(anchoringHelper15.getX()), new Integer(anchoringHelper15.getY()), new Integer(anchoringHelper15.getWidth()), new Integer(anchoringHelper15.getHeight()), new Integer(startTabIndex.intValue() + 9), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT, form_images_local.Core.FindEnabled24, form_images_local.Core.FindDisabled24, null, Boolean.FALSE, Boolean.TRUE, Boolean.TRUE, Boolean.FALSE, null}));
			}
		...
		public static class tabCustomListDetailsContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				ims.framework.FormUiLogic m_customControlMosDetailsForm = loader.loadComponent(102256, appForm, startControlID * 10 + 2000, anchoringHelper18.getSize(), instance1, startTabIndex.intValue() + 16, skipContextValidation);
				//ims.framework.Control m_customControlMosDetailsControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1018), new Integer(456), new Integer(56), new Integer(328), new Integer(20), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT, new Integer(startTabIndex.intValue() + 16), m_customControlMosDetailsForm, instance1 } );
				ims.framework.Control m_customControlMosDetailsControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1019),  new Integer(anchoringHelper18.getX()), new Integer(anchoringHelper18.getY()), new Integer(anchoringHelper18.getWidth()), new Integer(anchoringHelper18.getHeight()), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT, new Integer(startTabIndex.intValue() + 16), m_customControlMosDetailsForm, instance1, Boolean.FALSE } );
				...
				super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1032), new Integer(anchoringHelper31.getX()), new Integer(anchoringHelper31.getY()), new Integer(anchoringHelper31.getWidth()), new Integer(anchoringHelper31.getHeight()), new Integer(startTabIndex.intValue() + 20), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.FALSE, new Integer(0), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
				...
				super.addControl(factory.getControl(DateControl.class, new Object[] { control, new Integer(startControlID.intValue() + 1035), new Integer(anchoringHelper34.getX()), new Integer(anchoringHelper34.getY()), new Integer(anchoringHelper34.getWidth()), new Integer(anchoringHelper34.getHeight()), new Integer(startTabIndex.intValue() + 15), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.TRUE, null, Boolean.FALSE, null, Boolean.TRUE, null}));
				...
				ComboBox m_cmbListTypeDetailsTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1038), new Integer(anchoringHelper37.getX()), new Integer(anchoringHelper37.getY()), new Integer(anchoringHelper37.getWidth()), new Integer(anchoringHelper37.getHeight()), new Integer(startTabIndex.intValue() + 12), ControlState.DISABLED, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.TRUE, new Integer(-1)});
				...
				super.addControl(factory.getControl(CheckBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1039), new Integer(anchoringHelper38.getX()), new Integer(anchoringHelper38.getY()), new Integer(anchoringHelper38.getWidth()), new Integer(anchoringHelper38.getHeight()), new Integer(startTabIndex.intValue() + 18), ControlState.DISABLED, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,"Active", Boolean.FALSE, null}));
				...
				super.addControl(factory.getControl(ImageButton.class, new Object[] { control, new Integer(startControlID.intValue() + 1044), new Integer(anchoringHelper43.getX()), new Integer(anchoringHelper43.getY()), new Integer(anchoringHelper43.getWidth()), new Integer(anchoringHelper43.getHeight()), new Integer(startTabIndex.intValue() + 26), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, form_images_local.Admin.LeftArrowEnabled24, form_images_local.Admin.LeftArrowDisabled24, "Remove patient from Custom List", Boolean.FALSE, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null}));
				...
				super.addControl(factory.getControl(ImageButton.class, new Object[] { control, new Integer(startControlID.intValue() + 1045), new Integer(anchoringHelper44.getX()), new Integer(anchoringHelper44.getY()), new Integer(anchoringHelper44.getWidth()), new Integer(anchoringHelper44.getHeight()), new Integer(startTabIndex.intValue() + 25), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, form_images_local.Admin.RightArrowEnabled24, form_images_local.Admin.RightArrowDisabled24, "Add patient to Custom List", Boolean.FALSE, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null}));
	...
	private void validateContext(ims.framework.Context context)
	{
		if(context == null)
			return;
		if(!context.isValidContextType(ims.core.vo.CustomListMaintenanceSearchCriteriaVo.class))
			throw new ims.framework.exceptions.CodingRuntimeException("The type 'ims.core.vo.CustomListMaintenanceSearchCriteriaVo' of the global context variable 'Core.CustomListMaintenanceSearchCriteria' is not supported.");
	}
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1049), new Integer(anchoringHelper48.getX()), new Integer(anchoringHelper48.getY()), new Integer(anchoringHelper48.getWidth()), new Integer(anchoringHelper48.getHeight()), new Integer(startTabIndex.intValue() + 28), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Edit", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1051), new Integer(anchoringHelper50.getX()), new Integer(anchoringHelper50.getY()), new Integer(anchoringHelper50.getWidth()), new Integer(anchoringHelper50.getHeight()), new Integer(startTabIndex.intValue() + 30), ControlState.HIDDEN, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Cancel", Boolean.FALSE, null, Boolean.FALSE, Boolean.FALSE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
	}
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.CustomListMaintenance.__internal_x_context__SelectedPatient_" + componentIdentifier, "BO-1001100000-ID", "ID_Patient");
			fields[145] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.CustomListMaintenance.__internal_x_context__SelectedPatient_" + componentIdentifier, "BO-1001100000-SEX", "Sex");
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.CustomListMaintenance.__internal_x_context__SelectedPatient_" + componentIdentifier, "BO-1001100000-DOB", "Dob");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.CustomListMaintenance.__internal_x_context__SelectedPatient_" + componentIdentifier, "BO-1001100000-DOD", "Dod");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.CustomListMaintenance.__internal_x_context__SelectedPatient_" + componentIdentifier, "BO-1001100000-RELIGION", "Religion");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.CustomListMaintenance.__internal_x_context__SelectedPatient_" + componentIdentifier, "BO-1001100000-ISACTIVE", "IsActive");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.CustomListMaintenance.__internal_x_context__SelectedPatient_" + componentIdentifier, "BO-1001100000-ETHNICORIGIN", "EthnicOrigin");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.CustomListMaintenance.__internal_x_context__SelectedPatient_" + componentIdentifier, "BO-1001100000-MARITALSTATUS", "MaritalStatus");
			fields[152] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.CustomListMaintenance.__internal_x_context__SelectedPatient_" + componentIdentifier, "BO-1001100000-SCN", "SCN");
			fields[153] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.CustomListMaintenance.__internal_x_context__SelectedPatient_" + componentIdentifier, "BO-1001100000-SOURCEOFINFORMATION", "SourceOfInformation");
			fields[154] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.CustomListMaintenance.__internal_x_context__SelectedPatient_" + componentIdentifier, "BO-1001100000-TIMEOFDEATH", "TimeOfDeath");
			fields[155] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.CustomListMaintenance.__internal_x_context__SelectedPatient_" + componentIdentifier, "BO-1001100000-ISQUICKREGISTRATIONPATIENT", "IsQuickRegistrationPatient");
			fields[156] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.CustomListMaintenance.__internal_x_context__SelectedPatient_" + componentIdentifier, "BO-1001100000-CURRENTRESPONSIBLECONSULTANT", "CurrentResponsibleConsultant");
			fields[157] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.CustomListMaintenance.__internal_x_context__SelectedPatient_" + componentIdentifier, "BO-1001100000-DEMENTIABREACHDATETIME", "DementiaBreachDateTime");
			fields[158] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.CustomListMaintenance.__internal_x_context__SelectedPatient_" + componentIdentifier, "BO-1001100000-DEMENTIAWORKLISTSTATUS", "DementiaWorklistStatus");
			fields[159] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.CustomListMaintenance.__internal_x_context__SelectedPatient_" + componentIdentifier, "BO-1001100000-MRNSTATUS", "MRNStatus");
			fields[160] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.CustomListMaintenance.__internal_x_context__SelectedPatient_" + componentIdentifier, "BO-1001100000-HASSCANNEDCASENOTEFOLDERS", "HasScannedCaseNoteFolders");
			fields[161] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.CustomListMaintenance.__internal_x_context__SelectedPatient_" + componentIdentifier, "BO-1001100000-ISCONFIDENTIAL", "IsConfidential");
			fields[162] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.CustomListMaintenance.__internal_x_context__SelectedPatient_" + componentIdentifier, "BO-1001100000-TIMEOFBIRTH", "TimeOfBirth");
			fields[163] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.CustomListMaintenance.__internal_x_context__SelectedPatient_" + componentIdentifier, "BO-1001100000-PATIENTCATEGORY", "PatientCategory");
			fields[164] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.CustomListMaintenance.__internal_x_context__SelectedCustomList_" + componentIdentifier, "BO-1028100050-ID", "ID_CustomList");
			fields[165] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.CustomListMaintenance.__internal_x_context__SelectedCustomList_" + componentIdentifier, "BO-1028100050-LISTTYPE", "ListType");
			fields[166] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.CustomListMaintenance.__internal_x_context__SelectedCustomList_" + componentIdentifier, "BO-1028100050-LISTNAME", "ListName");
			fields[167] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.CustomListMaintenance.__internal_x_context__SelectedCustomList_" + componentIdentifier, "BO-1028100050-SPECIALTY", "Specialty");
			fields[168] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.CustomListMaintenance.__internal_x_context__SelectedCustomList_" + componentIdentifier, "BO-1028100050-DATE", "Date");
			fields[169] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.CustomListMaintenance.__internal_x_context__SelectedCustomList_" + componentIdentifier, "BO-1028100050-ISACTIVE", "IsActive");
			fields[170] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.CustomListMaintenance.__internal_x_context__SelectedCustomList_" + componentIdentifier, "BO-1028100050-ISREADONLY", "IsReadOnly");
			fields[171] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.CustomListMaintenance.__internal_x_context__SelectedCustomList_" + componentIdentifier, "BO-1028100050-ISFULLACCESS", "IsFullAccess");
			fields[172] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.CustomListMaintenance.__internal_x_context__PatientCustomListVo_" + componentIdentifier, "BO-1003100101-ID", "ID_MDTPatientCustomList");
			fields[173] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.CustomListMaintenance.__internal_x_context__PatientCustomListVo_" + componentIdentifier, "BO-1003100101-CUSTOMLISTTYPE", "CustomListType");
			fields[174] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.CustomListMaintenance.__internal_x_context__PatientCustomListVo_" + componentIdentifier, "BO-1003100101-LISTORDER", "ListOrder");
			return fields;
		}
