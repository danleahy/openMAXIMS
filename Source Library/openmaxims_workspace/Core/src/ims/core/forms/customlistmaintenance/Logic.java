...
import ims.core.vo.CustomListMaintenanceSearchCriteriaVo;
...
public class Logic extends BaseLogic
{
	...
	protected void onFormOpen() throws ims.framework.exceptions.PresentationLogicException
	{
		initialize();
		//WDEV-19389 
		if (form.getGlobalContext().Core.getCustomListMaintenanceSearchCriteriaIsNotNull())
		{
			setSearchCriteria(form.getGlobalContext().Core.getCustomListMaintenanceSearchCriteria());
			searchCustomList();
		}
	}
	
	private CustomListMaintenanceSearchCriteriaVo getSearchCriteria()
	{
		CustomListMaintenanceSearchCriteriaVo searchCriteria = new CustomListMaintenanceSearchCriteriaVo();
		
		searchCriteria.setListType(form.lyrCustomListSearch().tabCustomListSearch().cmbListType().getValue());
		searchCriteria.setListName(form.lyrCustomListSearch().tabCustomListSearch().txtListName().getValue());
		searchCriteria.setSpecialty(form.lyrCustomListSearch().tabCustomListSearch().cmbSpecialty().getValue());
		searchCriteria.setDate(form.lyrCustomListSearch().tabCustomListSearch().dteDate().getValue());
		searchCriteria.setListOwner((MemberOfStaffLiteVo) form.lyrCustomListSearch().tabCustomListSearch().customControlMos().getValue());
		searchCriteria.setIsActive(Boolean.TRUE.equals(form.lyrCustomListSearch().tabCustomListSearch().chkActiveOnly().getValue()) ? true : false);
		
		return searchCriteria;
	}
	
	private void setSearchCriteria(CustomListMaintenanceSearchCriteriaVo customListMaintenanceSearchCriteriaVo) 
	{
		if (customListMaintenanceSearchCriteriaVo.getListOwnerIsNotNull())
		{
			form.lyrCustomListSearch().tabCustomListSearch().customControlMos().setValue(customListMaintenanceSearchCriteriaVo.getListOwner());
		}
		else
			form.lyrCustomListSearch().tabCustomListSearch().customControlMos().setValue(null);
	
		form.lyrCustomListSearch().tabCustomListSearch().cmbListType().setValue(customListMaintenanceSearchCriteriaVo.getListType());
		form.lyrCustomListSearch().tabCustomListSearch().txtListName().setValue(customListMaintenanceSearchCriteriaVo.getListName());
		form.lyrCustomListSearch().tabCustomListSearch().cmbSpecialty().setValue(customListMaintenanceSearchCriteriaVo.getSpecialty());
		form.lyrCustomListSearch().tabCustomListSearch().dteDate().setValue(customListMaintenanceSearchCriteriaVo.getDate());
		form.lyrCustomListSearch().tabCustomListSearch().chkActiveOnly().setValue(customListMaintenanceSearchCriteriaVo.getIsActive());
	}
	...
	protected void onImbClearCustomListClick() throws PresentationLogicException {
		...
		form.getGlobalContext().Core.setCustomListMaintenanceSearchCriteria(null); //WDEV-19389 
	}
	...
	protected void onImbSearchCustomListClick() throws PresentationLogicException {
		searchCustomList();
		form.getGlobalContext().Core.setCustomListMaintenanceSearchCriteria(getSearchCriteria());//WDEV-19389 
	}
