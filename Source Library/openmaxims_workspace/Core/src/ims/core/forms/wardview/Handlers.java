...
abstract public class Handlers implements ims.framework.UILogic, IFormUILogicCode
{
	...
	abstract protected void onBtnAdmitToWardClick() throws ims.framework.exceptions.PresentationLogicException;
	...
	abstract protected void onBedPlannerBedAttachedImageClicked(ims.framework.controls.Bed bed);
	...
	abstract protected void onCcPatientSummaryValueChanged() throws ims.framework.exceptions.PresentationLogicException;
	...
	public final void setContext(ims.framework.UIEngine engine, GenForm form)
	{
		...
		this.form.btnAdmitToWard().setClickEvent(new Click()
		{
			private static final long serialVersionUID = 1L;
			public void handle() throws ims.framework.exceptions.PresentationLogicException
			{
				onBtnAdmitToWardClick();
			}
		});
		...
		this.form.bedPlanner().setBedAttachedImageClickedEvent(new BedPlannerBedAttachedImageClicked()
		{
			private static final long serialVersionUID = 1L;
			public void handle(ims.framework.controls.Bed bed)
			{
				onBedPlannerBedAttachedImageClicked(bed);
			}
		});
		...
		this.form.setccPatientSummaryValueChangedEvent(new ValueChanged()
		{
			private static final long serialVersionUID = 1L;
			public void handle() throws ims.framework.exceptions.PresentationLogicException
			{
				onCcPatientSummaryValueChanged();
			}
		});
