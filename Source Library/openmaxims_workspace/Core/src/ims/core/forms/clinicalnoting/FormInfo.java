...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Core.ClinicalNotingMode", "_cv_Core.ClinicalNotesShort" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Core.ClinicalNoting.__internal_x_context__" + String.valueOf(getFormId());
	}
