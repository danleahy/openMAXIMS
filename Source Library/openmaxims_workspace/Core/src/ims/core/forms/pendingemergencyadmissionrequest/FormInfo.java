...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "PendingEmergencyAdmissionRequest";
	}
	public int getWidth()
	{
		return 848;
	...
	{
		return new String[] { "_cv_Core.SelectedPendingNonEDEmergencyAdmission" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Core.PendingEmergencyAdmissionRequest.__internal_x_context__" + String.valueOf(getFormId());
	}
