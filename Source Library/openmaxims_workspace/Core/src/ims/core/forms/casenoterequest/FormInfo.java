...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Core.CaseNoteRequestRef", "_cv_Core.PatientCaseNoteFolderRef" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Core.CaseNoteRequest.__internal_x_context__" + String.valueOf(getFormId());
	}
