...
import ims.core.forms.vitalsignspupils.GenForm.grpShowByEnumeration;
...
public class Logic extends BaseLogic
{
	...
	protected void onFormOpen() throws FormOpenException 
	{
		...
		{
			//WDEV-19389 - start
			if (isVitalSignsPupils() && form.getGlobalContext().Core.getVitalSign() == null && form.getGlobalContext().Core.getVitalSignsPupilsSearchCriteriaIsNotNull())
			{
				if (form.getGlobalContext().Core.getVitalSign() == null && !(form.getGlobalContext().Core.getCurrentCareContextIsNotNull() && form.getGlobalContext().Core.getCurrentCareContext().equals(form.getGlobalContext().Core.getVitalSignsPupilsSearchCriteria().getCareContext())))
					form.getGlobalContext().Core.setVitalSignsPupilsSearchCriteria(null);
				
				doSeachCriteria(form.getGlobalContext().Core.getVitalSignsPupilsSearchCriteria());
			}
			else if (isVitalSignsPupilsAlias() && form.getGlobalContext().Core.getVitalSign() == null && form.getGlobalContext().Core.getVitalSignsPupilsAliasSearchCriteriaIsNotNull())
			{
				if (form.getGlobalContext().Core.getVitalSign() == null && !(form.getGlobalContext().Core.getCurrentCareContextIsNotNull() && form.getGlobalContext().Core.getCurrentCareContext().equals(form.getGlobalContext().Core.getVitalSignsPupilsAliasSearchCriteria().getCareContext())))
					form.getGlobalContext().Core.setVitalSignsPupilsAliasSearchCriteria(null);
				
				doSeachCriteria(form.getGlobalContext().Core.getVitalSignsPupilsAliasSearchCriteria());
			}
			else
			{
				try {
	...
	private boolean isVitalSignsPupils()
	{
		return engine.getFormName().equals(form.getForms().Core.VitalSignsPupils);
	}

	private boolean isVitalSignsPupilsAlias()
	{
		return engine.getFormName().equals(form.getForms().Core.VitalSignsPupilsAlias);
	}
	...
	protected void onBtnViewClick() throws PresentationLogicException 
	{
		...
		{
			if (isVitalSignsPupils())
			{
				form.getGlobalContext().Core.setVitalSignsPupilsSearchCriteria(getSearchCriteria());
			}
			else if (isVitalSignsPupilsAlias())
			{
				form.getGlobalContext().Core.setVitalSignsPupilsAliasSearchCriteria(getSearchCriteria());
			}				
		}
