...
import ims.core.forms.vitalsignsbloodsugar.GenForm.grpShowByEnumeration;
...
public class Logic extends BaseLogic
{
	...
	protected void onFormOpen() throws FormOpenException 
	{
		...
		{
			//WDEV-19389 - start
			if (isVitalSignsBloodSugar() && form.getGlobalContext().Core.getVitalSign() == null && form.getGlobalContext().Core.getVitalSignsBloodSugarSearchCriteriaIsNotNull())
			{
				if (form.getGlobalContext().Core.getVitalSign() == null && !(form.getGlobalContext().Core.getCurrentCareContextIsNotNull() && form.getGlobalContext().Core.getCurrentCareContext().equals(form.getGlobalContext().Core.getVitalSignsBloodSugarSearchCriteria().getCareContext())))
					form.getGlobalContext().Core.setVitalSignsBloodSugarSearchCriteria(null);
				
				doSearchCriteria(form.getGlobalContext().Core.getVitalSignsBloodSugarSearchCriteria());
			}
			else if (isVitalSignsBloodSugarAlias() && form.getGlobalContext().Core.getVitalSign() == null && form.getGlobalContext().Core.getVitalSignsBloodSugarAliasSearchCriteriaIsNotNull())
			{
				if (form.getGlobalContext().Core.getVitalSign() == null && !(form.getGlobalContext().Core.getCurrentCareContextIsNotNull() && form.getGlobalContext().Core.getCurrentCareContext().equals(form.getGlobalContext().Core.getVitalSignsBloodSugarAliasSearchCriteria().getCareContext())))
					form.getGlobalContext().Core.setVitalSignsBloodSugarAliasSearchCriteria(null);
				
				doSearchCriteria(form.getGlobalContext().Core.getVitalSignsBloodSugarAliasSearchCriteria());
			}
			else
			{
				try {
	...
	private void doSearchCriteria(VitalSignsFormsSearchCriteriaVo vitalSignsBloodSugarAliasSearchCriteria)
	{
		if (vitalSignsBloodSugarAliasSearchCriteria != null)
		{
			try
			{
				setSearchCriteria(vitalSignsBloodSugarAliasSearchCriteria);
				onBtnViewClick();
			}
			catch (PresentationLogicException e) {
				throw new DomainRuntimeException();
	...
	private boolean isVitalSignsBloodSugar()
	{
		return engine.getFormName().equals(form.getForms().Core.VitalSignsBloodSugar);
	}

	private boolean isVitalSignsBloodSugarAlias()
	{
		return engine.getFormName().equals(form.getForms().Core.VitalSignsBloodSugarAlias);
	}
	...
	{ 
		...
		{
			if (isVitalSignsBloodSugar())
			{
				form.getGlobalContext().Core.setVitalSignsBloodSugarSearchCriteria(getSearchCriteria());
			}
			else if (isVitalSignsBloodSugarAlias())
			{
				form.getGlobalContext().Core.setVitalSignsBloodSugarAliasSearchCriteria(getSearchCriteria());
			}				
		}
