...
public class GenForm extends FormBridge
{
	...
	public static class cmbAllergenTypeComboBox extends ComboBoxBridge
	{
		private static final long serialVersionUID = 1L;
	...
	public static class grdExtCodesRow extends GridRowBridge
	{
		private static final long serialVersionUID = 1L;
		
		protected grdExtCodesRow(GridRow row)
		{
			super(row);
		}
		public void showOpened(int column)
	...
	public static class grdExtCodesRowCollection extends GridRowCollectionBridge
	{
		private static final long serialVersionUID = 1L;
		
		private grdExtCodesRowCollection(GridRowCollection collection)
		{
			super(collection);
		}
		public grdExtCodesRow get(int index)
		{
			return new grdExtCodesRow(super.collection.get(index));
		}
		public grdExtCodesRow newRow()
		{
			return new grdExtCodesRow(super.collection.newRow());
		}
		public grdExtCodesRow newRow(boolean autoSelect)
		{
			return new grdExtCodesRow(super.collection.newRow(autoSelect));
		}
		public grdExtCodesRow newRowAt(int index)
		{
			return new grdExtCodesRow(super.collection.newRowAt(index));
		}
		public grdExtCodesRow newRowAt(int index, boolean autoSelect)
		{
			return new grdExtCodesRow(super.collection.newRowAt(index, autoSelect));
		}
	}
	public static class grdExtCodesGrid extends GridBridge
	{
		private static final long serialVersionUID = 1L;
		...
		public grdExtCodesRow getSelectedRow()
		{
			return super.grid.getSelectedRow() == null ? null : new grdExtCodesRow(super.grid.getSelectedRow());
		}
		public int getSelectedRowIndex()
		{
			return super.grid.getSelectedRowIndex();
		}
		public grdExtCodesRowCollection getRows()
		{
			return new grdExtCodesRowCollection(super.grid.getRows());
		}
		public grdExtCodesRow getRowByValue(ims.core.vo.TaxonomyMap value)
		{
			GridRow row = super.grid.getRowByValue(value);
			return row == null?null:new grdExtCodesRow(row);
		}
	...
	public static class grdAllergenRow extends GridRowBridge
	{
		private static final long serialVersionUID = 1L;
		
		protected grdAllergenRow(GridRow row)
		{
			super(row);
		}
		public void showOpened(int column)
		...
		public void setcolAllergenNameReadOnly(boolean value)
		{
			super.row.setReadOnly(0, value);
		}
		public boolean iscolAllergenNameReadOnly()
		{
			return super.row.isReadOnly(0);
		}
		public void showcolAllergenNameOpened()
		{
			super.row.showOpened(0);
		}
		public String getcolAllergenName()
		{
			return (String)super.row.get(0);
		}
		public void setcolAllergenName(String value)
		{
			super.row.set(0, value);
		}
		public void setCellcolAllergenNameTooltip(String value)
		{
			super.row.setTooltip(0, value);
		}
		...
		{
			return (ims.core.vo.AllergenVo)super.row.getValue();
		}
	...
	public static class grdAllergenRowCollection extends GridRowCollectionBridge
	{
		private static final long serialVersionUID = 1L;
		
		private grdAllergenRowCollection(GridRowCollection collection)
		{
			super(collection);
		}
		public grdAllergenRow get(int index)
		{
			return new grdAllergenRow(super.collection.get(index));
		}
		public grdAllergenRow newRow()
		{
			return new grdAllergenRow(super.collection.newRow());
		}
		public grdAllergenRow newRow(boolean autoSelect)
		{
			return new grdAllergenRow(super.collection.newRow(autoSelect));
		}
		public grdAllergenRow newRowAt(int index)
		{
			return new grdAllergenRow(super.collection.newRowAt(index));
		}
		public grdAllergenRow newRowAt(int index, boolean autoSelect)
		{
			return new grdAllergenRow(super.collection.newRowAt(index, autoSelect));
		}
	}
	public static class grdAllergenGrid extends GridBridge
	{
		private static final long serialVersionUID = 1L;
		...
		public ims.core.vo.AllergenVoCollection getValues()
		{
			ims.core.vo.AllergenVoCollection listOfValues = new ims.core.vo.AllergenVoCollection();
			for(int x = 0; x < this.getRows().size(); x++)
			{
				listOfValues.add(this.getRows().get(x).getValue());
			}
		...
		public ims.core.vo.AllergenVo getValue()
		{
			return (ims.core.vo.AllergenVo)super.grid.getValue();
		}
		public void setValue(ims.core.vo.AllergenVo value)
		{
			super.grid.setValue(value);
		}
		public grdAllergenRow getSelectedRow()
		{
			return super.grid.getSelectedRow() == null ? null : new grdAllergenRow(super.grid.getSelectedRow());
		}
		public int getSelectedRowIndex()
		{
			return super.grid.getSelectedRowIndex();
		}
		public grdAllergenRowCollection getRows()
		{
			return new grdAllergenRowCollection(super.grid.getRows());
		}
		public grdAllergenRow getRowByValue(ims.core.vo.AllergenVo value)
		{
			GridRow row = super.grid.getRowByValue(value);
			return row == null?null:new grdAllergenRow(row);
		}
		public void setcolAllergenNameHeaderTooltip(String value)
		{
			super.grid.setColumnHeaderTooltip(0, value);
		}
		public String getcolAllergenNameHeaderTooltip()
		{
			return super.grid.getColumnHeaderTooltip(0);
		}
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		contextMenus.contextMenuGenericGridCOPYItem = factory.createMenuItem(startControlID.intValue() + 17, "Copy", true, false, new Integer(102222), true, false);
		...
		contextMenus.contextMenuGenericGridREMOVE_UNVERIFIED_NHS_NUMBERItem = factory.createMenuItem(startControlID.intValue() + 18, "Remove Unverified NHS Number", true, false, new Integer(102300), true, false);
		...
		RuntimeAnchoring anchoringHelper4 = new RuntimeAnchoring(designSize, runtimeSize, 432, 112, 63, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1003), new Integer(anchoringHelper4.getX()), new Integer(anchoringHelper4.getY()), new Integer(anchoringHelper4.getWidth()), new Integer(anchoringHelper4.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Mappings:", new Integer(1), null, new Integer(0)}));
		RuntimeAnchoring anchoringHelper5 = new RuntimeAnchoring(designSize, runtimeSize, 432, 64, 36, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1004), new Integer(anchoringHelper5.getX()), new Integer(anchoringHelper5.getY()), new Integer(anchoringHelper5.getWidth()), new Integer(anchoringHelper5.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Type:", new Integer(1), null, new Integer(0)}));
		RuntimeAnchoring anchoringHelper6 = new RuntimeAnchoring(designSize, runtimeSize, 432, 40, 56, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1005), new Integer(anchoringHelper6.getX()), new Integer(anchoringHelper6.getY()), new Integer(anchoringHelper6.getWidth()), new Integer(anchoringHelper6.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Allergen:", new Integer(1), null, new Integer(0)}));
		RuntimeAnchoring anchoringHelper7 = new RuntimeAnchoring(designSize, runtimeSize, 32, 40, 93, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		RuntimeAnchoring anchoringHelper12 = new RuntimeAnchoring(designSize, runtimeSize, 336, 64, 48, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		// TextBox Controls
		RuntimeAnchoring anchoringHelper13 = new RuntimeAnchoring(designSize, runtimeSize, 528, 40, 288, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT);
		super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1012), new Integer(anchoringHelper13.getX()), new Integer(anchoringHelper13.getY()), new Integer(anchoringHelper13.getWidth()), new Integer(anchoringHelper13.getHeight()), new Integer(startTabIndex.intValue() + 4), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT,Boolean.FALSE, new Integer(255), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.TRUE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
		RuntimeAnchoring anchoringHelper14 = new RuntimeAnchoring(designSize, runtimeSize, 32, 64, 296, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		// ComboBox Controls
		RuntimeAnchoring anchoringHelper15 = new RuntimeAnchoring(designSize, runtimeSize, 528, 64, 288, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT);
		ComboBox m_cmbAllergenTypeTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1014), new Integer(anchoringHelper15.getX()), new Integer(anchoringHelper15.getY()), new Integer(anchoringHelper15.getWidth()), new Integer(anchoringHelper15.getHeight()), new Integer(startTabIndex.intValue() + 5), ControlState.DISABLED, ControlState.ENABLED,ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
		addControl(m_cmbAllergenTypeTemp);
		cmbAllergenTypeComboBox cmbAllergenType = (cmbAllergenTypeComboBox)ComboBoxFlyweightFactory.getInstance().createComboBoxBridge(cmbAllergenTypeComboBox.class, m_cmbAllergenTypeTemp);
		super.addComboBox(cmbAllergenType);

		// CheckBox Controls
		RuntimeAnchoring anchoringHelper16 = new RuntimeAnchoring(designSize, runtimeSize, 432, 88, 56, 16, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		RuntimeAnchoring anchoringHelper18 = new RuntimeAnchoring(designSize, runtimeSize, 432, 136, 384, 200, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT);
		Grid m_grdExtCodesTemp = (Grid)factory.getControl(Grid.class, new Object[] { control, new Integer(startControlID.intValue() + 1017), new Integer(anchoringHelper18.getX()), new Integer(anchoringHelper18.getY()), new Integer(anchoringHelper18.getWidth()), new Integer(anchoringHelper18.getHeight()), new Integer(startTabIndex.intValue() + 7), ControlState.READONLY, ControlState.EDITABLE, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT,Boolean.TRUE, Boolean.FALSE, new Integer(24), Boolean.TRUE, contextMenus.contextMenuGenericGrid, Boolean.FALSE, Boolean.FALSE, new Integer(0), null, Boolean.FALSE, Boolean.TRUE});
		addControl(m_grdExtCodesTemp);
		grdExtCodesGrid grdExtCodes = (grdExtCodesGrid)GridFlyweightFactory.getInstance().createGridBridge(grdExtCodesGrid.class, m_grdExtCodesTemp);
		grdExtCodes.addComboBoxColumn("External Code Type", 0, 0, 220, false, true, false, false, false, -1);
		grdExtCodes.addStringColumn("External Code", 0, 0, 100, false, false, 0, 30, true, ims.framework.enumerations.CharacterCasing.NORMAL);
		grdExtCodes.addButtonColumn(" ", 0, 0, -1, false, true);
		super.addGrid(grdExtCodes);
		RuntimeAnchoring anchoringHelper19 = new RuntimeAnchoring(designSize, runtimeSize, 32, 114, 352, 454, ims.framework.enumerations.ControlAnchoring.TOPBOTTOMLEFT);
		Grid m_grdAllergenTemp = (Grid)factory.getControl(Grid.class, new Object[] { control, new Integer(startControlID.intValue() + 1018), new Integer(anchoringHelper19.getX()), new Integer(anchoringHelper19.getY()), new Integer(anchoringHelper19.getWidth()), new Integer(anchoringHelper19.getHeight()), new Integer(startTabIndex.intValue() + 3), ControlState.READONLY, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.TOPBOTTOMLEFT,Boolean.TRUE, Boolean.FALSE, new Integer(24), Boolean.TRUE, null, Boolean.FALSE, Boolean.FALSE, new Integer(0), null, Boolean.FALSE, Boolean.TRUE});
		addControl(m_grdAllergenTemp);
		grdAllergenGrid grdAllergen = (grdAllergenGrid)GridFlyweightFactory.getInstance().createGridBridge(grdAllergenGrid.class, m_grdAllergenTemp);
		grdAllergen.addStringColumn("Allergen Name", 0, 0, 225, true, false, 0, 0, true, ims.framework.enumerations.CharacterCasing.NORMAL);
		grdAllergen.addStringColumn("Allergen Type", 0, 0, -1, true, false, 0, 0, true, ims.framework.enumerations.CharacterCasing.NORMAL);
		super.addGrid(grdAllergen);
	}
	...
	public TextBox txtAllergen()
	{
		return (TextBox)super.getControl(12);
	}
	public TextBox txtSpecifySearch()
	{
		return (TextBox)super.getControl(13);
	}
	public cmbAllergenTypeComboBox cmbAllergenType()
	{
		return (cmbAllergenTypeComboBox)super.getComboBox(0);
	}
	...
	public grdExtCodesGrid grdExtCodes()
	{
		return (grdExtCodesGrid)super.getGrid(1);
	}
	public grdAllergenGrid grdAllergen()
	{
		return (grdAllergenGrid)super.getGrid(2);
	}
	...
	public class LocalContext extends ContextBridge
	{
		...
		public LocalContext(Context context, ims.framework.FormInfo formInfo, String componentIdentifier)
		{
			...
			cxl_allergenDetails = new ims.framework.ContextVariable("allergenDetails", prefix + "_lv_Core.AllergenList.__internal_x_context__allergenDetails_" + componentIdentifier + "");
		}
		
		public boolean getallergenDetailsIsNotNull()
		{
			return !cxl_allergenDetails.getValueIsNull(context);
		}
		public ims.core.vo.AllergenDetails getallergenDetails()
		{
			return (ims.core.vo.AllergenDetails)cxl_allergenDetails.getValue(context);
		}
		public void setallergenDetails(ims.core.vo.AllergenDetails value)
		{
			cxl_allergenDetails.setValue(context, value);
		}
		private ims.framework.ContextVariable cxl_allergenDetails = null;
	}
	...
	public final class ContextMenus implements java.io.Serializable
	{
		...
		public final class GenericGrid implements java.io.Serializable
		{
			...
			public static final int REMOVE_UNVERIFIED_NHS_NUMBER = 18;
		}
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.AllergenList.__internal_x_context__allergenDetails_" + componentIdentifier, "BO-1003100018-ID", "ID_Allergen");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.AllergenList.__internal_x_context__allergenDetails_" + componentIdentifier, "BO-1003100018-ALLERGENNAME", "AllergenName");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.AllergenList.__internal_x_context__allergenDetails_" + componentIdentifier, "BO-1003100018-ALLERGENTYPE", "AllergenType");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.AllergenList.__internal_x_context__allergenDetails_" + componentIdentifier, "BO-1003100018-ISACTIVE", "IsActive");
			return fields;
		}
