...
{
	abstract protected void bindgrdExtCodescolExtCodeTypeLookup();
	abstract protected void bindcmbAllergenTypeLookup();
	abstract protected void defaultcmbAllergenTypeLookupValue();
	...
	abstract protected void onGrdExtCodesGridButtonClicked(int column, GenForm.grdExtCodesRow row) throws ims.framework.exceptions.PresentationLogicException;
	abstract protected void onGrdExtCodesSelectionChanged() throws ims.framework.exceptions.PresentationLogicException;
	abstract protected void oncmbAllergenTypeValueSet(Object value);
	abstract protected void onGrdAllergenSelectionChanged() throws ims.framework.exceptions.PresentationLogicException;
	...
	public final void setContext(ims.framework.UIEngine engine, GenForm form)
	{
		...
		this.form.grdExtCodes().setGridButtonClickedEvent(new GridButtonClicked()
		{
			private static final long serialVersionUID = 1L;
			...
			{
				onGrdExtCodesGridButtonClicked(column, new GenForm.grdExtCodesRow(row));
			}
		});
		this.form.grdExtCodes().setSelectionChangedEvent(new GridSelectionChanged()
		{
			private static final long serialVersionUID = 1L;
			public void handle(ims.framework.enumerations.MouseButton mouseButton) throws ims.framework.exceptions.PresentationLogicException
			{
		...
		this.form.cmbAllergenType().setValueSetEvent(new ComboBoxValueSet()
		{
			private static final long serialVersionUID = 1L;
			public void handle(Object value)
			{
				oncmbAllergenTypeValueSet(value);
			}
		});
		this.form.grdAllergen().setSelectionChangedEvent(new GridSelectionChanged()
		{
			private static final long serialVersionUID = 1L;
			public void handle(ims.framework.enumerations.MouseButton mouseButton) throws ims.framework.exceptions.PresentationLogicException
			{
	...
	{
		bindgrdExtCodescolExtCodeTypeLookup();
	...
	{
		defaultcmbAllergenTypeLookupValue();
	}
