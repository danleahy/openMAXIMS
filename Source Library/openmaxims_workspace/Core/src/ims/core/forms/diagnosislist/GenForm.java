...
public class GenForm extends FormBridge
{
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DiagnosisList.__internal_x_context__DiagnosisDetails_" + componentIdentifier, "BO-1003100025-ID", "ID_Diagnosis");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DiagnosisList.__internal_x_context__DiagnosisDetails_" + componentIdentifier, "BO-1003100025-DIAGNOSISNAME", "DiagnosisName");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DiagnosisList.__internal_x_context__DiagnosisDetails_" + componentIdentifier, "BO-1003100025-ISACTIVE", "IsActive");
			return fields;
		}
