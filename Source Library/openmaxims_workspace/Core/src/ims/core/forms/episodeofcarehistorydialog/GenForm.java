...
public class GenForm extends FormBridge
{
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, "_cv_Clinical.EpisodeOfCareWithHistory", "BO-1004100018-ID", "ID_EpisodeOfCare");
			fields[145] = new ims.framework.ReportField(this.context, "_cv_Clinical.EpisodeOfCareWithHistory", "BO-1004100018-SPECIALTY", "Specialty");
			fields[146] = new ims.framework.ReportField(this.context, "_cv_Clinical.EpisodeOfCareWithHistory", "BO-1004100018-STARTDATE", "StartDate");
			fields[147] = new ims.framework.ReportField(this.context, "_cv_Clinical.EpisodeOfCareWithHistory", "BO-1004100018-ENDDATE", "EndDate");
			return fields;
		}
