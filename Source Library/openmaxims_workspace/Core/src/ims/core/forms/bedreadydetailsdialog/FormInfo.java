...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Core.ADTPendingTransfer", "_cv_Core.BedReadyDetails" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Core.BedReadyDetailsDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
