...
public abstract class BaseLogic extends Handlers
{
	...
	{
		return ims.core.domain.PrivateInsuranceCompanies.class;
	}
	public final void setContext(ims.framework.UIEngine engine, GenForm form, ims.core.domain.PrivateInsuranceCompanies domain)
	{
	...
	{
		this.form.ctnDetails().grdMappings().colExtCodeTypeComboBox().clear();
		...
		{
			this.form.ctnDetails().grdMappings().colExtCodeTypeComboBox().newRow(lookupCollection.get(x), lookupCollection.get(x).getText(), lookupCollection.get(x).getImage(), lookupCollection.get(x).getTextColor());
		}
	}
	...
	protected ims.core.domain.PrivateInsuranceCompanies domain;
}
