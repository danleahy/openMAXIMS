...
public class GenForm extends FormBridge
{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		ims.framework.FormUiLogic m_ccCompletedForm = loader.loadComponent(102256, appForm, startControlID * 10 + 1000, anchoringHelper2.getSize(), instance1, startTabIndex.intValue() + 7, skipContextValidation);
		//ims.framework.Control m_ccCompletedControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1001), new Integer(155), new Integer(464), new Integer(224), new Integer(20), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, new Integer(startTabIndex.intValue() + 7), m_ccCompletedForm, instance1 } );
		ims.framework.Control m_ccCompletedControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1002),  new Integer(anchoringHelper2.getX()), new Integer(anchoringHelper2.getY()), new Integer(anchoringHelper2.getWidth()), new Integer(anchoringHelper2.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, new Integer(startTabIndex.intValue() + 7), m_ccCompletedForm, instance1, Boolean.FALSE } );
		...
		ims.framework.FormUiLogic m_ccAllocateForm = loader.loadComponent(102256, appForm, startControlID * 10 + 2000, anchoringHelper3.getSize(), instance2, startTabIndex.intValue() + 5, skipContextValidation);
		//ims.framework.Control m_ccAllocateControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1003), new Integer(155), new Integer(440), new Integer(224), new Integer(20), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, new Integer(startTabIndex.intValue() + 5), m_ccAllocateForm, instance2 } );
		ims.framework.Control m_ccAllocateControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1004),  new Integer(anchoringHelper3.getX()), new Integer(anchoringHelper3.getY()), new Integer(anchoringHelper3.getWidth()), new Integer(anchoringHelper3.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, new Integer(startTabIndex.intValue() + 5), m_ccAllocateForm, instance2, Boolean.TRUE } );
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1013), new Integer(anchoringHelper11.getX()), new Integer(anchoringHelper11.getY()), new Integer(anchoringHelper11.getWidth()), new Integer(anchoringHelper11.getHeight()), new Integer(startTabIndex.intValue() + 11), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "New", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1014), new Integer(anchoringHelper12.getX()), new Integer(anchoringHelper12.getY()), new Integer(anchoringHelper12.getWidth()), new Integer(anchoringHelper12.getHeight()), new Integer(startTabIndex.intValue() + 13), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Task Complete", Boolean.FALSE, null, Boolean.FALSE, Boolean.FALSE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, "_cv_Core.PatientClericalTask", "BO-1070100027-ID", "ID_PatientClericalTask");
			fields[145] = new ims.framework.ReportField(this.context, "_cv_Core.PatientClericalTask", "BO-1070100027-INVESTIGATION", "Investigation");
			fields[146] = new ims.framework.ReportField(this.context, "_cv_Core.PatientClericalTask", "BO-1070100027-REQUESTEDDATETIME", "RequestedDateTime");
			fields[147] = new ims.framework.ReportField(this.context, "_cv_Core.PatientClericalTask", "BO-1070100027-COMMENT", "Comment");
			fields[148] = new ims.framework.ReportField(this.context, "_cv_Core.PatientClericalTask", "BO-1070100027-COMPLETEDDATETIME", "CompletedDateTime");
			fields[149] = new ims.framework.ReportField(this.context, "_cv_Core.PatientClericalTask", "BO-1070100027-STATUS", "Status");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.PatientClericalTaskDialog.__internal_x_context__localContextClericalTask_" + componentIdentifier, "BO-1070100027-ID", "ID_PatientClericalTask");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.PatientClericalTaskDialog.__internal_x_context__localContextClericalTask_" + componentIdentifier, "BO-1070100027-INVESTIGATION", "Investigation");
			fields[152] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.PatientClericalTaskDialog.__internal_x_context__localContextClericalTask_" + componentIdentifier, "BO-1070100027-REQUESTEDDATETIME", "RequestedDateTime");
			fields[153] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.PatientClericalTaskDialog.__internal_x_context__localContextClericalTask_" + componentIdentifier, "BO-1070100027-COMMENT", "Comment");
			fields[154] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.PatientClericalTaskDialog.__internal_x_context__localContextClericalTask_" + componentIdentifier, "BO-1070100027-COMPLETEDDATETIME", "CompletedDateTime");
			fields[155] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.PatientClericalTaskDialog.__internal_x_context__localContextClericalTask_" + componentIdentifier, "BO-1070100027-STATUS", "Status");
			return fields;
		}
