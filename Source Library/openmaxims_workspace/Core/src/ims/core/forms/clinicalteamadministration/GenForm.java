...
public class GenForm extends FormBridge
{
		...
		public static class lyrDetailsLayer extends Layer
		{
			...
			public static class tabMemberDisplayContainer extends LayerBridge
			{
				...
				protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
				{
					...
					super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1010), new Integer(anchoringHelper11.getX()), new Integer(anchoringHelper11.getY()), new Integer(anchoringHelper11.getWidth()), new Integer(anchoringHelper11.getHeight()), new Integer(startTabIndex.intValue() + 25), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.FALSE, new Integer(0), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
					...
					super.addControl(factory.getControl(CheckBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1013), new Integer(anchoringHelper14.getX()), new Integer(anchoringHelper14.getY()), new Integer(anchoringHelper14.getWidth()), new Integer(anchoringHelper14.getHeight()), new Integer(startTabIndex.intValue() + 28), ControlState.DISABLED, ControlState.ENABLED,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,"Active", Boolean.FALSE, null}));
				}
			...
			public static class tabDetailsMembersContainer extends LayerBridge
			{
				...
				protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
				{
					...
					ims.framework.FormUiLogic m_customControlSearchHCPsForm = loader.loadComponent(103173, appForm, startControlID * 10 + 1000, anchoringHelper15.getSize(), instance1, startTabIndex.intValue() + 11, skipContextValidation);
					//ims.framework.Control m_customControlSearchHCPsControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1014), new Integer(8), new Integer(8), new Integer(328), new Integer(128), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, new Integer(startTabIndex.intValue() + 11), m_customControlSearchHCPsForm, instance1 } );
					ims.framework.Control m_customControlSearchHCPsControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1015),  new Integer(anchoringHelper15.getX()), new Integer(anchoringHelper15.getY()), new Integer(anchoringHelper15.getWidth()), new Integer(anchoringHelper15.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, new Integer(startTabIndex.intValue() + 11), m_customControlSearchHCPsForm, instance1, Boolean.FALSE } );
					...
					super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1018), new Integer(anchoringHelper18.getX()), new Integer(anchoringHelper18.getY()), new Integer(anchoringHelper18.getWidth()), new Integer(anchoringHelper18.getHeight()), new Integer(startTabIndex.intValue() + 24), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Cancel", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
					...
					super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1019), new Integer(anchoringHelper19.getX()), new Integer(anchoringHelper19.getY()), new Integer(anchoringHelper19.getWidth()), new Integer(anchoringHelper19.getHeight()), new Integer(startTabIndex.intValue() + 23), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Add/Apply", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
					...
					super.addControl(factory.getControl(DateControl.class, new Object[] { control, new Integer(startControlID.intValue() + 1020), new Integer(anchoringHelper20.getX()), new Integer(anchoringHelper20.getY()), new Integer(anchoringHelper20.getWidth()), new Integer(anchoringHelper20.getHeight()), new Integer(startTabIndex.intValue() + 21), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT,Boolean.TRUE, null, Boolean.FALSE, null, Boolean.FALSE, null}));
					...
					super.addControl(factory.getControl(DateControl.class, new Object[] { control, new Integer(startControlID.intValue() + 1021), new Integer(anchoringHelper21.getX()), new Integer(anchoringHelper21.getY()), new Integer(anchoringHelper21.getWidth()), new Integer(anchoringHelper21.getHeight()), new Integer(startTabIndex.intValue() + 20), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT,Boolean.TRUE, null, Boolean.FALSE, null, Boolean.TRUE, null}));
					...
					super.addControl(factory.getControl(CheckBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1022), new Integer(anchoringHelper22.getX()), new Integer(anchoringHelper22.getY()), new Integer(anchoringHelper22.getWidth()), new Integer(anchoringHelper22.getHeight()), new Integer(startTabIndex.intValue() + 22), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPRIGHT ,"Active", Boolean.TRUE, null}));
					...
					Grid m_grdTeamMembersTemp = (Grid)factory.getControl(Grid.class, new Object[] { control, new Integer(startControlID.intValue() + 1023), new Integer(anchoringHelper23.getX()), new Integer(anchoringHelper23.getY()), new Integer(anchoringHelper23.getWidth()), new Integer(anchoringHelper23.getHeight()), new Integer(startTabIndex.intValue() + 19), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL,Boolean.TRUE, Boolean.FALSE, new Integer(24), Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, new Integer(0), null, Boolean.FALSE, Boolean.TRUE});
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1032), new Integer(anchoringHelper32.getX()), new Integer(anchoringHelper32.getY()), new Integer(anchoringHelper32.getWidth()), new Integer(anchoringHelper32.getHeight()), new Integer(startTabIndex.intValue() + 29), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "New", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.ClinicalTeamAdministration.__internal_x_context__SelectedParentInstance_" + componentIdentifier, "BO-1006100003-ID", "ID_ClinicalTeam");
			fields[145] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.ClinicalTeamAdministration.__internal_x_context__SelectedParentInstance_" + componentIdentifier, "BO-1006100003-TEAMNAME", "TeamName");
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.ClinicalTeamAdministration.__internal_x_context__SelectedParentInstance_" + componentIdentifier, "BO-1006100003-TEAMTYPE", "TeamType");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.ClinicalTeamAdministration.__internal_x_context__SelectedParentInstance_" + componentIdentifier, "BO-1006100003-ISACTIVE", "IsActive");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.ClinicalTeamAdministration.__internal_x_context__SelectedChildInstance_" + componentIdentifier, "BO-1006100010-ID", "ID_ClinicalTeamMember");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.ClinicalTeamAdministration.__internal_x_context__SelectedChildInstance_" + componentIdentifier, "BO-1006100010-STARTDATE", "StartDate");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.ClinicalTeamAdministration.__internal_x_context__SelectedChildInstance_" + componentIdentifier, "BO-1006100010-ENDDATE", "EndDate");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.ClinicalTeamAdministration.__internal_x_context__SelectedChildInstance_" + componentIdentifier, "BO-1006100010-ISACTIVE", "IsActive");
			fields[152] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.ClinicalTeamAdministration.__internal_x_context__UpdatedChild_" + componentIdentifier, "BO-1006100010-ID", "ID_ClinicalTeamMember");
			fields[153] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.ClinicalTeamAdministration.__internal_x_context__UpdatedChild_" + componentIdentifier, "BO-1006100010-STARTDATE", "StartDate");
			fields[154] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.ClinicalTeamAdministration.__internal_x_context__UpdatedChild_" + componentIdentifier, "BO-1006100010-ENDDATE", "EndDate");
			fields[155] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.ClinicalTeamAdministration.__internal_x_context__UpdatedChild_" + componentIdentifier, "BO-1006100010-ISACTIVE", "IsActive");
			fields[156] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.ClinicalTeamAdministration.__internal_x_context__UpdatedParent_" + componentIdentifier, "BO-1006100003-ID", "ID_ClinicalTeam");
			fields[157] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.ClinicalTeamAdministration.__internal_x_context__UpdatedParent_" + componentIdentifier, "BO-1006100003-TEAMNAME", "TeamName");
			fields[158] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.ClinicalTeamAdministration.__internal_x_context__UpdatedParent_" + componentIdentifier, "BO-1006100003-TEAMTYPE", "TeamType");
			fields[159] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.ClinicalTeamAdministration.__internal_x_context__UpdatedParent_" + componentIdentifier, "BO-1006100003-ISACTIVE", "IsActive");
			return fields;
		}
