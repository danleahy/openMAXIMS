...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Core.SelectedWaitingAreaPatient", "_cv_Core.SelectedBedSpaceState", "_cv_Core.HomeLeaveDetails" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Core.HomeLeaveDetailsDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
	...
	{
		return "Images/Core/home_write_48.png";
	}
}
