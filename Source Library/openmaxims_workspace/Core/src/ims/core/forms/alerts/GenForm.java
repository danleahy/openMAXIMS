...
public class GenForm extends FormBridge
{
	...
	public static class ctnDetailsContainer extends ContainerBridge
	{
		...
		protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
		{
			...
			//ims.framework.Control m_customControlAuthoringInfoControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1000), new Integer(448), new Integer(72), new Integer(360), new Integer(56), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, new Integer(startTabIndex.intValue() + 11), m_customControlAuthoringInfoForm, instance1 } );
			ims.framework.Control m_customControlAuthoringInfoControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1001),  new Integer(anchoringHelper1.getX()), new Integer(anchoringHelper1.getY()), new Integer(anchoringHelper1.getWidth()), new Integer(anchoringHelper1.getHeight()), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, new Integer(startTabIndex.intValue() + 11), m_customControlAuthoringInfoForm, instance1, Boolean.FALSE } );
			...
			RuntimeAnchoring anchoringHelper3 = new RuntimeAnchoring(designSize, runtimeSize, 456, 130, 95, 17, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT);
			super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1003), new Integer(anchoringHelper3.getX()), new Integer(anchoringHelper3.getY()), new Integer(anchoringHelper3.getWidth()), new Integer(anchoringHelper3.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Recording User:", new Integer(1), null, new Integer(0)}));
			...
			super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1009), new Integer(anchoringHelper9.getX()), new Integer(anchoringHelper9.getY()), new Integer(anchoringHelper9.getWidth()), new Integer(anchoringHelper9.getHeight()), new Integer(startTabIndex.intValue() + 8), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFTRIGHT,Boolean.TRUE, new Integer(255), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
			...
			super.addControl(factory.getControl(DateTimeControl.class, new Object[] { control, new Integer(startControlID.intValue() + 1010), new Integer(anchoringHelper10.getX()), new Integer(anchoringHelper10.getY()), new Integer(anchoringHelper10.getWidth()), new Integer(anchoringHelper10.getHeight()), new Integer(startTabIndex.intValue() + 15), ControlState.DISABLED, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT,Boolean.TRUE, null, Boolean.FALSE, null, Boolean.FALSE, null}));
			...
			super.addControl(factory.getControl(PartialDateBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1011), new Integer(anchoringHelper11.getX()), new Integer(anchoringHelper11.getY()), new Integer(anchoringHelper11.getWidth()), new Integer(anchoringHelper11.getHeight()), new Integer(startTabIndex.intValue() + 10), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Invalid date entered", Boolean.FALSE, Boolean.FALSE}));
			...
			ComboBox m_cmbRecordingHCPTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1012), new Integer(anchoringHelper12.getX()), new Integer(anchoringHelper12.getY()), new Integer(anchoringHelper12.getWidth()), new Integer(anchoringHelper12.getHeight()), new Integer(startTabIndex.intValue() + 14), ControlState.DISABLED, ControlState.DISABLED,ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
			...
			ComboBox m_cmbCategoryTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1013), new Integer(anchoringHelper13.getX()), new Integer(anchoringHelper13.getY()), new Integer(anchoringHelper13.getWidth()), new Integer(anchoringHelper13.getHeight()), new Integer(startTabIndex.intValue() + 6), ControlState.DISABLED, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT ,Boolean.TRUE, Boolean.TRUE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.TRUE, new Integer(-1)});
			...
			ComboBox m_cmbAlertsTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1014), new Integer(anchoringHelper14.getX()), new Integer(anchoringHelper14.getY()), new Integer(anchoringHelper14.getWidth()), new Integer(anchoringHelper14.getHeight()), new Integer(startTabIndex.intValue() + 7), ControlState.DISABLED, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT ,Boolean.TRUE, Boolean.TRUE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.TRUE, new Integer(-1)});
			...
			ComboBox m_cmbSourceTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1015), new Integer(anchoringHelper15.getX()), new Integer(anchoringHelper15.getY()), new Integer(anchoringHelper15.getWidth()), new Integer(anchoringHelper15.getHeight()), new Integer(startTabIndex.intValue() + 9), ControlState.DISABLED, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
			...
			super.addControl(factory.getControl(CheckBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1016), new Integer(anchoringHelper16.getX()), new Integer(anchoringHelper16.getY()), new Integer(anchoringHelper16.getWidth()), new Integer(anchoringHelper16.getHeight()), new Integer(startTabIndex.intValue() + 5), ControlState.HIDDEN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,"No Known Alerts", Boolean.TRUE, null}));
		}
	...
	public static class groupFilterRadioButton extends RadioButtonBridge
	{
		...
		protected void setContext(Integer startTabIndex, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize)
		{
			...
			control.addButton(0, anchoringHelper17.getX(), anchoringHelper17.getY(), anchoringHelper17.getWidth(), "View All", startTabIndex.intValue() + 3);
			...
			control.addButton(1, anchoringHelper18.getX(), anchoringHelper18.getY(), anchoringHelper18.getWidth(), "View Active", startTabIndex.intValue() + 1);
		}
	...
	private void validateContext(ims.framework.Context context)
	{
		...
		if(!context.isValidContextType(ims.core.vo.AlertsResultsSearchCriteriaVo.class))
			throw new ims.framework.exceptions.CodingRuntimeException("The type 'ims.core.vo.AlertsResultsSearchCriteriaVo' of the global context variable 'Core.AlertsResultsSearchCriteria' is not supported.");
	}
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1020), new Integer(anchoringHelper22.getX()), new Integer(anchoringHelper22.getY()), new Integer(anchoringHelper22.getWidth()), new Integer(anchoringHelper22.getHeight()), new Integer(startTabIndex.intValue() + 17), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Edit", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1021), new Integer(anchoringHelper23.getX()), new Integer(anchoringHelper23.getY()), new Integer(anchoringHelper23.getWidth()), new Integer(anchoringHelper23.getHeight()), new Integer(startTabIndex.intValue() + 16), ControlState.UNKNOWN, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "New", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
	...
	public class LocalContext extends ContextBridge
	{
		...
		public LocalContext(Context context, ims.framework.FormInfo formInfo, String componentIdentifier)
		{
			...
			cxl_AlertsThatCanBeViewedOrEdited = new ims.framework.ContextVariable("AlertsThatCanBeViewedOrEdited", prefix + "_lv_Core.Alerts.__internal_x_context__AlertsThatCanBeViewedOrEdited_" + componentIdentifier + "");
			cxl_AlertsThatCanBeEdited = new ims.framework.ContextVariable("AlertsThatCanBeEdited", prefix + "_lv_Core.Alerts.__internal_x_context__AlertsThatCanBeEdited_" + componentIdentifier + "");
		}
		...
		public boolean getAlertsThatCanBeViewedOrEditedIsNotNull()
		{
			return !cxl_AlertsThatCanBeViewedOrEdited.getValueIsNull(context);
		}
		public ims.core.vo.lookups.AlertTypeCollection getAlertsThatCanBeViewedOrEdited()
		{
			return (ims.core.vo.lookups.AlertTypeCollection)cxl_AlertsThatCanBeViewedOrEdited.getValue(context);
		}
		public void setAlertsThatCanBeViewedOrEdited(ims.core.vo.lookups.AlertTypeCollection value)
		{
			cxl_AlertsThatCanBeViewedOrEdited.setValue(context, value);
		}
		private ims.framework.ContextVariable cxl_AlertsThatCanBeViewedOrEdited = null;
		public boolean getAlertsThatCanBeEditedIsNotNull()
		{
			return !cxl_AlertsThatCanBeEdited.getValueIsNull(context);
		}
		public ims.core.vo.lookups.AlertTypeCollection getAlertsThatCanBeEdited()
		{
			return (ims.core.vo.lookups.AlertTypeCollection)cxl_AlertsThatCanBeEdited.getValue(context);
		}
		public void setAlertsThatCanBeEdited(ims.core.vo.lookups.AlertTypeCollection value)
		{
			cxl_AlertsThatCanBeEdited.setValue(context, value);
		}
		private ims.framework.ContextVariable cxl_AlertsThatCanBeEdited = null;
	}
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.Alerts.__internal_x_context__AlertRecord_" + componentIdentifier, "BO-1003100012-ID", "ID_PatientAlert");
			fields[145] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.Alerts.__internal_x_context__AlertRecord_" + componentIdentifier, "BO-1003100012-ALERTTYPE", "AlertType");
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.Alerts.__internal_x_context__AlertRecord_" + componentIdentifier, "BO-1003100012-ISCURRENTLYACTIVEALERT", "IsCurrentlyActiveAlert");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.Alerts.__internal_x_context__AlertRecord_" + componentIdentifier, "BO-1003100012-SOURCEOFINFORMATION", "SourceofInformation");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.Alerts.__internal_x_context__AlertRecord_" + componentIdentifier, "BO-1003100012-PATIENT", "Patient");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.Alerts.__internal_x_context__AlertRecord_" + componentIdentifier, "BO-1003100012-COMMENTS", "Comments");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.Alerts.__internal_x_context__AlertRecord_" + componentIdentifier, "BO-1003100012-DATEIDENTIFIED", "DateIdentified");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.Alerts.__internal_x_context__AlertRecord_" + componentIdentifier, "BO-1003100012-INACTIVATIONCOMMENTS", "InactivationComments");
			fields[152] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.Alerts.__internal_x_context__PatientNoAlertInfoVo_" + componentIdentifier, "BO-1003100084-ID", "ID_PatientNoAlertInfo");
			fields[153] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.Alerts.__internal_x_context__PatientNoAlertInfoVo_" + componentIdentifier, "BO-1003100084-PATIENT", "Patient");
			fields[154] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.Alerts.__internal_x_context__PatientNoAlertInfoVo_" + componentIdentifier, "BO-1003100084-ALERTSTATUS", "AlertStatus");
			fields[155] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.Alerts.__internal_x_context__PatientNoAlertInfoVo_" + componentIdentifier, "BO-1003100084-WHENIDENTIFIED", "WhenIdentified");
			fields[156] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.Alerts.__internal_x_context__PatientNoAlertInfoVo_" + componentIdentifier, "BO-1003100084-NOALERTSOURCEOFINFORMATION", "NoAlertSourceofInformation");
			return fields;
		}
