...
public class GenForm extends FormBridge
{
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.AssignADTWardAndSpecialtyDialog.__internal_x_context__SelectedWard_" + componentIdentifier, "BO-1007100007-ID", "ID_Location");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.AssignADTWardAndSpecialtyDialog.__internal_x_context__SelectedWard_" + componentIdentifier, "BO-1007100007-NAME", "Name");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.AssignADTWardAndSpecialtyDialog.__internal_x_context__SelectedWard_" + componentIdentifier, "BO-1007100007-ISACTIVE", "IsActive");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.AssignADTWardAndSpecialtyDialog.__internal_x_context__SelectedWard_" + componentIdentifier, "BO-1007100007-ISVIRTUAL", "IsVirtual");
			fields[152] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.AssignADTWardAndSpecialtyDialog.__internal_x_context__SelectedWard_" + componentIdentifier, "BO-1007100007-TYPE", "Type");
			fields[153] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.AssignADTWardAndSpecialtyDialog.__internal_x_context__SelectedWard_" + componentIdentifier, "BO-1007100007-DISPLAYINEDTRACKING", "DisplayInEDTracking");
			fields[154] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.AssignADTWardAndSpecialtyDialog.__internal_x_context__SelectedWard_" + componentIdentifier, "BO-1007100007-CASENOTEFOLDERLOCATION", "CaseNoteFolderLocation");
			return fields;
		}
