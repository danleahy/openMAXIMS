...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "FilmTrackingTransferDialog";
	}
	public int getWidth()
	{
		return 432;
	...
	{
		return new String[] { "_cv_Core.FilmPacketTransfer" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Core.FilmTrackingTransferDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
