...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Core.PatientCaseNoteFolderRef", "_cv_Core.RieMessage" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Core.CaseNoteComments.__internal_x_context__" + String.valueOf(getFormId());
	}
