...
import ims.core.forms.vitalsignsrespiration.GenForm.grpShowByEnumeration;
...
public class Logic extends BaseLogic
{
	...
	protected void onFormOpen() throws ims.framework.exceptions.FormOpenException
	{
		...
		{
			//WDEV-19389 - start
			if (isVitalSignsRespiration() && form.getGlobalContext().Core.getVitalSign() == null && form.getGlobalContext().Core.getVitalSignsRespirationsSearchCriteriaIsNotNull())
			{
				if (form.getGlobalContext().Core.getVitalSign() == null && !(form.getGlobalContext().Core.getCurrentCareContextIsNotNull() && form.getGlobalContext().Core.getCurrentCareContext().equals(form.getGlobalContext().Core.getVitalSignsRespirationsSearchCriteria().getCareContext())))
					form.getGlobalContext().Core.setVitalSignsRespirationsSearchCriteria(null);
				
				doSearchCriteria(form.getGlobalContext().Core.getVitalSignsRespirationsSearchCriteria());
			}
			else if (isVitalSignsRespirationAlias() && form.getGlobalContext().Core.getVitalSign() == null && form.getGlobalContext().Core.getVitalSignsRespirationsAliasSearchCriteriaIsNotNull())
			{
				if (form.getGlobalContext().Core.getVitalSign() == null && !(form.getGlobalContext().Core.getCurrentCareContextIsNotNull() && form.getGlobalContext().Core.getCurrentCareContext().equals(form.getGlobalContext().Core.getVitalSignsRespirationsAliasSearchCriteria().getCareContext())))
					form.getGlobalContext().Core.setVitalSignsRespirationsAliasSearchCriteria(null);
			
				doSearchCriteria(form.getGlobalContext().Core.getVitalSignsRespirationsAliasSearchCriteria());
			}
			else
			{
				try {
	...
	private void doSearchCriteria(VitalSignsFormsSearchCriteriaVo vitalSignsRespirationsAliasSearchCriteria)
	{
		if (vitalSignsRespirationsAliasSearchCriteria != null)
		{
			try
			{
				setSearchCriteria(vitalSignsRespirationsAliasSearchCriteria);
				onBtnViewClick();
			}
			catch (PresentationLogicException e) {
				throw new DomainRuntimeException();
	...
	private boolean isVitalSignsRespiration()
	{
		return engine.getFormName().equals(form.getForms().Core.VitalSignsRespiration);
	}

	private boolean isVitalSignsRespirationAlias()
	{
		return engine.getFormName().equals(form.getForms().Core.VitalSignsRespirationAlias);
	}
	...
	protected void onBtnViewClick() throws PresentationLogicException
	{
		...
		{
			if (isVitalSignsRespiration())
			{
				form.getGlobalContext().Core.setVitalSignsRespirationsSearchCriteria(getSearchCriteria());
			}
			else if (isVitalSignsRespirationAlias())
			{
				form.getGlobalContext().Core.setVitalSignsRespirationsAliasSearchCriteria(getSearchCriteria());
			}
