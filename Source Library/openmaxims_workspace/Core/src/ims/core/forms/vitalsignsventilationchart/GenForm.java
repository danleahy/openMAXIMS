...
public class GenForm extends FormBridge
{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1003), new Integer(anchoringHelper4.getX()), new Integer(anchoringHelper4.getY()), new Integer(anchoringHelper4.getWidth()), new Integer(anchoringHelper4.getHeight()), new Integer(startTabIndex.intValue() + 3), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Edit", Boolean.TRUE, "Updates the current selected record", Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		ComboBox m_cmbRecordToUpdateTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1006), new Integer(anchoringHelper7.getX()), new Integer(anchoringHelper7.getY()), new Integer(anchoringHelper7.getWidth()), new Integer(anchoringHelper7.getHeight()), new Integer(startTabIndex.intValue() + 4), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT ,Boolean.TRUE, Boolean.TRUE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[155] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.VitalSignsVentilationChart.__internal_x_context__SelectedVitalSignsVo_" + componentIdentifier, "BO-1022100004-ID", "ID_VitalSigns");
			fields[156] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.VitalSignsVentilationChart.__internal_x_context__SelectedVitalSignsVo_" + componentIdentifier, "BO-1022100004-CARECONTEXT", "CareContext");
			fields[157] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.VitalSignsVentilationChart.__internal_x_context__SelectedVitalSignsVo_" + componentIdentifier, "BO-1022100004-ISVENTILATIONCHARTRECORD", "IsVentilationChartRecord");
			fields[158] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.VitalSignsVentilationChart.__internal_x_context__SelectedVitalSignsVo_" + componentIdentifier, "BO-1022100004-VITALSTAKENDATETIME", "VitalsTakenDateTime");
			fields[159] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.VitalSignsVentilationChart.__internal_x_context__SelectedVitalSignsVo_" + componentIdentifier, "BO-1022100004-PATIENTCONSCIOUS", "PatientConscious");
			fields[160] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.VitalSignsVentilationChart.__internal_x_context__SelectedVitalSignsVo_" + componentIdentifier, "BO-1022100004-URINE2MLKGKHR", "Urine2mlkgkhr");
			fields[161] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.VitalSignsVentilationChart.__internal_x_context__SelectedVitalSignsVo_" + componentIdentifier, "BO-1022100004-PATIENTCAUSINGCONCERN", "PatientCausingConcern");
			fields[162] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.VitalSignsVentilationChart.__internal_x_context__SelectedVitalSignsVo_" + componentIdentifier, "BO-1022100004-UNRECORDEDOBSERVATIONSREASON", "UnrecordedObservationsReason");
			return fields;
		}
