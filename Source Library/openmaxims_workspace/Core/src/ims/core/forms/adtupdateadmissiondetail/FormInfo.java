...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "ADTUpdateAdmissionDetail";
	}
	public int getWidth()
	{
		return 680;
	...
	{
		return new String[] { "_cv_Core.ADTAdmissionDetailUpdate" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Core.ADTUpdateAdmissionDetail.__internal_x_context__" + String.valueOf(getFormId());
	}
