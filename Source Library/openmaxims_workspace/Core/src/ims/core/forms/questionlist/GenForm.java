...
public class GenForm extends FormBridge
{
		...
		public static class tabPageTextClassContainer extends LayerBridge
		{
			...
			public static class GroupFilterRadioButton extends RadioButtonBridge
			{
				...
				protected void setContext(Integer startTabIndex, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize)
				{
					...
					control.addButton(0, anchoringHelper1.getX(), anchoringHelper1.getY(), anchoringHelper1.getWidth(), "Questions and Information", startTabIndex.intValue() + 3);
					...
					control.addButton(1, anchoringHelper2.getX(), anchoringHelper2.getY(), anchoringHelper2.getWidth(), "Information Only", startTabIndex.intValue() + 2);
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				ComboBox m_cmbStatusTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1004), new Integer(anchoringHelper8.getX()), new Integer(anchoringHelper8.getY()), new Integer(anchoringHelper8.getWidth()), new Integer(anchoringHelper8.getHeight()), new Integer(startTabIndex.intValue() + 10), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
	...
	public static class lyrTreesLayer extends Layer
	{
		...
		public static class tabPageSelectContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				Grid m_grdSelectedQuestionsTemp = (Grid)factory.getControl(Grid.class, new Object[] { control, new Integer(startControlID.intValue() + 1026), new Integer(anchoringHelper29.getX()), new Integer(anchoringHelper29.getY()), new Integer(anchoringHelper29.getWidth()), new Integer(anchoringHelper29.getHeight()), new Integer(startTabIndex.intValue() + 12), ControlState.EDITABLE, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL,Boolean.TRUE, Boolean.FALSE, new Integer(24), Boolean.TRUE, null, Boolean.FALSE, Boolean.FALSE, new Integer(0), null, Boolean.FALSE, Boolean.TRUE});
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, "_cv_Admin.SelectedQuestion", "BO-1058100000-ID", "ID_QuestionInformation");
			fields[145] = new ims.framework.ReportField(this.context, "_cv_Admin.SelectedQuestion", "BO-1058100000-TEXT", "Text");
			fields[146] = new ims.framework.ReportField(this.context, "_cv_Admin.SelectedQuestion", "BO-1058100000-SHORTTEXT", "ShortText");
			fields[147] = new ims.framework.ReportField(this.context, "_cv_Admin.SelectedQuestion", "BO-1058100000-ISQUESTION", "IsQuestion");
			fields[148] = new ims.framework.ReportField(this.context, "_cv_Admin.SelectedQuestion", "BO-1058100000-GENDERSPECIFIC", "GenderSpecific");
			fields[149] = new ims.framework.ReportField(this.context, "_cv_Admin.SelectedQuestion", "BO-1058100000-AGERANGEMIN", "AgeRangeMin");
			fields[150] = new ims.framework.ReportField(this.context, "_cv_Admin.SelectedQuestion", "BO-1058100000-AGERANGEMAX", "AgeRangeMax");
			fields[151] = new ims.framework.ReportField(this.context, "_cv_Admin.SelectedQuestion", "BO-1058100000-STATUS", "Status");
			fields[152] = new ims.framework.ReportField(this.context, "_cv_Admin.SelectedQuestion", "BO-1058100000-LEGENDTEXT", "LegendText");
			fields[153] = new ims.framework.ReportField(this.context, "_cv_Admin.SelectedQuestion", "BO-1058100000-QUESTIONTYPE", "QuestionType");
			return fields;
		}
