...
public class GenForm extends FormBridge
{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		grdOutput.addIntColumn("mls", 0, 0, -1, false, true, null, false, 0, true, 0);
		...
		Grid m_grdIntakeTemp = (Grid)factory.getControl(Grid.class, new Object[] { control, new Integer(startControlID.intValue() + 1017), new Integer(anchoringHelper17.getX()), new Integer(anchoringHelper17.getY()), new Integer(anchoringHelper17.getWidth()), new Integer(anchoringHelper17.getHeight()), new Integer(startTabIndex.intValue() + 6), ControlState.EDITABLE, ControlState.EDITABLE, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.TRUE, Boolean.FALSE, new Integer(24), Boolean.TRUE, null, Boolean.FALSE, Boolean.FALSE, new Integer(50), "Total :", Boolean.FALSE, Boolean.TRUE});
		...
		grdIntake.addIntColumn("mls", 0, 0, -1, false, true, null, false, 0, true, 0);
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, "_cv_Core.CurrentDailyFluidBalanceVo", "BO-1022100015-ID", "ID_DailyFluidBalance");
			fields[145] = new ims.framework.ReportField(this.context, "_cv_Core.CurrentDailyFluidBalanceVo", "BO-1022100015-CARECONTEXT", "CareContext");
			fields[146] = new ims.framework.ReportField(this.context, "_cv_Core.CurrentDailyFluidBalanceInstanceVo", "BO-1022100016-ID", "ID_FluidBalanceInstance");
			fields[147] = new ims.framework.ReportField(this.context, "_cv_Core.CurrentDailyFluidBalanceInstanceVo", "BO-1022100016-TOTALINPUT", "TotalIntake");
			fields[148] = new ims.framework.ReportField(this.context, "_cv_Core.CurrentDailyFluidBalanceInstanceVo", "BO-1022100016-TOTALOUTPUT", "TotalOutput");
			fields[149] = new ims.framework.ReportField(this.context, "_cv_Core.CurrentDailyFluidBalanceInstanceVo", "BO-1022100016-BALANCE", "Balance");
			fields[150] = new ims.framework.ReportField(this.context, "_cv_Core.CurrentDailyFluidBalanceInstanceVo", "BO-1022100016-FLUIDBALANCEDATE", "FluidBalanceDate");
			fields[151] = new ims.framework.ReportField(this.context, "_cv_Core.CurrentDailyFluidBalanceInstanceVo", "BO-1022100016-STARTTIME", "StartTime");
			fields[152] = new ims.framework.ReportField(this.context, "_cv_Core.CurrentDailyFluidBalanceInstanceVo", "BO-1022100016-COMMENTS", "Comments");
			fields[153] = new ims.framework.ReportField(this.context, "_cv_Core.CurrentDailyFluidBalanceInstanceVo", "BO-1022100016-CONFIRMINGDATETIME", "ConfirmingDateTime");
			fields[154] = new ims.framework.ReportField(this.context, "_cv_Core.CurrentDailyFluidBalanceInstanceVo", "BO-1022100016-ISCONFIRMED", "IsConfirmed");
			fields[155] = new ims.framework.ReportField(this.context, "_cv_Core.CurrentDailyFluidBalanceInstanceVo", "BO-1022100016-IRRIGATIONIN", "IrrigationIn");
			fields[156] = new ims.framework.ReportField(this.context, "_cv_Core.CurrentDailyFluidBalanceInstanceVo", "BO-1022100016-IRRIGATIONOUT", "IrrigationOut");
			fields[157] = new ims.framework.ReportField(this.context, "_cv_Core.CurrentDailyFluidBalanceInstanceVo", "BO-1022100016-TIMEPERIOD", "TimePeriod");
			fields[158] = new ims.framework.ReportField(this.context, "_cv_Core.CurrentDailyFluidBalanceInstanceVo", "BO-1022100016-SIGNATORYSHIFT", "SignatoryShift");
			fields[159] = new ims.framework.ReportField(this.context, "_cv_Core.CurrentDailyFluidBalanceInstanceVo", "BO-1022100016-ENDTIME", "EndTime");
			fields[160] = new ims.framework.ReportField(this.context, "_cv_Core.CurrentDailyPatternConfigVo", "BO-1028100023-ID", "ID_DailyPattern");
			fields[161] = new ims.framework.ReportField(this.context, "_cv_Core.CurrentDailyPatternConfigVo", "BO-1028100023-DAILYPATTERNTYPE", "DailyPatternType");
			fields[162] = new ims.framework.ReportField(this.context, "_cv_Core.CurrentDailyPatternConfigVo", "BO-1028100023-ISACTIVE", "IsActive");
			fields[163] = new ims.framework.ReportField(this.context, "_cv_Core.CurrentDailyPatternConfigVo", "BO-1028100023-STARTTIME", "StartTime");
			fields[164] = new ims.framework.ReportField(this.context, "_cv_Core.CurrentDailyPatternConfigVo", "BO-1028100023-USESIGNATORYPERIODS", "UseSignatoryPeriods");
			fields[165] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.FluidBalanceDetails.__internal_x_context__CurrentDailyFluidBalanceVo_" + componentIdentifier, "BO-1022100015-ID", "ID_DailyFluidBalance");
			fields[166] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.FluidBalanceDetails.__internal_x_context__CurrentDailyFluidBalanceVo_" + componentIdentifier, "BO-1022100015-CARECONTEXT", "CareContext");
			fields[167] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.FluidBalanceDetails.__internal_x_context__CurrentFluidBalanceInstanceVo_" + componentIdentifier, "BO-1022100016-ID", "ID_FluidBalanceInstance");
			fields[168] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.FluidBalanceDetails.__internal_x_context__CurrentFluidBalanceInstanceVo_" + componentIdentifier, "BO-1022100016-TOTALINPUT", "TotalIntake");
			fields[169] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.FluidBalanceDetails.__internal_x_context__CurrentFluidBalanceInstanceVo_" + componentIdentifier, "BO-1022100016-TOTALOUTPUT", "TotalOutput");
			fields[170] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.FluidBalanceDetails.__internal_x_context__CurrentFluidBalanceInstanceVo_" + componentIdentifier, "BO-1022100016-BALANCE", "Balance");
			fields[171] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.FluidBalanceDetails.__internal_x_context__CurrentFluidBalanceInstanceVo_" + componentIdentifier, "BO-1022100016-FLUIDBALANCEDATE", "FluidBalanceDate");
			fields[172] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.FluidBalanceDetails.__internal_x_context__CurrentFluidBalanceInstanceVo_" + componentIdentifier, "BO-1022100016-STARTTIME", "StartTime");
			fields[173] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.FluidBalanceDetails.__internal_x_context__CurrentFluidBalanceInstanceVo_" + componentIdentifier, "BO-1022100016-COMMENTS", "Comments");
			fields[174] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.FluidBalanceDetails.__internal_x_context__CurrentFluidBalanceInstanceVo_" + componentIdentifier, "BO-1022100016-CONFIRMINGDATETIME", "ConfirmingDateTime");
			fields[175] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.FluidBalanceDetails.__internal_x_context__CurrentFluidBalanceInstanceVo_" + componentIdentifier, "BO-1022100016-ISCONFIRMED", "IsConfirmed");
			fields[176] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.FluidBalanceDetails.__internal_x_context__CurrentFluidBalanceInstanceVo_" + componentIdentifier, "BO-1022100016-IRRIGATIONIN", "IrrigationIn");
			fields[177] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.FluidBalanceDetails.__internal_x_context__CurrentFluidBalanceInstanceVo_" + componentIdentifier, "BO-1022100016-IRRIGATIONOUT", "IrrigationOut");
			fields[178] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.FluidBalanceDetails.__internal_x_context__CurrentFluidBalanceInstanceVo_" + componentIdentifier, "BO-1022100016-TIMEPERIOD", "TimePeriod");
			fields[179] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.FluidBalanceDetails.__internal_x_context__CurrentFluidBalanceInstanceVo_" + componentIdentifier, "BO-1022100016-SIGNATORYSHIFT", "SignatoryShift");
			fields[180] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.FluidBalanceDetails.__internal_x_context__CurrentFluidBalanceInstanceVo_" + componentIdentifier, "BO-1022100016-ENDTIME", "EndTime");
			fields[181] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.FluidBalanceDetails.__internal_x_context__SavedDailyPatternConfig_" + componentIdentifier, "BO-1028100023-ID", "ID_DailyPattern");
			fields[182] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.FluidBalanceDetails.__internal_x_context__SavedDailyPatternConfig_" + componentIdentifier, "BO-1028100023-DAILYPATTERNTYPE", "DailyPatternType");
			fields[183] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.FluidBalanceDetails.__internal_x_context__SavedDailyPatternConfig_" + componentIdentifier, "BO-1028100023-ISACTIVE", "IsActive");
			fields[184] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.FluidBalanceDetails.__internal_x_context__SavedDailyPatternConfig_" + componentIdentifier, "BO-1028100023-STARTTIME", "StartTime");
			fields[185] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.FluidBalanceDetails.__internal_x_context__SavedDailyPatternConfig_" + componentIdentifier, "BO-1028100023-USESIGNATORYPERIODS", "UseSignatoryPeriods");
			fields[186] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.FluidBalanceDetails.__internal_x_context__CurrentSignatoryShiftDetailsVo_" + componentIdentifier, "BO-1022100020-ID", "ID_SignatoryShiftDetails");
			fields[187] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.FluidBalanceDetails.__internal_x_context__CurrentSignatoryShiftDetailsVo_" + componentIdentifier, "BO-1022100020-DATETIMESIGNED", "DateTimeSigned");
			fields[188] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.FluidBalanceDetails.__internal_x_context__CurrentSignatoryShiftDetailsVo_" + componentIdentifier, "BO-1022100020-STARTTIME", "StartTime");
			fields[189] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.FluidBalanceDetails.__internal_x_context__CurrentSignatoryShiftDetailsVo_" + componentIdentifier, "BO-1022100020-ENDTIME", "EndTime");
			fields[190] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.FluidBalanceDetails.__internal_x_context__CurrentSignatoryShiftDetailsVo_" + componentIdentifier, "BO-1022100020-SHIFTSTARTDATETIME", "ShiftStartDateTime");
			fields[191] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.FluidBalanceDetails.__internal_x_context__CurrentSignatoryShiftDetailsVo_" + componentIdentifier, "BO-1022100020-SHIFTENDDATETIME", "ShiftEndDateTime");
			return fields;
		}
