...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "ADTConsultantStaysDialog";
	}
	public int getWidth()
	{
		return 752;
	...
	{
		return new String[] { "_cv_Core.YesNoDialogLaunchedFromSelf", "_cv_Core.RieMessage", "_cv_Core.SelectedBedSpaceState", "_cv_Core.SelectedWaitingAreaPatient" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Core.ADTConsultantStaysDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
