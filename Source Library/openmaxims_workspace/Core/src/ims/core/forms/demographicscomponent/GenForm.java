...
public class GenForm extends FormBridge
{
	...
	public static class lyrAdditionalDetailsLayer extends Layer
	{
		...
		public static class tabMedicalCardIrishContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1002), new Integer(anchoringHelper3.getX()), new Integer(anchoringHelper3.getY()), new Integer(anchoringHelper3.getWidth()), new Integer(anchoringHelper3.getHeight()), new Integer(startTabIndex.intValue() + 40), ControlState.DISABLED, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.FALSE, new Integer(0), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
				...
				super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1003), new Integer(anchoringHelper4.getX()), new Integer(anchoringHelper4.getY()), new Integer(anchoringHelper4.getWidth()), new Integer(anchoringHelper4.getHeight()), new Integer(startTabIndex.intValue() + 39), ControlState.DISABLED, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.FALSE, new Integer(0), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
			}
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		contextMenus.Core.contextMenuIdentifierGridAddItem = factory.createMenuItem(startControlID.intValue() + 12, "New", true, false, new Integer(102179), true, false);
		contextMenus.Core.contextMenuIdentifierGrid.add(contextMenus.Core.contextMenuIdentifierGridAddItem);
		contextMenus.Core.contextMenuIdentifierGridRemoveItem = factory.createMenuItem(startControlID.intValue() + 13, "Remove", true, false, new Integer(102148), true, false);
		contextMenus.Core.contextMenuIdentifierGrid.add(contextMenus.Core.contextMenuIdentifierGridRemoveItem);
		contextMenus.Core.contextMenuIdentifierGridCOPYItem = factory.createMenuItem(startControlID.intValue() + 14, "Copy", true, false, new Integer(102222), true, false);
		...
		ims.framework.FormUiLogic m_ccAddressSearchForm = loader.loadComponent(102278, appForm, startControlID * 10 + 1000, anchoringHelper15.getSize(), instance1, startTabIndex.intValue() + 15, skipContextValidation);
		//ims.framework.Control m_ccAddressSearchControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1014), new Integer(8), new Integer(200), new Integer(416), new Integer(224), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT, new Integer(startTabIndex.intValue() + 15), m_ccAddressSearchForm, instance1 } );
		ims.framework.Control m_ccAddressSearchControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1015),  new Integer(anchoringHelper15.getX()), new Integer(anchoringHelper15.getY()), new Integer(anchoringHelper15.getWidth()), new Integer(anchoringHelper15.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT, new Integer(startTabIndex.intValue() + 15), m_ccAddressSearchForm, instance1, Boolean.FALSE } );
		...
		RuntimeAnchoring anchoringHelper21 = new RuntimeAnchoring(designSize, runtimeSize, 408, 34, 122, 17, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
		super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1021), new Integer(anchoringHelper21.getX()), new Integer(anchoringHelper21.getY()), new Integer(anchoringHelper21.getWidth()), new Integer(anchoringHelper21.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT, "Date/Time of Death:", new Integer(1), null, new Integer(0)}));
		...
		RuntimeAnchoring anchoringHelper23 = new RuntimeAnchoring(designSize, runtimeSize, 248, 159, 30, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		// Button Controls
		RuntimeAnchoring anchoringHelper32 = new RuntimeAnchoring(designSize, runtimeSize, 656, 28, 168, 24, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1032), new Integer(anchoringHelper32.getX()), new Integer(anchoringHelper32.getY()), new Integer(anchoringHelper32.getWidth()), new Integer(anchoringHelper32.getHeight()), new Integer(startTabIndex.intValue() + 8), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT, "Mark Patient as Deceased", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1033), new Integer(anchoringHelper33.getX()), new Integer(anchoringHelper33.getY()), new Integer(anchoringHelper33.getWidth()), new Integer(anchoringHelper33.getHeight()), new Integer(startTabIndex.intValue() + 36), ControlState.DISABLED, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.TOPRIGHT,Boolean.FALSE, new Integer(0), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
		...
		super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1034), new Integer(anchoringHelper34.getX()), new Integer(anchoringHelper34.getY()), new Integer(anchoringHelper34.getWidth()), new Integer(anchoringHelper34.getHeight()), new Integer(startTabIndex.intValue() + 35), ControlState.DISABLED, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.TOPRIGHT,Boolean.FALSE, new Integer(0), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
		...
		super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1035), new Integer(anchoringHelper35.getX()), new Integer(anchoringHelper35.getY()), new Integer(anchoringHelper35.getWidth()), new Integer(anchoringHelper35.getHeight()), new Integer(startTabIndex.intValue() + 33), ControlState.DISABLED, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.TOPRIGHT,Boolean.FALSE, new Integer(0), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
		...
		super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1036), new Integer(anchoringHelper36.getX()), new Integer(anchoringHelper36.getY()), new Integer(anchoringHelper36.getWidth()), new Integer(anchoringHelper36.getHeight()), new Integer(startTabIndex.intValue() + 30), ControlState.DISABLED, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.FALSE, new Integer(40), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
		RuntimeAnchoring anchoringHelper37 = new RuntimeAnchoring(designSize, runtimeSize, 280, 157, 96, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT);
		...
		// Date Controls
		RuntimeAnchoring anchoringHelper41 = new RuntimeAnchoring(designSize, runtimeSize, 528, 29, 82, 20, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
		super.addControl(factory.getControl(DateControl.class, new Object[] { control, new Integer(startControlID.intValue() + 1041), new Integer(anchoringHelper41.getX()), new Integer(anchoringHelper41.getY()), new Integer(anchoringHelper41.getWidth()), new Integer(anchoringHelper41.getHeight()), new Integer(startTabIndex.intValue() + 9), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT,Boolean.TRUE, null, Boolean.TRUE, null, Boolean.FALSE, null}));
		...
		RuntimeAnchoring anchoringHelper44 = new RuntimeAnchoring(designSize, runtimeSize, 528, 82, 296, 21, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
		ComboBox m_cmbOccupationTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1044), new Integer(anchoringHelper44.getX()), new Integer(anchoringHelper44.getY()), new Integer(anchoringHelper44.getWidth()), new Integer(anchoringHelper44.getHeight()), new Integer(startTabIndex.intValue() + 12), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPRIGHT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
		...
		RuntimeAnchoring anchoringHelper45 = new RuntimeAnchoring(designSize, runtimeSize, 528, 132, 296, 21, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
		ComboBox m_cmbEthnicTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1045), new Integer(anchoringHelper45.getX()), new Integer(anchoringHelper45.getY()), new Integer(anchoringHelper45.getWidth()), new Integer(anchoringHelper45.getHeight()), new Integer(startTabIndex.intValue() + 14), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPRIGHT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
		...
		RuntimeAnchoring anchoringHelper46 = new RuntimeAnchoring(designSize, runtimeSize, 528, 107, 296, 21, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
		ComboBox m_cmbReligionTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1046), new Integer(anchoringHelper46.getX()), new Integer(anchoringHelper46.getY()), new Integer(anchoringHelper46.getWidth()), new Integer(anchoringHelper46.getHeight()), new Integer(startTabIndex.intValue() + 13), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPRIGHT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
		...
		RuntimeAnchoring anchoringHelper47 = new RuntimeAnchoring(designSize, runtimeSize, 528, 57, 296, 21, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
		ComboBox m_cmbMaritalTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1047), new Integer(anchoringHelper47.getX()), new Integer(anchoringHelper47.getY()), new Integer(anchoringHelper47.getWidth()), new Integer(anchoringHelper47.getHeight()), new Integer(startTabIndex.intValue() + 11), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPRIGHT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
		...
		ComboBox m_cmbSexTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1048), new Integer(anchoringHelper48.getX()), new Integer(anchoringHelper48.getY()), new Integer(anchoringHelper48.getWidth()), new Integer(anchoringHelper48.getHeight()), new Integer(startTabIndex.intValue() + 5), ControlState.DISABLED, ControlState.ENABLED,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
		...
		// Time Controls
		RuntimeAnchoring anchoringHelper51 = new RuntimeAnchoring(designSize, runtimeSize, 615, 30, 36, 21, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
		super.addControl(factory.getControl(TimeControl.class, new Object[] { control, new Integer(startControlID.intValue() + 1051), new Integer(anchoringHelper51.getX()), new Integer(anchoringHelper51.getY()), new Integer(anchoringHelper51.getWidth()), new Integer(anchoringHelper51.getHeight()), new Integer(startTabIndex.intValue() + 10), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT,Boolean.TRUE, Boolean.FALSE, null, Boolean.FALSE, ""}));

		// Image Buttons Controls
		RuntimeAnchoring anchoringHelper52 = new RuntimeAnchoring(designSize, runtimeSize, 800, 274, 28, 28, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
		super.addControl(factory.getControl(ImageButton.class, new Object[] { control, new Integer(startControlID.intValue() + 1052), new Integer(anchoringHelper52.getX()), new Integer(anchoringHelper52.getY()), new Integer(anchoringHelper52.getWidth()), new Integer(anchoringHelper52.getHeight()), new Integer(startTabIndex.intValue() + 37), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT, this.getImages().Core.GPEnabled24, this.getImages().Core.GPDisabled24, "GP Details", Boolean.FALSE, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null}));
		RuntimeAnchoring anchoringHelper53 = new RuntimeAnchoring(designSize, runtimeSize, 800, 210, 28, 28, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
		super.addControl(factory.getControl(ImageButton.class, new Object[] { control, new Integer(startControlID.intValue() + 1053), new Integer(anchoringHelper53.getX()), new Integer(anchoringHelper53.getY()), new Integer(anchoringHelper53.getWidth()), new Integer(anchoringHelper53.getHeight()), new Integer(startTabIndex.intValue() + 34), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT, this.getImages().Core.NOKEnabled24, this.getImages().Core.NOKDisabled24, "NOK Details", Boolean.FALSE, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null}));
		RuntimeAnchoring anchoringHelper54 = new RuntimeAnchoring(designSize, runtimeSize, 384, 425, 28, 28, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(ImageButton.class, new Object[] { control, new Integer(startControlID.intValue() + 1054), new Integer(anchoringHelper54.getX()), new Integer(anchoringHelper54.getY()), new Integer(anchoringHelper54.getWidth()), new Integer(anchoringHelper54.getHeight()), new Integer(startTabIndex.intValue() + 31), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, this.getImages().Core.ZoomInfoEnabled24, this.getImages().Core.ZoomInfoDisabled24, "Other Addresses", Boolean.FALSE, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null}));
		RuntimeAnchoring anchoringHelper55 = new RuntimeAnchoring(designSize, runtimeSize, 240, 28, 28, 28, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(ImageButton.class, new Object[] { control, new Integer(startControlID.intValue() + 1055), new Integer(anchoringHelper55.getX()), new Integer(anchoringHelper55.getY()), new Integer(anchoringHelper55.getWidth()), new Integer(anchoringHelper55.getHeight()), new Integer(startTabIndex.intValue() + 7), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, this.getImages().Core.ZoomInfoEnabled24, this.getImages().Core.ZoomInfoDisabled24, "Other Names", Boolean.FALSE, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null}));
	}
	...
	public class LocalContext extends ContextBridge
	{
		...
		public LocalContext(Context context, ims.framework.FormInfo formInfo, String componentIdentifier)
		{
			...
			cxl_DemographicControlsConfig = new ims.framework.ContextVariable("DemographicControlsConfig", prefix + "_lv_Core.DemographicsComponent.__internal_x_context__DemographicControlsConfig_" + componentIdentifier + "");
			cxl_IsGridCommChannelsMandatory = new ims.framework.ContextVariable("IsGridCommChannelsMandatory", prefix + "_lv_Core.DemographicsComponent.__internal_x_context__IsGridCommChannelsMandatory_" + componentIdentifier + "");
			cxl_DemographicControlsConf = new ims.framework.ContextVariable("DemographicControlsConf", prefix + "_lv_Core.DemographicsComponent.__internal_x_context__DemographicControlsConf_" + componentIdentifier + "");
			cxl_bRemovePatientAppointments = new ims.framework.ContextVariable("bRemovePatientAppointments", prefix + "_lv_Core.DemographicsComponent.__internal_x_context__bRemovePatientAppointments_" + componentIdentifier + "");
			cxl_CancelAppointmentsMessageID = new ims.framework.ContextVariable("CancelAppointmentsMessageID", prefix + "_lv_Core.DemographicsComponent.__internal_x_context__CancelAppointmentsMessageID_" + componentIdentifier + "");
		}
		...
		public boolean getDemographicControlsConfIsNotNull()
		{
			return !cxl_DemographicControlsConf.getValueIsNull(context);
		}
		public ims.core.vo.DemographicControlsConfigVo getDemographicControlsConf()
		{
			return (ims.core.vo.DemographicControlsConfigVo)cxl_DemographicControlsConf.getValue(context);
		}
		public void setDemographicControlsConf(ims.core.vo.DemographicControlsConfigVo value)
		{
			cxl_DemographicControlsConf.setValue(context, value);
		}
		private ims.framework.ContextVariable cxl_DemographicControlsConf = null;
	...
	private class ReportFields
	{
		...
		{
			String prefix = formInfo.getLocalVariablesPrefix();
			IReportField[] fields = new IReportField[363];
			...
			fields[144] = new ims.framework.ReportField(this.context, "_cv_Core.DeathDetails", "BO-1003100060-ID", "ID_DeathDetails");
			fields[145] = new ims.framework.ReportField(this.context, "_cv_Core.DeathDetails", "BO-1003100060-DEATHPLACEOFDEATH", "DeathPlaceofDeath");
			fields[146] = new ims.framework.ReportField(this.context, "_cv_Core.DeathDetails", "BO-1003100060-DEATHCAUSEESTABLISHED", "DeathCauseEstablished");
			fields[147] = new ims.framework.ReportField(this.context, "_cv_Core.DeathDetails", "BO-1003100060-CANCERRELATEDDEATH", "CancerRelatedDeath");
			fields[148] = new ims.framework.ReportField(this.context, "_cv_Core.DeathDetails", "BO-1003100060-DEATHCODEDISCREPENCY", "DeathCodeDiscrepency");
			fields[149] = new ims.framework.ReportField(this.context, "_cv_Core.DeathDetails", "BO-1003100060-REFERREDTOCORRONER", "ReferredToCorroner");
			fields[150] = new ims.framework.ReportField(this.context, "_cv_Core.DeathDetails", "BO-1003100060-POSTMORTEM", "PostMortem");
			fields[151] = new ims.framework.ReportField(this.context, "_cv_Core.GPDetails", "BO-1006100001-ID", "ID_Gp");
			fields[152] = new ims.framework.ReportField(this.context, "_cv_Core.GPDetails", "BO-1006100001-STATUS", "Status");
			fields[153] = new ims.framework.ReportField(this.context, "_cv_Core.GPSurgery", "BO-1007100007-ID", "ID_Location");
			fields[154] = new ims.framework.ReportField(this.context, "_cv_Core.GPSurgery", "BO-1007100007-NAME", "Name");
			fields[155] = new ims.framework.ReportField(this.context, "_cv_Core.GPSurgery", "BO-1007100007-ISACTIVE", "IsActive");
			fields[156] = new ims.framework.ReportField(this.context, "_cv_Core.GPSurgery", "BO-1007100007-ISVIRTUAL", "IsVirtual");
			fields[157] = new ims.framework.ReportField(this.context, "_cv_Core.GPSurgery", "BO-1007100007-TYPE", "Type");
			fields[158] = new ims.framework.ReportField(this.context, "_cv_Core.GPSurgery", "BO-1007100007-DISPLAYINEDTRACKING", "DisplayInEDTracking");
			fields[159] = new ims.framework.ReportField(this.context, "_cv_Core.GPSurgery", "BO-1007100007-CASENOTEFOLDERLOCATION", "CaseNoteFolderLocation");
			fields[160] = new ims.framework.ReportField(this.context, "_cv_Core.GPSurgery", "BO-1007100007-SECUREACCOMMODATION", "SecureAccommodation");
			fields[161] = new ims.framework.ReportField(this.context, "_cv_Core.GPSurgery", "BO-1007100007-TREATINGHOSP", "TreatingHosp");
			fields[162] = new ims.framework.ReportField(this.context, "_cv_Core.GPSurgery", "BO-1007100007-REFERRINGHOSPITAL", "ReferringHospital");
			fields[163] = new ims.framework.ReportField(this.context, "_cv_Core.GPSurgery", "BO-1007100002-ALLSECUREACCOMMODATION", "AllSecureAccommodation");
			fields[164] = new ims.framework.ReportField(this.context, "_cv_Core.NOKDetails", "BO-1001100002-ID", "ID_Relative");
			fields[165] = new ims.framework.ReportField(this.context, "_cv_Core.NOKDetails", "BO-1001100002-RELATIONSHIP", "Relationship");
			fields[166] = new ims.framework.ReportField(this.context, "_cv_Core.NOKDetails", "BO-1001100002-PDSUPDATEMODE", "PdsUpdateMode");
			fields[167] = new ims.framework.ReportField(this.context, "_cv_Core.NOKDetails", "BO-1001100002-OBJECTIDENTIFIER", "Objectidentifier");
			fields[168] = new ims.framework.ReportField(this.context, "_cv_Core.NOKDetails", "BO-1001100002-ROLE", "Role");
			fields[169] = new ims.framework.ReportField(this.context, "_cv_Core.NOKDetails", "BO-1001100002-NHSNUM", "NhsNum");
			fields[170] = new ims.framework.ReportField(this.context, "_cv_Core.NOKDetails", "BO-1001100002-CONTACTRANK", "ContactRank");
			fields[171] = new ims.framework.ReportField(this.context, "_cv_Core.NOKDetails", "BO-1001100002-NOKIND", "NokInd");
			fields[172] = new ims.framework.ReportField(this.context, "_cv_Core.NOKDetails", "BO-1001100002-CPYCORRESP", "CpyCorresp");
			fields[173] = new ims.framework.ReportField(this.context, "_cv_Core.NOKDetails", "BO-1001100002-CALLBCKCONS", "CallbckCons");
			fields[174] = new ims.framework.ReportField(this.context, "_cv_Core.NOKDetails", "BO-1001100002-BEFFDATECNF", "Beffdatecnf");
			fields[175] = new ims.framework.ReportField(this.context, "_cv_Core.NOKDetails", "BO-1001100002-BETDATECNF", "Betdatecnf");
			fields[176] = new ims.framework.ReportField(this.context, "_cv_Core.NOKDetails", "BO-1001100002-BEFFDATE", "Beffdate");
			fields[177] = new ims.framework.ReportField(this.context, "_cv_Core.NOKDetails", "BO-1001100002-BETDATE", "Betdate");
			fields[178] = new ims.framework.ReportField(this.context, "_cv_Core.NOKDetails", "BO-1001100002-DOB", "Dob");
			fields[179] = new ims.framework.ReportField(this.context, "_cv_Core.NOKDetails", "BO-1001100002-ACTIVE", "Active");
			fields[180] = new ims.framework.ReportField(this.context, "_cv_Core.NOKDetails", "BO-1001100002-PDSLANGUAGE", "PDSlanguage");
			fields[181] = new ims.framework.ReportField(this.context, "_cv_Core.NOKDetails", "BO-1001100002-PDSINTERPRETERREQUIRED", "PDSInterpreterRequired");
			fields[182] = new ims.framework.ReportField(this.context, "_cv_Core.NOKDetails", "BO-1001100002-PENDING", "Pending");
			fields[183] = new ims.framework.ReportField(this.context, "_cv_Core.NOKDetails", "BO-1001100002-ISCONFIDENTIAL", "IsConfidential");
			fields[184] = new ims.framework.ReportField(this.context, "_cv_Core.NOKDetails", "BO-1001100001-TEMPFIELD", "TempField");
			fields[185] = new ims.framework.ReportField(this.context, "_cv_Core.PatientToBeDisplayed", "BO-1001100000-ID", "ID_Patient");
			fields[186] = new ims.framework.ReportField(this.context, "_cv_Core.PatientToBeDisplayed", "BO-1001100000-SEX", "Sex");
			fields[187] = new ims.framework.ReportField(this.context, "_cv_Core.PatientToBeDisplayed", "BO-1001100000-DOB", "Dob");
			fields[188] = new ims.framework.ReportField(this.context, "_cv_Core.PatientToBeDisplayed", "BO-1001100000-DOD", "Dod");
			fields[189] = new ims.framework.ReportField(this.context, "_cv_Core.PatientToBeDisplayed", "BO-1001100000-RELIGION", "Religion");
			fields[190] = new ims.framework.ReportField(this.context, "_cv_Core.PatientToBeDisplayed", "BO-1001100000-ISACTIVE", "IsActive");
			fields[191] = new ims.framework.ReportField(this.context, "_cv_Core.PatientToBeDisplayed", "BO-1001100000-ETHNICORIGIN", "EthnicOrigin");
			fields[192] = new ims.framework.ReportField(this.context, "_cv_Core.PatientToBeDisplayed", "BO-1001100000-MARITALSTATUS", "MaritalStatus");
			fields[193] = new ims.framework.ReportField(this.context, "_cv_Core.PatientToBeDisplayed", "BO-1001100000-SCN", "SCN");
			fields[194] = new ims.framework.ReportField(this.context, "_cv_Core.PatientToBeDisplayed", "BO-1001100000-SOURCEOFINFORMATION", "SourceOfInformation");
			fields[195] = new ims.framework.ReportField(this.context, "_cv_Core.PatientToBeDisplayed", "BO-1001100000-TIMEOFDEATH", "TimeOfDeath");
			fields[196] = new ims.framework.ReportField(this.context, "_cv_Core.PatientToBeDisplayed", "BO-1001100000-ISQUICKREGISTRATIONPATIENT", "IsQuickRegistrationPatient");
			fields[197] = new ims.framework.ReportField(this.context, "_cv_Core.PatientToBeDisplayed", "BO-1001100000-CURRENTRESPONSIBLECONSULTANT", "CurrentResponsibleConsultant");
			fields[198] = new ims.framework.ReportField(this.context, "_cv_Core.PatientToBeDisplayed", "BO-1001100000-DEMENTIABREACHDATETIME", "DementiaBreachDateTime");
			fields[199] = new ims.framework.ReportField(this.context, "_cv_Core.PatientToBeDisplayed", "BO-1001100000-DEMENTIAWORKLISTSTATUS", "DementiaWorklistStatus");
			fields[200] = new ims.framework.ReportField(this.context, "_cv_Core.PatientToBeDisplayed", "BO-1001100000-MRNSTATUS", "MRNStatus");
			fields[201] = new ims.framework.ReportField(this.context, "_cv_Core.PatientToBeDisplayed", "BO-1001100000-HASSCANNEDCASENOTEFOLDERS", "HasScannedCaseNoteFolders");
			fields[202] = new ims.framework.ReportField(this.context, "_cv_Core.PatientToBeDisplayed", "BO-1001100000-ISCONFIDENTIAL", "IsConfidential");
			fields[203] = new ims.framework.ReportField(this.context, "_cv_Core.PatientToBeDisplayed", "BO-1001100000-TIMEOFBIRTH", "TimeOfBirth");
			fields[204] = new ims.framework.ReportField(this.context, "_cv_Core.PatientToBeDisplayed", "BO-1001100000-PATIENTCATEGORY", "PatientCategory");
			fields[205] = new ims.framework.ReportField(this.context, "_cv_Core.PersonAddress", "BO-1002100000-ID", "ID_Address");
			fields[206] = new ims.framework.ReportField(this.context, "_cv_Core.PersonAddress", "BO-1002100000-LINE1", "Line1");
			fields[207] = new ims.framework.ReportField(this.context, "_cv_Core.PersonAddress", "BO-1002100000-LINE2", "Line2");
			fields[208] = new ims.framework.ReportField(this.context, "_cv_Core.PersonAddress", "BO-1002100000-LINE3", "Line3");
			fields[209] = new ims.framework.ReportField(this.context, "_cv_Core.PersonAddress", "BO-1002100000-LINE4", "Line4");
			fields[210] = new ims.framework.ReportField(this.context, "_cv_Core.PersonAddress", "BO-1002100000-LINE5", "Line5");
			fields[211] = new ims.framework.ReportField(this.context, "_cv_Core.PersonAddress", "BO-1002100000-POSTCODE", "PostCode");
			fields[212] = new ims.framework.ReportField(this.context, "_cv_Core.PersonAddress", "BO-1002100000-PHONE", "Phone");
			fields[213] = new ims.framework.ReportField(this.context, "_cv_Core.PersonAddress", "BO-1002100000-COUNTY", "County");
			fields[214] = new ims.framework.ReportField(this.context, "_cv_Core.PersonAddress", "BO-1002100000-FAX", "Fax");
			fields[215] = new ims.framework.ReportField(this.context, "_cv_Core.PersonAddress", "BO-1002100000-UPDATEDATE", "UpdateDate");
			fields[216] = new ims.framework.ReportField(this.context, "_cv_Core.PersonAddress", "BO-1002100000-NOTIFICATIONDATE", "NotificationDate");
			fields[217] = new ims.framework.ReportField(this.context, "_cv_Core.PersonAddress", "BO-1002100000-ADDRESSTYPE", "AddressType");
			fields[218] = new ims.framework.ReportField(this.context, "_cv_Core.PersonAddress", "BO-1002100000-PCT", "PCT");
			fields[219] = new ims.framework.ReportField(this.context, "_cv_Core.PersonAddress", "BO-1002100000-OTHERPHONE", "Otherphone");
			fields[220] = new ims.framework.ReportField(this.context, "_cv_Core.PersonAddress", "BO-1002100000-AREAOFRESIDENCE", "AreaOfResidence");
			fields[221] = new ims.framework.ReportField(this.context, "_cv_Core.PersonAddress", "BO-1002100000-PAFKEY", "Pafkey");
			fields[222] = new ims.framework.ReportField(this.context, "_cv_Core.PersonAddress", "BO-1002100000-DESCRIPTION", "Description");
			fields[223] = new ims.framework.ReportField(this.context, "_cv_Core.PersonAddress", "BO-1002100000-OBJECTIDENTIFIER", "Objectidentifier");
			fields[224] = new ims.framework.ReportField(this.context, "_cv_Core.PersonAddress", "BO-1002100000-BEFFDATE", "Beffdate");
			fields[225] = new ims.framework.ReportField(this.context, "_cv_Core.PersonAddress", "BO-1002100000-BEFFDATECNF", "Beffdatecnf");
			fields[226] = new ims.framework.ReportField(this.context, "_cv_Core.PersonAddress", "BO-1002100000-BETDATE", "Betdate");
			fields[227] = new ims.framework.ReportField(this.context, "_cv_Core.PersonAddress", "BO-1002100000-BETDATECNF", "Betdatecnf");
			fields[228] = new ims.framework.ReportField(this.context, "_cv_Core.PersonAddress", "BO-1002100000-PDSUPDATEMODE", "PdsUpdateMode");
			fields[229] = new ims.framework.ReportField(this.context, "_cv_Core.PersonAddress", "BO-1002100000-COUNTRY", "Country");
			fields[230] = new ims.framework.ReportField(this.context, "_cv_Core.PersonAddress", "BO-1002100000-NOFIXEDABODE", "NoFixedAbode");
			fields[231] = new ims.framework.ReportField(this.context, "_cv_Core.PersonAddress", "BO-1002100000-CAREHOME", "CareHome");
			fields[232] = new ims.framework.ReportField(this.context, "_cv_RefMan.PatientsGP", "BO-1006100001-ID", "ID_Gp");
			fields[233] = new ims.framework.ReportField(this.context, "_cv_RefMan.PatientsGP", "BO-1006100001-STATUS", "Status");
			fields[234] = new ims.framework.ReportField(this.context, "_cv_Core.NOKPersonAddress", "BO-1002100000-ID", "ID_Address");
			fields[235] = new ims.framework.ReportField(this.context, "_cv_Core.NOKPersonAddress", "BO-1002100000-LINE1", "Line1");
			fields[236] = new ims.framework.ReportField(this.context, "_cv_Core.NOKPersonAddress", "BO-1002100000-LINE2", "Line2");
			fields[237] = new ims.framework.ReportField(this.context, "_cv_Core.NOKPersonAddress", "BO-1002100000-LINE3", "Line3");
			fields[238] = new ims.framework.ReportField(this.context, "_cv_Core.NOKPersonAddress", "BO-1002100000-LINE4", "Line4");
			fields[239] = new ims.framework.ReportField(this.context, "_cv_Core.NOKPersonAddress", "BO-1002100000-LINE5", "Line5");
			fields[240] = new ims.framework.ReportField(this.context, "_cv_Core.NOKPersonAddress", "BO-1002100000-POSTCODE", "PostCode");
			fields[241] = new ims.framework.ReportField(this.context, "_cv_Core.NOKPersonAddress", "BO-1002100000-PHONE", "Phone");
			fields[242] = new ims.framework.ReportField(this.context, "_cv_Core.NOKPersonAddress", "BO-1002100000-COUNTY", "County");
			fields[243] = new ims.framework.ReportField(this.context, "_cv_Core.NOKPersonAddress", "BO-1002100000-FAX", "Fax");
			fields[244] = new ims.framework.ReportField(this.context, "_cv_Core.NOKPersonAddress", "BO-1002100000-UPDATEDATE", "UpdateDate");
			fields[245] = new ims.framework.ReportField(this.context, "_cv_Core.NOKPersonAddress", "BO-1002100000-NOTIFICATIONDATE", "NotificationDate");
			fields[246] = new ims.framework.ReportField(this.context, "_cv_Core.NOKPersonAddress", "BO-1002100000-ADDRESSTYPE", "AddressType");
			fields[247] = new ims.framework.ReportField(this.context, "_cv_Core.NOKPersonAddress", "BO-1002100000-PCT", "PCT");
			fields[248] = new ims.framework.ReportField(this.context, "_cv_Core.NOKPersonAddress", "BO-1002100000-OTHERPHONE", "Otherphone");
			fields[249] = new ims.framework.ReportField(this.context, "_cv_Core.NOKPersonAddress", "BO-1002100000-AREAOFRESIDENCE", "AreaOfResidence");
			fields[250] = new ims.framework.ReportField(this.context, "_cv_Core.NOKPersonAddress", "BO-1002100000-PAFKEY", "Pafkey");
			fields[251] = new ims.framework.ReportField(this.context, "_cv_Core.NOKPersonAddress", "BO-1002100000-DESCRIPTION", "Description");
			fields[252] = new ims.framework.ReportField(this.context, "_cv_Core.NOKPersonAddress", "BO-1002100000-OBJECTIDENTIFIER", "Objectidentifier");
			fields[253] = new ims.framework.ReportField(this.context, "_cv_Core.NOKPersonAddress", "BO-1002100000-BEFFDATE", "Beffdate");
			fields[254] = new ims.framework.ReportField(this.context, "_cv_Core.NOKPersonAddress", "BO-1002100000-BEFFDATECNF", "Beffdatecnf");
			fields[255] = new ims.framework.ReportField(this.context, "_cv_Core.NOKPersonAddress", "BO-1002100000-BETDATE", "Betdate");
			fields[256] = new ims.framework.ReportField(this.context, "_cv_Core.NOKPersonAddress", "BO-1002100000-BETDATECNF", "Betdatecnf");
			fields[257] = new ims.framework.ReportField(this.context, "_cv_Core.NOKPersonAddress", "BO-1002100000-PDSUPDATEMODE", "PdsUpdateMode");
			fields[258] = new ims.framework.ReportField(this.context, "_cv_Core.NOKPersonAddress", "BO-1002100000-COUNTRY", "Country");
			fields[259] = new ims.framework.ReportField(this.context, "_cv_Core.NOKPersonAddress", "BO-1002100000-NOFIXEDABODE", "NoFixedAbode");
			fields[260] = new ims.framework.ReportField(this.context, "_cv_Core.NOKPersonAddress", "BO-1002100000-CAREHOME", "CareHome");
			fields[261] = new ims.framework.ReportField(this.context, "_cv_Core.GPPracticeWithComm", "BO-1007100003-ID", "ID_Organisation");
			fields[262] = new ims.framework.ReportField(this.context, "_cv_Core.GPPracticeWithComm", "BO-1007100003-NAME", "Name");
			fields[263] = new ims.framework.ReportField(this.context, "_cv_Core.GPPracticeWithComm", "BO-1007100003-TYPE", "Type");
			fields[264] = new ims.framework.ReportField(this.context, "_cv_Core.GPPracticeWithComm", "BO-1007100003-ISACTIVE", "IsActive");
			fields[265] = new ims.framework.ReportField(this.context, "_cv_Core.GPPracticeWithComm", "BO-1007100003-COMMENT", "Comment");
			fields[266] = new ims.framework.ReportField(this.context, "_cv_Core.GPPracticeWithComm", "BO-1007100003-PCTCODE", "PctCode");
			fields[267] = new ims.framework.ReportField(this.context, "_cv_Core.GPPractice", "BO-1007100003-ID", "ID_Organisation");
			fields[268] = new ims.framework.ReportField(this.context, "_cv_Core.GPPractice", "BO-1007100003-NAME", "Name");
			fields[269] = new ims.framework.ReportField(this.context, "_cv_Core.GPPractice", "BO-1007100003-TYPE", "Type");
			fields[270] = new ims.framework.ReportField(this.context, "_cv_Core.GPPractice", "BO-1007100003-ISACTIVE", "IsActive");
			fields[271] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DemographicsComponent.__internal_x_context__Patient_" + componentIdentifier, "BO-1001100000-ID", "ID_Patient");
			fields[272] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DemographicsComponent.__internal_x_context__Patient_" + componentIdentifier, "BO-1001100000-SEX", "Sex");
			fields[273] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DemographicsComponent.__internal_x_context__Patient_" + componentIdentifier, "BO-1001100000-DOB", "Dob");
			fields[274] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DemographicsComponent.__internal_x_context__Patient_" + componentIdentifier, "BO-1001100000-DOD", "Dod");
			fields[275] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DemographicsComponent.__internal_x_context__Patient_" + componentIdentifier, "BO-1001100000-RELIGION", "Religion");
			fields[276] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DemographicsComponent.__internal_x_context__Patient_" + componentIdentifier, "BO-1001100000-ISACTIVE", "IsActive");
			fields[277] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DemographicsComponent.__internal_x_context__Patient_" + componentIdentifier, "BO-1001100000-ETHNICORIGIN", "EthnicOrigin");
			fields[278] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DemographicsComponent.__internal_x_context__Patient_" + componentIdentifier, "BO-1001100000-MARITALSTATUS", "MaritalStatus");
			fields[279] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DemographicsComponent.__internal_x_context__Patient_" + componentIdentifier, "BO-1001100000-SCN", "SCN");
			fields[280] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DemographicsComponent.__internal_x_context__Patient_" + componentIdentifier, "BO-1001100000-SOURCEOFINFORMATION", "SourceOfInformation");
			fields[281] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DemographicsComponent.__internal_x_context__Patient_" + componentIdentifier, "BO-1001100000-TIMEOFDEATH", "TimeOfDeath");
			fields[282] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DemographicsComponent.__internal_x_context__Patient_" + componentIdentifier, "BO-1001100000-ISQUICKREGISTRATIONPATIENT", "IsQuickRegistrationPatient");
			fields[283] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DemographicsComponent.__internal_x_context__Patient_" + componentIdentifier, "BO-1001100000-CURRENTRESPONSIBLECONSULTANT", "CurrentResponsibleConsultant");
			fields[284] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DemographicsComponent.__internal_x_context__Patient_" + componentIdentifier, "BO-1001100000-DEMENTIABREACHDATETIME", "DementiaBreachDateTime");
			fields[285] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DemographicsComponent.__internal_x_context__Patient_" + componentIdentifier, "BO-1001100000-DEMENTIAWORKLISTSTATUS", "DementiaWorklistStatus");
			fields[286] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DemographicsComponent.__internal_x_context__Patient_" + componentIdentifier, "BO-1001100000-MRNSTATUS", "MRNStatus");
			fields[287] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DemographicsComponent.__internal_x_context__Patient_" + componentIdentifier, "BO-1001100000-HASSCANNEDCASENOTEFOLDERS", "HasScannedCaseNoteFolders");
			fields[288] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DemographicsComponent.__internal_x_context__Patient_" + componentIdentifier, "BO-1001100000-ISCONFIDENTIAL", "IsConfidential");
			fields[289] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DemographicsComponent.__internal_x_context__Patient_" + componentIdentifier, "BO-1001100000-TIMEOFBIRTH", "TimeOfBirth");
			fields[290] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DemographicsComponent.__internal_x_context__Patient_" + componentIdentifier, "BO-1001100000-PATIENTCATEGORY", "PatientCategory");
			fields[291] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DemographicsComponent.__internal_x_context__Patient_" + componentIdentifier, "BO-1001100000-OCCUPATION", "Occupation");
			fields[292] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DemographicsComponent.__internal_x_context__Patient_" + componentIdentifier, "BO-1001100000-LANGUAGE", "Language");
			fields[293] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DemographicsComponent.__internal_x_context__Patient_" + componentIdentifier, "BO-1001100000-CLIENTPARENT", "ClientParent");
			fields[294] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DemographicsComponent.__internal_x_context__Patient_" + componentIdentifier, "BO-1001100000-HOMEFOLDERLOCATION", "HomeFolderLocation");
			fields[295] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DemographicsComponent.__internal_x_context__Patient_" + componentIdentifier, "BO-1001100000-PREFCOMMLANGUAGE", "PrefCommLanguage");
			fields[296] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DemographicsComponent.__internal_x_context__Patient_" + componentIdentifier, "BO-1001100000-COPYPATIENTONCORRESPONDENCE", "CopyPatientOnCorrespondence");
			fields[297] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DemographicsComponent.__internal_x_context__Patient_" + componentIdentifier, "BO-1001100000-COPYPATIENTONCORRESPONDENCEDATE", "CopyPatientOnCorrespondenceDate");
			fields[298] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DemographicsComponent.__internal_x_context__Patient_" + componentIdentifier, "BO-1001100000-HEALTHBOARD", "HealthBoard");
			fields[299] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DemographicsComponent.__internal_x_context__Patient_" + componentIdentifier, "BO-1001100000-PDSDEATHNOTIFICATIONSTATUS", "PDSDeathNotificationStatus");
			fields[300] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DemographicsComponent.__internal_x_context__Patient_" + componentIdentifier, "BO-1001100000-PDSINTERPRETERREQUIRED", "PDSInterpreterRequired");
			fields[301] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DemographicsComponent.__internal_x_context__Patient_" + componentIdentifier, "BO-1001100000-SCHOOL", "School");
			fields[302] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DemographicsComponent.__internal_x_context__Patient_" + componentIdentifier, "BO-1001100000-OVERSEASVISITOR", "OverseasVisitor");
			fields[303] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DemographicsComponent.__internal_x_context__Patient_" + componentIdentifier, "BO-1001100000-OVERSEASCLASSIFICATION", "OverseasClassification");
			fields[304] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DemographicsComponent.__internal_x_context__Patient_" + componentIdentifier, "BO-1001100000-HASLIVEDUK", "HasLivedUK");
			fields[305] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DemographicsComponent.__internal_x_context__Patient_" + componentIdentifier, "BO-1001100000-DECOUPLED", "Decoupled");
			fields[306] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DemographicsComponent.__internal_x_context__Patient_" + componentIdentifier, "BO-1001100000-PDSDATELASTCHECKED", "PDSDateLastChecked");
			fields[307] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DemographicsComponent.__internal_x_context__Patient_" + componentIdentifier, "BO-1001100000-SCHOOLORCOLLEGE", "SchoolOrCollege");
			fields[308] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DemographicsComponent.__internal_x_context__Patient_" + componentIdentifier, "BO-1001100000-ISCHILDINPUBLICCARE", "IsChildInPublicCare");
			fields[309] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DemographicsComponent.__internal_x_context__Patient_" + componentIdentifier, "BO-1001100000-PUBLICCARENEED", "PublicCareNeed");
			fields[310] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DemographicsComponent.__internal_x_context__Patient_" + componentIdentifier, "BO-1001100000-TXTOCCUPATION", "TxtOccupation");
			fields[311] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DemographicsComponent.__internal_x_context__DeathDetails_" + componentIdentifier, "BO-1003100060-ID", "ID_DeathDetails");
			fields[312] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DemographicsComponent.__internal_x_context__DeathDetails_" + componentIdentifier, "BO-1003100060-DEATHPLACEOFDEATH", "DeathPlaceofDeath");
			fields[313] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DemographicsComponent.__internal_x_context__DeathDetails_" + componentIdentifier, "BO-1003100060-DEATHCAUSEESTABLISHED", "DeathCauseEstablished");
			fields[314] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DemographicsComponent.__internal_x_context__DeathDetails_" + componentIdentifier, "BO-1003100060-CANCERRELATEDDEATH", "CancerRelatedDeath");
			fields[315] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DemographicsComponent.__internal_x_context__DeathDetails_" + componentIdentifier, "BO-1003100060-DEATHCODEDISCREPENCY", "DeathCodeDiscrepency");
			fields[316] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DemographicsComponent.__internal_x_context__DeathDetails_" + componentIdentifier, "BO-1003100060-REFERREDTOCORRONER", "ReferredToCorroner");
			fields[317] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DemographicsComponent.__internal_x_context__DeathDetails_" + componentIdentifier, "BO-1003100060-POSTMORTEM", "PostMortem");
			fields[318] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DemographicsComponent.__internal_x_context__savedPatient_" + componentIdentifier, "BO-1001100000-ID", "ID_Patient");
			fields[319] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DemographicsComponent.__internal_x_context__savedPatient_" + componentIdentifier, "BO-1001100000-SEX", "Sex");
			fields[320] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DemographicsComponent.__internal_x_context__savedPatient_" + componentIdentifier, "BO-1001100000-DOB", "Dob");
			fields[321] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DemographicsComponent.__internal_x_context__savedPatient_" + componentIdentifier, "BO-1001100000-DOD", "Dod");
			fields[322] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DemographicsComponent.__internal_x_context__savedPatient_" + componentIdentifier, "BO-1001100000-RELIGION", "Religion");
			fields[323] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DemographicsComponent.__internal_x_context__savedPatient_" + componentIdentifier, "BO-1001100000-ISACTIVE", "IsActive");
			fields[324] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DemographicsComponent.__internal_x_context__savedPatient_" + componentIdentifier, "BO-1001100000-ETHNICORIGIN", "EthnicOrigin");
			fields[325] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DemographicsComponent.__internal_x_context__savedPatient_" + componentIdentifier, "BO-1001100000-MARITALSTATUS", "MaritalStatus");
			fields[326] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DemographicsComponent.__internal_x_context__savedPatient_" + componentIdentifier, "BO-1001100000-SCN", "SCN");
			fields[327] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DemographicsComponent.__internal_x_context__savedPatient_" + componentIdentifier, "BO-1001100000-SOURCEOFINFORMATION", "SourceOfInformation");
			fields[328] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DemographicsComponent.__internal_x_context__savedPatient_" + componentIdentifier, "BO-1001100000-TIMEOFDEATH", "TimeOfDeath");
			fields[329] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DemographicsComponent.__internal_x_context__savedPatient_" + componentIdentifier, "BO-1001100000-ISQUICKREGISTRATIONPATIENT", "IsQuickRegistrationPatient");
			fields[330] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DemographicsComponent.__internal_x_context__savedPatient_" + componentIdentifier, "BO-1001100000-CURRENTRESPONSIBLECONSULTANT", "CurrentResponsibleConsultant");
			fields[331] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DemographicsComponent.__internal_x_context__savedPatient_" + componentIdentifier, "BO-1001100000-DEMENTIABREACHDATETIME", "DementiaBreachDateTime");
			fields[332] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DemographicsComponent.__internal_x_context__savedPatient_" + componentIdentifier, "BO-1001100000-DEMENTIAWORKLISTSTATUS", "DementiaWorklistStatus");
			fields[333] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DemographicsComponent.__internal_x_context__savedPatient_" + componentIdentifier, "BO-1001100000-MRNSTATUS", "MRNStatus");
			fields[334] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DemographicsComponent.__internal_x_context__savedPatient_" + componentIdentifier, "BO-1001100000-HASSCANNEDCASENOTEFOLDERS", "HasScannedCaseNoteFolders");
			fields[335] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DemographicsComponent.__internal_x_context__savedPatient_" + componentIdentifier, "BO-1001100000-ISCONFIDENTIAL", "IsConfidential");
			fields[336] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DemographicsComponent.__internal_x_context__savedPatient_" + componentIdentifier, "BO-1001100000-TIMEOFBIRTH", "TimeOfBirth");
			fields[337] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DemographicsComponent.__internal_x_context__savedPatient_" + componentIdentifier, "BO-1001100000-PATIENTCATEGORY", "PatientCategory");
			fields[338] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DemographicsComponent.__internal_x_context__savedPatient_" + componentIdentifier, "BO-1001100000-OCCUPATION", "Occupation");
			fields[339] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DemographicsComponent.__internal_x_context__savedPatient_" + componentIdentifier, "BO-1001100000-LANGUAGE", "Language");
			fields[340] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DemographicsComponent.__internal_x_context__savedPatient_" + componentIdentifier, "BO-1001100000-CLIENTPARENT", "ClientParent");
			fields[341] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DemographicsComponent.__internal_x_context__savedPatient_" + componentIdentifier, "BO-1001100000-HOMEFOLDERLOCATION", "HomeFolderLocation");
			fields[342] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DemographicsComponent.__internal_x_context__savedPatient_" + componentIdentifier, "BO-1001100000-PREFCOMMLANGUAGE", "PrefCommLanguage");
			fields[343] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DemographicsComponent.__internal_x_context__savedPatient_" + componentIdentifier, "BO-1001100000-COPYPATIENTONCORRESPONDENCE", "CopyPatientOnCorrespondence");
			fields[344] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DemographicsComponent.__internal_x_context__savedPatient_" + componentIdentifier, "BO-1001100000-COPYPATIENTONCORRESPONDENCEDATE", "CopyPatientOnCorrespondenceDate");
			fields[345] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DemographicsComponent.__internal_x_context__savedPatient_" + componentIdentifier, "BO-1001100000-HEALTHBOARD", "HealthBoard");
			fields[346] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DemographicsComponent.__internal_x_context__savedPatient_" + componentIdentifier, "BO-1001100000-PDSDEATHNOTIFICATIONSTATUS", "PDSDeathNotificationStatus");
			fields[347] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DemographicsComponent.__internal_x_context__savedPatient_" + componentIdentifier, "BO-1001100000-PDSINTERPRETERREQUIRED", "PDSInterpreterRequired");
			fields[348] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DemographicsComponent.__internal_x_context__savedPatient_" + componentIdentifier, "BO-1001100000-SCHOOL", "School");
			fields[349] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DemographicsComponent.__internal_x_context__savedPatient_" + componentIdentifier, "BO-1001100000-OVERSEASVISITOR", "OverseasVisitor");
			fields[350] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DemographicsComponent.__internal_x_context__savedPatient_" + componentIdentifier, "BO-1001100000-OVERSEASCLASSIFICATION", "OverseasClassification");
			fields[351] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DemographicsComponent.__internal_x_context__savedPatient_" + componentIdentifier, "BO-1001100000-HASLIVEDUK", "HasLivedUK");
			fields[352] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DemographicsComponent.__internal_x_context__savedPatient_" + componentIdentifier, "BO-1001100000-DECOUPLED", "Decoupled");
			fields[353] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DemographicsComponent.__internal_x_context__savedPatient_" + componentIdentifier, "BO-1001100000-PDSDATELASTCHECKED", "PDSDateLastChecked");
			fields[354] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DemographicsComponent.__internal_x_context__savedPatient_" + componentIdentifier, "BO-1001100000-SCHOOLORCOLLEGE", "SchoolOrCollege");
			fields[355] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DemographicsComponent.__internal_x_context__savedPatient_" + componentIdentifier, "BO-1001100000-ISCHILDINPUBLICCARE", "IsChildInPublicCare");
			fields[356] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DemographicsComponent.__internal_x_context__savedPatient_" + componentIdentifier, "BO-1001100000-PUBLICCARENEED", "PublicCareNeed");
			fields[357] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DemographicsComponent.__internal_x_context__savedPatient_" + componentIdentifier, "BO-1001100000-TXTOCCUPATION", "TxtOccupation");
			fields[358] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DemographicsComponent.__internal_x_context__DemographicControlsConf_" + componentIdentifier, "BO-1004100067-ID", "ID_DemographicControlsConfig");
			fields[359] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DemographicsComponent.__internal_x_context__DemographicControlsConf_" + componentIdentifier, "BO-1004100067-CONTROLIMSID", "ControlIMSID");
			fields[360] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DemographicsComponent.__internal_x_context__DemographicControlsConf_" + componentIdentifier, "BO-1004100067-CONTROLDESCRIPTIONONFORM", "ControlDescriptionOnForm");
			fields[361] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DemographicsComponent.__internal_x_context__DemographicControlsConf_" + componentIdentifier, "BO-1004100067-ISMANDATORY", "IsMandatory");
			fields[362] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DemographicsComponent.__internal_x_context__DemographicControlsConf_" + componentIdentifier, "BO-1004100067-CHANNELTYPE", "ChannelType");
			return fields;
		}
