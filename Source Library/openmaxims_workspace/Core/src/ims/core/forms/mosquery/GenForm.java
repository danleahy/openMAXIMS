...
public class GenForm extends FormBridge
{
	...
	public class LocalContext extends ContextBridge
	{
		...
		public LocalContext(Context context, ims.framework.FormInfo formInfo, String componentIdentifier)
		{
			...
			cxl_IsALocalConsultant = new ims.framework.ContextVariable("IsALocalConsultant", prefix + "_lv_Core.MOSQuery.__internal_x_context__IsALocalConsultant_" + componentIdentifier + "");
			...
			cxl_Service = new ims.framework.ContextVariable("Service", prefix + "_lv_Core.MOSQuery.__internal_x_context__Service_" + componentIdentifier + "");
			cxl_Function = new ims.framework.ContextVariable("Function", prefix + "_lv_Core.MOSQuery.__internal_x_context__Function_" + componentIdentifier + "");
			cxl_IsMedic = new ims.framework.ContextVariable("IsMedic", prefix + "_lv_Core.MOSQuery.__internal_x_context__IsMedic_" + componentIdentifier + "");
		}
		...
		{
			return !cxl_IsALocalConsultant.getValueIsNull(context);
		}
		public Boolean getIsALocalConsultant()
		{
			return (Boolean)cxl_IsALocalConsultant.getValue(context);
		}
		public void setIsALocalConsultant(Boolean value)
		{
			cxl_IsALocalConsultant.setValue(context, value);
		}
		private ims.framework.ContextVariable cxl_IsALocalConsultant = null;
		...
		{
			return (ims.core.clinical.vo.ServiceRefVo)cxl_Service.getValue(context);
		}
		public void setService(ims.core.clinical.vo.ServiceRefVo value)
		{
			if(value != null && (value.getBoId() == null || value.getBoId().intValue() < 1))
				throw new ims.framework.exceptions.CodingRuntimeException("Invalid domain object id for 'Service' RefVo context variable.");
			if(value == null)
				cxl_Service.setValue(context, null);
			else
				cxl_Service.setValue(context, new ims.core.clinical.vo.ServiceRefVo(value.getBoId(), value.getBoVersion()));
		}
		private ims.framework.ContextVariable cxl_Service = null;
		public boolean getFunctionIsNotNull()
		{
			return !cxl_Function.getValueIsNull(context);
		}
		public ims.core.vo.lookups.ServiceFunction getFunction()
		{
			return (ims.core.vo.lookups.ServiceFunction)cxl_Function.getValue(context);
		}
		public void setFunction(ims.core.vo.lookups.ServiceFunction value)
		{
			cxl_Function.setValue(context, value);
		}
		private ims.framework.ContextVariable cxl_Function = null;
		public boolean getIsMedicIsNotNull()
		{
			return !cxl_IsMedic.getValueIsNull(context);
		}
		public Boolean getIsMedic()
		{
			return (Boolean)cxl_IsMedic.getValue(context);
		}
		public void setIsMedic(Boolean value)
		{
			cxl_IsMedic.setValue(context, value);
		}
		private ims.framework.ContextVariable cxl_IsMedic = null;
	}
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.MOSQuery.__internal_x_context__Service_" + componentIdentifier, "BO-1003100032-ID", "ID_Service");
			return fields;
		}
