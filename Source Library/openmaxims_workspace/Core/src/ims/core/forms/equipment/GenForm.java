...
public class GenForm extends FormBridge
{
	...
	private void validateContext(ims.framework.Context context)
	{
		...
		if(!context.isValidContextType(ims.core.vo.EquipmentSearchCriteriaVo.class))
			throw new ims.framework.exceptions.CodingRuntimeException("The type 'ims.core.vo.EquipmentSearchCriteriaVo' of the global context variable 'Core.EquipmentSearchCriteria' is not supported.");
		if(!context.isValidContextType(ims.core.vo.EquipmentSearchCriteriaVo.class))
			throw new ims.framework.exceptions.CodingRuntimeException("The type 'ims.core.vo.EquipmentSearchCriteriaVo' of the global context variable 'Core.EquipmentSecondSearchCriteria' is not supported.");
	}
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1019), new Integer(anchoringHelper21.getX()), new Integer(anchoringHelper21.getY()), new Integer(anchoringHelper21.getWidth()), new Integer(anchoringHelper21.getHeight()), new Integer(startTabIndex.intValue() + 16), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Inactivate", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.Equipment.__internal_x_context__VoEquipment_" + componentIdentifier, "BO-1008100001-ID", "ID_Equipment");
			fields[145] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.Equipment.__internal_x_context__VoEquipment_" + componentIdentifier, "BO-1008100001-TYPE", "Type");
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.Equipment.__internal_x_context__VoEquipment_" + componentIdentifier, "BO-1008100001-SUPPLIER", "Supplier");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.Equipment.__internal_x_context__VoEquipment_" + componentIdentifier, "BO-1008100001-DATEREQUIRED", "DateRequired");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.Equipment.__internal_x_context__VoEquipment_" + componentIdentifier, "BO-1008100001-DATESUPPLIED", "DateSupplied");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.Equipment.__internal_x_context__VoEquipment_" + componentIdentifier, "BO-1008100001-SUPPLIEDFOR", "SuppliedFor");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.Equipment.__internal_x_context__VoEquipment_" + componentIdentifier, "BO-1008100001-LOAN", "Loan");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.Equipment.__internal_x_context__VoEquipment_" + componentIdentifier, "BO-1008100001-FUNDEDBY", "FundedBy");
			fields[152] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.Equipment.__internal_x_context__VoEquipment_" + componentIdentifier, "BO-1008100001-CARECONTEXT", "CareContext");
			fields[153] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.Equipment.__internal_x_context__VoEquipment_" + componentIdentifier, "BO-1008100001-INACTIVE", "Inactive");
			fields[154] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.Equipment.__internal_x_context__VoEquipment_" + componentIdentifier, "BO-1008100001-INACTIVATIONREASON", "InactivationReason");
			fields[155] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.Equipment.__internal_x_context__contactVo_" + componentIdentifier, "BO-1004100003-ID", "ID_ClinicalContact");
			fields[156] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.Equipment.__internal_x_context__contactVo_" + componentIdentifier, "BO-1004100003-SPECIALTY", "Specialty");
			fields[157] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.Equipment.__internal_x_context__contactVo_" + componentIdentifier, "BO-1004100003-SEENBY", "SeenBy");
			fields[158] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.Equipment.__internal_x_context__contactVo_" + componentIdentifier, "BO-1004100003-CONTACTTYPE", "ContactType");
			fields[159] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.Equipment.__internal_x_context__contactVo_" + componentIdentifier, "BO-1004100003-STARTDATETIME", "StartDateTime");
			fields[160] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.Equipment.__internal_x_context__contactVo_" + componentIdentifier, "BO-1004100003-ENDDATETIME", "EndDateTime");
			fields[161] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.Equipment.__internal_x_context__contactVo_" + componentIdentifier, "BO-1004100003-CARECONTEXT", "CareContext");
			fields[162] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.Equipment.__internal_x_context__contactVo_" + componentIdentifier, "BO-1004100003-ISCLINICALNOTECREATED", "IsClinicalNoteCreated");
			return fields;
		}
