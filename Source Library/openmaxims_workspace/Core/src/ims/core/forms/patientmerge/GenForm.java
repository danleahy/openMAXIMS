...
public class GenForm extends FormBridge
{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		ComboBox m_cmbToIdTypeTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1024), new Integer(anchoringHelper25.getX()), new Integer(anchoringHelper25.getY()), new Integer(anchoringHelper25.getWidth()), new Integer(anchoringHelper25.getHeight()), new Integer(startTabIndex.intValue() + 10), ControlState.ENABLED, ControlState.DISABLED,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
		...
		super.addControl(factory.getControl(ImageButton.class, new Object[] { control, new Integer(startControlID.intValue() + 1032), new Integer(anchoringHelper33.getX()), new Integer(anchoringHelper33.getY()), new Integer(anchoringHelper33.getWidth()), new Integer(anchoringHelper33.getHeight()), new Integer(startTabIndex.intValue() + 19), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, this.getImages().Core.Right, this.getImages().Core.RightDisabled, "Merge Patient", Boolean.TRUE, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null}));
	}
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.PatientMerge.__internal_x_context__MergeRequest_" + componentIdentifier, "BO-1001100007-ID", "ID_MergeRequest");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.PatientMerge.__internal_x_context__MergeRequest_" + componentIdentifier, "BO-1001100007-SOURCEPATID", "SourcePatId");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.PatientMerge.__internal_x_context__MergeRequest_" + componentIdentifier, "BO-1001100007-DESTINATIONPATID", "DestinationPatId");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.PatientMerge.__internal_x_context__MergeRequest_" + componentIdentifier, "BO-1001100007-STATUS", "Status");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.PatientMerge.__internal_x_context__MergeRequest_" + componentIdentifier, "BO-1001100007-COMMENT", "Comment");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.PatientMerge.__internal_x_context__MergeRequest_" + componentIdentifier, "BO-1001100007-MERGEIDENTIFIERS", "MergeIdentifiers");
			fields[152] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.PatientMerge.__internal_x_context__PatientFrom_" + componentIdentifier, "BO-1001100000-ID", "ID_Patient");
			fields[153] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.PatientMerge.__internal_x_context__PatientTo_" + componentIdentifier, "BO-1001100000-ID", "ID_Patient");
			return fields;
		}
