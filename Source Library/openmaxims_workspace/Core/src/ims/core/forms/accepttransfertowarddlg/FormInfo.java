...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "AcceptTransferToWardDlg";
	}
	public int getWidth()
	{
		return 672;
	...
	{
		return new String[] { "_cv_Core.WardViewPatientListWard", "_cv_Core.ADTPendingTransfer" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Core.AcceptTransferToWardDlg.__internal_x_context__" + String.valueOf(getFormId());
	}
