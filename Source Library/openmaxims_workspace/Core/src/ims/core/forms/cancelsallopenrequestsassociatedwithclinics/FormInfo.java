...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "CancelsAllOpenRequestsAssociatedWithClinics";
	}
	public int getWidth()
	{
		return 456;
	...
	{
		return "_lv_Core.CancelsAllOpenRequestsAssociatedWithClinics.__internal_x_context__" + String.valueOf(getFormId());
	}
