...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "PDSRelativesSynchronization";
	}
	public int getWidth()
	{
		return 848;
	...
	{
		return new String[] { "_cv_Core.SynchronizeRelatives", "_cv_Core.PdsRelativesSynchronization" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Core.PDSRelativesSynchronization.__internal_x_context__" + String.valueOf(getFormId());
	}
