...
public class GenForm extends FormBridge
{
	...
	public static class cmbDependencyLvlComboBox extends ComboBoxBridge
	{
		private static final long serialVersionUID = 1L;
	...
	public static class GroupWardTypeRadioButton extends RadioButtonBridge
	{
		...
		protected void setContext(Integer startTabIndex, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize)
		{
			...
			RuntimeAnchoring anchoringHelper1 = new RuntimeAnchoring(designSize, runtimeSize, 192, 55, 48, 24, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
			control.addButton(0, anchoringHelper1.getX(), anchoringHelper1.getY(), anchoringHelper1.getWidth(), "Side", startTabIndex.intValue() + 3);
			RuntimeAnchoring anchoringHelper2 = new RuntimeAnchoring(designSize, runtimeSize, 130, 55, 46, 24, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		ims.framework.utils.SizeInfo designSize = new ims.framework.utils.SizeInfo(448, 304);
		if(runtimeSize == null)
		...
		// Label Controls
		RuntimeAnchoring anchoringHelper3 = new RuntimeAnchoring(designSize, runtimeSize, 15, 215, 112, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		RuntimeAnchoring anchoringHelper4 = new RuntimeAnchoring(designSize, runtimeSize, 15, 244, 88, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1001), new Integer(anchoringHelper4.getX()), new Integer(anchoringHelper4.getY()), new Integer(anchoringHelper4.getWidth()), new Integer(anchoringHelper4.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Is Private Bed:", new Integer(1), null, new Integer(0)}));
		RuntimeAnchoring anchoringHelper5 = new RuntimeAnchoring(designSize, runtimeSize, 15, 185, 79, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1002), new Integer(anchoringHelper5.getX()), new Integer(anchoringHelper5.getY()), new Integer(anchoringHelper5.getWidth()), new Integer(anchoringHelper5.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Bed Number:", new Integer(1), null, new Integer(0)}));
		RuntimeAnchoring anchoringHelper6 = new RuntimeAnchoring(designSize, runtimeSize, 15, 22, 98, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1003), new Integer(anchoringHelper6.getX()), new Integer(anchoringHelper6.getY()), new Integer(anchoringHelper6.getWidth()), new Integer(anchoringHelper6.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Bed Space Type:", new Integer(1), null, new Integer(0)}));
		RuntimeAnchoring anchoringHelper7 = new RuntimeAnchoring(designSize, runtimeSize, 15, 55, 73, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1004), new Integer(anchoringHelper7.getX()), new Integer(anchoringHelper7.getY()), new Integer(anchoringHelper7.getWidth()), new Integer(anchoringHelper7.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Main / Side:", new Integer(1), null, new Integer(0)}));
		RuntimeAnchoring anchoringHelper8 = new RuntimeAnchoring(designSize, runtimeSize, 15, 85, 73, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1005), new Integer(anchoringHelper8.getX()), new Integer(anchoringHelper8.getY()), new Integer(anchoringHelper8.getWidth()), new Integer(anchoringHelper8.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Description:", new Integer(1), null, new Integer(0)}));

		// Button Controls
		RuntimeAnchoring anchoringHelper9 = new RuntimeAnchoring(designSize, runtimeSize, 359, 264, 75, 23, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		RuntimeAnchoring anchoringHelper10 = new RuntimeAnchoring(designSize, runtimeSize, 278, 264, 75, 23, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		// TextBox Controls
		RuntimeAnchoring anchoringHelper11 = new RuntimeAnchoring(designSize, runtimeSize, 240, 52, 0, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		RuntimeAnchoring anchoringHelper12 = new RuntimeAnchoring(designSize, runtimeSize, 130, 183, 144, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1009), new Integer(anchoringHelper12.getX()), new Integer(anchoringHelper12.getY()), new Integer(anchoringHelper12.getWidth()), new Integer(anchoringHelper12.getHeight()), new Integer(startTabIndex.intValue() + 5), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.FALSE, new Integer(10), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.SET, "", ""}));
		RuntimeAnchoring anchoringHelper13 = new RuntimeAnchoring(designSize, runtimeSize, 130, 85, 304, 88, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		// ComboBox Controls
		RuntimeAnchoring anchoringHelper14 = new RuntimeAnchoring(designSize, runtimeSize, 130, 213, 304, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		ComboBox m_cmbDependencyLvlTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1011), new Integer(anchoringHelper14.getX()), new Integer(anchoringHelper14.getY()), new Integer(anchoringHelper14.getWidth()), new Integer(anchoringHelper14.getHeight()), new Integer(startTabIndex.intValue() + 6), ControlState.DISABLED, ControlState.ENABLED,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
		addControl(m_cmbDependencyLvlTemp);
		cmbDependencyLvlComboBox cmbDependencyLvl = (cmbDependencyLvlComboBox)ComboBoxFlyweightFactory.getInstance().createComboBoxBridge(cmbDependencyLvlComboBox.class, m_cmbDependencyLvlTemp);
		super.addComboBox(cmbDependencyLvl);
		RuntimeAnchoring anchoringHelper15 = new RuntimeAnchoring(designSize, runtimeSize, 130, 20, 304, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		// CheckBox Controls
		RuntimeAnchoring anchoringHelper16 = new RuntimeAnchoring(designSize, runtimeSize, 130, 244, 16, 16, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		RadioButton tmpGroupWardType = (RadioButton)factory.getControl(RadioButton.class, new Object[] { control, new Integer(startControlID.intValue() + 1014), new Integer(0), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.FALSE});
	...
	public cmbDependencyLvlComboBox cmbDependencyLvl()
	{
		return (cmbDependencyLvlComboBox)super.getComboBox(0);
	}
	public cmbBedSpaceTypeComboBox cmbBedSpaceType()
	{
		return (cmbBedSpaceTypeComboBox)super.getComboBox(1);
	}
	public CheckBox chkIsPrivate()
	{
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.BedSpacePropertyDialog.__internal_x_context__SelectedBedSpace_" + componentIdentifier, "BO-1095100003-ID", "ID_BedSpace");
			fields[145] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.BedSpacePropertyDialog.__internal_x_context__SelectedBedSpace_" + componentIdentifier, "BO-1095100003-BEDSPACETYPE", "BedSpaceType");
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.BedSpacePropertyDialog.__internal_x_context__SelectedBedSpace_" + componentIdentifier, "BO-1095100003-DESCRIPTION", "Description");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.BedSpacePropertyDialog.__internal_x_context__SelectedBedSpace_" + componentIdentifier, "BO-1095100003-WARDTYPE", "WardType");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.BedSpacePropertyDialog.__internal_x_context__SelectedBedSpace_" + componentIdentifier, "BO-1095100003-BEDNUMBER", "BedNumber");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.BedSpacePropertyDialog.__internal_x_context__SelectedBedSpace_" + componentIdentifier, "BO-1095100003-PRIVATEBED", "PrivateBed");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.BedSpacePropertyDialog.__internal_x_context__SelectedBedSpace_" + componentIdentifier, "BO-1095100003-VML", "Vml");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.BedSpacePropertyDialog.__internal_x_context__SelectedBedSpace_" + componentIdentifier, "BO-1095100003-TEXTPOSITION", "TextPosition");
			fields[152] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.BedSpacePropertyDialog.__internal_x_context__SelectedBedSpace_" + componentIdentifier, "BO-1095100003-IMAGEPOSITION", "ImagePosition");
			fields[153] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.BedSpacePropertyDialog.__internal_x_context__SelectedBedSpace_" + componentIdentifier, "BO-1095100003-DEPENDENCY", "Dependency");
			fields[154] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.BedSpacePropertyDialog.__internal_x_context__SelectedBedSpaceState_" + componentIdentifier, "BO-1014100009-ID", "ID_BedSpaceState");
			fields[155] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.BedSpacePropertyDialog.__internal_x_context__SelectedBedSpaceState_" + componentIdentifier, "BO-1014100009-ISMATERNITY", "IsMaternity");
			fields[156] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.BedSpacePropertyDialog.__internal_x_context__SelectedBedSpaceState_" + componentIdentifier, "BO-1014100009-NOOFINFANTS", "NoOfInfants");
			fields[157] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.BedSpacePropertyDialog.__internal_x_context__SelectedBedSpaceState_" + componentIdentifier, "BO-1014100009-COMMENT", "Comment");
			return fields;
		}
