...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Core.PatientFromPDS", "_cv_Core.SamlXml", "_cv_Core.PatientToBeDisplayed", "_cv_Core.PatientToBeSynchronized" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Core.PDSBackOfficeWorklist.__internal_x_context__" + String.valueOf(getFormId());
	}
