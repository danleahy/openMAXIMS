...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Core.CurrentCaseFolderLocation", "_cv_Core.CaseFolderChange" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Core.CaseNoteTracking.__internal_x_context__" + String.valueOf(getFormId());
	}
