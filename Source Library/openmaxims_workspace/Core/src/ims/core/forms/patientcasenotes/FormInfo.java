...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Core.PatientCaseNoteFolderRef", "_cv_Core.CaseNoteRequestRef" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Core.PatientCaseNotes.__internal_x_context__" + String.valueOf(getFormId());
	}
	public ims.framework.FormInfo[] getComponentsFormInfo()
	{
		...
		componentsInfo[1] = new ims.core.forms.casenotefoldercc.FormInfo(102463);
		componentsInfo[2] = new ims.core.forms.casenoteopentrequestsgridcc.FormInfo(102462);
