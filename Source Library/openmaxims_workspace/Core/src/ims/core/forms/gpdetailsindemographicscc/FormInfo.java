...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "GPDetailsInDemographicsCC";
	}
	public int getWidth()
	{
		return 420;
	...
	{
		return new String[] { "_cv_Core.GPPractice", "_cv_Core.GPDetails", "_cv_Core.GPSurgery", "_cv_Core.GPPracticeWithComm" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Core.GPDetailsInDemographicsCC.__internal_x_context__" + String.valueOf(getFormId());
	}
