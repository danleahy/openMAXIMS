...
abstract public class Handlers implements ims.framework.UILogic, IFormUILogicCode
{
	...
	abstract protected void onDyngrdDemographicControlsCellValueChanged(ims.framework.controls.DynamicGridCell cell);
	...
	public final void setContext(ims.framework.UIEngine engine, GenForm form)
	{
		...
		this.form.dyngrdDemographicControls().setDynamicGridCellValueChangedEvent(new DynamicGridCellValueChanged()
		{
			private static final long serialVersionUID = 1L;
			...
			{
				onDyngrdDemographicControlsCellValueChanged(cell);
			}
		});
