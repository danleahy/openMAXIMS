...
public class GenForm extends FormBridge
{
	...
	public static class grdDocumentsRow extends GridRowBridge
	{
		...
		public void setColEnclosureReadOnly(boolean value)
		{
			super.row.setReadOnly(10, value);
		}
		public boolean isColEnclosureReadOnly()
		{
			return super.row.isReadOnly(10);
		}
		public void showColEnclosureOpened()
		{
			super.row.showOpened(10);
		}
		public void setTooltipForColEnclosure(String value)
		{
			super.row.setTooltip(10, value);
		}
		public ims.framework.utils.Image getColEnclosure()
		{
			return (ims.framework.utils.Image)super.row.get(10);
		}
		public void setColEnclosure(ims.framework.utils.Image value)
		{
			super.row.set(10, value);
		}
		public void setCellColEnclosureTooltip(String value)
		{
			super.row.setTooltip(10, value);
		}
		...
		{
			return ((Boolean)super.row.get(11)).booleanValue();
		}
		public void setSelect(boolean value)
		{
			super.row.set(11, new Boolean(value));
		}
	...
	public static class grdDocumentsGrid extends GridBridge
	{
		...
		public void setColEnclosureHeaderTooltip(String value)
		{
			super.grid.setColumnHeaderTooltip(10, value);
		}
		public String getColEnclosureHeaderTooltip()
		{
	...
	public static class GroupSearchDateIntervalRadioButton extends RadioButtonBridge
	{
		...
		protected void setContext(Integer startTabIndex, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize)
		{
			...
			RuntimeAnchoring anchoringHelper1 = new RuntimeAnchoring(designSize, runtimeSize, 500, 78, 100, 16, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
			control.addButton(0, anchoringHelper1.getX(), anchoringHelper1.getY(), anchoringHelper1.getWidth(), "Generated Date", startTabIndex.intValue() + 15);
			RuntimeAnchoring anchoringHelper2 = new RuntimeAnchoring(designSize, runtimeSize, 413, 78, 80, 16, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
			control.addButton(1, anchoringHelper2.getX(), anchoringHelper2.getY(), anchoringHelper2.getWidth(), "Event Date", startTabIndex.intValue() + 14);
		}
		...
		public GroupSearchDateIntervalEnumeration getValue()
		{
			switch (super.control.getValue())
			{
				...
				case 0: return GroupSearchDateIntervalEnumeration.rdoGeneratedDate;
				case 1: return GroupSearchDateIntervalEnumeration.rdoEventDate;
			}
			return null;
		}
	...
	public static class GroupSearchDateIntervalEnumeration implements java.io.Serializable
	{
		...
		public static GroupSearchDateIntervalEnumeration rdoGeneratedDate = new GroupSearchDateIntervalEnumeration(0);
		public static GroupSearchDateIntervalEnumeration rdoEventDate = new GroupSearchDateIntervalEnumeration(1);
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		RuntimeAnchoring anchoringHelper3 = new RuntimeAnchoring(designSize, runtimeSize, 120, 6, 280, 20, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT);
		ims.framework.FormUiLogic m_ccResponsibleForm = loader.loadComponent(102256, appForm, startControlID * 10 + 1000, anchoringHelper3.getSize(), instance1, startTabIndex.intValue() + 1, skipContextValidation);
		...
		RuntimeAnchoring anchoringHelper4 = new RuntimeAnchoring(designSize, runtimeSize, 120, 54, 280, 20, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT);
		ims.framework.FormUiLogic m_ccTypistForm = loader.loadComponent(102256, appForm, startControlID * 10 + 2000, anchoringHelper4.getSize(), instance2, startTabIndex.intValue() + 5, skipContextValidation);
		//ims.framework.Control m_ccTypistControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1002), new Integer(120), new Integer(54), new Integer(280), new Integer(20), ControlState.ENABLED, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT, new Integer(startTabIndex.intValue() + 5), m_ccTypistForm, instance2 } );
		ims.framework.Control m_ccTypistControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1003),  new Integer(anchoringHelper4.getX()), new Integer(anchoringHelper4.getY()), new Integer(anchoringHelper4.getWidth()), new Integer(anchoringHelper4.getHeight()), ControlState.ENABLED, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT, new Integer(startTabIndex.intValue() + 5), m_ccTypistForm, instance2, Boolean.FALSE } );
		...
		RuntimeAnchoring anchoringHelper5 = new RuntimeAnchoring(designSize, runtimeSize, 120, 30, 280, 20, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT);
		ims.framework.FormUiLogic m_ccAuthorForm = loader.loadComponent(102256, appForm, startControlID * 10 + 3000, anchoringHelper5.getSize(), instance3, startTabIndex.intValue() + 3, skipContextValidation);
		//ims.framework.Control m_ccAuthorControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1004), new Integer(120), new Integer(30), new Integer(280), new Integer(20), ControlState.ENABLED, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT, new Integer(startTabIndex.intValue() + 3), m_ccAuthorForm, instance3 } );
		ims.framework.Control m_ccAuthorControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1005),  new Integer(anchoringHelper5.getX()), new Integer(anchoringHelper5.getY()), new Integer(anchoringHelper5.getWidth()), new Integer(anchoringHelper5.getHeight()), ControlState.ENABLED, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT, new Integer(startTabIndex.intValue() + 3), m_ccAuthorForm, instance3, Boolean.FALSE } );
		...
		// Label Controls
		RuntimeAnchoring anchoringHelper6 = new RuntimeAnchoring(designSize, runtimeSize, 414, 155, 102, 17, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
		...
		RuntimeAnchoring anchoringHelper7 = new RuntimeAnchoring(designSize, runtimeSize, 414, 131, 97, 17, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
		...
		RuntimeAnchoring anchoringHelper8 = new RuntimeAnchoring(designSize, runtimeSize, 8, 8, 104, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1008), new Integer(anchoringHelper8.getX()), new Integer(anchoringHelper8.getY()), new Integer(anchoringHelper8.getWidth()), new Integer(anchoringHelper8.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Responsible HCP:", new Integer(1), null, new Integer(0)}));
		RuntimeAnchoring anchoringHelper9 = new RuntimeAnchoring(designSize, runtimeSize, 8, 80, 57, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1009), new Integer(anchoringHelper9.getX()), new Integer(anchoringHelper9.getY()), new Integer(anchoringHelper9.getWidth()), new Integer(anchoringHelper9.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Location:", new Integer(1), null, new Integer(0)}));
		RuntimeAnchoring anchoringHelper10 = new RuntimeAnchoring(designSize, runtimeSize, 625, 106, 22, 17, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
		...
		RuntimeAnchoring anchoringHelper11 = new RuntimeAnchoring(designSize, runtimeSize, 8, 104, 65, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1011), new Integer(anchoringHelper11.getX()), new Integer(anchoringHelper11.getY()), new Integer(anchoringHelper11.getWidth()), new Integer(anchoringHelper11.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "O/P Clinic:", new Integer(1), null, new Integer(0)}));
		RuntimeAnchoring anchoringHelper12 = new RuntimeAnchoring(designSize, runtimeSize, 625, 80, 38, 17, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
		...
		RuntimeAnchoring anchoringHelper13 = new RuntimeAnchoring(designSize, runtimeSize, 414, 56, 60, 17, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
		...
		RuntimeAnchoring anchoringHelper14 = new RuntimeAnchoring(designSize, runtimeSize, 414, 32, 97, 17, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
		...
		RuntimeAnchoring anchoringHelper15 = new RuntimeAnchoring(designSize, runtimeSize, 414, 8, 106, 17, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
		...
		RuntimeAnchoring anchoringHelper16 = new RuntimeAnchoring(designSize, runtimeSize, 8, 56, 43, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1016), new Integer(anchoringHelper16.getX()), new Integer(anchoringHelper16.getY()), new Integer(anchoringHelper16.getWidth()), new Integer(anchoringHelper16.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Typist:", new Integer(1), null, new Integer(0)}));
		RuntimeAnchoring anchoringHelper17 = new RuntimeAnchoring(designSize, runtimeSize, 8, 32, 92, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1017), new Integer(anchoringHelper17.getX()), new Integer(anchoringHelper17.getY()), new Integer(anchoringHelper17.getWidth()), new Integer(anchoringHelper17.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Authoring HCP:", new Integer(1), null, new Integer(0)}));

		// Button Controls
		RuntimeAnchoring anchoringHelper18 = new RuntimeAnchoring(designSize, runtimeSize, 8, 600, 168, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT);
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1018), new Integer(anchoringHelper18.getX()), new Integer(anchoringHelper18.getY()), new Integer(anchoringHelper18.getWidth()), new Integer(anchoringHelper18.getHeight()), new Integer(startTabIndex.intValue() + 23), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Clinic Letter Batch Create", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));

		// TextBox Controls
		RuntimeAnchoring anchoringHelper19 = new RuntimeAnchoring(designSize, runtimeSize, 528, 153, 244, 21, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
		super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1019), new Integer(anchoringHelper19.getX()), new Integer(anchoringHelper19.getY()), new Integer(anchoringHelper19.getWidth()), new Integer(anchoringHelper19.getHeight()), new Integer(startTabIndex.intValue() + 19), ControlState.UNKNOWN, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.TOPRIGHT,Boolean.FALSE, new Integer(50), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));

		// Date Controls
		RuntimeAnchoring anchoringHelper20 = new RuntimeAnchoring(designSize, runtimeSize, 668, 78, 104, 20, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
		super.addControl(factory.getControl(DateControl.class, new Object[] { control, new Integer(startControlID.intValue() + 1020), new Integer(anchoringHelper20.getX()), new Integer(anchoringHelper20.getY()), new Integer(anchoringHelper20.getWidth()), new Integer(anchoringHelper20.getHeight()), new Integer(startTabIndex.intValue() + 16), ControlState.ENABLED, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.TOPRIGHT,Boolean.TRUE, null, Boolean.FALSE, null, Boolean.FALSE, null}));
		RuntimeAnchoring anchoringHelper21 = new RuntimeAnchoring(designSize, runtimeSize, 668, 104, 104, 20, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
		super.addControl(factory.getControl(DateControl.class, new Object[] { control, new Integer(startControlID.intValue() + 1021), new Integer(anchoringHelper21.getX()), new Integer(anchoringHelper21.getY()), new Integer(anchoringHelper21.getWidth()), new Integer(anchoringHelper21.getHeight()), new Integer(startTabIndex.intValue() + 17), ControlState.ENABLED, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.TOPRIGHT,Boolean.TRUE, null, Boolean.FALSE, null, Boolean.FALSE, null}));

		// ComboBox Controls
		RuntimeAnchoring anchoringHelper22 = new RuntimeAnchoring(designSize, runtimeSize, 528, 129, 244, 21, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
		ComboBox m_cmbIdTypeTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1022), new Integer(anchoringHelper22.getX()), new Integer(anchoringHelper22.getY()), new Integer(anchoringHelper22.getWidth()), new Integer(anchoringHelper22.getHeight()), new Integer(startTabIndex.intValue() + 18), ControlState.UNKNOWN, ControlState.ENABLED,ims.framework.enumerations.ControlAnchoring.TOPRIGHT ,Boolean.FALSE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
		...
		RuntimeAnchoring anchoringHelper23 = new RuntimeAnchoring(designSize, runtimeSize, 120, 78, 264, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT);
		...
		RuntimeAnchoring anchoringHelper24 = new RuntimeAnchoring(designSize, runtimeSize, 532, 6, 240, 21, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
		ComboBox m_cmbDocStatusTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1024), new Integer(anchoringHelper24.getX()), new Integer(anchoringHelper24.getY()), new Integer(anchoringHelper24.getWidth()), new Integer(anchoringHelper24.getHeight()), new Integer(startTabIndex.intValue() + 11), ControlState.ENABLED, ControlState.DISABLED,ims.framework.enumerations.ControlAnchoring.TOPRIGHT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
		...
		RuntimeAnchoring anchoringHelper25 = new RuntimeAnchoring(designSize, runtimeSize, 532, 54, 240, 21, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
		ComboBox m_cmbSpecialtyTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1025), new Integer(anchoringHelper25.getX()), new Integer(anchoringHelper25.getY()), new Integer(anchoringHelper25.getWidth()), new Integer(anchoringHelper25.getHeight()), new Integer(startTabIndex.intValue() + 13), ControlState.ENABLED, ControlState.DISABLED,ims.framework.enumerations.ControlAnchoring.TOPRIGHT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
		...
		RuntimeAnchoring anchoringHelper26 = new RuntimeAnchoring(designSize, runtimeSize, 532, 30, 240, 21, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
		...
		RuntimeAnchoring anchoringHelper27 = new RuntimeAnchoring(designSize, runtimeSize, 120, 102, 264, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT);
		ComboBox m_qmbClinicTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1027), new Integer(anchoringHelper27.getX()), new Integer(anchoringHelper27.getY()), new Integer(anchoringHelper27.getWidth()), new Integer(anchoringHelper27.getHeight()), new Integer(startTabIndex.intValue() + 8), ControlState.UNKNOWN, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT,Boolean.TRUE, Boolean.TRUE, SortOrder.NONE, Boolean.TRUE, new Integer(1), null, Boolean.TRUE, new Integer(-1), Boolean.FALSE});
		...
		// CheckBox Controls
		RuntimeAnchoring anchoringHelper28 = new RuntimeAnchoring(designSize, runtimeSize, 120, 131, 264, 16, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(CheckBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1028), new Integer(anchoringHelper28.getX()), new Integer(anchoringHelper28.getY()), new Integer(anchoringHelper28.getWidth()), new Integer(anchoringHelper28.getHeight()), new Integer(startTabIndex.intValue() + 9), ControlState.UNKNOWN, ControlState.DISABLED,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,"Exclude completed documents", Boolean.FALSE, null}));
		RuntimeAnchoring anchoringHelper29 = new RuntimeAnchoring(designSize, runtimeSize, 430, 603, 350, 16, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT);
		super.addControl(factory.getControl(CheckBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1029), new Integer(anchoringHelper29.getX()), new Integer(anchoringHelper29.getY()), new Integer(anchoringHelper29.getWidth()), new Integer(anchoringHelper29.getHeight()), new Integer(startTabIndex.intValue() + 24), ControlState.UNKNOWN, ControlState.DISABLED,ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT ,"Keep Selected Patient Record Open after Viewing / Editing Document", Boolean.TRUE, null}));
		RuntimeAnchoring anchoringHelper30 = new RuntimeAnchoring(designSize, runtimeSize, 120, 155, 264, 16, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(CheckBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1030), new Integer(anchoringHelper30.getX()), new Integer(anchoringHelper30.getY()), new Integer(anchoringHelper30.getWidth()), new Integer(anchoringHelper30.getHeight()), new Integer(startTabIndex.intValue() + 10), ControlState.UNKNOWN, ControlState.DISABLED,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,"View documents for selected patient", Boolean.TRUE, null}));

		// Grid Controls
		RuntimeAnchoring anchoringHelper31 = new RuntimeAnchoring(designSize, runtimeSize, 8, 184, 832, 408, ims.framework.enumerations.ControlAnchoring.ALL);
		Grid m_grdDocumentsTemp = (Grid)factory.getControl(Grid.class, new Object[] { control, new Integer(startControlID.intValue() + 1031), new Integer(anchoringHelper31.getX()), new Integer(anchoringHelper31.getY()), new Integer(anchoringHelper31.getWidth()), new Integer(anchoringHelper31.getHeight()), new Integer(startTabIndex.intValue() + 22), ControlState.EDITABLE, ControlState.EDITABLE, ims.framework.enumerations.ControlAnchoring.ALL,Boolean.TRUE, Boolean.FALSE, new Integer(50), Boolean.TRUE, contextMenus.Core.contextMenuDocumentWorklistMenu, Boolean.FALSE, Boolean.TRUE, new Integer(0), null, Boolean.TRUE, Boolean.TRUE});
		...
		grdDocuments.addStringColumn("Surname", 0, 0, 80, true, false, 2, 0, true, ims.framework.enumerations.CharacterCasing.NORMAL);
		grdDocuments.setSurnameHeaderTooltip("Surname");
		grdDocuments.addStringColumn("Forename", 0, 0, 80, true, false, 2, 0, true, ims.framework.enumerations.CharacterCasing.NORMAL);
		grdDocuments.setForenameHeaderTooltip("Forename");
		grdDocuments.addStringColumn("NHS No", 0, 0, 80, true, false, 2, 0, false, ims.framework.enumerations.CharacterCasing.NORMAL);
		grdDocuments.setNHSNoHeaderTooltip("NHS No");
		grdDocuments.addStringColumn("Document\nTitle", 0, 0, 110, true, false, 2, 0, true, ims.framework.enumerations.CharacterCasing.NORMAL);
		grdDocuments.setColTitleHeaderTooltip("Document Title");
		grdDocuments.addStringColumn("Author", 0, 0, 100, true, false, 2, 0, true, ims.framework.enumerations.CharacterCasing.NORMAL);
		grdDocuments.addDateColumn("Event\nDate", 0, 0, 70, true, true, null, false, 2, false);
		grdDocuments.setDateHeaderTooltip("Event Date");
		grdDocuments.addImageColumn(" ", 0, 1, 26, true, 0);
		grdDocuments.addImageColumn(" ", 0, 1, 26, true, 0);
		grdDocuments.addStringColumn("Document\nStatus", 0, 0, 80, true, false, 2, 0, true, ims.framework.enumerations.CharacterCasing.NORMAL);
		grdDocuments.setStatusHeaderTooltip("Document Status");
		grdDocuments.addIntColumn("Copies", 0, 1, 45, true, true, null, false, 0, false, 0);
		grdDocuments.setColNoOfCopiesHeaderTooltip("Copies");
		grdDocuments.addImageColumn("Enclosure", 0, 1, 70, true, 0);
		grdDocuments.setColEnclosureHeaderTooltip("Enclosure");
		grdDocuments.addBoolColumn("Select", 1, 1, -1, false, true, 0, true);
		grdDocuments.setSelectHeaderTooltip("Select");
		super.addGrid(grdDocuments);

		// Image Buttons Controls
		RuntimeAnchoring anchoringHelper32 = new RuntimeAnchoring(designSize, runtimeSize, 810, 6, 30, 30, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
		super.addControl(factory.getControl(ImageButton.class, new Object[] { control, new Integer(startControlID.intValue() + 1032), new Integer(anchoringHelper32.getX()), new Integer(anchoringHelper32.getY()), new Integer(anchoringHelper32.getWidth()), new Integer(anchoringHelper32.getHeight()), new Integer(startTabIndex.intValue() + 21), ControlState.ENABLED, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.TOPRIGHT, this.getImages().Core.ClearEnabled24, this.getImages().Core.ClearDisabled24, "Clear", Boolean.FALSE, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null}));
		RuntimeAnchoring anchoringHelper33 = new RuntimeAnchoring(designSize, runtimeSize, 777, 6, 30, 30, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
		...
		RadioButton tmpGroupSearchDateInterval = (RadioButton)factory.getControl(RadioButton.class, new Object[] { control, new Integer(startControlID.intValue() + 1034), new Integer(0), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT,Boolean.TRUE});
	...
	public static class Images implements java.io.Serializable
	{
		...
		public final class CoreImages implements java.io.Serializable
		{
			...
			private CoreImages()
			{
				...
				OpenLetter16 = new ImageHelper(102576, "Images/Core/Open letter 16x16.png", new Integer(16), new Integer(16));
			}
			public final ims.framework.utils.Image ClearDisabled24;
			public final ims.framework.utils.Image ClearEnabled24;
			public final ims.framework.utils.Image FindDisabled24;
			public final ims.framework.utils.Image FindEnabled24;
			public final ims.framework.utils.Image OpenLetter16;
		}
	...
	public class LocalContext extends ContextBridge
	{
		...
		public LocalContext(Context context, ims.framework.FormInfo formInfo, String componentIdentifier)
		{
			...
			cxl_SortOrderAuthoring = new ims.framework.ContextVariable("SortOrderAuthoring", prefix + "_lv_Core.DocumentWorklist.__internal_x_context__SortOrderAuthoring_" + componentIdentifier + "");
			...
			cxl_SortOrderSurname = new ims.framework.ContextVariable("SortOrderSurname", prefix + "_lv_Core.DocumentWorklist.__internal_x_context__SortOrderSurname_" + componentIdentifier + "");
			cxl_SortOrderForename = new ims.framework.ContextVariable("SortOrderForename", prefix + "_lv_Core.DocumentWorklist.__internal_x_context__SortOrderForename_" + componentIdentifier + "");
			cxl_SortOrderNHS = new ims.framework.ContextVariable("SortOrderNHS", prefix + "_lv_Core.DocumentWorklist.__internal_x_context__SortOrderNHS_" + componentIdentifier + "");
			cxl_SortOrderTitle = new ims.framework.ContextVariable("SortOrderTitle", prefix + "_lv_Core.DocumentWorklist.__internal_x_context__SortOrderTitle_" + componentIdentifier + "");
			cxl_SortOrderDate = new ims.framework.ContextVariable("SortOrderDate", prefix + "_lv_Core.DocumentWorklist.__internal_x_context__SortOrderDate_" + componentIdentifier + "");
			cxl_SortOrderStatus = new ims.framework.ContextVariable("SortOrderStatus", prefix + "_lv_Core.DocumentWorklist.__internal_x_context__SortOrderStatus_" + componentIdentifier + "");
			cxl_DraftPDFFileName = new ims.framework.ContextVariable("DraftPDFFileName", prefix + "_lv_Core.DocumentWorklist.__internal_x_context__DraftPDFFileName_" + componentIdentifier + "");
		}
		...
		public boolean getSortOrderAuthoringIsNotNull()
		{
			return !cxl_SortOrderAuthoring.getValueIsNull(context);
		}
		public ims.framework.enumerations.SortOrder getSortOrderAuthoring()
		{
			return (ims.framework.enumerations.SortOrder)cxl_SortOrderAuthoring.getValue(context);
		}
		public void setSortOrderAuthoring(ims.framework.enumerations.SortOrder value)
		{
			cxl_SortOrderAuthoring.setValue(context, value);
		}
		private ims.framework.ContextVariable cxl_SortOrderAuthoring = null;
		...
		public boolean getSortOrderNHSIsNotNull()
		{
			return !cxl_SortOrderNHS.getValueIsNull(context);
		}
		public ims.framework.enumerations.SortOrder getSortOrderNHS()
		{
			return (ims.framework.enumerations.SortOrder)cxl_SortOrderNHS.getValue(context);
		}
		public void setSortOrderNHS(ims.framework.enumerations.SortOrder value)
		{
			cxl_SortOrderNHS.setValue(context, value);
		}
		private ims.framework.ContextVariable cxl_SortOrderNHS = null;
		public boolean getSortOrderTitleIsNotNull()
		{
			return !cxl_SortOrderTitle.getValueIsNull(context);
		}
		public ims.framework.enumerations.SortOrder getSortOrderTitle()
		{
			return (ims.framework.enumerations.SortOrder)cxl_SortOrderTitle.getValue(context);
		}
		public void setSortOrderTitle(ims.framework.enumerations.SortOrder value)
		{
			cxl_SortOrderTitle.setValue(context, value);
		}
		private ims.framework.ContextVariable cxl_SortOrderTitle = null;
		public boolean getSortOrderDateIsNotNull()
		{
			return !cxl_SortOrderDate.getValueIsNull(context);
		}
		public ims.framework.enumerations.SortOrder getSortOrderDate()
		{
			return (ims.framework.enumerations.SortOrder)cxl_SortOrderDate.getValue(context);
		}
		public void setSortOrderDate(ims.framework.enumerations.SortOrder value)
		{
			cxl_SortOrderDate.setValue(context, value);
		}
		private ims.framework.ContextVariable cxl_SortOrderDate = null;
		public boolean getSortOrderStatusIsNotNull()
		{
			return !cxl_SortOrderStatus.getValueIsNull(context);
		}
		public ims.framework.enumerations.SortOrder getSortOrderStatus()
		{
			return (ims.framework.enumerations.SortOrder)cxl_SortOrderStatus.getValue(context);
		}
		public void setSortOrderStatus(ims.framework.enumerations.SortOrder value)
		{
			cxl_SortOrderStatus.setValue(context, value);
		}
		private ims.framework.ContextVariable cxl_SortOrderStatus = null;
		public boolean getDraftPDFFileNameIsNotNull()
		{
			return !cxl_DraftPDFFileName.getValueIsNull(context);
		}
		public String getDraftPDFFileName()
		{
			return (String)cxl_DraftPDFFileName.getValue(context);
		}
		public void setDraftPDFFileName(String value)
		{
			cxl_DraftPDFFileName.setValue(context, value);
		}
		private ims.framework.ContextVariable cxl_DraftPDFFileName = null;
	}
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[173] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DocumentWorklist.__internal_x_context__SelectedDocument_" + componentIdentifier, "BO-1068100001-ID", "ID_PatientDocument");
			fields[174] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DocumentWorklist.__internal_x_context__SelectedDocument_" + componentIdentifier, "BO-1068100001-PATIENT", "Patient");
			fields[175] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DocumentWorklist.__internal_x_context__SelectedDocument_" + componentIdentifier, "BO-1068100001-EPISODEOFCARE", "EpisodeofCare");
			fields[176] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DocumentWorklist.__internal_x_context__SelectedDocument_" + componentIdentifier, "BO-1068100001-CARECONTEXT", "CareContext");
			fields[177] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DocumentWorklist.__internal_x_context__SelectedDocument_" + componentIdentifier, "BO-1068100001-CLINICALCONTACT", "ClinicalContact");
			fields[178] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DocumentWorklist.__internal_x_context__SelectedDocument_" + componentIdentifier, "BO-1068100001-REFERRAL", "Referral");
			fields[179] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DocumentWorklist.__internal_x_context__SelectedDocument_" + componentIdentifier, "BO-1068100001-NAME", "Name");
			fields[180] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DocumentWorklist.__internal_x_context__SelectedDocument_" + componentIdentifier, "BO-1068100001-CREATIONTYPE", "CreationType");
			fields[181] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DocumentWorklist.__internal_x_context__SelectedDocument_" + componentIdentifier, "BO-1068100001-CATEGORY", "Category");
			fields[182] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DocumentWorklist.__internal_x_context__SelectedDocument_" + componentIdentifier, "BO-1068100001-STATUS", "Status");
			fields[183] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DocumentWorklist.__internal_x_context__SelectedDocument_" + componentIdentifier, "BO-1068100001-RECORDINGUSER", "RecordingUser");
			fields[184] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DocumentWorklist.__internal_x_context__SelectedDocument_" + componentIdentifier, "BO-1068100001-RECORDINGDATETIME", "RecordingDateTime");
			fields[185] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DocumentWorklist.__internal_x_context__SelectedDocument_" + componentIdentifier, "BO-1068100001-AUTHORINGHCP", "AuthoringHCP");
			fields[186] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DocumentWorklist.__internal_x_context__SelectedDocument_" + componentIdentifier, "BO-1068100001-AUTHORINGDATETIME", "AuthoringDateTime");
			fields[187] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DocumentWorklist.__internal_x_context__SelectedDocument_" + componentIdentifier, "BO-1068100001-SPECIALTY", "Specialty");
			fields[188] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DocumentWorklist.__internal_x_context__SelectedDocument_" + componentIdentifier, "BO-1068100001-CORRESPONDENCESTATUS", "CorrespondenceStatus");
			fields[189] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DocumentWorklist.__internal_x_context__SelectedDocument_" + componentIdentifier, "BO-1068100001-DOCUMENTDATE", "DocumentDate");
			fields[190] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DocumentWorklist.__internal_x_context__SelectedDocument_" + componentIdentifier, "BO-1068100001-CLINIC", "Clinic");
			fields[191] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DocumentWorklist.__internal_x_context__SelectedDocument_" + componentIdentifier, "BO-1068100001-ISLOCKEDFOREDITING", "IsLockedForEditing");
			fields[192] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DocumentWorklist.__internal_x_context__SelectedDocument_" + componentIdentifier, "BO-1068100001-LOCKEDBYUSER", "LockedByUser");
			fields[193] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DocumentWorklist.__internal_x_context__SelectedDocument_" + componentIdentifier, "BO-1068100001-LOCKEDONDATETIME", "LockedOnDateTime");
			fields[194] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DocumentWorklist.__internal_x_context__SelectedDocument_" + componentIdentifier, "BO-1068100001-RESPONSIBLEHCP", "ResponsibleHCP");
			fields[195] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DocumentWorklist.__internal_x_context__SelectedDocument_" + componentIdentifier, "BO-1068100001-NOOFCOPIES", "NoOfCopies");
			fields[196] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DocumentWorklist.__internal_x_context__SelectedDocument_" + componentIdentifier, "BO-1068100001-HISTORICALFILENAME", "HistoricalFileName");
			fields[197] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DocumentWorklist.__internal_x_context__SelectedDocument_" + componentIdentifier, "BO-1068100001-HISTORICDOCID", "HistoricDocId");
			fields[198] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DocumentWorklist.__internal_x_context__SelectedDocument_" + componentIdentifier, "BO-1068100001-WASPRINTED", "WasPrinted");
			fields[199] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DocumentWorklist.__internal_x_context__SelectedDocument_" + componentIdentifier, "BO-1068100001-EMAILSTATUS", "EmailStatus");
			fields[200] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DocumentWorklist.__internal_x_context__SelectedDocument_" + componentIdentifier, "BO-1068100001-COPYPATIENTONCORRESPONDENCE", "CopyPatientOnCorrespondence");
			fields[201] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DocumentWorklist.__internal_x_context__SelectedDocument_" + componentIdentifier, "BO-1068100001-HASENCLOSURE", "HasEnclosure");
			fields[202] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DocumentWorklist.__internal_x_context__OldSelectedDocument_" + componentIdentifier, "BO-1068100001-ID", "ID_PatientDocument");
			fields[203] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DocumentWorklist.__internal_x_context__OldSelectedDocument_" + componentIdentifier, "BO-1068100001-DOCUMENTDATE", "DocumentDate");
			fields[204] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DocumentWorklist.__internal_x_context__OldSelectedDocument_" + componentIdentifier, "BO-1068100001-NOOFCOPIES", "NoOfCopies");
			fields[205] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DocumentWorklist.__internal_x_context__OldSelectedDocument_" + componentIdentifier, "BO-1068100001-NAME", "Name");
			fields[206] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DocumentWorklist.__internal_x_context__OldSelectedDocument_" + componentIdentifier, "BO-1068100001-CATEGORY", "Category");
			fields[207] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DocumentWorklist.__internal_x_context__OldSelectedDocument_" + componentIdentifier, "BO-1068100001-WASPRINTED", "WasPrinted");
			fields[208] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DocumentWorklist.__internal_x_context__OldSelectedDocument_" + componentIdentifier, "BO-1068100001-EMAILSTATUS", "EmailStatus");
			fields[209] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DocumentWorklist.__internal_x_context__OldSelectedDocument_" + componentIdentifier, "BO-1068100001-COPYPATIENTONCORRESPONDENCE", "CopyPatientOnCorrespondence");
			fields[210] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DocumentWorklist.__internal_x_context__OldSelectedDocument_" + componentIdentifier, "BO-1068100001-HASENCLOSURE", "HasEnclosure");
			fields[211] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.DocumentWorklist.__internal_x_context__PatientGP_" + componentIdentifier, "BO-1006100001-ID", "ID_Gp");
			return fields;
		}
