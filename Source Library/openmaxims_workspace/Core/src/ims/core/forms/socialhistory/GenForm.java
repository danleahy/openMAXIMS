...
public class GenForm extends FormBridge
{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		contextMenus.Core.contextMenuSocialHistoryGridAddItem = factory.createMenuItem(startControlID.intValue() + 12, "Add", true, false, new Integer(102179), true, false);
		contextMenus.Core.contextMenuSocialHistoryGrid.add(contextMenus.Core.contextMenuSocialHistoryGridAddItem);
		contextMenus.Core.contextMenuSocialHistoryGridEditItem = factory.createMenuItem(startControlID.intValue() + 13, "Edit", true, false, new Integer(102150), true, false);
		contextMenus.Core.contextMenuSocialHistoryGrid.add(contextMenus.Core.contextMenuSocialHistoryGridEditItem);
		contextMenus.Core.contextMenuSocialHistoryGridRemoveItem = factory.createMenuItem(startControlID.intValue() + 14, "Remove", true, false, new Integer(102148), true, false);
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1022), new Integer(anchoringHelper22.getX()), new Integer(anchoringHelper22.getY()), new Integer(anchoringHelper22.getWidth()), new Integer(anchoringHelper22.getHeight()), new Integer(startTabIndex.intValue() + 24), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "New", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1023), new Integer(anchoringHelper23.getX()), new Integer(anchoringHelper23.getY()), new Integer(anchoringHelper23.getWidth()), new Integer(anchoringHelper23.getHeight()), new Integer(startTabIndex.intValue() + 25), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Edit", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1025), new Integer(anchoringHelper25.getX()), new Integer(anchoringHelper25.getY()), new Integer(anchoringHelper25.getWidth()), new Integer(anchoringHelper25.getHeight()), new Integer(startTabIndex.intValue() + 28), ControlState.HIDDEN, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Cancel", Boolean.FALSE, null, Boolean.FALSE, Boolean.FALSE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1029), new Integer(anchoringHelper29.getX()), new Integer(anchoringHelper29.getY()), new Integer(anchoringHelper29.getWidth()), new Integer(anchoringHelper29.getHeight()), new Integer(startTabIndex.intValue() + 20), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT,Boolean.TRUE, new Integer(500), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
		...
		ComboBox m_cmbRecordingHCPTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1042), new Integer(anchoringHelper42.getX()), new Integer(anchoringHelper42.getY()), new Integer(anchoringHelper42.getWidth()), new Integer(anchoringHelper42.getHeight()), new Integer(startTabIndex.intValue() + 29), ControlState.DISABLED, ControlState.DISABLED,ims.framework.enumerations.ControlAnchoring.BOTTOMLEFTRIGHT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
		...
		grdSmokingDetails.addIntColumn("No./Day", 0, 0, 60, false, true, null, false, 0, true, 0);
		grdSmokingDetails.addIntColumn("No. of Yrs", 0, 0, 55, false, true, null, false, 0, true, 0);
		...
		super.addControl(factory.getControl(IntBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1046), new Integer(anchoringHelper46.getX()), new Integer(anchoringHelper46.getY()), new Integer(anchoringHelper46.getWidth()), new Integer(anchoringHelper46.getHeight()), new Integer(startTabIndex.intValue() + 19), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.TRUE, Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, new Integer(9)}));
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.SocialHistory.__internal_x_context__voSocialHistory_" + componentIdentifier, "BO-1003100026-ID", "ID_SocialHistory");
			fields[145] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.SocialHistory.__internal_x_context__voSocialHistory_" + componentIdentifier, "BO-1003100026-CARECONTEXT", "CareContext");
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.SocialHistory.__internal_x_context__voSocialHistory_" + componentIdentifier, "BO-1003100026-SMOKINGSTATUS", "SmokingStatus");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.SocialHistory.__internal_x_context__voSocialHistory_" + componentIdentifier, "BO-1003100026-ILLICITDRUGS", "IllicitDrugs");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.SocialHistory.__internal_x_context__voSocialHistory_" + componentIdentifier, "BO-1003100026-OCCUPATION", "Occupation");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.SocialHistory.__internal_x_context__voSocialHistory_" + componentIdentifier, "BO-1003100026-LIVESWITH", "LivesWith");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.SocialHistory.__internal_x_context__voSocialHistory_" + componentIdentifier, "BO-1003100026-FITTOCAREFORPATIENT", "FitToCareForPatient");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.SocialHistory.__internal_x_context__voSocialHistory_" + componentIdentifier, "BO-1003100026-FITTOTAKEHOME", "FitToTakeHome");
			fields[152] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.SocialHistory.__internal_x_context__voSocialHistory_" + componentIdentifier, "BO-1003100026-OCCUPATIONTEXT", "OccupationText");
			fields[153] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.SocialHistory.__internal_x_context__voSocialHistory_" + componentIdentifier, "BO-1003100026-SOCIALHISTORYNOTES", "SocialHistoryNotes");
			fields[154] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.SocialHistory.__internal_x_context__voSocialHistory_" + componentIdentifier, "BO-1003100026-MOBILITYINDEPENDENCE", "MobilityIndependence");
			fields[155] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.SocialHistory.__internal_x_context__voSocialHistory_" + componentIdentifier, "BO-1003100026-OCCUPATIONSTATUS", "OccupationStatus");
			fields[156] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.SocialHistory.__internal_x_context__voSocialHistory_" + componentIdentifier, "BO-1003100026-DIET", "Diet");
			fields[157] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.SocialHistory.__internal_x_context__contactVo_" + componentIdentifier, "BO-1004100003-ID", "ID_ClinicalContact");
			fields[158] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.SocialHistory.__internal_x_context__contactVo_" + componentIdentifier, "BO-1004100003-SPECIALTY", "Specialty");
			fields[159] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.SocialHistory.__internal_x_context__contactVo_" + componentIdentifier, "BO-1004100003-SEENBY", "SeenBy");
			fields[160] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.SocialHistory.__internal_x_context__contactVo_" + componentIdentifier, "BO-1004100003-CONTACTTYPE", "ContactType");
			fields[161] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.SocialHistory.__internal_x_context__contactVo_" + componentIdentifier, "BO-1004100003-STARTDATETIME", "StartDateTime");
			fields[162] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.SocialHistory.__internal_x_context__contactVo_" + componentIdentifier, "BO-1004100003-ENDDATETIME", "EndDateTime");
			fields[163] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.SocialHistory.__internal_x_context__contactVo_" + componentIdentifier, "BO-1004100003-CARECONTEXT", "CareContext");
			fields[164] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.SocialHistory.__internal_x_context__contactVo_" + componentIdentifier, "BO-1004100003-ISCLINICALNOTECREATED", "IsClinicalNoteCreated");
			fields[165] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.SocialHistory.__internal_x_context__currentSocialHistory_" + componentIdentifier, "BO-1003100026-ID", "ID_SocialHistory");
			fields[166] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.SocialHistory.__internal_x_context__currentSocialHistory_" + componentIdentifier, "BO-1003100026-CARECONTEXT", "CareContext");
			fields[167] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.SocialHistory.__internal_x_context__currentSocialHistory_" + componentIdentifier, "BO-1003100026-SMOKINGSTATUS", "SmokingStatus");
			fields[168] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.SocialHistory.__internal_x_context__currentSocialHistory_" + componentIdentifier, "BO-1003100026-ILLICITDRUGS", "IllicitDrugs");
			fields[169] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.SocialHistory.__internal_x_context__currentSocialHistory_" + componentIdentifier, "BO-1003100026-OCCUPATION", "Occupation");
			fields[170] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.SocialHistory.__internal_x_context__currentSocialHistory_" + componentIdentifier, "BO-1003100026-LIVESWITH", "LivesWith");
			fields[171] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.SocialHistory.__internal_x_context__currentSocialHistory_" + componentIdentifier, "BO-1003100026-FITTOCAREFORPATIENT", "FitToCareForPatient");
			fields[172] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.SocialHistory.__internal_x_context__currentSocialHistory_" + componentIdentifier, "BO-1003100026-FITTOTAKEHOME", "FitToTakeHome");
			fields[173] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.SocialHistory.__internal_x_context__currentSocialHistory_" + componentIdentifier, "BO-1003100026-OCCUPATIONTEXT", "OccupationText");
			fields[174] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.SocialHistory.__internal_x_context__currentSocialHistory_" + componentIdentifier, "BO-1003100026-SOCIALHISTORYNOTES", "SocialHistoryNotes");
			fields[175] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.SocialHistory.__internal_x_context__currentSocialHistory_" + componentIdentifier, "BO-1003100026-MOBILITYINDEPENDENCE", "MobilityIndependence");
			fields[176] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.SocialHistory.__internal_x_context__currentSocialHistory_" + componentIdentifier, "BO-1003100026-OCCUPATIONSTATUS", "OccupationStatus");
			fields[177] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.SocialHistory.__internal_x_context__currentSocialHistory_" + componentIdentifier, "BO-1003100026-DIET", "Diet");
			return fields;
		}
