...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "FilmTrackingNewMediaDialog";
	}
	public int getWidth()
	{
		return 392;
	...
	{
		return new String[] { "_cv_Core.FilmPacket" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Core.FilmTrackingNewMediaDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
