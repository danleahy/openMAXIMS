...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "CaseNoteOpenRequestForPatient";
	}
	public int getWidth()
	{
		return 616;
	...
	{
		return new String[] { "_cv_Core.SelectedPatientCaseNoteRequestToPull" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Core.CaseNoteOpenRequestForPatient.__internal_x_context__" + String.valueOf(getFormId());
	}
	public ims.framework.FormInfo[] getComponentsFormInfo()
	{
		ims.framework.FormInfo[] componentsInfo = new ims.framework.FormInfo[1];
		componentsInfo[0] = new ims.core.forms.casenoteopentrequestsgridcc.FormInfo(102462);
