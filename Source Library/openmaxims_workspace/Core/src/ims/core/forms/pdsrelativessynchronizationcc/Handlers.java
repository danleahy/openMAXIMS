...
{
	abstract protected void onGrdSyncGridButtonClicked(int column, GenForm.grdSyncRow row) throws ims.framework.exceptions.PresentationLogicException;
	...
	public final void setContext(ims.framework.UIComponentEngine engine, GenForm form)
	{
		...
		this.form.grdSync().setGridButtonClickedEvent(new GridButtonClicked()
		{
			...
			{
				onGrdSyncGridButtonClicked(column, new GenForm.grdSyncRow(row));
			}
		});
	}
