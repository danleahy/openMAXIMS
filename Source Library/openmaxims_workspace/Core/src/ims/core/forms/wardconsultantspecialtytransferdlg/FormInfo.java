...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "WardConsultantSpecialtyTransferDlg";
	}
	public int getWidth()
	{
		return 480;
	...
	{
		return new String[] { "_cv_Core.WardConsultantSpecialtyTransferVo" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Core.WardConsultantSpecialtyTransferDlg.__internal_x_context__" + String.valueOf(getFormId());
	}
