...
import ims.core.forms.supportnetworkprofessionalservices.GenForm.lyrProServicesLayer.tabProfessionalContainer.grpProfFilterEnumeration;
import ims.core.forms.supportnetworkprofessionalservices.GenForm.lyrProServicesLayer.tabServicesContainer.grpServiceFilterEnumeration;
...
import ims.core.vo.SupportNetworkSearchCriteriaVo;
...
public class Logic extends BaseLogic
{
	...
	protected void onFormOpen() throws ims.framework.exceptions.FormOpenException
	{
		...
		//WDEV-19389 
		if (!(form.getGlobalContext().Core.getPatientShortIsNotNull() && form.getGlobalContext().Core.getSupportNetworkProfSearchCriteriaIsNotNull() && form.getGlobalContext().Core.getPatientShort().equals(form.getGlobalContext().Core.getSupportNetworkProfSearchCriteria().getPatient())))
		{
			form.getGlobalContext().Core.setSupportNetworkProfSearchCriteria(null);
			form.getGlobalContext().Core.setSupportNetworkServSearchCriteria(null);
		}
		
		if(form.getGlobalContext().Core.getSupportNetworkProfSearchCriteriaIsNotNull())
		{
			setProfSearchCriteria(form.getGlobalContext().Core.getSupportNetworkProfSearchCriteria());
		}
	...
	private SupportNetworkSearchCriteriaVo getProfSearchCriteria()
	{
		SupportNetworkSearchCriteriaVo searchCriteria = new SupportNetworkSearchCriteriaVo();
		
		searchCriteria.setViewType(geProfViewType());
	...
	private void setProfSearchCriteria(SupportNetworkSearchCriteriaVo supportNetworkSearchCriteriaVo)
	{
		setProfViewType(supportNetworkSearchCriteriaVo.getViewType());		
	}

	private void setProfViewType(Integer searchType)
	{
		if (searchType == null)
			return;
		...
		{
		case LIST_ALL:
			form.lyrProServices().tabProfessional().grpProfFilter().setValue(grpProfFilterEnumeration.rdoAllProf);
			break;
		case LIST_ACTIVE:
			form.lyrProServices().tabProfessional().grpProfFilter().setValue(grpProfFilterEnumeration.rdoActiveProf);
			break;
		}				
	}

	private Integer geProfViewType()
	{
		grpProfFilterEnumeration searchType = form.lyrProServices().tabProfessional().grpProfFilter().getValue();
		if (grpProfFilterEnumeration.rdoAllProf.equals(searchType))
		{
			return LIST_ALL;
		}
		if (grpProfFilterEnumeration.rdoActiveProf.equals(searchType))
		{
			return LIST_ACTIVE;
		}
	...
	private SupportNetworkSearchCriteriaVo getServSearchCriteria()
	{
		SupportNetworkSearchCriteriaVo searchCriteria = new SupportNetworkSearchCriteriaVo();
		
		searchCriteria.setViewType(getServViewType());
		searchCriteria.setPatient(form.getGlobalContext().Core.getPatientShort());
	...
	private void setServSearchCriteria(SupportNetworkSearchCriteriaVo supportNetworkSearchCriteriaVo)
	{
		setServViewType(supportNetworkSearchCriteriaVo.getViewType());		
	}

	private void setServViewType(Integer searchType)
	{
		if (searchType == null)
			return;
		...
		{
		case LIST_ALL:
			form.lyrProServices().tabServices().grpServiceFilter().setValue(grpServiceFilterEnumeration.rdoAllServices);
			break;
		case LIST_ACTIVE:
			form.lyrProServices().tabServices().grpServiceFilter().setValue(grpServiceFilterEnumeration.rdoActiveServices);
			break;
		}				
	}

	private Integer getServViewType()
	{
		grpServiceFilterEnumeration searchType = form.lyrProServices().tabServices().grpServiceFilter().getValue();
		if (grpServiceFilterEnumeration.rdoAllServices.equals(searchType))
		{
			return LIST_ALL;
		}
		if (grpServiceFilterEnumeration.rdoActiveServices.equals(searchType))
		{
			return LIST_ACTIVE;
		}
...
//		form.lyrProServices().tabServices().grpServiceFilter().setValue(GenForm.lyrProServicesLayer.tabServicesContainer.grpServiceFilterEnumeration.rdoActiveServices);
	...
	protected void onRadioButtongrpProfFilterValueChanged() throws PresentationLogicException
	{
		...
		form.btnUpdate().setEnabled(false);
		listSupportNetworkProfessional(false);
		form.getGlobalContext().Core.setSupportNetworkProfSearchCriteria(getProfSearchCriteria());//WDEV-19389 
	}
	...
	protected void onRadioButtongrpServiceFilterValueChanged() throws PresentationLogicException
	{
		...
		form.btnUpdate().setEnabled(false);
		listSupportNetworkServices(false);
		form.getGlobalContext().Core.setSupportNetworkServSearchCriteria(getServSearchCriteria());//WDEV-19389 
	}
	...
	protected void onlyrProServicesTabChanged(LayerBridge tab)
	{
		...
		{
			if(form.getGlobalContext().Core.getSupportNetworkProfSearchCriteriaIsNotNull()) //WDEV-19389
			{
				setProfSearchCriteria(form.getGlobalContext().Core.getSupportNetworkProfSearchCriteria());
			}
			form.getLocalContext().setisTabProfessional(Boolean.TRUE);
		...
		{
			if(form.getGlobalContext().Core.getSupportNetworkServSearchCriteriaIsNotNull()) //WDEV-19389
			{
				setServSearchCriteria(form.getGlobalContext().Core.getSupportNetworkServSearchCriteria());
			}
