...
public class GenForm extends FormBridge
{
	...
	public static class ctnContainer extends ContainerBridge
	{
		...
		protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
		{
			...
			// TextBox Controls
			RuntimeAnchoring anchoringHelper10 = new RuntimeAnchoring(designSize, runtimeSize, 541, 90, 236, 62, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT);
			...
			// Date Time Controls
			RuntimeAnchoring anchoringHelper11 = new RuntimeAnchoring(designSize, runtimeSize, 541, 184, 236, 20, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT);
			...
			RuntimeAnchoring anchoringHelper12 = new RuntimeAnchoring(designSize, runtimeSize, 541, 16, 236, 20, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT);
			...
			RuntimeAnchoring anchoringHelper14 = new RuntimeAnchoring(designSize, runtimeSize, 625, 40, 152, 21, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT);
			...
			RuntimeAnchoring anchoringHelper16 = new RuntimeAnchoring(designSize, runtimeSize, 541, 160, 236, 21, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT);
			...
			RuntimeAnchoring anchoringHelper17 = new RuntimeAnchoring(designSize, runtimeSize, 541, 64, 236, 21, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT);
			...
			// IntBox Controls
			RuntimeAnchoring anchoringHelper19 = new RuntimeAnchoring(designSize, runtimeSize, 541, 40, 71, 21, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT);
			super.addControl(factory.getControl(IntBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1019), new Integer(anchoringHelper19.getX()), new Integer(anchoringHelper19.getY()), new Integer(anchoringHelper19.getWidth()), new Integer(anchoringHelper19.getHeight()), new Integer(startTabIndex.intValue() + 8), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT,Boolean.TRUE, Boolean.FALSE, Boolean.FALSE, null, null, Boolean.TRUE, new Integer(9)}));
		}
	...
	private void validateContext(ims.framework.Context context)
	{
		...
		if(!context.isValidContextType(ims.core.vo.VitalSignsMonitoringSearchCriteriaVo.class))
			throw new ims.framework.exceptions.CodingRuntimeException("The type 'ims.core.vo.VitalSignsMonitoringSearchCriteriaVo' of the global context variable 'Core.VitalSignsMonitoringSearchCriteria' is not supported.");
	}
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1021), new Integer(anchoringHelper23.getX()), new Integer(anchoringHelper23.getY()), new Integer(anchoringHelper23.getWidth()), new Integer(anchoringHelper23.getHeight()), new Integer(startTabIndex.intValue() + 17), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "New", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1022), new Integer(anchoringHelper24.getX()), new Integer(anchoringHelper24.getY()), new Integer(anchoringHelper24.getWidth()), new Integer(anchoringHelper24.getHeight()), new Integer(startTabIndex.intValue() + 18), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Edit", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1023), new Integer(anchoringHelper25.getX()), new Integer(anchoringHelper25.getY()), new Integer(anchoringHelper25.getWidth()), new Integer(anchoringHelper25.getHeight()), new Integer(startTabIndex.intValue() + 19), ControlState.HIDDEN, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Save", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalContact", "BO-1004100003-ID", "ID_ClinicalContact");
			fields[145] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalContact", "BO-1004100003-SPECIALTY", "Specialty");
			fields[146] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalContact", "BO-1004100003-SEENBY", "SeenBy");
			fields[147] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalContact", "BO-1004100003-CONTACTTYPE", "ContactType");
			fields[148] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalContact", "BO-1004100003-STARTDATETIME", "StartDateTime");
			fields[149] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalContact", "BO-1004100003-ENDDATETIME", "EndDateTime");
			fields[150] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalContact", "BO-1004100003-CARECONTEXT", "CareContext");
			fields[151] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalContact", "BO-1004100003-ISCLINICALNOTECREATED", "IsClinicalNoteCreated");
			fields[152] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.VitalSignsMonitoring.__internal_x_context__VitalSignMonitoringGroup_" + componentIdentifier, "BO-1028100022-ID", "ID_VitalSignMonitoringGroup");
			fields[153] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.VitalSignsMonitoring.__internal_x_context__VitalSignMonitoringGroup_" + componentIdentifier, "BO-1028100022-GROUPNAME", "GroupName");
			fields[154] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.VitalSignsMonitoring.__internal_x_context__VitalSignMonitoringGroup_" + componentIdentifier, "BO-1028100022-ISACTIVE", "IsActive");
			fields[155] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.VitalSignsMonitoring.__internal_x_context__VitalSignsMonitoring_" + componentIdentifier, "BO-1003100073-ID", "ID_VitalSignsMonitoring");
			fields[156] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.VitalSignsMonitoring.__internal_x_context__VitalSignsMonitoring_" + componentIdentifier, "BO-1003100073-CLINICALCONTACT", "ClinicalContact");
			fields[157] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.VitalSignsMonitoring.__internal_x_context__VitalSignsMonitoring_" + componentIdentifier, "BO-1003100073-CARECONTEXT", "CareContext");
			fields[158] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.VitalSignsMonitoring.__internal_x_context__VitalSignsMonitoring_" + componentIdentifier, "BO-1003100073-GROUPFREQUENCY", "GroupFrequency");
			fields[159] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.VitalSignsMonitoring.__internal_x_context__VitalSignsMonitoring_" + componentIdentifier, "BO-1003100073-STARTDATETIME", "StartDateTime");
			fields[160] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.VitalSignsMonitoring.__internal_x_context__VitalSignsMonitoring_" + componentIdentifier, "BO-1003100073-DURATIONVALUE", "DurationValue");
			fields[161] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.VitalSignsMonitoring.__internal_x_context__VitalSignsMonitoring_" + componentIdentifier, "BO-1003100073-DURATIONUNIT", "DurationUnit");
			fields[162] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.VitalSignsMonitoring.__internal_x_context__VitalSignsMonitoring_" + componentIdentifier, "BO-1003100073-REQUESTDETAILS", "RequestDetails");
			fields[163] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.VitalSignsMonitoring.__internal_x_context__VitalSignsMonitoring_" + componentIdentifier, "BO-1003100073-STOPPEDDATETIME", "StoppedDateTime");
			fields[164] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.VitalSignsMonitoring.__internal_x_context__LastRecord_" + componentIdentifier, "BO-1003100073-ID", "ID_VitalSignsMonitoring");
			fields[165] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.VitalSignsMonitoring.__internal_x_context__LastRecord_" + componentIdentifier, "BO-1003100073-CLINICALCONTACT", "ClinicalContact");
			fields[166] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.VitalSignsMonitoring.__internal_x_context__LastRecord_" + componentIdentifier, "BO-1003100073-CARECONTEXT", "CareContext");
			fields[167] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.VitalSignsMonitoring.__internal_x_context__LastRecord_" + componentIdentifier, "BO-1003100073-GROUPFREQUENCY", "GroupFrequency");
			fields[168] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.VitalSignsMonitoring.__internal_x_context__LastRecord_" + componentIdentifier, "BO-1003100073-STARTDATETIME", "StartDateTime");
			fields[169] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.VitalSignsMonitoring.__internal_x_context__LastRecord_" + componentIdentifier, "BO-1003100073-DURATIONVALUE", "DurationValue");
			fields[170] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.VitalSignsMonitoring.__internal_x_context__LastRecord_" + componentIdentifier, "BO-1003100073-DURATIONUNIT", "DurationUnit");
			fields[171] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.VitalSignsMonitoring.__internal_x_context__LastRecord_" + componentIdentifier, "BO-1003100073-REQUESTDETAILS", "RequestDetails");
			fields[172] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.VitalSignsMonitoring.__internal_x_context__LastRecord_" + componentIdentifier, "BO-1003100073-STOPPEDDATETIME", "StoppedDateTime");
			return fields;
		}
