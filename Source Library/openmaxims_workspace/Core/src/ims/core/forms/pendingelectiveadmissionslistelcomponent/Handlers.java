...
{
	abstract protected void bindcmbElectiveAdmTypeLookup();
	abstract protected void defaultcmbElectiveAdmTypeLookupValue();
	...
	abstract protected void oncmbElectiveAdmTypeValueSet(Object value);
	abstract protected void onBtnViewEleClick() throws ims.framework.exceptions.PresentationLogicException;
	...
	public final void setContext(ims.framework.UIComponentEngine engine, GenForm form)
	{
		...
		this.form.cmbElectiveAdmType().setValueSetEvent(new ComboBoxValueSet()
		{
			private static final long serialVersionUID = 1L;
			public void handle(Object value)
			{
				oncmbElectiveAdmTypeValueSet(value);
			}
		});
		this.form.btnViewEle().setClickEvent(new Click()
		{
			private static final long serialVersionUID = 1L;
		...
		this.form.getContextMenus().Core.getAddEditCommentForPendingElectiveListVIEWItem().setClickEvent(new ims.framework.delegates.MenuItemClick()
		{
			private static final long serialVersionUID = 1L;
			public void handle(ims.framework.Control sender) throws ims.framework.exceptions.PresentationLogicException
			{
				onContextMenuItemClick(GenForm.ContextMenus.CoreNamespace.AddEditCommentForPendingElectiveList.VIEW, sender);
			}
		});
		this.form.getContextMenus().Core.getAddEditCommentForPendingElectiveListREASSIGN_WARDItem().setClickEvent(new ims.framework.delegates.MenuItemClick()
		{
			private static final long serialVersionUID = 1L;
			public void handle(ims.framework.Control sender) throws ims.framework.exceptions.PresentationLogicException
			{
				onContextMenuItemClick(GenForm.ContextMenus.CoreNamespace.AddEditCommentForPendingElectiveList.REASSIGN_WARD, sender);
			}
		});
	}
	...
	{
		defaultcmbElectiveAdmTypeLookupValue();
