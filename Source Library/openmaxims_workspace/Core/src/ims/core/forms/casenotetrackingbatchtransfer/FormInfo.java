...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "CaseNoteTrackingBatchTransfer";
	}
	public int getWidth()
	{
		return 840;
	...
	{
		return new String[] { "_cv_Core.PatientCaseNotesForBatchTransfer" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Core.CaseNoteTrackingBatchTransfer.__internal_x_context__" + String.valueOf(getFormId());
	}
