...
public class GenForm extends FormBridge
{
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, "_cv_Core.CareContextSelectDialog.ChosenCareContext", "BO-1004100019-ID", "ID_CareContext");
			fields[145] = new ims.framework.ReportField(this.context, "_cv_Core.CareContextSelectDialog.ChosenCareContext", "BO-1004100019-CONTEXT", "Context");
			fields[146] = new ims.framework.ReportField(this.context, "_cv_Core.CareContextSelectDialog.ChosenCareContext", "BO-1004100019-ORDERINGHOSPITAL", "OrderingHospital");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.CareContextSelectDialog.__internal_x_context__PreviousDiagnosisEpisodeOfCare_" + componentIdentifier, "BO-1004100018-ID", "ID_EpisodeOfCare");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_Core.CareContextSelectDialog.__internal_x_context__PreviousProcedureEpisodeOfCare_" + componentIdentifier, "BO-1004100018-ID", "ID_EpisodeOfCare");
			return fields;
		}
