...
import ims.core.domain.CurrentInpatientListComponent;
...
public class RecentDischargesImpl extends BaseRecentDischargesImpl
{
	...
	public PatientShort getPatient(PatientRefVo voPat)
	{
		CurrentInpatientListComponent impl = (CurrentInpatientListComponent) getDomainImpl(STHKCurrentInpatientListComponentImpl.class);
		return impl.getPatientShort(voPat);
	}
