...
public class DemographicsComponentImpl extends DTODomainImplementation implements DemographicsComponent,ims.domain.impl.Transactional
{
	...
	*/
	...
	//WDEV-18644
	public LocSiteVo getLocationSite(LocationRefVo gpSurgeryRef)
	{
		Demographics impl = (Demographics) getDomainImpl(DemographicsImpl.class);
		
		return impl.getLocationSite(gpSurgeryRef);
	}

	public OrganisationWithSitesVo getGPPractice(OrganisationRefVo orgRef)
	{
		Demographics impl = (Demographics) getDomainImpl(DemographicsImpl.class);
		
		return impl.getGPPractice(orgRef);
	}
