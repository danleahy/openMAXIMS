...
public class ReportViewerImpl extends BaseReportViewerImpl
{
	...
	*/
	...
	public ArrayList<Object[]> listCustomSearchSeed(String name, String seedField, String[] displayFields, String[] searchFields, String searchText) throws DomainInterfaceException
	{
		ReportRunnerDialog reportRunnerImpl = (ReportRunnerDialog)getDomainImpl(ReportRunnerDialogImpl.class);
		return reportRunnerImpl.listCustomSearchSeed(name, seedField, displayFields, searchFields, searchText);
	}
}
