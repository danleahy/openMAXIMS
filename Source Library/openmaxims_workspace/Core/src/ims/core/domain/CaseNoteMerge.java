...
public interface CaseNoteMerge extends ims.domain.DomainInterface
{
	// Generated from form domain interface definition
	public ims.core.vo.PatientCaseNoteVo getPatientCaseNoteFolder(ims.core.clinical.vo.PatientCaseNoteRefVo caseNoteRef);
