...
public interface WardDataView extends ims.domain.DomainInterface
{
	...
	* getWardBayConfig
	*/
	public ims.core.vo.WardBayConfigForWardViewVo getWardBayConfigByWard(ims.core.resource.place.vo.LocationRefVo ward);
	...
	*/
	...
	// Generated from form domain interface definition
	public ims.vo.interfaces.IVTERiskAssessment getInpatientEpisodeForVTE(ims.core.admin.pas.vo.InpatientEpisodeRefVo inpatientEpisodeRef);

	// Generated from form domain interface definition
	/**
	* List all beds from Ward, regardless if the bed is occupied or not.
	*/
	public ims.core.vo.WardDataViewVoCollection listAllBedsForWard(ims.core.resource.place.vo.LocationRefVo ward) throws ims.domain.exceptions.DomainInterfaceException;

	// Generated from form domain interface definition
	public ims.core.vo.BedSpaceStateLiteVo getBedSpaceState(ims.core.admin.pas.vo.BedSpaceStateRefVo bedSpaceState);

	// Generated from form domain interface definition
	public Integer countFemalePatientsOnTheBayForSelectedBedSpace(ims.core.resource.place.vo.LocationRefVo wardRef, ims.core.resource.place.vo.LocationRefVo bayRef);

	// Generated from form domain interface definition
	public Integer countMalePatientsOnTheBayForSelectedBedSpace(ims.core.resource.place.vo.LocationRefVo wardRef, ims.core.resource.place.vo.LocationRefVo bayRef);

	// Generated from form domain interface definition
	public ims.core.vo.PatientShort getPatientShort(ims.core.patient.vo.PatientRefVo patRef);

	// Generated from form domain interface definition
	public ims.core.vo.PendingTransfersLiteVo getPendingTransfer(ims.core.admin.pas.vo.PendingTransfersRefVo pendingTransferRef);
}
