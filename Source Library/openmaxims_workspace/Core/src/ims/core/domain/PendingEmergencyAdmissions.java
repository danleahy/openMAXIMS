...
public interface PendingEmergencyAdmissions extends ims.domain.DomainInterface
{
	...
	*/
	...
	// Generated from form domain interface definition
	public ims.emergency.vo.TrackingForClinicianWorklistAndTriageVo getTrackingByPendingEmergencyAdmission(ims.core.admin.pas.vo.PendingEmergencyAdmissionRefVo pendingEmergencyAdmissionRef);

	// Generated from form domain interface definition
	public ims.core.vo.LocationLiteVo getCurrentHospital( ims.framework.interfaces.ILocation location);

	// Generated from form domain interface definition
	public ims.core.vo.CareContextShortVo getCurrentCareContext(ims.core.vo.PendingEmergencyAdmissionLiteVo pendingEmergencyAdmission);
}
