...
public class CcoContextEvalProvider extends CcoBaseContextEvalProvider implements IContextEvalProvider
{
	...
	public void setPatientInfoAndIcons(ValueObjectRef refVo)
	{
		...
		sessData.clearAlertsByType(ims.alerts.PatientAlertCCO.class);
	...
	public ValueObjectRef getCatsReferralForCareContext(ValueObjectRef refVo) {
		return null;
	}			
}
