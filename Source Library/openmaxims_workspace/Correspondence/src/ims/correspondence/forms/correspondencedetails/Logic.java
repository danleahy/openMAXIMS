...
public class Logic extends BaseLogic
{
	...
	private void populatePatientDetails(Patient voPatient)
	{
		...
		// Medical Record Number
		if (voPatient.getNationalHealthCoverIsNotNull())
		{
			// Medical Card Number
			if (voPatient.getNationalHealthCover().getMedicalCardNoIsNotNull())
				form.ctnPatientDetails().txtMedicalCardNo().setValue(voPatient.getNationalHealthCover().getMedicalCardNo());
		}
