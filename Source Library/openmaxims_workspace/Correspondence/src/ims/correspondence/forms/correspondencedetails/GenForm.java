...
public class GenForm extends FormBridge
{
	...
	public static class ctnHeaderContainer extends ContainerBridge
	{
		...
		protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
		{
			...
			grdCategories.addIntColumn("TemplateCategoryId", 0, 0, 0, true, true, null, false, 0, true, 0);
	...
	public static class ctnPatientDetailsContainer extends ContainerBridge
	{
		...
		protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
		{
			...
			super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1024), new Integer(anchoringHelper25.getX()), new Integer(anchoringHelper25.getY()), new Integer(anchoringHelper25.getWidth()), new Integer(anchoringHelper25.getHeight()), new Integer(startTabIndex.intValue() + 13), ControlState.DISABLED, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.FALSE, new Integer(0), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
			...
			super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1027), new Integer(anchoringHelper28.getX()), new Integer(anchoringHelper28.getY()), new Integer(anchoringHelper28.getWidth()), new Integer(anchoringHelper28.getHeight()), new Integer(startTabIndex.intValue() + 10), ControlState.DISABLED, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.FALSE, new Integer(0), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1047), new Integer(anchoringHelper48.getX()), new Integer(anchoringHelper48.getY()), new Integer(anchoringHelper48.getWidth()), new Integer(anchoringHelper48.getHeight()), new Integer(startTabIndex.intValue() + 5), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Letter Signed", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		ComboBox m_qmbSignedByTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1056), new Integer(anchoringHelper57.getX()), new Integer(anchoringHelper57.getY()), new Integer(anchoringHelper57.getWidth()), new Integer(anchoringHelper57.getHeight()), new Integer(startTabIndex.intValue() + 17), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.TRUE, new Integer(1), null, Boolean.FALSE, new Integer(-1), Boolean.FALSE});
		...
		super.addControl(factory.getControl(ImageButton.class, new Object[] { control, new Integer(startControlID.intValue() + 1058), new Integer(anchoringHelper59.getX()), new Integer(anchoringHelper59.getY()), new Integer(anchoringHelper59.getWidth()), new Integer(anchoringHelper59.getHeight()), new Integer(startTabIndex.intValue() + 18), ControlState.DISABLED, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, this.getImages().Core.ZoomInEnabled16, this.getImages().Core.ZoomInDisabled16, "View Correspondence Status History", Boolean.FALSE, Boolean.FALSE, Boolean.FALSE, Boolean.FALSE, null}));
		...
		super.addControl(factory.getControl(ImageButton.class, new Object[] { control, new Integer(startControlID.intValue() + 1059), new Integer(anchoringHelper60.getX()), new Integer(anchoringHelper60.getY()), new Integer(anchoringHelper60.getWidth()), new Integer(anchoringHelper60.getHeight()), new Integer(startTabIndex.intValue() + 16), ControlState.HIDDEN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, this.getImages().Core.Separator, this.getImages().Core.Separator, "Reset the template for this correspondence", Boolean.FALSE, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null}));
		...
		super.addControl(factory.getControl(ImageButton.class, new Object[] { control, new Integer(startControlID.intValue() + 1060), new Integer(anchoringHelper61.getX()), new Integer(anchoringHelper61.getY()), new Integer(anchoringHelper61.getWidth()), new Integer(anchoringHelper61.getHeight()), new Integer(startTabIndex.intValue() + 15), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, this.getImages().Core.ZoomInEnabled16, this.getImages().Core.ZoomInDisabled16, "View Correspondence Status History", Boolean.FALSE, Boolean.FALSE, Boolean.FALSE, Boolean.FALSE, null}));
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, "_cv_Correspondence.Mos", "BO-1006100006-ID", "ID_MemberOfStaff");
			fields[145] = new ims.framework.ReportField(this.context, "_cv_Correspondence.Mos", "BO-1006100006-INITIALS", "Initials");
			fields[146] = new ims.framework.ReportField(this.context, "_cv_Correspondence.Mos", "BO-1006100006-SIGNATUREBLOCK", "SignatureBlock");
			fields[147] = new ims.framework.ReportField(this.context, "_cv_Correspondence.Mos", "BO-1006100006-STAFFTYPE", "StaffType");
			fields[148] = new ims.framework.ReportField(this.context, "_cv_Correspondence.Mos", "BO-1006100006-ISACTIVE", "IsActive");
			fields[149] = new ims.framework.ReportField(this.context, "_cv_Correspondence.Mos", "BO-1006100006-SDSROLEID", "SdsRoleId");
			fields[150] = new ims.framework.ReportField(this.context, "_cv_Correspondence.Mos", "BO-1006100006-CANREFERPATIENT", "CanReferPatient");
			fields[151] = new ims.framework.ReportField(this.context, "_cv_Correspondence.ReportTemplate", "BO-1004100008-ID", "ID_TemplateBo");
			fields[152] = new ims.framework.ReportField(this.context, "_cv_Correspondence.ReportTemplate", "BO-1004100008-TEMPLATEXML", "TemplateXml");
			fields[153] = new ims.framework.ReportField(this.context, "_cv_Correspondence.ReportTemplate", "BO-1004100008-NAME", "Name");
			fields[154] = new ims.framework.ReportField(this.context, "_cv_Correspondence.ReportTemplate", "BO-1004100008-DESCRIPTION", "Description");
			fields[155] = new ims.framework.ReportField(this.context, "_cv_Correspondence.ReportTemplate", "BO-1004100008-ISACTIVE", "IsActive");
			fields[156] = new ims.framework.ReportField(this.context, "_cv_Core.GPDetails", "BO-1006100001-ID", "ID_Gp");
			fields[157] = new ims.framework.ReportField(this.context, "_cv_Core.GPDetails", "BO-1006100001-STATUS", "Status");
			fields[158] = new ims.framework.ReportField(this.context, "_cv_Correspondence.DocCategory", "BO-1052100002-ID", "ID_CategoryNotes");
			fields[159] = new ims.framework.ReportField(this.context, "_cv_Correspondence.DocCategory", "BO-1052100002-CATEGORY", "Category");
			fields[160] = new ims.framework.ReportField(this.context, "_cv_Correspondence.DocCategory", "BO-1052100002-CATEGORYTEXT", "CategoryText");
			fields[161] = new ims.framework.ReportField(this.context, "_cv_Correspondence.ExternalPerson", "BO-1002100006-ID", "ID_ExternalPerson");
			fields[162] = new ims.framework.ReportField(this.context, "_cv_Correspondence.ExternalPerson", "BO-1002100006-ISACTIVE", "IsActive");
			fields[163] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.CorrespondenceDetails.__internal_x_context__correspondenceDetails_" + componentIdentifier, "BO-1052100001-ID", "ID_CorrespondenceDetails");
			fields[164] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.CorrespondenceDetails.__internal_x_context__correspondenceDetails_" + componentIdentifier, "BO-1052100001-PASEVENT", "PasEvent");
			fields[165] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.CorrespondenceDetails.__internal_x_context__correspondenceDetails_" + componentIdentifier, "BO-1052100001-CURRENTSTATUS", "CurrentStatus");
			fields[166] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.CorrespondenceDetails.__internal_x_context__correspondenceDetails_" + componentIdentifier, "BO-1052100001-SPECIALINTEREST", "SpecialInterest");
			fields[167] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.CorrespondenceDetails.__internal_x_context__correspondenceDetails_" + componentIdentifier, "BO-1052100001-DATEOFCLINIC", "DateOfClinic");
			fields[168] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.CorrespondenceDetails.__internal_x_context__correspondenceDetails_" + componentIdentifier, "BO-1052100001-ADMISSIONDATE", "AdmissionDate");
			fields[169] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.CorrespondenceDetails.__internal_x_context__correspondenceDetails_" + componentIdentifier, "BO-1052100001-DISCHARGEDATE", "DischargeDate");
			fields[170] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.CorrespondenceDetails.__internal_x_context__correspondenceDetails_" + componentIdentifier, "BO-1052100001-DICTATEDBYINITIALS", "DictatedByInitials");
			fields[171] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.CorrespondenceDetails.__internal_x_context__correspondenceDetails_" + componentIdentifier, "BO-1052100001-TYPEDBYINITIALS", "TypedByInitials");
			fields[172] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.CorrespondenceDetails.__internal_x_context__correspondenceDetails_" + componentIdentifier, "BO-1052100001-WASTYPEDWITHOUTCASENOTES", "WasTypedWithoutCaseNotes");
			fields[173] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.CorrespondenceDetails.__internal_x_context__LastDocGenerated_" + componentIdentifier, "BO-1001100009-ID", "ID_Document");
			fields[174] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.CorrespondenceDetails.__internal_x_context__LastDocGenerated_" + componentIdentifier, "BO-1001100009-CONTENT", "Content");
			fields[175] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.CorrespondenceDetails.__internal_x_context__LastDocGenerated_" + componentIdentifier, "BO-1001100009-STATUS", "Status");
			fields[176] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.CorrespondenceDetails.__internal_x_context__loggedInMos_" + componentIdentifier, "BO-1006100006-ID", "ID_MemberOfStaff");
			fields[177] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.CorrespondenceDetails.__internal_x_context__loggedInMos_" + componentIdentifier, "BO-1006100006-INITIALS", "Initials");
			fields[178] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.CorrespondenceDetails.__internal_x_context__loggedInMos_" + componentIdentifier, "BO-1006100006-SIGNATUREBLOCK", "SignatureBlock");
			fields[179] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.CorrespondenceDetails.__internal_x_context__loggedInMos_" + componentIdentifier, "BO-1006100006-STAFFTYPE", "StaffType");
			fields[180] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.CorrespondenceDetails.__internal_x_context__loggedInMos_" + componentIdentifier, "BO-1006100006-ISACTIVE", "IsActive");
			fields[181] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.CorrespondenceDetails.__internal_x_context__loggedInMos_" + componentIdentifier, "BO-1006100006-SDSROLEID", "SdsRoleId");
			fields[182] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.CorrespondenceDetails.__internal_x_context__loggedInMos_" + componentIdentifier, "BO-1006100006-CANREFERPATIENT", "CanReferPatient");
			fields[183] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.CorrespondenceDetails.__internal_x_context__PatientGP_" + componentIdentifier, "BO-1006100001-ID", "ID_Gp");
			fields[184] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.CorrespondenceDetails.__internal_x_context__PatientGP_" + componentIdentifier, "BO-1006100001-STATUS", "Status");
			fields[185] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.CorrespondenceDetails.__internal_x_context__ReferrerGP_" + componentIdentifier, "BO-1006100001-ID", "ID_Gp");
			fields[186] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.CorrespondenceDetails.__internal_x_context__ReferrerPractice_" + componentIdentifier, "BO-1007100007-ID", "ID_Location");
			fields[187] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.CorrespondenceDetails.__internal_x_context__ReferrerPractice_" + componentIdentifier, "BO-1007100007-NAME", "Name");
			fields[188] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.CorrespondenceDetails.__internal_x_context__ReferrerPractice_" + componentIdentifier, "BO-1007100007-ISACTIVE", "IsActive");
			fields[189] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.CorrespondenceDetails.__internal_x_context__ReferrerPractice_" + componentIdentifier, "BO-1007100007-ISVIRTUAL", "IsVirtual");
			fields[190] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.CorrespondenceDetails.__internal_x_context__ReferrerPractice_" + componentIdentifier, "BO-1007100007-TYPE", "Type");
			fields[191] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.CorrespondenceDetails.__internal_x_context__ReferrerPractice_" + componentIdentifier, "BO-1007100007-DISPLAYINEDTRACKING", "DisplayInEDTracking");
			fields[192] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.CorrespondenceDetails.__internal_x_context__ReferrerPractice_" + componentIdentifier, "BO-1007100007-CASENOTEFOLDERLOCATION", "CaseNoteFolderLocation");
			fields[193] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.CorrespondenceDetails.__internal_x_context__ReferrerPractice_" + componentIdentifier, "BO-1007100007-SECUREACCOMMODATION", "SecureAccommodation");
			fields[194] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.CorrespondenceDetails.__internal_x_context__ReferrerPractice_" + componentIdentifier, "BO-1007100007-TREATINGHOSP", "TreatingHosp");
			fields[195] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.CorrespondenceDetails.__internal_x_context__ReferrerPractice_" + componentIdentifier, "BO-1007100007-REFERRINGHOSPITAL", "ReferringHospital");
			fields[196] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.CorrespondenceDetails.__internal_x_context__ReferrerPractice_" + componentIdentifier, "BO-1007100002-ALLSECUREACCOMMODATION", "AllSecureAccommodation");
			fields[197] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.CorrespondenceDetails.__internal_x_context__pasEventVo_" + componentIdentifier, "BO-1014100003-ID", "ID_PASEvent");
			fields[198] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.CorrespondenceDetails.__internal_x_context__pasEventVo_" + componentIdentifier, "BO-1014100003-PASEPISODEID", "PasEpisodeId");
			fields[199] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.CorrespondenceDetails.__internal_x_context__pasEventVo_" + componentIdentifier, "BO-1014100003-EVENTDATETIME", "EventDateTime");
			fields[200] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.CorrespondenceDetails.__internal_x_context__pasEventVo_" + componentIdentifier, "BO-1014100003-PASEVENTID", "PasEventId");
			fields[201] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.CorrespondenceDetails.__internal_x_context__pasEventVo_" + componentIdentifier, "BO-1014100003-EVENTTYPE", "EventType");
			fields[202] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.CorrespondenceDetails.__internal_x_context__pasEventVo_" + componentIdentifier, "BO-1014100003-SPECIALTY", "Specialty");
			fields[203] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.CorrespondenceDetails.__internal_x_context__pasEventVo_" + componentIdentifier, "BO-1014100003-EPISODEFINANCIALCLASS", "EpisodeFinancialClass");
			fields[204] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.CorrespondenceDetails.__internal_x_context__pasEventVo_" + componentIdentifier, "BO-1014100003-SOURCEOFREFERRAL", "SourceOfReferral");
			fields[205] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.CorrespondenceDetails.__internal_x_context__pasEventVo_" + componentIdentifier, "BO-1014100003-ISVIP", "IsVip");
			fields[206] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.CorrespondenceDetails.__internal_x_context__pasEventVo_" + componentIdentifier, "BO-1014100003-CSPDOCUMENTSTATUS", "CspDocumentStatus");
			fields[207] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.CorrespondenceDetails.__internal_x_context__pasEventVo_" + componentIdentifier, "BO-1014100003-PASSPECIALTY", "PASSpecialty");
			return fields;
		}
