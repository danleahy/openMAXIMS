...
public class GenForm extends FormBridge
{
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.PatientDocuments.__internal_x_context__docVo_" + componentIdentifier, "BO-1001100009-ID", "ID_Document");
			fields[145] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.PatientDocuments.__internal_x_context__docVo_" + componentIdentifier, "BO-1001100009-CONTENT", "Content");
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.PatientDocuments.__internal_x_context__docVo_" + componentIdentifier, "BO-1001100009-STATUS", "Status");
			return fields;
		}
