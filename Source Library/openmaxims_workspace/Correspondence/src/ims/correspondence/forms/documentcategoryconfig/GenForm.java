...
public class GenForm extends FormBridge
{
	...
	public static class lyrMainLayer extends Layer
	{
		...
		public static class tabByCategoryContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1015), new Integer(anchoringHelper15.getX()), new Integer(anchoringHelper15.getY()), new Integer(anchoringHelper15.getWidth()), new Integer(anchoringHelper15.getHeight()), new Integer(startTabIndex.intValue() + 10), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Edit", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
				...
				super.addControl(factory.getControl(ImageButton.class, new Object[] { control, new Integer(startControlID.intValue() + 1020), new Integer(anchoringHelper20.getX()), new Integer(anchoringHelper20.getY()), new Integer(anchoringHelper20.getWidth()), new Integer(anchoringHelper20.getHeight()), new Integer(startTabIndex.intValue() + 14), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT, form_images_local.Correspondence.MoveAllUp24, form_images_local.Correspondence.MoveAllUpDisabled24, "Add all templates", Boolean.FALSE, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null}));
				...
				super.addControl(factory.getControl(ImageButton.class, new Object[] { control, new Integer(startControlID.intValue() + 1021), new Integer(anchoringHelper21.getX()), new Integer(anchoringHelper21.getY()), new Integer(anchoringHelper21.getWidth()), new Integer(anchoringHelper21.getHeight()), new Integer(startTabIndex.intValue() + 15), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT, form_images_local.Correspondence.MoveUp24, form_images_local.Correspondence.MoveUpDisabled24, "Add selected templates", Boolean.FALSE, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null}));
				...
				super.addControl(factory.getControl(ImageButton.class, new Object[] { control, new Integer(startControlID.intValue() + 1022), new Integer(anchoringHelper22.getX()), new Integer(anchoringHelper22.getY()), new Integer(anchoringHelper22.getWidth()), new Integer(anchoringHelper22.getHeight()), new Integer(startTabIndex.intValue() + 17), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT, form_images_local.Correspondence.MoveAllDown24, form_images_local.Correspondence.MoveAllDownDisabled24, "Remove all templates", Boolean.FALSE, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null}));
				...
				super.addControl(factory.getControl(ImageButton.class, new Object[] { control, new Integer(startControlID.intValue() + 1023), new Integer(anchoringHelper23.getX()), new Integer(anchoringHelper23.getY()), new Integer(anchoringHelper23.getWidth()), new Integer(anchoringHelper23.getHeight()), new Integer(startTabIndex.intValue() + 16), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT, form_images_local.Correspondence.MoveDown24, form_images_local.Correspondence.MoveDownDisabled24, "Remove selected templates", Boolean.FALSE, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null}));
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.DocumentCategoryConfig.__internal_x_context__CurrentRecord_" + componentIdentifier, "BO-1068100004-ID", "ID_DocumentCategoryConfig");
			fields[145] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.DocumentCategoryConfig.__internal_x_context__CurrentRecord_" + componentIdentifier, "BO-1068100004-CATEGORY", "Category");
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.DocumentCategoryConfig.__internal_x_context__CurrentRecordTem_" + componentIdentifier, "BO-1004100008-ID", "ID_TemplateBo");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.DocumentCategoryConfig.__internal_x_context__CurrentRecordTem_" + componentIdentifier, "BO-1004100008-NAME", "Name");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.DocumentCategoryConfig.__internal_x_context__CurrentRecordTem_" + componentIdentifier, "BO-1004100008-DESCRIPTION", "Description");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.DocumentCategoryConfig.__internal_x_context__CurrentRecordTem_" + componentIdentifier, "BO-1004100008-ISACTIVE", "IsActive");
			return fields;
		}
