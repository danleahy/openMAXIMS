...
public class GenForm extends FormBridge
{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		grdConsultant.addIntColumn("Column Header", 0, 0, 0, true, true, null, false, 0, true, 0);
		grdConsultant.addIntColumn("Column Header", 0, 0, 0, true, true, null, false, 0, true, 0);
		...
		grdClinic.addIntColumn("Column Header", 0, 0, 0, true, true, null, false, 0, true, 0);
		grdClinic.addIntColumn(" ", 0, 0, 0, true, true, null, false, 0, true, 0);
		...
		grdSpecialty.addIntColumn("Column Header", 0, 0, 0, true, true, null, false, 0, true, 0);
		grdSpecialty.addIntColumn(" ", 0, 0, 0, true, true, null, false, 0, true, 0);
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.NoLetterRequiredAdmin.__internal_x_context__NoLetterIsRequiredInstance_" + componentIdentifier, "BO-1053100007-ID", "ID_NoLetterIsRequired");
			fields[145] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.NoLetterRequiredAdmin.__internal_x_context__NoLetterIsRequiredInstance_" + componentIdentifier, "BO-1053100007-ISACTIVE", "IsActive");
			return fields;
		}
