...
public class GenForm extends FormBridge
{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1007), new Integer(anchoringHelper8.getX()), new Integer(anchoringHelper8.getY()), new Integer(anchoringHelper8.getWidth()), new Integer(anchoringHelper8.getHeight()), new Integer(startTabIndex.intValue() + 13), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Edit", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.UserProfile.__internal_x_context__SelectedUser_" + componentIdentifier, "BO-1021100004-ID", "ID_AppUser");
			fields[145] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.UserProfile.__internal_x_context__SelectedUser_" + componentIdentifier, "BO-1021100004-USERNAME", "Username");
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.UserProfile.__internal_x_context__SelectedUser_" + componentIdentifier, "BO-1021100004-PASSWORD", "Password");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.UserProfile.__internal_x_context__SelectedUser_" + componentIdentifier, "BO-1021100004-ENCODEDPASSWORD", "EncodedPassword");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.UserProfile.__internal_x_context__SelectedUser_" + componentIdentifier, "BO-1021100004-THEME", "Theme");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.UserProfile.__internal_x_context__SelectedUser_" + componentIdentifier, "BO-1021100004-PWDEXPDATE", "PwdExpDate");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.UserProfile.__internal_x_context__SelectedUser_" + componentIdentifier, "BO-1021100004-EFFECTIVEFROM", "EffectiveFrom");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.UserProfile.__internal_x_context__SelectedUser_" + componentIdentifier, "BO-1021100004-EFFECTIVETO", "EffectiveTo");
			fields[152] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.UserProfile.__internal_x_context__SelectedUser_" + componentIdentifier, "BO-1021100004-ISACTIVE", "IsActive");
			fields[153] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.UserProfile.__internal_x_context__SelectedUser_" + componentIdentifier, "BO-1021100004-DEBUGMODE", "DebugMode");
			fields[154] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.UserProfile.__internal_x_context__SelectedUser_" + componentIdentifier, "BO-1021100004-LDAPUSERNAME", "LDAPUsername");
			fields[155] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.UserProfile.__internal_x_context__SelectedUser_" + componentIdentifier, "BO-1021100004-LDAPPASSWORD", "LDAPPassword");
			fields[156] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.UserProfile.__internal_x_context__SelectedUser_" + componentIdentifier, "BO-1021100004-LOCKED", "Locked");
			fields[157] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.UserProfile.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1053100011-ID", "ID_UserAccess");
			fields[158] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.UserProfile.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1053100011-APPUSER", "AppUser");
			return fields;
		}
