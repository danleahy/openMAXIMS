...
public class GenForm extends FormBridge
{
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.CorrespondenceHeadersAdmin.__internal_x_context__SelTemplateCategoryVo_" + componentIdentifier, "BO-1053100002-ID", "ID_TemplateCategory");
			fields[145] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.CorrespondenceHeadersAdmin.__internal_x_context__SelTemplateCategoryVo_" + componentIdentifier, "BO-1053100002-TEMPLATE", "Template");
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.CorrespondenceHeadersAdmin.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1004100008-ID", "ID_TemplateBo");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.CorrespondenceHeadersAdmin.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1004100008-TEMPLATEXML", "TemplateXml");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.CorrespondenceHeadersAdmin.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1004100008-NAME", "Name");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.CorrespondenceHeadersAdmin.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1004100008-DESCRIPTION", "Description");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.CorrespondenceHeadersAdmin.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1004100008-ISACTIVE", "IsActive");
			return fields;
		}
