...
public class GenForm extends FormBridge
{
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.GlossaryAdmin.__internal_x_context__voGlossary_" + componentIdentifier, "BO-1053100003-ID", "ID_Glossary");
			fields[145] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.GlossaryAdmin.__internal_x_context__voGlossary_" + componentIdentifier, "BO-1053100003-GLOSSARY", "Glossary");
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.GlossaryAdmin.__internal_x_context__voGlossary_" + componentIdentifier, "BO-1053100003-GLOSSARYTEXT", "GlossaryText");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.GlossaryAdmin.__internal_x_context__GlossaryProfile_" + componentIdentifier, "BO-1053100001-ID", "ID_GlossaryProfile");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.GlossaryAdmin.__internal_x_context__GlossaryProfile_" + componentIdentifier, "BO-1053100001-SPECIFIERID", "SpecifierID");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.GlossaryAdmin.__internal_x_context__GlossaryProfile_" + componentIdentifier, "BO-1053100001-SPECIFIERTYPE", "SpecifierType");
			return fields;
		}
