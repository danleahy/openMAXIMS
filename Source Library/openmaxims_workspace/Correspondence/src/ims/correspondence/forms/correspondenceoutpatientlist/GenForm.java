...
public class GenForm extends FormBridge
{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		super.addControl(factory.getControl(DateControl.class, new Object[] { control, new Integer(startControlID.intValue() + 1010), new Integer(anchoringHelper11.getX()), new Integer(anchoringHelper11.getY()), new Integer(anchoringHelper11.getWidth()), new Integer(anchoringHelper11.getHeight()), new Integer(startTabIndex.intValue() + 10), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT,Boolean.TRUE, null, Boolean.FALSE, null, Boolean.TRUE, null}));
		...
		super.addControl(factory.getControl(DateControl.class, new Object[] { control, new Integer(startControlID.intValue() + 1011), new Integer(anchoringHelper12.getX()), new Integer(anchoringHelper12.getY()), new Integer(anchoringHelper12.getWidth()), new Integer(anchoringHelper12.getHeight()), new Integer(startTabIndex.intValue() + 9), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT,Boolean.TRUE, null, Boolean.FALSE, null, Boolean.FALSE, null}));
		...
		ComboBox m_cmbStatusOfLetterTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1012), new Integer(anchoringHelper13.getX()), new Integer(anchoringHelper13.getY()), new Integer(anchoringHelper13.getWidth()), new Integer(anchoringHelper13.getHeight()), new Integer(startTabIndex.intValue() + 8), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPRIGHT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
		...
		Grid m_grdOutPatientTemp = (Grid)factory.getControl(Grid.class, new Object[] { control, new Integer(startControlID.intValue() + 1020), new Integer(anchoringHelper21.getX()), new Integer(anchoringHelper21.getY()), new Integer(anchoringHelper21.getWidth()), new Integer(anchoringHelper21.getHeight()), new Integer(startTabIndex.intValue() + 13), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL,Boolean.TRUE, Boolean.FALSE, new Integer(24), Boolean.TRUE, contextMenus.contextMenuADTMenu, Boolean.FALSE, Boolean.FALSE, new Integer(0), null, Boolean.FALSE, Boolean.TRUE});
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[164] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.CorrespondenceOutpatientList.__internal_x_context__UserAccessVo_" + componentIdentifier, "BO-1053100011-ID", "ID_UserAccess");
			fields[165] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.CorrespondenceOutpatientList.__internal_x_context__UserAccessVo_" + componentIdentifier, "BO-1053100011-APPUSER", "AppUser");
			fields[166] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.CorrespondenceOutpatientList.__internal_x_context__SelectedCorrespondenceInstance_" + componentIdentifier, "BO-1052100001-ID", "ID_CorrespondenceDetails");
			fields[167] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.CorrespondenceOutpatientList.__internal_x_context__SelectedCorrespondenceInstance_" + componentIdentifier, "BO-1052100001-PASEVENT", "PasEvent");
			fields[168] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.CorrespondenceOutpatientList.__internal_x_context__SelectedCorrespondenceInstance_" + componentIdentifier, "BO-1052100001-CURRENTSTATUS", "CurrentStatus");
			fields[169] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.CorrespondenceOutpatientList.__internal_x_context__SelectedCorrespondenceInstance_" + componentIdentifier, "BO-1052100001-SPECIALINTEREST", "SpecialInterest");
			fields[170] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.CorrespondenceOutpatientList.__internal_x_context__SelectedCorrespondenceInstance_" + componentIdentifier, "BO-1052100001-DATEOFCLINIC", "DateOfClinic");
			fields[171] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.CorrespondenceOutpatientList.__internal_x_context__SelectedCorrespondenceInstance_" + componentIdentifier, "BO-1052100001-ADMISSIONDATE", "AdmissionDate");
			fields[172] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.CorrespondenceOutpatientList.__internal_x_context__SelectedCorrespondenceInstance_" + componentIdentifier, "BO-1052100001-DISCHARGEDATE", "DischargeDate");
			fields[173] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.CorrespondenceOutpatientList.__internal_x_context__SelectedCorrespondenceInstance_" + componentIdentifier, "BO-1052100001-DICTATEDBYINITIALS", "DictatedByInitials");
			fields[174] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.CorrespondenceOutpatientList.__internal_x_context__SelectedCorrespondenceInstance_" + componentIdentifier, "BO-1052100001-TYPEDBYINITIALS", "TypedByInitials");
			fields[175] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.CorrespondenceOutpatientList.__internal_x_context__SelectedCorrespondenceInstance_" + componentIdentifier, "BO-1052100001-WASTYPEDWITHOUTCASENOTES", "WasTypedWithoutCaseNotes");
			return fields;
		}
