...
public class GenForm extends FormBridge
{
	...
	public static class lyrPatientListsLayer extends Layer
	{
		...
		public static class tabInpatientListContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				ComboBox m_cmbWardTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1011), new Integer(anchoringHelper12.getX()), new Integer(anchoringHelper12.getY()), new Integer(anchoringHelper12.getWidth()), new Integer(anchoringHelper12.getHeight()), new Integer(startTabIndex.intValue() + 15), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.PatientLists.__internal_x_context__SelectedCorrespondenceInstance_" + componentIdentifier, "BO-1052100001-ID", "ID_CorrespondenceDetails");
			fields[145] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.PatientLists.__internal_x_context__SelectedCorrespondenceInstance_" + componentIdentifier, "BO-1052100001-PASEVENT", "PasEvent");
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.PatientLists.__internal_x_context__SelectedCorrespondenceInstance_" + componentIdentifier, "BO-1052100001-CURRENTSTATUS", "CurrentStatus");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.PatientLists.__internal_x_context__SelectedCorrespondenceInstance_" + componentIdentifier, "BO-1052100001-SPECIALINTEREST", "SpecialInterest");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.PatientLists.__internal_x_context__SelectedCorrespondenceInstance_" + componentIdentifier, "BO-1052100001-DATEOFCLINIC", "DateOfClinic");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.PatientLists.__internal_x_context__SelectedCorrespondenceInstance_" + componentIdentifier, "BO-1052100001-ADMISSIONDATE", "AdmissionDate");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.PatientLists.__internal_x_context__SelectedCorrespondenceInstance_" + componentIdentifier, "BO-1052100001-DISCHARGEDATE", "DischargeDate");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.PatientLists.__internal_x_context__SelectedCorrespondenceInstance_" + componentIdentifier, "BO-1052100001-DICTATEDBYINITIALS", "DictatedByInitials");
			fields[152] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.PatientLists.__internal_x_context__SelectedCorrespondenceInstance_" + componentIdentifier, "BO-1052100001-TYPEDBYINITIALS", "TypedByInitials");
			fields[153] = new ims.framework.ReportField(this.context, prefix + "_lv_Correspondence.PatientLists.__internal_x_context__SelectedCorrespondenceInstance_" + componentIdentifier, "BO-1052100001-WASTYPEDWITHOUTCASENOTES", "WasTypedWithoutCaseNotes");
			return fields;
		}
