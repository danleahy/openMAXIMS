...
public class GenForm extends FormBridge
{
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, prefix + "_lv_Rules.RulesPriorityEditor.__internal_x_context__SelectedRule_" + componentIdentifier, "BO-1004100040-ID", "ID_BusinessRule");
			fields[145] = new ims.framework.ReportField(this.context, prefix + "_lv_Rules.RulesPriorityEditor.__internal_x_context__SelectedRule_" + componentIdentifier, "BO-1004100040-NAME", "Name");
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_Rules.RulesPriorityEditor.__internal_x_context__SelectedRule_" + componentIdentifier, "BO-1004100040-DESCRIPTION", "Description");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_Rules.RulesPriorityEditor.__internal_x_context__SelectedRule_" + componentIdentifier, "BO-1004100040-CATEGORY", "Category");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_Rules.RulesPriorityEditor.__internal_x_context__SelectedRule_" + componentIdentifier, "BO-1004100040-VALIDFROM", "ValidFrom");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_Rules.RulesPriorityEditor.__internal_x_context__SelectedRule_" + componentIdentifier, "BO-1004100040-VALIDTO", "ValidTo");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_Rules.RulesPriorityEditor.__internal_x_context__SelectedRule_" + componentIdentifier, "BO-1004100040-PRIORITY", "Priority");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_Rules.RulesPriorityEditor.__internal_x_context__SelectedRule_" + componentIdentifier, "BO-1004100040-XMLCONTENT", "XmlContent");
			fields[152] = new ims.framework.ReportField(this.context, prefix + "_lv_Rules.RulesPriorityEditor.__internal_x_context__SelectedRule_" + componentIdentifier, "BO-1004100040-ACTIVE", "Active");
			fields[153] = new ims.framework.ReportField(this.context, prefix + "_lv_Rules.RulesPriorityEditor.__internal_x_context__SelectedRule_" + componentIdentifier, "BO-1004100040-ROOTENTITY", "RootEntity");
			return fields;
		}
