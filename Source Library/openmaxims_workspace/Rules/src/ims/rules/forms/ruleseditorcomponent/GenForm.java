...
public class GenForm extends FormBridge
{
	...
	public static class lyrRulesLayer extends Layer
	{
		...
		public static class tabGeneralContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				super.addControl(factory.getControl(DateControl.class, new Object[] { control, new Integer(startControlID.intValue() + 1009), new Integer(anchoringHelper9.getX()), new Integer(anchoringHelper9.getY()), new Integer(anchoringHelper9.getWidth()), new Integer(anchoringHelper9.getHeight()), new Integer(startTabIndex.intValue() + 6), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT,Boolean.TRUE, null, Boolean.FALSE, null, Boolean.FALSE, null}));
				...
				super.addControl(factory.getControl(DateControl.class, new Object[] { control, new Integer(startControlID.intValue() + 1010), new Integer(anchoringHelper10.getX()), new Integer(anchoringHelper10.getY()), new Integer(anchoringHelper10.getWidth()), new Integer(anchoringHelper10.getHeight()), new Integer(startTabIndex.intValue() + 5), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT,Boolean.TRUE, null, Boolean.FALSE, null, Boolean.FALSE, null}));
		...
		public static class tabActionsContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				super.addControl(factory.getControl(DynamicGrid.class, new Object[] { control, new Integer(startControlID.intValue() + 1016), new Integer(anchoringHelper16.getX()), new Integer(anchoringHelper16.getY()), new Integer(anchoringHelper16.getWidth()), new Integer(anchoringHelper16.getHeight()), new Integer(startTabIndex.intValue() + 10), ControlState.READONLY, ControlState.EDITABLE, ims.framework.enumerations.ControlAnchoring.ALL, contextMenus.Rules.contextMenuRulesEditorActions, Boolean.FALSE, Boolean.FALSE, Boolean.TRUE}));
			}
		...
		public static class tabOverviewContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				super.addControl(factory.getControl(HTMLViewer.class, new Object[] { control, new Integer(startControlID.intValue() + 1017), new Integer(anchoringHelper17.getX()), new Integer(anchoringHelper17.getY()), new Integer(anchoringHelper17.getWidth()), new Integer(anchoringHelper17.getHeight()), new Integer(startTabIndex.intValue() + 11), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE}));
			}
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		contextMenus.Rules.contextMenuRulesEditorActionsAddActionItem = factory.createMenuItem(startControlID.intValue() + 1, "Add Action", true, false, new Integer(102179), true, false);
		contextMenus.Rules.contextMenuRulesEditorActions.add(contextMenus.Rules.contextMenuRulesEditorActionsAddActionItem);
		contextMenus.Rules.contextMenuRulesEditorActionsRemoveActionItem = factory.createMenuItem(startControlID.intValue() + 2, "Remove Action", true, false, new Integer(102300), true, true);
		contextMenus.Rules.contextMenuRulesEditorActions.add(contextMenus.Rules.contextMenuRulesEditorActionsRemoveActionItem);
		contextMenus.Rules.contextMenuRulesEditorActionsRemoveAllItem = factory.createMenuItem(startControlID.intValue() + 3, "Remove All", true, false, new Integer(102300), true, true);
		...
		contextMenus.Admin.contextMenuRulesEditorAddLogicalConditionItem = factory.createMenuItem(startControlID.intValue() + 17, "Add Logical Condition", true, false, new Integer(102179), true, false);
		contextMenus.Admin.contextMenuRulesEditor.add(contextMenus.Admin.contextMenuRulesEditorAddLogicalConditionItem);
		contextMenus.Admin.contextMenuRulesEditorAddValueConditionItem = factory.createMenuItem(startControlID.intValue() + 18, "Add Value Condition", true, false, new Integer(102179), true, false);
		contextMenus.Admin.contextMenuRulesEditor.add(contextMenus.Admin.contextMenuRulesEditorAddValueConditionItem);
		contextMenus.Admin.contextMenuRulesEditorRemoveItem = factory.createMenuItem(startControlID.intValue() + 19, "Remove", true, false, new Integer(102300), true, true);
		contextMenus.Admin.contextMenuRulesEditor.add(contextMenus.Admin.contextMenuRulesEditorRemoveItem);
		contextMenus.Admin.contextMenuRulesEditorRemoveAllItem = factory.createMenuItem(startControlID.intValue() + 20, "Remove All", true, false, new Integer(102300), true, true);
		contextMenus.Admin.contextMenuRulesEditor.add(contextMenus.Admin.contextMenuRulesEditorRemoveAllItem);
		contextMenus.Admin.contextMenuRulesEditorRemoveLogicalConditionItem = factory.createMenuItem(startControlID.intValue() + 21, "Remove Logical Condition", true, false, new Integer(102300), true, false);
		contextMenus.Admin.contextMenuRulesEditor.add(contextMenus.Admin.contextMenuRulesEditorRemoveLogicalConditionItem);
		contextMenus.Admin.contextMenuRulesEditorRemoveValueConditionItem = factory.createMenuItem(startControlID.intValue() + 22, "Remove Value Condition", true, false, new Integer(102300), true, false);
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, "_cv_Rules.RuleToEdit", "BO-1004100040-ID", "ID_BusinessRule");
			fields[145] = new ims.framework.ReportField(this.context, "_cv_Rules.RuleToEdit", "BO-1004100040-NAME", "Name");
			fields[146] = new ims.framework.ReportField(this.context, "_cv_Rules.RuleToEdit", "BO-1004100040-DESCRIPTION", "Description");
			fields[147] = new ims.framework.ReportField(this.context, "_cv_Rules.RuleToEdit", "BO-1004100040-CATEGORY", "Category");
			fields[148] = new ims.framework.ReportField(this.context, "_cv_Rules.RuleToEdit", "BO-1004100040-VALIDFROM", "ValidFrom");
			fields[149] = new ims.framework.ReportField(this.context, "_cv_Rules.RuleToEdit", "BO-1004100040-VALIDTO", "ValidTo");
			fields[150] = new ims.framework.ReportField(this.context, "_cv_Rules.RuleToEdit", "BO-1004100040-PRIORITY", "Priority");
			fields[151] = new ims.framework.ReportField(this.context, "_cv_Rules.RuleToEdit", "BO-1004100040-XMLCONTENT", "XmlContent");
			fields[152] = new ims.framework.ReportField(this.context, "_cv_Rules.RuleToEdit", "BO-1004100040-ACTIVE", "Active");
			fields[153] = new ims.framework.ReportField(this.context, "_cv_Rules.RuleToEdit", "BO-1004100040-ROOTENTITY", "RootEntity");
			fields[154] = new ims.framework.ReportField(this.context, prefix + "_lv_Rules.RulesEditorComponent.__internal_x_context__EditedRule_" + componentIdentifier, "BO-1004100040-ID", "ID_BusinessRule");
			fields[155] = new ims.framework.ReportField(this.context, prefix + "_lv_Rules.RulesEditorComponent.__internal_x_context__EditedRule_" + componentIdentifier, "BO-1004100040-NAME", "Name");
			fields[156] = new ims.framework.ReportField(this.context, prefix + "_lv_Rules.RulesEditorComponent.__internal_x_context__EditedRule_" + componentIdentifier, "BO-1004100040-DESCRIPTION", "Description");
			fields[157] = new ims.framework.ReportField(this.context, prefix + "_lv_Rules.RulesEditorComponent.__internal_x_context__EditedRule_" + componentIdentifier, "BO-1004100040-CATEGORY", "Category");
			fields[158] = new ims.framework.ReportField(this.context, prefix + "_lv_Rules.RulesEditorComponent.__internal_x_context__EditedRule_" + componentIdentifier, "BO-1004100040-VALIDFROM", "ValidFrom");
			fields[159] = new ims.framework.ReportField(this.context, prefix + "_lv_Rules.RulesEditorComponent.__internal_x_context__EditedRule_" + componentIdentifier, "BO-1004100040-VALIDTO", "ValidTo");
			fields[160] = new ims.framework.ReportField(this.context, prefix + "_lv_Rules.RulesEditorComponent.__internal_x_context__EditedRule_" + componentIdentifier, "BO-1004100040-PRIORITY", "Priority");
			fields[161] = new ims.framework.ReportField(this.context, prefix + "_lv_Rules.RulesEditorComponent.__internal_x_context__EditedRule_" + componentIdentifier, "BO-1004100040-XMLCONTENT", "XmlContent");
			fields[162] = new ims.framework.ReportField(this.context, prefix + "_lv_Rules.RulesEditorComponent.__internal_x_context__EditedRule_" + componentIdentifier, "BO-1004100040-ACTIVE", "Active");
			fields[163] = new ims.framework.ReportField(this.context, prefix + "_lv_Rules.RulesEditorComponent.__internal_x_context__EditedRule_" + componentIdentifier, "BO-1004100040-ROOTENTITY", "RootEntity");
			return fields;
		}
