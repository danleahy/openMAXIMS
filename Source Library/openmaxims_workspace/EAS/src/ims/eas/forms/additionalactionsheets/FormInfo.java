...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_EAS.AdditionalActionSheet" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_EAS.AdditionalActionSheets.__internal_x_context__" + String.valueOf(getFormId());
	}
