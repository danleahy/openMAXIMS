...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_EAS.ElectronicActionSheet", "_cv_Core.OutpatientAttendanceForOrder", "_cv_Core.CommentDialogString", "_cv_EAS.EasStatusHistory" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_EAS.PatientEasList.__internal_x_context__" + String.valueOf(getFormId());
	}
