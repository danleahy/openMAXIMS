...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "TreatmentSiteConfiguration";
	}
	public int getWidth()
	{
		return 848;
	...
	{
		return new String[] { "_cv_EAS.TreatmentSiteConfig" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_EAS.TreatmentSiteConfiguration.__internal_x_context__" + String.valueOf(getFormId());
	}
