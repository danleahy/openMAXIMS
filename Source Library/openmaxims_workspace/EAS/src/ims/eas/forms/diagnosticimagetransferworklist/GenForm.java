...
public class GenForm extends FormBridge
{
	...
	public static class cmbEASStatusComboBox extends ComboBoxBridge
	{
		private static final long serialVersionUID = 1L;
		
		public void newRow(ims.eas.vo.lookups.EASStatus value, String text)
		{
			super.control.newRow(value, text);
		}
		public void newRow(ims.eas.vo.lookups.EASStatus value, String text, ims.framework.utils.Image image)
		{
			super.control.newRow(value, text, image);
		}
		public void newRow(ims.eas.vo.lookups.EASStatus value, String text, ims.framework.utils.Color textColor)
		{
			super.control.newRow(value, text, textColor);
		}
		public void newRow(ims.eas.vo.lookups.EASStatus value, String text, ims.framework.utils.Image image, ims.framework.utils.Color textColor)
		{
			super.control.newRow(value, text, image, textColor);
		}
		public boolean removeRow(ims.eas.vo.lookups.EASStatus value)
		{
			return super.control.removeRow(value);
		}
		public ims.eas.vo.lookups.EASStatus getValue()
		{
			return (ims.eas.vo.lookups.EASStatus)super.control.getValue();
		}
		public void setValue(ims.eas.vo.lookups.EASStatus value)
		{
	...
	public static class grdResultsRow extends GridRowBridge
	{
		...
		public void setColDecisionToTreatReadOnly(boolean value)
		{
			super.row.setReadOnly(4, value);
		}
		public boolean isColDecisionToTreatReadOnly()
		{
			return super.row.isReadOnly(4);
		}
		public void showColDecisionToTreatOpened()
		{
			super.row.showOpened(4);
		}
		public void setTooltipForColDecisionToTreat(String value)
		{
			super.row.setTooltip(4, value);
		}
		public ims.framework.utils.Date getColDecisionToTreat()
		{
			return (ims.framework.utils.Date)super.row.get(4);
		}
		public void setColDecisionToTreat(ims.framework.utils.Date value)
		{
			super.row.set(4, value);
		}
		public void setCellColDecisionToTreatTooltip(String value)
		{
			super.row.setTooltip(4, value);
		}
		public void setColSeenByReadOnly(boolean value)
		{
			super.row.setReadOnly(5, value);
		}
		public boolean isColSeenByReadOnly()
		{
			return super.row.isReadOnly(5);
		}
		public void showColSeenByOpened()
		{
			super.row.showOpened(5);
		}
		public void setTooltipForColSeenBy(String value)
		{
			super.row.setTooltip(5, value);
		}
		public String getColSeenBy()
		{
			return (String)super.row.get(5);
		}
		public void setColSeenBy(String value)
		{
			super.row.set(5, value);
		}
		public void setCellColSeenByTooltip(String value)
		{
			super.row.setTooltip(5, value);
		}
		...
		public ims.eas.vo.DiagnosticImageTransferVo getValue()
		{
			return (ims.eas.vo.DiagnosticImageTransferVo)super.row.getValue();
		}
		public void setValue(ims.eas.vo.DiagnosticImageTransferVo value)
		{
	...
	public static class grdResultsGrid extends GridBridge
	{
		...
		public ims.eas.vo.DiagnosticImageTransferVoCollection getValues()
		{
			ims.eas.vo.DiagnosticImageTransferVoCollection listOfValues = new ims.eas.vo.DiagnosticImageTransferVoCollection();
		...
		public ims.eas.vo.DiagnosticImageTransferVo getValue()
		{
			return (ims.eas.vo.DiagnosticImageTransferVo)super.grid.getValue();
		}
		public void setValue(ims.eas.vo.DiagnosticImageTransferVo value)
		{
		...
		public grdResultsRow getRowByValue(ims.eas.vo.DiagnosticImageTransferVo value)
		{
		...
		public void setColDecisionToTreatHeaderTooltip(String value)
		{
			super.grid.setColumnHeaderTooltip(4, value);
		}
		public String getColDecisionToTreatHeaderTooltip()
		{
			return super.grid.getColumnHeaderTooltip(4);
		}
		public void setColSeenByHeaderTooltip(String value)
		{
			super.grid.setColumnHeaderTooltip(5, value);
		}
		public String getColSeenByHeaderTooltip()
		{
	...
	private void validateContext(ims.framework.Context context)
	{
		...
		if(!context.isValidContextType(ims.eas.vo.DiagnosticImageTransferSearchCriteriaVo.class))
			throw new ims.framework.exceptions.CodingRuntimeException("The type 'ims.eas.vo.DiagnosticImageTransferSearchCriteriaVo' of the global context variable 'EAS.DiagnosticImageTransferWorklistSearchCriteria' is not supported.");
	}
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		contextMenus.EAS.contextMenuTransferImage = factory.createMenu(startControlID.intValue() + 1);
		contextMenus.EAS.contextMenuTransferImageREMOVEItem = factory.createMenuItem(startControlID.intValue() + 1, "Remove", true, false, new Integer(102300), true, false);
		if(factory.getUIEngine().getLoggedInRole().hasMenuActionRight(appForm, new ims.framework.MenuAction(5170002)))
			contextMenus.EAS.contextMenuTransferImage.add(contextMenus.EAS.contextMenuTransferImageREMOVEItem);
		contextMenus.EAS.contextMenuTransferImageVIEW_SUMMARYItem = factory.createMenuItem(startControlID.intValue() + 2, "View Summary", true, false, new Integer(102240), true, false);
		if(factory.getUIEngine().getLoggedInRole().hasMenuActionRight(appForm, new ims.framework.MenuAction(5170003)))
			contextMenus.EAS.contextMenuTransferImage.add(contextMenus.EAS.contextMenuTransferImageVIEW_SUMMARYItem);
		contextMenus.EAS.contextMenuTransferImageREQUESTItem = factory.createMenuItem(startControlID.intValue() + 3, "Mark requested Images Transfered", true, false, new Integer(141100), true, false);
		if(factory.getUIEngine().getLoggedInRole().hasMenuActionRight(appForm, new ims.framework.MenuAction(5170001)))
			contextMenus.EAS.contextMenuTransferImage.add(contextMenus.EAS.contextMenuTransferImageREQUESTItem);
		form.registerMenu(contextMenus.EAS.contextMenuTransferImage);


		// Label Controls
		RuntimeAnchoring anchoringHelper1 = new RuntimeAnchoring(designSize, runtimeSize, 176, 34, 22, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1000), new Integer(anchoringHelper1.getX()), new Integer(anchoringHelper1.getY()), new Integer(anchoringHelper1.getWidth()), new Integer(anchoringHelper1.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "To:", new Integer(1), null, new Integer(0)}));
		RuntimeAnchoring anchoringHelper2 = new RuntimeAnchoring(designSize, runtimeSize, 8, 34, 63, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1001), new Integer(anchoringHelper2.getX()), new Integer(anchoringHelper2.getY()), new Integer(anchoringHelper2.getWidth()), new Integer(anchoringHelper2.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "DTT From:", new Integer(1), null, new Integer(0)}));
		RuntimeAnchoring anchoringHelper3 = new RuntimeAnchoring(designSize, runtimeSize, 568, 10, 70, 17, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
		super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1002), new Integer(anchoringHelper3.getX()), new Integer(anchoringHelper3.getY()), new Integer(anchoringHelper3.getWidth()), new Integer(anchoringHelper3.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT, "EAS Status:", new Integer(1), null, new Integer(0)}));
		RuntimeAnchoring anchoringHelper4 = new RuntimeAnchoring(designSize, runtimeSize, 312, 10, 54, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1003), new Integer(anchoringHelper4.getX()), new Integer(anchoringHelper4.getY()), new Integer(anchoringHelper4.getWidth()), new Integer(anchoringHelper4.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Seen By:", new Integer(1), null, new Integer(0)}));
		RuntimeAnchoring anchoringHelper5 = new RuntimeAnchoring(designSize, runtimeSize, 176, 10, 22, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1004), new Integer(anchoringHelper5.getX()), new Integer(anchoringHelper5.getY()), new Integer(anchoringHelper5.getWidth()), new Integer(anchoringHelper5.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "To:", new Integer(1), null, new Integer(0)}));
		RuntimeAnchoring anchoringHelper6 = new RuntimeAnchoring(designSize, runtimeSize, 312, 34, 67, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1005), new Integer(anchoringHelper6.getX()), new Integer(anchoringHelper6.getY()), new Integer(anchoringHelper6.getWidth()), new Integer(anchoringHelper6.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Resp. HCP:", new Integer(1), null, new Integer(0)}));
		RuntimeAnchoring anchoringHelper7 = new RuntimeAnchoring(designSize, runtimeSize, 8, 10, 69, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1006), new Integer(anchoringHelper7.getX()), new Integer(anchoringHelper7.getY()), new Integer(anchoringHelper7.getWidth()), new Integer(anchoringHelper7.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Seen From:", new Integer(1), null, new Integer(0)}));

		// Date Controls
		RuntimeAnchoring anchoringHelper8 = new RuntimeAnchoring(designSize, runtimeSize, 200, 32, 96, 20, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		RuntimeAnchoring anchoringHelper9 = new RuntimeAnchoring(designSize, runtimeSize, 76, 32, 96, 20, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		RuntimeAnchoring anchoringHelper10 = new RuntimeAnchoring(designSize, runtimeSize, 200, 8, 96, 20, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(DateControl.class, new Object[] { control, new Integer(startControlID.intValue() + 1009), new Integer(anchoringHelper10.getX()), new Integer(anchoringHelper10.getY()), new Integer(anchoringHelper10.getWidth()), new Integer(anchoringHelper10.getHeight()), new Integer(startTabIndex.intValue() + 2), ControlState.ENABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.TRUE, null, Boolean.FALSE, null, Boolean.FALSE, null}));
		RuntimeAnchoring anchoringHelper11 = new RuntimeAnchoring(designSize, runtimeSize, 76, 8, 96, 20, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		// ComboBox Controls
		RuntimeAnchoring anchoringHelper12 = new RuntimeAnchoring(designSize, runtimeSize, 640, 8, 128, 21, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
		ComboBox m_cmbEASStatusTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1011), new Integer(anchoringHelper12.getX()), new Integer(anchoringHelper12.getY()), new Integer(anchoringHelper12.getWidth()), new Integer(anchoringHelper12.getHeight()), new Integer(startTabIndex.intValue() + 7), ControlState.ENABLED, ControlState.ENABLED,ims.framework.enumerations.ControlAnchoring.TOPRIGHT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
		addControl(m_cmbEASStatusTemp);
		cmbEASStatusComboBox cmbEASStatus = (cmbEASStatusComboBox)ComboBoxFlyweightFactory.getInstance().createComboBoxBridge(cmbEASStatusComboBox.class, m_cmbEASStatusTemp);
		super.addComboBox(cmbEASStatus);

		// Query ComboBox Controls
		RuntimeAnchoring anchoringHelper13 = new RuntimeAnchoring(designSize, runtimeSize, 376, 32, 176, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT);
		...
		RuntimeAnchoring anchoringHelper14 = new RuntimeAnchoring(designSize, runtimeSize, 376, 8, 176, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT);
		...
		// CheckBox Controls
		RuntimeAnchoring anchoringHelper15 = new RuntimeAnchoring(designSize, runtimeSize, 568, 34, 112, 16, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
		super.addControl(factory.getControl(CheckBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1014), new Integer(anchoringHelper15.getX()), new Integer(anchoringHelper15.getY()), new Integer(anchoringHelper15.getWidth()), new Integer(anchoringHelper15.getHeight()), new Integer(startTabIndex.intValue() + 8), ControlState.ENABLED, ControlState.ENABLED,ims.framework.enumerations.ControlAnchoring.TOPRIGHT ,"Include Removed", Boolean.FALSE, null}));

		// Grid Controls
		RuntimeAnchoring anchoringHelper16 = new RuntimeAnchoring(designSize, runtimeSize, 8, 64, 832, 560, ims.framework.enumerations.ControlAnchoring.ALL);
		Grid m_grdResultsTemp = (Grid)factory.getControl(Grid.class, new Object[] { control, new Integer(startControlID.intValue() + 1015), new Integer(anchoringHelper16.getX()), new Integer(anchoringHelper16.getY()), new Integer(anchoringHelper16.getWidth()), new Integer(anchoringHelper16.getHeight()), new Integer(startTabIndex.intValue() + 11), ControlState.READONLY, ControlState.READONLY, ims.framework.enumerations.ControlAnchoring.ALL,Boolean.TRUE, Boolean.FALSE, new Integer(24), Boolean.TRUE, contextMenus.EAS.contextMenuTransferImage, Boolean.TRUE, Boolean.FALSE, new Integer(0), null, Boolean.FALSE, Boolean.TRUE});
		...
		grdResults.addStringColumn("Hosp. No", 1, 2, 80, true, false, 1, 0, true, ims.framework.enumerations.CharacterCasing.NORMAL);
		grdResults.addDateColumn("Seen", 1, 1, 85, true, true, null, false, 1, true);
		grdResults.addStringColumn("Surname", 1, 0, 140, true, false, 1, 0, true, ims.framework.enumerations.CharacterCasing.NORMAL);
		grdResults.addStringColumn("Forename", 1, 0, 140, true, false, 1, 0, true, ims.framework.enumerations.CharacterCasing.NORMAL);
		grdResults.addDateColumn("DTT", 1, 1, 85, true, true, null, false, 1, true);
		grdResults.addStringColumn("Seen By", 1, 0, 200, true, false, 1, 0, true, ims.framework.enumerations.CharacterCasing.NORMAL);
		grdResults.addStringColumn("Status", 1, 1, -1, true, false, 1, 0, true, ims.framework.enumerations.CharacterCasing.NORMAL);
		super.addGrid(grdResults);

		// Image Buttons Controls
		RuntimeAnchoring anchoringHelper17 = new RuntimeAnchoring(designSize, runtimeSize, 808, 14, 32, 32, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
		...
		RuntimeAnchoring anchoringHelper18 = new RuntimeAnchoring(designSize, runtimeSize, 772, 14, 32, 32, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
	...
	public DateControl dteDTATo()
	{
		return (DateControl)super.getControl(7);
	}
	public DateControl dteDTAFrom()
	{
	...
	public cmbEASStatusComboBox cmbEASStatus()
	{
		return (cmbEASStatusComboBox)super.getComboBox(0);
	}
	public qmbResponsibleHCPComboBox qmbResponsibleHCP()
	{
		return (qmbResponsibleHCPComboBox)super.getComboBox(1);
	}
	public qmbSeenByComboBox qmbSeenBy()
	{
		return (qmbSeenByComboBox)super.getComboBox(2);
	}
	public CheckBox chkRemoved()
	{
	...
	public static class Forms implements java.io.Serializable
	{
		...
		public final class EASForms implements java.io.Serializable
		{
			...
			private EASForms()
			{
				...
				RequestImageTransfer = new LocalFormName(145120);
			}
			public final FormName PatientElectronicActionSheet;
			public final FormName RemovalReason;
			public final FormName RequestImageTransfer;
		}
	...
	public final class ContextMenus implements java.io.Serializable
	{
		...
		{
			private static final long serialVersionUID = 1L;
			public final class TransferImage implements java.io.Serializable
			{
				private static final long serialVersionUID = 1L;
			...
			public void disableAllTransferImageMenuItems()
			{
				this.contextMenuTransferImageREMOVEItem.setEnabled(false);
				this.contextMenuTransferImageVIEW_SUMMARYItem.setEnabled(false);
				this.contextMenuTransferImageREQUESTItem.setEnabled(false);
			}
			public void hideAllTransferImageMenuItems()
			{
				this.contextMenuTransferImageREMOVEItem.setVisible(false);
				this.contextMenuTransferImageVIEW_SUMMARYItem.setVisible(false);
				this.contextMenuTransferImageREQUESTItem.setVisible(false);
			}
			private Menu contextMenuTransferImage;
			public ReadOnlyMenuItem getTransferImageREMOVEItem()
			{
				return this.contextMenuTransferImageREMOVEItem;
			}
			private MenuItem contextMenuTransferImageREMOVEItem;
			public ReadOnlyMenuItem getTransferImageVIEW_SUMMARYItem()
			{
				return this.contextMenuTransferImageVIEW_SUMMARYItem;
			}
			private MenuItem contextMenuTransferImageVIEW_SUMMARYItem;
			public ReadOnlyMenuItem getTransferImageREQUESTItem()
			{
				return this.contextMenuTransferImageREQUESTItem;
			}
			private MenuItem contextMenuTransferImageREQUESTItem;
		}
	}
