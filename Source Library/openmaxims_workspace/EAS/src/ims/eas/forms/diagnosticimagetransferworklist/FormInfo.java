...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "DiagnosticImageTransferWorklist";
	}
	public int getWidth()
	{
		return 848;
	...
	{
		return new String[] { "_cv_EAS.ElectronicActionSheet", "_cv_EAS.RemovalReason" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_EAS.DiagnosticImageTransferWorklist.__internal_x_context__" + String.valueOf(getFormId());
	}
