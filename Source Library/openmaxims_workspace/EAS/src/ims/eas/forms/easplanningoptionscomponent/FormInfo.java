...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "EASPlanningOptionsComponent";
	}
	public int getWidth()
	{
		return 824;
	...
	{
		return "_lv_EAS.EASPlanningOptionsComponent.__internal_x_context__" + String.valueOf(getFormId());
	}
	public ims.framework.FormInfo[] getComponentsFormInfo()
	{
		ims.framework.FormInfo[] componentsInfo = new ims.framework.FormInfo[1];
		componentsInfo[0] = new ims.eas.forms.eassummaryinformation.FormInfo(145110);
