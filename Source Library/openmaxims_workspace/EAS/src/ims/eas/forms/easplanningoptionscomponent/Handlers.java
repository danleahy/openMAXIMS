...
abstract public class Handlers implements ims.framework.UILogic, IFormUILogicCode
{
	...
	abstract protected void onDyngrdPOCellValueChanged(ims.framework.controls.DynamicGridCell cell);
	...
	public final void setContext(ims.framework.UIComponentEngine engine, GenForm form)
	{
		...
		this.form.dyngrdPO().setDynamicGridCellValueChangedEvent(new DynamicGridCellValueChanged()
		{
			private static final long serialVersionUID = 1L;
			...
			{
				onDyngrdPOCellValueChanged(cell);
			}
		});
	}
