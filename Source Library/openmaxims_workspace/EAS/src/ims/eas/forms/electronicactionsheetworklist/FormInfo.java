...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "ElectronicActionSheetWorklist";
	}
	public int getWidth()
	{
		return 848;
	...
	{
		return new String[] { "_cv_EAS.ElectronicActionSheet", "_cv_EAS.RemovalReason", "_cv_EAS.EasStatusHistory" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_EAS.ElectronicActionSheetWorklist.__internal_x_context__" + String.valueOf(getFormId());
	}
