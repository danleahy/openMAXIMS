...
public class GenForm extends FormBridge
{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1003), new Integer(anchoringHelper3.getX()), new Integer(anchoringHelper3.getY()), new Integer(anchoringHelper3.getWidth()), new Integer(anchoringHelper3.getHeight()), new Integer(startTabIndex.intValue() + 9), ControlState.HIDDEN, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Cancel", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1005), new Integer(anchoringHelper5.getX()), new Integer(anchoringHelper5.getY()), new Integer(anchoringHelper5.getWidth()), new Integer(anchoringHelper5.getHeight()), new Integer(startTabIndex.intValue() + 6), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Capture/Import", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1006), new Integer(anchoringHelper6.getX()), new Integer(anchoringHelper6.getY()), new Integer(anchoringHelper6.getWidth()), new Integer(anchoringHelper6.getHeight()), new Integer(startTabIndex.intValue() + 7), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Edit", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1007), new Integer(anchoringHelper7.getX()), new Integer(anchoringHelper7.getY()), new Integer(anchoringHelper7.getWidth()), new Integer(anchoringHelper7.getHeight()), new Integer(startTabIndex.intValue() + 5), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT,Boolean.TRUE, new Integer(5000), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[147] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalContact", "BO-1004100003-ID", "ID_ClinicalContact");
			fields[148] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalContact", "BO-1004100003-SPECIALTY", "Specialty");
			fields[149] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalContact", "BO-1004100003-SEENBY", "SeenBy");
			fields[150] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalContact", "BO-1004100003-CONTACTTYPE", "ContactType");
			fields[151] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalContact", "BO-1004100003-STARTDATETIME", "StartDateTime");
			fields[152] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalContact", "BO-1004100003-ENDDATETIME", "EndDateTime");
			fields[153] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalContact", "BO-1004100003-CARECONTEXT", "CareContext");
			fields[154] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalContact", "BO-1004100003-ISCLINICALNOTECREATED", "IsClinicalNoteCreated");
			fields[155] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.WoundImagesCC.__internal_x_context__CurrentWoundImage_" + componentIdentifier, "BO-1086100050-ID", "ID_WoundImage");
			fields[156] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.WoundImagesCC.__internal_x_context__CurrentWoundImage_" + componentIdentifier, "BO-1086100050-COMMENT", "Comment");
			fields[157] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.WoundImagesCC.__internal_x_context__EDAssessmentWoundImages_" + componentIdentifier, "BO-1086100049-ID", "ID_PatientWoundImages");
			fields[158] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.WoundImagesCC.__internal_x_context__EDAssessmentWoundImages_" + componentIdentifier, "BO-1086100049-PATIENT", "Patient");
			fields[159] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.WoundImagesCC.__internal_x_context__EDAssessmentWoundImages_" + componentIdentifier, "BO-1086100049-CARECONTEXT", "CareContext");
			fields[160] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.WoundImagesCC.__internal_x_context__PatientRef_" + componentIdentifier, "BO-1001100000-ID", "ID_Patient");
			fields[161] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.WoundImagesCC.__internal_x_context__EpisodeOfCareRef_" + componentIdentifier, "BO-1004100018-ID", "ID_EpisodeOfCare");
			fields[162] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.WoundImagesCC.__internal_x_context__CareContextRef_" + componentIdentifier, "BO-1004100019-ID", "ID_CareContext");
			fields[163] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.WoundImagesCC.__internal_x_context__WoundImageDB_" + componentIdentifier, "BO-1028100055-ID", "ID_AppDBImage");
			fields[164] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.WoundImagesCC.__internal_x_context__WoundImageDB_" + componentIdentifier, "BO-1028100055-IMAGEDATA", "ImageData");
			fields[165] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.WoundImagesCC.__internal_x_context__WoundImageDB_" + componentIdentifier, "BO-1028100055-IMAGETYPE", "ImageType");
			return fields;
		}
