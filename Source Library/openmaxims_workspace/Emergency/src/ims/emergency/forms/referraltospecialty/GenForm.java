...
public class GenForm extends FormBridge
{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1012), new Integer(anchoringHelper12.getX()), new Integer(anchoringHelper12.getY()), new Integer(anchoringHelper12.getWidth()), new Integer(anchoringHelper12.getHeight()), new Integer(startTabIndex.intValue() + 12), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "New", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, "_cv_Emergency.ReferralToSpecialtyComments", "BO-1086100019-ID", "ID_ReferralToSpecTeamComments");
			fields[145] = new ims.framework.ReportField(this.context, "_cv_Emergency.ReferralToSpecialtyComments", "BO-1086100019-COMMENTS", "Comments");
			fields[146] = new ims.framework.ReportField(this.context, "_cv_Emergency.Tracking", "BO-1086100005-ID", "ID_Tracking");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.ReferralToSpecialty.__internal_x_context__SelectedComment_" + componentIdentifier, "BO-1086100019-ID", "ID_ReferralToSpecTeamComments");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.ReferralToSpecialty.__internal_x_context__SelectedComment_" + componentIdentifier, "BO-1086100019-COMMENTS", "Comments");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.ReferralToSpecialty.__internal_x_context__SelectedReferralToSpecialty_" + componentIdentifier, "BO-1086100003-ID", "ID_ReferralToSpecTeam");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.ReferralToSpecialty.__internal_x_context__SelectedReferralToSpecialty_" + componentIdentifier, "BO-1086100003-EPISODE", "Episode");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.ReferralToSpecialty.__internal_x_context__SelectedReferralToSpecialty_" + componentIdentifier, "BO-1086100003-ATTENDANCE", "Attendance");
			fields[152] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.ReferralToSpecialty.__internal_x_context__SelectedReferralToSpecialty_" + componentIdentifier, "BO-1086100003-TRACKINGAREA", "TrackingArea");
			fields[153] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.ReferralToSpecialty.__internal_x_context__SelectedReferralToSpecialty_" + componentIdentifier, "BO-1086100003-TEAMCONSULTANT", "TeamConsultant");
			fields[154] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.ReferralToSpecialty.__internal_x_context__SelectedReferralToSpecialty_" + componentIdentifier, "BO-1086100003-SPECIALTY", "Specialty");
			fields[155] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.ReferralToSpecialty.__internal_x_context__SelectedReferralToSpecialty_" + componentIdentifier, "BO-1086100003-REFERREDDATETIME", "ReferredDateTime");
			fields[156] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.ReferralToSpecialty.__internal_x_context__SelectedReferralToSpecialty_" + componentIdentifier, "BO-1086100003-SEENDATETIME", "SeenDateTime");
			fields[157] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.ReferralToSpecialty.__internal_x_context__SelectedReferralToSpecialty_" + componentIdentifier, "BO-1086100003-COMPLETIONDATETIME", "CompletionDateTime");
			fields[158] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.ReferralToSpecialty.__internal_x_context__SelectedReferralToSpecialty_" + componentIdentifier, "BO-1086100003-NOTACCEPTED", "NotAccepted");
			fields[159] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.ReferralToSpecialty.__internal_x_context__SelectedReferralToSpecialty_" + componentIdentifier, "BO-1086100003-ISSAFEGUARDINGCONCERN", "IsSafeguardingConcern");
			fields[160] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.ReferralToSpecialty.__internal_x_context__SelectedReferralToSpecialty_" + componentIdentifier, "BO-1086100003-SAFEGUARDINGCOMMENTS", "SafeguardingComments");
			fields[161] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.ReferralToSpecialty.__internal_x_context__TrackingForReferral_" + componentIdentifier, "BO-1086100005-ID", "ID_Tracking");
			fields[162] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.ReferralToSpecialty.__internal_x_context__TrackingForReferral_" + componentIdentifier, "BO-1086100005-ISDISCHARGED", "IsDischarged");
			return fields;
		}
