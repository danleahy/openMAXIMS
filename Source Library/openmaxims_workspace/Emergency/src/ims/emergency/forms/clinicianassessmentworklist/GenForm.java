...
public class GenForm extends FormBridge
{
	...
	public static class lyrPatientTriageLayer extends Layer
	{
		...
		public static class tabNotesContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				ims.framework.FormUiLogic m_ccMedicNotesForm = loader.loadComponent(129144, appForm, startControlID * 10 + 1000, anchoringHelper1.getSize(), instance1, startTabIndex.intValue() + 6, skipContextValidation);
				//ims.framework.Control m_ccMedicNotesControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1000), new Integer(0), new Integer(0), new Integer(552), new Integer(547), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 6), m_ccMedicNotesForm, instance1 } );
				ims.framework.Control m_ccMedicNotesControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1001),  new Integer(anchoringHelper1.getX()), new Integer(anchoringHelper1.getY()), new Integer(anchoringHelper1.getWidth()), new Integer(anchoringHelper1.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 6), m_ccMedicNotesForm, instance1, Boolean.FALSE } );
		...
		public static class tabObsContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				ims.framework.FormUiLogic m_ccVitalSignsForm = loader.loadComponent(102387, appForm, startControlID * 10 + 2000, anchoringHelper2.getSize(), instance1, startTabIndex.intValue() + 11, skipContextValidation);
				//ims.framework.Control m_ccVitalSignsControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1002), new Integer(0), new Integer(0), new Integer(552), new Integer(552), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 11), m_ccVitalSignsForm, instance1 } );
				ims.framework.Control m_ccVitalSignsControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1003),  new Integer(anchoringHelper2.getX()), new Integer(anchoringHelper2.getY()), new Integer(anchoringHelper2.getWidth()), new Integer(anchoringHelper2.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 11), m_ccVitalSignsForm, instance1, Boolean.FALSE } );
			...
			public static class lyrObs2Layer extends Layer
			{
				...
				public static class tabVitalSignsContainer extends LayerBridge
				{
					...
					protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
					{
						...
						ims.framework.FormUiLogic m_ccVitalSignsObsForm = loader.loadComponent(102387, appForm, startControlID * 10 + 3000, anchoringHelper3.getSize(), instance1, startTabIndex.intValue() + 89, skipContextValidation);
						//ims.framework.Control m_ccVitalSignsObsControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1004), new Integer(0), new Integer(0), new Integer(534), new Integer(523), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 89), m_ccVitalSignsObsForm, instance1 } );
				...
				public static class tabUrinalysisContainer extends LayerBridge
				{
					...
					protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
					{
						...
						ims.framework.FormUiLogic m_ccUrinalysisForm = loader.loadComponent(123254, appForm, startControlID * 10 + 4000, anchoringHelper4.getSize(), instance1, startTabIndex.intValue() + 167, skipContextValidation);
						//ims.framework.Control m_ccUrinalysisControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1006), new Integer(0), new Integer(0), new Integer(534), new Integer(523), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 167), m_ccUrinalysisForm, instance1 } );
				...
				public static class tabUrineToxContainer extends LayerBridge
				{
					...
					protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
					{
						...
						ims.framework.FormUiLogic m_ccUrineToxForm = loader.loadComponent(123255, appForm, startControlID * 10 + 5000, anchoringHelper5.getSize(), instance1, startTabIndex.intValue() + 234, skipContextValidation);
						//ims.framework.Control m_ccUrineToxControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1008), new Integer(0), new Integer(0), new Integer(534), new Integer(523), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 234), m_ccUrineToxForm, instance1 } );
						ims.framework.Control m_ccUrineToxControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1009),  new Integer(anchoringHelper5.getX()), new Integer(anchoringHelper5.getY()), new Integer(anchoringHelper5.getWidth()), new Integer(anchoringHelper5.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 234), m_ccUrineToxForm, instance1, Boolean.FALSE } );
				...
				public static class tabHCGContainer extends LayerBridge
				{
					...
					protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
					{
						...
						ims.framework.FormUiLogic m_ccHCGForm = loader.loadComponent(123256, appForm, startControlID * 10 + 6000, anchoringHelper6.getSize(), instance1, startTabIndex.intValue() + 236, skipContextValidation);
						//ims.framework.Control m_ccHCGControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1010), new Integer(0), new Integer(0), new Integer(534), new Integer(523), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 236), m_ccHCGForm, instance1 } );
				...
				public static class tabOtherContainer extends LayerBridge
				{
					...
					protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
					{
						...
						ims.framework.FormUiLogic m_ccPatientAssessmentForm = loader.loadComponent(123257, appForm, startControlID * 10 + 7000, anchoringHelper7.getSize(), instance1, startTabIndex.intValue() + 238, skipContextValidation);
						//ims.framework.Control m_ccPatientAssessmentControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1012), new Integer(0), new Integer(0), new Integer(534), new Integer(523), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 238), m_ccPatientAssessmentForm, instance1 } );
						ims.framework.Control m_ccPatientAssessmentControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1013),  new Integer(anchoringHelper7.getX()), new Integer(anchoringHelper7.getY()), new Integer(anchoringHelper7.getWidth()), new Integer(anchoringHelper7.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 238), m_ccPatientAssessmentForm, instance1, Boolean.FALSE } );
		...
		public static class tabPathwayContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				ims.framework.FormUiLogic m_ccICPForm = loader.loadComponent(118128, appForm, startControlID * 10 + 8000, anchoringHelper13.getSize(), instance1, startTabIndex.intValue() + 249, skipContextValidation);
				//ims.framework.Control m_ccICPControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1019), new Integer(8), new Integer(0), new Integer(544), new Integer(544), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 249), m_ccICPForm, instance1 } );
				ims.framework.Control m_ccICPControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1020),  new Integer(anchoringHelper13.getX()), new Integer(anchoringHelper13.getY()), new Integer(anchoringHelper13.getWidth()), new Integer(anchoringHelper13.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 249), m_ccICPForm, instance1, Boolean.FALSE } );
		...
		public static class tabSysReviewContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				ims.framework.FormUiLogic m_ccSystemReviewForm = loader.loadComponent(129151, appForm, startControlID * 10 + 9000, anchoringHelper14.getSize(), instance1, startTabIndex.intValue() + 268, skipContextValidation);
				//ims.framework.Control m_ccSystemReviewControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1021), new Integer(0), new Integer(0), new Integer(552), new Integer(552), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 268), m_ccSystemReviewForm, instance1 } );
				ims.framework.Control m_ccSystemReviewControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1022),  new Integer(anchoringHelper14.getX()), new Integer(anchoringHelper14.getY()), new Integer(anchoringHelper14.getWidth()), new Integer(anchoringHelper14.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 268), m_ccSystemReviewForm, instance1, Boolean.FALSE } );
		...
		public static class tabPatientMedsContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				ims.framework.FormUiLogic m_ccPatientMedsForm = loader.loadComponent(129126, appForm, startControlID * 10 + 10000, anchoringHelper15.getSize(), instance1, startTabIndex.intValue() + 273, skipContextValidation);
				//ims.framework.Control m_ccPatientMedsControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1023), new Integer(0), new Integer(0), new Integer(552), new Integer(553), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 273), m_ccPatientMedsForm, instance1 } );
				ims.framework.Control m_ccPatientMedsControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1024),  new Integer(anchoringHelper15.getX()), new Integer(anchoringHelper15.getY()), new Integer(anchoringHelper15.getWidth()), new Integer(anchoringHelper15.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 273), m_ccPatientMedsForm, instance1, Boolean.FALSE } );
		...
		public static class tabRelevantPMHContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				ims.framework.FormUiLogic m_ccRelevantPMHForm = loader.loadComponent(129125, appForm, startControlID * 10 + 11000, anchoringHelper16.getSize(), instance1, startTabIndex.intValue() + 279, skipContextValidation);
				//ims.framework.Control m_ccRelevantPMHControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1025), new Integer(0), new Integer(0), new Integer(552), new Integer(552), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 279), m_ccRelevantPMHForm, instance1 } );
				ims.framework.Control m_ccRelevantPMHControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1026),  new Integer(anchoringHelper16.getX()), new Integer(anchoringHelper16.getY()), new Integer(anchoringHelper16.getWidth()), new Integer(anchoringHelper16.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 279), m_ccRelevantPMHForm, instance1, Boolean.FALSE } );
		...
		public static class tabSupportContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				ims.framework.FormUiLogic m_ccSupportServiceForm = loader.loadComponent(129161, appForm, startControlID * 10 + 12000, anchoringHelper17.getSize(), instance1, startTabIndex.intValue() + 286, skipContextValidation);
				//ims.framework.Control m_ccSupportServiceControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1027), new Integer(0), new Integer(0), new Integer(552), new Integer(544), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 286), m_ccSupportServiceForm, instance1 } );
				ims.framework.Control m_ccSupportServiceControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1028),  new Integer(anchoringHelper17.getX()), new Integer(anchoringHelper17.getY()), new Integer(anchoringHelper17.getWidth()), new Integer(anchoringHelper17.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 286), m_ccSupportServiceForm, instance1, Boolean.FALSE } );
		...
		public static class tabDischargeDetailsContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				ims.framework.FormUiLogic m_ccDischargeForm = loader.loadComponent(129155, appForm, startControlID * 10 + 13000, anchoringHelper18.getSize(), instance1, startTabIndex.intValue() + 355, skipContextValidation);
				//ims.framework.Control m_ccDischargeControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1029), new Integer(0), new Integer(0), new Integer(552), new Integer(552), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 355), m_ccDischargeForm, instance1 } );
				ims.framework.Control m_ccDischargeControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1030),  new Integer(anchoringHelper18.getX()), new Integer(anchoringHelper18.getY()), new Integer(anchoringHelper18.getWidth()), new Integer(anchoringHelper18.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 355), m_ccDischargeForm, instance1, Boolean.FALSE } );
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		ims.framework.FormUiLogic m_ccAlertForm = loader.loadComponent(102401, appForm, startControlID * 10 + 14000, anchoringHelper33.getSize(), instance1, startTabIndex.intValue() + 363, skipContextValidation);
		//ims.framework.Control m_ccAlertControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1043), new Integer(920), new Integer(210), new Integer(240), new Integer(96), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT, new Integer(startTabIndex.intValue() + 363), m_ccAlertForm, instance1 } );
		ims.framework.Control m_ccAlertControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1044),  new Integer(anchoringHelper33.getX()), new Integer(anchoringHelper33.getY()), new Integer(anchoringHelper33.getWidth()), new Integer(anchoringHelper33.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT, new Integer(startTabIndex.intValue() + 363), m_ccAlertForm, instance1, Boolean.FALSE } );
		...
		ims.framework.FormUiLogic m_ccAllergyForm = loader.loadComponent(123239, appForm, startControlID * 10 + 15000, anchoringHelper34.getSize(), instance2, startTabIndex.intValue() + 357, skipContextValidation);
		//ims.framework.Control m_ccAllergyControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1045), new Integer(920), new Integer(113), new Integer(240), new Integer(96), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT, new Integer(startTabIndex.intValue() + 357), m_ccAllergyForm, instance2 } );
		ims.framework.Control m_ccAllergyControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1046),  new Integer(anchoringHelper34.getX()), new Integer(anchoringHelper34.getY()), new Integer(anchoringHelper34.getWidth()), new Integer(anchoringHelper34.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT, new Integer(startTabIndex.intValue() + 357), m_ccAllergyForm, instance2, Boolean.FALSE } );
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1068), new Integer(anchoringHelper56.getX()), new Integer(anchoringHelper56.getY()), new Integer(anchoringHelper56.getWidth()), new Integer(anchoringHelper56.getHeight()), new Integer(startTabIndex.intValue() + 384), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Results", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1069), new Integer(anchoringHelper57.getX()), new Integer(anchoringHelper57.getY()), new Integer(anchoringHelper57.getWidth()), new Integer(anchoringHelper57.getHeight()), new Integer(startTabIndex.intValue() + 378), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Start Assessment", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1070), new Integer(anchoringHelper58.getX()), new Integer(anchoringHelper58.getY()), new Integer(anchoringHelper58.getWidth()), new Integer(anchoringHelper58.getHeight()), new Integer(startTabIndex.intValue() + 386), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Seen/Complete HCP", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1071), new Integer(anchoringHelper59.getX()), new Integer(anchoringHelper59.getY()), new Integer(anchoringHelper59.getWidth()), new Integer(anchoringHelper59.getHeight()), new Integer(startTabIndex.intValue() + 382), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "View Triage Notes", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1073), new Integer(anchoringHelper61.getX()), new Integer(anchoringHelper61.getY()), new Integer(anchoringHelper61.getWidth()), new Integer(anchoringHelper61.getHeight()), new Integer(startTabIndex.intValue() + 385), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Refer To Specialty", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1074), new Integer(anchoringHelper62.getX()), new Integer(anchoringHelper62.getY()), new Integer(anchoringHelper62.getWidth()), new Integer(anchoringHelper62.getHeight()), new Integer(startTabIndex.intValue() + 387), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Save + Move", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1075), new Integer(anchoringHelper63.getX()), new Integer(anchoringHelper63.getY()), new Integer(anchoringHelper63.getWidth()), new Integer(anchoringHelper63.getHeight()), new Integer(startTabIndex.intValue() + 383), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "View History", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1076), new Integer(anchoringHelper64.getX()), new Integer(anchoringHelper64.getY()), new Integer(anchoringHelper64.getWidth()), new Integer(anchoringHelper64.getHeight()), new Integer(startTabIndex.intValue() + 381), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Patient Summary", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1079), new Integer(anchoringHelper67.getX()), new Integer(anchoringHelper67.getY()), new Integer(anchoringHelper67.getWidth()), new Integer(anchoringHelper67.getHeight()), new Integer(startTabIndex.intValue() + 373), ControlState.DISABLED, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT,Boolean.FALSE, new Integer(0), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
		...
		super.addControl(factory.getControl(DateTimeControl.class, new Object[] { control, new Integer(startControlID.intValue() + 1080), new Integer(anchoringHelper68.getX()), new Integer(anchoringHelper68.getY()), new Integer(anchoringHelper68.getWidth()), new Integer(anchoringHelper68.getHeight()), new Integer(startTabIndex.intValue() + 377), ControlState.DISABLED, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT,Boolean.TRUE, null, Boolean.FALSE, null, Boolean.FALSE, null}));
		...
		super.addControl(factory.getControl(DateTimeControl.class, new Object[] { control, new Integer(startControlID.intValue() + 1081), new Integer(anchoringHelper69.getX()), new Integer(anchoringHelper69.getY()), new Integer(anchoringHelper69.getWidth()), new Integer(anchoringHelper69.getHeight()), new Integer(startTabIndex.intValue() + 376), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT,Boolean.TRUE, null, Boolean.FALSE, null, Boolean.FALSE, null}));
		...
		super.addControl(factory.getControl(DateTimeControl.class, new Object[] { control, new Integer(startControlID.intValue() + 1082), new Integer(anchoringHelper70.getX()), new Integer(anchoringHelper70.getY()), new Integer(anchoringHelper70.getWidth()), new Integer(anchoringHelper70.getHeight()), new Integer(startTabIndex.intValue() + 375), ControlState.DISABLED, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT,Boolean.TRUE, null, Boolean.FALSE, null, Boolean.FALSE, null}));
		...
		super.addControl(factory.getControl(DateTimeControl.class, new Object[] { control, new Integer(startControlID.intValue() + 1083), new Integer(anchoringHelper71.getX()), new Integer(anchoringHelper71.getY()), new Integer(anchoringHelper71.getWidth()), new Integer(anchoringHelper71.getHeight()), new Integer(startTabIndex.intValue() + 374), ControlState.DISABLED, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT,Boolean.TRUE, null, Boolean.FALSE, null, Boolean.FALSE, null}));
		...
		super.addControl(factory.getControl(DateTimeControl.class, new Object[] { control, new Integer(startControlID.intValue() + 1084), new Integer(anchoringHelper72.getX()), new Integer(anchoringHelper72.getY()), new Integer(anchoringHelper72.getWidth()), new Integer(anchoringHelper72.getHeight()), new Integer(startTabIndex.intValue() + 372), ControlState.DISABLED, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT,Boolean.TRUE, null, Boolean.FALSE, null, Boolean.FALSE, null}));
		...
		super.addControl(factory.getControl(DateTimeControl.class, new Object[] { control, new Integer(startControlID.intValue() + 1085), new Integer(anchoringHelper73.getX()), new Integer(anchoringHelper73.getY()), new Integer(anchoringHelper73.getWidth()), new Integer(anchoringHelper73.getHeight()), new Integer(startTabIndex.intValue() + 371), ControlState.DISABLED, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT,Boolean.TRUE, null, Boolean.FALSE, null, Boolean.FALSE, null}));
		...
		super.addControl(factory.getControl(DateTimeControl.class, new Object[] { control, new Integer(startControlID.intValue() + 1086), new Integer(anchoringHelper74.getX()), new Integer(anchoringHelper74.getY()), new Integer(anchoringHelper74.getWidth()), new Integer(anchoringHelper74.getHeight()), new Integer(startTabIndex.intValue() + 370), ControlState.DISABLED, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT,Boolean.TRUE, null, Boolean.FALSE, null, Boolean.FALSE, null}));
	...
	private class ReportFields
	{
		...
		{
			String prefix = formInfo.getLocalVariablesPrefix();
			IReportField[] fields = new IReportField[189];
			...
			fields[144] = new ims.framework.ReportField(this.context, "_cv_Emergency.TriageProtocolAssessment", "BO-1086100018-ID", "ID_TriageProtocolAssessment");
			fields[145] = new ims.framework.ReportField(this.context, "_cv_Emergency.Triage", "BO-1086100004-ID", "ID_Triage");
			fields[146] = new ims.framework.ReportField(this.context, "_cv_Emergency.Tracking", "BO-1086100005-ID", "ID_Tracking");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.ClinicianAssessmentWorklist.__internal_x_context__SelectedWaitingPatient_" + componentIdentifier, "BO-1086100005-ID", "ID_Tracking");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.ClinicianAssessmentWorklist.__internal_x_context__SelectedWaitingPatient_" + componentIdentifier, "BO-1086100005-CURRENTAREA", "CurrentArea");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.ClinicianAssessmentWorklist.__internal_x_context__SelectedWaitingPatient_" + componentIdentifier, "BO-1086100005-ISDISCHARGED", "IsDischarged");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.ClinicianAssessmentWorklist.__internal_x_context__SelectedWaitingPatient_" + componentIdentifier, "BO-1086100005-SEENBY", "SeenBy");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.ClinicianAssessmentWorklist.__internal_x_context__SelectedWaitingPatient_" + componentIdentifier, "BO-1086100005-SEENBYNURSE", "SeenByNurse");
			fields[152] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.ClinicianAssessmentWorklist.__internal_x_context__LoggedHcp_" + componentIdentifier, "BO-1006100000-ID", "ID_Hcp");
			fields[153] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.ClinicianAssessmentWorklist.__internal_x_context__AttendanceKPIConfig_" + componentIdentifier, "BO-1087100007-ID", "ID_AttendanceKPIConfig");
			fields[154] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.ClinicianAssessmentWorklist.__internal_x_context__AttendanceKPIConfig_" + componentIdentifier, "BO-1087100007-LOSBREACHWARNINGKPI", "LosBreachWarningKPI");
			fields[155] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.ClinicianAssessmentWorklist.__internal_x_context__AttendanceKPIConfig_" + componentIdentifier, "BO-1087100007-LOSBREACHEDKPI", "LosBreachedKPI");
			fields[156] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.ClinicianAssessmentWorklist.__internal_x_context__AttendanceKPIConfig_" + componentIdentifier, "BO-1087100007-LOSBREACHWARNINGKPIFLASHINGTEXTCOLOUR", "LosBreachWarningKPIFlashingTextColour");
			fields[157] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.ClinicianAssessmentWorklist.__internal_x_context__AttendanceKPIConfig_" + componentIdentifier, "BO-1087100007-LOSBREACHWARNINGKPIBACKGROUNDCOLOUR", "LosBreachWarningKPIBackgroundColour");
			fields[158] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.ClinicianAssessmentWorklist.__internal_x_context__AttendanceKPIConfig_" + componentIdentifier, "BO-1087100007-LOSBREACHEDKPIFLASHINGTEXTCOLOUR", "LosBreachedKPIFlashingTextColour");
			fields[159] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.ClinicianAssessmentWorklist.__internal_x_context__AttendanceKPIConfig_" + componentIdentifier, "BO-1087100007-LOSBREACHEDKPIBACKGROUNDCOLOUR", "LosBreachedKPIBackgroundColour");
			fields[160] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.ClinicianAssessmentWorklist.__internal_x_context__AttendanceKPIConfig_" + componentIdentifier, "BO-1087100007-LOSBREACHWARNINGKPITEXTCOLOUR", "LosBreachWarningKPITextColour");
			fields[161] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.ClinicianAssessmentWorklist.__internal_x_context__AttendanceKPIConfig_" + componentIdentifier, "BO-1087100007-LOSBREACHWARNINGKPIFLASHINGTEXT", "LosBreachWarningKPIFlashingText");
			fields[162] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.ClinicianAssessmentWorklist.__internal_x_context__AttendanceKPIConfig_" + componentIdentifier, "BO-1087100007-LOSBREACHKPITEXTCOLOUR", "LosBreachKPITextColour");
			fields[163] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.ClinicianAssessmentWorklist.__internal_x_context__AttendanceKPIConfig_" + componentIdentifier, "BO-1087100007-LOSBREACHEDKPIFLASHINGTEXT", "LosBreachedKPIFlashingText");
			fields[164] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.ClinicianAssessmentWorklist.__internal_x_context__AttendanceKPIConfig_" + componentIdentifier, "BO-1087100007-AWAITINGTRIAGEBREACHEDKPI", "AwaitingTriageBreachedKPI");
			fields[165] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.ClinicianAssessmentWorklist.__internal_x_context__CurrentAttendance_" + componentIdentifier, "BO-1004100025-ID", "ID_EmergencyAttendance");
			fields[166] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.ClinicianAssessmentWorklist.__internal_x_context__CurrentAttendance_" + componentIdentifier, "BO-1004100025-REGISTRATIONDATETIME", "RegistrationDateTime");
			fields[167] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.ClinicianAssessmentWorklist.__internal_x_context__CurrentAttendance_" + componentIdentifier, "BO-1004100025-AGEATATTENDANCE", "AgeAtAttendance");
			fields[168] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.ClinicianAssessmentWorklist.__internal_x_context__CurrentAttendance_" + componentIdentifier, "BO-1004100025-ARRIVALDATETIME", "ArrivalDateTime");
			fields[169] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.ClinicianAssessmentWorklist.__internal_x_context__CurrentAttendance_" + componentIdentifier, "BO-1004100025-DISCHARGEDATETIME", "DischargeDateTime");
			fields[170] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.ClinicianAssessmentWorklist.__internal_x_context__CurrentAttendance_" + componentIdentifier, "BO-1004100025-CARECONTEXT", "CareContext");
			fields[171] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.ClinicianAssessmentWorklist.__internal_x_context__CurrentAttendance_" + componentIdentifier, "BO-1004100025-URGENCYLEVEL", "UrgencyLevel");
			fields[172] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.ClinicianAssessmentWorklist.__internal_x_context__CurrentAttendance_" + componentIdentifier, "BO-1004100025-CONCLUSIONDATETIME", "ConclusionDateTime");
			fields[173] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.ClinicianAssessmentWorklist.__internal_x_context__CurrentAttendance_" + componentIdentifier, "BO-1004100025-BEDTYPEREQUESTED", "BedTypeRequested");
			fields[174] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.ClinicianAssessmentWorklist.__internal_x_context__CurrentAttendance_" + componentIdentifier, "BO-1004100025-MC", "MC");
			fields[175] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.ClinicianAssessmentWorklist.__internal_x_context__CurrentAttendance_" + componentIdentifier, "BO-1004100025-COTA", "COTA");
			fields[176] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.ClinicianAssessmentWorklist.__internal_x_context__CurrentAttendance_" + componentIdentifier, "BO-1004100025-PCG1", "PCG1");
			fields[177] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.ClinicianAssessmentWorklist.__internal_x_context__CurrentAttendance_" + componentIdentifier, "BO-1004100025-PCG2", "PCG2");
			fields[178] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.ClinicianAssessmentWorklist.__internal_x_context__CurrentAttendance_" + componentIdentifier, "BO-1004100025-HAR", "HAR");
			fields[179] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.ClinicianAssessmentWorklist.__internal_x_context__CurrentAttendance_" + componentIdentifier, "BO-1004100025-PURCHASER", "Purchaser");
			fields[180] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.ClinicianAssessmentWorklist.__internal_x_context__CurrentAttendance_" + componentIdentifier, "BO-1004100025-SEQUENCENUMBER", "SequenceNumber");
			fields[181] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.ClinicianAssessmentWorklist.__internal_x_context__CurrentAttendance_" + componentIdentifier, "BO-1004100025-CUSTOMID", "CustomID");
			fields[182] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.ClinicianAssessmentWorklist.__internal_x_context__CurrentAttendance_" + componentIdentifier, "BO-1004100025-ENDOFREGISTRATIONDATETIME", "EndOfRegistrationDateTime");
			fields[183] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.ClinicianAssessmentWorklist.__internal_x_context__CurrentAttendance_" + componentIdentifier, "BO-1004100025-MODEOFARRIVAL", "ModeOfArrival");
			fields[184] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.ClinicianAssessmentWorklist.__internal_x_context__CurrentEpisode_" + componentIdentifier, "BO-1004100024-ID", "ID_EmergencyEpisode");
			fields[185] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.ClinicianAssessmentWorklist.__internal_x_context__CurrentEpisode_" + componentIdentifier, "BO-1004100024-INJURYDATETIME", "InjuryDateTime");
			fields[186] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.ClinicianAssessmentWorklist.__internal_x_context__CurrentEpisode_" + componentIdentifier, "BO-1004100024-PRESENTINGCOMPLAINT", "PresentingComplaint");
			fields[187] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.ClinicianAssessmentWorklist.__internal_x_context__CurrentEpisode_" + componentIdentifier, "BO-1004100024-CATEGORY", "Category");
			fields[188] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.ClinicianAssessmentWorklist.__internal_x_context__CurrentEpisode_" + componentIdentifier, "BO-1004100024-MEDPATIENTCONSENT", "MedPatientConsent");
			return fields;
		}
