...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "AmentAttendanceSeenByHCPTimes";
	}
	public int getWidth()
	{
		return 464;
	...
	{
		return new String[] { "_cv_Emergency.EmergencyAttendanceForTimeAmendments", "_cv_Emergency.AmendAttendanceReferralToSpecialtyTimes", "_cv_Emergency.AmendAttendanceSeenByTimes" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Emergency.AmentAttendanceSeenByHCPTimes.__internal_x_context__" + String.valueOf(getFormId());
	}
