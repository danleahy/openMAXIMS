...
public class GenForm extends FormBridge
{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1014), new Integer(anchoringHelper14.getX()), new Integer(anchoringHelper14.getY()), new Integer(anchoringHelper14.getWidth()), new Integer(anchoringHelper14.getHeight()), new Integer(startTabIndex.intValue() + 6), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Edit", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.DiscriminatorConfiguration.__internal_x_context__SelectedItem_" + componentIdentifier, "BO-1087100009-ID", "ID_DiscriminatorConfig");
			fields[145] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.DiscriminatorConfiguration.__internal_x_context__SelectedItem_" + componentIdentifier, "BO-1087100009-DISCRIMINATORNAME", "DiscriminatorName");
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.DiscriminatorConfiguration.__internal_x_context__SelectedItem_" + componentIdentifier, "BO-1087100009-DISCRIMINATORDESCRIPTION", "DiscriminatorDescription");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.DiscriminatorConfiguration.__internal_x_context__SelectedItem_" + componentIdentifier, "BO-1087100009-ISACTIVE", "IsActive");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.DiscriminatorConfiguration.__internal_x_context__SelectedItem_" + componentIdentifier, "BO-1087100009-DEFAULTTRIAGEPRIORITY", "DefaultTriagePriority");
			return fields;
		}
