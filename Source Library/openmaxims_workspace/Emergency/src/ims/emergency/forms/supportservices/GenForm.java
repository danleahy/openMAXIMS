...
public class GenForm extends FormBridge
{
		...
		public static class tabPageProfContainer extends LayerBridge
		{
			...
			public static class grpProfFilterRadioButton extends RadioButtonBridge
			{
				...
				protected void setContext(Integer startTabIndex, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize)
				{
					...
					control.addButton(0, anchoringHelper1.getX(), anchoringHelper1.getY(), anchoringHelper1.getWidth(), "View All", startTabIndex.intValue() + 2);
					...
					control.addButton(1, anchoringHelper2.getX(), anchoringHelper2.getY(), anchoringHelper2.getWidth(), "View Active", startTabIndex.intValue() + 1);
				}
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1011), new Integer(anchoringHelper13.getX()), new Integer(anchoringHelper13.getY()), new Integer(anchoringHelper13.getWidth()), new Integer(anchoringHelper13.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT, "None at Present", new Integer(1), null, new Integer(1)}));
				...
				super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1012), new Integer(anchoringHelper14.getX()), new Integer(anchoringHelper14.getY()), new Integer(anchoringHelper14.getWidth()), new Integer(anchoringHelper14.getHeight()), new Integer(startTabIndex.intValue() + 20), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Edit", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
				...
				super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1013), new Integer(anchoringHelper15.getX()), new Integer(anchoringHelper15.getY()), new Integer(anchoringHelper15.getWidth()), new Integer(anchoringHelper15.getHeight()), new Integer(startTabIndex.intValue() + 19), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "New", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
				...
				super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1017), new Integer(anchoringHelper19.getX()), new Integer(anchoringHelper19.getY()), new Integer(anchoringHelper19.getWidth()), new Integer(anchoringHelper19.getHeight()), new Integer(startTabIndex.intValue() + 10), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT,Boolean.FALSE, new Integer(50), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
				...
				super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1018), new Integer(anchoringHelper20.getX()), new Integer(anchoringHelper20.getY()), new Integer(anchoringHelper20.getWidth()), new Integer(anchoringHelper20.getHeight()), new Integer(startTabIndex.intValue() + 8), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT,Boolean.FALSE, new Integer(100), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.TRUE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
				...
				super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1019), new Integer(anchoringHelper21.getX()), new Integer(anchoringHelper21.getY()), new Integer(anchoringHelper21.getWidth()), new Integer(anchoringHelper21.getHeight()), new Integer(startTabIndex.intValue() + 12), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT,Boolean.FALSE, new Integer(30), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
				...
				super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1022), new Integer(anchoringHelper24.getX()), new Integer(anchoringHelper24.getY()), new Integer(anchoringHelper24.getWidth()), new Integer(anchoringHelper24.getHeight()), new Integer(startTabIndex.intValue() + 15), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFTRIGHT,Boolean.FALSE, new Integer(30), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
				...
				ComboBox m_cmbProfessionalTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1023), new Integer(anchoringHelper25.getX()), new Integer(anchoringHelper25.getY()), new Integer(anchoringHelper25.getWidth()), new Integer(anchoringHelper25.getHeight()), new Integer(startTabIndex.intValue() + 5), ControlState.DISABLED, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT ,Boolean.TRUE, Boolean.TRUE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.TRUE, new Integer(-1)});
				...
				ComboBox m_cmbHcpSubTypeTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1024), new Integer(anchoringHelper26.getX()), new Integer(anchoringHelper26.getY()), new Integer(anchoringHelper26.getWidth()), new Integer(anchoringHelper26.getHeight()), new Integer(startTabIndex.intValue() + 6), ControlState.DISABLED, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT ,Boolean.TRUE, Boolean.TRUE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.TRUE, new Integer(-1)});
				...
				ComboBox m_cmbLocationHcpTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1025), new Integer(anchoringHelper27.getX()), new Integer(anchoringHelper27.getY()), new Integer(anchoringHelper27.getWidth()), new Integer(anchoringHelper27.getHeight()), new Integer(startTabIndex.intValue() + 11), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT ,Boolean.TRUE, Boolean.TRUE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
				...
				ComboBox m_qmbHcpNameTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1026), new Integer(anchoringHelper28.getX()), new Integer(anchoringHelper28.getY()), new Integer(anchoringHelper28.getWidth()), new Integer(anchoringHelper28.getHeight()), new Integer(startTabIndex.intValue() + 9), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT,Boolean.TRUE, Boolean.TRUE, SortOrder.NONE, Boolean.TRUE, new Integer(1), null, Boolean.TRUE, new Integer(-1), Boolean.FALSE});
				...
				super.addControl(factory.getControl(CheckBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1027), new Integer(anchoringHelper29.getX()), new Integer(anchoringHelper29.getY()), new Integer(anchoringHelper29.getWidth()), new Integer(anchoringHelper29.getHeight()), new Integer(startTabIndex.intValue() + 4), ControlState.HIDDEN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT ,"None at Present", Boolean.TRUE, null}));
				...
				super.addControl(factory.getControl(CheckBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1028), new Integer(anchoringHelper30.getX()), new Integer(anchoringHelper30.getY()), new Integer(anchoringHelper30.getWidth()), new Integer(anchoringHelper30.getHeight()), new Integer(startTabIndex.intValue() + 7), ControlState.HIDDEN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT ,"Enter HCP Details:", Boolean.TRUE, null}));
		...
		public static class tabPageServicesContainer extends LayerBridge
		{
			...
			public static class grpServiceFilterRadioButton extends RadioButtonBridge
			{
				...
				protected void setContext(Integer startTabIndex, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize)
				{
					...
					control.addButton(0, anchoringHelper32.getX(), anchoringHelper32.getY(), anchoringHelper32.getWidth(), "View Active", startTabIndex.intValue() + 24);
					...
					control.addButton(1, anchoringHelper33.getX(), anchoringHelper33.getY(), anchoringHelper33.getWidth(), "View All", startTabIndex.intValue() + 25);
				}
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1042), new Integer(anchoringHelper44.getX()), new Integer(anchoringHelper44.getY()), new Integer(anchoringHelper44.getWidth()), new Integer(anchoringHelper44.getHeight()), new Integer(startTabIndex.intValue() + 41), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Edit", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
				...
				super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1043), new Integer(anchoringHelper45.getX()), new Integer(anchoringHelper45.getY()), new Integer(anchoringHelper45.getWidth()), new Integer(anchoringHelper45.getHeight()), new Integer(startTabIndex.intValue() + 40), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "New", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
				...
				super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1044), new Integer(anchoringHelper46.getX()), new Integer(anchoringHelper46.getY()), new Integer(anchoringHelper46.getWidth()), new Integer(anchoringHelper46.getHeight()), new Integer(startTabIndex.intValue() + 44), ControlState.HIDDEN, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Cancel", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
				...
				super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1046), new Integer(anchoringHelper48.getX()), new Integer(anchoringHelper48.getY()), new Integer(anchoringHelper48.getWidth()), new Integer(anchoringHelper48.getHeight()), new Integer(startTabIndex.intValue() + 42), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Inactivate", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
				...
				super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1047), new Integer(anchoringHelper49.getX()), new Integer(anchoringHelper49.getY()), new Integer(anchoringHelper49.getWidth()), new Integer(anchoringHelper49.getHeight()), new Integer(startTabIndex.intValue() + 31), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT,Boolean.FALSE, new Integer(50), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
				...
				super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1048), new Integer(anchoringHelper50.getX()), new Integer(anchoringHelper50.getY()), new Integer(anchoringHelper50.getWidth()), new Integer(anchoringHelper50.getHeight()), new Integer(startTabIndex.intValue() + 33), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT,Boolean.FALSE, new Integer(100), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
				...
				super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1049), new Integer(anchoringHelper51.getX()), new Integer(anchoringHelper51.getY()), new Integer(anchoringHelper51.getWidth()), new Integer(anchoringHelper51.getHeight()), new Integer(startTabIndex.intValue() + 34), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT,Boolean.FALSE, new Integer(30), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
				...
				super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1050), new Integer(anchoringHelper52.getX()), new Integer(anchoringHelper52.getY()), new Integer(anchoringHelper52.getWidth()), new Integer(anchoringHelper52.getHeight()), new Integer(startTabIndex.intValue() + 29), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFTRIGHT,Boolean.FALSE, new Integer(255), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
				...
				super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1051), new Integer(anchoringHelper53.getX()), new Integer(anchoringHelper53.getY()), new Integer(anchoringHelper53.getWidth()), new Integer(anchoringHelper53.getHeight()), new Integer(startTabIndex.intValue() + 35), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFTRIGHT,Boolean.TRUE, new Integer(160), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
				...
				super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1052), new Integer(anchoringHelper54.getX()), new Integer(anchoringHelper54.getY()), new Integer(anchoringHelper54.getWidth()), new Integer(anchoringHelper54.getHeight()), new Integer(startTabIndex.intValue() + 36), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFTRIGHT,Boolean.TRUE, new Integer(255), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
				...
				ComboBox m_cmbServiceTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1053), new Integer(anchoringHelper55.getX()), new Integer(anchoringHelper55.getY()), new Integer(anchoringHelper55.getWidth()), new Integer(anchoringHelper55.getHeight()), new Integer(startTabIndex.intValue() + 28), ControlState.DISABLED, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT ,Boolean.TRUE, Boolean.TRUE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.TRUE, new Integer(-1)});
				...
				ComboBox m_cmbLocationServicesTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1054), new Integer(anchoringHelper56.getX()), new Integer(anchoringHelper56.getY()), new Integer(anchoringHelper56.getWidth()), new Integer(anchoringHelper56.getHeight()), new Integer(startTabIndex.intValue() + 32), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT ,Boolean.TRUE, Boolean.TRUE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
				...
				super.addControl(factory.getControl(CheckBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1055), new Integer(anchoringHelper57.getX()), new Integer(anchoringHelper57.getY()), new Integer(anchoringHelper57.getWidth()), new Integer(anchoringHelper57.getHeight()), new Integer(startTabIndex.intValue() + 27), ControlState.HIDDEN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT ,"None At Present", Boolean.TRUE, null}));
				...
				super.addControl(factory.getControl(CheckBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1056), new Integer(anchoringHelper58.getX()), new Integer(anchoringHelper58.getY()), new Integer(anchoringHelper58.getWidth()), new Integer(anchoringHelper58.getHeight()), new Integer(startTabIndex.intValue() + 30), ControlState.HIDDEN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT ,"Enter Service  Details:", Boolean.TRUE, null}));
		...
		public static class tabPageFamilyContainer extends LayerBridge
		{
			...
			public static class groupFamilyFilterRadioButton extends RadioButtonBridge
			{
				...
				protected void setContext(Integer startTabIndex, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize)
				{
					...
					control.addButton(0, anchoringHelper60.getX(), anchoringHelper60.getY(), anchoringHelper60.getWidth(), "View All", startTabIndex.intValue() + 46);
					...
					control.addButton(1, anchoringHelper61.getX(), anchoringHelper61.getY(), anchoringHelper61.getWidth(), "View Active", startTabIndex.intValue() + 45);
				}
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1074), new Integer(anchoringHelper76.getX()), new Integer(anchoringHelper76.getY()), new Integer(anchoringHelper76.getWidth()), new Integer(anchoringHelper76.getHeight()), new Integer(startTabIndex.intValue() + 66), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Edit", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
				...
				super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1075), new Integer(anchoringHelper77.getX()), new Integer(anchoringHelper77.getY()), new Integer(anchoringHelper77.getWidth()), new Integer(anchoringHelper77.getHeight()), new Integer(startTabIndex.intValue() + 65), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "New", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
				...
				super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1076), new Integer(anchoringHelper78.getX()), new Integer(anchoringHelper78.getY()), new Integer(anchoringHelper78.getWidth()), new Integer(anchoringHelper78.getHeight()), new Integer(startTabIndex.intValue() + 67), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Copy Patient Address", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
				...
				super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1077), new Integer(anchoringHelper79.getX()), new Integer(anchoringHelper79.getY()), new Integer(anchoringHelper79.getWidth()), new Integer(anchoringHelper79.getHeight()), new Integer(startTabIndex.intValue() + 68), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Reactivate", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
				...
				super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1080), new Integer(anchoringHelper82.getX()), new Integer(anchoringHelper82.getY()), new Integer(anchoringHelper82.getWidth()), new Integer(anchoringHelper82.getHeight()), new Integer(startTabIndex.intValue() + 71), ControlState.HIDDEN, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Cancel", Boolean.FALSE, null, Boolean.FALSE, Boolean.FALSE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
				...
				super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1081), new Integer(anchoringHelper83.getX()), new Integer(anchoringHelper83.getY()), new Integer(anchoringHelper83.getWidth()), new Integer(anchoringHelper83.getHeight()), new Integer(startTabIndex.intValue() + 59), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFTRIGHT,Boolean.FALSE, new Integer(50), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
				...
				super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1082), new Integer(anchoringHelper84.getX()), new Integer(anchoringHelper84.getY()), new Integer(anchoringHelper84.getWidth()), new Integer(anchoringHelper84.getHeight()), new Integer(startTabIndex.intValue() + 58), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFTRIGHT,Boolean.FALSE, new Integer(30), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
				...
				super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1084), new Integer(anchoringHelper86.getX()), new Integer(anchoringHelper86.getY()), new Integer(anchoringHelper86.getWidth()), new Integer(anchoringHelper86.getHeight()), new Integer(startTabIndex.intValue() + 57), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFTRIGHT,Boolean.FALSE, new Integer(30), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
				...
				super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1086), new Integer(anchoringHelper88.getX()), new Integer(anchoringHelper88.getY()), new Integer(anchoringHelper88.getWidth()), new Integer(anchoringHelper88.getHeight()), new Integer(startTabIndex.intValue() + 55), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFTRIGHT,Boolean.TRUE, new Integer(120), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
				...
				super.addControl(factory.getControl(DateTimeControl.class, new Object[] { control, new Integer(startControlID.intValue() + 1087), new Integer(anchoringHelper89.getX()), new Integer(anchoringHelper89.getY()), new Integer(anchoringHelper89.getWidth()), new Integer(anchoringHelper89.getHeight()), new Integer(startTabIndex.intValue() + 61), ControlState.DISABLED, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFTRIGHT,Boolean.TRUE, null, Boolean.FALSE, null, Boolean.FALSE, null}));
				...
				ComboBox m_cmbRecordingHCPTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1088), new Integer(anchoringHelper90.getX()), new Integer(anchoringHelper90.getY()), new Integer(anchoringHelper90.getWidth()), new Integer(anchoringHelper90.getHeight()), new Integer(startTabIndex.intValue() + 60), ControlState.DISABLED, ControlState.DISABLED,ims.framework.enumerations.ControlAnchoring.BOTTOMLEFTRIGHT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
				...
				super.addControl(factory.getControl(CheckBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1091), new Integer(anchoringHelper93.getX()), new Integer(anchoringHelper93.getY()), new Integer(anchoringHelper93.getWidth()), new Integer(anchoringHelper93.getHeight()), new Integer(startTabIndex.intValue() + 54), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT ,"Permission given to discuss issues with them ? ", Boolean.FALSE, null}));
				...
				super.addControl(factory.getControl(CheckBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1092), new Integer(anchoringHelper94.getX()), new Integer(anchoringHelper94.getY()), new Integer(anchoringHelper94.getWidth()), new Integer(anchoringHelper94.getHeight()), new Integer(startTabIndex.intValue() + 50), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT ,"Fit and Well ?", Boolean.FALSE, null}));
				...
				super.addControl(factory.getControl(CheckBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1093), new Integer(anchoringHelper95.getX()), new Integer(anchoringHelper95.getY()), new Integer(anchoringHelper95.getWidth()), new Integer(anchoringHelper95.getHeight()), new Integer(startTabIndex.intValue() + 51), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT ,"Aware of client's position ?", Boolean.FALSE, null}));
	...
	private class ReportFields
	{
		...
		{
			String prefix = formInfo.getLocalVariablesPrefix();
			IReportField[] fields = new IReportField[225];
			...
			fields[144] = new ims.framework.ReportField(this.context, "_cv_COE.SupportNetworkSelectedLocation", "BO-1007100007-ID", "ID_Location");
			fields[145] = new ims.framework.ReportField(this.context, "_cv_COE.SupportNetworkSelectedLocation", "BO-1007100007-NAME", "Name");
			fields[146] = new ims.framework.ReportField(this.context, "_cv_COE.SupportNetworkSelectedLocation", "BO-1007100007-ISACTIVE", "IsActive");
			fields[147] = new ims.framework.ReportField(this.context, "_cv_COE.SupportNetworkSelectedLocation", "BO-1007100007-ISVIRTUAL", "IsVirtual");
			fields[148] = new ims.framework.ReportField(this.context, "_cv_COE.SupportNetworkSelectedLocation", "BO-1007100007-TYPE", "Type");
			fields[149] = new ims.framework.ReportField(this.context, "_cv_COE.SupportNetworkSelectedLocation", "BO-1007100007-DISPLAYINEDTRACKING", "DisplayInEDTracking");
			fields[150] = new ims.framework.ReportField(this.context, "_cv_COE.SupportNetworkSelectedLocation", "BO-1007100007-CASENOTEFOLDERLOCATION", "CaseNoteFolderLocation");
			fields[151] = new ims.framework.ReportField(this.context, "_cv_COE.SupportNetworkSelectedLocation", "BO-1007100007-SECUREACCOMMODATION", "SecureAccommodation");
			fields[152] = new ims.framework.ReportField(this.context, "_cv_COE.SupportNetworkSelectedLocation", "BO-1007100007-TREATINGHOSP", "TreatingHosp");
			fields[153] = new ims.framework.ReportField(this.context, "_cv_COE.SupportNetworkSelectedLocation", "BO-1007100007-REFERRINGHOSPITAL", "ReferringHospital");
			fields[154] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.SupportServices.__internal_x_context__SelectedFamilyRecord_" + componentIdentifier, "BO-1003100005-ID", "ID_SupportNetworkFamily");
			fields[155] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.SupportServices.__internal_x_context__SelectedFamilyRecord_" + componentIdentifier, "BO-1003100005-CARERNAME", "CarerName");
			fields[156] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.SupportServices.__internal_x_context__SelectedFamilyRecord_" + componentIdentifier, "BO-1003100005-CARERRELATIONSHIP", "CarerRelationship");
			fields[157] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.SupportServices.__internal_x_context__SelectedFamilyRecord_" + componentIdentifier, "BO-1003100005-CARERADDRESS", "CarerAddress");
			fields[158] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.SupportServices.__internal_x_context__SelectedFamilyRecord_" + componentIdentifier, "BO-1003100005-CARERHOMEPHONE", "CarerHomePhone");
			fields[159] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.SupportServices.__internal_x_context__SelectedFamilyRecord_" + componentIdentifier, "BO-1003100005-CARERMOBILEPHONE", "CarerMobilePhone");
			fields[160] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.SupportServices.__internal_x_context__SelectedFamilyRecord_" + componentIdentifier, "BO-1003100005-CARERWORKPHONE", "CarerWorkPhone");
			fields[161] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.SupportServices.__internal_x_context__SelectedFamilyRecord_" + componentIdentifier, "BO-1003100005-CAREREMAIL", "CarerEmail");
			fields[162] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.SupportServices.__internal_x_context__SelectedFamilyRecord_" + componentIdentifier, "BO-1003100005-ISMAINCARER", "IsMainCarer");
			fields[163] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.SupportServices.__internal_x_context__SelectedFamilyRecord_" + componentIdentifier, "BO-1003100005-EMERGENCYCONTACTORDER", "EmergencyContactOrder");
			fields[164] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.SupportServices.__internal_x_context__SelectedFamilyRecord_" + componentIdentifier, "BO-1003100005-ISCURRENTLYACTIVEFAMILYSUPPORT", "IsCurrentlyActiveFamilySupport");
			fields[165] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.SupportServices.__internal_x_context__SelectedFamilyRecord_" + componentIdentifier, "BO-1003100005-DISCUSSPROGRESS", "DiscussProgress");
			fields[166] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.SupportServices.__internal_x_context__SelectedFamilyRecord_" + componentIdentifier, "BO-1003100005-PATIENT", "Patient");
			fields[167] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.SupportServices.__internal_x_context__SelectedFamilyRecord_" + componentIdentifier, "BO-1003100005-FITANDWELL", "FitAndWell");
			fields[168] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.SupportServices.__internal_x_context__SelectedFamilyRecord_" + componentIdentifier, "BO-1003100005-AWARECLIENTPOSITION", "AwareClientPosition");
			fields[169] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.SupportServices.__internal_x_context__SelectedFamilyRecord_" + componentIdentifier, "BO-1003100005-PERMISSIONTOCONTACT", "PermissionToContact");
			fields[170] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.SupportServices.__internal_x_context__SelectedFamilyRecord_" + componentIdentifier, "BO-1003100005-INACTIVATINGDATETIME", "InactivatingDateTime");
			fields[171] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.SupportServices.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1086100026-ID", "ID_DischargeServicesAndAdvice");
			fields[172] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.SupportServices.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1086100026-PATIENT", "Patient");
			fields[173] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.SupportServices.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1086100026-EPISODE", "Episode");
			fields[174] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.SupportServices.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1086100026-ATTENDANCE", "Attendance");
			fields[175] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.SupportServices.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1086100026-TRANSPORTARRANGEDTYPE", "TransportArrangedType");
			fields[176] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.SupportServices.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1086100026-TRANSPORTDATETIME", "TransportDateTime");
			fields[177] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.SupportServices.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1086100026-COMMENTS", "Comments");
			fields[178] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.SupportServices.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1086100026-BOOKINGNO", "BookingNo");
			fields[179] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.SupportServices.__internal_x_context__NextOfKin_" + componentIdentifier, "BO-1001100002-ID", "ID_Relative");
			fields[180] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.SupportServices.__internal_x_context__NextOfKin_" + componentIdentifier, "BO-1001100002-RELATIONSHIP", "Relationship");
			fields[181] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.SupportServices.__internal_x_context__NextOfKin_" + componentIdentifier, "BO-1001100002-PDSUPDATEMODE", "PdsUpdateMode");
			fields[182] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.SupportServices.__internal_x_context__NextOfKin_" + componentIdentifier, "BO-1001100002-OBJECTIDENTIFIER", "Objectidentifier");
			fields[183] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.SupportServices.__internal_x_context__NextOfKin_" + componentIdentifier, "BO-1001100002-ROLE", "Role");
			fields[184] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.SupportServices.__internal_x_context__NextOfKin_" + componentIdentifier, "BO-1001100002-NHSNUM", "NhsNum");
			fields[185] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.SupportServices.__internal_x_context__NextOfKin_" + componentIdentifier, "BO-1001100002-CONTACTRANK", "ContactRank");
			fields[186] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.SupportServices.__internal_x_context__NextOfKin_" + componentIdentifier, "BO-1001100002-NOKIND", "NokInd");
			fields[187] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.SupportServices.__internal_x_context__NextOfKin_" + componentIdentifier, "BO-1001100002-CPYCORRESP", "CpyCorresp");
			fields[188] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.SupportServices.__internal_x_context__NextOfKin_" + componentIdentifier, "BO-1001100002-CALLBCKCONS", "CallbckCons");
			fields[189] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.SupportServices.__internal_x_context__NextOfKin_" + componentIdentifier, "BO-1001100002-BEFFDATECNF", "Beffdatecnf");
			fields[190] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.SupportServices.__internal_x_context__NextOfKin_" + componentIdentifier, "BO-1001100002-BETDATECNF", "Betdatecnf");
			fields[191] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.SupportServices.__internal_x_context__NextOfKin_" + componentIdentifier, "BO-1001100002-BEFFDATE", "Beffdate");
			fields[192] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.SupportServices.__internal_x_context__NextOfKin_" + componentIdentifier, "BO-1001100002-BETDATE", "Betdate");
			fields[193] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.SupportServices.__internal_x_context__NextOfKin_" + componentIdentifier, "BO-1001100002-DOB", "Dob");
			fields[194] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.SupportServices.__internal_x_context__NextOfKin_" + componentIdentifier, "BO-1001100002-ACTIVE", "Active");
			fields[195] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.SupportServices.__internal_x_context__NextOfKin_" + componentIdentifier, "BO-1001100002-PDSLANGUAGE", "PDSlanguage");
			fields[196] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.SupportServices.__internal_x_context__NextOfKin_" + componentIdentifier, "BO-1001100002-PDSINTERPRETERREQUIRED", "PDSInterpreterRequired");
			fields[197] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.SupportServices.__internal_x_context__NextOfKin_" + componentIdentifier, "BO-1001100002-PENDING", "Pending");
			fields[198] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.SupportServices.__internal_x_context__NextOfKin_" + componentIdentifier, "BO-1001100002-ISCONFIDENTIAL", "IsConfidential");
			fields[199] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.SupportServices.__internal_x_context__NextOfKin_" + componentIdentifier, "BO-1001100001-TEMPFIELD", "TempField");
			fields[200] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.SupportServices.__internal_x_context__CareContextRef_" + componentIdentifier, "BO-1004100019-ID", "ID_CareContext");
			fields[201] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.SupportServices.__internal_x_context__EpisodeOfCareRef_" + componentIdentifier, "BO-1004100018-ID", "ID_EpisodeOfCare");
			fields[202] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.SupportServices.__internal_x_context__PatientRef_" + componentIdentifier, "BO-1001100000-ID", "ID_Patient");
			fields[203] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.SupportServices.__internal_x_context__SelectedSupportNetworkService_" + componentIdentifier, "BO-1003100011-ID", "ID_SupportNetworkServices");
			fields[204] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.SupportServices.__internal_x_context__SelectedSupportNetworkService_" + componentIdentifier, "BO-1003100011-FREQUENCYOFSERVICE", "FrequencyOfService");
			fields[205] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.SupportServices.__internal_x_context__SelectedSupportNetworkService_" + componentIdentifier, "BO-1003100011-COMMENTS", "Comments");
			fields[206] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.SupportServices.__internal_x_context__SelectedSupportNetworkService_" + componentIdentifier, "BO-1003100011-ISCURRENTLYACTIVE", "IsCurrentlyActive");
			fields[207] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.SupportServices.__internal_x_context__SelectedSupportNetworkProfessional_" + componentIdentifier, "BO-1003100006-ID", "ID_SupportNetworkProfessional");
			fields[208] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.SupportServices.__internal_x_context__SelectedSupportNetworkProfessional_" + componentIdentifier, "BO-1003100006-ISCURRACTIVEPROFSUPP", "IsCurrActiveProfSupp");
			fields[209] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.SupportServices.__internal_x_context__SelectedSupportNetworkProfessional_" + componentIdentifier, "BO-1003100006-ISADMISSIONHCP", "IsAdmissionHCP");
			fields[210] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.SupportServices.__internal_x_context__SelectedSupportNetworkProfessional_" + componentIdentifier, "BO-1003100006-HCPSUBTYPE", "HcpSubType");
			fields[211] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.SupportServices.__internal_x_context__SelectedSupportNetworkProfessional_" + componentIdentifier, "BO-1003100006-PROFESSION", "Profession");
			fields[212] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.SupportServices.__internal_x_context__PatientNoSupportNetworkServicesInfo_" + componentIdentifier, "BO-1003100087-ID", "ID_PatientNoSupportNetworkServicesInfo");
			fields[213] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.SupportServices.__internal_x_context__PatientNoSupportNetworkServicesInfo_" + componentIdentifier, "BO-1003100087-PATIENT", "Patient");
			fields[214] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.SupportServices.__internal_x_context__PatientNoSupportNetworkServicesInfo_" + componentIdentifier, "BO-1003100087-SUPPORTNETWORKSERVICESTATUS", "SupportNetworkServiceStatus");
			fields[215] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.SupportServices.__internal_x_context__PatientNoSupportNetworkStatusInfo_" + componentIdentifier, "BO-1003100086-ID", "ID_PatientNoSupportNetworkStatusInfo");
			fields[216] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.SupportServices.__internal_x_context__PatientNoSupportNetworkStatusInfo_" + componentIdentifier, "BO-1003100086-PATIENT", "Patient");
			fields[217] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.SupportServices.__internal_x_context__PatientNoSupportNetworkStatusInfo_" + componentIdentifier, "BO-1003100086-SUPPORTNETWORKSTATUS", "SupportNetworkStatus");
			fields[218] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.SupportServices.__internal_x_context__voMemberOfStaffShort_" + componentIdentifier, "BO-1006100006-ID", "ID_MemberOfStaff");
			fields[219] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.SupportServices.__internal_x_context__voMemberOfStaffShort_" + componentIdentifier, "BO-1006100006-INITIALS", "Initials");
			fields[220] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.SupportServices.__internal_x_context__voMemberOfStaffShort_" + componentIdentifier, "BO-1006100006-SIGNATUREBLOCK", "SignatureBlock");
			fields[221] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.SupportServices.__internal_x_context__voMemberOfStaffShort_" + componentIdentifier, "BO-1006100006-STAFFTYPE", "StaffType");
			fields[222] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.SupportServices.__internal_x_context__voMemberOfStaffShort_" + componentIdentifier, "BO-1006100006-ISACTIVE", "IsActive");
			fields[223] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.SupportServices.__internal_x_context__voMemberOfStaffShort_" + componentIdentifier, "BO-1006100006-SDSROLEID", "SdsRoleId");
			fields[224] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.SupportServices.__internal_x_context__voMemberOfStaffShort_" + componentIdentifier, "BO-1006100006-CANREFERPATIENT", "CanReferPatient");
			return fields;
		}
