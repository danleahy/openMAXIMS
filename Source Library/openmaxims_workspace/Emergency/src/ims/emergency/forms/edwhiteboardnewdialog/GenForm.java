...
public class GenForm extends FormBridge
{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		ims.framework.utils.SizeInfo designSize = new ims.framework.utils.SizeInfo(1200, 792);
		if(runtimeSize == null)
		...
		// Timers
		timers = new Timers();
		timers.timerRefresh = factory.createTimer(0, 60, false);
		form.addTimer(timers.timerRefresh);


		// Label Controls
		RuntimeAnchoring anchoringHelper1 = new RuntimeAnchoring(designSize, runtimeSize, 256, 10, 97, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1000), new Integer(anchoringHelper1.getX()), new Integer(anchoringHelper1.getY()), new Integer(anchoringHelper1.getWidth()), new Integer(anchoringHelper1.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Tracking Status:", new Integer(1), null, new Integer(0)}));
		RuntimeAnchoring anchoringHelper2 = new RuntimeAnchoring(designSize, runtimeSize, 8, 10, 40, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1001), new Integer(anchoringHelper2.getX()), new Integer(anchoringHelper2.getY()), new Integer(anchoringHelper2.getWidth()), new Integer(anchoringHelper2.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Areas:", new Integer(1), null, new Integer(0)}));

		// Button Controls
		RuntimeAnchoring anchoringHelper3 = new RuntimeAnchoring(designSize, runtimeSize, 1118, 764, 75, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT);
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1002), new Integer(anchoringHelper3.getX()), new Integer(anchoringHelper3.getY()), new Integer(anchoringHelper3.getWidth()), new Integer(anchoringHelper3.getHeight()), new Integer(startTabIndex.intValue() + 6), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Close", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		RuntimeAnchoring anchoringHelper4 = new RuntimeAnchoring(designSize, runtimeSize, 912, 7, 136, 23, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1003), new Integer(anchoringHelper4.getX()), new Integer(anchoringHelper4.getY()), new Integer(anchoringHelper4.getWidth()), new Integer(anchoringHelper4.getHeight()), new Integer(startTabIndex.intValue() + 3), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT, "Edit All", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		RuntimeAnchoring anchoringHelper5 = new RuntimeAnchoring(designSize, runtimeSize, 1057, 7, 136, 23, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1004), new Integer(anchoringHelper5.getX()), new Integer(anchoringHelper5.getY()), new Integer(anchoringHelper5.getWidth()), new Integer(anchoringHelper5.getHeight()), new Integer(startTabIndex.intValue() + 4), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT, "Public Area", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));

		// ComboBox Controls
		RuntimeAnchoring anchoringHelper6 = new RuntimeAnchoring(designSize, runtimeSize, 352, 8, 264, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		RuntimeAnchoring anchoringHelper7 = new RuntimeAnchoring(designSize, runtimeSize, 48, 8, 176, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		RuntimeAnchoring anchoringHelper8 = new RuntimeAnchoring(designSize, runtimeSize, 8, 40, 1185, 720, ims.framework.enumerations.ControlAnchoring.ALL);
		super.addControl(factory.getControl(DynamicGrid.class, new Object[] { control, new Integer(startControlID.intValue() + 1007), new Integer(anchoringHelper8.getX()), new Integer(anchoringHelper8.getY()), new Integer(anchoringHelper8.getWidth()), new Integer(anchoringHelper8.getHeight()), new Integer(startTabIndex.intValue() + 5), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, null, Boolean.FALSE, Boolean.FALSE, Boolean.TRUE}));
	}
	...
	public class LocalContext extends ContextBridge
	{
		...
		public LocalContext(Context context, ims.framework.FormInfo formInfo, String componentIdentifier)
		{
			...
			cxl_PatientImagesList = new ims.framework.ContextVariable("PatientImagesList", prefix + "_lv_Emergency.EDWhiteBoardNewDialog.__internal_x_context__PatientImagesList_" + componentIdentifier + "");
			cxl_SelectedComboValue = new ims.framework.ContextVariable("SelectedComboValue", prefix + "_lv_Emergency.EDWhiteBoardNewDialog.__internal_x_context__SelectedComboValue_" + componentIdentifier + "");
			cxl_SelectedEvent = new ims.framework.ContextVariable("SelectedEvent", prefix + "_lv_Emergency.EDWhiteBoardNewDialog.__internal_x_context__SelectedEvent_" + componentIdentifier + "");
			cxl_CurrentPatientWhiteboard = new ims.framework.ContextVariable("CurrentPatientWhiteboard", prefix + "_lv_Emergency.EDWhiteBoardNewDialog.__internal_x_context__CurrentPatientWhiteboard_" + componentIdentifier + "");
			cxl_SelectedArea = new ims.framework.ContextVariable("SelectedArea", prefix + "_lv_Emergency.EDWhiteBoardNewDialog.__internal_x_context__SelectedArea_" + componentIdentifier + "");
			cxl_PublicArea = new ims.framework.ContextVariable("PublicArea", prefix + "_lv_Emergency.EDWhiteBoardNewDialog.__internal_x_context__PublicArea_" + componentIdentifier + "");
		}
		...
		public boolean getCurrentPatientWhiteboardIsNotNull()
		{
			return !cxl_CurrentPatientWhiteboard.getValueIsNull(context);
		}
		public ims.emergency.vo.PatientWhiteboardRecordVo getCurrentPatientWhiteboard()
		{
			return (ims.emergency.vo.PatientWhiteboardRecordVo)cxl_CurrentPatientWhiteboard.getValue(context);
		}
		public void setCurrentPatientWhiteboard(ims.emergency.vo.PatientWhiteboardRecordVo value)
		{
			cxl_CurrentPatientWhiteboard.setValue(context, value);
		}
		private ims.framework.ContextVariable cxl_CurrentPatientWhiteboard = null;
		...
		public boolean getPublicAreaIsNotNull()
		{
			return !cxl_PublicArea.getValueIsNull(context);
		}
		public Boolean getPublicArea()
		{
			return (Boolean)cxl_PublicArea.getValue(context);
		}
		public void setPublicArea(Boolean value)
		{
			cxl_PublicArea.setValue(context, value);
		}
		private ims.framework.ContextVariable cxl_PublicArea = null;
	}
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.EDWhiteBoardNewDialog.__internal_x_context__CurrentPatientWhiteboard_" + componentIdentifier, "BO-1086100045-ID", "ID_PatientWhiteboardRecord");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.EDWhiteBoardNewDialog.__internal_x_context__CurrentPatientWhiteboard_" + componentIdentifier, "BO-1086100045-PATIENT", "Patient");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.EDWhiteBoardNewDialog.__internal_x_context__CurrentPatientWhiteboard_" + componentIdentifier, "BO-1086100045-EPISODE", "Episode");
			fields[152] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.EDWhiteBoardNewDialog.__internal_x_context__CurrentPatientWhiteboard_" + componentIdentifier, "BO-1086100045-ATTENDANCE", "Attendance");
			fields[153] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.EDWhiteBoardNewDialog.__internal_x_context__SelectedArea_" + componentIdentifier, "BO-1087100001-ID", "ID_TrackingArea");
			fields[154] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.EDWhiteBoardNewDialog.__internal_x_context__SelectedArea_" + componentIdentifier, "BO-1087100001-EDLOCATION", "EDLocation");
			fields[155] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.EDWhiteBoardNewDialog.__internal_x_context__SelectedArea_" + componentIdentifier, "BO-1087100001-AREANAMEDESCRIPTION", "AreaNameDescription");
			fields[156] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.EDWhiteBoardNewDialog.__internal_x_context__SelectedArea_" + componentIdentifier, "BO-1087100001-AREADISPLAYNAME", "AreaDisplayName");
			fields[157] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.EDWhiteBoardNewDialog.__internal_x_context__SelectedArea_" + componentIdentifier, "BO-1087100001-STATUS", "Status");
			fields[158] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.EDWhiteBoardNewDialog.__internal_x_context__SelectedArea_" + componentIdentifier, "BO-1087100001-ISOVERALLVIEW", "IsOverallView");
			fields[159] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.EDWhiteBoardNewDialog.__internal_x_context__SelectedArea_" + componentIdentifier, "BO-1087100001-ISREGISTRATIONAREA", "IsRegistrationArea");
			return fields;
		}
