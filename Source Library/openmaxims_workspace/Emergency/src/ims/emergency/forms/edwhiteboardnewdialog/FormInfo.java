...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Emergency.WhiteBoardConfig", "_cv_Emergency.Tracking" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Emergency.EDWhiteBoardNewDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
