...
public class Logic extends BaseLogic
{
	...
	{
		EmergencyEpisodeTIIGVo record = populateDataFromScreen(form.getGlobalContext().Emergency.getTIIG());
	...
	private EmergencyEpisodeTIIGVo populateDataFromScreen(EmergencyEpisodeTIIGVo record)
	{
		if(	record == null)
			record = new EmergencyEpisodeTIIGVo();
	...
	private void populateScreenFromDate(EmergencyEpisodeTIIGVo episodeVo)
	{
		clear();
		if( episodeVo == null)
			return;
