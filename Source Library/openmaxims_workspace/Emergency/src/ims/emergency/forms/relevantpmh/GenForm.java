...
public class GenForm extends FormBridge
{
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.RelevantPMH.__internal_x_context__CurrentCareContextRef_" + componentIdentifier, "BO-1004100019-ID", "ID_CareContext");
			fields[145] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.RelevantPMH.__internal_x_context__SelectedPatientRef_" + componentIdentifier, "BO-1001100000-ID", "ID_Patient");
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.RelevantPMH.__internal_x_context__SelectedRelevantPMH_" + componentIdentifier, "BO-1086100017-ID", "ID_PatientRelevantPMH");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.RelevantPMH.__internal_x_context__SelectedRelevantPMH_" + componentIdentifier, "BO-1086100017-PATIENT", "Patient");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.RelevantPMH.__internal_x_context__SelectedRelevantPMH_" + componentIdentifier, "BO-1086100017-EPISODE", "Episode");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.RelevantPMH.__internal_x_context__SelectedRelevantPMH_" + componentIdentifier, "BO-1086100017-ATTENDANCE", "Attendance");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.RelevantPMH.__internal_x_context__SelectedRelevantPMH_" + componentIdentifier, "BO-1086100017-RELEVANTPMH", "RelevantPMH");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.RelevantPMH.__internal_x_context__CurrentPatientEpisode_" + componentIdentifier, "BO-1004100018-ID", "ID_EpisodeOfCare");
			return fields;
		}
