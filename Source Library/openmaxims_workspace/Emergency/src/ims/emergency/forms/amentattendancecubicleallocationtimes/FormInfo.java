...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "AmentAttendanceCubicleAllocationTimes";
	}
	public int getWidth()
	{
		return 464;
	...
	{
		return new String[] { "_cv_Emergency.AmendAttendanceCubicleAllocationTimes", "_cv_Emergency.EmergencyAttendanceForTimeAmendments" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Emergency.AmentAttendanceCubicleAllocationTimes.__internal_x_context__" + String.valueOf(getFormId());
	}
