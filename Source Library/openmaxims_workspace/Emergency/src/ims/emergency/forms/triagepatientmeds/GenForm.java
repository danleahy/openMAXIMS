...
public class GenForm extends FormBridge
{
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.TriagePatientMeds.__internal_x_context__selectedCareContext_" + componentIdentifier, "BO-1004100019-ID", "ID_CareContext");
			fields[145] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.TriagePatientMeds.__internal_x_context__CareContextRef_" + componentIdentifier, "BO-1004100019-ID", "ID_CareContext");
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.TriagePatientMeds.__internal_x_context__EpisodeOfCareRef_" + componentIdentifier, "BO-1004100018-ID", "ID_EpisodeOfCare");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.TriagePatientMeds.__internal_x_context__PatientRef_" + componentIdentifier, "BO-1001100000-ID", "ID_Patient");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.TriagePatientMeds.__internal_x_context__selectedPatientMeds_" + componentIdentifier, "BO-1086100016-ID", "ID_PatientMedicationOnAttendance");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.TriagePatientMeds.__internal_x_context__selectedPatientMeds_" + componentIdentifier, "BO-1086100016-PATIENT", "Patient");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.TriagePatientMeds.__internal_x_context__selectedPatientMeds_" + componentIdentifier, "BO-1086100016-EPISODE", "Episode");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.TriagePatientMeds.__internal_x_context__selectedPatientMeds_" + componentIdentifier, "BO-1086100016-ATTENDANCE", "Attendance");
			fields[152] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.TriagePatientMeds.__internal_x_context__selectedPatientMeds_" + componentIdentifier, "BO-1086100016-CURRENTMEDICATIONDETAILS", "CurrentMedicationDetails");
			fields[153] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.TriagePatientMeds.__internal_x_context__selectedPatientMeds_" + componentIdentifier, "BO-1086100016-MEDICATIONDETAILSFROMGP", "MedicationDetailsFromGP");
			fields[154] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.TriagePatientMeds.__internal_x_context__TrackingForClinicianWorklistAndTriage_" + componentIdentifier, "BO-1086100005-ID", "ID_Tracking");
			fields[155] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.TriagePatientMeds.__internal_x_context__TrackingForClinicianWorklistAndTriage_" + componentIdentifier, "BO-1086100005-ISDISCHARGED", "IsDischarged");
			return fields;
		}
