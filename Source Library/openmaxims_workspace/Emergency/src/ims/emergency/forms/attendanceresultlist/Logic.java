...
import ims.emergency.vo.AttendanceResultListSearchCriteriaVo;
...
public class Logic extends BaseLogic
{
	...
	protected void onFormOpen(Object[] args) throws PresentationLogicException
	{
		...
		//WDEV-19389 
		if (!(form.getGlobalContext().Core.getPatientShortIsNotNull() && form.getGlobalContext().Emergency.getAttendanceResultListSearchCriteriaIsNotNull() && form.getGlobalContext().Emergency.getAttendanceResultListSearchCriteria().getPatientIsNotNull() && form.getGlobalContext().Core.getPatientShort().equals(form.getGlobalContext().Emergency.getAttendanceResultListSearchCriteria().getPatient())))
			form.getGlobalContext().Emergency.setAttendanceResultListSearchCriteria(null);
		
		if(form.getGlobalContext().Emergency.getAttendanceResultListSearchCriteriaIsNotNull())
		{
			setSearchCriteria(form.getGlobalContext().Emergency.getAttendanceResultListSearchCriteria());
		}
		//WDEV-19389 - end
		search();
	}
	
	private AttendanceResultListSearchCriteriaVo getSearchCriteria()
	{
		AttendanceResultListSearchCriteriaVo searchCriteria = new AttendanceResultListSearchCriteriaVo();
	...
	private void setSearchCriteria(AttendanceResultListSearchCriteriaVo attendanceResultListSearchCriteriaVo)
	{
		form.dteFrom().setValue(attendanceResultListSearchCriteriaVo.getStartDate());
		form.dteTo().setValue(attendanceResultListSearchCriteriaVo.getEndDate());
	}
	...
	{
		if(search())
			form.getGlobalContext().Emergency.setAttendanceResultListSearchCriteria(getSearchCriteria());//WDEV-19389 
	}
	...
	public void clear()
	{
		...
		form.getGlobalContext().Emergency.setAttendanceResultListSearchCriteria(null);//WDEV-19389
