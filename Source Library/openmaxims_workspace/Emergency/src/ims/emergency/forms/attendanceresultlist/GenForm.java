...
public class GenForm extends FormBridge
{
	...
	private void validateContext(ims.framework.Context context)
	{
		...
		if(!context.isValidContextType(ims.emergency.vo.AttendanceResultListSearchCriteriaVo.class))
			throw new ims.framework.exceptions.CodingRuntimeException("The type 'ims.emergency.vo.AttendanceResultListSearchCriteriaVo' of the global context variable 'Emergency.AttendanceResultListSearchCriteria' is not supported.");
