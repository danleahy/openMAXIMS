...
public class GenForm extends FormBridge
{
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.PresentingProblemsAndInterventions.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1086100007-ID", "ID_PresProblemsProceduresPerformed");
			fields[145] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.PresentingProblemsAndInterventions.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1086100007-CARECONTEXT", "CareContext");
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.PresentingProblemsAndInterventions.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1086100007-HISTORYPRESENTINGPROBLEM", "HistoryPresentingProblem");
			return fields;
		}
