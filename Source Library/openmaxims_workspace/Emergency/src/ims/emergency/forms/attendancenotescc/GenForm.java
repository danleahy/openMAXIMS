...
public class GenForm extends FormBridge
{
	...
	public static class cmbAttendanceComboBox extends ComboBoxBridge
	{
		...
		public boolean removeRow(ims.core.admin.vo.CareContextRefVo value)
		{
	...
	public static class GroupRadioFilterRadioButton extends RadioButtonBridge
	{
		...
		protected void setContext(Integer startTabIndex, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize)
		{
			...
			RuntimeAnchoring anchoringHelper1 = new RuntimeAnchoring(designSize, runtimeSize, 16, 388, 80, 16, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT);
			...
			RuntimeAnchoring anchoringHelper2 = new RuntimeAnchoring(designSize, runtimeSize, 112, 388, 80, 16, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT);
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		contextMenus.Emergency.contextMenuAttendanceClinicalNoteMenuNEW_HPC_NOTEItem = factory.createMenuItem(startControlID.intValue() + 2, "New HPC Note", true, false, new Integer(102179), true, false);
		if(factory.getUIEngine().getLoggedInRole().hasMenuActionRight(appForm, new ims.framework.MenuAction(5050004)))
			contextMenus.Emergency.contextMenuAttendanceClinicalNoteMenu.add(contextMenus.Emergency.contextMenuAttendanceClinicalNoteMenuNEW_HPC_NOTEItem);
		contextMenus.Emergency.contextMenuAttendanceClinicalNoteMenuEDITItem = factory.createMenuItem(startControlID.intValue() + 3, "Correct", true, false, new Integer(102150), true, false);
		...
		contextMenus.Emergency.contextMenuAttendanceClinicalNoteMenuRIEItem = factory.createMenuItem(startControlID.intValue() + 4, "RIE", true, false, new Integer(102142), true, false);
		...
		ims.framework.FormUiLogic m_ccInterventionDiagnosisInvestigationsForm = loader.loadComponent(129196, appForm, startControlID * 10 + 1000, anchoringHelper4.getSize(), instance1, startTabIndex.intValue() + 14, skipContextValidation);
		//ims.framework.Control m_ccInterventionDiagnosisInvestigationsControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1001), new Integer(544), new Integer(0), new Integer(280), new Integer(528), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPBOTTOMRIGHT, new Integer(startTabIndex.intValue() + 14), m_ccInterventionDiagnosisInvestigationsForm, instance1 } );
		ims.framework.Control m_ccInterventionDiagnosisInvestigationsControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1002),  new Integer(anchoringHelper4.getX()), new Integer(anchoringHelper4.getY()), new Integer(anchoringHelper4.getWidth()), new Integer(anchoringHelper4.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPBOTTOMRIGHT, new Integer(startTabIndex.intValue() + 14), m_ccInterventionDiagnosisInvestigationsForm, instance1, Boolean.FALSE } );
		...
		// Label Controls
		RuntimeAnchoring anchoringHelper5 = new RuntimeAnchoring(designSize, runtimeSize, 16, 414, 73, 17, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT);
		...
		RuntimeAnchoring anchoringHelper6 = new RuntimeAnchoring(designSize, runtimeSize, 16, 446, 66, 17, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT);
		...
		RuntimeAnchoring anchoringHelper7 = new RuntimeAnchoring(designSize, runtimeSize, 256, 414, 63, 17, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT);
		...
		RuntimeAnchoring anchoringHelper8 = new RuntimeAnchoring(designSize, runtimeSize, 256, 446, 60, 17, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT);
		...
		// Button Controls
		RuntimeAnchoring anchoringHelper9 = new RuntimeAnchoring(designSize, runtimeSize, 88, 482, 88, 40, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT);
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1007), new Integer(anchoringHelper9.getX()), new Integer(anchoringHelper9.getY()), new Integer(anchoringHelper9.getWidth()), new Integer(anchoringHelper9.getHeight()), new Integer(startTabIndex.intValue() + 11), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "New HPC Note", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		RuntimeAnchoring anchoringHelper10 = new RuntimeAnchoring(designSize, runtimeSize, 260, 482, 76, 40, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT);
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1008), new Integer(anchoringHelper10.getX()), new Integer(anchoringHelper10.getY()), new Integer(anchoringHelper10.getWidth()), new Integer(anchoringHelper10.getHeight()), new Integer(startTabIndex.intValue() + 13), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "RIE", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		RuntimeAnchoring anchoringHelper11 = new RuntimeAnchoring(designSize, runtimeSize, 180, 482, 76, 40, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT);
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1009), new Integer(anchoringHelper11.getX()), new Integer(anchoringHelper11.getY()), new Integer(anchoringHelper11.getWidth()), new Integer(anchoringHelper11.getHeight()), new Integer(startTabIndex.intValue() + 12), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Correct Note", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		RuntimeAnchoring anchoringHelper12 = new RuntimeAnchoring(designSize, runtimeSize, 8, 482, 76, 40, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT);
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1010), new Integer(anchoringHelper12.getX()), new Integer(anchoringHelper12.getY()), new Integer(anchoringHelper12.getWidth()), new Integer(anchoringHelper12.getHeight()), new Integer(startTabIndex.intValue() + 10), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "New Note", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));

		// ComboBox Controls
		RuntimeAnchoring anchoringHelper13 = new RuntimeAnchoring(designSize, runtimeSize, 88, 412, 158, 21, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFTRIGHT);
		...
		RuntimeAnchoring anchoringHelper14 = new RuntimeAnchoring(designSize, runtimeSize, 88, 444, 158, 21, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFTRIGHT);
		...
		RuntimeAnchoring anchoringHelper15 = new RuntimeAnchoring(designSize, runtimeSize, 320, 412, 144, 21, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT);
		ComboBox m_cmbDisciplineTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1013), new Integer(anchoringHelper15.getX()), new Integer(anchoringHelper15.getY()), new Integer(anchoringHelper15.getWidth()), new Integer(anchoringHelper15.getHeight()), new Integer(startTabIndex.intValue() + 6), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
		...
		RuntimeAnchoring anchoringHelper16 = new RuntimeAnchoring(designSize, runtimeSize, 320, 444, 144, 21, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT);
		ComboBox m_cmbSpecialtyTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1014), new Integer(anchoringHelper16.getX()), new Integer(anchoringHelper16.getY()), new Integer(anchoringHelper16.getWidth()), new Integer(anchoringHelper16.getHeight()), new Integer(startTabIndex.intValue() + 7), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
		...
		// Grid Controls
		RuntimeAnchoring anchoringHelper17 = new RuntimeAnchoring(designSize, runtimeSize, 8, 6, 536, 346, ims.framework.enumerations.ControlAnchoring.ALL);
		Grid m_grdNotesTemp = (Grid)factory.getControl(Grid.class, new Object[] { control, new Integer(startControlID.intValue() + 1015), new Integer(anchoringHelper17.getX()), new Integer(anchoringHelper17.getY()), new Integer(anchoringHelper17.getWidth()), new Integer(anchoringHelper17.getHeight()), new Integer(startTabIndex.intValue() + 1), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL,Boolean.TRUE, Boolean.FALSE, new Integer(24), Boolean.TRUE, contextMenus.Emergency.contextMenuAttendanceClinicalNoteMenu, Boolean.FALSE, Boolean.FALSE, new Integer(0), null, Boolean.FALSE, Boolean.TRUE});
		...
		grdNotes.addHtmlColumn("Authoring HCP / Date Time", 0, 0, 200, true, false, 0, true);
		grdNotes.addHtmlColumn("Note Type", 0, 0, 150, true, false, 1, true);
		grdNotes.addHtmlColumn("Notes", 0, 0, -1, true, false, 0, true);
		super.addGrid(grdNotes);

		// Image Buttons Controls
		RuntimeAnchoring anchoringHelper18 = new RuntimeAnchoring(designSize, runtimeSize, 504, 407, 30, 30, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT);
		super.addControl(factory.getControl(ImageButton.class, new Object[] { control, new Integer(startControlID.intValue() + 1016), new Integer(anchoringHelper18.getX()), new Integer(anchoringHelper18.getY()), new Integer(anchoringHelper18.getWidth()), new Integer(anchoringHelper18.getHeight()), new Integer(startTabIndex.intValue() + 9), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, this.getImages().Core.ClearEnabled24, this.getImages().Core.ClearDisabled24, "Reset search criteria and results", Boolean.FALSE, Boolean.FALSE, Boolean.FALSE, Boolean.FALSE, null}));
		RuntimeAnchoring anchoringHelper19 = new RuntimeAnchoring(designSize, runtimeSize, 472, 407, 30, 30, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT);
		super.addControl(factory.getControl(ImageButton.class, new Object[] { control, new Integer(startControlID.intValue() + 1017), new Integer(anchoringHelper19.getX()), new Integer(anchoringHelper19.getY()), new Integer(anchoringHelper19.getWidth()), new Integer(anchoringHelper19.getHeight()), new Integer(startTabIndex.intValue() + 8), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, this.getImages().Core.FindEnabled24, this.getImages().Core.FindDisabled24, "Search for notes matching 'Search Criteria'", Boolean.FALSE, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null}));

		// RadioButton Controls
		RadioButton tmpGroupRadioFilter = (RadioButton)factory.getControl(RadioButton.class, new Object[] { control, new Integer(startControlID.intValue() + 1018), new Integer(0), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT,Boolean.FALSE});
	...
	public final class ContextMenus implements java.io.Serializable
	{
		...
		public final class EmergencyNamespace implements java.io.Serializable
		{
			...
			public final class AttendanceClinicalNoteMenu implements java.io.Serializable
			{
				...
				public static final int NEW_HPC_NOTE = 2;
			...
			public void disableAllAttendanceClinicalNoteMenuMenuItems()
			{
				...
				this.contextMenuAttendanceClinicalNoteMenuNEW_HPC_NOTEItem.setEnabled(false);
			...
			public void hideAllAttendanceClinicalNoteMenuMenuItems()
			{
				...
				this.contextMenuAttendanceClinicalNoteMenuNEW_HPC_NOTEItem.setVisible(false);
			...
			public ReadOnlyMenuItem getAttendanceClinicalNoteMenuNEW_HPC_NOTEItem()
			{
				return this.contextMenuAttendanceClinicalNoteMenuNEW_HPC_NOTEItem;
			}
			private MenuItem contextMenuAttendanceClinicalNoteMenuNEW_HPC_NOTEItem;
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, "_cv_Emergency.InterventionsTreatmentsForAttendence", "BO-1086100012-ID", "ID_InterventionsTreatmentsForAttendence");
			fields[145] = new ims.framework.ReportField(this.context, "_cv_Emergency.InterventionsTreatmentsForAttendence", "BO-1086100012-PATIENT", "Patient");
			fields[146] = new ims.framework.ReportField(this.context, "_cv_Emergency.InterventionsTreatmentsForAttendence", "BO-1086100012-EPISODE", "Episode");
			fields[147] = new ims.framework.ReportField(this.context, "_cv_Emergency.InterventionsTreatmentsForAttendence", "BO-1086100012-ATTENDANCE", "Attendance");
			fields[148] = new ims.framework.ReportField(this.context, "_cv_Emergency.AttendanceClinicalNotes", "BO-1086100035-ID", "ID_AttendanceClinicalNotes");
			fields[149] = new ims.framework.ReportField(this.context, "_cv_Emergency.AttendanceClinicalNotes", "BO-1086100035-PATIENT", "Patient");
			fields[150] = new ims.framework.ReportField(this.context, "_cv_Emergency.AttendanceClinicalNotes", "BO-1086100035-EPISODE", "Episode");
			fields[151] = new ims.framework.ReportField(this.context, "_cv_Emergency.AttendanceClinicalNotes", "BO-1086100035-ATTENDANCE", "Attendance");
			fields[152] = new ims.framework.ReportField(this.context, "_cv_Emergency.AttendanceClinicalNotes", "BO-1086100035-CLINICALNOTE", "ClinicalNote");
			fields[153] = new ims.framework.ReportField(this.context, "_cv_Emergency.AttendanceClinicalNotes", "BO-1086100035-NOTETYPE", "NoteType");
			fields[154] = new ims.framework.ReportField(this.context, "_cv_Emergency.AttendanceClinicalNotes", "BO-1086100035-DISCIPLINE", "Discipline");
			fields[155] = new ims.framework.ReportField(this.context, "_cv_Emergency.AttendanceClinicalNotes", "BO-1086100035-SPECIALTY", "Specialty");
			fields[156] = new ims.framework.ReportField(this.context, "_cv_Emergency.AttendanceClinicalNotes", "BO-1086100035-ISCORRECTED", "IsCorrected");
			fields[157] = new ims.framework.ReportField(this.context, "_cv_Emergency.AttendanceClinicalNotes", "BO-1086100035-CORRECTIONCOMMENTS", "CorrectionComments");
			fields[158] = new ims.framework.ReportField(this.context, "_cv_Emergency.InvestigationsForAttend", "BO-1086100057-ID", "ID_InvestigationsForAttend");
			fields[159] = new ims.framework.ReportField(this.context, "_cv_Emergency.InvestigationsForAttend", "BO-1086100057-PATIENT", "Patient");
			fields[160] = new ims.framework.ReportField(this.context, "_cv_Emergency.InvestigationsForAttend", "BO-1086100057-EPISODE", "Episode");
			fields[161] = new ims.framework.ReportField(this.context, "_cv_Emergency.InvestigationsForAttend", "BO-1086100057-ATTENDANCE", "Attendance");
			fields[162] = new ims.framework.ReportField(this.context, "_cv_Core.PatientDiagnosisAtConsultation", "BO-1003100016-ID", "ID_PatientDiagnosis");
			fields[163] = new ims.framework.ReportField(this.context, "_cv_Core.PatientDiagnosisAtConsultation", "BO-1003100016-SPECIALTY", "Specialty");
			fields[164] = new ims.framework.ReportField(this.context, "_cv_Core.PatientDiagnosisAtConsultation", "BO-1003100016-DIAGNOSISDESCRIPTION", "DiagnosisDescription");
			fields[165] = new ims.framework.ReportField(this.context, "_cv_Core.PatientDiagnosisAtConsultation", "BO-1003100016-DIAGNOSEDDATE", "DiagnosedDate");
			fields[166] = new ims.framework.ReportField(this.context, "_cv_Core.PatientDiagnosisAtConsultation", "BO-1003100016-SOURCEOFINFORMATION", "SourceofInformation");
			fields[167] = new ims.framework.ReportField(this.context, "_cv_Core.PatientDiagnosisAtConsultation", "BO-1003100016-CARECONTEXT", "CareContext");
			fields[168] = new ims.framework.ReportField(this.context, "_cv_Core.PatientDiagnosisAtConsultation", "BO-1003100016-EPISODEOFCARE", "EpisodeOfCare");
			fields[169] = new ims.framework.ReportField(this.context, "_cv_Core.PatientDiagnosisAtConsultation", "BO-1003100016-ADDEDDURINGCODING", "AddedDuringCoding");
			fields[170] = new ims.framework.ReportField(this.context, "_cv_Core.PatientDiagnosisAtConsultation", "BO-1003100016-CODINGSEQUENCE", "CodingSequence");
			fields[171] = new ims.framework.ReportField(this.context, "_cv_Core.PatientDiagnosisAtConsultation", "BO-1003100016-DIAGLATERALITY", "DiagLaterality");
			fields[172] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.AttendanceNotesCc.__internal_x_context__Patient_" + componentIdentifier, "BO-1001100000-ID", "ID_Patient");
			fields[173] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.AttendanceNotesCc.__internal_x_context__EpisodeOfCare_" + componentIdentifier, "BO-1004100018-ID", "ID_EpisodeOfCare");
			fields[174] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.AttendanceNotesCc.__internal_x_context__CareContext_" + componentIdentifier, "BO-1004100019-ID", "ID_CareContext");
			fields[175] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.AttendanceNotesCc.__internal_x_context__PresentingProblem_" + componentIdentifier, "BO-1073100005-ID", "ID_ClinicalProblem");
			fields[176] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.AttendanceNotesCc.__internal_x_context__LoggedHCP_" + componentIdentifier, "BO-1006100000-ID", "ID_Hcp");
			return fields;
		}
