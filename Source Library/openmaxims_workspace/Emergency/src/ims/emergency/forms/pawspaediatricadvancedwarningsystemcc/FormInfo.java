...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "PAWSPaediatricAdvancedWarningSystemCC";
	}
	public int getWidth()
	{
		return 704;
	...
	{
		return "_lv_Emergency.PAWSPaediatricAdvancedWarningSystemCC.__internal_x_context__" + String.valueOf(getFormId());
	}
