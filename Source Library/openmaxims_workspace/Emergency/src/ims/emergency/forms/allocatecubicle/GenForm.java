...
public class GenForm extends FormBridge
{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		// Button Controls
		RuntimeAnchoring anchoringHelper7 = new RuntimeAnchoring(designSize, runtimeSize, 228, 201, 136, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT);
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1007), new Integer(anchoringHelper7.getX()), new Integer(anchoringHelper7.getY()), new Integer(anchoringHelper7.getWidth()), new Integer(anchoringHelper7.getHeight()), new Integer(startTabIndex.intValue() + 8), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Unallocate Cubicle", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		RuntimeAnchoring anchoringHelper8 = new RuntimeAnchoring(designSize, runtimeSize, 368, 201, 75, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT);
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1008), new Integer(anchoringHelper8.getX()), new Integer(anchoringHelper8.getY()), new Integer(anchoringHelper8.getWidth()), new Integer(anchoringHelper8.getHeight()), new Integer(startTabIndex.intValue() + 9), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, " RIE", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		RuntimeAnchoring anchoringHelper9 = new RuntimeAnchoring(designSize, runtimeSize, 590, 201, 75, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT);
		...
		RuntimeAnchoring anchoringHelper10 = new RuntimeAnchoring(designSize, runtimeSize, 589, 201, 75, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT);
		...
		RuntimeAnchoring anchoringHelper11 = new RuntimeAnchoring(designSize, runtimeSize, 511, 201, 75, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT);
		...
		RuntimeAnchoring anchoringHelper12 = new RuntimeAnchoring(designSize, runtimeSize, 88, 201, 75, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT);
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1012), new Integer(anchoringHelper12.getX()), new Integer(anchoringHelper12.getY()), new Integer(anchoringHelper12.getWidth()), new Integer(anchoringHelper12.getHeight()), new Integer(startTabIndex.intValue() + 7), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Edit", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		RuntimeAnchoring anchoringHelper13 = new RuntimeAnchoring(designSize, runtimeSize, 8, 201, 75, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT);
		...
		// Date Time Controls
		RuntimeAnchoring anchoringHelper14 = new RuntimeAnchoring(designSize, runtimeSize, 192, 86, 200, 20, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		// ComboBox Controls
		RuntimeAnchoring anchoringHelper15 = new RuntimeAnchoring(designSize, runtimeSize, 192, 117, 200, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		RuntimeAnchoring anchoringHelper16 = new RuntimeAnchoring(designSize, runtimeSize, 8, 8, 656, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT);
	...
	public Button btnUnallocateCubicle()
	{
	...
	public class LocalContext extends ContextBridge
	{
		...
		public LocalContext(Context context, ims.framework.FormInfo formInfo, String componentIdentifier)
		{
			...
			cxl_CurrentlyAllocatedCubicles = new ims.framework.ContextVariable("CurrentlyAllocatedCubicles", prefix + "_lv_Emergency.AllocateCubicle.__internal_x_context__CurrentlyAllocatedCubicles_" + componentIdentifier + "");
		}
		...
		public boolean getCurrentlyAllocatedCubiclesIsNotNull()
		{
			return !cxl_CurrentlyAllocatedCubicles.getValueIsNull(context);
		}
		public ims.emergency.vo.TrackingCubicleRoomBedVoCollection getCurrentlyAllocatedCubicles()
		{
			return (ims.emergency.vo.TrackingCubicleRoomBedVoCollection)cxl_CurrentlyAllocatedCubicles.getValue(context);
		}
		public void setCurrentlyAllocatedCubicles(ims.emergency.vo.TrackingCubicleRoomBedVoCollection value)
		{
			cxl_CurrentlyAllocatedCubicles.setValue(context, value);
		}
		private ims.framework.ContextVariable cxl_CurrentlyAllocatedCubicles = null;
	}
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[145] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.AllocateCubicle.__internal_x_context__CurrentCubicleAllocation_" + componentIdentifier, "BO-1086100010-ID", "ID_CubicleAllocation");
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.AllocateCubicle.__internal_x_context__CurrentCubicleAllocation_" + componentIdentifier, "BO-1086100010-PATIENT", "Patient");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.AllocateCubicle.__internal_x_context__CurrentCubicleAllocation_" + componentIdentifier, "BO-1086100010-EPISODE", "Episode");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.AllocateCubicle.__internal_x_context__CurrentCubicleAllocation_" + componentIdentifier, "BO-1086100010-ATTENDANCE", "Attendance");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.AllocateCubicle.__internal_x_context__CurrentCubicleAllocation_" + componentIdentifier, "BO-1086100010-ALLOCATEDCUBICLEDATETIME", "AllocatedCubicleDateTime");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.AllocateCubicle.__internal_x_context__CurrentTracking_" + componentIdentifier, "BO-1086100005-ID", "ID_Tracking");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.AllocateCubicle.__internal_x_context__CurrentTracking_" + componentIdentifier, "BO-1086100005-ISDISCHARGED", "IsDischarged");
			fields[152] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.AllocateCubicle.__internal_x_context__CurrentTracking_" + componentIdentifier, "BO-1086100005-PATIENT", "Patient");
			return fields;
		}
