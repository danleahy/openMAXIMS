...
public class GenForm extends FormBridge
{
	...
	public static class lyr1Layer extends Layer
	{
		...
		public static class tabAreaDefinitionContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				ims.framework.FormUiLogic m_ccAreaDefinitionForm = loader.loadComponent(129111, appForm, startControlID * 10 + 1000, anchoringHelper1.getSize(), instance1, startTabIndex.intValue() + 4, skipContextValidation);
				//ims.framework.Control m_ccAreaDefinitionControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1000), new Integer(0), new Integer(0), new Integer(808), new Integer(512), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 4), m_ccAreaDefinitionForm, instance1 } );
				ims.framework.Control m_ccAreaDefinitionControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1001),  new Integer(anchoringHelper1.getX()), new Integer(anchoringHelper1.getY()), new Integer(anchoringHelper1.getWidth()), new Integer(anchoringHelper1.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 4), m_ccAreaDefinitionForm, instance1, Boolean.FALSE } );
		...
		public static class tabSendToConfigContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				ims.framework.FormUiLogic m_ccSendToConfigForm = loader.loadComponent(129110, appForm, startControlID * 10 + 2000, anchoringHelper2.getSize(), instance1, startTabIndex.intValue() + 6, skipContextValidation);
				//ims.framework.Control m_ccSendToConfigControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1002), new Integer(0), new Integer(0), new Integer(808), new Integer(512), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 6), m_ccSendToConfigForm, instance1 } );
				ims.framework.Control m_ccSendToConfigControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1003),  new Integer(anchoringHelper2.getX()), new Integer(anchoringHelper2.getY()), new Integer(anchoringHelper2.getWidth()), new Integer(anchoringHelper2.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 6), m_ccSendToConfigForm, instance1, Boolean.FALSE } );
		...
		public static class tabAreaWorkspaceContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				ims.framework.FormUiLogic m_ccAreaWorkspaceConfigForm = loader.loadComponent(129118, appForm, startControlID * 10 + 3000, anchoringHelper3.getSize(), instance1, startTabIndex.intValue() + 9, skipContextValidation);
				//ims.framework.Control m_ccAreaWorkspaceConfigControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1004), new Integer(0), new Integer(0), new Integer(808), new Integer(504), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 9), m_ccAreaWorkspaceConfigForm, instance1 } );
				ims.framework.Control m_ccAreaWorkspaceConfigControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1005),  new Integer(anchoringHelper3.getX()), new Integer(anchoringHelper3.getY()), new Integer(anchoringHelper3.getWidth()), new Integer(anchoringHelper3.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 9), m_ccAreaWorkspaceConfigForm, instance1, Boolean.FALSE } );
		...
		public static class tabCubiclesRoomsBedsContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				ims.framework.FormUiLogic m_ccCubicleRoomBedForm = loader.loadComponent(129173, appForm, startControlID * 10 + 4000, anchoringHelper4.getSize(), instance1, startTabIndex.intValue() + 12, skipContextValidation);
				//ims.framework.Control m_ccCubicleRoomBedControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1006), new Integer(8), new Integer(0), new Integer(808), new Integer(520), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 12), m_ccCubicleRoomBedForm, instance1 } );
				ims.framework.Control m_ccCubicleRoomBedControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1007),  new Integer(anchoringHelper4.getX()), new Integer(anchoringHelper4.getY()), new Integer(anchoringHelper4.getWidth()), new Integer(anchoringHelper4.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 12), m_ccCubicleRoomBedForm, instance1, Boolean.FALSE } );
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1017), new Integer(anchoringHelper14.getX()), new Integer(anchoringHelper14.getY()), new Integer(anchoringHelper14.getWidth()), new Integer(anchoringHelper14.getHeight()), new Integer(startTabIndex.intValue() + 16), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Edit", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1018), new Integer(anchoringHelper15.getX()), new Integer(anchoringHelper15.getY()), new Integer(anchoringHelper15.getWidth()), new Integer(anchoringHelper15.getHeight()), new Integer(startTabIndex.intValue() + 15), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "New", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(IntBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1021), new Integer(anchoringHelper18.getX()), new Integer(anchoringHelper18.getY()), new Integer(anchoringHelper18.getWidth()), new Integer(anchoringHelper18.getHeight()), new Integer(startTabIndex.intValue() + 3), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT,Boolean.TRUE, Boolean.TRUE, Boolean.FALSE, null, null, Boolean.TRUE, new Integer(9)}));
	}
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, "_cv_Emergency.EDLocation", "BO-1007100007-ID", "ID_Location");
			fields[145] = new ims.framework.ReportField(this.context, "_cv_Emergency.EDLocation", "BO-1007100007-NAME", "Name");
			fields[146] = new ims.framework.ReportField(this.context, "_cv_Emergency.EDLocation", "BO-1007100007-ISACTIVE", "IsActive");
			fields[147] = new ims.framework.ReportField(this.context, "_cv_Emergency.EDLocation", "BO-1007100007-ISVIRTUAL", "IsVirtual");
			fields[148] = new ims.framework.ReportField(this.context, "_cv_Emergency.EDLocation", "BO-1007100007-TYPE", "Type");
			fields[149] = new ims.framework.ReportField(this.context, "_cv_Emergency.EDLocation", "BO-1007100007-DISPLAYINEDTRACKING", "DisplayInEDTracking");
			fields[150] = new ims.framework.ReportField(this.context, "_cv_Emergency.EDLocation", "BO-1007100007-CASENOTEFOLDERLOCATION", "CaseNoteFolderLocation");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.TrackingConfiguration.__internal_x_context__TrackingConfig_" + componentIdentifier, "BO-1087100000-ID", "ID_TrackingConfiguration");
			fields[152] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.TrackingConfiguration.__internal_x_context__TrackingConfig_" + componentIdentifier, "BO-1087100000-ISACTIVE", "IsActive");
			fields[153] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.TrackingConfiguration.__internal_x_context__TrackingConfig_" + componentIdentifier, "BO-1087100000-AREACOUNTREFRESHRATE", "AreaCountRefreshRate");
			fields[154] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.TrackingConfiguration.__internal_x_context__TrackingArea_" + componentIdentifier, "BO-1087100001-ID", "ID_TrackingArea");
			fields[155] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.TrackingConfiguration.__internal_x_context__TrackingArea_" + componentIdentifier, "BO-1087100001-AREANAMEDESCRIPTION", "AreaNameDescription");
			fields[156] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.TrackingConfiguration.__internal_x_context__TrackingArea_" + componentIdentifier, "BO-1087100001-AREADISPLAYNAME", "AreaDisplayName");
			fields[157] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.TrackingConfiguration.__internal_x_context__TrackingArea_" + componentIdentifier, "BO-1087100001-STATUS", "Status");
			fields[158] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.TrackingConfiguration.__internal_x_context__TrackingArea_" + componentIdentifier, "BO-1087100001-ISOVERALLVIEW", "IsOverallView");
			fields[159] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.TrackingConfiguration.__internal_x_context__TrackingArea_" + componentIdentifier, "BO-1087100001-ISREGISTRATIONAREA", "IsRegistrationArea");
			fields[160] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.TrackingConfiguration.__internal_x_context__TrackingArea_" + componentIdentifier, "BO-1087100001-PATIENTREFRESHRATE", "PatientRefreshRate");
			fields[161] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.TrackingConfiguration.__internal_x_context__TrackingArea_" + componentIdentifier, "BO-1087100001-AREATYPE", "AreaType");
			fields[162] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.TrackingConfiguration.__internal_x_context__TrackingArea_" + componentIdentifier, "BO-1087100001-ASSOCIATEDWORKFLOWMANDATORY", "AssociatedWorkflowMandatory");
			fields[163] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.TrackingConfiguration.__internal_x_context__AreaFromSendToConfig_" + componentIdentifier, "BO-1087100001-ID", "ID_TrackingArea");
			fields[164] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.TrackingConfiguration.__internal_x_context__AreaFromSendToConfig_" + componentIdentifier, "BO-1087100001-AREANAMEDESCRIPTION", "AreaNameDescription");
			fields[165] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.TrackingConfiguration.__internal_x_context__AreaFromSendToConfig_" + componentIdentifier, "BO-1087100001-AREADISPLAYNAME", "AreaDisplayName");
			fields[166] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.TrackingConfiguration.__internal_x_context__AreaFromSendToConfig_" + componentIdentifier, "BO-1087100001-STATUS", "Status");
			fields[167] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.TrackingConfiguration.__internal_x_context__AreaFromSendToConfig_" + componentIdentifier, "BO-1087100001-ISOVERALLVIEW", "IsOverallView");
			fields[168] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.TrackingConfiguration.__internal_x_context__AreaFromSendToConfig_" + componentIdentifier, "BO-1087100001-ISREGISTRATIONAREA", "IsRegistrationArea");
			fields[169] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.TrackingConfiguration.__internal_x_context__AreaFromSendToConfig_" + componentIdentifier, "BO-1087100001-PATIENTREFRESHRATE", "PatientRefreshRate");
			fields[170] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.TrackingConfiguration.__internal_x_context__AreaFromSendToConfig_" + componentIdentifier, "BO-1087100001-AREATYPE", "AreaType");
			fields[171] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.TrackingConfiguration.__internal_x_context__AreaFromSendToConfig_" + componentIdentifier, "BO-1087100001-ASSOCIATEDWORKFLOWMANDATORY", "AssociatedWorkflowMandatory");
			fields[172] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.TrackingConfiguration.__internal_x_context__AreaFromAreaWorkspace_" + componentIdentifier, "BO-1087100001-ID", "ID_TrackingArea");
			fields[173] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.TrackingConfiguration.__internal_x_context__AreaFromAreaWorkspace_" + componentIdentifier, "BO-1087100001-AREANAMEDESCRIPTION", "AreaNameDescription");
			fields[174] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.TrackingConfiguration.__internal_x_context__AreaFromAreaWorkspace_" + componentIdentifier, "BO-1087100001-AREADISPLAYNAME", "AreaDisplayName");
			fields[175] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.TrackingConfiguration.__internal_x_context__AreaFromAreaWorkspace_" + componentIdentifier, "BO-1087100001-STATUS", "Status");
			fields[176] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.TrackingConfiguration.__internal_x_context__AreaFromAreaWorkspace_" + componentIdentifier, "BO-1087100001-ISOVERALLVIEW", "IsOverallView");
			fields[177] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.TrackingConfiguration.__internal_x_context__AreaFromAreaWorkspace_" + componentIdentifier, "BO-1087100001-ISREGISTRATIONAREA", "IsRegistrationArea");
			fields[178] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.TrackingConfiguration.__internal_x_context__AreaFromAreaWorkspace_" + componentIdentifier, "BO-1087100001-PATIENTREFRESHRATE", "PatientRefreshRate");
			fields[179] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.TrackingConfiguration.__internal_x_context__AreaFromAreaWorkspace_" + componentIdentifier, "BO-1087100001-AREATYPE", "AreaType");
			fields[180] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.TrackingConfiguration.__internal_x_context__AreaFromAreaWorkspace_" + componentIdentifier, "BO-1087100001-ASSOCIATEDWORKFLOWMANDATORY", "AssociatedWorkflowMandatory");
			return fields;
		}
