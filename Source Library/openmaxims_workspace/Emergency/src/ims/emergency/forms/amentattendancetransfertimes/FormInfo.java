...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "AmentAttendanceTransferTimes";
	}
	public int getWidth()
	{
		return 464;
	...
	{
		return new String[] { "_cv_Emergency.AmendAttendanceTransferTimes", "_cv_Emergency.EmergencyAttendanceForTimeAmendments" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Emergency.AmentAttendanceTransferTimes.__internal_x_context__" + String.valueOf(getFormId());
	}
