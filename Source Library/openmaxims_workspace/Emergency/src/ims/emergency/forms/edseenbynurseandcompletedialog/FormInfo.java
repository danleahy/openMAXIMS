...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "EDSeenByNurseAndCompleteDialog";
	}
	public int getWidth()
	{
		return 704;
	...
	{
		return new String[] { "_cv_Emergency.AttendanceClinicalNotes", "_cv_Emergency.TrackingAttendanceStatus", "_cv_Core.RieMessage", "_cv_Emergency.Tracking" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Emergency.EDSeenByNurseAndCompleteDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
