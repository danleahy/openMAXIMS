...
public abstract class BaseLogic extends Handlers implements IComponent
{
	...
	protected final void oncmbInvoiceAmountValueSet(Object value)
	{
		java.util.ArrayList listOfValues = this.form.cmbInvoiceAmount().getValues();
		...
		if(value == null)
		{
			if(listOfValues != null && listOfValues.size() > 0)
			{
				...
				{
					ims.emergency.vo.lookups.InvoiceAmount existingInstance = (ims.emergency.vo.lookups.InvoiceAmount)listOfValues.get(x);
		...
		else if(value instanceof ims.emergency.vo.lookups.InvoiceAmount)
		{
			ims.emergency.vo.lookups.InvoiceAmount instance = (ims.emergency.vo.lookups.InvoiceAmount)value;
			...
			this.form.cmbInvoiceAmount().newRow(instance, instance.getText(), instance.getImage(), instance.getTextColor());
		}
	}
	protected final void bindcmbInvoiceAmountLookup()
	{
		this.form.cmbInvoiceAmount().clear();
		ims.emergency.vo.lookups.InvoiceAmountCollection lookupCollection = ims.emergency.vo.lookups.LookupHelper.getInvoiceAmount(this.domain.getLookupService());
		for(int x = 0; x < lookupCollection.size(); x++)
		{
			this.form.cmbInvoiceAmount().newRow(lookupCollection.get(x), lookupCollection.get(x).getText(), lookupCollection.get(x).getImage(), lookupCollection.get(x).getTextColor());
		}
	}
	protected final void setcmbInvoiceAmountLookupValue(int id)
	{
		ims.emergency.vo.lookups.InvoiceAmount instance = ims.emergency.vo.lookups.LookupHelper.getInvoiceAmountInstance(this.domain.getLookupService(), id);
		if(instance != null)
			this.form.cmbInvoiceAmount().setValue(instance);
	}
	protected final void defaultcmbInvoiceAmountLookupValue()
	{
		this.form.cmbInvoiceAmount().setValue((ims.emergency.vo.lookups.InvoiceAmount)domain.getLookupService().getDefaultInstance(ims.emergency.vo.lookups.InvoiceAmount.class, engine.getFormName().getID(), ims.emergency.vo.lookups.InvoiceAmount.TYPE_ID));
	}
