...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "AmentAttendanceSentToXrayTimes";
	}
	public int getWidth()
	{
		return 464;
	...
	{
		return new String[] { "_cv_Emergency.AmendAttendanceSentToXrayTimes", "_cv_Emergency.EmergencyAttendanceForTimeAmendments" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Emergency.AmentAttendanceSentToXrayTimes.__internal_x_context__" + String.valueOf(getFormId());
	}
