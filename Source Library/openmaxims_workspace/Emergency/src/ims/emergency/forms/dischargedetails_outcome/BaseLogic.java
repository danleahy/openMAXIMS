...
public abstract class BaseLogic extends Handlers implements IComponent
{
	...
	protected final void oncmbGPLetterStatusValueSet(Object value)
	{
		java.util.ArrayList listOfValues = this.form.cmbGPLetterStatus().getValues();
		...
		if(value == null)
		{
			if(listOfValues != null && listOfValues.size() > 0)
			{
				...
				{
					ims.emergency.vo.lookups.GPLetterStatus existingInstance = (ims.emergency.vo.lookups.GPLetterStatus)listOfValues.get(x);
		...
		else if(value instanceof ims.emergency.vo.lookups.GPLetterStatus)
		{
			ims.emergency.vo.lookups.GPLetterStatus instance = (ims.emergency.vo.lookups.GPLetterStatus)value;
			...
			this.form.cmbGPLetterStatus().newRow(instance, instance.getText(), instance.getImage(), instance.getTextColor());
		}
	}
	protected final void bindcmbGPLetterStatusLookup()
	{
		this.form.cmbGPLetterStatus().clear();
		ims.emergency.vo.lookups.GPLetterStatusCollection lookupCollection = ims.emergency.vo.lookups.LookupHelper.getGPLetterStatus(this.domain.getLookupService());
		for(int x = 0; x < lookupCollection.size(); x++)
		{
			this.form.cmbGPLetterStatus().newRow(lookupCollection.get(x), lookupCollection.get(x).getText(), lookupCollection.get(x).getImage(), lookupCollection.get(x).getTextColor());
		}
	}
	protected final void setcmbGPLetterStatusLookupValue(int id)
	{
		ims.emergency.vo.lookups.GPLetterStatus instance = ims.emergency.vo.lookups.LookupHelper.getGPLetterStatusInstance(this.domain.getLookupService(), id);
		if(instance != null)
			this.form.cmbGPLetterStatus().setValue(instance);
	}
	protected final void defaultcmbGPLetterStatusLookupValue()
	{
		this.form.cmbGPLetterStatus().setValue((ims.emergency.vo.lookups.GPLetterStatus)domain.getLookupService().getDefaultInstance(ims.emergency.vo.lookups.GPLetterStatus.class, engine.getFormName().getID(), ims.emergency.vo.lookups.GPLetterStatus.TYPE_ID));
	}
