...
abstract public class Handlers implements ims.framework.UILogic, IFormUILogicCode, ims.framework.interfaces.IClearInfo
{
	...
	abstract protected void bindcmbTrackingStatusLookup();
	abstract protected void defaultcmbTrackingStatusLookupValue();
	...
	abstract protected void onRadioButtongrpAttendanceDepartureValueChanged() throws ims.framework.exceptions.PresentationLogicException;
	abstract protected void oncmbTrackingStatusValueSet(Object value);
	...
	public final void setContext(ims.framework.UIEngine engine, GenForm form)
	{
		...
		this.form.grpAttendanceDeparture().setValueChangedEvent(new ValueChanged()
		{
			private static final long serialVersionUID = 1L;
			public void handle() throws ims.framework.exceptions.PresentationLogicException
			{
				onRadioButtongrpAttendanceDepartureValueChanged();
			}
		});
		this.form.cmbTrackingStatus().setValueSetEvent(new ComboBoxValueSet()
		{
			private static final long serialVersionUID = 1L;
			public void handle(Object value)
			{
				oncmbTrackingStatusValueSet(value);
			}
		});
	...
	protected void defaultAllLookupValues()
	{
		...
		defaultcmbTrackingStatusLookupValue();
	}
