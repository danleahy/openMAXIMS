...
public class GenForm extends FormBridge
{
	...
	public static class lyrPatientTriageLayer extends Layer
	{
		...
		public static class tabNotesContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				ims.framework.FormUiLogic m_ccNotesForm = loader.loadComponent(129119, appForm, startControlID * 10 + 1000, anchoringHelper1.getSize(), instance1, startTabIndex.intValue() + 7, skipContextValidation);
				//ims.framework.Control m_ccNotesControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1000), new Integer(0), new Integer(0), new Integer(552), new Integer(530), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 7), m_ccNotesForm, instance1 } );
				ims.framework.Control m_ccNotesControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1001),  new Integer(anchoringHelper1.getX()), new Integer(anchoringHelper1.getY()), new Integer(anchoringHelper1.getWidth()), new Integer(anchoringHelper1.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 7), m_ccNotesForm, instance1, Boolean.FALSE } );
		...
		public static class tabObsContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				ims.framework.FormUiLogic m_ccVitalSignsForm = loader.loadComponent(102387, appForm, startControlID * 10 + 2000, anchoringHelper2.getSize(), instance1, startTabIndex.intValue() + 12, skipContextValidation);
				//ims.framework.Control m_ccVitalSignsControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1002), new Integer(0), new Integer(0), new Integer(552), new Integer(530), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 12), m_ccVitalSignsForm, instance1 } );
				ims.framework.Control m_ccVitalSignsControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1003),  new Integer(anchoringHelper2.getX()), new Integer(anchoringHelper2.getY()), new Integer(anchoringHelper2.getWidth()), new Integer(anchoringHelper2.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 12), m_ccVitalSignsForm, instance1, Boolean.FALSE } );
			...
			public static class lyrObs2Layer extends Layer
			{
				...
				public static class tabVitalSignsContainer extends LayerBridge
				{
					...
					protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
					{
						...
						ims.framework.FormUiLogic m_ccVitalSignsObsForm = loader.loadComponent(102387, appForm, startControlID * 10 + 3000, anchoringHelper3.getSize(), instance1, startTabIndex.intValue() + 90, skipContextValidation);
						//ims.framework.Control m_ccVitalSignsObsControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1004), new Integer(0), new Integer(0), new Integer(544), new Integer(501), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 90), m_ccVitalSignsObsForm, instance1 } );
						ims.framework.Control m_ccVitalSignsObsControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1005),  new Integer(anchoringHelper3.getX()), new Integer(anchoringHelper3.getY()), new Integer(anchoringHelper3.getWidth()), new Integer(anchoringHelper3.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 90), m_ccVitalSignsObsForm, instance1, Boolean.FALSE } );
				...
				public static class tabUrinalysisContainer extends LayerBridge
				{
					...
					protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
					{
						...
						ims.framework.FormUiLogic m_ccUrinalysisForm = loader.loadComponent(123254, appForm, startControlID * 10 + 4000, anchoringHelper4.getSize(), instance1, startTabIndex.intValue() + 168, skipContextValidation);
						//ims.framework.Control m_ccUrinalysisControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1006), new Integer(0), new Integer(0), new Integer(544), new Integer(501), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 168), m_ccUrinalysisForm, instance1 } );
						ims.framework.Control m_ccUrinalysisControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1007),  new Integer(anchoringHelper4.getX()), new Integer(anchoringHelper4.getY()), new Integer(anchoringHelper4.getWidth()), new Integer(anchoringHelper4.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 168), m_ccUrinalysisForm, instance1, Boolean.FALSE } );
				...
				public static class tabUrineToxContainer extends LayerBridge
				{
					...
					protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
					{
						...
						ims.framework.FormUiLogic m_ccUrineToxForm = loader.loadComponent(123255, appForm, startControlID * 10 + 5000, anchoringHelper5.getSize(), instance1, startTabIndex.intValue() + 235, skipContextValidation);
						//ims.framework.Control m_ccUrineToxControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1008), new Integer(0), new Integer(0), new Integer(544), new Integer(501), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 235), m_ccUrineToxForm, instance1 } );
						ims.framework.Control m_ccUrineToxControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1009),  new Integer(anchoringHelper5.getX()), new Integer(anchoringHelper5.getY()), new Integer(anchoringHelper5.getWidth()), new Integer(anchoringHelper5.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 235), m_ccUrineToxForm, instance1, Boolean.FALSE } );
				...
				public static class tabHCGContainer extends LayerBridge
				{
					...
					protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
					{
						...
						ims.framework.FormUiLogic m_ccHCGForm = loader.loadComponent(123256, appForm, startControlID * 10 + 6000, anchoringHelper6.getSize(), instance1, startTabIndex.intValue() + 237, skipContextValidation);
						//ims.framework.Control m_ccHCGControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1010), new Integer(0), new Integer(0), new Integer(544), new Integer(501), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 237), m_ccHCGForm, instance1 } );
						ims.framework.Control m_ccHCGControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1011),  new Integer(anchoringHelper6.getX()), new Integer(anchoringHelper6.getY()), new Integer(anchoringHelper6.getWidth()), new Integer(anchoringHelper6.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 237), m_ccHCGForm, instance1, Boolean.FALSE } );
				...
				public static class tabOtherContainer extends LayerBridge
				{
					...
					protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
					{
						...
						ims.framework.FormUiLogic m_ccPatientAssessmentForm = loader.loadComponent(123257, appForm, startControlID * 10 + 7000, anchoringHelper7.getSize(), instance1, startTabIndex.intValue() + 239, skipContextValidation);
						//ims.framework.Control m_ccPatientAssessmentControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1012), new Integer(0), new Integer(0), new Integer(544), new Integer(501), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 239), m_ccPatientAssessmentForm, instance1 } );
						ims.framework.Control m_ccPatientAssessmentControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1013),  new Integer(anchoringHelper7.getX()), new Integer(anchoringHelper7.getY()), new Integer(anchoringHelper7.getWidth()), new Integer(anchoringHelper7.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 239), m_ccPatientAssessmentForm, instance1, Boolean.FALSE } );
		...
		public static class tabTriagePathwayContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				ims.framework.FormUiLogic m_ccICPForm = loader.loadComponent(118128, appForm, startControlID * 10 + 8000, anchoringHelper13.getSize(), instance1, startTabIndex.intValue() + 250, skipContextValidation);
				//ims.framework.Control m_ccICPControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1019), new Integer(8), new Integer(0), new Integer(544), new Integer(522), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 250), m_ccICPForm, instance1 } );
				ims.framework.Control m_ccICPControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1020),  new Integer(anchoringHelper13.getX()), new Integer(anchoringHelper13.getY()), new Integer(anchoringHelper13.getWidth()), new Integer(anchoringHelper13.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 250), m_ccICPForm, instance1, Boolean.FALSE } );
		...
		public static class tabPatientMedsContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				ims.framework.FormUiLogic m_ccPatientMedsForm = loader.loadComponent(129126, appForm, startControlID * 10 + 9000, anchoringHelper14.getSize(), instance1, startTabIndex.intValue() + 268, skipContextValidation);
				//ims.framework.Control m_ccPatientMedsControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1021), new Integer(0), new Integer(0), new Integer(552), new Integer(531), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 268), m_ccPatientMedsForm, instance1 } );
				ims.framework.Control m_ccPatientMedsControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1022),  new Integer(anchoringHelper14.getX()), new Integer(anchoringHelper14.getY()), new Integer(anchoringHelper14.getWidth()), new Integer(anchoringHelper14.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 268), m_ccPatientMedsForm, instance1, Boolean.FALSE } );
		...
		public static class tabRelevantPMHContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				ims.framework.FormUiLogic m_ccRelevantPMHForm = loader.loadComponent(129125, appForm, startControlID * 10 + 10000, anchoringHelper15.getSize(), instance1, startTabIndex.intValue() + 274, skipContextValidation);
				//ims.framework.Control m_ccRelevantPMHControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1023), new Integer(0), new Integer(0), new Integer(552), new Integer(530), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 274), m_ccRelevantPMHForm, instance1 } );
				ims.framework.Control m_ccRelevantPMHControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1024),  new Integer(anchoringHelper15.getX()), new Integer(anchoringHelper15.getY()), new Integer(anchoringHelper15.getWidth()), new Integer(anchoringHelper15.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 274), m_ccRelevantPMHForm, instance1, Boolean.FALSE } );
		...
		public static class tabSupportContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				ims.framework.FormUiLogic m_ccSuppForm = loader.loadComponent(129161, appForm, startControlID * 10 + 11000, anchoringHelper16.getSize(), instance1, startTabIndex.intValue() + 281, skipContextValidation);
				//ims.framework.Control m_ccSuppControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1025), new Integer(8), new Integer(8), new Integer(552), new Integer(530), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 281), m_ccSuppForm, instance1 } );
				ims.framework.Control m_ccSuppControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1026),  new Integer(anchoringHelper16.getX()), new Integer(anchoringHelper16.getY()), new Integer(anchoringHelper16.getWidth()), new Integer(anchoringHelper16.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 281), m_ccSuppForm, instance1, Boolean.FALSE } );
		...
		public static class tabDischargeContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				ims.framework.FormUiLogic m_ccDischargeForm = loader.loadComponent(129155, appForm, startControlID * 10 + 12000, anchoringHelper17.getSize(), instance1, startTabIndex.intValue() + 350, skipContextValidation);
				//ims.framework.Control m_ccDischargeControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1027), new Integer(0), new Integer(0), new Integer(552), new Integer(530), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 350), m_ccDischargeForm, instance1 } );
				ims.framework.Control m_ccDischargeControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1028),  new Integer(anchoringHelper17.getX()), new Integer(anchoringHelper17.getY()), new Integer(anchoringHelper17.getWidth()), new Integer(anchoringHelper17.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 350), m_ccDischargeForm, instance1, Boolean.FALSE } );
	...
	public static class GroupClinicianReviewRadioButton extends RadioButtonBridge
	{
		...
		protected void setContext(Integer startTabIndex, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize)
		{
			...
			control.addButton(0, anchoringHelper26.getX(), anchoringHelper26.getY(), anchoringHelper26.getWidth(), "My Allocated", startTabIndex.intValue() + 3);
			...
			control.addButton(1, anchoringHelper27.getX(), anchoringHelper27.getY(), anchoringHelper27.getWidth(), "All", startTabIndex.intValue() + 2);
		}
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		ims.framework.FormUiLogic m_ccAlertForm = loader.loadComponent(102401, appForm, startControlID * 10 + 13000, anchoringHelper31.getSize(), instance1, startTabIndex.intValue() + 358, skipContextValidation);
		//ims.framework.Control m_ccAlertControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1040), new Integer(920), new Integer(210), new Integer(240), new Integer(96), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT, new Integer(startTabIndex.intValue() + 358), m_ccAlertForm, instance1 } );
		ims.framework.Control m_ccAlertControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1041),  new Integer(anchoringHelper31.getX()), new Integer(anchoringHelper31.getY()), new Integer(anchoringHelper31.getWidth()), new Integer(anchoringHelper31.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT, new Integer(startTabIndex.intValue() + 358), m_ccAlertForm, instance1, Boolean.FALSE } );
		...
		ims.framework.FormUiLogic m_ccAllergyForm = loader.loadComponent(123239, appForm, startControlID * 10 + 14000, anchoringHelper32.getSize(), instance2, startTabIndex.intValue() + 352, skipContextValidation);
		//ims.framework.Control m_ccAllergyControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1042), new Integer(920), new Integer(113), new Integer(240), new Integer(96), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT, new Integer(startTabIndex.intValue() + 352), m_ccAllergyForm, instance2 } );
		ims.framework.Control m_ccAllergyControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1043),  new Integer(anchoringHelper32.getX()), new Integer(anchoringHelper32.getY()), new Integer(anchoringHelper32.getWidth()), new Integer(anchoringHelper32.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT, new Integer(startTabIndex.intValue() + 352), m_ccAllergyForm, instance2, Boolean.FALSE } );
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1062), new Integer(anchoringHelper51.getX()), new Integer(anchoringHelper51.getY()), new Integer(anchoringHelper51.getWidth()), new Integer(anchoringHelper51.getHeight()), new Integer(startTabIndex.intValue() + 373), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Start Triage", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1063), new Integer(anchoringHelper52.getX()), new Integer(anchoringHelper52.getY()), new Integer(anchoringHelper52.getWidth()), new Integer(anchoringHelper52.getHeight()), new Integer(startTabIndex.intValue() + 6), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Edit", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1064), new Integer(anchoringHelper53.getX()), new Integer(anchoringHelper53.getY()), new Integer(anchoringHelper53.getWidth()), new Integer(anchoringHelper53.getHeight()), new Integer(startTabIndex.intValue() + 376), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Refer To Specialty", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1065), new Integer(anchoringHelper54.getX()), new Integer(anchoringHelper54.getY()), new Integer(anchoringHelper54.getWidth()), new Integer(anchoringHelper54.getHeight()), new Integer(startTabIndex.intValue() + 377), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Move Patient", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1066), new Integer(anchoringHelper55.getX()), new Integer(anchoringHelper55.getY()), new Integer(anchoringHelper55.getWidth()), new Integer(anchoringHelper55.getHeight()), new Integer(startTabIndex.intValue() + 375), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "View History", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1067), new Integer(anchoringHelper56.getX()), new Integer(anchoringHelper56.getY()), new Integer(anchoringHelper56.getWidth()), new Integer(anchoringHelper56.getHeight()), new Integer(startTabIndex.intValue() + 374), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Patient Summary", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(DateTimeControl.class, new Object[] { control, new Integer(startControlID.intValue() + 1071), new Integer(anchoringHelper60.getX()), new Integer(anchoringHelper60.getY()), new Integer(anchoringHelper60.getWidth()), new Integer(anchoringHelper60.getHeight()), new Integer(startTabIndex.intValue() + 370), ControlState.DISABLED, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT,Boolean.TRUE, null, Boolean.FALSE, null, Boolean.FALSE, null}));
		...
		super.addControl(factory.getControl(DateTimeControl.class, new Object[] { control, new Integer(startControlID.intValue() + 1072), new Integer(anchoringHelper61.getX()), new Integer(anchoringHelper61.getY()), new Integer(anchoringHelper61.getWidth()), new Integer(anchoringHelper61.getHeight()), new Integer(startTabIndex.intValue() + 369), ControlState.DISABLED, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT,Boolean.TRUE, null, Boolean.FALSE, null, Boolean.FALSE, null}));
		...
		super.addControl(factory.getControl(DateTimeControl.class, new Object[] { control, new Integer(startControlID.intValue() + 1073), new Integer(anchoringHelper62.getX()), new Integer(anchoringHelper62.getY()), new Integer(anchoringHelper62.getWidth()), new Integer(anchoringHelper62.getHeight()), new Integer(startTabIndex.intValue() + 368), ControlState.DISABLED, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT,Boolean.TRUE, null, Boolean.FALSE, null, Boolean.FALSE, null}));
		...
		super.addControl(factory.getControl(DateTimeControl.class, new Object[] { control, new Integer(startControlID.intValue() + 1074), new Integer(anchoringHelper63.getX()), new Integer(anchoringHelper63.getY()), new Integer(anchoringHelper63.getWidth()), new Integer(anchoringHelper63.getHeight()), new Integer(startTabIndex.intValue() + 367), ControlState.DISABLED, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT,Boolean.TRUE, null, Boolean.FALSE, null, Boolean.FALSE, null}));
		...
		super.addControl(factory.getControl(DateTimeControl.class, new Object[] { control, new Integer(startControlID.intValue() + 1075), new Integer(anchoringHelper64.getX()), new Integer(anchoringHelper64.getY()), new Integer(anchoringHelper64.getWidth()), new Integer(anchoringHelper64.getHeight()), new Integer(startTabIndex.intValue() + 366), ControlState.DISABLED, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT,Boolean.TRUE, null, Boolean.FALSE, null, Boolean.FALSE, null}));
		...
		super.addControl(factory.getControl(DateTimeControl.class, new Object[] { control, new Integer(startControlID.intValue() + 1076), new Integer(anchoringHelper65.getX()), new Integer(anchoringHelper65.getY()), new Integer(anchoringHelper65.getWidth()), new Integer(anchoringHelper65.getHeight()), new Integer(startTabIndex.intValue() + 365), ControlState.DISABLED, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT,Boolean.TRUE, null, Boolean.FALSE, null, Boolean.FALSE, null}));
		...
		ComboBox m_qmbPresentingProblemTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1077), new Integer(anchoringHelper66.getX()), new Integer(anchoringHelper66.getY()), new Integer(anchoringHelper66.getWidth()), new Integer(anchoringHelper66.getHeight()), new Integer(startTabIndex.intValue() + 5), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.TRUE, Boolean.TRUE, SortOrder.NONE, Boolean.TRUE, new Integer(1), null, Boolean.FALSE, new Integer(-1), Boolean.FALSE});
		...
		super.addControl(factory.getControl(DynamicGrid.class, new Object[] { control, new Integer(startControlID.intValue() + 1080), new Integer(anchoringHelper69.getX()), new Integer(anchoringHelper69.getY()), new Integer(anchoringHelper69.getWidth()), new Integer(anchoringHelper69.getHeight()), new Integer(startTabIndex.intValue() + 4), ControlState.READONLY, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.TOPBOTTOMLEFT, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE}));
	...
	private class ReportFields
	{
		...
		{
			String prefix = formInfo.getLocalVariablesPrefix();
			IReportField[] fields = new IReportField[200];
			...
			fields[147] = new ims.framework.ReportField(this.context, "_cv_Emergency.TriageProtocolAssessment", "BO-1086100018-ID", "ID_TriageProtocolAssessment");
			fields[148] = new ims.framework.ReportField(this.context, "_cv_Emergency.Triage", "BO-1086100004-ID", "ID_Triage");
			fields[149] = new ims.framework.ReportField(this.context, "_cv_Emergency.Tracking", "BO-1086100005-ID", "ID_Tracking");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.Triage.__internal_x_context__SelectedTriagePatient_" + componentIdentifier, "BO-1086100005-ID", "ID_Tracking");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.Triage.__internal_x_context__SelectedTriagePatient_" + componentIdentifier, "BO-1086100005-CURRENTAREA", "CurrentArea");
			fields[152] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.Triage.__internal_x_context__SelectedTriagePatient_" + componentIdentifier, "BO-1086100005-ISDISCHARGED", "IsDischarged");
			fields[153] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.Triage.__internal_x_context__LoggedHcp_" + componentIdentifier, "BO-1006100000-ID", "ID_Hcp");
			fields[154] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.Triage.__internal_x_context__AttendanceKPIConfig_" + componentIdentifier, "BO-1087100007-ID", "ID_AttendanceKPIConfig");
			fields[155] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.Triage.__internal_x_context__AttendanceKPIConfig_" + componentIdentifier, "BO-1087100007-AWAITINGTRIAGEBREACHWARNINGKPI", "AwaitingTriageBreachWarningKPI");
			fields[156] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.Triage.__internal_x_context__AttendanceKPIConfig_" + componentIdentifier, "BO-1087100007-AWAITINGTRIAGEBREACHEDKPI", "AwaitingTriageBreachedKPI");
			fields[157] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.Triage.__internal_x_context__AttendanceKPIConfig_" + componentIdentifier, "BO-1087100007-EDLOCATION", "EDLocation");
			fields[158] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.Triage.__internal_x_context__AttendanceKPIConfig_" + componentIdentifier, "BO-1087100007-AWAITINGTRIAGEBREACHWARNINGKPIFLASHINGTEXT", "AwaitingTriageBreachWarningKPIFlashingText");
			fields[159] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.Triage.__internal_x_context__AttendanceKPIConfig_" + componentIdentifier, "BO-1087100007-AWAITINGTRIAGEBREACHWARNINGKPIFLASHINGTEXTCOLOUR", "AwaitingTriageBreachWarningKPIFlashingTextColour");
			fields[160] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.Triage.__internal_x_context__AttendanceKPIConfig_" + componentIdentifier, "BO-1087100007-AWAITINGTRIAGEBREACHWARNINGKPIBACKGROUNDCOLOUR", "AwaitingTriageBreachWarningKPIBackgroundColour");
			fields[161] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.Triage.__internal_x_context__AttendanceKPIConfig_" + componentIdentifier, "BO-1087100007-AWAITINGTRIAGEBREACHKPIFLASHINGTEXT", "AwaitingTriageBreachKPIFlashingText");
			fields[162] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.Triage.__internal_x_context__AttendanceKPIConfig_" + componentIdentifier, "BO-1087100007-AWAITINGTRIAGEBREACHKPIFLASHINGTEXTCOLOUR", "AwaitingTriageBreachKPIFlashingTextColour");
			fields[163] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.Triage.__internal_x_context__AttendanceKPIConfig_" + componentIdentifier, "BO-1087100007-AWAITINGTRIAGEBREACHKPIBACKGROUNDCOLOUR", "AwaitingTriageBreachKPIBackgroundColour");
			fields[164] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.Triage.__internal_x_context__AttendanceKPIConfig_" + componentIdentifier, "BO-1087100007-AWAITINGTRIAGEBREACHWARNINGKPITEXTCOLOUR", "AwaitingTriageBreachWarningKPITextColour");
			fields[165] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.Triage.__internal_x_context__AttendanceKPIConfig_" + componentIdentifier, "BO-1087100007-AWAITINGTRIAGEBREACHKPITEXTCOLOUR", "AwaitingTriageBreachKPITextColour");
			fields[166] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.Triage.__internal_x_context__CurrentAttendance_" + componentIdentifier, "BO-1004100025-ID", "ID_EmergencyAttendance");
			fields[167] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.Triage.__internal_x_context__CurrentAttendance_" + componentIdentifier, "BO-1004100025-REGISTRATIONDATETIME", "RegistrationDateTime");
			fields[168] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.Triage.__internal_x_context__CurrentAttendance_" + componentIdentifier, "BO-1004100025-AGEATATTENDANCE", "AgeAtAttendance");
			fields[169] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.Triage.__internal_x_context__CurrentAttendance_" + componentIdentifier, "BO-1004100025-ARRIVALDATETIME", "ArrivalDateTime");
			fields[170] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.Triage.__internal_x_context__CurrentAttendance_" + componentIdentifier, "BO-1004100025-DISCHARGEDATETIME", "DischargeDateTime");
			fields[171] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.Triage.__internal_x_context__CurrentAttendance_" + componentIdentifier, "BO-1004100025-CARECONTEXT", "CareContext");
			fields[172] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.Triage.__internal_x_context__CurrentAttendance_" + componentIdentifier, "BO-1004100025-URGENCYLEVEL", "UrgencyLevel");
			fields[173] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.Triage.__internal_x_context__CurrentAttendance_" + componentIdentifier, "BO-1004100025-CONCLUSIONDATETIME", "ConclusionDateTime");
			fields[174] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.Triage.__internal_x_context__CurrentAttendance_" + componentIdentifier, "BO-1004100025-BEDTYPEREQUESTED", "BedTypeRequested");
			fields[175] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.Triage.__internal_x_context__CurrentAttendance_" + componentIdentifier, "BO-1004100025-MC", "MC");
			fields[176] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.Triage.__internal_x_context__CurrentAttendance_" + componentIdentifier, "BO-1004100025-COTA", "COTA");
			fields[177] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.Triage.__internal_x_context__CurrentAttendance_" + componentIdentifier, "BO-1004100025-PCG1", "PCG1");
			fields[178] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.Triage.__internal_x_context__CurrentAttendance_" + componentIdentifier, "BO-1004100025-PCG2", "PCG2");
			fields[179] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.Triage.__internal_x_context__CurrentAttendance_" + componentIdentifier, "BO-1004100025-HAR", "HAR");
			fields[180] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.Triage.__internal_x_context__CurrentAttendance_" + componentIdentifier, "BO-1004100025-PURCHASER", "Purchaser");
			fields[181] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.Triage.__internal_x_context__CurrentAttendance_" + componentIdentifier, "BO-1004100025-SEQUENCENUMBER", "SequenceNumber");
			fields[182] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.Triage.__internal_x_context__CurrentAttendance_" + componentIdentifier, "BO-1004100025-CUSTOMID", "CustomID");
			fields[183] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.Triage.__internal_x_context__CurrentAttendance_" + componentIdentifier, "BO-1004100025-ENDOFREGISTRATIONDATETIME", "EndOfRegistrationDateTime");
			fields[184] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.Triage.__internal_x_context__CurrentAttendance_" + componentIdentifier, "BO-1004100025-MODEOFARRIVAL", "ModeOfArrival");
			fields[185] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.Triage.__internal_x_context__CurrentEpisode_" + componentIdentifier, "BO-1004100024-ID", "ID_EmergencyEpisode");
			fields[186] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.Triage.__internal_x_context__CurrentEpisode_" + componentIdentifier, "BO-1004100024-INJURYDATETIME", "InjuryDateTime");
			fields[187] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.Triage.__internal_x_context__CurrentEpisode_" + componentIdentifier, "BO-1004100024-PRESENTINGCOMPLAINT", "PresentingComplaint");
			fields[188] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.Triage.__internal_x_context__CurrentEpisode_" + componentIdentifier, "BO-1004100024-CATEGORY", "Category");
			fields[189] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.Triage.__internal_x_context__CurrentEpisode_" + componentIdentifier, "BO-1004100024-MEDPATIENTCONSENT", "MedPatientConsent");
			fields[190] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.Triage.__internal_x_context__OldTrackingArea_" + componentIdentifier, "BO-1087100001-ID", "ID_TrackingArea");
			fields[191] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.Triage.__internal_x_context__AllocatedNurse_" + componentIdentifier, "BO-1086100034-ID", "ID_SeenByHCP");
			fields[192] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.Triage.__internal_x_context__AllocatedNurse_" + componentIdentifier, "BO-1086100034-PATIENT", "Patient");
			fields[193] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.Triage.__internal_x_context__AllocatedNurse_" + componentIdentifier, "BO-1086100034-EPISODE", "Episode");
			fields[194] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.Triage.__internal_x_context__AllocatedNurse_" + componentIdentifier, "BO-1086100034-ATTENDANCE", "Attendance");
			fields[195] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.Triage.__internal_x_context__AllocatedNurse_" + componentIdentifier, "BO-1086100034-TRACKINGAREA", "TrackingArea");
			fields[196] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.Triage.__internal_x_context__AllocatedNurse_" + componentIdentifier, "BO-1086100034-ALLOCATEDDATETIME", "AllocatedDateTime");
			fields[197] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.Triage.__internal_x_context__AllocatedNurse_" + componentIdentifier, "BO-1086100034-SEENDATETIME", "SeenDateTime");
			fields[198] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.Triage.__internal_x_context__AllocatedNurse_" + componentIdentifier, "BO-1086100034-COMPLETEDDATETIME", "CompletedDateTime");
			fields[199] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.Triage.__internal_x_context__AllocatedNurse_" + componentIdentifier, "BO-1086100034-SIGNOFF", "SignOff");
			return fields;
		}
