...
public class GenForm extends FormBridge
{
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[152] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.SystemReview.__internal_x_context__SelectedSystemReview_" + componentIdentifier, "BO-1086100022-ID", "ID_SystemsReview");
			fields[153] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.SystemReview.__internal_x_context__SelectedSystemReview_" + componentIdentifier, "BO-1086100022-PATIENT", "Patient");
			fields[154] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.SystemReview.__internal_x_context__SelectedSystemReview_" + componentIdentifier, "BO-1086100022-EPISODE", "Episode");
			fields[155] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.SystemReview.__internal_x_context__SelectedSystemReview_" + componentIdentifier, "BO-1086100022-ATTENDANCE", "Attendance");
			fields[156] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.SystemReview.__internal_x_context__SelectedSystemReview_" + componentIdentifier, "BO-1086100022-SYSTEMREVIEWNOTE", "SystemReviewNote");
			fields[157] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.SystemReview.__internal_x_context__SelectedSystemReview_" + componentIdentifier, "BO-1086100022-SYSTEMS", "Systems");
			fields[158] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.SystemReview.__internal_x_context__SelectedSystemReview_" + componentIdentifier, "BO-1086100022-ISCORRECTED", "IsCorrected");
			fields[159] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.SystemReview.__internal_x_context__SelectedSystemReview_" + componentIdentifier, "BO-1086100022-CORRECTIONCOMMENTS", "CorrectionComments");
			fields[160] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.SystemReview.__internal_x_context__PatientRef_" + componentIdentifier, "BO-1001100000-ID", "ID_Patient");
			fields[161] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.SystemReview.__internal_x_context__CareContextRef_" + componentIdentifier, "BO-1004100019-ID", "ID_CareContext");
			fields[162] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.SystemReview.__internal_x_context__EpisodeOfCareRef_" + componentIdentifier, "BO-1004100018-ID", "ID_EpisodeOfCare");
			fields[163] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.SystemReview.__internal_x_context__ClinicalProblemRef_" + componentIdentifier, "BO-1073100005-ID", "ID_ClinicalProblem");
			return fields;
		}
