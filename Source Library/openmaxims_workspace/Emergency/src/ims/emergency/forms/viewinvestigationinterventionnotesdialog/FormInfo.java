...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "ViewInvestigationInterventionNotesDialog";
	}
	public int getWidth()
	{
		return 648;
	...
	{
		return "_lv_Emergency.ViewInvestigationInterventionNotesDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
