...
abstract public class Handlers implements ims.framework.UILogic, IFormUILogicCode
{
	...
	abstract protected void onBtnSafeguardingClick() throws ims.framework.exceptions.PresentationLogicException;
	abstract protected void onBtnAmbulanceHandoverClick() throws ims.framework.exceptions.PresentationLogicException;
	abstract protected void onBtnSeenCompleteNurseClick() throws ims.framework.exceptions.PresentationLogicException;
	...
	abstract protected void onBtnRetriageClick() throws ims.framework.exceptions.PresentationLogicException;
	...
	abstract protected void onCcDischargePrescriptionValueChanged() throws ims.framework.exceptions.PresentationLogicException;
	...
	public final void setContext(ims.framework.UIComponentEngine engine, GenForm form)
	{
		...
		this.form.btnSafeguarding().setClickEvent(new Click()
		{
			private static final long serialVersionUID = 1L;
			public void handle() throws ims.framework.exceptions.PresentationLogicException
			{
				onBtnSafeguardingClick();
			}
		});
		this.form.btnAmbulanceHandover().setClickEvent(new Click()
		{
			private static final long serialVersionUID = 1L;
			public void handle() throws ims.framework.exceptions.PresentationLogicException
			{
				onBtnAmbulanceHandoverClick();
			}
		});
		this.form.btnSeenCompleteNurse().setClickEvent(new Click()
		{
			private static final long serialVersionUID = 1L;
			public void handle() throws ims.framework.exceptions.PresentationLogicException
			{
		...
		this.form.btnRetriage().setClickEvent(new Click()
		{
			private static final long serialVersionUID = 1L;
			public void handle() throws ims.framework.exceptions.PresentationLogicException
			{
		...
		this.form.lyrPatientTriage().tabPAWS().setTabActivatedEvent(new ims.framework.delegates.TabActivated()
		{
			private static final long serialVersionUID = 1L;
			public void handle() throws ims.framework.exceptions.PresentationLogicException
			{
				onlyrPatientTriagetabPAWSActivated();
			}
		});
		...
		this.form.lyrPatientTriage().tabPagePrescription().setTabActivatedEvent(new ims.framework.delegates.TabActivated()
		{
			private static final long serialVersionUID = 1L;
			public void handle() throws ims.framework.exceptions.PresentationLogicException
			{
				onlyrPatientTriagetabPagePrescriptionActivated();
			}
		});
		...
		this.form.lyrPatientTriage().tabPagePrescription().setccDischargePrescriptionValueChangedEvent(new ValueChanged()
		{
			private static final long serialVersionUID = 1L;
			public void handle() throws ims.framework.exceptions.PresentationLogicException
			{
				onCcDischargePrescriptionValueChanged();
			}
		});
	...
	private void onlyrPatientTriagetabPAWSActivated()
	{
		this.form.lyrPatientTriage().showtabPAWS();
		onlyrPatientTriageTabChanged(this.form.lyrPatientTriage().tabPAWS());
	}
	...
	private void onlyrPatientTriagetabPagePrescriptionActivated()
	{
		this.form.lyrPatientTriage().showtabPagePrescription();
		onlyrPatientTriageTabChanged(this.form.lyrPatientTriage().tabPagePrescription());
	}
