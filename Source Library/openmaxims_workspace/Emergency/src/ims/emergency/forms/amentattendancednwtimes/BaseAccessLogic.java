...
public class BaseAccessLogic extends FormAccessLogic implements Serializable
{
	...
	{
		if(!form.getGlobalContext().Emergency.getEmergencyAttendanceForTimeAmendmentsIsNotNull())
			return false;
		if(!form.getGlobalContext().Emergency.getAmendAttendanceDNWTimesIsNotNull())
			return false;
