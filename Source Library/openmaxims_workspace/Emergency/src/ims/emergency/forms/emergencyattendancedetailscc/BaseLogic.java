...
public abstract class BaseLogic extends Handlers implements IComponent
{
	...
	{
		this.form.cmbRequestedBedType().setValue((ims.core.vo.lookups.BedTypeRequested)domain.getLookupService().getDefaultInstance(ims.core.vo.lookups.BedTypeRequested.class, engine.getFormName().getID(), ims.core.vo.lookups.BedTypeRequested.TYPE_ID));
	}
	...
	protected final void oncmbPatientStatusValueSet(Object value)
	{
		...
		if(value == null)
		{
			if(listOfValues != null && listOfValues.size() > 0)
			{
				for(int x = 0; x < listOfValues.size(); x++)
				{
					ims.emergency.vo.lookups.TriagePatientStatus existingInstance = (ims.emergency.vo.lookups.TriagePatientStatus)listOfValues.get(x);
					if(!existingInstance.isActive())
					{
		...
		else if(value instanceof ims.emergency.vo.lookups.TriagePatientStatus)
		{
			ims.emergency.vo.lookups.TriagePatientStatus instance = (ims.emergency.vo.lookups.TriagePatientStatus)value;
	...
	protected final void bindcmbPatientStatusLookup()
	{
		...
		ims.emergency.vo.lookups.TriagePatientStatusCollection lookupCollection = ims.emergency.vo.lookups.LookupHelper.getTriagePatientStatus(this.domain.getLookupService());
		for(int x = 0; x < lookupCollection.size(); x++)
		{
	...
	{
		ims.emergency.vo.lookups.TriagePatientStatus instance = ims.emergency.vo.lookups.LookupHelper.getTriagePatientStatusInstance(this.domain.getLookupService(), id);
		if(instance != null)
			this.form.cmbPatientStatus().setValue(instance);
	}
	protected final void defaultcmbPatientStatusLookupValue()
	{
		this.form.cmbPatientStatus().setValue((ims.emergency.vo.lookups.TriagePatientStatus)domain.getLookupService().getDefaultInstance(ims.emergency.vo.lookups.TriagePatientStatus.class, engine.getFormName().getID(), ims.emergency.vo.lookups.TriagePatientStatus.TYPE_ID));
	}
