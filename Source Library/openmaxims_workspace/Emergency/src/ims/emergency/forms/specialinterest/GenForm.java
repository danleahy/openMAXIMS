...
public class GenForm extends FormBridge
{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1011), new Integer(anchoringHelper12.getX()), new Integer(anchoringHelper12.getY()), new Integer(anchoringHelper12.getWidth()), new Integer(anchoringHelper12.getHeight()), new Integer(startTabIndex.intValue() + 7), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Edit", Boolean.TRUE, null, Boolean.FALSE, Boolean.FALSE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.SpecialInterest.__internal_x_context__SelectedSpecialInterest_" + componentIdentifier, "BO-1086100024-ID", "ID_SpecialInterestDetail");
			fields[145] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.SpecialInterest.__internal_x_context__SelectedSpecialInterest_" + componentIdentifier, "BO-1086100024-PATIENT", "Patient");
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.SpecialInterest.__internal_x_context__SelectedSpecialInterest_" + componentIdentifier, "BO-1086100024-EPISODE", "Episode");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.SpecialInterest.__internal_x_context__SelectedSpecialInterest_" + componentIdentifier, "BO-1086100024-ATTENDANCE", "Attendance");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.SpecialInterest.__internal_x_context__SelectedSpecialInterest_" + componentIdentifier, "BO-1086100024-STARTDATETIME", "StartDateTime");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.SpecialInterest.__internal_x_context__SelectedSpecialInterest_" + componentIdentifier, "BO-1086100024-COMPLETEDDATETIME", "CompletedDateTime");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.SpecialInterest.__internal_x_context__SelectedSpecialInterest_" + componentIdentifier, "BO-1086100024-SPECIALINTERESTCATEGORY", "SpecialInterestCategory");
			return fields;
		}
