...
public class Logic extends BaseLogic
{
	...
	private static final int NOTE_LENGTH       = 5000;	//wdev-15998
	...
	{
		form.imbSearch().setFocus();	//wdev-15998
		open();
	}
	...
	public String[] validateUIErrorsMode()
	{
		ArrayList<String> errors = new ArrayList<String>();
		String ValLim = form.ctnDetails().richNote().getValue().toString(); 
		if( ValLim != null )
		{
			if( ValLim.length() > NOTE_LENGTH)
				errors.add(" Default Triage Note has too many characters.");
		}
