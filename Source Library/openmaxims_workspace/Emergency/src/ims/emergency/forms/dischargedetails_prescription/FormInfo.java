...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "DischargeDetails_Prescription";
	}
	public int getWidth()
	{
		return 568;
	...
	{
		return new String[] { "_cv_Emergency.MedsAlreadyAddedInPrescription", "_cv_Emergency.EDPrescriptionRef", "_cv_Core.RieMessage", "_cv_Emergency.PrescriptionDrug" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Emergency.DischargeDetails_Prescription.__internal_x_context__" + String.valueOf(getFormId());
	}
