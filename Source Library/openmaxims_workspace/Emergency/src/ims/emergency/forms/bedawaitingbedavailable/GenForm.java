...
public class GenForm extends FormBridge
{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1006), new Integer(anchoringHelper6.getX()), new Integer(anchoringHelper6.getY()), new Integer(anchoringHelper6.getWidth()), new Integer(anchoringHelper6.getHeight()), new Integer(startTabIndex.intValue() + 6), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Remove Bed Request", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(DateTimeControl.class, new Object[] { control, new Integer(startControlID.intValue() + 1009), new Integer(anchoringHelper9.getX()), new Integer(anchoringHelper9.getY()), new Integer(anchoringHelper9.getWidth()), new Integer(anchoringHelper9.getHeight()), new Integer(startTabIndex.intValue() + 5), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT,Boolean.TRUE, null, Boolean.FALSE, null, Boolean.FALSE, null}));
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[155] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.BedAwaitingBedAvailable.__internal_x_context__currentBedAvailability_" + componentIdentifier, "BO-1086100001-ID", "ID_BedAvailability");
			fields[156] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.BedAwaitingBedAvailable.__internal_x_context__currentBedAvailability_" + componentIdentifier, "BO-1086100001-PATIENT", "Patient");
			fields[157] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.BedAwaitingBedAvailable.__internal_x_context__currentBedAvailability_" + componentIdentifier, "BO-1086100001-EPISODE", "Episode");
			fields[158] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.BedAwaitingBedAvailable.__internal_x_context__currentBedAvailability_" + componentIdentifier, "BO-1086100001-ATTENDANCE", "Attendance");
			fields[159] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.BedAwaitingBedAvailable.__internal_x_context__currentBedAvailability_" + componentIdentifier, "BO-1086100001-TRACKINGAREA", "TrackingArea");
			fields[160] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.BedAwaitingBedAvailable.__internal_x_context__currentBedAvailability_" + componentIdentifier, "BO-1086100001-AWAITINGDATETIME", "AwaitingDateTime");
			fields[161] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.BedAwaitingBedAvailable.__internal_x_context__currentBedAvailability_" + componentIdentifier, "BO-1086100001-AVAILABLEDATETIME", "AvailableDateTime");
			fields[162] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.BedAwaitingBedAvailable.__internal_x_context__currentTracking_" + componentIdentifier, "BO-1086100005-ID", "ID_Tracking");
			fields[163] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.BedAwaitingBedAvailable.__internal_x_context__currentTracking_" + componentIdentifier, "BO-1086100005-CURRENTAREA", "CurrentArea");
			fields[164] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.BedAwaitingBedAvailable.__internal_x_context__currentTracking_" + componentIdentifier, "BO-1086100005-ISDISCHARGED", "IsDischarged");
			fields[165] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.BedAwaitingBedAvailable.__internal_x_context__currentTracking_" + componentIdentifier, "BO-1086100005-PATIENT", "Patient");
			return fields;
		}
