...
public class Logic extends BaseLogic
{
	...
	private PendingEmergencyAdmissionShortVo populatePendingAdmission(TrackingForBedAvailabilityVo tracking)
	{
		...
		{
			PasEventForPendingEmergencyAdmissionShortVo newPasEvent = new PasEventForPendingEmergencyAdmissionShortVo();
			...
			newPasEvent.setService(pendingAdmission.getService());
