...
public class GenForm extends FormBridge
{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1010), new Integer(anchoringHelper11.getX()), new Integer(anchoringHelper11.getY()), new Integer(anchoringHelper11.getWidth()), new Integer(anchoringHelper11.getHeight()), new Integer(startTabIndex.intValue() + 9), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Edit", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		Grid m_grdAdviceLefletTemp = (Grid)factory.getControl(Grid.class, new Object[] { control, new Integer(startControlID.intValue() + 1017), new Integer(anchoringHelper18.getX()), new Integer(anchoringHelper18.getY()), new Integer(anchoringHelper18.getWidth()), new Integer(anchoringHelper18.getHeight()), new Integer(startTabIndex.intValue() + 1), ControlState.EDITABLE, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT,Boolean.FALSE, Boolean.FALSE, new Integer(24), Boolean.TRUE, contextMenus.Emergency.contextMenuDischargeAdviceTransport, Boolean.FALSE, Boolean.FALSE, new Integer(0), null, Boolean.FALSE, Boolean.TRUE});
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.DischargeDetails_AdviceTransport.__internal_x_context__CareContext_" + componentIdentifier, "BO-1004100019-ID", "ID_CareContext");
			fields[145] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.DischargeDetails_AdviceTransport.__internal_x_context__MainProblem_" + componentIdentifier, "BO-1073100005-ID", "ID_ClinicalProblem");
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.DischargeDetails_AdviceTransport.__internal_x_context__Record_" + componentIdentifier, "BO-1086100026-ID", "ID_DischargeServicesAndAdvice");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.DischargeDetails_AdviceTransport.__internal_x_context__Record_" + componentIdentifier, "BO-1086100026-PATIENT", "Patient");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.DischargeDetails_AdviceTransport.__internal_x_context__Record_" + componentIdentifier, "BO-1086100026-EPISODE", "Episode");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.DischargeDetails_AdviceTransport.__internal_x_context__Record_" + componentIdentifier, "BO-1086100026-ATTENDANCE", "Attendance");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.DischargeDetails_AdviceTransport.__internal_x_context__Record_" + componentIdentifier, "BO-1086100026-TRANSPORTARRANGEDTYPE", "TransportArrangedType");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.DischargeDetails_AdviceTransport.__internal_x_context__Record_" + componentIdentifier, "BO-1086100026-TRANSPORTDATETIME", "TransportDateTime");
			fields[152] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.DischargeDetails_AdviceTransport.__internal_x_context__Record_" + componentIdentifier, "BO-1086100026-COMMENTS", "Comments");
			fields[153] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.DischargeDetails_AdviceTransport.__internal_x_context__Record_" + componentIdentifier, "BO-1086100026-BOOKINGNO", "BookingNo");
			return fields;
		}
