...
public class GenForm extends FormBridge
{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1010), new Integer(anchoringHelper11.getX()), new Integer(anchoringHelper11.getY()), new Integer(anchoringHelper11.getWidth()), new Integer(anchoringHelper11.getHeight()), new Integer(startTabIndex.intValue() + 7), ControlState.DISABLED, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFTRIGHT,Boolean.TRUE, new Integer(0), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
		...
		super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1011), new Integer(anchoringHelper12.getX()), new Integer(anchoringHelper12.getY()), new Integer(anchoringHelper12.getWidth()), new Integer(anchoringHelper12.getHeight()), new Integer(startTabIndex.intValue() + 6), ControlState.DISABLED, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFTRIGHT,Boolean.FALSE, new Integer(0), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
		RuntimeAnchoring anchoringHelper13 = new RuntimeAnchoring(designSize, runtimeSize, 144, 79, 528, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT);
		super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1012), new Integer(anchoringHelper13.getX()), new Integer(anchoringHelper13.getY()), new Integer(anchoringHelper13.getWidth()), new Integer(anchoringHelper13.getHeight()), new Integer(startTabIndex.intValue() + 4), ControlState.DISABLED, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT,Boolean.FALSE, new Integer(0), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
		RuntimeAnchoring anchoringHelper14 = new RuntimeAnchoring(designSize, runtimeSize, 144, 8, 528, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT);
		super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1013), new Integer(anchoringHelper14.getX()), new Integer(anchoringHelper14.getY()), new Integer(anchoringHelper14.getWidth()), new Integer(anchoringHelper14.getHeight()), new Integer(startTabIndex.intValue() + 1), ControlState.DISABLED, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT,Boolean.FALSE, new Integer(0), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));

		// Date Time Controls
		RuntimeAnchoring anchoringHelper15 = new RuntimeAnchoring(designSize, runtimeSize, 168, 520, 176, 20, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT);
		super.addControl(factory.getControl(DateTimeControl.class, new Object[] { control, new Integer(startControlID.intValue() + 1014), new Integer(anchoringHelper15.getX()), new Integer(anchoringHelper15.getY()), new Integer(anchoringHelper15.getWidth()), new Integer(anchoringHelper15.getHeight()), new Integer(startTabIndex.intValue() + 9), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT,Boolean.TRUE, null, Boolean.FALSE, null, Boolean.TRUE, null}));

		// Query ComboBox Controls
		RuntimeAnchoring anchoringHelper16 = new RuntimeAnchoring(designSize, runtimeSize, 168, 496, 352, 21, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT);
		ComboBox m_qmbAssessmentHCPTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1015), new Integer(anchoringHelper16.getX()), new Integer(anchoringHelper16.getY()), new Integer(anchoringHelper16.getWidth()), new Integer(anchoringHelper16.getHeight()), new Integer(startTabIndex.intValue() + 8), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.TRUE, new Integer(1), null, Boolean.TRUE, new Integer(-1), Boolean.FALSE});
		...
		RuntimeAnchoring anchoringHelper17 = new RuntimeAnchoring(designSize, runtimeSize, 144, 30, 528, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT);
		...
		// CheckBox Controls
		RuntimeAnchoring anchoringHelper18 = new RuntimeAnchoring(designSize, runtimeSize, 144, 57, 104, 16, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		// Grid Controls
		RuntimeAnchoring anchoringHelper19 = new RuntimeAnchoring(designSize, runtimeSize, 16, 104, 656, 264, ims.framework.enumerations.ControlAnchoring.ALL);
		Grid m_grdPrioritiesTemp = (Grid)factory.getControl(Grid.class, new Object[] { control, new Integer(startControlID.intValue() + 1018), new Integer(anchoringHelper19.getX()), new Integer(anchoringHelper19.getY()), new Integer(anchoringHelper19.getWidth()), new Integer(anchoringHelper19.getHeight()), new Integer(startTabIndex.intValue() + 5), ControlState.EDITABLE, ControlState.EDITABLE, ims.framework.enumerations.ControlAnchoring.ALL,Boolean.FALSE, Boolean.FALSE, new Integer(24), Boolean.TRUE, null, Boolean.FALSE, Boolean.FALSE, new Integer(0), null, Boolean.FALSE, Boolean.TRUE});
		...
		// Picture Controls
		RuntimeAnchoring anchoringHelper20 = new RuntimeAnchoring(designSize, runtimeSize, 168, 372, 24, 24, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT);
	...
	public class LocalContext extends ContextBridge
	{
		...
		public LocalContext(Context context, ims.framework.FormInfo formInfo, String componentIdentifier)
		{
			...
			cxl_TriageAssessmentAction = new ims.framework.ContextVariable("TriageAssessmentAction", prefix + "_lv_Emergency.TriageProtocolAssessment.__internal_x_context__TriageAssessmentAction_" + componentIdentifier + "");
			cxl_PatientWeighedConfirm = new ims.framework.ContextVariable("PatientWeighedConfirm", prefix + "_lv_Emergency.TriageProtocolAssessment.__internal_x_context__PatientWeighedConfirm_" + componentIdentifier + "");
		}
		...
		public boolean getTriageAssessmentActionIsNotNull()
		{
			return !cxl_TriageAssessmentAction.getValueIsNull(context);
		}
		public ims.emergency.vo.enums.TriageAssessmentAction getTriageAssessmentAction()
		{
			return (ims.emergency.vo.enums.TriageAssessmentAction)cxl_TriageAssessmentAction.getValue(context);
		}
		public void setTriageAssessmentAction(ims.emergency.vo.enums.TriageAssessmentAction value)
		{
			cxl_TriageAssessmentAction.setValue(context, value);
		}
		private ims.framework.ContextVariable cxl_TriageAssessmentAction = null;
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.TriageProtocolAssessment.__internal_x_context__Triage_" + componentIdentifier, "BO-1086100004-ID", "ID_Triage");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.TriageProtocolAssessment.__internal_x_context__Triage_" + componentIdentifier, "BO-1086100004-CURRENTTRIAGEPRIORITY", "CurrentTriagePriority");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.TriageProtocolAssessment.__internal_x_context__Triage_" + componentIdentifier, "BO-1086100004-CURRENTTRIAGEPATHWAY", "CurrentTriagePathway");
			fields[152] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.TriageProtocolAssessment.__internal_x_context__Triage_" + componentIdentifier, "BO-1086100004-EPISODE", "Episode");
			fields[153] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.TriageProtocolAssessment.__internal_x_context__Triage_" + componentIdentifier, "BO-1086100004-TRIAGEPRIORITYCHANGE", "TriagePriorityChange");
			fields[154] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.TriageProtocolAssessment.__internal_x_context__SelectedProtocolDiscriminator_" + componentIdentifier, "BO-1087100011-ID", "ID_ProtocolDiscriminator");
			fields[155] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.TriageProtocolAssessment.__internal_x_context__SelectedProtocolDiscriminator_" + componentIdentifier, "BO-1087100011-PRIORITY", "Priority");
			fields[156] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.TriageProtocolAssessment.__internal_x_context__SelectedManchesterTriageProtocol_" + componentIdentifier, "BO-1087100010-ID", "ID_ManchesterTriageProtocolConfiguration");
			fields[157] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.TriageProtocolAssessment.__internal_x_context__SelectedManchesterTriageProtocol_" + componentIdentifier, "BO-1087100010-PROTOCOLNAME", "ProtocolName");
			fields[158] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.TriageProtocolAssessment.__internal_x_context__SelectedManchesterTriageProtocol_" + componentIdentifier, "BO-1087100010-DEFAULTPRIORITY", "DefaultPriority");
			fields[159] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.TriageProtocolAssessment.__internal_x_context__EmergencyEpisode_" + componentIdentifier, "BO-1004100024-ID", "ID_EmergencyEpisode");
			fields[160] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.TriageProtocolAssessment.__internal_x_context__EmergencyEpisode_" + componentIdentifier, "BO-1004100024-INJURYDATETIME", "InjuryDateTime");
			fields[161] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.TriageProtocolAssessment.__internal_x_context__EmergencyEpisode_" + componentIdentifier, "BO-1004100024-PRESENTINGCOMPLAINT", "PresentingComplaint");
			fields[162] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.TriageProtocolAssessment.__internal_x_context__EmergencyEpisode_" + componentIdentifier, "BO-1004100024-CATEGORY", "Category");
			fields[163] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.TriageProtocolAssessment.__internal_x_context__EmergencyEpisode_" + componentIdentifier, "BO-1004100024-MEDPATIENTCONSENT", "MedPatientConsent");
			fields[164] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.TriageProtocolAssessment.__internal_x_context__TriageProtocolAssessment_" + componentIdentifier, "BO-1086100018-ID", "ID_TriageProtocolAssessment");
			fields[165] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.TriageProtocolAssessment.__internal_x_context__TriageProtocolAssessment_" + componentIdentifier, "BO-1086100018-TRIAGEPRIORITY", "TriagePriority");
			fields[166] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.TriageProtocolAssessment.__internal_x_context__TriageProtocolAssessment_" + componentIdentifier, "BO-1086100018-PATIENT", "Patient");
			fields[167] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.TriageProtocolAssessment.__internal_x_context__TriageProtocolAssessment_" + componentIdentifier, "BO-1086100018-EPISODE", "Episode");
			fields[168] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.TriageProtocolAssessment.__internal_x_context__TriageProtocolAssessment_" + componentIdentifier, "BO-1086100018-ATTENDANCE", "Attendance");
			fields[169] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.TriageProtocolAssessment.__internal_x_context__TriageProtocolAssessment_" + componentIdentifier, "BO-1086100018-ISMAIN", "IsMain");
			fields[170] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.TriageProtocolAssessment.__internal_x_context__TriageProtocolAssessment_" + componentIdentifier, "BO-1086100018-TRIAGEPROTOCOL", "TriageProtocol");
			fields[171] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.TriageProtocolAssessment.__internal_x_context__TriageProtocolAssessment_" + componentIdentifier, "BO-1086100018-ASSESSMENTDATETIME", "AssessmentDateTime");
			return fields;
		}
