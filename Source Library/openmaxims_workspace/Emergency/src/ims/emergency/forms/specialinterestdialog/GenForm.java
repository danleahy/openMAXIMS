...
public class GenForm extends FormBridge
{
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, "_cv_Emergency.SpecialInterestDetails", "BO-1086100024-ID", "ID_SpecialInterestDetail");
			fields[145] = new ims.framework.ReportField(this.context, "_cv_Emergency.SpecialInterestDetails", "BO-1086100024-PATIENT", "Patient");
			fields[146] = new ims.framework.ReportField(this.context, "_cv_Emergency.SpecialInterestDetails", "BO-1086100024-EPISODE", "Episode");
			fields[147] = new ims.framework.ReportField(this.context, "_cv_Emergency.SpecialInterestDetails", "BO-1086100024-ATTENDANCE", "Attendance");
			fields[148] = new ims.framework.ReportField(this.context, "_cv_Emergency.SpecialInterestDetails", "BO-1086100024-STARTDATETIME", "StartDateTime");
			fields[149] = new ims.framework.ReportField(this.context, "_cv_Emergency.SpecialInterestDetails", "BO-1086100024-COMPLETEDDATETIME", "CompletedDateTime");
			fields[150] = new ims.framework.ReportField(this.context, "_cv_Emergency.SpecialInterestDetails", "BO-1086100024-SPECIALINTERESTCATEGORY", "SpecialInterestCategory");
			return fields;
		}
