...
public class GenForm extends FormBridge
{
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[144] = new ims.framework.ReportField(this.context, "_cv_Emergency.MedicNote", "BO-1086100015-ID", "ID_MedicNotes");
			fields[145] = new ims.framework.ReportField(this.context, "_cv_Emergency.MedicNote", "BO-1086100015-PATIENT", "Patient");
			fields[146] = new ims.framework.ReportField(this.context, "_cv_Emergency.MedicNote", "BO-1086100015-EPISODE", "Episode");
			fields[147] = new ims.framework.ReportField(this.context, "_cv_Emergency.MedicNote", "BO-1086100015-ATTENDANCE", "Attendance");
			fields[148] = new ims.framework.ReportField(this.context, "_cv_Emergency.MedicNote", "BO-1086100015-MEDICNOTE", "MedicNote");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.MedicNotes.__internal_x_context__Patient_" + componentIdentifier, "BO-1001100000-ID", "ID_Patient");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.MedicNotes.__internal_x_context__EpisodeOfCare_" + componentIdentifier, "BO-1004100018-ID", "ID_EpisodeOfCare");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.MedicNotes.__internal_x_context__CareContext_" + componentIdentifier, "BO-1004100019-ID", "ID_CareContext");
			fields[152] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.MedicNotes.__internal_x_context__RIERecord_" + componentIdentifier, "BO-1086100015-ID", "ID_MedicNotes");
			fields[153] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.MedicNotes.__internal_x_context__RIERecord_" + componentIdentifier, "BO-1086100015-PATIENT", "Patient");
			fields[154] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.MedicNotes.__internal_x_context__RIERecord_" + componentIdentifier, "BO-1086100015-EPISODE", "Episode");
			fields[155] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.MedicNotes.__internal_x_context__RIERecord_" + componentIdentifier, "BO-1086100015-ATTENDANCE", "Attendance");
			fields[156] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.MedicNotes.__internal_x_context__RIERecord_" + componentIdentifier, "BO-1086100015-MEDICNOTE", "MedicNote");
			fields[157] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.MedicNotes.__internal_x_context__ClinicalProblem_" + componentIdentifier, "BO-1073100005-ID", "ID_ClinicalProblem");
			fields[158] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.MedicNotes.__internal_x_context__LoggedHCP_" + componentIdentifier, "BO-1006100000-ID", "ID_Hcp");
			return fields;
		}
