...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "AmendAttendanceTimesDialog";
	}
	public int getWidth()
	{
		return 760;
	...
	{
		return new String[] { "_cv_Emergency.AmendAttendanceTimes" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Emergency.AmendAttendanceTimesDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
