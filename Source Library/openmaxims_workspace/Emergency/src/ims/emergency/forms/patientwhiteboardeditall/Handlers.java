...
abstract public class Handlers implements ims.framework.UILogic, IFormUILogicCode
{
	...
	abstract protected void onDyngrCheckActionsCellButtonClicked(ims.framework.controls.DynamicGridCell cell);
	...
	public final void setContext(ims.framework.UIEngine engine, GenForm form)
	{
		...
		this.form.dyngrCheckActions().setDynamicGridCellButtonClickedEvent(new DynamicGridCellButtonClicked()
		{
			private static final long serialVersionUID = 1L;
			...
			{
				onDyngrCheckActionsCellButtonClicked(cell);
			}
		});
