...
public class GenForm extends FormBridge
{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		// Label Controls
		RuntimeAnchoring anchoringHelper1 = new RuntimeAnchoring(designSize, runtimeSize, 714, 16, 258, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1000), new Integer(anchoringHelper1.getX()), new Integer(anchoringHelper1.getY()), new Integer(anchoringHelper1.getWidth()), new Integer(anchoringHelper1.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "These actions will be applied for all patients:", new Integer(1), null, new Integer(0)}));
		RuntimeAnchoring anchoringHelper2 = new RuntimeAnchoring(designSize, runtimeSize, 336, 74, 97, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1001), new Integer(anchoringHelper2.getX()), new Integer(anchoringHelper2.getY()), new Integer(anchoringHelper2.getWidth()), new Integer(anchoringHelper2.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Tracking Status:", new Integer(1), null, new Integer(0)}));
		RuntimeAnchoring anchoringHelper3 = new RuntimeAnchoring(designSize, runtimeSize, 8, 74, 34, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1002), new Integer(anchoringHelper3.getX()), new Integer(anchoringHelper3.getY()), new Integer(anchoringHelper3.getWidth()), new Integer(anchoringHelper3.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Area:", new Integer(1), null, new Integer(0)}));

		// Button Controls
		RuntimeAnchoring anchoringHelper4 = new RuntimeAnchoring(designSize, runtimeSize, 920, 764, 120, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT);
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1003), new Integer(anchoringHelper4.getX()), new Integer(anchoringHelper4.getY()), new Integer(anchoringHelper4.getWidth()), new Integer(anchoringHelper4.getHeight()), new Integer(startTabIndex.intValue() + 5), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Save", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		RuntimeAnchoring anchoringHelper5 = new RuntimeAnchoring(designSize, runtimeSize, 1048, 764, 120, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT);
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1004), new Integer(anchoringHelper5.getX()), new Integer(anchoringHelper5.getY()), new Integer(anchoringHelper5.getWidth()), new Integer(anchoringHelper5.getHeight()), new Integer(startTabIndex.intValue() + 6), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Cancel", Boolean.FALSE, null, Boolean.FALSE, Boolean.FALSE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));

		// ComboBox Controls
		RuntimeAnchoring anchoringHelper6 = new RuntimeAnchoring(designSize, runtimeSize, 440, 72, 256, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		RuntimeAnchoring anchoringHelper7 = new RuntimeAnchoring(designSize, runtimeSize, 48, 72, 248, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		RuntimeAnchoring anchoringHelper8 = new RuntimeAnchoring(designSize, runtimeSize, 714, 32, 454, 61, ims.framework.enumerations.ControlAnchoring.ALL);
		super.addControl(factory.getControl(DynamicGrid.class, new Object[] { control, new Integer(startControlID.intValue() + 1007), new Integer(anchoringHelper8.getX()), new Integer(anchoringHelper8.getY()), new Integer(anchoringHelper8.getWidth()), new Integer(anchoringHelper8.getHeight()), new Integer(startTabIndex.intValue() + 3), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, null, Boolean.TRUE, Boolean.FALSE, Boolean.TRUE}));
		RuntimeAnchoring anchoringHelper9 = new RuntimeAnchoring(designSize, runtimeSize, 8, 104, 1160, 656, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFTRIGHT);
		super.addControl(factory.getControl(DynamicGrid.class, new Object[] { control, new Integer(startControlID.intValue() + 1008), new Integer(anchoringHelper9.getX()), new Integer(anchoringHelper9.getY()), new Integer(anchoringHelper9.getWidth()), new Integer(anchoringHelper9.getHeight()), new Integer(startTabIndex.intValue() + 4), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFTRIGHT, null, Boolean.TRUE, Boolean.FALSE, Boolean.TRUE}));
	}
	...
	public DynamicGrid dyngrCheckActions()
	{
	...
	public static class Images implements java.io.Serializable
	{
		...
		public final class EmergencyImages implements java.io.Serializable
		{
			...
			private EmergencyImages()
			{
				...
				AttendanceNoComment48x48 = new ImageHelper(129235, "Images/Emergency/attendancenocomment.png", new Integer(48), new Integer(48));
				AttendanceWComment48x48 = new ImageHelper(129236, "Images/Emergency/attendancewithcomment.png", new Integer(48), new Integer(48));
				AttendanceNoComment24 = new ImageHelper(129237, "Images/Emergency/attendancenocomment24.png", new Integer(24), new Integer(24));
				AttendanceWComment24 = new ImageHelper(129238, "Images/Emergency/attendancewithcomment24.png", new Integer(24), new Integer(24));
			}
			...
			public final ims.framework.utils.Image AttendanceNoComment48x48;
			public final ims.framework.utils.Image AttendanceWComment48x48;
			public final ims.framework.utils.Image AttendanceNoComment24;
			public final ims.framework.utils.Image AttendanceWComment24;
		}
	...
	public class LocalContext extends ContextBridge
	{
		...
		public LocalContext(Context context, ims.framework.FormInfo formInfo, String componentIdentifier)
		{
			...
			cxl_PatientImagesList = new ims.framework.ContextVariable("PatientImagesList", prefix + "_lv_Emergency.PatientWhiteBoardEditAll.__internal_x_context__PatientImagesList_" + componentIdentifier + "");
			cxl_SelectedComboValue = new ims.framework.ContextVariable("SelectedComboValue", prefix + "_lv_Emergency.PatientWhiteBoardEditAll.__internal_x_context__SelectedComboValue_" + componentIdentifier + "");
			cxl_SelectedEvent = new ims.framework.ContextVariable("SelectedEvent", prefix + "_lv_Emergency.PatientWhiteBoardEditAll.__internal_x_context__SelectedEvent_" + componentIdentifier + "");
			cxl_WhiteBoardConfigVo = new ims.framework.ContextVariable("WhiteBoardConfigVo", prefix + "_lv_Emergency.PatientWhiteBoardEditAll.__internal_x_context__WhiteBoardConfigVo_" + componentIdentifier + "");
			cxl_SelectedArea = new ims.framework.ContextVariable("SelectedArea", prefix + "_lv_Emergency.PatientWhiteBoardEditAll.__internal_x_context__SelectedArea_" + componentIdentifier + "");
		}
		...
		public boolean getWhiteBoardConfigVoIsNotNull()
		{
			return !cxl_WhiteBoardConfigVo.getValueIsNull(context);
		}
		public ims.emergency.vo.WhiteBoardConfigVo getWhiteBoardConfigVo()
		{
			return (ims.emergency.vo.WhiteBoardConfigVo)cxl_WhiteBoardConfigVo.getValue(context);
		}
		public void setWhiteBoardConfigVo(ims.emergency.vo.WhiteBoardConfigVo value)
		{
			cxl_WhiteBoardConfigVo.setValue(context, value);
		}
		private ims.framework.ContextVariable cxl_WhiteBoardConfigVo = null;
		public boolean getSelectedAreaIsNotNull()
		{
			return !cxl_SelectedArea.getValueIsNull(context);
		}
		public ims.emergency.vo.TrackingAreaShortVo getSelectedArea()
		{
			return (ims.emergency.vo.TrackingAreaShortVo)cxl_SelectedArea.getValue(context);
		}
		public void setSelectedArea(ims.emergency.vo.TrackingAreaShortVo value)
		{
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[145] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.PatientWhiteBoardEditAll.__internal_x_context__WhiteBoardConfigVo_" + componentIdentifier, "BO-1087100018-ID", "ID_WhiteBoardConfig");
			fields[146] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.PatientWhiteBoardEditAll.__internal_x_context__WhiteBoardConfigVo_" + componentIdentifier, "BO-1087100018-ISACTIVE", "IsActive");
			fields[147] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.PatientWhiteBoardEditAll.__internal_x_context__WhiteBoardConfigVo_" + componentIdentifier, "BO-1087100018-COMMENTS", "Comments");
			fields[148] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.PatientWhiteBoardEditAll.__internal_x_context__WhiteBoardConfigVo_" + componentIdentifier, "BO-1087100018-REFRESHINTERVAL", "RefreshInterval");
			fields[149] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.PatientWhiteBoardEditAll.__internal_x_context__SelectedArea_" + componentIdentifier, "BO-1087100001-ID", "ID_TrackingArea");
			fields[150] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.PatientWhiteBoardEditAll.__internal_x_context__SelectedArea_" + componentIdentifier, "BO-1087100001-EDLOCATION", "EDLocation");
			fields[151] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.PatientWhiteBoardEditAll.__internal_x_context__SelectedArea_" + componentIdentifier, "BO-1087100001-AREANAMEDESCRIPTION", "AreaNameDescription");
			fields[152] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.PatientWhiteBoardEditAll.__internal_x_context__SelectedArea_" + componentIdentifier, "BO-1087100001-AREADISPLAYNAME", "AreaDisplayName");
			fields[153] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.PatientWhiteBoardEditAll.__internal_x_context__SelectedArea_" + componentIdentifier, "BO-1087100001-STATUS", "Status");
			fields[154] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.PatientWhiteBoardEditAll.__internal_x_context__SelectedArea_" + componentIdentifier, "BO-1087100001-ISOVERALLVIEW", "IsOverallView");
			fields[155] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.PatientWhiteBoardEditAll.__internal_x_context__SelectedArea_" + componentIdentifier, "BO-1087100001-ISREGISTRATIONAREA", "IsRegistrationArea");
			return fields;
		}
