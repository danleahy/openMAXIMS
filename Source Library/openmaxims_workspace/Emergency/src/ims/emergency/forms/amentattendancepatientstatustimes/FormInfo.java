...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "AmentAttendancePatientStatusTimes";
	}
	public int getWidth()
	{
		return 424;
	...
	{
		return new String[] { "_cv_Emergency.AmendAttendancePatientStatusTimes", "_cv_Emergency.EmergencyAttendanceForTimeAmendments" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Emergency.AmentAttendancePatientStatusTimes.__internal_x_context__" + String.valueOf(getFormId());
	}
