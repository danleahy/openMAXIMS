...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "EDWhiteboardOtherActions";
	}
	public int getWidth()
	{
		return 480;
	...
	{
		return new String[] { "_cv_Emergency.WhiteboardOtherAction" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Emergency.EDWhiteboardOtherActions.__internal_x_context__" + String.valueOf(getFormId());
	}
