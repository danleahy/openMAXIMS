...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "NoteCorrectionMosDialog";
	}
	public int getWidth()
	{
		return 528;
	...
	{
		return new String[] { "_cv_Pathways.BreachReasonCorrectionData" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Emergency.NoteCorrectionMosDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
