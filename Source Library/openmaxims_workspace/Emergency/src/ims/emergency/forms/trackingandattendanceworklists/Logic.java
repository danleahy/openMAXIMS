...
public class Logic extends BaseLogic
{
	...
	private void initialize()
	{
		...
		form.lblIdType().setValue(dispIdType.getText());
		form.grdResults().setColHopitalNoCaption(dispIdType.getText());
	}
	...
	public void updateControlsState()
	{
		...
		form.btnSeenCompleteNurse().setEnabled(recordInED);//WDEV-20429
	...
	private void clearSearchControls()
	{
		...
		form.chkIncludeRequiresDocumentationReview().setValue(null); //WDEV-20703
		...
		form.txtIDValue().setValue(null); //WDEV-19652
	
		form.chkShowTemporaryRegistrations().setValue(false);	//WDEV-19298
	}
	...
	private void populateSearchControls(TrackingAttendanceWorklist_SearchCriteriaVo searchCriteria)
	{
		...
		form.qmbProblem().setValue(searchCriteria.getClinicalProblem());
		
		form.txtIDValue().setValue(searchCriteria.getIDValue()); //WDEV-19652
		
		form.chkShowTemporaryRegistrations().setValue(searchCriteria.getShowTemporaryRegistrations()); //WDEV-19298
		form.chkIncludeRequiresDocumentationReview().setValue(searchCriteria.getIncludeRequiresDischargeDocumentationReview()); //WDEV-20703
	}
	...
	private void saveSearchCriteria()
	{
		...
		searchCriteria.setClinicalProblem(form.qmbProblem().getValue());
		searchCriteria.setShowTemporaryRegistrations(form.chkShowTemporaryRegistrations().getValue());  //WDEV-19298
		
		searchCriteria.setIDValue(form.txtIDValue().getValue());//WDEV-19652
		searchCriteria.setIncludeRequiresDischargeDocumentationReview(form.chkIncludeRequiresDocumentationReview().getValue()); //WDEV-20703
