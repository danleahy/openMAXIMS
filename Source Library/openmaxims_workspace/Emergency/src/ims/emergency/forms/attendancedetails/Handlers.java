...
abstract public class Handlers implements ims.framework.UILogic, IFormUILogicCode
{
	...
	abstract protected void onCcInsuranceDetailsValueChanged() throws ims.framework.exceptions.PresentationLogicException;
	...
	public final void setContext(ims.framework.UIEngine engine, GenForm form)
	{
		...
		this.form.lyrEmergencyAttendance().tabInsuranceDetails().setTabActivatedEvent(new ims.framework.delegates.TabActivated()
		{
			private static final long serialVersionUID = 1L;
			public void handle() throws ims.framework.exceptions.PresentationLogicException
			{
				onlyrEmergencyAttendancetabInsuranceDetailsActivated();
			}
		});
		...
		this.form.lyrEmergencyAttendance().tabInsuranceDetails().setccInsuranceDetailsValueChangedEvent(new ValueChanged()
		{
			private static final long serialVersionUID = 1L;
			public void handle() throws ims.framework.exceptions.PresentationLogicException
			{
				onCcInsuranceDetailsValueChanged();
			}
		});
		...
		this.form.getContextMenus().Emergency.getAttendanceDetailsCancelAttendanceItem().setClickEvent(new ims.framework.delegates.MenuItemClick()
		{
			private static final long serialVersionUID = 1L;
			public void handle(ims.framework.Control sender) throws ims.framework.exceptions.PresentationLogicException
			{
				onContextMenuItemClick(GenForm.ContextMenus.EmergencyNamespace.AttendanceDetails.CancelAttendance, sender);
			}
		});
	}
	...
	private void onlyrEmergencyAttendancetabInsuranceDetailsActivated()
	{
		this.form.lyrEmergencyAttendance().showtabInsuranceDetails();
		onlyrEmergencyAttendanceTabChanged(this.form.lyrEmergencyAttendance().tabInsuranceDetails());
	}
