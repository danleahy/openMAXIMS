...
import ims.core.vo.CareContextForAttendanceDetailsVoCollection;
...
public class AttendanceNotesCcImpl extends BaseAttendanceNotesCcImpl
{
	...
	public CareContextForAttendanceNotesVoCollection getCareContextsByPatient(PatientRefVo patientRef)
	{
		IEmergencyHelper impl = (IEmergencyHelper)getDomainImpl(EmergencyHelper.class);
		return impl.getCareContextsLiteByPatient(patientRef);
	}
