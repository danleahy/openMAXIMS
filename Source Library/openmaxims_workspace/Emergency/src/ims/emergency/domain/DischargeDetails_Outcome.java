...
public interface DischargeDetails_Outcome extends ims.domain.DomainInterface
{
	...
	// Generated from form domain interface definition
	public void saveTrackingAttendanceOutcome(ims.emergency.vo.TrackingAttendanceOutcomeVo trackingAttendance, ims.emergency.vo.enums.Discharge_Action action, ims.core.vo.DeathDetailsVo deathDetailsVo, Boolean cancelFutureAppointments) throws ims.domain.exceptions.DomainInterfaceException, ims.domain.exceptions.StaleObjectException;
	...
	// Generated from form domain interface definition
	public Boolean isCodingRequiredForDischarge(ims.emergency.vo.lookups.AttendanceOutcome lookup);

	// Generated from form domain interface definition
	public ims.emergency.vo.MandatoryEDOutcomeCodingVo getMandatoryEDOutcomeCoding();

	// Generated from form domain interface definition
	public ims.core.vo.DeathDetailsVo getDeathDetails(ims.core.vo.Patient_DODVo patientVo);
