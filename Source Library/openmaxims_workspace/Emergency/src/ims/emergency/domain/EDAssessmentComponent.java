...
public interface EDAssessmentComponent extends ims.domain.DomainInterface
{
	...
	// Generated from form domain interface definition
	public ims.emergency.vo.SeenByHCPLiteVo getFirstSeenByHCP(ims.core.admin.vo.CareContextRefVo careContextRef);
	...
	// Generated from form domain interface definition
	public ims.emergency.vo.TriageTabConfigVo getTabsConfigForRole(Integer roleId);

	// Generated from form domain interface definition
	public ims.emergency.vo.PatientProblemForClinicianWorklistVo getMainPresentingProblem(ims.core.admin.vo.CareContextRefVo careContexRef);

	// Generated from form domain interface definition
	public Boolean wasTriageAlreadyCreated(ims.emergency.vo.TrackingRefVo tracking);

	// Generated from form domain interface definition
	public Boolean isStaleCareContext(ims.core.admin.vo.CareContextRefVo careContext);
