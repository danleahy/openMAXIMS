...
public class InpatientEpisodeQueue extends ims.domain.DomainObject implements ims.domain.SystemInformationRetainer, java.io.Serializable {
	public static final int CLASSID = 1103100006;
	private static final long serialVersionUID = 1103100006L;
    ...
    public InpatientEpisodeQueue (Integer id, int ver)
    {
    	super(id, ver);
    }
    public InpatientEpisodeQueue ()
    {
    	super();
    }
    public InpatientEpisodeQueue (Integer id, int ver, Boolean includeRecord)
    {
    	super(id, ver, includeRecord);
    }
	public Class getRealDomainClass()
	{
		return ims.hl7adtout.domain.objects.InpatientEpisodeQueue.class;
	}
	...
	public String toXMLString(java.util.HashMap domMap)
	{
		...
		String keyClassName = "InpatientEpisodeQueue";
	...
	private static void fillSetFromXMLString(java.util.Set set, org.dom4j.Element el, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		...
		for(int i=0; i<size; i++) 
		{
			...
			InpatientEpisodeQueue domainObject = getInpatientEpisodeQueuefromXML(itemEl, factory, domMap);
	...
	public static InpatientEpisodeQueue getInpatientEpisodeQueuefromXML(String xml, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		org.dom4j.Document doc = new org.dom4j.io.SAXReader().read(new org.xml.sax.InputSource(xml));
		return getInpatientEpisodeQueuefromXML(doc.getRootElement(), factory, domMap);
	}
	
	public static InpatientEpisodeQueue getInpatientEpisodeQueuefromXML(org.dom4j.Element el, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		if (el == null)
			return null;
		
		String className = el.attributeValue("type");
		if (!InpatientEpisodeQueue.class.getName().equals(className))
		{
			Class clz = Class.forName(className);
			if (!InpatientEpisodeQueue.class.isAssignableFrom(clz))
				throw new Exception("Element of type = " + className + " cannot be imported using the InpatientEpisodeQueue class");
			String shortClassName = className.substring(className.lastIndexOf(".")+1);
			String methodName = "get" + shortClassName + "fromXML";
			java.lang.reflect.Method m = clz.getMethod(methodName, new Class[]{org.dom4j.Element.class, ims.domain.DomainFactory.class, java.util.HashMap.class});
			return (InpatientEpisodeQueue)m.invoke(null, new Object[]{el, factory, domMap});
		}

		String impVersion = el.attributeValue("classVersion");
		if(!impVersion.equals(InpatientEpisodeQueue.CLASSVERSION))
		{
			throw new Exception("Incompatible class structure found. Cannot import instance.");
		}		
		
		InpatientEpisodeQueue ret = null;
		int extId = Integer.parseInt(el.attributeValue("id"));
		String externalSource = el.attributeValue("source");
		ret = (InpatientEpisodeQueue)factory.getImportedDomainObject(InpatientEpisodeQueue.class, externalSource, extId);	
		if (ret == null)
		{
			ret = new InpatientEpisodeQueue();
		}
		String keyClassName = "InpatientEpisodeQueue";
		...
		if (impObj != null)
		{
			return (InpatientEpisodeQueue)impObj.getDomainObject();
		}
		else
		{
    		impObj = new ims.configuration.ImportedObject();
	...
	public static void fillFieldsfromXML(org.dom4j.Element el, ims.domain.DomainFactory factory, InpatientEpisodeQueue obj, java.util.HashMap domMap) throws Exception
	{
