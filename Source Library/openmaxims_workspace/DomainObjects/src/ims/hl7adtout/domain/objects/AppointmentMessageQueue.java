...
public class AppointmentMessageQueue extends ims.domain.DomainObject implements ims.domain.SystemInformationRetainer, java.io.Serializable {
	public static final int CLASSID = 1103100004;
	private static final long serialVersionUID = 1103100004L;
	...
	/** Id of the Booking Appointment object */
	private ims.scheduling.domain.objects.Booking_Appointment apptDetail;
	private ims.scheduling.domain.objects.Sch_Booking appointment;
    ...
    public AppointmentMessageQueue (Integer id, int ver)
    {
    	super(id, ver);
    }
    public AppointmentMessageQueue ()
    {
    	super();
    }
    public AppointmentMessageQueue (Integer id, int ver, Boolean includeRecord)
    {
    	super(id, ver, includeRecord);
    }
	public Class getRealDomainClass()
	{
		return ims.hl7adtout.domain.objects.AppointmentMessageQueue.class;
	}


	public ims.scheduling.domain.objects.Booking_Appointment getApptDetail() {
		return apptDetail;
	}
	public void setApptDetail(ims.scheduling.domain.objects.Booking_Appointment apptDetail) {
		this.apptDetail = apptDetail;
	}

	public ims.scheduling.domain.objects.Sch_Booking getAppointment() {
		return appointment;
	}
	public void setAppointment(ims.scheduling.domain.objects.Sch_Booking appointment) {
	...
	public String toAuditString()
	{
		...
		if (apptDetail != null)
		{
			auditStr.append(toShortClassName(apptDetail));
				
		    auditStr.append(apptDetail.getId());
		}
	    auditStr.append("; ");
		auditStr.append("\r\n*appointment* :");
		if (appointment != null)
	...
	public String toXMLString(java.util.HashMap domMap)
	{
		...
		String keyClassName = "AppointmentMessageQueue";
	...
	public String fieldsToXMLString(java.util.HashMap domMap)
	{
		...
		if (this.getApptDetail() != null)
		{
			...
			sb.append(this.getApptDetail().toXMLString(domMap)); 	
			sb.append("</apptDetail>");		
		}
	...
	private static void fillSetFromXMLString(java.util.Set set, org.dom4j.Element el, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		...
		for(int i=0; i<size; i++) 
		{
			...
			AppointmentMessageQueue domainObject = getAppointmentMessageQueuefromXML(itemEl, factory, domMap);
	...
	public static AppointmentMessageQueue getAppointmentMessageQueuefromXML(String xml, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		org.dom4j.Document doc = new org.dom4j.io.SAXReader().read(new org.xml.sax.InputSource(xml));
		return getAppointmentMessageQueuefromXML(doc.getRootElement(), factory, domMap);
	}
	
	public static AppointmentMessageQueue getAppointmentMessageQueuefromXML(org.dom4j.Element el, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		if (el == null)
			return null;
		
		String className = el.attributeValue("type");
		if (!AppointmentMessageQueue.class.getName().equals(className))
		{
			Class clz = Class.forName(className);
			if (!AppointmentMessageQueue.class.isAssignableFrom(clz))
				throw new Exception("Element of type = " + className + " cannot be imported using the AppointmentMessageQueue class");
			String shortClassName = className.substring(className.lastIndexOf(".")+1);
			String methodName = "get" + shortClassName + "fromXML";
			java.lang.reflect.Method m = clz.getMethod(methodName, new Class[]{org.dom4j.Element.class, ims.domain.DomainFactory.class, java.util.HashMap.class});
			return (AppointmentMessageQueue)m.invoke(null, new Object[]{el, factory, domMap});
		}

		String impVersion = el.attributeValue("classVersion");
		if(!impVersion.equals(AppointmentMessageQueue.CLASSVERSION))
		{
			throw new Exception("Incompatible class structure found. Cannot import instance.");
		}		
		
		AppointmentMessageQueue ret = null;
		int extId = Integer.parseInt(el.attributeValue("id"));
		String externalSource = el.attributeValue("source");
		ret = (AppointmentMessageQueue)factory.getImportedDomainObject(AppointmentMessageQueue.class, externalSource, extId);	
		if (ret == null)
		{
			ret = new AppointmentMessageQueue();
		}
		String keyClassName = "AppointmentMessageQueue";
		...
		if (impObj != null)
		{
			return (AppointmentMessageQueue)impObj.getDomainObject();
		}
		else
		{
    		impObj = new ims.configuration.ImportedObject();
	...
	public static void fillFieldsfromXML(org.dom4j.Element el, ims.domain.DomainFactory factory, AppointmentMessageQueue obj, java.util.HashMap domMap) throws Exception
	{
		...
		if(fldEl != null)
		{
			...
			obj.setApptDetail(ims.scheduling.domain.objects.Booking_Appointment.getBooking_AppointmentfromXML(fldEl, factory, domMap)); 
		}
		fldEl = el.element("appointment");
		if(fldEl != null)
		{
			fldEl = fldEl.element("class");		
			obj.setAppointment(ims.scheduling.domain.objects.Sch_Booking.getSch_BookingfromXML(fldEl, factory, domMap)); 
		}
