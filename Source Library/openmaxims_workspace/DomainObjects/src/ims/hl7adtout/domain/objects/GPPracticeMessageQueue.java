...
public class GPPracticeMessageQueue extends ims.domain.DomainObject implements ims.domain.SystemInformationRetainer, java.io.Serializable {
	public static final int CLASSID = 1103100009;
	private static final long serialVersionUID = 1103100009L;
    ...
    public GPPracticeMessageQueue (Integer id, int ver)
    {
    	super(id, ver);
    }
    public GPPracticeMessageQueue ()
    {
    	super();
    }
    public GPPracticeMessageQueue (Integer id, int ver, Boolean includeRecord)
    {
    	super(id, ver, includeRecord);
    }
	public Class getRealDomainClass()
	{
		return ims.hl7adtout.domain.objects.GPPracticeMessageQueue.class;
	}
	...
	public String toXMLString(java.util.HashMap domMap)
	{
		...
		String keyClassName = "GPPracticeMessageQueue";
	...
	private static void fillSetFromXMLString(java.util.Set set, org.dom4j.Element el, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		...
		for(int i=0; i<size; i++) 
		{
			...
			GPPracticeMessageQueue domainObject = getGPPracticeMessageQueuefromXML(itemEl, factory, domMap);
	...
	public static GPPracticeMessageQueue getGPPracticeMessageQueuefromXML(String xml, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		org.dom4j.Document doc = new org.dom4j.io.SAXReader().read(new org.xml.sax.InputSource(xml));
		return getGPPracticeMessageQueuefromXML(doc.getRootElement(), factory, domMap);
	}
	
	public static GPPracticeMessageQueue getGPPracticeMessageQueuefromXML(org.dom4j.Element el, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		if (el == null)
			return null;
		
		String className = el.attributeValue("type");
		if (!GPPracticeMessageQueue.class.getName().equals(className))
		{
			Class clz = Class.forName(className);
			if (!GPPracticeMessageQueue.class.isAssignableFrom(clz))
				throw new Exception("Element of type = " + className + " cannot be imported using the GPPracticeMessageQueue class");
			String shortClassName = className.substring(className.lastIndexOf(".")+1);
			String methodName = "get" + shortClassName + "fromXML";
			java.lang.reflect.Method m = clz.getMethod(methodName, new Class[]{org.dom4j.Element.class, ims.domain.DomainFactory.class, java.util.HashMap.class});
			return (GPPracticeMessageQueue)m.invoke(null, new Object[]{el, factory, domMap});
		}

		String impVersion = el.attributeValue("classVersion");
		if(!impVersion.equals(GPPracticeMessageQueue.CLASSVERSION))
		{
			throw new Exception("Incompatible class structure found. Cannot import instance.");
		}		
		
		GPPracticeMessageQueue ret = null;
		int extId = Integer.parseInt(el.attributeValue("id"));
		String externalSource = el.attributeValue("source");
		ret = (GPPracticeMessageQueue)factory.getImportedDomainObject(GPPracticeMessageQueue.class, externalSource, extId);	
		if (ret == null)
		{
			ret = new GPPracticeMessageQueue();
		}
		String keyClassName = "GPPracticeMessageQueue";
		...
		if (impObj != null)
		{
			return (GPPracticeMessageQueue)impObj.getDomainObject();
		}
		else
		{
    		impObj = new ims.configuration.ImportedObject();
	...
	public static void fillFieldsfromXML(org.dom4j.Element el, ims.domain.DomainFactory factory, GPPracticeMessageQueue obj, java.util.HashMap domMap) throws Exception
	{
