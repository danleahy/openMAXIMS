...
public class ElectiveListMessageQueue extends ims.domain.DomainObject implements ims.domain.SystemInformationRetainer, java.io.Serializable {
	public static final int CLASSID = 1103100011;
	private static final long serialVersionUID = 1103100011L;
	...
	private ims.RefMan.domain.objects.PatientElectiveList patientElectiveList;
	/** SystemInformation */
	private ims.domain.SystemInformation systemInformation = new ims.domain.SystemInformation();
    public ElectiveListMessageQueue (Integer id, int ver)
    {
    	super(id, ver);
    }
    public ElectiveListMessageQueue ()
    {
    	super();
    }
    public ElectiveListMessageQueue (Integer id, int ver, Boolean includeRecord)
    {
	...
	public ims.RefMan.domain.objects.PatientElectiveList getPatientElectiveList() {
		return patientElectiveList;
	}
	public void setPatientElectiveList(ims.RefMan.domain.objects.PatientElectiveList patientElectiveList) {
		this.patientElectiveList = patientElectiveList;
	}
	...
	public String toAuditString()
	{
		...
		{
			auditStr.append(toShortClassName(patientElectiveList));
				
		    auditStr.append(patientElectiveList.getId());
		}
	    auditStr.append("; ");
	...
	public String toXMLString(java.util.HashMap domMap)
	{
		...
		String keyClassName = "ElectiveListMessageQueue";
	...
	public String fieldsToXMLString(java.util.HashMap domMap)
	{
		...
		if (this.getPatientElectiveList() != null)
		{
			sb.append("<patientElectiveList>");
			sb.append(this.getPatientElectiveList().toXMLString(domMap)); 	
			sb.append("</patientElectiveList>");		
		}
		return sb.toString();
	}
	...
	private static void fillSetFromXMLString(java.util.Set set, org.dom4j.Element el, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		...
		for(int i=0; i<size; i++) 
		{
			...
			ElectiveListMessageQueue domainObject = getElectiveListMessageQueuefromXML(itemEl, factory, domMap);
	...
	public static ElectiveListMessageQueue getElectiveListMessageQueuefromXML(String xml, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		org.dom4j.Document doc = new org.dom4j.io.SAXReader().read(new org.xml.sax.InputSource(xml));
		return getElectiveListMessageQueuefromXML(doc.getRootElement(), factory, domMap);
	}
	
	public static ElectiveListMessageQueue getElectiveListMessageQueuefromXML(org.dom4j.Element el, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		if (el == null)
			return null;
		
		String className = el.attributeValue("type");
		if (!ElectiveListMessageQueue.class.getName().equals(className))
		{
			Class clz = Class.forName(className);
			if (!ElectiveListMessageQueue.class.isAssignableFrom(clz))
				throw new Exception("Element of type = " + className + " cannot be imported using the ElectiveListMessageQueue class");
			String shortClassName = className.substring(className.lastIndexOf(".")+1);
			String methodName = "get" + shortClassName + "fromXML";
			java.lang.reflect.Method m = clz.getMethod(methodName, new Class[]{org.dom4j.Element.class, ims.domain.DomainFactory.class, java.util.HashMap.class});
			return (ElectiveListMessageQueue)m.invoke(null, new Object[]{el, factory, domMap});
		}

		String impVersion = el.attributeValue("classVersion");
		if(!impVersion.equals(ElectiveListMessageQueue.CLASSVERSION))
		{
			throw new Exception("Incompatible class structure found. Cannot import instance.");
		}		
		
		ElectiveListMessageQueue ret = null;
		int extId = Integer.parseInt(el.attributeValue("id"));
		String externalSource = el.attributeValue("source");
		ret = (ElectiveListMessageQueue)factory.getImportedDomainObject(ElectiveListMessageQueue.class, externalSource, extId);	
		if (ret == null)
		{
			ret = new ElectiveListMessageQueue();
		}
		String keyClassName = "ElectiveListMessageQueue";
		...
		if (impObj != null)
		{
			return (ElectiveListMessageQueue)impObj.getDomainObject();
		}
		else
		{
    		impObj = new ims.configuration.ImportedObject();
	...
	public static void fillFieldsfromXML(org.dom4j.Element el, ims.domain.DomainFactory factory, ElectiveListMessageQueue obj, java.util.HashMap domMap) throws Exception
	{
		...
		fldEl = el.element("patientElectiveList");
		if(fldEl != null)
		{
			fldEl = fldEl.element("class");		
			obj.setPatientElectiveList(ims.RefMan.domain.objects.PatientElectiveList.getPatientElectiveListfromXML(fldEl, factory, domMap)); 
		}
	}
	...
	public static final String ID = "id";
		...
		public static final String PatientElectiveList = "patientElectiveList";
	}
}
