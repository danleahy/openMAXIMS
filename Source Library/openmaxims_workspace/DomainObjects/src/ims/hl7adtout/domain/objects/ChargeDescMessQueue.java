...
public class ChargeDescMessQueue extends ims.domain.DomainObject implements ims.domain.SystemInformationRetainer, java.io.Serializable {
	public static final int CLASSID = 1103100013;
	private static final long serialVersionUID = 1103100013L;
    ...
    public ChargeDescMessQueue (Integer id, int ver)
    {
    	super(id, ver);
    }
    public ChargeDescMessQueue ()
    {
    	super();
    }
    public ChargeDescMessQueue (Integer id, int ver, Boolean includeRecord)
    {
    	super(id, ver, includeRecord);
    }
	public Class getRealDomainClass()
	{
		return ims.hl7adtout.domain.objects.ChargeDescMessQueue.class;
	}
	...
	public String toXMLString(java.util.HashMap domMap)
	{
		...
		String keyClassName = "ChargeDescMessQueue";
	...
	private static void fillSetFromXMLString(java.util.Set set, org.dom4j.Element el, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		...
		for(int i=0; i<size; i++) 
		{
			...
			ChargeDescMessQueue domainObject = getChargeDescMessQueuefromXML(itemEl, factory, domMap);
	...
	public static ChargeDescMessQueue getChargeDescMessQueuefromXML(String xml, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		org.dom4j.Document doc = new org.dom4j.io.SAXReader().read(new org.xml.sax.InputSource(xml));
		return getChargeDescMessQueuefromXML(doc.getRootElement(), factory, domMap);
	}
	
	public static ChargeDescMessQueue getChargeDescMessQueuefromXML(org.dom4j.Element el, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		if (el == null)
			return null;
		
		String className = el.attributeValue("type");
		if (!ChargeDescMessQueue.class.getName().equals(className))
		{
			Class clz = Class.forName(className);
			if (!ChargeDescMessQueue.class.isAssignableFrom(clz))
				throw new Exception("Element of type = " + className + " cannot be imported using the ChargeDescMessQueue class");
			String shortClassName = className.substring(className.lastIndexOf(".")+1);
			String methodName = "get" + shortClassName + "fromXML";
			java.lang.reflect.Method m = clz.getMethod(methodName, new Class[]{org.dom4j.Element.class, ims.domain.DomainFactory.class, java.util.HashMap.class});
			return (ChargeDescMessQueue)m.invoke(null, new Object[]{el, factory, domMap});
		}

		String impVersion = el.attributeValue("classVersion");
		if(!impVersion.equals(ChargeDescMessQueue.CLASSVERSION))
		{
			throw new Exception("Incompatible class structure found. Cannot import instance.");
		}		
		
		ChargeDescMessQueue ret = null;
		int extId = Integer.parseInt(el.attributeValue("id"));
		String externalSource = el.attributeValue("source");
		ret = (ChargeDescMessQueue)factory.getImportedDomainObject(ChargeDescMessQueue.class, externalSource, extId);	
		if (ret == null)
		{
			ret = new ChargeDescMessQueue();
		}
		String keyClassName = "ChargeDescMessQueue";
		...
		if (impObj != null)
		{
			return (ChargeDescMessQueue)impObj.getDomainObject();
		}
		else
		{
    		impObj = new ims.configuration.ImportedObject();
	...
	public static void fillFieldsfromXML(org.dom4j.Element el, ims.domain.DomainFactory factory, ChargeDescMessQueue obj, java.util.HashMap domMap) throws Exception
	{
