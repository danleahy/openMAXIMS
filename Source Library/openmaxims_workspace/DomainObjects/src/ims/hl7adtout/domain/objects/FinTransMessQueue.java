...
public class FinTransMessQueue extends ims.domain.DomainObject implements ims.domain.SystemInformationRetainer, java.io.Serializable {
	public static final int CLASSID = 1103100012;
	private static final long serialVersionUID = 1103100012L;
    ...
    public FinTransMessQueue (Integer id, int ver)
    {
    	super(id, ver);
    }
    public FinTransMessQueue ()
    {
    	super();
    }
    public FinTransMessQueue (Integer id, int ver, Boolean includeRecord)
    {
    	super(id, ver, includeRecord);
    }
	public Class getRealDomainClass()
	{
		return ims.hl7adtout.domain.objects.FinTransMessQueue.class;
	}
	...
	public String toXMLString(java.util.HashMap domMap)
	{
		...
		String keyClassName = "FinTransMessQueue";
	...
	private static void fillSetFromXMLString(java.util.Set set, org.dom4j.Element el, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		...
		for(int i=0; i<size; i++) 
		{
			...
			FinTransMessQueue domainObject = getFinTransMessQueuefromXML(itemEl, factory, domMap);
	...
	public static FinTransMessQueue getFinTransMessQueuefromXML(String xml, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		org.dom4j.Document doc = new org.dom4j.io.SAXReader().read(new org.xml.sax.InputSource(xml));
		return getFinTransMessQueuefromXML(doc.getRootElement(), factory, domMap);
	}
	
	public static FinTransMessQueue getFinTransMessQueuefromXML(org.dom4j.Element el, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		if (el == null)
			return null;
		
		String className = el.attributeValue("type");
		if (!FinTransMessQueue.class.getName().equals(className))
		{
			Class clz = Class.forName(className);
			if (!FinTransMessQueue.class.isAssignableFrom(clz))
				throw new Exception("Element of type = " + className + " cannot be imported using the FinTransMessQueue class");
			String shortClassName = className.substring(className.lastIndexOf(".")+1);
			String methodName = "get" + shortClassName + "fromXML";
			java.lang.reflect.Method m = clz.getMethod(methodName, new Class[]{org.dom4j.Element.class, ims.domain.DomainFactory.class, java.util.HashMap.class});
			return (FinTransMessQueue)m.invoke(null, new Object[]{el, factory, domMap});
		}

		String impVersion = el.attributeValue("classVersion");
		if(!impVersion.equals(FinTransMessQueue.CLASSVERSION))
		{
			throw new Exception("Incompatible class structure found. Cannot import instance.");
		}		
		
		FinTransMessQueue ret = null;
		int extId = Integer.parseInt(el.attributeValue("id"));
		String externalSource = el.attributeValue("source");
		ret = (FinTransMessQueue)factory.getImportedDomainObject(FinTransMessQueue.class, externalSource, extId);	
		if (ret == null)
		{
			ret = new FinTransMessQueue();
		}
		String keyClassName = "FinTransMessQueue";
		...
		if (impObj != null)
		{
			return (FinTransMessQueue)impObj.getDomainObject();
		}
		else
		{
    		impObj = new ims.configuration.ImportedObject();
	...
	public static void fillFieldsfromXML(org.dom4j.Element el, ims.domain.DomainFactory factory, FinTransMessQueue obj, java.util.HashMap domMap) throws Exception
	{
