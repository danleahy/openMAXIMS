...
public class Townland extends ims.domain.DomainObject implements ims.domain.SystemInformationRetainer, java.io.Serializable {
	public static final int CLASSID = 1007100012;
	private static final long serialVersionUID = 1007100012L;
    ...
    public Townland (Integer id, int ver)
    {
    	super(id, ver);
    }
    public Townland ()
    ...
    public Townland (Integer id, int ver, Boolean includeRecord)
    {
    	super(id, ver, includeRecord);
    }
	public Class getRealDomainClass()
	{
		return ims.core.resource.place.domain.objects.Townland.class;
	}
	...
	private static void fillSetFromXMLString(java.util.Set set, org.dom4j.Element el, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		...
		for(int i=0; i<size; i++) 
		{
			...
			Townland domainObject = getTownlandfromXML(itemEl, factory, domMap);
	...
	public static Townland getTownlandfromXML(String xml, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		org.dom4j.Document doc = new org.dom4j.io.SAXReader().read(new org.xml.sax.InputSource(xml));
		return getTownlandfromXML(doc.getRootElement(), factory, domMap);
	}
	
	public static Townland getTownlandfromXML(org.dom4j.Element el, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		if (el == null)
			return null;
		
		String className = el.attributeValue("type");
		if (!Townland.class.getName().equals(className))
		{
			Class clz = Class.forName(className);
			if (!Townland.class.isAssignableFrom(clz))
				throw new Exception("Element of type = " + className + " cannot be imported using the Townland class");
			String shortClassName = className.substring(className.lastIndexOf(".")+1);
			String methodName = "get" + shortClassName + "fromXML";
			java.lang.reflect.Method m = clz.getMethod(methodName, new Class[]{org.dom4j.Element.class, ims.domain.DomainFactory.class, java.util.HashMap.class});
			return (Townland)m.invoke(null, new Object[]{el, factory, domMap});
		}

		String impVersion = el.attributeValue("classVersion");
		if(!impVersion.equals(Townland.CLASSVERSION))
		{
		...
		ret = (Townland)factory.getImportedDomainObject(Townland.class, externalSource, extId);	
		if (ret == null)
		{
			ret = new Townland();
		}
		...
		if (impObj != null)
		{
			return (Townland)impObj.getDomainObject();
		}
		else
		{
    		impObj = new ims.configuration.ImportedObject();
	...
	public static void fillFieldsfromXML(org.dom4j.Element el, ims.domain.DomainFactory factory, Townland obj, java.util.HashMap domMap) throws Exception
	{
