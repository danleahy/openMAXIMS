...
public class HCPServiceFunction extends ims.domain.DomainObject implements ims.domain.SystemInformationRetainer, java.io.Serializable {
	public static final int CLASSID = 1005100009;
	private static final long serialVersionUID = 1005100009L;
    ...
    public HCPServiceFunction (Integer id, int ver)
    {
    	super(id, ver);
    }
    public HCPServiceFunction ()
    {
    	super();
    }
    public HCPServiceFunction (Integer id, int ver, Boolean includeRecord)
    {
    	super(id, ver, includeRecord);
    }
	public Class getRealDomainClass()
	{
		return ims.core.resource.domain.objects.HCPServiceFunction.class;
	}
	...
	public String toXMLString(java.util.HashMap domMap)
	{
		...
		String keyClassName = "HCPServiceFunction";
	...
	private static void fillSetFromXMLString(java.util.Set set, org.dom4j.Element el, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		...
		for(int i=0; i<size; i++) 
		{
			...
			HCPServiceFunction domainObject = getHCPServiceFunctionfromXML(itemEl, factory, domMap);
	...
	public static HCPServiceFunction getHCPServiceFunctionfromXML(String xml, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		org.dom4j.Document doc = new org.dom4j.io.SAXReader().read(new org.xml.sax.InputSource(xml));
		return getHCPServiceFunctionfromXML(doc.getRootElement(), factory, domMap);
	}
	
	public static HCPServiceFunction getHCPServiceFunctionfromXML(org.dom4j.Element el, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		if (el == null)
			return null;
		
		String className = el.attributeValue("type");
		if (!HCPServiceFunction.class.getName().equals(className))
		{
			Class clz = Class.forName(className);
			if (!HCPServiceFunction.class.isAssignableFrom(clz))
				throw new Exception("Element of type = " + className + " cannot be imported using the HCPServiceFunction class");
			String shortClassName = className.substring(className.lastIndexOf(".")+1);
			String methodName = "get" + shortClassName + "fromXML";
			java.lang.reflect.Method m = clz.getMethod(methodName, new Class[]{org.dom4j.Element.class, ims.domain.DomainFactory.class, java.util.HashMap.class});
			return (HCPServiceFunction)m.invoke(null, new Object[]{el, factory, domMap});
		}

		String impVersion = el.attributeValue("classVersion");
		if(!impVersion.equals(HCPServiceFunction.CLASSVERSION))
		{
			throw new Exception("Incompatible class structure found. Cannot import instance.");
		}		
		
		HCPServiceFunction ret = null;
		int extId = Integer.parseInt(el.attributeValue("id"));
		String externalSource = el.attributeValue("source");
		ret = (HCPServiceFunction)factory.getImportedDomainObject(HCPServiceFunction.class, externalSource, extId);	
		if (ret == null)
		{
			ret = new HCPServiceFunction();
		}
		String keyClassName = "HCPServiceFunction";
		...
		if (impObj != null)
		{
			return (HCPServiceFunction)impObj.getDomainObject();
		}
		else
		{
    		impObj = new ims.configuration.ImportedObject();
	...
	public static void fillFieldsfromXML(org.dom4j.Element el, ims.domain.DomainFactory factory, HCPServiceFunction obj, java.util.HashMap domMap) throws Exception
	{
