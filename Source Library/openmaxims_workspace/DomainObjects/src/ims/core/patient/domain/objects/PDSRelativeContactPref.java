...
public class PDSRelativeContactPref extends ims.domain.DomainObject implements ims.domain.SystemInformationRetainer, java.io.Serializable {
	public static final int CLASSID = 1001100027;
	private static final long serialVersionUID = 1001100027L;
    ...
    public PDSRelativeContactPref (Integer id, int ver)
    {
    	super(id, ver);
    }
    public PDSRelativeContactPref ()
    {
    	super();
    }
    public PDSRelativeContactPref (Integer id, int ver, Boolean includeRecord)
    {
    	super(id, ver, includeRecord);
    }
	public Class getRealDomainClass()
	{
		return ims.core.patient.domain.objects.PDSRelativeContactPref.class;
	}
	...
	public String toXMLString(java.util.HashMap domMap)
	{
		...
		String keyClassName = "PDSRelativeContactPref";
	...
	private static void fillSetFromXMLString(java.util.Set set, org.dom4j.Element el, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		...
		for(int i=0; i<size; i++) 
		{
			...
			PDSRelativeContactPref domainObject = getPDSRelativeContactPreffromXML(itemEl, factory, domMap);
	...
	public static PDSRelativeContactPref getPDSRelativeContactPreffromXML(String xml, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		org.dom4j.Document doc = new org.dom4j.io.SAXReader().read(new org.xml.sax.InputSource(xml));
		return getPDSRelativeContactPreffromXML(doc.getRootElement(), factory, domMap);
	}
	
	public static PDSRelativeContactPref getPDSRelativeContactPreffromXML(org.dom4j.Element el, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		if (el == null)
			return null;
		
		String className = el.attributeValue("type");
		if (!PDSRelativeContactPref.class.getName().equals(className))
		{
			Class clz = Class.forName(className);
			if (!PDSRelativeContactPref.class.isAssignableFrom(clz))
				throw new Exception("Element of type = " + className + " cannot be imported using the PDSRelativeContactPref class");
			String shortClassName = className.substring(className.lastIndexOf(".")+1);
			String methodName = "get" + shortClassName + "fromXML";
			java.lang.reflect.Method m = clz.getMethod(methodName, new Class[]{org.dom4j.Element.class, ims.domain.DomainFactory.class, java.util.HashMap.class});
			return (PDSRelativeContactPref)m.invoke(null, new Object[]{el, factory, domMap});
		}

		String impVersion = el.attributeValue("classVersion");
		if(!impVersion.equals(PDSRelativeContactPref.CLASSVERSION))
		{
			throw new Exception("Incompatible class structure found. Cannot import instance.");
		}		
		
		PDSRelativeContactPref ret = null;
		int extId = Integer.parseInt(el.attributeValue("id"));
		String externalSource = el.attributeValue("source");
		ret = (PDSRelativeContactPref)factory.getImportedDomainObject(PDSRelativeContactPref.class, externalSource, extId);	
		if (ret == null)
		{
			ret = new PDSRelativeContactPref();
		}
		String keyClassName = "PDSRelativeContactPref";
		...
		if (impObj != null)
		{
			return (PDSRelativeContactPref)impObj.getDomainObject();
		}
		else
		{
    		impObj = new ims.configuration.ImportedObject();
	...
	public static void fillFieldsfromXML(org.dom4j.Element el, ims.domain.DomainFactory factory, PDSRelativeContactPref obj, java.util.HashMap domMap) throws Exception
	{
