...
public class NationalHealthCover extends ims.domain.DomainObject implements java.io.Serializable {
	...
	/** Institute Lookup */
	private ims.domain.lookups.LookupInstance eHICInstitutionCode;
	/** Eligibility */
	private ims.domain.lookups.LookupInstance eligibility;
    public NationalHealthCover (Integer id, int ver)
    {
    	super(id, ver);
		isComponentClass=true;
    }
    public NationalHealthCover ()
    {
    	super();
		isComponentClass=true;
    }
    public NationalHealthCover (Integer id, int ver, Boolean includeRecord)
    {
	...
	{
		return ims.core.patient.domain.objects.NationalHealthCover.class;
	}
	...
	public ims.domain.lookups.LookupInstance getEHICInstitutionCode() {
		return eHICInstitutionCode;
	}
	public void setEHICInstitutionCode(ims.domain.lookups.LookupInstance eHICInstitutionCode) {
		this.eHICInstitutionCode = eHICInstitutionCode;
	}

	public ims.domain.lookups.LookupInstance getEligibility() {
		return eligibility;
	}
	public void setEligibility(ims.domain.lookups.LookupInstance eligibility) {
	...
	public String toAuditString()
	{
	    ...
	    auditStr.append("; ");
		auditStr.append("\r\n*eHICInstitutionCode* :");
		if (eHICInstitutionCode != null)
			auditStr.append(eHICInstitutionCode.getText());
	    auditStr.append("; ");
		auditStr.append("\r\n*eligibility* :");
		if (eligibility != null)
			auditStr.append(eligibility.getText());
	    auditStr.append("; ");
	...
	public String fieldsToXMLString(java.util.HashMap domMap)
	{
		...
		if (this.getEHICInstitutionCode() != null)
		{
			sb.append("<eHICInstitutionCode>");
			sb.append(this.getEHICInstitutionCode().toXMLString()); 
			sb.append("</eHICInstitutionCode>");		
		}
		if (this.getEligibility() != null)
		{
			sb.append("<eligibility>");
			sb.append(this.getEligibility().toXMLString()); 
			sb.append("</eligibility>");		
		}
		return sb.toString();
	}
	...
	private static void fillSetFromXMLString(java.util.Set set, org.dom4j.Element el, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		...
		for(int i=0; i<size; i++) 
		{
			...
			NationalHealthCover domainObject = getNationalHealthCoverfromXML(itemEl, factory, domMap);
	...
	public static NationalHealthCover getNationalHealthCoverfromXML(String xml, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		org.dom4j.Document doc = new org.dom4j.io.SAXReader().read(new org.xml.sax.InputSource(xml));
		return getNationalHealthCoverfromXML(doc.getRootElement(), factory, domMap);
	}
	
	public static NationalHealthCover getNationalHealthCoverfromXML(org.dom4j.Element el, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		if (el == null)
			return null;
		
		String className = el.attributeValue("type");
		if (!NationalHealthCover.class.getName().equals(className))
		{
			Class clz = Class.forName(className);
			if (!NationalHealthCover.class.isAssignableFrom(clz))
				throw new Exception("Element of type = " + className + " cannot be imported using the NationalHealthCover class");
			String shortClassName = className.substring(className.lastIndexOf(".")+1);
			String methodName = "get" + shortClassName + "fromXML";
			java.lang.reflect.Method m = clz.getMethod(methodName, new Class[]{org.dom4j.Element.class, ims.domain.DomainFactory.class, java.util.HashMap.class});
			return (NationalHealthCover)m.invoke(null, new Object[]{el, factory, domMap});
		}

		String impVersion = el.attributeValue("classVersion");
		if(!impVersion.equals(NationalHealthCover.CLASSVERSION))
		{
			throw new Exception("Incompatible class structure found. Cannot import instance.");
		}		
		
		NationalHealthCover ret = null;
		if (ret == null)
		{
			ret = new NationalHealthCover();
		}
		fillFieldsfromXML(el, factory, ret, domMap);
		return ret;
	}

	public static void fillFieldsfromXML(org.dom4j.Element el, ims.domain.DomainFactory factory, NationalHealthCover obj, java.util.HashMap domMap) throws Exception
	{
		...
		fldEl = el.element("eHICInstitutionCode");
		if(fldEl != null)
		{
			fldEl = fldEl.element("lki");
			obj.setEHICInstitutionCode(ims.domain.lookups.LookupInstance.fromXMLString(fldEl, factory)); 	
		}
		fldEl = el.element("eligibility");
		if(fldEl != null)
		{
			fldEl = fldEl.element("lki");
			obj.setEligibility(ims.domain.lookups.LookupInstance.fromXMLString(fldEl, factory)); 	
		}
	}
	...
	*/
	public boolean equals(Object obj)
	{
		...
		if (!(obj instanceof ims.core.patient.domain.objects.NationalHealthCover)) 
		{
			return false;
		}
		ims.core.patient.domain.objects.NationalHealthCover tmp = (ims.core.patient.domain.objects.NationalHealthCover)obj;
	...
	*/
	...
	public static final String ID = "id";
		...
		public static final String EHICInstitutionCode = "eHICInstitutionCode";
