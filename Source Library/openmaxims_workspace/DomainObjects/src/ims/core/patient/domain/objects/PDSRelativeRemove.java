...
public class PDSRelativeRemove extends ims.domain.DomainObject implements ims.domain.SystemInformationRetainer, java.io.Serializable {
	public static final int CLASSID = 1001100031;
	private static final long serialVersionUID = 1001100031L;
    ...
    public PDSRelativeRemove (Integer id, int ver)
    {
    	super(id, ver);
    }
    public PDSRelativeRemove ()
    {
    	super();
    }
    public PDSRelativeRemove (Integer id, int ver, Boolean includeRecord)
    {
	...
	public String toAuditString()
	{
		...
		for (i3=0; i3<commChannels.size(); i3++)
		{
			if (i3 > 0)
				auditStr.append(",");
			ims.core.patient.domain.objects.PDSCommChannelRemoved obj = (ims.core.patient.domain.objects.PDSCommChannelRemoved)commChannels.get(i3);
		    if (obj != null)
			{
				if (i3 == 0)
				{
	...
	public String toXMLString(java.util.HashMap domMap)
	{
		...
		String keyClassName = "PDSRelativeRemove";
	...
	private static void fillSetFromXMLString(java.util.Set set, org.dom4j.Element el, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		...
		for(int i=0; i<size; i++) 
		{
			...
			PDSRelativeRemove domainObject = getPDSRelativeRemovefromXML(itemEl, factory, domMap);
	...
	public static PDSRelativeRemove getPDSRelativeRemovefromXML(String xml, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		org.dom4j.Document doc = new org.dom4j.io.SAXReader().read(new org.xml.sax.InputSource(xml));
		return getPDSRelativeRemovefromXML(doc.getRootElement(), factory, domMap);
	}
	
	public static PDSRelativeRemove getPDSRelativeRemovefromXML(org.dom4j.Element el, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		if (el == null)
			return null;
		
		String className = el.attributeValue("type");
		if (!PDSRelativeRemove.class.getName().equals(className))
		{
			Class clz = Class.forName(className);
			if (!PDSRelativeRemove.class.isAssignableFrom(clz))
				throw new Exception("Element of type = " + className + " cannot be imported using the PDSRelativeRemove class");
			String shortClassName = className.substring(className.lastIndexOf(".")+1);
			String methodName = "get" + shortClassName + "fromXML";
			java.lang.reflect.Method m = clz.getMethod(methodName, new Class[]{org.dom4j.Element.class, ims.domain.DomainFactory.class, java.util.HashMap.class});
			return (PDSRelativeRemove)m.invoke(null, new Object[]{el, factory, domMap});
		}

		String impVersion = el.attributeValue("classVersion");
		if(!impVersion.equals(PDSRelativeRemove.CLASSVERSION))
		{
			throw new Exception("Incompatible class structure found. Cannot import instance.");
		}		
		
		PDSRelativeRemove ret = null;
		int extId = Integer.parseInt(el.attributeValue("id"));
		String externalSource = el.attributeValue("source");
		ret = (PDSRelativeRemove)factory.getImportedDomainObject(PDSRelativeRemove.class, externalSource, extId);	
		if (ret == null)
		{
			ret = new PDSRelativeRemove();
		}
		String keyClassName = "PDSRelativeRemove";
		...
		if (impObj != null)
		{
			return (PDSRelativeRemove)impObj.getDomainObject();
		}
		else
		{
    		impObj = new ims.configuration.ImportedObject();
	...
	public static void fillFieldsfromXML(org.dom4j.Element el, ims.domain.DomainFactory factory, PDSRelativeRemove obj, java.util.HashMap domMap) throws Exception
	{
