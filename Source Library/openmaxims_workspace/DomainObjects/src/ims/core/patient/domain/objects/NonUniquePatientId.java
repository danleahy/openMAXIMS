...
public class NonUniquePatientId extends ims.domain.DomainObject implements ims.domain.SystemInformationRetainer, java.io.Serializable {
	public static final int CLASSID = 1001100023;
	private static final long serialVersionUID = 1001100023L;
    ...
    public NonUniquePatientId (Integer id, int ver)
    {
    	super(id, ver);
		isComponentClass=true;
    }
    public NonUniquePatientId ()
    {
    	super();
		isComponentClass=true;
    }
    public NonUniquePatientId (Integer id, int ver, Boolean includeRecord)
    {
	...
	{
		return ims.core.patient.domain.objects.NonUniquePatientId.class;
	}
	...
	private static void fillSetFromXMLString(java.util.Set set, org.dom4j.Element el, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		...
		for(int i=0; i<size; i++) 
		{
			...
			NonUniquePatientId domainObject = getNonUniquePatientIdfromXML(itemEl, factory, domMap);
	...
	public static NonUniquePatientId getNonUniquePatientIdfromXML(String xml, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		org.dom4j.Document doc = new org.dom4j.io.SAXReader().read(new org.xml.sax.InputSource(xml));
		return getNonUniquePatientIdfromXML(doc.getRootElement(), factory, domMap);
	}
	
	public static NonUniquePatientId getNonUniquePatientIdfromXML(org.dom4j.Element el, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		if (el == null)
			return null;
		
		String className = el.attributeValue("type");
		if (!NonUniquePatientId.class.getName().equals(className))
		{
			Class clz = Class.forName(className);
			if (!NonUniquePatientId.class.isAssignableFrom(clz))
				throw new Exception("Element of type = " + className + " cannot be imported using the NonUniquePatientId class");
			String shortClassName = className.substring(className.lastIndexOf(".")+1);
			String methodName = "get" + shortClassName + "fromXML";
			java.lang.reflect.Method m = clz.getMethod(methodName, new Class[]{org.dom4j.Element.class, ims.domain.DomainFactory.class, java.util.HashMap.class});
			return (NonUniquePatientId)m.invoke(null, new Object[]{el, factory, domMap});
		}

		String impVersion = el.attributeValue("classVersion");
		if(!impVersion.equals(NonUniquePatientId.CLASSVERSION))
		{
			throw new Exception("Incompatible class structure found. Cannot import instance.");
		}		
		
		NonUniquePatientId ret = null;
		if (ret == null)
		{
			ret = new NonUniquePatientId();
		}
		fillFieldsfromXML(el, factory, ret, domMap);
		return ret;
	}

	public static void fillFieldsfromXML(org.dom4j.Element el, ims.domain.DomainFactory factory, NonUniquePatientId obj, java.util.HashMap domMap) throws Exception
	{
