...
public class VaccineManufacturerBatch extends ims.domain.DomainObject implements ims.domain.SystemInformationRetainer, java.io.Serializable {
	public static final int CLASSID = 1003100089;
	private static final long serialVersionUID = 1003100089L;
    ...
    public VaccineManufacturerBatch (Integer id, int ver)
    {
    	super(id, ver);
    }
    public VaccineManufacturerBatch ()
    {
    	super();
    }
    public VaccineManufacturerBatch (Integer id, int ver, Boolean includeRecord)
    {
    	super(id, ver, includeRecord);
    }
	public Class getRealDomainClass()
	{
		return ims.core.clinical.domain.objects.VaccineManufacturerBatch.class;
	}
	...
	public String toXMLString(java.util.HashMap domMap)
	{
		...
		String keyClassName = "VaccineManufacturerBatch";
	...
	private static void fillSetFromXMLString(java.util.Set set, org.dom4j.Element el, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		...
		for(int i=0; i<size; i++) 
		{
			...
			VaccineManufacturerBatch domainObject = getVaccineManufacturerBatchfromXML(itemEl, factory, domMap);
	...
	public static VaccineManufacturerBatch getVaccineManufacturerBatchfromXML(String xml, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		org.dom4j.Document doc = new org.dom4j.io.SAXReader().read(new org.xml.sax.InputSource(xml));
		return getVaccineManufacturerBatchfromXML(doc.getRootElement(), factory, domMap);
	}
	
	public static VaccineManufacturerBatch getVaccineManufacturerBatchfromXML(org.dom4j.Element el, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		if (el == null)
			return null;
		
		String className = el.attributeValue("type");
		if (!VaccineManufacturerBatch.class.getName().equals(className))
		{
			Class clz = Class.forName(className);
			if (!VaccineManufacturerBatch.class.isAssignableFrom(clz))
				throw new Exception("Element of type = " + className + " cannot be imported using the VaccineManufacturerBatch class");
			String shortClassName = className.substring(className.lastIndexOf(".")+1);
			String methodName = "get" + shortClassName + "fromXML";
			java.lang.reflect.Method m = clz.getMethod(methodName, new Class[]{org.dom4j.Element.class, ims.domain.DomainFactory.class, java.util.HashMap.class});
			return (VaccineManufacturerBatch)m.invoke(null, new Object[]{el, factory, domMap});
		}

		String impVersion = el.attributeValue("classVersion");
		if(!impVersion.equals(VaccineManufacturerBatch.CLASSVERSION))
		{
			throw new Exception("Incompatible class structure found. Cannot import instance.");
		}		
		
		VaccineManufacturerBatch ret = null;
		int extId = Integer.parseInt(el.attributeValue("id"));
		String externalSource = el.attributeValue("source");
		ret = (VaccineManufacturerBatch)factory.getImportedDomainObject(VaccineManufacturerBatch.class, externalSource, extId);	
		if (ret == null)
		{
			ret = new VaccineManufacturerBatch();
		}
		String keyClassName = "VaccineManufacturerBatch";
		...
		if (impObj != null)
		{
			return (VaccineManufacturerBatch)impObj.getDomainObject();
		}
		else
		{
    		impObj = new ims.configuration.ImportedObject();
	...
	public static void fillFieldsfromXML(org.dom4j.Element el, ims.domain.DomainFactory factory, VaccineManufacturerBatch obj, java.util.HashMap domMap) throws Exception
	{
