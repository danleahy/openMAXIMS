...
public class TCIRequestsBatch extends ims.domain.DomainObject implements ims.domain.SystemInformationRetainer, java.io.Serializable {
	public static final int CLASSID = 1028100086;
	private static final long serialVersionUID = 1028100086L;
	...
	private Integer printRequestsForTCIsInNdays;
	/** SystemInformation */
	private ims.domain.SystemInformation systemInformation = new ims.domain.SystemInformation();
    public TCIRequestsBatch (Integer id, int ver)
    {
    	super(id, ver);
    }
    public TCIRequestsBatch ()
    {
    	super();
    }
    public TCIRequestsBatch (Integer id, int ver, Boolean includeRecord)
    {
    	super(id, ver, includeRecord);
    }
	public Class getRealDomainClass()
	{
		return ims.core.configuration.domain.objects.TCIRequestsBatch.class;
	}
	...
	public static TCIRequestsBatch getTCIRequestsBatchFromConfiguredJobDetails(ims.domain.ILightweightDomainFactory factory, Integer id)
	{
		java.util.List l = factory.find("from TCIRequestsBatch c where c.configuredJobDetails.id = " + id);
		if (l == null || l.size() == 0) return null;
		if (l.size() > 1) throw new ims.domain.exceptions.DomainRuntimeException("Non-unique get call. TCIRequestsBatch.configuredJobDetails.id = " + id + " returned " + l.size() + " records. " );
		return (TCIRequestsBatch)l.get(0);
	}
	...
	public Integer getPrintRequestsForTCIsInNdays() {
		return printRequestsForTCIsInNdays;
	}
	public void setPrintRequestsForTCIsInNdays(Integer printRequestsForTCIsInNdays) {
		this.printRequestsForTCIsInNdays = printRequestsForTCIsInNdays;
	}
	...
	public String toAuditString()
	{
		...
		auditStr.append(printRequestsForTCIsInNdays);
	    auditStr.append("; ");
	...
	public String toXMLString(java.util.HashMap domMap)
	{
		...
		String keyClassName = "TCIRequestsBatch";
	...
	public String fieldsToXMLString(java.util.HashMap domMap)
	{
		...
		if (this.getPrintRequestsForTCIsInNdays() != null)
		{
			sb.append("<printRequestsForTCIsInNdays>");
			sb.append(ims.framework.utils.StringUtils.encodeXML(this.getPrintRequestsForTCIsInNdays().toString()));
			sb.append("</printRequestsForTCIsInNdays>");		
		}
		return sb.toString();
	}
	...
	private static void fillSetFromXMLString(java.util.Set set, org.dom4j.Element el, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		...
		for(int i=0; i<size; i++) 
		{
			...
			TCIRequestsBatch domainObject = getTCIRequestsBatchfromXML(itemEl, factory, domMap);
	...
	public static TCIRequestsBatch getTCIRequestsBatchfromXML(String xml, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		org.dom4j.Document doc = new org.dom4j.io.SAXReader().read(new org.xml.sax.InputSource(xml));
		return getTCIRequestsBatchfromXML(doc.getRootElement(), factory, domMap);
	}
	
	public static TCIRequestsBatch getTCIRequestsBatchfromXML(org.dom4j.Element el, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		if (el == null)
			return null;
		
		String className = el.attributeValue("type");
		if (!TCIRequestsBatch.class.getName().equals(className))
		{
			Class clz = Class.forName(className);
			if (!TCIRequestsBatch.class.isAssignableFrom(clz))
				throw new Exception("Element of type = " + className + " cannot be imported using the TCIRequestsBatch class");
			String shortClassName = className.substring(className.lastIndexOf(".")+1);
			String methodName = "get" + shortClassName + "fromXML";
			java.lang.reflect.Method m = clz.getMethod(methodName, new Class[]{org.dom4j.Element.class, ims.domain.DomainFactory.class, java.util.HashMap.class});
			return (TCIRequestsBatch)m.invoke(null, new Object[]{el, factory, domMap});
		}

		String impVersion = el.attributeValue("classVersion");
		if(!impVersion.equals(TCIRequestsBatch.CLASSVERSION))
		{
			throw new Exception("Incompatible class structure found. Cannot import instance.");
		}		
		
		TCIRequestsBatch ret = null;
		int extId = Integer.parseInt(el.attributeValue("id"));
		String externalSource = el.attributeValue("source");
		ret = (TCIRequestsBatch)factory.getImportedDomainObject(TCIRequestsBatch.class, externalSource, extId);	
		if (ret == null)
		{
			ret = new TCIRequestsBatch();
		}
		String keyClassName = "TCIRequestsBatch";
		...
		if (impObj != null)
		{
			return (TCIRequestsBatch)impObj.getDomainObject();
		}
		else
		{
    		impObj = new ims.configuration.ImportedObject();
	...
	public static void fillFieldsfromXML(org.dom4j.Element el, ims.domain.DomainFactory factory, TCIRequestsBatch obj, java.util.HashMap domMap) throws Exception
	{
		...
		fldEl = el.element("printRequestsForTCIsInNdays");
		if(fldEl != null)
		{	
    		obj.setPrintRequestsForTCIsInNdays(new Integer(fldEl.getTextTrim()));	
		}
	}
	...
	public static final String ID = "id";
		...
		public static final String PrintRequestsForTCIsInNdays = "printRequestsForTCIsInNdays";
	}
}
